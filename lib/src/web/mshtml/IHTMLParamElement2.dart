...
/// @nodoc
const IID_IHTMLParamElement2 = '{30510444-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category Interface}
/// {@category com}
class IHTMLParamElement2 extends IDispatch {
  // vtable begins at 7, is 8 entries long.
  IHTMLParamElement2(Pointer<COMObject> ptr) : super(ptr);
  ...
  set valueType(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(13)
        .cast<
            Pointer<
