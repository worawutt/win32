...
/// @nodoc
const IID_IHTMLInputButtonElement = '{3050F2B2-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category Interface}
/// {@category com}
class IHTMLInputButtonElement extends IDispatch {
  // vtable begins at 7, is 11 entries long.
  IHTMLInputButtonElement(Pointer<COMObject> ptr) : super(ptr);
...
/// @nodoc
const CLSID_HTMLInputButtonElement = '{3050F2B4-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category com}
class HTMLInputButtonElement extends IHTMLInputButtonElement {
  HTMLInputButtonElement(Pointer<COMObject> ptr) : super(ptr);

  factory HTMLInputButtonElement.createInstance() {
    final ptr = calloc<COMObject>();
    final clsid = calloc<GUID>()..ref.setGUID(CLSID_HTMLInputButtonElement);
    final iid = calloc<GUID>()..ref.setGUID(IID_IHTMLInputButtonElement);
    ...
    try {
      ...
      return HTMLInputButtonElement(ptr);
    } finally {
      free(clsid);
      free(iid);
    }
