...
/// @nodoc
const IID_IHTMLXDomainRequest = '{30510454-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category Interface}
/// {@category com}
class IHTMLXDomainRequest extends IDispatch {
  // vtable begins at 7, is 15 entries long.
  IHTMLXDomainRequest(Pointer<COMObject> ptr) : super(ptr);
  ...
  int open(Pointer<Utf16> bstrMethod, Pointer<Utf16> bstrUrl) => ptr
      .ref.lpVtbl.value
      .elementAt(20)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Utf16> bstrMethod,
                      Pointer<Utf16> bstrUrl)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<Utf16> bstrMethod,
              Pointer<Utf16> bstrUrl)>()(ptr.ref.lpVtbl, bstrMethod, bstrUrl);
