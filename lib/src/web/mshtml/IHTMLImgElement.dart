...
/// @nodoc
const IID_IHTMLImgElement = '{3050F240-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category Interface}
/// {@category com}
class IHTMLImgElement extends IDispatch {
  // vtable begins at 7, is 48 entries long.
  IHTMLImgElement(Pointer<COMObject> ptr) : super(ptr);
  ...
  Pointer<Utf16> get fileCreatedDate {
    final retValuePtr = calloc<Pointer<Utf16>>();
  ...
  set lowsrc(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(29)
        .cast<
            Pointer<
  ...
  set dynsrc(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(33)
        .cast<
            Pointer<
