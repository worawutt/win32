...
/// @nodoc
const IID_IHTMLElementDefaults = '{3050F6C9-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category Interface}
/// {@category com}
class IHTMLElementDefaults extends IDispatch {
  // vtable begins at 7, is 21 entries long.
  IHTMLElementDefaults(Pointer<COMObject> ptr) : super(ptr);
  ...
  set viewInheritStyle(int value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(10)
        .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int16 v)>>>()
        .value
  ...
  int putref_viewLink(Pointer<COMObject> v) => ptr.ref.lpVtbl.value
      .elementAt(24)
      .cast<
          Pointer<
  ...
  Pointer<COMObject> get viewLink {
    final retValuePtr = calloc<Pointer<COMObject>>();
