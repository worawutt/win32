...
/// @nodoc
const IID_IHTMLButtonElement = '{3050F2BB-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category Interface}
/// {@category com}
class IHTMLButtonElement extends IDispatch {
  // vtable begins at 7, is 11 entries long.
  IHTMLButtonElement(Pointer<COMObject> ptr) : super(ptr);
...
/// @nodoc
const CLSID_HTMLButtonElement = '{3050F2C6-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category com}
class HTMLButtonElement extends IHTMLButtonElement {
  HTMLButtonElement(Pointer<COMObject> ptr) : super(ptr);

  factory HTMLButtonElement.createInstance() {
    final ptr = calloc<COMObject>();
    final clsid = calloc<GUID>()..ref.setGUID(CLSID_HTMLButtonElement);
    final iid = calloc<GUID>()..ref.setGUID(IID_IHTMLButtonElement);
