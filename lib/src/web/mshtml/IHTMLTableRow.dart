...
/// @nodoc
const IID_IHTMLTableRow = '{3050F23C-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category Interface}
/// {@category com}
class IHTMLTableRow extends IDispatch {
  // vtable begins at 7, is 17 entries long.
  IHTMLTableRow(Pointer<COMObject> ptr) : super(ptr);
...
/// @nodoc
const CLSID_HTMLTableRow = '{3050F26D-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category com}
class HTMLTableRow extends IHTMLTableRow {
  HTMLTableRow(Pointer<COMObject> ptr) : super(ptr);

  factory HTMLTableRow.createInstance() {
    final ptr = calloc<COMObject>();
    final clsid = calloc<GUID>()..ref.setGUID(CLSID_HTMLTableRow);
    final iid = calloc<GUID>()..ref.setGUID(IID_IHTMLTableRow);
