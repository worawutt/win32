...
/// @nodoc
const IID_IWebBridge = '{AE24FDAD-03C6-11D1-8B76-0080C744F389}';

/// {@category Interface}
/// {@category com}
class IWebBridge extends IDispatch {
  // vtable begins at 7, is 9 entries long.
  IWebBridge(Pointer<COMObject> ptr) : super(ptr);
  ...
  int AboutBox() => ptr.ref.lpVtbl.value
      .elementAt(15)
