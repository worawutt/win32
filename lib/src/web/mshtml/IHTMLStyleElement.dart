...
/// @nodoc
const IID_IHTMLStyleElement = '{3050F375-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category Interface}
/// {@category com}
class IHTMLStyleElement extends IDispatch {
  // vtable begins at 7, is 14 entries long.
  IHTMLStyleElement(Pointer<COMObject> ptr) : super(ptr);
...
/// @nodoc
const CLSID_HTMLStyleElement = '{3050F37D-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category com}
class HTMLStyleElement extends IHTMLStyleElement {
  HTMLStyleElement(Pointer<COMObject> ptr) : super(ptr);

  factory HTMLStyleElement.createInstance() {
    final ptr = calloc<COMObject>();
    final clsid = calloc<GUID>()..ref.setGUID(CLSID_HTMLStyleElement);
    final iid = calloc<GUID>()..ref.setGUID(IID_IHTMLStyleElement);
