...
/// @nodoc
const IID_IHTMLOptionElement = '{3050F211-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category Interface}
/// {@category com}
class IHTMLOptionElement extends IDispatch {
  // vtable begins at 7, is 11 entries long.
  IHTMLOptionElement(Pointer<COMObject> ptr) : super(ptr);
...
/// @nodoc
const CLSID_HTMLOptionElement = '{3050F24D-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category com}
class HTMLOptionElement extends IHTMLOptionElement {
  HTMLOptionElement(Pointer<COMObject> ptr) : super(ptr);

  factory HTMLOptionElement.createInstance() {
    final ptr = calloc<COMObject>();
    final clsid = calloc<GUID>()..ref.setGUID(CLSID_HTMLOptionElement);
    final iid = calloc<GUID>()..ref.setGUID(IID_IHTMLOptionElement);
