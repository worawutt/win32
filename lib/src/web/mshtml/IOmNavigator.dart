...
import '../../web/mshtml/IHTMLMimeTypesCollection.dart';
import '../../web/mshtml/IHTMLPluginsCollection.dart';
import '../../web/mshtml/IHTMLOpsProfile.dart';

/// @nodoc
const IID_IOmNavigator = '{FECEAAA5-8405-11CF-8BA1-00AA00476DA6}';

/// {@category Interface}
/// {@category com}
class IOmNavigator extends IDispatch {
  // vtable begins at 7, is 20 entries long.
  IOmNavigator(Pointer<COMObject> ptr) : super(ptr);

  Pointer<Utf16> get appCodeName {
  ...
  int javaEnabled(Pointer<Int16> enabled) => ptr.ref.lpVtbl.value
          .elementAt(11)
          .cast<
              Pointer<
                  NativeFunction<
      ...
      ptr.ref.lpVtbl, enabled);

  int taintEnabled(Pointer<Int16> enabled) => ptr.ref.lpVtbl.value
          .elementAt(12)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  Pointer<COMObject> get mimeTypes {
  ...
  Pointer<COMObject> get opsProfile {
    final retValuePtr = calloc<Pointer<COMObject>>();
  ...
  Pointer<Utf16> get browserLanguage {
    final retValuePtr = calloc<Pointer<Utf16>>();
  ...
  Pointer<Utf16> get appMinorVersion {
    final retValuePtr = calloc<Pointer<Utf16>>();
  ...
  Pointer<COMObject> get userProfile {
    final retValuePtr = calloc<Pointer<COMObject>>();
