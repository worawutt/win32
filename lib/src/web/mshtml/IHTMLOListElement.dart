...
/// @nodoc
const IID_IHTMLOListElement = '{3050F1DE-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category Interface}
/// {@category com}
class IHTMLOListElement extends IDispatch {
  // vtable begins at 7, is 6 entries long.
  IHTMLOListElement(Pointer<COMObject> ptr) : super(ptr);
...
/// @nodoc
const CLSID_HTMLOListElement = '{3050F270-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category com}
class HTMLOListElement extends IHTMLOListElement {
  HTMLOListElement(Pointer<COMObject> ptr) : super(ptr);

  factory HTMLOListElement.createInstance() {
    final ptr = calloc<COMObject>();
    final clsid = calloc<GUID>()..ref.setGUID(CLSID_HTMLOListElement);
    final iid = calloc<GUID>()..ref.setGUID(IID_IHTMLOListElement);
