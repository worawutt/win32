...
/// @nodoc
const IID_IHTMLTableRow4 = '{305106C6-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category Interface}
/// {@category com}
class IHTMLTableRow4 extends IDispatch {
  // vtable begins at 7, is 6 entries long.
  IHTMLTableRow4(Pointer<COMObject> ptr) : super(ptr);
  ...
  int insertCell(int index, Pointer<Pointer<COMObject>> row) => ptr
      .ref.lpVtbl.value
      .elementAt(11)
      .cast<
          Pointer<
  ...
  int deleteCell(int index) => ptr.ref.lpVtbl.value
      .elementAt(12)
