...
import '../../web/mshtml/ISVGPathSeg.dart';

/// @nodoc
const IID_ISVGPathSegList = '{30510510-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category Interface}
/// {@category com}
class ISVGPathSegList extends IDispatch {
  // vtable begins at 7, is 9 entries long.
  ISVGPathSegList(Pointer<COMObject> ptr) : super(ptr);
...
/// @nodoc
const CLSID_SVGPathSegList = '{305105B4-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category com}
class SVGPathSegList extends ISVGPathSegList {
  SVGPathSegList(Pointer<COMObject> ptr) : super(ptr);

  factory SVGPathSegList.createInstance() {
    final ptr = calloc<COMObject>();
    final clsid = calloc<GUID>()..ref.setGUID(CLSID_SVGPathSegList);
    final iid = calloc<GUID>()..ref.setGUID(IID_ISVGPathSegList);
