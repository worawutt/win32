...
/// @nodoc
const IID_IHTMLOptionButtonElement = '{3050F2BC-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category Interface}
/// {@category com}
class IHTMLOptionButtonElement extends IDispatch {
  // vtable begins at 7, is 18 entries long.
  IHTMLOptionButtonElement(Pointer<COMObject> ptr) : super(ptr);
...
/// @nodoc
const CLSID_HTMLOptionButtonElement = '{3050F2BE-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category com}
class HTMLOptionButtonElement extends IHTMLOptionButtonElement {
  HTMLOptionButtonElement(Pointer<COMObject> ptr) : super(ptr);

  factory HTMLOptionButtonElement.createInstance() {
    final ptr = calloc<COMObject>();
    final clsid = calloc<GUID>()..ref.setGUID(CLSID_HTMLOptionButtonElement);
    final iid = calloc<GUID>()..ref.setGUID(IID_IHTMLOptionButtonElement);
    ...
    try {
      ...
      return HTMLOptionButtonElement(ptr);
    } finally {
      free(clsid);
      free(iid);
    }
