...
/// @nodoc
const IID_ISVGPathSegArcRel = '{30510507-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category Interface}
/// {@category com}
class ISVGPathSegArcRel extends IDispatch {
  // vtable begins at 7, is 14 entries long.
  ISVGPathSegArcRel(Pointer<COMObject> ptr) : super(ptr);
...
/// @nodoc
const CLSID_SVGPathSegArcRel = '{305105BC-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category com}
class SVGPathSegArcRel extends ISVGPathSegArcRel {
  SVGPathSegArcRel(Pointer<COMObject> ptr) : super(ptr);

  factory SVGPathSegArcRel.createInstance() {
    final ptr = calloc<COMObject>();
    final clsid = calloc<GUID>()..ref.setGUID(CLSID_SVGPathSegArcRel);
    final iid = calloc<GUID>()..ref.setGUID(IID_ISVGPathSegArcRel);
