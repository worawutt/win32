...
/// @nodoc
const IID_IHTMLBodyElement = '{3050F1D8-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category Interface}
/// {@category com}
class IHTMLBodyElement extends IDispatch {
  // vtable begins at 7, is 35 entries long.
  IHTMLBodyElement(Pointer<COMObject> ptr) : super(ptr);
  ...
  set bgProperties(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(9)
        .cast<
            Pointer<
  ...
  Pointer<Utf16> get bgProperties {
    final retValuePtr = calloc<Pointer<Utf16>>();
  ...
  set bottomMargin(VARIANT value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(17)
        .cast<Pointer<NativeFunction<Int32 Function(Pointer, VARIANT v)>>>()
        .value
  ...
  set scroll(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(35)
        .cast<
            Pointer<
