...
import '../../web/mshtml/IHTMLStyleSheet.dart';

/// @nodoc
const IID_IHTMLLinkElement = '{3050F205-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category Interface}
/// {@category com}
class IHTMLLinkElement extends IDispatch {
  // vtable begins at 7, is 20 entries long.
  IHTMLLinkElement(Pointer<COMObject> ptr) : super(ptr);
...
/// @nodoc
const CLSID_HTMLLinkElement = '{3050F277-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category com}
class HTMLLinkElement extends IHTMLLinkElement {
  HTMLLinkElement(Pointer<COMObject> ptr) : super(ptr);

  factory HTMLLinkElement.createInstance() {
    final ptr = calloc<COMObject>();
    final clsid = calloc<GUID>()..ref.setGUID(CLSID_HTMLLinkElement);
    final iid = calloc<GUID>()..ref.setGUID(IID_IHTMLLinkElement);
