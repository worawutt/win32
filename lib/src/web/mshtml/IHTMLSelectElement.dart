...
/// @nodoc
const IID_IHTMLSelectElement = '{3050F244-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category Interface}
/// {@category com}
class IHTMLSelectElement extends IDispatch {
  // vtable begins at 7, is 24 entries long.
  IHTMLSelectElement(Pointer<COMObject> ptr) : super(ptr);
...
/// @nodoc
const CLSID_HTMLSelectElement = '{3050F245-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category com}
class HTMLSelectElement extends IHTMLSelectElement {
  HTMLSelectElement(Pointer<COMObject> ptr) : super(ptr);

  factory HTMLSelectElement.createInstance() {
    final ptr = calloc<COMObject>();
    final clsid = calloc<GUID>()..ref.setGUID(CLSID_HTMLSelectElement);
    final iid = calloc<GUID>()..ref.setGUID(IID_IHTMLSelectElement);
