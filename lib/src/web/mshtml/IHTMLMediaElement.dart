...
import '../../web/mshtml/IHTMLMediaError.dart';
import '../../foundation/structs.g.dart';
import '../../web/mshtml/IHTMLTimeRanges.dart';

/// @nodoc
const IID_IHTMLMediaElement = '{30510706-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category Interface}
/// {@category com}
class IHTMLMediaElement extends IDispatch {
  // vtable begins at 7, is 37 entries long.
  IHTMLMediaElement(Pointer<COMObject> ptr) : super(ptr);
  ...
  set preload(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(12)
        .cast<
            Pointer<
  ...
  Pointer<COMObject> get buffered {
    final retValuePtr = calloc<Pointer<COMObject>>();
  ...
  int canPlayType(Pointer<Utf16> type, Pointer<Pointer<Utf16>> canPlay) =>
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> type,
                              Pointer<Pointer<Utf16>> canPlay)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> type,
                      Pointer<Pointer<Utf16>> canPlay)>()(
          ptr.ref.lpVtbl, type, canPlay);
  ...
  Pointer<COMObject> get seekable {
    final retValuePtr = calloc<Pointer<COMObject>>();
...
/// @nodoc
const CLSID_HTMLMediaElement = '{3051070C-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category com}
class HTMLMediaElement extends IHTMLMediaElement {
  HTMLMediaElement(Pointer<COMObject> ptr) : super(ptr);

  factory HTMLMediaElement.createInstance() {
    final ptr = calloc<COMObject>();
    final clsid = calloc<GUID>()..ref.setGUID(CLSID_HTMLMediaElement);
    final iid = calloc<GUID>()..ref.setGUID(IID_IHTMLMediaElement);
