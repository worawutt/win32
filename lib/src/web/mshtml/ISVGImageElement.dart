...
/// @nodoc
const IID_ISVGImageElement = '{305104F0-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category Interface}
/// {@category com}
class ISVGImageElement extends IDispatch {
  // vtable begins at 7, is 8 entries long.
  ISVGImageElement(Pointer<COMObject> ptr) : super(ptr);
...
/// @nodoc
const CLSID_SVGImageElement = '{305105CF-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category com}
class SVGImageElement extends ISVGImageElement {
  SVGImageElement(Pointer<COMObject> ptr) : super(ptr);

  factory SVGImageElement.createInstance() {
    final ptr = calloc<COMObject>();
    final clsid = calloc<GUID>()..ref.setGUID(CLSID_SVGImageElement);
    final iid = calloc<GUID>()..ref.setGUID(IID_ISVGImageElement);
