// IHTMLStyleSheetRulesCollection2.dart
...
/// @nodoc
const IID_IHTMLStyleSheetRulesCollection2 =
...
class IHTMLStyleSheetRulesCollection2 extends IDispatch {
  ...
  IHTMLStyleSheetRulesCollection2(Pointer<COMObject> ptr) : super(ptr);
  ...
  int item(int index, Pointer<Pointer<COMObject>> ppHTMLCSSRule) => ptr
          .ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 index,
                          Pointer<Pointer<COMObject>> ppHTMLCSSRule)>>>()
          .value
          .asFunction<
              int Function(Pointer, int index,
                  Pointer<Pointer<COMObject>> ppHTMLCSSRule)>()(
      ptr.ref.lpVtbl, index, ppHTMLCSSRule);
}
