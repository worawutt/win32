...
/// @nodoc
const IID_ISVGLengthList = '{305104D1-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category Interface}
/// {@category com}
class ISVGLengthList extends IDispatch {
  // vtable begins at 7, is 9 entries long.
  ISVGLengthList(Pointer<COMObject> ptr) : super(ptr);
...
/// @nodoc
const CLSID_SVGLengthList = '{30510580-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category com}
class SVGLengthList extends ISVGLengthList {
  SVGLengthList(Pointer<COMObject> ptr) : super(ptr);

  factory SVGLengthList.createInstance() {
    final ptr = calloc<COMObject>();
    final clsid = calloc<GUID>()..ref.setGUID(CLSID_SVGLengthList);
    final iid = calloc<GUID>()..ref.setGUID(IID_ISVGLengthList);
