...
/// @nodoc
const IID_ISVGTransformList = '{305104F8-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category Interface}
/// {@category com}
class ISVGTransformList extends IDispatch {
  // vtable begins at 7, is 11 entries long.
  ISVGTransformList(Pointer<COMObject> ptr) : super(ptr);
  ...
  int consolidate(Pointer<Pointer<COMObject>> ppResult) => ptr.ref.lpVtbl.value
          .elementAt(17)
          .cast<
              Pointer<
                  NativeFunction<
...
/// @nodoc
const CLSID_SVGTransformList = '{305105B0-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category com}
class SVGTransformList extends ISVGTransformList {
  SVGTransformList(Pointer<COMObject> ptr) : super(ptr);

  factory SVGTransformList.createInstance() {
    final ptr = calloc<COMObject>();
    final clsid = calloc<GUID>()..ref.setGUID(CLSID_SVGTransformList);
    final iid = calloc<GUID>()..ref.setGUID(IID_ISVGTransformList);
