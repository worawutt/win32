...
/// @nodoc
const IID_IHTMLTableCell = '{3050F23D-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category Interface}
/// {@category com}
class IHTMLTableCell extends IDispatch {
  // vtable begins at 7, is 25 entries long.
  IHTMLTableCell(Pointer<COMObject> ptr) : super(ptr);
  ...
  set borderColorLight(VARIANT value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(23)
        .cast<Pointer<NativeFunction<Int32 Function(Pointer, VARIANT v)>>>()
        .value
  ...
  set borderColorDark(VARIANT value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(25)
        .cast<Pointer<NativeFunction<Int32 Function(Pointer, VARIANT v)>>>()
        .value
...
/// @nodoc
const CLSID_HTMLTableCell = '{3050F246-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category com}
class HTMLTableCell extends IHTMLTableCell {
  HTMLTableCell(Pointer<COMObject> ptr) : super(ptr);

  factory HTMLTableCell.createInstance() {
    final ptr = calloc<COMObject>();
    final clsid = calloc<GUID>()..ref.setGUID(CLSID_HTMLTableCell);
    final iid = calloc<GUID>()..ref.setGUID(IID_IHTMLTableCell);
