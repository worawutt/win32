...
/// @nodoc
const IID_IHTMLInputElement = '{3050F5D2-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category Interface}
/// {@category com}
class IHTMLInputElement extends IDispatch {
  // vtable begins at 7, is 65 entries long.
  IHTMLInputElement(Pointer<COMObject> ptr) : super(ptr);
...
/// @nodoc
const CLSID_HTMLInputElement = '{3050F5D8-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category com}
class HTMLInputElement extends IHTMLInputElement {
  HTMLInputElement(Pointer<COMObject> ptr) : super(ptr);

  factory HTMLInputElement.createInstance() {
    final ptr = calloc<COMObject>();
    final clsid = calloc<GUID>()..ref.setGUID(CLSID_HTMLInputElement);
    final iid = calloc<GUID>()..ref.setGUID(IID_IHTMLInputElement);
