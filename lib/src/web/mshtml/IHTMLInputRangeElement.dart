...
/// @nodoc
const IID_IHTMLInputRangeElement = '{3050F2D4-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category Interface}
/// {@category com}
class IHTMLInputRangeElement extends IDispatch {
  // vtable begins at 7, is 19 entries long.
  IHTMLInputRangeElement(Pointer<COMObject> ptr) : super(ptr);
  ...
  int stepUp(int n) => ptr.ref.lpVtbl.value
      .elementAt(24)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 n)>>>()
      .value
      .asFunction<int Function(Pointer, int n)>()(ptr.ref.lpVtbl, n);

  int stepDown(int n) => ptr.ref.lpVtbl.value
      .elementAt(25)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 n)>>>()
      .value
      .asFunction<int Function(Pointer, int n)>()(ptr.ref.lpVtbl, n);
