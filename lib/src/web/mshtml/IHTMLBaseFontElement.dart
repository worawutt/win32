...
/// @nodoc
const IID_IHTMLBaseFontElement = '{3050F202-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category Interface}
/// {@category com}
class IHTMLBaseFontElement extends IDispatch {
  // vtable begins at 7, is 6 entries long.
  IHTMLBaseFontElement(Pointer<COMObject> ptr) : super(ptr);
...
/// @nodoc
const CLSID_HTMLBaseFontElement = '{3050F282-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category com}
class HTMLBaseFontElement extends IHTMLBaseFontElement {
  HTMLBaseFontElement(Pointer<COMObject> ptr) : super(ptr);

  factory HTMLBaseFontElement.createInstance() {
    final ptr = calloc<COMObject>();
    final clsid = calloc<GUID>()..ref.setGUID(CLSID_HTMLBaseFontElement);
    final iid = calloc<GUID>()..ref.setGUID(IID_IHTMLBaseFontElement);
    ...
    try {
      ...
      return HTMLBaseFontElement(ptr);
    } finally {
      free(clsid);
      free(iid);
    }
