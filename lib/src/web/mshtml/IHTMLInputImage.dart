...
/// @nodoc
const IID_IHTMLInputImage = '{3050F2C2-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category Interface}
/// {@category com}
class IHTMLInputImage extends IDispatch {
  // vtable begins at 7, is 39 entries long.
  IHTMLInputImage(Pointer<COMObject> ptr) : super(ptr);
...
/// @nodoc
const CLSID_HTMLInputImage = '{3050F2C4-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category com}
class HTMLInputImage extends IHTMLInputImage {
  HTMLInputImage(Pointer<COMObject> ptr) : super(ptr);

  factory HTMLInputImage.createInstance() {
    final ptr = calloc<COMObject>();
    final clsid = calloc<GUID>()..ref.setGUID(CLSID_HTMLInputImage);
    final iid = calloc<GUID>()..ref.setGUID(IID_IHTMLInputImage);
