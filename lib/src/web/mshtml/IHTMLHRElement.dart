...
/// @nodoc
const IID_IHTMLHRElement = '{3050F1F4-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category Interface}
/// {@category com}
class IHTMLHRElement extends IDispatch {
  // vtable begins at 7, is 10 entries long.
  IHTMLHRElement(Pointer<COMObject> ptr) : super(ptr);
...
/// @nodoc
const CLSID_HTMLHRElement = '{3050F252-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category com}
class HTMLHRElement extends IHTMLHRElement {
  HTMLHRElement(Pointer<COMObject> ptr) : super(ptr);

  factory HTMLHRElement.createInstance() {
    final ptr = calloc<COMObject>();
    final clsid = calloc<GUID>()..ref.setGUID(CLSID_HTMLHRElement);
    final iid = calloc<GUID>()..ref.setGUID(IID_IHTMLHRElement);
