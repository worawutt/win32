...
/// @nodoc
const IID_IHTMLInputHiddenElement = '{3050F2A4-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category Interface}
/// {@category com}
class IHTMLInputHiddenElement extends IDispatch {
  // vtable begins at 7, is 11 entries long.
  IHTMLInputHiddenElement(Pointer<COMObject> ptr) : super(ptr);
