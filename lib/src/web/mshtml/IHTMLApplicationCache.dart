...
/// @nodoc
const IID_IHTMLApplicationCache = '{30510828-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category Interface}
/// {@category com}
class IHTMLApplicationCache extends IDispatch {
  // vtable begins at 7, is 20 entries long.
  IHTMLApplicationCache(Pointer<COMObject> ptr) : super(ptr);
  ...
  set ondownloading(VARIANT value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(14)
        .cast<Pointer<NativeFunction<Int32 Function(Pointer, VARIANT v)>>>()
        .value
  ...
  set onupdateready(VARIANT value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(18)
        .cast<Pointer<NativeFunction<Int32 Function(Pointer, VARIANT v)>>>()
        .value
  ...
  int swapCache() => ptr.ref.lpVtbl.value
      .elementAt(25)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer)>>>()
      .value
      .asFunction<int Function(Pointer)>()(ptr.ref.lpVtbl);
