...
/// @nodoc
const IID_IHTMLScriptElement = '{3050F28B-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category Interface}
/// {@category com}
class IHTMLScriptElement extends IDispatch {
  // vtable begins at 7, is 15 entries long.
  IHTMLScriptElement(Pointer<COMObject> ptr) : super(ptr);
...
/// @nodoc
const CLSID_HTMLScriptElement = '{3050F28C-98B5-11CF-BB82-00AA00BDCE0B}';

/// {@category com}
class HTMLScriptElement extends IHTMLScriptElement {
  HTMLScriptElement(Pointer<COMObject> ptr) : super(ptr);

  factory HTMLScriptElement.createInstance() {
    final ptr = calloc<COMObject>();
    final clsid = calloc<GUID>()..ref.setGUID(CLSID_HTMLScriptElement);
    final iid = calloc<GUID>()..ref.setGUID(IID_IHTMLScriptElement);
