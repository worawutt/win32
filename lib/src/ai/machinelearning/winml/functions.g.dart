...
int WinMLCreateRuntime(Pointer<COMObject> runtime) =>
    _WinMLCreateRuntime(runtime);

late final _WinMLCreateRuntime = _winml.lookupFunction<
    Int32 Function(Pointer<COMObject> runtime),
    int Function(Pointer<COMObject> runtime)>('WinMLCreateRuntime');
...
int MLCreateOperatorRegistry(Pointer<COMObject> registry) =>
    _MLCreateOperatorRegistry(registry);

late final _MLCreateOperatorRegistry =
    _windows_ai_machinelearning.lookupFunction<
        Int32 Function(Pointer<COMObject> registry),
        int Function(Pointer<COMObject> registry)>('MLCreateOperatorRegistry');
