      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<HypothesisResult> pResults,
                      Pointer<Pointer<Utf16>> ppwszUpdatedDescription,
                      Pointer<Int32> pUpdatedStatus)>()(ptr.ref.lpVtbl, celt,
          pResults, ppwszUpdatedDescription, pUpdatedStatus);

  int SetUtilities(Pointer<COMObject> pUtilities) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> pUtilities)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<COMObject> pUtilities)>()(ptr.ref.lpVtbl, pUtilities);
