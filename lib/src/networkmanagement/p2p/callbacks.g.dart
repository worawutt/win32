...
typedef PFNPEER_FREE_SECURITY_DATA = Int32 Function(
    Pointer hGraph, Pointer pvContext, Pointer<PEER_DATA> pSecurityData);
typedef PFNPEER_ON_PASSWORD_AUTH_FAILED = Int32 Function(
    Pointer hGraph, Pointer pvContext);
...
typedef PFNPEER_VALIDATE_RECORD = Int32 Function(Pointer hGraph,
    Pointer pvContext, Pointer<PEER_RECORD> pRecord, Int32 changeType);
