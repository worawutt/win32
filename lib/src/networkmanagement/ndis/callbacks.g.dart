...
typedef DOT11EXTIHV_ADAPTER_RESET = Uint32 Function(IntPtr hIhvExtAdapter);
...
typedef DOT11EXTIHV_DEINIT_ADAPTER = Void Function(IntPtr hIhvExtAdapter);
...
typedef DOT11EXTIHV_INIT_VIRTUAL_STATION = Uint32 Function(
    Pointer<DOT11EXT_VIRTUAL_STATION_APIS> pDot11ExtVSAPI, Pointer pvReserved);
typedef DOT11EXTIHV_IS_UI_REQUEST_PENDING = Uint32 Function(
    GUID guidUIRequest, Pointer<Int32> pbIsRequestPending);
...
typedef DOT11EXTIHV_PROCESS_SESSION_CHANGE = Uint32 Function(
    Uint32 uEventType, Pointer<WTSSESSION_NOTIFICATION> pSessionNotification);
typedef DOT11EXTIHV_PROCESS_UI_RESPONSE = Uint32 Function(
    GUID guidUIRequest, Uint32 dwByteCount, Pointer pvResponseBuffer);
...
typedef DOT11EXTIHV_RECEIVE_INDICATION = Uint32 Function(IntPtr hIhvExtAdapter,
    Int32 indicationType, Uint32 uBufferLength, Pointer pvBuffer);
typedef DOT11EXTIHV_RECEIVE_PACKET = Uint32 Function(
    IntPtr hIhvExtAdapter, Uint32 dwInBufferSize, Pointer pvInBuffer);
typedef DOT11EXTIHV_SEND_PACKET_COMPLETION = Uint32 Function(
    IntPtr hSendCompletion);
typedef DOT11EXTIHV_STOP_POST_ASSOCIATE = Uint32 Function(IntPtr hIhvExtAdapter,
    Pointer<Pointer<Uint8>> pPeer, Uint32 dot11AssocStatus);
...
typedef DOT11EXT_ALLOCATE_BUFFER = Uint32 Function(
    Uint32 dwByteCount, Pointer<Pointer> ppvBuffer);
typedef DOT11EXT_FREE_BUFFER = Void Function(Pointer pvMemory);
...
typedef DOT11EXT_ONEX_START = Uint32 Function(
    IntPtr hDot11SvcHandle, Pointer<EAP_ATTRIBUTES> pEapAttributes);
typedef DOT11EXT_ONEX_STOP = Uint32 Function(IntPtr hDot11SvcHandle);
...
typedef DOT11EXT_PROCESS_ONEX_PACKET = Uint32 Function(
    IntPtr hDot11SvcHandle, Uint32 dwInPacketSize, Pointer pvInPacket);
...
typedef DOT11EXT_RELEASE_VIRTUAL_STATION = Uint32 Function(
    IntPtr hDot11PrimaryHandle, Pointer pvReserved);
typedef DOT11EXT_REQUEST_VIRTUAL_STATION = Uint32 Function(
    IntPtr hDot11PrimaryHandle, Pointer pvReserved);
typedef DOT11EXT_SEND_NOTIFICATION = Uint32 Function(
    IntPtr hDot11SvcHandle, Pointer<L2_NOTIFICATION_DATA> pNotificationData);
typedef DOT11EXT_SEND_PACKET = Uint32 Function(IntPtr hDot11SvcHandle,
    Uint32 uPacketLen, Pointer pvPacket, IntPtr hSendCompletion);
typedef DOT11EXT_SEND_UI_REQUEST = Uint32 Function(
    IntPtr hDot11SvcHandle, Pointer<DOT11EXT_IHV_UI_REQUEST> pIhvUIRequest);
typedef DOT11EXT_SET_AUTH_ALGORITHM = Uint32 Function(
    IntPtr hDot11SvcHandle, Uint32 dwAuthAlgo);
typedef DOT11EXT_SET_CURRENT_PROFILE = Uint32 Function(
    IntPtr hDot11SvcHandle,
    IntPtr hConnectSession,
    Pointer<DOT11EXT_IHV_CONNECTIVITY_PROFILE> pIhvConnProfile,
    Pointer<DOT11EXT_IHV_SECURITY_PROFILE> pIhvSecProfile);
typedef DOT11EXT_SET_DEFAULT_KEY = Uint32 Function(IntPtr hDot11SvcHandle,
    Pointer<DOT11_CIPHER_DEFAULT_KEY_VALUE> pKey, Int32 dot11Direction);
typedef DOT11EXT_SET_DEFAULT_KEY_ID = Uint32 Function(
    IntPtr hDot11SvcHandle, Uint32 uDefaultKeyId);
...
typedef DOT11EXT_SET_EXCLUDE_UNENCRYPTED = Uint32 Function(
    IntPtr hDot11SvcHandle, Int32 bExcludeUnencrypted);
typedef DOT11EXT_SET_KEY_MAPPING_KEY = Uint32 Function(
    IntPtr hDot11SvcHandle, Pointer<DOT11_CIPHER_KEY_MAPPING_KEY_VALUE> pKey);
typedef DOT11EXT_SET_MULTICAST_CIPHER_ALGORITHM = Uint32 Function(
    IntPtr hDot11SvcHandle, Uint32 dwMulticastCipherAlgo);
...
typedef DOT11EXT_SET_UNICAST_CIPHER_ALGORITHM = Uint32 Function(
    IntPtr hDot11SvcHandle, Uint32 dwUnicastCipherAlgo);
