...
class IMbnDeviceServicesManager extends IUnknown {
  ...
  int
      GetDeviceServicesContext(Pointer<Utf16> networkInterfaceID,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<Utf16> networkInterfaceID,
                          Pointer<Pointer<COMObject>> mbnDevicesContext)>()(
              ptr.ref.lpVtbl, networkInterfaceID, mbnDevicesContext);
}
