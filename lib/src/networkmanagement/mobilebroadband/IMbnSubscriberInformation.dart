  ...
  Pointer<Utf16> get SubscriberID {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> SubscriberID)>()(
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<Utf16>> SimIccID)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<Utf16>> SimIccID)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  Pointer<SAFEARRAY> get TelephoneNumbers {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<SAFEARRAY>> TelephoneNumbers)>()(
          ptr.ref.lpVtbl, retValuePtr);
