...
class IMbnInterfaceManager extends IUnknown {
  ...
  int GetInterface(Pointer<Utf16> interfaceID,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> interfaceID,
                      Pointer<Pointer<COMObject>> mbnInterface)>()(
          ptr.ref.lpVtbl, interfaceID, mbnInterface);

  int GetInterfaces(Pointer<Pointer<SAFEARRAY>> mbnInterfaces) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<SAFEARRAY>> mbnInterfaces)>()(
          ptr.ref.lpVtbl, mbnInterfaces);
}
