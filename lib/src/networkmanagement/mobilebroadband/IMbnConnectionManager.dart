...
class IMbnConnectionManager extends IUnknown {
  ...
  int GetConnection(Pointer<Utf16> connectionID,
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> connectionID,
                              Pointer<Pointer<COMObject>> mbnConnection)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> connectionID,
                      Pointer<Pointer<COMObject>> mbnConnection)>()(
          ptr.ref.lpVtbl, connectionID, mbnConnection);

  int GetConnections(Pointer<Pointer<SAFEARRAY>> mbnConnections) => ptr
          .ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<SAFEARRAY>> mbnConnections)>()(
      ptr.ref.lpVtbl, mbnConnections);
}
