...
class IMbnConnectionProfileManager extends IUnknown {
  ...
  int
      GetConnectionProfiles(Pointer<COMObject> mbnInterface,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(Pointer, Pointer<COMObject> mbnInterface,
                          Pointer<Pointer<SAFEARRAY>> connectionProfiles)>()(
              ptr.ref.lpVtbl, mbnInterface, connectionProfiles);
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(
                          ...
                          Pointer<Utf16> profileName,
                          Pointer<Pointer<COMObject>> connectionProfile)>()(
              ptr.ref.lpVtbl, mbnInterface, profileName, connectionProfile);

  int CreateConnectionProfile(Pointer<Utf16> xmlProfile) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> xmlProfile)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Utf16> xmlProfile)>()(
      ptr.ref.lpVtbl, xmlProfile);
}
