...
class IMbnVendorSpecificEvents extends IUnknown {
  ...
  int OnEventNotification(Pointer<COMObject> vendorOperation,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> vendorOperation,
                      Pointer<SAFEARRAY> vendorSpecificData)>()(
          ptr.ref.lpVtbl, vendorOperation, vendorSpecificData);

  int OnSetVendorSpecificComplete(Pointer<COMObject> vendorOperation,
          Pointer<SAFEARRAY> vendorSpecificData, int requestID) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> vendorOperation,
                      Pointer<SAFEARRAY> vendorSpecificData, int requestID)>()(
          ptr.ref.lpVtbl, vendorOperation, vendorSpecificData, requestID);
}
