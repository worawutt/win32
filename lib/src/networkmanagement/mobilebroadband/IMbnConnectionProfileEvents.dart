...
class IMbnConnectionProfileEvents extends IUnknown {
  ...
  int OnProfileUpdate(Pointer<COMObject> newProfile) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> newProfile)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<COMObject> newProfile)>()(ptr.ref.lpVtbl, newProfile);
}
