...
class IMbnConnectionContext extends IUnknown {
  ...
  int
      GetProvisionedContexts(Pointer<Pointer<SAFEARRAY>> provisionedContexts) =>
          ptr.ref.lpVtbl.value
              ...
              ptr.ref.lpVtbl, provisionedContexts);

  int SetProvisionedContext(MBN_CONTEXT provisionedContexts,
          Pointer<Utf16> providerID, Pointer<Uint32> requestID) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, MBN_CONTEXT provisionedContexts,
                      Pointer<Utf16> providerID, Pointer<Uint32> requestID)>()(
          ptr.ref.lpVtbl, provisionedContexts, providerID, requestID);
}
