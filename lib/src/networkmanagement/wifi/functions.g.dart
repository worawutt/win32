...
int WFDCancelOpenSession(int hSessionHandle) =>
    _WFDCancelOpenSession(hSessionHandle);

late final _WFDCancelOpenSession = _wlanapi.lookupFunction<
    Uint32 Function(IntPtr hSessionHandle),
    int Function(int hSessionHandle)>('WFDCancelOpenSession');

int WFDCloseHandle(int hClientHandle) => _WFDCloseHandle(hClientHandle);

late final _WFDCloseHandle = _wlanapi.lookupFunction<
    Uint32 Function(IntPtr hClientHandle),
    int Function(int hClientHandle)>('WFDCloseHandle');

int WFDCloseSession(int hSessionHandle) => _WFDCloseSession(hSessionHandle);

late final _WFDCloseSession = _wlanapi.lookupFunction<
    Uint32 Function(IntPtr hSessionHandle),
    int Function(int hSessionHandle)>('WFDCloseSession');

int WFDOpenHandle(int dwClientVersion, Pointer<Uint32> pdwNegotiatedVersion,
        Pointer<IntPtr> phClientHandle) =>
    _WFDOpenHandle(dwClientVersion, pdwNegotiatedVersion, phClientHandle);

late final _WFDOpenHandle = _wlanapi.lookupFunction<
    Uint32 Function(Uint32 dwClientVersion,
        Pointer<Uint32> pdwNegotiatedVersion, Pointer<IntPtr> phClientHandle),
    int Function(int dwClientVersion, Pointer<Uint32> pdwNegotiatedVersion,
        Pointer<IntPtr> phClientHandle)>('WFDOpenHandle');
...
int WFDOpenLegacySession(
    ...
    _WFDOpenLegacySession(hClientHandle, pLegacyMacAddress, phSessionHandle,
...
late final _WFDOpenLegacySession = _wlanapi.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Pointer<Uint8>> pLegacyMacAddress,
        Pointer<IntPtr> phSessionHandle,
        Pointer<GUID> pGuidSessionInterface)>('WFDOpenLegacySession');
...
late final _WFDStartOpenSession = _wlanapi.lookupFunction<
    ...
    int Function(
        ...
        Pointer pvContext,
        Pointer<NativeFunction<WFD_OPEN_SESSION_COMPLETE_CALLBACK>> pfnCallback,
        Pointer<IntPtr> phSessionHandle)>('WFDStartOpenSession');

int WFDUpdateDeviceVisibility(Pointer<Pointer<Uint8>> pDeviceAddress) =>
    _WFDUpdateDeviceVisibility(pDeviceAddress);

late final _WFDUpdateDeviceVisibility = _wlanapi.lookupFunction<
    Uint32 Function(Pointer<Pointer<Uint8>> pDeviceAddress),
    int Function(
        Pointer<Pointer<Uint8>> pDeviceAddress)>('WFDUpdateDeviceVisibility');
...
late final _WlanConnect2 = _wlanapi.lookupFunction<
    ...
    int Function(
        ...
        Pointer<GUID> pInterfaceGuid,
        Pointer<WLAN_CONNECTION_PARAMETERS_V2> pConnectionParameters,
        Pointer pReserved)>('WlanConnect2');
...
int WlanGetAvailableNetworkList2(
        ...
        int dwFlags,
        Pointer pReserved,
        Pointer<Pointer<WLAN_AVAILABLE_NETWORK_LIST_V2>>
            ppAvailableNetworkList) =>
    _WlanGetAvailableNetworkList2(hClientHandle, pInterfaceGuid, dwFlags,
        pReserved, ppAvailableNetworkList);
...
late final _WlanGetAvailableNetworkList2 = _wlanapi.lookupFunction<
    ...
    int Function(
        ...
        Pointer pReserved,
        Pointer<Pointer<WLAN_AVAILABLE_NETWORK_LIST_V2>>
            ppAvailableNetworkList)>('WlanGetAvailableNetworkList2');
