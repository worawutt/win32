...
class IDot11AdHocManager extends IUnknown {
  ...
  int CommitCreatedNetwork(Pointer<COMObject> pIAdHoc, int fSaveProfile,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pIAdHoc,
                      int fSaveProfile, int fMakeSavedProfileUserSpecific)>()(
          ptr.ref.lpVtbl, pIAdHoc, fSaveProfile, fMakeSavedProfileUserSpecific);

  int GetIEnumDot11AdHocNetworks(
          Pointer<GUID> pContextGuid, Pointer<Pointer<COMObject>> ppEnum) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<GUID> pContextGuid,
                      Pointer<Pointer<COMObject>> ppEnum)>()(
          ptr.ref.lpVtbl, pContextGuid, ppEnum);

  int GetIEnumDot11AdHocInterfaces(Pointer<Pointer<COMObject>> ppEnum) =>
      ptr.ref.lpVtbl.value
              .elementAt(6)
              .cast<
                  Pointer<
  ...
  int GetNetwork(Pointer<GUID> NetworkSignature,
      ...
      ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<GUID> NetworkSignature,
                          Pointer<Pointer<COMObject>> pNetwork)>>>()
          .value
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<COMObject>>
                      pNetwork)>()(ptr.ref.lpVtbl, NetworkSignature, pNetwork);
}
