...
int McastApiStartup(Pointer<Uint32> Version) => _McastApiStartup(Version);

late final _McastApiStartup = _dhcpcsvc.lookupFunction<
    Uint32 Function(Pointer<Uint32> Version),
    int Function(Pointer<Uint32> Version)>('McastApiStartup');
...
late final _McastEnumerateScopes = _dhcpcsvc.lookupFunction<
    ...
    int Function(
        ...
        Pointer<MCAST_SCOPE_ENTRY> pScopeList,
        Pointer<Uint32> pScopeLen,
        Pointer<Uint32> pScopeCount)>('McastEnumerateScopes');

int McastGenUID(Pointer<MCAST_CLIENT_UID> pRequestID) =>
    _McastGenUID(pRequestID);

late final _McastGenUID = _dhcpcsvc.lookupFunction<
    Uint32 Function(Pointer<MCAST_CLIENT_UID> pRequestID),
    int Function(Pointer<MCAST_CLIENT_UID> pRequestID)>('McastGenUID');

int McastReleaseAddress(int AddrFamily, Pointer<MCAST_CLIENT_UID> pRequestID,
        Pointer<MCAST_LEASE_REQUEST> pReleaseRequest) =>
    _McastReleaseAddress(AddrFamily, pRequestID, pReleaseRequest);

late final _McastReleaseAddress = _dhcpcsvc.lookupFunction<
    Uint32 Function(Uint16 AddrFamily, Pointer<MCAST_CLIENT_UID> pRequestID,
        Pointer<MCAST_LEASE_REQUEST> pReleaseRequest),
    int Function(int AddrFamily, Pointer<MCAST_CLIENT_UID> pRequestID,
        Pointer<MCAST_LEASE_REQUEST> pReleaseRequest)>('McastReleaseAddress');
...
int McastRenewAddress(
    ...
    _McastRenewAddress(AddrFamily, pRequestID, pRenewRequest, pRenewResponse);
...
late final _McastRenewAddress = _dhcpcsvc.lookupFunction<
    ...
    int Function(
        ...
        Pointer<MCAST_CLIENT_UID> pRequestID,
        Pointer<MCAST_LEASE_REQUEST> pRenewRequest,
        Pointer<MCAST_LEASE_RESPONSE> pRenewResponse)>('McastRenewAddress');
...
int McastRequestAddress(
    ...
    _McastRequestAddress(
        AddrFamily, pRequestID, pScopeCtx, pAddrRequest, pAddrResponse);
...
late final _McastRequestAddress = _dhcpcsvc.lookupFunction<
    ...
    int Function(
        ...
        Pointer<MCAST_SCOPE_CTX> pScopeCtx,
        Pointer<MCAST_LEASE_REQUEST> pAddrRequest,
        Pointer<MCAST_LEASE_RESPONSE> pAddrResponse)>('McastRequestAddress');
