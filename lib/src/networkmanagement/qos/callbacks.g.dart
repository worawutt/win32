...
typedef PALLOCMEM = Pointer Function(Uint32 Size);
typedef PFREEMEM = Void Function(Pointer pv);
typedef TCI_ADD_FLOW_COMPLETE_HANDLER = Void Function(
    IntPtr ClFlowCtx, Uint32 Status);
typedef TCI_DEL_FLOW_COMPLETE_HANDLER = Void Function(
    IntPtr ClFlowCtx, Uint32 Status);
typedef TCI_MOD_FLOW_COMPLETE_HANDLER = Void Function(
    IntPtr ClFlowCtx, Uint32 Status);
typedef TCI_NOTIFY_HANDLER = Void Function(IntPtr ClRegCtx, IntPtr ClIfcCtx,
    Uint32 Event, IntPtr SubCode, Uint32 BufSize, Pointer Buffer);
