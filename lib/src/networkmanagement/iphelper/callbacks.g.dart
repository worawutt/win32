...
typedef PIPFORWARD_CHANGE_CALLBACK = Void Function(Pointer CallerContext,
    Pointer<MIB_IPFORWARD_ROW2> Row, Int32 NotificationType);
typedef PIPINTERFACE_CHANGE_CALLBACK = Void Function(Pointer CallerContext,
    Pointer<MIB_IPINTERFACE_RO> Row, Int32 NotificationType);
typedef PNETWORK_CONNECTIVITY_HINT_CHANGE_CALLBACK = Void Function(
    Pointer CallerContext, NL_NETWORK_CONNECTIVITY_HINT ConnectivityHint);
typedef PSTABLE_UNICAST_IPADDRESS_TABLE_CALLBACK = Void Function(
    Pointer CallerContext, Pointer<MIB_UNICASTIPADDRESS_TABLE> AddressTable);
typedef PTEREDO_PORT_CHANGE_CALLBACK = Void Function(
    Pointer CallerContext, Uint16 Port, Int32 NotificationType);
