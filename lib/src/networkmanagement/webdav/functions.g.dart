...
late final _DavAddConnection = _netapi32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Utf16> Password,
        Pointer<Uint8> ClientCert,
        int CertSize)>('DavAddConnection');

int DavDeleteConnection(int ConnectionHandle) =>
    _DavDeleteConnection(ConnectionHandle);

late final _DavDeleteConnection = _netapi32.lookupFunction<
    Uint32 Function(IntPtr ConnectionHandle),
    int Function(int ConnectionHandle)>('DavDeleteConnection');

int DavFlushFile(int hFile) => _DavFlushFile(hFile);

late final _DavFlushFile = _netapi32.lookupFunction<
    Uint32 Function(IntPtr hFile), int Function(int hFile)>('DavFlushFile');

int DavGetExtendedError(int hFile, Pointer<Uint32> ExtError,
        Pointer<Utf16> ExtErrorString, Pointer<Uint32> cChSize) =>
    _DavGetExtendedError(hFile, ExtError, ExtErrorString, cChSize);

late final _DavGetExtendedError = _netapi32.lookupFunction<
    Uint32 Function(IntPtr hFile, Pointer<Uint32> ExtError,
        Pointer<Utf16> ExtErrorString, Pointer<Uint32> cChSize),
    int Function(
        int hFile,
        Pointer<Uint32> ExtError,
        Pointer<Utf16> ExtErrorString,
        Pointer<Uint32> cChSize)>('DavGetExtendedError');

int DavGetHTTPFromUNCPath(
        Pointer<Utf16> UncPath, Pointer<Utf16> Url, Pointer<Uint32> lpSize) =>
    _DavGetHTTPFromUNCPath(UncPath, Url, lpSize);

late final _DavGetHTTPFromUNCPath = _netapi32.lookupFunction<
    Uint32 Function(
        Pointer<Utf16> UncPath, Pointer<Utf16> Url, Pointer<Uint32> lpSize),
    int Function(Pointer<Utf16> UncPath, Pointer<Utf16> Url,
        Pointer<Uint32> lpSize)>('DavGetHTTPFromUNCPath');

int DavGetUNCFromHTTPPath(
        Pointer<Utf16> Url, Pointer<Utf16> UncPath, Pointer<Uint32> lpSize) =>
    _DavGetUNCFromHTTPPath(Url, UncPath, lpSize);

late final _DavGetUNCFromHTTPPath = _netapi32.lookupFunction<
    Uint32 Function(
        Pointer<Utf16> Url, Pointer<Utf16> UncPath, Pointer<Uint32> lpSize),
    int Function(Pointer<Utf16> Url, Pointer<Utf16> UncPath,
        Pointer<Uint32> lpSize)>('DavGetUNCFromHTTPPath');
