...
typedef PF_AddConnectNotify = Uint32 Function(
    Pointer<NOTIFYINFO> lpNotifyInfo, Pointer<NOTIFYADD> lpAddInfo);
typedef PF_CancelConnectNotify = Uint32 Function(
    Pointer<NOTIFYINFO> lpNotifyInfo, Pointer<NOTIFYCANCEL> lpCancelInfo);
typedef PF_NPAddConnection = Uint32 Function(Pointer<NETRESOURCE> lpNetResource,
...
typedef PF_NPCancelConnection = Uint32 Function(
    Pointer<Utf16> lpName, Int32 fForce);
typedef PF_NPCancelConnection2 = Uint32 Function(
    Pointer<Utf16> lpName, Int32 fForce, Uint32 dwFlags);
typedef PF_NPCloseEnum = Uint32 Function(IntPtr hEnum);
typedef PF_NPDeviceMode = Uint32 Function(IntPtr hParent);
typedef PF_NPDirectoryNotify = Uint32 Function(
    IntPtr hwnd, Pointer<Utf16> lpDir, Uint32 dwOper);
typedef PF_NPEnumResource = Uint32 Function(IntPtr hEnum,
    Pointer<Uint32> lpcCount, Pointer lpBuffer, Pointer<Uint32> lpBufferSize);
typedef PF_NPFMXEditPerm = Uint32 Function(
    Pointer<Utf16> lpDriveName, IntPtr hwndFMX, Uint32 nDialogType);
typedef PF_NPFMXGetPermCaps = Uint32 Function(Pointer<Utf16> lpDriveName);
...
typedef PF_NPGetCaps = Uint32 Function(Uint32 ndex);
typedef PF_NPGetConnection = Uint32 Function(Pointer<Utf16> lpLocalName,
    Pointer<Utf16> lpRemoteName, Pointer<Uint32> lpnBufferLen);
typedef PF_NPGetConnection3 = Uint32 Function(Pointer<Utf16> lpLocalName,
    Uint32 dwLevel, Pointer lpBuffer, Pointer<Uint32> lpBufferSize);
...
typedef PF_NPGetDirectoryType = Uint32 Function(
    Pointer<Utf16> lpName, Pointer<Int32> lpType, Int32 bFlushCache);
...
typedef PF_NPGetResourceParent = Uint32 Function(
    ...
    Pointer lpBuffer,
    Pointer<Uint32> lpBufferSize);
typedef PF_NPGetUniversalName = Uint32 Function(Pointer<Utf16> lpLocalPath,
    Uint32 dwInfoLevel, Pointer lpBuffer, Pointer<Uint32> lpnBufferSize);
typedef PF_NPGetUser = Uint32 Function(Pointer<Utf16> lpName,
    Pointer<Utf16> lpUserName, Pointer<Uint32> lpnBufferLen);
