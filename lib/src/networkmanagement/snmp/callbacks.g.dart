...
typedef PFNSNMPEXTENSIONMONITOR = Int32 Function(Pointer pAgentMgmtData);
...
typedef SNMPAPI_CALLBACK = Uint32 Function(IntPtr hSession, IntPtr hWnd,
    Uint32 wMsg, IntPtr wParam, IntPtr lParam, Pointer lpClientData);
