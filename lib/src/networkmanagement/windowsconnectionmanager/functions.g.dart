...
void FreeInterfaceContextTable(
    ...
    _FreeInterfaceContextTable(InterfaceContextTable);

late final _FreeInterfaceContextTable = _ondemandconnroutehelper.lookupFunction<
    Void Function(Pointer<NET_INTERFACE_CONTEXT_TABLE> InterfaceContextTable),
    void Function(
        Pointer<NET_INTERFACE_CONTEXT_TABLE>
            InterfaceContextTable)>('FreeInterfaceContextTable');
...
late final _GetInterfaceContextTableForHostName =
    _ondemandconnroutehelper.lookupFunction<
        Int32 Function(
            ...
            Pointer<Pointer<NET_INTERFACE_CONTEXT_TABLE>>
                InterfaceContextTable),
        int Function(
            Pointer<Utf16> HostName,
            Pointer<Utf16> ProxyName,
            ...
            int ConnectionProfileFilterRawDataSize,
            Pointer<Pointer<NET_INTERFACE_CONTEXT_TABLE>>
                InterfaceContextTable)>('GetInterfaceContextTableForHostName');

int OnDemandGetRoutingHint(
        Pointer<Utf16> destinationHostName, Pointer<Uint32> interfaceIndex) =>
    _OnDemandGetRoutingHint(destinationHostName, interfaceIndex);

late final _OnDemandGetRoutingHint = _ondemandconnroutehelper.lookupFunction<
    Int32 Function(
        Pointer<Utf16> destinationHostName, Pointer<Uint32> interfaceIndex),
    int Function(Pointer<Utf16> destinationHostName,
        Pointer<Uint32> interfaceIndex)>('OnDemandGetRoutingHint');
...
late final _OnDemandRegisterNotification =
    _ondemandconnroutehelper.lookupFunction<
        ...
        int Function(
            ...
            Pointer callbackContext,
            Pointer<IntPtr>
                registrationHandle)>('OnDemandRegisterNotification');

int OnDemandUnRegisterNotification(int registrationHandle) =>
    _OnDemandUnRegisterNotification(registrationHandle);

late final _OnDemandUnRegisterNotification =
    _ondemandconnroutehelper.lookupFunction<
        Int32 Function(IntPtr registrationHandle),
        int Function(int registrationHandle)>('OnDemandUnRegisterNotification');
