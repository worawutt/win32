...
class IWCNConnectNotify extends IUnknown {
  ...
  int ConnectFailed(int hrFailure) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 hrFailure)>>>()
      .value
      .asFunction<
          int Function(Pointer, int hrFailure)>()(ptr.ref.lpVtbl, hrFailure);
}
