...
typedef FWPM_CALLOUT_CHANGE_CALLBACK0 = Void Function(
    Pointer context, Pointer<FWPM_CALLOUT_CHANGE0> change);
typedef FWPM_CONNECTION_CALLBACK0 = Void Function(
    Pointer context, Int32 eventType, Pointer<FWPM_CONNECTION0> connection);
typedef FWPM_DYNAMIC_KEYWORD_CALLBACK0 = Void Function(
    Pointer notification, Pointer context);
typedef FWPM_FILTER_CHANGE_CALLBACK0 = Void Function(
    Pointer context, Pointer<FWPM_FILTER_CHANGE0> change);
typedef FWPM_NET_EVENT_CALLBACK0 = Void Function(
    Pointer context, Pointer<FWPM_NET_EVENT1> event);
typedef FWPM_NET_EVENT_CALLBACK1 = Void Function(
    Pointer context, Pointer<FWPM_NET_EVENT2> event);
typedef FWPM_NET_EVENT_CALLBACK2 = Void Function(
    Pointer context, Pointer<FWPM_NET_EVENT3> event);
typedef FWPM_NET_EVENT_CALLBACK3 = Void Function(
    Pointer context, Pointer<FWPM_NET_EVENT4_> event);
typedef FWPM_NET_EVENT_CALLBACK4 = Void Function(
    Pointer context, Pointer<FWPM_NET_EVENT5_> event);
typedef FWPM_PROVIDER_CHANGE_CALLBACK0 = Void Function(
    Pointer context, Pointer<FWPM_PROVIDER_CHANGE0> change);
typedef FWPM_PROVIDER_CONTEXT_CHANGE_CALLBACK0 = Void Function(
    Pointer context, Pointer<FWPM_PROVIDER_CONTEXT_CHANGE0> change);
typedef FWPM_SUBLAYER_CHANGE_CALLBACK0 = Void Function(
    Pointer context, Pointer<FWPM_SUBLAYER_CHANGE0> change);
typedef FWPM_SYSTEM_PORTS_CALLBACK0 = Void Function(
    Pointer context, Pointer<FWPM_SYSTEM_PORTS0> sysPorts);
typedef FWPM_VSWITCH_EVENT_CALLBACK0 = Uint32 Function(
    Pointer context, Pointer<FWPM_VSWITCH_EVENT0> vSwitchEvent);
...
typedef IPSEC_SA_CONTEXT_CALLBACK0 = Void Function(
    Pointer context, Pointer<IPSEC_SA_CONTEXT_CHANGE0> change);
