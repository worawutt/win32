...
class ISdoCollection extends IDispatch {
  ...
  int Add(Pointer<Utf16> bstrName, Pointer<Pointer<COMObject>> ppItem) =>
  ...
  int IsNameUnique(Pointer<Utf16> bstrName, Pointer<Int16> pBool) =>
      ptr.ref.lpVtbl.value
          .elementAt(12)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(Pointer, Pointer<Utf16> bstrName,
                  Pointer<Int16> pBool)>()(ptr.ref.lpVtbl, bstrName, pBool);

  int Item(Pointer<VARIANT> Name, Pointer<Pointer<COMObject>> pItem) =>
      ptr.ref.lpVtbl.value
              .elementAt(13)
              .cast<
                  Pointer<
