...
class ISdoMachine2 extends ISdoMachine {
  ...
  int GetTemplatesSDO(Pointer<Utf16> bstrServiceName,
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> bstrServiceName,
                              Pointer<Pointer<COMObject>> ppTemplatesSDO)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrServiceName,
                      Pointer<Pointer<COMObject>> ppTemplatesSDO)>()(
          ptr.ref.lpVtbl, bstrServiceName, ppTemplatesSDO);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppConfigRoot,
                      Pointer<Pointer<COMObject>> ppTemplatesRoot,
                      int bForcedSync)>()(ptr.ref.lpVtbl, bstrServiceName,
          ppConfigRoot, ppTemplatesRoot, bForcedSync);

  int ImportRemoteTemplates(Pointer<COMObject> pLocalTemplatesRoot,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pLocalTemplatesRoot,
                      Pointer<Utf16> bstrRemoteMachineName)>()(
          ptr.ref.lpVtbl, pLocalTemplatesRoot, bstrRemoteMachineName);
