      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint32> pdwNumInterfaces,
                      Pointer<Pointer<GUID>> ppguidInterfaceIds)>()(
          ptr.ref.lpVtbl, pAdapter, pdwNumInterfaces, ppguidInterfaceIds);

  int AddInterfacesToAdapter(
          Pointer<COMObject> pAdapter, int dwNumInterfaces) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<COMObject> pAdapter,
                              Uint32 dwNumInterfaces)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pAdapter,
                      int dwNumInterfaces)>()(
          ptr.ref.lpVtbl, pAdapter, dwNumInterfaces);

  int RemoveInterfacesFromAdapter(Pointer<COMObject> pAdapter,
          int dwNumInterfaces, Pointer<GUID> pguidInterfaceIds) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pAdapter,
                      int dwNumInterfaces, Pointer<GUID> pguidInterfaceIds)>()(
          ptr.ref.lpVtbl, pAdapter, dwNumInterfaces, pguidInterfaceIds);
}
