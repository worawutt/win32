...
class INetCfgClass extends IUnknown {
  ...
  int FindComponent(
          Pointer<Utf16> pszwInfId, Pointer<Pointer<COMObject>> ppnccItem) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> pszwInfId,
                      Pointer<Pointer<COMObject>> ppnccItem)>()(
          ptr.ref.lpVtbl, pszwInfId, ppnccItem);

  int EnumComponents(Pointer<Pointer<COMObject>> ppenumComponent) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppenumComponent)>()(
          ptr.ref.lpVtbl, ppenumComponent);
}
