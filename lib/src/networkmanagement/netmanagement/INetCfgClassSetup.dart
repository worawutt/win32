...
class INetCfgClassSetup extends IUnknown {
  ...
  int SelectAndInstall(int hwndParent, Pointer<OBO_TOKEN> pOboToken,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<OBO_TOKEN> pOboToken,
                      Pointer<Pointer<COMObject>> ppnccItem)>()(
          ptr.ref.lpVtbl, hwndParent, pOboToken, ppnccItem);
  ...
  int DeInstall(Pointer<COMObject> pComponent, Pointer<OBO_TOKEN> pOboToken,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<OBO_TOKEN> pOboToken,
                      Pointer<Pointer<Utf16>> pmszwRefs)>()(
          ptr.ref.lpVtbl, pComponent, pOboToken, pmszwRefs);
}
