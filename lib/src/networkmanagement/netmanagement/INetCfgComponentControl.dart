...
class INetCfgComponentControl extends IUnknown {
  ...
  int
      Initialize(Pointer<COMObject> pIComp, Pointer<COMObject> pINetCfg,
              int fInstalling) =>
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<COMObject> pIComp,
                          Pointer<COMObject> pINetCfg, int fInstalling)>()(
              ptr.ref.lpVtbl, pIComp, pINetCfg, fInstalling);
  ...
  int ApplyPnpChanges(Pointer<COMObject> pICallback) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> pICallback)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<COMObject> pICallback)>()(ptr.ref.lpVtbl, pICallback);
