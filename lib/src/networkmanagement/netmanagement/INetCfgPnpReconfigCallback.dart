...
class INetCfgPnpReconfigCallback extends IUnknown {
  ...
  int SendPnpReconfig(int Layer, Pointer<Utf16> pszwUpper,
          Pointer<Utf16> pszwLower, Pointer pvData, int dwSizeOfData) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer pvData,
                      int dwSizeOfData)>()(
          ptr.ref.lpVtbl, Layer, pszwUpper, pszwLower, pvData, dwSizeOfData);
}
