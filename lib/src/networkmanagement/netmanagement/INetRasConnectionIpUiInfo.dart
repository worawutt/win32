...
class INetRasConnectionIpUiInfo extends IUnknown {
  ...
  int GetUiInfo(Pointer<RASCON_IPUI> pInfo) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<RASCON_IPUI> pInfo)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<RASCON_IPUI> pInfo)>()(
