...
class INetCfgClassSetup2 extends INetCfgClassSetup {
  ...
  int
      UpdateNonEnumeratedComponent(Pointer<COMObject> pIComp, int dwSetupFlags,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(Pointer, Pointer<COMObject> pIComp,
                          int dwSetupFlags, int dwUpgradeFromBuildNo)>()(
              ptr.ref.lpVtbl, pIComp, dwSetupFlags, dwUpgradeFromBuildNo);
}
