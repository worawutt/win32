...
class INetCfgLock extends IUnknown {
  ...
  int
      AcquireWriteLock(int cmsTimeout, Pointer<Utf16> pszwClientDescription,
  ...
  int IsWriteLocked(Pointer<Pointer<Utf16>> ppszwClientDescription) => ptr
          .ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<Utf16>> ppszwClientDescription)>()(
      ptr.ref.lpVtbl, ppszwClientDescription);
}
