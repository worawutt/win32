...
class IDynamicPortMappingCollection extends IDispatch {
  ...
  int get_Item(Pointer<Utf16> bstrRemoteHost, int lExternalPort,
          Pointer<Utf16> bstrProtocol, Pointer<Pointer<COMObject>> ppDPM) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> bstrProtocol,
                      Pointer<Pointer<COMObject>> ppDPM)>()(
          ptr.ref.lpVtbl, bstrRemoteHost, lExternalPort, bstrProtocol, ppDPM);
  ...
  int
      Remove(Pointer<Utf16> bstrRemoteHost, int lExternalPort,
              Pointer<Utf16> bstrProtocol) =>
          ptr.ref.lpVtbl.value
                  .elementAt(10)
                  .cast<
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<Utf16> bstrRemoteHost,
                          int lExternalPort, Pointer<Utf16> bstrProtocol)>()(
              ptr.ref.lpVtbl, bstrRemoteHost, lExternalPort, bstrProtocol);
