...
class INetFwServices extends IDispatch {
  ...
  int Item(int svcType, Pointer<Pointer<COMObject>> service) => ptr
          .ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 svcType,
                          Pointer<Pointer<COMObject>> service)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer, int svcType, Pointer<Pointer<COMObject>> service)>()(
      ptr.ref.lpVtbl, svcType, service);
