...
class INetFwOpenPorts extends IDispatch {
  ...
  int Add(Pointer<COMObject> port) => ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> port)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> port)>()(
      ptr.ref.lpVtbl, port);

  int Remove(int portNumber, int ipProtocol) => ptr.ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Int32 portNumber, Int32 ipProtocol)>>>()
          .value
          .asFunction<int Function(Pointer, int portNumber, int ipProtocol)>()(
      ptr.ref.lpVtbl, portNumber, ipProtocol);

  int Item(int portNumber, int ipProtocol,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int portNumber, int ipProtocol,
                      Pointer<Pointer<COMObject>> openPort)>()(
          ptr.ref.lpVtbl, portNumber, ipProtocol, openPort);
