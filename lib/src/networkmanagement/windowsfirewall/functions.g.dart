...
int NetworkIsolationDiagnoseConnectFailureAndGetInfo(
        Pointer<Utf16> wszServerName, Pointer<Int32> netIsoError) =>
...
int NetworkIsolationEnumAppContainers(
    ...
    _NetworkIsolationEnumAppContainers(Flags, pdwNumPublicAppCs, ppPublicAppCs);

late final _NetworkIsolationEnumAppContainers =
    _api_ms_win_net_isolation_l1_1_0.lookupFunction<
            Uint32 Function(Uint32 Flags, Pointer<Uint32> pdwNumPublicAppCs,
                Pointer<Pointer<INET_FIREWALL_APP_CONTAINER>> ppPublicAppCs),
            int Function(int Flags, Pointer<Uint32> pdwNumPublicAppCs,
                Pointer<Pointer<INET_FIREWALL_APP_CONTAINER>> ppPublicAppCs)>(
        'NetworkIsolationEnumAppContainers');

int NetworkIsolationFreeAppContainers(
        Pointer<INET_FIREWALL_APP_CONTAINER> pPublicAppCs) =>
    _NetworkIsolationFreeAppContainers(pPublicAppCs);

late final _NetworkIsolationFreeAppContainers =
    _api_ms_win_net_isolation_l1_1_0.lookupFunction<
            Uint32 Function(Pointer<INET_FIREWALL_APP_CONTAINER> pPublicAppCs),
            int Function(Pointer<INET_FIREWALL_APP_CONTAINER> pPublicAppCs)>(
        'NetworkIsolationFreeAppContainers');

int NetworkIsolationGetAppContainerConfig(Pointer<Uint32> pdwNumPublicAppCs,
        Pointer<Pointer<SID_AND_ATTRIBUTES>> appContainerSids) =>
    _NetworkIsolationGetAppContainerConfig(pdwNumPublicAppCs, appContainerSids);

late final _NetworkIsolationGetAppContainerConfig =
    _api_ms_win_net_isolation_l1_1_0.lookupFunction<
            Uint32 Function(Pointer<Uint32> pdwNumPublicAppCs,
                Pointer<Pointer<SID_AND_ATTRIBUTES>> appContainerSids),
            int Function(Pointer<Uint32> pdwNumPublicAppCs,
                Pointer<Pointer<SID_AND_ATTRIBUTES>> appContainerSids)>(
...
int NetworkIsolationRegisterForAppContainerChanges(
    ...
    _NetworkIsolationRegisterForAppContainerChanges(
        flags, callback, context, registrationObject);
...
int NetworkIsolationSetAppContainerConfig(
        int dwNumPublicAppCs, Pointer<SID_AND_ATTRIBUTES> appContainerSids) =>
    _NetworkIsolationSetAppContainerConfig(dwNumPublicAppCs, appContainerSids);

late final _NetworkIsolationSetAppContainerConfig =
    _api_ms_win_net_isolation_l1_1_0.lookupFunction<
            Uint32 Function(Uint32 dwNumPublicAppCs,
                Pointer<SID_AND_ATTRIBUTES> appContainerSids),
            int Function(int dwNumPublicAppCs,
                Pointer<SID_AND_ATTRIBUTES> appContainerSids)>(
...
late final _NetworkIsolationSetupAppContainerBinaries =
    _api_ms_win_net_isolation_l1_1_0.lookupFunction<
        ...
        int Function(
            ...
            int bBinariesFullyComputed,
            Pointer<Pointer<Utf16>> binaries,
            int binariesCount)>('NetworkIsolationSetupAppContainerBinaries');

int NetworkIsolationUnregisterForAppContainerChanges(int registrationObject) =>
    _NetworkIsolationUnregisterForAppContainerChanges(registrationObject);

late final _NetworkIsolationUnregisterForAppContainerChanges =
    _api_ms_win_net_isolation_l1_1_0.lookupFunction<
            Uint32 Function(IntPtr registrationObject),
            int Function(int registrationObject)>(
