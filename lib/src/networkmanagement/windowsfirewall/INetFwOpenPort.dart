...
class INetFwOpenPort extends IDispatch {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> ipProtocol)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int32> ipProtocol)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  set Protocol(int value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<Int32 Function(Pointer, Int32 ipProtocol)>>>()
        .value
        .asFunction<
            int Function(Pointer, int ipProtocol)>()(ptr.ref.lpVtbl, value);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> portNumber)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int32> portNumber)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  set Port(int value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<Int32 Function(Pointer, Int32 portNumber)>>>()
        .value
        .asFunction<
            int Function(Pointer, int portNumber)>()(ptr.ref.lpVtbl, value);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int16> builtIn)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int16> builtIn)>()(
          ptr.ref.lpVtbl, retValuePtr);
