...
class INetSharingConfiguration extends IDispatch {
  ...
  int EnableSharing(int Type) => ptr.ref.lpVtbl.value
      .elementAt(10)
  ...
  int get_EnumPortMappings(int Flags, Pointer<Pointer<COMObject>> ppColl) => ptr
          .ref.lpVtbl.value
          .elementAt(14)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, int Flags, Pointer<Pointer<COMObject>> ppColl)>()(
  ...
  int RemovePortMapping(Pointer<COMObject> pMapping) => ptr.ref.lpVtbl.value
          .elementAt(16)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pMapping)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> pMapping)>()(
      ptr.ref.lpVtbl, pMapping);
}
