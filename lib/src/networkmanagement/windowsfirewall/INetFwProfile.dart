...
class INetFwProfile extends IDispatch {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int16> notAllowed)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int16> notAllowed)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  set ExceptionsNotAllowed(int value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<Int32 Function(Pointer, Int16 notAllowed)>>>()
        .value
        .asFunction<
            int Function(Pointer, int notAllowed)>()(ptr.ref.lpVtbl, value);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int16> disabled)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int16> disabled)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set NotificationsDisabled(int value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(13)
        .cast<
            Pointer<NativeFunction<Int32 Function(Pointer, Int16 disabled)>>>()
        .value
        .asFunction<
            int Function(Pointer, int disabled)>()(ptr.ref.lpVtbl, value);
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<COMObject>>
                      remoteAdminSettings)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  Pointer<COMObject> get IcmpSettings {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> icmpSettings)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  Pointer<COMObject> get Services {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> services)>()(
          ptr.ref.lpVtbl, retValuePtr);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<COMObject>> apps)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<COMObject>> apps)>()(
          ptr.ref.lpVtbl, retValuePtr);
