...
class INATExternalIPAddressCallback extends IUnknown {
  ...
  int NewExternalIPAddress(Pointer<Utf16> bstrNewExternalIPAddress) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Utf16> bstrNewExternalIPAddress)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Utf16> bstrNewExternalIPAddress)>()(
      ptr.ref.lpVtbl, bstrNewExternalIPAddress);
}
