...
class IStaticPortMappingCollection extends IDispatch {
  ...
  int get_Item(int lExternalPort, Pointer<Utf16> bstrProtocol,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> bstrProtocol,
                      Pointer<Pointer<COMObject>> ppSPM)>()(
          ptr.ref.lpVtbl, lExternalPort, bstrProtocol, ppSPM);
  ...
  int Remove(int lExternalPort, Pointer<Utf16> bstrProtocol) => ptr
          .ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 lExternalPort,
                          Pointer<Utf16> bstrProtocol)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer, int lExternalPort, Pointer<Utf16> bstrProtocol)>()(
      ptr.ref.lpVtbl, lExternalPort, bstrProtocol);
