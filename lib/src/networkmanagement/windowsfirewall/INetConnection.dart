...
class INetConnection extends IUnknown {
  ...
  int Duplicate(Pointer<Utf16> pszwDuplicateName,
      ...
      ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> pszwDuplicateName,
                          Pointer<Pointer<COMObject>> ppCon)>>>()
          .value
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<COMObject>>
                      ppCon)>()(ptr.ref.lpVtbl, pszwDuplicateName, ppCon);

  int GetProperties(Pointer<Pointer<NETCON_PROPERTIES>> ppProps) => ptr
          .ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<NETCON_PROPERTIES>> ppProps)>()(
      ptr.ref.lpVtbl, ppProps);

  int GetUiObjectClassId(Pointer<GUID> pclsid) => ptr.ref.lpVtbl.value
      .elementAt(8)
      .cast<
          Pointer<
  ...
  int Rename(Pointer<Utf16> pszwNewName) => ptr.ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> pszwNewName)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Utf16> pszwNewName)>()(
      ptr.ref.lpVtbl, pszwNewName);
}
