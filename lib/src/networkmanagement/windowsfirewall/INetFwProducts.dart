...
class INetFwProducts extends IDispatch {
  ...
  int Register(Pointer<COMObject> product,
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<COMObject> product,
                              Pointer<Pointer<COMObject>> registration)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> product,
                      Pointer<Pointer<COMObject>> registration)>()(
          ptr.ref.lpVtbl, product, registration);

  int Item(int index, Pointer<Pointer<COMObject>> product) => ptr
          .ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, int index, Pointer<Pointer<COMObject>> product)>()(
      ptr.ref.lpVtbl, index, product);
