...
class INetFwRule3 extends INetFwRule2 {
  ...
  Pointer<Utf16> get LocalAppPackageId {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> wszPackageId)>()(
  ...
  set LocalAppPackageId(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<
                    Int32 Function(Pointer, Pointer<Utf16> wszPackageId)>>>()
        .value
        .asFunction<
            int Function(
                Pointer, Pointer<Utf16> wszPackageId)>()(ptr.ref.lpVtbl, value);
  ...
  Pointer<Utf16> get LocalUserOwner {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> wszUserOwner)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set LocalUserOwner(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<
                    Int32 Function(Pointer, Pointer<Utf16> wszUserOwner)>>>()
        .value
        .asFunction<
            int Function(
                Pointer, Pointer<Utf16> wszUserOwner)>()(ptr.ref.lpVtbl, value);
  ...
  Pointer<Utf16> get LocalUserAuthorizedList {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> wszUserAuthList)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set LocalUserAuthorizedList(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<
                    Int32 Function(Pointer, Pointer<Utf16> wszUserAuthList)>>>()
        .value
        .asFunction<
            int Function(Pointer,
                Pointer<Utf16> wszUserAuthList)>()(ptr.ref.lpVtbl, value);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> lOptions)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> lOptions)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set SecureFlags(int value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(56)
        .cast<
            Pointer<NativeFunction<Int32 Function(Pointer, Int32 lOptions)>>>()
        .value
        .asFunction<
            int Function(Pointer, int lOptions)>()(ptr.ref.lpVtbl, value);
