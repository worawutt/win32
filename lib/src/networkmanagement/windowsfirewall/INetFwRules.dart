...
class INetFwRules extends IDispatch {
  ...
  int Add(Pointer<COMObject> rule) => ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> rule)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> rule)>()(
      ptr.ref.lpVtbl, rule);
  ...
  int Item(Pointer<Utf16> name, Pointer<Pointer<COMObject>> rule) => ptr
      .ref.lpVtbl.value
      .elementAt(10)
      .cast<
          Pointer<
      ...
      .asFunction<
          int Function(Pointer, Pointer<Utf16> name,
              Pointer<Pointer<COMObject>> rule)>()(ptr.ref.lpVtbl, name, rule);
