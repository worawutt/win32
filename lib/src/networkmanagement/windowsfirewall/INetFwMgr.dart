...
class INetFwMgr extends IDispatch {
  ...
  Pointer<COMObject> get LocalPolicy {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> localPolicy)>()(
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> profileType)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int32> profileType)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  int IsIcmpTypeAllowed(int ipVersion, Pointer<Utf16> localAddress, int type,
          Pointer<VARIANT> allowed, Pointer<VARIANT> restricted) =>
      ptr.ref.lpVtbl.value
              .elementAt(11)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<VARIANT> allowed,
                      Pointer<VARIANT> restricted)>()(
          ptr.ref.lpVtbl, ipVersion, localAddress, type, allowed, restricted);
}
