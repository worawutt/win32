...
class INetSharingManager extends IDispatch {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int16> pbInstalled)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int16> pbInstalled)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  int get_EnumPublicConnections(
          int Flags, Pointer<Pointer<COMObject>> ppColl) =>
  ...
  int get_INetSharingConfigurationForINetConnection(
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pNetConnection,
                      Pointer<Pointer<COMObject>> ppNetSharingConfiguration)>()(
          ptr.ref.lpVtbl, pNetConnection, ppNetSharingConfiguration);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<COMObject>> ppColl)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<COMObject>> ppColl)>()(
  ...
  int get_NetConnectionProps(Pointer<COMObject> pNetConnection,
      ...
      ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pNetConnection,
                          Pointer<Pointer<COMObject>> ppProps)>>>()
          .value
          .asFunction<
              int Function(
                  ...
                  Pointer<COMObject> pNetConnection,
                  Pointer<Pointer<COMObject>>
                      ppProps)>()(ptr.ref.lpVtbl, pNetConnection, ppProps);
}
