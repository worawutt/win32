...
class IKsJackContainerId extends IUnknown {
  ...
  int GetJackContainerId(Pointer<GUID> pJackContainerId) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<GUID> pJackContainerId)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<GUID> pJackContainerId)>()(
          ptr.ref.lpVtbl, pJackContainerId);
}
