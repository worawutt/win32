      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Int32> plPitch,
                      Pointer<Pointer<Uint8>> ppbBufferStart,
                      Pointer<Uint32> pcbBufferLength)>()(ptr.ref.lpVtbl,
          lockFlags, ppbScanline0, plPitch, ppbBufferStart, pcbBufferLength);

  int Copy2DTo(Pointer<COMObject> pDestBuffer) => ptr.ref.lpVtbl.value
      .elementAt(11)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> pDestBuffer)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<COMObject> pDestBuffer)>()(ptr.ref.lpVtbl, pDestBuffer);
}
