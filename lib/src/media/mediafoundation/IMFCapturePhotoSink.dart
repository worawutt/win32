...
class IMFCapturePhotoSink extends IMFCaptureSink {
  ...
  int SetSampleCallback(Pointer<COMObject> pCallback) => ptr.ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int SetOutputByteStream(Pointer<COMObject> pByteStream) => ptr
      .ref.lpVtbl.value
      .elementAt(10)
      .cast<
          Pointer<
      ...
      .asFunction<
          int Function(Pointer,
              Pointer<COMObject> pByteStream)>()(ptr.ref.lpVtbl, pByteStream);
}
