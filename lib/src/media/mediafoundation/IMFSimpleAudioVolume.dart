...
class IMFSimpleAudioVolume extends IUnknown {
  ...
  int SetMasterVolume(double fLevel) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Float fLevel)>>>()
      .value
      .asFunction<
          int Function(Pointer, double fLevel)>()(ptr.ref.lpVtbl, fLevel);
  ...
  int SetMute(int bMute) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 bMute)>>>()
      .value
      .asFunction<int Function(Pointer, int bMute)>()(ptr.ref.lpVtbl, bMute);
