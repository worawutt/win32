...
class IMFSSLCertificateManager extends IUnknown {
  ...
  int GetClientCertificate(Pointer<Utf16> pszURL,
          Pointer<Pointer<Uint8>> ppbData, Pointer<Uint32> pcbData) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<Uint8>> ppbData,
                      Pointer<Uint32> pcbData)>()(
          ptr.ref.lpVtbl, pszURL, ppbData, pcbData);

  int BeginGetClientCertificate(Pointer<Utf16> pszURL,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pCallback,
                      Pointer<COMObject> pState)>()(
          ptr.ref.lpVtbl, pszURL, pCallback, pState);

  int EndGetClientCertificate(Pointer<COMObject> pResult,
          Pointer<Pointer<Uint8>> ppbData, Pointer<Uint32> pcbData) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<Uint8>> ppbData,
                      Pointer<Uint32> pcbData)>()(
          ptr.ref.lpVtbl, pResult, ppbData, pcbData);
  ...
  int OnServerCertificate(Pointer<Utf16> pszURL, Pointer<Uint8> pbData,
          int cbData, Pointer<Int32> pfIsGood) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      int cbData,
                      Pointer<Int32> pfIsGood)>()(
          ptr.ref.lpVtbl, pszURL, pbData, cbData, pfIsGood);
}
