...
class IMFVideoSampleAllocatorEx extends IMFVideoSampleAllocator {
  ...
  int InitializeSampleAllocatorEx(int cInitialSamples, int cMaximumSamples,
          Pointer<COMObject> pAttributes, Pointer<COMObject> pMediaType) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int cMaximumSamples,
                      Pointer<COMObject> pAttributes,
                      Pointer<COMObject> pMediaType)>()(ptr.ref.lpVtbl,
          cInitialSamples, cMaximumSamples, pAttributes, pMediaType);
}
