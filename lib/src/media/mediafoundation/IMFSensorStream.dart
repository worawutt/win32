...
class IMFSensorStream extends IMFAttributes {
  ...
  int GetMediaTypeCount(Pointer<Uint32> pdwCount) => ptr.ref.lpVtbl.value
          .elementAt(33)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetMediaType(int dwIndex, Pointer<Pointer<COMObject>> ppMediaType) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int dwIndex,
                      Pointer<Pointer<COMObject>> ppMediaType)>()(
          ptr.ref.lpVtbl, dwIndex, ppMediaType);

  int CloneSensorStream(Pointer<Pointer<COMObject>> ppStream) => ptr
          .ref.lpVtbl.value
          .elementAt(35)
          .cast<
              Pointer<
