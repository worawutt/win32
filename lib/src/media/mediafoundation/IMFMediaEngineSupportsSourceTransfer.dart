...
class IMFMediaEngineSupportsSourceTransfer extends IUnknown {
  ...
  int ShouldTransferSource(Pointer<Int32> pfShouldTransfer) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Int32> pfShouldTransfer)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> pfShouldTransfer)>()(
          ptr.ref.lpVtbl, pfShouldTransfer);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppMediaSource,
                      Pointer<Pointer<COMObject>> ppMSE)>()(
          ptr.ref.lpVtbl, ppByteStream, ppMediaSource, ppMSE);

  int AttachMediaSource(Pointer<COMObject> pByteStream,
          Pointer<COMObject> pMediaSource, Pointer<COMObject> pMSE) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pMediaSource,
                      Pointer<COMObject> pMSE)>()(
          ptr.ref.lpVtbl, pByteStream, pMediaSource, pMSE);
}
