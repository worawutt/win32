...
class IMFMediaEngineWebSupport extends IUnknown {
  ...
  int ConnectWebAudio(
          int dwSampleRate, Pointer<Pointer<COMObject>> ppSourceProvider) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint32 dwSampleRate,
                              Pointer<Pointer<COMObject>> ppSourceProvider)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int dwSampleRate,
                      Pointer<Pointer<COMObject>> ppSourceProvider)>()(
          ptr.ref.lpVtbl, dwSampleRate, ppSourceProvider);
