...
class IMFNetCredentialCache extends IUnknown {
  ...
  int SetUserOptions(Pointer<COMObject> pCred, int dwOptionsFlags) =>
      ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pCred,
                          Uint32 dwOptionsFlags)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> pCred,
                  int dwOptionsFlags)>()(ptr.ref.lpVtbl, pCred, dwOptionsFlags);
}
