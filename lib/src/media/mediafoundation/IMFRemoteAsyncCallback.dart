...
class IMFRemoteAsyncCallback extends IUnknown {
  ...
  int Invoke(int hr, Pointer<COMObject> pRemoteResult) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 hr,
                          Pointer<COMObject> pRemoteResult)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer, int hr, Pointer<COMObject> pRemoteResult)>()(
      ptr.ref.lpVtbl, hr, pRemoteResult);
}
