...
class IMFMediaEngineNeedKeyNotify extends IUnknown {
  ...
  void NeedKey(Pointer<Uint8> initData, int cb) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Void Function(
                          Pointer, Pointer<Uint8> initData, Uint32 cb)>>>()
          .value
          .asFunction<
              void Function(Pointer, Pointer<Uint8> initData, int cb)>()(
      ptr.ref.lpVtbl, initData, cb);
}
