...
class IMFSpatialAudioSample extends IMFSample {
  ...
  int GetObjectCount(Pointer<Uint32> pdwObjectCount) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Uint32> pdwObjectCount)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> pdwObjectCount)>()(
          ptr.ref.lpVtbl, pdwObjectCount);

  int AddSpatialAudioObject(Pointer<COMObject> pAudioObjBuffer) =>
      ptr.ref.lpVtbl.value
              .elementAt(48)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<COMObject> pAudioObjBuffer)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pAudioObjBuffer)>()(
          ptr.ref.lpVtbl, pAudioObjBuffer);

  int GetSpatialAudioObjectByIndex(
          int dwIndex, Pointer<Pointer<COMObject>> ppAudioObjBuffer) =>
      ptr.ref.lpVtbl.value
              .elementAt(49)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, int dwIndex,
                      Pointer<Pointer<COMObject>> ppAudioObjBuffer)>()(
          ptr.ref.lpVtbl, dwIndex, ppAudioObjBuffer);
}
