...
typedef MFPERIODICCALLBACK = Void Function(Pointer<COMObject> pContext);
typedef PDXVAHDSW_CreateDevice = Int32 Function(
    Pointer<COMObject> pD3DDevice, Pointer<IntPtr> phDevice);
typedef PDXVAHDSW_CreateVideoProcessor = Int32 Function(
    IntPtr hDevice, Pointer<GUID> pVPGuid, Pointer<IntPtr> phVideoProcessor);
typedef PDXVAHDSW_DestroyDevice = Int32 Function(IntPtr hDevice);
...
typedef PDXVAHDSW_GetVideoProcessBltStatePrivate = Int32 Function(
    IntPtr hVideoProcessor, Pointer<DXVAHD_BLT_STATE_PRIVATE_DATA> pData);
...
typedef PDXVAHDSW_GetVideoProcessorFilterRange = Int32 Function(
    IntPtr hDevice, Int32 Filter, Pointer<DXVAHD_FILTER_RANGE_DATA> pRange);
...
typedef PDXVAHDSW_GetVideoProcessorOutputFormats = Int32 Function(
    ...
    Uint32 Count,
    Pointer<Uint32> pFormats);
typedef PDXVAHDSW_Plugin = Int32 Function(Uint32 Size, Pointer pCallbacks);
typedef PDXVAHDSW_ProposeVideoPrivateFormat = Int32 Function(
    IntPtr hDevice, Pointer<Uint32> pFormat);
typedef PDXVAHDSW_SetVideoProcessBltState = Int32 Function(
    IntPtr hVideoProcessor, Int32 State, Uint32 DataSize, Pointer pData);
