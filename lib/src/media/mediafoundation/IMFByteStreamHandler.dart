...
class IMFByteStreamHandler extends IUnknown {
  ...
  int EndCreateObject(Pointer<COMObject> pResult, Pointer<Int32> pObjectType,
  ...
  int GetMaxNumberOfBytesRequiredForResolution(Pointer<Uint64> pqwBytes) =>
      ptr.ref.lpVtbl.value
              .elementAt(6)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Uint64> pqwBytes)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Uint64> pqwBytes)>()(
          ptr.ref.lpVtbl, pqwBytes);
}
