...
class IMFMediaSourcePresentationProvider extends IUnknown {
  ...
  int ForceEndOfPresentation(Pointer<COMObject> pPresentationDescriptor) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<COMObject> pPresentationDescriptor)>()(
          ptr.ref.lpVtbl, pPresentationDescriptor);
}
