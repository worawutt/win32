...
class IMFSinkWriterCallback2 extends IMFSinkWriterCallback {
  ...
  int OnStreamError(int dwStreamIndex, int hrStatus) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Uint32 dwStreamIndex, Int32 hrStatus)>>>()
          .value
          .asFunction<int Function(Pointer, int dwStreamIndex, int hrStatus)>()(
      ptr.ref.lpVtbl, dwStreamIndex, hrStatus);
}
