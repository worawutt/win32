...
class IMFDXGIDeviceManagerSource extends IUnknown {
  ...
  int GetManager(Pointer<Pointer<COMObject>> ppManager) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> ppManager)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> ppManager)>()(
      ptr.ref.lpVtbl, ppManager);
}
