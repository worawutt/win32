          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(
                          ...
                          Pointer<COMObject> contentDecryptionModuleProperties,
                          Pointer<Pointer<COMObject>>
                              contentDecryptionModule)>()(ptr.ref.lpVtbl,
              contentDecryptionModuleProperties, contentDecryptionModule);

  int GetConfiguration(Pointer<Pointer<COMObject>> configuration) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> configuration)>()(
          ptr.ref.lpVtbl, configuration);

  int GetKeySystem(Pointer<Pointer<Utf16>> keySystem) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
