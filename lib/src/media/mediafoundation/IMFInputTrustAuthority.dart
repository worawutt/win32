...
class IMFInputTrustAuthority extends IUnknown {
  ...
  int GetDecrypter(Pointer<GUID> riid, Pointer<Pointer> ppv) => ptr
      .ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
  ...
  int RequestAccess(
          int Action, Pointer<Pointer<COMObject>> ppContentEnablerActivate) =>
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int Action,
                      Pointer<Pointer<COMObject>> ppContentEnablerActivate)>()(
          ptr.ref.lpVtbl, Action, ppContentEnablerActivate);

  int GetPolicy(int Action, Pointer<Pointer<COMObject>> ppPolicy) => ptr
          .ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 Action,
                          Pointer<Pointer<COMObject>> ppPolicy)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer, int Action, Pointer<Pointer<COMObject>> ppPolicy)>()(
      ptr.ref.lpVtbl, Action, ppPolicy);

  int BindAccess(Pointer<MFINPUTTRUSTAUTHORITY_ACCESS_PARAMS> pParam) => ptr
      .ref.lpVtbl.value
      .elementAt(6)
      .cast<
          Pointer<
      ...
      .asFunction<
          int Function(
              ...
              Pointer<MFINPUTTRUSTAUTHORITY_ACCESS_PARAMS>
                  pParam)>()(ptr.ref.lpVtbl, pParam);

  int UpdateAccess(Pointer<MFINPUTTRUSTAUTHORITY_ACCESS_PARAMS> pParam) => ptr
      .ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<
