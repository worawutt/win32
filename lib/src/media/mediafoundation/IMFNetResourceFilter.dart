...
class IMFNetResourceFilter extends IUnknown {
  ...
  int OnRedirect(Pointer<Utf16> pszUrl, Pointer<Int16> pvbCancel) => ptr
      .ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
      ...
      .asFunction<
          int Function(Pointer, Pointer<Utf16> pszUrl,
              Pointer<Int16> pvbCancel)>()(ptr.ref.lpVtbl, pszUrl, pvbCancel);

  int OnSendingRequest(Pointer<Utf16> pszUrl) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
