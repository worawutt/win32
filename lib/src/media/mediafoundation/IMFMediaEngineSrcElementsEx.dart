...
class IMFMediaEngineSrcElementsEx extends IMFMediaEngineSrcElements {
  ...
  int AddElementEx(Pointer<Utf16> pURL, Pointer<Utf16> pType,
          Pointer<Utf16> pMedia, Pointer<Utf16> keySystem) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> pMedia,
                      Pointer<Utf16> keySystem)>()(
          ptr.ref.lpVtbl, pURL, pType, pMedia, keySystem);

  int GetKeySystem(int index, Pointer<Pointer<Utf16>> pType) => ptr
      .ref.lpVtbl.value
      .elementAt(10)
      .cast<
          Pointer<
