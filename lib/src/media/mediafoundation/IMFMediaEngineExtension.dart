...
class IMFMediaEngineExtension extends IUnknown {
  ...
  int CanPlayType(
          int AudioOnly, Pointer<Utf16> MimeType, Pointer<Int32> pAnswer) =>
      ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 AudioOnly,
                          Pointer<Utf16> MimeType, Pointer<Int32> pAnswer)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer,
                  ...
                  Pointer<Int32>
                      pAnswer)>()(ptr.ref.lpVtbl, AudioOnly, MimeType, pAnswer);
  ...
  int CancelObjectCreation(Pointer<COMObject> pIUnknownCancelCookie) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<COMObject> pIUnknownCancelCookie)>()(
          ptr.ref.lpVtbl, pIUnknownCancelCookie);

  int EndCreateObject(
          Pointer<COMObject> pResult, Pointer<Pointer<COMObject>> ppObject) =>
      ptr.ref.lpVtbl.value
              .elementAt(6)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pResult,
                      Pointer<Pointer<COMObject>> ppObject)>()(
          ptr.ref.lpVtbl, pResult, ppObject);
}
