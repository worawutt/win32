...
class IMFExtendedDRMTypeSupport extends IUnknown {
  ...
  int IsTypeSupportedEx(Pointer<Utf16> type, Pointer<Utf16> keySystem,
              ...
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> type,
                          Pointer<Utf16> keySystem, Pointer<Int32> pAnswer)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer,
                  ...
                  Pointer<Int32>
                      pAnswer)>()(ptr.ref.lpVtbl, type, keySystem, pAnswer);
}
