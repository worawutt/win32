...
class IMFTrustedInput extends IUnknown {
  ...
  int GetInputTrustAuthority(int dwStreamID, Pointer<GUID> riid,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int dwStreamID, Pointer<GUID> riid,
                      Pointer<Pointer<COMObject>> ppunkObject)>()(
          ptr.ref.lpVtbl, dwStreamID, riid, ppunkObject);
}
