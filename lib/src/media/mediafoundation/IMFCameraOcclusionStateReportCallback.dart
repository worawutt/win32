...
class IMFCameraOcclusionStateReportCallback extends IUnknown {
  ...
  int OnOcclusionStateReport(Pointer<COMObject> occlusionStateReport) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<COMObject> occlusionStateReport)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> occlusionStateReport)>()(
      ptr.ref.lpVtbl, occlusionStateReport);
}
