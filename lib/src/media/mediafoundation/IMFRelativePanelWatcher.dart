...
class IMFRelativePanelWatcher extends IMFShutdown {
  ...
  int BeginGetReport(Pointer<COMObject> pCallback, Pointer<COMObject> pState) =>
  ...
  int EndGetReport(Pointer<COMObject> pResult,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pResult,
                      Pointer<Pointer<COMObject>> ppRelativePanelReport)>()(
          ptr.ref.lpVtbl, pResult, ppRelativePanelReport);

  int GetReport(Pointer<Pointer<COMObject>> ppRelativePanelReport) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer,
                      Pointer<Pointer<COMObject>> ppRelativePanelReport)>()(
          ptr.ref.lpVtbl, ppRelativePanelReport);
}
