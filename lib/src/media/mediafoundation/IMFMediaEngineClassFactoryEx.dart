...
class IMFMediaEngineClassFactoryEx extends IMFMediaEngineClassFactory {
  ...
  int CreateMediaSourceExtension(int dwFlags, Pointer<COMObject> pAttr,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int dwFlags, Pointer<COMObject> pAttr,
                      Pointer<Pointer<COMObject>> ppMSE)>()(
          ptr.ref.lpVtbl, dwFlags, pAttr, ppMSE);

  int CreateMediaKeys(Pointer<Utf16> keySystem, Pointer<Utf16> cdmStorePath,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> cdmStorePath,
                      Pointer<Pointer<COMObject>> ppKeys)>()(
          ptr.ref.lpVtbl, keySystem, cdmStorePath, ppKeys);

  int IsTypeSupported(Pointer<Utf16> type, Pointer<Utf16> keySystem,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> type,
                      Pointer<Utf16> keySystem, Pointer<Int32> isSupported)>()(
          ptr.ref.lpVtbl, type, keySystem, isSupported);
}
