...
class IMFByteStreamBuffering extends IUnknown {
  ...
  int SetBufferingParams(Pointer<MFBYTESTREAM_BUFFERING_PARAMS> pParams) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<MFBYTESTREAM_BUFFERING_PARAMS> pParams)>()(
      ptr.ref.lpVtbl, pParams);

  int EnableBuffering(int fEnable) => ptr.ref.lpVtbl.value
      .elementAt(4)
