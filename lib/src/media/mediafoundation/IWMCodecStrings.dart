...
class IWMCodecStrings extends IUnknown {
  ...
  int GetName(Pointer<DMO_MEDIA_TYPE> pmt, int cchLength, Pointer<Utf16> szName,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> szName,
                      Pointer<Uint32> pcchLength)>()(
          ptr.ref.lpVtbl, pmt, cchLength, szName, pcchLength);

  int GetDescription(Pointer<DMO_MEDIA_TYPE> pmt, int cchLength,
          Pointer<Utf16> szDescription, Pointer<Uint32> pcchLength) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> szDescription,
                      Pointer<Uint32> pcchLength)>()(
          ptr.ref.lpVtbl, pmt, cchLength, szDescription, pcchLength);
}
