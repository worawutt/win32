...
class IMFSourceResolver extends IUnknown {
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Int32> pObjectType,
                      Pointer<Pointer<COMObject>> ppObject)>()(
          ptr.ref.lpVtbl, pwszURL, dwFlags, pProps, pObjectType, ppObject);
  ...
  int CreateObjectFromByteStream(
      ...
      ptr.ref.lpVtbl.value
          ...
          pByteStream, pwszURL, dwFlags, pProps, pObjectType, ppObject);
  ...
  int EndCreateObjectFromURL(Pointer<COMObject> pResult,
          Pointer<Int32> pObjectType, Pointer<Pointer<COMObject>> ppObject) =>
      ptr.ref.lpVtbl.value
              .elementAt(6)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Int32> pObjectType,
                      Pointer<Pointer<COMObject>> ppObject)>()(
          ptr.ref.lpVtbl, pResult, pObjectType, ppObject);
  ...
  int EndCreateObjectFromByteStream(Pointer<COMObject> pResult,
          Pointer<Int32> pObjectType, Pointer<Pointer<COMObject>> ppObject) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
