...
class IMFSensorTransformFactory extends IUnknown {
  ...
  int GetFactoryAttributes(Pointer<Pointer<COMObject>> ppAttributes) =>
  ...
  int InitializeFactory(int dwMaxTransformCount,
          Pointer<COMObject> pSensorDevices, Pointer<COMObject> pAttributes) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pSensorDevices,
                      Pointer<COMObject> pAttributes)>()(
          ptr.ref.lpVtbl, dwMaxTransformCount, pSensorDevices, pAttributes);

  int GetTransformCount(Pointer<Uint32> pdwCount) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pAttributes,
                      Pointer<Pointer<COMObject>> ppDeviceMFT)>()(
          ptr.ref.lpVtbl, guidSensorTransformID, pAttributes, ppDeviceMFT);
}
