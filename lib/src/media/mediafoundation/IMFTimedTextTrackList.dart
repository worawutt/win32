...
class IMFTimedTextTrackList extends IUnknown {
  ...
  int GetTrack(int index, Pointer<Pointer<COMObject>> track) => ptr
          .ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, int index, Pointer<Pointer<COMObject>> track)>()(
      ptr.ref.lpVtbl, index, track);

  int GetTrackById(int trackId, Pointer<Pointer<COMObject>> track) => ptr
          .ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Uint32 trackId,
                          Pointer<Pointer<COMObject>> track)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer, int trackId, Pointer<Pointer<COMObject>> track)>()(
      ptr.ref.lpVtbl, trackId, track);
}
