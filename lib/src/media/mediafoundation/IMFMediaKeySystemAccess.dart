...
class IMFMediaKeySystemAccess extends IUnknown {
  ...
  int CreateMediaKeys(Pointer<COMObject> pCdmCustomConfig,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pCdmCustomConfig,
                      Pointer<Pointer<COMObject>> ppKeys)>()(
          ptr.ref.lpVtbl, pCdmCustomConfig, ppKeys);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<Utf16>> pKeySystem)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<Utf16>> pKeySystem)>()(
          ptr.ref.lpVtbl, retValuePtr);
