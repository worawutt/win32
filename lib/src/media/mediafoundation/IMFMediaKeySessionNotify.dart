...
class IMFMediaKeySessionNotify extends IUnknown {
  ...
  void KeyMessage(
          Pointer<Utf16> destinationURL, Pointer<Uint8> message, int cb) =>
      ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Void Function(Pointer, Pointer<Utf16> destinationURL,
                          Pointer<Uint8> message, Uint32 cb)>>>()
          .value
          .asFunction<
              void Function(
                  Pointer,
                  ...
                  int cb)>()(ptr.ref.lpVtbl, destinationURL, message, cb);
  ...
  void KeyError(int code, int systemCode) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
                      NativeFunction<
                          Void Function(
                              Pointer, Uint16 code, Uint32 systemCode)>>>()
              .value
              .asFunction<void Function(Pointer, int code, int systemCode)>()(
          ptr.ref.lpVtbl, code, systemCode);
}
