...
class IWMSampleExtensionSupport extends IUnknown {
  ...
  int SetUseSampleExtensions(int fUseExtensions) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Int32 fUseExtensions)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int fUseExtensions)>()(ptr.ref.lpVtbl, fUseExtensions);
}
