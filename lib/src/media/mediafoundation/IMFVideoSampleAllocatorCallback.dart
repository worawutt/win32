...
class IMFVideoSampleAllocatorCallback extends IUnknown {
  ...
  int SetCallback(Pointer<COMObject> pNotify) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetFreeSampleCount(Pointer<Int32> plSamples) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> plSamples)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Int32> plSamples)>()(
      ptr.ref.lpVtbl, plSamples);
}
