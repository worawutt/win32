...
class ID3D12VideoDevice extends IUnknown {
  ...
  int CheckFeatureSupport(int FeatureVideo, Pointer pFeatureSupportData,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int FeatureVideo,
                      Pointer pFeatureSupportData,
                      int FeatureSupportDataSize)>()(ptr.ref.lpVtbl,
          FeatureVideo, pFeatureSupportData, FeatureSupportDataSize);

  int CreateVideoDecoder(Pointer<D3D12_VIDEO_DECODER_DESC> pDesc,
          Pointer<GUID> riid, Pointer<Pointer> ppVideoDecoder) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<D3D12_VIDEO_DECODER_DESC> pDesc,
                      Pointer<GUID> riid, Pointer<Pointer> ppVideoDecoder)>()(
          ptr.ref.lpVtbl, pDesc, riid, ppVideoDecoder);
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(
                          ...
                          Pointer<GUID> riid,
                          Pointer<Pointer> ppVideoDecoderHeap)>()(
              ptr.ref.lpVtbl, pVideoDecoderHeapDesc, riid, ppVideoDecoderHeap);
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<D3D12_VIDEO_PROCESS_INPUT_STREAM_DESC>
                      pInputStreamDescs,
                  Pointer<GUID> riid,
                  Pointer<Pointer> ppVideoProcessor)>()(ptr.ref.lpVtbl, NodeMask, pOutputStreamDesc, NumInputStreamDescs, pInputStreamDescs, riid, ppVideoProcessor);
}
