...
class IMFTimedTextFormattedText extends IUnknown {
  ...
  int GetText(Pointer<Pointer<Utf16>> text) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .value
          .asFunction<int Function(Pointer, Pointer<Pointer<Utf16>> text)>()(
      ptr.ref.lpVtbl, text);
  ...
  int GetSubformatting(int index, Pointer<Uint32> firstChar,
          Pointer<Uint32> charLength, Pointer<Pointer<COMObject>> style) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint32> charLength,
                      Pointer<Pointer<COMObject>> style)>()(
          ptr.ref.lpVtbl, index, firstChar, charLength, style);
}
