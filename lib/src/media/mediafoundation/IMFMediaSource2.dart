...
class IMFMediaSource2 extends IMFMediaSourceEx {
  ...
  int SetMediaType(int dwStreamID, Pointer<COMObject> pMediaType) => ptr
          .ref.lpVtbl.value
          .elementAt(16)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, int dwStreamID, Pointer<COMObject> pMediaType)>()(
      ptr.ref.lpVtbl, dwStreamID, pMediaType);
}
