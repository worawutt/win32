...
class IMFWorkQueueServicesEx extends IMFWorkQueueServices {
  ...
  int GetTopologyWorkQueueMMCSSPriority(
          int dwTopologyWorkQueueId, Pointer<Int32> plPriority) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int dwTopologyWorkQueueId,
                      Pointer<Int32> plPriority)>()(
          ptr.ref.lpVtbl, dwTopologyWorkQueueId, plPriority);
  ...
  int GetPlatformWorkQueueMMCSSPriority(
          int dwPlatformWorkQueueId, Pointer<Int32> plPriority) =>
      ptr.ref.lpVtbl.value
              .elementAt(17)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, int dwPlatformWorkQueueId,
                      Pointer<Int32> plPriority)>()(
          ptr.ref.lpVtbl, dwPlatformWorkQueueId, plPriority);
}
