...
class IMFSampleAllocatorControl extends IUnknown {
  ...
  int SetDefaultAllocator(
          int dwOutputStreamID, Pointer<COMObject> pAllocator) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int dwOutputStreamID,
                      Pointer<COMObject> pAllocator)>()(
          ptr.ref.lpVtbl, dwOutputStreamID, pAllocator);

  int GetAllocatorUsage(int dwOutputStreamID, Pointer<Uint32> pdwInputStreamID,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint32> pdwInputStreamID,
                      Pointer<Int32> peUsage)>()(
          ptr.ref.lpVtbl, dwOutputStreamID, pdwInputStreamID, peUsage);
}
