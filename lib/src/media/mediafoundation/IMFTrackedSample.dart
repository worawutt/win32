...
class IMFTrackedSample extends IUnknown {
  ...
  int SetAllocator(
          Pointer<COMObject> pSampleAllocator, Pointer<COMObject> pUnkState) =>
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pSampleAllocator,
                      Pointer<COMObject> pUnkState)>()(
          ptr.ref.lpVtbl, pSampleAllocator, pUnkState);
}
