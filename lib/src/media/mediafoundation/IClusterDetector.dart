...
class IClusterDetector extends IUnknown {
  ...
  int Initialize(int wBaseEntryLevel, int wClusterEntryLevel) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint16 wBaseEntryLevel,
                              Uint16 wClusterEntryLevel)>>>()
              .value
              .asFunction<
                  int Function(
                      Pointer, int wBaseEntryLevel, int wClusterEntryLevel)>()(
          ptr.ref.lpVtbl, wBaseEntryLevel, wClusterEntryLevel);
