...
class IMFMediaStream extends IMFMediaEventGenerator {
  ...
  int GetStreamDescriptor(Pointer<Pointer<COMObject>> ppStreamDescriptor) => ptr
          .ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<COMObject>> ppStreamDescriptor)>()(
      ptr.ref.lpVtbl, ppStreamDescriptor);

  int RequestSample(Pointer<COMObject> pToken) => ptr.ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
