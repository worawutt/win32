...
class IMFSecureBuffer extends IUnknown {
  ...
  int GetIdentifier(Pointer<GUID> pGuidIdentifier) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<GUID> pGuidIdentifier)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<GUID> pGuidIdentifier)>()(
          ptr.ref.lpVtbl, pGuidIdentifier);
}
