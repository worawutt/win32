...
class IMFStreamDescriptor extends IMFAttributes {
  ...
  int GetStreamIdentifier(Pointer<Uint32> pdwStreamIdentifier) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Uint32> pdwStreamIdentifier)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> pdwStreamIdentifier)>()(
          ptr.ref.lpVtbl, pdwStreamIdentifier);

  int GetMediaTypeHandler(Pointer<Pointer<COMObject>> ppMediaTypeHandler) => ptr
          .ref.lpVtbl.value
          .elementAt(34)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<COMObject>> ppMediaTypeHandler)>()(
      ptr.ref.lpVtbl, ppMediaTypeHandler);
}
