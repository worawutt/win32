...
class ID3D12VideoEncoderHeap extends ID3D12Pageable {
  ...
  int GetCodecProfile(D3D12_VIDEO_ENCODER_PROFILE_DESC dstProfile) => ptr
          .ref.lpVtbl.value
          .elementAt(11)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, D3D12_VIDEO_ENCODER_PROFILE_DESC dstProfile)>()(
      ptr.ref.lpVtbl, dstProfile);

  int GetCodecLevel(D3D12_VIDEO_ENCODER_LEVEL_SETTING dstLevel) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, D3D12_VIDEO_ENCODER_LEVEL_SETTING dstLevel)>()(
          ptr.ref.lpVtbl, dstLevel);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<D3D12_VIDEO_ENCODER_PICTURE_RESOLUTION_DESC>
                          pResolutionList)>()(
          ptr.ref.lpVtbl, ResolutionsListCount, pResolutionList);
}
