...
class IMFContentDecryptionModuleSessionCallbacks extends IUnknown {
  ...
  int KeyMessage(int messageType, Pointer<Uint8> message, int messageSize,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int messageType, Pointer<Uint8> message,
                      int messageSize, Pointer<Utf16> destinationURL)>()(
          ptr.ref.lpVtbl, messageType, message, messageSize, destinationURL);
