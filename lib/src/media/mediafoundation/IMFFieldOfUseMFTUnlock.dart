...
class IMFFieldOfUseMFTUnlock extends IUnknown {
  ...
  int Unlock(Pointer<COMObject> pUnkMFT) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pUnkMFT)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> pUnkMFT)>()(
      ptr.ref.lpVtbl, pUnkMFT);
}
