...
class IMFOutputPolicy extends IMFAttributes {
  ...
  int GetMinimumGRLVersion(Pointer<Uint32> pdwMinimumGRLVersion) => ptr
          .ref.lpVtbl.value
          .elementAt(35)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Uint32> pdwMinimumGRLVersion)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Uint32> pdwMinimumGRLVersion)>()(
      ptr.ref.lpVtbl, pdwMinimumGRLVersion);
}
