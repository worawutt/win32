...
class IMFSinkWriterEncoderConfig extends IUnknown {
  ...
  int SetTargetMediaType(int dwStreamIndex, Pointer<COMObject> pTargetMediaType,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pTargetMediaType,
                      Pointer<COMObject> pEncodingParameters)>()(
          ptr.ref.lpVtbl, dwStreamIndex, pTargetMediaType, pEncodingParameters);

  int PlaceEncodingParameters(
          int dwStreamIndex, Pointer<COMObject> pEncodingParameters) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, int dwStreamIndex,
                      Pointer<COMObject> pEncodingParameters)>()(
          ptr.ref.lpVtbl, dwStreamIndex, pEncodingParameters);
}
