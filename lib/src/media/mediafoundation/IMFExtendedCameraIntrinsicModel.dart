...
class IMFExtendedCameraIntrinsicModel extends IUnknown {
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer,
                          Pointer<MFExtendedCameraIntrinsic_IntrinsicModel>
                              pIntrinsicModel)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer,
                  Pointer<MFExtendedCameraIntrinsic_IntrinsicModel>
                      pIntrinsicModel)>()(ptr.ref.lpVtbl, pIntrinsicModel);
  ...
  int GetDistortionModelType(Pointer<Int32> pDistortionModelType) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Int32> pDistortionModelType)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> pDistortionModelType)>()(
          ptr.ref.lpVtbl, pDistortionModelType);
}
