...
class IMFNetProxyLocatorFactory extends IUnknown {
  ...
  int CreateProxyLocator(Pointer<Utf16> pszProtocol,
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> pszProtocol,
                              Pointer<Pointer<COMObject>> ppProxyLocator)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> pszProtocol,
                      Pointer<Pointer<COMObject>> ppProxyLocator)>()(
          ptr.ref.lpVtbl, pszProtocol, ppProxyLocator);
}
