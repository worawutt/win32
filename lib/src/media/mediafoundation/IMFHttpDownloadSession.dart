...
class IMFHttpDownloadSession extends IUnknown {
  ...
  int SetServer(Pointer<Utf16> szServerName, int nPort) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Pointer<Utf16> szServerName, Uint32 nPort)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<Utf16> szServerName,
              int nPort)>()(ptr.ref.lpVtbl, szServerName, nPort);
