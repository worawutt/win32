...
class ID3D12VideoDevice3 extends ID3D12VideoDevice2 {
  ...
  int CreateVideoEncoder(Pointer<D3D12_VIDEO_ENCODER_DESC> pDesc,
          Pointer<GUID> riid, Pointer<Pointer> ppVideoEncoder) =>
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<D3D12_VIDEO_ENCODER_DESC> pDesc,
                      Pointer<GUID> riid, Pointer<Pointer> ppVideoEncoder)>()(
          ptr.ref.lpVtbl, pDesc, riid, ppVideoEncoder);

  int CreateVideoEncoderHeap(Pointer<D3D12_VIDEO_ENCODER_HEAP_DESC> pDesc,
          Pointer<GUID> riid, Pointer<Pointer> ppVideoEncoderHeap) =>
      ptr.ref.lpVtbl.value
              .elementAt(15)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> riid,
                      Pointer<Pointer> ppVideoEncoderHeap)>()(
          ptr.ref.lpVtbl, pDesc, riid, ppVideoEncoderHeap);
}
