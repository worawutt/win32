...
class IMFImageSharingEngineClassFactory extends IUnknown {
  ...
  int CreateInstanceFromUDN(Pointer<Utf16> pUniqueDeviceName,
      ...
      ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> pUniqueDeviceName,
                          Pointer<Pointer<COMObject>> ppEngine)>>>()
          .value
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<COMObject>>
                      ppEngine)>()(ptr.ref.lpVtbl, pUniqueDeviceName, ppEngine);
}
