...
class ID3D12VideoProcessor extends ID3D12Pageable {
  ...
  int GetInputStreamDescs(int NumInputStreamDescs,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<D3D12_VIDEO_PROCESS_INPUT_STREAM_DESC>
                          pInputStreamDescs)>()(
          ptr.ref.lpVtbl, NumInputStreamDescs, pInputStreamDescs);

  D3D12_VIDEO_PROCESS_OUTPUT_STREAM_DESC GetOutputStreamDesc() => ptr
      .ref.lpVtbl.value
      .elementAt(11)
      .cast<
          Pointer<
              NativeFunction<
                  D3D12_VIDEO_PROCESS_OUTPUT_STREAM_DESC Function(Pointer)>>>()
      .value
      .asFunction<
          D3D12_VIDEO_PROCESS_OUTPUT_STREAM_DESC Function(
              Pointer)>()(ptr.ref.lpVtbl);
}
