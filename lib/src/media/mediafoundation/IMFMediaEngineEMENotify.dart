...
class IMFMediaEngineEMENotify extends IUnknown {
  ...
  void Encrypted(
          Pointer<Uint8> pbInitData, int cb, Pointer<Utf16> bstrInitDataType) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Void Function(Pointer, Pointer<Uint8> pbInitData,
                              Uint32 cb, Pointer<Utf16> bstrInitDataType)>>>()
              .value
              .asFunction<
                  void Function(Pointer, Pointer<Uint8> pbInitData, int cb,
                      Pointer<Utf16> bstrInitDataType)>()(
          ptr.ref.lpVtbl, pbInitData, cb, bstrInitDataType);
