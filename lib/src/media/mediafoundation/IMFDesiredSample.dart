...
class IMFDesiredSample extends IUnknown {
  ...
  int GetDesiredSampleTimeAndDuration(
          Pointer<Int64> phnsSampleTime, Pointer<Int64> phnsSampleDuration) =>
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int64> phnsSampleTime,
                      Pointer<Int64> phnsSampleDuration)>()(
          ptr.ref.lpVtbl, phnsSampleTime, phnsSampleDuration);

  void SetDesiredSampleTimeAndDuration(
          int hnsSampleTime, int hnsSampleDuration) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
                      NativeFunction<
                          Void Function(Pointer, Int64 hnsSampleTime,
                              Int64 hnsSampleDuration)>>>()
              .value
              .asFunction<
                  void Function(
                      Pointer, int hnsSampleTime, int hnsSampleDuration)>()(
          ptr.ref.lpVtbl, hnsSampleTime, hnsSampleDuration);
