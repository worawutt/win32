...
class IMFExtendedCameraController extends IUnknown {
  ...
  int GetExtendedCameraControl(int dwStreamIndex, int ulPropertyId,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int dwStreamIndex, int ulPropertyId,
                      Pointer<Pointer<COMObject>> ppControl)>()(
          ptr.ref.lpVtbl, dwStreamIndex, ulPropertyId, ppControl);
}
