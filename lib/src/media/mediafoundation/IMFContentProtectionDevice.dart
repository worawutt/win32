...
class IMFContentProtectionDevice extends IUnknown {
  ...
  int GetPrivateDataByteCount(Pointer<Uint32> PrivateInputByteCount,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> PrivateInputByteCount,
                      Pointer<Uint32> PrivateOutputByteCount)>()(
          ptr.ref.lpVtbl, PrivateInputByteCount, PrivateOutputByteCount);
}
