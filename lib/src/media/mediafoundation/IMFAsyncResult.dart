...
class IMFAsyncResult extends IUnknown {
  ...
  int GetState(Pointer<Pointer<COMObject>> ppunkState) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> ppunkState)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> ppunkState)>()(
      ptr.ref.lpVtbl, ppunkState);
  ...
  int SetStatus(int hrStatus) => ptr.ref.lpVtbl.value
      .elementAt(5)
