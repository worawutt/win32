...
class IMFLocalMFTRegistration extends IUnknown {
  ...
  int RegisterMFTs(Pointer<MFT_REGISTRATION_INFO> pMFTs, int cMFTs) =>
      ptr.ref.lpVtbl.value
          ...
          .value
          .asFunction<
              int Function(Pointer, Pointer<MFT_REGISTRATION_INFO> pMFTs,
                  int cMFTs)>()(ptr.ref.lpVtbl, pMFTs, cMFTs);
}
