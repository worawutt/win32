...
class IDirectXVideoProcessorService extends IDirectXVideoAccelerationService {
  ...
  int RegisterVideoProcessorSoftwareDevice(Pointer pCallbacks) => ptr
      .ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer pCallbacks)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, Pointer pCallbacks)>()(ptr.ref.lpVtbl, pCallbacks);

  int GetVideoProcessorDeviceGuids(Pointer<DXVA2_VideoDesc> pVideoDesc,
          Pointer<Uint32> pCount, Pointer<Pointer<GUID>> pGuids) =>
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<DXVA2_VideoDesc> pVideoDesc,
                      Pointer<Uint32> pCount, Pointer<Pointer<GUID>> pGuids)>()(
          ptr.ref.lpVtbl, pVideoDesc, pCount, pGuids);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint32> pCount,
                      Pointer<Pointer<Uint32>> pFormats)>()(
          ptr.ref.lpVtbl, VideoProcDeviceGuid, pVideoDesc, pCount, pFormats);
