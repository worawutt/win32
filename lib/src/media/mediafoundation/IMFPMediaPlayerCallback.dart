...
class IMFPMediaPlayerCallback extends IUnknown {
  ...
  void OnMediaPlayerEvent(Pointer<MFP_EVENT_HEADER> pEventHeader) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Void Function(
                          Pointer, Pointer<MFP_EVENT_HEADER> pEventHeader)>>>()
          .value
          .asFunction<
              void Function(Pointer, Pointer<MFP_EVENT_HEADER> pEventHeader)>()(
      ptr.ref.lpVtbl, pEventHeader);
}
