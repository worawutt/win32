...
class IMFCaptureSink extends IUnknown {
  ...
  int GetOutputMediaType(
          int dwSinkStreamIndex, Pointer<Pointer<COMObject>> ppMediaType) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint32 dwSinkStreamIndex,
                              Pointer<Pointer<COMObject>> ppMediaType)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int dwSinkStreamIndex,
                      Pointer<Pointer<COMObject>> ppMediaType)>()(
          ptr.ref.lpVtbl, dwSinkStreamIndex, ppMediaType);

  int GetService(int dwSinkStreamIndex, Pointer<GUID> rguidService,
          Pointer<GUID> riid, Pointer<Pointer<COMObject>> ppUnknown) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> riid,
                      Pointer<Pointer<COMObject>> ppUnknown)>()(
          ptr.ref.lpVtbl, dwSinkStreamIndex, rguidService, riid, ppUnknown);

  int AddStream(int dwSourceStreamIndex, Pointer<COMObject> pMediaType,
          Pointer<COMObject> pAttributes, Pointer<Uint32> pdwSinkStreamIndex) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pMediaType,
                      Pointer<COMObject> pAttributes,
                      Pointer<Uint32> pdwSinkStreamIndex)>()(ptr.ref.lpVtbl,
          dwSourceStreamIndex, pMediaType, pAttributes, pdwSinkStreamIndex);
