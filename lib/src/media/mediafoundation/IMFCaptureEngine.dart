...
class IMFCaptureEngine extends IUnknown {
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pAttributes,
                      Pointer<COMObject> pAudioSource,
                      Pointer<COMObject> pVideoSource)>()(ptr.ref.lpVtbl,
          pEventCallback, pAttributes, pAudioSource, pVideoSource);
  ...
  int StopRecord(int bFinalize, int bFlushUnprocessedSamples) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 bFinalize,
                              Int32 bFlushUnprocessedSamples)>>>()
              .value
              .asFunction<
                  int Function(
                      Pointer, int bFinalize, int bFlushUnprocessedSamples)>()(
          ptr.ref.lpVtbl, bFinalize, bFlushUnprocessedSamples);
  ...
  int GetSink(
          int mfCaptureEngineSinkType, Pointer<Pointer<COMObject>> ppSink) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 mfCaptureEngineSinkType,
                              Pointer<Pointer<COMObject>> ppSink)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int mfCaptureEngineSinkType,
                      Pointer<Pointer<COMObject>> ppSink)>()(
          ptr.ref.lpVtbl, mfCaptureEngineSinkType, ppSink);

  int GetSource(Pointer<Pointer<COMObject>> ppSource) => ptr.ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
                  NativeFunction<
