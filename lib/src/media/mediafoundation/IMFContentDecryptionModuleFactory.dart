...
class IMFContentDecryptionModuleFactory extends IUnknown {
  ...
  int IsTypeSupported(Pointer<Utf16> keySystem, Pointer<Utf16> contentType) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> keySystem,
                              Pointer<Utf16> contentType)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> keySystem,
                      Pointer<Utf16> contentType)>()(
          ptr.ref.lpVtbl, keySystem, contentType);
