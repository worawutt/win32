...
class IMFMediaKeySessionNotify2 extends IMFMediaKeySessionNotify {
  ...
  void KeyMessage2(int eMessageType, Pointer<Utf16> destinationURL,
          Pointer<Uint8> pbMessage, int cbMessage) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  void Function(
                      ...
                      Pointer<Uint8> pbMessage,
                      int cbMessage)>()(
          ptr.ref.lpVtbl, eMessageType, destinationURL, pbMessage, cbMessage);
