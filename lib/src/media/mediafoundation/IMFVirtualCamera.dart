...
class IMFVirtualCamera extends IMFAttributes {
  ...
  int AddDeviceSourceInfo(Pointer<Utf16> DeviceSourceInfo) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Utf16> DeviceSourceInfo)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> DeviceSourceInfo)>()(
          ptr.ref.lpVtbl, DeviceSourceInfo);

  int AddProperty(Pointer<DEVPROPKEY> pKey, int Type, Pointer<Uint8> pbData,
          int cbData) =>
      ptr.ref.lpVtbl.value
          .elementAt(34)
          .cast<
          ...
          .asFunction<
              int Function(
                  ...
                  int Type,
                  Pointer<Uint8> pbData,
                  int cbData)>()(ptr.ref.lpVtbl, pKey, Type, pbData, cbData);

  int AddRegistryEntry(Pointer<Utf16> EntryName, Pointer<Utf16> SubkeyPath,
          int dwRegType, Pointer<Uint8> pbData, int cbData) =>
      ptr.ref.lpVtbl.value
              .elementAt(35)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint8> pbData,
                      int cbData)>()(
          ptr.ref.lpVtbl, EntryName, SubkeyPath, dwRegType, pbData, cbData);

  int Start(Pointer<COMObject> pCallback) => ptr.ref.lpVtbl.value
          .elementAt(36)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetMediaSource(Pointer<Pointer<COMObject>> ppMediaSource) =>
      ptr.ref.lpVtbl.value
              .elementAt(39)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppMediaSource)>()(
          ptr.ref.lpVtbl, ppMediaSource);
  ...
  int CreateSyncEvent(Pointer<GUID> kseventSet, int kseventId, int kseventFlags,
          int eventHandle, Pointer<Pointer<COMObject>> cameraSyncObject) =>
      ptr.ref.lpVtbl.value
              .elementAt(41)
              .cast<
                  Pointer<
