...
class IPlayToControlWithCapabilities extends IPlayToControl {
  ...
  int GetCapabilities(Pointer<Int32> pCapabilities) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> pCapabilities)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Int32> pCapabilities)>()(
