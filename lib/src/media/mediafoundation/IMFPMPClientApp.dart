...
class IMFPMPClientApp extends IUnknown {
  ...
  int SetPMPHost(Pointer<COMObject> pPMPHost) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pPMPHost)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> pPMPHost)>()(
      ptr.ref.lpVtbl, pPMPHost);
}
