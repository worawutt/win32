...
class IMFVideoMediaType extends IMFMediaType {
  ...
  Pointer<MFVIDEOFORMAT> GetVideoFormat() => ptr.ref.lpVtbl.value
      .elementAt(38)
      .cast<Pointer<NativeFunction<Pointer<MFVIDEOFORMAT> Function(Pointer)>>>()
      .value
      .asFunction<Pointer<MFVIDEOFORMAT> Function(Pointer)>()(ptr.ref.lpVtbl);

  int GetVideoRepresentation(GUID guidRepresentation,
          Pointer<Pointer> ppvRepresentation, int lStride) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, GUID guidRepresentation,
                      Pointer<Pointer> ppvRepresentation, int lStride)>()(
          ptr.ref.lpVtbl, guidRepresentation, ppvRepresentation, lStride);
}
