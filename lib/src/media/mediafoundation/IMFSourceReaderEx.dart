...
class IMFSourceReaderEx extends IMFSourceReader {
  ...
  int SetNativeMediaType(int dwStreamIndex, Pointer<COMObject> pMediaType,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pMediaType,
                      Pointer<Uint32> pdwStreamFlags)>()(
          ptr.ref.lpVtbl, dwStreamIndex, pMediaType, pdwStreamFlags);

  int AddTransformForStream(
          int dwStreamIndex, Pointer<COMObject> pTransformOrActivate) =>
      ptr.ref.lpVtbl.value
              .elementAt(14)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, int dwStreamIndex,
                      Pointer<COMObject> pTransformOrActivate)>()(
          ptr.ref.lpVtbl, dwStreamIndex, pTransformOrActivate);

  int RemoveAllTransformsForStream(int dwStreamIndex) => ptr.ref.lpVtbl.value
      .elementAt(15)
      .cast<
          Pointer<
