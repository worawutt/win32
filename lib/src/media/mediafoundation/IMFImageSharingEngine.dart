...
class IMFImageSharingEngine extends IUnknown {
  ...
  int SetSource(Pointer<COMObject> pStream) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetDevice(Pointer<DEVICE_INFO> pDevice) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<DEVICE_INFO> pDevice)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<DEVICE_INFO> pDevice)>()(
