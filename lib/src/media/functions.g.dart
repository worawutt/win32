...
int timeKillEvent(int uTimerID) => _timeKillEvent(uTimerID);

late final _timeKillEvent = _winmm.lookupFunction<
    Uint32 Function(Uint32 uTimerID),
    int Function(int uTimerID)>('timeKillEvent');
...
int timeSetEvent(
        ...
        int dwUser,
        int fuEvent) =>
    _timeSetEvent(uDelay, uResolution, fptc, dwUser, fuEvent);
