...
class IMFDeviceTransformCallback extends IUnknown {
  ...
  int OnBufferSent(Pointer<COMObject> pCallbackAttributes, int pinId) =>
      ptr.ref.lpVtbl.value
          ...
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> pCallbackAttributes,
                  int pinId)>()(ptr.ref.lpVtbl, pCallbackAttributes, pinId);
}
