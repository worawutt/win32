...
class IPersistTuneXmlUtility2 extends IPersistTuneXmlUtility {
  ...
  int Serialize(
          Pointer<COMObject> piTuneRequest, Pointer<Pointer<Utf16>> pString) =>
      ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> piTuneRequest,
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<Utf16>>
                      pString)>()(ptr.ref.lpVtbl, piTuneRequest, pString);
}
