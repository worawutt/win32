...
class IATSC_EIT extends IUnknown {
  ...
  int GetSourceId(Pointer<Uint16> pwVal) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
  ...
  int GetRecordTitleText(int dwRecordIndex, Pointer<Uint32> pdwLength,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint32> pdwLength,
                      Pointer<Pointer<Uint8>> ppText)>()(
          ptr.ref.lpVtbl, dwRecordIndex, pdwLength, ppText);
