...
class IAudioStreamSample extends IStreamSample {
  ...
  int GetAudioData(Pointer<Pointer<COMObject>> ppAudio) => ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> ppAudio)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> ppAudio)>()(
      ptr.ref.lpVtbl, ppAudio);
}
