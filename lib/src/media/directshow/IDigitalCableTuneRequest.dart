...
class IDigitalCableTuneRequest extends IATSCChannelTuneRequest {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> pMajorChannel)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int32> pMajorChannel)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  set MajorChannel(int value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<Int32 Function(Pointer, Int32 MajorChannel)>>>()
        .value
        .asFunction<
            int Function(Pointer, int MajorChannel)>()(ptr.ref.lpVtbl, value);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> pSourceID)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> pSourceID)>()(
  ...
  set SourceID(int value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(19)
        .cast<
            Pointer<NativeFunction<Int32 Function(Pointer, Int32 SourceID)>>>()
        .value
        .asFunction<
            int Function(Pointer, int SourceID)>()(ptr.ref.lpVtbl, value);
