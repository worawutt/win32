...
class IMpeg2Data extends IUnknown {
  ...
  int GetSection(int pid, int tid, Pointer<MPEG2_FILTER> pFilter, int dwTimeout,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int dwTimeout,
                      Pointer<Pointer<COMObject>> ppSectionList)>()(
          ptr.ref.lpVtbl, pid, tid, pFilter, dwTimeout, ppSectionList);

  int GetTable(int pid, int tid, Pointer<MPEG2_FILTER> pFilter, int dwTimeout,
          Pointer<Pointer<COMObject>> ppSectionList) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
  ...
  int GetStreamOfSections(int pid, int tid, Pointer<MPEG2_FILTER> pFilter,
          int hDataReadyEvent, Pointer<Pointer<COMObject>> ppMpegStream) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      int hDataReadyEvent,
                      Pointer<Pointer<COMObject>> ppMpegStream)>()(
          ptr.ref.lpVtbl, pid, tid, pFilter, hDataReadyEvent, ppMpegStream);
}
