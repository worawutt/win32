...
class IDvbLinkageDescriptor extends IUnknown {
  ...
  int GetTSId(Pointer<Uint16> pwVal) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
  ...
  int GetONId(Pointer<Uint16> pwVal) => ptr.ref.lpVtbl.value
      .elementAt(6)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Uint16> pwVal)>>>()
  ...
  int GetLinkageType(Pointer<Uint8> pbVal) => ptr.ref.lpVtbl.value
      .elementAt(8)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Uint8> pbVal)>>>()
  ...
  int GetPrivateDataLength(Pointer<Uint8> pbVal) => ptr.ref.lpVtbl.value
      .elementAt(9)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Uint8> pbVal)>>>()
  ...
  int GetPrivateData(Pointer<Uint8> pbLen, Pointer<Uint8> pbData) => ptr
      .ref.lpVtbl.value
      .elementAt(10)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Pointer<Uint8> pbLen, Pointer<Uint8> pbData)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<Uint8> pbLen,
              Pointer<Uint8> pbData)>()(ptr.ref.lpVtbl, pbLen, pbData);
}
