...
class IBDA_EasMessage extends IUnknown {
  ...
  int get_EasMessage(int ulEventID, Pointer<Pointer<COMObject>> ppEASObject) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint32 ulEventID,
                              Pointer<Pointer<COMObject>> ppEASObject)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int ulEventID,
                      Pointer<Pointer<COMObject>> ppEASObject)>()(
          ptr.ref.lpVtbl, ulEventID, ppEASObject);
}
