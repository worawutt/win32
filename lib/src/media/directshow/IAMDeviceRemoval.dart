...
class IAMDeviceRemoval extends IUnknown {
  ...
  int DeviceInfo(Pointer<GUID> pclsidInterfaceClass,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<GUID> pclsidInterfaceClass,
                      Pointer<Pointer<Utf16>> pwszSymbolicLink)>()(
          ptr.ref.lpVtbl, pclsidInterfaceClass, pwszSymbolicLink);
