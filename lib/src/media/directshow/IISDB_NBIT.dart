...
class IISDB_NBIT extends IUnknown {
  ...
  int GetRecordInformationId(int dwRecordIndex, Pointer<Uint16> pwVal) => ptr
      .ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<
  ...
  int GetRecordInformationType(int dwRecordIndex, Pointer<Uint8> pbVal) => ptr
      .ref.lpVtbl.value
      .elementAt(8)
      .cast<
          Pointer<
  ...
  int GetRecordMessageSectionNumber(int dwRecordIndex, Pointer<Uint8> pbVal) =>
      ptr.ref.lpVtbl.value
              .elementAt(10)
              .cast<
                  Pointer<
  ...
  int GetRecordUserDefined(int dwRecordIndex, Pointer<Uint8> pbVal) => ptr
      .ref.lpVtbl.value
      .elementAt(11)
      .cast<
          Pointer<
  ...
  int GetRecordNumberOfKeys(int dwRecordIndex, Pointer<Uint8> pbVal) => ptr
      .ref.lpVtbl.value
      .elementAt(12)
      .cast<
          Pointer<
  ...
  int GetRecordKeys(int dwRecordIndex, Pointer<Pointer<Uint8>> pbKeys) =>
      ptr.ref.lpVtbl.value
              .elementAt(13)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, int dwRecordIndex,
                      Pointer<Pointer<Uint8>> pbKeys)>()(
          ptr.ref.lpVtbl, dwRecordIndex, pbKeys);
