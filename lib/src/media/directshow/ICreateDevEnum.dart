...
class ICreateDevEnum extends IUnknown {
  ...
  int CreateClassEnumerator(Pointer<GUID> clsidDeviceClass,
          Pointer<Pointer<COMObject>> ppEnumMoniker, int dwFlags) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppEnumMoniker,
                      int dwFlags)>()(
          ptr.ref.lpVtbl, clsidDeviceClass, ppEnumMoniker, dwFlags);
}
