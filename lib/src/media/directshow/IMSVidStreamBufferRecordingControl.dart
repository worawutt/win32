...
class IMSVidStreamBufferRecordingControl extends IDispatch {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> rtStart)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> rtStart)>()(
  ...
  set StartTime(int value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(8)
        .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 rtStart)>>>()
        .value
        .asFunction<
            int Function(Pointer, int rtStart)>()(ptr.ref.lpVtbl, value);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> rtStop)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> rtStop)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set StopTime(int value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(10)
        .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 rtStop)>>>()
        .value
        .asFunction<int Function(Pointer, int rtStop)>()(ptr.ref.lpVtbl, value);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int16> phResult)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int16> phResult)>()(
          ptr.ref.lpVtbl, retValuePtr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> dwType)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> dwType)>()(
          ptr.ref.lpVtbl, retValuePtr);
