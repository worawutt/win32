...
class IIsdbCADescriptor extends IUnknown {
  ...
  int GetReservedBits(Pointer<Uint8> pbVal) => ptr.ref.lpVtbl.value
      .elementAt(6)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Uint8> pbVal)>>>()
  ...
  int GetCAPID(Pointer<Uint16> pwVal) => ptr.ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Uint16> pwVal)>>>()
  ...
  int GetPrivateDataBytes(
          Pointer<Uint8> pbBufferLength, Pointer<Uint8> pbBuffer) =>
      ptr
              .ref.lpVtbl.value
              .elementAt(8)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Uint8> pbBufferLength,
                              Pointer<Uint8> pbBuffer)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint8> pbBufferLength,
                      Pointer<Uint8> pbBuffer)>()(
          ptr.ref.lpVtbl, pbBufferLength, pbBuffer);
}
