...
class IAMMultiMediaStream extends IMultiMediaStream {
  ...
  int
      Initialize(
              int StreamType, int dwFlags, Pointer<COMObject> pFilterGraph) =>
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, int StreamType, int dwFlags,
                          Pointer<COMObject> pFilterGraph)>()(
              ptr.ref.lpVtbl, StreamType, dwFlags, pFilterGraph);

  int GetFilterGraph(Pointer<Pointer<COMObject>> ppGraphBuilder) => ptr
          .ref.lpVtbl.value
          .elementAt(13)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<COMObject>> ppGraphBuilder)>()(
      ptr.ref.lpVtbl, ppGraphBuilder);

  int GetFilter(Pointer<Pointer<COMObject>> ppFilter) => ptr.ref.lpVtbl.value
          .elementAt(14)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int AddMediaStream(Pointer<COMObject> pStreamObject, Pointer<GUID> PurposeId,
          int dwFlags, Pointer<Pointer<COMObject>> ppNewStream) =>
      ptr.ref.lpVtbl.value
              .elementAt(15)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      int dwFlags,
                      Pointer<Pointer<COMObject>> ppNewStream)>()(
          ptr.ref.lpVtbl, pStreamObject, PurposeId, dwFlags, ppNewStream);

  int OpenFile(Pointer<Utf16> pszFileName, int dwFlags) => ptr.ref.lpVtbl.value
      .elementAt(16)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Pointer<Utf16> pszFileName, Uint32 dwFlags)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<Utf16> pszFileName,
              int dwFlags)>()(ptr.ref.lpVtbl, pszFileName, dwFlags);

  int OpenMoniker(
          Pointer<COMObject> pCtx, Pointer<COMObject> pMoniker, int dwFlags) =>
      ptr.ref.lpVtbl.value
          .elementAt(17)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pCtx,
                          Pointer<COMObject> pMoniker, Uint32 dwFlags)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer,
                  ...
                  int dwFlags)>()(ptr.ref.lpVtbl, pCtx, pMoniker, dwFlags);

  int Render(int dwFlags) => ptr.ref.lpVtbl.value
      .elementAt(18)
