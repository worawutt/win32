...
class IDVBTuningSpace extends ITuningSpace {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> SysType)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> SysType)>()(
  ...
  set SystemType(int value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(27)
        .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 SysType)>>>()
        .value
        .asFunction<
            int Function(Pointer, int SysType)>()(ptr.ref.lpVtbl, value);
