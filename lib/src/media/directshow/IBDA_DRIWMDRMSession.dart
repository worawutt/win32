...
class IBDA_DRIWMDRMSession extends IUnknown {
  ...
  int AcknowledgeLicense(int hrLicenseAck) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Int32 hrLicenseAck)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int hrLicenseAck)>()(ptr.ref.lpVtbl, hrLicenseAck);
  ...
  int SetRevInfo(int dwRevInfoLen, Pointer<Uint8> pbRevInfo,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int dwRevInfoLen,
                      Pointer<Uint8> pbRevInfo, Pointer<Uint32> pdwResponse)>()(
          ptr.ref.lpVtbl, dwRevInfoLen, pbRevInfo, pdwResponse);

  int SetCrl(
          int dwCrlLen, Pointer<Uint8> pbCrlLen, Pointer<Uint32> pdwResponse) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, int dwCrlLen, Pointer<Uint8> pbCrlLen,
                      Pointer<Uint32> pdwResponse)>()(
          ptr.ref.lpVtbl, dwCrlLen, pbCrlLen, pdwResponse);
  ...
  int GetLastCardeaError(Pointer<Uint32> pdwError) => ptr.ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Uint32> pdwError)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Uint32> pdwError)>()(
      ptr.ref.lpVtbl, pdwError);
}
