...
class IAtscContentAdvisoryDescriptor extends IUnknown {
  ...
  int GetRatingRegionCount(Pointer<Uint8> pbVal) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Uint8> pbVal)>>>()
  ...
  int GetRecordRatingRegion(int bIndex, Pointer<Uint8> pbVal) =>
  ...
  int GetRecordRatedDimensions(int bIndex, Pointer<Uint8> pbVal) => ptr
          .ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
  ...
  int GetRecordRatingDimension(
          int bIndexOuter, int bIndexInner, Pointer<Uint8> pbVal) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint8 bIndexOuter,
                              Uint8 bIndexInner, Pointer<Uint8> pbVal)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int bIndexOuter, int bIndexInner,
                      Pointer<Uint8> pbVal)>()(
          ptr.ref.lpVtbl, bIndexOuter, bIndexInner, pbVal);
  ...
  int GetRecordRatingDescriptionText(int bIndex, Pointer<Uint8> pbLength,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int bIndex, Pointer<Uint8> pbLength,
                      Pointer<Pointer<Uint8>> ppText)>()(
          ptr.ref.lpVtbl, bIndex, pbLength, ppText);
}
