...
class IMSVidXDSEvent extends IMSVidFeatureEvent {
  ...
  int RatingChange(int PrevRatingSystem, int PrevLevel, int PrevAttributes,
          int NewRatingSystem, int NewLevel, int NewAttributes) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int NewRatingSystem,
                      int NewLevel,
                      int NewAttributes)>()(ptr.ref.lpVtbl, PrevRatingSystem,
          PrevLevel, PrevAttributes, NewRatingSystem, NewLevel, NewAttributes);
}
