      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Int32> PhysicalChannel)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> PhysicalChannel)>()(
  ...
  set PhysicalChannel(int value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(Pointer, Int32 PhysicalChannel)>>>()
            .value
            .asFunction<int Function(Pointer, int PhysicalChannel)>()(
