...
class IMSEventBinder extends IDispatch {
  ...
  int Bind(Pointer<COMObject> pEventObject, Pointer<Utf16> EventName,
          Pointer<Utf16> EventHandler, Pointer<Int32> CancelID) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> EventHandler,
                      Pointer<Int32> CancelID)>()(
          ptr.ref.lpVtbl, pEventObject, EventName, EventHandler, CancelID);

  int Unbind(int CancelCookie) => ptr.ref.lpVtbl.value
      .elementAt(8)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Uint32 CancelCookie)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int CancelCookie)>()(ptr.ref.lpVtbl, CancelCookie);
}
