...
class IRegisterTuner extends IUnknown {
  ...
  int Register(Pointer<COMObject> pTuner, Pointer<COMObject> pGraph) =>
      ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pTuner,
                          Pointer<COMObject> pGraph)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> pTuner,
                  Pointer<COMObject> pGraph)>()(ptr.ref.lpVtbl, pTuner, pGraph);
