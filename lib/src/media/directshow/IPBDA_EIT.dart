...
class IPBDA_EIT extends IUnknown {
  ...
  int GetTableId(Pointer<Uint8> pbVal) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
  ...
  int GetVersionNumber(Pointer<Uint16> pwVal) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
  ...
  int GetServiceIdx(Pointer<Uint64> plwVal) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Uint64> plwVal)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Uint64> plwVal)>()(
      ptr.ref.lpVtbl, plwVal);
  ...
  int GetRecordEventId(int dwRecordIndex, Pointer<Uint64> plwVal) => ptr
      .ref.lpVtbl.value
      .elementAt(8)
      .cast<
          Pointer<
      ...
      .asFunction<
          int Function(Pointer, int dwRecordIndex,
              Pointer<Uint64> plwVal)>()(ptr.ref.lpVtbl, dwRecordIndex, plwVal);
