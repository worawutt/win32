      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> lpcwstrFilterName,
                      Pointer<Pointer<COMObject>> ppFilter)>()(
          ptr.ref.lpVtbl, pMoniker, pCtx, lpcwstrFilterName, ppFilter);

  int ReconnectEx(Pointer<COMObject> ppin, Pointer<AM_MEDIA_TYPE> pmt) =>
      ptr.ref.lpVtbl.value
          .elementAt(19)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(Pointer, Pointer<COMObject> ppin,
                  Pointer<AM_MEDIA_TYPE> pmt)>()(ptr.ref.lpVtbl, ppin, pmt);

  int RenderEx(
          Pointer<COMObject> pPinOut, int dwFlags, Pointer<Uint32> pvContext) =>
      ptr.ref.lpVtbl.value
              .elementAt(20)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<COMObject> pPinOut,
                              Uint32 dwFlags, Pointer<Uint32> pvContext)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pPinOut, int dwFlags,
                      Pointer<Uint32> pvContext)>()(
          ptr.ref.lpVtbl, pPinOut, dwFlags, pvContext);
}
