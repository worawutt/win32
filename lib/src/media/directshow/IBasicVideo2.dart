...
class IBasicVideo2 extends IBasicVideo {
  ...
  int GetPreferredAspectRatio(
          Pointer<Int32> plAspectX, Pointer<Int32> plAspectY) =>
      ptr
              .ref.lpVtbl.value
              .elementAt(39)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> plAspectX,
                              Pointer<Int32> plAspectY)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> plAspectX,
                      Pointer<Int32> plAspectY)>()(
          ptr.ref.lpVtbl, plAspectX, plAspectY);
}
