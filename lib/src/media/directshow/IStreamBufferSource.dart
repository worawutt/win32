...
class IStreamBufferSource extends IUnknown {
  ...
  int SetStreamSink(Pointer<COMObject> pIStreamBufferSink) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<COMObject> pIStreamBufferSink)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> pIStreamBufferSink)>()(
      ptr.ref.lpVtbl, pIStreamBufferSink);
}
