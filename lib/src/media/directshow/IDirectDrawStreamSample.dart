...
class IDirectDrawStreamSample extends IStreamSample {
  ...
  int GetSurface(Pointer<Pointer<COMObject>> ppDirectDrawSurface,
          Pointer<RECT> pRect) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppDirectDrawSurface,
                      Pointer<RECT> pRect)>()(
          ptr.ref.lpVtbl, ppDirectDrawSurface, pRect);

  int SetRect(Pointer<RECT> pRect) => ptr.ref.lpVtbl.value
      .elementAt(9)
      .cast<
          Pointer<
