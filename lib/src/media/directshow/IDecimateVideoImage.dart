...
class IDecimateVideoImage extends IUnknown {
  ...
  int SetDecimationImageSize(int lWidth, int lHeight) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 lWidth, Int32 lHeight)>>>()
          .value
          .asFunction<int Function(Pointer, int lWidth, int lHeight)>()(
      ptr.ref.lpVtbl, lWidth, lHeight);
