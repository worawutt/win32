...
class IATSC_MGT extends IUnknown {
  ...
  int GetRecordType(int dwRecordIndex, Pointer<Uint16> pwVal) => ptr
      .ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<
  ...
  int GetRecordTypePid(int dwRecordIndex, Pointer<Uint16> ppidVal) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
                  Pointer<
  ...
  int GetRecordVersionNumber(int dwRecordIndex, Pointer<Uint8> pbVal) => ptr
      .ref.lpVtbl.value
      .elementAt(9)
      .cast<
          Pointer<
