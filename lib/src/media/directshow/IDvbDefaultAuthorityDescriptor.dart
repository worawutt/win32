...
class IDvbDefaultAuthorityDescriptor extends IUnknown {
  ...
  int GetDefaultAuthority(
          Pointer<Uint8> pbLength, Pointer<Pointer<Uint8>> ppbBytes) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Uint8> pbLength,
                              Pointer<Pointer<Uint8>> ppbBytes)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint8> pbLength,
                      Pointer<Pointer<Uint8>> ppbBytes)>()(
          ptr.ref.lpVtbl, pbLength, ppbBytes);
}
