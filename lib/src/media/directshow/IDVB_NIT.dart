...
class IDVB_NIT extends IUnknown {
  ...
  int GetNetworkId(Pointer<Uint16> pwVal) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
  ...
  int GetRecordOriginalNetworkId(int dwRecordIndex, Pointer<Uint16> pwVal) =>
      ptr.ref.lpVtbl.value
              .elementAt(11)
              .cast<
                  Pointer<
  ...
  int GetNextTable(Pointer<Pointer<COMObject>> ppNIT) => ptr.ref.lpVtbl.value
          .elementAt(16)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> ppNIT)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> ppNIT)>()(
      ptr.ref.lpVtbl, ppNIT);
