    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> Formats)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> Formats)>()(
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> Inputs)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> Inputs)>()(
          ptr.ref.lpVtbl, retValuePtr);
