...
class IXDSToRat extends IDispatch {
  ...
  int ParseXDSBytePair(int byte1, int byte2, Pointer<Int32> pEnSystem,
          Pointer<Int32> pEnLevel, Pointer<Int32> plBfEnAttributes) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Int32> pEnLevel,
                      Pointer<Int32> plBfEnAttributes)>()(
          ptr.ref.lpVtbl, byte1, byte2, pEnSystem, pEnLevel, plBfEnAttributes);
}
