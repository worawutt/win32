...
class IAnalogLocator extends ILocator {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> AVS)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> AVS)>()(
  ...
  set VideoStandard(int value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(23)
        .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 AVS)>>>()
        .value
        .asFunction<int Function(Pointer, int AVS)>()(ptr.ref.lpVtbl, value);
