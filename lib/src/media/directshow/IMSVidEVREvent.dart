...
class IMSVidEVREvent extends IMSVidOutputDeviceEvent {
  ...
  int OnUserEvent(int lEventCode) => ptr.ref.lpVtbl.value
      .elementAt(8)
      .cast<
          Pointer<NativeFunction<Int32 Function(Pointer, Int32 lEventCode)>>>()
      .value
      .asFunction<
          int Function(Pointer, int lEventCode)>()(ptr.ref.lpVtbl, lEventCode);
}
