...
class IETFilterConfig extends IUnknown {
  ...
  int InitLicense(int LicenseId) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 LicenseId)>>>()
      .value
      .asFunction<
          int Function(Pointer, int LicenseId)>()(ptr.ref.lpVtbl, LicenseId);
