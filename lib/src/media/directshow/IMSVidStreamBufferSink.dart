...
class IMSVidStreamBufferSink extends IMSVidOutputDevice {
  ...
  int
      get_ContentRecorder(Pointer<Utf16> pszFilename,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(Pointer, Pointer<Utf16> pszFilename,
                          Pointer<Pointer<COMObject>> pRecordingIUnknown)>()(
              ptr.ref.lpVtbl, pszFilename, pRecordingIUnknown);

  int
      get_ReferenceRecorder(Pointer<Utf16> pszFilename,
              Pointer<Pointer<COMObject>> pRecordingIUnknown) =>
          ptr.ref.lpVtbl.value
                  .elementAt(17)
                  .cast<
  ...
  Pointer<COMObject> get SBESink {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> sbeConfig)>()(
          ptr.ref.lpVtbl, retValuePtr);
