...
class IBufferingTime extends IUnknown {
  ...
  int GetBufferingTime(Pointer<Uint32> pdwMilliseconds) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Uint32> pdwMilliseconds)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> pdwMilliseconds)>()(
          ptr.ref.lpVtbl, pdwMilliseconds);

  int SetBufferingTime(int dwMilliseconds) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
