...
class ISpecifyParticularPages extends IUnknown {
  ...
  int GetPages(Pointer<GUID> guidWhatPages, Pointer<CAUUID> pPages) => ptr
      .ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<GUID> guidWhatPages,
                      Pointer<CAUUID> pPages)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<GUID> guidWhatPages,
              Pointer<CAUUID> pPages)>()(ptr.ref.lpVtbl, guidWhatPages, pPages);
}
