...
class IStreamBufferDataCounters extends IUnknown {
  ...
  int GetData(Pointer<SBE_PIN_DATA> pPinData) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<SBE_PIN_DATA> pPinData)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<SBE_PIN_DATA> pPinData)>()(ptr.ref.lpVtbl, pPinData);
