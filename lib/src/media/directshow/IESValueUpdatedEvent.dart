...
class IESValueUpdatedEvent extends IESEvent {
  ...
  int GetValueNames(Pointer<Pointer<SAFEARRAY>> pbstrNames) => ptr
          .ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<SAFEARRAY>> pbstrNames)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<SAFEARRAY>> pbstrNames)>()(
      ptr.ref.lpVtbl, pbstrNames);
}
