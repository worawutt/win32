...
class IDvbServiceAttributeDescriptor extends IUnknown {
  ...
  int GetRecordServiceId(int bRecordIndex, Pointer<Uint16> pwVal) => ptr
      .ref.lpVtbl.value
      .elementAt(6)
      .cast<
          Pointer<
  ...
  int GetRecordNumericSelectionFlag(int bRecordIndex, Pointer<Int32> pfVal) =>
      ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(Pointer, int bRecordIndex,
                  Pointer<Int32> pfVal)>()(ptr.ref.lpVtbl, bRecordIndex, pfVal);

  int GetRecordVisibleServiceFlag(int bRecordIndex, Pointer<Int32> pfVal) => ptr
      .ref.lpVtbl.value
      .elementAt(8)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Uint8 bRecordIndex, Pointer<Int32> pfVal)>>>()
      .value
      .asFunction<
          int Function(Pointer, int bRecordIndex,
              Pointer<Int32> pfVal)>()(ptr.ref.lpVtbl, bRecordIndex, pfVal);
