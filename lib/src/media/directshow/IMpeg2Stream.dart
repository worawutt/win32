      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int tid,
                      Pointer<MPEG2_FILTER> pFilter,
                      int hDataReadyEvent)>()(ptr.ref.lpVtbl, requestType,
          pMpeg2Data, pContext, pid, tid, pFilter, hDataReadyEvent);

  int SupplyDataBuffer(Pointer<MPEG_STREAM_BUFFER> pStreamBuffer) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<MPEG_STREAM_BUFFER> pStreamBuffer)>()(
          ptr.ref.lpVtbl, pStreamBuffer);
}
