...
class IVMRSurfaceAllocator extends IUnknown {
  ...
  int FreeSurface(int dwID) => ptr.ref.lpVtbl.value
      .elementAt(4)
  ...
  int PrepareSurface(
          int dwUserID, Pointer<COMObject> lpSurface, int dwSurfaceFlags) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, int dwUserID,
                      Pointer<COMObject> lpSurface, int dwSurfaceFlags)>()(
          ptr.ref.lpVtbl, dwUserID, lpSurface, dwSurfaceFlags);
