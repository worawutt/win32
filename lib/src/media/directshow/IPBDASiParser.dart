...
class IPBDASiParser extends IUnknown {
  ...
  int Initialize(Pointer<COMObject> punk) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetEIT(int dwSize, Pointer<Uint8> pBuffer,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int dwSize, Pointer<Uint8> pBuffer,
                      Pointer<Pointer<COMObject>> ppEIT)>()(
          ptr.ref.lpVtbl, dwSize, pBuffer, ppEIT);

  int GetServices(int dwSize, Pointer<Uint8> pBuffer,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int dwSize, Pointer<Uint8> pBuffer,
                      Pointer<Pointer<COMObject>> ppServices)>()(
          ptr.ref.lpVtbl, dwSize, pBuffer, ppServices);
}
