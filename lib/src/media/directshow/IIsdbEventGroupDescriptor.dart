...
class IIsdbEventGroupDescriptor extends IUnknown {
  ...
  int GetGroupType(Pointer<Uint8> pbVal) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Uint8> pbVal)>>>()
  ...
  int GetRecordEvent(int bRecordIndex, Pointer<Uint16> pwServiceId,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint16> pwServiceId,
                      Pointer<Uint16> pwEventId)>()(
          ptr.ref.lpVtbl, bRecordIndex, pwServiceId, pwEventId);

  int GetCountOfRefRecords(Pointer<Uint8> pbVal) => ptr.ref.lpVtbl.value
      .elementAt(8)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Uint8> pbVal)>>>()
