...
class IStreamBufferMediaSeeking2 extends IStreamBufferMediaSeeking {
  ...
  int SetRateEx(double dRate, int dwFramesPerSec) => ptr.ref.lpVtbl.value
          .elementAt(20)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Double dRate, Uint32 dwFramesPerSec)>>>()
          .value
          .asFunction<
              int Function(Pointer, double dRate, int dwFramesPerSec)>()(
      ptr.ref.lpVtbl, dRate, dwFramesPerSec);
}
