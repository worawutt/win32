...
class IMSVidFilePlayback2 extends IMSVidFilePlayback {
  ...
  int put___SourceFilter(GUID FileName) => ptr.ref.lpVtbl.value
      .elementAt(35)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, GUID FileName)>>>()
      .value
      .asFunction<
          int Function(Pointer, GUID FileName)>()(ptr.ref.lpVtbl, FileName);
}
