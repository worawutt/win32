...
class IXDSCodec extends IUnknown {
  ...
  set CCSubstreamService(int value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<Int32 Function(Pointer, Int32 SubstreamMask)>>>()
        .value
        .asFunction<
            int Function(Pointer, int SubstreamMask)>()(ptr.ref.lpVtbl, value);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Int32> pSubstreamMask)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> pSubstreamMask)>()(
          ptr.ref.lpVtbl, retValuePtr);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Int64> pTimeStart,
                      Pointer<Int64> pTimeEnd)>()(
          ptr.ref.lpVtbl, pRat, pPktSeqID, pCallSeqID, pTimeStart, pTimeEnd);
