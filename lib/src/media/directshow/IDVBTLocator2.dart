  ...
  int get PhysicalLayerPipeId {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Int32> PhysicalLayerPipeIdVal)>()(
  ...
  set PhysicalLayerPipeId(int value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<
                    Int32 Function(Pointer, Int32 PhysicalLayerPipeIdVal)>>>()
        .value
        .asFunction<
            int Function(
                Pointer, int PhysicalLayerPipeIdVal)>()(ptr.ref.lpVtbl, value);
