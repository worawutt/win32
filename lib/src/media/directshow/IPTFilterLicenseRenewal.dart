...
class IPTFilterLicenseRenewal extends IUnknown {
  ...
  int RenewLicenses(Pointer<Utf16> wszFileName, Pointer<Utf16> wszExpiredKid,
          int dwCallersId, int bHighPriority) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> wszExpiredKid,
                      int dwCallersId,
                      int bHighPriority)>()(ptr.ref.lpVtbl, wszFileName,
          wszExpiredKid, dwCallersId, bHighPriority);
