...
class IDvbServiceDescriptor extends IUnknown {
  ...
  int GetServiceType(Pointer<Uint8> pbVal) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Uint8> pbVal)>>>()
  ...
  int GetServiceProviderName(Pointer<Pointer<Uint8>> pszName) => ptr
      .ref.lpVtbl.value
      .elementAt(6)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Pointer<Uint8>> pszName)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<Pointer<Uint8>> pszName)>()(ptr.ref.lpVtbl, pszName);

  int GetServiceProviderNameW(Pointer<Pointer<Utf16>> pbstrName) => ptr
          .ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
  ...
  int GetServiceName(Pointer<Pointer<Uint8>> pszName) => ptr.ref.lpVtbl.value
      .elementAt(8)
      .cast<
          Pointer<
              NativeFunction<
  ...
  int GetProcessedServiceName(Pointer<Pointer<Utf16>> pbstrName) => ptr
          .ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
  ...
  int GetServiceNameEmphasized(Pointer<Pointer<Utf16>> pbstrName) =>
