...
class IMSVidDeviceEvent extends IDispatch {
  ...
  int StateChange(Pointer<COMObject> lpd, int oldState, int newState) =>
      ptr.ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> lpd,
                          Int32 oldState, Int32 newState)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> lpd, int oldState,
                  int newState)>()(ptr.ref.lpVtbl, lpd, oldState, newState);
}
