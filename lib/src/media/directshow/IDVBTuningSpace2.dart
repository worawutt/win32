...
class IDVBTuningSpace2 extends IDVBTuningSpace {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> NetworkID)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> NetworkID)>()(
  ...
  set NetworkID(int value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(29)
        .cast<
            Pointer<NativeFunction<Int32 Function(Pointer, Int32 NetworkID)>>>()
        .value
        .asFunction<
            int Function(Pointer, int NetworkID)>()(ptr.ref.lpVtbl, value);
