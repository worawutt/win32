...
class IESEventService extends IUnknown {
  ...
  int FireESEvent(Pointer<COMObject> pESEvent) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pESEvent)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> pESEvent)>()(
      ptr.ref.lpVtbl, pESEvent);
}
