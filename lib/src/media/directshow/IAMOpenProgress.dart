...
class IAMOpenProgress extends IUnknown {
  ...
  int QueryProgress(Pointer<Int64> pllTotal, Pointer<Int64> pllCurrent) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int64> pllTotal,
                              Pointer<Int64> pllCurrent)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int64> pllTotal,
                      Pointer<Int64> pllCurrent)>()(
          ptr.ref.lpVtbl, pllTotal, pllCurrent);
