...
class ITuneRequest extends IDispatch {
  ...
  Pointer<COMObject> get Components {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> Components)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  int Clone(Pointer<Pointer<COMObject>> NewTuneRequest) => ptr.ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<COMObject>> NewTuneRequest)>()(
      ptr.ref.lpVtbl, NewTuneRequest);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<COMObject>> Locator)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<COMObject>> Locator)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set Locator(Pointer<COMObject> value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(Pointer, Pointer<COMObject> Locator)>>>()
            .value
            .asFunction<int Function(Pointer, Pointer<COMObject> Locator)>()(
