...
class IATSCChannelTuneRequest extends IChannelTuneRequest {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> MinorChannel)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int32> MinorChannel)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  set MinorChannel(int value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<Int32 Function(Pointer, Int32 MinorChannel)>>>()
        .value
        .asFunction<
            int Function(Pointer, int MinorChannel)>()(ptr.ref.lpVtbl, value);
