...
class IMSVidStreamBufferSource extends IMSVidFilePlayback {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> lStart)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> lStart)>()(
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<COMObject>>
                      pRecordingAttribute)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  int CurrentRatings(Pointer<Int32> pEnSystem, Pointer<Int32> pEnRating,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Int32> pEnSystem,
                      Pointer<Int32> pEnRating, Pointer<Int32> pBfEnAttr)>()(
          ptr.ref.lpVtbl, pEnSystem, pEnRating, pBfEnAttr);

  int MaxRatingsLevel(int enSystem, int enRating, int lbfEnAttr) => ptr
      .ref.lpVtbl.value
      .elementAt(37)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Int32 enSystem, Int32 enRating,
                      Int32 lbfEnAttr)>>>()
      .value
      .asFunction<
          int Function(Pointer, int enSystem, int enRating,
              int lbfEnAttr)>()(ptr.ref.lpVtbl, enSystem, enRating, lbfEnAttr);

  set BlockUnrated(int value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(38)
        .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int16 bBlock)>>>()
        .value
        .asFunction<int Function(Pointer, int bBlock)>()(ptr.ref.lpVtbl, value);
  ...
  set UnratedDelay(int value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(39)
        .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 dwDelay)>>>()
        .value
        .asFunction<
            int Function(Pointer, int dwDelay)>()(ptr.ref.lpVtbl, value);
  ...
  Pointer<COMObject> get SBESource {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> sbeFilter)>()(
          ptr.ref.lpVtbl, retValuePtr);
