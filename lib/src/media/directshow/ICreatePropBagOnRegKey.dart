...
class ICreatePropBagOnRegKey extends IUnknown {
  ...
  int Create(int hkey, Pointer<Utf16> subkey, int ulOptions, int samDesired,
          Pointer<GUID> iid, Pointer<Pointer> ppBag) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> iid,
                      Pointer<Pointer> ppBag)>()(
          ptr.ref.lpVtbl, hkey, subkey, ulOptions, samDesired, iid, ppBag);
}
