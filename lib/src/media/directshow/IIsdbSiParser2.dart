...
class IIsdbSiParser2 extends IDvbSiParser2 {
  ...
  int GetSDT_1(int tableId, Pointer<Uint16> pwTransportStreamId,
  ...
  int GetBIT(int tableId, Pointer<Uint16> pwOriginalNetworkId,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint16> pwOriginalNetworkId,
                      Pointer<Pointer<COMObject>> ppBIT)>()(
          ptr.ref.lpVtbl, tableId, pwOriginalNetworkId, ppBIT);

  int GetNBIT(int tableId, Pointer<Uint16> pwOriginalNetworkId,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint16> pwOriginalNetworkId,
                      Pointer<Pointer<COMObject>> ppNBIT)>()(
          ptr.ref.lpVtbl, tableId, pwOriginalNetworkId, ppNBIT);

  int GetLDT(int tableId, Pointer<Uint16> pwOriginalServiceId,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint16> pwOriginalServiceId,
                      Pointer<Pointer<COMObject>> ppLDT)>()(
          ptr.ref.lpVtbl, tableId, pwOriginalServiceId, ppLDT);

  int GetSDTT(int tableId, Pointer<Uint16> pwTableIdExt,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint16> pwTableIdExt,
                      Pointer<Pointer<COMObject>> ppSDTT)>()(
          ptr.ref.lpVtbl, tableId, pwTableIdExt, ppSDTT);

  int GetCDT(int tableId, int bSectionNumber, Pointer<Uint16> pwDownloadDataId,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint16> pwDownloadDataId,
                      Pointer<Pointer<COMObject>> ppCDT)>()(
          ptr.ref.lpVtbl, tableId, bSectionNumber, pwDownloadDataId, ppCDT);

  int GetEMM(int pid, int wTableIdExt, Pointer<Pointer<COMObject>> ppEMM) => ptr
          .ref.lpVtbl.value
          .elementAt(25)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Uint16 pid, Uint16 wTableIdExt,
                          Pointer<Pointer<COMObject>> ppEMM)>>>()
          .value
          .asFunction<
              int Function(Pointer, int pid, int wTableIdExt,
                  Pointer<Pointer<COMObject>> ppEMM)>()(
      ptr.ref.lpVtbl, pid, wTableIdExt, ppEMM);
}
