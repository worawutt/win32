...
class IDvbSiParser2 extends IDvbSiParser {
  ...
  int GetEIT2(int tableId, Pointer<Uint16> pwServiceId,
          Pointer<Uint8> pbSegment, Pointer<Pointer<COMObject>> ppEIT) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint8> pbSegment,
                      Pointer<Pointer<COMObject>> ppEIT)>()(
          ptr.ref.lpVtbl, tableId, pwServiceId, pbSegment, ppEIT);
}
