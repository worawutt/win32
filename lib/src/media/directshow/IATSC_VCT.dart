...
class IATSC_VCT extends IUnknown {
  ...
  int GetRecordName(int dwRecordIndex, Pointer<Pointer<Utf16>> pwsName) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, int dwRecordIndex,
                      Pointer<Pointer<Utf16>> pwsName)>()(
          ptr.ref.lpVtbl, dwRecordIndex, pwsName);

  int GetRecordMajorChannelNumber(int dwRecordIndex, Pointer<Uint16> pwVal) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, int dwRecordIndex, Pointer<Uint16> pwVal)>()(
          ptr.ref.lpVtbl, dwRecordIndex, pwVal);

  int GetRecordMinorChannelNumber(int dwRecordIndex, Pointer<Uint16> pwVal) =>
      ptr.ref.lpVtbl.value
              .elementAt(10)
              .cast<
                  Pointer<
  ...
  int GetRecordModulationMode(int dwRecordIndex, Pointer<Uint8> pbVal) => ptr
      .ref.lpVtbl.value
      .elementAt(11)
      .cast<
          Pointer<
  ...
  int GetRecordCarrierFrequency(int dwRecordIndex, Pointer<Uint32> pdwVal) =>
      ptr.ref.lpVtbl.value
              .elementAt(12)
              .cast<
                  Pointer<
  ...
  int GetRecordTransportStreamId(int dwRecordIndex, Pointer<Uint16> pwVal) =>
      ptr.ref.lpVtbl.value
              .elementAt(13)
              .cast<
                  Pointer<
  ...
  int GetRecordProgramNumber(int dwRecordIndex, Pointer<Uint16> pwVal) => ptr
      .ref.lpVtbl.value
      .elementAt(14)
      .cast<
          Pointer<
  ...
  int GetRecordEtmLocation(int dwRecordIndex, Pointer<Uint8> pbVal) => ptr
      .ref.lpVtbl.value
      .elementAt(15)
      .cast<
          Pointer<
  ...
  int GetRecordIsHiddenBitSet(int dwRecordIndex, Pointer<Int32> pfVal) => ptr
      .ref.lpVtbl.value
      .elementAt(17)
      .cast<
          Pointer<
  ...
  int GetRecordIsPathSelectBitSet(int dwRecordIndex, Pointer<Int32> pfVal) =>
      ptr.ref.lpVtbl.value
              .elementAt(18)
              .cast<
                  Pointer<
  ...
  int GetRecordIsOutOfBandBitSet(int dwRecordIndex, Pointer<Int32> pfVal) => ptr
      .ref.lpVtbl.value
      .elementAt(19)
      .cast<
          Pointer<
  ...
  int GetRecordIsHideGuideBitSet(int dwRecordIndex, Pointer<Int32> pfVal) => ptr
      .ref.lpVtbl.value
      .elementAt(20)
      .cast<
          Pointer<
  ...
  int GetRecordServiceType(int dwRecordIndex, Pointer<Uint8> pbVal) => ptr
      .ref.lpVtbl.value
      .elementAt(21)
      .cast<
          Pointer<
  ...
  int GetRecordSourceId(int dwRecordIndex, Pointer<Uint16> pwVal) => ptr
      .ref.lpVtbl.value
      .elementAt(22)
      .cast<
          Pointer<
