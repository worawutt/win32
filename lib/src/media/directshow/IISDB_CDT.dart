...
class IISDB_CDT extends IUnknown {
  ...
  int Initialize(Pointer<COMObject> pSectionList, Pointer<COMObject> pMPEGData,
          int bSectionNumber) =>
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pSectionList,
                      Pointer<COMObject> pMPEGData, int bSectionNumber)>()(
          ptr.ref.lpVtbl, pSectionList, pMPEGData, bSectionNumber);
  ...
  int GetDownloadDataId(Pointer<Uint16> pwVal) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
  ...
  int GetSectionNumber(Pointer<Uint8> pbVal) => ptr.ref.lpVtbl.value
      .elementAt(6)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Uint8> pbVal)>>>()
  ...
  int GetDataType(Pointer<Uint8> pbVal) => ptr.ref.lpVtbl.value
      .elementAt(8)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Uint8> pbVal)>>>()
  ...
  int GetSizeOfDataModule(Pointer<Uint32> pdwVal) => ptr.ref.lpVtbl.value
          .elementAt(12)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetDataModule(Pointer<Pointer<Uint8>> pbData) => ptr.ref.lpVtbl.value
      .elementAt(13)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Pointer<Uint8>> pbData)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<Pointer<Uint8>> pbData)>()(ptr.ref.lpVtbl, pbData);
