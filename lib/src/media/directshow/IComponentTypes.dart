...
class IComponentTypes extends IDispatch {
  ...
  int EnumComponentTypes(Pointer<Pointer<COMObject>> ppNewEnum) => ptr
          .ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
          ...
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> ppNewEnum)>()(
      ptr.ref.lpVtbl, ppNewEnum);

  int get_Item(VARIANT Index, Pointer<Pointer<COMObject>> ComponentType) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, VARIANT Index,
                      Pointer<Pointer<COMObject>> ComponentType)>()(
          ptr.ref.lpVtbl, Index, ComponentType);

  int put_Item(VARIANT Index, Pointer<COMObject> ComponentType) => ptr
          .ref.lpVtbl.value
          .elementAt(11)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, VARIANT Index, Pointer<COMObject> ComponentType)>()(
      ptr.ref.lpVtbl, Index, ComponentType);

  int Add(Pointer<COMObject> ComponentType, Pointer<VARIANT> NewIndex) => ptr
          .ref.lpVtbl.value
          .elementAt(12)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> ComponentType,
                          Pointer<VARIANT> NewIndex)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> ComponentType,
                  Pointer<VARIANT> NewIndex)>()(
      ptr.ref.lpVtbl, ComponentType, NewIndex);
  ...
  int Clone(Pointer<Pointer<COMObject>> NewList) => ptr.ref.lpVtbl.value
          .elementAt(14)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> NewList)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> NewList)>()(
      ptr.ref.lpVtbl, NewList);
}
