...
class IMSVidClosedCaptioning extends IMSVidFeature {
  ...
  int get Enable {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<Int32 Function(Pointer, Pointer<Int16> On)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer, Pointer<Int16> On)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  set Enable(int value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(17)
        .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int16 On)>>>()
        .value
        .asFunction<int Function(Pointer, int On)>()(ptr.ref.lpVtbl, value);
