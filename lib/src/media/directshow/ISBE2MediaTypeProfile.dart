...
class ISBE2MediaTypeProfile extends IUnknown {
  ...
  int GetStreamCount(Pointer<Uint32> pCount) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetStream(int Index, Pointer<Pointer<AM_MEDIA_TYPE>> ppMediaType) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int Index,
                      Pointer<Pointer<AM_MEDIA_TYPE>> ppMediaType)>()(
          ptr.ref.lpVtbl, Index, ppMediaType);

  int AddStream(Pointer<AM_MEDIA_TYPE> pMediaType) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int DeleteStream(int Index) => ptr.ref.lpVtbl.value
      .elementAt(6)
