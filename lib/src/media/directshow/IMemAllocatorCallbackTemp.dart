...
class IMemAllocatorCallbackTemp extends IMemAllocator {
  ...
  int SetNotify(Pointer<COMObject> pNotify) => ptr.ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetFreeCount(Pointer<Int32> plBuffersFree) => ptr.ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> plBuffersFree)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Int32> plBuffersFree)>()(
      ptr.ref.lpVtbl, plBuffersFree);
}
