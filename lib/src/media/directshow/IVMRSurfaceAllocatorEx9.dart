...
class IVMRSurfaceAllocatorEx9 extends IVMRSurfaceAllocator9 {
  ...
  int GetSurfaceEx(int dwUserID, int SurfaceIndex, int SurfaceFlags,
          Pointer<Pointer<COMObject>> lplpSurface, Pointer<RECT> lprcDst) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int SurfaceFlags,
                      Pointer<Pointer<COMObject>> lplpSurface,
                      Pointer<RECT> lprcDst)>()(ptr.ref.lpVtbl, dwUserID,
          SurfaceIndex, SurfaceFlags, lplpSurface, lprcDst);
}
