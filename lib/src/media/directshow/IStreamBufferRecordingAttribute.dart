...
class IStreamBufferRecordingAttribute extends IUnknown {
  ...
  int GetAttributeCount(int ulReserved, Pointer<Uint16> pcAttributes) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint32 ulReserved,
                              Pointer<Uint16> pcAttributes)>>>()
              .value
              .asFunction<
                  int Function(
                      Pointer, int ulReserved, Pointer<Uint16> pcAttributes)>()(
          ptr.ref.lpVtbl, ulReserved, pcAttributes);
  ...
  int EnumAttributes(Pointer<Pointer<COMObject>> ppIEnumStreamBufferAttrib) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
