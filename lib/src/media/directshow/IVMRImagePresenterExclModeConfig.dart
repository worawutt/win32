...
class IVMRImagePresenterExclModeConfig extends IVMRImagePresenterConfig {
  ...
  int SetXlcModeDDObjAndPrimarySurface(
          Pointer<COMObject> lpDDObj, Pointer<COMObject> lpPrimarySurf) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<COMObject> lpDDObj,
                              Pointer<COMObject> lpPrimarySurf)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> lpDDObj,
                      Pointer<COMObject> lpPrimarySurf)>()(
          ptr.ref.lpVtbl, lpDDObj, lpPrimarySurf);

  int GetXlcModeDDObjAndPrimarySurface(Pointer<Pointer<COMObject>> lpDDObj,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<COMObject>> lpDDObj,
                      Pointer<Pointer<COMObject>> lpPrimarySurf)>()(
          ptr.ref.lpVtbl, lpDDObj, lpPrimarySurf);
}
