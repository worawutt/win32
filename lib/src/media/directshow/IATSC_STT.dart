...
class IATSC_STT extends IUnknown {
  ...
  int GetSystemTime(Pointer<MPEG_DATE_AND_TIME> pmdtSystemTime) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<MPEG_DATE_AND_TIME> pmdtSystemTime)>()(
          ptr.ref.lpVtbl, pmdtSystemTime);

  int GetGpsUtcOffset(Pointer<Uint8> pbVal) => ptr.ref.lpVtbl.value
      .elementAt(6)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Uint8> pbVal)>>>()
  ...
  int GetDaylightSavings(Pointer<Uint16> pwVal) => ptr.ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<
