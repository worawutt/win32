...
class IEnumPins extends IUnknown {
  ...
  int Next(int cPins, Pointer<Pointer<COMObject>> ppPins,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppPins,
                      Pointer<Uint32> pcFetched)>()(
          ptr.ref.lpVtbl, cPins, ppPins, pcFetched);

  int Skip(int cPins) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Uint32 cPins)>>>()
      .value
      .asFunction<int Function(Pointer, int cPins)>()(ptr.ref.lpVtbl, cPins);
