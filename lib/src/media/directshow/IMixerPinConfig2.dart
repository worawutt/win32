...
class IMixerPinConfig2 extends IMixerPinConfig {
  ...
  int SetOverlaySurfaceColorControls(Pointer<DDCOLORCONTROL> pColorControl) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<DDCOLORCONTROL> pColorControl)>()(
          ptr.ref.lpVtbl, pColorControl);

  int GetOverlaySurfaceColorControls(Pointer<DDCOLORCONTROL> pColorControl) =>
      ptr.ref.lpVtbl.value
              .elementAt(16)
              .cast<
                  Pointer<
