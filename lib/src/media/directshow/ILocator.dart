...
class ILocator extends IDispatch {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> Frequency)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> Frequency)>()(
  ...
  set CarrierFrequency(int value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(8)
        .cast<
            Pointer<NativeFunction<Int32 Function(Pointer, Int32 Frequency)>>>()
        .value
        .asFunction<
            int Function(Pointer, int Frequency)>()(ptr.ref.lpVtbl, value);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> Modulation)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int32> Modulation)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  set Modulation(int value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<Int32 Function(Pointer, Int32 Modulation)>>>()
        .value
        .asFunction<
            int Function(Pointer, int Modulation)>()(ptr.ref.lpVtbl, value);
  ...
  int Clone(Pointer<Pointer<COMObject>> NewLocator) => ptr.ref.lpVtbl.value
          .elementAt(21)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> NewLocator)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> NewLocator)>()(
      ptr.ref.lpVtbl, NewLocator);
}
