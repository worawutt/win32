...
typedef AMGETERRORTEXTPROCW = Int32 Function(
    Int32 param0, Pointer<Utf16> param1, Uint32 param2);
...
typedef PDXVA2SW_DESTROYVIDEOPROCESSDEVICE = Int32 Function(IntPtr hDevice);
...
typedef PDXVA2SW_GETVIDEOPROCESSORRENDERTARGETCOUNT = Int32 Function(
    Pointer<DXVA2_VideoDesc> pVideoDesc, Pointer<Uint32> pCount);
...
typedef PDXVA2SW_GETVIDEOPROCESSORSUBSTREAMFORMATS = Int32 Function(
    ...
    Uint32 Count,
    Pointer<Uint32> pFormats);
typedef PDXVA2SW_VIDEOPROCESSBEGINFRAME = Int32 Function(IntPtr hDevice);
typedef PDXVA2SW_VIDEOPROCESSBLT = Int32 Function(
    IntPtr hDevice, Pointer<DXVA2_VIDEOPROCESSBLT> pBlt);
typedef PDXVA2SW_VIDEOPROCESSENDFRAME = Int32 Function(
    IntPtr hDevice, Pointer<IntPtr> pHandleComplete);
typedef PDXVA2SW_VIDEOPROCESSSETRENDERTARGET = Int32 Function(
    IntPtr hDevice, Pointer<COMObject> pRenderTarget);
