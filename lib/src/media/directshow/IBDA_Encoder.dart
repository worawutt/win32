...
class IBDA_Encoder extends IUnknown {
  ...
  int QueryCapabilities(
          Pointer<Uint32> NumAudioFmts, Pointer<Uint32> NumVideoFmts) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Uint32> NumAudioFmts,
                              Pointer<Uint32> NumVideoFmts)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> NumAudioFmts,
                      Pointer<Uint32> NumVideoFmts)>()(
          ptr.ref.lpVtbl, NumAudioFmts, NumVideoFmts);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint32> SamplingRate,
                      Pointer<Uint32> BitDepth,
                      Pointer<Uint32> NumChannels)>()(ptr.ref.lpVtbl, FmtIndex,
          MethodID, AlgorithmType, SamplingRate, BitDepth, NumChannels);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Int32> SignalLevel,
                      Pointer<Uint32> SignalToNoiseRatio)>()(
          ptr.ref.lpVtbl, AudioBitrateMax, AudioBitrateMin, AudioBitrateMode, AudioBitrateStepping, AudioBitrate, AudioMethodID, AvailableAudioPrograms, AudioProgram, VideoBitrateMax, VideoBitrateMin, VideoBitrateMode, VideoBitrate, VideoBitrateStepping, VideoMethodID, SignalSourceID, SignalFormat, SignalLock, SignalLevel, SignalToNoiseRatio);
}
