...
class IPBDAEntitlementDescriptor extends IUnknown {
  ...
  int GetLength(Pointer<Uint16> pwVal) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
  ...
  int GetToken(Pointer<Pointer<Uint8>> ppbTokenBuffer,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<Uint8>> ppbTokenBuffer,
                      Pointer<Uint32> pdwTokenLength)>()(
          ptr.ref.lpVtbl, ppbTokenBuffer, pdwTokenLength);
}
