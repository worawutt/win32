...
class IEnumMediaTypes extends IUnknown {
  ...
  int Next(int cMediaTypes, Pointer<Pointer<AM_MEDIA_TYPE>> ppMediaTypes,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<AM_MEDIA_TYPE>> ppMediaTypes,
                      Pointer<Uint32> pcFetched)>()(
          ptr.ref.lpVtbl, cMediaTypes, ppMediaTypes, pcFetched);

  int Skip(int cMediaTypes) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Uint32 cMediaTypes)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int cMediaTypes)>()(ptr.ref.lpVtbl, cMediaTypes);
