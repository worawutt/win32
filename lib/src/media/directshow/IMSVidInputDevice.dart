...
class IMSVidInputDevice extends IMSVidDevice {
  ...
  int IsViewable(Pointer<VARIANT> v, Pointer<Int16> pfViewable) =>
      ptr.ref.lpVtbl.value
          .elementAt(16)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<VARIANT> v,
                          Pointer<Int16> pfViewable)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<VARIANT> v,
                  Pointer<Int16> pfViewable)>()(ptr.ref.lpVtbl, v, pfViewable);
