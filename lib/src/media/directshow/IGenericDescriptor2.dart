...
class IGenericDescriptor2 extends IGenericDescriptor {
  ...
  int Initialize_1(Pointer<Uint8> pbDesc, int wCount) => ptr.ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Uint8> pbDesc, Uint16 wCount)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Uint8> pbDesc, int wCount)>()(
      ptr.ref.lpVtbl, pbDesc, wCount);

  int GetLength_1(Pointer<Uint16> pwVal) => ptr.ref.lpVtbl.value
      .elementAt(8)
      .cast<
          Pointer<
