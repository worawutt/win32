...
class IATSC_ETT extends IUnknown {
  ...
  int GetEtmId(Pointer<Uint32> pdwVal) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetExtendedMessageText(
          Pointer<Uint32> pdwLength, Pointer<Pointer<Uint8>> ppText) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> pdwLength,
                      Pointer<Pointer<Uint8>> ppText)>()(
          ptr.ref.lpVtbl, pdwLength, ppText);
}
