...
class IPMT extends IUnknown {
  ...
  int GetProgramNumber(Pointer<Uint16> pwVal) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
  ...
  int GetPcrPid(Pointer<Uint16> pPidVal) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Uint16> pPidVal)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Uint16> pPidVal)>()(
      ptr.ref.lpVtbl, pPidVal);
  ...
  int GetRecordStreamType(int dwRecordIndex, Pointer<Uint8> pbVal) => ptr
      .ref.lpVtbl.value
      .elementAt(11)
      .cast<
          Pointer<
  ...
  int GetRecordElementaryPid(int dwRecordIndex, Pointer<Uint16> pPidVal) =>
      ptr.ref.lpVtbl.value
              .elementAt(12)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, int dwRecordIndex, Pointer<Uint16> pPidVal)>()(
          ptr.ref.lpVtbl, dwRecordIndex, pPidVal);
  ...
  int GetRecordDescriptorByIndex(int dwRecordIndex, int dwDescIndex,
          Pointer<Pointer<COMObject>> ppDescriptor) =>
      ptr.ref.lpVtbl.value
              .elementAt(14)
              .cast<
              ...
              .value
              .asFunction<
                  int Function(Pointer, int dwRecordIndex, int dwDescIndex,
                      Pointer<Pointer<COMObject>> ppDescriptor)>()(
          ptr.ref.lpVtbl, dwRecordIndex, dwDescIndex, ppDescriptor);
  ...
  int QueryServiceGatewayInfo(Pointer<Pointer<DSMCC_ELEMENT>> ppDSMCCList,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<DSMCC_ELEMENT>> ppDSMCCList,
                      Pointer<Uint32> puiCount)>()(
          ptr.ref.lpVtbl, ppDSMCCList, puiCount);

  int QueryMPEInfo(
          Pointer<Pointer<MPE_ELEMENT>> ppMPEList, Pointer<Uint32> puiCount) =>
      ptr.ref.lpVtbl.value
              .elementAt(17)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<MPE_ELEMENT>> ppMPEList,
                      Pointer<Uint32> puiCount)>()(
          ptr.ref.lpVtbl, ppMPEList, puiCount);
  ...
  int GetNextTable(Pointer<Pointer<COMObject>> ppPMT) => ptr.ref.lpVtbl.value
          .elementAt(19)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> ppPMT)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> ppPMT)>()(
      ptr.ref.lpVtbl, ppPMT);
