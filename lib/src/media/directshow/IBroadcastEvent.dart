...
class IBroadcastEvent extends IUnknown {
  ...
  int Fire(GUID EventID) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, GUID EventID)>>>()
      .value
      .asFunction<
          int Function(Pointer, GUID EventID)>()(ptr.ref.lpVtbl, EventID);
}
