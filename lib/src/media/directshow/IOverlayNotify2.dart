...
class IOverlayNotify2 extends IOverlayNotify {
  ...
  int OnDisplayChange(int hMonitor) => ptr.ref.lpVtbl.value
      .elementAt(7)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, IntPtr hMonitor)>>>()
      .value
      .asFunction<
          int Function(Pointer, int hMonitor)>()(ptr.ref.lpVtbl, hMonitor);
}
