...
class IESCloseMmiEvent extends IESEvent {
  ...
  int GetDialogNumber(Pointer<Uint32> pDialogNumber) => ptr.ref.lpVtbl.value
      .elementAt(8)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Uint32> pDialogNumber)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<Uint32> pDialogNumber)>()(ptr.ref.lpVtbl, pDialogNumber);
}
