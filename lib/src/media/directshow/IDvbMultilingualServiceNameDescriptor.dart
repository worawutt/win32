...
class IDvbMultilingualServiceNameDescriptor extends IUnknown {
  ...
  int GetRecordLangId(int bRecordIndex, Pointer<Uint32> ulVal) => ptr
      .ref.lpVtbl.value
      .elementAt(6)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Uint8 bRecordIndex, Pointer<Uint32> ulVal)>>>()
      .value
      .asFunction<
          int Function(Pointer, int bRecordIndex,
              Pointer<Uint32> ulVal)>()(ptr.ref.lpVtbl, bRecordIndex, ulVal);

  int GetRecordServiceProviderNameW(
          int bRecordIndex, int convMode, Pointer<Pointer<Utf16>> pbstrName) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int bRecordIndex, int convMode,
                      Pointer<Pointer<Utf16>> pbstrName)>()(
          ptr.ref.lpVtbl, bRecordIndex, convMode, pbstrName);
