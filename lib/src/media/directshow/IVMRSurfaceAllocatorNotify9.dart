...
class IVMRSurfaceAllocatorNotify9 extends IUnknown {
  ...
  int SetD3DDevice(Pointer<COMObject> lpD3DDevice, int hMonitor) => ptr
      .ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> lpD3DDevice,
                      IntPtr hMonitor)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<COMObject> lpD3DDevice,
              int hMonitor)>()(ptr.ref.lpVtbl, lpD3DDevice, hMonitor);

  int ChangeD3DDevice(Pointer<COMObject> lpD3DDevice, int hMonitor) =>
      ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint32> lpNumBuffers,
                      Pointer<Pointer<COMObject>> lplpSurface)>()(
          ptr.ref.lpVtbl, lpAllocInfo, lpNumBuffers, lplpSurface);
