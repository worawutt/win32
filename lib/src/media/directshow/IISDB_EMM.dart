...
class IISDB_EMM extends IUnknown {
  ...
  int GetTableIdExtension(Pointer<Uint16> pwVal) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
  ...
  int GetDataBytes(Pointer<Uint16> pwBufferLength, Pointer<Uint8> pbBuffer) =>
      ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Uint16> pwBufferLength,
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<Uint8>
                      pbBuffer)>()(ptr.ref.lpVtbl, pwBufferLength, pbBuffer);

  int GetSharedEmmMessage(
          Pointer<Uint16> pwLength, Pointer<Pointer<Uint8>> ppbMessage) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint16> pwLength,
                      Pointer<Pointer<Uint8>> ppbMessage)>()(
          ptr.ref.lpVtbl, pwLength, ppbMessage);

  int GetIndividualEmmMessage(Pointer<COMObject> pUnknown,
          Pointer<Uint16> pwLength, Pointer<Pointer<Uint8>> ppbMessage) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint16> pwLength,
                      Pointer<Pointer<Uint8>> ppbMessage)>()(
          ptr.ref.lpVtbl, pUnknown, pwLength, ppbMessage);
