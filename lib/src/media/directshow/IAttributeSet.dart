...
class IAttributeSet extends IUnknown {
  ...
  int SetAttrib(GUID guidAttribute, Pointer<Uint8> pbAttribute,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, GUID guidAttribute,
                      Pointer<Uint8> pbAttribute, int dwAttributeLength)>()(
          ptr.ref.lpVtbl, guidAttribute, pbAttribute, dwAttributeLength);
}
