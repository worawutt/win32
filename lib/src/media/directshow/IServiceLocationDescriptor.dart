...
class IServiceLocationDescriptor extends IUnknown {
  ...
  int GetPCR_PID(Pointer<Uint16> pwVal) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
  ...
  int GetNumberOfElements(Pointer<Uint8> pbVal) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
  ...
  int GetElementStreamType(int bIndex, Pointer<Uint8> pbVal) => ptr
          .ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
  ...
  int GetElementPID(int bIndex, Pointer<Uint16> pwVal) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Uint8 bIndex, Pointer<Uint16> pwVal)>>>()
          .value
          .asFunction<
              int Function(Pointer, int bIndex, Pointer<Uint16> pwVal)>()(
      ptr.ref.lpVtbl, bIndex, pwVal);

  int GetElementLanguageCode(int bIndex, Pointer<Uint8> LangCode) =>
