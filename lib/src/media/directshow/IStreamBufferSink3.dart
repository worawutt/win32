...
class IStreamBufferSink3 extends IStreamBufferSink2 {
  ...
  int SetAvailableFilter(Pointer<Int64> prtMin) => ptr.ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Int64> prtMin)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, Pointer<Int64> prtMin)>()(ptr.ref.lpVtbl, prtMin);
}
