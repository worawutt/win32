...
class ITuneRequestInfoEx extends ITuneRequestInfo {
  ...
  int CreateComponentListEx(Pointer<COMObject> CurrentRequest,
      ...
      ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> CurrentRequest,
                          Pointer<Pointer<COMObject>> ppCurPMT)>>>()
          .value
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<COMObject>>
                      ppCurPMT)>()(ptr.ref.lpVtbl, CurrentRequest, ppCurPMT);
}
