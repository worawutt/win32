...
class IMSVidDevice extends IDispatch {
  ...
  set Power(int value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(9)
        .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int16 Power)>>>()
        .value
        .asFunction<int Function(Pointer, int Power)>()(ptr.ref.lpVtbl, value);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int16> Power)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int16> Power)>()(
          ptr.ref.lpVtbl, retValuePtr);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<Utf16>> Clsid)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<Utf16>> Clsid)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  int get__Category(Pointer<GUID> Guid) => ptr.ref.lpVtbl.value
      .elementAt(13)
      .cast<
          Pointer<
  ...
  int get__ClassID(Pointer<GUID> Clsid) => ptr.ref.lpVtbl.value
      .elementAt(14)
      .cast<
          Pointer<
  ...
  int IsEqualDevice(Pointer<COMObject> Device, Pointer<Int16> IsEqual) =>
      ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(Pointer, Pointer<COMObject> Device,
                  Pointer<Int16> IsEqual)>()(ptr.ref.lpVtbl, Device, IsEqual);
}
