...
class IConfigInterleaving extends IUnknown {
  ...
  int put_Interleaving(
          Pointer<Int64> prtInterleave, Pointer<Int64> prtPreroll) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int64> prtInterleave,
                              Pointer<Int64> prtPreroll)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int64> prtInterleave,
                      Pointer<Int64> prtPreroll)>()(
          ptr.ref.lpVtbl, prtInterleave, prtPreroll);
