...
class IDVB_EIT extends IUnknown {
  ...
  int GetSegmentLastSectionNumber(Pointer<Uint8> pbVal) => ptr.ref.lpVtbl.value
      .elementAt(8)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Uint8> pbVal)>>>()
  ...
  int GetLastTableId(Pointer<Uint8> pbVal) => ptr.ref.lpVtbl.value
      .elementAt(9)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Uint8> pbVal)>>>()
  ...
  int GetRecordEventId(int dwRecordIndex, Pointer<Uint16> pwVal) => ptr
      .ref.lpVtbl.value
      .elementAt(11)
      .cast<
          Pointer<
  ...
  int GetRecordStartTime(
          int dwRecordIndex, Pointer<MPEG_DATE_AND_TIME> pmdtVal) =>
      ptr.ref.lpVtbl.value
              .elementAt(12)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, int dwRecordIndex,
                      Pointer<MPEG_DATE_AND_TIME> pmdtVal)>()(
          ptr.ref.lpVtbl, dwRecordIndex, pmdtVal);

  int GetRecordDuration(int dwRecordIndex, Pointer<MPEG_TIME> pmdVal) =>
      ptr.ref.lpVtbl.value
              .elementAt(13)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, int dwRecordIndex, Pointer<MPEG_TIME> pmdVal)>()(
          ptr.ref.lpVtbl, dwRecordIndex, pmdVal);
  ...
  int GetNextTable(Pointer<Pointer<COMObject>> ppEIT) => ptr.ref.lpVtbl.value
          .elementAt(20)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> ppEIT)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> ppEIT)>()(
      ptr.ref.lpVtbl, ppEIT);
