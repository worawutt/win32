...
class IComponents extends IDispatch {
  ...
  int EnumComponents(Pointer<Pointer<COMObject>> ppNewEnum) => ptr
          .ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
  ...
  int get_Item(VARIANT Index, Pointer<Pointer<COMObject>> ppComponent) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, VARIANT Index,
                      Pointer<Pointer<COMObject>> ppComponent)>()(
          ptr.ref.lpVtbl, Index, ppComponent);

  int Add(Pointer<COMObject> Component, Pointer<VARIANT> NewIndex) =>
      ptr.ref.lpVtbl.value
              .elementAt(11)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<COMObject> Component,
                              Pointer<VARIANT> NewIndex)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> Component,
                      Pointer<VARIANT> NewIndex)>()(
          ptr.ref.lpVtbl, Component, NewIndex);
  ...
  int put_Item(VARIANT Index, Pointer<COMObject> ppComponent) => ptr
          .ref.lpVtbl.value
          .elementAt(14)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, VARIANT Index, Pointer<COMObject> ppComponent)>()(
      ptr.ref.lpVtbl, Index, ppComponent);
}
