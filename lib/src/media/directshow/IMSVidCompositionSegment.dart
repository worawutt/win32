...
class IMSVidCompositionSegment extends IMSVidGraphSegment {
  ...
  int Compose(Pointer<COMObject> upstream, Pointer<COMObject> downstream) =>
      ptr.ref.lpVtbl.value
              .elementAt(19)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<COMObject> upstream,
                              Pointer<COMObject> downstream)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> upstream,
                      Pointer<COMObject> downstream)>()(
          ptr.ref.lpVtbl, upstream, downstream);
  ...
  Pointer<COMObject> get Up {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> upstream)>()(
  ...
  Pointer<COMObject> get Down {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> downstream)>()(
          ptr.ref.lpVtbl, retValuePtr);
