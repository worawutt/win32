...
class IFilterChain extends IUnknown {
  ...
  int StartChain(
          Pointer<COMObject> pStartFilter, Pointer<COMObject> pEndFilter) =>
      ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pStartFilter,
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<COMObject>
                      pEndFilter)>()(ptr.ref.lpVtbl, pStartFilter, pEndFilter);
