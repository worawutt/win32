...
class IMPEG2ComponentType extends ILanguageComponentType {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> MP2StreamType)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int32> MP2StreamType)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  set StreamType(int value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<Int32 Function(Pointer, Int32 MP2StreamType)>>>()
        .value
        .asFunction<
            int Function(Pointer, int MP2StreamType)>()(ptr.ref.lpVtbl, value);
