...
class IDVB_BAT extends IUnknown {
  ...
  int GetBouquetId(Pointer<Uint16> pwVal) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
  ...
  int GetNextTable(Pointer<Pointer<COMObject>> ppBAT) => ptr.ref.lpVtbl.value
          .elementAt(16)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> ppBAT)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> ppBAT)>()(
      ptr.ref.lpVtbl, ppBAT);
