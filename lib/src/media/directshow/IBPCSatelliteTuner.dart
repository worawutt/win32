...
class IBPCSatelliteTuner extends IAMTuner {
  ...
  int
      get_DefaultSubChannelTypes(Pointer<Int32> plDefaultVideoType,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<Int32> plDefaultVideoType,
                          Pointer<Int32> plDefaultAudioType)>()(
              ptr.ref.lpVtbl, plDefaultVideoType, plDefaultAudioType);

  int put_DefaultSubChannelTypes(
          int lDefaultVideoType, int lDefaultAudioType) =>
      ptr.ref.lpVtbl.value
              .elementAt(19)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 lDefaultVideoType,
                              Int32 lDefaultAudioType)>>>()
              .value
              .asFunction<
                  int Function(
                      Pointer, int lDefaultVideoType, int lDefaultAudioType)>()(
          ptr.ref.lpVtbl, lDefaultVideoType, lDefaultAudioType);
