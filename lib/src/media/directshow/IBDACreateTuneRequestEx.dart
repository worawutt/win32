...
class IBDACreateTuneRequestEx extends IUnknown {
  ...
  int CreateTuneRequestEx(Pointer<GUID> TuneRequestIID,
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<GUID> TuneRequestIID,
                              Pointer<Pointer<COMObject>> TuneRequest)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<GUID> TuneRequestIID,
                      Pointer<Pointer<COMObject>> TuneRequest)>()(
          ptr.ref.lpVtbl, TuneRequestIID, TuneRequest);
}
