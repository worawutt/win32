...
class IGuideDataLoader extends IUnknown {
  ...
  int Init(Pointer<COMObject> pGuideStore) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> pGuideStore)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<COMObject> pGuideStore)>()(ptr.ref.lpVtbl, pGuideStore);
