...
class IMSVidStreamBufferSinkEvent3 extends IMSVidStreamBufferSinkEvent2 {
  ...
  int LicenseChange(int dwProt) => ptr.ref.lpVtbl.value
      .elementAt(13)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 dwProt)>>>()
      .value
      .asFunction<int Function(Pointer, int dwProt)>()(ptr.ref.lpVtbl, dwProt);
}
