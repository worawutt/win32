...
class IMSVidGenericSink extends IMSVidOutputDevice {
  ...
  int SetSinkFilter(Pointer<Utf16> bstrName) => ptr.ref.lpVtbl.value
          .elementAt(16)
          .cast<
              Pointer<
                  NativeFunction<
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> pStreams)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> pStreams)>()(
  ...
  set SinkStreams(int value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(18)
        .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 Streams)>>>()
        .value
        .asFunction<
            int Function(Pointer, int Streams)>()(ptr.ref.lpVtbl, value);
