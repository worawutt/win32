...
class IScanningTuner extends ITuner {
  ...
  int ScanUp(int MillisecondsPause) => ptr.ref.lpVtbl.value
          .elementAt(15)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 MillisecondsPause)>>>()
          .value
          .asFunction<int Function(Pointer, int MillisecondsPause)>()(
      ptr.ref.lpVtbl, MillisecondsPause);

  int ScanDown(int MillisecondsPause) => ptr.ref.lpVtbl.value
          .elementAt(16)
          .cast<
              Pointer<
                  NativeFunction<
