...
class IFilterGraph3 extends IFilterGraph2 {
  ...
  int SetSyncSourceEx(Pointer<COMObject> pClockForMostOfFilterGraph,
          Pointer<COMObject> pClockForFilter, Pointer<COMObject> pFilter) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pClockForFilter,
                      Pointer<COMObject> pFilter)>()(
          ptr.ref.lpVtbl, pClockForMostOfFilterGraph, pClockForFilter, pFilter);
}
