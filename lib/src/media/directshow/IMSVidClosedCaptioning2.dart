...
class IMSVidClosedCaptioning2 extends IMSVidClosedCaptioning {
  ...
  int get Service {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<Int32 Function(Pointer, Pointer<Int32> On)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer, Pointer<Int32> On)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  set Service(int value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(19)
        .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 On)>>>()
        .value
