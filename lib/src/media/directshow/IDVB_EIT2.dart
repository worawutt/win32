...
class IDVB_EIT2 extends IDVB_EIT {
  ...
  int GetSegmentInfo(Pointer<Uint8> pbTid, Pointer<Uint8> pbSegment) => ptr
      .ref.lpVtbl.value
      .elementAt(24)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Uint8> pbTid,
                      Pointer<Uint8> pbSegment)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<Uint8> pbTid,
              Pointer<Uint8> pbSegment)>()(ptr.ref.lpVtbl, pbTid, pbSegment);

  int GetRecordSection(int dwRecordIndex, Pointer<Uint8> pbVal) => ptr
      .ref.lpVtbl.value
      .elementAt(25)
      .cast<
          Pointer<
