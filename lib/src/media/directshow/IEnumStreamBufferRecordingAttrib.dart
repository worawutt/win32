...
class IEnumStreamBufferRecordingAttrib extends IUnknown {
  ...
  int Next(int cRequest, Pointer<STREAMBUFFER_ATTRIBUTE> pStreamBufferAttribute,
      ...
      ptr.ref.lpVtbl.value
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer,
                              Uint32 cRequest,
                              Pointer<STREAMBUFFER_ATTRIBUTE>
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint32> pcReceived)>()(
          ptr.ref.lpVtbl, cRequest, pStreamBufferAttribute, pcReceived);
  ...
  int Clone(Pointer<Pointer<COMObject>> ppIEnumStreamBufferAttrib) =>
      ptr.ref.lpVtbl.value
              .elementAt(6)
              .cast<
                  Pointer<
          ...
          ptr.ref.lpVtbl, ppIEnumStreamBufferAttrib);
}
