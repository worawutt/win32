...
class ISIInbandEPG extends IUnknown {
  ...
  int IsSIEPGScanRunning(Pointer<Int32> bRunning) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> bRunning)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Int32> bRunning)>()(
      ptr.ref.lpVtbl, bRunning);
}
