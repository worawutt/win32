...
class IBDA_IPSinkControl extends IUnknown {
  ...
  int GetMulticastList(
          Pointer<Uint32> pulcbSize, Pointer<Pointer<Uint8>> pbBuffer) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Uint32> pulcbSize,
                              Pointer<Pointer<Uint8>> pbBuffer)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> pulcbSize,
                      Pointer<Pointer<Uint8>> pbBuffer)>()(
          ptr.ref.lpVtbl, pulcbSize, pbBuffer);
