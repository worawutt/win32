...
class IBroadcastEventEx extends IBroadcastEvent {
  ...
  int FireEx(GUID EventID, int Param1, int Param2, int Param3, int Param4) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, GUID EventID, Uint32 Param1,
                              Uint32 Param2, Uint32 Param3, Uint32 Param4)>>>()
              .value
              .asFunction<
                  int Function(Pointer, GUID EventID, int Param1, int Param2,
                      int Param3, int Param4)>()(
          ptr.ref.lpVtbl, EventID, Param1, Param2, Param3, Param4);
}
