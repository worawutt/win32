...
class IAVIEditStream extends IUnknown {
  ...
  int Paste(Pointer<Int32> plPos, Pointer<Int32> plLength,
          Pointer<COMObject> pstream, int lStart, int lEnd) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
  ...
  int Clone(Pointer<Pointer<COMObject>> ppResult) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
