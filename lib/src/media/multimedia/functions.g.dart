...
int mciDriverNotify(int hwndCallback, int wDeviceID, int uStatus) =>
    _mciDriverNotify(hwndCallback, wDeviceID, uStatus);

late final _mciDriverNotify = _winmm.lookupFunction<
    Int32 Function(IntPtr hwndCallback, Uint32 wDeviceID, Uint32 uStatus),
    int Function(
        int hwndCallback, int wDeviceID, int uStatus)>('mciDriverNotify');

int mciDriverYield(int wDeviceID) => _mciDriverYield(wDeviceID);

late final _mciDriverYield = _winmm.lookupFunction<
    Uint32 Function(Uint32 wDeviceID),
    int Function(int wDeviceID)>('mciDriverYield');

int mciFreeCommandResource(int wTable) => _mciFreeCommandResource(wTable);

late final _mciFreeCommandResource = _winmm.lookupFunction<
    Int32 Function(Uint32 wTable),
    int Function(int wTable)>('mciFreeCommandResource');

int mciGetCreatorTask(int mciId) => _mciGetCreatorTask(mciId);

late final _mciGetCreatorTask = _winmm.lookupFunction<
    IntPtr Function(Uint32 mciId),
    int Function(int mciId)>('mciGetCreatorTask');
...
int mciGetDriverData(int wDeviceID) => _mciGetDriverData(wDeviceID);

late final _mciGetDriverData = _winmm.lookupFunction<
    IntPtr Function(Uint32 wDeviceID),
    int Function(int wDeviceID)>('mciGetDriverData');
...
Pointer<NativeFunction<YIELDPROC>> mciGetYieldProc(
        int mciId, Pointer<Uint32> pdwYieldData) =>
    _mciGetYieldProc(mciId, pdwYieldData);

late final _mciGetYieldProc = _winmm.lookupFunction<
    Pointer<NativeFunction<YIELDPROC>> Function(
        Uint32 mciId, Pointer<Uint32> pdwYieldData),
    Pointer<NativeFunction<YIELDPROC>> Function(
        int mciId, Pointer<Uint32> pdwYieldData)>('mciGetYieldProc');

int mciLoadCommandResource(
        int hInstance, Pointer<Utf16> lpResName, int wType) =>
    _mciLoadCommandResource(hInstance, lpResName, wType);

late final _mciLoadCommandResource = _winmm.lookupFunction<
    Uint32 Function(IntPtr hInstance, Pointer<Utf16> lpResName, Uint32 wType),
    int Function(int hInstance, Pointer<Utf16> lpResName,
        int wType)>('mciLoadCommandResource');
...
int mciSetDriverData(int wDeviceID, int dwData) =>
    _mciSetDriverData(wDeviceID, dwData);

late final _mciSetDriverData = _winmm.lookupFunction<
    Int32 Function(Uint32 wDeviceID, IntPtr dwData),
    int Function(int wDeviceID, int dwData)>('mciSetDriverData');

int mciSetYieldProc(int mciId, Pointer<NativeFunction<YIELDPROC>> fpYieldProc,
        int dwYieldData) =>
    _mciSetYieldProc(mciId, fpYieldProc, dwYieldData);

late final _mciSetYieldProc = _winmm.lookupFunction<
    Int32 Function(Uint32 mciId, Pointer<NativeFunction<YIELDPROC>> fpYieldProc,
        Uint32 dwYieldData),
    int Function(int mciId, Pointer<NativeFunction<YIELDPROC>> fpYieldProc,
        int dwYieldData)>('mciSetYieldProc');
...
int ICOpenFunction(
        int fccType, int fccHandler, int wMode, Pointer lpfnHandler) =>
    _ICOpenFunction(fccType, fccHandler, wMode, lpfnHandler);

late final _ICOpenFunction = _msvfw32.lookupFunction<
    IntPtr Function(
        Uint32 fccType, Uint32 fccHandler, Uint32 wMode, Pointer lpfnHandler),
    int Function(int fccType, int fccHandler, int wMode,
        Pointer lpfnHandler)>('ICOpenFunction');
...
int AVIFileAddRef(Pointer<COMObject> pfile) => _AVIFileAddRef(pfile);

late final _AVIFileAddRef = _avifil32.lookupFunction<
    Uint32 Function(Pointer<COMObject> pfile),
    int Function(Pointer<COMObject> pfile)>('AVIFileAddRef');

int AVIFileCreateStream(Pointer<COMObject> pfile,
        Pointer<Pointer<COMObject>> ppavi, Pointer<AVISTREAMINFO> psi) =>
    _AVIFileCreateStream(pfile, ppavi, psi);

late final _AVIFileCreateStream = _avifil32.lookupFunction<
    Int32 Function(Pointer<COMObject> pfile, Pointer<Pointer<COMObject>> ppavi,
        Pointer<AVISTREAMINFO> psi),
    int Function(Pointer<COMObject> pfile, Pointer<Pointer<COMObject>> ppavi,
        Pointer<AVISTREAMINFO> psi)>('AVIFileCreateStreamW');

int AVIFileEndRecord(Pointer<COMObject> pfile) => _AVIFileEndRecord(pfile);

late final _AVIFileEndRecord = _avifil32.lookupFunction<
    Int32 Function(Pointer<COMObject> pfile),
    int Function(Pointer<COMObject> pfile)>('AVIFileEndRecord');
...
int AVIFileGetStream(Pointer<COMObject> pfile,
        Pointer<Pointer<COMObject>> ppavi, int fccType, int lParam) =>
    _AVIFileGetStream(pfile, ppavi, fccType, lParam);

late final _AVIFileGetStream = _avifil32.lookupFunction<
    Int32 Function(Pointer<COMObject> pfile, Pointer<Pointer<COMObject>> ppavi,
        Uint32 fccType, Int32 lParam),
    int Function(Pointer<COMObject> pfile, Pointer<Pointer<COMObject>> ppavi,
        int fccType, int lParam)>('AVIFileGetStream');

int AVIFileInfo(
        Pointer<COMObject> pfile, Pointer<AVIFILEINFO> pfi, int lSize) =>
    _AVIFileInfo(pfile, pfi, lSize);

late final _AVIFileInfo = _avifil32.lookupFunction<
    Int32 Function(
        Pointer<COMObject> pfile, Pointer<AVIFILEINFO> pfi, Int32 lSize),
    int Function(Pointer<COMObject> pfile, Pointer<AVIFILEINFO> pfi,
        int lSize)>('AVIFileInfoW');
...
int AVIFileOpen(Pointer<Pointer<COMObject>> ppfile, Pointer<Utf16> szFile,
        int uMode, Pointer<GUID> lpHandler) =>
    _AVIFileOpen(ppfile, szFile, uMode, lpHandler);

late final _AVIFileOpen = _avifil32.lookupFunction<
    Int32 Function(Pointer<Pointer<COMObject>> ppfile, Pointer<Utf16> szFile,
        Uint32 uMode, Pointer<GUID> lpHandler),
    int Function(Pointer<Pointer<COMObject>> ppfile, Pointer<Utf16> szFile,
        int uMode, Pointer<GUID> lpHandler)>('AVIFileOpenW');

int AVIFileReadData(Pointer<COMObject> pfile, int ckid, Pointer lpData,
        Pointer<Int32> lpcbData) =>
    _AVIFileReadData(pfile, ckid, lpData, lpcbData);

late final _AVIFileReadData = _avifil32.lookupFunction<
    Int32 Function(Pointer<COMObject> pfile, Uint32 ckid, Pointer lpData,
        Pointer<Int32> lpcbData),
    int Function(Pointer<COMObject> pfile, int ckid, Pointer lpData,
        Pointer<Int32> lpcbData)>('AVIFileReadData');

int AVIFileRelease(Pointer<COMObject> pfile) => _AVIFileRelease(pfile);

late final _AVIFileRelease = _avifil32.lookupFunction<
    Uint32 Function(Pointer<COMObject> pfile),
    int Function(Pointer<COMObject> pfile)>('AVIFileRelease');

int AVIFileWriteData(
        Pointer<COMObject> pfile, int ckid, Pointer lpData, int cbData) =>
    _AVIFileWriteData(pfile, ckid, lpData, cbData);

late final _AVIFileWriteData = _avifil32.lookupFunction<
    Int32 Function(
        Pointer<COMObject> pfile, Uint32 ckid, Pointer lpData, Int32 cbData),
    int Function(Pointer<COMObject> pfile, int ckid, Pointer lpData,
        int cbData)>('AVIFileWriteData');

int AVIGetFromClipboard(Pointer<Pointer<COMObject>> lppf) =>
    _AVIGetFromClipboard(lppf);

late final _AVIGetFromClipboard = _avifil32.lookupFunction<
    Int32 Function(Pointer<Pointer<COMObject>> lppf),
    int Function(Pointer<Pointer<COMObject>> lppf)>('AVIGetFromClipboard');
...
int AVIMakeFileFromStreams(Pointer<Pointer<COMObject>> ppfile, int nStreams,
...
late final _AVIMakeFileFromStreams = _avifil32.lookupFunction<
    Int32 Function(Pointer<Pointer<COMObject>> ppfile, Int32 nStreams,
        Pointer<Pointer<COMObject>> papStreams),
    int Function(Pointer<Pointer<COMObject>> ppfile, int nStreams,
        Pointer<Pointer<COMObject>> papStreams)>('AVIMakeFileFromStreams');

int AVIMakeStreamFromClipboard(
        int cfFormat, int hGlobal, Pointer<Pointer<COMObject>> ppstream) =>
    _AVIMakeStreamFromClipboard(cfFormat, hGlobal, ppstream);

late final _AVIMakeStreamFromClipboard = _avifil32.lookupFunction<
    Int32 Function(
        Uint32 cfFormat, IntPtr hGlobal, Pointer<Pointer<COMObject>> ppstream),
    int Function(int cfFormat, int hGlobal,
        Pointer<Pointer<COMObject>> ppstream)>('AVIMakeStreamFromClipboard');

int AVIPutFileOnClipboard(Pointer<COMObject> pf) => _AVIPutFileOnClipboard(pf);

late final _AVIPutFileOnClipboard = _avifil32.lookupFunction<
    Int32 Function(Pointer<COMObject> pf),
    int Function(Pointer<COMObject> pf)>('AVIPutFileOnClipboard');
...
int AVIStreamAddRef(Pointer<COMObject> pavi) => _AVIStreamAddRef(pavi);

late final _AVIStreamAddRef = _avifil32.lookupFunction<
    Uint32 Function(Pointer<COMObject> pavi),
    int Function(Pointer<COMObject> pavi)>('AVIStreamAddRef');

int AVIStreamBeginStreaming(
        Pointer<COMObject> pavi, int lStart, int lEnd, int lRate) =>
    _AVIStreamBeginStreaming(pavi, lStart, lEnd, lRate);

late final _AVIStreamBeginStreaming = _avifil32.lookupFunction<
    Int32 Function(
        Pointer<COMObject> pavi, Int32 lStart, Int32 lEnd, Int32 lRate),
    int Function(Pointer<COMObject> pavi, int lStart, int lEnd,
        int lRate)>('AVIStreamBeginStreaming');

int AVIStreamCreate(Pointer<Pointer<COMObject>> ppavi, int lParam1, int lParam2,
        Pointer<GUID> pclsidHandler) =>
    _AVIStreamCreate(ppavi, lParam1, lParam2, pclsidHandler);

late final _AVIStreamCreate = _avifil32.lookupFunction<
    Int32 Function(Pointer<Pointer<COMObject>> ppavi, Int32 lParam1,
        Int32 lParam2, Pointer<GUID> pclsidHandler),
    int Function(Pointer<Pointer<COMObject>> ppavi, int lParam1, int lParam2,
        Pointer<GUID> pclsidHandler)>('AVIStreamCreate');

int AVIStreamEndStreaming(Pointer<COMObject> pavi) =>
    _AVIStreamEndStreaming(pavi);

late final _AVIStreamEndStreaming = _avifil32.lookupFunction<
    Int32 Function(Pointer<COMObject> pavi),
    int Function(Pointer<COMObject> pavi)>('AVIStreamEndStreaming');

int AVIStreamFindSample(Pointer<COMObject> pavi, int lPos, int lFlags) =>
    _AVIStreamFindSample(pavi, lPos, lFlags);

late final _AVIStreamFindSample = _avifil32.lookupFunction<
    Int32 Function(Pointer<COMObject> pavi, Int32 lPos, Int32 lFlags),
    int Function(
        Pointer<COMObject> pavi, int lPos, int lFlags)>('AVIStreamFindSample');

Pointer AVIStreamGetFrame(Pointer<COMObject> pg, int lPos) =>
    _AVIStreamGetFrame(pg, lPos);

late final _AVIStreamGetFrame = _avifil32.lookupFunction<
    Pointer Function(Pointer<COMObject> pg, Int32 lPos),
    Pointer Function(Pointer<COMObject> pg, int lPos)>('AVIStreamGetFrame');

int AVIStreamGetFrameClose(Pointer<COMObject> pg) =>
    _AVIStreamGetFrameClose(pg);

late final _AVIStreamGetFrameClose = _avifil32.lookupFunction<
    Int32 Function(Pointer<COMObject> pg),
    int Function(Pointer<COMObject> pg)>('AVIStreamGetFrameClose');

Pointer<COMObject> AVIStreamGetFrameOpen(
        Pointer<COMObject> pavi, Pointer<BITMAPINFOHEADER> lpbiWanted) =>
...
late final _AVIStreamGetFrameOpen = _avifil32.lookupFunction<
    Pointer<COMObject> Function(
        Pointer<COMObject> pavi, Pointer<BITMAPINFOHEADER> lpbiWanted),
    Pointer<COMObject> Function(Pointer<COMObject> pavi,
        Pointer<BITMAPINFOHEADER> lpbiWanted)>('AVIStreamGetFrameOpen');

int AVIStreamInfo(
        Pointer<COMObject> pavi, Pointer<AVISTREAMINFO> psi, int lSize) =>
    _AVIStreamInfo(pavi, psi, lSize);

late final _AVIStreamInfo = _avifil32.lookupFunction<
    Int32 Function(
        Pointer<COMObject> pavi, Pointer<AVISTREAMINFO> psi, Int32 lSize),
    int Function(Pointer<COMObject> pavi, Pointer<AVISTREAMINFO> psi,
        int lSize)>('AVIStreamInfoW');

int AVIStreamLength(Pointer<COMObject> pavi) => _AVIStreamLength(pavi);

late final _AVIStreamLength = _avifil32.lookupFunction<
    Int32 Function(Pointer<COMObject> pavi),
    int Function(Pointer<COMObject> pavi)>('AVIStreamLength');
...
late final _AVIStreamOpenFromFile = _avifil32.lookupFunction<
    Int32 Function(Pointer<Pointer<COMObject>> ppavi, Pointer<Utf16> szFile,
...
int AVIStreamReadData(
        Pointer<COMObject> pavi, int fcc, Pointer lp, Pointer<Int32> lpcb) =>
    _AVIStreamReadData(pavi, fcc, lp, lpcb);

late final _AVIStreamReadData = _avifil32.lookupFunction<
    Int32 Function(
        Pointer<COMObject> pavi, Uint32 fcc, Pointer lp, Pointer<Int32> lpcb),
    int Function(Pointer<COMObject> pavi, int fcc, Pointer lp,
        Pointer<Int32> lpcb)>('AVIStreamReadData');

int AVIStreamReadFormat(Pointer<COMObject> pavi, int lPos, Pointer lpFormat,
...
late final _AVIStreamReadFormat = _avifil32.lookupFunction<
    Int32 Function(Pointer<COMObject> pavi, Int32 lPos, Pointer lpFormat,
        Pointer<Int32> lpcbFormat),
    int Function(Pointer<COMObject> pavi, int lPos, Pointer lpFormat,
        Pointer<Int32> lpcbFormat)>('AVIStreamReadFormat');

int AVIStreamRelease(Pointer<COMObject> pavi) => _AVIStreamRelease(pavi);

late final _AVIStreamRelease = _avifil32.lookupFunction<
    Uint32 Function(Pointer<COMObject> pavi),
    int Function(Pointer<COMObject> pavi)>('AVIStreamRelease');

int AVIStreamSampleToTime(Pointer<COMObject> pavi, int lSample) =>
    _AVIStreamSampleToTime(pavi, lSample);

late final _AVIStreamSampleToTime = _avifil32.lookupFunction<
    Int32 Function(Pointer<COMObject> pavi, Int32 lSample),
    int Function(
        Pointer<COMObject> pavi, int lSample)>('AVIStreamSampleToTime');

int AVIStreamSetFormat(
        Pointer<COMObject> pavi, int lPos, Pointer lpFormat, int cbFormat) =>
    _AVIStreamSetFormat(pavi, lPos, lpFormat, cbFormat);

late final _AVIStreamSetFormat = _avifil32.lookupFunction<
    Int32 Function(
        Pointer<COMObject> pavi, Int32 lPos, Pointer lpFormat, Int32 cbFormat),
    int Function(Pointer<COMObject> pavi, int lPos, Pointer lpFormat,
        int cbFormat)>('AVIStreamSetFormat');

int AVIStreamStart(Pointer<COMObject> pavi) => _AVIStreamStart(pavi);

late final _AVIStreamStart = _avifil32.lookupFunction<
    Int32 Function(Pointer<COMObject> pavi),
    int Function(Pointer<COMObject> pavi)>('AVIStreamStart');

int AVIStreamTimeToSample(Pointer<COMObject> pavi, int lTime) =>
    _AVIStreamTimeToSample(pavi, lTime);

late final _AVIStreamTimeToSample = _avifil32.lookupFunction<
    Int32 Function(Pointer<COMObject> pavi, Int32 lTime),
    int Function(Pointer<COMObject> pavi, int lTime)>('AVIStreamTimeToSample');
...
int AVIStreamWriteData(Pointer<COMObject> pavi, int fcc, Pointer lp, int cb) =>
    _AVIStreamWriteData(pavi, fcc, lp, cb);

late final _AVIStreamWriteData = _avifil32.lookupFunction<
    Int32 Function(Pointer<COMObject> pavi, Uint32 fcc, Pointer lp, Int32 cb),
    int Function(Pointer<COMObject> pavi, int fcc, Pointer lp,
        int cb)>('AVIStreamWriteData');

int CreateEditableStream(
        Pointer<Pointer<COMObject>> ppsEditable, Pointer<COMObject> psSource) =>
    _CreateEditableStream(ppsEditable, psSource);

late final _CreateEditableStream = _avifil32.lookupFunction<
    Int32 Function(
        Pointer<Pointer<COMObject>> ppsEditable, Pointer<COMObject> psSource),
    int Function(Pointer<Pointer<COMObject>> ppsEditable,
        Pointer<COMObject> psSource)>('CreateEditableStream');

int EditStreamClone(
        Pointer<COMObject> pavi, Pointer<Pointer<COMObject>> ppResult) =>
    _EditStreamClone(pavi, ppResult);

late final _EditStreamClone = _avifil32.lookupFunction<
    Int32 Function(
        Pointer<COMObject> pavi, Pointer<Pointer<COMObject>> ppResult),
    int Function(Pointer<COMObject> pavi,
        Pointer<Pointer<COMObject>> ppResult)>('EditStreamClone');

int EditStreamCopy(Pointer<COMObject> pavi, Pointer<Int32> plStart,
        Pointer<Int32> plLength, Pointer<Pointer<COMObject>> ppResult) =>
    _EditStreamCopy(pavi, plStart, plLength, ppResult);

late final _EditStreamCopy = _avifil32.lookupFunction<
    Int32 Function(Pointer<COMObject> pavi, Pointer<Int32> plStart,
        Pointer<Int32> plLength, Pointer<Pointer<COMObject>> ppResult),
    int Function(
        Pointer<COMObject> pavi,
        Pointer<Int32> plStart,
        Pointer<Int32> plLength,
        Pointer<Pointer<COMObject>> ppResult)>('EditStreamCopy');

int EditStreamCut(Pointer<COMObject> pavi, Pointer<Int32> plStart,
        Pointer<Int32> plLength, Pointer<Pointer<COMObject>> ppResult) =>
...
late final _EditStreamCut = _avifil32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Int32> plStart,
        Pointer<Int32> plLength,
        Pointer<Pointer<COMObject>> ppResult)>('EditStreamCut');
...
late final _EditStreamPaste = _avifil32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<COMObject> pstream,
        int lStart,
        int lEnd)>('EditStreamPaste');

int EditStreamSetInfo(
        Pointer<COMObject> pavi, Pointer<AVISTREAMINFO> lpInfo, int cbInfo) =>
    _EditStreamSetInfo(pavi, lpInfo, cbInfo);

late final _EditStreamSetInfo = _avifil32.lookupFunction<
    Int32 Function(
        Pointer<COMObject> pavi, Pointer<AVISTREAMINFO> lpInfo, Int32 cbInfo),
    int Function(Pointer<COMObject> pavi, Pointer<AVISTREAMINFO> lpInfo,
        int cbInfo)>('EditStreamSetInfoW');

int EditStreamSetName(Pointer<COMObject> pavi, Pointer<Utf16> lpszName) =>
    _EditStreamSetName(pavi, lpszName);

late final _EditStreamSetName = _avifil32.lookupFunction<
    Int32 Function(Pointer<COMObject> pavi, Pointer<Utf16> lpszName),
    int Function(Pointer<COMObject> pavi,
        Pointer<Utf16> lpszName)>('EditStreamSetNameW');
