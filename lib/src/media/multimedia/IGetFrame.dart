...
class IGetFrame extends IUnknown {
  ...
  Pointer GetFrame(int lPos) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<Pointer<NativeFunction<Pointer Function(Pointer, Int32 lPos)>>>()
      .value
      .asFunction<Pointer Function(Pointer, int lPos)>()(ptr.ref.lpVtbl, lPos);
  ...
  int Begin(int lStart, int lEnd, int lRate) => ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Int32 lStart, Int32 lEnd, Int32 lRate)>>>()
          .value
          .asFunction<int Function(Pointer, int lStart, int lEnd, int lRate)>()(
      ptr.ref.lpVtbl, lStart, lEnd, lRate);
      ...
      ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(
                  ...
                  int y,
                  int dx,
                  int dy)>()(ptr.ref.lpVtbl, lpbi, lpBits, x, y, dx, dy);
}
