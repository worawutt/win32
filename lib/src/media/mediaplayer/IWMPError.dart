...
class IWMPError extends IDispatch {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> plNumErrors)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int32> plNumErrors)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  int get_item(int dwIndex, Pointer<Pointer<COMObject>> ppErrorItem) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int dwIndex,
                      Pointer<Pointer<COMObject>> ppErrorItem)>()(
          ptr.ref.lpVtbl, dwIndex, ppErrorItem);
