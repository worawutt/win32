...
class IWMPStringCollection2 extends IWMPStringCollection {
  ...
  int isIdentical(
          Pointer<COMObject> pIWMPStringCollection2, Pointer<Int16> pvbool) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pIWMPStringCollection2,
                      Pointer<Int16> pvbool)>()(
          ptr.ref.lpVtbl, pIWMPStringCollection2, pvbool);

  int getItemInfo(int lCollectionIndex, Pointer<Utf16> bstrItemName,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> bstrItemName,
                      Pointer<Pointer<Utf16>> pbstrValue)>()(
          ptr.ref.lpVtbl, lCollectionIndex, bstrItemName, pbstrValue);

  int getAttributeCountByType(int lCollectionIndex, Pointer<Utf16> bstrType,
          Pointer<Utf16> bstrLanguage, Pointer<Int32> plCount) =>
      ptr.ref.lpVtbl.value
              .elementAt(11)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> bstrLanguage,
                      Pointer<Int32> plCount)>()(
          ptr.ref.lpVtbl, lCollectionIndex, bstrType, bstrLanguage, plCount);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> bstrLanguage,
                      int lAttributeIndex,
                      Pointer<VARIANT> pvarValue)>()(ptr.ref.lpVtbl,
          lCollectionIndex, bstrType, bstrLanguage, lAttributeIndex, pvarValue);
}
