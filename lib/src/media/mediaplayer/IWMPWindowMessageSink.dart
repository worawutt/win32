...
class IWMPWindowMessageSink extends IUnknown {
  ...
  int OnWindowMessage(int uMsg, int wparam, int lparam, Pointer<IntPtr> plRet,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int uMsg, int wparam, int lparam,
                      Pointer<IntPtr> plRet, Pointer<Int32> pfHandled)>()(
          ptr.ref.lpVtbl, uMsg, wparam, lparam, plRet, pfHandled);
}
