...
class IWMPPlayer4 extends IWMPCore3 {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int16> pvarfIsRemote)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int16> pvarfIsRemote)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  int openPlayer(Pointer<Utf16> bstrURL) => ptr.ref.lpVtbl.value
          .elementAt(45)
          .cast<
              Pointer<
                  NativeFunction<
