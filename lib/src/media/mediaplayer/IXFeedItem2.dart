...
class IXFeedItem2 extends IXFeedItem {
  ...
  int EffectiveId(Pointer<Uint32> puiEffectiveId) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Uint32> puiEffectiveId)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> puiEffectiveId)>()(
          ptr.ref.lpVtbl, puiEffectiveId);
}
