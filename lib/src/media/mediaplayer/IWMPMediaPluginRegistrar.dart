...
class IWMPMediaPluginRegistrar extends IUnknown {
  ...
  int WMPUnRegisterPlayerPlugin(GUID guidPluginType, GUID clsid) => ptr
      .ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, GUID guidPluginType, GUID clsid)>>>()
      .value
      .asFunction<
          int Function(Pointer, GUID guidPluginType,
              GUID clsid)>()(ptr.ref.lpVtbl, guidPluginType, clsid);
}
