...
class IWMPPlayerServices2 extends IWMPPlayerServices {
  ...
  int setBackgroundProcessingPriority(Pointer<Utf16> bstrPriority) => ptr
          .ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> bstrPriority)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Utf16> bstrPriority)>()(
      ptr.ref.lpVtbl, bstrPriority);
}
