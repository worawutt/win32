...
class IWMPCdromBurn extends IUnknown {
  ...
  int isAvailable(Pointer<Utf16> bstrItem, Pointer<Int16> pIsAvailable) =>
  ...
  int getItemInfo(Pointer<Utf16> bstrItem, Pointer<Pointer<Utf16>> pbstrVal) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrItem,
                      Pointer<Pointer<Utf16>> pbstrVal)>()(
          ptr.ref.lpVtbl, bstrItem, pbstrVal);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> pwmpbf)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> pwmpbf)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set burnFormat(int value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(8)
        .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 wmpbf)>>>()
        .value
        .asFunction<int Function(Pointer, int wmpbf)>()(ptr.ref.lpVtbl, value);
  ...
  Pointer<COMObject> get burnPlaylist {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppPlaylist)>()(
          ptr.ref.lpVtbl, retValuePtr);
    ...
    final hr = ptr.ref.lpVtbl.value
        ...
        .asFunction<
            int Function(Pointer,
                Pointer<COMObject> pPlaylist)>()(ptr.ref.lpVtbl, value);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> pwmpbs)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> pwmpbs)>()(
          ptr.ref.lpVtbl, retValuePtr);
