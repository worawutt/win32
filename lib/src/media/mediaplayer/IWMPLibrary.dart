...
class IWMPLibrary extends IUnknown {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> pwmplt)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> pwmplt)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  int isIdentical(Pointer<COMObject> pIWMPLibrary, Pointer<Int16> pvbool) => ptr
      .ref.lpVtbl.value
      .elementAt(6)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> pIWMPLibrary,
                      Pointer<Int16> pvbool)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<COMObject> pIWMPLibrary,
              Pointer<Int16> pvbool)>()(ptr.ref.lpVtbl, pIWMPLibrary, pvbool);
}
