...
class IWMPGraphCreation extends IUnknown {
  ...
  int GraphCreationPreRender(
          Pointer<COMObject> pFilterGraph, Pointer<COMObject> pReserved) =>
      ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<COMObject>
                      pReserved)>()(ptr.ref.lpVtbl, pFilterGraph, pReserved);

  int GraphCreationPostRender(Pointer<COMObject> pFilterGraph) => ptr
      .ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
  ...
  int GetGraphCreationFlags(Pointer<Uint32> pdwFlags) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
