...
class IWMPSubscriptionService extends IUnknown {
  ...
  int allowPlay(
          int hwnd, Pointer<COMObject> pMedia, Pointer<Int32> pfAllowPlay) =>
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int hwnd, Pointer<COMObject> pMedia,
                      Pointer<Int32> pfAllowPlay)>()(
          ptr.ref.lpVtbl, hwnd, pMedia, pfAllowPlay);

  int allowCDBurn(
          int hwnd, Pointer<COMObject> pPlaylist, Pointer<Int32> pfAllowBurn) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, int hwnd, Pointer<COMObject> pPlaylist,
                      Pointer<Int32> pfAllowBurn)>()(
          ptr.ref.lpVtbl, hwnd, pPlaylist, pfAllowBurn);

  int allowPDATransfer(int hwnd, Pointer<COMObject> pPlaylist,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int hwnd, Pointer<COMObject> pPlaylist,
                      Pointer<Int32> pfAllowTransfer)>()(
          ptr.ref.lpVtbl, hwnd, pPlaylist, pfAllowTransfer);

  int startBackgroundProcessing(int hwnd) => ptr.ref.lpVtbl.value
      .elementAt(6)
