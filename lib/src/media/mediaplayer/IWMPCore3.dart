...
class IWMPCore3 extends IWMPCore2 {
  ...
  int newPlaylist(Pointer<Utf16> bstrName, Pointer<Utf16> bstrURL,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> bstrURL,
                      Pointer<Pointer<COMObject>> ppPlaylist)>()(
          ptr.ref.lpVtbl, bstrName, bstrURL, ppPlaylist);

  int newMedia(Pointer<Utf16> bstrURL, Pointer<Pointer<COMObject>> ppMedia) =>
      ptr.ref.lpVtbl.value
              .elementAt(30)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrURL,
                      Pointer<Pointer<COMObject>> ppMedia)>()(
          ptr.ref.lpVtbl, bstrURL, ppMedia);
}
