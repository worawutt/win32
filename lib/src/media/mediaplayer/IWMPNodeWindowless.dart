...
class IWMPNodeWindowless extends IWMPWindowMessageSink {
  ...
  int OnDraw(int hdc, Pointer<RECT> prcDraw) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, IntPtr hdc, Pointer<RECT> prcDraw)>>>()
          .value
          .asFunction<int Function(Pointer, int hdc, Pointer<RECT> prcDraw)>()(
      ptr.ref.lpVtbl, hdc, prcDraw);
}
