...
class IWMPEvents4 extends IWMPEvents3 {
  ...
  void DeviceEstimation(Pointer<COMObject> pDevice, int hrResult,
          int qwEstimatedUsedSpace, int qwEstimatedSpace) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  void Function(
                      ...
                      int qwEstimatedSpace)>()(ptr.ref.lpVtbl, pDevice,
          hrResult, qwEstimatedUsedSpace, qwEstimatedSpace);
}
