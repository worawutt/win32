...
class IWMPFolderMonitorServices extends IUnknown {
  ...
  int item(int lIndex, Pointer<Pointer<Utf16>> pbstrFolder) => ptr
          .ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, int lIndex, Pointer<Pointer<Utf16>> pbstrFolder)>()(
      ptr.ref.lpVtbl, lIndex, pbstrFolder);

  int add(Pointer<Utf16> bstrFolder) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> bstrFolder)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Utf16> bstrFolder)>()(
      ptr.ref.lpVtbl, bstrFolder);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> pwmpfss)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> pwmpfss)>()(
          ptr.ref.lpVtbl, retValuePtr);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<Utf16>> pbstrFolder)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<Utf16>> pbstrFolder)>()(
          ptr.ref.lpVtbl, retValuePtr);
