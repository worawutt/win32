...
class IWMPRemoteMediaServices extends IUnknown {
  ...
  int GetServiceType(Pointer<Pointer<Utf16>> pbstrType) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetApplicationName(Pointer<Pointer<Utf16>> pbstrName) =>
  ...
  int GetScriptableObject(Pointer<Pointer<Utf16>> pbstrName,
      ...
      ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Pointer<Utf16>> pbstrName,
                          Pointer<Pointer<COMObject>> ppDispatch)>>>()
          .value
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<COMObject>>
                      ppDispatch)>()(ptr.ref.lpVtbl, pbstrName, ppDispatch);

  int GetCustomUIMode(Pointer<Pointer<Utf16>> pbstrFile) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<Utf16>> pbstrFile)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<Utf16>> pbstrFile)>()(
      ptr.ref.lpVtbl, pbstrFile);
}
