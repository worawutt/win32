...
class IWMPDownloadManager extends IDispatch {
  ...
  int getDownloadCollection(
          int lCollectionId, Pointer<Pointer<COMObject>> ppCollection) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 lCollectionId,
                              Pointer<Pointer<COMObject>> ppCollection)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int lCollectionId,
                      Pointer<Pointer<COMObject>> ppCollection)>()(
          ptr.ref.lpVtbl, lCollectionId, ppCollection);

  int createDownloadCollection(Pointer<Pointer<COMObject>> ppCollection) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
                  Pointer<
