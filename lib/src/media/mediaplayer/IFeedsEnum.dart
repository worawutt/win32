...
class IFeedsEnum extends IDispatch {
  ...
  int Item(int index, Pointer<Pointer<COMObject>> disp) => ptr.ref.lpVtbl.value
      .elementAt(8)
      .cast<
          Pointer<
              NativeFunction<
      ...
      .asFunction<
          int Function(Pointer, int index,
              Pointer<Pointer<COMObject>> disp)>()(ptr.ref.lpVtbl, index, disp);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<COMObject>> enumVar)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<COMObject>> enumVar)>()(
          ptr.ref.lpVtbl, retValuePtr);
