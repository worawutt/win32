...
class IWMPPlugin extends IUnknown {
  ...
  int Init(int dwPlaybackContext) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, IntPtr dwPlaybackContext)>>>()
          .value
          .asFunction<int Function(Pointer, int dwPlaybackContext)>()(
      ptr.ref.lpVtbl, dwPlaybackContext);
  ...
  int GetID(Pointer<GUID> pGUID) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
  ...
  int GetCaps(Pointer<Uint32> pdwFlags) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int AdviseWMPServices(Pointer<COMObject> pWMPServices) => ptr.ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> pWMPServices)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<COMObject> pWMPServices)>()(ptr.ref.lpVtbl, pWMPServices);
