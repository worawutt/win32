...
class IWMPSyncDevice3 extends IWMPSyncDevice2 {
  ...
  int estimateSyncSize(Pointer<COMObject> pNonRulePlaylist,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pNonRulePlaylist,
                      Pointer<COMObject> pRulesPlaylist)>()(
          ptr.ref.lpVtbl, pNonRulePlaylist, pRulesPlaylist);
