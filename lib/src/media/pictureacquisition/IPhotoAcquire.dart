...
class IPhotoAcquire extends IUnknown {
  ...
  int
      CreatePhotoSource(Pointer<Utf16> pszDevice,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<Utf16> pszDevice,
                          Pointer<Pointer<COMObject>> ppPhotoAcquireSource)>()(
              ptr.ref.lpVtbl, pszDevice, ppPhotoAcquireSource);
  ...
  int EnumResults(Pointer<Pointer<COMObject>> ppEnumFilePaths) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppEnumFilePaths)>()(
          ptr.ref.lpVtbl, ppEnumFilePaths);
}
