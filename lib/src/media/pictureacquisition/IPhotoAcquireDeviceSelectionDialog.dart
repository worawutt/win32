...
class IPhotoAcquireDeviceSelectionDialog extends IUnknown {
  ...
  int SetSubmitButtonText(Pointer<Utf16> pszSubmitButtonText) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Utf16> pszSubmitButtonText)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> pszSubmitButtonText)>()(
          ptr.ref.lpVtbl, pszSubmitButtonText);

  int DoModal(int hWndParent, int dwDeviceFlags,
          Pointer<Pointer<Utf16>> pbstrDeviceId, Pointer<Int32> pnDeviceType) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      int dwDeviceFlags,
                      Pointer<Pointer<Utf16>> pbstrDeviceId,
                      Pointer<Int32> pnDeviceType)>()(ptr.ref.lpVtbl,
          hWndParent, dwDeviceFlags, pbstrDeviceId, pnDeviceType);
}
