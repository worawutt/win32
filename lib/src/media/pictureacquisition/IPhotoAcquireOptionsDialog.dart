...
class IPhotoAcquireOptionsDialog extends IUnknown {
  ...
  int Initialize(Pointer<Utf16> pszRegistryRoot) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Utf16> pszRegistryRoot)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> pszRegistryRoot)>()(
          ptr.ref.lpVtbl, pszRegistryRoot);

  int Create(int hWndParent, Pointer<IntPtr> phWndDialog) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, int hWndParent, Pointer<IntPtr> phWndDialog)>()(
          ptr.ref.lpVtbl, hWndParent, phWndDialog);
  ...
  int DoModal(int hWndParent, Pointer<IntPtr> ppnReturnCode) => ptr
          .ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, int hWndParent, Pointer<IntPtr> ppnReturnCode)>()(
      ptr.ref.lpVtbl, hWndParent, ppnReturnCode);
