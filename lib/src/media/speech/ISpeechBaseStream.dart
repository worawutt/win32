...
class ISpeechBaseStream extends IDispatch {
  ...
  Pointer<COMObject> get Format {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> AudioFormat)>()(
  ...
  int putref_Format(Pointer<COMObject> AudioFormat) => ptr.ref.lpVtbl.value
      .elementAt(8)
      .cast<
          Pointer<
              NativeFunction<
  ...
  int Write(VARIANT Buffer, Pointer<Int32> BytesWritten) => ptr.ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
                  NativeFunction<
