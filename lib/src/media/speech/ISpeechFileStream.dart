...
class ISpeechFileStream extends ISpeechBaseStream {
  ...
  int Open(Pointer<Utf16> FileName, int FileMode, int DoEvents) => ptr
      .ref.lpVtbl.value
      .elementAt(12)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Utf16> FileName,
                      Int32 FileMode, Int16 DoEvents)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<Utf16> FileName, int FileMode,
              int DoEvents)>()(ptr.ref.lpVtbl, FileName, FileMode, DoEvents);
