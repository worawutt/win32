...
class ISpPhoneConverter extends ISpObjectWithToken {
  ...
  int PhoneToId(Pointer<Utf16> pszPhone, Pointer<Uint16> pId) =>
      ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> pszPhone,
                          Pointer<Uint16> pId)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Utf16> pszPhone,
                  Pointer<Uint16> pId)>()(ptr.ref.lpVtbl, pszPhone, pId);

  int IdToPhone(Pointer<Uint16> pId, Pointer<Utf16> pszPhone) =>
      ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Uint16> pId,
                          Pointer<Utf16> pszPhone)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Uint16> pId,
                  Pointer<Utf16> pszPhone)>()(ptr.ref.lpVtbl, pId, pszPhone);
}
