  ...
  Pointer<COMObject> get BufferInfo {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> BufferInfo)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  Pointer<COMObject> get DefaultFormat {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> StreamFormat)>()(
          ptr.ref.lpVtbl, retValuePtr);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Int32> BufferNotifySize)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> BufferNotifySize)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set BufferNotifySize(int value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(Pointer, Int32 BufferNotifySize)>>>()
            .value
            .asFunction<int Function(Pointer, int BufferNotifySize)>()(
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> EventHandle)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int32> EventHandle)>()(ptr.ref.lpVtbl, retValuePtr);
