      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int cRequestCount,
                      Pointer<Pointer<SPDISPLAYPHRASE>> ppCoMemPhrases,
                      Pointer<Uint32> pcPhrasesReturned)>()(ptr.ref.lpVtbl,
          pPhrase, cRequestCount, ppCoMemPhrases, pcPhrasesReturned);

  int SetFullStopTrailSpace(int ulTrailSpace) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Uint32 ulTrailSpace)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int ulTrailSpace)>()(ptr.ref.lpVtbl, ulTrailSpace);
}
