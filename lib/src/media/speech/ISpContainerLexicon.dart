...
class ISpContainerLexicon extends ISpLexicon {
  ...
  int AddLexicon(Pointer<COMObject> pAddLexicon, int dwFlags) =>
      ptr.ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pAddLexicon,
                          Uint32 dwFlags)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> pAddLexicon,
                  int dwFlags)>()(ptr.ref.lpVtbl, pAddLexicon, dwFlags);
}
