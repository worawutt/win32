...
class ISpGrammarBuilder extends IUnknown {
  ...
  int ResetGrammar(int NewLanguage) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Uint16 NewLanguage)>>>()
      .value
      .asFunction<
          int Function(
                      ...
                      Pointer<
                          NativeFunction<
                              Int32 Function(
                                  ...
                                  Pointer<Pointer<SPSTATEHANDLE__>>
                                      phInitialState)>>>()
                  .value
                  .asFunction<
                      int Function(
  ...
  int ClearRule(Pointer<SPSTATEHANDLE__> hState) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<SPSTATEHANDLE__> hState)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<SPSTATEHANDLE__> hState)>()(ptr.ref.lpVtbl, hState);

  int CreateNewState(Pointer<SPSTATEHANDLE__> hState,
      ...
      ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<SPSTATEHANDLE__>>
                      phState)>()(ptr.ref.lpVtbl, hState, phState);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      double Weight,
                      Pointer<SPPROPERTYINFO> pPropInfo)>()(
          ptr.ref.lpVtbl, hFromState, hToState, hRule, Weight, pPropInfo);

  int AddResource(Pointer<SPSTATEHANDLE__> hRuleState,
          Pointer<Utf16> pszResourceName, Pointer<Utf16> pszResourceValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> pszResourceName,
                      Pointer<Utf16> pszResourceValue)>()(
          ptr.ref.lpVtbl, hRuleState, pszResourceName, pszResourceValue);

  int Commit(int dwReserved) => ptr.ref.lpVtbl.value
      .elementAt(10)
      .cast<
