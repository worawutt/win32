...
class IEnumSpObjectTokens extends IUnknown {
  ...
  int Next(int celt, Pointer<Pointer<COMObject>> pelt,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> pelt,
                      Pointer<Uint32> pceltFetched)>()(
          ptr.ref.lpVtbl, celt, pelt, pceltFetched);
  ...
  int Item(int Index, Pointer<Pointer<COMObject>> ppToken) => ptr
          .ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, int Index, Pointer<Pointer<COMObject>> ppToken)>()(
      ptr.ref.lpVtbl, Index, ppToken);
