...
class ISpStreamFormatConverter extends ISpStreamFormat {
  ...
  int SetBaseStream(Pointer<COMObject> pStream,
          int fSetFormatToBaseStreamFormat, int fWriteToBaseStream) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int fWriteToBaseStream)>()(ptr.ref.lpVtbl, pStream,
          fSetFormatToBaseStreamFormat, fWriteToBaseStream);

  int GetBaseStream(Pointer<Pointer<COMObject>> ppStream) => ptr
          .ref.lpVtbl.value
          .elementAt(16)
          .cast<
              Pointer<
  ...
  int SetFormat(Pointer<GUID> rguidFormatIdOfConvertedStream,
  ...
  int
      ScaleConvertedToBaseOffset(int ullOffsetConvertedStream,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, int ullOffsetConvertedStream,
                          Pointer<Uint64> pullOffsetBaseStream)>()(
              ptr.ref.lpVtbl, ullOffsetConvertedStream, pullOffsetBaseStream);

  int ScaleBaseToConvertedOffset(
          int ullOffsetBaseStream, Pointer<Uint64> pullOffsetConvertedStream) =>
      ptr.ref.lpVtbl.value
              .elementAt(20)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint64 ullOffsetBaseStream,
                              Pointer<Uint64> pullOffsetConvertedStream)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int ullOffsetBaseStream,
                      Pointer<Uint64> pullOffsetConvertedStream)>()(
          ptr.ref.lpVtbl, ullOffsetBaseStream, pullOffsetConvertedStream);
}
