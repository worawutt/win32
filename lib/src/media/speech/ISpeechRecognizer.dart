...
class ISpeechRecognizer extends IDispatch {
  ...
  int putref_Recognizer(Pointer<COMObject> Recognizer) => ptr.ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> Recognizer)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<COMObject> Recognizer)>()(ptr.ref.lpVtbl, Recognizer);
  ...
  int putref_AudioInput(Pointer<COMObject> AudioInput) => ptr.ref.lpVtbl.value
      .elementAt(11)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> AudioInput)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<COMObject> AudioInput)>()(ptr.ref.lpVtbl, AudioInput);
  ...
  Pointer<COMObject> get AudioInput {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> AudioInput)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  int putref_AudioInputStream(Pointer<COMObject> AudioInputStream) =>
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> AudioInputStream)>()(
          ptr.ref.lpVtbl, AudioInputStream);
  ...
  Pointer<COMObject> get AudioInputStream {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> AudioInputStream)>()(
          ptr.ref.lpVtbl, retValuePtr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int16> Shared)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int16> Shared)>()(
          ptr.ref.lpVtbl, retValuePtr);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<COMObject>> Status)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<COMObject>> Status)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  int putref_Profile(Pointer<COMObject> Profile) => ptr.ref.lpVtbl.value
          .elementAt(19)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> Profile)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> Profile)>()(
      ptr.ref.lpVtbl, Profile);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<COMObject>> Profile)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<COMObject>> Profile)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  int EmulateRecognition(VARIANT TextElements,
          Pointer<VARIANT> ElementDisplayAttributes, int LanguageId) =>
      ptr.ref.lpVtbl.value
              .elementAt(21)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<VARIANT> ElementDisplayAttributes,
                      int LanguageId)>()(
          ptr.ref.lpVtbl, TextElements, ElementDisplayAttributes, LanguageId);

  int CreateRecoContext(Pointer<Pointer<COMObject>> NewContext) => ptr
          .ref.lpVtbl.value
          .elementAt(22)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> NewContext)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> NewContext)>()(
      ptr.ref.lpVtbl, NewContext);

  int GetFormat(int Type, Pointer<Pointer<COMObject>> Format) =>
      ptr.ref.lpVtbl.value
              .elementAt(23)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, int Type, Pointer<Pointer<COMObject>> Format)>()(
          ptr.ref.lpVtbl, Type, Format);

  int SetPropertyNumber(
          Pointer<Utf16> Name, int Value, Pointer<Int16> Supported) =>
      ptr
          .ref.lpVtbl.value
          .elementAt(24)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> Name, Int32 Value,
          ...
          .asFunction<
              int Function(
                  ...
                  int Value,
                  Pointer<Int16>
                      Supported)>()(ptr.ref.lpVtbl, Name, Value, Supported);

  int GetPropertyNumber(Pointer<Utf16> Name, Pointer<Int32> Value,
          Pointer<Int16> Supported) =>
      ptr.ref.lpVtbl.value
          .elementAt(25)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> Name,
                          Pointer<Int32> Value, Pointer<Int16> Supported)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer,
  ...
  int SetPropertyString(Pointer<Utf16> Name, Pointer<Utf16> Value,
          Pointer<Int16> Supported) =>
      ptr.ref.lpVtbl.value
          .elementAt(26)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> Name,
                          Pointer<Utf16> Value, Pointer<Int16> Supported)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer,
  ...
  int GetPropertyString(Pointer<Utf16> Name, Pointer<Pointer<Utf16>> Value,
          Pointer<Int16> Supported) =>
      ptr.ref.lpVtbl.value
              .elementAt(27)
              .cast<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<Utf16>> Value,
                      Pointer<Int16> Supported)>()(
          ptr.ref.lpVtbl, Name, Value, Supported);
