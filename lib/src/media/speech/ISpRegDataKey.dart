...
class ISpRegDataKey extends ISpDataKey {
  ...
  int SetKey(int hkey, int fReadOnly) => ptr.ref.lpVtbl.value
          .elementAt(15)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, IntPtr hkey, Int32 fReadOnly)>>>()
          .value
          .asFunction<int Function(Pointer, int hkey, int fReadOnly)>()(
      ptr.ref.lpVtbl, hkey, fReadOnly);
}
