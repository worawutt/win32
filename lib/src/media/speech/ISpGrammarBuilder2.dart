      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> psz,
                      int eMatchMode)>()(
          ptr.ref.lpVtbl, hFromState, hToState, psz, eMatchMode);

  int SetPhoneticAlphabet(int phoneticALphabet) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 phoneticALphabet)>>>()
          .value
          .asFunction<int Function(Pointer, int phoneticALphabet)>()(
      ptr.ref.lpVtbl, phoneticALphabet);
}
