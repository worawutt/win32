...
class ISpeechResourceLoader extends IDispatch {
  ...
  int ReleaseLocalCopy(Pointer<Utf16> pbstrLocalPath) => ptr.ref.lpVtbl.value
      .elementAt(9)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Utf16> pbstrLocalPath)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<Utf16> pbstrLocalPath)>()(ptr.ref.lpVtbl, pbstrLocalPath);
}
