...
class ISpResourceManager extends IServiceProvider {
  ...
  int SetObject(Pointer<GUID> guidServiceId, Pointer<COMObject> pUnkObject) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<GUID> guidServiceId,
                              Pointer<COMObject> pUnkObject)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<GUID> guidServiceId,
                      Pointer<COMObject> pUnkObject)>()(
          ptr.ref.lpVtbl, guidServiceId, pUnkObject);
