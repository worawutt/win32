...
class ISpStream extends ISpStreamFormat {
  ...
  int SetBaseStream(Pointer<COMObject> pStream, Pointer<GUID> rguidFormat,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> rguidFormat,
                      Pointer<WAVEFORMATEX> pWaveFormatEx)>()(
          ptr.ref.lpVtbl, pStream, rguidFormat, pWaveFormatEx);
  ...
  int BindToFile(Pointer<Utf16> pszFileName, int eMode, Pointer<GUID> pFormatId,
          Pointer<WAVEFORMATEX> pWaveFormatEx, int ullEventInterest) =>
      ptr.ref.lpVtbl.value
              .elementAt(17)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> pFormatId,
                      Pointer<WAVEFORMATEX> pWaveFormatEx,
                      int ullEventInterest)>()(ptr.ref.lpVtbl, pszFileName,
          eMode, pFormatId, pWaveFormatEx, ullEventInterest);
