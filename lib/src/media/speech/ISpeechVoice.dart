...
class ISpeechVoice extends IDispatch {
  ...
  Pointer<COMObject> get AudioOutput {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> AudioOutput)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  int putref_AudioOutput(Pointer<COMObject> AudioOutput) => ptr.ref.lpVtbl.value
      .elementAt(11)
      .cast<
          Pointer<
              NativeFunction<
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<COMObject>>
                      AudioOutputStream)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  int WaitUntilDone(int msTimeout, Pointer<Int16> Done) => ptr.ref.lpVtbl.value
          .elementAt(35)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int SpeakCompleteEvent(Pointer<Int32> Handle_) => ptr.ref.lpVtbl.value
          .elementAt(36)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> Handle_)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Int32> Handle_)>()(
