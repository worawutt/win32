...
class ISpNotifyTranslator extends ISpNotifySink {
  ...
  int InitWindowMessage(int hWnd, int Msg, int wParam, int lParam) =>
  ...
  int InitWin32Event(int hEvent, int fCloseHandleOnRelease) => ptr
          .ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
          ...
          .value
          .asFunction<
              int Function(Pointer, int hEvent, int fCloseHandleOnRelease)>()(
      ptr.ref.lpVtbl, hEvent, fCloseHandleOnRelease);

  int Wait(int dwMilliseconds) => ptr.ref.lpVtbl.value
      .elementAt(8)
      .cast<
          Pointer<
