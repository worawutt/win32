...
class IAudioVolumeDuckNotification extends IUnknown {
  ...
  int OnVolumeDuckNotification(
          Pointer<Utf16> sessionID, int countCommunicationSessions) =>
      ptr.ref.lpVtbl.value
          ...
          ptr.ref.lpVtbl, sessionID, countCommunicationSessions);

  int OnVolumeUnduckNotification(Pointer<Utf16> sessionID) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> sessionID)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Utf16> sessionID)>()(
