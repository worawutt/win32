...
class ISpatialAudioObjectRenderStreamBase extends IUnknown {
  ...
  int GetAvailableDynamicObjectCount(Pointer<Uint32> value) => ptr
      .ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
  ...
  int GetService(Pointer<GUID> riid, Pointer<Pointer> service) =>
      ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(Pointer, Pointer<GUID> riid,
                  Pointer<Pointer> service)>()(ptr.ref.lpVtbl, riid, service);
  ...
  int BeginUpdatingAudioObjects(Pointer<Uint32> availableDynamicObjectCount,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint32> availableDynamicObjectCount,
                      Pointer<Uint32> frameCountPerBuffer)>()(
          ptr.ref.lpVtbl, availableDynamicObjectCount, frameCountPerBuffer);
