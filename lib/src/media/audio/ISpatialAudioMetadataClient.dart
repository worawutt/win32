...
class ISpatialAudioMetadataClient extends IUnknown {
  ...
  int GetSpatialAudioMetadataItemsBufferLength(
          int maxItemCount, Pointer<Uint32> bufferLength) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint16 maxItemCount,
                              Pointer<Uint32> bufferLength)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int maxItemCount,
                      Pointer<Uint32> bufferLength)>()(
          ptr.ref.lpVtbl, maxItemCount, bufferLength);

  int ActivateSpatialAudioMetadataWriter(
          int overflowMode, Pointer<Pointer<COMObject>> metadataWriter) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 overflowMode,
                              Pointer<Pointer<COMObject>> metadataWriter)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int overflowMode,
                      Pointer<Pointer<COMObject>> metadataWriter)>()(
          ptr.ref.lpVtbl, overflowMode, metadataWriter);
  ...
  int ActivateSpatialAudioMetadataCopier(
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> metadataCopier)>()(
          ptr.ref.lpVtbl, metadataCopier);
  ...
  int ActivateSpatialAudioMetadataReader(
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> metadataReader)>()(
          ptr.ref.lpVtbl, metadataReader);
}
