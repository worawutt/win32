...
class IDirectSoundCaptureBuffer8 extends IDirectSoundCaptureBuffer {
  ...
  int GetFXStatus(int dwEffectsCount, Pointer<Uint32> pdwFXStatus) => ptr
          .ref.lpVtbl.value
          .elementAt(13)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Uint32 dwEffectsCount,
                          Pointer<Uint32> pdwFXStatus)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer, int dwEffectsCount, Pointer<Uint32> pdwFXStatus)>()(
      ptr.ref.lpVtbl, dwEffectsCount, pdwFXStatus);
}
