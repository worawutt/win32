...
class IDirectSoundCaptureBuffer extends IUnknown {
  ...
  int GetCaps(Pointer<DSCBCAPS> pDSCBCaps) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<DSCBCAPS> pDSCBCaps)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<DSCBCAPS> pDSCBCaps)>()(
      ptr.ref.lpVtbl, pDSCBCaps);

  int GetCurrentPosition(Pointer<Uint32> pdwCapturePosition,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> pdwCapturePosition,
                      Pointer<Uint32> pdwReadPosition)>()(
          ptr.ref.lpVtbl, pdwCapturePosition, pdwReadPosition);
  ...
  int Initialize(Pointer<COMObject> pDirectSoundCapture,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pDirectSoundCapture,
                      Pointer<DSCBUFFERDESC> pcDSCBufferDesc)>()(
          ptr.ref.lpVtbl, pDirectSoundCapture, pcDSCBufferDesc);
  ...
  int Start(int dwFlags) => ptr.ref.lpVtbl.value
      .elementAt(9)
