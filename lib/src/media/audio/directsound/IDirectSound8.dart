...
class IDirectSound8 extends IDirectSound {
  ...
  int VerifyCertification(Pointer<Uint32> pdwCertified) => ptr.ref.lpVtbl.value
          .elementAt(11)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Uint32> pdwCertified)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Uint32> pdwCertified)>()(
      ptr.ref.lpVtbl, pdwCertified);
}
