...
class IDirectSoundNotify extends IUnknown {
  ...
  int
      SetNotificationPositions(int dwPositionNotifies,
                      ...
                      Pointer<
                          NativeFunction<
                              Int32 Function(
                                  ...
                                  Pointer<DSBPOSITIONNOTIFY>
                                      pcPositionNotifies)>>>()
                  .value
                  .asFunction<
                      int Function(Pointer, int dwPositionNotifies,
                          Pointer<DSBPOSITIONNOTIFY> pcPositionNotifies)>()(
              ptr.ref.lpVtbl, dwPositionNotifies, pcPositionNotifies);
}
