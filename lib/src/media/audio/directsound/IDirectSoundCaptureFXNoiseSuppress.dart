...
class IDirectSoundCaptureFXNoiseSuppress extends IUnknown {
  ...
  int SetAllParameters(Pointer<DSCFXNoiseSuppress> pcDscFxNoiseSuppress) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<DSCFXNoiseSuppress> pcDscFxNoiseSuppress)>()(
      ptr.ref.lpVtbl, pcDscFxNoiseSuppress);

  int GetAllParameters(Pointer<DSCFXNoiseSuppress> pDscFxNoiseSuppress) => ptr
          .ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<DSCFXNoiseSuppress> pDscFxNoiseSuppress)>()(
      ptr.ref.lpVtbl, pDscFxNoiseSuppress);
