...
class IDirectSoundBuffer8 extends IDirectSoundBuffer {
  ...
  int SetFX(int dwEffectsCount, Pointer<DSEFFECTDESC> pDSFXDesc,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<DSEFFECTDESC> pDSFXDesc,
                      Pointer<Uint32> pdwResultCodes)>()(
          ptr.ref.lpVtbl, dwEffectsCount, pDSFXDesc, pdwResultCodes);

  int AcquireResources(
          int dwFlags, int dwEffectsCount, Pointer<Uint32> pdwResultCodes) =>
      ptr.ref.lpVtbl.value
              .elementAt(22)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, int dwFlags, int dwEffectsCount,
                      Pointer<Uint32> pdwResultCodes)>()(
          ptr.ref.lpVtbl, dwFlags, dwEffectsCount, pdwResultCodes);

  int GetObjectInPath(Pointer<GUID> rguidObject, int dwIndex,
          Pointer<GUID> rguidInterface, Pointer<Pointer> ppObject) =>
      ptr.ref.lpVtbl.value
              .elementAt(23)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> rguidInterface,
                      Pointer<Pointer> ppObject)>()(
          ptr.ref.lpVtbl, rguidObject, dwIndex, rguidInterface, ppObject);
}
