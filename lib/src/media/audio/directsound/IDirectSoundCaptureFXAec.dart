...
class IDirectSoundCaptureFXAec extends IUnknown {
  ...
  int SetAllParameters(Pointer<DSCFXAec> pDscFxAec) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<DSCFXAec> pDscFxAec)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<DSCFXAec> pDscFxAec)>()(
      ptr.ref.lpVtbl, pDscFxAec);

  int GetAllParameters(Pointer<DSCFXAec> pDscFxAec) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
