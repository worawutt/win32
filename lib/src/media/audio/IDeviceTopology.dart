...
class IDeviceTopology extends IUnknown {
  ...
  int GetConnectorCount(Pointer<Uint32> pCount) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetConnector(int nIndex, Pointer<Pointer<COMObject>> ppConnector) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int nIndex,
                      Pointer<Pointer<COMObject>> ppConnector)>()(
          ptr.ref.lpVtbl, nIndex, ppConnector);

  int GetSubunitCount(Pointer<Uint32> pCount) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetSubunit(int nIndex, Pointer<Pointer<COMObject>> ppSubunit) =>
      ptr.ref.lpVtbl.value
              .elementAt(6)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, int nIndex,
                      Pointer<Pointer<COMObject>> ppSubunit)>()(
          ptr.ref.lpVtbl, nIndex, ppSubunit);

  int GetPartById(int nId, Pointer<Pointer<COMObject>> ppPart) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint32 nId,
                              Pointer<Pointer<COMObject>> ppPart)>>>()
              .value
              .asFunction<
                  int Function(
                      Pointer, int nId, Pointer<Pointer<COMObject>> ppPart)>()(
          ptr.ref.lpVtbl, nId, ppPart);

  int GetDeviceId(Pointer<Pointer<Utf16>> ppwstrDeviceId) => ptr
          .ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
  ...
  int GetSignalPath(Pointer<COMObject> pIPartFrom, Pointer<COMObject> pIPartTo,
          int bRejectMixedPaths, Pointer<Pointer<COMObject>> ppParts) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppParts)>()(
          ptr.ref.lpVtbl, pIPartFrom, pIPartTo, bRejectMixedPaths, ppParts);
}
