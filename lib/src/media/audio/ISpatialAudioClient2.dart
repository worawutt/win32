...
class ISpatialAudioClient2 extends ISpatialAudioClient {
  ...
  int IsOffloadCapable(int category, Pointer<Int32> isOffloadCapable) => ptr
          .ref.lpVtbl.value
          .elementAt(11)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, int category, Pointer<Int32> isOffloadCapable)>()(
      ptr.ref.lpVtbl, category, isOffloadCapable);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int offloadEnabled,
                      Pointer<WAVEFORMATEX> objectFormat,
                      Pointer<Uint32> frameCountPerBuffer)>()(ptr.ref.lpVtbl,
          category, offloadEnabled, objectFormat, frameCountPerBuffer);
}
