...
class IAudioSessionNotification extends IUnknown {
  ...
  int OnSessionCreated(Pointer<COMObject> NewSession) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> NewSession)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<COMObject> NewSession)>()(ptr.ref.lpVtbl, NewSession);
}
