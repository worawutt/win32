...
class IControlChangeNotify extends IUnknown {
  ...
  int OnNotify(int dwSenderProcessId, Pointer<GUID> pguidEventContext) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint32 dwSenderProcessId,
                              Pointer<GUID> pguidEventContext)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int dwSenderProcessId,
                      Pointer<GUID> pguidEventContext)>()(
          ptr.ref.lpVtbl, dwSenderProcessId, pguidEventContext);
}
