...
int CoRegisterMessageFilter(Pointer<COMObject> lpMessageFilter,
        Pointer<Pointer<COMObject>> lplpMessageFilter) =>
    _CoRegisterMessageFilter(lpMessageFilter, lplpMessageFilter);

late final _CoRegisterMessageFilter = _ole32.lookupFunction<
        Int32 Function(Pointer<COMObject> lpMessageFilter,
            Pointer<Pointer<COMObject>> lplpMessageFilter),
        int Function(Pointer<COMObject> lpMessageFilter,
            Pointer<Pointer<COMObject>> lplpMessageFilter)>(
...
int CreateCaptureAudioStateMonitor(
    ...
    _CreateCaptureAudioStateMonitor(audioStateMonitor);

late final _CreateCaptureAudioStateMonitor =
    _windows_media_mediacontrol.lookupFunction<
            Int32 Function(Pointer<Pointer<COMObject>> audioStateMonitor),
            int Function(Pointer<Pointer<COMObject>> audioStateMonitor)>(
        'CreateCaptureAudioStateMonitor');

int CreateCaptureAudioStateMonitorForCategory(
        int category, Pointer<Pointer<COMObject>> audioStateMonitor) =>
    _CreateCaptureAudioStateMonitorForCategory(category, audioStateMonitor);

late final _CreateCaptureAudioStateMonitorForCategory =
    _windows_media_mediacontrol.lookupFunction<
            Int32 Function(
                Int32 category, Pointer<Pointer<COMObject>> audioStateMonitor),
            int Function(
                int category, Pointer<Pointer<COMObject>> audioStateMonitor)>(
...
late final _CreateCaptureAudioStateMonitorForCategoryAndDeviceId =
    _windows_media_mediacontrol.lookupFunction<
            Int32 Function(Int32 category, Pointer<Utf16> deviceId,
                Pointer<Pointer<COMObject>> audioStateMonitor),
            int Function(int category, Pointer<Utf16> deviceId,
                Pointer<Pointer<COMObject>> audioStateMonitor)>(
        'CreateCaptureAudioStateMonitorForCategoryAndDeviceId');

int CreateCaptureAudioStateMonitorForCategoryAndDeviceRole(int category,
        int role, Pointer<Pointer<COMObject>> audioStateMonitor) =>
...
late final _CreateCaptureAudioStateMonitorForCategoryAndDeviceRole =
    _windows_media_mediacontrol.lookupFunction<
            Int32 Function(Int32 category, Int32 role,
                Pointer<Pointer<COMObject>> audioStateMonitor),
            int Function(int category, int role,
                Pointer<Pointer<COMObject>> audioStateMonitor)>(
        'CreateCaptureAudioStateMonitorForCategoryAndDeviceRole');

int CreateRenderAudioStateMonitor(
        Pointer<Pointer<COMObject>> audioStateMonitor) =>
    _CreateRenderAudioStateMonitor(audioStateMonitor);
...
int CreateRenderAudioStateMonitorForCategory(
        int category, Pointer<Pointer<COMObject>> audioStateMonitor) =>
    _CreateRenderAudioStateMonitorForCategory(category, audioStateMonitor);
...
int CreateRenderAudioStateMonitorForCategoryAndDeviceRole(int category,
        int role, Pointer<Pointer<COMObject>> audioStateMonitor) =>
