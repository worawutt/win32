...
class IAudioSystemEffectsPropertyStore extends IUnknown {
  ...
  int OpenDefaultPropertyStore(
          int stgmAccess, Pointer<Pointer<COMObject>> propStore) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int stgmAccess,
                      Pointer<Pointer<COMObject>> propStore)>()(
          ptr.ref.lpVtbl, stgmAccess, propStore);
  ...
  int RegisterPropertyChangeNotification(Pointer<COMObject> callback) => ptr
          .ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
  ...
  int UnregisterPropertyChangeNotification(Pointer<COMObject> callback) => ptr
          .ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
