...
class IAudioSystemEffectsPropertyChangeNotificationClient extends IUnknown {
  ...
  int OnPropertyChanged(int type, PROPERTYKEY key) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 type, PROPERTYKEY key)>>>()
          .value
          .asFunction<int Function(Pointer, int type, PROPERTYKEY key)>()(
      ptr.ref.lpVtbl, type, key);
}
