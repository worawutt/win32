...
class ISpatialAudioMetadataCopier extends IUnknown {
  ...
  int CopyMetadataForFrames(int copyFrameCount, int copyMode,
          Pointer<COMObject> dstMetadataItems, Pointer<Uint16> itemsCopied) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      int copyMode,
                      Pointer<COMObject> dstMetadataItems,
                      Pointer<Uint16> itemsCopied)>()(ptr.ref.lpVtbl,
          copyFrameCount, copyMode, dstMetadataItems, itemsCopied);
