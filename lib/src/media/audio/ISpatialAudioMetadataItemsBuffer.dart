...
class ISpatialAudioMetadataItemsBuffer extends IUnknown {
  ...
  int AttachToBuffer(Pointer<Uint8> buffer, int bufferLength) => ptr
      .ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Pointer<Uint8> buffer, Uint32 bufferLength)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<Uint8> buffer,
              int bufferLength)>()(ptr.ref.lpVtbl, buffer, bufferLength);

  int AttachToPopulatedBuffer(Pointer<Uint8> buffer, int bufferLength) => ptr
      .ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
