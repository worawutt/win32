...
class IXAudio2EngineCallback {
  ...
  void OnCriticalError(int Error) => ptr.ref.lpVtbl.value
      .elementAt(2)
      .cast<Pointer<NativeFunction<Void Function(Pointer, Int32 Error)>>>()
      .value
      .asFunction<void Function(Pointer, int Error)>()(ptr.ref.lpVtbl, Error);
}
