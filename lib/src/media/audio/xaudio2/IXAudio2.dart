...
class IXAudio2 extends IUnknown {
  ...
  int RegisterForCallbacks(Pointer<COMObject> pCallback) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  void UnregisterForCallbacks(Pointer<COMObject> pCallback) => ptr
          .ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Void Function(Pointer, Pointer<COMObject> pCallback)>>>()
          .value
          .asFunction<void Function(Pointer, Pointer<COMObject> pCallback)>()(
      ptr.ref.lpVtbl, pCallback);
  ...
  int CommitChanges(int OperationSet) => ptr.ref.lpVtbl.value
      .elementAt(10)
      .cast<
          Pointer<
  ...
  void GetPerformanceData(Pointer<XAUDIO2_PERFORMANCE_DATA> pPerfData) =>
      ptr.ref.lpVtbl.value
              .elementAt(11)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  void Function(
                      Pointer, Pointer<XAUDIO2_PERFORMANCE_DATA> pPerfData)>()(
          ptr.ref.lpVtbl, pPerfData);
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Void Function(
                              Pointer,
                              Pointer<XAUDIO2_DEBUG_CONFIGURATION>
                                  pDebugConfiguration,
                              Pointer pReserved)>>>()
              .value
              .asFunction<
                  void Function(
                      ...
                      Pointer<XAUDIO2_DEBUG_CONFIGURATION> pDebugConfiguration,
                      Pointer pReserved)>()(
          ptr.ref.lpVtbl, pDebugConfiguration, pReserved);
}
