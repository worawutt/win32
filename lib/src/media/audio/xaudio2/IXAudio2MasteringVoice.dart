...
class IXAudio2MasteringVoice extends IXAudio2Voice {
  ...
  int GetChannelMask(Pointer<Uint32> pChannelmask) => ptr.ref.lpVtbl.value
          .elementAt(19)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Uint32> pChannelmask)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Uint32> pChannelmask)>()(
      ptr.ref.lpVtbl, pChannelmask);
}
