      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<XAPO_REGISTRATION_PROPERTIES>>
                          ppRegistrationProperties)>()(
          ptr.ref.lpVtbl, ppRegistrationProperties);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<WAVEFORMATEX> pRequestedOutputFormat,
                      Pointer<Pointer<WAVEFORMATEX>>
                          ppSupportedOutputFormat)>()(ptr.ref.lpVtbl,
          pInputFormat, pRequestedOutputFormat, ppSupportedOutputFormat);

  int Initialize(Pointer pData, int DataByteSize) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer pData, Uint32 DataByteSize)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer pData, int DataByteSize)>()(
      ptr.ref.lpVtbl, pData, DataByteSize);
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              ...
                              Pointer<XAPO_LOCKFORPROCESS_PARAMETERS>
                  ...
                  Pointer<
                      NativeFunction<
                          Void Function(
                              ...
                              Pointer<XAPO_PROCESS_BUFFER_PARAMETERS>
              ...
              .asFunction<
                  void Function(
                      ...
                      Pointer<XAPO_PROCESS_BUFFER_PARAMETERS>
                          pOutputProcessParameters,
                      int IsEnabled)>()(
          ptr.ref.lpVtbl, InputProcessParameterCount, pInputProcessParameters, OutputProcessParameterCount, pOutputProcessParameters, IsEnabled);

  int CalcInputFrames(int OutputFrameCount) => ptr.ref.lpVtbl.value
          .elementAt(11)
          .cast<
              Pointer<
                  NativeFunction<
                      Uint32 Function(Pointer, Uint32 OutputFrameCount)>>>()
          .value
          .asFunction<int Function(Pointer, int OutputFrameCount)>()(
      ptr.ref.lpVtbl, OutputFrameCount);

  int CalcOutputFrames(int InputFrameCount) => ptr.ref.lpVtbl.value
          .elementAt(12)
          .cast<
              Pointer<
                  NativeFunction<
                      Uint32 Function(Pointer, Uint32 InputFrameCount)>>>()
          .value
          .asFunction<int Function(Pointer, int InputFrameCount)>()(
      ptr.ref.lpVtbl, InputFrameCount);
}
