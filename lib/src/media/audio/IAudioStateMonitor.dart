      ...
      RegisterCallback(
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(
                          Pointer,
                          Pointer<NativeFunction<PAudioStateMonitorCallback>>
                              callback,
                          Pointer context,
                          Pointer<Int64> registration)>()(
              ptr.ref.lpVtbl, callback, context, registration);

  void UnregisterCallback(int registration) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<NativeFunction<Void Function(Pointer, Int64 registration)>>>()
      .value
      .asFunction<
          void Function(
              Pointer, int registration)>()(ptr.ref.lpVtbl, registration);
