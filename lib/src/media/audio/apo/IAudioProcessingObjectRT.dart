...
class IAudioProcessingObjectRT extends IUnknown {
  ...
  int CalcInputFrames(int u32OutputFrameCount) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Uint32 Function(Pointer, Uint32 u32OutputFrameCount)>>>()
          .value
          .asFunction<int Function(Pointer, int u32OutputFrameCount)>()(
      ptr.ref.lpVtbl, u32OutputFrameCount);

  int CalcOutputFrames(int u32InputFrameCount) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Uint32 Function(Pointer, Uint32 u32InputFrameCount)>>>()
          .value
          .asFunction<int Function(Pointer, int u32InputFrameCount)>()(
      ptr.ref.lpVtbl, u32InputFrameCount);
}
