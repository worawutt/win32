...
class IAudioProcessingObjectLoggingService extends IUnknown {
  ...
  void ApoLog(int level, Pointer<Utf16> format) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Void Function(
                          Pointer, Int32 level, Pointer<Utf16> format)>>>()
          .value
          .asFunction<
              void Function(Pointer, int level, Pointer<Utf16> format)>()(
      ptr.ref.lpVtbl, level, format);
}
