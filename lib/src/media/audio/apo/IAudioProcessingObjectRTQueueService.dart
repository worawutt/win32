...
class IAudioProcessingObjectRTQueueService extends IUnknown {
  ...
  int GetRealTimeWorkQueue(Pointer<Uint32> workQueueId) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Uint32> workQueueId)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Uint32> workQueueId)>()(
      ptr.ref.lpVtbl, workQueueId);
}
