              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<APO_NOTIFICATION_DESCRIPTOR>>
                          apoNotifications,
                      Pointer<Uint32> count)>()(
          ptr.ref.lpVtbl, apoNotifications, count);

  void HandleNotification(Pointer<APO_NOTIFICATION> apoNotification) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  void Function(
                      Pointer, Pointer<APO_NOTIFICATION> apoNotification)>()(
          ptr.ref.lpVtbl, apoNotification);
}
