...
class IAudioProcessingObject extends IUnknown {
  ...
  int GetLatency(Pointer<Int64> pTime) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
  ...
  int GetRegistrationProperties(
      ...
      ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(
                  Pointer,
                  Pointer<Pointer<APO_REG_PROPERTIES>>
                      ppRegProps)>()(ptr.ref.lpVtbl, ppRegProps);

  int Initialize(int cbDataSize, Pointer<Uint8> pbyData) => ptr.ref.lpVtbl.value
      .elementAt(6)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Uint32 cbDataSize, Pointer<Uint8> pbyData)>>>()
      .value
      .asFunction<
          int Function(Pointer, int cbDataSize,
              Pointer<Uint8> pbyData)>()(ptr.ref.lpVtbl, cbDataSize, pbyData);
  ...
  int GetInputChannelCount(Pointer<Uint32> pu32ChannelCount) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Uint32> pu32ChannelCount)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> pu32ChannelCount)>()(
          ptr.ref.lpVtbl, pu32ChannelCount);
}
