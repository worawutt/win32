...
class IAudioEndpointVolume extends IUnknown {
  ...
  int RegisterControlChangeNotify(Pointer<COMObject> pNotify) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
  ...
  int GetMasterVolumeLevel(Pointer<Float> pfLevelDB) => ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetMasterVolumeLevelScalar(Pointer<Float> pfLevel) => ptr.ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int SetMute(int bMute, Pointer<GUID> pguidEventContext) =>
      ptr.ref.lpVtbl.value
              .elementAt(14)
              .cast<
                  Pointer<
