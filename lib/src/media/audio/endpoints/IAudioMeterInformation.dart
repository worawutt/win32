...
class IAudioMeterInformation extends IUnknown {
  ...
  int GetPeakValue(Pointer<Float> pfPeak) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Float> pfPeak)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, Pointer<Float> pfPeak)>()(ptr.ref.lpVtbl, pfPeak);

  int GetMeteringChannelCount(Pointer<Uint32> pnChannelCount) =>
  ...
  int GetChannelsPeakValues(int u32ChannelCount, Pointer<Float> afPeakValues) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, int u32ChannelCount,
                      Pointer<Float> afPeakValues)>()(
          ptr.ref.lpVtbl, u32ChannelCount, afPeakValues);
