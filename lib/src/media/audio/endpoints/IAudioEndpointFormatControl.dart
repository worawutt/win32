...
class IAudioEndpointFormatControl extends IUnknown {
  ...
  int ResetToDefault(int ResetFlags) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<NativeFunction<Int32 Function(Pointer, Uint32 ResetFlags)>>>()
      .value
      .asFunction<
          int Function(Pointer, int ResetFlags)>()(ptr.ref.lpVtbl, ResetFlags);
}
