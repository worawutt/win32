...
class IAudioSessionControl2 extends IAudioSessionControl {
  ...
  int GetSessionIdentifier(Pointer<Pointer<Utf16>> pRetVal) => ptr
      .ref.lpVtbl.value
      .elementAt(12)
      .cast<
          Pointer<
  ...
  int GetSessionInstanceIdentifier(Pointer<Pointer<Utf16>> pRetVal) => ptr
      .ref.lpVtbl.value
      .elementAt(13)
      .cast<
          Pointer<
  ...
  int GetProcessId(Pointer<Uint32> pRetVal) => ptr.ref.lpVtbl.value
          .elementAt(14)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int SetDuckingPreference(int optOut) => ptr.ref.lpVtbl.value
      .elementAt(16)
