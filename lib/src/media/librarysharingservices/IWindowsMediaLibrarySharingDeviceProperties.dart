...
class IWindowsMediaLibrarySharingDeviceProperties extends IDispatch {
  ...
  int get_Item(int index, Pointer<Pointer<COMObject>> property) => ptr
          .ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, int index, Pointer<Pointer<COMObject>> property)>()(
      ptr.ref.lpVtbl, index, property);
  ...
  int GetProperty(Pointer<Utf16> name, Pointer<Pointer<COMObject>> property) =>
