...
class IWindowsMediaLibrarySharingServices extends IDispatch {
  ...
  int showShareMediaCPL(Pointer<Utf16> device) => ptr.ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Utf16> device)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, Pointer<Utf16> device)>()(ptr.ref.lpVtbl, device);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Int16> sharingEnabled)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int16> sharingEnabled)>()(
  ...
  set userHomeMediaSharingState(int value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(Pointer, Int16 sharingEnabled)>>>()
            .value
            .asFunction<int Function(Pointer, int sharingEnabled)>()(
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<Utf16>> libraryName)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<Utf16>> libraryName)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set userHomeMediaSharingLibraryName(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(Pointer, Pointer<Utf16> libraryName)>>>()
            .value
            .asFunction<int Function(Pointer, Pointer<Utf16> libraryName)>()(
        ptr.ref.lpVtbl, value);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Int16> sharingAllowed)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int16> sharingAllowed)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set computerHomeMediaSharingAllowedState(int value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(Pointer, Int16 sharingAllowed)>>>()
            .value
            .asFunction<int Function(Pointer, int sharingAllowed)>()(
        ptr.ref.lpVtbl, value);
  ...
  Pointer<Utf16> get internetMediaSharingSecurityGroup {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> securityGroup)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set internetMediaSharingSecurityGroup(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<
                    Int32 Function(Pointer, Pointer<Utf16> securityGroup)>>>()
        .value
        .asFunction<
            int Function(Pointer,
                Pointer<Utf16> securityGroup)>()(ptr.ref.lpVtbl, value);
  ...
  int
      setDefaultAuthorization(Pointer<Utf16> MACAddresses,
              Pointer<Utf16> friendlyName, int authorization) =>
          ptr.ref.lpVtbl.value
                  .elementAt(22)
                  .cast<
                      Pointer<
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<Utf16> MACAddresses,
                          Pointer<Utf16> friendlyName, int authorization)>()(
              ptr.ref.lpVtbl, MACAddresses, friendlyName, authorization);

  int setAuthorizationState(
          Pointer<Utf16> MACAddress, int authorizationState) =>
      ptr.ref.lpVtbl.value
              .elementAt(23)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> MACAddress,
                              Int16 authorizationState)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> MACAddress,
                      int authorizationState)>()(
          ptr.ref.lpVtbl, MACAddress, authorizationState);

  int getAllDevices(Pointer<Pointer<COMObject>> devices) => ptr.ref.lpVtbl.value
          .elementAt(24)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> devices)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> devices)>()(
      ptr.ref.lpVtbl, devices);
  ...
  int get customSettingsApplied {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Int16> customSettingsApplied)>()(
          ptr.ref.lpVtbl, retValuePtr);
