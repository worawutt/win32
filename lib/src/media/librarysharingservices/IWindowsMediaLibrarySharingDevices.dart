...
class IWindowsMediaLibrarySharingDevices extends IDispatch {
  ...
  int get_Item(int index, Pointer<Pointer<COMObject>> device) => ptr
          .ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, int index, Pointer<Pointer<COMObject>> device)>()(
      ptr.ref.lpVtbl, index, device);
  ...
  int GetDevice(Pointer<Utf16> deviceID, Pointer<Pointer<COMObject>> device) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> deviceID,
                              Pointer<Pointer<COMObject>> device)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> deviceID,
                      Pointer<Pointer<COMObject>> device)>()(
          ptr.ref.lpVtbl, deviceID, device);
}
