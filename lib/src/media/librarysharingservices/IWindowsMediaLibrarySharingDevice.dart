...
class IWindowsMediaLibrarySharingDevice extends IDispatch {
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<Utf16>> deviceID)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<Utf16>> deviceID)>()(
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> authorization)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int32> authorization)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  set Authorization(int value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<Int32 Function(Pointer, Int32 authorization)>>>()
        .value
        .asFunction<
            int Function(Pointer, int authorization)>()(ptr.ref.lpVtbl, value);
  ...
  Pointer<COMObject> get Properties {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> deviceProperties)>()(
          ptr.ref.lpVtbl, retValuePtr);
