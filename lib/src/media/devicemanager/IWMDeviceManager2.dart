...
class IWMDeviceManager2 extends IWMDeviceManager {
  ...
  int GetDeviceFromCanonicalName(Pointer<Utf16> pwszCanonicalName,
      ...
      ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> pwszCanonicalName,
                          Pointer<Pointer<COMObject>> ppDevice)>>>()
          .value
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<COMObject>>
                      ppDevice)>()(ptr.ref.lpVtbl, pwszCanonicalName, ppDevice);

  int EnumDevices2(Pointer<Pointer<COMObject>> ppEnumDevice) => ptr
          .ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
