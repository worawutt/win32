...
class IMDSPEnumStorage extends IUnknown {
  ...
  int Next(int celt, Pointer<Pointer<COMObject>> ppStorage,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppStorage,
                      Pointer<Uint32> pceltFetched)>()(
          ptr.ref.lpVtbl, celt, ppStorage, pceltFetched);
  ...
  int Clone(Pointer<Pointer<COMObject>> ppEnumStorage) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
