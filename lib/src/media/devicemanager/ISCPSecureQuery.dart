      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint32> pdwMinExamineData,
                      Pointer<Uint32> pdwMinDecideData,
                      Pointer<Uint8> abMac)>()(ptr.ref.lpVtbl, pfuFlags,
          pdwMinRightsData, pdwMinExamineData, pdwMinDecideData, abMac);

  int ExamineData(int fuFlags, Pointer<Utf16> pwszExtension,
          Pointer<Uint8> pData, int dwSize, Pointer<Uint8> abMac) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      int dwSize,
                      Pointer<Uint8> abMac)>()(
          ptr.ref.lpVtbl, fuFlags, pwszExtension, pData, dwSize, abMac);
