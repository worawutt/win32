...
class IComponentAuthenticate extends IUnknown {
  ...
  int SACGetProtocols(Pointer<Pointer<Uint32>> ppdwProtocols,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<Uint32>> ppdwProtocols,
                      Pointer<Uint32> pdwProtocolCount)>()(
          ptr.ref.lpVtbl, ppdwProtocols, pdwProtocolCount);
}
