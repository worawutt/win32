      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int dwSize,
                      Pointer<COMObject> pProgressCallback,
                      Pointer<Uint32> pfuReadyFlags)>()(ptr.ref.lpVtbl, pDevice,
          pData, dwSize, pProgressCallback, pfuReadyFlags);

  int GetObjectDataOnClearChannel(Pointer<COMObject> pDevice,
          Pointer<Uint8> pData, Pointer<Uint32> pdwSize) =>
      ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<Uint8> pData,
                  Pointer<Uint32>
                      pdwSize)>()(ptr.ref.lpVtbl, pDevice, pData, pdwSize);

  int TransferCompleteForDevice(Pointer<COMObject> pDevice) => ptr
          .ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pDevice)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> pDevice)>()(
