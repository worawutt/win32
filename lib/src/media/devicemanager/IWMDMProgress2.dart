...
class IWMDMProgress2 extends IWMDMProgress {
  ...
  int End2(int hrCompletionCode) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 hrCompletionCode)>>>()
          .value
          .asFunction<int Function(Pointer, int hrCompletionCode)>()(
      ptr.ref.lpVtbl, hrCompletionCode);
}
