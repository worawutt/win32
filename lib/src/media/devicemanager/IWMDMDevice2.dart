...
class IWMDMDevice2 extends IWMDMDevice {
  ...
  int GetStorage(Pointer<Utf16> pszStorageName,
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> pszStorageName,
                              Pointer<Pointer<COMObject>> ppStorage)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> pszStorageName,
                      Pointer<Pointer<COMObject>> ppStorage)>()(
          ptr.ref.lpVtbl, pszStorageName, ppStorage);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<Pointer<COMObject>>> pppUnknowns,
                      Pointer<Uint32> pcUnks)>()(
          ptr.ref.lpVtbl, ppSpecifyPropPages, pppUnknowns, pcUnks);

  int GetCanonicalName(Pointer<Utf16> pwszPnPName, int nMaxChars) =>
      ptr.ref.lpVtbl.value
          .elementAt(17)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> pwszPnPName,
                          Uint32 nMaxChars)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Utf16> pwszPnPName,
                  int nMaxChars)>()(ptr.ref.lpVtbl, pwszPnPName, nMaxChars);
}
