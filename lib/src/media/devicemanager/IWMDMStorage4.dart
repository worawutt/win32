...
class IWMDMStorage4 extends IWMDMStorage3 {
  ...
  int SetReferences(int dwRefs, Pointer<Pointer<COMObject>> ppIWMDMStorage) =>
      ptr.ref.lpVtbl.value
              .elementAt(19)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint32 dwRefs,
                              Pointer<Pointer<COMObject>> ppIWMDMStorage)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int dwRefs,
                      Pointer<Pointer<COMObject>> ppIWMDMStorage)>()(
          ptr.ref.lpVtbl, dwRefs, ppIWMDMStorage);

  int GetReferences(Pointer<Uint32> pdwRefs,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> pdwRefs,
                      Pointer<Pointer<Pointer<COMObject>>> pppIWMDMStorage)>()(
          ptr.ref.lpVtbl, pdwRefs, pppIWMDMStorage);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<WMDMRIGHTS>> ppRights,
                      Pointer<Uint32> pnRightsCount)>()(
          ptr.ref.lpVtbl, pIProgressCallback, ppRights, pnRightsCount);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<Utf16>> ppwszPropNames,
                      Pointer<Pointer<COMObject>> ppMetadata)>()(
          ptr.ref.lpVtbl, cProperties, ppwszPropNames, ppMetadata);

  int FindStorage(int findScope, Pointer<Utf16> pwszUniqueID,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> pwszUniqueID,
                      Pointer<Pointer<COMObject>> ppStorage)>()(
          ptr.ref.lpVtbl, findScope, pwszUniqueID, ppStorage);

  int GetParent(Pointer<Pointer<COMObject>> ppStorage) => ptr.ref.lpVtbl.value
          .elementAt(24)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> ppStorage)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> ppStorage)>()(
      ptr.ref.lpVtbl, ppStorage);
}
