...
class IMDServiceProvider3 extends IMDServiceProvider2 {
  ...
  int SetDeviceEnumPreference(int dwEnumPref) => ptr.ref.lpVtbl.value
      .elementAt(6)
      .cast<
          Pointer<NativeFunction<Int32 Function(Pointer, Uint32 dwEnumPref)>>>()
      .value
      .asFunction<
          int Function(Pointer, int dwEnumPref)>()(ptr.ref.lpVtbl, dwEnumPref);
}
