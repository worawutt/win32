...
class IWMStreamPrioritization extends IUnknown {
  ...
  int GetPriorityRecords(Pointer<WM_STREAM_PRIORITY_RECORD> pRecordArray,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<WM_STREAM_PRIORITY_RECORD> pRecordArray,
                      Pointer<Uint16> pcRecords)>()(
          ptr.ref.lpVtbl, pRecordArray, pcRecords);

  int SetPriorityRecords(
          Pointer<WM_STREAM_PRIORITY_RECORD> pRecordArray, int cRecords) =>
      ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer,
                  Pointer<WM_STREAM_PRIORITY_RECORD> pRecordArray,
                  int cRecords)>()(ptr.ref.lpVtbl, pRecordArray, cRecords);
}
