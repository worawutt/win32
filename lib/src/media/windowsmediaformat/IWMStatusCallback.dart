...
class IWMStatusCallback extends IUnknown {
  ...
  int OnStatus(int Status, int hr, int dwType, Pointer<Uint8> pValue,
          Pointer pvContext) =>
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int Status, int hr, int dwType,
                      Pointer<Uint8> pValue, Pointer pvContext)>()(
          ptr.ref.lpVtbl, Status, hr, dwType, pValue, pvContext);
}
