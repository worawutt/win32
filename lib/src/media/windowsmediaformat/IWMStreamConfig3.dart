...
class IWMStreamConfig3 extends IWMStreamConfig2 {
  ...
  int
      GetLanguage(Pointer<Utf16> pwszLanguageString,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<Utf16> pwszLanguageString,
                          Pointer<Uint16> pcchLanguageStringLength)>()(
              ptr.ref.lpVtbl, pwszLanguageString, pcchLanguageStringLength);

  int SetLanguage(Pointer<Utf16> pwszLanguageString) => ptr.ref.lpVtbl.value
          .elementAt(21)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Utf16> pwszLanguageString)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Utf16> pwszLanguageString)>()(
      ptr.ref.lpVtbl, pwszLanguageString);
}
