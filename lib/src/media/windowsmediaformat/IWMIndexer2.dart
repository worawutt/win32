...
class IWMIndexer2 extends IWMIndexer {
  ...
  int Configure(int wStreamNum, int nIndexerType, Pointer pvInterval,
          Pointer pvIndexType) =>
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int wStreamNum, int nIndexerType,
                      Pointer pvInterval, Pointer pvIndexType)>()(
          ptr.ref.lpVtbl, wStreamNum, nIndexerType, pvInterval, pvIndexType);
}
