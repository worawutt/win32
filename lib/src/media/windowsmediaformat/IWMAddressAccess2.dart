      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<Utf16>> pbstrAddress,
                      Pointer<Pointer<Utf16>> pbstrMask)>()(
          ptr.ref.lpVtbl, aeType, dwEntryNum, pbstrAddress, pbstrMask);

  int AddAccessEntryEx(
          int aeType, Pointer<Utf16> bstrAddress, Pointer<Utf16> bstrMask) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, int aeType, Pointer<Utf16> bstrAddress,
                      Pointer<Utf16> bstrMask)>()(
          ptr.ref.lpVtbl, aeType, bstrAddress, bstrMask);
}
