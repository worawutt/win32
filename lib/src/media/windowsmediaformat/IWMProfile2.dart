...
class IWMProfile2 extends IWMProfile {
  ...
  int GetProfileID(Pointer<GUID> pguidID) => ptr.ref.lpVtbl.value
      .elementAt(21)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<GUID> pguidID)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, Pointer<GUID> pguidID)>()(ptr.ref.lpVtbl, pguidID);
}
