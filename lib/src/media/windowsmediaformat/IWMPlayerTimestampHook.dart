...
class IWMPlayerTimestampHook extends IUnknown {
  ...
  int MapTimestamp(int rtIn, Pointer<Int64> prtOut) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Int64 rtIn, Pointer<Int64> prtOut)>>>()
          .value
          .asFunction<int Function(Pointer, int rtIn, Pointer<Int64> prtOut)>()(
      ptr.ref.lpVtbl, rtIn, prtOut);
}
