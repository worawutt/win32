...
class IWMDRMReader3 extends IWMDRMReader2 {
  ...
  int GetInclusionList(
          Pointer<Pointer<GUID>> ppGuids, Pointer<Uint32> pcGuids) =>
      ptr.ref.lpVtbl.value
          .elementAt(15)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Pointer<GUID>> ppGuids,
                          Pointer<Uint32> pcGuids)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<GUID>> ppGuids,
                  Pointer<Uint32> pcGuids)>()(ptr.ref.lpVtbl, ppGuids, pcGuids);
}
