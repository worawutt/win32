      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint8> pValue,
                      Pointer<Uint16> pcbLength)>()(
          ptr.ref.lpVtbl, dwInputNum, pszName, pType, pValue, pcbLength);

  int SetInputSetting(int dwInputNum, Pointer<Utf16> pszName, int Type,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int dwInputNum, Pointer<Utf16> pszName,
                      int Type, Pointer<Uint8> pValue, int cbLength)>()(
          ptr.ref.lpVtbl, dwInputNum, pszName, Type, pValue, cbLength);
}
