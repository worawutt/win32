...
class IWMStreamConfig2 extends IWMStreamConfig {
  ...
  int GetTransportType(Pointer<Int32> pnTransportType) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Int32> pnTransportType)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> pnTransportType)>()(
          ptr.ref.lpVtbl, pnTransportType);

  int SetTransportType(int nTransportType) => ptr.ref.lpVtbl.value
      .elementAt(15)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Int32 nTransportType)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int nTransportType)>()(ptr.ref.lpVtbl, nTransportType);

  int AddDataUnitExtension(GUID guidExtensionSystemID, int cbExtensionDataSize,
  ...
  int GetDataUnitExtensionCount(Pointer<Uint16> pcDataUnitExtensions) => ptr
          .ref.lpVtbl.value
          .elementAt(17)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Uint16> pcDataUnitExtensions)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Uint16> pcDataUnitExtensions)>()(
      ptr.ref.lpVtbl, pcDataUnitExtensions);
