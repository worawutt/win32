...
class IWMDRMReader extends IUnknown {
  ...
  int AcquireLicense(int dwFlags) => ptr.ref.lpVtbl.value
      .elementAt(3)
  ...
  int Individualize(int dwFlags) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Uint32 dwFlags)>>>()
      .value
      .asFunction<
  ...
  int SetDRMProperty(Pointer<Utf16> pwstrName, int dwType,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> pwstrName, int dwType,
                      Pointer<Uint8> pValue, int cbLength)>()(
          ptr.ref.lpVtbl, pwstrName, dwType, pValue, cbLength);

  int GetDRMProperty(Pointer<Utf16> pwstrName, Pointer<Int32> pdwType,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint8> pValue,
                      Pointer<Uint16> pcbLength)>()(
          ptr.ref.lpVtbl, pwstrName, pdwType, pValue, pcbLength);
}
