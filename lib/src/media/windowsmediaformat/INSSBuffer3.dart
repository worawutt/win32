...
class INSSBuffer3 extends INSSBuffer2 {
  ...
  int SetProperty(GUID guidBufferProperty, Pointer pvBufferProperty,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, GUID guidBufferProperty,
                      Pointer pvBufferProperty, int dwBufferPropertySize)>()(
          ptr.ref.lpVtbl,
          guidBufferProperty,
          pvBufferProperty,
          dwBufferPropertySize);

  int GetProperty(GUID guidBufferProperty, Pointer pvBufferProperty,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      GUID guidBufferProperty,
                      Pointer pvBufferProperty,
                      Pointer<Uint32> pdwBufferPropertySize)>()(ptr.ref.lpVtbl,
          guidBufferProperty, pvBufferProperty, pdwBufferPropertySize);
}
