...
class IWMDRMTranscryptor extends IUnknown {
  ...
  int Seek(int hnsTime) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Uint64 hnsTime)>>>()
      .value
      .asFunction<
          int Function(Pointer, int hnsTime)>()(ptr.ref.lpVtbl, hnsTime);

  int Read(Pointer<Uint8> pbData, Pointer<Uint32> pcbData) =>
      ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
