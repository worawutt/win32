...
class IAMWMBufferPassCallback extends IUnknown {
  ...
  int Notify(Pointer<COMObject> pNSSBuffer3, Pointer<COMObject> pPin,
          Pointer<Int64> prtStart, Pointer<Int64> prtEnd) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Int64> prtStart,
                      Pointer<Int64> prtEnd)>()(
          ptr.ref.lpVtbl, pNSSBuffer3, pPin, prtStart, prtEnd);
}
