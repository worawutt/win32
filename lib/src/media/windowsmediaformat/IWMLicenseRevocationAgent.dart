...
class IWMLicenseRevocationAgent extends IUnknown {
  ...
  int ProcessLRB(Pointer<Uint8> pSignedLRB, int dwSignedLRBLength,
          Pointer<Uint8> pSignedACK, Pointer<Uint32> pdwSignedACKLength) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint8> pSignedACK,
                      Pointer<Uint32> pdwSignedACKLength)>()(ptr.ref.lpVtbl,
          pSignedLRB, dwSignedLRBLength, pSignedACK, pdwSignedACKLength);
}
