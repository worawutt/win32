...
class IWMImageInfo extends IUnknown {
  ...
  int GetImageCount(Pointer<Uint32> pcImages) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Uint32> pcImages)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Uint32> pcImages)>()(
      ptr.ref.lpVtbl, pcImages);
