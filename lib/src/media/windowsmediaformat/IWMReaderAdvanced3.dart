...
class IWMReaderAdvanced3 extends IWMReaderAdvanced2 {
  ...
  int StartAtPosition(int wStreamNum, Pointer pvOffsetStart, Pointer pvDuration,
          int dwOffsetFormat, double fRate, Pointer pvContext) =>
      ptr.ref.lpVtbl.value
          ...
          pvOffsetStart, pvDuration, dwOffsetFormat, fRate, pvContext);
}
