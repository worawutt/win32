...
class IWMGetSecureChannel extends IUnknown {
  ...
  int GetPeerSecureChannelInterface(Pointer<Pointer<COMObject>> ppPeer) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<COMObject>> ppPeer)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<COMObject>> ppPeer)>()(
          ptr.ref.lpVtbl, ppPeer);
}
