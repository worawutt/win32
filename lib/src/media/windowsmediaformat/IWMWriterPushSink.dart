...
class IWMWriterPushSink extends IWMWriterSink {
  ...
  int Connect(Pointer<Utf16> pwszURL, Pointer<Utf16> pwszTemplateURL,
          int fAutoDestroy) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> pwszURL,
                      Pointer<Utf16> pwszTemplateURL, int fAutoDestroy)>()(
          ptr.ref.lpVtbl, pwszURL, pwszTemplateURL, fAutoDestroy);
