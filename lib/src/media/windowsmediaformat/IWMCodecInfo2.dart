...
class IWMCodecInfo2 extends IWMCodecInfo {
  ...
  int GetCodecName(Pointer<GUID> guidType, int dwCodecIndex,
          Pointer<Utf16> wszName, Pointer<Uint32> pcchName) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> wszName,
                      Pointer<Uint32> pcchName)>()(
          ptr.ref.lpVtbl, guidType, dwCodecIndex, wszName, pcchName);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppIStreamConfig,
                      Pointer<Utf16> wszDesc,
                      Pointer<Uint32> pcchDesc)>()(ptr.ref.lpVtbl, guidType,
          dwCodecIndex, dwFormatIndex, ppIStreamConfig, wszDesc, pcchDesc);
}
