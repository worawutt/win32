...
class IWMSInternalAdminNetSource3 extends IWMSInternalAdminNetSource2 {
  ...
  int
      GetNetSourceCreator2(Pointer<Pointer<COMObject>> ppNetSourceCreator) =>
  ...
  int RegisterProxyFailure2(int hrParam, int qwProxyContext) => ptr
          .ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Int32 hrParam, Uint64 qwProxyContext)>>>()
          .value
          .asFunction<int Function(Pointer, int hrParam, int qwProxyContext)>()(
      ptr.ref.lpVtbl, hrParam, qwProxyContext);

  int ShutdownProxyContext2(int qwProxyContext) => ptr.ref.lpVtbl.value
      .elementAt(10)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Uint64 qwProxyContext)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int qwProxyContext)>()(ptr.ref.lpVtbl, qwProxyContext);

  int IsUsingIE2(int qwProxyContext, Pointer<Int32> pfIsUsingIE) => ptr
          .ref.lpVtbl.value
          .elementAt(11)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Uint64 qwProxyContext,
                          Pointer<Int32> pfIsUsingIE)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer, int qwProxyContext, Pointer<Int32> pfIsUsingIE)>()(
      ptr.ref.lpVtbl, qwProxyContext, pfIsUsingIE);
