...
class IWMSInternalAdminNetSource2 extends IUnknown {
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> bstrPassword,
                      int fPersist,
                      int fConfirmedGood)>()(ptr.ref.lpVtbl, bstrRealm, bstrUrl,
          fProxy, bstrName, bstrPassword, fPersist, fConfirmedGood);
  ...
  int DeleteCredentialsEx(
          Pointer<Utf16> bstrRealm, Pointer<Utf16> bstrUrl, int fProxy) =>
      ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> bstrRealm,
                          Pointer<Utf16> bstrUrl, Int32 fProxy)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer,
                  Pointer<Utf16> bstrRealm,
                  Pointer<Utf16> bstrUrl,
                  int fProxy)>()(ptr.ref.lpVtbl, bstrRealm, bstrUrl, fProxy);
