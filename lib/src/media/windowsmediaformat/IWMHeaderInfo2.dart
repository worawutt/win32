...
class IWMHeaderInfo2 extends IWMHeaderInfo {
  ...
  int GetCodecInfoCount(Pointer<Uint32> pcCodecInfos) => ptr.ref.lpVtbl.value
          .elementAt(15)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Uint32> pcCodecInfos)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Uint32> pcCodecInfos)>()(
      ptr.ref.lpVtbl, pcCodecInfos);
