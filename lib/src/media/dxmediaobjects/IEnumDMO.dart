...
class IEnumDMO extends IUnknown {
  ...
  int Next(int cItemsToFetch, Pointer<GUID> pCLSID,
          Pointer<Pointer<Utf16>> Names, Pointer<Uint32> pcItemsFetched) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<Utf16>> Names,
                      Pointer<Uint32> pcItemsFetched)>()(
          ptr.ref.lpVtbl, cItemsToFetch, pCLSID, Names, pcItemsFetched);

  int Skip(int cItemsToSkip) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Uint32 cItemsToSkip)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int cItemsToSkip)>()(ptr.ref.lpVtbl, cItemsToSkip);
