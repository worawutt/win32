...
class IITDatabase extends IUnknown {
  ...
  int Open(Pointer<Utf16> lpszHost, Pointer<Utf16> lpszMoniker, int dwFlags) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> lpszHost,
                              Pointer<Utf16> lpszMoniker, Uint32 dwFlags)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> lpszHost,
                      Pointer<Utf16> lpszMoniker, int dwFlags)>()(
  ...
  int CreateObject(Pointer<GUID> rclsid, Pointer<Uint32> pdwObjInstance) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<GUID> rclsid,
                      Pointer<Uint32> pdwObjInstance)>()(
          ptr.ref.lpVtbl, rclsid, pdwObjInstance);
  ...
  int GetObject(
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint32 dwObjInstance,
                              Pointer<GUID> riid, Pointer<Pointer> ppvObj)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int dwObjInstance, Pointer<GUID> riid,
