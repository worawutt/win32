...
class IStemmerConfig extends IUnknown {
  ...
  int SetControlInfo(int grfStemFlags, int dwReserved) => ptr.ref.lpVtbl.value
          ...
          .value
          .asFunction<
              int Function(Pointer, int grfStemFlags, int dwReserved)>()(
  ...
  int GetControlInfo(
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Uint32> pgrfStemFlags,
                              Pointer<Uint32> pdwReserved)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> pgrfStemFlags,
                      Pointer<Uint32> pdwReserved)>()(
          ptr.ref.lpVtbl, pgrfStemFlags, pdwReserved);

  int LoadExternalStemmerData(Pointer<COMObject> pStream, int dwExtDataType) =>
      ptr.ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
