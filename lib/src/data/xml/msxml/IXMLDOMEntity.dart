    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<VARIANT> publicID)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<VARIANT> publicID)>()(ptr.ref.lpVtbl, retValuePtr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<VARIANT> systemID)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<VARIANT> systemID)>()(ptr.ref.lpVtbl, retValuePtr);
