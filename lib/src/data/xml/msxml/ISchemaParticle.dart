    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<VARIANT> minOccurs)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<VARIANT> minOccurs)>()(ptr.ref.lpVtbl, retValuePtr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<VARIANT> maxOccurs)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<VARIANT> maxOccurs)>()(ptr.ref.lpVtbl, retValuePtr);
