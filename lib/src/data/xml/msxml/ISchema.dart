  ...
  Pointer<Utf16> get targetNamespace {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> targetNamespace)>()(
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<COMObject>> types)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<COMObject>> types)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  Pointer<COMObject> get attributeGroups {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> attributeGroups)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  Pointer<COMObject> get modelGroups {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> modelGroups)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  Pointer<COMObject> get notations {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> notations)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  Pointer<COMObject> get schemaLocations {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> schemaLocations)>()(
          ptr.ref.lpVtbl, retValuePtr);
