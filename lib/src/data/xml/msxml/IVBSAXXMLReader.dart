...
typedef _get_baseURL_Native = Int32 Function(
  Pointer,
  Pointer<Pointer<Utf16>> );
typedef _get_baseURL_Dart = int Function(
  Pointer,
  Pointer<Pointer<Utf16>> );

typedef _put_baseURL_Native = Int32 Function(
  Pointer,
  Pointer<Utf16> strBaseURL
);
typedef _put_baseURL_Dart = int Function(
  Pointer,
  Pointer<Utf16> strBaseURL
);

typedef _get_secureBaseURL_Native = Int32 Function(
  Pointer,
  Pointer<Pointer<Utf16>> );
typedef _get_secureBaseURL_Dart = int Function(
  Pointer,
  Pointer<Pointer<Utf16>> );

typedef _put_secureBaseURL_Native = Int32 Function(
  Pointer,
  Pointer<Utf16> strSecureBaseURL
);
typedef _put_secureBaseURL_Dart = int Function(
  Pointer,
  Pointer<Utf16> strSecureBaseURL
);
...
class IVBSAXXMLReader extends IDispatch {
  ...
  int putref_errorHandler(COMObject oHandler) => ptr.ref.lpVtbl.value      .elementAt(18)
    ...
    Pointer<Utf16> get baseURL {
      ...
      try {
        final hr = ptr.ref.lpVtbl.value
          .elementAt(19)
          .cast<Pointer<NativeFunction<_get_baseURL_Native>>>()
          .value
          .asFunction<_get_baseURL_Dart>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  set baseURL(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
          .elementAt(20)
          .cast<Pointer<NativeFunction<_put_baseURL_Native>>>()
          .value
          .asFunction<_put_baseURL_Dart>()(ptr.ref.lpVtbl, value);
    ...
    Pointer<Utf16> get secureBaseURL {
      ...
      try {
        final hr = ptr.ref.lpVtbl.value
          .elementAt(21)
          .cast<Pointer<NativeFunction<_get_secureBaseURL_Native>>>()
          .value
          .asFunction<_get_secureBaseURL_Dart>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  set secureBaseURL(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
          .elementAt(22)
          .cast<Pointer<NativeFunction<_put_secureBaseURL_Native>>>()
          .value
          .asFunction<_put_secureBaseURL_Dart>()(ptr.ref.lpVtbl, value);

    if (FAILED(hr)) throw WindowsException(hr);
  }

  int parse(VARIANT varInput) => ptr.ref.lpVtbl.value      .elementAt(23)
      .cast<Pointer<NativeFunction<_parse_Native>>>()
      .value
      .asFunction<_parse_Dart>()(ptr.ref.lpVtbl, varInput);

  int parseURL(Pointer<Utf16> strURL) => ptr.ref.lpVtbl.value      .elementAt(24)
      .cast<Pointer<NativeFunction<_parseURL_Native>>>()
      .value
      .asFunction<_parseURL_Dart>()(ptr.ref.lpVtbl, strURL);
