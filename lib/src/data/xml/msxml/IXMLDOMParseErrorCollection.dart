...
class IXMLDOMParseErrorCollection extends IDispatch {
  ...
  int get_item(int index, Pointer<Pointer<COMObject>> error) => ptr
          .ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, int index, Pointer<Pointer<COMObject>> error)>()(
      ptr.ref.lpVtbl, index, error);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<COMObject>> error)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<COMObject>> error)>()(
          ptr.ref.lpVtbl, retValuePtr);
