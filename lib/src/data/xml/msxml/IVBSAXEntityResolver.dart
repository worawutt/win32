...
class IVBSAXEntityResolver extends IDispatch {
  ...
  int resolveEntity(Pointer<Pointer<Utf16>> strPublicId,
          Pointer<Pointer<Utf16>> strSystemId, Pointer<VARIANT> varInput) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<Utf16>> strSystemId,
                      Pointer<VARIANT> varInput)>()(
          ptr.ref.lpVtbl, strPublicId, strSystemId, varInput);
}
