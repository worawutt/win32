...
class IXMLDOMParseError2 extends IXMLDOMParseError {
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<Utf16>> xpathexpr)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<Utf16>> xpathexpr)>()(
  ...
  Pointer<COMObject> get allErrors {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> allErrors)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  int errorParameters(int index, Pointer<Pointer<Utf16>> param1) => ptr
      .ref.lpVtbl.value
      .elementAt(16)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Int32 index, Pointer<Pointer<Utf16>> param1)>>>()
      .value
      .asFunction<
          int Function(Pointer, int index,
              Pointer<Pointer<Utf16>> param1)>()(ptr.ref.lpVtbl, index, param1);
