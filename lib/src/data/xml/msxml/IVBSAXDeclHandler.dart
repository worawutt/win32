...
class IVBSAXDeclHandler extends IDispatch {
  ...
  int elementDecl(
          Pointer<Pointer<Utf16>> strName, Pointer<Pointer<Utf16>> strModel) =>
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<Utf16>>
                      strModel)>()(ptr.ref.lpVtbl, strName, strModel);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<Utf16>> strType,
                      Pointer<Pointer<Utf16>> strValueDefault,
                      Pointer<Pointer<Utf16>> strValue)>()(ptr.ref.lpVtbl,
          strElementName, strAttributeName, strType, strValueDefault, strValue);

  int internalEntityDecl(
          Pointer<Pointer<Utf16>> strName, Pointer<Pointer<Utf16>> strValue) =>
      ptr.ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<Utf16>> strName,
                  Pointer<Pointer<Utf16>>
                      strValue)>()(ptr.ref.lpVtbl, strName, strValue);
