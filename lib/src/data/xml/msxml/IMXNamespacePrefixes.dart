...
class IMXNamespacePrefixes extends IDispatch {
  ...
  int get_item(int index, Pointer<Pointer<Utf16>> prefix) => ptr
      .ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Int32 index, Pointer<Pointer<Utf16>> prefix)>>>()
      .value
      .asFunction<
          int Function(Pointer, int index,
              Pointer<Pointer<Utf16>> prefix)>()(ptr.ref.lpVtbl, index, prefix);
