...
class ISAXDeclHandler extends IUnknown {
  ...
  int elementDecl(Pointer<Utf16> pwchName, int cchName,
          Pointer<Utf16> pwchModel, int cchModel) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> pwchName, int cchName,
                      Pointer<Utf16> pwchModel, int cchModel)>()(
          ptr.ref.lpVtbl, pwchName, cchName, pwchModel, cchModel);
  ...
  int internalEntityDecl(Pointer<Utf16> pwchName, int cchName,
          Pointer<Utf16> pwchValue, int cchValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> pwchName, int cchName,
                      Pointer<Utf16> pwchValue, int cchValue)>()(
          ptr.ref.lpVtbl, pwchName, cchName, pwchValue, cchValue);
