...
class ISchemaItem extends IDispatch {
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<COMObject>> schema)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<COMObject>> schema)>()(
          ptr.ref.lpVtbl, retValuePtr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> itemType)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> itemType)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  int writeAnnotation(
          Pointer<COMObject> annotationSink, Pointer<Int16> isWritten) =>
      ptr.ref.lpVtbl.value
          .elementAt(13)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> annotationSink,
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<Int16>
                      isWritten)>()(ptr.ref.lpVtbl, annotationSink, isWritten);
}
