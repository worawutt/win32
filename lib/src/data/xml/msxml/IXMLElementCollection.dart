...
class IXMLElementCollection extends IDispatch {
  ...
  int item(VARIANT var1, VARIANT var2, Pointer<Pointer<COMObject>> ppDisp) =>
      ptr.ref.lpVtbl.value
              .elementAt(10)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, VARIANT var1, VARIANT var2,
                              Pointer<Pointer<COMObject>> ppDisp)>>>()
              .value
              .asFunction<
                  int Function(Pointer, VARIANT var1, VARIANT var2,
                      Pointer<Pointer<COMObject>> ppDisp)>()(
          ptr.ref.lpVtbl, var1, var2, ppDisp);
}
