...
class IServerXMLHTTPRequest2 extends IServerXMLHTTPRequest {
  ...
  int
      setProxy(int proxySetting, VARIANT varProxyServer,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, int proxySetting,
                          VARIANT varProxyServer, VARIANT varBypassList)>()(
              ptr.ref.lpVtbl, proxySetting, varProxyServer, varBypassList);
