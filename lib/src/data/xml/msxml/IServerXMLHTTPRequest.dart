...
class IServerXMLHTTPRequest extends IXMLHTTPRequest {
  ...
  int waitForResponse(VARIANT timeoutInSeconds, Pointer<Int16> isSuccessful) =>
      ptr.ref.lpVtbl.value
              .elementAt(22)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, VARIANT timeoutInSeconds,
                              Pointer<Int16> isSuccessful)>>>()
              .value
              .asFunction<
                  int Function(Pointer, VARIANT timeoutInSeconds,
                      Pointer<Int16> isSuccessful)>()(
          ptr.ref.lpVtbl, timeoutInSeconds, isSuccessful);

  int getOption(int option, Pointer<VARIANT> value) => ptr.ref.lpVtbl.value
          .elementAt(23)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Int32 option, Pointer<VARIANT> value)>>>()
          .value
          .asFunction<
              int Function(Pointer, int option, Pointer<VARIANT> value)>()(
      ptr.ref.lpVtbl, option, value);

  int setOption(int option, VARIANT value) => ptr.ref.lpVtbl.value
          .elementAt(24)
          .cast<
              Pointer<
                  NativeFunction<
