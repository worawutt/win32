...
class IXMLHTTPRequest3 extends IXMLHTTPRequest2 {
  ...
  int SetClientCertificate(int cbClientCertificateHash,
          Pointer<Uint8> pbClientCertificateHash, Pointer<Utf16> pwszPin) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint8> pbClientCertificateHash,
                      Pointer<Utf16> pwszPin)>()(ptr.ref.lpVtbl,
          cbClientCertificateHash, pbClientCertificateHash, pwszPin);
}
