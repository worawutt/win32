...
class IXMLDOMSchemaCollection2 extends IXMLDOMSchemaCollection {
  ...
  set validateOnLoad(int value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(Pointer, Int16 validateOnLoad)>>>()
            .value
            .asFunction<int Function(Pointer, int validateOnLoad)>()(
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Int16> validateOnLoad)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int16> validateOnLoad)>()(
  ...
  int getSchema(
          Pointer<Utf16> namespaceURI, Pointer<Pointer<COMObject>> schema) =>
      ptr.ref.lpVtbl.value
              .elementAt(17)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> namespaceURI,
                      Pointer<Pointer<COMObject>> schema)>()(
          ptr.ref.lpVtbl, namespaceURI, schema);

  int getDeclaration(
          Pointer<COMObject> node, Pointer<Pointer<COMObject>> item) =>
      ptr.ref.lpVtbl.value
              .elementAt(18)
              .cast<
                  Pointer<
