...
class IXMLDOMElement extends IXMLDOMNode {
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<Utf16>> tagName)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<Utf16>> tagName)>()(
  ...
  int getAttributeNode(
          Pointer<Utf16> name, Pointer<Pointer<COMObject>> attributeNode) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> name,
                      Pointer<Pointer<COMObject>> attributeNode)>()(
          ptr.ref.lpVtbl, name, attributeNode);

  int
      setAttributeNode(Pointer<COMObject> DOMAttribute,
              Pointer<Pointer<COMObject>> attributeNode) =>
          ptr.ref.lpVtbl.value
                  .elementAt(48)
                  .cast<
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<COMObject> DOMAttribute,
                          Pointer<Pointer<COMObject>> attributeNode)>()(
              ptr.ref.lpVtbl, DOMAttribute, attributeNode);

  int
      removeAttributeNode(Pointer<COMObject> DOMAttribute,
              Pointer<Pointer<COMObject>> attributeNode) =>
          ptr.ref.lpVtbl.value
                  .elementAt(49)
                  .cast<
