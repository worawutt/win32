...
class IMXSchemaDeclHandler extends IDispatch {
  ...
  int schemaElementDecl(Pointer<COMObject> oSchemaElement) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<COMObject> oSchemaElement)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> oSchemaElement)>()(
          ptr.ref.lpVtbl, oSchemaElement);
}
