...
class ISchemaItemCollection extends IDispatch {
  ...
  int itemByName(Pointer<Utf16> name, Pointer<Pointer<COMObject>> item) => ptr
      .ref.lpVtbl.value
      .elementAt(8)
      .cast<
          Pointer<
      ...
      .asFunction<
          int Function(Pointer, Pointer<Utf16> name,
              Pointer<Pointer<COMObject>> item)>()(ptr.ref.lpVtbl, name, item);

  int itemByQName(Pointer<Utf16> name, Pointer<Utf16> namespaceURI,
          Pointer<Pointer<COMObject>> item) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> namespaceURI,
                      Pointer<Pointer<COMObject>> item)>()(
          ptr.ref.lpVtbl, name, namespaceURI, item);
