...
class IVBSAXErrorHandler extends IDispatch {
  ...
  int error(Pointer<COMObject> oLocator,
          Pointer<Pointer<Utf16>> strErrorMessage, int nErrorCode) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<Utf16>> strErrorMessage,
                      int nErrorCode)>()(
          ptr.ref.lpVtbl, oLocator, strErrorMessage, nErrorCode);

  int fatalError(Pointer<COMObject> oLocator,
          Pointer<Pointer<Utf16>> strErrorMessage, int nErrorCode) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
  ...
  int ignorableWarning(Pointer<COMObject> oLocator,
          Pointer<Pointer<Utf16>> strErrorMessage, int nErrorCode) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
