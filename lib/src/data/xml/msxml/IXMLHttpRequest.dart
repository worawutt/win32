...
class IXMLHTTPRequest extends IDispatch {
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      VARIANT varAsync,
                      VARIANT bstrUser,
                      VARIANT bstrPassword)>()(ptr.ref.lpVtbl, bstrMethod,
  ...
  int getResponseHeader(
          Pointer<Utf16> bstrHeader, Pointer<Pointer<Utf16>> pbstrValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrHeader,
                      Pointer<Pointer<Utf16>> pbstrValue)>()(
          ptr.ref.lpVtbl, bstrHeader, pbstrValue);

  int getAllResponseHeaders(Pointer<Pointer<Utf16>> pbstrHeaders) => ptr
          .ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<Utf16>> pbstrHeaders)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<Utf16>> pbstrHeaders)>()(
      ptr.ref.lpVtbl, pbstrHeaders);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> plStatus)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> plStatus)>()(
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<COMObject>> ppBody)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<COMObject>> ppBody)>()(
          ptr.ref.lpVtbl, retValuePtr);
    ...
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(
                            Pointer, Pointer<COMObject> pReadyStateSink)>>>()
            .value
            .asFunction<
                int Function(Pointer, Pointer<COMObject> pReadyStateSink)>()(
        ptr.ref.lpVtbl, value);
