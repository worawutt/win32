...
class IXMLDOMDocument3 extends IXMLDOMDocument2 {
  ...
  int validateNode(
          Pointer<COMObject> node, Pointer<Pointer<COMObject>> errorObj) =>
      ptr
              .ref.lpVtbl.value
              .elementAt(82)
              .cast<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> node,
                      Pointer<Pointer<COMObject>> errorObj)>()(
          ptr.ref.lpVtbl, node, errorObj);

  int importNode(Pointer<COMObject> node, int deep,
      ...
      ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> node,
                          Int16 deep, Pointer<Pointer<COMObject>> clone)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer,
                  ...
                  Pointer<Pointer<COMObject>>
                      clone)>()(ptr.ref.lpVtbl, node, deep, clone);
}
