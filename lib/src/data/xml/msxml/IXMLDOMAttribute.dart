  ...
  Pointer<Utf16> get name {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> attributeName)>()(
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<VARIANT> attributeValue)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<VARIANT> attributeValue)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set value(VARIANT value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(Pointer, VARIANT attributeValue)>>>()
            .value
            .asFunction<int Function(Pointer, VARIANT attributeValue)>()(
