  ...
  Pointer<COMObject> get anyAttribute {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> anyAttribute)>()(
          ptr.ref.lpVtbl, retValuePtr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> contentType)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int32> contentType)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  Pointer<COMObject> get contentModel {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> contentModel)>()(
          ptr.ref.lpVtbl, retValuePtr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> prohibited)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int32> prohibited)>()(ptr.ref.lpVtbl, retValuePtr);
