...
int CreateXmlReader(Pointer<GUID> riid, Pointer<Pointer> ppvObject,
        Pointer<COMObject> pMalloc) =>
    _CreateXmlReader(riid, ppvObject, pMalloc);

late final _CreateXmlReader = _xmllite.lookupFunction<
    Int32 Function(Pointer<GUID> riid, Pointer<Pointer> ppvObject,
        Pointer<COMObject> pMalloc),
    int Function(Pointer<GUID> riid, Pointer<Pointer> ppvObject,
        Pointer<COMObject> pMalloc)>('CreateXmlReader');
...
int CreateXmlReaderInputWithEncodingCodePage(
    ...
    _CreateXmlReaderInputWithEncodingCodePage(pInputStream, pMalloc,
...
int CreateXmlReaderInputWithEncodingName(
        ...
        Pointer<Utf16> pwszBaseUri,
        Pointer<Pointer<COMObject>> ppInput) =>
    _CreateXmlReaderInputWithEncodingName(pInputStream, pMalloc,
...
int CreateXmlWriter(Pointer<GUID> riid, Pointer<Pointer> ppvObject,
        Pointer<COMObject> pMalloc) =>
    _CreateXmlWriter(riid, ppvObject, pMalloc);

late final _CreateXmlWriter = _xmllite.lookupFunction<
    Int32 Function(Pointer<GUID> riid, Pointer<Pointer> ppvObject,
        Pointer<COMObject> pMalloc),
    int Function(Pointer<GUID> riid, Pointer<Pointer> ppvObject,
        Pointer<COMObject> pMalloc)>('CreateXmlWriter');
...
late final _CreateXmlWriterOutputWithEncodingCodePage = _xmllite.lookupFunction<
    Int32 Function(Pointer<COMObject> pOutputStream, Pointer<COMObject> pMalloc,
        Uint32 nEncodingCodePage, Pointer<Pointer<COMObject>> ppOutput),
    int Function(
        Pointer<COMObject> pOutputStream,
        Pointer<COMObject> pMalloc,
        int nEncodingCodePage,
        Pointer<Pointer<COMObject>>
            ppOutput)>('CreateXmlWriterOutputWithEncodingCodePage');
...
late final _CreateXmlWriterOutputWithEncodingName = _xmllite.lookupFunction<
    Int32 Function(Pointer<COMObject> pOutputStream, Pointer<COMObject> pMalloc,
        Pointer<Utf16> pwszEncodingName, Pointer<Pointer<COMObject>> ppOutput),
    int Function(
        Pointer<COMObject> pOutputStream,
        Pointer<COMObject> pMalloc,
        Pointer<Utf16> pwszEncodingName,
        Pointer<Pointer<COMObject>>
            ppOutput)>('CreateXmlWriterOutputWithEncodingName');
