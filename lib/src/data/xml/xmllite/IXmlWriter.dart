...
typedef _WriteQualifiedName_Native = Int32 Function(
  Pointer,
  Pointer<Utf16> pwszLocalName, 
  Pointer<Utf16> pwszNamespaceUri
);
typedef _WriteQualifiedName_Dart = int Function(
  Pointer,
  Pointer<Utf16> pwszLocalName, 
  Pointer<Utf16> pwszNamespaceUri
);
...
class IXmlWriter extends IUnknown {
  ...
  int WriteAttributeString(Pointer<Utf16> pwszPrefix, Pointer<Utf16> pwszLocalName, Pointer<Utf16> pwszNamespaceUri, Pointer<Utf16> pwszValue) => ptr.ref.lpVtbl.value      .elementAt(7)
      .cast<Pointer<NativeFunction<_WriteAttributeString_Native>>>()
      .value
      .asFunction<_WriteAttributeString_Dart>()(ptr.ref.lpVtbl, pwszPrefix, pwszLocalName, pwszNamespaceUri, pwszValue);
  ...
  int WriteElementString(Pointer<Utf16> pwszPrefix, Pointer<Utf16> pwszLocalName, Pointer<Utf16> pwszNamespaceUri, Pointer<Utf16> pwszValue) => ptr.ref.lpVtbl.value      .elementAt(13)
      .cast<Pointer<NativeFunction<_WriteElementString_Native>>>()
      .value
      .asFunction<_WriteElementString_Dart>()(ptr.ref.lpVtbl, pwszPrefix, pwszLocalName, pwszNamespaceUri, pwszValue);
  ...
  int WriteEndElement() => ptr.ref.lpVtbl.value      .elementAt(15)
      .cast<Pointer<NativeFunction<_WriteEndElement_Native>>>()
      .value
      .asFunction<_WriteEndElement_Dart>()(ptr.ref.lpVtbl);
  ...
  int WriteFullEndElement() => ptr.ref.lpVtbl.value      .elementAt(17)
      .cast<Pointer<NativeFunction<_WriteFullEndElement_Native>>>()
      .value
      .asFunction<_WriteFullEndElement_Dart>()(ptr.ref.lpVtbl);
  ...
  int WriteQualifiedName(Pointer<Utf16> pwszLocalName, Pointer<Utf16> pwszNamespaceUri) => ptr.ref.lpVtbl.value      .elementAt(23)
      .cast<Pointer<NativeFunction<_WriteQualifiedName_Native>>>()
      .value
      .asFunction<_WriteQualifiedName_Dart>()(ptr.ref.lpVtbl, pwszLocalName, pwszNamespaceUri);

  int WriteRaw(Pointer<Utf16> pwszData) => ptr.ref.lpVtbl.value      .elementAt(24)
      .cast<Pointer<NativeFunction<_WriteRaw_Native>>>()
      .value
      .asFunction<_WriteRaw_Dart>()(ptr.ref.lpVtbl, pwszData);

  int WriteRawChars(Pointer<Utf16> pwch, int cwch) => ptr.ref.lpVtbl.value      .elementAt(25)
      .cast<Pointer<NativeFunction<_WriteRawChars_Native>>>()
      .value
      .asFunction<_WriteRawChars_Dart>()(ptr.ref.lpVtbl, pwch, cwch);

  int WriteStartDocument(int standalone) => ptr.ref.lpVtbl.value      .elementAt(26)
      .cast<Pointer<NativeFunction<_WriteStartDocument_Native>>>()
      .value
      .asFunction<_WriteStartDocument_Dart>()(ptr.ref.lpVtbl, standalone);

  int WriteStartElement(Pointer<Utf16> pwszPrefix, Pointer<Utf16> pwszLocalName, Pointer<Utf16> pwszNamespaceUri) => ptr.ref.lpVtbl.value      .elementAt(27)
      .cast<Pointer<NativeFunction<_WriteStartElement_Native>>>()
      .value
      .asFunction<_WriteStartElement_Dart>()(ptr.ref.lpVtbl, pwszPrefix, pwszLocalName, pwszNamespaceUri);

  int WriteString(Pointer<Utf16> pwszText) => ptr.ref.lpVtbl.value      .elementAt(28)
      .cast<Pointer<NativeFunction<_WriteString_Native>>>()
      .value
      .asFunction<_WriteString_Dart>()(ptr.ref.lpVtbl, pwszText);

  int WriteSurrogateCharEntity(int wchLow, int wchHigh) => ptr.ref.lpVtbl.value      .elementAt(29)
  ...
  int WriteWhitespace(Pointer<Utf16> pwszWhitespace) => ptr.ref.lpVtbl.value      .elementAt(30)
      .cast<Pointer<NativeFunction<_WriteWhitespace_Native>>>()
      .value
      .asFunction<_WriteWhitespace_Dart>()(ptr.ref.lpVtbl, pwszWhitespace);

  int Flush() => ptr.ref.lpVtbl.value      .elementAt(31)
