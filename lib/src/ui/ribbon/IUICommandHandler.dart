...
class IUICommandHandler extends IUnknown {
  ...
  int UpdateProperty(int commandId, Pointer<PROPERTYKEY> key,
          Pointer<PROPVARIANT> currentValue, Pointer<PROPVARIANT> newValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<PROPVARIANT> currentValue,
                      Pointer<PROPVARIANT> newValue)>()(
          ptr.ref.lpVtbl, commandId, key, currentValue, newValue);
}
