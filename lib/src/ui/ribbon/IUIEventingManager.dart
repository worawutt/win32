...
class IUIEventingManager extends IUnknown {
  ...
  int SetEventLogger(Pointer<COMObject> eventLogger) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> eventLogger)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<COMObject> eventLogger)>()(ptr.ref.lpVtbl, eventLogger);
}
