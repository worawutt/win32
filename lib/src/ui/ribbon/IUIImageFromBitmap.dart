...
class IUIImageFromBitmap extends IUnknown {
  ...
  int CreateImage(int bitmap, int options, Pointer<Pointer<COMObject>> image) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, IntPtr bitmap, Int32 options,
                              Pointer<Pointer<COMObject>> image)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int bitmap, int options,
                      Pointer<Pointer<COMObject>> image)>()(
          ptr.ref.lpVtbl, bitmap, options, image);
}
