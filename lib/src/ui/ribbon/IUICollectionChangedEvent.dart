...
class IUICollectionChangedEvent extends IUnknown {
  ...
  int OnChanged(int action, int oldIndex, Pointer<COMObject> oldItem,
          int newIndex, Pointer<COMObject> newItem) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int newIndex,
                      Pointer<COMObject> newItem)>()(
          ptr.ref.lpVtbl, action, oldIndex, oldItem, newIndex, newItem);
}
