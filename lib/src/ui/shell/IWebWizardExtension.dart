...
class IWebWizardExtension extends IWizardExtension {
  ...
  int SetInitialURL(Pointer<Utf16> pszURL) => ptr.ref.lpVtbl.value
      .elementAt(6)
      .cast<
          Pointer<
  ...
  int SetErrorURL(Pointer<Utf16> pszErrorURL) => ptr.ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> pszErrorURL)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Utf16> pszErrorURL)>()(
      ptr.ref.lpVtbl, pszErrorURL);
}
