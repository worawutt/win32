...
class ITaskbarList4 extends ITaskbarList3 {
  ...
  int SetTabProperties(int hwndTab, int stpFlags) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, IntPtr hwndTab, Int32 stpFlags)>>>()
              .value
              .asFunction<int Function(Pointer, int hwndTab, int stpFlags)>()(
          ptr.ref.lpVtbl, hwndTab, stpFlags);
}
