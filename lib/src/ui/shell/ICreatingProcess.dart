...
class ICreatingProcess extends IUnknown {
  ...
  int OnCreating(Pointer<COMObject> pcpi) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pcpi)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> pcpi)>()(
      ptr.ref.lpVtbl, pcpi);
}
