...
class IShellPropSheetExt extends IUnknown {
  ...
  int AddPages(Pointer<NativeFunction<LPFNSVADDPROPSHEETPAGE>> pfnAddPage,
          int lParam) =>
      ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(
                  ...
                  int lParam)>()(ptr.ref.lpVtbl, pfnAddPage, lParam);
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<NativeFunction<LPFNSVADDPROPSHEETPAGE>>
                          pfnReplaceWith,
                      int lParam)>()(
          ptr.ref.lpVtbl, uPageID, pfnReplaceWith, lParam);
}
