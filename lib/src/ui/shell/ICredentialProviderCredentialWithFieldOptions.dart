...
class ICredentialProviderCredentialWithFieldOptions extends IUnknown {
  ...
  int GetFieldOptions(int fieldID, Pointer<Int32> options) =>
      ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Uint32 fieldID, Pointer<Int32> options)>>>()
          .value
          .asFunction<
              int Function(Pointer, int fieldID,
                  Pointer<Int32> options)>()(ptr.ref.lpVtbl, fieldID, options);
}
