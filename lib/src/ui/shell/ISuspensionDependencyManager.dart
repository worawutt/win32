...
class ISuspensionDependencyManager extends IUnknown {
  ...
  int RegisterAsChild(int processHandle) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, IntPtr processHandle)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int processHandle)>()(ptr.ref.lpVtbl, processHandle);

  int GroupChildWithParent(int childProcessHandle) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, IntPtr childProcessHandle)>>>()
          .value
          .asFunction<int Function(Pointer, int childProcessHandle)>()(
      ptr.ref.lpVtbl, childProcessHandle);

  int UngroupChildFromParent(int childProcessHandle) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
