...
class IExpDispSupportXP extends IUnknown {
  ...
  int FindCIE4ConnectionPoint(
          Pointer<GUID> riid, Pointer<Pointer<COMObject>> ppccp) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<GUID> riid,
                      Pointer<Pointer<COMObject>> ppccp)>()(
          ptr.ref.lpVtbl, riid, ppccp);

  int OnTranslateAccelerator(Pointer<MSG> pMsg, int grfModifiers) =>
      ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
  ...
  int OnInvoke(
      ...
      ptr.ref.lpVtbl.value
          ...
          iid, lcid, wFlags, pdispparams, pVarResult, pexcepinfo, puArgErr);
}
