...
class IStorageProviderHandler extends IUnknown {
  ...
  int GetPropertyHandlerFromPath(
          Pointer<Utf16> path, Pointer<Pointer<COMObject>> propertyHandler) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> path,
                      Pointer<Pointer<COMObject>> propertyHandler)>()(
          ptr.ref.lpVtbl, path, propertyHandler);

  int GetPropertyHandlerFromUri(
          Pointer<Utf16> uri, Pointer<Pointer<COMObject>> propertyHandler) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> uri,
                      Pointer<Pointer<COMObject>> propertyHandler)>()(
          ptr.ref.lpVtbl, uri, propertyHandler);

  int GetPropertyHandlerFromFileId(
          Pointer<Utf16> fileId, Pointer<Pointer<COMObject>> propertyHandler) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> fileId,
                              Pointer<Pointer<COMObject>> propertyHandler)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> fileId,
                      Pointer<Pointer<COMObject>> propertyHandler)>()(
          ptr.ref.lpVtbl, fileId, propertyHandler);
}
