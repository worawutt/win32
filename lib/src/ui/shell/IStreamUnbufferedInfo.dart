...
class IStreamUnbufferedInfo extends IUnknown {
  ...
  int GetSectorSize(Pointer<Uint32> pcbSectorSize) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Uint32> pcbSectorSize)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<Uint32> pcbSectorSize)>()(ptr.ref.lpVtbl, pcbSectorSize);
}
