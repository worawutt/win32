...
class IShellDispatch3 extends IShellDispatch2 {
  ...
  int AddToRecent(VARIANT varFile, Pointer<Utf16> bstrCategory) =>
      ptr.ref.lpVtbl.value
              .elementAt(39)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, VARIANT varFile,
                              Pointer<Utf16> bstrCategory)>>>()
              .value
              .asFunction<
                  int Function(
                      Pointer, VARIANT varFile, Pointer<Utf16> bstrCategory)>()(
          ptr.ref.lpVtbl, varFile, bstrCategory);
}
