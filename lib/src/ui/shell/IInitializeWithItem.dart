...
class IInitializeWithItem extends IUnknown {
  ...
  int Initialize(Pointer<COMObject> psi, int grfMode) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<COMObject> psi, Uint32 grfMode)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> psi, int grfMode)>()(
      ptr.ref.lpVtbl, psi, grfMode);
}
