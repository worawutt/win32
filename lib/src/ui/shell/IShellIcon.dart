...
class IShellIcon extends IUnknown {
  ...
  int GetIconOf(
          Pointer<ITEMIDLIST> pidl, int flags, Pointer<Int32> pIconIndex) =>
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<ITEMIDLIST> pidl,
                              Uint32 flags, Pointer<Int32> pIconIndex)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<ITEMIDLIST> pidl, int flags,
                      Pointer<Int32> pIconIndex)>()(
          ptr.ref.lpVtbl, pidl, flags, pIconIndex);
}
