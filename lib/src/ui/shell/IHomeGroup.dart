...
class IHomeGroup extends IUnknown {
  ...
  int IsMember(Pointer<Int32> member) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Int32> member)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, Pointer<Int32> member)>()(ptr.ref.lpVtbl, member);

  int ShowSharingWizard(int owner, Pointer<Int32> sharingchoices) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, IntPtr owner,
                              Pointer<Int32> sharingchoices)>>>()
              .value
              .asFunction<
                  int Function(
                      Pointer, int owner, Pointer<Int32> sharingchoices)>()(
          ptr.ref.lpVtbl, owner, sharingchoices);
}
