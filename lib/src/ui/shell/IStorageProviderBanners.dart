...
class IStorageProviderBanners extends IUnknown {
  ...
  int SetBanner(Pointer<Utf16> providerIdentity, Pointer<Utf16> subscriptionId,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> subscriptionId,
                      Pointer<Utf16> contentId)>()(
          ptr.ref.lpVtbl, providerIdentity, subscriptionId, contentId);

  int
      ClearBanner(
              Pointer<Utf16> providerIdentity, Pointer<Utf16> subscriptionId) =>
          ptr
                  .ref.lpVtbl.value
                  .elementAt(4)
                  .cast<
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<Utf16> providerIdentity,
                          Pointer<Utf16> subscriptionId)>()(
              ptr.ref.lpVtbl, providerIdentity, subscriptionId);

  int ClearAllBanners(Pointer<Utf16> providerIdentity) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Utf16> providerIdentity)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> providerIdentity)>()(
          ptr.ref.lpVtbl, providerIdentity);

  int GetBanner(Pointer<Utf16> providerIdentity, Pointer<Utf16> subscriptionId,
