...
class ILaunchTargetViewSizePreference extends IUnknown {
  ...
  int GetTargetViewSizePreference(Pointer<Int32> targetSizeOnLaunch) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Int32> targetSizeOnLaunch)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> targetSizeOnLaunch)>()(
          ptr.ref.lpVtbl, targetSizeOnLaunch);
}
