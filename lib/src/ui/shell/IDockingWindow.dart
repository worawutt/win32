...
class IDockingWindow extends IOleWindow {
  ...
  int ShowDW(int fShow) => ptr.ref.lpVtbl.value
      .elementAt(5)
  ...
  int CloseDW(int dwReserved) => ptr.ref.lpVtbl.value
      .elementAt(6)
      .cast<
  ...
  int ResizeBorderDW(Pointer<RECT> prcBorder,
          Pointer<COMObject> punkToolbarSite, int fReserved) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<RECT> prcBorder,
                      Pointer<COMObject> punkToolbarSite, int fReserved)>()(
          ptr.ref.lpVtbl, prcBorder, punkToolbarSite, fReserved);
}
