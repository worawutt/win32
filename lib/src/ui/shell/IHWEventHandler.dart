...
class IHWEventHandler extends IUnknown {
  ...
  int Initialize(Pointer<Utf16> pszParams) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> pszParams)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Utf16> pszParams)>()(
      ptr.ref.lpVtbl, pszParams);

  int HandleEvent(Pointer<Utf16> pszDeviceID, Pointer<Utf16> pszAltDeviceID,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> pszAltDeviceID,
                      Pointer<Utf16> pszEventType)>()(
          ptr.ref.lpVtbl, pszDeviceID, pszAltDeviceID, pszEventType);
