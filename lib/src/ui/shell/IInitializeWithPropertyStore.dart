...
class IInitializeWithPropertyStore extends IUnknown {
  ...
  int Initialize(Pointer<COMObject> pps) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pps)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> pps)>()(
      ptr.ref.lpVtbl, pps);
}
