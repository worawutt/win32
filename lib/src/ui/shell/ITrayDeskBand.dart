...
class ITrayDeskBand extends IUnknown {
  ...
  int ShowDeskBand(Pointer<GUID> clsid) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
  ...
  int HideDeskBand(Pointer<GUID> clsid) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<GUID> clsid)>>>()
  ...
  int IsDeskBandShown(Pointer<GUID> clsid) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<GUID> clsid)>>>()
