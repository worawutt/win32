...
class IFileOperation2 extends IFileOperation {
  ...
  int SetOperationFlags2(int operationFlags2) => ptr.ref.lpVtbl.value
      .elementAt(23)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Int32 operationFlags2)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int operationFlags2)>()(ptr.ref.lpVtbl, operationFlags2);
}
