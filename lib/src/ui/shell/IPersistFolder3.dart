...
class IPersistFolder3 extends IPersistFolder2 {
  ...
  int InitializeEx(Pointer<COMObject> pbc, Pointer<ITEMIDLIST> pidlRoot,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<ITEMIDLIST> pidlRoot,
                      Pointer<PERSIST_FOLDER_TARGET_INFO> ppfti)>()(
          ptr.ref.lpVtbl, pbc, pidlRoot, ppfti);

  int GetFolderTargetInfo(Pointer<PERSIST_FOLDER_TARGET_INFO> ppfti) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<PERSIST_FOLDER_TARGET_INFO> ppfti)>()(
          ptr.ref.lpVtbl, ppfti);
}
