...
class IQueryCancelAutoPlay extends IUnknown {
  ...
  int AllowAutoPlay(Pointer<Utf16> pszPath, int dwContentType,
          Pointer<Utf16> pszLabel, int dwSerialNumber) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> pszLabel,
                      int dwSerialNumber)>()(
          ptr.ref.lpVtbl, pszPath, dwContentType, pszLabel, dwSerialNumber);
}
