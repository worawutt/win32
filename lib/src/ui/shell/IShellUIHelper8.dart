...
class IShellUIHelper8 extends IShellUIHelper7 {
  ...
  int GetCVListData(Pointer<Pointer<Utf16>> pbstrResult) => ptr.ref.lpVtbl.value
          .elementAt(97)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<Utf16>> pbstrResult)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<Utf16>> pbstrResult)>()(
      ptr.ref.lpVtbl, pbstrResult);

  int GetCVListLocalData(Pointer<Pointer<Utf16>> pbstrResult) =>
  ...
  int GetEMIEListData(Pointer<Pointer<Utf16>> pbstrResult) =>
      ptr.ref.lpVtbl.value
              .elementAt(99)
              .cast<
                  Pointer<
  ...
  int GetEMIEListLocalData(Pointer<Pointer<Utf16>> pbstrResult) =>
      ptr.ref.lpVtbl.value
              .elementAt(100)
              .cast<
                  Pointer<
  ...
  int LaunchInHVSI(Pointer<Utf16> bstrUrl) => ptr.ref.lpVtbl.value
          .elementAt(103)
          .cast<
              Pointer<
                  NativeFunction<
