...
class IPersistSerializedPropStorage2 extends IPersistSerializedPropStorage {
  ...
  int GetPropertyStorageSize(Pointer<Uint32> pcb) => ptr.ref.lpVtbl.value
      .elementAt(6)
      .cast<
          Pointer<
  ...
  int GetPropertyStorageBuffer(Pointer<SERIALIZEDPROPSTORAGE> psps, int cb,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<SERIALIZEDPROPSTORAGE> psps,
                      int cb, Pointer<Uint32> pcbWritten)>()(
          ptr.ref.lpVtbl, psps, cb, pcbWritten);
}
