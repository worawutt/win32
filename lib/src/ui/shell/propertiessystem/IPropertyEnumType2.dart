...
class IPropertyEnumType2 extends IPropertyEnumType {
  ...
  int GetImageReference(Pointer<Pointer<Utf16>> ppszImageRes) => ptr
          .ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<Utf16>> ppszImageRes)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<Utf16>> ppszImageRes)>()(
      ptr.ref.lpVtbl, ppszImageRes);
}
