...
class IPropertyChange extends IObjectWithPropertyKey {
  ...
  int ApplyToPropVariant(
          Pointer<PROPVARIANT> propvarIn, Pointer<PROPVARIANT> ppropvarOut) =>
      ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<PROPVARIANT> propvarIn,
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<PROPVARIANT>
                      ppropvarOut)>()(ptr.ref.lpVtbl, propvarIn, ppropvarOut);
}
