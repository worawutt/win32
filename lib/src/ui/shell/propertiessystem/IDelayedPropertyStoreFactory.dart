...
class IDelayedPropertyStoreFactory extends IPropertyStoreFactory {
  ...
  int GetDelayedPropertyStore(
          int flags, int dwStoreId, Pointer<GUID> riid, Pointer<Pointer> ppv) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 flags, Uint32 dwStoreId,
                              Pointer<GUID> riid, Pointer<Pointer> ppv)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int flags, int dwStoreId,
                      Pointer<GUID> riid, Pointer<Pointer> ppv)>()(
          ptr.ref.lpVtbl, flags, dwStoreId, riid, ppv);
}
