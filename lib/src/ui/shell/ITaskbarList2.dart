...
class ITaskbarList2 extends ITaskbarList {
  ...
  int MarkFullscreenWindow(int hwnd, int fFullscreen) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, IntPtr hwnd, Int32 fFullscreen)>>>()
              .value
              .asFunction<int Function(Pointer, int hwnd, int fFullscreen)>()(
          ptr.ref.lpVtbl, hwnd, fFullscreen);
}
