...
class ICredentialProviderEvents extends IUnknown {
  ...
  int CredentialsChanged(int upAdviseContext) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, IntPtr upAdviseContext)>>>()
          .value
          .asFunction<int Function(Pointer, int upAdviseContext)>()(
      ptr.ref.lpVtbl, upAdviseContext);
}
