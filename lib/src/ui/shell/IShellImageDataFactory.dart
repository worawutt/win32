...
class IShellImageDataFactory extends IUnknown {
  ...
  int CreateIShellImageData(Pointer<Pointer<COMObject>> ppshimg) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> ppshimg)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> ppshimg)>()(
      ptr.ref.lpVtbl, ppshimg);

  int CreateImageFromFile(
          Pointer<Utf16> pszPath, Pointer<Pointer<COMObject>> ppshimg) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> pszPath,
                      Pointer<Pointer<COMObject>> ppshimg)>()(
          ptr.ref.lpVtbl, pszPath, ppshimg);

  int CreateImageFromStream(
          Pointer<COMObject> pStream, Pointer<Pointer<COMObject>> ppshimg) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pStream,
                      Pointer<Pointer<COMObject>> ppshimg)>()(
          ptr.ref.lpVtbl, pStream, ppshimg);

  int GetDataFormatFromPath(
          Pointer<Utf16> pszPath, Pointer<GUID> pDataFormat) =>
      ptr.ref.lpVtbl.value
              .elementAt(6)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> pszPath,
                      Pointer<GUID> pDataFormat)>()(
          ptr.ref.lpVtbl, pszPath, pDataFormat);
}
