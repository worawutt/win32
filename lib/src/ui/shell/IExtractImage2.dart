...
class IExtractImage2 extends IExtractImage {
  ...
  int GetDateStamp(Pointer<FILETIME> pDateStamp) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<FILETIME> pDateStamp)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<FILETIME> pDateStamp)>()(
      ptr.ref.lpVtbl, pDateStamp);
}
