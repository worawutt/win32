...
class IOpenSearchSource extends IUnknown {
  ...
  int GetResults(int hwnd, Pointer<Utf16> pszQuery, int dwStartIndex,
          int dwCount, Pointer<GUID> riid, Pointer<Pointer> ppv) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> riid,
                      Pointer<Pointer> ppv)>()(
          ptr.ref.lpVtbl, hwnd, pszQuery, dwStartIndex, dwCount, riid, ppv);
}
