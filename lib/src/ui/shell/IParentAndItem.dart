...
class IParentAndItem extends IUnknown {
  ...
  int SetParentAndItem(Pointer<ITEMIDLIST> pidlParent, Pointer<COMObject> psf,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<ITEMIDLIST> pidlParent,
                      Pointer<COMObject> psf, Pointer<ITEMIDLIST> pidlChild)>()(
          ptr.ref.lpVtbl, pidlParent, psf, pidlChild);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppsf,
                      Pointer<Pointer<ITEMIDLIST>> ppidlChild)>()(
          ptr.ref.lpVtbl, ppidlParent, ppsf, ppidlChild);
}
