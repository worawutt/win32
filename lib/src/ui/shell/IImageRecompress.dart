...
class IImageRecompress extends IUnknown {
  ...
  int RecompressImage(Pointer<COMObject> psi, int cx, int cy, int iQuality,
          Pointer<COMObject> pstg, Pointer<Pointer<COMObject>> ppstrmOut) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pstg,
                      Pointer<Pointer<COMObject>> ppstrmOut)>()(
          ptr.ref.lpVtbl, psi, cx, cy, iQuality, pstg, ppstrmOut);
}
