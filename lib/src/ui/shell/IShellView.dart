...
class IShellView extends IOleWindow {
  ...
  int UIActivate(int uState) => ptr.ref.lpVtbl.value
      .elementAt(7)
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<RECT> prcView,
                      Pointer<IntPtr> phWnd)>()(
          ptr.ref.lpVtbl, psvPrevious, pfs, psb, prcView, phWnd);
  ...
  int GetCurrentInfo(Pointer<FOLDERSETTINGS> pfs) => ptr.ref.lpVtbl.value
          .elementAt(11)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int AddPropertySheetPages(int dwReserved,
          Pointer<NativeFunction<LPFNSVADDPROPSHEETPAGE>> pfn, int lparam) =>
      ptr.ref.lpVtbl.value
          .elementAt(12)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  ...
                  int dwReserved,
                  Pointer<NativeFunction<LPFNSVADDPROPSHEETPAGE>> pfn,
                  int lparam)>()(ptr.ref.lpVtbl, dwReserved, pfn, lparam);
  ...
  int SelectItem(Pointer<ITEMIDLIST> pidlItem, int uFlags) => ptr
      .ref.lpVtbl.value
      .elementAt(14)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Pointer<ITEMIDLIST> pidlItem, Uint32 uFlags)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<ITEMIDLIST> pidlItem,
              int uFlags)>()(ptr.ref.lpVtbl, pidlItem, uFlags);

  int GetItemObject(int uItem, Pointer<GUID> riid, Pointer<Pointer> ppv) =>
      ptr.ref.lpVtbl.value
          .elementAt(15)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Uint32 uItem, Pointer<GUID> riid,
                          Pointer<Pointer> ppv)>>>()
          .value
          .asFunction<
              int Function(Pointer, int uItem, Pointer<GUID> riid,
                  Pointer<Pointer> ppv)>()(ptr.ref.lpVtbl, uItem, riid, ppv);
}
