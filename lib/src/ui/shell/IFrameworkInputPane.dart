...
class IFrameworkInputPane extends IUnknown {
  ...
  int Advise(Pointer<COMObject> pWindow, Pointer<COMObject> pHandler,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pHandler,
                      Pointer<Uint32> pdwCookie)>()(
          ptr.ref.lpVtbl, pWindow, pHandler, pdwCookie);

  int AdviseWithHWND(
          int hwnd, Pointer<COMObject> pHandler, Pointer<Uint32> pdwCookie) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, int hwnd, Pointer<COMObject> pHandler,
                      Pointer<Uint32> pdwCookie)>()(
          ptr.ref.lpVtbl, hwnd, pHandler, pdwCookie);
  ...
  int Location(Pointer<RECT> prcInputPaneScreenLocation) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<RECT> prcInputPaneScreenLocation)>()(
      ptr.ref.lpVtbl, prcInputPaneScreenLocation);
}
