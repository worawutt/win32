...
class ILaunchTargetMonitor extends IUnknown {
  ...
  int GetMonitor(Pointer<IntPtr> monitor) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<IntPtr> monitor)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<IntPtr> monitor)>()(
