...
class IAppVisibility extends IUnknown {
  ...
  int GetAppVisibilityOnMonitor(int hMonitor, Pointer<Int32> pMode) =>
      ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, IntPtr hMonitor, Pointer<Int32> pMode)>>>()
          .value
          .asFunction<
              int Function(Pointer, int hMonitor,
                  Pointer<Int32> pMode)>()(ptr.ref.lpVtbl, hMonitor, pMode);

  int IsLauncherVisible(Pointer<Int32> pfVisible) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> pfVisible)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Int32> pfVisible)>()(
      ptr.ref.lpVtbl, pfVisible);

  int Advise(Pointer<COMObject> pCallback, Pointer<Uint32> pdwCookie) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pCallback,
                      Pointer<Uint32> pdwCookie)>()(
          ptr.ref.lpVtbl, pCallback, pdwCookie);
