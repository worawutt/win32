...
class IInputObject extends IUnknown {
  ...
  int UIActivateIO(int fActivate, Pointer<MSG> pMsg) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Int32 fActivate, Pointer<MSG> pMsg)>>>()
          .value
          .asFunction<
              int Function(Pointer, int fActivate, Pointer<MSG> pMsg)>()(
      ptr.ref.lpVtbl, fActivate, pMsg);
  ...
  int TranslateAcceleratorIO(Pointer<MSG> pMsg) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
