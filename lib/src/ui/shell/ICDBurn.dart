...
class ICDBurn extends IUnknown {
  ...
  int GetRecorderDriveLetter(Pointer<Utf16> pszDrive, int cch) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Utf16> pszDrive, Uint32 cch)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> pszDrive, int cch)>()(
          ptr.ref.lpVtbl, pszDrive, cch);

  int Burn(int hwnd) => ptr.ref.lpVtbl.value
      .elementAt(4)
  ...
  int HasRecordableDrive(Pointer<Int32> pfHasRecorder) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> pfHasRecorder)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Int32> pfHasRecorder)>()(
      ptr.ref.lpVtbl, pfHasRecorder);
}
