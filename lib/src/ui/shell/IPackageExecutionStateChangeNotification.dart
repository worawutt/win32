...
class IPackageExecutionStateChangeNotification extends IUnknown {
  ...
  int OnStateChanged(Pointer<Utf16> pszPackageFullName, int pesNewState) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> pszPackageFullName,
                          Int32 pesNewState)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Utf16> pszPackageFullName,
                  int pesNewState)>()(
      ptr.ref.lpVtbl, pszPackageFullName, pesNewState);
}
