...
class IDynamicHWHandler extends IUnknown {
  ...
  int GetDynamicInfo(Pointer<Utf16> pszDeviceID, int dwContentType,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> pszDeviceID,
                      int dwContentType, Pointer<Pointer<Utf16>> ppszAction)>()(
          ptr.ref.lpVtbl, pszDeviceID, dwContentType, ppszAction);
}
