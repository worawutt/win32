...
class ISharingConfigurationManager extends IUnknown {
  ...
  int CreateShare(int dsid, int role) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 dsid, Int32 role)>>>()
          .value
          .asFunction<int Function(Pointer, int dsid, int role)>()(
      ptr.ref.lpVtbl, dsid, role);

  int DeleteShare(int dsid) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 dsid)>>>()
      .value
      .asFunction<int Function(Pointer, int dsid)>()(ptr.ref.lpVtbl, dsid);

  int ShareExists(int dsid) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 dsid)>>>()
      .value
      .asFunction<int Function(Pointer, int dsid)>()(ptr.ref.lpVtbl, dsid);

  int GetSharePermissions(int dsid, Pointer<Int32> pRole) => ptr
      .ref.lpVtbl.value
      .elementAt(6)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Int32 dsid, Pointer<Int32> pRole)>>>()
      .value
      .asFunction<
          int Function(Pointer, int dsid,
              Pointer<Int32> pRole)>()(ptr.ref.lpVtbl, dsid, pRole);
