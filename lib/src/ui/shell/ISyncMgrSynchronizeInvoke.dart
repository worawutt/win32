...
class ISyncMgrSynchronizeInvoke extends IUnknown {
  ...
  int UpdateItems(int dwInvokeFlags, Pointer<GUID> clsid, int cbCookie,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int dwInvokeFlags, Pointer<GUID> clsid,
                      int cbCookie, Pointer<Uint8> pCookie)>()(
          ptr.ref.lpVtbl, dwInvokeFlags, clsid, cbCookie, pCookie);
