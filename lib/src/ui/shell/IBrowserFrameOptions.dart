...
class IBrowserFrameOptions extends IUnknown {
  ...
  int GetFrameOptions(int dwMask, Pointer<Uint32> pdwOptions) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Uint32 dwMask,
                          Pointer<Uint32> pdwOptions)>>>()
          .value
          .asFunction<
              int Function(Pointer, int dwMask, Pointer<Uint32> pdwOptions)>()(
      ptr.ref.lpVtbl, dwMask, pdwOptions);
}
