      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> itemsBeingActivated,
                      Pointer<COMObject> handlerInfo)>()(
          ptr.ref.lpVtbl, clsidHandler, itemsBeingActivated, handlerInfo);

  int BeforeCreateProcess(Pointer<Utf16> applicationPath,
          Pointer<Utf16> commandLine, Pointer<COMObject> handlerInfo) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> commandLine,
                      Pointer<COMObject> handlerInfo)>()(
          ptr.ref.lpVtbl, applicationPath, commandLine, handlerInfo);
}
