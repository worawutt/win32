...
class INewWDEvents extends IWebWizardHost {
  ...
  int PassportAuthenticate(
          Pointer<Utf16> bstrSignInUrl, Pointer<Int16> pvfAuthenitcated) =>
      ptr.ref.lpVtbl.value
              .elementAt(16)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> bstrSignInUrl,
                              Pointer<Int16> pvfAuthenitcated)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrSignInUrl,
                      Pointer<Int16> pvfAuthenitcated)>()(
          ptr.ref.lpVtbl, bstrSignInUrl, pvfAuthenitcated);
}
