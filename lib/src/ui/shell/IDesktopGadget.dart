...
class IDesktopGadget extends IUnknown {
  ...
  int RunGadget(Pointer<Utf16> gadgetPath) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> gadgetPath)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Utf16> gadgetPath)>()(
      ptr.ref.lpVtbl, gadgetPath);
}
