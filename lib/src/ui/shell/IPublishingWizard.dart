...
class IPublishingWizard extends IWizardExtension {
  ...
  int
      Initialize(Pointer<COMObject> pdo, int dwOptions,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(Pointer, Pointer<COMObject> pdo,
                          int dwOptions, Pointer<Utf16> pszServiceScope)>()(
              ptr.ref.lpVtbl, pdo, dwOptions, pszServiceScope);

  int
      GetTransferManifest(Pointer<Int32> phrFromTransfer,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<Int32> phrFromTransfer,
                          Pointer<Pointer<COMObject>> pdocManifest)>()(
              ptr.ref.lpVtbl, phrFromTransfer, pdocManifest);
}
