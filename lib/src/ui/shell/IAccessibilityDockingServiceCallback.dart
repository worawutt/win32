...
class IAccessibilityDockingServiceCallback extends IUnknown {
  ...
  int Undocked(int undockReason) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Int32 undockReason)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int undockReason)>()(ptr.ref.lpVtbl, undockReason);
}
