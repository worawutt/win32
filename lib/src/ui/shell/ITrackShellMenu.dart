...
class ITrackShellMenu extends IShellMenu {
  ...
  int
      SetObscured(int hwndTB, Pointer<COMObject> punkBand, int dwSMSetFlags) =>
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, int hwndTB,
                          Pointer<COMObject> punkBand, int dwSMSetFlags)>()(
              ptr.ref.lpVtbl, hwndTB, punkBand, dwSMSetFlags);

  int
      Popup(int hwnd, Pointer<POINTL> ppt, Pointer<RECTL> prcExclude,
              int dwFlags) =>
          ptr.ref.lpVtbl.value
                  .elementAt(13)
                  .cast<
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, int hwnd, Pointer<POINTL> ppt,
                          Pointer<RECTL> prcExclude, int dwFlags)>()(
              ptr.ref.lpVtbl, hwnd, ppt, prcExclude, dwFlags);
}
