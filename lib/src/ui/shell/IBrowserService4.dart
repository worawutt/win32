...
class IBrowserService4 extends IBrowserService3 {
  ...
  int ActivateView(int fPendingView) => ptr.ref.lpVtbl.value
      .elementAt(97)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Int32 fPendingView)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int fPendingView)>()(ptr.ref.lpVtbl, fPendingView);
