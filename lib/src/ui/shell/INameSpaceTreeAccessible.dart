...
class INameSpaceTreeAccessible extends IUnknown {
  ...
  int OnGetDefaultAccessibilityAction(
          Pointer<COMObject> psi, Pointer<Pointer<Utf16>> pbstrDefaultAction) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> psi,
                      Pointer<Pointer<Utf16>> pbstrDefaultAction)>()(
          ptr.ref.lpVtbl, psi, pbstrDefaultAction);

  int OnDoDefaultAccessibilityAction(Pointer<COMObject> psi) => ptr
          .ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
  ...
  int OnGetAccessibilityRole(
          Pointer<COMObject> psi, Pointer<VARIANT> pvarRole) =>
      ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(Pointer, Pointer<COMObject> psi,
                  Pointer<VARIANT> pvarRole)>()(ptr.ref.lpVtbl, psi, pvarRole);
}
