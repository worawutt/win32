...
class IThumbnailCachePrimer extends IUnknown {
  ...
  int PageInThumbnail(
          Pointer<COMObject> psi, int wtsFlags, int cxyRequestedThumbSize) =>
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<COMObject> psi,
                              Int32 wtsFlags, Uint32 cxyRequestedThumbSize)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> psi, int wtsFlags,
                      int cxyRequestedThumbSize)>()(
          ptr.ref.lpVtbl, psi, wtsFlags, cxyRequestedThumbSize);
}
