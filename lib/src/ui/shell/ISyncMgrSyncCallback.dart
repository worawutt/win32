...
class ISyncMgrSyncCallback extends IUnknown {
  ...
  int
      SetHandlerProgressText(
              Pointer<Utf16> pszProgressText, Pointer<Int32> pnCancelRequest) =>
          ptr.ref.lpVtbl.value
                  .elementAt(4)
                  .cast<
                      Pointer<
                  ...
                  .asFunction<
                      int Function(Pointer, Pointer<Utf16> pszProgressText,
                          Pointer<Int32> pnCancelRequest)>()(
              ptr.ref.lpVtbl, pszProgressText, pnCancelRequest);
  ...
  int CanContinue(Pointer<Utf16> pszItemID) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> pszItemID)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Utf16> pszItemID)>()(
      ptr.ref.lpVtbl, pszItemID);

  int QueryForAdditionalItems(Pointer<Pointer<COMObject>> ppenumItemIDs,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppenumItemIDs,
                      Pointer<Pointer<COMObject>> ppenumPunks)>()(
          ptr.ref.lpVtbl, ppenumItemIDs, ppenumPunks);

  int AddItemToSession(Pointer<Utf16> pszItemID) => ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int AddIUnknownToSession(Pointer<COMObject> punk) => ptr.ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int ProposeItem(Pointer<COMObject> pNewItem) => ptr.ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> pNewItem)>()(
      ptr.ref.lpVtbl, pNewItem);

  int CommitItem(Pointer<Utf16> pszItemID) => ptr.ref.lpVtbl.value
          .elementAt(11)
          .cast<
              Pointer<
                  NativeFunction<
