...
class IWebWizardHost extends IDispatch {
  ...
  set Caption(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(Pointer, Pointer<Utf16> bstrCaption)>>>()
            .value
            .asFunction<int Function(Pointer, Pointer<Utf16> bstrCaption)>()(
  ...
  Pointer<Utf16> get Caption {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> pbstrCaption)>()(
  ...
  int
      put_Property(
              Pointer<Utf16> bstrPropertyName, Pointer<VARIANT> pvProperty) =>
          ptr.ref.lpVtbl.value
                  .elementAt(12)
                  .cast<
                      Pointer<
                  ...
                  .asFunction<
                      int Function(Pointer, Pointer<Utf16> bstrPropertyName,
                          Pointer<VARIANT> pvProperty)>()(
              ptr.ref.lpVtbl, bstrPropertyName, pvProperty);
  ...
  int SetWizardButtons(int vfEnableBack, int vfEnableNext, int vfLastPage) =>
      ptr.ref.lpVtbl.value
              .elementAt(14)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int16 vfEnableBack,
                              Int16 vfEnableNext, Int16 vfLastPage)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int vfEnableBack, int vfEnableNext,
                      int vfLastPage)>()(
          ptr.ref.lpVtbl, vfEnableBack, vfEnableNext, vfLastPage);

  int
      SetHeaderText(Pointer<Utf16> bstrHeaderTitle,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<Utf16> bstrHeaderTitle,
                          Pointer<Utf16> bstrHeaderSubtitle)>()(
              ptr.ref.lpVtbl, bstrHeaderTitle, bstrHeaderSubtitle);
}
