...
class IThumbnailCache extends IUnknown {
  ...
  int GetThumbnailByID(WTS_THUMBNAILID thumbnailID, int cxyRequestedThumbSize,
          Pointer<Pointer<COMObject>> ppvThumb, Pointer<Int32> pOutFlags) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      int cxyRequestedThumbSize,
                      Pointer<Pointer<COMObject>> ppvThumb,
                      Pointer<Int32> pOutFlags)>()(ptr.ref.lpVtbl, thumbnailID,
          cxyRequestedThumbSize, ppvThumb, pOutFlags);
}
