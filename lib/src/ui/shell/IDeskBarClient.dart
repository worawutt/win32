...
class IDeskBarClient extends IOleWindow {
  ...
  int SetDeskBarSite(Pointer<COMObject> punkSite) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int SetModeDBC(int dwMode) => ptr.ref.lpVtbl.value
      .elementAt(6)
  ...
  int UIActivateDBC(int dwState) => ptr.ref.lpVtbl.value
      .elementAt(7)
  ...
  int GetSize(int dwWhich, Pointer<RECT> prc) => ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Uint32 dwWhich, Pointer<RECT> prc)>>>()
          .value
          .asFunction<int Function(Pointer, int dwWhich, Pointer<RECT> prc)>()(
      ptr.ref.lpVtbl, dwWhich, prc);
}
