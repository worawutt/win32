...
class INameSpaceTreeControlFolderCapabilities extends IUnknown {
  ...
  int GetFolderCapabilities(int nfcMask, Pointer<Int32> pnfcValue) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Int32 nfcMask, Pointer<Int32> pnfcValue)>>>()
          .value
          .asFunction<
              int Function(Pointer, int nfcMask, Pointer<Int32> pnfcValue)>()(
      ptr.ref.lpVtbl, nfcMask, pnfcValue);
}
