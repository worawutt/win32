...
class IQueryInfo extends IUnknown {
  ...
  int GetInfoTip(int dwFlags, Pointer<Pointer<Utf16>> ppwszTip) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 dwFlags,
                          Pointer<Pointer<Utf16>> ppwszTip)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer, int dwFlags, Pointer<Pointer<Utf16>> ppwszTip)>()(
      ptr.ref.lpVtbl, dwFlags, ppwszTip);

  int GetInfoFlags(Pointer<Uint32> pdwFlags) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
