...
class IApplicationAssociationRegistration extends IUnknown {
  ...
  int QueryCurrentDefault(Pointer<Utf16> pszQuery, int atQueryType,
          int alQueryLevel, Pointer<Pointer<Utf16>> ppszAssociation) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int alQueryLevel,
                      Pointer<Pointer<Utf16>> ppszAssociation)>()(
          ptr.ref.lpVtbl, pszQuery, atQueryType, alQueryLevel, ppszAssociation);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int alQueryLevel,
                      Pointer<Utf16> pszAppRegistryName,
                      Pointer<Int32> pfDefault)>()(ptr.ref.lpVtbl, pszQuery,
          atQueryType, alQueryLevel, pszAppRegistryName, pfDefault);

  int QueryAppIsDefaultAll(int alQueryLevel, Pointer<Utf16> pszAppRegistryName,
          Pointer<Int32> pfDefault) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> pszAppRegistryName,
                      Pointer<Int32> pfDefault)>()(
          ptr.ref.lpVtbl, alQueryLevel, pszAppRegistryName, pfDefault);

  int
      SetAppAsDefault(Pointer<Utf16> pszAppRegistryName, Pointer<Utf16> pszSet,
              int atSetType) =>
          ptr.ref.lpVtbl.value
                  .elementAt(6)
                  .cast<
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<Utf16> pszAppRegistryName,
                          Pointer<Utf16> pszSet, int atSetType)>()(
              ptr.ref.lpVtbl, pszAppRegistryName, pszSet, atSetType);

  int SetAppAsDefaultAll(Pointer<Utf16> pszAppRegistryName) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Utf16> pszAppRegistryName)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> pszAppRegistryName)>()(
          ptr.ref.lpVtbl, pszAppRegistryName);
