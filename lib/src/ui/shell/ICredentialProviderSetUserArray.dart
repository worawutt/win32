...
class ICredentialProviderSetUserArray extends IUnknown {
  ...
  int SetUserArray(Pointer<COMObject> users) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> users)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> users)>()(
      ptr.ref.lpVtbl, users);
}
