...
class IFolderFilter extends IUnknown {
  ...
  int ShouldShow(Pointer<COMObject> psf, Pointer<ITEMIDLIST> pidlFolder,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<ITEMIDLIST> pidlFolder,
                      Pointer<ITEMIDLIST> pidlItem)>()(
          ptr.ref.lpVtbl, psf, pidlFolder, pidlItem);

  int GetEnumFlags(Pointer<COMObject> psf, Pointer<ITEMIDLIST> pidlFolder,
          Pointer<IntPtr> phwnd, Pointer<Uint32> pgrfFlags) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<IntPtr> phwnd,
                      Pointer<Uint32> pgrfFlags)>()(
          ptr.ref.lpVtbl, psf, pidlFolder, phwnd, pgrfFlags);
}
