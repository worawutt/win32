...
class ILaunchSourceAppUserModelId extends IUnknown {
  ...
  int GetAppUserModelId(Pointer<Pointer<Utf16>> launchingApp) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<Utf16>> launchingApp)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<Utf16>> launchingApp)>()(
      ptr.ref.lpVtbl, launchingApp);
}
