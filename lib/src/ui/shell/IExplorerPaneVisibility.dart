...
class IExplorerPaneVisibility extends IUnknown {
  ...
  int GetPaneState(Pointer<GUID> ep, Pointer<Uint32> peps) =>
      ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<GUID> ep, Pointer<Uint32> peps)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<GUID> ep,
                  Pointer<Uint32> peps)>()(ptr.ref.lpVtbl, ep, peps);
}
