...
class ICredentialProviderCredentialEvents2
  ...
  int SetFieldOptions(
          Pointer<COMObject> credential, int fieldID, int options) =>
      ptr.ref.lpVtbl.value
          .elementAt(15)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> credential,
                          Uint32 fieldID, Int32 options)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> credential, int fieldID,
                  int options)>()(ptr.ref.lpVtbl, credential, fieldID, options);
}
