...
class IShellIconOverlay extends IUnknown {
  ...
  int GetOverlayIndex(Pointer<ITEMIDLIST> pidl, Pointer<Int32> pIndex) =>
      ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(Pointer, Pointer<ITEMIDLIST> pidl,
                  Pointer<Int32> pIndex)>()(ptr.ref.lpVtbl, pidl, pIndex);

  int GetOverlayIconIndex(
          Pointer<ITEMIDLIST> pidl, Pointer<Int32> pIconIndex) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<ITEMIDLIST> pidl,
                      Pointer<Int32> pIconIndex)>()(
          ptr.ref.lpVtbl, pidl, pIconIndex);
}
