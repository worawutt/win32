...
class IFileSystemBindData2 extends IFileSystemBindData {
  ...
  int SetFileID(int liFileID) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int64 liFileID)>>>()
      .value
      .asFunction<
          int Function(Pointer, int liFileID)>()(ptr.ref.lpVtbl, liFileID);

  int GetFileID(Pointer<Int64> pliFileID) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int64> pliFileID)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Int64> pliFileID)>()(
      ptr.ref.lpVtbl, pliFileID);

  int SetJunctionCLSID(Pointer<GUID> clsid) => ptr.ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<
  ...
  int GetJunctionCLSID(Pointer<GUID> pclsid) => ptr.ref.lpVtbl.value
      .elementAt(8)
      .cast<
          Pointer<
