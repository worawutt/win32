...
class FolderItems3 extends FolderItems2 {
  ...
  int Filter(int grfFlags, Pointer<Utf16> bstrFileSpec) => ptr.ref.lpVtbl.value
          .elementAt(13)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 grfFlags,
                          Pointer<Utf16> bstrFileSpec)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer, int grfFlags, Pointer<Utf16> bstrFileSpec)>()(
      ptr.ref.lpVtbl, grfFlags, bstrFileSpec);
