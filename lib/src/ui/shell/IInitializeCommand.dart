...
class IInitializeCommand extends IUnknown {
  ...
  int Initialize(Pointer<Utf16> pszCommandName, Pointer<COMObject> ppb) => ptr
      .ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Utf16> pszCommandName,
                      Pointer<COMObject> ppb)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<Utf16> pszCommandName,
              Pointer<COMObject> ppb)>()(ptr.ref.lpVtbl, pszCommandName, ppb);
}
