...
class IExecuteCommandApplicationHostEnvironment extends IUnknown {
  ...
  int GetValue(Pointer<Int32> pahe) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Int32> pahe)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<Int32> pahe)>()(ptr.ref.lpVtbl, pahe);
}
