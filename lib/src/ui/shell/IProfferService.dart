...
class IProfferService extends IUnknown {
  ...
  int ProfferService(Pointer<GUID> serviceId,
          Pointer<COMObject> serviceProvider, Pointer<Uint32> cookie) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> serviceProvider,
                      Pointer<Uint32> cookie)>()(
          ptr.ref.lpVtbl, serviceId, serviceProvider, cookie);

  int RevokeService(int cookie) => ptr.ref.lpVtbl.value
      .elementAt(4)
