...
class IPublishedApp2 extends IPublishedApp {
  ...
  int Install2(Pointer<SYSTEMTIME> pstInstall, int hwndParent) =>
      ptr.ref.lpVtbl.value
          ...
          .value
          .asFunction<
              int Function(Pointer, Pointer<SYSTEMTIME> pstInstall,
                  int hwndParent)>()(ptr.ref.lpVtbl, pstInstall, hwndParent);
}
