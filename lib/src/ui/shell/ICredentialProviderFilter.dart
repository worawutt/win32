...
class ICredentialProviderFilter extends IUnknown {
  ...
  int Filter(int cpus, int dwFlags, Pointer<GUID> rgclsidProviders,
          Pointer<Int32> rgbAllow, int cProviders) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> rgclsidProviders,
                      Pointer<Int32> rgbAllow,
                      int cProviders)>()(ptr.ref.lpVtbl, cpus, dwFlags,
          rgclsidProviders, rgbAllow, cProviders);
      ...
      ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<CREDENTIAL_PROVIDER_CREDENTIAL_SERIALIZATION> pcpcsIn,
                  Pointer<CREDENTIAL_PROVIDER_CREDENTIAL_SERIALIZATION>
                      pcpcsOut)>()(ptr.ref.lpVtbl, pcpcsIn, pcpcsOut);
}
