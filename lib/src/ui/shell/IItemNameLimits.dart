...
class IItemNameLimits extends IUnknown {
  ...
  int GetValidCharacters(Pointer<Pointer<Utf16>> ppwszValidChars,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<Utf16>> ppwszValidChars,
                      Pointer<Pointer<Utf16>> ppwszInvalidChars)>()(
          ptr.ref.lpVtbl, ppwszValidChars, ppwszInvalidChars);

  int GetMaxLength(Pointer<Utf16> pszName, Pointer<Int32> piMaxNameLen) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> pszName,
                      Pointer<Int32> piMaxNameLen)>()(
          ptr.ref.lpVtbl, pszName, piMaxNameLen);
}
