...
class IEnumPublishedApps extends IUnknown {
  ...
  int Next(Pointer<Pointer<COMObject>> pia) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Pointer<COMObject>> pia)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, Pointer<Pointer<COMObject>> pia)>()(ptr.ref.lpVtbl, pia);
