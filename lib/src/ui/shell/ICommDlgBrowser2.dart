...
class ICommDlgBrowser2 extends ICommDlgBrowser {
  ...
  int Notify(Pointer<COMObject> ppshv, int dwNotifyType) => ptr.ref.lpVtbl.value
      .elementAt(6)
      .cast<
          Pointer<
              NativeFunction<
      ...
      .asFunction<
          int Function(Pointer, Pointer<COMObject> ppshv,
              int dwNotifyType)>()(ptr.ref.lpVtbl, ppshv, dwNotifyType);

  int GetDefaultMenuText(
          Pointer<COMObject> ppshv, Pointer<Utf16> pszText, int cchMax) =>
      ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> ppshv,
                          Pointer<Utf16> pszText, Int32 cchMax)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer,
                  ...
                  int cchMax)>()(ptr.ref.lpVtbl, ppshv, pszText, cchMax);

  int GetViewFlags(Pointer<Uint32> pdwFlags) => ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
