...
class IObjectProvider extends IUnknown {
  ...
  int QueryObject(Pointer<GUID> guidObject, Pointer<GUID> riid,
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<GUID> guidObject,
                              Pointer<GUID> riid, Pointer<Pointer> ppvOut)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<GUID> guidObject,
                      Pointer<GUID> riid, Pointer<Pointer> ppvOut)>()(
          ptr.ref.lpVtbl, guidObject, riid, ppvOut);
}
