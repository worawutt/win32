...
class IEnumHLITEM extends IUnknown {
  ...
  int Next(int celt, Pointer<HLITEM> rgelt, Pointer<Uint32> pceltFetched) =>
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int celt, Pointer<HLITEM> rgelt,
                      Pointer<Uint32> pceltFetched)>()(
  ...
  int Clone(Pointer<Pointer<COMObject>> ppienumhlitem) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<COMObject>> ppienumhlitem)>()(
      ptr.ref.lpVtbl, ppienumhlitem);
}
