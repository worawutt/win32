...
class IFolderViewHost extends IUnknown {
  ...
  int Initialize(int hwndParent, Pointer<COMObject> pdo, Pointer<RECT> prc) =>
              ...
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, IntPtr hwndParent,
                          Pointer<COMObject> pdo, Pointer<RECT> prc)>>>()
          .value
          .asFunction<
              int Function(Pointer, int hwndParent, Pointer<COMObject> pdo,
                  Pointer<RECT> prc)>()(ptr.ref.lpVtbl, hwndParent, pdo, prc);
}
