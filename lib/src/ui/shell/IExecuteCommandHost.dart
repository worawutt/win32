...
class IExecuteCommandHost extends IUnknown {
  ...
  int GetUIMode(Pointer<Int32> pUIMode) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> pUIMode)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Int32> pUIMode)>()(
      ptr.ref.lpVtbl, pUIMode);
}
