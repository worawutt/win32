...
class IShellUIHelper5 extends IShellUIHelper4 {
  ...
  int msProvisionNetworks(
          Pointer<Utf16> bstrProvisioningXml, Pointer<VARIANT> puiResult) =>
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrProvisioningXml,
                      Pointer<VARIANT> puiResult)>()(
          ptr.ref.lpVtbl, bstrProvisioningXml, puiResult);
  ...
  int msChangeDefaultBrowser(int fChange) => ptr.ref.lpVtbl.value
      .elementAt(73)
