...
class IAccessibilityDockingService extends IUnknown {
  ...
  int GetAvailableSize(
          int hMonitor, Pointer<Uint32> pcxFixed, Pointer<Uint32> pcyMax) =>
              ...
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, IntPtr hMonitor,
                          Pointer<Uint32> pcxFixed, Pointer<Uint32> pcyMax)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer,
                  ...
                  Pointer<Uint32>
                      pcyMax)>()(ptr.ref.lpVtbl, hMonitor, pcxFixed, pcyMax);

  int
      DockWindow(int hwnd, int hMonitor, int cyRequested,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, int hwnd, int hMonitor,
                          int cyRequested, Pointer<COMObject> pCallback)>()(
              ptr.ref.lpVtbl, hwnd, hMonitor, cyRequested, pCallback);

  int UndockWindow(int hwnd) => ptr.ref.lpVtbl.value
      .elementAt(5)
