...
class IContactManagerInterop extends IUnknown {
  ...
  int ShowContactCardForWindow(int appWindow, Pointer<COMObject> contact,
          Pointer<RECT> selection, int preferredPlacement) =>
      ptr.ref.lpVtbl.value
          ...
          ptr.ref.lpVtbl, appWindow, contact, selection, preferredPlacement);
}
