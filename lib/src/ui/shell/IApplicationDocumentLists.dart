...
class IApplicationDocumentLists extends IUnknown {
  ...
  int GetList(int listtype, int cItemsDesired, Pointer<GUID> riid,
          Pointer<Pointer> ppv) =>
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int listtype, int cItemsDesired,
                      Pointer<GUID> riid, Pointer<Pointer> ppv)>()(
          ptr.ref.lpVtbl, listtype, cItemsDesired, riid, ppv);
}
