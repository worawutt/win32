...
class IFileSyncMergeHandler extends IUnknown {
  ...
  int Merge(Pointer<Utf16> localFilePath, Pointer<Utf16> serverFilePath,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> serverFilePath,
                      Pointer<Int32> updateStatus)>()(
          ptr.ref.lpVtbl, localFilePath, serverFilePath, updateStatus);

  int ShowResolveConflictUIAsync(
          Pointer<Utf16> localFilePath, int monitorToDisplayOn) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> localFilePath,
                              IntPtr monitorToDisplayOn)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> localFilePath,
                      int monitorToDisplayOn)>()(
          ptr.ref.lpVtbl, localFilePath, monitorToDisplayOn);
}
