...
class IWebBrowser extends IDispatch {
  ...
  int Refresh2(Pointer<VARIANT> Level) => ptr.ref.lpVtbl.value
          .elementAt(13)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<VARIANT> Level)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<VARIANT> Level)>()(
      ptr.ref.lpVtbl, Level);
      ...
      final hr = ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(Pointer,
                  Pointer<Pointer<Utf16>> Type)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  int get Left {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<Int32 Function(Pointer, Pointer<Int32> pl)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer, Pointer<Int32> pl)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  Pointer<Utf16> get LocationName {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> LocationName)>()(
          ptr.ref.lpVtbl, retValuePtr);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<Utf16>> LocationURL)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<Utf16>> LocationURL)>()(
          ptr.ref.lpVtbl, retValuePtr);
