...
class IOpenControlPanel extends IUnknown {
  ...
  int Open(Pointer<Utf16> pszName, Pointer<Utf16> pszPage,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> pszName,
                      Pointer<Utf16> pszPage, Pointer<COMObject> punkSite)>()(
          ptr.ref.lpVtbl, pszName, pszPage, punkSite);

  int GetPath(Pointer<Utf16> pszName, Pointer<Utf16> pszPath, int cchPath) =>
      ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> pszName,
                          Pointer<Utf16> pszPath, Uint32 cchPath)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer,
                  ...
                  int cchPath)>()(ptr.ref.lpVtbl, pszName, pszPath, cchPath);

  int GetCurrentView(Pointer<Int32> pView) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Int32> pView)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<Int32> pView)>()(ptr.ref.lpVtbl, pView);
}
