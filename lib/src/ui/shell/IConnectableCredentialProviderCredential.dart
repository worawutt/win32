...
class IConnectableCredentialProviderCredential
  ...
  int Connect(Pointer<COMObject> pqcws) => ptr.ref.lpVtbl.value
          .elementAt(20)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pqcws)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> pqcws)>()(
      ptr.ref.lpVtbl, pqcws);
