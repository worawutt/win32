...
class IPreviewHandlerFrame extends IUnknown {
  ...
  int GetWindowContext(Pointer<PREVIEWHANDLERFRAMEINFO> pinfo) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<PREVIEWHANDLERFRAMEINFO> pinfo)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<PREVIEWHANDLERFRAMEINFO> pinfo)>()(
