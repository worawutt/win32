...
class IThumbnailProvider extends IUnknown {
  ...
  int GetThumbnail(int cx, Pointer<IntPtr> phbmp, Pointer<Int32> pdwAlpha) =>
      ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Uint32 cx, Pointer<IntPtr> phbmp,
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<Int32>
                      pdwAlpha)>()(ptr.ref.lpVtbl, cx, phbmp, pdwAlpha);
}
