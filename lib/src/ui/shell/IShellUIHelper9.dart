...
class IShellUIHelper9 extends IShellUIHelper8 {
  ...
  int GetOSSku(Pointer<Uint32> pdwResult) => ptr.ref.lpVtbl.value
          .elementAt(104)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Uint32> pdwResult)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Uint32> pdwResult)>()(
      ptr.ref.lpVtbl, pdwResult);
}
