...
class IShellExtInit extends IUnknown {
  ...
  int
      Initialize(Pointer<ITEMIDLIST> pidlFolder, Pointer<COMObject> pdtobj,
              int hkeyProgID) =>
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<ITEMIDLIST> pidlFolder,
                          Pointer<COMObject> pdtobj, int hkeyProgID)>()(
              ptr.ref.lpVtbl, pidlFolder, pdtobj, hkeyProgID);
}
