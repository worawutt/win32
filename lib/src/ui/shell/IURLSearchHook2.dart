...
class IURLSearchHook2 extends IURLSearchHook {
  ...
  int TranslateWithSearchContext(Pointer<Utf16> pwszSearchURL,
          int cchBufferSize, Pointer<COMObject> pSearchContext) =>
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> pwszSearchURL,
                      int cchBufferSize, Pointer<COMObject> pSearchContext)>()(
          ptr.ref.lpVtbl, pwszSearchURL, cchBufferSize, pSearchContext);
}
