...
class IDropTargetHelper extends IUnknown {
  ...
  int DragEnter(int hwndTarget, Pointer<COMObject> pDataObject,
          Pointer<POINT> ppt, int dwEffect) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<POINT> ppt,
                      int dwEffect)>()(
          ptr.ref.lpVtbl, hwndTarget, pDataObject, ppt, dwEffect);
  ...
  int DragOver(Pointer<POINT> ppt, int dwEffect) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<POINT> ppt, Uint32 dwEffect)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<POINT> ppt, int dwEffect)>()(
      ptr.ref.lpVtbl, ppt, dwEffect);

  int Drop(Pointer<COMObject> pDataObject, Pointer<POINT> ppt, int dwEffect) =>
      ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pDataObject,
                          Pointer<POINT> ppt, Uint32 dwEffect)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer,
                  Pointer<COMObject> pDataObject,
                  Pointer<POINT> ppt,
                  int dwEffect)>()(ptr.ref.lpVtbl, pDataObject, ppt, dwEffect);
