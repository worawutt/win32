...
class IReconcilableObject extends IUnknown {
  ...
  int GetProgressFeedbackMaxEstimate(Pointer<Uint32> pulProgressMax) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Uint32> pulProgressMax)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> pulProgressMax)>()(
          ptr.ref.lpVtbl, pulProgressMax);
}
