...
class IEmptyVolumeCache extends IUnknown {
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<Utf16>> ppwszDisplayName,
                      Pointer<Pointer<Utf16>> ppwszDescription,
                      Pointer<Uint32> pdwFlags)>()(ptr.ref.lpVtbl, hkRegKey,
          pcwszVolume, ppwszDisplayName, ppwszDescription, pdwFlags);

  int GetSpaceUsed(Pointer<Uint64> pdwlSpaceUsed, Pointer<COMObject> picb) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Uint64> pdwlSpaceUsed,
                              Pointer<COMObject> picb)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint64> pdwlSpaceUsed,
                      Pointer<COMObject> picb)>()(
          ptr.ref.lpVtbl, pdwlSpaceUsed, picb);

  int Purge(int dwlSpaceToFree, Pointer<COMObject> picb) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Uint64 dwlSpaceToFree,
                      Pointer<COMObject> picb)>>>()
      .value
      .asFunction<
          int Function(Pointer, int dwlSpaceToFree,
              Pointer<COMObject> picb)>()(ptr.ref.lpVtbl, dwlSpaceToFree, picb);

  int ShowProperties(int hwnd) => ptr.ref.lpVtbl.value
      .elementAt(6)
  ...
  int Deactivate(Pointer<Uint32> pdwFlags) => ptr.ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
                  NativeFunction<
