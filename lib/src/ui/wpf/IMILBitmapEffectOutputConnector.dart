...
class IMILBitmapEffectOutputConnector extends IMILBitmapEffectConnector {
  ...
  int GetNumberConnections(Pointer<Uint32> puiNumberConnections) => ptr
          .ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Uint32> puiNumberConnections)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Uint32> puiNumberConnections)>()(
      ptr.ref.lpVtbl, puiNumberConnections);

  int GetConnection(int uiIndex, Pointer<Pointer<COMObject>> ppConnection) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int uiIndex,
                      Pointer<Pointer<COMObject>> ppConnection)>()(
          ptr.ref.lpVtbl, uiIndex, ppConnection);
}
