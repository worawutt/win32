...
class IMILBitmapEffectEvents extends IUnknown {
  ...
  int PropertyChange(
          Pointer<COMObject> pEffect, Pointer<Utf16> bstrPropertyName) =>
      ptr
              .ref.lpVtbl.value
              .elementAt(3)
              .cast<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pEffect,
                      Pointer<Utf16> bstrPropertyName)>()(
          ptr.ref.lpVtbl, pEffect, bstrPropertyName);

  int DirtyRegion(Pointer<COMObject> pEffect, Pointer<MilRectD> pRect) =>
      ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(Pointer, Pointer<COMObject> pEffect,
                  Pointer<MilRectD> pRect)>()(ptr.ref.lpVtbl, pEffect, pRect);
}
