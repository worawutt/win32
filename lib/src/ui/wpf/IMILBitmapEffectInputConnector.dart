...
class IMILBitmapEffectInputConnector extends IMILBitmapEffectConnector {
  ...
  int ConnectTo(Pointer<COMObject> pConnector) => ptr.ref.lpVtbl.value
      .elementAt(9)
      .cast<
          Pointer<
              NativeFunction<
      ...
      .asFunction<
          int Function(Pointer,
              Pointer<COMObject> pConnector)>()(ptr.ref.lpVtbl, pConnector);

  int GetConnection(Pointer<Pointer<COMObject>> ppConnector) => ptr
          .ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> ppConnector)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> ppConnector)>()(
      ptr.ref.lpVtbl, ppConnector);
}
