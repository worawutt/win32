...
class IMILBitmapEffectOutputConnectorImpl extends IUnknown {
  ...
  int AddBackLink(Pointer<COMObject> pConnection) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> pConnection)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<COMObject> pConnection)>()(ptr.ref.lpVtbl, pConnection);

  int RemoveBackLink(Pointer<COMObject> pConnection) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
              NativeFunction<
