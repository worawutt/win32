...
class IMILBitmapEffect extends IUnknown {
  ...
  int GetOutput(int uiIndex, Pointer<COMObject> pContext,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pContext,
                      Pointer<Pointer<COMObject>> ppBitmapSource)>()(
          ptr.ref.lpVtbl, uiIndex, pContext, ppBitmapSource);

  int GetParentEffect(Pointer<Pointer<COMObject>> ppParentEffect) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppParentEffect)>()(
          ptr.ref.lpVtbl, ppParentEffect);

  int SetInputSource(int uiIndex, Pointer<COMObject> pBitmapSource) => ptr
          .ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, int uiIndex, Pointer<COMObject> pBitmapSource)>()(
      ptr.ref.lpVtbl, uiIndex, pBitmapSource);
}
