...
class INotificationActivationCallback extends IUnknown {
  ...
  int Activate(Pointer<Utf16> appUserModelId, Pointer<Utf16> invokedArgs,
          Pointer<NOTIFICATION_USER_INPUT_DATA> data, int count) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<NOTIFICATION_USER_INPUT_DATA> data,
                      int count)>()(
          ptr.ref.lpVtbl, appUserModelId, invokedArgs, data, count);
}
