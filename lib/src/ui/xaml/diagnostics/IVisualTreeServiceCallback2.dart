...
class IVisualTreeServiceCallback2 extends IVisualTreeServiceCallback {
  ...
  int OnElementStateChanged(
          int element, int elementState, Pointer<Utf16> context) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint64 element,
                              Int32 elementState, Pointer<Utf16> context)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int element, int elementState,
                      Pointer<Utf16> context)>()(
          ptr.ref.lpVtbl, element, elementState, context);
}
