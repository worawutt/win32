...
class IUIAnimationTimerUpdateHandler extends IUnknown {
  ...
  int OnUpdate(double timeNow, Pointer<Int32> result) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Double timeNow, Pointer<Int32> result)>>>()
          .value
          .asFunction<
              int Function(Pointer, double timeNow, Pointer<Int32> result)>()(
      ptr.ref.lpVtbl, timeNow, result);

  int SetTimerClientEventHandler(Pointer<COMObject> handler) => ptr
          .ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
