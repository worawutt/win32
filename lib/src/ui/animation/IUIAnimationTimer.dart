...
class IUIAnimationTimer extends IUnknown {
  ...
  int
      SetTimerUpdateHandler(
              Pointer<COMObject> updateHandler, int idleBehavior) =>
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<COMObject> updateHandler,
                          int idleBehavior)>()(
              ptr.ref.lpVtbl, updateHandler, idleBehavior);

  int SetTimerEventHandler(Pointer<COMObject> handler) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetTime(Pointer<Double> seconds) => ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int SetFrameRateThreshold(int framesPerSecond) => ptr.ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Uint32 framesPerSecond)>>>()
          .value
          .asFunction<int Function(Pointer, int framesPerSecond)>()(
      ptr.ref.lpVtbl, framesPerSecond);
}
