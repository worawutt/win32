...
class IUIAnimationVariableIntegerChangeHandler extends IUnknown {
  ...
  int OnIntegerValueChanged(Pointer<COMObject> storyboard,
          Pointer<COMObject> variable, int newValue, int previousValue) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int newValue,
                      int previousValue)>()(
          ptr.ref.lpVtbl, storyboard, variable, newValue, previousValue);
}
