...
class IUIAnimationLoopIterationChangeHandler2 extends IUnknown {
  ...
  int OnLoopIterationChanged(Pointer<COMObject> storyboard, int id,
          int newIterationCount, int oldIterationCount) =>
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> storyboard, int id,
                      int newIterationCount, int oldIterationCount)>()(
          ptr.ref.lpVtbl, storyboard, id, newIterationCount, oldIterationCount);
}
