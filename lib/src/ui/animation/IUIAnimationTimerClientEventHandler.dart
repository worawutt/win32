...
class IUIAnimationTimerClientEventHandler extends IUnknown {
  ...
  int OnTimerClientStatusChanged(int newStatus, int previousStatus) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Int32 newStatus, Int32 previousStatus)>>>()
          .value
          .asFunction<
              int Function(Pointer, int newStatus, int previousStatus)>()(
      ptr.ref.lpVtbl, newStatus, previousStatus);
}
