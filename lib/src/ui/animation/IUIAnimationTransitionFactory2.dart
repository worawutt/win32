...
class IUIAnimationTransitionFactory2 extends IUnknown {
  ...
  int CreateTransition(Pointer<COMObject> interpolator,
      ...
      ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> interpolator,
                          Pointer<Pointer<COMObject>> transition)>>>()
          .value
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<COMObject>>
                      transition)>()(ptr.ref.lpVtbl, interpolator, transition);
}
