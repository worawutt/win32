...
int FlashWindow(int hWnd, int bInvert) => _FlashWindow(hWnd, bInvert);
...
int FlashWindowEx(Pointer<FLASHWINFO> pfwi) => _FlashWindowEx(pfwi);

late final _FlashWindowEx = _user32.lookupFunction<
    Int32 Function(Pointer<FLASHWINFO> pfwi),
    int Function(Pointer<FLASHWINFO> pfwi)>('FlashWindowEx');
...
late final _GetClassLong = _user32.lookupFunction<
    Uint32 Function(IntPtr hWnd, Int32 nIndex),
...
int GetScrollPos(int hWnd, int nBar) => _GetScrollPos(hWnd, nBar);

late final _GetScrollPos = _user32.lookupFunction<
    Int32 Function(IntPtr hWnd, Uint32 nBar),
    int Function(int hWnd, int nBar)>('GetScrollPos');

int GetScrollRange(
        int hWnd, int nBar, Pointer<Int32> lpMinPos, Pointer<Int32> lpMaxPos) =>
    _GetScrollRange(hWnd, nBar, lpMinPos, lpMaxPos);

late final _GetScrollRange = _user32.lookupFunction<
    Int32 Function(IntPtr hWnd, Uint32 nBar, Pointer<Int32> lpMinPos,
        Pointer<Int32> lpMaxPos),
    int Function(int hWnd, int nBar, Pointer<Int32> lpMinPos,
        Pointer<Int32> lpMaxPos)>('GetScrollRange');
...
int MessageBoxIndirect(Pointer<MSGBOXPARAMS> lpmbp) =>
    _MessageBoxIndirect(lpmbp);

late final _MessageBoxIndirect = _user32.lookupFunction<
    Int32 Function(Pointer<MSGBOXPARAMS> lpmbp),
    int Function(Pointer<MSGBOXPARAMS> lpmbp)>('MessageBoxIndirectW');
...
late final _SetClassLong = _user32.lookupFunction<
    Uint32 Function(IntPtr hWnd, Int32 nIndex, Int32 dwNewLong),
...
late final _MrmCreateConfig = _mrmsupport.lookupFunction<
    Int32 Function(Int32 platformVersion, Pointer<Utf16> defaultQualifiers,
        Pointer<Utf16> outputXmlFile),
...
late final _MrmCreateResourceFile = _mrmsupport.lookupFunction<
    Int32 Function(MrmResourceIndexerHandle indexer, Int32 packagingMode,
        Int32 packagingOptions, Pointer<Utf16> outputDirectory),
    int Function(
...
int MrmCreateResourceFileWithChecksum(
    ...
    _MrmCreateResourceFileWithChecksum(
        indexer, packagingMode, packagingOptions, checksum, outputDirectory);
...
late final _MrmCreateResourceFileWithChecksum = _mrmsupport.lookupFunction<
    ...
    int Function(
        ...
        int packagingOptions,
        int checksum,
        Pointer<Utf16> outputDirectory)>('MrmCreateResourceFileWithChecksum');
...
int MrmCreateResourceIndexerWithFlags(
        ...
        int flags,
        Pointer<MrmResourceIndexerHandle> indexer) =>
    _MrmCreateResourceIndexerWithFlags(packageFamilyName, projectRoot,
        platformVersion, defaultQualifiers, flags, indexer);
...
late final _MrmDumpPriFile = _mrmsupport.lookupFunction<
    Int32 Function(Pointer<Utf16> indexFileName, Pointer<Utf16> schemaPriFile,
        Int32 dumpType, Pointer<Utf16> outputXmlFile),
...
int MrmGetPriFileContentChecksum(
        Pointer<Utf16> priFile, Pointer<Uint32> checksum) =>
    _MrmGetPriFileContentChecksum(priFile, checksum);

late final _MrmGetPriFileContentChecksum = _mrmsupport.lookupFunction<
    Int32 Function(Pointer<Utf16> priFile, Pointer<Uint32> checksum),
    int Function(Pointer<Utf16> priFile,
        Pointer<Uint32> checksum)>('MrmGetPriFileContentChecksum');
