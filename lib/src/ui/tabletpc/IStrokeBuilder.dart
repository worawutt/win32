...
class IStrokeBuilder extends IUnknown {
  ...
  int
      AppendPackets(
              int tcid, int sid, int cPktBuffLength, Pointer<Int32> pPackets) =>
          ptr.ref.lpVtbl.value
                  .elementAt(5)
                  .cast<
                      Pointer<
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, int tcid, int sid,
                          int cPktBuffLength, Pointer<Int32> pPackets)>()(
              ptr.ref.lpVtbl, tcid, sid, cPktBuffLength, pPackets);

  int EndStroke(int tcid, int sid, Pointer<Pointer<COMObject>> ppIInkStroke,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppIInkStroke,
                      Pointer<RECT> pDirtyRect)>()(
          ptr.ref.lpVtbl, tcid, sid, ppIInkStroke, pDirtyRect);
  ...
  Pointer<COMObject> get Ink {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppiInkObj)>()(
  ...
  int putref_Ink(Pointer<COMObject> piInkObj) => ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> piInkObj)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> piInkObj)>()(
      ptr.ref.lpVtbl, piInkObj);
}
