...
class IRealTimeStylusSynchronization extends IUnknown {
  ...
  int AcquireLock(int lock) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 lock)>>>()
      .value
      .asFunction<int Function(Pointer, int lock)>()(ptr.ref.lpVtbl, lock);

  int ReleaseLock(int lock) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 lock)>>>()
      .value
      .asFunction<int Function(Pointer, int lock)>()(ptr.ref.lpVtbl, lock);
