...
class IInkCustomStrokes extends IDispatch {
  ...
  int Item(VARIANT Identifier, Pointer<Pointer<COMObject>> Strokes) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, VARIANT Identifier,
                      Pointer<Pointer<COMObject>> Strokes)>()(
          ptr.ref.lpVtbl, Identifier, Strokes);

  int Add(Pointer<Utf16> Name, Pointer<COMObject> Strokes) =>
      ptr.ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(Pointer, Pointer<Utf16> Name,
                  Pointer<COMObject> Strokes)>()(ptr.ref.lpVtbl, Name, Strokes);
