...
class ITipAutoCompleteClient extends IUnknown {
  ...
  int AdviseProvider(int hWndField, Pointer<COMObject> pIProvider) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, IntPtr hWndField,
                              Pointer<COMObject> pIProvider)>>>()
              .value
              .asFunction<
                  int Function(
                      Pointer, int hWndField, Pointer<COMObject> pIProvider)>()(
          ptr.ref.lpVtbl, hWndField, pIProvider);

  int UnadviseProvider(int hWndField, Pointer<COMObject> pIProvider) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
  ...
  int PreferredRects(Pointer<RECT> prcACList, Pointer<RECT> prcField,
          Pointer<RECT> prcModifiedACList, Pointer<Int32> pfShownAboveTip) =>
      ptr.ref.lpVtbl.value
              .elementAt(6)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<RECT> prcField,
                      Pointer<RECT> prcModifiedACList,
                      Pointer<Int32> pfShownAboveTip)>()(ptr.ref.lpVtbl,
          prcACList, prcField, prcModifiedACList, pfShownAboveTip);

  int RequestShowUI(int hWndList, Pointer<Int32> pfAllowShowing) => ptr
          .ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, IntPtr hWndList,
                          Pointer<Int32> pfAllowShowing)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer, int hWndList, Pointer<Int32> pfAllowShowing)>()(
      ptr.ref.lpVtbl, hWndList, pfAllowShowing);
}
