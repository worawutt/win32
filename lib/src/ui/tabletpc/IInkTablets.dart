...
class IInkTablets extends IDispatch {
  ...
  Pointer<COMObject> get DefaultTablet {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> DefaultTablet)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  int Item(int Index, Pointer<Pointer<COMObject>> Tablet) => ptr
          .ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, int Index, Pointer<Pointer<COMObject>> Tablet)>()(
      ptr.ref.lpVtbl, Index, Tablet);
