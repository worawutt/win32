...
class IInkDivisionResult extends IDispatch {
  ...
  int ResultByType(
          int divisionType, Pointer<Pointer<COMObject>> InkDivisionUnits) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 divisionType,
                              Pointer<Pointer<COMObject>> InkDivisionUnits)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int divisionType,
                      Pointer<Pointer<COMObject>> InkDivisionUnits)>()(
          ptr.ref.lpVtbl, divisionType, InkDivisionUnits);
}
