...
class IInkExtendedProperties extends IDispatch {
  ...
  int Item(VARIANT Identifier, Pointer<Pointer<COMObject>> Item) => ptr
          .ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, VARIANT Identifier,
                          Pointer<Pointer<COMObject>> Item)>>>()
          .value
          .asFunction<
              int Function(Pointer, VARIANT Identifier,
                  Pointer<Pointer<COMObject>> Item)>()(
      ptr.ref.lpVtbl, Identifier, Item);

  int
      Add(Pointer<Utf16> Guid, VARIANT Data,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<Utf16> Guid, VARIANT Data,
                          Pointer<Pointer<COMObject>> InkExtendedProperty)>()(
              ptr.ref.lpVtbl, Guid, Data, InkExtendedProperty);

  int Remove(VARIANT Identifier) => ptr.ref.lpVtbl.value
      .elementAt(11)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, VARIANT Identifier)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, VARIANT Identifier)>()(ptr.ref.lpVtbl, Identifier);
  ...
  int DoesPropertyExist(
          Pointer<Utf16> Guid, Pointer<Int16> DoesPropertyExist) =>
      ptr.ref.lpVtbl.value
              .elementAt(13)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> Guid,
                              Pointer<Int16> DoesPropertyExist)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> Guid,
                      Pointer<Int16> DoesPropertyExist)>()(
          ptr.ref.lpVtbl, Guid, DoesPropertyExist);
}
