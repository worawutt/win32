...
class IInkRecognitionResult extends IDispatch {
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<Utf16>> TopString)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<Utf16>> TopString)>()(
  ...
  Pointer<COMObject> get TopAlternate {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> TopAlternate)>()(
          ptr.ref.lpVtbl, retValuePtr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> TopConfidence)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int32> TopConfidence)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  int ModifyTopAlternate(Pointer<COMObject> Alternate) => ptr.ref.lpVtbl.value
          .elementAt(12)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> Alternate)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> Alternate)>()(
      ptr.ref.lpVtbl, Alternate);
