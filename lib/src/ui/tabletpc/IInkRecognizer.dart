...
class IInkRecognizer extends IDispatch {
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<Utf16>> Vendor)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<Utf16>> Vendor)>()(
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Int32> CapabilitiesFlags)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> CapabilitiesFlags)>()(
          ptr.ref.lpVtbl, retValuePtr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<VARIANT> Languages)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<VARIANT> Languages)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  VARIANT get SupportedProperties {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<VARIANT> SupportedProperties)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  VARIANT get PreferredPacketDescription {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<VARIANT> PreferredPacketDescription)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  int CreateRecognizerContext(Pointer<Pointer<COMObject>> Context) =>
