...
class ITipAutoCompleteProvider extends IUnknown {
  ...
  int UpdatePendingText(Pointer<Utf16> bstrPendingText) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Utf16> bstrPendingText)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrPendingText)>()(
          ptr.ref.lpVtbl, bstrPendingText);
