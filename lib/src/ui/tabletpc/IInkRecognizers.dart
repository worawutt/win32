...
class IInkRecognizers extends IDispatch {
  ...
  int
      GetDefaultRecognizer(
              int lcid, Pointer<Pointer<COMObject>> DefaultRecognizer) =>
          ptr.ref.lpVtbl.value
              ...
              ptr.ref.lpVtbl, lcid, DefaultRecognizer);

  int Item(int Index, Pointer<Pointer<COMObject>> InkRecognizer) => ptr
          .ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(Pointer, int Index,
                  Pointer<Pointer<COMObject>> InkRecognizer)>()(
      ptr.ref.lpVtbl, Index, InkRecognizer);
}
