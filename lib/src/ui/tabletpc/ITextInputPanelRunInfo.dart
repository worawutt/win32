...
class ITextInputPanelRunInfo extends IUnknown {
  ...
  int IsTipRunning(Pointer<Int32> pfRunning) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> pfRunning)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Int32> pfRunning)>()(
      ptr.ref.lpVtbl, pfRunning);
}
