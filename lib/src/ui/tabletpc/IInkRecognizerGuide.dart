  ...
  Pointer<COMObject> get WritingBox {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> Rectangle)>()(
    ...
    final hr = ptr.ref.lpVtbl.value
        ...
        .asFunction<
            int Function(Pointer,
                Pointer<COMObject> Rectangle)>()(ptr.ref.lpVtbl, value);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<InkRecoGuide> pRecoGuide)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<InkRecoGuide> pRecoGuide)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set GuideData(InkRecoGuide value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(Pointer, InkRecoGuide recoGuide)>>>()
            .value
            .asFunction<int Function(Pointer, InkRecoGuide recoGuide)>()(
