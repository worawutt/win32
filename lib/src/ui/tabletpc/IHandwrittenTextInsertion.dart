...
class IHandwrittenTextInsertion extends IUnknown {
  ...
  int InsertRecognitionResultsArray(Pointer<SAFEARRAY> psaAlternates,
          int locale, int fAlternateContainsAutoSpacingInformation) =>
  ...
  int InsertInkRecognitionResult(Pointer<COMObject> pIInkRecoResult, int locale,
          int fAlternateContainsAutoSpacingInformation) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
