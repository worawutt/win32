...
class ITextServices extends IUnknown {
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Int32> plPage,
                      Pointer<Int32> pfEnabled)>()(
          ptr.ref.lpVtbl, plMin, plMax, plPos, plPage, pfEnabled);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<RECT> lprcClient,
                      int x,
                      int y)>()(ptr.ref.lpVtbl, dwDrawAspect, lindex, pvAspect,
          ptd, hdcDraw, hicTargetDev, lprcClient, x, y);
  ...
  int OnTxInPlaceActivate(Pointer<RECT> prcClient) => ptr.ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<RECT> prcClient)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<RECT> prcClient)>()(
      ptr.ref.lpVtbl, prcClient);
  ...
  int TxGetText(Pointer<Pointer<Utf16>> pbstrText) => ptr.ref.lpVtbl.value
          .elementAt(13)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int TxSetText(Pointer<Utf16> pszText) => ptr.ref.lpVtbl.value
          .elementAt(14)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int TxGetCurTargetX(Pointer<Int32> param0) => ptr.ref.lpVtbl.value
      .elementAt(15)
      .cast<
          Pointer<
  ...
  int TxGetBaseLinePos(Pointer<Int32> param0) => ptr.ref.lpVtbl.value
      .elementAt(16)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Int32> param0)>>>()
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<SIZE> psizelExtent,
                      Pointer<Int32> pwidth,
                      Pointer<Int32> pheight)>()(ptr.ref.lpVtbl, dwAspect,
          hdcDraw, hicTargetDev, ptd, dwMode, psizelExtent, pwidth, pheight);

  int TxGetDropTarget(Pointer<Pointer<COMObject>> ppDropTarget) =>
      ptr.ref.lpVtbl.value
              .elementAt(18)
              .cast<
                  Pointer<
  ...
  int OnTxPropertyBitsChange(int dwMask, int dwBits) => ptr.ref.lpVtbl.value
          .elementAt(19)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Uint32 dwMask, Uint32 dwBits)>>>()
          .value
          .asFunction<int Function(Pointer, int dwMask, int dwBits)>()(
      ptr.ref.lpVtbl, dwMask, dwBits);

  int TxGetCachedSize(Pointer<Uint32> pdwWidth, Pointer<Uint32> pdwHeight) =>
      ptr.ref.lpVtbl.value
              .elementAt(20)
              .cast<
                  Pointer<
