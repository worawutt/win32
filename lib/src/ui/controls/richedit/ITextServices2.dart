...
class ITextServices2 extends ITextServices {
  ...
  int TxDrawD2D(Pointer<COMObject> pRenderTarget, Pointer<RECTL> lprcBounds,
          Pointer<RECT> lprcUpdate, int lViewId) =>
      ptr.ref.lpVtbl.value
              .elementAt(22)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<RECT> lprcUpdate,
                      int lViewId)>()(
          ptr.ref.lpVtbl, pRenderTarget, lprcBounds, lprcUpdate, lViewId);
}
