...
typedef EDITSTREAMCALLBACK = Uint32 Function(
    IntPtr dwCookie, Pointer<Uint8> pbBuff, Int32 cb, Pointer<Int32> pcb);
typedef EDITWORDBREAKPROCEX = Int32 Function(
    Pointer<Utf8> pchText, Int32 cchText, Uint8 bCharSet, Int32 action);
typedef PCreateTextServices = Int32 Function(Pointer<COMObject> punkOuter,
    Pointer<COMObject> pITextHost, Pointer<Pointer<COMObject>> ppUnk);
