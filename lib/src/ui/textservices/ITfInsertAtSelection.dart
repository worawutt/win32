...
class ITfInsertAtSelection extends IUnknown {
  ...
  int InsertTextAtSelection(int ec, int dwFlags, Pointer<Utf16> pchText,
          int cch, Pointer<Pointer<COMObject>> ppRange) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int cch,
                      Pointer<Pointer<COMObject>> ppRange)>()(
          ptr.ref.lpVtbl, ec, dwFlags, pchText, cch, ppRange);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pDataObject,
                      Pointer<Pointer<COMObject>> ppRange)>()(
          ptr.ref.lpVtbl, ec, dwFlags, pDataObject, ppRange);
}
