...
class ITfContextView extends IUnknown {
  ...
  int GetRangeFromPoint(int ec, Pointer<POINT> ppt, int dwFlags,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int ec, Pointer<POINT> ppt, int dwFlags,
                      Pointer<Pointer<COMObject>> ppRange)>()(
          ptr.ref.lpVtbl, ec, ppt, dwFlags, ppRange);

  int GetTextExt(int ec, Pointer<COMObject> pRange, Pointer<RECT> prc,
      ...
      ptr.ref.lpVtbl.value
          ...
          ptr.ref.lpVtbl, ec, pRange, prc, pfClipped);
