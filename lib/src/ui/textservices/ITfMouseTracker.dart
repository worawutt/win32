...
class ITfMouseTracker extends IUnknown {
  ...
  int AdviseMouseSink(Pointer<COMObject> range, Pointer<COMObject> pSink,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> range,
                      Pointer<COMObject> pSink, Pointer<Uint32> pdwCookie)>()(
          ptr.ref.lpVtbl, range, pSink, pdwCookie);

  int UnadviseMouseSink(int dwCookie) => ptr.ref.lpVtbl.value
      .elementAt(4)
