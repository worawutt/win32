...
class ITfContextComposition extends IUnknown {
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pSink,
                      Pointer<Pointer<COMObject>> ppComposition)>()(
          ptr.ref.lpVtbl, ecWrite, pCompositionRange, pSink, ppComposition);

  int EnumCompositions(Pointer<Pointer<COMObject>> ppEnum) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
  ...
  int FindComposition(int ecRead, Pointer<COMObject> pTestRange,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pTestRange,
                      Pointer<Pointer<COMObject>> ppEnum)>()(
          ptr.ref.lpVtbl, ecRead, pTestRange, ppEnum);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pSink,
                      Pointer<Pointer<COMObject>> ppComposition)>()(
          ptr.ref.lpVtbl, ecWrite, pComposition, pSink, ppComposition);
}
