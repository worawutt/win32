...
class ITfLangBarItemButton extends ITfLangBarItem {
  ...
  int GetIcon(Pointer<IntPtr> phIcon) => ptr.ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<IntPtr> phIcon)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<IntPtr> phIcon)>()(
      ptr.ref.lpVtbl, phIcon);
