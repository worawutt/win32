...
class ITfEditRecord extends IUnknown {
  ...
  int GetSelectionStatus(Pointer<Int32> pfChanged) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> pfChanged)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Int32> pfChanged)>()(
      ptr.ref.lpVtbl, pfChanged);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int cProperties,
                      Pointer<Pointer<COMObject>> ppEnum)>()(
          ptr.ref.lpVtbl, dwFlags, prgProperties, cProperties, ppEnum);
}
