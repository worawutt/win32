...
class ITfContextOwnerServices extends IUnknown {
  ...
  int OnAttributeChange(Pointer<GUID> rguidAttribute) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .value
          .asFunction<int Function(Pointer, Pointer<GUID> rguidAttribute)>()(
      ptr.ref.lpVtbl, rguidAttribute);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<TF_PERSISTENT_PROPERTY_HEADER_ACP> pHdr,
                      Pointer<COMObject> pStream)>()(
          ptr.ref.lpVtbl, pProp, pRange, pHdr, pStream);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pStream,
                      Pointer<COMObject> pLoader)>()(
          ptr.ref.lpVtbl, pProp, pHdr, pStream, pLoader);

  int ForceLoadProperty(Pointer<COMObject> pProp) => ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pProp)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> pProp)>()(
      ptr.ref.lpVtbl, pProp);

  int CreateRange(
          int acpStart, int acpEnd, Pointer<Pointer<COMObject>> ppRange) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, int acpStart, int acpEnd,
                      Pointer<Pointer<COMObject>> ppRange)>()(
          ptr.ref.lpVtbl, acpStart, acpEnd, ppRange);
}
