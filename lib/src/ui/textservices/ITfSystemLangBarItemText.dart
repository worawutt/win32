...
class ITfSystemLangBarItemText extends IUnknown {
  ...
  int SetItemText(Pointer<Utf16> pch, int cch) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Utf16> pch, Uint32 cch)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Utf16> pch, int cch)>()(
          ptr.ref.lpVtbl, pch, cch);

  int GetItemText(Pointer<Pointer<Utf16>> pbstrText) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
