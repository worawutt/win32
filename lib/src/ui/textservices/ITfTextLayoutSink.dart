...
class ITfTextLayoutSink extends IUnknown {
  ...
  int OnLayoutChange(
          Pointer<COMObject> pic, int lcode, Pointer<COMObject> pView) =>
      ptr
              .ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<COMObject> pic,
                              Int32 lcode, Pointer<COMObject> pView)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pic, int lcode,
                      Pointer<COMObject> pView)>()(
          ptr.ref.lpVtbl, pic, lcode, pView);
}
