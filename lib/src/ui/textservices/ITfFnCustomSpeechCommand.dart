...
class ITfFnCustomSpeechCommand extends ITfFunction {
  ...
  int SetSpeechCommandProvider(Pointer<COMObject> pspcmdProvider) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<COMObject> pspcmdProvider)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pspcmdProvider)>()(
          ptr.ref.lpVtbl, pspcmdProvider);
}
