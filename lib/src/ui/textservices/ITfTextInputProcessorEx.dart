...
class ITfTextInputProcessorEx extends ITfTextInputProcessor {
  ...
  int ActivateEx(Pointer<COMObject> ptim, int tid, int dwFlags) =>
      ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> ptim,
                          Uint32 tid, Uint32 dwFlags)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> ptim, int tid,
                  int dwFlags)>()(ptr.ref.lpVtbl, ptim, tid, dwFlags);
}
