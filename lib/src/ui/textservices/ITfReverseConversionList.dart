...
class ITfReverseConversionList extends IUnknown {
  ...
  int GetLength(Pointer<Uint32> puIndex) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetString(int uIndex, Pointer<Pointer<Utf16>> pbstr) => ptr
      .ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
      ...
      .asFunction<
          int Function(Pointer, int uIndex,
              Pointer<Pointer<Utf16>> pbstr)>()(ptr.ref.lpVtbl, uIndex, pbstr);
}
