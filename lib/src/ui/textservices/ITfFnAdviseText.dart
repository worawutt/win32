...
class ITfFnAdviseText extends ITfFunction {
  ...
  int OnTextUpdate(
          Pointer<COMObject> pRange, Pointer<Utf16> pchText, int cch) =>
      ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(
                  ...
                  int cch)>()(ptr.ref.lpVtbl, pRange, pchText, cch);

  int OnLatticeUpdate(Pointer<COMObject> pRange, Pointer<COMObject> pLattice) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pRange,
                      Pointer<COMObject> pLattice)>()(
          ptr.ref.lpVtbl, pRange, pLattice);
}
