...
class ITfUIElement extends IUnknown {
  ...
  int Show(int bShow) => ptr.ref.lpVtbl.value
      .elementAt(5)
  ...
  int IsShown(Pointer<Int32> pbShow) => ptr.ref.lpVtbl.value
      .elementAt(6)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Int32> pbShow)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, Pointer<Int32> pbShow)>()(ptr.ref.lpVtbl, pbShow);
}
