...
class ITfCompositionSink extends IUnknown {
  ...
  int OnCompositionTerminated(int ecWrite, Pointer<COMObject> pComposition) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, int ecWrite, Pointer<COMObject> pComposition)>()(
          ptr.ref.lpVtbl, ecWrite, pComposition);
}
