...
class ITextStoreAnchorEx extends IUnknown {
  ...
  int ScrollToRect(Pointer<COMObject> pStart, Pointer<COMObject> pEnd, RECT rc,
          int dwPosition) =>
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pStart,
                      Pointer<COMObject> pEnd, RECT rc, int dwPosition)>()(
          ptr.ref.lpVtbl, pStart, pEnd, rc, dwPosition);
}
