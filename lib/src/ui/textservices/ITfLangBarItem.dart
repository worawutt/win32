...
class ITfLangBarItem extends IUnknown {
  ...
  int GetInfo(Pointer<TF_LANGBARITEMINFO> pInfo) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<TF_LANGBARITEMINFO> pInfo)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<TF_LANGBARITEMINFO> pInfo)>()(
  ...
  int GetTooltipString(Pointer<Pointer<Utf16>> pbstrToolTip) => ptr
          .ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<Utf16>> pbstrToolTip)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<Utf16>> pbstrToolTip)>()(
      ptr.ref.lpVtbl, pbstrToolTip);
}
