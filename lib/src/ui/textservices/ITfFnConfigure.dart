...
class ITfFnConfigure extends ITfFunction {
  ...
  int Show(int hwndParent, int langid, Pointer<GUID> rguidProfile) => ptr
          .ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, IntPtr hwndParent, Uint16 langid,
                          Pointer<GUID> rguidProfile)>>>()
          .value
          .asFunction<
              int Function(Pointer, int hwndParent, int langid,
                  Pointer<GUID> rguidProfile)>()(
      ptr.ref.lpVtbl, hwndParent, langid, rguidProfile);
}
