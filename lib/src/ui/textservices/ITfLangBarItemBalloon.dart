...
class ITfLangBarItemBalloon extends ITfLangBarItem {
  ...
  int GetBalloonInfo(Pointer<TF_LBBALLOONINFO> pInfo) => ptr.ref.lpVtbl.value
      .elementAt(9)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<TF_LBBALLOONINFO> pInfo)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<TF_LBBALLOONINFO> pInfo)>()(ptr.ref.lpVtbl, pInfo);
}
