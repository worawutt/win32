...
class ITfSpeechUIServer extends IUnknown {
  ...
  int ShowUI(int fShow) => ptr.ref.lpVtbl.value
      .elementAt(4)
  ...
  int UpdateBalloon(int style, Pointer<Utf16> pch, int cch) => ptr
      .ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Int32 style, Pointer<Utf16> pch, Uint32 cch)>>>()
      .value
      .asFunction<
          int Function(Pointer, int style, Pointer<Utf16> pch,
              int cch)>()(ptr.ref.lpVtbl, style, pch, cch);
}
