...
class ITfReverseConversion extends IUnknown {
  ...
  int DoReverseConversion(
          Pointer<Utf16> lpstr, Pointer<Pointer<COMObject>> ppList) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> lpstr,
                              Pointer<Pointer<COMObject>> ppList)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> lpstr,
                      Pointer<Pointer<COMObject>> ppList)>()(
          ptr.ref.lpVtbl, lpstr, ppList);
}
