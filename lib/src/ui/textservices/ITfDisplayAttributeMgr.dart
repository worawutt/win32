...
class ITfDisplayAttributeMgr extends IUnknown {
  ...
  int EnumDisplayAttributeInfo(Pointer<Pointer<COMObject>> ppEnum) =>
  ...
  int GetDisplayAttributeInfo(Pointer<GUID> guid,
          Pointer<Pointer<COMObject>> ppInfo, Pointer<GUID> pclsidOwner) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppInfo,
                      Pointer<GUID> pclsidOwner)>()(
          ptr.ref.lpVtbl, guid, ppInfo, pclsidOwner);
}
