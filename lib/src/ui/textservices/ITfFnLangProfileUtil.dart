...
class ITfFnLangProfileUtil extends ITfFunction {
  ...
  int IsProfileAvailableForLang(int langid, Pointer<Int32> pfAvailable) => ptr
          .ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
          ...
          .value
          .asFunction<
              int Function(Pointer, int langid, Pointer<Int32> pfAvailable)>()(
      ptr.ref.lpVtbl, langid, pfAvailable);
}
