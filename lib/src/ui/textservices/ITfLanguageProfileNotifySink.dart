...
class ITfLanguageProfileNotifySink extends IUnknown {
  ...
  int OnLanguageChange(int langid, Pointer<Int32> pfAccept) =>
      ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Uint16 langid, Pointer<Int32> pfAccept)>>>()
          .value
          .asFunction<
              int Function(Pointer, int langid,
                  Pointer<Int32> pfAccept)>()(ptr.ref.lpVtbl, langid, pfAccept);
