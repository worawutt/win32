...
class ITfReadOnlyProperty extends IUnknown {
  ...
  int EnumRanges(int ec, Pointer<Pointer<COMObject>> ppEnum,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppEnum,
                      Pointer<COMObject> pTargetRange)>()(
          ptr.ref.lpVtbl, ec, ppEnum, pTargetRange);

  int GetValue(int ec, Pointer<COMObject> pRange, Pointer<VARIANT> pvarValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
