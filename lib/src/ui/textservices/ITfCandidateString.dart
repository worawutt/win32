...
class ITfCandidateString extends IUnknown {
  ...
  int GetString(Pointer<Pointer<Utf16>> pbstr) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
  ...
  int GetIndex(Pointer<Uint32> pnIndex) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Uint32> pnIndex)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Uint32> pnIndex)>()(
      ptr.ref.lpVtbl, pnIndex);
}
