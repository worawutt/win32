...
class ICoCreatedLocally extends IUnknown {
  ...
  int LocalInit(Pointer<COMObject> punkLocalObject, Pointer<GUID> riidParam,
          Pointer<COMObject> punkParam, VARIANT varParam) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> punkParam,
                      VARIANT varParam)>()(
          ptr.ref.lpVtbl, punkLocalObject, riidParam, punkParam, varParam);
}
