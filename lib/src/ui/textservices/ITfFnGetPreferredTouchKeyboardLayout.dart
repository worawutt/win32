...
class ITfFnGetPreferredTouchKeyboardLayout extends ITfFunction {
  ...
  int GetLayout(
          Pointer<Int32> pTKBLayoutType, Pointer<Uint16> pwPreferredLayoutId) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> pTKBLayoutType,
                              Pointer<Uint16> pwPreferredLayoutId)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> pTKBLayoutType,
                      Pointer<Uint16> pwPreferredLayoutId)>()(
          ptr.ref.lpVtbl, pTKBLayoutType, pwPreferredLayoutId);
}
