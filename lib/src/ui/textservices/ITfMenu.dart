...
class ITfMenu extends IUnknown {
  ...
  int AddMenuItem(int uId, int dwFlags, int hbmp, int hbmpMask,
          Pointer<Utf16> pch, int cch, Pointer<Pointer<COMObject>> ppMenu) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int cch,
                      Pointer<Pointer<COMObject>> ppMenu)>()(
          ptr.ref.lpVtbl, uId, dwFlags, hbmp, hbmpMask, pch, cch, ppMenu);
}
