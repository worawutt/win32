...
class ITfPreservedKeyNotifySink extends IUnknown {
  ...
  int OnUpdated(Pointer<TF_PRESERVEDKEY> pprekey) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<TF_PRESERVEDKEY> pprekey)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<TF_PRESERVEDKEY> pprekey)>()(ptr.ref.lpVtbl, pprekey);
}
