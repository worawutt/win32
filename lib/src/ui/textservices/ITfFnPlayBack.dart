...
class ITfFnPlayBack extends ITfFunction {
  ...
  int QueryRange(Pointer<COMObject> pRange,
          Pointer<Pointer<COMObject>> ppNewRange, Pointer<Int32> pfPlayable) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppNewRange,
                      Pointer<Int32> pfPlayable)>()(
          ptr.ref.lpVtbl, pRange, ppNewRange, pfPlayable);

  int Play(Pointer<COMObject> pRange) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
