...
class ITfSource extends IUnknown {
  ...
  int AdviseSink(Pointer<GUID> riid, Pointer<COMObject> punk,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<GUID> riid,
                      Pointer<COMObject> punk, Pointer<Uint32> pdwCookie)>()(
          ptr.ref.lpVtbl, riid, punk, pdwCookie);

  int UnadviseSink(int dwCookie) => ptr.ref.lpVtbl.value
      .elementAt(4)
