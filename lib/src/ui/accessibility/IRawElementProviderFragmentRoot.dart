...
class IRawElementProviderFragmentRoot extends IUnknown {
  ...
  int ElementProviderFromPoint(
          double x, double y, Pointer<Pointer<COMObject>> pRetVal) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Double x, Double y,
                              Pointer<Pointer<COMObject>> pRetVal)>>>()
              .value
              .asFunction<
                  int Function(Pointer, double x, double y,
                      Pointer<Pointer<COMObject>> pRetVal)>()(
          ptr.ref.lpVtbl, x, y, pRetVal);

  int GetFocus(Pointer<Pointer<COMObject>> pRetVal) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
