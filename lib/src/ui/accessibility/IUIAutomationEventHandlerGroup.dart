...
class IUIAutomationEventHandlerGroup extends IUnknown {
  ...
  int AddActiveTextPositionChangedEventHandler(int scope,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> cacheRequest,
                      Pointer<COMObject> handler)>()(
          ptr.ref.lpVtbl, scope, cacheRequest, handler);

  int AddAutomationEventHandler(int eventId, int scope,
          Pointer<COMObject> cacheRequest, Pointer<COMObject> handler) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> cacheRequest,
                      Pointer<COMObject> handler)>()(
          ptr.ref.lpVtbl, eventId, scope, cacheRequest, handler);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int changesCount,
                      Pointer<COMObject> cacheRequest,
                      Pointer<COMObject> handler)>()(ptr.ref.lpVtbl, scope,
          changeTypes, changesCount, cacheRequest, handler);

  int AddNotificationEventHandler(int scope, Pointer<COMObject> cacheRequest,
          Pointer<COMObject> handler) =>
      ptr.ref.lpVtbl.value
              .elementAt(6)
              .cast<
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> handler,
                      Pointer<Int32> propertyArray,
                      int propertyCount)>()(ptr.ref.lpVtbl, scope, cacheRequest,
          handler, propertyArray, propertyCount);

  int AddStructureChangedEventHandler(int scope,
          Pointer<COMObject> cacheRequest, Pointer<COMObject> handler) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
  ...
  int AddTextEditTextChangedEventHandler(int scope, int textEditChangeType,
          Pointer<COMObject> cacheRequest, Pointer<COMObject> handler) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> cacheRequest,
                      Pointer<COMObject> handler)>()(
          ptr.ref.lpVtbl, scope, textEditChangeType, cacheRequest, handler);
}
