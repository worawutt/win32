...
class IUIAutomationTransformPattern extends IUnknown {
  ...
  int Move(double x, double y) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
  ...
  int Resize(double width, double height) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int Rotate(double degrees) => ptr.ref.lpVtbl.value
      .elementAt(5)
