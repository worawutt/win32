...
class IUIAutomationTextRange extends IUnknown {
  ...
  int Clone(Pointer<Pointer<COMObject>> clonedRange) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int ExpandToEnclosingUnit(int textUnit) => ptr.ref.lpVtbl.value
      .elementAt(6)
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Int32 attr, Pointer<VARIANT> value)>>>()
              .value
              .asFunction<
  ...
  int GetText(int maxLength, Pointer<Pointer<Utf16>> text) => ptr
      .ref.lpVtbl.value
      .elementAt(12)
      .cast<
          Pointer<
  ...
  int Move(int unit, int count, Pointer<Int32> moved) => ptr.ref.lpVtbl.value
      .elementAt(13)
      .cast<
          Pointer<
              NativeFunction<
  ...
  int GetChildren(Pointer<Pointer<COMObject>> children) => ptr.ref.lpVtbl.value
          .elementAt(20)
          .cast<
              Pointer<
                  NativeFunction<
