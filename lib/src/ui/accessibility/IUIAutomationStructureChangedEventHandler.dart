...
class IUIAutomationStructureChangedEventHandler extends IUnknown {
  ...
  int
      HandleStructureChangedEvent(Pointer<COMObject> sender, int changeType,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(Pointer, Pointer<COMObject> sender,
                          int changeType, Pointer<SAFEARRAY> runtimeId)>()(
              ptr.ref.lpVtbl, sender, changeType, runtimeId);
}
