...
class IUIAutomationElement extends IUnknown {
  ...
  int GetRuntimeId(Pointer<Pointer<SAFEARRAY>> runtimeId) => ptr
          .ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
  ...
  int GetCurrentPropertyValue(int propertyId, Pointer<VARIANT> retVal) => ptr
      ...
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Int32 propertyId, Pointer<VARIANT> retVal)>>>()
      .value
      .asFunction<
  ...
  int GetCachedChildren(Pointer<Pointer<COMObject>> children) => ptr
          .ref.lpVtbl.value
          .elementAt(19)
          .cast<
              Pointer<
