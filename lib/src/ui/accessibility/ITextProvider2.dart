...
class ITextProvider2 extends ITextProvider {
  ...
  int RangeFromAnnotation(Pointer<COMObject> annotationElement,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> annotationElement,
                      Pointer<Pointer<COMObject>> pRetVal)>()(
          ptr.ref.lpVtbl, annotationElement, pRetVal);

  int GetCaretRange(
          Pointer<Int32> isActive, Pointer<Pointer<COMObject>> pRetVal) =>
      ptr
              .ref.lpVtbl.value
              .elementAt(10)
              .cast<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Int32> isActive,
                      Pointer<Pointer<COMObject>> pRetVal)>()(
          ptr.ref.lpVtbl, isActive, pRetVal);
}
