...
class IUIAutomationTextEditTextChangedEventHandler extends IUnknown {
  ...
  int HandleTextEditTextChangedEvent(Pointer<COMObject> sender,
          int textEditChangeType, Pointer<SAFEARRAY> eventStrings) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<SAFEARRAY> eventStrings)>()(
          ptr.ref.lpVtbl, sender, textEditChangeType, eventStrings);
}
