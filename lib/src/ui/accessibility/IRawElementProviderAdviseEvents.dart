...
class IRawElementProviderAdviseEvents extends IUnknown {
  ...
  int AdviseEventAdded(int eventId, Pointer<SAFEARRAY> propertyIDs) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 eventId,
                              Pointer<SAFEARRAY> propertyIDs)>>>()
              .value
              .asFunction<
                  int Function(
                      Pointer, int eventId, Pointer<SAFEARRAY> propertyIDs)>()(
          ptr.ref.lpVtbl, eventId, propertyIDs);

  int AdviseEventRemoved(int eventId, Pointer<SAFEARRAY> propertyIDs) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
