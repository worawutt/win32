...
class IAccessibleHandler extends IUnknown {
  ...
  int AccessibleObjectFromID(
          int hwnd, int lObjectID, Pointer<Pointer<COMObject>> pIAccessible) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 hwnd, Int32 lObjectID,
                              Pointer<Pointer<COMObject>> pIAccessible)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int hwnd, int lObjectID,
                      Pointer<Pointer<COMObject>> pIAccessible)>()(
          ptr.ref.lpVtbl, hwnd, lObjectID, pIAccessible);
}
