...
class IUIAutomationPatternHandler extends IUnknown {
  ...
  int CreateClientWrapper(Pointer<COMObject> pPatternInstance,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pPatternInstance,
                      Pointer<Pointer<COMObject>> pClientWrapper)>()(
          ptr.ref.lpVtbl, pPatternInstance, pClientWrapper);

  int Dispatch(Pointer<COMObject> pTarget, int index,
          Pointer<UIAutomationParameter> pParams, int cParams) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pTarget, int index,
                      Pointer<UIAutomationParameter> pParams, int cParams)>()(
          ptr.ref.lpVtbl, pTarget, index, pParams, cParams);
}
