...
class IUIAutomation extends IUnknown {
  ...
  int GetRootElement(Pointer<Pointer<COMObject>> root) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<
  ...
  int GetFocusedElement(Pointer<Pointer<COMObject>> element) => ptr
          .ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
  ...
  int RectToVariant(RECT rc, Pointer<VARIANT> $var) => ptr.ref.lpVtbl.value
      .elementAt(44)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, RECT rc, Pointer<VARIANT> $var)>>>()
      .value
      .asFunction<
          int Function(Pointer, RECT rc,
              Pointer<VARIANT> $var)>()(ptr.ref.lpVtbl, rc, $var);

  int VariantToRect(VARIANT $var, Pointer<RECT> rc) => ptr.ref.lpVtbl.value
      .elementAt(45)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, VARIANT $var, Pointer<RECT> rc)>>>()
      .value
      .asFunction<
          int Function(Pointer, VARIANT $var,
              Pointer<RECT> rc)>()(ptr.ref.lpVtbl, $var, rc);
  ...
  int GetPropertyProgrammaticName(int property, Pointer<Pointer<Utf16>> name) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 property,
  ...
  int GetPatternProgrammaticName(int pattern, Pointer<Pointer<Utf16>> name) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 pattern,
                              Pointer<Pointer<Utf16>> name)>>>()
              .value
              .asFunction<
                  int Function(
