...
class IUIAutomationPropertyChangedEventHandler extends IUnknown {
  ...
  int HandlePropertyChangedEvent(
          Pointer<COMObject> sender, int propertyId, VARIANT newValue) =>
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<COMObject> sender,
                              Int32 propertyId, VARIANT newValue)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> sender,
                      int propertyId, VARIANT newValue)>()(
          ptr.ref.lpVtbl, sender, propertyId, newValue);
}
