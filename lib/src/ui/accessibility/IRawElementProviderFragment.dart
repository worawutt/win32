...
class IRawElementProviderFragment extends IUnknown {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<UiaRect> pRetVal)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<UiaRect> pRetVal)>()(
  ...
  int GetEmbeddedFragmentRoots(Pointer<Pointer<SAFEARRAY>> pRetVal) =>
      ptr.ref.lpVtbl.value
              .elementAt(6)
              .cast<
                  Pointer<
