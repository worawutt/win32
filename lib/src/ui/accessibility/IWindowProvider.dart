...
class IWindowProvider extends IUnknown {
  ...
  int SetVisualState(int state) => ptr.ref.lpVtbl.value
      .elementAt(3)
  ...
  int WaitForInputIdle(int milliseconds, Pointer<Int32> pRetVal) => ptr
      .ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Int32 milliseconds, Pointer<Int32> pRetVal)>>>()
      .value
      .asFunction<
          int Function(Pointer, int milliseconds,
              Pointer<Int32> pRetVal)>()(ptr.ref.lpVtbl, milliseconds, pRetVal);
