...
class IAccPropServer extends IUnknown {
  ...
  int GetPropValue(Pointer<Uint8> pIDString, int dwIDStringLen, GUID idProp,
          Pointer<VARIANT> pvarValue, Pointer<Int32> pfHasProp) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      GUID idProp,
                      Pointer<VARIANT> pvarValue,
                      Pointer<Int32> pfHasProp)>()(ptr.ref.lpVtbl, pIDString,
          dwIDStringLen, idProp, pvarValue, pfHasProp);
}
