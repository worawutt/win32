...
class IProxyProviderWinEventHandler extends IUnknown {
  ...
  int RespondToWinEvent(int idWinEvent, int hwnd, int idObject, int idChild,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int idWinEvent, int hwnd, int idObject,
                      int idChild, Pointer<COMObject> pSink)>()(
          ptr.ref.lpVtbl, idWinEvent, hwnd, idObject, idChild, pSink);
}
