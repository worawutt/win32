...
class ILegacyIAccessibleProvider extends IUnknown {
  ...
  int Select(int flagsSelect) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
  ...
  int SetValue(Pointer<Utf16> szValue) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetSelection(Pointer<Pointer<SAFEARRAY>> pvarSelectedChildren) => ptr
          .ref.lpVtbl.value
          .elementAt(15)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<SAFEARRAY>> pvarSelectedChildren)>()(
