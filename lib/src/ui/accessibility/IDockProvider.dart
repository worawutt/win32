...
class IDockProvider extends IUnknown {
  ...
  int SetDockPosition(int dockPosition) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Int32 dockPosition)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int dockPosition)>()(ptr.ref.lpVtbl, dockPosition);
