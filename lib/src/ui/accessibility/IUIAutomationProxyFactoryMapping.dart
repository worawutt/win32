...
class IUIAutomationProxyFactoryMapping extends IUnknown {
  ...
  int GetTable(Pointer<Pointer<SAFEARRAY>> table) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetEntry(int index, Pointer<Pointer<COMObject>> entry) => ptr
          .ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
  ...
  int SetTable(Pointer<SAFEARRAY> factoryList) => ptr.ref.lpVtbl.value
      .elementAt(6)
      .cast<
          Pointer<
              NativeFunction<
  ...
  int InsertEntry(int before, Pointer<COMObject> factory) => ptr
      .ref.lpVtbl.value
      .elementAt(8)
      .cast<
          Pointer<
  ...
  int RemoveEntry(int index) => ptr.ref.lpVtbl.value
      .elementAt(9)
