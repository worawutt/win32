...
class IUIAutomationEventHandler extends IUnknown {
  ...
  int HandleAutomationEvent(Pointer<COMObject> sender, int eventId) => ptr
      .ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Pointer<COMObject> sender, Int32 eventId)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<COMObject> sender,
              int eventId)>()(ptr.ref.lpVtbl, sender, eventId);
}
