...
class IUIAutomationRegistrar extends IUnknown {
  ...
  int RegisterProperty(Pointer<UIAutomationPropertyInfo> property,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<UIAutomationPropertyInfo> property,
                      Pointer<Int32> propertyId)>()(
          ptr.ref.lpVtbl, property, propertyId);

  int RegisterEvent(
          Pointer<UIAutomationEventInfo> event, Pointer<Int32> eventId) =>
      ptr
          .ref.lpVtbl.value
          .elementAt(4)
          .cast<
          ...
          .value
          .asFunction<
              int Function(Pointer, Pointer<UIAutomationEventInfo> event,
                  Pointer<Int32> eventId)>()(ptr.ref.lpVtbl, event, eventId);
