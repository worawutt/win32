      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GamutBoundaryDescription> pSrcGBD,
                      Pointer<GamutBoundaryDescription> pDestGBD)>()(
          ptr.ref.lpVtbl, bstrXml, pSrcPlugIn, pDestPlugIn, pSrcGBD, pDestGBD);

  int SourceToDestinationAppearanceColors(int cColors,
          Pointer<JChColorF> pInputColors, Pointer<JChColorF> pOutputColors) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<JChColorF> pInputColors,
                      Pointer<JChColorF> pOutputColors)>()(
          ptr.ref.lpVtbl, cColors, pInputColors, pOutputColors);
}
