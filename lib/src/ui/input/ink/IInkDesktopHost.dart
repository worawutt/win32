...
class IInkDesktopHost extends IUnknown {
  ...
  int QueueWorkItem(Pointer<COMObject> workItem) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> workItem)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> workItem)>()(
      ptr.ref.lpVtbl, workItem);

  int CreateInkPresenter(Pointer<GUID> riid, Pointer<Pointer> ppv) => ptr
      .ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> riid,
                      Pointer<Pointer> ppv)>()(
          ptr.ref.lpVtbl, rootVisual, width, height, riid, ppv);
}
