...
class IInkD2DRenderer2 extends IUnknown {
  ...
  int Draw(Pointer<COMObject> pD2D1DeviceContext,
          Pointer<COMObject> pInkStrokeIterable, int highContrastAdjustment) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pD2D1DeviceContext,
                      Pointer<COMObject> pInkStrokeIterable,
                      int highContrastAdjustment)>()(ptr.ref.lpVtbl,
          pD2D1DeviceContext, pInkStrokeIterable, highContrastAdjustment);
}
