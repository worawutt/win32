...
int GetPointerDevice(int device, Pointer<POINTER_DEVICE_INFO> pointerDevice) =>
    _GetPointerDevice(device, pointerDevice);

late final _GetPointerDevice = _user32.lookupFunction<
    Int32 Function(IntPtr device, Pointer<POINTER_DEVICE_INFO> pointerDevice),
    int Function(int device,
        Pointer<POINTER_DEVICE_INFO> pointerDevice)>('GetPointerDevice');

int GetPointerDeviceCursors(int device, Pointer<Uint32> cursorCount,
        Pointer<POINTER_DEVICE_CURSOR_INFO> deviceCursors) =>
    _GetPointerDeviceCursors(device, cursorCount, deviceCursors);

late final _GetPointerDeviceCursors = _user32.lookupFunction<
        Int32 Function(IntPtr device, Pointer<Uint32> cursorCount,
            Pointer<POINTER_DEVICE_CURSOR_INFO> deviceCursors),
        int Function(int device, Pointer<Uint32> cursorCount,
            Pointer<POINTER_DEVICE_CURSOR_INFO> deviceCursors)>(
    'GetPointerDeviceCursors');

int GetPointerDeviceProperties(int device, Pointer<Uint32> propertyCount,
        Pointer<POINTER_DEVICE_PROPERTY> pointerProperties) =>
    _GetPointerDeviceProperties(device, propertyCount, pointerProperties);

late final _GetPointerDeviceProperties = _user32.lookupFunction<
        Int32 Function(IntPtr device, Pointer<Uint32> propertyCount,
            Pointer<POINTER_DEVICE_PROPERTY> pointerProperties),
        int Function(int device, Pointer<Uint32> propertyCount,
            Pointer<POINTER_DEVICE_PROPERTY> pointerProperties)>(
    'GetPointerDeviceProperties');

int GetPointerDeviceRects(int device, Pointer<RECT> pointerDeviceRect,
        Pointer<RECT> displayRect) =>
    _GetPointerDeviceRects(device, pointerDeviceRect, displayRect);

late final _GetPointerDeviceRects = _user32.lookupFunction<
    Int32 Function(IntPtr device, Pointer<RECT> pointerDeviceRect,
        Pointer<RECT> displayRect),
    int Function(int device, Pointer<RECT> pointerDeviceRect,
        Pointer<RECT> displayRect)>('GetPointerDeviceRects');

int GetPointerDevices(Pointer<Uint32> deviceCount,
        Pointer<POINTER_DEVICE_INFO> pointerDevices) =>
    _GetPointerDevices(deviceCount, pointerDevices);

late final _GetPointerDevices = _user32.lookupFunction<
    Int32 Function(Pointer<Uint32> deviceCount,
        Pointer<POINTER_DEVICE_INFO> pointerDevices),
    int Function(Pointer<Uint32> deviceCount,
        Pointer<POINTER_DEVICE_INFO> pointerDevices)>('GetPointerDevices');
...
late final _GetRawPointerDeviceData = _user32.lookupFunction<
    ...
    int Function(
        ...
        int propertiesCount,
        Pointer<POINTER_DEVICE_PROPERTY> pProperties,
        Pointer<Int32> pValues)>('GetRawPointerDeviceData');
...
int InitializeTouchInjection(int maxCount, int dwMode) =>
    _InitializeTouchInjection(maxCount, dwMode);

late final _InitializeTouchInjection = _user32.lookupFunction<
    Int32 Function(Uint32 maxCount, Uint32 dwMode),
    int Function(int maxCount, int dwMode)>('InitializeTouchInjection');

int InjectSyntheticPointerInput(
        int device, Pointer<POINTER_TYPE_INFO> pointerInfo, int count) =>
    _InjectSyntheticPointerInput(device, pointerInfo, count);

late final _InjectSyntheticPointerInput = _user32.lookupFunction<
    Int32 Function(
        IntPtr device, Pointer<POINTER_TYPE_INFO> pointerInfo, Uint32 count),
    int Function(int device, Pointer<POINTER_TYPE_INFO> pointerInfo,
        int count)>('InjectSyntheticPointerInput');

int InjectTouchInput(int count, Pointer<POINTER_TOUCH_INFO> contacts) =>
    _InjectTouchInput(count, contacts);

late final _InjectTouchInput = _user32.lookupFunction<
    Int32 Function(Uint32 count, Pointer<POINTER_TOUCH_INFO> contacts),
    int Function(
        int count, Pointer<POINTER_TOUCH_INFO> contacts)>('InjectTouchInput');
