...
int GetCIMSSM(Pointer<INPUT_MESSAGE_SOURCE> inputMessageSource) =>
    _GetCIMSSM(inputMessageSource);

late final _GetCIMSSM = _user32.lookupFunction<
    Int32 Function(Pointer<INPUT_MESSAGE_SOURCE> inputMessageSource),
    int Function(
        Pointer<INPUT_MESSAGE_SOURCE> inputMessageSource)>('GetCIMSSM');

int GetCurrentInputMessageSource(
        Pointer<INPUT_MESSAGE_SOURCE> inputMessageSource) =>
    _GetCurrentInputMessageSource(inputMessageSource);

late final _GetCurrentInputMessageSource = _user32.lookupFunction<
        Int32 Function(Pointer<INPUT_MESSAGE_SOURCE> inputMessageSource),
        int Function(Pointer<INPUT_MESSAGE_SOURCE> inputMessageSource)>(
