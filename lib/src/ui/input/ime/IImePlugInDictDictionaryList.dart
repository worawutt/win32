      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<SAFEARRAY>> prgDateCreated,
                      Pointer<Pointer<SAFEARRAY>> prgfEncrypted)>()(
          ptr.ref.lpVtbl, prgDictionaryGUID, prgDateCreated, prgfEncrypted);

  int DeleteDictionary(Pointer<Utf16> bstrDictionaryGUID) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Utf16> bstrDictionaryGUID)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrDictionaryGUID)>()(
          ptr.ref.lpVtbl, bstrDictionaryGUID);
}
