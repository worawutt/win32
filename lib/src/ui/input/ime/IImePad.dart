...
class IImePad extends IUnknown {
  ...
  int
      Request(Pointer<COMObject> pIImePadApplet, int reqId, int wParam,
              int lParam) =>
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<COMObject> pIImePadApplet,
                          int reqId, int wParam, int lParam)>()(
              ptr.ref.lpVtbl, pIImePadApplet, reqId, wParam, lParam);
}
