...
class IActiveIME2 extends IActiveIME {
  ...
  int Unsleep(int fDead) => ptr.ref.lpVtbl.value
      .elementAt(21)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 fDead)>>>()
      .value
      .asFunction<int Function(Pointer, int fDead)>()(ptr.ref.lpVtbl, fDead);
}
