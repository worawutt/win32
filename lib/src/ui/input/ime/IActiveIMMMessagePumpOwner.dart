...
class IActiveIMMMessagePumpOwner extends IUnknown {
  ...
  int OnTranslateMessage(Pointer<MSG> pMsg) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
  ...
  int Pause(Pointer<Uint32> pdwCookie) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int Resume(int dwCookie) => ptr.ref.lpVtbl.value
      .elementAt(7)
