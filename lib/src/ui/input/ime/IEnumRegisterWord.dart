...
/// @nodoc
const IID_IEnumRegisterWord = '{4955DD31-B159-11D0-8FCF-00AA006BCC59}';

/// {@category Interface}
/// {@category com}
class IEnumRegisterWord extends IUnknown {
  // vtable begins at 3, is 4 entries long.
  IEnumRegisterWord(Pointer<COMObject> ptr) : super(ptr);
  ...
  int Next(int ulCount, Pointer<REGISTERWORD> rgRegisterWord,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<REGISTERWORD> rgRegisterWord,
                      Pointer<Uint32> pcFetched)>()(
          ptr.ref.lpVtbl, ulCount, rgRegisterWord, pcFetched);
