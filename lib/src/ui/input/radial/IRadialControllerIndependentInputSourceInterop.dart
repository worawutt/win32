...
class IRadialControllerIndependentInputSourceInterop extends IInspectable {
  ...
  int CreateForWindow(int hwnd, Pointer<GUID> riid, Pointer<Pointer> ppv) =>
      ptr.ref.lpVtbl.value
          ...
          .value
          .asFunction<
              int Function(Pointer, int hwnd, Pointer<GUID> riid,
                  Pointer<Pointer> ppv)>()(ptr.ref.lpVtbl, hwnd, riid, ppv);
}
