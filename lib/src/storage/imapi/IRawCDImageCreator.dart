...
class IRawCDImageCreator extends IDispatch {
  ...
  int AddTrack(
          int dataType, Pointer<COMObject> data, Pointer<Int32> trackIndex) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, int dataType, Pointer<COMObject> data,
                      Pointer<Int32> trackIndex)>()(
          ptr.ref.lpVtbl, dataType, data, trackIndex);

  int AddSpecialPregap(Pointer<COMObject> data) => ptr.ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> data)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> data)>()(
      ptr.ref.lpVtbl, data);

  int AddSubcodeRWGenerator(Pointer<COMObject> subcode) => ptr.ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> subcode)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> subcode)>()(
      ptr.ref.lpVtbl, subcode);
  ...
  int get_TrackInfo(int trackIndex, Pointer<Pointer<COMObject>> value) =>
      ptr.ref.lpVtbl.value
              .elementAt(22)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 trackIndex,
                              Pointer<Pointer<COMObject>> value)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int trackIndex,
                      Pointer<Pointer<COMObject>> value)>()(
          ptr.ref.lpVtbl, trackIndex, value);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<SAFEARRAY>> value)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<SAFEARRAY>> value)>()(
          ptr.ref.lpVtbl, retValuePtr);
