...
class IEnumDiscRecorders extends IUnknown {
  ...
  int Next(int cRecorders, Pointer<Pointer<COMObject>> ppRecorder,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppRecorder,
                      Pointer<Uint32> pcFetched)>()(
          ptr.ref.lpVtbl, cRecorders, ppRecorder, pcFetched);

  int Skip(int cRecorders) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<NativeFunction<Int32 Function(Pointer, Uint32 cRecorders)>>>()
      .value
      .asFunction<
          int Function(Pointer, int cRecorders)>()(ptr.ref.lpVtbl, cRecorders);
