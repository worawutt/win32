...
class IProgressItems extends IDispatch {
  ...
  int get_Item(int Index, Pointer<Pointer<COMObject>> item) => ptr
      .ref.lpVtbl.value
      .elementAt(8)
      .cast<
          Pointer<
  ...
  int ProgressItemFromBlock(int block, Pointer<Pointer<COMObject>> item) => ptr
      .ref.lpVtbl.value
      .elementAt(10)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Uint32 block,
                      Pointer<Pointer<COMObject>> item)>>>()
      .value
      .asFunction<
          int Function(Pointer, int block,
              Pointer<Pointer<COMObject>> item)>()(ptr.ref.lpVtbl, block, item);

  int ProgressItemFromDescription(
          Pointer<Utf16> description, Pointer<Pointer<COMObject>> item) =>
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> description,
                      Pointer<Pointer<COMObject>> item)>()(
          ptr.ref.lpVtbl, description, item);
