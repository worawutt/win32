...
class IEnumDiscMasterFormats extends IUnknown {
  ...
  int Next(int cFormats, Pointer<GUID> lpiidFormatID,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> lpiidFormatID,
                      Pointer<Uint32> pcFetched)>()(
          ptr.ref.lpVtbl, cFormats, lpiidFormatID, pcFetched);

  int Skip(int cFormats) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Uint32 cFormats)>>>()
      .value
      .asFunction<
          int Function(Pointer, int cFormats)>()(ptr.ref.lpVtbl, cFormats);
