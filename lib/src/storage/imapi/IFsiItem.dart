...
class IFsiItem extends IDispatch {
  ...
  set CreationTime(double value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(10)
        .cast<Pointer<NativeFunction<Int32 Function(Pointer, Double newVal)>>>()
        .value
        .asFunction<
            int Function(Pointer, double newVal)>()(ptr.ref.lpVtbl, value);
  ...
  int FileSystemName(int fileSystem, Pointer<Pointer<Utf16>> pVal) =>
      ptr.ref.lpVtbl.value
              .elementAt(17)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 fileSystem,
                              Pointer<Pointer<Utf16>> pVal)>>>()
              .value
              .asFunction<
                  int Function(
                      Pointer, int fileSystem, Pointer<Pointer<Utf16>> pVal)>()(
          ptr.ref.lpVtbl, fileSystem, pVal);

  int FileSystemPath(int fileSystem, Pointer<Pointer<Utf16>> pVal) =>
      ptr.ref.lpVtbl.value
              .elementAt(18)
              .cast<
                  Pointer<
