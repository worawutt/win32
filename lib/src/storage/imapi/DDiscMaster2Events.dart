...
class DDiscMaster2Events extends IDispatch {
  ...
  int NotifyDeviceAdded(Pointer<COMObject> object, Pointer<Utf16> uniqueId) =>
      ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(Pointer, Pointer<COMObject> object,
                  Pointer<Utf16> uniqueId)>()(ptr.ref.lpVtbl, object, uniqueId);

  int NotifyDeviceRemoved(Pointer<COMObject> object, Pointer<Utf16> uniqueId) =>
      ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
