...
class IDiscFormat2RawCD extends IDiscFormat2 {
  ...
  int WriteMedia(Pointer<COMObject> data) => ptr.ref.lpVtbl.value
          .elementAt(13)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int WriteMedia2(Pointer<COMObject> data, int streamLeadInSectors) => ptr
          .ref.lpVtbl.value
          .elementAt(14)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<COMObject> data, int streamLeadInSectors)>()(
      ptr.ref.lpVtbl, data, streamLeadInSectors);
  ...
  int
      SetWriteSpeed(int RequestedSectorsPerSecond, int RotationTypeIsPureCAV) =>
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, int RequestedSectorsPerSecond,
                          int RotationTypeIsPureCAV)>()(
              ptr.ref.lpVtbl, RequestedSectorsPerSecond, RotationTypeIsPureCAV);
  ...
  Pointer<SAFEARRAY> get SupportedWriteSpeeds {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<SAFEARRAY>> supportedSpeeds)>()(
          ptr.ref.lpVtbl, retValuePtr);
