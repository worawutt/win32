...
void CloseIMsgSession(Pointer<MSGSESS> lpMsgSess) =>
    _CloseIMsgSession(lpMsgSess);

late final _CloseIMsgSession = _mapi32.lookupFunction<
    Void Function(Pointer<MSGSESS> lpMsgSess),
    void Function(Pointer<MSGSESS> lpMsgSess)>('CloseIMsgSession');

int GetAttribIMsgOnIStg(Pointer lpObject, Pointer<SPropTagArray> lpPropTagArray,
        Pointer<Pointer<SPropAttrArray>> lppPropAttrArray) =>
    _GetAttribIMsgOnIStg(lpObject, lpPropTagArray, lppPropAttrArray);

late final _GetAttribIMsgOnIStg = _mapi32.lookupFunction<
        Int32 Function(Pointer lpObject, Pointer<SPropTagArray> lpPropTagArray,
            Pointer<Pointer<SPropAttrArray>> lppPropAttrArray),
        int Function(Pointer lpObject, Pointer<SPropTagArray> lpPropTagArray,
            Pointer<Pointer<SPropAttrArray>> lppPropAttrArray)>(
    'GetAttribIMsgOnIStg');

int MapStorageSCode(int StgSCode) => _MapStorageSCode(StgSCode);

late final _MapStorageSCode = _mapi32.lookupFunction<
    Int32 Function(Int32 StgSCode),
    int Function(int StgSCode)>('MapStorageSCode');
...
late final _OpenIMsgOnIStg = _mapi32.lookupFunction<
    ...
    int Function(
        ...
        int ulCallerData,
        int ulFlags,
        Pointer<Pointer<COMObject>> lppMsg)>('OpenIMsgOnIStg');

int OpenIMsgSession(Pointer<COMObject> lpMalloc, int ulFlags,
        Pointer<Pointer<MSGSESS>> lppMsgSess) =>
    _OpenIMsgSession(lpMalloc, ulFlags, lppMsgSess);

late final _OpenIMsgSession = _mapi32.lookupFunction<
    Int32 Function(Pointer<COMObject> lpMalloc, Uint32 ulFlags,
        Pointer<Pointer<MSGSESS>> lppMsgSess),
    int Function(Pointer<COMObject> lpMalloc, int ulFlags,
        Pointer<Pointer<MSGSESS>> lppMsgSess)>('OpenIMsgSession');
...
int SetAttribIMsgOnIStg(
    ...
    _SetAttribIMsgOnIStg(lpObject, lpPropTags, lpPropAttrs, lppPropProblems);
