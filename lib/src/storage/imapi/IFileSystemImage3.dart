...
class IFileSystemImage3 extends IFileSystemImage2 {
  ...
  int ProbeSpecificFileSystem(
          int fileSystemToProbe, Pointer<Int16> isAppendable) =>
      ptr
              .ref.lpVtbl.value
              .elementAt(61)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 fileSystemToProbe,
                              Pointer<Int16> isAppendable)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int fileSystemToProbe,
                      Pointer<Int16> isAppendable)>()(
          ptr.ref.lpVtbl, fileSystemToProbe, isAppendable);
}
