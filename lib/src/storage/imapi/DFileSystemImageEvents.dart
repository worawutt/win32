...
class DFileSystemImageEvents extends IDispatch {
  ...
  int Update(Pointer<COMObject> object, Pointer<Utf16> currentFile,
          int copiedSectors, int totalSectors) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int copiedSectors,
                      int totalSectors)>()(
          ptr.ref.lpVtbl, object, currentFile, copiedSectors, totalSectors);
}
