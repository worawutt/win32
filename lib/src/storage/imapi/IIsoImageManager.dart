...
class IIsoImageManager extends IDispatch {
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<COMObject>> data)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<COMObject>> data)>()(
  ...
  int SetPath(Pointer<Utf16> Val) => ptr.ref.lpVtbl.value
      .elementAt(9)
      .cast<
          Pointer<
  ...
  int SetStream(Pointer<COMObject> data) => ptr.ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
                  NativeFunction<
