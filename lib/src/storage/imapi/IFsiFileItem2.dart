...
class IFsiFileItem2 extends IFsiFileItem {
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<COMObject>> streams)>>>()
              .value
              .asFunction<
  ...
  int AddStream(Pointer<Utf16> name, Pointer<COMObject> streamData) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> name,
                      Pointer<COMObject> streamData)>()(
          ptr.ref.lpVtbl, name, streamData);

  int RemoveStream(Pointer<Utf16> name) => ptr.ref.lpVtbl.value
      .elementAt(27)
      .cast<
          Pointer<
