...
class IFsiDirectoryItem extends IFsiItem {
  ...
  int get_Item(Pointer<Utf16> path, Pointer<Pointer<COMObject>> item) => ptr
      .ref.lpVtbl.value
      .elementAt(20)
      .cast<
          Pointer<
      ...
      .asFunction<
          int Function(Pointer, Pointer<Utf16> path,
              Pointer<Pointer<COMObject>> item)>()(ptr.ref.lpVtbl, path, item);
  ...
  int AddDirectory(Pointer<Utf16> path) => ptr.ref.lpVtbl.value
      .elementAt(23)
      .cast<
          Pointer<
  ...
  int AddFile(Pointer<Utf16> path, Pointer<COMObject> fileData) => ptr
      .ref.lpVtbl.value
      .elementAt(24)
      .cast<
          Pointer<
      ...
      .asFunction<
          int Function(Pointer, Pointer<Utf16> path,
              Pointer<COMObject> fileData)>()(ptr.ref.lpVtbl, path, fileData);

  int AddTree(Pointer<Utf16> sourceDirectory, int includeBaseDirectory) => ptr
          .ref.lpVtbl.value
          .elementAt(25)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> sourceDirectory,
                          Int16 includeBaseDirectory)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Utf16> sourceDirectory,
                  int includeBaseDirectory)>()(
      ptr.ref.lpVtbl, sourceDirectory, includeBaseDirectory);
  ...
  int Remove(Pointer<Utf16> path) => ptr.ref.lpVtbl.value
      .elementAt(27)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Utf16> path)>>>()
  ...
  int RemoveTree(Pointer<Utf16> path) => ptr.ref.lpVtbl.value
      .elementAt(28)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Utf16> path)>>>()
