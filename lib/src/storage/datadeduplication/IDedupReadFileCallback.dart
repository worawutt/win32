...
class IDedupReadFileCallback extends IUnknown {
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint8> FileBuffer,
                      Pointer<Uint32> ReturnedSize,
                      int Flags)>()(ptr.ref.lpVtbl, FileFullPath, FileOffset,
          SizeToRead, FileBuffer, ReturnedSize, Flags);
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              ...
                              Pointer<Pointer<Utf16>> ContainerPaths,
                              Pointer<Uint32> ReadPlanEntries,
                              Pointer<Pointer<DEDUP_CONTAINER_EXTENT>>
                                  ReadPlan)>>>()
              .value
              .asFunction<
                  int Function(
  ...
  int PreviewContainerRead(Pointer<Utf16> FileFullPath, int NumberOfReads,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int NumberOfReads,
                      Pointer<DDP_FILE_EXTENT> ReadOffsets)>()(
          ptr.ref.lpVtbl, FileFullPath, NumberOfReads, ReadOffsets);
}
