...
class IDedupDataPort extends IUnknown {
  ...
  int GetStatus(Pointer<Int32> pStatus, Pointer<Uint32> pDataHeadroomMb) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Int32> pStatus,
                      Pointer<Uint32> pDataHeadroomMb)>()(
          ptr.ref.lpVtbl, pStatus, pDataHeadroomMb);

  int LookupChunks(
          int Count, Pointer<DedupHash> pHashes, Pointer<GUID> pRequestId) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, int Count, Pointer<DedupHash> pHashes,
                      Pointer<GUID> pRequestId)>()(
          ptr.ref.lpVtbl, Count, pHashes, pRequestId);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int DataByteCount,
                      Pointer<Uint8> pChunkData,
                      Pointer<GUID> pRequestId)>()(ptr.ref.lpVtbl, ChunkCount,
          pChunkMetadata, DataByteCount, pChunkData, pRequestId);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pChunkDataStream,
                      Pointer<GUID> pRequestId)>()(ptr.ref.lpVtbl, ChunkCount,
          pChunkMetadata, DataByteCount, pChunkDataStream, pRequestId);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int EntryCount,
                      Pointer<DedupStreamEntry> pEntries,
                      Pointer<GUID> pRequestId)>()(ptr.ref.lpVtbl, StreamCount,
          pStreams, EntryCount, pEntries, pRequestId);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pEntriesStream,
                      Pointer<GUID> pRequestId)>()(ptr.ref.lpVtbl, StreamCount,
          pStreams, EntryCount, pEntriesStream, pRequestId);

  int GetStreams(int StreamCount, Pointer<Pointer<Utf16>> pStreamPaths,
          Pointer<GUID> pRequestId) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<Utf16>> pStreamPaths,
                      Pointer<GUID> pRequestId)>()(
          ptr.ref.lpVtbl, StreamCount, pStreamPaths, pRequestId);
  ...
  int GetRequestStatus(GUID RequestId, Pointer<Int32> pStatus) => ptr
          .ref.lpVtbl.value
          .elementAt(13)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, GUID RequestId, Pointer<Int32> pStatus)>>>()
          .value
          .asFunction<
              int Function(Pointer, GUID RequestId, Pointer<Int32> pStatus)>()(
      ptr.ref.lpVtbl, RequestId, pStatus);
