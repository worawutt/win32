...
class IDedupDataPortManager extends IUnknown {
  ...
  int GetVolumeStatus(
          int Options, Pointer<Utf16> Path, Pointer<Int32> pStatus) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint32 Options,
                              Pointer<Utf16> Path, Pointer<Int32> pStatus)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int Options, Pointer<Utf16> Path,
                      Pointer<Int32> pStatus)>()(
          ptr.ref.lpVtbl, Options, Path, pStatus);

  int GetVolumeDataPort(int Options, Pointer<Utf16> Path,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int Options, Pointer<Utf16> Path,
                      Pointer<Pointer<COMObject>> ppDataPort)>()(
          ptr.ref.lpVtbl, Options, Path, ppDataPort);
}
