...
class IDedupIterateChunksHash32 extends IUnknown {
  ...
  int PushBuffer(Pointer<Uint8> pBuffer, int ulBufferLength) => ptr
      .ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
      ...
      .value
      .asFunction<
          int Function(Pointer, Pointer<Uint8> pBuffer,
              int ulBufferLength)>()(ptr.ref.lpVtbl, pBuffer, ulBufferLength);

  int Next(int ulMaxChunks, Pointer<DEDUP_CHUNK_INFO_HASH32> pArrChunks,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<DEDUP_CHUNK_INFO_HASH32> pArrChunks,
                      Pointer<Uint32> pulFetched)>()(
          ptr.ref.lpVtbl, ulMaxChunks, pArrChunks, pulFetched);
