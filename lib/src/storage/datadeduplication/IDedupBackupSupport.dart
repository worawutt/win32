...
class IDedupBackupSupport extends IUnknown {
  ...
  int RestoreFiles(int NumberOfFiles, Pointer<Pointer<Utf16>> FileFullPaths,
          Pointer<COMObject> Store, int Flags, Pointer<Int32> FileResults) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> Store,
                      int Flags,
                      Pointer<Int32> FileResults)>()(ptr.ref.lpVtbl,
          NumberOfFiles, FileFullPaths, Store, Flags, FileResults);
}
