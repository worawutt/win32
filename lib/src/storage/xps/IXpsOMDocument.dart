...
class IXpsOMDocument extends IXpsOMPart {
  ...
  int GetOwner(Pointer<Pointer<COMObject>> documentSequence) => ptr
          .ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
  ...
  int GetPageReferences(Pointer<Pointer<COMObject>> pageReferences) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> pageReferences)>()(
          ptr.ref.lpVtbl, pageReferences);
  ...
  int GetDocumentStructureResource(
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer,
                      Pointer<Pointer<COMObject>> documentStructureResource)>()(
          ptr.ref.lpVtbl, documentStructureResource);
  ...
  int GetSignatureBlockResources(
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer,
                      Pointer<Pointer<COMObject>> signatureBlockResources)>()(
          ptr.ref.lpVtbl, signatureBlockResources);

  int Clone(Pointer<Pointer<COMObject>> document) => ptr.ref.lpVtbl.value
          .elementAt(12)
          .cast<
              Pointer<
                  NativeFunction<
