...
class IXpsOMGeometryFigureCollection extends IUnknown {
  ...
  int GetAt(int index, Pointer<Pointer<COMObject>> geometryFigure) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int index,
                      Pointer<Pointer<COMObject>> geometryFigure)>()(
          ptr.ref.lpVtbl, index, geometryFigure);

  int InsertAt(int index, Pointer<COMObject> geometryFigure) => ptr
          .ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, int index, Pointer<COMObject> geometryFigure)>()(
      ptr.ref.lpVtbl, index, geometryFigure);
  ...
  int SetAt(int index, Pointer<COMObject> geometryFigure) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
  ...
  int Append(Pointer<COMObject> geometryFigure) => ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> geometryFigure)>()(
