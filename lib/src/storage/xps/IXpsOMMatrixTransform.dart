...
class IXpsOMMatrixTransform extends IXpsOMShareable {
  ...
  int GetMatrix(Pointer<XPS_MATRIX> matrix) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .value
          .asFunction<int Function(Pointer, Pointer<XPS_MATRIX> matrix)>()(
      ptr.ref.lpVtbl, matrix);

  int SetMatrix(Pointer<XPS_MATRIX> matrix) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int Clone(Pointer<Pointer<COMObject>> matrixTransform) => ptr.ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
                  NativeFunction<
