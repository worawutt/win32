...
class IXpsOMPartUriCollection extends IUnknown {
  ...
  int GetAt(int index, Pointer<Pointer<COMObject>> partUri) => ptr
          .ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, int index, Pointer<Pointer<COMObject>> partUri)>()(
      ptr.ref.lpVtbl, index, partUri);

  int InsertAt(int index, Pointer<COMObject> partUri) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Uint32 index, Pointer<COMObject> partUri)>>>()
      .value
      .asFunction<
          int Function(Pointer, int index,
              Pointer<COMObject> partUri)>()(ptr.ref.lpVtbl, index, partUri);
  ...
  int SetAt(int index, Pointer<COMObject> partUri) => ptr.ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<
              NativeFunction<
  ...
  int Append(Pointer<COMObject> partUri) => ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> partUri)>()(
      ptr.ref.lpVtbl, partUri);
}
