...
class IXpsSignatureManager extends IUnknown {
  ...
  int LoadPackageFile(Pointer<Utf16> fileName) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int LoadPackageStream(Pointer<COMObject> stream) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> stream)>()(
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<CERT_CONTEXT> x509Certificate,
                      Pointer<Pointer<COMObject>> signature)>()(
          ptr.ref.lpVtbl, signOptions, x509Certificate, signature);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer,
                      Pointer<Pointer<COMObject>> signatureOriginPartName)>()(
          ptr.ref.lpVtbl, signatureOriginPartName);

  int SetSignatureOriginPartName(Pointer<COMObject> signatureOriginPartName) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
  ...
  int GetSignatures(Pointer<Pointer<COMObject>> signatures) => ptr
          .ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> signatures)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> signatures)>()(
      ptr.ref.lpVtbl, signatures);

  int AddSignatureBlock(Pointer<COMObject> partName, int fixedDocumentIndex,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> signatureBlock)>()(
          ptr.ref.lpVtbl, partName, fixedDocumentIndex, signatureBlock);

  int GetSignatureBlocks(Pointer<Pointer<COMObject>> signatureBlocks) =>
      ptr.ref.lpVtbl.value
              .elementAt(10)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> signatureBlocks)>()(
          ptr.ref.lpVtbl, signatureBlocks);

  int CreateSigningOptions(Pointer<Pointer<COMObject>> signingOptions) =>
      ptr.ref.lpVtbl.value
              .elementAt(11)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> signingOptions)>()(
          ptr.ref.lpVtbl, signingOptions);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<SECURITY_ATTRIBUTES> securityAttributes,
                      int flagsAndAttributes)>()(
          ptr.ref.lpVtbl, fileName, securityAttributes, flagsAndAttributes);

  int SavePackageToStream(Pointer<COMObject> stream) => ptr.ref.lpVtbl.value
          .elementAt(13)
          .cast<
              Pointer<
                  NativeFunction<
