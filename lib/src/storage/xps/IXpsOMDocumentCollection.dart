...
class IXpsOMDocumentCollection extends IUnknown {
  ...
  int GetAt(int index, Pointer<Pointer<COMObject>> document) => ptr
          .ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, int index, Pointer<Pointer<COMObject>> document)>()(
      ptr.ref.lpVtbl, index, document);

  int InsertAt(int index, Pointer<COMObject> document) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Uint32 index, Pointer<COMObject> document)>>>()
      .value
      .asFunction<
          int Function(Pointer, int index,
              Pointer<COMObject> document)>()(ptr.ref.lpVtbl, index, document);
  ...
  int SetAt(int index, Pointer<COMObject> document) => ptr.ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<
              NativeFunction<
  ...
  int Append(Pointer<COMObject> document) => ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> document)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> document)>()(
