...
class IXpsDocumentPackageTarget extends IUnknown {
  ...
  int GetXpsOMFactory(Pointer<Pointer<COMObject>> xpsFactory) => ptr
          .ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> xpsFactory)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> xpsFactory)>()(
      ptr.ref.lpVtbl, xpsFactory);

  int GetXpsType(Pointer<Int32> documentType) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
