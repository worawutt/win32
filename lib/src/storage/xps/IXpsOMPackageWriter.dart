...
class IXpsOMPackageWriter extends IUnknown {
  ...
  int AddResource(Pointer<COMObject> resource) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> resource)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> resource)>()(
      ptr.ref.lpVtbl, resource);
  ...
  int IsClosed(Pointer<Int32> isClosed) => ptr.ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
                  NativeFunction<
