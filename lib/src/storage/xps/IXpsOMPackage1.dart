...
class IXpsOMPackage1 extends IXpsOMPackage {
  ...
  int GetDocumentType(Pointer<Int32> documentType) => ptr.ref.lpVtbl.value
          .elementAt(13)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> documentType)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Int32> documentType)>()(
      ptr.ref.lpVtbl, documentType);
  ...
  int
      WriteToStream1(Pointer<COMObject> outputStream, int optimizeMarkupSize,
              int documentType) =>
          ptr.ref.lpVtbl.value
                  .elementAt(15)
                  .cast<
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<COMObject> outputStream,
                          int optimizeMarkupSize, int documentType)>()(
              ptr.ref.lpVtbl, outputStream, optimizeMarkupSize, documentType);
}
