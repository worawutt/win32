...
class IXpsOMPackageWriter3D extends IXpsOMPackageWriter {
  ...
  int AddModelTexture(
          Pointer<COMObject> texturePartName, Pointer<COMObject> textureData) =>
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> texturePartName,
                      Pointer<COMObject> textureData)>()(
          ptr.ref.lpVtbl, texturePartName, textureData);

  int SetModelPrintTicket(Pointer<COMObject> printTicketPartName,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> printTicketPartName,
                      Pointer<COMObject> printTicketData)>()(
          ptr.ref.lpVtbl, printTicketPartName, printTicketData);
}
