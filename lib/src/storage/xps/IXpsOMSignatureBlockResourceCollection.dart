...
class IXpsOMSignatureBlockResourceCollection extends IUnknown {
  ...
  int GetAt(int index, Pointer<Pointer<COMObject>> signatureBlockResource) =>
      ptr.ref.lpVtbl.value
          ...
          ptr.ref.lpVtbl, index, signatureBlockResource);

  int InsertAt(int index, Pointer<COMObject> signatureBlockResource) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
  ...
  int SetAt(int index, Pointer<COMObject> signatureBlockResource) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
  ...
  int Append(Pointer<COMObject> signatureBlockResource) => ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<COMObject> signatureBlockResource)>()(
      ptr.ref.lpVtbl, signatureBlockResource);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> partName,
                      Pointer<Pointer<COMObject>> signatureBlockResource)>()(
          ptr.ref.lpVtbl, partName, signatureBlockResource);
}
