...
class IXpsOMColorProfileResourceCollection extends IUnknown {
  ...
  int GetAt(int index, Pointer<Pointer<COMObject>> object) => ptr
          .ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, int index, Pointer<Pointer<COMObject>> object)>()(
      ptr.ref.lpVtbl, index, object);

  int InsertAt(int index, Pointer<COMObject> object) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Uint32 index, Pointer<COMObject> object)>>>()
          .value
          .asFunction<
              int Function(Pointer, int index, Pointer<COMObject> object)>()(
      ptr.ref.lpVtbl, index, object);
  ...
  int SetAt(int index, Pointer<COMObject> object) => ptr.ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int Append(Pointer<COMObject> object) => ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetByPartName(
          Pointer<COMObject> partName, Pointer<Pointer<COMObject>> part) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<COMObject> partName,
                              Pointer<Pointer<COMObject>> part)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> partName,
                      Pointer<Pointer<COMObject>> part)>()(
          ptr.ref.lpVtbl, partName, part);
}
