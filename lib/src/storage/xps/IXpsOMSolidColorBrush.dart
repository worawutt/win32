...
class IXpsOMSolidColorBrush extends IXpsOMBrush {
  ...
  int Clone(Pointer<Pointer<COMObject>> solidColorBrush) => ptr.ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<COMObject>> solidColorBrush)>()(
      ptr.ref.lpVtbl, solidColorBrush);
}
