...
class IXpsOMPartResources extends IUnknown {
  ...
  int GetFontResources(Pointer<Pointer<COMObject>> fontResources) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> fontResources)>()(
          ptr.ref.lpVtbl, fontResources);

  int GetImageResources(Pointer<Pointer<COMObject>> imageResources) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> imageResources)>()(
          ptr.ref.lpVtbl, imageResources);
      ...
      ptr
              ...
              .asFunction<
                  int Function(Pointer,
                      Pointer<Pointer<COMObject>> colorProfileResources)>()(
          ptr.ref.lpVtbl, colorProfileResources);
      ...
      GetRemoteDictionaryResources(
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(Pointer,
                          Pointer<Pointer<COMObject>> dictionaryResources)>()(
              ptr.ref.lpVtbl, dictionaryResources);
}
