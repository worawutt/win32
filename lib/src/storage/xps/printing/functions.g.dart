...
late final _StartXpsPrintJob = _xpsprint.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Pointer<COMObject>> xpsPrintJob,
        Pointer<Pointer<COMObject>> documentStream,
        Pointer<Pointer<COMObject>> printTicketStream)>('StartXpsPrintJob');
...
int StartXpsPrintJob1(
    ...
    _StartXpsPrintJob1(printerName, jobName, outputFileName, progressEvent,
        completionEvent, xpsPrintJob, printContentReceiver);
...
late final _StartXpsPrintJob1 = _xpsprint.lookupFunction<
    ...
    int Function(
        ...
        int completionEvent,
        Pointer<Pointer<COMObject>> xpsPrintJob,
        Pointer<Pointer<COMObject>> printContentReceiver)>('StartXpsPrintJob1');
