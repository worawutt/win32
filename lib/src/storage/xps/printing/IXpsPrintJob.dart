...
class IXpsPrintJob extends IUnknown {
  ...
  int GetJobStatus(Pointer<XPS_JOB_STATUS> jobStatus) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<XPS_JOB_STATUS> jobStatus)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<XPS_JOB_STATUS> jobStatus)>()(
      ptr.ref.lpVtbl, jobStatus);
}
