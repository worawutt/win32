...
class IPrintDocumentPackageTarget extends IUnknown {
  ...
  int GetPackageTargetTypes(
          Pointer<Uint32> targetCount, Pointer<Pointer<GUID>> targetTypes) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Uint32> targetCount,
                              Pointer<Pointer<GUID>> targetTypes)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> targetCount,
                      Pointer<Pointer<GUID>> targetTypes)>()(
          ptr.ref.lpVtbl, targetCount, targetTypes);

  int
      GetPackageTarget(Pointer<GUID> guidTargetType, Pointer<GUID> riid,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<GUID> guidTargetType,
                          Pointer<GUID> riid, Pointer<Pointer> ppvTarget)>()(
              ptr.ref.lpVtbl, guidTargetType, riid, ppvTarget);
