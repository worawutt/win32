...
class IEnumDiskQuotaUsers extends IUnknown {
  ...
  int Next(int cUsers, Pointer<Pointer<COMObject>> rgUsers,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> rgUsers,
                      Pointer<Uint32> pcUsersFetched)>()(
          ptr.ref.lpVtbl, cUsers, rgUsers, pcUsersFetched);

  int Skip(int cUsers) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Uint32 cUsers)>>>()
      .value
      .asFunction<int Function(Pointer, int cUsers)>()(ptr.ref.lpVtbl, cUsers);
