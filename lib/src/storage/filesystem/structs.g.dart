...
class IORING_HANDLE_REF extends Struct {
  ...
  external _IORING_HANDLE_REF_HandleUnion Handle_;
}

/// {@category Struct}
class _IORING_HANDLE_REF_HandleUnion extends Union {
  @IntPtr()
  external int Handle_;
...
extension IORING_HANDLE_REF_Extension on IORING_HANDLE_REF {
  int get Handle_ => this.Handle_.Handle_;
  set Handle_(int value) => this.Handle_.Handle_ = value;

  int get Index => this.Handle_.Index;
  set Index(int value) => this.Handle_.Index = value;
}
