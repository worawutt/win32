...
int AreShortNamesEnabled(int $Handle, Pointer<Int32> Enabled) =>
    _AreShortNamesEnabled($Handle, Enabled);

late final _AreShortNamesEnabled = _kernel32.lookupFunction<
    Int32 Function(IntPtr $Handle, Pointer<Int32> Enabled),
    int Function(int $Handle, Pointer<Int32> Enabled)>('AreShortNamesEnabled');
...
int BackupRead(
    ...
    _BackupRead(hFile, lpBuffer, nNumberOfBytesToRead, lpNumberOfBytesRead,
...
late final _BackupRead = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        int bAbort,
        int bProcessSecurity,
        Pointer<Pointer> lpContext)>('BackupRead');
...
int BackupSeek(
        ...
        Pointer<Pointer> lpContext) =>
    _BackupSeek(hFile, dwLowBytesToSeek, dwHighBytesToSeek, lpdwLowByteSeeked,
...
late final _BackupSeek = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> lpdwLowByteSeeked,
        Pointer<Uint32> lpdwHighByteSeeked,
        Pointer<Pointer> lpContext)>('BackupSeek');
...
int BackupWrite(
        ...
        int bProcessSecurity,
        Pointer<Pointer> lpContext) =>
    _BackupWrite(hFile, lpBuffer, nNumberOfBytesToWrite, lpNumberOfBytesWritten,
        bAbort, bProcessSecurity, lpContext);
...
late final _BackupWrite = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        int bAbort,
        int bProcessSecurity,
        Pointer<Pointer> lpContext)>('BackupWrite');
...
late final _CheckNameLegalDOS8Dot3 = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        int OemNameSize,
        Pointer<Int32> pbNameContainsSpaces,
        Pointer<Int32> pbNameLegal)>('CheckNameLegalDOS8Dot3W');

int CompareFileTime(
        Pointer<FILETIME> lpFileTime1, Pointer<FILETIME> lpFileTime2) =>
    _CompareFileTime(lpFileTime1, lpFileTime2);

late final _CompareFileTime = _kernel32.lookupFunction<
    Int32 Function(
        Pointer<FILETIME> lpFileTime1, Pointer<FILETIME> lpFileTime2),
    int Function(Pointer<FILETIME> lpFileTime1,
        Pointer<FILETIME> lpFileTime2)>('CompareFileTime');

int CopyFile2(
        Pointer<Utf16> pwszExistingFileName,
        Pointer<Utf16> pwszNewFileName,
        Pointer<COPYFILE2_EXTENDED_PARAMETERS> pExtendedParameters) =>
    _CopyFile2(pwszExistingFileName, pwszNewFileName, pExtendedParameters);
...
int CopyFileEx(
        ...
        int dwCopyFlags) =>
    _CopyFileEx(lpExistingFileName, lpNewFileName, lpProgressRoutine, lpData,
...
int CopyFileTransacted(
        ...
        int dwCopyFlags,
        int hTransaction) =>
    _CopyFileTransacted(lpExistingFileName, lpNewFileName, lpProgressRoutine,
        lpData, pbCancel, dwCopyFlags, hTransaction);
...
late final _CopyFileTransacted = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Int32> pbCancel,
        int dwCopyFlags,
        int hTransaction)>('CopyFileTransactedW');

int CopyFile(Pointer<Utf16> lpExistingFileName, Pointer<Utf16> lpNewFileName,
        int bFailIfExists) =>
...
late final _CopyFile = _kernel32.lookupFunction<
    ...
    int Function(Pointer<Utf16> lpExistingFileName,
        Pointer<Utf16> lpNewFileName, int bFailIfExists)>('CopyFileW');

int CopyLZFile(int hfSource, int hfDest) => _CopyLZFile(hfSource, hfDest);

late final _CopyLZFile = _kernel32.lookupFunction<
    Int32 Function(Int32 hfSource, Int32 hfDest),
    int Function(int hfSource, int hfDest)>('CopyLZFile');
...
int CreateDirectoryTransacted(
        ...
        Pointer<SECURITY_ATTRIBUTES> lpSecurityAttributes,
        int hTransaction) =>
    _CreateDirectoryTransacted(lpTemplateDirectory, lpNewDirectory,
        lpSecurityAttributes, hTransaction);
...
late final _CreateDirectoryTransacted = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Utf16> lpNewDirectory,
        Pointer<SECURITY_ATTRIBUTES> lpSecurityAttributes,
        int hTransaction)>('CreateDirectoryTransactedW');
...
late final _CreateFileTransacted = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        int hTransaction,
        Pointer<Uint32> pusMiniVersion,
        Pointer lpExtendedParameter)>('CreateFileTransactedW');
...
late final _CreateHardLinkTransacted = _kernel32.lookupFunction<
    Int32 Function(Pointer<Utf16> lpFileName, Pointer<Utf16> lpExistingFileName,
        Pointer<SECURITY_ATTRIBUTES> lpSecurityAttributes, IntPtr hTransaction),
    int Function(
        Pointer<Utf16> lpFileName,
        Pointer<Utf16> lpExistingFileName,
        Pointer<SECURITY_ATTRIBUTES> lpSecurityAttributes,
        int hTransaction)>('CreateHardLinkTransactedW');

int CreateHardLink(Pointer<Utf16> lpFileName, Pointer<Utf16> lpExistingFileName,
        Pointer<SECURITY_ATTRIBUTES> lpSecurityAttributes) =>
    _CreateHardLink(lpFileName, lpExistingFileName, lpSecurityAttributes);

late final _CreateHardLink = _kernel32.lookupFunction<
    Int32 Function(Pointer<Utf16> lpFileName, Pointer<Utf16> lpExistingFileName,
        Pointer<SECURITY_ATTRIBUTES> lpSecurityAttributes),
    int Function(Pointer<Utf16> lpFileName, Pointer<Utf16> lpExistingFileName,
        Pointer<SECURITY_ATTRIBUTES> lpSecurityAttributes)>('CreateHardLinkW');

int CreateSymbolicLinkTransacted(Pointer<Utf16> lpSymlinkFileName,
        Pointer<Utf16> lpTargetFileName, int dwFlags, int hTransaction) =>
...
late final _CreateSymbolicLinkTransacted = _kernel32.lookupFunction<
    Uint8 Function(Pointer<Utf16> lpSymlinkFileName,
        Pointer<Utf16> lpTargetFileName, Uint32 dwFlags, IntPtr hTransaction),
    int Function(
        Pointer<Utf16> lpSymlinkFileName,
        Pointer<Utf16> lpTargetFileName,
        int dwFlags,
        int hTransaction)>('CreateSymbolicLinkTransactedW');

int CreateSymbolicLink(Pointer<Utf16> lpSymlinkFileName,
        Pointer<Utf16> lpTargetFileName, int dwFlags) =>
    _CreateSymbolicLink(lpSymlinkFileName, lpTargetFileName, dwFlags);

late final _CreateSymbolicLink = _kernel32.lookupFunction<
    Uint8 Function(Pointer<Utf16> lpSymlinkFileName,
        Pointer<Utf16> lpTargetFileName, Uint32 dwFlags),
    int Function(Pointer<Utf16> lpSymlinkFileName,
        Pointer<Utf16> lpTargetFileName, int dwFlags)>('CreateSymbolicLinkW');

int CreateTapePartition(
        int hDevice, int dwPartitionMethod, int dwCount, int dwSize) =>
    _CreateTapePartition(hDevice, dwPartitionMethod, dwCount, dwSize);

late final _CreateTapePartition = _kernel32.lookupFunction<
    Uint32 Function(
        IntPtr hDevice, Int32 dwPartitionMethod, Uint32 dwCount, Uint32 dwSize),
    int Function(int hDevice, int dwPartitionMethod, int dwCount,
        int dwSize)>('CreateTapePartition');
...
int DeleteFileTransacted(Pointer<Utf16> lpFileName, int hTransaction) =>
    _DeleteFileTransacted(lpFileName, hTransaction);

late final _DeleteFileTransacted = _kernel32.lookupFunction<
    Int32 Function(Pointer<Utf16> lpFileName, IntPtr hTransaction),
    int Function(
        Pointer<Utf16> lpFileName, int hTransaction)>('DeleteFileTransactedW');
...
int EraseTape(int hDevice, int dwEraseType, int bImmediate) =>
    _EraseTape(hDevice, dwEraseType, bImmediate);

late final _EraseTape = _kernel32.lookupFunction<
    Uint32 Function(IntPtr hDevice, Int32 dwEraseType, Int32 bImmediate),
    int Function(int hDevice, int dwEraseType, int bImmediate)>('EraseTape');

int FileTimeToLocalFileTime(
        Pointer<FILETIME> lpFileTime, Pointer<FILETIME> lpLocalFileTime) =>
    _FileTimeToLocalFileTime(lpFileTime, lpLocalFileTime);

late final _FileTimeToLocalFileTime = _kernel32.lookupFunction<
    Int32 Function(
        Pointer<FILETIME> lpFileTime, Pointer<FILETIME> lpLocalFileTime),
    int Function(Pointer<FILETIME> lpFileTime,
        Pointer<FILETIME> lpLocalFileTime)>('FileTimeToLocalFileTime');
...
late final _FindFirstFileNameTransacted = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> StringLength,
        Pointer<Utf16> LinkName,
        int hTransaction)>('FindFirstFileNameTransactedW');
...
int FindFirstFileTransacted(
        ...
        int dwAdditionalFlags,
        int hTransaction) =>
    _FindFirstFileTransacted(lpFileName, fInfoLevelId, lpFindFileData,
        fSearchOp, lpSearchFilter, dwAdditionalFlags, hTransaction);
...
late final _FindFirstFileTransacted = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        Pointer lpSearchFilter,
        int dwAdditionalFlags,
        int hTransaction)>('FindFirstFileTransactedW');
...
int FindFirstStreamTransacted(Pointer<Utf16> lpFileName, int InfoLevel,
        Pointer lpFindStreamData, int dwFlags, int hTransaction) =>
...
late final _FindFirstStreamTransacted = _kernel32.lookupFunction<
    IntPtr Function(Pointer<Utf16> lpFileName, Int32 InfoLevel,
        Pointer lpFindStreamData, Uint32 dwFlags, IntPtr hTransaction),
    int Function(
        Pointer<Utf16> lpFileName,
        int InfoLevel,
        Pointer lpFindStreamData,
        int dwFlags,
        int hTransaction)>('FindFirstStreamTransactedW');
...
int FindFirstVolumeMountPoint(Pointer<Utf16> lpszRootPathName,
        Pointer<Utf16> lpszVolumeMountPoint, int cchBufferLength) =>
...
late final _FindFirstVolumeMountPoint = _kernel32.lookupFunction<
    IntPtr Function(Pointer<Utf16> lpszRootPathName,
        Pointer<Utf16> lpszVolumeMountPoint, Uint32 cchBufferLength),
    int Function(
        Pointer<Utf16> lpszRootPathName,
        Pointer<Utf16> lpszVolumeMountPoint,
        int cchBufferLength)>('FindFirstVolumeMountPointW');
...
int FindNextVolumeMountPoint(int hFindVolumeMountPoint,
        Pointer<Utf16> lpszVolumeMountPoint, int cchBufferLength) =>
...
late final _FindNextVolumeMountPoint = _kernel32.lookupFunction<
    Int32 Function(IntPtr hFindVolumeMountPoint,
        Pointer<Utf16> lpszVolumeMountPoint, Uint32 cchBufferLength),
    int Function(int hFindVolumeMountPoint, Pointer<Utf16> lpszVolumeMountPoint,
        int cchBufferLength)>('FindNextVolumeMountPointW');
...
int FindVolumeMountPointClose(int hFindVolumeMountPoint) =>
    _FindVolumeMountPointClose(hFindVolumeMountPoint);

late final _FindVolumeMountPointClose = _kernel32.lookupFunction<
    Int32 Function(IntPtr hFindVolumeMountPoint),
    int Function(int hFindVolumeMountPoint)>('FindVolumeMountPointClose');

int FlushFileBuffers(int hFile) => _FlushFileBuffers(hFile);

late final _FlushFileBuffers = _kernel32.lookupFunction<
    Int32 Function(IntPtr hFile), int Function(int hFile)>('FlushFileBuffers');
...
int GetCompressedFileSizeTransacted(Pointer<Utf16> lpFileName,
        Pointer<Uint32> lpFileSizeHigh, int hTransaction) =>
    _GetCompressedFileSizeTransacted(lpFileName, lpFileSizeHigh, hTransaction);
...
late final _GetCompressedFileSizeTransacted = _kernel32.lookupFunction<
    ...
    int Function(Pointer<Utf16> lpFileName, Pointer<Uint32> lpFileSizeHigh,
        int hTransaction)>('GetCompressedFileSizeTransactedW');
...
int GetDiskSpaceInformation(Pointer<Utf16> rootPath,
        Pointer<DISK_SPACE_INFORMATION> diskSpaceInfo) =>
    _GetDiskSpaceInformation(rootPath, diskSpaceInfo);

late final _GetDiskSpaceInformation = _kernel32.lookupFunction<
    Int32 Function(
        Pointer<Utf16> rootPath, Pointer<DISK_SPACE_INFORMATION> diskSpaceInfo),
    int Function(
        Pointer<Utf16> rootPath,
        Pointer<DISK_SPACE_INFORMATION>
            diskSpaceInfo)>('GetDiskSpaceInformationW');
...
int GetExpandedName(Pointer<Utf16> lpszSource, Pointer<Utf16> lpszBuffer) =>
    _GetExpandedName(lpszSource, lpszBuffer);

late final _GetExpandedName = _kernel32.lookupFunction<
    Int32 Function(Pointer<Utf16> lpszSource, Pointer<Utf16> lpszBuffer),
    int Function(Pointer<Utf16> lpszSource,
        Pointer<Utf16> lpszBuffer)>('GetExpandedNameW');
...
int GetFileAttributesTransacted(Pointer<Utf16> lpFileName, int fInfoLevelId,
        Pointer lpFileInformation, int hTransaction) =>
...
late final _GetFileAttributesTransacted = _kernel32.lookupFunction<
    Int32 Function(Pointer<Utf16> lpFileName, Int32 fInfoLevelId,
        Pointer lpFileInformation, IntPtr hTransaction),
    int Function(
        Pointer<Utf16> lpFileName,
        int fInfoLevelId,
        Pointer lpFileInformation,
        int hTransaction)>('GetFileAttributesTransactedW');
...
int GetFileBandwidthReservation(
    ...
    _GetFileBandwidthReservation(hFile, lpPeriodMilliseconds, lpBytesPerPeriod,
...
int GetFileInformationByHandleEx(int hFile, int FileInformationClass,
...
late final _GetFileInformationByHandleEx = _kernel32.lookupFunction<
    ...
    int Function(int hFile, int FileInformationClass, Pointer lpFileInformation,
        int dwBufferSize)>('GetFileInformationByHandleEx');
...
int GetFileTime(
    ...
    _GetFileTime(hFile, lpCreationTime, lpLastAccessTime, lpLastWriteTime);

late final _GetFileTime = _kernel32.lookupFunction<
    Int32 Function(IntPtr hFile, Pointer<FILETIME> lpCreationTime,
        Pointer<FILETIME> lpLastAccessTime, Pointer<FILETIME> lpLastWriteTime),
    int Function(
        int hFile,
        Pointer<FILETIME> lpCreationTime,
        Pointer<FILETIME> lpLastAccessTime,
        Pointer<FILETIME> lpLastWriteTime)>('GetFileTime');
...
late final _GetFullPathNameTransacted = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Utf16> lpBuffer,
        Pointer<Pointer<Utf16>> lpFilePart,
        int hTransaction)>('GetFullPathNameTransactedW');
...
int GetLongPathNameTransacted(Pointer<Utf16> lpszShortPath,
        Pointer<Utf16> lpszLongPath, int cchBuffer, int hTransaction) =>
...
late final _GetLongPathNameTransacted = _kernel32.lookupFunction<
    Uint32 Function(Pointer<Utf16> lpszShortPath, Pointer<Utf16> lpszLongPath,
        Uint32 cchBuffer, IntPtr hTransaction),
    int Function(Pointer<Utf16> lpszShortPath, Pointer<Utf16> lpszLongPath,
        int cchBuffer, int hTransaction)>('GetLongPathNameTransactedW');
...
int GetTapeParameters(int hDevice, int dwOperation, Pointer<Uint32> lpdwSize,
        Pointer lpTapeInformation) =>
    _GetTapeParameters(hDevice, dwOperation, lpdwSize, lpTapeInformation);

late final _GetTapeParameters = _kernel32.lookupFunction<
    Uint32 Function(IntPtr hDevice, Uint32 dwOperation,
        Pointer<Uint32> lpdwSize, Pointer lpTapeInformation),
    int Function(int hDevice, int dwOperation, Pointer<Uint32> lpdwSize,
        Pointer lpTapeInformation)>('GetTapeParameters');
...
late final _GetTapePosition = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> lpdwPartition,
        Pointer<Uint32> lpdwOffsetLow,
        Pointer<Uint32> lpdwOffsetHigh)>('GetTapePosition');

int GetTapeStatus(int hDevice) => _GetTapeStatus(hDevice);

late final _GetTapeStatus = _kernel32.lookupFunction<
    Uint32 Function(IntPtr hDevice),
    int Function(int hDevice)>('GetTapeStatus');
...
void LZClose(int hFile) => _LZClose(hFile);

late final _LZClose = _kernel32.lookupFunction<Void Function(Int32 hFile),
    void Function(int hFile)>('LZClose');

int LZCopy(int hfSource, int hfDest) => _LZCopy(hfSource, hfDest);

late final _LZCopy = _kernel32.lookupFunction<
    Int32 Function(Int32 hfSource, Int32 hfDest),
    int Function(int hfSource, int hfDest)>('LZCopy');
...
int LZInit(int hfSource) => _LZInit(hfSource);

late final _LZInit = _kernel32.lookupFunction<Int32 Function(Int32 hfSource),
    int Function(int hfSource)>('LZInit');

int LZOpenFile(
        Pointer<Utf16> lpFileName, Pointer<OFSTRUCT> lpReOpenBuf, int wStyle) =>
    _LZOpenFile(lpFileName, lpReOpenBuf, wStyle);

late final _LZOpenFile = _kernel32.lookupFunction<
    Int32 Function(Pointer<Utf16> lpFileName, Pointer<OFSTRUCT> lpReOpenBuf,
        Uint32 wStyle),
    int Function(Pointer<Utf16> lpFileName, Pointer<OFSTRUCT> lpReOpenBuf,
        int wStyle)>('LZOpenFileW');

int LZRead(int hFile, Pointer<Utf8> lpBuffer, int cbRead) =>
    _LZRead(hFile, lpBuffer, cbRead);

late final _LZRead = _kernel32.lookupFunction<
    Int32 Function(Int32 hFile, Pointer<Utf8> lpBuffer, Int32 cbRead),
    int Function(int hFile, Pointer<Utf8> lpBuffer, int cbRead)>('LZRead');

int LZSeek(int hFile, int lOffset, int iOrigin) =>
    _LZSeek(hFile, lOffset, iOrigin);

late final _LZSeek = _kernel32.lookupFunction<
    Int32 Function(Int32 hFile, Int32 lOffset, Int32 iOrigin),
    int Function(int hFile, int lOffset, int iOrigin)>('LZSeek');
...
int LocalFileTimeToFileTime(
        Pointer<FILETIME> lpLocalFileTime, Pointer<FILETIME> lpFileTime) =>
    _LocalFileTimeToFileTime(lpLocalFileTime, lpFileTime);

late final _LocalFileTimeToFileTime = _kernel32.lookupFunction<
    Int32 Function(
        Pointer<FILETIME> lpLocalFileTime, Pointer<FILETIME> lpFileTime),
    int Function(Pointer<FILETIME> lpLocalFileTime,
        Pointer<FILETIME> lpFileTime)>('LocalFileTimeToFileTime');
...
int MoveFileEx(Pointer<Utf16> lpExistingFileName, Pointer<Utf16> lpNewFileName,
        int dwFlags) =>
    _MoveFileEx(lpExistingFileName, lpNewFileName, dwFlags);

late final _MoveFileEx = _kernel32.lookupFunction<
    Int32 Function(Pointer<Utf16> lpExistingFileName,
        Pointer<Utf16> lpNewFileName, Uint32 dwFlags),
    int Function(Pointer<Utf16> lpExistingFileName,
        Pointer<Utf16> lpNewFileName, int dwFlags)>('MoveFileExW');
...
int MoveFileTransacted(
        ...
        int dwFlags,
        int hTransaction) =>
    _MoveFileTransacted(lpExistingFileName, lpNewFileName, lpProgressRoutine,
...
late final _MoveFileTransacted = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        Pointer lpData,
        int dwFlags,
        int hTransaction)>('MoveFileTransactedW');
...
late final _MoveFileWithProgress = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<NativeFunction<LPPROGRESS_ROUTINE>> lpProgressRoutine,
        Pointer lpData,
        int dwFlags)>('MoveFileWithProgressW');

int OpenFile(
        Pointer<Utf8> lpFileName, Pointer<OFSTRUCT> lpReOpenBuff, int uStyle) =>
    _OpenFile(lpFileName, lpReOpenBuff, uStyle);

late final _OpenFile = _kernel32.lookupFunction<
    Int32 Function(Pointer<Utf8> lpFileName, Pointer<OFSTRUCT> lpReOpenBuff,
        Uint32 uStyle),
    int Function(Pointer<Utf8> lpFileName, Pointer<OFSTRUCT> lpReOpenBuff,
        int uStyle)>('OpenFile');
...
int OpenFileById(
        ...
        Pointer<SECURITY_ATTRIBUTES> lpSecurityAttributes,
        int dwFlagsAndAttributes) =>
    _OpenFileById(hVolumeHint, lpFileId, dwDesiredAccess, dwShareMode,
        lpSecurityAttributes, dwFlagsAndAttributes);
...
late final _OpenFileById = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        int dwShareMode,
        Pointer<SECURITY_ATTRIBUTES> lpSecurityAttributes,
        int dwFlagsAndAttributes)>('OpenFileById');

int PrepareTape(int hDevice, int dwOperation, int bImmediate) =>
    _PrepareTape(hDevice, dwOperation, bImmediate);

late final _PrepareTape = _kernel32.lookupFunction<
    Uint32 Function(IntPtr hDevice, Int32 dwOperation, Int32 bImmediate),
    int Function(int hDevice, int dwOperation, int bImmediate)>('PrepareTape');
...
late final _ReadDirectoryChangesEx = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<NativeFunction<LPOVERLAPPED_COMPLETION_ROUTINE>>
            lpCompletionRoutine,
        int ReadDirectoryNotifyInformationClass)>('ReadDirectoryChangesExW');
...
int ReadDirectoryChanges(
        ...
        Pointer<NativeFunction<LPOVERLAPPED_COMPLETION_ROUTINE>>
            lpCompletionRoutine) =>
    _ReadDirectoryChanges(hDirectory, lpBuffer, nBufferLength, bWatchSubtree,
...
late final _ReadDirectoryChanges = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<OVERLAPPED> lpOverlapped,
        Pointer<NativeFunction<LPOVERLAPPED_COMPLETION_ROUTINE>>
            lpCompletionRoutine)>('ReadDirectoryChangesW');
...
int RemoveDirectoryTransacted(Pointer<Utf16> lpPathName, int hTransaction) =>
    _RemoveDirectoryTransacted(lpPathName, hTransaction);

late final _RemoveDirectoryTransacted = _kernel32.lookupFunction<
    Int32 Function(Pointer<Utf16> lpPathName, IntPtr hTransaction),
    int Function(Pointer<Utf16> lpPathName,
        int hTransaction)>('RemoveDirectoryTransactedW');
...
int ReplaceFile(
        ...
        Pointer lpExclude,
        Pointer lpReserved) =>
    _ReplaceFile(lpReplacedFileName, lpReplacementFileName, lpBackupFileName,
...
late final _ReplaceFile = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        int dwReplaceFlags,
        Pointer lpExclude,
        Pointer lpReserved)>('ReplaceFileW');
...
late final _SearchPath = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        int nBufferLength,
        Pointer<Utf16> lpBuffer,
        Pointer<Pointer<Utf16>> lpFilePart)>('SearchPathW');

int SetEndOfFile(int hFile) => _SetEndOfFile(hFile);

late final _SetEndOfFile = _kernel32.lookupFunction<
    Int32 Function(IntPtr hFile), int Function(int hFile)>('SetEndOfFile');
...
int SetFileAttributesTransacted(
        Pointer<Utf16> lpFileName, int dwFileAttributes, int hTransaction) =>
    _SetFileAttributesTransacted(lpFileName, dwFileAttributes, hTransaction);
...
late final _SetFileAttributesTransacted = _kernel32.lookupFunction<
    ...
    int Function(Pointer<Utf16> lpFileName, int dwFileAttributes,
        int hTransaction)>('SetFileAttributesTransactedW');
...
int SetFileBandwidthReservation(
        ...
        Pointer<Uint32> lpTransferSize,
        Pointer<Uint32> lpNumOutstandingRequests) =>
    _SetFileBandwidthReservation(hFile, nPeriodMilliseconds, nBytesPerPeriod,
...
int SetFileCompletionNotificationModes(int FileHandle, int Flags) =>
    _SetFileCompletionNotificationModes(FileHandle, Flags);

late final _SetFileCompletionNotificationModes = _kernel32.lookupFunction<
    Int32 Function(IntPtr FileHandle, Uint8 Flags),
    int Function(
        int FileHandle, int Flags)>('SetFileCompletionNotificationModes');
...
late final _SetFileTime = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<FILETIME> lpCreationTime,
        Pointer<FILETIME> lpLastAccessTime,
        Pointer<FILETIME> lpLastWriteTime)>('SetFileTime');
...
int SetSearchPathMode(int Flags) => _SetSearchPathMode(Flags);

late final _SetSearchPathMode = _kernel32.lookupFunction<
    Int32 Function(Uint32 Flags), int Function(int Flags)>('SetSearchPathMode');

int SetTapeParameters(
        int hDevice, int dwOperation, Pointer lpTapeInformation) =>
    _SetTapeParameters(hDevice, dwOperation, lpTapeInformation);

late final _SetTapeParameters = _kernel32.lookupFunction<
    Uint32 Function(
        IntPtr hDevice, Uint32 dwOperation, Pointer lpTapeInformation),
    int Function(int hDevice, int dwOperation,
        Pointer lpTapeInformation)>('SetTapeParameters');

int SetTapePosition(int hDevice, int dwPositionMethod, int dwPartition,
        int dwOffsetLow, int dwOffsetHigh, int bImmediate) =>
    _SetTapePosition(hDevice, dwPositionMethod, dwPartition, dwOffsetLow,
        dwOffsetHigh, bImmediate);

late final _SetTapePosition = _kernel32.lookupFunction<
    Uint32 Function(IntPtr hDevice, Int32 dwPositionMethod, Uint32 dwPartition,
        Uint32 dwOffsetLow, Uint32 dwOffsetHigh, Int32 bImmediate),
    int Function(int hDevice, int dwPositionMethod, int dwPartition,
        int dwOffsetLow, int dwOffsetHigh, int bImmediate)>('SetTapePosition');
...
int SetVolumeMountPoint(
        Pointer<Utf16> lpszVolumeMountPoint, Pointer<Utf16> lpszVolumeName) =>
...
late final _SetVolumeMountPoint = _kernel32.lookupFunction<
    ...
    int Function(Pointer<Utf16> lpszVolumeMountPoint,
        Pointer<Utf16> lpszVolumeName)>('SetVolumeMountPointW');
...
int Wow64DisableWow64FsRedirection(Pointer<Pointer> OldValue) =>
    _Wow64DisableWow64FsRedirection(OldValue);

late final _Wow64DisableWow64FsRedirection = _kernel32.lookupFunction<
    Int32 Function(Pointer<Pointer> OldValue),
    int Function(Pointer<Pointer> OldValue)>('Wow64DisableWow64FsRedirection');

int Wow64EnableWow64FsRedirection(int Wow64FsEnableRedirection) =>
    _Wow64EnableWow64FsRedirection(Wow64FsEnableRedirection);

late final _Wow64EnableWow64FsRedirection = _kernel32.lookupFunction<
    Uint8 Function(Uint8 Wow64FsEnableRedirection),
    int Function(
        int Wow64FsEnableRedirection)>('Wow64EnableWow64FsRedirection');

int Wow64RevertWow64FsRedirection(Pointer OlValue) =>
    _Wow64RevertWow64FsRedirection(OlValue);

late final _Wow64RevertWow64FsRedirection = _kernel32.lookupFunction<
    Int32 Function(Pointer OlValue),
    int Function(Pointer OlValue)>('Wow64RevertWow64FsRedirection');
...
int WriteTapemark(
        int hDevice, int dwTapemarkType, int dwTapemarkCount, int bImmediate) =>
    _WriteTapemark(hDevice, dwTapemarkType, dwTapemarkCount, bImmediate);

late final _WriteTapemark = _kernel32.lookupFunction<
    Uint32 Function(IntPtr hDevice, Int32 dwTapemarkType,
        Uint32 dwTapemarkCount, Int32 bImmediate),
    int Function(int hDevice, int dwTapemarkType, int dwTapemarkCount,
        int bImmediate)>('WriteTapemark');
...
int AddUsersToEncryptedFile(Pointer<Utf16> lpFileName,
        Pointer<ENCRYPTION_CERTIFICATE_LIST> pEncryptionCertificates) =>
    _AddUsersToEncryptedFile(lpFileName, pEncryptionCertificates);
...
void CloseEncryptedFileRaw(Pointer pvContext) =>
    _CloseEncryptedFileRaw(pvContext);

late final _CloseEncryptedFileRaw = _advapi32.lookupFunction<
    Void Function(Pointer pvContext),
    void Function(Pointer pvContext)>('CloseEncryptedFileRaw');
...
int DuplicateEncryptionInfoFile(
        ...
        int dwAttributes,
        Pointer<SECURITY_ATTRIBUTES> lpSecurityAttributes) =>
    _DuplicateEncryptionInfoFile(SrcFileName, DstFileName,
        dwCreationDistribution, dwAttributes, lpSecurityAttributes);
...
int EncryptionDisable(Pointer<Utf16> DirPath, int Disable) =>
    _EncryptionDisable(DirPath, Disable);

late final _EncryptionDisable = _advapi32.lookupFunction<
    Int32 Function(Pointer<Utf16> DirPath, Int32 Disable),
    int Function(Pointer<Utf16> DirPath, int Disable)>('EncryptionDisable');
...
void FreeEncryptedFileMetadata(Pointer<Uint8> pbMetadata) =>
    _FreeEncryptedFileMetadata(pbMetadata);

late final _FreeEncryptedFileMetadata = _advapi32.lookupFunction<
    Void Function(Pointer<Uint8> pbMetadata),
    void Function(Pointer<Uint8> pbMetadata)>('FreeEncryptedFileMetadata');

void FreeEncryptionCertificateHashList(
        Pointer<ENCRYPTION_CERTIFICATE_HASH_LIST> pUsers) =>
    _FreeEncryptionCertificateHashList(pUsers);

late final _FreeEncryptionCertificateHashList = _advapi32.lookupFunction<
        Void Function(Pointer<ENCRYPTION_CERTIFICATE_HASH_LIST> pUsers),
        void Function(Pointer<ENCRYPTION_CERTIFICATE_HASH_LIST> pUsers)>(
    'FreeEncryptionCertificateHashList');

int GetEncryptedFileMetadata(Pointer<Utf16> lpFileName,
        Pointer<Uint32> pcbMetadata, Pointer<Pointer<Uint8>> ppbMetadata) =>
    _GetEncryptedFileMetadata(lpFileName, pcbMetadata, ppbMetadata);

late final _GetEncryptedFileMetadata = _advapi32.lookupFunction<
    Uint32 Function(Pointer<Utf16> lpFileName, Pointer<Uint32> pcbMetadata,
        Pointer<Pointer<Uint8>> ppbMetadata),
    int Function(Pointer<Utf16> lpFileName, Pointer<Uint32> pcbMetadata,
        Pointer<Pointer<Uint8>> ppbMetadata)>('GetEncryptedFileMetadata');

int OpenEncryptedFileRaw(
        Pointer<Utf16> lpFileName, int ulFlags, Pointer<Pointer> pvContext) =>
    _OpenEncryptedFileRaw(lpFileName, ulFlags, pvContext);

late final _OpenEncryptedFileRaw = _advapi32.lookupFunction<
    Uint32 Function(
        Pointer<Utf16> lpFileName, Uint32 ulFlags, Pointer<Pointer> pvContext),
    int Function(Pointer<Utf16> lpFileName, int ulFlags,
        Pointer<Pointer> pvContext)>('OpenEncryptedFileRawW');

int QueryRecoveryAgentsOnEncryptedFile(Pointer<Utf16> lpFileName,
        Pointer<Pointer<ENCRYPTION_CERTIFICATE_HASH_LIST>> pRecoveryAgents) =>
    _QueryRecoveryAgentsOnEncryptedFile(lpFileName, pRecoveryAgents);
...
late final _QueryRecoveryAgentsOnEncryptedFile = _advapi32.lookupFunction<
    ...
    int Function(
        Pointer<Utf16> lpFileName,
        Pointer<Pointer<ENCRYPTION_CERTIFICATE_HASH_LIST>>
            pRecoveryAgents)>('QueryRecoveryAgentsOnEncryptedFile');

int QueryUsersOnEncryptedFile(Pointer<Utf16> lpFileName,
        Pointer<Pointer<ENCRYPTION_CERTIFICATE_HASH_LIST>> pUsers) =>
    _QueryUsersOnEncryptedFile(lpFileName, pUsers);
...
int ReadEncryptedFileRaw(
        ...
        Pointer pvContext) =>
    _ReadEncryptedFileRaw(pfExportCallback, pvCallbackContext, pvContext);

late final _ReadEncryptedFileRaw = _advapi32.lookupFunction<
    Uint32 Function(Pointer<NativeFunction<PFE_EXPORT_FUNC>> pfExportCallback,
        Pointer pvCallbackContext, Pointer pvContext),
    int Function(Pointer<NativeFunction<PFE_EXPORT_FUNC>> pfExportCallback,
        Pointer pvCallbackContext, Pointer pvContext)>('ReadEncryptedFileRaw');

int RemoveUsersFromEncryptedFile(Pointer<Utf16> lpFileName,
        Pointer<ENCRYPTION_CERTIFICATE_HASH_LIST> pHashes) =>
    _RemoveUsersFromEncryptedFile(lpFileName, pHashes);
...
int SetEncryptedFileMetadata(
    ...
    _SetEncryptedFileMetadata(lpFileName, pbOldMetadata, pbNewMetadata,
        pOwnerHash, dwOperation, pCertificatesAdded);
...
int SetUserFileEncryptionKey(
    ...
    _SetUserFileEncryptionKey(pEncryptionCertificate);

late final _SetUserFileEncryptionKey = _advapi32.lookupFunction<
        Uint32 Function(Pointer<ENCRYPTION_CERTIFICATE> pEncryptionCertificate),
        int Function(Pointer<ENCRYPTION_CERTIFICATE> pEncryptionCertificate)>(
...
late final _SetUserFileEncryptionKeyEx = _advapi32.lookupFunction<
    Uint32 Function(Pointer<ENCRYPTION_CERTIFICATE> pEncryptionCertificate,
        Uint32 dwCapabilities, Uint32 dwFlags, Pointer pvReserved),
    int Function(
        Pointer<ENCRYPTION_CERTIFICATE> pEncryptionCertificate,
        int dwCapabilities,
        int dwFlags,
        Pointer pvReserved)>('SetUserFileEncryptionKeyEx');

int WriteEncryptedFileRaw(
        Pointer<NativeFunction<PFE_IMPORT_FUNC>> pfImportCallback,
        Pointer pvCallbackContext,
        Pointer pvContext) =>
    _WriteEncryptedFileRaw(pfImportCallback, pvCallbackContext, pvContext);

late final _WriteEncryptedFileRaw = _advapi32.lookupFunction<
    Uint32 Function(Pointer<NativeFunction<PFE_IMPORT_FUNC>> pfImportCallback,
        Pointer pvCallbackContext, Pointer pvContext),
    int Function(Pointer<NativeFunction<PFE_IMPORT_FUNC>> pfImportCallback,
        Pointer pvCallbackContext, Pointer pvContext)>('WriteEncryptedFileRaw');
...
int WofEnumEntries(Pointer<Utf16> VolumeName, int Provider,
        Pointer<NativeFunction<WofEnumEntryProc>> EnumProc, Pointer UserData) =>
    _WofEnumEntries(VolumeName, Provider, EnumProc, UserData);

late final _WofEnumEntries = _wofutil.lookupFunction<
    Int32 Function(Pointer<Utf16> VolumeName, Uint32 Provider,
        Pointer<NativeFunction<WofEnumEntryProc>> EnumProc, Pointer UserData),
    int Function(
        Pointer<Utf16> VolumeName,
        int Provider,
        Pointer<NativeFunction<WofEnumEntryProc>> EnumProc,
        Pointer UserData)>('WofEnumEntries');

int WofFileEnumFiles(Pointer<Utf16> VolumeName, int Algorithm,
        Pointer<NativeFunction<WofEnumFilesProc>> EnumProc, Pointer UserData) =>
    _WofFileEnumFiles(VolumeName, Algorithm, EnumProc, UserData);

late final _WofFileEnumFiles = _wofutil.lookupFunction<
    Int32 Function(Pointer<Utf16> VolumeName, Uint32 Algorithm,
        Pointer<NativeFunction<WofEnumFilesProc>> EnumProc, Pointer UserData),
    int Function(
        Pointer<Utf16> VolumeName,
        int Algorithm,
        Pointer<NativeFunction<WofEnumFilesProc>> EnumProc,
        Pointer UserData)>('WofFileEnumFiles');

int WofGetDriverVersion(
        int FileOrVolumeHandle, int Provider, Pointer<Uint32> WofVersion) =>
    _WofGetDriverVersion(FileOrVolumeHandle, Provider, WofVersion);

late final _WofGetDriverVersion = _wofutil.lookupFunction<
    Int32 Function(
        IntPtr FileOrVolumeHandle, Uint32 Provider, Pointer<Uint32> WofVersion),
    int Function(int FileOrVolumeHandle, int Provider,
        Pointer<Uint32> WofVersion)>('WofGetDriverVersion');
...
late final _WofIsExternalFile = _wofutil.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> Provider,
        Pointer ExternalFileInfo,
        Pointer<Uint32> BufferLength)>('WofIsExternalFile');

int WofSetFileDataLocation(
        int FileHandle, int Provider, Pointer ExternalFileInfo, int Length) =>
    _WofSetFileDataLocation(FileHandle, Provider, ExternalFileInfo, Length);

late final _WofSetFileDataLocation = _wofutil.lookupFunction<
    Int32 Function(IntPtr FileHandle, Uint32 Provider, Pointer ExternalFileInfo,
        Uint32 Length),
    int Function(int FileHandle, int Provider, Pointer ExternalFileInfo,
        int Length)>('WofSetFileDataLocation');

int WofShouldCompressBinaries(
        Pointer<Utf16> Volume, Pointer<Uint32> Algorithm) =>
    _WofShouldCompressBinaries(Volume, Algorithm);

late final _WofShouldCompressBinaries = _wofutil.lookupFunction<
    Int32 Function(Pointer<Utf16> Volume, Pointer<Uint32> Algorithm),
    int Function(Pointer<Utf16> Volume,
        Pointer<Uint32> Algorithm)>('WofShouldCompressBinaries');

int WofWimAddEntry(Pointer<Utf16> VolumeName, Pointer<Utf16> WimPath,
        int WimType, int WimIndex, Pointer<Int64> DataSourceId) =>
    _WofWimAddEntry(VolumeName, WimPath, WimType, WimIndex, DataSourceId);

late final _WofWimAddEntry = _wofutil.lookupFunction<
    Int32 Function(Pointer<Utf16> VolumeName, Pointer<Utf16> WimPath,
        Uint32 WimType, Uint32 WimIndex, Pointer<Int64> DataSourceId),
    int Function(Pointer<Utf16> VolumeName, Pointer<Utf16> WimPath, int WimType,
        int WimIndex, Pointer<Int64> DataSourceId)>('WofWimAddEntry');

int WofWimEnumFiles(Pointer<Utf16> VolumeName, int DataSourceId,
        Pointer<NativeFunction<WofEnumFilesProc>> EnumProc, Pointer UserData) =>
    _WofWimEnumFiles(VolumeName, DataSourceId, EnumProc, UserData);

late final _WofWimEnumFiles = _wofutil.lookupFunction<
    Int32 Function(Pointer<Utf16> VolumeName, Int64 DataSourceId,
        Pointer<NativeFunction<WofEnumFilesProc>> EnumProc, Pointer UserData),
    int Function(
        Pointer<Utf16> VolumeName,
        int DataSourceId,
        Pointer<NativeFunction<WofEnumFilesProc>> EnumProc,
        Pointer UserData)>('WofWimEnumFiles');

int WofWimRemoveEntry(Pointer<Utf16> VolumeName, int DataSourceId) =>
    _WofWimRemoveEntry(VolumeName, DataSourceId);

late final _WofWimRemoveEntry = _wofutil.lookupFunction<
    Int32 Function(Pointer<Utf16> VolumeName, Int64 DataSourceId),
    int Function(
        Pointer<Utf16> VolumeName, int DataSourceId)>('WofWimRemoveEntry');

int WofWimSuspendEntry(Pointer<Utf16> VolumeName, int DataSourceId) =>
    _WofWimSuspendEntry(VolumeName, DataSourceId);

late final _WofWimSuspendEntry = _wofutil.lookupFunction<
    Int32 Function(Pointer<Utf16> VolumeName, Int64 DataSourceId),
    int Function(
        Pointer<Utf16> VolumeName, int DataSourceId)>('WofWimSuspendEntry');

int WofWimUpdateEntry(Pointer<Utf16> VolumeName, int DataSourceId,
        Pointer<Utf16> NewWimPath) =>
    _WofWimUpdateEntry(VolumeName, DataSourceId, NewWimPath);

late final _WofWimUpdateEntry = _wofutil.lookupFunction<
    Int32 Function(Pointer<Utf16> VolumeName, Int64 DataSourceId,
        Pointer<Utf16> NewWimPath),
    int Function(Pointer<Utf16> VolumeName, int DataSourceId,
        Pointer<Utf16> NewWimPath)>('WofWimUpdateEntry');
...
int NetConnectionEnum(
    ...
    _NetConnectionEnum(servername, qualifier, level, bufptr, prefmaxlen,
...
late final _NetConnectionEnum = _netapi32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> entriesread,
        Pointer<Uint32> totalentries,
        Pointer<Uint32> resume_handle)>('NetConnectionEnum');

int NetFileClose(Pointer<Utf16> servername, int fileid) =>
    _NetFileClose(servername, fileid);

late final _NetFileClose = _netapi32.lookupFunction<
    Uint32 Function(Pointer<Utf16> servername, Uint32 fileid),
    int Function(Pointer<Utf16> servername, int fileid)>('NetFileClose');
...
int NetFileEnum(
    ...
    _NetFileEnum(servername, basepath, username, level, bufptr, prefmaxlen,
        entriesread, totalentries, resume_handle);
...
late final _NetFileEnum = _netapi32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> entriesread,
        Pointer<Uint32> totalentries,
        Pointer<IntPtr> resume_handle)>('NetFileEnum');

int NetFileGetInfo(Pointer<Utf16> servername, int fileid, int level,
        Pointer<Pointer<Uint8>> bufptr) =>
    _NetFileGetInfo(servername, fileid, level, bufptr);

late final _NetFileGetInfo = _netapi32.lookupFunction<
    Uint32 Function(Pointer<Utf16> servername, Uint32 fileid, Uint32 level,
        Pointer<Pointer<Uint8>> bufptr),
    int Function(Pointer<Utf16> servername, int fileid, int level,
        Pointer<Pointer<Uint8>> bufptr)>('NetFileGetInfo');

int NetServerAliasAdd(
        Pointer<Utf16> servername, int level, Pointer<Uint8> buf) =>
    _NetServerAliasAdd(servername, level, buf);

late final _NetServerAliasAdd = _netapi32.lookupFunction<
    Uint32 Function(
        Pointer<Utf16> servername, Uint32 level, Pointer<Uint8> buf),
    int Function(Pointer<Utf16> servername, int level,
        Pointer<Uint8> buf)>('NetServerAliasAdd');

int NetServerAliasDel(
        Pointer<Utf16> servername, int level, Pointer<Uint8> buf) =>
    _NetServerAliasDel(servername, level, buf);

late final _NetServerAliasDel = _netapi32.lookupFunction<
    Uint32 Function(
        Pointer<Utf16> servername, Uint32 level, Pointer<Uint8> buf),
    int Function(Pointer<Utf16> servername, int level,
        Pointer<Uint8> buf)>('NetServerAliasDel');
...
int NetServerAliasEnum(
    ...
    _NetServerAliasEnum(servername, level, bufptr, prefmaxlen, entriesread,
...
late final _NetServerAliasEnum = _netapi32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> entriesread,
        Pointer<Uint32> totalentries,
        Pointer<Uint32> resumehandle)>('NetServerAliasEnum');

int NetSessionDel(Pointer<Utf16> servername, Pointer<Utf16> UncClientName,
        Pointer<Utf16> username) =>
    _NetSessionDel(servername, UncClientName, username);

late final _NetSessionDel = _netapi32.lookupFunction<
    Uint32 Function(Pointer<Utf16> servername, Pointer<Utf16> UncClientName,
        Pointer<Utf16> username),
    int Function(Pointer<Utf16> servername, Pointer<Utf16> UncClientName,
        Pointer<Utf16> username)>('NetSessionDel');
...
int NetSessionEnum(
        ...
        Pointer<Uint32> totalentries,
        Pointer<Uint32> resume_handle) =>
    _NetSessionEnum(servername, UncClientName, username, level, bufptr,
...
late final _NetSessionEnum = _netapi32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> entriesread,
        Pointer<Uint32> totalentries,
        Pointer<Uint32> resume_handle)>('NetSessionEnum');

int NetSessionGetInfo(Pointer<Utf16> servername, Pointer<Utf16> UncClientName,
        Pointer<Utf16> username, int level, Pointer<Pointer<Uint8>> bufptr) =>
    _NetSessionGetInfo(servername, UncClientName, username, level, bufptr);

late final _NetSessionGetInfo = _netapi32.lookupFunction<
    Uint32 Function(Pointer<Utf16> servername, Pointer<Utf16> UncClientName,
        Pointer<Utf16> username, Uint32 level, Pointer<Pointer<Uint8>> bufptr),
    int Function(
        Pointer<Utf16> servername,
        Pointer<Utf16> UncClientName,
        Pointer<Utf16> username,
        int level,
        Pointer<Pointer<Uint8>> bufptr)>('NetSessionGetInfo');

int NetShareAdd(Pointer<Utf16> servername, int level, Pointer<Uint8> buf,
        Pointer<Uint32> parm_err) =>
    _NetShareAdd(servername, level, buf, parm_err);
...
late final _NetShareAdd = _netapi32.lookupFunction<
    ...
    int Function(Pointer<Utf16> servername, int level, Pointer<Uint8> buf,
        Pointer<Uint32> parm_err)>('NetShareAdd');

int NetShareCheck(Pointer<Utf16> servername, Pointer<Utf16> device,
        Pointer<Uint32> type) =>
    _NetShareCheck(servername, device, type);

late final _NetShareCheck = _netapi32.lookupFunction<
    Uint32 Function(
        Pointer<Utf16> servername, Pointer<Utf16> device, Pointer<Uint32> type),
    int Function(Pointer<Utf16> servername, Pointer<Utf16> device,
        Pointer<Uint32> type)>('NetShareCheck');

int NetShareDel(
        Pointer<Utf16> servername, Pointer<Utf16> netname, int reserved) =>
    _NetShareDel(servername, netname, reserved);

late final _NetShareDel = _netapi32.lookupFunction<
    Uint32 Function(
        Pointer<Utf16> servername, Pointer<Utf16> netname, Uint32 reserved),
    int Function(Pointer<Utf16> servername, Pointer<Utf16> netname,
        int reserved)>('NetShareDel');

int NetShareDelEx(Pointer<Utf16> servername, int level, Pointer<Uint8> buf) =>
    _NetShareDelEx(servername, level, buf);

late final _NetShareDelEx = _netapi32.lookupFunction<
    Uint32 Function(
        Pointer<Utf16> servername, Uint32 level, Pointer<Uint8> buf),
    int Function(Pointer<Utf16> servername, int level,
        Pointer<Uint8> buf)>('NetShareDelEx');

int NetShareDelSticky(
        Pointer<Utf16> servername, Pointer<Utf16> netname, int reserved) =>
    _NetShareDelSticky(servername, netname, reserved);

late final _NetShareDelSticky = _netapi32.lookupFunction<
    Uint32 Function(
        Pointer<Utf16> servername, Pointer<Utf16> netname, Uint32 reserved),
    int Function(Pointer<Utf16> servername, Pointer<Utf16> netname,
        int reserved)>('NetShareDelSticky');
...
int NetShareEnum(
        ...
        Pointer<Uint32> totalentries,
        Pointer<Uint32> resume_handle) =>
    _NetShareEnum(servername, level, bufptr, prefmaxlen, entriesread,
...
late final _NetShareEnum = _netapi32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> entriesread,
        Pointer<Uint32> totalentries,
        Pointer<Uint32> resume_handle)>('NetShareEnum');
...
int NetShareEnumSticky(
        ...
        Pointer<Uint32> totalentries,
        Pointer<Uint32> resume_handle) =>
    _NetShareEnumSticky(servername, level, bufptr, prefmaxlen, entriesread,
        totalentries, resume_handle);
...
late final _NetShareEnumSticky = _netapi32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> entriesread,
        Pointer<Uint32> totalentries,
        Pointer<Uint32> resume_handle)>('NetShareEnumSticky');

int NetShareGetInfo(Pointer<Utf16> servername, Pointer<Utf16> netname,
        int level, Pointer<Pointer<Uint8>> bufptr) =>
    _NetShareGetInfo(servername, netname, level, bufptr);

late final _NetShareGetInfo = _netapi32.lookupFunction<
    Uint32 Function(Pointer<Utf16> servername, Pointer<Utf16> netname,
        Uint32 level, Pointer<Pointer<Uint8>> bufptr),
    int Function(Pointer<Utf16> servername, Pointer<Utf16> netname, int level,
        Pointer<Pointer<Uint8>> bufptr)>('NetShareGetInfo');

int NetShareSetInfo(Pointer<Utf16> servername, Pointer<Utf16> netname,
        int level, Pointer<Uint8> buf, Pointer<Uint32> parm_err) =>
    _NetShareSetInfo(servername, netname, level, buf, parm_err);

late final _NetShareSetInfo = _netapi32.lookupFunction<
    Uint32 Function(Pointer<Utf16> servername, Pointer<Utf16> netname,
        Uint32 level, Pointer<Uint8> buf, Pointer<Uint32> parm_err),
    int Function(Pointer<Utf16> servername, Pointer<Utf16> netname, int level,
        Pointer<Uint8> buf, Pointer<Uint32> parm_err)>('NetShareSetInfo');

int NetStatisticsGet(Pointer<Int8> ServerName, Pointer<Int8> Service, int Level,
        int Options, Pointer<Pointer<Uint8>> Buffer) =>
    _NetStatisticsGet(ServerName, Service, Level, Options, Buffer);

late final _NetStatisticsGet = _netapi32.lookupFunction<
    Uint32 Function(Pointer<Int8> ServerName, Pointer<Int8> Service,
        Uint32 Level, Uint32 Options, Pointer<Pointer<Uint8>> Buffer),
    int Function(Pointer<Int8> ServerName, Pointer<Int8> Service, int Level,
        int Options, Pointer<Pointer<Uint8>> Buffer)>('NetStatisticsGet');
