...
class IVssComponentEx2 extends IVssComponentEx {
  ...
  int SetFailure(int hr, int hrApplication,
          Pointer<Utf16> wszApplicationMessage, int dwReserved) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int hr, int hrApplication,
                      Pointer<Utf16> wszApplicationMessage, int dwReserved)>()(
          ptr.ref.lpVtbl, hr, hrApplication, wszApplicationMessage, dwReserved);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Int32> phrApplication,
                      Pointer<Pointer<Utf16>> pbstrApplicationMessage,
                      Pointer<Uint32> pdwReserved)>()(ptr.ref.lpVtbl, phr,
          phrApplication, pbstrApplicationMessage, pdwReserved);
}
