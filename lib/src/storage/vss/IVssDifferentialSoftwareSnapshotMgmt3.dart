...
class IVssDifferentialSoftwareSnapshotMgmt3
  ...
  int
      SetVolumeProtectLevel(
              Pointer<Uint16> pwszVolumeName, int protectionLevel) =>
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(Pointer, Pointer<Uint16> pwszVolumeName,
                          int protectionLevel)>()(
              ptr.ref.lpVtbl, pwszVolumeName, protectionLevel);

  int GetVolumeProtectLevel(Pointer<Uint16> pwszVolumeName,
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer,
                              Pointer<Uint16> pwszVolumeName,
                              Pointer<VSS_VOLUME_PROTECTION_INFO>
                                  protectionLevel)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint16> pwszVolumeName,
  ...
  int ClearVolumeProtectFault(Pointer<Uint16> pwszVolumeName) =>
      ptr.ref.lpVtbl.value
              .elementAt(15)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Uint16> pwszVolumeName)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint16> pwszVolumeName)>()(
          ptr.ref.lpVtbl, pwszVolumeName);

  int DeleteUnusedDiffAreas(Pointer<Uint16> pwszDiffAreaVolumeName) => ptr
          .ref.lpVtbl.value
          .elementAt(16)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Uint16> pwszDiffAreaVolumeName)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Uint16> pwszDiffAreaVolumeName)>()(
      ptr.ref.lpVtbl, pwszDiffAreaVolumeName);
