...
class IVssSnapshotMgmt extends IUnknown {
  ...
  int GetProviderMgmtInterface(GUID ProviderId, Pointer<GUID> InterfaceId,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> InterfaceId,
                      Pointer<Pointer<COMObject>> ppItf)>()(
          ptr.ref.lpVtbl, ProviderId, InterfaceId, ppItf);

  int QueryVolumesSupportedForSnapshots(
          GUID ProviderId, int lContext, Pointer<Pointer<COMObject>> ppEnum) =>
      ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<COMObject>>
                      ppEnum)>()(ptr.ref.lpVtbl, ProviderId, lContext, ppEnum);

  int QuerySnapshotsByVolume(Pointer<Uint16> pwszVolumeName, GUID ProviderId,
          Pointer<Pointer<COMObject>> ppEnum) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Uint16> pwszVolumeName,
                      GUID ProviderId, Pointer<Pointer<COMObject>> ppEnum)>()(
          ptr.ref.lpVtbl, pwszVolumeName, ProviderId, ppEnum);
}
