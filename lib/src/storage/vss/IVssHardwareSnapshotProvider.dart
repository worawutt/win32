...
class IVssHardwareSnapshotProvider extends IUnknown {
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<Uint16>> rgwszDevices,
                      Pointer<VDS_LUN_INFORMATION> pLunInformation,
                      Pointer<Int32> pbIsSupported)>()(ptr.ref.lpVtbl,
          lLunCount, lContext, rgwszDevices, pLunInformation, pbIsSupported);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<VDS_LUN_INFORMATION> pLunInfo,
                      Pointer<Int32> pbIsSupported)>()(
          ptr.ref.lpVtbl, wszDeviceName, pLunInfo, pbIsSupported);
  ...
  int LocateLuns(int lLunCount, Pointer<VDS_LUN_INFORMATION> rgSourceLuns) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 lLunCount,
                              Pointer<VDS_LUN_INFORMATION> rgSourceLuns)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int lLunCount,
                      Pointer<VDS_LUN_INFORMATION> rgSourceLuns)>()(
          ptr.ref.lpVtbl, lLunCount, rgSourceLuns);

  int OnLunEmpty(Pointer<Uint16> wszDeviceName,
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Uint16> wszDeviceName,
                              Pointer<VDS_LUN_INFORMATION> pInformation)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint16> wszDeviceName,
                      Pointer<VDS_LUN_INFORMATION> pInformation)>()(
          ptr.ref.lpVtbl, wszDeviceName, pInformation);
}
