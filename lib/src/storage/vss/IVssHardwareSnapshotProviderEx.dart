...
class IVssHardwareSnapshotProviderEx extends IVssHardwareSnapshotProvider {
  ...
  int GetProviderCapabilities(Pointer<Uint64> pllOriginalCapabilityMask) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Uint64> pllOriginalCapabilityMask)>()(
          ptr.ref.lpVtbl, pllOriginalCapabilityMask);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int dwCount,
                      int dwFlags)>()(
          ptr.ref.lpVtbl, pSnapshotLuns, pOriginalLuns, dwCount, dwFlags);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int dwCount,
                      Pointer<Pointer<COMObject>> ppAsync)>()(
          ptr.ref.lpVtbl, pSourceLuns, pTargetLuns, dwCount, ppAsync);

  int OnReuseLuns(Pointer<VDS_LUN_INFORMATION> pSnapshotLuns,
          Pointer<VDS_LUN_INFORMATION> pOriginalLuns, int dwCount) =>
      ptr.ref.lpVtbl.value
              .elementAt(12)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<VDS_LUN_INFORMATION> pOriginalLuns,
                      int dwCount)>()(
          ptr.ref.lpVtbl, pSnapshotLuns, pOriginalLuns, dwCount);
}
