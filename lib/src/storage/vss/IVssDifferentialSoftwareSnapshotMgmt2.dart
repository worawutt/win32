      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint16> pwszDiffAreaVolumeName,
                      int llMaximumDiffSpace,
                      int bVolatile)>()(ptr.ref.lpVtbl, pwszVolumeName,
          pwszDiffAreaVolumeName, llMaximumDiffSpace, bVolatile);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint16> pwszDiffAreaVolumeName,
                      Pointer<Pointer<COMObject>> ppAsync)>()(
          ptr.ref.lpVtbl, pwszVolumeName, pwszDiffAreaVolumeName, ppAsync);

  int SetSnapshotPriority(GUID idSnapshot, int priority) => ptr.ref.lpVtbl.value
      .elementAt(12)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, GUID idSnapshot, Uint8 priority)>>>()
      .value
      .asFunction<
          int Function(Pointer, GUID idSnapshot,
              int priority)>()(ptr.ref.lpVtbl, idSnapshot, priority);
}
