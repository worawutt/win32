...
class IVssAdmin extends IUnknown {
  ...
  int UnregisterProvider(GUID ProviderId) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, GUID ProviderId)>>>()
      .value
      .asFunction<
          int Function(Pointer, GUID ProviderId)>()(ptr.ref.lpVtbl, ProviderId);

  int QueryProviders(Pointer<Pointer<COMObject>> ppEnum) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
