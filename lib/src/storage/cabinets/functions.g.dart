...
int FCIAddFile(
        ...
        int typeCompress) =>
    _FCIAddFile(hfci, pszSourceFile, pszFileName, fExecute, pfnfcignc, pfnfcis,
...
Pointer FCICreate(
        ...
        Pointer<CCAB> pccab,
        Pointer pv) =>
    _FCICreate(perf, pfnfcifp, pfna, pfnf, pfnopen, pfnread, pfnwrite, pfnclose,
...
late final _FCICreate = _cabinet.lookupFunction<
    ...
    Pointer Function(
        ...
        Pointer<NativeFunction<PFNFCIGETTEMPFILE>> pfnfcigtf,
        Pointer<CCAB> pccab,
        Pointer pv)>('FCICreate');

int FCIDestroy(Pointer hfci) => _FCIDestroy(hfci);

late final _FCIDestroy = _cabinet.lookupFunction<Int32 Function(Pointer hfci),
    int Function(Pointer hfci)>('FCIDestroy');
...
int FCIFlushCabinet(
        ...
        Pointer<NativeFunction<PFNFCIGETNEXTCABINET>> pfnfcignc,
        Pointer<NativeFunction<PFNFCISTATUS>> pfnfcis) =>
    _FCIFlushCabinet(hfci, fGetNextCab, pfnfcignc, pfnfcis);
...
late final _FCIFlushCabinet = _cabinet.lookupFunction<
    ...
    int Function(
        ...
        int fGetNextCab,
        Pointer<NativeFunction<PFNFCIGETNEXTCABINET>> pfnfcignc,
        Pointer<NativeFunction<PFNFCISTATUS>> pfnfcis)>('FCIFlushCabinet');

int FCIFlushFolder(
        Pointer hfci,
        Pointer<NativeFunction<PFNFCIGETNEXTCABINET>> pfnfcignc,
        Pointer<NativeFunction<PFNFCISTATUS>> pfnfcis) =>
    _FCIFlushFolder(hfci, pfnfcignc, pfnfcis);
...
late final _FCIFlushFolder = _cabinet.lookupFunction<
    ...
    int Function(
        Pointer hfci,
        Pointer<NativeFunction<PFNFCIGETNEXTCABINET>> pfnfcignc,
        Pointer<NativeFunction<PFNFCISTATUS>> pfnfcis)>('FCIFlushFolder');
...
int FDICopy(
        ...
        Pointer pvUser) =>
    _FDICopy(hfdi, pszCabinet, pszCabPath, flags, pfnfdin, pfnfdid, pvUser);
...
Pointer FDICreate(
        ...
        int cpuType,
        Pointer<ERF> perf) =>
    _FDICreate(pfnalloc, pfnfree, pfnopen, pfnread, pfnwrite, pfnclose, pfnseek,
        cpuType, perf);
...
late final _FDICreate = _cabinet.lookupFunction<
    ...
    Pointer Function(
        ...
        Pointer<NativeFunction<PFNSEEK>> pfnseek,
        int cpuType,
        Pointer<ERF> perf)>('FDICreate');

int FDIDestroy(Pointer hfdi) => _FDIDestroy(hfdi);

late final _FDIDestroy = _cabinet.lookupFunction<Int32 Function(Pointer hfdi),
    int Function(Pointer hfdi)>('FDIDestroy');

int FDIIsCabinet(Pointer hfdi, int hf, Pointer<FDICABINETINFO> pfdici) =>
    _FDIIsCabinet(hfdi, hf, pfdici);

late final _FDIIsCabinet = _cabinet.lookupFunction<
    Int32 Function(Pointer hfdi, IntPtr hf, Pointer<FDICABINETINFO> pfdici),
    int Function(
        Pointer hfdi, int hf, Pointer<FDICABINETINFO> pfdici)>('FDIIsCabinet');

int FDITruncateCabinet(
        Pointer hfdi, Pointer<Utf8> pszCabinetName, int iFolderToDelete) =>
    _FDITruncateCabinet(hfdi, pszCabinetName, iFolderToDelete);

late final _FDITruncateCabinet = _cabinet.lookupFunction<
    Int32 Function(
        Pointer hfdi, Pointer<Utf8> pszCabinetName, Uint16 iFolderToDelete),
    int Function(Pointer hfdi, Pointer<Utf8> pszCabinetName,
        int iFolderToDelete)>('FDITruncateCabinet');
