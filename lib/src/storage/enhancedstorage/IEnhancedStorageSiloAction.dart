...
class IEnhancedStorageSiloAction extends IUnknown {
  ...
  int GetName(Pointer<Pointer<Utf16>> ppwszActionName) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<Utf16>> ppwszActionName)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<Utf16>> ppwszActionName)>()(
      ptr.ref.lpVtbl, ppwszActionName);

  int GetDescription(Pointer<Pointer<Utf16>> ppwszActionDescription) => ptr
          .ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<Utf16>> ppwszActionDescription)>()(
      ptr.ref.lpVtbl, ppwszActionDescription);
