...
class IEnhancedStorageACT3 extends IEnhancedStorageACT2 {
  ...
  int UnauthorizeEx(int dwFlags) => ptr.ref.lpVtbl.value
      .elementAt(11)
  ...
  int IsQueueFrozen(Pointer<Int32> pIsQueueFrozen) => ptr.ref.lpVtbl.value
      .elementAt(12)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Int32> pIsQueueFrozen)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<Int32> pIsQueueFrozen)>()(ptr.ref.lpVtbl, pIsQueueFrozen);

  int GetShellExtSupport(Pointer<Int32> pShellExtSupport) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Int32> pShellExtSupport)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> pShellExtSupport)>()(
          ptr.ref.lpVtbl, pShellExtSupport);
}
