...
class IEnhancedStorageSilo extends IUnknown {
  ...
  int GetInfo(Pointer<SILO_INFO> pSiloInfo) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<SILO_INFO> pSiloInfo)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<SILO_INFO> pSiloInfo)>()(
      ptr.ref.lpVtbl, pSiloInfo);
  ...
  int GetPortableDevice(Pointer<Pointer<COMObject>> ppIPortableDevice) => ptr
          .ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<COMObject>> ppIPortableDevice)>()(
      ptr.ref.lpVtbl, ppIPortableDevice);

  int GetDevicePath(Pointer<Pointer<Utf16>> ppwszSiloDevicePath) => ptr
          .ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<Utf16>> ppwszSiloDevicePath)>()(
      ptr.ref.lpVtbl, ppwszSiloDevicePath);
}
