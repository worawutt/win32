...
class IEnumEnhancedStorageACT extends IUnknown {
  ...
  int
      GetACTs(Pointer<Pointer<Pointer<COMObject>>> pppIEnhancedStorageACTs,
                  ...
                  .asFunction<
                      int Function(
                          ...
                          Pointer<Pointer<Pointer<COMObject>>>
                              pppIEnhancedStorageACTs,
                          Pointer<Uint32> pcEnhancedStorageACTs)>()(
              ptr.ref.lpVtbl, pppIEnhancedStorageACTs, pcEnhancedStorageACTs);

  int GetMatchingACT(Pointer<Utf16> szVolume,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> szVolume,
                      Pointer<Pointer<COMObject>> ppIEnhancedStorageACT)>()(
          ptr.ref.lpVtbl, szVolume, ppIEnhancedStorageACT);
}
