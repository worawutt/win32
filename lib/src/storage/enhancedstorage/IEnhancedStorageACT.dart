...
class IEnhancedStorageACT extends IUnknown {
  ...
  int Authorize(int hwndParent, int dwFlags) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Uint32 hwndParent, Uint32 dwFlags)>>>()
          .value
  ...
  int GetAuthorizationState(Pointer<ACT_AUTHORIZATION_STATE> pState) => ptr
          .ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<ACT_AUTHORIZATION_STATE> pState)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<ACT_AUTHORIZATION_STATE> pState)>()(
      ptr.ref.lpVtbl, pState);

  int GetMatchingVolume(Pointer<Pointer<Utf16>> ppwszVolume) => ptr
          .ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<Utf16>> ppwszVolume)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<Utf16>> ppwszVolume)>()(
      ptr.ref.lpVtbl, ppwszVolume);

  int GetUniqueIdentity(Pointer<Pointer<Utf16>> ppwszIdentity) => ptr
          .ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<Utf16>> ppwszIdentity)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<Utf16>> ppwszIdentity)>()(
      ptr.ref.lpVtbl, ppwszIdentity);

  int
      GetSilos(Pointer<Pointer<Pointer<COMObject>>> pppIEnhancedStorageSilos,
                  ...
                  .asFunction<
                      int Function(
                          ...
                          Pointer<Pointer<Pointer<COMObject>>>
                              pppIEnhancedStorageSilos,
                          Pointer<Uint32> pcEnhancedStorageSilos)>()(
              ptr.ref.lpVtbl, pppIEnhancedStorageSilos, pcEnhancedStorageSilos);
}
