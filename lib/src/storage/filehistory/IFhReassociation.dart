...
class IFhReassociation extends IUnknown {
  ...
  int ScanTargetForConfigurations(Pointer<Utf16> TargetUrl) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> TargetUrl)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Utf16> TargetUrl)>()(
          ptr.ref.lpVtbl, TargetUrl);

  int GetConfigurationDetails(int Index, Pointer<Pointer<Utf16>> UserName,
          Pointer<Pointer<Utf16>> PcName, Pointer<FILETIME> BackupTime) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<Utf16>> PcName,
                      Pointer<FILETIME> BackupTime)>()(
          ptr.ref.lpVtbl, Index, UserName, PcName, BackupTime);

  int SelectConfiguration(int Index) => ptr.ref.lpVtbl.value
      .elementAt(6)
  ...
  int PerformReassociation(int OverwriteIfExists) => ptr.ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
                  NativeFunction<
