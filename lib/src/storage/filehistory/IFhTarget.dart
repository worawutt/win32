...
class IFhTarget extends IUnknown {
  ...
  int GetStringProperty(
          int PropertyType, Pointer<Pointer<Utf16>> PropertyValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 PropertyType,
                              Pointer<Pointer<Utf16>> PropertyValue)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int PropertyType,
                      Pointer<Pointer<Utf16>> PropertyValue)>()(
          ptr.ref.lpVtbl, PropertyType, PropertyValue);

  int GetNumericalProperty(int PropertyType, Pointer<Uint64> PropertyValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
