...
class IVdsAdviseSink extends IUnknown {
  ...
  int OnNotify(int lNumberOfNotifications,
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 lNumberOfNotifications,
                              Pointer<VDS_NOTIFICATION> pNotificationArray)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int lNumberOfNotifications,
                      Pointer<VDS_NOTIFICATION> pNotificationArray)>()(
          ptr.ref.lpVtbl, lNumberOfNotifications, pNotificationArray);
}
