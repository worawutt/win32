...
class IVdsSubSystem2 extends IUnknown {
  ...
  int GetProperties2(Pointer<VDS_SUB_SYSTEM_PROP2> pSubSystemProp2) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<VDS_SUB_SYSTEM_PROP2> pSubSystemProp2)>()(
      ptr.ref.lpVtbl, pSubSystemProp2);

  int GetDrive2(int sBusNumber, int sSlotNumber, int ulEnclosureNumber,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppDrive)>()(
          ptr.ref.lpVtbl, sBusNumber, sSlotNumber, ulEnclosureNumber, ppDrive);
  ...
  int QueryMaxLunCreateSize2(
      ...
      ptr.ref.lpVtbl.value
          ...
          pDriveIdArray, lNumberOfDrives, pHints2, pullMaxLunSize);
}
