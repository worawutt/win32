...
class IVdsSubSystemIscsi extends IUnknown {
  ...
  int QueryTargets(Pointer<Pointer<COMObject>> ppEnum) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int QueryPortals(Pointer<Pointer<COMObject>> ppEnum) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> pwszFriendlyName,
                      Pointer<Pointer<COMObject>> ppAsync)>()(
          ptr.ref.lpVtbl, pwszIscsiName, pwszFriendlyName, ppAsync);

  int SetIpsecGroupPresharedKey(Pointer<VDS_ISCSI_IPSEC_KEY> pIpsecKey) => ptr
          .ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<VDS_ISCSI_IPSEC_KEY> pIpsecKey)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<VDS_ISCSI_IPSEC_KEY> pIpsecKey)>()(
      ptr.ref.lpVtbl, pIpsecKey);
}
