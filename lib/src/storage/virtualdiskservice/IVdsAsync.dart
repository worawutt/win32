...
class IVdsAsync extends IUnknown {
  ...
  int Wait(Pointer<Int32> pHrResult, Pointer<VDS_ASYNC_OUTPUT> pAsyncOut) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Int32> pHrResult,
                      Pointer<VDS_ASYNC_OUTPUT> pAsyncOut)>()(
          ptr.ref.lpVtbl, pHrResult, pAsyncOut);

  int QueryStatus(
          Pointer<Int32> pHrResult, Pointer<Uint32> pulPercentCompleted) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Int32> pHrResult,
                      Pointer<Uint32> pulPercentCompleted)>()(
          ptr.ref.lpVtbl, pHrResult, pulPercentCompleted);
}
