...
class IVdsHwProviderPrivateMpio extends IUnknown {
  ...
  int SetAllPathStatusesFromHbaPort(
          VDS_HBAPORT_PROP hbaPortProp, int status) =>
      ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, VDS_HBAPORT_PROP hbaPortProp,
                          Int32 status)>>>()
          .value
          .asFunction<
              int Function(Pointer, VDS_HBAPORT_PROP hbaPortProp,
                  int status)>()(ptr.ref.lpVtbl, hbaPortProp, status);
}
