...
class IVdsHwProviderStoragePools extends IUnknown {
  ...
  int QueryStoragePools(
      ...
      ptr.ref.lpVtbl.value
          ...
          ulFlags, ullRemainingFreeSpace, pPoolAttributes, ppEnum);
  ...
  int QueryMaxLunCreateSizeInStoragePool(int type, GUID StoragePoolId,
          Pointer<VDS_HINTS2> pHints2, Pointer<Uint64> pullMaxLunSize) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<VDS_HINTS2> pHints2,
                      Pointer<Uint64> pullMaxLunSize)>()(
          ptr.ref.lpVtbl, type, StoragePoolId, pHints2, pullMaxLunSize);
}
