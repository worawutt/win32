...
class IAppxBundleManifestPackageInfo2 extends IUnknown {
  ...
  int GetIsPackageReference(Pointer<Int32> isPackageReference) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Int32> isPackageReference)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> isPackageReference)>()(
          ptr.ref.lpVtbl, isPackageReference);
  ...
  int GetIsDefaultApplicablePackage(
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Int32> isDefaultApplicablePackage)>()(
          ptr.ref.lpVtbl, isDefaultApplicablePackage);
}
