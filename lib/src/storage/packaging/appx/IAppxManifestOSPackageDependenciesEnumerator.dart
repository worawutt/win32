...
class IAppxManifestOSPackageDependenciesEnumerator extends IUnknown {
  ...
  int GetCurrent(Pointer<Pointer<COMObject>> osPackageDependency) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<COMObject>> osPackageDependency)>()(
      ptr.ref.lpVtbl, osPackageDependency);
