...
class IAppxManifestCapabilitiesEnumerator extends IUnknown {
  ...
  int GetCurrent(Pointer<Pointer<Utf16>> capability) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<Utf16>> capability)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<Utf16>> capability)>()(
      ptr.ref.lpVtbl, capability);
