...
class IAppxBundleManifestPackageInfo4 extends IUnknown {
  ...
  int GetIsStub(Pointer<Int32> isStub) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Int32> isStub)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, Pointer<Int32> isStub)>()(ptr.ref.lpVtbl, isStub);
}
