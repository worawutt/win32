...
class IAppxEncryptionFactory extends IUnknown {
  ...
  int DecryptPackage(Pointer<COMObject> inputStream,
          Pointer<COMObject> outputStream, Pointer<APPX_KEY_INFO> keyInfo) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> outputStream,
                      Pointer<APPX_KEY_INFO> keyInfo)>()(
          ptr.ref.lpVtbl, inputStream, outputStream, keyInfo);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<APPX_KEY_INFO> keyInfo,
                      Pointer<Pointer<COMObject>> packageReader)>()(
          ptr.ref.lpVtbl, inputStream, keyInfo, packageReader);
  ...
  int DecryptBundle(Pointer<COMObject> inputStream,
          Pointer<COMObject> outputStream, Pointer<APPX_KEY_INFO> keyInfo) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<APPX_KEY_INFO> keyInfo,
                      Pointer<Pointer<COMObject>> bundleReader)>()(
          ptr.ref.lpVtbl, inputStream, keyInfo, bundleReader);
}
