...
class IAppxPackageEditor extends IUnknown {
  ...
  int SetWorkingDirectory(Pointer<Utf16> workingDirectory) =>
      ptr.ref.lpVtbl.value
          ...
          ptr.ref.lpVtbl, workingDirectory);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> updatedPackageStream,
                      Pointer<COMObject> baselinePackageStream,
                      Pointer<COMObject> deltaPackageStream)>()(ptr.ref.lpVtbl,
          updatedPackageStream, baselinePackageStream, deltaPackageStream);
  ...
  int UpdatePackage(Pointer<COMObject> baselinePackageStream,
          Pointer<COMObject> deltaPackageStream, int updateOption) =>
      ptr.ref.lpVtbl.value
              .elementAt(6)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> baselinePackageStream,
                      Pointer<COMObject> deltaPackageStream,
                      int updateOption)>()(ptr.ref.lpVtbl,
          baselinePackageStream, deltaPackageStream, updateOption);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> updatedManifestStream,
                      int isPackageEncrypted,
                      int options)>()(ptr.ref.lpVtbl, packageStream,
          updatedManifestStream, isPackageEncrypted, options);
}
