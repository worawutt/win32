...
class IAppxManifestQualifiedResourcesEnumerator extends IUnknown {
  ...
  int GetCurrent(Pointer<Pointer<COMObject>> resource) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> resource)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> resource)>()(
