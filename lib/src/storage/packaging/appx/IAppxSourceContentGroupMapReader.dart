...
class IAppxSourceContentGroupMapReader extends IUnknown {
  ...
  int GetRequiredGroup(Pointer<Pointer<COMObject>> requiredGroup) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> requiredGroup)>()(
          ptr.ref.lpVtbl, requiredGroup);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer,
                      Pointer<Pointer<COMObject>> automaticGroupsEnumerator)>()(
          ptr.ref.lpVtbl, automaticGroupsEnumerator);
}
