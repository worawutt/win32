...
class IAppxBundleManifestPackageInfoEnumerator extends IUnknown {
  ...
  int GetCurrent(Pointer<Pointer<COMObject>> packageInfo) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> packageInfo)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> packageInfo)>()(
      ptr.ref.lpVtbl, packageInfo);
