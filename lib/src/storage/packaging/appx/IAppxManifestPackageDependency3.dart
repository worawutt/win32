...
class IAppxManifestPackageDependency3 extends IUnknown {
  ...
  int GetIsOptional(Pointer<Int32> isOptional) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> isOptional)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Int32> isOptional)>()(
      ptr.ref.lpVtbl, isOptional);
}
