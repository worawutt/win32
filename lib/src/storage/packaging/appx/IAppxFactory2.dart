...
class IAppxFactory2 extends IUnknown {
  ...
  int CreateContentGroupMapReader(Pointer<COMObject> inputStream,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> inputStream,
                      Pointer<Pointer<COMObject>> contentGroupMapReader)>()(
          ptr.ref.lpVtbl, inputStream, contentGroupMapReader);

  int CreateSourceContentGroupMapReader(
          Pointer<COMObject> inputStream, Pointer<Pointer<COMObject>> reader) =>
      ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<COMObject> inputStream,
                  Pointer<Pointer<COMObject>>
                      reader)>()(ptr.ref.lpVtbl, inputStream, reader);

  int CreateContentGroupMapWriter(Pointer<COMObject> stream,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> stream,
                      Pointer<Pointer<COMObject>> contentGroupMapWriter)>()(
          ptr.ref.lpVtbl, stream, contentGroupMapWriter);
}
