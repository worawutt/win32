...
class IAppxManifestDriverDependency extends IUnknown {
  ...
  int GetDriverConstraints(Pointer<Pointer<COMObject>> driverConstraints) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<COMObject>> driverConstraints)>()(
      ptr.ref.lpVtbl, driverConstraints);
}
