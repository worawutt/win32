      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf8> contextName,
                      Pointer<Utf16> contextMessage,
                      Pointer<Utf16> detailsMessage)>()(ptr.ref.lpVtbl,
          changeType, contextId, contextName, contextMessage, detailsMessage);

  int ReportError(Pointer<Utf16> errorMessage) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> errorMessage)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Utf16> errorMessage)>()(
      ptr.ref.lpVtbl, errorMessage);
}
