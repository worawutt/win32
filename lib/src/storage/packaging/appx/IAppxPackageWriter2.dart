...
class IAppxPackageWriter2 extends IUnknown {
  ...
  int Close(Pointer<COMObject> manifest, Pointer<COMObject> contentGroupMap) =>
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> manifest,
                      Pointer<COMObject> contentGroupMap)>()(
          ptr.ref.lpVtbl, manifest, contentGroupMap);
}
