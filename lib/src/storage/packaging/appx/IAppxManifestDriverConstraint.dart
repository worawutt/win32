...
class IAppxManifestDriverConstraint extends IUnknown {
  ...
  int GetMinDate(Pointer<Pointer<Utf16>> minDate) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Pointer<Utf16>> minDate)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<Pointer<Utf16>> minDate)>()(ptr.ref.lpVtbl, minDate);
}
