...
class IAppxManifestTargetDeviceFamily extends IUnknown {
  ...
  int GetMaxVersionTested(Pointer<Uint64> maxVersionTested) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Uint64> maxVersionTested)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint64> maxVersionTested)>()(
          ptr.ref.lpVtbl, maxVersionTested);
}
