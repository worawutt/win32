...
class IAppxBlockMapBlocksEnumerator extends IUnknown {
  ...
  int GetCurrent(Pointer<Pointer<COMObject>> block) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> block)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> block)>()(
      ptr.ref.lpVtbl, block);
