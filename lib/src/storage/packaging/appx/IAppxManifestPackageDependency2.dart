...
class IAppxManifestPackageDependency2 extends IAppxManifestPackageDependency {
  ...
  int GetMaxMajorVersionTested(Pointer<Uint16> maxMajorVersionTested) => ptr
          .ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Uint16> maxMajorVersionTested)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Uint16> maxMajorVersionTested)>()(
      ptr.ref.lpVtbl, maxMajorVersionTested);
}
