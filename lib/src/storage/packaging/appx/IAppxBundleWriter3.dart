...
class IAppxBundleWriter3 extends IUnknown {
  ...
  int AddPackageReference(
          Pointer<Utf16> fileName, Pointer<COMObject> inputStream) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> fileName,
                      Pointer<COMObject> inputStream)>()(
          ptr.ref.lpVtbl, fileName, inputStream);

  int Close(Pointer<Utf16> hashMethodString) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Utf16> hashMethodString)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> hashMethodString)>()(
          ptr.ref.lpVtbl, hashMethodString);
}
