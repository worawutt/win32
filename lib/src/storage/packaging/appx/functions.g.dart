...
int ActivatePackageVirtualizationContext(
    ...
    _ActivatePackageVirtualizationContext(context, cookie);

late final _ActivatePackageVirtualizationContext = _kernel32.lookupFunction<
    Int32 Function(Pointer<PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE__> context,
        Pointer<IntPtr> cookie),
    int Function(Pointer<PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE__> context,
        Pointer<IntPtr> cookie)>('ActivatePackageVirtualizationContext');
...
int AddPackageDependency(
    ...
    _AddPackageDependency(packageDependencyId, rank, options,
        packageDependencyContext, packageFullName);
...
late final _AddPackageDependency = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        int options,
        Pointer<Pointer<PACKAGEDEPENDENCY_CONTEXT__>> packageDependencyContext,
        Pointer<Pointer<Utf16>> packageFullName)>('AddPackageDependency');

int AppPolicyGetClrCompat(int processToken, Pointer<Int32> policy) =>
    _AppPolicyGetClrCompat(processToken, policy);

late final _AppPolicyGetClrCompat = _kernel32.lookupFunction<
    Int32 Function(IntPtr processToken, Pointer<Int32> policy),
    int Function(
        int processToken, Pointer<Int32> policy)>('AppPolicyGetClrCompat');

int AppPolicyGetCreateFileAccess(int processToken, Pointer<Int32> policy) =>
    _AppPolicyGetCreateFileAccess(processToken, policy);

late final _AppPolicyGetCreateFileAccess = _kernel32.lookupFunction<
    Int32 Function(IntPtr processToken, Pointer<Int32> policy),
    int Function(int processToken,
        Pointer<Int32> policy)>('AppPolicyGetCreateFileAccess');

int AppPolicyGetLifecycleManagement(int processToken, Pointer<Int32> policy) =>
    _AppPolicyGetLifecycleManagement(processToken, policy);

late final _AppPolicyGetLifecycleManagement = _kernel32.lookupFunction<
    Int32 Function(IntPtr processToken, Pointer<Int32> policy),
    int Function(int processToken,
        Pointer<Int32> policy)>('AppPolicyGetLifecycleManagement');

int AppPolicyGetMediaFoundationCodecLoading(
        int processToken, Pointer<Int32> policy) =>
    _AppPolicyGetMediaFoundationCodecLoading(processToken, policy);

late final _AppPolicyGetMediaFoundationCodecLoading = _kernel32.lookupFunction<
    Int32 Function(IntPtr processToken, Pointer<Int32> policy),
    int Function(int processToken,
        Pointer<Int32> policy)>('AppPolicyGetMediaFoundationCodecLoading');

int AppPolicyGetProcessTerminationMethod(
        int processToken, Pointer<Int32> policy) =>
    _AppPolicyGetProcessTerminationMethod(processToken, policy);

late final _AppPolicyGetProcessTerminationMethod = _kernel32.lookupFunction<
    Int32 Function(IntPtr processToken, Pointer<Int32> policy),
    int Function(int processToken,
        Pointer<Int32> policy)>('AppPolicyGetProcessTerminationMethod');

int AppPolicyGetShowDeveloperDiagnostic(
        int processToken, Pointer<Int32> policy) =>
    _AppPolicyGetShowDeveloperDiagnostic(processToken, policy);

late final _AppPolicyGetShowDeveloperDiagnostic = _kernel32.lookupFunction<
    Int32 Function(IntPtr processToken, Pointer<Int32> policy),
    int Function(int processToken,
        Pointer<Int32> policy)>('AppPolicyGetShowDeveloperDiagnostic');

int AppPolicyGetThreadInitializationType(
        int processToken, Pointer<Int32> policy) =>
    _AppPolicyGetThreadInitializationType(processToken, policy);

late final _AppPolicyGetThreadInitializationType = _kernel32.lookupFunction<
    Int32 Function(IntPtr processToken, Pointer<Int32> policy),
    int Function(int processToken,
        Pointer<Int32> policy)>('AppPolicyGetThreadInitializationType');

int AppPolicyGetWindowingModel(int processToken, Pointer<Int32> policy) =>
    _AppPolicyGetWindowingModel(processToken, policy);

late final _AppPolicyGetWindowingModel = _kernel32.lookupFunction<
    Int32 Function(IntPtr processToken, Pointer<Int32> policy),
    int Function(
        int processToken, Pointer<Int32> policy)>('AppPolicyGetWindowingModel');

int CheckIsMSIXPackage(
        Pointer<Utf16> packageFullName, Pointer<Int32> isMSIXPackage) =>
    _CheckIsMSIXPackage(packageFullName, isMSIXPackage);

late final _CheckIsMSIXPackage = _kernel32.lookupFunction<
    Int32 Function(
        Pointer<Utf16> packageFullName, Pointer<Int32> isMSIXPackage),
    int Function(Pointer<Utf16> packageFullName,
        Pointer<Int32> isMSIXPackage)>('CheckIsMSIXPackage');

int ClosePackageInfo(Pointer<PACKAGE_INFO_REFERENCE> packageInfoReference) =>
    _ClosePackageInfo(packageInfoReference);

late final _ClosePackageInfo = _kernel32.lookupFunction<
        Int32 Function(Pointer<PACKAGE_INFO_REFERENCE> packageInfoReference),
        int Function(Pointer<PACKAGE_INFO_REFERENCE> packageInfoReference)>(
    'ClosePackageInfo');

int CreatePackageVirtualizationContext(Pointer<Utf16> packageFamilyName,
        Pointer<Pointer<PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE__>> context) =>
    _CreatePackageVirtualizationContext(packageFamilyName, context);

late final _CreatePackageVirtualizationContext = _kernel32.lookupFunction<
        Int32 Function(Pointer<Utf16> packageFamilyName,
            Pointer<Pointer<PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE__>> context),
        int Function(Pointer<Utf16> packageFamilyName,
            Pointer<Pointer<PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE__>> context)>(
    'CreatePackageVirtualizationContext');

void DeactivatePackageVirtualizationContext(int cookie) =>
    _DeactivatePackageVirtualizationContext(cookie);

late final _DeactivatePackageVirtualizationContext = _kernel32.lookupFunction<
    Void Function(IntPtr cookie),
    void Function(int cookie)>('DeactivatePackageVirtualizationContext');

int DeletePackageDependency(Pointer<Utf16> packageDependencyId) =>
    _DeletePackageDependency(packageDependencyId);

late final _DeletePackageDependency = _kernel32.lookupFunction<
    Int32 Function(Pointer<Utf16> packageDependencyId),
    int Function(
        Pointer<Utf16> packageDependencyId)>('DeletePackageDependency');

int DuplicatePackageVirtualizationContext(
        Pointer<PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE__> sourceContext,
        Pointer<Pointer<PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE__>>
            destContext) =>
    _DuplicatePackageVirtualizationContext(sourceContext, destContext);
...
late final _DuplicatePackageVirtualizationContext = _kernel32.lookupFunction<
    ...
    int Function(
        Pointer<PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE__> sourceContext,
        Pointer<Pointer<PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE__>>
            destContext)>('DuplicatePackageVirtualizationContext');
...
late final _FormatApplicationUserModelId = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Utf16> packageRelativeApplicationId,
        Pointer<Uint32> applicationUserModelIdLength,
        Pointer<Utf16> applicationUserModelId)>('FormatApplicationUserModelId');
...
late final _GetCurrentApplicationUserModelId = _kernel32.lookupFunction<
        Int32 Function(Pointer<Uint32> applicationUserModelIdLength,
            Pointer<Utf16> applicationUserModelId),
        int Function(Pointer<Uint32> applicationUserModelIdLength,
            Pointer<Utf16> applicationUserModelId)>(
    'GetCurrentApplicationUserModelId');

int GetCurrentPackageFamilyName(Pointer<Uint32> packageFamilyNameLength,
        Pointer<Utf16> packageFamilyName) =>
    _GetCurrentPackageFamilyName(packageFamilyNameLength, packageFamilyName);

late final _GetCurrentPackageFamilyName = _kernel32.lookupFunction<
    Int32 Function(Pointer<Uint32> packageFamilyNameLength,
        Pointer<Utf16> packageFamilyName),
    int Function(Pointer<Uint32> packageFamilyNameLength,
        Pointer<Utf16> packageFamilyName)>('GetCurrentPackageFamilyName');
...
int GetCurrentPackageId(Pointer<Uint32> bufferLength, Pointer<Uint8> buffer) =>
    _GetCurrentPackageId(bufferLength, buffer);

late final _GetCurrentPackageId = _kernel32.lookupFunction<
    Int32 Function(Pointer<Uint32> bufferLength, Pointer<Uint8> buffer),
    int Function(Pointer<Uint32> bufferLength,
        Pointer<Uint8> buffer)>('GetCurrentPackageId');

int GetCurrentPackageInfo(int flags, Pointer<Uint32> bufferLength,
        Pointer<Uint8> buffer, Pointer<Uint32> count) =>
    _GetCurrentPackageInfo(flags, bufferLength, buffer, count);

late final _GetCurrentPackageInfo = _kernel32.lookupFunction<
    Int32 Function(Uint32 flags, Pointer<Uint32> bufferLength,
        Pointer<Uint8> buffer, Pointer<Uint32> count),
    int Function(int flags, Pointer<Uint32> bufferLength, Pointer<Uint8> buffer,
        Pointer<Uint32> count)>('GetCurrentPackageInfo');

int GetCurrentPackagePath(Pointer<Uint32> pathLength, Pointer<Utf16> path) =>
    _GetCurrentPackagePath(pathLength, path);

late final _GetCurrentPackagePath = _kernel32.lookupFunction<
    Int32 Function(Pointer<Uint32> pathLength, Pointer<Utf16> path),
    int Function(Pointer<Uint32> pathLength,
        Pointer<Utf16> path)>('GetCurrentPackagePath');
...
int GetIdForPackageDependencyContext(
    ...
    _GetIdForPackageDependencyContext(
        packageDependencyContext, packageDependencyId);
...
int GetPackageApplicationIds(
    ...
    _GetPackageApplicationIds(
        packageInfoReference, bufferLength, buffer, count);
...
late final _GetPackageApplicationIds = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> bufferLength,
        Pointer<Uint8> buffer,
        Pointer<Uint32> count)>('GetPackageApplicationIds');

int GetPackageFamilyName(int hProcess, Pointer<Uint32> packageFamilyNameLength,
        Pointer<Utf16> packageFamilyName) =>
    _GetPackageFamilyName(hProcess, packageFamilyNameLength, packageFamilyName);

late final _GetPackageFamilyName = _kernel32.lookupFunction<
    Int32 Function(IntPtr hProcess, Pointer<Uint32> packageFamilyNameLength,
        Pointer<Utf16> packageFamilyName),
    int Function(int hProcess, Pointer<Uint32> packageFamilyNameLength,
        Pointer<Utf16> packageFamilyName)>('GetPackageFamilyName');

int GetPackageFullName(int hProcess, Pointer<Uint32> packageFullNameLength,
        Pointer<Utf16> packageFullName) =>
    _GetPackageFullName(hProcess, packageFullNameLength, packageFullName);

late final _GetPackageFullName = _kernel32.lookupFunction<
    Int32 Function(IntPtr hProcess, Pointer<Uint32> packageFullNameLength,
        Pointer<Utf16> packageFullName),
    int Function(int hProcess, Pointer<Uint32> packageFullNameLength,
        Pointer<Utf16> packageFullName)>('GetPackageFullName');

int GetPackageId(
        int hProcess, Pointer<Uint32> bufferLength, Pointer<Uint8> buffer) =>
    _GetPackageId(hProcess, bufferLength, buffer);

late final _GetPackageId = _kernel32.lookupFunction<
    Int32 Function(
        IntPtr hProcess, Pointer<Uint32> bufferLength, Pointer<Uint8> buffer),
    int Function(int hProcess, Pointer<Uint32> bufferLength,
        Pointer<Uint8> buffer)>('GetPackageId');
...
int GetPackageInfo(
        ...
        Pointer<Uint8> buffer,
        Pointer<Uint32> count) =>
    _GetPackageInfo(packageInfoReference, flags, bufferLength, buffer, count);
...
late final _GetPackageInfo = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> bufferLength,
        Pointer<Uint8> buffer,
        Pointer<Uint32> count)>('GetPackageInfo');

int GetPackagePath(Pointer<PACKAGE_ID> packageId, int reserved,
        Pointer<Uint32> pathLength, Pointer<Utf16> path) =>
    _GetPackagePath(packageId, reserved, pathLength, path);

late final _GetPackagePath = _kernel32.lookupFunction<
    Int32 Function(Pointer<PACKAGE_ID> packageId, Uint32 reserved,
        Pointer<Uint32> pathLength, Pointer<Utf16> path),
    int Function(Pointer<PACKAGE_ID> packageId, int reserved,
        Pointer<Uint32> pathLength, Pointer<Utf16> path)>('GetPackagePath');

int GetPackagePathByFullName(Pointer<Utf16> packageFullName,
        Pointer<Uint32> pathLength, Pointer<Utf16> path) =>
    _GetPackagePathByFullName(packageFullName, pathLength, path);

late final _GetPackagePathByFullName = _kernel32.lookupFunction<
    Int32 Function(Pointer<Utf16> packageFullName, Pointer<Uint32> pathLength,
        Pointer<Utf16> path),
    int Function(Pointer<Utf16> packageFullName, Pointer<Uint32> pathLength,
        Pointer<Utf16> path)>('GetPackagePathByFullName');
...
int GetPackagesByPackageFamily(
    ...
    _GetPackagesByPackageFamily(
        packageFamilyName, count, packageFullNames, bufferLength, buffer);
...
late final _GetPackagesByPackageFamily = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Pointer<Utf16>> packageFullNames,
        Pointer<Uint32> bufferLength,
        Pointer<Utf16> buffer)>('GetPackagesByPackageFamily');

int GetProcessesInVirtualizationContext(Pointer<Utf16> packageFamilyName,
        Pointer<Uint32> count, Pointer<Pointer<IntPtr>> processes) =>
    _GetProcessesInVirtualizationContext(packageFamilyName, count, processes);

late final _GetProcessesInVirtualizationContext = _kernel32.lookupFunction<
        Int32 Function(Pointer<Utf16> packageFamilyName, Pointer<Uint32> count,
            Pointer<Pointer<IntPtr>> processes),
        int Function(Pointer<Utf16> packageFamilyName, Pointer<Uint32> count,
            Pointer<Pointer<IntPtr>> processes)>(
...
int GetResolvedPackageFullNameForPackageDependency(
    ...
    _GetResolvedPackageFullNameForPackageDependency(
        packageDependencyId, packageFullName);

late final _GetResolvedPackageFullNameForPackageDependency =
    _kernel32.lookupFunction<
            Int32 Function(Pointer<Utf16> packageDependencyId,
                Pointer<Pointer<Utf16>> packageFullName),
            int Function(Pointer<Utf16> packageDependencyId,
                Pointer<Pointer<Utf16>> packageFullName)>(
        'GetResolvedPackageFullNameForPackageDependency');

int GetStagedPackagePathByFullName(Pointer<Utf16> packageFullName,
        Pointer<Uint32> pathLength, Pointer<Utf16> path) =>
    _GetStagedPackagePathByFullName(packageFullName, pathLength, path);

late final _GetStagedPackagePathByFullName = _kernel32.lookupFunction<
    Int32 Function(Pointer<Utf16> packageFullName, Pointer<Uint32> pathLength,
        Pointer<Utf16> path),
    int Function(Pointer<Utf16> packageFullName, Pointer<Uint32> pathLength,
        Pointer<Utf16> path)>('GetStagedPackagePathByFullName');

int OpenPackageInfoByFullName(Pointer<Utf16> packageFullName, int reserved,
        Pointer<Pointer<PACKAGE_INFO_REFERENCE>> packageInfoReference) =>
    _OpenPackageInfoByFullName(packageFullName, reserved, packageInfoReference);

late final _OpenPackageInfoByFullName = _kernel32.lookupFunction<
        Int32 Function(Pointer<Utf16> packageFullName, Uint32 reserved,
            Pointer<Pointer<PACKAGE_INFO_REFERENCE>> packageInfoReference),
        int Function(Pointer<Utf16> packageFullName, int reserved,
            Pointer<Pointer<PACKAGE_INFO_REFERENCE>> packageInfoReference)>(
...
int PackageFamilyNameFromId(
    ...
    _PackageFamilyNameFromId(
        packageId, packageFamilyNameLength, packageFamilyName);
...
late final _PackageFamilyNameFromId = _kernel32.lookupFunction<
    ...
    int Function(
        Pointer<PACKAGE_ID> packageId,
        Pointer<Uint32> packageFamilyNameLength,
        Pointer<Utf16> packageFamilyName)>('PackageFamilyNameFromId');

int PackageFullNameFromId(
        Pointer<PACKAGE_ID> packageId,
        Pointer<Uint32> packageFullNameLength,
        Pointer<Utf16> packageFullName) =>
    _PackageFullNameFromId(packageId, packageFullNameLength, packageFullName);
...
late final _PackageFullNameFromId = _kernel32.lookupFunction<
    ...
    int Function(
        Pointer<PACKAGE_ID> packageId,
        Pointer<Uint32> packageFullNameLength,
        Pointer<Utf16> packageFullName)>('PackageFullNameFromId');

int PackageIdFromFullName(Pointer<Utf16> packageFullName, int flags,
        Pointer<Uint32> bufferLength, Pointer<Uint8> buffer) =>
    _PackageIdFromFullName(packageFullName, flags, bufferLength, buffer);

late final _PackageIdFromFullName = _kernel32.lookupFunction<
    Int32 Function(Pointer<Utf16> packageFullName, Uint32 flags,
        Pointer<Uint32> bufferLength, Pointer<Uint8> buffer),
    int Function(
        Pointer<Utf16> packageFullName,
        int flags,
        Pointer<Uint32> bufferLength,
        Pointer<Uint8> buffer)>('PackageIdFromFullName');
...
void ReleasePackageVirtualizationContext(
        Pointer<PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE__> context) =>
    _ReleasePackageVirtualizationContext(context);

late final _ReleasePackageVirtualizationContext = _kernel32.lookupFunction<
        Void Function(Pointer<PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE__> context),
        void Function(
            Pointer<PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE__> context)>(
...
int RemovePackageDependency(
        Pointer<PACKAGEDEPENDENCY_CONTEXT__> packageDependencyContext) =>
    _RemovePackageDependency(packageDependencyContext);
