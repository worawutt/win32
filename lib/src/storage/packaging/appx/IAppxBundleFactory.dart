...
class IAppxBundleFactory extends IUnknown {
  ...
  int CreateBundleWriter(Pointer<COMObject> outputStream, int bundleVersion,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int bundleVersion,
                      Pointer<Pointer<COMObject>> bundleWriter)>()(
          ptr.ref.lpVtbl, outputStream, bundleVersion, bundleWriter);

  int
      CreateBundleReader(Pointer<COMObject> inputStream,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(Pointer, Pointer<COMObject> inputStream,
                          Pointer<Pointer<COMObject>> bundleReader)>()(
              ptr.ref.lpVtbl, inputStream, bundleReader);

  int CreateBundleManifestReader(Pointer<COMObject> inputStream,
