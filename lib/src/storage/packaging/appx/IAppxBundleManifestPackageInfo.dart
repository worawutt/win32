...
class IAppxBundleManifestPackageInfo extends IUnknown {
  ...
  int GetPackageType(Pointer<Int32> packageType) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> packageType)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Int32> packageType)>()(
      ptr.ref.lpVtbl, packageType);
  ...
  int GetFileName(Pointer<Pointer<Utf16>> fileName) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<
