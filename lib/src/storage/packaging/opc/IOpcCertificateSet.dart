...
class IOpcCertificateSet extends IUnknown {
  ...
  int Add(Pointer<CERT_CONTEXT> certificate) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .value
          .asFunction<
              int Function(Pointer, Pointer<CERT_CONTEXT> certificate)>()(
      ptr.ref.lpVtbl, certificate);

  int Remove(Pointer<CERT_CONTEXT> certificate) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetEnumerator(Pointer<Pointer<COMObject>> certificateEnumerator) =>
