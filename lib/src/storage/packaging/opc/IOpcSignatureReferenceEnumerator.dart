...
class IOpcSignatureReferenceEnumerator extends IUnknown {
  ...
  int GetCurrent(Pointer<Pointer<COMObject>> reference) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> reference)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> reference)>()(
