          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(Pointer,
                          Pointer<Pointer<COMObject>> relationshipPartUri)>()(
              ptr.ref.lpVtbl, relationshipPartUri);

  int
      GetRelativeUri(Pointer<COMObject> targetPartUri,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<COMObject> targetPartUri,
                          Pointer<Pointer<COMObject>> relativeUri)>()(
              ptr.ref.lpVtbl, targetPartUri, relativeUri);

  int CombinePartUri(Pointer<COMObject> relativeUri,
      ...
      ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> relativeUri,
                          Pointer<Pointer<COMObject>> combinedUri)>>>()
          .value
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<COMObject>>
                      combinedUri)>()(ptr.ref.lpVtbl, relativeUri, combinedUri);
}
