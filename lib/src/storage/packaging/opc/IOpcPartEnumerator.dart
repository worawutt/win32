...
class IOpcPartEnumerator extends IUnknown {
  ...
  int GetCurrent(Pointer<Pointer<COMObject>> part) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Pointer<COMObject>> part)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<Pointer<COMObject>> part)>()(ptr.ref.lpVtbl, part);
