...
class IOpcRelationshipSelectorSet extends IUnknown {
  ...
  int
      Create(int selector, Pointer<Utf16> selectionCriterion,
  ...
  int Delete(Pointer<COMObject> relationshipSelector) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> relationshipSelector)>()(
      ptr.ref.lpVtbl, relationshipSelector);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>>
                          relationshipSelectorEnumerator)>()(
          ptr.ref.lpVtbl, relationshipSelectorEnumerator);
}
