...
class IOpcPart extends IUnknown {
  ...
  int GetRelationshipSet(Pointer<Pointer<COMObject>> relationshipSet) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> relationshipSet)>()(
          ptr.ref.lpVtbl, relationshipSet);

  int GetContentStream(Pointer<Pointer<COMObject>> stream) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
  ...
  int GetName(Pointer<Pointer<COMObject>> name) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Pointer<COMObject>> name)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<Pointer<COMObject>> name)>()(ptr.ref.lpVtbl, name);
  ...
  int GetCompressionOptions(Pointer<Int32> compressionOptions) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Int32> compressionOptions)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> compressionOptions)>()(
          ptr.ref.lpVtbl, compressionOptions);
}
