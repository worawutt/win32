...
class IOpcSignatureCustomObjectSet extends IUnknown {
  ...
  int Create(Pointer<Uint8> xmlMarkup, int count,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint8> xmlMarkup, int count,
                      Pointer<Pointer<COMObject>> customObject)>()(
          ptr.ref.lpVtbl, xmlMarkup, count, customObject);

  int Delete(Pointer<COMObject> customObject) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> customObject)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<COMObject> customObject)>()(ptr.ref.lpVtbl, customObject);

  int GetEnumerator(Pointer<Pointer<COMObject>> customObjectEnumerator) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
