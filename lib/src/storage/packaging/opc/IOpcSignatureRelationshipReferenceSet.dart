...
class IOpcSignatureRelationshipReferenceSet extends IUnknown {
  ...
  int CreateRelationshipSelectorSet(Pointer<Pointer<COMObject>> selectorSet) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> selectorSet)>()(
          ptr.ref.lpVtbl, selectorSet);

  int Delete(Pointer<COMObject> relationshipReference) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<COMObject> relationshipReference)>()(
      ptr.ref.lpVtbl, relationshipReference);
