...
class IOpcSignaturePartReferenceSet extends IUnknown {
  ...
  int Create(Pointer<COMObject> partUri, Pointer<Utf16> digestMethod,
          int transformMethod, Pointer<Pointer<COMObject>> partReference) =>
  ...
  int Delete(Pointer<COMObject> partReference) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> partReference)>()(
          ptr.ref.lpVtbl, partReference);

  int GetEnumerator(Pointer<Pointer<COMObject>> partReferenceEnumerator) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
