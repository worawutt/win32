...
class IOpcSignatureReferenceSet extends IUnknown {
  ...
  int Delete(Pointer<COMObject> reference) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> reference)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> reference)>()(
      ptr.ref.lpVtbl, reference);

  int GetEnumerator(Pointer<Pointer<COMObject>> referenceEnumerator) => ptr
          .ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<COMObject>> referenceEnumerator)>()(
      ptr.ref.lpVtbl, referenceEnumerator);
}
