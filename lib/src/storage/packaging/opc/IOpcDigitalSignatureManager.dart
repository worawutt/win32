...
class IOpcDigitalSignatureManager extends IUnknown {
  ...
  int
      GetSignatureEnumerator(Pointer<Pointer<COMObject>> signatureEnumerator) =>
          ptr.ref.lpVtbl.value
                  .elementAt(5)
                  .cast<
                      Pointer<
              ...
              ptr.ref.lpVtbl, signatureEnumerator);

  int RemoveSignature(Pointer<COMObject> signaturePartName) => ptr
          .ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
  ...
  int Validate(Pointer<COMObject> signature, Pointer<CERT_CONTEXT> certificate,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<CERT_CONTEXT> certificate,
                      Pointer<Int32> validationResult)>()(
          ptr.ref.lpVtbl, signature, certificate, validationResult);

  int Sign(Pointer<CERT_CONTEXT> certificate, Pointer<COMObject> signingOptions,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> signingOptions,
                      Pointer<Pointer<COMObject>> digitalSignature)>()(
          ptr.ref.lpVtbl, certificate, signingOptions, digitalSignature);
