      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<COMObject>> members)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<COMObject>> members)>()(
  ...
  set Members(Pointer<COMObject> value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(Pointer, Pointer<COMObject> members)>>>()
            .value
            .asFunction<int Function(Pointer, Pointer<COMObject> members)>()(
  ...
  Pointer<COMObject> get NonMembers {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> nonMembers)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set NonMembers(Pointer<COMObject> value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<
                    Int32 Function(Pointer, Pointer<COMObject> nonMembers)>>>()
        .value
        .asFunction<
            int Function(Pointer,
                Pointer<COMObject> nonMembers)>()(ptr.ref.lpVtbl, value);
