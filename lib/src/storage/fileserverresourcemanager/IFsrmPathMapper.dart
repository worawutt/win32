...
class IFsrmPathMapper extends IDispatch {
  ...
  int GetSharePathsForLocalPath(
          Pointer<Utf16> localPath, Pointer<Pointer<SAFEARRAY>> sharePaths) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> localPath,
                              Pointer<Pointer<SAFEARRAY>> sharePaths)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> localPath,
                      Pointer<Pointer<SAFEARRAY>> sharePaths)>()(
          ptr.ref.lpVtbl, localPath, sharePaths);
}
