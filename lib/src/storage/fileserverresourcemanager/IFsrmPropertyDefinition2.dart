  ...
  int get PropertyDefinitionFlags {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Int32> propertyDefinitionFlags)>()(
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> appliesTo)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> appliesTo)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  Pointer<COMObject> get ValueDefinitions {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> valueDefinitions)>()(
          ptr.ref.lpVtbl, retValuePtr);
