...
class IFsrmReportScheduler extends IDispatch {
  ...
  int VerifyNamespaces(Pointer<VARIANT> namespacesSafeArray) => ptr
          .ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<VARIANT> namespacesSafeArray)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<VARIANT> namespacesSafeArray)>()(
      ptr.ref.lpVtbl, namespacesSafeArray);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<VARIANT> namespacesSafeArray,
                      Pointer<Utf16> serializedTask)>()(
          ptr.ref.lpVtbl, taskName, namespacesSafeArray, serializedTask);
  ...
  int DeleteScheduleTask(Pointer<Utf16> taskName) => ptr.ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
                  NativeFunction<
