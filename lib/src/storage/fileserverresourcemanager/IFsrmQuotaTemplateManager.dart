...
class IFsrmQuotaTemplateManager extends IDispatch {
  ...
  int CreateTemplate(Pointer<Pointer<COMObject>> quotaTemplate) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> quotaTemplate)>()(
          ptr.ref.lpVtbl, quotaTemplate);

  int GetTemplate(
          Pointer<Utf16> name, Pointer<Pointer<COMObject>> quotaTemplate) =>
      ptr
              .ref.lpVtbl.value
              .elementAt(8)
              .cast<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> name,
                      Pointer<Pointer<COMObject>> quotaTemplate)>()(
          ptr.ref.lpVtbl, name, quotaTemplate);

  int EnumTemplates(int options, Pointer<Pointer<COMObject>> quotaTemplates) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, int options,
                      Pointer<Pointer<COMObject>> quotaTemplates)>()(
          ptr.ref.lpVtbl, options, quotaTemplates);

  int
      ExportTemplates(Pointer<VARIANT> quotaTemplateNamesArray,
