...
class IFsrmMutableCollection extends IFsrmCollection {
  ...
  int Add(VARIANT item) => ptr.ref.lpVtbl.value
      .elementAt(14)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, VARIANT item)>>>()
      .value
      .asFunction<int Function(Pointer, VARIANT item)>()(ptr.ref.lpVtbl, item);
  ...
  int RemoveById(GUID id) => ptr.ref.lpVtbl.value
      .elementAt(16)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, GUID id)>>>()
      .value
      .asFunction<int Function(Pointer, GUID id)>()(ptr.ref.lpVtbl, id);

  int Clone(Pointer<Pointer<COMObject>> collection) => ptr.ref.lpVtbl.value
          .elementAt(17)
          .cast<
              Pointer<
                  NativeFunction<
