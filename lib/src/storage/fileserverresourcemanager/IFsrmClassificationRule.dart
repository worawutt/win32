...
class IFsrmClassificationRule extends IFsrmRule {
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Int32> executionOption)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> executionOption)>()(
  ...
  set ExecutionOption(int value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(Pointer, Int32 executionOption)>>>()
            .value
            .asFunction<int Function(Pointer, int executionOption)>()(
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<Utf16>> property)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<Utf16>> property)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set PropertyAffected(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .value
            .asFunction<int Function(Pointer, Pointer<Utf16> property)>()(
        ptr.ref.lpVtbl, value);
