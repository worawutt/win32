...
class IFsrmAutoApplyQuota extends IFsrmQuotaObject {
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<SAFEARRAY>> folders)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<SAFEARRAY>> folders)>()(
  ...
  set ExcludeFolders(Pointer<SAFEARRAY> value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(Pointer, Pointer<SAFEARRAY> folders)>>>()
            .value
            .asFunction<int Function(Pointer, Pointer<SAFEARRAY> folders)>()(
  ...
  int
      CommitAndUpdateDerived(int commitOptions, int applyOptions,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, int commitOptions, int applyOptions,
                          Pointer<Pointer<COMObject>> derivedObjectsResult)>()(
              ptr.ref.lpVtbl,
              commitOptions,
              applyOptions,
