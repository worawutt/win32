    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<VARIANT> used)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<VARIANT> used)>()(
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<VARIANT> peakUsage)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<VARIANT> peakUsage)>()(ptr.ref.lpVtbl, retValuePtr);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Double> peakUsageDateTime)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Double> peakUsageDateTime)>()(
          ptr.ref.lpVtbl, retValuePtr);
