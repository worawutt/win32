...
class IFsrmFileScreenManager extends IDispatch {
  ...
  int CreateFileScreen(
          Pointer<Utf16> path, Pointer<Pointer<COMObject>> fileScreen) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> path,
                      Pointer<Pointer<COMObject>> fileScreen)>()(
          ptr.ref.lpVtbl, path, fileScreen);
  ...
  int EnumFileScreens(Pointer<Utf16> path, int options,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> path, int options,
                      Pointer<Pointer<COMObject>> fileScreens)>()(
          ptr.ref.lpVtbl, path, options, fileScreens);

  int
      CreateFileScreenException(Pointer<Utf16> path,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(Pointer, Pointer<Utf16> path,
                          Pointer<Pointer<COMObject>> fileScreenException)>()(
              ptr.ref.lpVtbl, path, fileScreenException);

  int
      GetFileScreenException(Pointer<Utf16> path,
              Pointer<Pointer<COMObject>> fileScreenException) =>
          ptr.ref.lpVtbl.value
                  .elementAt(13)
                  .cast<
  ...
  int
      EnumFileScreenExceptions(Pointer<Utf16> path, int options,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(Pointer, Pointer<Utf16> path, int options,
                          Pointer<Pointer<COMObject>> fileScreenExceptions)>()(
              ptr.ref.lpVtbl, path, options, fileScreenExceptions);

  int CreateFileScreenCollection(Pointer<Pointer<COMObject>> collection) => ptr
          .ref.lpVtbl.value
          .elementAt(15)
          .cast<
              Pointer<
