...
class IFsrmFileGroupManager extends IDispatch {
  ...
  int CreateFileGroup(Pointer<Pointer<COMObject>> fileGroup) => ptr
          .ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> fileGroup)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> fileGroup)>()(
      ptr.ref.lpVtbl, fileGroup);

  int GetFileGroup(
          Pointer<Utf16> name, Pointer<Pointer<COMObject>> fileGroup) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> name,
                      Pointer<Pointer<COMObject>> fileGroup)>()(
          ptr.ref.lpVtbl, name, fileGroup);

  int EnumFileGroups(int options, Pointer<Pointer<COMObject>> fileGroups) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, int options,
                      Pointer<Pointer<COMObject>> fileGroups)>()(
          ptr.ref.lpVtbl, options, fileGroups);

  int ExportFileGroups(Pointer<VARIANT> fileGroupNamesArray,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<VARIANT> fileGroupNamesArray,
                      Pointer<Pointer<Utf16>> serializedFileGroups)>()(
          ptr.ref.lpVtbl, fileGroupNamesArray, serializedFileGroups);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> serializedFileGroups,
                      Pointer<VARIANT> fileGroupNamesArray,
                      Pointer<Pointer<COMObject>> fileGroups)>()(ptr.ref.lpVtbl,
          serializedFileGroups, fileGroupNamesArray, fileGroups);
}
