...
class IFsrmQuotaManager extends IDispatch {
  ...
  Pointer<SAFEARRAY> get ActionVariables {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<SAFEARRAY>> variables)>()(
  ...
  Pointer<SAFEARRAY> get ActionVariableDescriptions {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<SAFEARRAY>> descriptions)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  int CreateQuota(Pointer<Utf16> path, Pointer<Pointer<COMObject>> quota) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> path,
                      Pointer<Pointer<COMObject>> quota)>()(
          ptr.ref.lpVtbl, path, quota);

  int CreateAutoApplyQuota(Pointer<Utf16> quotaTemplateName,
          Pointer<Utf16> path, Pointer<Pointer<COMObject>> quota) =>
      ptr.ref.lpVtbl.value
              .elementAt(10)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> path,
                      Pointer<Pointer<COMObject>> quota)>()(
          ptr.ref.lpVtbl, quotaTemplateName, path, quota);

  int GetQuota(Pointer<Utf16> path, Pointer<Pointer<COMObject>> quota) =>
      ptr.ref.lpVtbl.value
              .elementAt(11)
              .cast<
                  Pointer<
  ...
  int EnumQuotas(Pointer<Utf16> path, int options,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> path, int options,
                      Pointer<Pointer<COMObject>> quotas)>()(
          ptr.ref.lpVtbl, path, options, quotas);

  int EnumAutoApplyQuotas(Pointer<Utf16> path, int options,
          Pointer<Pointer<COMObject>> quotas) =>
      ptr.ref.lpVtbl.value
              .elementAt(15)
              .cast<
  ...
  int EnumEffectiveQuotas(Pointer<Utf16> path, int options,
          Pointer<Pointer<COMObject>> quotas) =>
      ptr.ref.lpVtbl.value
              .elementAt(16)
              .cast<
  ...
  int Scan(Pointer<Utf16> strPath) => ptr.ref.lpVtbl.value
          .elementAt(17)
          .cast<
              Pointer<
                  NativeFunction<
      ...
      ptr.ref.lpVtbl, strPath);

  int CreateQuotaCollection(Pointer<Pointer<COMObject>> collection) => ptr
          .ref.lpVtbl.value
          .elementAt(18)
          .cast<
              Pointer<
          ...
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> collection)>()(
