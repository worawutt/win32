  ...
  int get AttachmentFileListSize {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Int32> attachmentFileListSize)>()(
  ...
  set AttachmentFileListSize(int value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<
                    Int32 Function(Pointer, Int32 attachmentFileListSize)>>>()
        .value
        .asFunction<
            int Function(
                Pointer, int attachmentFileListSize)>()(ptr.ref.lpVtbl, value);
