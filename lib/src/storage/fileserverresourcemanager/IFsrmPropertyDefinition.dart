...
class IFsrmPropertyDefinition extends IFsrmObject {
  ...
  Pointer<SAFEARRAY> get PossibleValues {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<SAFEARRAY>> possibleValues)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set PossibleValues(Pointer<SAFEARRAY> value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .value
            .asFunction<
                int Function(Pointer, Pointer<SAFEARRAY> possibleValues)>()(
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<SAFEARRAY>>
                      valueDescriptions)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  set ValueDescriptions(Pointer<SAFEARRAY> value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .value
            .asFunction<
                int Function(Pointer, Pointer<SAFEARRAY> valueDescriptions)>()(
        ptr.ref.lpVtbl, value);
