...
class IFsrmPropertyBag2 extends IFsrmPropertyBag {
  ...
  int GetFieldValue(int field, Pointer<VARIANT> value) => ptr.ref.lpVtbl.value
          .elementAt(28)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Int32 field, Pointer<VARIANT> value)>>>()
          .value
          .asFunction<
              int Function(Pointer, int field, Pointer<VARIANT> value)>()(
      ptr.ref.lpVtbl, field, value);

  int GetUntrustedInFileProperties(Pointer<Pointer<COMObject>> props) =>
