...
class IFsrmRule extends IFsrmObject {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> ruleType)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> ruleType)>()(
  ...
  Pointer<Utf16> get ModuleDefinitionName {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> moduleDefinitionName)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set ModuleDefinitionName(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .value
            .asFunction<
                int Function(Pointer, Pointer<Utf16> moduleDefinitionName)>()(
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> ruleFlags)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> ruleFlags)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set RuleFlags(int value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(20)
        .cast<
            Pointer<NativeFunction<Int32 Function(Pointer, Int32 ruleFlags)>>>()
        .value
        .asFunction<
            int Function(Pointer, int ruleFlags)>()(ptr.ref.lpVtbl, value);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<VARIANT> lastModified)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<VARIANT> lastModified)>()(
          ptr.ref.lpVtbl, retValuePtr);
