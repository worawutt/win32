...
class IFsrmActionEventLog extends IFsrmAction {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> eventType)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> eventType)>()(
  ...
  set EventType(int value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(13)
        .cast<
            Pointer<NativeFunction<Int32 Function(Pointer, Int32 eventType)>>>()
        .value
        .asFunction<
            int Function(Pointer, int eventType)>()(ptr.ref.lpVtbl, value);
