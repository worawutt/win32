...
class IFsrmStorageModuleImplementation
  ...
  int UseDefinitions(Pointer<COMObject> propertyDefinitions) => ptr
          .ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
          ...
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> propertyDefinitions)>()(
      ptr.ref.lpVtbl, propertyDefinitions);

  int LoadProperties(Pointer<COMObject> propertyBag) => ptr.ref.lpVtbl.value
      .elementAt(10)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> propertyBag)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<COMObject> propertyBag)>()(ptr.ref.lpVtbl, propertyBag);

  int SaveProperties(Pointer<COMObject> propertyBag) => ptr.ref.lpVtbl.value
      .elementAt(11)
      .cast<
          Pointer<
              NativeFunction<
