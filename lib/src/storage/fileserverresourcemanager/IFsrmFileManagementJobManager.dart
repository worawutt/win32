...
class IFsrmFileManagementJobManager extends IDispatch {
  ...
  int
      EnumFileManagementJobs(
              int options, Pointer<Pointer<COMObject>> fileManagementJobs) =>
          ptr.ref.lpVtbl.value
              ...
              ptr.ref.lpVtbl, options, fileManagementJobs);

  int CreateFileManagementJob(Pointer<Pointer<COMObject>> fileManagementJob) =>
      ptr.ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer,
                  Pointer<Pointer<COMObject>>
                      fileManagementJob)>()(ptr.ref.lpVtbl, fileManagementJob);

  int
      GetFileManagementJob(Pointer<Utf16> name,
              Pointer<Pointer<COMObject>> fileManagementJob) =>
          ptr.ref.lpVtbl.value
                  .elementAt(11)
                  .cast<
                  ...
                  .asFunction<
                      int Function(Pointer, Pointer<Utf16> name,
                          Pointer<Pointer<COMObject>> fileManagementJob)>()(
              ptr.ref.lpVtbl, name, fileManagementJob);
}
