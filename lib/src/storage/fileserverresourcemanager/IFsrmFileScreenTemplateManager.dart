...
class IFsrmFileScreenTemplateManager extends IDispatch {
  ...
  int CreateTemplate(Pointer<Pointer<COMObject>> fileScreenTemplate) => ptr
          .ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<COMObject>> fileScreenTemplate)>()(
      ptr.ref.lpVtbl, fileScreenTemplate);

  int
      GetTemplate(Pointer<Utf16> name,
              Pointer<Pointer<COMObject>> fileScreenTemplate) =>
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(Pointer, Pointer<Utf16> name,
                          Pointer<Pointer<COMObject>> fileScreenTemplate)>()(
              ptr.ref.lpVtbl, name, fileScreenTemplate);

  int
      EnumTemplates(
              int options, Pointer<Pointer<COMObject>> fileScreenTemplates) =>
          ptr
                  .ref.lpVtbl.value
                  .elementAt(9)
                  .cast<
              ...
              ptr.ref.lpVtbl, options, fileScreenTemplates);

  int ExportTemplates(Pointer<VARIANT> fileScreenTemplateNamesArray,
