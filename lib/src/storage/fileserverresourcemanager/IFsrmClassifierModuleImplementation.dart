...
class IFsrmClassifierModuleImplementation
  ...
  int UseRulesAndDefinitions(
          Pointer<COMObject> rules, Pointer<COMObject> propertyDefinitions) =>
      ptr.ref.lpVtbl.value
              .elementAt(10)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<COMObject> rules,
                              Pointer<COMObject> propertyDefinitions)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> rules,
                      Pointer<COMObject> propertyDefinitions)>()(
          ptr.ref.lpVtbl, rules, propertyDefinitions);

  int
      OnBeginFile(Pointer<COMObject> propertyBag,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<COMObject> propertyBag,
                          Pointer<SAFEARRAY> arrayRuleIds)>()(
              ptr.ref.lpVtbl, propertyBag, arrayRuleIds);

  int DoesPropertyValueApply(Pointer<Utf16> property, Pointer<Utf16> value,
          Pointer<Int16> applyValue, GUID idRule, GUID idPropDef) =>
      ptr.ref.lpVtbl.value
              .elementAt(12)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      GUID idRule,
                      GUID idPropDef)>()(
          ptr.ref.lpVtbl, property, value, applyValue, idRule, idPropDef);

  int GetPropertyValueToApply(Pointer<Utf16> property,
          Pointer<Pointer<Utf16>> value, GUID idRule, GUID idPropDef) =>
      ptr.ref.lpVtbl.value
              .elementAt(13)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      GUID idRule,
                      GUID idPropDef)>()(
          ptr.ref.lpVtbl, property, value, idRule, idPropDef);
