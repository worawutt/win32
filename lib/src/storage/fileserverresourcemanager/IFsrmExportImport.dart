...
class IFsrmExportImport extends IDispatch {
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<VARIANT> fileGroupNamesSafeArray,
                      Pointer<Utf16> remoteHost)>()(
          ptr.ref.lpVtbl, filePath, fileGroupNamesSafeArray, remoteHost);
  ...
  int ImportFileGroups(
      ...
      ptr.ref.lpVtbl.value
          ...
          filePath, fileGroupNamesSafeArray, remoteHost, fileGroups);

  int ExportFileScreenTemplates(Pointer<Utf16> filePath,
          Pointer<VARIANT> templateNamesSafeArray, Pointer<Utf16> remoteHost) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<VARIANT> templateNamesSafeArray,
                      Pointer<Utf16> remoteHost)>()(
          ptr.ref.lpVtbl, filePath, templateNamesSafeArray, remoteHost);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<VARIANT> templateNamesSafeArray,
                      Pointer<Utf16> remoteHost,
                      Pointer<Pointer<COMObject>> templates)>()(ptr.ref.lpVtbl,
          filePath, templateNamesSafeArray, remoteHost, templates);

  int ExportQuotaTemplates(Pointer<Utf16> filePath,
          Pointer<VARIANT> templateNamesSafeArray, Pointer<Utf16> remoteHost) =>
      ptr.ref.lpVtbl.value
              .elementAt(11)
              .cast<
