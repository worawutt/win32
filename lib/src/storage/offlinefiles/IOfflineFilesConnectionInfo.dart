...
class IOfflineFilesConnectionInfo extends IUnknown {
  ...
  int GetConnectState(
          Pointer<Int32> pConnectState, Pointer<Int32> pOfflineReason) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> pConnectState,
                              Pointer<Int32> pOfflineReason)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> pConnectState,
                      Pointer<Int32> pOfflineReason)>()(
          ptr.ref.lpVtbl, pConnectState, pOfflineReason);

  int SetConnectState(int hwndParent, int dwFlags, int ConnectState) => ptr
          .ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, IntPtr hwndParent, Uint32 dwFlags,
                          Int32 ConnectState)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer, int hwndParent, int dwFlags, int ConnectState)>()(
      ptr.ref.lpVtbl, hwndParent, dwFlags, ConnectState);

  int TransitionOnline(int hwndParent, int dwFlags) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int
      TransitionOffline(int hwndParent, int dwFlags, int bForceOpenFilesClosed,
