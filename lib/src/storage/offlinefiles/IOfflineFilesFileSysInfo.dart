...
class IOfflineFilesFileSysInfo extends IUnknown {
  ...
  int GetAttributes(int copy, Pointer<Uint32> pdwAttributes) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 copy,
                          Pointer<Uint32> pdwAttributes)>>>()
          .value
          .asFunction<
              int Function(Pointer, int copy, Pointer<Uint32> pdwAttributes)>()(
      ptr.ref.lpVtbl, copy, pdwAttributes);
  ...
  int GetFileSize(int copy, Pointer<Int64> pSize) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Int32 copy, Pointer<Int64> pSize)>>>()
      .value
      .asFunction<
          int Function(Pointer, int copy,
              Pointer<Int64> pSize)>()(ptr.ref.lpVtbl, copy, pSize);
}
