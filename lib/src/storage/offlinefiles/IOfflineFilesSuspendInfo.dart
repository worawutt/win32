...
class IOfflineFilesSuspendInfo extends IUnknown {
  ...
  int IsSuspended(Pointer<Int32> pbSuspended, Pointer<Int32> pbSuspendedRoot) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> pbSuspended,
                              Pointer<Int32> pbSuspendedRoot)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> pbSuspended,
                      Pointer<Int32> pbSuspendedRoot)>()(
          ptr.ref.lpVtbl, pbSuspended, pbSuspendedRoot);
}
