...
class IOfflineFilesTransparentCacheInfo extends IUnknown {
  ...
  int IsTransparentlyCached(Pointer<Int32> pbTransparentlyCached) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Int32> pbTransparentlyCached)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Int32> pbTransparentlyCached)>()(
      ptr.ref.lpVtbl, pbTransparentlyCached);
}
