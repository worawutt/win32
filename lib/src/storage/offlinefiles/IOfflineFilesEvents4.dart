...
class IOfflineFilesEvents4 extends IOfflineFilesEvents3 {
  ...
  int PrefetchCloseHandleEnd(
          int dwClosedHandleCount, int dwOpenHandleCount, int hrResult) =>
      ptr.ref.lpVtbl.value
              .elementAt(41)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint32 dwClosedHandleCount,
                              Uint32 dwOpenHandleCount, Int32 hrResult)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int dwClosedHandleCount,
                      int dwOpenHandleCount, int hrResult)>()(
          ptr.ref.lpVtbl, dwClosedHandleCount, dwOpenHandleCount, hrResult);
}
