...
class IOfflineFilesEventsFilter extends IUnknown {
  ...
  int GetPathFilter(
          Pointer<Pointer<Utf16>> ppszFilter, Pointer<Int32> pMatch) =>
      ptr.ref.lpVtbl.value
          ...
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<Utf16>> ppszFilter,
                  Pointer<Int32> pMatch)>()(ptr.ref.lpVtbl, ppszFilter, pMatch);

  int GetIncludedEvents(
          int cElements, Pointer<Int32> prgEvents, Pointer<Uint32> pcEvents) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, int cElements, Pointer<Int32> prgEvents,
                      Pointer<Uint32> pcEvents)>()(
          ptr.ref.lpVtbl, cElements, prgEvents, pcEvents);
