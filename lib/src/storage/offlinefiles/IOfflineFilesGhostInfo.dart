...
class IOfflineFilesGhostInfo extends IUnknown {
  ...
  int IsGhosted(Pointer<Int32> pbGhosted) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> pbGhosted)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Int32> pbGhosted)>()(
      ptr.ref.lpVtbl, pbGhosted);
}
