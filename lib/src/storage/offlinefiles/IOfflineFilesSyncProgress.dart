...
class IOfflineFilesSyncProgress extends IOfflineFilesProgress {
  ...
  int SyncItemBegin(Pointer<Utf16> pszFile, Pointer<Int32> pResponse) => ptr
      .ref.lpVtbl.value
      .elementAt(6)
      .cast<
          Pointer<
  ...
  int SyncItemResult(Pointer<Utf16> pszFile, int hrResult,
          Pointer<COMObject> pErrorInfo, Pointer<Int32> pResponse) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pErrorInfo,
                      Pointer<Int32> pResponse)>()(
          ptr.ref.lpVtbl, pszFile, hrResult, pErrorInfo, pResponse);
}
