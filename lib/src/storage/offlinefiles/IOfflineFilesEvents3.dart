...
class IOfflineFilesEvents3 extends IOfflineFilesEvents2 {
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int bModifiedData,
                      int bModifiedAttributes,
                      Pointer<Utf16> pzsOldPath)>()(ptr.ref.lpVtbl, pszPath,
          EventType, ItemType, bModifiedData, bModifiedAttributes, pzsOldPath);

  int PrefetchFileBegin(Pointer<Utf16> pszPath) => ptr.ref.lpVtbl.value
          .elementAt(38)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int PrefetchFileEnd(Pointer<Utf16> pszPath, int hrResult) =>
      ptr.ref.lpVtbl.value
          .elementAt(39)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Utf16> pszPath, Int32 hrResult)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Utf16> pszPath,
                  int hrResult)>()(ptr.ref.lpVtbl, pszPath, hrResult);
}
