...
class IOfflineFilesPinInfo2 extends IOfflineFilesPinInfo {
  ...
  int IsPartlyPinned(Pointer<Int32> pbPartlyPinned) => ptr.ref.lpVtbl.value
      .elementAt(8)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Int32> pbPartlyPinned)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<Int32> pbPartlyPinned)>()(ptr.ref.lpVtbl, pbPartlyPinned);
}
