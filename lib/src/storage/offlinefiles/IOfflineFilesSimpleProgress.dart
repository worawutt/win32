...
class IOfflineFilesSimpleProgress extends IOfflineFilesProgress {
  ...
  int ItemBegin(Pointer<Utf16> pszFile, Pointer<Int32> pResponse) => ptr
      .ref.lpVtbl.value
      .elementAt(6)
      .cast<
          Pointer<
      ...
      .asFunction<
          int Function(Pointer, Pointer<Utf16> pszFile,
              Pointer<Int32> pResponse)>()(ptr.ref.lpVtbl, pszFile, pResponse);

  int ItemResult(
          Pointer<Utf16> pszFile, int hrResult, Pointer<Int32> pResponse) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> pszFile,
                              Int32 hrResult, Pointer<Int32> pResponse)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> pszFile, int hrResult,
                      Pointer<Int32> pResponse)>()(
          ptr.ref.lpVtbl, pszFile, hrResult, pResponse);
}
