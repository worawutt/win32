...
class IOfflineFilesSuspend extends IUnknown {
  ...
  int SuspendRoot(int bSuspend) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 bSuspend)>>>()
      .value
      .asFunction<
          int Function(Pointer, int bSuspend)>()(ptr.ref.lpVtbl, bSuspend);
}
