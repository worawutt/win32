...
class IOfflineFilesItemContainer extends IUnknown {
  ...
  int EnumItems(int dwQueryFlags, Pointer<Pointer<COMObject>> ppenum) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint32 dwQueryFlags,
                              Pointer<Pointer<COMObject>> ppenum)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int dwQueryFlags,
                      Pointer<Pointer<COMObject>> ppenum)>()(
          ptr.ref.lpVtbl, dwQueryFlags, ppenum);
