...
typedef _Ignore_Native = Int32 Function(
  Pointer,
  Pointer<Utf16> word
);
typedef _Ignore_Dart = int Function(
  Pointer,
  Pointer<Utf16> word
);
...
class ISpellChecker extends IUnknown {
  ...
  int Add(Pointer<Utf16> word) => ptr.ref.lpVtbl.value      .elementAt(6)
      .cast<Pointer<NativeFunction<_Add_Native>>>()
      .value
      .asFunction<_Add_Dart>()(ptr.ref.lpVtbl, word);

  int Ignore(Pointer<Utf16> word) => ptr.ref.lpVtbl.value      .elementAt(7)
      .cast<Pointer<NativeFunction<_Ignore_Native>>>()
      .value
      .asFunction<_Ignore_Dart>()(ptr.ref.lpVtbl, word);

  int AutoCorrect(Pointer<Utf16> from, Pointer<Utf16> to) => ptr.ref.lpVtbl.value      .elementAt(8)
      .cast<Pointer<NativeFunction<_AutoCorrect_Native>>>()
      .value
      .asFunction<_AutoCorrect_Dart>()(ptr.ref.lpVtbl, from, to);

  int GetOptionValue(Pointer<Utf16> optionId, Pointer<Uint8> value) => ptr.ref.lpVtbl.value      .elementAt(9)
  ...
  int add_SpellCheckerChanged(COMObject handler, Pointer<Uint32> eventCookie) => ptr.ref.lpVtbl.value      .elementAt(13)
      .cast<Pointer<NativeFunction<_add_SpellCheckerChanged_Native>>>()
      .value
      .asFunction<_add_SpellCheckerChanged_Dart>()(ptr.ref.lpVtbl, handler, eventCookie);

  int remove_SpellCheckerChanged(int eventCookie) => ptr.ref.lpVtbl.value      .elementAt(14)
      .cast<Pointer<NativeFunction<_remove_SpellCheckerChanged_Native>>>()
      .value
      .asFunction<_remove_SpellCheckerChanged_Dart>()(ptr.ref.lpVtbl, eventCookie);

  int GetOptionDescription(Pointer<Utf16> optionId, Pointer<COMObject> value) => ptr.ref.lpVtbl.value      .elementAt(15)
  ...
  int ComprehensiveCheck(Pointer<Utf16> text, Pointer<COMObject> value) => ptr.ref.lpVtbl.value      .elementAt(16)
