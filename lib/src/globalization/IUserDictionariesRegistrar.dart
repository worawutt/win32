...
class IUserDictionariesRegistrar extends IUnknown {
  ...
  int RegisterUserDictionary(
          Pointer<Utf16> dictionaryPath, Pointer<Utf16> languageTag) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> dictionaryPath,
                              Pointer<Utf16> languageTag)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> dictionaryPath,
                      Pointer<Utf16> languageTag)>()(
          ptr.ref.lpVtbl, dictionaryPath, languageTag);
