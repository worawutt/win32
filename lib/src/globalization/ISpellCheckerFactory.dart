...
class ISpellCheckerFactory extends IUnknown {
  ...
  int CreateSpellChecker(Pointer<Utf16> languageTag, Pointer<COMObject> value) => ptr.ref.lpVtbl.value      .elementAt(5)
      .cast<Pointer<NativeFunction<_CreateSpellChecker_Native>>>()
      .value
      .asFunction<_CreateSpellChecker_Dart>()(ptr.ref.lpVtbl, languageTag, value);
