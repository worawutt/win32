...
class DetectEncodingInfo extends Struct {
  @Uint32() external int nLangID;
  @Uint32() external int nCodePage;
  @Int32() external int nDocPercent;
  @Int32() external int nConfidence;
}
...
class MAPPING_OPTIONS extends Struct {
  ...
  external Pointer<NativeFunction<PFN_MAPPINGCALLBACKPROC>> pfnRecognizeCallback;
...
class MIMECPINFO extends Struct {
  ...
  @Uint32() external int uiCodePage;
  @Uint32() external int uiFamilyCodePage;
  @Array(64)
  ...
  @Uint8() external int bGDICharset;
}

/// {@category Struct}
class MIMECSETINFO extends Struct {
  @Uint32() external int uiCodePage;
  @Uint32() external int uiInternetEncoding;
  @Array(50)
...
class UCPTrie extends Struct {
  ...
  @Int32() external int indexLength;
  @Int32() external int dataLength;
  @Int32() external int highStart;
  @Uint16() external int shifted12HighStart;
  @Int8() external int type;
  @Int8() external int valueWidth;
  @Uint32() external int reserved32;
  @Uint16() external int reserved16;
  @Uint16() external int index3NullOffset;
  @Int32() external int dataNullOffset;
  @Uint32() external int nullValue;
}

/// {@category Struct}
class UCPTrieData extends Struct {
...
class UNICODERANGE extends Struct {
  @Uint16() external int wcFrom;
  @Uint16() external int wcTo;
}
...
class UTextFuncs extends Struct {
  ...
  external Pointer<NativeFunction<UTextMapNativeIndexToUTF16>> mapNativeIndexToUTF16;
