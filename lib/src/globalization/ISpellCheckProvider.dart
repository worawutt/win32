...
class ISpellCheckProvider extends IUnknown {
  ...
  int SetOptionValue(Pointer<Utf16> optionId, int value) => ptr.ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Utf16> optionId, Uint8 value)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Utf16> optionId, int value)>()(
  ...
  int InitializeWordlist(int wordlistType, Pointer<COMObject> words) => ptr
      .ref.lpVtbl.value
      .elementAt(12)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Int32 wordlistType,
                      Pointer<COMObject> words)>>>()
      .value
      .asFunction<
          int Function(Pointer, int wordlistType,
              Pointer<COMObject> words)>()(ptr.ref.lpVtbl, wordlistType, words);
}
