...
typedef PIBIO_ENGINE_GET_ENROLLMENT_STATUS_FN = Int32 Function(
    Pointer<WINBIO_PIPELINE> Pipeline, Pointer<Uint32> RejectDetail);
...
typedef PIBIO_ENGINE_NOTIFY_POWER_CHANGE_FN = Int32 Function(
    Pointer<WINBIO_PIPELINE> Pipeline, Uint32 PowerEventType);
...
typedef PIBIO_ENGINE_QUERY_INDEX_VECTOR_SIZE_FN = Int32 Function(
    Pointer<WINBIO_PIPELINE> Pipeline, Pointer<IntPtr> IndexElementCount);
...
typedef PIBIO_ENGINE_QUERY_SAMPLE_HINT_FN = Int32 Function(
    Pointer<WINBIO_PIPELINE> Pipeline, Pointer<IntPtr> SampleHint);
typedef PIBIO_ENGINE_REFRESH_CACHE_FN = Int32 Function(
    Pointer<WINBIO_PIPELINE> Pipeline);
typedef PIBIO_ENGINE_RESERVED_1_FN = Int32 Function(
    Pointer<WINBIO_PIPELINE> Pipeline, Pointer<WINBIO_IDENTITY> Identity);
...
typedef PIBIO_ENGINE_SET_ENROLLMENT_SELECTOR_FN = Int32 Function(
    Pointer<WINBIO_PIPELINE> Pipeline, Uint64 SelectorValue);
...
typedef PIBIO_FRAMEWORK_FREE_MEMORY_FN = Int32 Function(
    Pointer<WINBIO_PIPELINE> Pipeline, Pointer Address);
...
typedef PIBIO_FRAMEWORK_RELEASE_SECURE_BUFFER_FN = Int32 Function(
    Pointer<WINBIO_PIPELINE> Pipeline, GUID SecureBufferIdentifier);
...
typedef PIBIO_SENSOR_FINISH_NOTIFY_WAKE_FN = Int32 Function(
    Pointer<WINBIO_PIPELINE> Pipeline, Pointer<Uint32> Reason);
typedef PIBIO_SENSOR_GET_INDICATOR_STATUS_FN = Int32 Function(
    Pointer<WINBIO_PIPELINE> Pipeline, Pointer<Uint32> IndicatorStatus);
...
typedef PIBIO_SENSOR_START_NOTIFY_WAKE_FN = Int32 Function(
    Pointer<WINBIO_PIPELINE> Pipeline, Pointer<Pointer<OVERLAPPED>> Overlapped);
...
typedef PWINBIO_ENROLL_CAPTURE_CALLBACK = Void Function(
    Pointer EnrollCallbackContext, Int32 OperationStatus, Uint32 RejectDetail);
typedef PWINBIO_EVENT_CALLBACK = Void Function(Pointer EventCallbackContext,
    Int32 OperationStatus, Pointer<WINBIO_EVENT> Event);
...
typedef PWINBIO_LOCATE_SENSOR_CALLBACK = Void Function(
    Pointer LocateCallbackContext, Int32 OperationStatus, Uint32 UnitId);
...
typedef PWINBIO_VERIFY_CALLBACK = Void Function(Pointer VerifyCallbackContext,
    Int32 OperationStatus, Uint32 UnitId, Uint8 Match, Uint32 RejectDetail);
