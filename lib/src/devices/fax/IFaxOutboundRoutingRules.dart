...
class IFaxOutboundRoutingRules extends IDispatch {
  ...
  int get_Item(
          int lIndex, Pointer<Pointer<COMObject>> pFaxOutboundRoutingRule) =>
      ptr.ref.lpVtbl.value
          ...
          ptr.ref.lpVtbl, lIndex, pFaxOutboundRoutingRule);
  ...
  int ItemByCountryAndArea(int lCountryCode, int lAreaCode,
          Pointer<Pointer<COMObject>> pFaxOutboundRoutingRule) =>
      ptr.ref.lpVtbl.value
              .elementAt(10)
              .cast<
              ...
              .value
              .asFunction<
                  int Function(Pointer, int lCountryCode, int lAreaCode,
                      Pointer<Pointer<COMObject>> pFaxOutboundRoutingRule)>()(
          ptr.ref.lpVtbl, lCountryCode, lAreaCode, pFaxOutboundRoutingRule);

  int RemoveByCountryAndArea(int lCountryCode, int lAreaCode) => ptr
          .ref.lpVtbl.value
          .elementAt(11)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Int32 lCountryCode, Int32 lAreaCode)>>>()
          .value
          .asFunction<int Function(Pointer, int lCountryCode, int lAreaCode)>()(
      ptr.ref.lpVtbl, lCountryCode, lAreaCode);
