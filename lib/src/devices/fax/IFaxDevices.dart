...
class IFaxDevices extends IDispatch {
  ...
  int get_Item(VARIANT vIndex, Pointer<Pointer<COMObject>> pFaxDevice) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, VARIANT vIndex,
                              Pointer<Pointer<COMObject>> pFaxDevice)>>>()
              .value
              .asFunction<
                  int Function(Pointer, VARIANT vIndex,
                      Pointer<Pointer<COMObject>> pFaxDevice)>()(
          ptr.ref.lpVtbl, vIndex, pFaxDevice);
  ...
  int get_ItemById(int lId, Pointer<Pointer<COMObject>> ppFaxDevice) => ptr
          .ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 lId,
                          Pointer<Pointer<COMObject>> ppFaxDevice)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer, int lId, Pointer<Pointer<COMObject>> ppFaxDevice)>()(
      ptr.ref.lpVtbl, lId, ppFaxDevice);
}
