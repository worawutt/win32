...
/// @nodoc
const CLSID_FaxInboundRoutingExtension = '{1D7DFB51-7207-4436-A0D9-24E32EE56988}';
/// @nodoc
const IID_IFaxInboundRoutingExtension = '{885B5E08-C26C-4EF9-AF83-51580A750BE1}';
...
typedef _get_Methods_Native = Int32 Function(
  Pointer,
  Pointer<VARIANT> );
typedef _get_Methods_Dart = int Function(
  Pointer,
  Pointer<VARIANT> );
   ...
   IFaxInboundRoutingExtension(Pointer<COMObject> ptr) : super(ptr);
    ...
    VARIANT get Methods {
      ...
      try {
        final hr = ptr.ref.lpVtbl.value
          .elementAt(17)
          .cast<Pointer<NativeFunction<_get_Methods_Native>>>()
          .value
          .asFunction<_get_Methods_Dart>()(ptr.ref.lpVtbl, retValuePtr);
