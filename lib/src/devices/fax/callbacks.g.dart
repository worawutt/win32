...
typedef PFAXABORT = Int32 Function(IntPtr FaxHandle, Uint32 JobId);
typedef PFAXACCESSCHECK = Int32 Function(IntPtr FaxHandle, Uint32 AccessMask);
typedef PFAXCLOSE = Int32 Function(IntPtr FaxHandle);
...
typedef PFAXDEVABORTOPERATION = Int32 Function(IntPtr param0);
typedef PFAXDEVCONFIGURE = Int32 Function(Pointer<IntPtr> param0);
typedef PFAXDEVENDJOB = Int32 Function(IntPtr param0);
...
typedef PFAXDEVRECEIVE = Int32 Function(
    IntPtr param0, Uint32 param1, Pointer<FAX_RECEIVE> param2);
typedef PFAXDEVREPORTSTATUS = Int32 Function(IntPtr param0,
    Pointer<FAX_DEV_STATUS> param1, Uint32 param2, Pointer<Uint32> param3);
typedef PFAXDEVSEND = Int32 Function(IntPtr param0, Pointer<FAX_SEND> param1,
    Pointer<NativeFunction<PFAX_SEND_CALLBACK>> param2);
typedef PFAXDEVSHUTDOWN = Int32 Function();
typedef PFAXDEVSTARTJOB = Int32 Function(Uint32 param0, Uint32 param1,
    Pointer<IntPtr> param2, IntPtr param3, IntPtr param4);
...
typedef PFAXENUMJOBSW = Int32 Function(IntPtr FaxHandle,
    Pointer<Pointer<FAX_JOB_ENTRY>> JobEntry, Pointer<Uint32> JobsReturned);
typedef PFAXENUMPORTSW = Int32 Function(IntPtr FaxHandle,
    Pointer<Pointer<FAX_PORT_INFO>> PortInfo, Pointer<Uint32> PortsReturned);
typedef PFAXENUMROUTINGMETHODSW = Int32 Function(
    IntPtr FaxPortHandle,
    Pointer<Pointer<FAX_ROUTING_METHOD>> RoutingMethod,
    Pointer<Uint32> MethodsReturned);
typedef PFAXFREEBUFFER = Void Function(Pointer Buffer);
...
typedef PFAXGETJOBW = Int32 Function(
    IntPtr FaxHandle, Uint32 JobId, Pointer<Pointer<FAX_JOB_ENTRY>> JobEntry);
...
typedef PFAXINITIALIZEEVENTQUEUE = Int32 Function(
    ...
    IntPtr hWnd,
    Uint32 MessageStart);
typedef PFAXOPENPORT = Int32 Function(IntPtr FaxHandle, Uint32 DeviceId,
    Uint32 Flags, Pointer<IntPtr> FaxPortHandle);
...
typedef PFAXROUTEADDFILE = Int32 Function(
    Uint32 JobId, Pointer<Utf16> FileName, Pointer<GUID> Guid);
typedef PFAXROUTEDELETEFILE = Int32 Function(
    Uint32 JobId, Pointer<Utf16> FileName);
typedef PFAXROUTEDEVICECHANGENOTIFICATION = Int32 Function(
    Uint32 param0, Int32 param1);
typedef PFAXROUTEDEVICEENABLE = Int32 Function(
    Pointer<Utf16> param0, Uint32 param1, Int32 param2);
typedef PFAXROUTEENUMFILE = Int32 Function(
    ...
    Pointer Context);
typedef PFAXROUTEENUMFILES = Int32 Function(Uint32 JobId, Pointer<GUID> Guid,
    Pointer<NativeFunction<PFAXROUTEENUMFILE>> FileEnumerator, Pointer Context);
typedef PFAXROUTEGETFILE = Int32 Function(Uint32 JobId, Uint32 Index,
    Pointer<Utf16> FileNameBuffer, Pointer<Uint32> RequiredSize);
typedef PFAXROUTEGETROUTINGINFO = Int32 Function(Pointer<Utf16> param0,
    Uint32 param1, Pointer<Uint8> param2, Pointer<Uint32> param3);
typedef PFAXROUTEINITIALIZE = Int32 Function(
    IntPtr param0, Pointer<FAX_ROUTE_CALLBACKROUTINES> param1);
typedef PFAXROUTEMETHOD = Int32 Function(
    Pointer<FAX_ROUTE> param0, Pointer<Pointer> param1, Pointer<Uint32> param2);
...
typedef PFAXROUTESETROUTINGINFO = Int32 Function(
    Pointer<Utf16> param0, Uint32 param1, Pointer<Uint8> param2, Uint32 param3);
...
typedef PFAXSETCONFIGURATIONW = Int32 Function(
    IntPtr FaxHandle, Pointer<FAX_CONFIGURATION> FaxConfig);
typedef PFAXSETGLOBALROUTINGINFOW = Int32 Function(
    IntPtr FaxPortHandle, Pointer<FAX_GLOBAL_ROUTING_INFO> RoutingInfo);
typedef PFAXSETJOBW = Int32 Function(IntPtr FaxHandle, Uint32 JobId,
    Uint32 Command, Pointer<FAX_JOB_ENTRY> JobEntry);
typedef PFAXSETLOGGINGCATEGORIESW = Int32 Function(IntPtr FaxHandle,
    Pointer<FAX_LOG_CATEGORY> Categories, Uint32 NumberCategories);
typedef PFAXSETPORTW = Int32 Function(
    IntPtr FaxPortHandle, Pointer<FAX_PORT_INFO> PortInfo);
...
typedef PFAX_EXT_CONFIG_CHANGE = Int32 Function(
    Uint32 param0, Pointer<Utf16> param1, Pointer<Uint8> param2, Uint32 param3);
typedef PFAX_EXT_FREE_BUFFER = Void Function(Pointer param0);
...
typedef PFAX_EXT_SET_DATA = Uint32 Function(IntPtr param0, Uint32 param1,
    Int32 param2, Pointer<Utf16> param3, Pointer<Uint8> param4, Uint32 param5);
typedef PFAX_EXT_UNREGISTER_FOR_EVENTS = Uint32 Function(IntPtr param0);
...
typedef PFAX_SEND_CALLBACK = Int32 Function(
    IntPtr FaxHandle, Uint32 CallHandle, Uint32 Reserved1, Uint32 Reserved2);
typedef PFAX_SERVICE_CALLBACK = Int32 Function(IntPtr FaxHandle,
    Uint32 DeviceId, IntPtr Param1, IntPtr Param2, IntPtr Param3);
