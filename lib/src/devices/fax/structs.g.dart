...
class FAX_ROUTE_CALLBACKROUTINES extends Struct {
  ...
  external Pointer<NativeFunction<PFAXROUTEMODIFYROUTINGDATA>> FaxRouteModifyRoutingData;
}
...
/// {@category Struct}
class IStiDevice extends Opaque {
}
...
class STISUBSCRIBE extends Struct {
  ...
  @Uint32() external int dwFilter;
  @IntPtr() external int hWndNotify;
  @IntPtr() external int hEvent;
  @Uint32() external int uiNotificationMessage;
}
...
class STI_DEVICE_INFORMATION extends Struct {
  ...
  @Uint32() external int dwHardwareConfiguration;
...
class STI_DEVICE_STATUS extends Struct {
  @Uint32() external int dwSize;
  @Uint32() external int StatusMask;
  @Uint32() external int dwOnlineState;
  @Uint32() external int dwHardwareStatusCode;
  @Uint32() external int dwEventHandlingState;
  @Uint32() external int dwPollingInterval;
}

/// {@category Struct}
class STI_DEV_CAPS extends Struct {
  @Uint32() external int dwGeneric;
}

/// {@category Struct}
class STI_DIAG extends Struct {
  @Uint32() external int dwSize;
  @Uint32() external int dwBasicDiagCode;
  @Uint32() external int dwVendorDiagCode;
  @Uint32() external int dwStatusMask;
...
class STI_USD_CAPS extends Struct {
  ...
  @Uint32() external int dwGenericCaps;
}
...
class ERROR_INFO extends Struct {
  @Uint32() external int dwSize;
  @Uint32() external int dwGenericError;
  @Uint32() external int dwVendorError;
  @Array(255)
