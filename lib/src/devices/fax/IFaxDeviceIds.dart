...
class IFaxDeviceIds extends IDispatch {
  ...
  int get_Item(int lIndex, Pointer<Int32> plDeviceId) => ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Int32 lIndex, Pointer<Int32> plDeviceId)>>>()
          .value
          .asFunction<
              int Function(Pointer, int lIndex, Pointer<Int32> plDeviceId)>()(
      ptr.ref.lpVtbl, lIndex, plDeviceId);
  ...
  int Add(int lDeviceId) => ptr.ref.lpVtbl.value
      .elementAt(10)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 lDeviceId)>>>()
      .value
      .asFunction<
          int Function(Pointer, int lDeviceId)>()(ptr.ref.lpVtbl, lDeviceId);
  ...
  int SetOrder(int lDeviceId, int lNewOrder) => ptr.ref.lpVtbl.value
      .elementAt(12)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Int32 lDeviceId, Int32 lNewOrder)>>>()
      .value
      .asFunction<
          int Function(Pointer, int lDeviceId,
              int lNewOrder)>()(ptr.ref.lpVtbl, lDeviceId, lNewOrder);
}
