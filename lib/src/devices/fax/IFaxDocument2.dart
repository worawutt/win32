...
class IFaxDocument2 extends IFaxDocument {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<VARIANT> pvBodies)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<VARIANT> pvBodies)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  set Bodies(VARIANT value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(43)
        .cast<
            Pointer<NativeFunction<Int32 Function(Pointer, VARIANT vBodies)>>>()
        .value
        .asFunction<
            int Function(Pointer, VARIANT vBodies)>()(ptr.ref.lpVtbl, value);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> bstrFaxServerName,
                      Pointer<VARIANT> pvFaxOutgoingJobIDs,
                      Pointer<Int32> plErrorBodyFile)>()(ptr.ref.lpVtbl,
          bstrFaxServerName, pvFaxOutgoingJobIDs, plErrorBodyFile);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<VARIANT> pvFaxOutgoingJobIDs,
                      Pointer<Int32> plErrorBodyFile)>()(
          ptr.ref.lpVtbl, pFaxServer, pvFaxOutgoingJobIDs, plErrorBodyFile);
}
