...
class IFaxAccount extends IDispatch {
  ...
  Pointer<Utf16> get AccountName {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> pbstrAccountName)>()(
  ...
  Pointer<COMObject> get Folders {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppFolders)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  int ListenToAccountEvents(int EventTypes) => ptr.ref.lpVtbl.value
      .elementAt(9)
      .cast<
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Int32> pRegisteredEvents)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> pRegisteredEvents)>()(
          ptr.ref.lpVtbl, retValuePtr);
