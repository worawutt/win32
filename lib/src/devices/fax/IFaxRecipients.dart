...
class IFaxRecipients extends IDispatch {
  ...
  int get_Item(int lIndex, Pointer<Pointer<COMObject>> ppFaxRecipient) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int lIndex,
                      Pointer<Pointer<COMObject>> ppFaxRecipient)>()(
          ptr.ref.lpVtbl, lIndex, ppFaxRecipient);
  ...
  int Add(Pointer<Utf16> bstrFaxNumber, Pointer<Utf16> bstrRecipientName,
          Pointer<Pointer<COMObject>> ppFaxRecipient) =>
      ptr.ref.lpVtbl.value
              .elementAt(10)
              .cast<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> bstrRecipientName,
                      Pointer<Pointer<COMObject>> ppFaxRecipient)>()(
          ptr.ref.lpVtbl, bstrFaxNumber, bstrRecipientName, ppFaxRecipient);
