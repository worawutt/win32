...
class IFaxOutboundRouting extends IDispatch {
  ...
  int GetGroups(Pointer<Pointer<COMObject>> pFaxOutboundRoutingGroups) =>
      ptr.ref.lpVtbl.value
          ...
          ptr.ref.lpVtbl, pFaxOutboundRoutingGroups);

  int GetRules(Pointer<Pointer<COMObject>> pFaxOutboundRoutingRules) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
                  Pointer<
          ...
          ptr.ref.lpVtbl, pFaxOutboundRoutingRules);
}
