          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<COMObject>>
                      ppFaxConfiguration)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  Pointer<COMObject> get CurrentAccount {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppCurrentAccount)>()(
  ...
  Pointer<COMObject> get FaxAccountSet {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppFaxAccountSet)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  Pointer<COMObject> get Security2 {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppFaxSecurity2)>()(
          ptr.ref.lpVtbl, retValuePtr);
