...
class IFaxOutboundRoutingRule extends IDispatch {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> plAreaCode)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int32> plAreaCode)>()(ptr.ref.lpVtbl, retValuePtr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int16> pbUseDevice)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int16> pbUseDevice)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  set UseDevice(int value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<Int32 Function(Pointer, Int16 bUseDevice)>>>()
        .value
        .asFunction<
            int Function(Pointer, int bUseDevice)>()(ptr.ref.lpVtbl, value);
  ...
  set DeviceId(int value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(13)
        .cast<
            Pointer<NativeFunction<Int32 Function(Pointer, Int32 DeviceId)>>>()
        .value
        .asFunction<
            int Function(Pointer, int DeviceId)>()(ptr.ref.lpVtbl, value);
  ...
  Pointer<Utf16> get GroupName {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> pbstrGroupName)>()(
          ptr.ref.lpVtbl, retValuePtr);
