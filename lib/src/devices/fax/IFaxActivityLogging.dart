...
class IFaxActivityLogging extends IDispatch {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int16> pbLogIncoming)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int16> pbLogIncoming)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  set LogIncoming(int value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<Int32 Function(Pointer, Int16 bLogIncoming)>>>()
        .value
        .asFunction<
            int Function(Pointer, int bLogIncoming)>()(ptr.ref.lpVtbl, value);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int16> pbLogOutgoing)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int16> pbLogOutgoing)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  set LogOutgoing(int value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<Int32 Function(Pointer, Int16 bLogOutgoing)>>>()
        .value
        .asFunction<
            int Function(Pointer, int bLogOutgoing)>()(ptr.ref.lpVtbl, value);
  ...
  Pointer<Utf16> get DatabasePath {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> pbstrDatabasePath)>()(
    ...
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(
                            Pointer, Pointer<Utf16> bstrDatabasePath)>>>()
            .value
            .asFunction<
                int Function(Pointer, Pointer<Utf16> bstrDatabasePath)>()(
