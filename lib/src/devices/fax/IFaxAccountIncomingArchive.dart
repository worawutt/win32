...
/// @nodoc
const CLSID_FaxAccountIncomingArchive = '{14B33DB5-4C40-4ECF-9EF8-A360CBE809ED}';
/// @nodoc
...
typedef _GetMessages_Native = Int32 Function(
  Pointer,
  Int32 lPrefetchSize, 
  Pointer<COMObject> pFaxIncomingMessageIterator
);
...
typedef _GetMessage_Native = Int32 Function(
  ...
  Pointer<COMObject> pFaxIncomingMessage
);
...
class IFaxAccountIncomingArchive extends IDispatch {
  ...
  int GetMessages(int lPrefetchSize, Pointer<COMObject> pFaxIncomingMessageIterator) => ptr.ref.lpVtbl.value      .elementAt(10)
      .cast<Pointer<NativeFunction<_GetMessages_Native>>>()
      .value
      .asFunction<_GetMessages_Dart>()(ptr.ref.lpVtbl, lPrefetchSize, pFaxIncomingMessageIterator);

  int GetMessage(Pointer<Utf16> bstrMessageId, Pointer<COMObject> pFaxIncomingMessage) => ptr.ref.lpVtbl.value      .elementAt(11)
      .cast<Pointer<NativeFunction<_GetMessage_Native>>>()
      .value
      .asFunction<_GetMessage_Dart>()(ptr.ref.lpVtbl, bstrMessageId, pFaxIncomingMessage);
