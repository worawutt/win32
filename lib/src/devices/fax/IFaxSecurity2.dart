...
class IFaxSecurity2 extends IDispatch {
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<VARIANT> pvDescriptor)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<VARIANT> pvDescriptor)>()(
  ...
  set Descriptor(VARIANT value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<Int32 Function(Pointer, VARIANT vDescriptor)>>>()
        .value
        .asFunction<
            int Function(
                Pointer, VARIANT vDescriptor)>()(ptr.ref.lpVtbl, value);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Int32> pGrantedRights)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> pGrantedRights)>()(
          ptr.ref.lpVtbl, retValuePtr);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Int32> plInformationType)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> plInformationType)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set InformationType(int value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(Pointer, Int32 lInformationType)>>>()
            .value
            .asFunction<int Function(Pointer, int lInformationType)>()(
