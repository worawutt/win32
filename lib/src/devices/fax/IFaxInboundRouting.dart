...
class IFaxInboundRouting extends IDispatch {
  ...
  int GetExtensions(Pointer<Pointer<COMObject>> pFaxInboundRoutingExtensions) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>>
                          pFaxInboundRoutingExtensions)>()(
          ptr.ref.lpVtbl, pFaxInboundRoutingExtensions);

  int GetMethods(Pointer<Pointer<COMObject>> pFaxInboundRoutingMethods) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
                  Pointer<
          ...
          ptr.ref.lpVtbl, pFaxInboundRoutingMethods);
}
