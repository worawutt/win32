...
class IFaxIncomingArchive extends IDispatch {
  ...
  int GetMessages(int lPrefetchSize, Pointer<COMObject> pFaxIncomingMessageIterator) => ptr.ref.lpVtbl.value      .elementAt(23)
  ...
  int GetMessage(Pointer<Utf16> bstrMessageId, Pointer<COMObject> pFaxIncomingMessage) => ptr.ref.lpVtbl.value      .elementAt(24)
