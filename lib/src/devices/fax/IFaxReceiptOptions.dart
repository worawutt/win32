...
class IFaxReceiptOptions extends IDispatch {
  ...
  Pointer<Utf16> get SMTPServer {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> pbstrSMTPServer)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set SMTPServer(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<
                    Int32 Function(Pointer, Pointer<Utf16> bstrSMTPServer)>>>()
        .value
        .asFunction<
            int Function(Pointer,
                Pointer<Utf16> bstrSMTPServer)>()(ptr.ref.lpVtbl, value);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> plSMTPPort)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int32> plSMTPPort)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  set SMTPPort(int value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(12)
        .cast<
            Pointer<NativeFunction<Int32 Function(Pointer, Int32 lSMTPPort)>>>()
        .value
        .asFunction<
            int Function(Pointer, int lSMTPPort)>()(ptr.ref.lpVtbl, value);
  ...
  Pointer<Utf16> get SMTPSender {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> pbstrSMTPSender)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set SMTPSender(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<
                    Int32 Function(Pointer, Pointer<Utf16> bstrSMTPSender)>>>()
        .value
        .asFunction<
            int Function(Pointer,
                Pointer<Utf16> bstrSMTPSender)>()(ptr.ref.lpVtbl, value);
  ...
  Pointer<Utf16> get SMTPUser {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> pbstrSMTPUser)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set SMTPUser(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<
                    Int32 Function(Pointer, Pointer<Utf16> bstrSMTPUser)>>>()
        .value
        .asFunction<
            int Function(
                Pointer, Pointer<Utf16> bstrSMTPUser)>()(ptr.ref.lpVtbl, value);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Int32> pAllowedReceipts)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> pAllowedReceipts)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set AllowedReceipts(int value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(Pointer, Int32 AllowedReceipts)>>>()
            .value
            .asFunction<int Function(Pointer, int AllowedReceipts)>()(
  ...
  Pointer<Utf16> get SMTPPassword {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> pbstrSMTPPassword)>()(
          ptr.ref.lpVtbl, retValuePtr);
    ...
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(
                            Pointer, Pointer<Utf16> bstrSMTPPassword)>>>()
            .value
            .asFunction<
                int Function(Pointer, Pointer<Utf16> bstrSMTPPassword)>()(
        ptr.ref.lpVtbl, value);
  ...
  int get UseForInboundRouting {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Int16> pbUseForInboundRouting)>()(
          ptr.ref.lpVtbl, retValuePtr);
        ...
        ptr.ref.lpVtbl.value
                ...
                .cast<
                    Pointer<
                        NativeFunction<
                            Int32 Function(
                                Pointer, Int16 bUseForInboundRouting)>>>()
                .value
                .asFunction<int Function(Pointer, int bUseForInboundRouting)>()(
            ptr.ref.lpVtbl, value);
