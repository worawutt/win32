...
class IFaxAccountSet extends IDispatch {
  ...
  int GetAccounts(Pointer<Pointer<COMObject>> ppFaxAccounts) => ptr
          .ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<COMObject>> ppFaxAccounts)>()(
      ptr.ref.lpVtbl, ppFaxAccounts);

  int
      GetAccount(Pointer<Utf16> bstrAccountName,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<Utf16> bstrAccountName,
                          Pointer<Pointer<COMObject>> pFaxAccount)>()(
              ptr.ref.lpVtbl, bstrAccountName, pFaxAccount);

  int
      AddAccount(Pointer<Utf16> bstrAccountName,
              Pointer<Pointer<COMObject>> pFaxAccount) =>
          ptr.ref.lpVtbl.value
                  .elementAt(9)
                  .cast<
  ...
  int RemoveAccount(Pointer<Utf16> bstrAccountName) =>
      ptr.ref.lpVtbl.value
              .elementAt(10)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Utf16> bstrAccountName)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrAccountName)>()(
          ptr.ref.lpVtbl, bstrAccountName);
}
