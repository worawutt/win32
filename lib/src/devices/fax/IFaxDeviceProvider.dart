  ...
  Pointer<Utf16> get ImageName {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> pbstrImageName)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  Pointer<Utf16> get UniqueName {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> pbstrUniqueName)>()(
          ptr.ref.lpVtbl, retValuePtr);
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<Utf16>>
                      pbstrTapiProviderName)>()(ptr.ref.lpVtbl, retValuePtr);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Int32> plInitErrorCode)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> plInitErrorCode)>()(
          ptr.ref.lpVtbl, retValuePtr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<VARIANT> pvDeviceIds)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<VARIANT> pvDeviceIds)>()(ptr.ref.lpVtbl, retValuePtr);
