...
class IFaxOutboundRoutingGroups extends IDispatch {
  ...
  int get_Item(VARIANT vIndex,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, VARIANT vIndex,
                      Pointer<Pointer<COMObject>> pFaxOutboundRoutingGroup)>()(
          ptr.ref.lpVtbl, vIndex, pFaxOutboundRoutingGroup);
  ...
  int Add(Pointer<Utf16> bstrName,
          Pointer<Pointer<COMObject>> pFaxOutboundRoutingGroup) =>
      ptr.ref.lpVtbl.value
              .elementAt(10)
              .cast<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrName,
                      Pointer<Pointer<COMObject>> pFaxOutboundRoutingGroup)>()(
          ptr.ref.lpVtbl, bstrName, pFaxOutboundRoutingGroup);

  int Remove(VARIANT vIndex) => ptr.ref.lpVtbl.value
      .elementAt(11)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, VARIANT vIndex)>>>()
      .value
      .asFunction<
          int Function(Pointer, VARIANT vIndex)>()(ptr.ref.lpVtbl, vIndex);
}
