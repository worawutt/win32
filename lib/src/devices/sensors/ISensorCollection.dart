...
class ISensorCollection extends IUnknown {
  ...
  int Add(Pointer<COMObject> pSensor) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int Remove(Pointer<COMObject> pSensor) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int RemoveByID(Pointer<GUID> sensorID) => ptr.ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
                  NativeFunction<
