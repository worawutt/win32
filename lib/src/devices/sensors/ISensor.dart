...
class ISensor extends IUnknown {
  ...
  int GetID(Pointer<GUID> pID) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
  ...
  int GetType(Pointer<GUID> pSensorType) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetState(Pointer<Int32> pState) => ptr.ref.lpVtbl.value
      .elementAt(12)
      .cast<
          Pointer<
  ...
  int GetData(Pointer<Pointer<COMObject>> ppDataReport) => ptr.ref.lpVtbl.value
          .elementAt(13)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int SetEventInterest(Pointer<GUID> pValues, int count) => ptr.ref.lpVtbl.value
          .elementAt(16)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int SetEventSink(Pointer<COMObject> pEvents) => ptr.ref.lpVtbl.value
          .elementAt(17)
          .cast<
              Pointer<
                  NativeFunction<
