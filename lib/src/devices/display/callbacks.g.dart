...
typedef FREEOBJPROC = Int32 Function(Pointer<DRIVEROBJ> pDriverObj);
typedef PFN = IntPtr Function();
typedef PFN_DrvAccumulateD3DDirtyRect = Int32 Function(
    Pointer<SURFOBJ> param0, Pointer<CDDDXGK_REDIRBITMAPPRESENTINFO> param1);
...
typedef PFN_DrvAssertMode = Int32 Function(IntPtr param0, Int32 param1);
typedef PFN_DrvAssociateSharedSurface = Int32 Function(
    Pointer<SURFOBJ> param0, IntPtr param1, IntPtr param2, SIZE param3);
typedef PFN_DrvBitBlt = Int32 Function(
    ...
    Uint32 param10);
typedef PFN_DrvCompletePDEV = Void Function(IntPtr param0, IntPtr param1);
...
typedef PFN_DrvCreateDeviceBitmap = IntPtr Function(
    IntPtr param0, SIZE param1, Uint32 param2);
...
typedef PFN_DrvDeleteDeviceBitmap = Void Function(IntPtr param0);
typedef PFN_DrvDeleteDeviceBitmapEx = Void Function(IntPtr param0);
typedef PFN_DrvDeriveSurface = IntPtr Function(
    Pointer<DD_DIRECTDRAW_GLOBAL> param0, Pointer<DD_SURFACE_LOCAL> param1);
typedef PFN_DrvDescribePixelFormat = Int32 Function(IntPtr param0, Int32 param1,
    Uint32 param2, Pointer<PIXELFORMATDESCRIPTOR> param3);
typedef PFN_DrvDestroyFont = Void Function(Pointer<FONTOBJ> param0);
typedef PFN_DrvDisableDirectDraw = Void Function(IntPtr param0);
typedef PFN_DrvDisableDriver = Void Function();
typedef PFN_DrvDisablePDEV = Void Function(IntPtr param0);
typedef PFN_DrvDisableSurface = Void Function(IntPtr param0);
typedef PFN_DrvDitherColor = Uint32 Function(
    IntPtr param0, Uint32 param1, Uint32 param2, Pointer<Uint32> param3);
...
typedef PFN_DrvEnableDriver = Int32 Function(
    Uint32 param0, Uint32 param1, Pointer<DRVENABLEDATA> param2);
typedef PFN_DrvEnablePDEV = IntPtr Function(
    ...
    IntPtr param10);
typedef PFN_DrvEnableSurface = IntPtr Function(IntPtr param0);
typedef PFN_DrvEndDoc = Int32 Function(Pointer<SURFOBJ> pso, Uint32 fl);
typedef PFN_DrvEndDxInterop = Int32 Function(Pointer<SURFOBJ> param0,
    Int32 param1, Pointer<Int32> param2, Pointer KernelModeDeviceHandle);
typedef PFN_DrvEscape = Uint32 Function(Pointer<SURFOBJ> param0, Uint32 param1,
    Uint32 param2, Pointer param3, Uint32 param4, Pointer param5);
...
typedef PFN_DrvFontManagement = Uint32 Function(
    ...
    Uint32 param5,
    Pointer param6);
typedef PFN_DrvFree = Void Function(Pointer param0, IntPtr param1);
...
typedef PFN_DrvGetGlyphMode = Uint32 Function(
    IntPtr dhpdev, Pointer<FONTOBJ> pfo);
typedef PFN_DrvGetModes = Uint32 Function(
    IntPtr param0, Uint32 param1, Pointer<DEVMODE> param2);
typedef PFN_DrvGetTrueTypeFile = Pointer Function(
    IntPtr param0, Pointer<Uint32> param1);
typedef PFN_DrvGradientFill = Int32 Function(
    ...
    Uint32 param9);
typedef PFN_DrvIcmCheckBitmapBits = Int32 Function(IntPtr param0, IntPtr param1,
    Pointer<SURFOBJ> param2, Pointer<Uint8> param3);
...
typedef PFN_DrvIcmDeleteColorTransform = Int32 Function(
    IntPtr param0, IntPtr param1);
typedef PFN_DrvIcmSetDeviceGammaRamp = Int32 Function(
    IntPtr param0, Uint32 param1, Pointer param2);
...
typedef PFN_DrvLockDisplayArea = Void Function(
    IntPtr param0, Pointer<RECTL> param1);
typedef PFN_DrvMovePointer = Void Function(
    Pointer<SURFOBJ> pso, Int32 x, Int32 y, Pointer<RECTL> prcl);
typedef PFN_DrvNextBand = Int32 Function(
    Pointer<SURFOBJ> param0, Pointer<POINTL> ppointl);
typedef PFN_DrvNotify = Void Function(
    Pointer<SURFOBJ> param0, Uint32 param1, Pointer param2);
...
typedef PFN_DrvQueryFont = Pointer<IFIMETRICS> Function(
    IntPtr param0, IntPtr param1, Uint32 param2, Pointer<IntPtr> param3);
...
typedef PFN_DrvQueryFontFile = Int32 Function(
    IntPtr param0, Uint32 param1, Uint32 param2, Pointer<Uint32> param3);
typedef PFN_DrvQueryFontTree = Pointer Function(IntPtr param0, IntPtr param1,
    Uint32 param2, Uint32 param3, Pointer<IntPtr> param4);
...
typedef PFN_DrvQueryPerBandInfo = Int32 Function(
    Pointer<SURFOBJ> param0, Pointer<PERBANDINFO> param1);
typedef PFN_DrvQuerySpoolType = Int32 Function(
    IntPtr dhpdev, Pointer<Utf16> pwchType);
...
typedef PFN_DrvRenderHint = Int32 Function(
    IntPtr dhpdev, Uint32 NotifyCode, IntPtr Length, Pointer Data);
typedef PFN_DrvResetDevice = Uint32 Function(IntPtr param0, Pointer param1);
typedef PFN_DrvResetPDEV = Int32 Function(IntPtr dhpdevOld, IntPtr dhpdevNew);
typedef PFN_DrvSaveScreenBits = IntPtr Function(Pointer<SURFOBJ> param0,
    Uint32 param1, IntPtr param2, Pointer<RECTL> param3);
typedef PFN_DrvSendPage = Int32 Function(Pointer<SURFOBJ> param0);
typedef PFN_DrvSetPalette = Int32 Function(IntPtr param0,
    Pointer<PALOBJ> param1, Uint32 param2, Uint32 param3, Uint32 param4);
typedef PFN_DrvSetPixelFormat = Int32 Function(
    Pointer<SURFOBJ> param0, Int32 param1, IntPtr param2);
...
typedef PFN_DrvStartDoc = Int32 Function(
    Pointer<SURFOBJ> pso, Pointer<Utf16> pwszDocName, Uint32 dwJobId);
typedef PFN_DrvStartDxInterop = Int32 Function(
    Pointer<SURFOBJ> param0, Int32 param1, Pointer KernelModeDeviceHandle);
typedef PFN_DrvStartPage = Int32 Function(Pointer<SURFOBJ> pso);
...
typedef PFN_DrvStrokePath = Int32 Function(
    ...
    Uint32 param7);
typedef PFN_DrvSurfaceComplete = Int32 Function(IntPtr param0, IntPtr param1);
typedef PFN_DrvSwapBuffers = Int32 Function(
    Pointer<SURFOBJ> param0, Pointer<WNDOBJ> param1);
...
typedef PFN_DrvSynchronizeSurface = Void Function(
    Pointer<SURFOBJ> param0, Pointer<RECTL> param1, Uint32 param2);
...
typedef PFN_DrvTransparentBlt = Int32 Function(
    ...
    Uint32 param6,
    Uint32 param7);
typedef PFN_DrvUnloadFontFile = Int32 Function(IntPtr param0);
typedef PFN_DrvUnlockDisplayArea = Void Function(
    IntPtr param0, Pointer<RECTL> param1);
typedef PFN_EngCombineRgn = Int32 Function(
    IntPtr hrgnTrg, IntPtr hrgnSrc1, IntPtr hrgnSrc2, Int32 imode);
typedef PFN_EngCopyRgn = Int32 Function(IntPtr hrgnDst, IntPtr hrgnSrc);
typedef PFN_EngCreateRectRgn = IntPtr Function(
    Int32 left, Int32 top, Int32 right, Int32 bottom);
typedef PFN_EngDeleteRgn = Void Function(IntPtr hrgn);
typedef PFN_EngIntersectRgn = Int32 Function(
    IntPtr hrgnResult, IntPtr hRgnA, IntPtr hRgnB);
...
typedef SORTCOMP = Int32 Function(Pointer pv1, Pointer pv2);
typedef WNDOBJCHANGEPROC = Void Function(Pointer<WNDOBJ> pwo, Uint32 fl);
