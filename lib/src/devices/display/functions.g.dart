...
late final _GetNumberOfPhysicalMonitorsFromIDirect3DDevice9 =
    _dxva2.lookupFunction<
            Int32 Function(Pointer<COMObject> pDirect3DDevice9,
                Pointer<Uint32> pdwNumberOfPhysicalMonitors),
            int Function(Pointer<COMObject> pDirect3DDevice9,
                Pointer<Uint32> pdwNumberOfPhysicalMonitors)>(
...
late final _GetVCPFeatureAndVCPFeatureReply = _dxva2.lookupFunction<
    Int32 Function(IntPtr hMonitor, Uint8 bVCPCode, Pointer<Int32> pvct,
...
void EngAcquireSemaphore(int hsem) => _EngAcquireSemaphore(hsem);

late final _EngAcquireSemaphore =
    _gdi32.lookupFunction<Void Function(IntPtr hsem), void Function(int hsem)>(
        'EngAcquireSemaphore');
...
void EngDeleteSemaphore(int hsem) => _EngDeleteSemaphore(hsem);

late final _EngDeleteSemaphore =
    _gdi32.lookupFunction<Void Function(IntPtr hsem), void Function(int hsem)>(
        'EngDeleteSemaphore');
...
int EngQueryEMFInfo(int hdev, Pointer<EMFINFO> pEMFInfo) =>
    _EngQueryEMFInfo(hdev, pEMFInfo);

late final _EngQueryEMFInfo = _gdi32.lookupFunction<
    Int32 Function(IntPtr hdev, Pointer<EMFINFO> pEMFInfo),
    int Function(int hdev, Pointer<EMFINFO> pEMFInfo)>('EngQueryEMFInfo');
...
void EngReleaseSemaphore(int hsem) => _EngReleaseSemaphore(hsem);

late final _EngReleaseSemaphore =
    _gdi32.lookupFunction<Void Function(IntPtr hsem), void Function(int hsem)>(
        'EngReleaseSemaphore');
...
int GetAutoRotationState(Pointer<Int32> pState) =>
    _GetAutoRotationState(pState);

late final _GetAutoRotationState = _user32.lookupFunction<
    Int32 Function(Pointer<Int32> pState),
    int Function(Pointer<Int32> pState)>('GetAutoRotationState');
...
late final _QueryDisplayConfig = _user32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> numModeInfoArrayElements,
        Pointer<DISPLAYCONFIG_MODE_INFO> modeInfoArray,
        Pointer<Int32> currentTopologyId)>('QueryDisplayConfig');
