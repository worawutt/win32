...
class DisplayModes extends Struct {
  @Int32() external int numDisplayModes;
  @Array(1)
...
class Sources extends Struct {
  @Uint32() external int sourceId;
  @Int32() external int numTargets;
  @Array(1)
...
class VGA_CHAR extends Struct {
  @Uint8() external int Char;
  @Uint8() external int Attributes;
}
