...
class ITLegacyWaveSupport extends IDispatch {
  ...
  int IsFullDuplex(Pointer<Int32> pSupport) => ptr.ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> pSupport)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Int32> pSupport)>()(
      ptr.ref.lpVtbl, pSupport);
}
