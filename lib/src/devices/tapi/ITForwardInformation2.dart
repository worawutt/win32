...
class ITForwardInformation2 extends ITForwardInformation {
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int DestAddressType,
                      Pointer<Utf16> pCallerAddress,
                      int CallerAddressType)>()(ptr.ref.lpVtbl, ForwardType,
          pDestAddress, DestAddressType, pCallerAddress, CallerAddressType);
  ...
  int get_ForwardTypeDestinationAddressType(
          int ForwardType, Pointer<Int32> pDestAddressType) =>
      ptr.ref.lpVtbl.value
              .elementAt(16)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, int ForwardType,
                      Pointer<Int32> pDestAddressType)>()(
          ptr.ref.lpVtbl, ForwardType, pDestAddressType);

  int get_ForwardTypeCallerAddressType(
          int Forwardtype, Pointer<Int32> pCallerAddressType) =>
      ptr.ref.lpVtbl.value
              .elementAt(17)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, int Forwardtype,
                      Pointer<Int32> pCallerAddressType)>()(
          ptr.ref.lpVtbl, Forwardtype, pCallerAddressType);
}
