...
class ITPluggableTerminalEventSink extends IUnknown {
  ...
  int FireEvent(Pointer<MSP_EVENT_INFO> pMspEventInfo) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<MSP_EVENT_INFO> pMspEventInfo)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<MSP_EVENT_INFO> pMspEventInfo)>()(
      ptr.ref.lpVtbl, pMspEventInfo);
}
