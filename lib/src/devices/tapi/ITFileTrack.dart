  ...
  Pointer<COMObject> get AudioFormatForScripting {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppAudioFormat)>()(
          ptr.ref.lpVtbl, retValuePtr);
    ...
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(
                            Pointer, Pointer<COMObject> pAudioFormat)>>>()
            .value
            .asFunction<
                int Function(Pointer, Pointer<COMObject> pAudioFormat)>()(
        ptr.ref.lpVtbl, value);
