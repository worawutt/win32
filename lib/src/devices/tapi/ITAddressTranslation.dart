...
class ITAddressTranslation extends IDispatch {
  ...
  int TranslateAddress(Pointer<Utf16> pAddressToTranslate, int lCard,
          int lTranslateOptions, Pointer<Pointer<COMObject>> ppTranslated) =>
  ...
  int TranslateDialog(int hwndOwner, Pointer<Utf16> pAddressIn) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, int hwndOwner, Pointer<Utf16> pAddressIn)>()(
          ptr.ref.lpVtbl, hwndOwner, pAddressIn);

  int EnumerateLocations(Pointer<Pointer<COMObject>> ppEnumLocation) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppEnumLocation)>()(
          ptr.ref.lpVtbl, ppEnumLocation);
  ...
  int EnumerateCallingCards(Pointer<Pointer<COMObject>> ppEnumCallingCard) =>
      ptr.ref.lpVtbl.value
          .elementAt(11)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<COMObject>>
                      ppEnumCallingCard)>()(ptr.ref.lpVtbl, ppEnumCallingCard);
