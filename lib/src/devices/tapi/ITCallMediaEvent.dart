      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Int32> pCallMediaEvent)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> pCallMediaEvent)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  Pointer<COMObject> get Terminal {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppTerminal)>()(
          ptr.ref.lpVtbl, retValuePtr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> pCause)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> pCause)>()(
          ptr.ref.lpVtbl, retValuePtr);
