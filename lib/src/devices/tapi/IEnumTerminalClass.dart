...
class IEnumTerminalClass extends IUnknown {
  ...
  int Next(int celt, Pointer<GUID> pElements, Pointer<Uint32> pceltFetched) =>
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int celt, Pointer<GUID> pElements,
                      Pointer<Uint32> pceltFetched)>()(
          ptr.ref.lpVtbl, celt, pElements, pceltFetched);
