...
class IEnumBstr extends IUnknown {
  ...
  int Next(int celt, Pointer<Pointer<Utf16>> ppStrings, Pointer<Uint32> pceltFetched) => ptr.ref.lpVtbl.value      .elementAt(3)
      .cast<Pointer<NativeFunction<_Next_Native>>>()
      .value
      .asFunction<_Next_Dart>()(ptr.ref.lpVtbl, celt, ppStrings, pceltFetched);
