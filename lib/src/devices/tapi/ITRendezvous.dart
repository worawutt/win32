...
class ITRendezvous extends IDispatch {
  ...
  int EnumerateDefaultDirectories(
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppEnumDirectory)>()(
          ptr.ref.lpVtbl, ppEnumDirectory);

  int CreateDirectory(int DirectoryType, Pointer<Utf16> pName,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int DirectoryType, Pointer<Utf16> pName,
                      Pointer<Pointer<COMObject>> ppDir)>()(
          ptr.ref.lpVtbl, DirectoryType, pName, ppDir);

  int
      CreateDirectoryObject(int DirectoryObjectType, Pointer<Utf16> pName,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(
                          ...
                          Pointer<Utf16> pName,
                          Pointer<Pointer<COMObject>> ppDirectoryObject)>()(
              ptr.ref.lpVtbl, DirectoryObjectType, pName, ppDirectoryObject);
}
