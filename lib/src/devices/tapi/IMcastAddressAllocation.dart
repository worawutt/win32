...
class IMcastAddressAllocation extends IDispatch {
  ...
  int EnumerateScopes(Pointer<Pointer<COMObject>> ppEnumMcastScope) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppEnumMcastScope)>()(
          ptr.ref.lpVtbl, ppEnumMcastScope);
  ...
  int RenewAddress(int lReserved, Pointer<COMObject> pRenewRequest,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pRenewRequest,
                      Pointer<Pointer<COMObject>> ppRenewResponse)>()(
          ptr.ref.lpVtbl, lReserved, pRenewRequest, ppRenewResponse);

  int ReleaseAddress(Pointer<COMObject> pReleaseRequest) => ptr.ref.lpVtbl.value
          .elementAt(11)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<COMObject> pReleaseRequest)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> pReleaseRequest)>()(
      ptr.ref.lpVtbl, pReleaseRequest);
