      ...
      EnumerateStaticTerminals(
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(Pointer,
                          Pointer<Pointer<COMObject>> ppTerminalEnumerator)>()(
              ptr.ref.lpVtbl, ppTerminalEnumerator);
  ...
  int EnumerateDynamicTerminalClasses(
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer,
                      Pointer<Pointer<COMObject>> ppTerminalClassEnumerator)>()(
          ptr.ref.lpVtbl, ppTerminalClassEnumerator);

  int CreateTerminal(Pointer<Utf16> pTerminalClass, int lMediaType,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int Direction,
                      Pointer<Pointer<COMObject>> ppTerminal)>()(
          ptr.ref.lpVtbl, pTerminalClass, lMediaType, Direction, ppTerminal);

  int
      GetDefaultStaticTerminal(int lMediaType, int Direction,
              Pointer<Pointer<COMObject>> ppTerminal) =>
          ptr.ref.lpVtbl.value
                  .elementAt(12)
                  .cast<
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, int lMediaType, int Direction,
                          Pointer<Pointer<COMObject>> ppTerminal)>()(
              ptr.ref.lpVtbl, lMediaType, Direction, ppTerminal);
}
