  ...
  int EnumeratePluggableSuperclasses(
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer,
                      Pointer<Pointer<COMObject>> ppSuperclassEnumerator)>()(
          ptr.ref.lpVtbl, ppSuperclassEnumerator);

  int get_PluggableTerminalClasses(Pointer<Utf16> bstrTerminalSuperclass,
          int lMediaType, Pointer<VARIANT> pVariant) =>
      ptr.ref.lpVtbl.value
              .elementAt(15)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrTerminalSuperclass,
                      int lMediaType, Pointer<VARIANT> pVariant)>()(
          ptr.ref.lpVtbl, bstrTerminalSuperclass, lMediaType, pVariant);

  int
      EnumeratePluggableTerminalClasses(GUID iidTerminalSuperclass,
              int lMediaType, Pointer<Pointer<COMObject>> ppClassEnumerator) =>
          ptr.ref.lpVtbl.value
                  .elementAt(16)
                  .cast<
                      Pointer<
