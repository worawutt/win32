  ...
  Pointer<COMObject> get Track {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppTrackTerminal)>()(
          ptr.ref.lpVtbl, retValuePtr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> phrErrorCode)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int32> phrErrorCode)>()(ptr.ref.lpVtbl, retValuePtr);
