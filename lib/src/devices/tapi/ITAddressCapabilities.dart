...
class ITAddressCapabilities extends IDispatch {
  ...
  int get_AddressCapability(int AddressCap, Pointer<Int32> plCapability) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 AddressCap,
                              Pointer<Int32> plCapability)>>>()
              .value
              .asFunction<
                  int Function(
                      Pointer, int AddressCap, Pointer<Int32> plCapability)>()(
          ptr.ref.lpVtbl, AddressCap, plCapability);

  int get_AddressCapabilityString(
          int AddressCapString, Pointer<Pointer<Utf16>> ppCapabilityString) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 AddressCapString,
                              Pointer<Pointer<Utf16>> ppCapabilityString)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int AddressCapString,
                      Pointer<Pointer<Utf16>> ppCapabilityString)>()(
          ptr.ref.lpVtbl, AddressCapString, ppCapabilityString);
      ...
      EnumerateCallTreatments(
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(Pointer,
                          Pointer<Pointer<COMObject>> ppEnumCallTreatment)>()(
              ptr.ref.lpVtbl, ppEnumCallTreatment);
  ...
  int EnumerateCompletionMessages(
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer,
                      Pointer<Pointer<COMObject>> ppEnumCompletionMessage)>()(
          ptr.ref.lpVtbl, ppEnumCompletionMessage);
  ...
  int EnumerateDeviceClasses(Pointer<Pointer<COMObject>> ppEnumDeviceClass) =>
      ptr.ref.lpVtbl.value
          .elementAt(14)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer,
                  Pointer<Pointer<COMObject>>
                      ppEnumDeviceClass)>()(ptr.ref.lpVtbl, ppEnumDeviceClass);
}
