...
class IEnumDialableAddrs extends IUnknown {
  ...
  int Next(int celt, Pointer<Pointer<Utf16>> ppElements, Pointer<Uint32> pcFetched) => ptr.ref.lpVtbl.value      .elementAt(3)
      .cast<Pointer<NativeFunction<_Next_Native>>>()
      .value
      .asFunction<_Next_Dart>()(ptr.ref.lpVtbl, celt, ppElements, pcFetched);
