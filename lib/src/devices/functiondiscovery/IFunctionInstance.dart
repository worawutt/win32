...
class IFunctionInstance extends IServiceProvider {
  ...
  int GetID(Pointer<Pointer<Uint16>> ppszCoMemIdentity) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<Uint16>> ppszCoMemIdentity)>()(
      ptr.ref.lpVtbl, ppszCoMemIdentity);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<Uint16>>
                          ppszCoMemProviderInstanceIdentity)>()(
          ptr.ref.lpVtbl, ppszCoMemProviderInstanceIdentity);

  int OpenPropertyStore(
          int dwStgAccess, Pointer<Pointer<COMObject>> ppIPropertyStore) =>
      ptr.ref.lpVtbl.value
              .elementAt(6)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint32 dwStgAccess,
                              Pointer<Pointer<COMObject>> ppIPropertyStore)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int dwStgAccess,
                      Pointer<Pointer<COMObject>> ppIPropertyStore)>()(
          ptr.ref.lpVtbl, dwStgAccess, ppIPropertyStore);

  int
      GetCategory(Pointer<Pointer<Uint16>> ppszCoMemCategory,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(
                          ...
                          Pointer<Pointer<Uint16>> ppszCoMemCategory,
                          Pointer<Pointer<Uint16>> ppszCoMemSubCategory)>()(
              ptr.ref.lpVtbl, ppszCoMemCategory, ppszCoMemSubCategory);
}
