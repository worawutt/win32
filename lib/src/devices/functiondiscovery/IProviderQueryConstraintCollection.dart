...
class IProviderQueryConstraintCollection extends IUnknown {
  ...
  int Get(Pointer<Utf16> pszConstraintName,
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> pszConstraintName,
                              Pointer<Pointer<Uint16>> ppszConstraintValue)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> pszConstraintName,
                      Pointer<Pointer<Uint16>> ppszConstraintValue)>()(
          ptr.ref.lpVtbl, pszConstraintName, ppszConstraintValue);

  int Item(int dwIndex, Pointer<Pointer<Uint16>> ppszConstraintName,
          Pointer<Pointer<Uint16>> ppszConstraintValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<Uint16>> ppszConstraintName,
                      Pointer<Pointer<Uint16>> ppszConstraintValue)>()(
          ptr.ref.lpVtbl, dwIndex, ppszConstraintName, ppszConstraintValue);

  int Next(Pointer<Pointer<Uint16>> ppszConstraintName,
          Pointer<Pointer<Uint16>> ppszConstraintValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(6)
              .cast<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<Uint16>> ppszConstraintName,
                      Pointer<Pointer<Uint16>> ppszConstraintValue)>()(
          ptr.ref.lpVtbl, ppszConstraintName, ppszConstraintValue);
