...
class IPropertyStoreCollection extends IUnknown {
  ...
  int Get(Pointer<Utf16> pszInstanceIdentity, Pointer<Uint32> pdwIndex,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint32> pdwIndex,
                      Pointer<Pointer<COMObject>> ppIPropertyStore)>()(
          ptr.ref.lpVtbl, pszInstanceIdentity, pdwIndex, ppIPropertyStore);

  int Item(int dwIndex, Pointer<Pointer<COMObject>> ppIPropertyStore) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, int dwIndex,
                      Pointer<Pointer<COMObject>> ppIPropertyStore)>()(
          ptr.ref.lpVtbl, dwIndex, ppIPropertyStore);

  int Add(Pointer<COMObject> pIPropertyStore) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> pIPropertyStore)>()(
      ptr.ref.lpVtbl, pIPropertyStore);

  int Remove(int dwIndex, Pointer<Pointer<COMObject>> pIPropertyStore) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, int dwIndex,
                      Pointer<Pointer<COMObject>> pIPropertyStore)>()(
          ptr.ref.lpVtbl, dwIndex, pIPropertyStore);

  int Delete(int dwIndex) => ptr.ref.lpVtbl.value
      .elementAt(8)
