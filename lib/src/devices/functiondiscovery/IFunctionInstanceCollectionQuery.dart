...
class IFunctionInstanceCollectionQuery extends IUnknown {
  ...
  int
      AddQueryConstraint(Pointer<Utf16> pszConstraintName,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<Utf16> pszConstraintName,
                          Pointer<Utf16> pszConstraintValue)>()(
              ptr.ref.lpVtbl, pszConstraintName, pszConstraintValue);

  int AddPropertyConstraint(Pointer<PROPERTYKEY> Key, Pointer<PROPVARIANT> pv,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<PROPERTYKEY> Key,
                      Pointer<PROPVARIANT> pv, int enumPropertyConstraint)>()(
          ptr.ref.lpVtbl, Key, pv, enumPropertyConstraint);

  int Execute(Pointer<Pointer<COMObject>> ppIFunctionInstanceCollection) => ptr
          .ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
      ...
      ptr.ref.lpVtbl, ppIFunctionInstanceCollection);
}
