...
class IPNPXDeviceAssociation extends IUnknown {
  ...
  int Associate(Pointer<Utf16> pszSubCategory,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> pszSubCategory,
                      Pointer<COMObject> pIFunctionDiscoveryNotification)>()(
          ptr.ref.lpVtbl, pszSubCategory, pIFunctionDiscoveryNotification);

  int Unassociate(Pointer<Utf16> pszSubCategory,
          Pointer<COMObject> pIFunctionDiscoveryNotification) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
  ...
  int Delete(Pointer<Utf16> pszSubcategory,
          Pointer<COMObject> pIFunctionDiscoveryNotification) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
