...
class IFunctionDiscoveryProviderQuery extends IUnknown {
  ...
  int IsInstanceQuery(Pointer<Int32> pisInstanceQuery,
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> pisInstanceQuery,
                              Pointer<Pointer<Uint16>> ppszConstraintValue)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> pisInstanceQuery,
                      Pointer<Pointer<Uint16>> ppszConstraintValue)>()(
          ptr.ref.lpVtbl, pisInstanceQuery, ppszConstraintValue);

  int IsSubcategoryQuery(Pointer<Int32> pisSubcategoryQuery,
          Pointer<Pointer<Uint16>> ppszConstraintValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> pisSubcategoryQuery,
                      Pointer<Pointer<Uint16>> ppszConstraintValue)>()(
          ptr.ref.lpVtbl, pisSubcategoryQuery, ppszConstraintValue);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>>
                          ppIProviderQueryConstraints)>()(
          ptr.ref.lpVtbl, ppIProviderQueryConstraints);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>>
                          ppIProviderPropertyConstraints)>()(
          ptr.ref.lpVtbl, ppIProviderPropertyConstraints);
}
