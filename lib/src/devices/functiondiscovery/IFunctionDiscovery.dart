...
class IFunctionDiscovery extends IUnknown {
  ...
  int
      GetInstance(Pointer<Utf16> pszFunctionInstanceIdentity,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(
                          ...
                          Pointer<Utf16> pszFunctionInstanceIdentity,
                          Pointer<Pointer<COMObject>> ppIFunctionInstance)>()(
              ptr.ref.lpVtbl, pszFunctionInstanceIdentity, ppIFunctionInstance);
  ...
  int RemoveInstance(int enumSystemVisibility, Pointer<Utf16> pszCategory,
          Pointer<Utf16> pszSubCategory, Pointer<Utf16> pszCategoryIdentity) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
                  Pointer<
