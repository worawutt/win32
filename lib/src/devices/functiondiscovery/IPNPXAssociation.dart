...
class IPNPXAssociation extends IUnknown {
  ...
  int Associate(Pointer<Utf16> pszSubcategory) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Utf16> pszSubcategory)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<Utf16> pszSubcategory)>()(ptr.ref.lpVtbl, pszSubcategory);

  int Unassociate(Pointer<Utf16> pszSubcategory) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
              NativeFunction<
  ...
  int Delete(Pointer<Utf16> pszSubcategory) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<
