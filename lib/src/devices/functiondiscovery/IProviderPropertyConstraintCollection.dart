...
class IProviderPropertyConstraintCollection extends IUnknown {
  ...
  int Get(Pointer<PROPERTYKEY> Key, Pointer<PROPVARIANT> pPropVar,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<PROPVARIANT> pPropVar,
                      Pointer<Uint32> pdwPropertyConstraint)>()(
          ptr.ref.lpVtbl, Key, pPropVar, pdwPropertyConstraint);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<PROPVARIANT> pPropVar,
                      Pointer<Uint32> pdwPropertyConstraint)>()(
          ptr.ref.lpVtbl, dwIndex, pKey, pPropVar, pdwPropertyConstraint);

  int Next(Pointer<PROPERTYKEY> pKey, Pointer<PROPVARIANT> pPropVar,
          Pointer<Uint32> pdwPropertyConstraint) =>
      ptr.ref.lpVtbl.value
              .elementAt(6)
              .cast<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<PROPVARIANT> pPropVar,
                      Pointer<Uint32> pdwPropertyConstraint)>()(
          ptr.ref.lpVtbl, pKey, pPropVar, pdwPropertyConstraint);
