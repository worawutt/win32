...
class IFunctionInstanceCollection extends IUnknown {
  ...
  int
      Get(Pointer<Utf16> pszInstanceIdentity, Pointer<Uint32> pdwIndex,
  ...
  int Item(int dwIndex, Pointer<Pointer<COMObject>> ppIFunctionInstance) => ptr
          .ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(Pointer, int dwIndex,
                  Pointer<Pointer<COMObject>> ppIFunctionInstance)>()(
      ptr.ref.lpVtbl, dwIndex, ppIFunctionInstance);

  int Add(Pointer<COMObject> pIFunctionInstance) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<COMObject> pIFunctionInstance)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> pIFunctionInstance)>()(
      ptr.ref.lpVtbl, pIFunctionInstance);

  int
      Remove(int dwIndex, Pointer<Pointer<COMObject>> ppIFunctionInstance) =>
          ptr.ref.lpVtbl.value
                  .elementAt(7)
                  .cast<
                      Pointer<
