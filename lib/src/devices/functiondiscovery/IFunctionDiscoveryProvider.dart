...
class IFunctionDiscoveryProvider extends IUnknown {
  ...
  int
      Query(Pointer<COMObject> pIFunctionDiscoveryProviderQuery,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(
                          ...
                          Pointer<Pointer<COMObject>>
                              ppIFunctionInstanceCollection)>()(ptr.ref.lpVtbl,
              pIFunctionDiscoveryProviderQuery, ppIFunctionInstanceCollection);
  ...
  int InstancePropertyStoreValidateAccess(Pointer<COMObject> pIFunctionInstance,
          int iProviderInstanceContext, int dwStgAccess) =>
      ptr.ref.lpVtbl.value
              .elementAt(6)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pIFunctionInstance,
                      int iProviderInstanceContext, int dwStgAccess)>()(
          ptr.ref.lpVtbl,
          pIFunctionInstance,
  ...
  int InstancePropertyStoreFlush(Pointer<COMObject> pIFunctionInstance,
          int iProviderInstanceContext) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pIFunctionInstance,
                      int iProviderInstanceContext)>()(
          ptr.ref.lpVtbl, pIFunctionInstance, iProviderInstanceContext);
  ...
  int InstanceReleased(Pointer<COMObject> pIFunctionInstance,
          int iProviderInstanceContext) =>
      ptr.ref.lpVtbl.value
              .elementAt(10)
              .cast<
