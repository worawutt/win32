...
class IWSDiscoveryPublisher extends IUnknown {
  ...
  int SetAddressFamily(int dwAddressFamily) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Uint32 dwAddressFamily)>>>()
          .value
          .asFunction<int Function(Pointer, int dwAddressFamily)>()(
      ptr.ref.lpVtbl, dwAddressFamily);

  int RegisterNotificationSink(Pointer<COMObject> pSink) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int UnRegisterNotificationSink(Pointer<COMObject> pSink) =>
  ...
  int UnPublish(Pointer<Utf16> pszId, int ullInstanceId, int ullMessageNumber,
          Pointer<Utf16> pszSessionId, Pointer<WSDXML_ELEMENT> pAny) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      int ullMessageNumber,
                      Pointer<Utf16> pszSessionId,
                      Pointer<WSDXML_ELEMENT> pAny)>()(ptr.ref.lpVtbl, pszId,
          ullInstanceId, ullMessageNumber, pszSessionId, pAny);
  ...
  int RegisterScopeMatchingRule(Pointer<COMObject> pScopeMatchingRule) => ptr
          .ref.lpVtbl.value
          .elementAt(13)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<COMObject> pScopeMatchingRule)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> pScopeMatchingRule)>()(
      ptr.ref.lpVtbl, pScopeMatchingRule);

  int UnRegisterScopeMatchingRule(Pointer<COMObject> pScopeMatchingRule) => ptr
          .ref.lpVtbl.value
          .elementAt(14)
          .cast<
              Pointer<
  ...
  int GetXMLContext(Pointer<Pointer<COMObject>> ppContext) => ptr
          .ref.lpVtbl.value
          .elementAt(15)
          .cast<
              Pointer<
