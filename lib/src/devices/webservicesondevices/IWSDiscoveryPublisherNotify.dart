...
class IWSDiscoveryPublisherNotify extends IUnknown {
  ...
  int
      ProbeHandler(Pointer<WSD_SOAP_MESSAGE> pSoap,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<WSD_SOAP_MESSAGE> pSoap,
                          Pointer<COMObject> pMessageParameters)>()(
              ptr.ref.lpVtbl, pSoap, pMessageParameters);

  int
      ResolveHandler(Pointer<WSD_SOAP_MESSAGE> pSoap,
              Pointer<COMObject> pMessageParameters) =>
          ptr.ref.lpVtbl.value
                  .elementAt(4)
                  .cast<
