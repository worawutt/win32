...
class IWSDServiceMessaging extends IUnknown {
  ...
  int SendResponse(Pointer pBody, Pointer<WSD_OPERATION> pOperation,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<WSD_OPERATION> pOperation,
                      Pointer<COMObject> pMessageParameters)>()(
          ptr.ref.lpVtbl, pBody, pOperation, pMessageParameters);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pMessageParameters,
                      Pointer<WSD_SOAP_FAULT> pFault)>()(
          ptr.ref.lpVtbl, pRequestHeader, pMessageParameters, pFault);
}
