...
class IWSDServiceProxy extends IWSDMetadataExchange {
  ...
  int EndGetMetadata(Pointer<COMObject> pResult,
      ...
      ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<COMObject> pResult,
                  Pointer<Pointer<WSD_METADATA_SECTION_LIST>>
                      ppMetadata)>()(ptr.ref.lpVtbl, pResult, ppMetadata);
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer,
                          Pointer<Pointer<WSD_SERVICE_METADATA>>
                              ppServiceMetadata)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer,
                  Pointer<Pointer<WSD_SERVICE_METADATA>>
                      ppServiceMetadata)>()(ptr.ref.lpVtbl, ppServiceMetadata);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<WSDXML_ELEMENT> pAny,
                      Pointer<Pointer<WSDXML_ELEMENT>> ppAny)>()(
          ptr.ref.lpVtbl, pOperation, pUnknown, pAny, ppAny);

  int UnsubscribeToOperation(Pointer<WSD_OPERATION> pOperation) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<WSD_OPERATION> pOperation)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<WSD_OPERATION> pOperation)>()(
          ptr.ref.lpVtbl, pOperation);

  int SetEventingStatusCallback(Pointer<COMObject> pStatus) => ptr
          .ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pStatus)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> pStatus)>()(
