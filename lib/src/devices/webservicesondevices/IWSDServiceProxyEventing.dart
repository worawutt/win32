...
class IWSDServiceProxyEventing extends IWSDServiceProxy {
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pResult,
                      Pointer<Pointer<WSD_EVENTING_EXPIRES>> ppExpires,
                      Pointer<Pointer<WSDXML_ELEMENT>> ppAny)>()(ptr.ref.lpVtbl,
          pOperations, dwOperationCount, pResult, ppExpires, ppAny);

  int UnsubscribeToMultipleOperations(Pointer<WSD_OPERATION> pOperations,
          int dwOperationCount, Pointer<WSDXML_ELEMENT> pAny) =>
      ptr.ref.lpVtbl.value
              .elementAt(14)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<WSD_OPERATION> pOperations,
                      int dwOperationCount, Pointer<WSDXML_ELEMENT> pAny)>()(
          ptr.ref.lpVtbl, pOperations, dwOperationCount, pAny);
  ...
  int EndUnsubscribeToMultipleOperations(Pointer<WSD_OPERATION> pOperations,
          int dwOperationCount, Pointer<COMObject> pResult) =>
      ptr.ref.lpVtbl.value
              .elementAt(16)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<WSD_OPERATION> pOperations,
                      int dwOperationCount, Pointer<COMObject> pResult)>()(
          ptr.ref.lpVtbl, pOperations, dwOperationCount, pResult);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<WSD_EVENTING_EXPIRES>> ppExpires,
                      Pointer<Pointer<WSDXML_ELEMENT>> ppAny)>()(ptr.ref.lpVtbl,
          pOperations, dwOperationCount, pExpires, pAny, ppExpires, ppAny);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<WSD_EVENTING_EXPIRES>> ppExpires,
                      Pointer<Pointer<WSDXML_ELEMENT>> ppAny)>()(ptr.ref.lpVtbl,
          pOperations, dwOperationCount, pAny, ppExpires, ppAny);
