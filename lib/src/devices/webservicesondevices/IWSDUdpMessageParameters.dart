...
class IWSDUdpMessageParameters extends IWSDMessageParameters {
  ...
  int SetRetransmitParams(Pointer<WSDUdpRetransmitParams> pParams) => ptr
          .ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<WSDUdpRetransmitParams> pParams)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<WSDUdpRetransmitParams> pParams)>()(
      ptr.ref.lpVtbl, pParams);

  int GetRetransmitParams(Pointer<WSDUdpRetransmitParams> pParams) => ptr
          .ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
