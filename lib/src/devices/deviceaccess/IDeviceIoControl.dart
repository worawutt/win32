...
class IDeviceIoControl extends IUnknown {
  ...
  int CancelOperation(int cancelContext) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, IntPtr cancelContext)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int cancelContext)>()(ptr.ref.lpVtbl, cancelContext);
}
