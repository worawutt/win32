...
class IWiaTransfer extends IUnknown {
  ...
  int Download(int lFlags, Pointer<COMObject> pIWiaTransferCallback) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int lFlags,
                      Pointer<COMObject> pIWiaTransferCallback)>()(
          ptr.ref.lpVtbl, lFlags, pIWiaTransferCallback);

  int Upload(int lFlags, Pointer<COMObject> pSource,
          Pointer<COMObject> pIWiaTransferCallback) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
              ...
              .value
              .asFunction<
                  int Function(Pointer, int lFlags, Pointer<COMObject> pSource,
                      Pointer<COMObject> pIWiaTransferCallback)>()(
          ptr.ref.lpVtbl, lFlags, pSource, pIWiaTransferCallback);
  ...
  int EnumWIA_FORMAT_INFO(Pointer<Pointer<COMObject>> ppEnum) =>
      ptr.ref.lpVtbl.value
              .elementAt(6)
              .cast<
                  Pointer<
