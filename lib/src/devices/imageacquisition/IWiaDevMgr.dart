...
class IWiaDevMgr extends IUnknown {
  ...
  int EnumDeviceInfo(int lFlag, Pointer<Pointer<COMObject>> ppIEnum) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 lFlag,
                          Pointer<Pointer<COMObject>> ppIEnum)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer, int lFlag, Pointer<Pointer<COMObject>> ppIEnum)>()(
      ptr.ref.lpVtbl, lFlag, ppIEnum);

  int CreateDevice(Pointer<Utf16> bstrDeviceID,
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> bstrDeviceID,
                              Pointer<Pointer<COMObject>> ppWiaItemRoot)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrDeviceID,
                      Pointer<Pointer<COMObject>> ppWiaItemRoot)>()(
          ptr.ref.lpVtbl, bstrDeviceID, ppWiaItemRoot);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int lFlags,
                      Pointer<Pointer<Utf16>> pbstrDeviceID,
                      Pointer<Pointer<COMObject>> ppItemRoot)>()(ptr.ref.lpVtbl,
          hwndParent, lDeviceType, lFlags, pbstrDeviceID, ppItemRoot);

  int SelectDeviceDlgID(int hwndParent, int lDeviceType, int lFlags,
          Pointer<Pointer<Utf16>> pbstrDeviceID) =>
      ptr.ref.lpVtbl.value
              .elementAt(6)
              .cast<
              ...
              .value
              .asFunction<
                  int Function(Pointer, int hwndParent, int lDeviceType,
                      int lFlags, Pointer<Pointer<Utf16>> pbstrDeviceID)>()(
          ptr.ref.lpVtbl, hwndParent, lDeviceType, lFlags, pbstrDeviceID);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pItemRoot,
                      Pointer<Utf16> bstrFilename,
                      Pointer<GUID> pguidFormat)>()(ptr.ref.lpVtbl, hwndParent,
          lDeviceType, lFlags, lIntent, pItemRoot, bstrFilename, pguidFormat);
  ...
  int AddDeviceDlg(int hwndParent, int lFlags) =>
      ptr.ref.lpVtbl.value
              .elementAt(11)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, IntPtr hwndParent, Int32 lFlags)>>>()
              .value
              .asFunction<int Function(Pointer, int hwndParent, int lFlags)>()(
          ptr.ref.lpVtbl, hwndParent, lFlags);
}
