...
class IWiaDevMgr2 extends IUnknown {
  ...
  int EnumDeviceInfo(int lFlags, Pointer<Pointer<COMObject>> ppIEnum) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, int lFlags, Pointer<Pointer<COMObject>> ppIEnum)>()(
      ptr.ref.lpVtbl, lFlags, ppIEnum);

  int CreateDevice(int lFlags, Pointer<Utf16> bstrDeviceID,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int lFlags, Pointer<Utf16> bstrDeviceID,
                      Pointer<Pointer<COMObject>> ppWiaItem2Root)>()(
          ptr.ref.lpVtbl, lFlags, bstrDeviceID, ppWiaItem2Root);
