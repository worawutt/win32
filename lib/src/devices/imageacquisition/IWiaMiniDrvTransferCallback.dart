      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> bstrFullItemName,
                      Pointer<Pointer<COMObject>> ppIStream)>()(
          ptr.ref.lpVtbl, lFlags, bstrItemName, bstrFullItemName, ppIStream);

  int
      SendMessage(int lFlags, Pointer<WiaTransferParams> pWiaTransferParams) =>
          ptr.ref.lpVtbl.value
                  .elementAt(4)
                  .cast<
                      Pointer<
