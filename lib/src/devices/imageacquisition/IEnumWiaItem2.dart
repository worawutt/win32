...
class IEnumWiaItem2 extends IUnknown {
  ...
  int Next(int cElt, Pointer<Pointer<COMObject>> ppIWiaItem2,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppIWiaItem2,
                      Pointer<Uint32> pcEltFetched)>()(
          ptr.ref.lpVtbl, cElt, ppIWiaItem2, pcEltFetched);
  ...
  int GetCount(Pointer<Uint32> cElt) => ptr.ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Uint32> cElt)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<Uint32> cElt)>()(ptr.ref.lpVtbl, cElt);
}
