...
class IWiaPreview extends IUnknown {
  ...
  int GetNewPreview(int lFlags, Pointer<COMObject> pWiaItem2,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pWiaItem2,
                      Pointer<COMObject> pWiaTransferCallback)>()(
          ptr.ref.lpVtbl, lFlags, pWiaItem2, pWiaTransferCallback);

  int UpdatePreview(int lFlags, Pointer<COMObject> pChildWiaItem2,
          Pointer<COMObject> pWiaTransferCallback) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pChildWiaItem2,
                      Pointer<COMObject> pWiaTransferCallback)>()(
          ptr.ref.lpVtbl, lFlags, pChildWiaItem2, pWiaTransferCallback);

  int DetectRegions(int lFlags) => ptr.ref.lpVtbl.value
      .elementAt(5)
