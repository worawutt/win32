...
class IWiaPropertyStorage extends IUnknown {
  ...
  int GetPropertyAttributes(int cpspec, Pointer<PROPSPEC> rgpspec,
          Pointer<Uint32> rgflags, Pointer<PROPVARIANT> rgpropvar) =>
      ptr.ref.lpVtbl.value
              .elementAt(15)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint32> rgflags,
                      Pointer<PROPVARIANT> rgpropvar)>()(
          ptr.ref.lpVtbl, cpspec, rgpspec, rgflags, rgpropvar);

  int GetCount(Pointer<Uint32> pulNumProps) => ptr.ref.lpVtbl.value
          .elementAt(16)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Uint32> pulNumProps)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Uint32> pulNumProps)>()(
      ptr.ref.lpVtbl, pulNumProps);

  int
      GetPropertyStream(Pointer<GUID> pCompatibilityId,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<GUID> pCompatibilityId,
                          Pointer<Pointer<COMObject>> ppIStream)>()(
              ptr.ref.lpVtbl, pCompatibilityId, ppIStream);

  int SetPropertyStream(
          Pointer<GUID> pCompatibilityId, Pointer<COMObject> pIStream) =>
      ptr.ref.lpVtbl.value
          .elementAt(18)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<GUID> pCompatibilityId,
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<GUID> pCompatibilityId,
                  Pointer<COMObject>
                      pIStream)>()(ptr.ref.lpVtbl, pCompatibilityId, pIStream);
}
