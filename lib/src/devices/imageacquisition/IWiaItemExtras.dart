...
class IWiaItemExtras extends IUnknown {
  ...
  int GetExtendedErrorInfo(Pointer<Pointer<Utf16>> bstrErrorText) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<Utf16>> bstrErrorText)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<Utf16>> bstrErrorText)>()(
      ptr.ref.lpVtbl, bstrErrorText);
