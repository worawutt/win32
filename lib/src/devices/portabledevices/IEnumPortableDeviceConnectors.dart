...
class IEnumPortableDeviceConnectors extends IUnknown {
  ...
  int Next(int cRequested, Pointer<Pointer<COMObject>> pConnectors,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> pConnectors,
                      Pointer<Uint32> pcFetched)>()(
          ptr.ref.lpVtbl, cRequested, pConnectors, pcFetched);

  int Skip(int cConnectors) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Uint32 cConnectors)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int cConnectors)>()(ptr.ref.lpVtbl, cConnectors);
