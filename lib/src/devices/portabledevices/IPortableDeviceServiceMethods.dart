...
class IPortableDeviceServiceMethods extends IUnknown {
  ...
  int Invoke(Pointer<GUID> Method, Pointer<COMObject> pParameters,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pParameters,
                      Pointer<Pointer<COMObject>> ppResults)>()(
          ptr.ref.lpVtbl, Method, pParameters, ppResults);

  int InvokeAsync(Pointer<GUID> Method, Pointer<COMObject> pParameters,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pParameters,
                      Pointer<COMObject> pCallback)>()(
          ptr.ref.lpVtbl, Method, pParameters, pCallback);
