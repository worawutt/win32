...
class IPortableDeviceEventCallback extends IUnknown {
  ...
  int OnEvent(Pointer<COMObject> pEventParameters) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<COMObject> pEventParameters)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> pEventParameters)>()(
      ptr.ref.lpVtbl, pEventParameters);
}
