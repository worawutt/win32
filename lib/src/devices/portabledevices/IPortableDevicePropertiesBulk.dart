...
class IPortableDevicePropertiesBulk extends IUnknown {
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pCallback,
                      Pointer<GUID> pContext)>()(
          ptr.ref.lpVtbl, pObjectIDs, pKeys, pCallback, pContext);
  ...
  int QueueSetValuesByObjectList(Pointer<COMObject> pObjectValues,
          Pointer<COMObject> pCallback, Pointer<GUID> pContext) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pObjectValues,
                      Pointer<COMObject> pCallback, Pointer<GUID> pContext)>()(
          ptr.ref.lpVtbl, pObjectValues, pCallback, pContext);

  int Start(Pointer<GUID> pContext) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int Cancel(Pointer<GUID> pContext) => ptr.ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
                  NativeFunction<
