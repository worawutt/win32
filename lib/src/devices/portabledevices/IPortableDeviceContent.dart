...
class IPortableDeviceContent extends IUnknown {
  ...
  int EnumObjects(int dwFlags, Pointer<Utf16> pszParentObjectID,
          Pointer<COMObject> pFilter, Pointer<Pointer<COMObject>> ppEnum) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pFilter,
                      Pointer<Pointer<COMObject>> ppEnum)>()(
          ptr.ref.lpVtbl, dwFlags, pszParentObjectID, pFilter, ppEnum);

  int Properties(Pointer<Pointer<COMObject>> ppProperties) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
          ...
          ptr.ref.lpVtbl, ppProperties);

  int Transfer(Pointer<Pointer<COMObject>> ppResources) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int CreateObjectWithPropertiesOnly(
          Pointer<COMObject> pValues, Pointer<Pointer<Utf16>> ppszObjectID) =>
      ptr.ref.lpVtbl.value
              .elementAt(6)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<COMObject> pValues,
                              Pointer<Pointer<Utf16>> ppszObjectID)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pValues,
                      Pointer<Pointer<Utf16>> ppszObjectID)>()(
          ptr.ref.lpVtbl, pValues, ppszObjectID);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppData,
                      Pointer<Uint32> pdwOptimalWriteBufferSize,
                      Pointer<Pointer<Utf16>> ppszCookie)>()(ptr.ref.lpVtbl,
          pValues, ppData, pdwOptimalWriteBufferSize, ppszCookie);

  int Delete(int dwOptions, Pointer<COMObject> pObjectIDs,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pObjectIDs,
                      Pointer<Pointer<COMObject>> ppResults)>()(
          ptr.ref.lpVtbl, dwOptions, pObjectIDs, ppResults);
  ...
  int GetObjectIDsFromPersistentUniqueIDs(
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pPersistentUniqueIDs,
                      Pointer<Pointer<COMObject>> ppObjectIDs)>()(
          ptr.ref.lpVtbl, pPersistentUniqueIDs, ppObjectIDs);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> pszDestinationFolderObjectID,
                      Pointer<Pointer<COMObject>> ppResults)>()(
          ptr.ref.lpVtbl, pObjectIDs, pszDestinationFolderObjectID, ppResults);
