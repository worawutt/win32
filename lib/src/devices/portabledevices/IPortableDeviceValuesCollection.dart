...
class IPortableDeviceValuesCollection extends IUnknown {
  ...
  int GetAt(int dwIndex, Pointer<Pointer<COMObject>> ppValues) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int dwIndex,
                      Pointer<Pointer<COMObject>> ppValues)>()(
          ptr.ref.lpVtbl, dwIndex, ppValues);

  int Add(Pointer<COMObject> pValues) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> pValues)>()(
      ptr.ref.lpVtbl, pValues);
