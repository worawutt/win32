...
class IPortableDeviceDataStream extends IStream {
  ...
  int GetObjectID(Pointer<Pointer<Utf16>> ppszObjectID) => ptr.ref.lpVtbl.value
          .elementAt(14)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<Utf16>> ppszObjectID)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<Utf16>> ppszObjectID)>()(
      ptr.ref.lpVtbl, ppszObjectID);
