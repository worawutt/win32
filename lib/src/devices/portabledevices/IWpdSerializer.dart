...
class IWpdSerializer extends IUnknown {
  ...
  int GetIPortableDeviceValuesFromBuffer(Pointer<Uint8> pBuffer,
          int dwInputBufferLength, Pointer<Pointer<COMObject>> ppParams) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppParams)>()(
          ptr.ref.lpVtbl, pBuffer, dwInputBufferLength, ppParams);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pResults,
                      Pointer<Uint8> pBuffer,
                      Pointer<Uint32> pdwBytesWritten)>()(ptr.ref.lpVtbl,
          dwOutputBufferLength, pResults, pBuffer, pdwBytesWritten);

  int GetBufferFromIPortableDeviceValues(Pointer<COMObject> pSource,
          Pointer<Pointer<Uint8>> ppBuffer, Pointer<Uint32> pdwBufferSize) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<Uint8>> ppBuffer,
                      Pointer<Uint32> pdwBufferSize)>()(
          ptr.ref.lpVtbl, pSource, ppBuffer, pdwBufferSize);

  int GetSerializedSize(Pointer<COMObject> pSource, Pointer<Uint32> pdwSize) =>
      ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pSource,
                          Pointer<Uint32> pdwSize)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> pSource,
                  Pointer<Uint32> pdwSize)>()(ptr.ref.lpVtbl, pSource, pdwSize);
}
