...
class IPortableDeviceResources extends IUnknown {
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(
                          ...
                          Pointer<PROPERTYKEY> Key,
                          Pointer<Pointer<COMObject>> ppResourceAttributes)>()(
              ptr.ref.lpVtbl, pszObjectID, Key, ppResourceAttributes);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int dwMode,
                      Pointer<Uint32> pdwOptimalBufferSize,
                      Pointer<Pointer<COMObject>> ppStream)>()(ptr.ref.lpVtbl,
          pszObjectID, Key, dwMode, pdwOptimalBufferSize, ppStream);
  ...
  int CreateResource(
      ...
      ptr.ref.lpVtbl.value
          ...
          pResourceAttributes, ppData, pdwOptimalWriteBufferSize, ppszCookie);
}
