...
class IEnumPortableDeviceObjectIDs extends IUnknown {
  ...
  int Next(int cObjects, Pointer<Pointer<Utf16>> pObjIDs,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<Utf16>> pObjIDs,
                      Pointer<Uint32> pcFetched)>()(
          ptr.ref.lpVtbl, cObjects, pObjIDs, pcFetched);

  int Skip(int cObjects) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Uint32 cObjects)>>>()
      .value
      .asFunction<
          int Function(Pointer, int cObjects)>()(ptr.ref.lpVtbl, cObjects);
