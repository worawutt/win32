...
class IMediaRadioManager extends IUnknown {
  ...
  int GetRadioInstances(Pointer<Pointer<COMObject>> ppCollection) =>
  ...
  int OnSystemRadioStateChange(int sysRadioState, int uTimeoutSec) => ptr
          .ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Int32 sysRadioState, Uint32 uTimeoutSec)>>>()
          .value
          .asFunction<
              int Function(Pointer, int sysRadioState, int uTimeoutSec)>()(
      ptr.ref.lpVtbl, sysRadioState, uTimeoutSec);
}
