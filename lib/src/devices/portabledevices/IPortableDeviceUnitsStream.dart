...
class IPortableDeviceUnitsStream extends IUnknown {
  ...
  int
      SeekInUnits(int dlibMove, int units, int dwOrigin,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, int dlibMove, int units,
                          int dwOrigin, Pointer<Uint64> plibNewPosition)>()(
              ptr.ref.lpVtbl, dlibMove, units, dwOrigin, plibNewPosition);
