      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> guidServiceCategory,
                      Pointer<Pointer<Utf16>> pServices,
                      Pointer<Uint32> pcServices)>()(ptr.ref.lpVtbl,
          pszPnPDeviceID, guidServiceCategory, pServices, pcServices);

  int
      GetDeviceForService(Pointer<Utf16> pszPnPServiceID,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(Pointer, Pointer<Utf16> pszPnPServiceID,
                          Pointer<Pointer<Utf16>> ppszPnPDeviceID)>()(
              ptr.ref.lpVtbl, pszPnPServiceID, ppszPnPDeviceID);
}
