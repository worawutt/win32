...
class IPortableDevicePropVariantCollection extends IUnknown {
  ...
  int GetType(Pointer<Uint16> pvt) => ptr.ref.lpVtbl.value
      .elementAt(6)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Uint16> pvt)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<Uint16> pvt)>()(ptr.ref.lpVtbl, pvt);

  int ChangeType(int vt) => ptr.ref.lpVtbl.value
      .elementAt(7)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Uint16 vt)>>>()
      .value
      .asFunction<int Function(Pointer, int vt)>()(ptr.ref.lpVtbl, vt);
