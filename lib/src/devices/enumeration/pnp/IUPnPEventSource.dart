...
class IUPnPEventSource extends IUnknown {
  ...
  int Advise(Pointer<COMObject> pesSubscriber) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<COMObject> pesSubscriber)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pesSubscriber)>()(
          ptr.ref.lpVtbl, pesSubscriber);

  int Unadvise(Pointer<COMObject> pesSubscriber) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
