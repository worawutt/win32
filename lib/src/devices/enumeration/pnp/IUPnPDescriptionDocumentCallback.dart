...
class IUPnPDescriptionDocumentCallback extends IUnknown {
  ...
  int LoadComplete(int hrLoadResult) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Int32 hrLoadResult)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int hrLoadResult)>()(ptr.ref.lpVtbl, hrLoadResult);
}
