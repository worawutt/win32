...
class IUPnPRemoteEndpointInfo extends IUnknown {
  ...
  int GetDwordValue(Pointer<Utf16> bstrValueName, Pointer<Uint32> pdwValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> bstrValueName,
                              Pointer<Uint32> pdwValue)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrValueName,
                      Pointer<Uint32> pdwValue)>()(
          ptr.ref.lpVtbl, bstrValueName, pdwValue);

  int GetStringValue(
          Pointer<Utf16> bstrValueName, Pointer<Pointer<Utf16>> pbstrValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrValueName,
                      Pointer<Pointer<Utf16>> pbstrValue)>()(
          ptr.ref.lpVtbl, bstrValueName, pbstrValue);

  int GetGuidValue(Pointer<Utf16> bstrValueName, Pointer<GUID> pguidValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrValueName,
                      Pointer<GUID> pguidValue)>()(
          ptr.ref.lpVtbl, bstrValueName, pguidValue);
}
