...
class IUPnPServices extends IDispatch {
  ...
  int get_Item(Pointer<Utf16> bstrServiceId,
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> bstrServiceId,
                              Pointer<Pointer<COMObject>> ppService)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrServiceId,
                      Pointer<Pointer<COMObject>> ppService)>()(
          ptr.ref.lpVtbl, bstrServiceId, ppService);
}
