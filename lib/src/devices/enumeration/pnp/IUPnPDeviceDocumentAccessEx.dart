...
class IUPnPDeviceDocumentAccessEx extends IUnknown {
  ...
  int GetDocument(Pointer<Pointer<Utf16>> pbstrDocument) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<Utf16>> pbstrDocument)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<Utf16>> pbstrDocument)>()(
      ptr.ref.lpVtbl, pbstrDocument);
}
