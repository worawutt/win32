...
class IUPnPHttpHeaderControl extends IUnknown {
  ...
  int AddRequestHeaders(Pointer<Utf16> bstrHttpHeaders) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Utf16> bstrHttpHeaders)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrHttpHeaders)>()(
          ptr.ref.lpVtbl, bstrHttpHeaders);
}
