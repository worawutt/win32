...
class IUPnPDescriptionDocument extends IDispatch {
  ...
  int Load(Pointer<Utf16> bstrUrl) => ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int LoadAsync(Pointer<Utf16> bstrUrl, Pointer<COMObject> punkCallback) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrUrl,
                      Pointer<COMObject> punkCallback)>()(
          ptr.ref.lpVtbl, bstrUrl, punkCallback);
  ...
  int get LoadResult {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> phrError)>()(
  ...
  int RootDevice(Pointer<Pointer<COMObject>> ppudRootDevice) => ptr
          .ref.lpVtbl.value
          .elementAt(12)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<COMObject>> ppudRootDevice)>()(
      ptr.ref.lpVtbl, ppudRootDevice);

  int DeviceByUDN(
          Pointer<Utf16> bstrUDN, Pointer<Pointer<COMObject>> ppudDevice) =>
      ptr
              .ref.lpVtbl.value
              .elementAt(13)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> bstrUDN,
                              Pointer<Pointer<COMObject>> ppudDevice)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrUDN,
                      Pointer<Pointer<COMObject>> ppudDevice)>()(
          ptr.ref.lpVtbl, bstrUDN, ppudDevice);
}
