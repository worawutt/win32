...
class IUPnPDevice extends IDispatch {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int16> pvarb)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int16> pvarb)>()(
  ...
  Pointer<COMObject> get ParentDevice {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppudDeviceParent)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  Pointer<COMObject> get Children {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppudChildren)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  int IconURL(Pointer<Utf16> bstrEncodingFormat, int lSizeX, int lSizeY,
          int lBitDepth, Pointer<Pointer<Utf16>> pbstrIconURL) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int lSizeY,
                      int lBitDepth,
                      Pointer<Pointer<Utf16>> pbstrIconURL)>()(ptr.ref.lpVtbl,
          bstrEncodingFormat, lSizeX, lSizeY, lBitDepth, pbstrIconURL);
  ...
  Pointer<COMObject> get Services {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppusServices)>()(
          ptr.ref.lpVtbl, retValuePtr);
