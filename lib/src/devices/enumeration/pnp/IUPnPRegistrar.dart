...
class IUPnPRegistrar extends IUnknown {
  ...
  int GetUniqueDeviceName(Pointer<Utf16> bstrDeviceIdentifier,
          Pointer<Utf16> bstrTemplateUDN, Pointer<Pointer<Utf16>> pbstrUDN) =>
      ptr.ref.lpVtbl.value
              .elementAt(6)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> bstrTemplateUDN,
                      Pointer<Pointer<Utf16>> pbstrUDN)>()(
          ptr.ref.lpVtbl, bstrDeviceIdentifier, bstrTemplateUDN, pbstrUDN);

  int UnregisterDevice(Pointer<Utf16> bstrDeviceIdentifier, int fPermanent) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrDeviceIdentifier,
                      int fPermanent)>()(
          ptr.ref.lpVtbl, bstrDeviceIdentifier, fPermanent);

  int UnregisterDeviceProvider(Pointer<Utf16> bstrProviderName) =>
      ptr
              .ref.lpVtbl.value
              .elementAt(8)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Utf16> bstrProviderName)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrProviderName)>()(
          ptr.ref.lpVtbl, bstrProviderName);
}
