...
class IUPnPService extends IDispatch {
  ...
  int QueryStateVariable(
          Pointer<Utf16> bstrVariableName, Pointer<VARIANT> pValue) =>
      ptr.ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> bstrVariableName,
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<VARIANT>
                      pValue)>()(ptr.ref.lpVtbl, bstrVariableName, pValue);

  int InvokeAction(Pointer<Utf16> bstrActionName, VARIANT vInActionArgs,
          Pointer<VARIANT> pvOutActionArgs, Pointer<VARIANT> pvRetVal) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      VARIANT vInActionArgs,
                      Pointer<VARIANT> pvOutActionArgs,
                      Pointer<VARIANT> pvRetVal)>()(ptr.ref.lpVtbl,
          bstrActionName, vInActionArgs, pvOutActionArgs, pvRetVal);
  ...
  int AddCallback(Pointer<COMObject> pUnkCallback) => ptr.ref.lpVtbl.value
      .elementAt(10)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> pUnkCallback)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<COMObject> pUnkCallback)>()(ptr.ref.lpVtbl, pUnkCallback);
