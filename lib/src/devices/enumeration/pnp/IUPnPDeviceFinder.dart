...
class IUPnPDeviceFinder extends IDispatch {
  ...
  int FindByType(Pointer<Utf16> bstrTypeURI, int dwFlags,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrTypeURI, int dwFlags,
                      Pointer<Pointer<COMObject>> pDevices)>()(
          ptr.ref.lpVtbl, bstrTypeURI, dwFlags, pDevices);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int dwFlags,
                      Pointer<COMObject> punkDeviceFinderCallback,
                      Pointer<Int32> plFindData)>()(ptr.ref.lpVtbl, bstrTypeURI,
          dwFlags, punkDeviceFinderCallback, plFindData);

  int StartAsyncFind(int lFindData) => ptr.ref.lpVtbl.value
      .elementAt(9)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 lFindData)>>>()
      .value
      .asFunction<
          int Function(Pointer, int lFindData)>()(ptr.ref.lpVtbl, lFindData);

  int CancelAsyncFind(int lFindData) => ptr.ref.lpVtbl.value
      .elementAt(10)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 lFindData)>>>()
      .value
      .asFunction<
  ...
  int FindByUDN(Pointer<Utf16> bstrUDN, Pointer<Pointer<COMObject>> pDevice) =>
      ptr.ref.lpVtbl.value
              .elementAt(11)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrUDN,
                      Pointer<Pointer<COMObject>> pDevice)>()(
          ptr.ref.lpVtbl, bstrUDN, pDevice);
}
