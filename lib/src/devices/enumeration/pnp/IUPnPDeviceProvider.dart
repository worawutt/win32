...
class IUPnPDeviceProvider extends IUnknown {
  ...
  int Start(Pointer<Utf16> bstrInitString) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Utf16> bstrInitString)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<Utf16> bstrInitString)>()(ptr.ref.lpVtbl, bstrInitString);
