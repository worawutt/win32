...
late final _BluetoothRegisterForAuthentication = _bluetoothapis.lookupFunction<
    ...
    int Function(
        ...
        Pointer<IntPtr> phRegHandle,
        Pointer<NativeFunction<PFN_AUTHENTICATION_CALLBACK>> pfnCallback,
        Pointer pvParam)>('BluetoothRegisterForAuthentication');
...
int BluetoothSendAuthenticationResponse(int hRadio,
        Pointer<BLUETOOTH_DEVICE_INFO> pbtdi, Pointer<Utf16> pszPasskey) =>
    _BluetoothSendAuthenticationResponse(hRadio, pbtdi, pszPasskey);
...
late final _BluetoothSendAuthenticationResponse = _bluetoothapis.lookupFunction<
    ...
    int Function(int hRadio, Pointer<BLUETOOTH_DEVICE_INFO> pbtdi,
        Pointer<Utf16> pszPasskey)>('BluetoothSendAuthenticationResponse');
...
int BluetoothSetLocalServiceInfo(int hRadioIn, Pointer<GUID> pClassGuid,
        int ulInstance, Pointer<BLUETOOTH_LOCAL_SERVICE_INFO> pServiceInfoIn) =>
    _BluetoothSetLocalServiceInfo(
        hRadioIn, pClassGuid, ulInstance, pServiceInfoIn);
...
late final _BluetoothSetLocalServiceInfo = _bluetoothapis.lookupFunction<
        ...
        int Function(int hRadioIn, Pointer<GUID> pClassGuid, int ulInstance,
            Pointer<BLUETOOTH_LOCAL_SERVICE_INFO> pServiceInfoIn)>(
...
late final _BluetoothAuthenticateDevice = _bthprops.lookupFunction<
    ...
    int Function(
        ...
        Pointer<BLUETOOTH_DEVICE_INFO> pbtbi,
        Pointer<Utf16> pszPasskey,
        int ulPasskeyLength)>('BluetoothAuthenticateDevice');
...
int BluetoothAuthenticateMultipleDevices(int hwndParent, int hRadio,
        int cDevices, Pointer<BLUETOOTH_DEVICE_INFO> rgbtdi) =>
...
late final _BluetoothAuthenticateMultipleDevices = _bthprops.lookupFunction<
        Uint32 Function(IntPtr hwndParent, IntPtr hRadio, Uint32 cDevices,
            Pointer<BLUETOOTH_DEVICE_INFO> rgbtdi),
        int Function(int hwndParent, int hRadio, int cDevices,
            Pointer<BLUETOOTH_DEVICE_INFO> rgbtdi)>(
