...
typedef LPDIENUMDEVICESCALLBACKW = Int32 Function(
    Pointer<DIDEVICEINSTANCE> param0, Pointer param1);
typedef LPDIENUMEFFECTSCALLBACKW = Int32 Function(
    Pointer<DIEFFECTINFO> param0, Pointer param1);
typedef LPDIENUMEFFECTSINFILECALLBACK = Int32 Function(
    Pointer<DIFILEEFFECT> param0, Pointer param1);
typedef LPDIJOYTYPECALLBACK = Int32 Function(
    Pointer<Utf16> param0, Pointer param1);
typedef LPFNSHOWJOYCPL = Void Function(IntPtr hWnd);
typedef PFN_HidP_GetVersionInternal = Int32 Function(Pointer<Uint32> Version);
typedef PHIDP_INSERT_SCANCODES = Uint8 Function(
    Pointer Context, Pointer<Utf8> NewScanCodes, Uint32 Length);
