...
/// @nodoc
const IID_IDirectInput7 = '{9A4CB685-236D-11D3-8E9D-00C04F6844AE}';

/// {@category Interface}
/// {@category com}
class IDirectInput7 extends IDirectInput2 {
  // vtable begins at 9, is 1 entries long.
  IDirectInput7(Pointer<COMObject> ptr) : super(ptr);

  int CreateDeviceEx(Pointer<GUID> param0, Pointer<GUID> param1,
          Pointer<Pointer> param2, Pointer<COMObject> param3) =>
