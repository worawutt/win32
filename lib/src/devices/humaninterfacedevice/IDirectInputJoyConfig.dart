...
typedef _OpenConfigKey_Native = Int32 Function(
  Pointer,
  Uint32 param0, 
  Uint32 param1, 
  Pointer<IntPtr> param2
);
typedef _OpenConfigKey_Dart = int Function(
  Pointer,
  int param0, 
  int param1, 
  Pointer<IntPtr> param2
...
class IDirectInputJoyConfig extends IUnknown {
  ...
  int SetTypeInfo(Pointer<Utf16> param0, Pointer<DIJOYTYPEINFO> param1, int param2) => ptr.ref.lpVtbl.value      .elementAt(9)
      .cast<Pointer<NativeFunction<_SetTypeInfo_Native>>>()
      .value
      .asFunction<_SetTypeInfo_Dart>()(ptr.ref.lpVtbl, param0, param1, param2);
  ...
  int OpenConfigKey(int param0, int param1, Pointer<IntPtr> param2) => ptr.ref.lpVtbl.value      .elementAt(18)
      .cast<Pointer<NativeFunction<_OpenConfigKey_Native>>>()
      .value
      .asFunction<_OpenConfigKey_Dart>()(ptr.ref.lpVtbl, param0, param1, param2);
