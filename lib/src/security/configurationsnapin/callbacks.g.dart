...
typedef PFSCE_FREE_INFO = Uint32 Function(Pointer pvServiceInfo);
typedef PFSCE_LOG_INFO = Uint32 Function(
    Uint32 ErrLevel, Uint32 Win32rc, Pointer<Int8> pErrFmt);
...
typedef PFSCE_SET_INFO = Uint32 Function(Pointer sceHandle, Int32 sceType,
    Pointer<Int8> lpPrefix, Int32 bExact, Pointer pvInfo);
