...
class IEAPProviderConfig extends IUnknown {
  ...
  int Initialize(Pointer<Utf16> pszMachineName, int dwEapTypeId,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> pszMachineName,
                      int dwEapTypeId, Pointer<IntPtr> puConnectionParam)>()(
          ptr.ref.lpVtbl, pszMachineName, dwEapTypeId, puConnectionParam);

  int Uninitialize(int dwEapTypeId, int uConnectionParam) => ptr
          .ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Uint32 dwEapTypeId,
                          IntPtr uConnectionParam)>>>()
          .value
          .asFunction<
              int Function(Pointer, int dwEapTypeId, int uConnectionParam)>()(
      ptr.ref.lpVtbl, dwEapTypeId, uConnectionParam);

  int ServerInvokeConfigUI(int dwEapTypeId, int uConnectionParam, int hWnd,
          int uReserved1, int uReserved2) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, int dwEapTypeId, int uConnectionParam,
                      int hWnd, int uReserved1, int uReserved2)>()(
          ptr.ref.lpVtbl,
          dwEapTypeId,
          uConnectionParam,
          hWnd,
