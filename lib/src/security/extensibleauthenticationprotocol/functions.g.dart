...
int EapHostPeerConfigBlob2Xml(
    ...
    _EapHostPeerConfigBlob2Xml(dwFlags, eapMethodType, dwSizeOfConfigIn,
...
late final _EapHostPeerConfigBlob2Xml = _eappcfg.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint8> pConfigIn,
        Pointer<Pointer<COMObject>> ppConfigDoc,
        Pointer<Pointer<EAP_ERROR>> ppEapError)>('EapHostPeerConfigBlob2Xml');
...
int EapHostPeerConfigXml2Blob(
        ...
        Pointer<Pointer<EAP_ERROR>> ppEapError) =>
    _EapHostPeerConfigXml2Blob(dwFlags, pConfigDoc, pdwSizeOfConfigOut,
...
late final _EapHostPeerConfigXml2Blob = _eappcfg.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Pointer<Uint8>> ppConfigOut,
        Pointer<EAP_METHOD_TYPE> pEapMethodType,
        Pointer<Pointer<EAP_ERROR>> ppEapError)>('EapHostPeerConfigXml2Blob');
...
void EapHostPeerFreeErrorMemory(Pointer<EAP_ERROR> pEapError) =>
    _EapHostPeerFreeErrorMemory(pEapError);

late final _EapHostPeerFreeErrorMemory = _eappcfg.lookupFunction<
    Void Function(Pointer<EAP_ERROR> pEapError),
    void Function(Pointer<EAP_ERROR> pEapError)>('EapHostPeerFreeErrorMemory');

void EapHostPeerFreeMemory(Pointer<Uint8> pData) =>
    _EapHostPeerFreeMemory(pData);

late final _EapHostPeerFreeMemory = _eappcfg.lookupFunction<
    Void Function(Pointer<Uint8> pData),
    void Function(Pointer<Uint8> pData)>('EapHostPeerFreeMemory');
...
int EapHostPeerGetMethods(Pointer<EAP_METHOD_INFO_ARRAY> pEapMethodInfoArray,
        Pointer<Pointer<EAP_ERROR>> ppEapError) =>
    _EapHostPeerGetMethods(pEapMethodInfoArray, ppEapError);

late final _EapHostPeerGetMethods = _eappcfg.lookupFunction<
    Uint32 Function(Pointer<EAP_METHOD_INFO_ARRAY> pEapMethodInfoArray,
        Pointer<Pointer<EAP_ERROR>> ppEapError),
    int Function(Pointer<EAP_METHOD_INFO_ARRAY> pEapMethodInfoArray,
        Pointer<Pointer<EAP_ERROR>> ppEapError)>('EapHostPeerGetMethods');
...
late final _EapHostPeerInvokeConfigUI = _eappcfg.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> pdwSizeOfConfigOut,
        Pointer<Pointer<Uint8>> ppConfigOut,
        Pointer<Pointer<EAP_ERROR>> ppEapError)>('EapHostPeerInvokeConfigUI');
...
late final _EapHostPeerInvokeIdentityUI = _eappcfg.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Pointer<Utf16>> ppwszIdentity,
        Pointer<Pointer<EAP_ERROR>> ppEapError,
        Pointer<Pointer> ppvReserved)>('EapHostPeerInvokeIdentityUI');
...
late final _EapHostPeerBeginSession = _eappprxy.lookupFunction<
    ...
    int Function(
        ...
        Pointer pContextData,
        Pointer<Uint32> pSessionId,
        Pointer<Pointer<EAP_ERROR>> ppEapError)>('EapHostPeerBeginSession');

int EapHostPeerClearConnection(
        Pointer<GUID> pConnectionId, Pointer<Pointer<EAP_ERROR>> ppEapError) =>
    _EapHostPeerClearConnection(pConnectionId, ppEapError);

late final _EapHostPeerClearConnection = _eappprxy.lookupFunction<
    Uint32 Function(
        Pointer<GUID> pConnectionId, Pointer<Pointer<EAP_ERROR>> ppEapError),
    int Function(Pointer<GUID> pConnectionId,
        Pointer<Pointer<EAP_ERROR>> ppEapError)>('EapHostPeerClearConnection');

int EapHostPeerEndSession(
        int sessionHandle, Pointer<Pointer<EAP_ERROR>> ppEapError) =>
    _EapHostPeerEndSession(sessionHandle, ppEapError);

late final _EapHostPeerEndSession = _eappprxy.lookupFunction<
    Uint32 Function(
        Uint32 sessionHandle, Pointer<Pointer<EAP_ERROR>> ppEapError),
    int Function(int sessionHandle,
        Pointer<Pointer<EAP_ERROR>> ppEapError)>('EapHostPeerEndSession');

void EapHostPeerFreeEapError(Pointer<EAP_ERROR> pEapError) =>
    _EapHostPeerFreeEapError(pEapError);

late final _EapHostPeerFreeEapError = _eappprxy.lookupFunction<
    Void Function(Pointer<EAP_ERROR> pEapError),
    void Function(Pointer<EAP_ERROR> pEapError)>('EapHostPeerFreeEapError');

void EapHostPeerFreeRuntimeMemory(Pointer<Uint8> pData) =>
    _EapHostPeerFreeRuntimeMemory(pData);

late final _EapHostPeerFreeRuntimeMemory = _eappprxy.lookupFunction<
    Void Function(Pointer<Uint8> pData),
    void Function(Pointer<Uint8> pData)>('EapHostPeerFreeRuntimeMemory');
...
int EapHostPeerGetAuthStatus(
    ...
    _EapHostPeerGetAuthStatus(
        sessionHandle, authParam, pcbAuthData, ppAuthData, ppEapError);
...
late final _EapHostPeerGetAuthStatus = _eappprxy.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> pcbAuthData,
        Pointer<Pointer<Uint8>> ppAuthData,
        Pointer<Pointer<EAP_ERROR>> ppEapError)>('EapHostPeerGetAuthStatus');
...
int EapHostPeerGetEncryptedPassword(int dwSizeofPassword,
        Pointer<Utf16> szPassword, Pointer<Pointer<Utf16>> ppszEncPassword) =>
...
late final _EapHostPeerGetEncryptedPassword = _eappprxy.lookupFunction<
        Uint32 Function(Uint32 dwSizeofPassword, Pointer<Utf16> szPassword,
            Pointer<Pointer<Utf16>> ppszEncPassword),
        int Function(int dwSizeofPassword, Pointer<Utf16> szPassword,
            Pointer<Pointer<Utf16>> ppszEncPassword)>(
...
late final _EapHostPeerGetIdentity = _eappprxy.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Pointer<Utf16>> ppwszIdentity,
        Pointer<Pointer<EAP_ERROR>> ppEapError,
        Pointer<Pointer<Uint8>> ppvReserved)>('EapHostPeerGetIdentity');

int EapHostPeerGetResponseAttributes(
        int sessionHandle,
        Pointer<EAP_ATTRIBUTES> pAttribs,
        Pointer<Pointer<EAP_ERROR>> ppEapError) =>
    _EapHostPeerGetResponseAttributes(sessionHandle, pAttribs, ppEapError);

late final _EapHostPeerGetResponseAttributes = _eappprxy.lookupFunction<
        Uint32 Function(Uint32 sessionHandle, Pointer<EAP_ATTRIBUTES> pAttribs,
            Pointer<Pointer<EAP_ERROR>> ppEapError),
        int Function(int sessionHandle, Pointer<EAP_ATTRIBUTES> pAttribs,
            Pointer<Pointer<EAP_ERROR>> ppEapError)>(
...
int EapHostPeerGetResult(
        ...
        Pointer<Pointer<EAP_ERROR>> ppEapError) =>
    _EapHostPeerGetResult(sessionHandle, reason, ppResult, ppEapError);
...
late final _EapHostPeerGetResult = _eappprxy.lookupFunction<
    ...
    int Function(
        ...
        int reason,
        Pointer<EapHostPeerMethodResult> ppResult,
        Pointer<Pointer<EAP_ERROR>> ppEapError)>('EapHostPeerGetResult');
...
int EapHostPeerGetSendPacket(
    ...
    _EapHostPeerGetSendPacket(
        sessionHandle, pcbSendPacket, ppSendPacket, ppEapError);
...
late final _EapHostPeerGetSendPacket = _eappprxy.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> pcbSendPacket,
        Pointer<Pointer<Uint8>> ppSendPacket,
        Pointer<Pointer<EAP_ERROR>> ppEapError)>('EapHostPeerGetSendPacket');
...
int EapHostPeerGetUIContext(
    ...
    _EapHostPeerGetUIContext(
        sessionHandle, pdwSizeOfUIContextData, ppUIContextData, ppEapError);
...
late final _EapHostPeerGetUIContext = _eappprxy.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> pdwSizeOfUIContextData,
        Pointer<Pointer<Uint8>> ppUIContextData,
        Pointer<Pointer<EAP_ERROR>> ppEapError)>('EapHostPeerGetUIContext');
...
int EapHostPeerProcessReceivedPacket(
    ...
    _EapHostPeerProcessReceivedPacket(
        sessionHandle, cbReceivePacket, pReceivePacket, pEapOutput, ppEapError);
...
int EapHostPeerSetResponseAttributes(
    ...
    _EapHostPeerSetResponseAttributes(
        sessionHandle, pAttribs, pEapOutput, ppEapError);

late final _EapHostPeerSetResponseAttributes = _eappprxy.lookupFunction<
        Uint32 Function(Uint32 sessionHandle, Pointer<EAP_ATTRIBUTES> pAttribs,
            Pointer<Int32> pEapOutput, Pointer<Pointer<EAP_ERROR>> ppEapError),
        int Function(int sessionHandle, Pointer<EAP_ATTRIBUTES> pAttribs,
            Pointer<Int32> pEapOutput, Pointer<Pointer<EAP_ERROR>> ppEapError)>(
...
int EapHostPeerSetUIContext(
        ...
        Pointer<Int32> pEapOutput,
        Pointer<Pointer<EAP_ERROR>> ppEapError) =>
    _EapHostPeerSetUIContext(sessionHandle, dwSizeOfUIContextData,
        pUIContextData, pEapOutput, ppEapError);
...
late final _EapHostPeerSetUIContext = _eappprxy.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint8> pUIContextData,
        Pointer<Int32> pEapOutput,
        Pointer<Pointer<EAP_ERROR>> ppEapError)>('EapHostPeerSetUIContext');
