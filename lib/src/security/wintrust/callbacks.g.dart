...
typedef PFN_ALLOCANDFILLDEFUSAGE = Int32 Function(
    Pointer<Utf8> pszUsageOID, Pointer<CRYPT_PROVIDER_DEFUSAGE> psDefUsage);
...
typedef PFN_CPD_ADD_STORE = Int32 Function(
    Pointer<CRYPT_PROVIDER_DATA> pProvData, Pointer hStore2Add);
typedef PFN_CPD_MEM_ALLOC = Pointer Function(Uint32 cbSize);
typedef PFN_CPD_MEM_FREE = Void Function(Pointer pvMem2Free);
...
typedef PFN_PROVUI_CALL = Int32 Function(
    IntPtr hWndSecurityDialog, Pointer<CRYPT_PROVIDER_DATA> pProvData);
