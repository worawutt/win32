...
class ITpmVirtualSmartCardManager extends IUnknown {
  ...
  int DestroyVirtualSmartCard(Pointer<Utf16> pszInstanceId,
          Pointer<COMObject> pStatusCallback, Pointer<Int32> pfNeedReboot) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pStatusCallback,
                      Pointer<Int32> pfNeedReboot)>()(
          ptr.ref.lpVtbl, pszInstanceId, pStatusCallback, pfNeedReboot);
}
