...
int DSCreateISecurityInfoObject(
        ...
        int lpContext) =>
    _DSCreateISecurityInfoObject(pwszObjectPath, pwszObjectClass, dwFlags, ppSI,
        pfnReadSD, pfnWriteSD, lpContext);
...
late final _DSCreateISecurityInfoObject = _dssec.lookupFunction<
    ...
    int Function(
        ...
        Pointer<NativeFunction<PFNREADOBJECTSECURITY>> pfnReadSD,
        Pointer<NativeFunction<PFNWRITEOBJECTSECURITY>> pfnWriteSD,
        int lpContext)>('DSCreateISecurityInfoObject');
...
late final _DSCreateISecurityInfoObjectEx = _dssec.lookupFunction<
    ...
    int Function(
        ...
        Pointer<NativeFunction<PFNREADOBJECTSECURITY>> pfnReadSD,
        Pointer<NativeFunction<PFNWRITEOBJECTSECURITY>> pfnWriteSD,
        int lpContext)>('DSCreateISecurityInfoObjectEx');
...
int DSCreateSecurityPage(
        ...
        Pointer<NativeFunction<PFNWRITEOBJECTSECURITY>> pfnWriteSD,
        int lpContext) =>
    _DSCreateSecurityPage(pwszObjectPath, pwszObjectClass, dwFlags, phPage,
        pfnReadSD, pfnWriteSD, lpContext);
...
late final _DSCreateSecurityPage = _dssec.lookupFunction<
    ...
    int Function(
        ...
        Pointer<NativeFunction<PFNREADOBJECTSECURITY>> pfnReadSD,
        Pointer<NativeFunction<PFNWRITEOBJECTSECURITY>> pfnWriteSD,
        int lpContext)>('DSCreateSecurityPage');
...
int DSEditSecurity(
        ...
        Pointer<NativeFunction<PFNWRITEOBJECTSECURITY>> pfnWriteSD,
        int lpContext) =>
    _DSEditSecurity(hwndOwner, pwszObjectPath, pwszObjectClass, dwFlags,
        pwszCaption, pfnReadSD, pfnWriteSD, lpContext);
