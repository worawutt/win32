...
typedef PFNDSEDITSECURITY = Int32 Function(
    ...
    IntPtr param7);
typedef PFNREADOBJECTSECURITY = Int32 Function(Pointer<Utf16> param0,
    Uint32 param1, Pointer<Pointer<SECURITY_DESCRIPTOR>> param2, IntPtr param3);
typedef PFNWRITEOBJECTSECURITY = Int32 Function(Pointer<Utf16> param0,
    Uint32 param1, Pointer<SECURITY_DESCRIPTOR> param2, IntPtr param3);
