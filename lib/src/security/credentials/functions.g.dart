...
void KeyCredentialManagerFreeInformation(
    ...
    _KeyCredentialManagerFreeInformation(keyCredentialManagerInfo);

late final _KeyCredentialManagerFreeInformation = _keycredmgr.lookupFunction<
    Void Function(Pointer<KeyCredentialManagerInfo> keyCredentialManagerInfo),
    void Function(
        Pointer<KeyCredentialManagerInfo>
            keyCredentialManagerInfo)>('KeyCredentialManagerFreeInformation');

int KeyCredentialManagerGetInformation(
        Pointer<Pointer<KeyCredentialManagerInfo>> keyCredentialManagerInfo) =>
    _KeyCredentialManagerGetInformation(keyCredentialManagerInfo);

late final _KeyCredentialManagerGetInformation = _keycredmgr.lookupFunction<
    Int32 Function(
        Pointer<Pointer<KeyCredentialManagerInfo>> keyCredentialManagerInfo),
    int Function(
        Pointer<Pointer<KeyCredentialManagerInfo>>
            keyCredentialManagerInfo)>('KeyCredentialManagerGetInformation');
...
int KeyCredentialManagerShowUIOperation(
        int hWndOwner, int keyCredentialManagerOperationType) =>
    _KeyCredentialManagerShowUIOperation(
        hWndOwner, keyCredentialManagerOperationType);

late final _KeyCredentialManagerShowUIOperation =
    _keycredmgr.lookupFunction<
            Int32 Function(
                IntPtr hWndOwner, Int32 keyCredentialManagerOperationType),
            int Function(int hWndOwner, int keyCredentialManagerOperationType)>(
...
int CredEnumerate(Pointer<Utf16> Filter, int Flags, Pointer<Uint32> Count,
        Pointer<Pointer<Pointer<CREDENTIAL>>> Credential) =>
    _CredEnumerate(Filter, Flags, Count, Credential);

late final _CredEnumerate = _advapi32.lookupFunction<
    Int32 Function(Pointer<Utf16> Filter, Uint32 Flags, Pointer<Uint32> Count,
        Pointer<Pointer<Pointer<CREDENTIAL>>> Credential),
    int Function(Pointer<Utf16> Filter, int Flags, Pointer<Uint32> Count,
        Pointer<Pointer<Pointer<CREDENTIAL>>> Credential)>('CredEnumerateW');

int CredFindBestCredential(Pointer<Utf16> TargetName, int Type, int Flags,
        Pointer<Pointer<CREDENTIAL>> Credential) =>
    _CredFindBestCredential(TargetName, Type, Flags, Credential);

late final _CredFindBestCredential = _advapi32.lookupFunction<
    Int32 Function(Pointer<Utf16> TargetName, Uint32 Type, Uint32 Flags,
        Pointer<Pointer<CREDENTIAL>> Credential),
    int Function(Pointer<Utf16> TargetName, int Type, int Flags,
        Pointer<Pointer<CREDENTIAL>> Credential)>('CredFindBestCredentialW');
...
int CredGetSessionTypes(
        int MaximumPersistCount, Pointer<Uint32> MaximumPersist) =>
    _CredGetSessionTypes(MaximumPersistCount, MaximumPersist);

late final _CredGetSessionTypes = _advapi32.lookupFunction<
    Int32 Function(Uint32 MaximumPersistCount, Pointer<Uint32> MaximumPersist),
    int Function(int MaximumPersistCount,
        Pointer<Uint32> MaximumPersist)>('CredGetSessionTypes');

int CredGetTargetInfo(Pointer<Utf16> TargetName, int Flags,
        Pointer<Pointer<CREDENTIAL_TARGET_INFORMATION>> TargetInfo) =>
    _CredGetTargetInfo(TargetName, Flags, TargetInfo);

late final _CredGetTargetInfo = _advapi32.lookupFunction<
        Int32 Function(Pointer<Utf16> TargetName, Uint32 Flags,
            Pointer<Pointer<CREDENTIAL_TARGET_INFORMATION>> TargetInfo),
        int Function(Pointer<Utf16> TargetName, int Flags,
            Pointer<Pointer<CREDENTIAL_TARGET_INFORMATION>> TargetInfo)>(
    'CredGetTargetInfoW');

int CredIsMarshaledCredential(Pointer<Utf16> MarshaledCredential) =>
    _CredIsMarshaledCredential(MarshaledCredential);

late final _CredIsMarshaledCredential = _advapi32.lookupFunction<
    Int32 Function(Pointer<Utf16> MarshaledCredential),
    int Function(
        Pointer<Utf16> MarshaledCredential)>('CredIsMarshaledCredentialW');

int CredIsProtected(Pointer<Utf16> pszProtectedCredentials,
        Pointer<Int32> pProtectionType) =>
    _CredIsProtected(pszProtectedCredentials, pProtectionType);

late final _CredIsProtected = _advapi32.lookupFunction<
    Int32 Function(
        Pointer<Utf16> pszProtectedCredentials, Pointer<Int32> pProtectionType),
    int Function(Pointer<Utf16> pszProtectedCredentials,
        Pointer<Int32> pProtectionType)>('CredIsProtectedW');

int CredMarshalCredential(int CredType, Pointer Credential,
        Pointer<Pointer<Utf16>> MarshaledCredential) =>
    _CredMarshalCredential(CredType, Credential, MarshaledCredential);

late final _CredMarshalCredential = _advapi32.lookupFunction<
    Int32 Function(Int32 CredType, Pointer Credential,
        Pointer<Pointer<Utf16>> MarshaledCredential),
    int Function(int CredType, Pointer Credential,
        Pointer<Pointer<Utf16>> MarshaledCredential)>('CredMarshalCredentialW');
...
int CredProtect(
    ...
    _CredProtect(fAsSelf, pszCredentials, cchCredentials,
        pszProtectedCredentials, pcchMaxChars, ProtectionType);
...
late final _CredProtect = _advapi32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Utf16> pszProtectedCredentials,
        Pointer<Uint32> pcchMaxChars,
        Pointer<Int32> ProtectionType)>('CredProtectW');
...
int CredReadDomainCredentials(
        ...
        Pointer<Pointer<Pointer<CREDENTIAL>>> Credential) =>
    _CredReadDomainCredentials(TargetInfo, Flags, Count, Credential);
...
int CredRename(Pointer<Utf16> OldTargetName, Pointer<Utf16> NewTargetName,
        int Type, int Flags) =>
    _CredRename(OldTargetName, NewTargetName, Type, Flags);

late final _CredRename = _advapi32.lookupFunction<
    Int32 Function(Pointer<Utf16> OldTargetName, Pointer<Utf16> NewTargetName,
        Uint32 Type, Uint32 Flags),
    int Function(Pointer<Utf16> OldTargetName, Pointer<Utf16> NewTargetName,
        int Type, int Flags)>('CredRenameW');

int CredUnmarshalCredential(Pointer<Utf16> MarshaledCredential,
        Pointer<Int32> CredType, Pointer<Pointer> Credential) =>
    _CredUnmarshalCredential(MarshaledCredential, CredType, Credential);

late final _CredUnmarshalCredential = _advapi32.lookupFunction<
    Int32 Function(Pointer<Utf16> MarshaledCredential, Pointer<Int32> CredType,
        Pointer<Pointer> Credential),
    int Function(Pointer<Utf16> MarshaledCredential, Pointer<Int32> CredType,
        Pointer<Pointer> Credential)>('CredUnmarshalCredentialW');
...
int CredUnprotect(
        ...
        Pointer<Utf16> pszCredentials,
        Pointer<Uint32> pcchMaxChars) =>
    _CredUnprotect(fAsSelf, pszProtectedCredentials, cchProtectedCredentials,
        pszCredentials, pcchMaxChars);
...
late final _CredUnprotect = _advapi32.lookupFunction<
    ...
    int Function(
        ...
        int cchProtectedCredentials,
        Pointer<Utf16> pszCredentials,
        Pointer<Uint32> pcchMaxChars)>('CredUnprotectW');

int CredWriteDomainCredentials(
        Pointer<CREDENTIAL_TARGET_INFORMATION> TargetInfo,
        Pointer<CREDENTIAL> Credential,
        int Flags) =>
    _CredWriteDomainCredentials(TargetInfo, Credential, Flags);

late final _CredWriteDomainCredentials = _advapi32.lookupFunction<
    Int32 Function(Pointer<CREDENTIAL_TARGET_INFORMATION> TargetInfo,
        Pointer<CREDENTIAL> Credential, Uint32 Flags),
    int Function(
        Pointer<CREDENTIAL_TARGET_INFORMATION> TargetInfo,
        Pointer<CREDENTIAL> Credential,
        int Flags)>('CredWriteDomainCredentialsW');
...
int SCardState(int hCard, Pointer<Uint32> pdwState, Pointer<Uint32> pdwProtocol,
        Pointer<Uint8> pbAtr, Pointer<Uint32> pcbAtrLen) =>
    _SCardState(hCard, pdwState, pdwProtocol, pbAtr, pcbAtrLen);
...
late final _SCardState = _winscard.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> pdwProtocol,
        Pointer<Uint8> pbAtr,
        Pointer<Uint32> pcbAtrLen)>('SCardState');
...
int GetOpenCardName(Pointer<OPENCARDNAME> param0) => _GetOpenCardName(param0);

late final _GetOpenCardName = _scarddlg.lookupFunction<
    Int32 Function(Pointer<OPENCARDNAME> param0),
    int Function(Pointer<OPENCARDNAME> param0)>('GetOpenCardNameW');
