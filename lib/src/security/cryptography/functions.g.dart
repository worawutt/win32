...
int CryptAcquireContext(Pointer<IntPtr> phProv, Pointer<Utf16> szContainer,
        Pointer<Utf16> szProvider, int dwProvType, int dwFlags) =>
    _CryptAcquireContext(phProv, szContainer, szProvider, dwProvType, dwFlags);

late final _CryptAcquireContext = _advapi32.lookupFunction<
    Int32 Function(Pointer<IntPtr> phProv, Pointer<Utf16> szContainer,
        Pointer<Utf16> szProvider, Uint32 dwProvType, Uint32 dwFlags),
    int Function(
        Pointer<IntPtr> phProv,
        Pointer<Utf16> szContainer,
        Pointer<Utf16> szProvider,
        int dwProvType,
        int dwFlags)>('CryptAcquireContextW');

int CryptContextAddRef(int hProv, Pointer<Uint32> pdwReserved, int dwFlags) =>
    _CryptContextAddRef(hProv, pdwReserved, dwFlags);

late final _CryptContextAddRef = _advapi32.lookupFunction<
    Int32 Function(IntPtr hProv, Pointer<Uint32> pdwReserved, Uint32 dwFlags),
    int Function(int hProv, Pointer<Uint32> pdwReserved,
        int dwFlags)>('CryptContextAddRef');

int CryptCreateHash(
        int hProv, int Algid, int hKey, int dwFlags, Pointer<IntPtr> phHash) =>
    _CryptCreateHash(hProv, Algid, hKey, dwFlags, phHash);

late final _CryptCreateHash = _advapi32.lookupFunction<
    Int32 Function(IntPtr hProv, Uint32 Algid, IntPtr hKey, Uint32 dwFlags,
        Pointer<IntPtr> phHash),
    int Function(int hProv, int Algid, int hKey, int dwFlags,
        Pointer<IntPtr> phHash)>('CryptCreateHash');

int CryptDecrypt(int hKey, int hHash, int Final, int dwFlags,
        Pointer<Uint8> pbData, Pointer<Uint32> pdwDataLen) =>
    _CryptDecrypt(hKey, hHash, Final, dwFlags, pbData, pdwDataLen);

late final _CryptDecrypt = _advapi32.lookupFunction<
    Int32 Function(IntPtr hKey, IntPtr hHash, Int32 Final, Uint32 dwFlags,
        Pointer<Uint8> pbData, Pointer<Uint32> pdwDataLen),
    int Function(int hKey, int hHash, int Final, int dwFlags,
        Pointer<Uint8> pbData, Pointer<Uint32> pdwDataLen)>('CryptDecrypt');

int CryptDeriveKey(int hProv, int Algid, int hBaseData, int dwFlags,
        Pointer<IntPtr> phKey) =>
    _CryptDeriveKey(hProv, Algid, hBaseData, dwFlags, phKey);

late final _CryptDeriveKey = _advapi32.lookupFunction<
    Int32 Function(IntPtr hProv, Uint32 Algid, IntPtr hBaseData, Uint32 dwFlags,
        Pointer<IntPtr> phKey),
    int Function(int hProv, int Algid, int hBaseData, int dwFlags,
        Pointer<IntPtr> phKey)>('CryptDeriveKey');

int CryptDestroyHash(int hHash) => _CryptDestroyHash(hHash);

late final _CryptDestroyHash = _advapi32.lookupFunction<
    Int32 Function(IntPtr hHash), int Function(int hHash)>('CryptDestroyHash');

int CryptDestroyKey(int hKey) => _CryptDestroyKey(hKey);

late final _CryptDestroyKey = _advapi32.lookupFunction<
    Int32 Function(IntPtr hKey), int Function(int hKey)>('CryptDestroyKey');

int CryptDuplicateHash(int hHash, Pointer<Uint32> pdwReserved, int dwFlags,
        Pointer<IntPtr> phHash) =>
    _CryptDuplicateHash(hHash, pdwReserved, dwFlags, phHash);

late final _CryptDuplicateHash = _advapi32.lookupFunction<
    Int32 Function(IntPtr hHash, Pointer<Uint32> pdwReserved, Uint32 dwFlags,
        Pointer<IntPtr> phHash),
    int Function(int hHash, Pointer<Uint32> pdwReserved, int dwFlags,
        Pointer<IntPtr> phHash)>('CryptDuplicateHash');

int CryptDuplicateKey(int hKey, Pointer<Uint32> pdwReserved, int dwFlags,
        Pointer<IntPtr> phKey) =>
    _CryptDuplicateKey(hKey, pdwReserved, dwFlags, phKey);

late final _CryptDuplicateKey = _advapi32.lookupFunction<
    Int32 Function(IntPtr hKey, Pointer<Uint32> pdwReserved, Uint32 dwFlags,
        Pointer<IntPtr> phKey),
    int Function(int hKey, Pointer<Uint32> pdwReserved, int dwFlags,
        Pointer<IntPtr> phKey)>('CryptDuplicateKey');

int CryptEncrypt(int hKey, int hHash, int Final, int dwFlags,
        Pointer<Uint8> pbData, Pointer<Uint32> pdwDataLen, int dwBufLen) =>
    _CryptEncrypt(hKey, hHash, Final, dwFlags, pbData, pdwDataLen, dwBufLen);

late final _CryptEncrypt = _advapi32.lookupFunction<
    Int32 Function(IntPtr hKey, IntPtr hHash, Int32 Final, Uint32 dwFlags,
        Pointer<Uint8> pbData, Pointer<Uint32> pdwDataLen, Uint32 dwBufLen),
    int Function(
        int hKey,
        int hHash,
        int Final,
...
late final _CryptEnumProviderTypes = _advapi32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> pdwProvType,
        Pointer<Utf16> szTypeName,
        Pointer<Uint32> pcbTypeName)>('CryptEnumProviderTypesW');
...
late final _CryptEnumProviders = _advapi32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> pdwProvType,
        Pointer<Utf16> szProvName,
        Pointer<Uint32> pcbProvName)>('CryptEnumProvidersW');

int CryptExportKey(int hKey, int hExpKey, int dwBlobType, int dwFlags,
        Pointer<Uint8> pbData, Pointer<Uint32> pdwDataLen) =>
    _CryptExportKey(hKey, hExpKey, dwBlobType, dwFlags, pbData, pdwDataLen);

late final _CryptExportKey = _advapi32.lookupFunction<
    Int32 Function(IntPtr hKey, IntPtr hExpKey, Uint32 dwBlobType,
        Uint32 dwFlags, Pointer<Uint8> pbData, Pointer<Uint32> pdwDataLen),
    int Function(int hKey, int hExpKey, int dwBlobType, int dwFlags,
        Pointer<Uint8> pbData, Pointer<Uint32> pdwDataLen)>('CryptExportKey');

int CryptGenKey(int hProv, int Algid, int dwFlags, Pointer<IntPtr> phKey) =>
    _CryptGenKey(hProv, Algid, dwFlags, phKey);

late final _CryptGenKey = _advapi32.lookupFunction<
    Int32 Function(
        IntPtr hProv, Uint32 Algid, Uint32 dwFlags, Pointer<IntPtr> phKey),
    int Function(int hProv, int Algid, int dwFlags,
        Pointer<IntPtr> phKey)>('CryptGenKey');

int CryptGenRandom(int hProv, int dwLen, Pointer<Uint8> pbBuffer) =>
    _CryptGenRandom(hProv, dwLen, pbBuffer);

late final _CryptGenRandom = _advapi32.lookupFunction<
    Int32 Function(IntPtr hProv, Uint32 dwLen, Pointer<Uint8> pbBuffer),
    int Function(
        int hProv, int dwLen, Pointer<Uint8> pbBuffer)>('CryptGenRandom');

int CryptGetDefaultProvider(int dwProvType, Pointer<Uint32> pdwReserved,
        int dwFlags, Pointer<Utf16> pszProvName, Pointer<Uint32> pcbProvName) =>
...
late final _CryptGetDefaultProvider = _advapi32.lookupFunction<
    ...
    int Function(
        ...
        int dwFlags,
        Pointer<Utf16> pszProvName,
        Pointer<Uint32> pcbProvName)>('CryptGetDefaultProviderW');

int CryptGetHashParam(int hHash, int dwParam, Pointer<Uint8> pbData,
        Pointer<Uint32> pdwDataLen, int dwFlags) =>
    _CryptGetHashParam(hHash, dwParam, pbData, pdwDataLen, dwFlags);

late final _CryptGetHashParam = _advapi32.lookupFunction<
    Int32 Function(IntPtr hHash, Uint32 dwParam, Pointer<Uint8> pbData,
        Pointer<Uint32> pdwDataLen, Uint32 dwFlags),
    int Function(int hHash, int dwParam, Pointer<Uint8> pbData,
        Pointer<Uint32> pdwDataLen, int dwFlags)>('CryptGetHashParam');

int CryptGetKeyParam(int hKey, int dwParam, Pointer<Uint8> pbData,
        Pointer<Uint32> pdwDataLen, int dwFlags) =>
    _CryptGetKeyParam(hKey, dwParam, pbData, pdwDataLen, dwFlags);

late final _CryptGetKeyParam = _advapi32.lookupFunction<
    Int32 Function(IntPtr hKey, Uint32 dwParam, Pointer<Uint8> pbData,
        Pointer<Uint32> pdwDataLen, Uint32 dwFlags),
    int Function(int hKey, int dwParam, Pointer<Uint8> pbData,
        Pointer<Uint32> pdwDataLen, int dwFlags)>('CryptGetKeyParam');

int CryptGetProvParam(int hProv, int dwParam, Pointer<Uint8> pbData,
        Pointer<Uint32> pdwDataLen, int dwFlags) =>
    _CryptGetProvParam(hProv, dwParam, pbData, pdwDataLen, dwFlags);

late final _CryptGetProvParam = _advapi32.lookupFunction<
    Int32 Function(IntPtr hProv, Uint32 dwParam, Pointer<Uint8> pbData,
        Pointer<Uint32> pdwDataLen, Uint32 dwFlags),
    int Function(int hProv, int dwParam, Pointer<Uint8> pbData,
        Pointer<Uint32> pdwDataLen, int dwFlags)>('CryptGetProvParam');

int CryptGetUserKey(int hProv, int dwKeySpec, Pointer<IntPtr> phUserKey) =>
    _CryptGetUserKey(hProv, dwKeySpec, phUserKey);

late final _CryptGetUserKey = _advapi32.lookupFunction<
    Int32 Function(IntPtr hProv, Uint32 dwKeySpec, Pointer<IntPtr> phUserKey),
    int Function(int hProv, int dwKeySpec,
        Pointer<IntPtr> phUserKey)>('CryptGetUserKey');

int CryptHashData(
        int hHash, Pointer<Uint8> pbData, int dwDataLen, int dwFlags) =>
    _CryptHashData(hHash, pbData, dwDataLen, dwFlags);

late final _CryptHashData = _advapi32.lookupFunction<
    Int32 Function(
        IntPtr hHash, Pointer<Uint8> pbData, Uint32 dwDataLen, Uint32 dwFlags),
    int Function(int hHash, Pointer<Uint8> pbData, int dwDataLen,
        int dwFlags)>('CryptHashData');

int CryptHashSessionKey(int hHash, int hKey, int dwFlags) =>
    _CryptHashSessionKey(hHash, hKey, dwFlags);

late final _CryptHashSessionKey = _advapi32.lookupFunction<
    Int32 Function(IntPtr hHash, IntPtr hKey, Uint32 dwFlags),
    int Function(int hHash, int hKey, int dwFlags)>('CryptHashSessionKey');

int CryptImportKey(int hProv, Pointer<Uint8> pbData, int dwDataLen, int hPubKey,
        int dwFlags, Pointer<IntPtr> phKey) =>
    _CryptImportKey(hProv, pbData, dwDataLen, hPubKey, dwFlags, phKey);

late final _CryptImportKey = _advapi32.lookupFunction<
    Int32 Function(IntPtr hProv, Pointer<Uint8> pbData, Uint32 dwDataLen,
        IntPtr hPubKey, Uint32 dwFlags, Pointer<IntPtr> phKey),
    int Function(int hProv, Pointer<Uint8> pbData, int dwDataLen, int hPubKey,
        int dwFlags, Pointer<IntPtr> phKey)>('CryptImportKey');

int CryptReleaseContext(int hProv, int dwFlags) =>
    _CryptReleaseContext(hProv, dwFlags);

late final _CryptReleaseContext = _advapi32.lookupFunction<
    Int32 Function(IntPtr hProv, Uint32 dwFlags),
    int Function(int hProv, int dwFlags)>('CryptReleaseContext');

int CryptSetHashParam(
        int hHash, int dwParam, Pointer<Uint8> pbData, int dwFlags) =>
    _CryptSetHashParam(hHash, dwParam, pbData, dwFlags);

late final _CryptSetHashParam = _advapi32.lookupFunction<
    Int32 Function(
        IntPtr hHash, Uint32 dwParam, Pointer<Uint8> pbData, Uint32 dwFlags),
    int Function(int hHash, int dwParam, Pointer<Uint8> pbData,
        int dwFlags)>('CryptSetHashParam');

int CryptSetKeyParam(
        int hKey, int dwParam, Pointer<Uint8> pbData, int dwFlags) =>
    _CryptSetKeyParam(hKey, dwParam, pbData, dwFlags);

late final _CryptSetKeyParam = _advapi32.lookupFunction<
    Int32 Function(
        IntPtr hKey, Uint32 dwParam, Pointer<Uint8> pbData, Uint32 dwFlags),
    int Function(int hKey, int dwParam, Pointer<Uint8> pbData,
        int dwFlags)>('CryptSetKeyParam');

int CryptSetProvParam(
        int hProv, int dwParam, Pointer<Uint8> pbData, int dwFlags) =>
    _CryptSetProvParam(hProv, dwParam, pbData, dwFlags);

late final _CryptSetProvParam = _advapi32.lookupFunction<
    Int32 Function(
        IntPtr hProv, Uint32 dwParam, Pointer<Uint8> pbData, Uint32 dwFlags),
    int Function(int hProv, int dwParam, Pointer<Uint8> pbData,
        int dwFlags)>('CryptSetProvParam');

int CryptSetProviderEx(Pointer<Utf16> pszProvName, int dwProvType,
        Pointer<Uint32> pdwReserved, int dwFlags) =>
    _CryptSetProviderEx(pszProvName, dwProvType, pdwReserved, dwFlags);

late final _CryptSetProviderEx = _advapi32.lookupFunction<
    Int32 Function(Pointer<Utf16> pszProvName, Uint32 dwProvType,
        Pointer<Uint32> pdwReserved, Uint32 dwFlags),
    int Function(Pointer<Utf16> pszProvName, int dwProvType,
        Pointer<Uint32> pdwReserved, int dwFlags)>('CryptSetProviderExW');

int CryptSetProvider(Pointer<Utf16> pszProvName, int dwProvType) =>
    _CryptSetProvider(pszProvName, dwProvType);

late final _CryptSetProvider = _advapi32.lookupFunction<
    Int32 Function(Pointer<Utf16> pszProvName, Uint32 dwProvType),
    int Function(
        Pointer<Utf16> pszProvName, int dwProvType)>('CryptSetProviderW');

int CryptSignHash(int hHash, int dwKeySpec, Pointer<Utf16> szDescription,
        int dwFlags, Pointer<Uint8> pbSignature, Pointer<Uint32> pdwSigLen) =>
    _CryptSignHash(
        hHash, dwKeySpec, szDescription, dwFlags, pbSignature, pdwSigLen);

late final _CryptSignHash = _advapi32.lookupFunction<
    Int32 Function(IntPtr hHash, Uint32 dwKeySpec, Pointer<Utf16> szDescription,
        Uint32 dwFlags, Pointer<Uint8> pbSignature, Pointer<Uint32> pdwSigLen),
    int Function(
        int hHash,
        int dwKeySpec,
        ...
        Pointer<Uint32> pdwSigLen)>('CryptSignHashW');

int CryptVerifySignature(int hHash, Pointer<Uint8> pbSignature, int dwSigLen,
        int hPubKey, Pointer<Utf16> szDescription, int dwFlags) =>
...
late final _CryptVerifySignature = _advapi32.lookupFunction<
    Int32 Function(IntPtr hHash, Pointer<Uint8> pbSignature, Uint32 dwSigLen,
        IntPtr hPubKey, Pointer<Utf16> szDescription, Uint32 dwFlags),
    int Function(
        int hHash,
        Pointer<Uint8> pbSignature,
        int dwSigLen,
        int hPubKey,
        Pointer<Utf16> szDescription,
        int dwFlags)>('CryptVerifySignatureW');
...
late final _CertAddCRLContextToStore = _crypt32.lookupFunction<
    Int32 Function(Pointer hCertStore, Pointer<CRL_CONTEXT> pCrlContext,
        Uint32 dwAddDisposition, Pointer<Pointer<CRL_CONTEXT>> ppStoreContext),
    int Function(
        Pointer hCertStore,
        Pointer<CRL_CONTEXT> pCrlContext,
        int dwAddDisposition,
        Pointer<Pointer<CRL_CONTEXT>>
            ppStoreContext)>('CertAddCRLContextToStore');

int CertAddCRLLinkToStore(Pointer hCertStore, Pointer<CRL_CONTEXT> pCrlContext,
        int dwAddDisposition, Pointer<Pointer<CRL_CONTEXT>> ppStoreContext) =>
...
late final _CertAddCRLLinkToStore = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<CRL_CONTEXT> pCrlContext,
        int dwAddDisposition,
        Pointer<Pointer<CRL_CONTEXT>> ppStoreContext)>('CertAddCRLLinkToStore');
...
late final _CertAddCTLContextToStore = _crypt32.lookupFunction<
    Int32 Function(Pointer hCertStore, Pointer<CTL_CONTEXT> pCtlContext,
        Uint32 dwAddDisposition, Pointer<Pointer<CTL_CONTEXT>> ppStoreContext),
    int Function(
        Pointer hCertStore,
        Pointer<CTL_CONTEXT> pCtlContext,
        int dwAddDisposition,
        Pointer<Pointer<CTL_CONTEXT>>
            ppStoreContext)>('CertAddCTLContextToStore');

int CertAddCTLLinkToStore(Pointer hCertStore, Pointer<CTL_CONTEXT> pCtlContext,
        int dwAddDisposition, Pointer<Pointer<CTL_CONTEXT>> ppStoreContext) =>
...
late final _CertAddCTLLinkToStore = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<CTL_CONTEXT> pCtlContext,
        int dwAddDisposition,
        Pointer<Pointer<CTL_CONTEXT>> ppStoreContext)>('CertAddCTLLinkToStore');
...
late final _CertAddCertificateContextToStore = _crypt32.lookupFunction<
    Int32 Function(Pointer hCertStore, Pointer<CERT_CONTEXT> pCertContext,
        Uint32 dwAddDisposition, Pointer<Pointer<CERT_CONTEXT>> ppStoreContext),
    int Function(
        Pointer hCertStore,
        Pointer<CERT_CONTEXT> pCertContext,
        int dwAddDisposition,
        Pointer<Pointer<CERT_CONTEXT>>
            ppStoreContext)>('CertAddCertificateContextToStore');
...
late final _CertAddCertificateLinkToStore = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        int dwAddDisposition,
        Pointer<Pointer<CERT_CONTEXT>>
            ppStoreContext)>('CertAddCertificateLinkToStore');
...
int CertAddEncodedCRLToStore(
    ...
    _CertAddEncodedCRLToStore(hCertStore, dwCertEncodingType, pbCrlEncoded,
        cbCrlEncoded, dwAddDisposition, ppCrlContext);
...
int CertAddEncodedCTLToStore(
    ...
    _CertAddEncodedCTLToStore(hCertStore, dwMsgAndCertEncodingType,
        pbCtlEncoded, cbCtlEncoded, dwAddDisposition, ppCtlContext);
...
int CertAddEncodedCertificateToStore(
    ...
    _CertAddEncodedCertificateToStore(hCertStore, dwCertEncodingType,
...
int CertAddEncodedCertificateToSystemStore(Pointer<Utf16> szCertStoreName,
        Pointer<Uint8> pbCertEncoded, int cbCertEncoded) =>
...
late final _CertAddEncodedCertificateToSystemStore = _crypt32.lookupFunction<
    Int32 Function(Pointer<Utf16> szCertStoreName, Pointer<Uint8> pbCertEncoded,
        Uint32 cbCertEncoded),
    int Function(Pointer<Utf16> szCertStoreName, Pointer<Uint8> pbCertEncoded,
        int cbCertEncoded)>('CertAddEncodedCertificateToSystemStoreW');

int CertAddEnhancedKeyUsageIdentifier(
        Pointer<CERT_CONTEXT> pCertContext, Pointer<Utf8> pszUsageIdentifier) =>
    _CertAddEnhancedKeyUsageIdentifier(pCertContext, pszUsageIdentifier);

late final _CertAddEnhancedKeyUsageIdentifier = _crypt32.lookupFunction<
    Int32 Function(
        Pointer<CERT_CONTEXT> pCertContext, Pointer<Utf8> pszUsageIdentifier),
    int Function(Pointer<CERT_CONTEXT> pCertContext,
        Pointer<Utf8> pszUsageIdentifier)>('CertAddEnhancedKeyUsageIdentifier');

void CertAddRefServerOcspResponse(Pointer hServerOcspResponse) =>
    _CertAddRefServerOcspResponse(hServerOcspResponse);

late final _CertAddRefServerOcspResponse = _crypt32.lookupFunction<
    Void Function(Pointer hServerOcspResponse),
    void Function(Pointer hServerOcspResponse)>('CertAddRefServerOcspResponse');

void CertAddRefServerOcspResponseContext(
        Pointer<CERT_SERVER_OCSP_RESPONSE_CONTEXT>
            pServerOcspResponseContext) =>
    _CertAddRefServerOcspResponseContext(pServerOcspResponseContext);
...
late final _CertAddRefServerOcspResponseContext = _crypt32.lookupFunction<
    ...
    void Function(
        Pointer<CERT_SERVER_OCSP_RESPONSE_CONTEXT>
            pServerOcspResponseContext)>('CertAddRefServerOcspResponseContext');
...
late final _CertAddSerializedElementToStore = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        int dwContextTypeFlags,
        Pointer<Uint32> pdwContextType,
        Pointer<Pointer> ppvContext)>('CertAddSerializedElementToStore');

int CertAddStoreToCollection(Pointer hCollectionStore, Pointer hSiblingStore,
        int dwUpdateFlags, int dwPriority) =>
...
late final _CertAddStoreToCollection = _crypt32.lookupFunction<
    Int32 Function(Pointer hCollectionStore, Pointer hSiblingStore,
        Uint32 dwUpdateFlags, Uint32 dwPriority),
    int Function(Pointer hCollectionStore, Pointer hSiblingStore,
        int dwUpdateFlags, int dwPriority)>('CertAddStoreToCollection');

Pointer<Utf8> CertAlgIdToOID(int dwAlgId) => _CertAlgIdToOID(dwAlgId);

late final _CertAlgIdToOID = _crypt32.lookupFunction<
    Pointer<Utf8> Function(Uint32 dwAlgId),
    Pointer<Utf8> Function(int dwAlgId)>('CertAlgIdToOID');

void CertCloseServerOcspResponse(Pointer hServerOcspResponse, int dwFlags) =>
    _CertCloseServerOcspResponse(hServerOcspResponse, dwFlags);

late final _CertCloseServerOcspResponse = _crypt32.lookupFunction<
    Void Function(Pointer hServerOcspResponse, Uint32 dwFlags),
    void Function(Pointer hServerOcspResponse,
        int dwFlags)>('CertCloseServerOcspResponse');

int CertCloseStore(Pointer hCertStore, int dwFlags) =>
    _CertCloseStore(hCertStore, dwFlags);

late final _CertCloseStore = _crypt32.lookupFunction<
    Int32 Function(Pointer hCertStore, Uint32 dwFlags),
    int Function(Pointer hCertStore, int dwFlags)>('CertCloseStore');

int CertCompareCertificate(int dwCertEncodingType, Pointer<CERT_INFO> pCertId1,
        Pointer<CERT_INFO> pCertId2) =>
    _CertCompareCertificate(dwCertEncodingType, pCertId1, pCertId2);

late final _CertCompareCertificate = _crypt32.lookupFunction<
    Int32 Function(Uint32 dwCertEncodingType, Pointer<CERT_INFO> pCertId1,
        Pointer<CERT_INFO> pCertId2),
    int Function(int dwCertEncodingType, Pointer<CERT_INFO> pCertId1,
        Pointer<CERT_INFO> pCertId2)>('CertCompareCertificate');

int CertCompareCertificateName(
        int dwCertEncodingType,
        Pointer<CRYPTOAPI_BLOB> pCertName1,
        Pointer<CRYPTOAPI_BLOB> pCertName2) =>
    _CertCompareCertificateName(dwCertEncodingType, pCertName1, pCertName2);

late final _CertCompareCertificateName = _crypt32.lookupFunction<
    Int32 Function(Uint32 dwCertEncodingType,
        Pointer<CRYPTOAPI_BLOB> pCertName1, Pointer<CRYPTOAPI_BLOB> pCertName2),
    int Function(int dwCertEncodingType, Pointer<CRYPTOAPI_BLOB> pCertName1,
        Pointer<CRYPTOAPI_BLOB> pCertName2)>('CertCompareCertificateName');

int CertCompareIntegerBlob(
        Pointer<CRYPTOAPI_BLOB> pInt1, Pointer<CRYPTOAPI_BLOB> pInt2) =>
    _CertCompareIntegerBlob(pInt1, pInt2);

late final _CertCompareIntegerBlob = _crypt32.lookupFunction<
    Int32 Function(
        Pointer<CRYPTOAPI_BLOB> pInt1, Pointer<CRYPTOAPI_BLOB> pInt2),
    int Function(Pointer<CRYPTOAPI_BLOB> pInt1,
        Pointer<CRYPTOAPI_BLOB> pInt2)>('CertCompareIntegerBlob');

int CertComparePublicKeyInfo(
        int dwCertEncodingType,
        Pointer<CERT_PUBLIC_KEY_INFO> pPublicKey1,
        Pointer<CERT_PUBLIC_KEY_INFO> pPublicKey2) =>
    _CertComparePublicKeyInfo(dwCertEncodingType, pPublicKey1, pPublicKey2);
...
late final _CertComparePublicKeyInfo = _crypt32.lookupFunction<
    ...
    int Function(
        int dwCertEncodingType,
        Pointer<CERT_PUBLIC_KEY_INFO> pPublicKey1,
        Pointer<CERT_PUBLIC_KEY_INFO> pPublicKey2)>('CertComparePublicKeyInfo');

int CertControlStore(
        Pointer hCertStore, int dwFlags, int dwCtrlType, Pointer pvCtrlPara) =>
    _CertControlStore(hCertStore, dwFlags, dwCtrlType, pvCtrlPara);

late final _CertControlStore = _crypt32.lookupFunction<
    Int32 Function(Pointer hCertStore, Uint32 dwFlags, Uint32 dwCtrlType,
        Pointer pvCtrlPara),
    int Function(Pointer hCertStore, int dwFlags, int dwCtrlType,
        Pointer pvCtrlPara)>('CertControlStore');

Pointer<CRL_CONTEXT> CertCreateCRLContext(int dwCertEncodingType,
        Pointer<Uint8> pbCrlEncoded, int cbCrlEncoded) =>
    _CertCreateCRLContext(dwCertEncodingType, pbCrlEncoded, cbCrlEncoded);

late final _CertCreateCRLContext = _crypt32.lookupFunction<
    Pointer<CRL_CONTEXT> Function(Uint32 dwCertEncodingType,
        Pointer<Uint8> pbCrlEncoded, Uint32 cbCrlEncoded),
    Pointer<CRL_CONTEXT> Function(int dwCertEncodingType,
        Pointer<Uint8> pbCrlEncoded, int cbCrlEncoded)>('CertCreateCRLContext');

Pointer<CTL_CONTEXT> CertCreateCTLContext(int dwMsgAndCertEncodingType,
        Pointer<Uint8> pbCtlEncoded, int cbCtlEncoded) =>
    _CertCreateCTLContext(dwMsgAndCertEncodingType, pbCtlEncoded, cbCtlEncoded);

late final _CertCreateCTLContext = _crypt32.lookupFunction<
    Pointer<CTL_CONTEXT> Function(Uint32 dwMsgAndCertEncodingType,
        Pointer<Uint8> pbCtlEncoded, Uint32 cbCtlEncoded),
    Pointer<CTL_CONTEXT> Function(int dwMsgAndCertEncodingType,
        Pointer<Uint8> pbCtlEncoded, int cbCtlEncoded)>('CertCreateCTLContext');
...
int CertCreateCTLEntryFromCertificateContextProperties(
    ...
    _CertCreateCTLEntryFromCertificateContextProperties(pCertContext, cOptAttr,
        rgOptAttr, dwFlags, pvReserved, pCtlEntry, pcbCtlEntry);
...
int CertCreateCertificateChainEngine(Pointer<CERT_CHAIN_ENGINE_CONFIG> pConfig,
        Pointer<IntPtr> phChainEngine) =>
    _CertCreateCertificateChainEngine(pConfig, phChainEngine);

late final _CertCreateCertificateChainEngine = _crypt32.lookupFunction<
    Int32 Function(Pointer<CERT_CHAIN_ENGINE_CONFIG> pConfig,
        Pointer<IntPtr> phChainEngine),
    int Function(Pointer<CERT_CHAIN_ENGINE_CONFIG> pConfig,
        Pointer<IntPtr> phChainEngine)>('CertCreateCertificateChainEngine');

Pointer<CERT_CONTEXT> CertCreateCertificateContext(int dwCertEncodingType,
        Pointer<Uint8> pbCertEncoded, int cbCertEncoded) =>
...
late final _CertCreateCertificateContext = _crypt32.lookupFunction<
    Pointer<CERT_CONTEXT> Function(Uint32 dwCertEncodingType,
        Pointer<Uint8> pbCertEncoded, Uint32 cbCertEncoded),
    Pointer<CERT_CONTEXT> Function(
        int dwCertEncodingType,
        Pointer<Uint8> pbCertEncoded,
        int cbCertEncoded)>('CertCreateCertificateContext');
...
Pointer CertCreateContext(
    ...
    _CertCreateContext(dwContextType, dwEncodingType, pbEncoded, cbEncoded,
        dwFlags, pCreatePara);
...
late final _CertCreateContext = _crypt32.lookupFunction<
    ...
    Pointer Function(
        ...
        int cbEncoded,
        int dwFlags,
        Pointer<CERT_CREATE_CONTEXT_PARA> pCreatePara)>('CertCreateContext');
...
late final _CertCreateSelfSignCertificate = _crypt32.lookupFunction<
    ...
    Pointer<CERT_CONTEXT> Function(
        ...
        Pointer<SYSTEMTIME> pStartTime,
        Pointer<SYSTEMTIME> pEndTime,
        Pointer<CERT_EXTENSIONS> pExtensions)>('CertCreateSelfSignCertificate');

int CertDeleteCRLFromStore(Pointer<CRL_CONTEXT> pCrlContext) =>
    _CertDeleteCRLFromStore(pCrlContext);

late final _CertDeleteCRLFromStore = _crypt32.lookupFunction<
    Int32 Function(Pointer<CRL_CONTEXT> pCrlContext),
    int Function(Pointer<CRL_CONTEXT> pCrlContext)>('CertDeleteCRLFromStore');

int CertDeleteCTLFromStore(Pointer<CTL_CONTEXT> pCtlContext) =>
    _CertDeleteCTLFromStore(pCtlContext);

late final _CertDeleteCTLFromStore = _crypt32.lookupFunction<
    Int32 Function(Pointer<CTL_CONTEXT> pCtlContext),
    int Function(Pointer<CTL_CONTEXT> pCtlContext)>('CertDeleteCTLFromStore');

int CertDeleteCertificateFromStore(Pointer<CERT_CONTEXT> pCertContext) =>
    _CertDeleteCertificateFromStore(pCertContext);

late final _CertDeleteCertificateFromStore = _crypt32.lookupFunction<
    Int32 Function(Pointer<CERT_CONTEXT> pCertContext),
    int Function(
        Pointer<CERT_CONTEXT> pCertContext)>('CertDeleteCertificateFromStore');

Pointer<CRL_CONTEXT> CertDuplicateCRLContext(
        Pointer<CRL_CONTEXT> pCrlContext) =>
    _CertDuplicateCRLContext(pCrlContext);

late final _CertDuplicateCRLContext = _crypt32.lookupFunction<
    Pointer<CRL_CONTEXT> Function(Pointer<CRL_CONTEXT> pCrlContext),
    Pointer<CRL_CONTEXT> Function(
        Pointer<CRL_CONTEXT> pCrlContext)>('CertDuplicateCRLContext');

Pointer<CTL_CONTEXT> CertDuplicateCTLContext(
        Pointer<CTL_CONTEXT> pCtlContext) =>
    _CertDuplicateCTLContext(pCtlContext);

late final _CertDuplicateCTLContext = _crypt32.lookupFunction<
    Pointer<CTL_CONTEXT> Function(Pointer<CTL_CONTEXT> pCtlContext),
    Pointer<CTL_CONTEXT> Function(
        Pointer<CTL_CONTEXT> pCtlContext)>('CertDuplicateCTLContext');

Pointer<CERT_CHAIN_CONTEXT> CertDuplicateCertificateChain(
        Pointer<CERT_CHAIN_CONTEXT> pChainContext) =>
    _CertDuplicateCertificateChain(pChainContext);
...
Pointer<CERT_CONTEXT> CertDuplicateCertificateContext(
        Pointer<CERT_CONTEXT> pCertContext) =>
    _CertDuplicateCertificateContext(pCertContext);

late final _CertDuplicateCertificateContext = _crypt32.lookupFunction<
    Pointer<CERT_CONTEXT> Function(Pointer<CERT_CONTEXT> pCertContext),
    Pointer<CERT_CONTEXT> Function(
        Pointer<CERT_CONTEXT> pCertContext)>('CertDuplicateCertificateContext');

Pointer CertDuplicateStore(Pointer hCertStore) =>
    _CertDuplicateStore(hCertStore);

late final _CertDuplicateStore = _crypt32.lookupFunction<
    Pointer Function(Pointer hCertStore),
    Pointer Function(Pointer hCertStore)>('CertDuplicateStore');

int CertEnumCRLContextProperties(
        Pointer<CRL_CONTEXT> pCrlContext, int dwPropId) =>
    _CertEnumCRLContextProperties(pCrlContext, dwPropId);

late final _CertEnumCRLContextProperties = _crypt32.lookupFunction<
    Uint32 Function(Pointer<CRL_CONTEXT> pCrlContext, Uint32 dwPropId),
    int Function(Pointer<CRL_CONTEXT> pCrlContext,
        int dwPropId)>('CertEnumCRLContextProperties');

Pointer<CRL_CONTEXT> CertEnumCRLsInStore(
        Pointer hCertStore, Pointer<CRL_CONTEXT> pPrevCrlContext) =>
    _CertEnumCRLsInStore(hCertStore, pPrevCrlContext);

late final _CertEnumCRLsInStore = _crypt32.lookupFunction<
    Pointer<CRL_CONTEXT> Function(
        Pointer hCertStore, Pointer<CRL_CONTEXT> pPrevCrlContext),
    Pointer<CRL_CONTEXT> Function(Pointer hCertStore,
        Pointer<CRL_CONTEXT> pPrevCrlContext)>('CertEnumCRLsInStore');

int CertEnumCTLContextProperties(
        Pointer<CTL_CONTEXT> pCtlContext, int dwPropId) =>
    _CertEnumCTLContextProperties(pCtlContext, dwPropId);

late final _CertEnumCTLContextProperties = _crypt32.lookupFunction<
    Uint32 Function(Pointer<CTL_CONTEXT> pCtlContext, Uint32 dwPropId),
    int Function(Pointer<CTL_CONTEXT> pCtlContext,
        int dwPropId)>('CertEnumCTLContextProperties');

Pointer<CTL_CONTEXT> CertEnumCTLsInStore(
        Pointer hCertStore, Pointer<CTL_CONTEXT> pPrevCtlContext) =>
    _CertEnumCTLsInStore(hCertStore, pPrevCtlContext);

late final _CertEnumCTLsInStore = _crypt32.lookupFunction<
    Pointer<CTL_CONTEXT> Function(
        Pointer hCertStore, Pointer<CTL_CONTEXT> pPrevCtlContext),
    Pointer<CTL_CONTEXT> Function(Pointer hCertStore,
        Pointer<CTL_CONTEXT> pPrevCtlContext)>('CertEnumCTLsInStore');

int CertEnumCertificateContextProperties(
        Pointer<CERT_CONTEXT> pCertContext, int dwPropId) =>
    _CertEnumCertificateContextProperties(pCertContext, dwPropId);

late final _CertEnumCertificateContextProperties = _crypt32.lookupFunction<
    Uint32 Function(Pointer<CERT_CONTEXT> pCertContext, Uint32 dwPropId),
    int Function(Pointer<CERT_CONTEXT> pCertContext,
        int dwPropId)>('CertEnumCertificateContextProperties');

Pointer<CERT_CONTEXT> CertEnumCertificatesInStore(
        Pointer hCertStore, Pointer<CERT_CONTEXT> pPrevCertContext) =>
    _CertEnumCertificatesInStore(hCertStore, pPrevCertContext);

late final _CertEnumCertificatesInStore = _crypt32.lookupFunction<
    Pointer<CERT_CONTEXT> Function(
        Pointer hCertStore, Pointer<CERT_CONTEXT> pPrevCertContext),
    Pointer<CERT_CONTEXT> Function(Pointer hCertStore,
        Pointer<CERT_CONTEXT> pPrevCertContext)>('CertEnumCertificatesInStore');

int CertEnumPhysicalStore(Pointer pvSystemStore, int dwFlags, Pointer pvArg,
        Pointer<NativeFunction<PFN_CERT_ENUM_PHYSICAL_STORE>> pfnEnum) =>
    _CertEnumPhysicalStore(pvSystemStore, dwFlags, pvArg, pfnEnum);

late final _CertEnumPhysicalStore = _crypt32.lookupFunction<
        Int32 Function(Pointer pvSystemStore, Uint32 dwFlags, Pointer pvArg,
            Pointer<NativeFunction<PFN_CERT_ENUM_PHYSICAL_STORE>> pfnEnum),
        int Function(Pointer pvSystemStore, int dwFlags, Pointer pvArg,
            Pointer<NativeFunction<PFN_CERT_ENUM_PHYSICAL_STORE>> pfnEnum)>(
...
int CertEnumSystemStore(
    ...
    _CertEnumSystemStore(dwFlags, pvSystemStoreLocationPara, pvArg, pfnEnum);
...
int CertEnumSystemStoreLocation(int dwFlags, Pointer pvArg,
        Pointer<NativeFunction<PFN_CERT_ENUM_SYSTEM_STORE_LOCATION>> pfnEnum) =>
    _CertEnumSystemStoreLocation(dwFlags, pvArg, pfnEnum);

late final _CertEnumSystemStoreLocation = _crypt32.lookupFunction<
    Int32 Function(Uint32 dwFlags, Pointer pvArg,
        Pointer<NativeFunction<PFN_CERT_ENUM_SYSTEM_STORE_LOCATION>> pfnEnum),
    int Function(
        int dwFlags,
        Pointer pvArg,
        Pointer<NativeFunction<PFN_CERT_ENUM_SYSTEM_STORE_LOCATION>>
            pfnEnum)>('CertEnumSystemStoreLocation');

Pointer<CRYPT_ATTRIBUTE> CertFindAttribute(
        Pointer<Utf8> pszObjId, int cAttr, Pointer<CRYPT_ATTRIBUTE> rgAttr) =>
    _CertFindAttribute(pszObjId, cAttr, rgAttr);

late final _CertFindAttribute = _crypt32.lookupFunction<
    Pointer<CRYPT_ATTRIBUTE> Function(
        Pointer<Utf8> pszObjId, Uint32 cAttr, Pointer<CRYPT_ATTRIBUTE> rgAttr),
    Pointer<CRYPT_ATTRIBUTE> Function(Pointer<Utf8> pszObjId, int cAttr,
        Pointer<CRYPT_ATTRIBUTE> rgAttr)>('CertFindAttribute');
...
Pointer<CRL_CONTEXT> CertFindCRLInStore(
    ...
    _CertFindCRLInStore(hCertStore, dwCertEncodingType, dwFindFlags, dwFindType,
...
late final _CertFindCRLInStore = _crypt32.lookupFunction<
    ...
    Pointer<CRL_CONTEXT> Function(
        ...
        int dwFindType,
        Pointer pvFindPara,
        Pointer<CRL_CONTEXT> pPrevCrlContext)>('CertFindCRLInStore');
...
Pointer<CTL_CONTEXT> CertFindCTLInStore(
    ...
    _CertFindCTLInStore(hCertStore, dwMsgAndCertEncodingType, dwFindFlags,
...
late final _CertFindCTLInStore = _crypt32.lookupFunction<
    ...
    Pointer<CTL_CONTEXT> Function(
        ...
        int dwFindType,
        Pointer pvFindPara,
        Pointer<CTL_CONTEXT> pPrevCtlContext)>('CertFindCTLInStore');
...
late final _CertFindCertificateInCRL = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        int dwFlags,
        Pointer pvReserved,
        Pointer<Pointer<CRL_ENTRY>> ppCrlEntry)>('CertFindCertificateInCRL');
...
Pointer<CERT_CONTEXT> CertFindCertificateInStore(
    ...
    _CertFindCertificateInStore(hCertStore, dwCertEncodingType, dwFindFlags,
...
late final _CertFindCertificateInStore = _crypt32.lookupFunction<
    ...
    Pointer<CERT_CONTEXT> Function(
        ...
        int dwFindType,
        Pointer pvFindPara,
        Pointer<CERT_CONTEXT> pPrevCertContext)>('CertFindCertificateInStore');
...
Pointer<CERT_CHAIN_CONTEXT> CertFindChainInStore(
    ...
    _CertFindChainInStore(hCertStore, dwCertEncodingType, dwFindFlags,
        dwFindType, pvFindPara, pPrevChainContext);
...
late final _CertFindChainInStore = _crypt32.lookupFunction<
    ...
    Pointer<CERT_CHAIN_CONTEXT> Function(
        ...
        int dwFindType,
        Pointer pvFindPara,
        Pointer<CERT_CHAIN_CONTEXT> pPrevChainContext)>('CertFindChainInStore');

Pointer<CERT_EXTENSION> CertFindExtension(Pointer<Utf8> pszObjId,
        int cExtensions, Pointer<CERT_EXTENSION> rgExtensions) =>
    _CertFindExtension(pszObjId, cExtensions, rgExtensions);

late final _CertFindExtension = _crypt32.lookupFunction<
    Pointer<CERT_EXTENSION> Function(Pointer<Utf8> pszObjId, Uint32 cExtensions,
        Pointer<CERT_EXTENSION> rgExtensions),
    Pointer<CERT_EXTENSION> Function(Pointer<Utf8> pszObjId, int cExtensions,
        Pointer<CERT_EXTENSION> rgExtensions)>('CertFindExtension');

Pointer<CERT_RDN_ATTR> CertFindRDNAttr(
        Pointer<Utf8> pszObjId, Pointer<CERT_NAME_INFO> pName) =>
    _CertFindRDNAttr(pszObjId, pName);

late final _CertFindRDNAttr = _crypt32.lookupFunction<
    Pointer<CERT_RDN_ATTR> Function(
        Pointer<Utf8> pszObjId, Pointer<CERT_NAME_INFO> pName),
    Pointer<CERT_RDN_ATTR> Function(Pointer<Utf8> pszObjId,
        Pointer<CERT_NAME_INFO> pName)>('CertFindRDNAttr');

Pointer<CTL_ENTRY> CertFindSubjectInCTL(int dwEncodingType, int dwSubjectType,
        Pointer pvSubject, Pointer<CTL_CONTEXT> pCtlContext, int dwFlags) =>
...
late final _CertFindSubjectInCTL = _crypt32.lookupFunction<
    Pointer<CTL_ENTRY> Function(Uint32 dwEncodingType, Uint32 dwSubjectType,
        Pointer pvSubject, Pointer<CTL_CONTEXT> pCtlContext, Uint32 dwFlags),
    Pointer<CTL_ENTRY> Function(
        int dwEncodingType,
        int dwSubjectType,
        Pointer pvSubject,
        Pointer<CTL_CONTEXT> pCtlContext,
        int dwFlags)>('CertFindSubjectInCTL');
...
int CertFindSubjectInSortedCTL(
        ...
        Pointer pvReserved,
        Pointer<CRYPTOAPI_BLOB> pEncodedAttributes) =>
    _CertFindSubjectInSortedCTL(pSubjectIdentifier, pCtlContext, dwFlags,
        pvReserved, pEncodedAttributes);
...
int CertFreeCRLContext(Pointer<CRL_CONTEXT> pCrlContext) =>
    _CertFreeCRLContext(pCrlContext);

late final _CertFreeCRLContext = _crypt32.lookupFunction<
    Int32 Function(Pointer<CRL_CONTEXT> pCrlContext),
    int Function(Pointer<CRL_CONTEXT> pCrlContext)>('CertFreeCRLContext');

int CertFreeCTLContext(Pointer<CTL_CONTEXT> pCtlContext) =>
    _CertFreeCTLContext(pCtlContext);

late final _CertFreeCTLContext = _crypt32.lookupFunction<
    Int32 Function(Pointer<CTL_CONTEXT> pCtlContext),
    int Function(Pointer<CTL_CONTEXT> pCtlContext)>('CertFreeCTLContext');

void CertFreeCertificateChain(Pointer<CERT_CHAIN_CONTEXT> pChainContext) =>
    _CertFreeCertificateChain(pChainContext);

late final _CertFreeCertificateChain = _crypt32.lookupFunction<
    Void Function(Pointer<CERT_CHAIN_CONTEXT> pChainContext),
    void Function(
        Pointer<CERT_CHAIN_CONTEXT> pChainContext)>('CertFreeCertificateChain');

void CertFreeCertificateChainEngine(int hChainEngine) =>
    _CertFreeCertificateChainEngine(hChainEngine);

late final _CertFreeCertificateChainEngine = _crypt32.lookupFunction<
    Void Function(IntPtr hChainEngine),
    void Function(int hChainEngine)>('CertFreeCertificateChainEngine');

void CertFreeCertificateChainList(
        Pointer<Pointer<CERT_CHAIN_CONTEXT>> prgpSelection) =>
    _CertFreeCertificateChainList(prgpSelection);

late final _CertFreeCertificateChainList = _crypt32.lookupFunction<
        Void Function(Pointer<Pointer<CERT_CHAIN_CONTEXT>> prgpSelection),
        void Function(Pointer<Pointer<CERT_CHAIN_CONTEXT>> prgpSelection)>(
    'CertFreeCertificateChainList');

int CertFreeCertificateContext(Pointer<CERT_CONTEXT> pCertContext) =>
    _CertFreeCertificateContext(pCertContext);

late final _CertFreeCertificateContext = _crypt32.lookupFunction<
    Int32 Function(Pointer<CERT_CONTEXT> pCertContext),
    int Function(
        Pointer<CERT_CONTEXT> pCertContext)>('CertFreeCertificateContext');

void CertFreeServerOcspResponseContext(
        Pointer<CERT_SERVER_OCSP_RESPONSE_CONTEXT>
            pServerOcspResponseContext) =>
    _CertFreeServerOcspResponseContext(pServerOcspResponseContext);
...
late final _CertFreeServerOcspResponseContext = _crypt32.lookupFunction<
    ...
    void Function(
        Pointer<CERT_SERVER_OCSP_RESPONSE_CONTEXT>
            pServerOcspResponseContext)>('CertFreeServerOcspResponseContext');

int CertGetCRLContextProperty(Pointer<CRL_CONTEXT> pCrlContext, int dwPropId,
        Pointer pvData, Pointer<Uint32> pcbData) =>
    _CertGetCRLContextProperty(pCrlContext, dwPropId, pvData, pcbData);

late final _CertGetCRLContextProperty = _crypt32.lookupFunction<
    Int32 Function(Pointer<CRL_CONTEXT> pCrlContext, Uint32 dwPropId,
        Pointer pvData, Pointer<Uint32> pcbData),
    int Function(Pointer<CRL_CONTEXT> pCrlContext, int dwPropId, Pointer pvData,
        Pointer<Uint32> pcbData)>('CertGetCRLContextProperty');
...
Pointer<CRL_CONTEXT> CertGetCRLFromStore(
    ...
    _CertGetCRLFromStore(hCertStore, pIssuerContext, pPrevCrlContext, pdwFlags);
...
late final _CertGetCRLFromStore = _crypt32.lookupFunction<
    ...
    Pointer<CRL_CONTEXT> Function(
        ...
        Pointer<CERT_CONTEXT> pIssuerContext,
        Pointer<CRL_CONTEXT> pPrevCrlContext,
        Pointer<Uint32> pdwFlags)>('CertGetCRLFromStore');

int CertGetCTLContextProperty(Pointer<CTL_CONTEXT> pCtlContext, int dwPropId,
        Pointer pvData, Pointer<Uint32> pcbData) =>
    _CertGetCTLContextProperty(pCtlContext, dwPropId, pvData, pcbData);

late final _CertGetCTLContextProperty = _crypt32.lookupFunction<
    Int32 Function(Pointer<CTL_CONTEXT> pCtlContext, Uint32 dwPropId,
        Pointer pvData, Pointer<Uint32> pcbData),
    int Function(Pointer<CTL_CONTEXT> pCtlContext, int dwPropId, Pointer pvData,
        Pointer<Uint32> pcbData)>('CertGetCTLContextProperty');
...
int CertGetCertificateChain(
    ...
    _CertGetCertificateChain(hChainEngine, pCertContext, pTime,
        hAdditionalStore, pChainPara, dwFlags, pvReserved, ppChainContext);
...
int CertGetCertificateContextProperty(Pointer<CERT_CONTEXT> pCertContext,
        int dwPropId, Pointer pvData, Pointer<Uint32> pcbData) =>
    _CertGetCertificateContextProperty(pCertContext, dwPropId, pvData, pcbData);

late final _CertGetCertificateContextProperty = _crypt32.lookupFunction<
    Int32 Function(Pointer<CERT_CONTEXT> pCertContext, Uint32 dwPropId,
        Pointer pvData, Pointer<Uint32> pcbData),
    int Function(
        Pointer<CERT_CONTEXT> pCertContext,
        int dwPropId,
        Pointer pvData,
        Pointer<Uint32> pcbData)>('CertGetCertificateContextProperty');

int CertGetEnhancedKeyUsage(Pointer<CERT_CONTEXT> pCertContext, int dwFlags,
        Pointer<CTL_USAGE> pUsage, Pointer<Uint32> pcbUsage) =>
    _CertGetEnhancedKeyUsage(pCertContext, dwFlags, pUsage, pcbUsage);

late final _CertGetEnhancedKeyUsage = _crypt32.lookupFunction<
    Int32 Function(Pointer<CERT_CONTEXT> pCertContext, Uint32 dwFlags,
        Pointer<CTL_USAGE> pUsage, Pointer<Uint32> pcbUsage),
    int Function(
        Pointer<CERT_CONTEXT> pCertContext,
        int dwFlags,
        Pointer<CTL_USAGE> pUsage,
        Pointer<Uint32> pcbUsage)>('CertGetEnhancedKeyUsage');
...
late final _CertGetIntendedKeyUsage = _crypt32.lookupFunction<
    Int32 Function(Uint32 dwCertEncodingType, Pointer<CERT_INFO> pCertInfo,
        Pointer<Uint8> pbKeyUsage, Uint32 cbKeyUsage),
    int Function(int dwCertEncodingType, Pointer<CERT_INFO> pCertInfo,
        Pointer<Uint8> pbKeyUsage, int cbKeyUsage)>('CertGetIntendedKeyUsage');
...
late final _CertGetIssuerCertificateFromStore = _crypt32.lookupFunction<
    ...
    Pointer<CERT_CONTEXT> Function(
        ...
        Pointer<CERT_CONTEXT> pSubjectContext,
        Pointer<CERT_CONTEXT> pPrevIssuerContext,
        Pointer<Uint32> pdwFlags)>('CertGetIssuerCertificateFromStore');
...
int CertGetNameString(
        ...
        int cchNameString) =>
    _CertGetNameString(pCertContext, dwType, dwFlags, pvTypePara, pszNameString,
        cchNameString);
...
late final _CertGetNameString = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer pvTypePara,
        Pointer<Utf16> pszNameString,
        int cchNameString)>('CertGetNameStringW');

int CertGetPublicKeyLength(
        int dwCertEncodingType, Pointer<CERT_PUBLIC_KEY_INFO> pPublicKey) =>
    _CertGetPublicKeyLength(dwCertEncodingType, pPublicKey);

late final _CertGetPublicKeyLength = _crypt32.lookupFunction<
    Uint32 Function(
        Uint32 dwCertEncodingType, Pointer<CERT_PUBLIC_KEY_INFO> pPublicKey),
    int Function(int dwCertEncodingType,
        Pointer<CERT_PUBLIC_KEY_INFO> pPublicKey)>('CertGetPublicKeyLength');

Pointer<CERT_SERVER_OCSP_RESPONSE_CONTEXT> CertGetServerOcspResponseContext(
        Pointer hServerOcspResponse, int dwFlags, Pointer pvReserved) =>
    _CertGetServerOcspResponseContext(hServerOcspResponse, dwFlags, pvReserved);

late final _CertGetServerOcspResponseContext = _crypt32.lookupFunction<
    Pointer<CERT_SERVER_OCSP_RESPONSE_CONTEXT> Function(
        Pointer hServerOcspResponse, Uint32 dwFlags, Pointer pvReserved),
    Pointer<CERT_SERVER_OCSP_RESPONSE_CONTEXT> Function(
        Pointer hServerOcspResponse,
        int dwFlags,
        Pointer pvReserved)>('CertGetServerOcspResponseContext');

int CertGetStoreProperty(Pointer hCertStore, int dwPropId, Pointer pvData,
        Pointer<Uint32> pcbData) =>
    _CertGetStoreProperty(hCertStore, dwPropId, pvData, pcbData);

late final _CertGetStoreProperty = _crypt32.lookupFunction<
    Int32 Function(Pointer hCertStore, Uint32 dwPropId, Pointer pvData,
        Pointer<Uint32> pcbData),
    int Function(Pointer hCertStore, int dwPropId, Pointer pvData,
        Pointer<Uint32> pcbData)>('CertGetStoreProperty');

Pointer<CERT_CONTEXT> CertGetSubjectCertificateFromStore(Pointer hCertStore,
        int dwCertEncodingType, Pointer<CERT_INFO> pCertId) =>
    _CertGetSubjectCertificateFromStore(
        hCertStore, dwCertEncodingType, pCertId);

late final _CertGetSubjectCertificateFromStore = _crypt32.lookupFunction<
    Pointer<CERT_CONTEXT> Function(Pointer hCertStore,
        Uint32 dwCertEncodingType, Pointer<CERT_INFO> pCertId),
    Pointer<CERT_CONTEXT> Function(Pointer hCertStore, int dwCertEncodingType,
        Pointer<CERT_INFO> pCertId)>('CertGetSubjectCertificateFromStore');
...
int CertGetValidUsages(
    ...
    _CertGetValidUsages(cCerts, rghCerts, cNumOIDs, rghOIDs, pcbOIDs);
...
late final _CertGetValidUsages = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Int32> cNumOIDs,
        Pointer<Pointer<Utf8>> rghOIDs,
        Pointer<Uint32> pcbOIDs)>('CertGetValidUsages');

int CertIsRDNAttrsInCertificateName(int dwCertEncodingType, int dwFlags,
        Pointer<CRYPTOAPI_BLOB> pCertName, Pointer<CERT_RDN> pRDN) =>
...
late final _CertIsRDNAttrsInCertificateName = _crypt32.lookupFunction<
    Int32 Function(Uint32 dwCertEncodingType, Uint32 dwFlags,
        Pointer<CRYPTOAPI_BLOB> pCertName, Pointer<CERT_RDN> pRDN),
    int Function(
        int dwCertEncodingType,
        int dwFlags,
        Pointer<CRYPTOAPI_BLOB> pCertName,
        Pointer<CERT_RDN> pRDN)>('CertIsRDNAttrsInCertificateName');

int CertIsStrongHashToSign(Pointer<CERT_STRONG_SIGN_PARA> pStrongSignPara,
        Pointer<Utf16> pwszCNGHashAlgid, Pointer<CERT_CONTEXT> pSigningCert) =>
    _CertIsStrongHashToSign(pStrongSignPara, pwszCNGHashAlgid, pSigningCert);

late final _CertIsStrongHashToSign = _crypt32.lookupFunction<
    Int32 Function(Pointer<CERT_STRONG_SIGN_PARA> pStrongSignPara,
        Pointer<Utf16> pwszCNGHashAlgid, Pointer<CERT_CONTEXT> pSigningCert),
    int Function(
        Pointer<CERT_STRONG_SIGN_PARA> pStrongSignPara,
        Pointer<Utf16> pwszCNGHashAlgid,
        Pointer<CERT_CONTEXT> pSigningCert)>('CertIsStrongHashToSign');

int CertIsValidCRLForCertificate(Pointer<CERT_CONTEXT> pCert,
        Pointer<CRL_CONTEXT> pCrl, int dwFlags, Pointer pvReserved) =>
    _CertIsValidCRLForCertificate(pCert, pCrl, dwFlags, pvReserved);

late final _CertIsValidCRLForCertificate = _crypt32.lookupFunction<
    Int32 Function(Pointer<CERT_CONTEXT> pCert, Pointer<CRL_CONTEXT> pCrl,
        Uint32 dwFlags, Pointer pvReserved),
    int Function(Pointer<CERT_CONTEXT> pCert, Pointer<CRL_CONTEXT> pCrl,
        int dwFlags, Pointer pvReserved)>('CertIsValidCRLForCertificate');
...
int CertIsWeakHash(
    ...
    _CertIsWeakHash(dwHashUseType, pwszCNGHashAlgid, dwChainFlags,
        pSignerChainContext, pTimeStamp, pwszFileName);
...
late final _CertIsWeakHash = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<CERT_CHAIN_CONTEXT> pSignerChainContext,
        Pointer<FILETIME> pTimeStamp,
        Pointer<Utf16> pwszFileName)>('CertIsWeakHash');

int CertNameToStr(int dwCertEncodingType, Pointer<CRYPTOAPI_BLOB> pName,
        int dwStrType, Pointer<Utf16> psz, int csz) =>
    _CertNameToStr(dwCertEncodingType, pName, dwStrType, psz, csz);

late final _CertNameToStr = _crypt32.lookupFunction<
    Uint32 Function(Uint32 dwCertEncodingType, Pointer<CRYPTOAPI_BLOB> pName,
        Uint32 dwStrType, Pointer<Utf16> psz, Uint32 csz),
    int Function(int dwCertEncodingType, Pointer<CRYPTOAPI_BLOB> pName,
        int dwStrType, Pointer<Utf16> psz, int csz)>('CertNameToStrW');

int CertOIDToAlgId(Pointer<Utf8> pszObjId) => _CertOIDToAlgId(pszObjId);

late final _CertOIDToAlgId = _crypt32.lookupFunction<
    Uint32 Function(Pointer<Utf8> pszObjId),
    int Function(Pointer<Utf8> pszObjId)>('CertOIDToAlgId');

Pointer CertOpenServerOcspResponse(Pointer<CERT_CHAIN_CONTEXT> pChainContext,
        int dwFlags, Pointer<CERT_SERVER_OCSP_RESPONSE_OPEN_PARA> pOpenPara) =>
    _CertOpenServerOcspResponse(pChainContext, dwFlags, pOpenPara);

late final _CertOpenServerOcspResponse = _crypt32.lookupFunction<
    Pointer Function(Pointer<CERT_CHAIN_CONTEXT> pChainContext, Uint32 dwFlags,
        Pointer<CERT_SERVER_OCSP_RESPONSE_OPEN_PARA> pOpenPara),
    Pointer Function(
        Pointer<CERT_CHAIN_CONTEXT> pChainContext,
        int dwFlags,
        Pointer<CERT_SERVER_OCSP_RESPONSE_OPEN_PARA>
            pOpenPara)>('CertOpenServerOcspResponse');

Pointer CertOpenStore(Pointer<Utf8> lpszStoreProvider, int dwEncodingType,
        int hCryptProv, int dwFlags, Pointer pvPara) =>
    _CertOpenStore(
        lpszStoreProvider, dwEncodingType, hCryptProv, dwFlags, pvPara);

late final _CertOpenStore = _crypt32.lookupFunction<
    Pointer Function(Pointer<Utf8> lpszStoreProvider, Uint32 dwEncodingType,
        IntPtr hCryptProv, Uint32 dwFlags, Pointer pvPara),
    Pointer Function(Pointer<Utf8> lpszStoreProvider, int dwEncodingType,
        int hCryptProv, int dwFlags, Pointer pvPara)>('CertOpenStore');

Pointer CertOpenSystemStore(int hProv, Pointer<Utf16> szSubsystemProtocol) =>
    _CertOpenSystemStore(hProv, szSubsystemProtocol);

late final _CertOpenSystemStore = _crypt32.lookupFunction<
    Pointer Function(IntPtr hProv, Pointer<Utf16> szSubsystemProtocol),
    Pointer Function(
        int hProv, Pointer<Utf16> szSubsystemProtocol)>('CertOpenSystemStoreW');

int CertRDNValueToStr(int dwValueType, Pointer<CRYPTOAPI_BLOB> pValue,
        Pointer<Utf16> psz, int csz) =>
    _CertRDNValueToStr(dwValueType, pValue, psz, csz);

late final _CertRDNValueToStr = _crypt32.lookupFunction<
    Uint32 Function(Uint32 dwValueType, Pointer<CRYPTOAPI_BLOB> pValue,
        Pointer<Utf16> psz, Uint32 csz),
    int Function(int dwValueType, Pointer<CRYPTOAPI_BLOB> pValue,
        Pointer<Utf16> psz, int csz)>('CertRDNValueToStrW');
...
late final _CertRegisterPhysicalStore = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Utf16> pwszStoreName,
        Pointer<CERT_PHYSICAL_STORE_INFO> pStoreInfo,
        Pointer pvReserved)>('CertRegisterPhysicalStore');

int CertRegisterSystemStore(Pointer pvSystemStore, int dwFlags,
        Pointer<CERT_SYSTEM_STORE_INFO> pStoreInfo, Pointer pvReserved) =>
    _CertRegisterSystemStore(pvSystemStore, dwFlags, pStoreInfo, pvReserved);

late final _CertRegisterSystemStore = _crypt32.lookupFunction<
    Int32 Function(Pointer pvSystemStore, Uint32 dwFlags,
        Pointer<CERT_SYSTEM_STORE_INFO> pStoreInfo, Pointer pvReserved),
    int Function(
        Pointer pvSystemStore,
        int dwFlags,
        Pointer<CERT_SYSTEM_STORE_INFO> pStoreInfo,
        Pointer pvReserved)>('CertRegisterSystemStore');

int CertRemoveEnhancedKeyUsageIdentifier(
        Pointer<CERT_CONTEXT> pCertContext, Pointer<Utf8> pszUsageIdentifier) =>
    _CertRemoveEnhancedKeyUsageIdentifier(pCertContext, pszUsageIdentifier);
...
late final _CertRemoveEnhancedKeyUsageIdentifier = _crypt32.lookupFunction<
    ...
    int Function(
        Pointer<CERT_CONTEXT> pCertContext,
        Pointer<Utf8>
            pszUsageIdentifier)>('CertRemoveEnhancedKeyUsageIdentifier');

void CertRemoveStoreFromCollection(
        Pointer hCollectionStore, Pointer hSiblingStore) =>
    _CertRemoveStoreFromCollection(hCollectionStore, hSiblingStore);

late final _CertRemoveStoreFromCollection = _crypt32.lookupFunction<
    Void Function(Pointer hCollectionStore, Pointer hSiblingStore),
    void Function(Pointer hCollectionStore,
        Pointer hSiblingStore)>('CertRemoveStoreFromCollection');

int CertResyncCertificateChainEngine(int hChainEngine) =>
    _CertResyncCertificateChainEngine(hChainEngine);

late final _CertResyncCertificateChainEngine = _crypt32.lookupFunction<
    Int32 Function(IntPtr hChainEngine),
    int Function(int hChainEngine)>('CertResyncCertificateChainEngine');
...
int CertSaveStore(Pointer hCertStore, int dwEncodingType, int dwSaveAs,
        int dwSaveTo, Pointer pvSaveToPara, int dwFlags) =>
    _CertSaveStore(
        hCertStore, dwEncodingType, dwSaveAs, dwSaveTo, pvSaveToPara, dwFlags);

late final _CertSaveStore = _crypt32.lookupFunction<
    Int32 Function(Pointer hCertStore, Uint32 dwEncodingType, Uint32 dwSaveAs,
        Uint32 dwSaveTo, Pointer pvSaveToPara, Uint32 dwFlags),
    int Function(Pointer hCertStore, int dwEncodingType, int dwSaveAs,
        int dwSaveTo, Pointer pvSaveToPara, int dwFlags)>('CertSaveStore');
...
int CertSelectCertificateChains(
    ...
    _CertSelectCertificateChains(pSelectionContext, dwFlags, pChainParameters,
        cCriteria, rgpCriteria, hStore, pcSelection, pprgpSelection);
...
int CertSerializeCRLStoreElement(Pointer<CRL_CONTEXT> pCrlContext, int dwFlags,
        Pointer<Uint8> pbElement, Pointer<Uint32> pcbElement) =>
    _CertSerializeCRLStoreElement(pCrlContext, dwFlags, pbElement, pcbElement);

late final _CertSerializeCRLStoreElement = _crypt32.lookupFunction<
    Int32 Function(Pointer<CRL_CONTEXT> pCrlContext, Uint32 dwFlags,
        Pointer<Uint8> pbElement, Pointer<Uint32> pcbElement),
    int Function(
        Pointer<CRL_CONTEXT> pCrlContext,
        int dwFlags,
        Pointer<Uint8> pbElement,
        Pointer<Uint32> pcbElement)>('CertSerializeCRLStoreElement');

int CertSerializeCTLStoreElement(Pointer<CTL_CONTEXT> pCtlContext, int dwFlags,
        Pointer<Uint8> pbElement, Pointer<Uint32> pcbElement) =>
    _CertSerializeCTLStoreElement(pCtlContext, dwFlags, pbElement, pcbElement);

late final _CertSerializeCTLStoreElement = _crypt32.lookupFunction<
    Int32 Function(Pointer<CTL_CONTEXT> pCtlContext, Uint32 dwFlags,
        Pointer<Uint8> pbElement, Pointer<Uint32> pcbElement),
    int Function(
        Pointer<CTL_CONTEXT> pCtlContext,
        int dwFlags,
        Pointer<Uint8> pbElement,
        Pointer<Uint32> pcbElement)>('CertSerializeCTLStoreElement');

int CertSerializeCertificateStoreElement(Pointer<CERT_CONTEXT> pCertContext,
        int dwFlags, Pointer<Uint8> pbElement, Pointer<Uint32> pcbElement) =>
...
late final _CertSerializeCertificateStoreElement = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        int dwFlags,
        Pointer<Uint8> pbElement,
        Pointer<Uint32> pcbElement)>('CertSerializeCertificateStoreElement');

int CertSetCRLContextProperty(Pointer<CRL_CONTEXT> pCrlContext, int dwPropId,
        int dwFlags, Pointer pvData) =>
    _CertSetCRLContextProperty(pCrlContext, dwPropId, dwFlags, pvData);

late final _CertSetCRLContextProperty = _crypt32.lookupFunction<
    Int32 Function(Pointer<CRL_CONTEXT> pCrlContext, Uint32 dwPropId,
        Uint32 dwFlags, Pointer pvData),
    int Function(Pointer<CRL_CONTEXT> pCrlContext, int dwPropId, int dwFlags,
        Pointer pvData)>('CertSetCRLContextProperty');

int CertSetCTLContextProperty(Pointer<CTL_CONTEXT> pCtlContext, int dwPropId,
        int dwFlags, Pointer pvData) =>
    _CertSetCTLContextProperty(pCtlContext, dwPropId, dwFlags, pvData);

late final _CertSetCTLContextProperty = _crypt32.lookupFunction<
    Int32 Function(Pointer<CTL_CONTEXT> pCtlContext, Uint32 dwPropId,
        Uint32 dwFlags, Pointer pvData),
    int Function(Pointer<CTL_CONTEXT> pCtlContext, int dwPropId, int dwFlags,
        Pointer pvData)>('CertSetCTLContextProperty');
...
late final _CertSetCertificateContextPropertiesFromCTLEntry =
    _crypt32.lookupFunction<
        Int32 Function(Pointer<CERT_CONTEXT> pCertContext,
            Pointer<CTL_ENTRY> pCtlEntry, Uint32 dwFlags),
        int Function(
            Pointer<CERT_CONTEXT> pCertContext,
            Pointer<CTL_ENTRY> pCtlEntry,
            int dwFlags)>('CertSetCertificateContextPropertiesFromCTLEntry');

int CertSetCertificateContextProperty(Pointer<CERT_CONTEXT> pCertContext,
        int dwPropId, int dwFlags, Pointer pvData) =>
    _CertSetCertificateContextProperty(pCertContext, dwPropId, dwFlags, pvData);

late final _CertSetCertificateContextProperty = _crypt32.lookupFunction<
    Int32 Function(Pointer<CERT_CONTEXT> pCertContext, Uint32 dwPropId,
        Uint32 dwFlags, Pointer pvData),
    int Function(Pointer<CERT_CONTEXT> pCertContext, int dwPropId, int dwFlags,
        Pointer pvData)>('CertSetCertificateContextProperty');

int CertSetEnhancedKeyUsage(
        Pointer<CERT_CONTEXT> pCertContext, Pointer<CTL_USAGE> pUsage) =>
    _CertSetEnhancedKeyUsage(pCertContext, pUsage);

late final _CertSetEnhancedKeyUsage = _crypt32.lookupFunction<
    Int32 Function(
        Pointer<CERT_CONTEXT> pCertContext, Pointer<CTL_USAGE> pUsage),
    int Function(Pointer<CERT_CONTEXT> pCertContext,
        Pointer<CTL_USAGE> pUsage)>('CertSetEnhancedKeyUsage');

int CertSetStoreProperty(
        Pointer hCertStore, int dwPropId, int dwFlags, Pointer pvData) =>
    _CertSetStoreProperty(hCertStore, dwPropId, dwFlags, pvData);

late final _CertSetStoreProperty = _crypt32.lookupFunction<
    Int32 Function(
        Pointer hCertStore, Uint32 dwPropId, Uint32 dwFlags, Pointer pvData),
    int Function(Pointer hCertStore, int dwPropId, int dwFlags,
        Pointer pvData)>('CertSetStoreProperty');
...
int CertStrToName(
    ...
    _CertStrToName(dwCertEncodingType, pszX500, dwStrType, pvReserved,
...
late final _CertStrToName = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint8> pbEncoded,
        Pointer<Uint32> pcbEncoded,
        Pointer<Pointer<Utf16>> ppszError)>('CertStrToNameW');

int CertUnregisterPhysicalStore(
        Pointer pvSystemStore, int dwFlags, Pointer<Utf16> pwszStoreName) =>
    _CertUnregisterPhysicalStore(pvSystemStore, dwFlags, pwszStoreName);

late final _CertUnregisterPhysicalStore = _crypt32.lookupFunction<
    Int32 Function(
        Pointer pvSystemStore, Uint32 dwFlags, Pointer<Utf16> pwszStoreName),
    int Function(Pointer pvSystemStore, int dwFlags,
        Pointer<Utf16> pwszStoreName)>('CertUnregisterPhysicalStore');

int CertUnregisterSystemStore(Pointer pvSystemStore, int dwFlags) =>
    _CertUnregisterSystemStore(pvSystemStore, dwFlags);

late final _CertUnregisterSystemStore = _crypt32.lookupFunction<
    Int32 Function(Pointer pvSystemStore, Uint32 dwFlags),
    int Function(
        Pointer pvSystemStore, int dwFlags)>('CertUnregisterSystemStore');

int CertVerifyCRLRevocation(int dwCertEncodingType, Pointer<CERT_INFO> pCertId,
        int cCrlInfo, Pointer<Pointer<CRL_INFO>> rgpCrlInfo) =>
    _CertVerifyCRLRevocation(dwCertEncodingType, pCertId, cCrlInfo, rgpCrlInfo);

late final _CertVerifyCRLRevocation = _crypt32.lookupFunction<
    Int32 Function(Uint32 dwCertEncodingType, Pointer<CERT_INFO> pCertId,
        Uint32 cCrlInfo, Pointer<Pointer<CRL_INFO>> rgpCrlInfo),
    int Function(
        int dwCertEncodingType,
        Pointer<CERT_INFO> pCertId,
        int cCrlInfo,
        Pointer<Pointer<CRL_INFO>> rgpCrlInfo)>('CertVerifyCRLRevocation');

int CertVerifyCRLTimeValidity(
        Pointer<FILETIME> pTimeToVerify, Pointer<CRL_INFO> pCrlInfo) =>
    _CertVerifyCRLTimeValidity(pTimeToVerify, pCrlInfo);

late final _CertVerifyCRLTimeValidity = _crypt32.lookupFunction<
    Int32 Function(Pointer<FILETIME> pTimeToVerify, Pointer<CRL_INFO> pCrlInfo),
    int Function(Pointer<FILETIME> pTimeToVerify,
        Pointer<CRL_INFO> pCrlInfo)>('CertVerifyCRLTimeValidity');
...
int CertVerifyCTLUsage(
    ...
    _CertVerifyCTLUsage(dwEncodingType, dwSubjectType, pvSubject, pSubjectUsage,
...
int CertVerifyRevocation(
    ...
    _CertVerifyRevocation(dwEncodingType, dwRevType, cContext, rgpvContext,
...
late final _CertVerifyRevocation = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        int dwFlags,
        Pointer<CERT_REVOCATION_PARA> pRevPara,
        Pointer<CERT_REVOCATION_STATUS> pRevStatus)>('CertVerifyRevocation');

int CertVerifySubjectCertificateContext(Pointer<CERT_CONTEXT> pSubject,
        Pointer<CERT_CONTEXT> pIssuer, Pointer<Uint32> pdwFlags) =>
    _CertVerifySubjectCertificateContext(pSubject, pIssuer, pdwFlags);

late final _CertVerifySubjectCertificateContext = _crypt32.lookupFunction<
    Int32 Function(Pointer<CERT_CONTEXT> pSubject,
        Pointer<CERT_CONTEXT> pIssuer, Pointer<Uint32> pdwFlags),
    int Function(Pointer<CERT_CONTEXT> pSubject, Pointer<CERT_CONTEXT> pIssuer,
        Pointer<Uint32> pdwFlags)>('CertVerifySubjectCertificateContext');

int CertVerifyTimeValidity(
        Pointer<FILETIME> pTimeToVerify, Pointer<CERT_INFO> pCertInfo) =>
    _CertVerifyTimeValidity(pTimeToVerify, pCertInfo);

late final _CertVerifyTimeValidity = _crypt32.lookupFunction<
    Int32 Function(
        Pointer<FILETIME> pTimeToVerify, Pointer<CERT_INFO> pCertInfo),
    int Function(Pointer<FILETIME> pTimeToVerify,
        Pointer<CERT_INFO> pCertInfo)>('CertVerifyTimeValidity');

int CertVerifyValidityNesting(
        Pointer<CERT_INFO> pSubjectInfo, Pointer<CERT_INFO> pIssuerInfo) =>
    _CertVerifyValidityNesting(pSubjectInfo, pIssuerInfo);

late final _CertVerifyValidityNesting = _crypt32.lookupFunction<
    Int32 Function(
        Pointer<CERT_INFO> pSubjectInfo, Pointer<CERT_INFO> pIssuerInfo),
    int Function(Pointer<CERT_INFO> pSubjectInfo,
        Pointer<CERT_INFO> pIssuerInfo)>('CertVerifyValidityNesting');
...
int CryptAcquireCertificatePrivateKey(
    ...
    _CryptAcquireCertificatePrivateKey(pCert, dwFlags, pvParameters,
        phCryptProvOrNCryptKey, pdwKeySpec, pfCallerFreeProvOrNCryptKey);
...
int CryptBinaryToString(Pointer<Uint8> pbBinary, int cbBinary, int dwFlags,
        Pointer<Utf16> pszString, Pointer<Uint32> pcchString) =>
    _CryptBinaryToString(pbBinary, cbBinary, dwFlags, pszString, pcchString);

late final _CryptBinaryToString = _crypt32.lookupFunction<
    Int32 Function(Pointer<Uint8> pbBinary, Uint32 cbBinary, Uint32 dwFlags,
        Pointer<Utf16> pszString, Pointer<Uint32> pcchString),
    int Function(
        ...
        Pointer<Uint32> pcchString)>('CryptBinaryToStringW');

int CryptCloseAsyncHandle(int hAsync) => _CryptCloseAsyncHandle(hAsync);

late final _CryptCloseAsyncHandle = _crypt32.lookupFunction<
    Int32 Function(IntPtr hAsync),
    int Function(int hAsync)>('CryptCloseAsyncHandle');

int CryptCreateAsyncHandle(int dwFlags, Pointer<IntPtr> phAsync) =>
    _CryptCreateAsyncHandle(dwFlags, phAsync);

late final _CryptCreateAsyncHandle = _crypt32.lookupFunction<
    Int32 Function(Uint32 dwFlags, Pointer<IntPtr> phAsync),
    int Function(
        int dwFlags, Pointer<IntPtr> phAsync)>('CryptCreateAsyncHandle');
...
int CryptCreateKeyIdentifierFromCSP(
    ...
    _CryptCreateKeyIdentifierFromCSP(dwCertEncodingType, pszPubKeyOID,
        pPubKeyStruc, cbPubKeyStruc, dwFlags, pvReserved, pbHash, pcbHash);
...
late final _CryptCreateKeyIdentifierFromCSP = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer pvReserved,
        Pointer<Uint8> pbHash,
        Pointer<Uint32> pcbHash)>('CryptCreateKeyIdentifierFromCSP');
...
late final _CryptDecodeMessage = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> pcbDecoded,
        Pointer<Pointer<CERT_CONTEXT>> ppXchgCert,
        Pointer<Pointer<CERT_CONTEXT>> ppSignerCert)>('CryptDecodeMessage');
...
int CryptDecodeObject(
    ...
    _CryptDecodeObject(dwCertEncodingType, lpszStructType, pbEncoded, cbEncoded,
...
late final _CryptDecodeObject = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        int dwFlags,
        Pointer pvStructInfo,
        Pointer<Uint32> pcbStructInfo)>('CryptDecodeObject');
...
int CryptDecodeObjectEx(
        ...
        Pointer pvStructInfo,
        Pointer<Uint32> pcbStructInfo) =>
    _CryptDecodeObjectEx(dwCertEncodingType, lpszStructType, pbEncoded,
...
late final _CryptDecodeObjectEx = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<CRYPT_DECODE_PARA> pDecodePara,
        Pointer pvStructInfo,
        Pointer<Uint32> pcbStructInfo)>('CryptDecodeObjectEx');
...
int CryptDecryptMessage(
        ...
        Pointer<Uint32> pcbDecrypted,
        Pointer<Pointer<CERT_CONTEXT>> ppXchgCert) =>
    _CryptDecryptMessage(pDecryptPara, pbEncryptedBlob, cbEncryptedBlob,
        pbDecrypted, pcbDecrypted, ppXchgCert);
...
late final _CryptDecryptMessage = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint8> pbDecrypted,
        Pointer<Uint32> pcbDecrypted,
        Pointer<Pointer<CERT_CONTEXT>> ppXchgCert)>('CryptDecryptMessage');
...
int CryptEncodeObject(
        ...
        Pointer<Uint8> pbEncoded,
        Pointer<Uint32> pcbEncoded) =>
    _CryptEncodeObject(dwCertEncodingType, lpszStructType, pvStructInfo,
...
late final _CryptEncodeObject = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer pvStructInfo,
        Pointer<Uint8> pbEncoded,
        Pointer<Uint32> pcbEncoded)>('CryptEncodeObject');
...
int CryptEncodeObjectEx(
        ...
        Pointer pvEncoded,
        Pointer<Uint32> pcbEncoded) =>
    _CryptEncodeObjectEx(dwCertEncodingType, lpszStructType, pvStructInfo,
...
late final _CryptEncodeObjectEx = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<CRYPT_ENCODE_PARA> pEncodePara,
        Pointer pvEncoded,
        Pointer<Uint32> pcbEncoded)>('CryptEncodeObjectEx');
...
int CryptEncryptMessage(
    ...
    _CryptEncryptMessage(pEncryptPara, cRecipientCert, rgpRecipientCert,
        pbToBeEncrypted, cbToBeEncrypted, pbEncryptedBlob, pcbEncryptedBlob);
...
late final _CryptEncryptMessage = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        int cbToBeEncrypted,
        Pointer<Uint8> pbEncryptedBlob,
        Pointer<Uint32> pcbEncryptedBlob)>('CryptEncryptMessage');
...
int CryptEnumKeyIdentifierProperties(
    ...
    _CryptEnumKeyIdentifierProperties(pKeyIdentifier, dwPropId, dwFlags,
        pwszComputerName, pvReserved, pvArg, pfnEnum);
...
int CryptEnumOIDInfo(int dwGroupId, int dwFlags, Pointer pvArg,
        Pointer<NativeFunction<PFN_CRYPT_ENUM_OID_INFO>> pfnEnumOIDInfo) =>
    _CryptEnumOIDInfo(dwGroupId, dwFlags, pvArg, pfnEnumOIDInfo);

late final _CryptEnumOIDInfo = _crypt32.lookupFunction<
        Int32 Function(Uint32 dwGroupId, Uint32 dwFlags, Pointer pvArg,
            Pointer<NativeFunction<PFN_CRYPT_ENUM_OID_INFO>> pfnEnumOIDInfo),
        int Function(int dwGroupId, int dwFlags, Pointer pvArg,
            Pointer<NativeFunction<PFN_CRYPT_ENUM_OID_INFO>> pfnEnumOIDInfo)>(
    'CryptEnumOIDInfo');
...
int CryptExportPKCS8(
    ...
    _CryptExportPKCS8(hCryptProv, dwKeySpec, pszPrivateKeyObjId, dwFlags,
        pvAuxInfo, pbPrivateKeyBlob, pcbPrivateKeyBlob);
...
late final _CryptExportPKCS8 = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer pvAuxInfo,
        Pointer<Uint8> pbPrivateKeyBlob,
        Pointer<Uint32> pcbPrivateKeyBlob)>('CryptExportPKCS8');
...
late final _CryptExportPublicKeyInfo = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        int dwCertEncodingType,
        Pointer<CERT_PUBLIC_KEY_INFO> pInfo,
        Pointer<Uint32> pcbInfo)>('CryptExportPublicKeyInfo');
...
late final _CryptExportPublicKeyInfoEx = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer pvAuxInfo,
        Pointer<CERT_PUBLIC_KEY_INFO> pInfo,
        Pointer<Uint32> pcbInfo)>('CryptExportPublicKeyInfoEx');
...
int CryptExportPublicKeyInfoFromBCryptKeyHandle(
        ...
        Pointer<CERT_PUBLIC_KEY_INFO> pInfo,
        Pointer<Uint32> pcbInfo) =>
    _CryptExportPublicKeyInfoFromBCryptKeyHandle(hBCryptKey, dwCertEncodingType,
...
int CryptFindCertificateKeyProvInfo(
        Pointer<CERT_CONTEXT> pCert, int dwFlags, Pointer pvReserved) =>
    _CryptFindCertificateKeyProvInfo(pCert, dwFlags, pvReserved);

late final _CryptFindCertificateKeyProvInfo = _crypt32.lookupFunction<
    Int32 Function(
        Pointer<CERT_CONTEXT> pCert, Uint32 dwFlags, Pointer pvReserved),
    int Function(Pointer<CERT_CONTEXT> pCert, int dwFlags,
        Pointer pvReserved)>('CryptFindCertificateKeyProvInfo');

Pointer<Utf16> CryptFindLocalizedName(Pointer<Utf16> pwszCryptName) =>
    _CryptFindLocalizedName(pwszCryptName);

late final _CryptFindLocalizedName = _crypt32.lookupFunction<
    Pointer<Utf16> Function(Pointer<Utf16> pwszCryptName),
    Pointer<Utf16> Function(
        Pointer<Utf16> pwszCryptName)>('CryptFindLocalizedName');

Pointer<CRYPT_OID_INFO> CryptFindOIDInfo(
        int dwKeyType, Pointer pvKey, int dwGroupId) =>
    _CryptFindOIDInfo(dwKeyType, pvKey, dwGroupId);

late final _CryptFindOIDInfo = _crypt32.lookupFunction<
    Pointer<CRYPT_OID_INFO> Function(
        Uint32 dwKeyType, Pointer pvKey, Uint32 dwGroupId),
    Pointer<CRYPT_OID_INFO> Function(
        int dwKeyType, Pointer pvKey, int dwGroupId)>('CryptFindOIDInfo');
...
late final _CryptFormatObject = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        int cbEncoded,
        Pointer pbFormat,
        Pointer<Uint32> pcbFormat)>('CryptFormatObject');

int CryptFreeOIDFunctionAddress(Pointer hFuncAddr, int dwFlags) =>
    _CryptFreeOIDFunctionAddress(hFuncAddr, dwFlags);

late final _CryptFreeOIDFunctionAddress = _crypt32.lookupFunction<
    Int32 Function(Pointer hFuncAddr, Uint32 dwFlags),
    int Function(
        Pointer hFuncAddr, int dwFlags)>('CryptFreeOIDFunctionAddress');

int CryptGetAsyncParam(
        int hAsync,
        Pointer<Utf8> pszParamOid,
        Pointer<Pointer> ppvParam,
        Pointer<Pointer<NativeFunction<PFN_CRYPT_ASYNC_PARAM_FREE_FUNC>>>
            ppfnFree) =>
    _CryptGetAsyncParam(hAsync, pszParamOid, ppvParam, ppfnFree);
...
late final _CryptGetAsyncParam = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Pointer> ppvParam,
        Pointer<Pointer<NativeFunction<PFN_CRYPT_ASYNC_PARAM_FREE_FUNC>>>
            ppfnFree)>('CryptGetAsyncParam');

int CryptGetDefaultOIDDllList(Pointer hFuncSet, int dwEncodingType,
        Pointer<Utf16> pwszDllList, Pointer<Uint32> pcchDllList) =>
...
late final _CryptGetDefaultOIDDllList = _crypt32.lookupFunction<
    Int32 Function(Pointer hFuncSet, Uint32 dwEncodingType,
        Pointer<Utf16> pwszDllList, Pointer<Uint32> pcchDllList),
    int Function(
        Pointer hFuncSet,
        int dwEncodingType,
        Pointer<Utf16> pwszDllList,
        Pointer<Uint32> pcchDllList)>('CryptGetDefaultOIDDllList');
...
late final _CryptGetDefaultOIDFunctionAddress = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        int dwFlags,
        Pointer<Pointer> ppvFuncAddr,
        Pointer<Pointer> phFuncAddr)>('CryptGetDefaultOIDFunctionAddress');
...
int CryptGetKeyIdentifierProperty(
        ...
        Pointer pvData,
        Pointer<Uint32> pcbData) =>
    _CryptGetKeyIdentifierProperty(pKeyIdentifier, dwPropId, dwFlags,
        pwszComputerName, pvReserved, pvData, pcbData);
...
late final _CryptGetKeyIdentifierProperty = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer pvReserved,
        Pointer pvData,
        Pointer<Uint32> pcbData)>('CryptGetKeyIdentifierProperty');
...
Pointer CryptGetMessageCertificates(
        ...
        int cbSignedBlob) =>
    _CryptGetMessageCertificates(dwMsgAndCertEncodingType, hCryptProv, dwFlags,
        pbSignedBlob, cbSignedBlob);

late final _CryptGetMessageCertificates = _crypt32.lookupFunction<
    Pointer Function(Uint32 dwMsgAndCertEncodingType, IntPtr hCryptProv,
        Uint32 dwFlags, Pointer<Uint8> pbSignedBlob, Uint32 cbSignedBlob),
    Pointer Function(
        int dwMsgAndCertEncodingType,
        int hCryptProv,
        int dwFlags,
        Pointer<Uint8> pbSignedBlob,
        int cbSignedBlob)>('CryptGetMessageCertificates');

int CryptGetMessageSignerCount(
        int dwMsgEncodingType, Pointer<Uint8> pbSignedBlob, int cbSignedBlob) =>
    _CryptGetMessageSignerCount(dwMsgEncodingType, pbSignedBlob, cbSignedBlob);

late final _CryptGetMessageSignerCount = _crypt32.lookupFunction<
    Int32 Function(Uint32 dwMsgEncodingType, Pointer<Uint8> pbSignedBlob,
        Uint32 cbSignedBlob),
    int Function(int dwMsgEncodingType, Pointer<Uint8> pbSignedBlob,
        int cbSignedBlob)>('CryptGetMessageSignerCount');
...
late final _CryptGetOIDFunctionAddress = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        int dwFlags,
        Pointer<Pointer> ppvFuncAddr,
        Pointer<Pointer> phFuncAddr)>('CryptGetOIDFunctionAddress');
...
int CryptGetOIDFunctionValue(
    ...
    _CryptGetOIDFunctionValue(dwEncodingType, pszFuncName, pszOID,
        pwszValueName, pdwValueType, pbValueData, pcbValueData);
...
late final _CryptGetOIDFunctionValue = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> pdwValueType,
        Pointer<Uint8> pbValueData,
        Pointer<Uint32> pcbValueData)>('CryptGetOIDFunctionValue');
...
int CryptHashCertificate(
    ...
    _CryptHashCertificate(hCryptProv, Algid, dwFlags, pbEncoded, cbEncoded,
...
late final _CryptHashCertificate = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        int cbEncoded,
        Pointer<Uint8> pbComputedHash,
        Pointer<Uint32> pcbComputedHash)>('CryptHashCertificate');
...
int CryptHashCertificate2(
        ...
        Pointer<Uint8> pbComputedHash,
        Pointer<Uint32> pcbComputedHash) =>
    _CryptHashCertificate2(pwszCNGHashAlgid, dwFlags, pvReserved, pbEncoded,
        cbEncoded, pbComputedHash, pcbComputedHash);
...
late final _CryptHashCertificate2 = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        int cbEncoded,
        Pointer<Uint8> pbComputedHash,
        Pointer<Uint32> pcbComputedHash)>('CryptHashCertificate2');
...
late final _CryptHashMessage = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> pcbHashedBlob,
        Pointer<Uint8> pbComputedHash,
        Pointer<Uint32> pcbComputedHash)>('CryptHashMessage');
...
int CryptHashPublicKeyInfo(
        ...
        Pointer<Uint8> pbComputedHash,
        Pointer<Uint32> pcbComputedHash) =>
    _CryptHashPublicKeyInfo(hCryptProv, Algid, dwFlags, dwCertEncodingType,
...
late final _CryptHashPublicKeyInfo = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<CERT_PUBLIC_KEY_INFO> pInfo,
        Pointer<Uint8> pbComputedHash,
        Pointer<Uint32> pcbComputedHash)>('CryptHashPublicKeyInfo');
...
int CryptHashToBeSigned(
        ...
        Pointer<Uint8> pbComputedHash,
        Pointer<Uint32> pcbComputedHash) =>
    _CryptHashToBeSigned(hCryptProv, dwCertEncodingType, pbEncoded, cbEncoded,
        pbComputedHash, pcbComputedHash);
...
late final _CryptHashToBeSigned = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        int cbEncoded,
        Pointer<Uint8> pbComputedHash,
        Pointer<Uint32> pcbComputedHash)>('CryptHashToBeSigned');

int CryptImportPKCS8(CRYPT_PKCS8_IMPORT_PARAMS sPrivateKeyAndParams,
        int dwFlags, Pointer<IntPtr> phCryptProv, Pointer pvAuxInfo) =>
    _CryptImportPKCS8(sPrivateKeyAndParams, dwFlags, phCryptProv, pvAuxInfo);

late final _CryptImportPKCS8 = _crypt32.lookupFunction<
    Int32 Function(CRYPT_PKCS8_IMPORT_PARAMS sPrivateKeyAndParams,
        Uint32 dwFlags, Pointer<IntPtr> phCryptProv, Pointer pvAuxInfo),
    int Function(CRYPT_PKCS8_IMPORT_PARAMS sPrivateKeyAndParams, int dwFlags,
        Pointer<IntPtr> phCryptProv, Pointer pvAuxInfo)>('CryptImportPKCS8');

int CryptImportPublicKeyInfo(int hCryptProv, int dwCertEncodingType,
        Pointer<CERT_PUBLIC_KEY_INFO> pInfo, Pointer<IntPtr> phKey) =>
    _CryptImportPublicKeyInfo(hCryptProv, dwCertEncodingType, pInfo, phKey);

late final _CryptImportPublicKeyInfo = _crypt32.lookupFunction<
    Int32 Function(IntPtr hCryptProv, Uint32 dwCertEncodingType,
        Pointer<CERT_PUBLIC_KEY_INFO> pInfo, Pointer<IntPtr> phKey),
    int Function(
        int hCryptProv,
        int dwCertEncodingType,
        Pointer<CERT_PUBLIC_KEY_INFO> pInfo,
        Pointer<IntPtr> phKey)>('CryptImportPublicKeyInfo');
...
int CryptImportPublicKeyInfoEx(
        ...
        Pointer pvAuxInfo,
        Pointer<IntPtr> phKey) =>
    _CryptImportPublicKeyInfoEx(hCryptProv, dwCertEncodingType, pInfo, aiKeyAlg,
...
late final _CryptImportPublicKeyInfoEx = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        int dwFlags,
        Pointer pvAuxInfo,
        Pointer<IntPtr> phKey)>('CryptImportPublicKeyInfoEx');
...
late final _CryptImportPublicKeyInfoEx2 = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        int dwFlags,
        Pointer pvAuxInfo,
        Pointer<IntPtr> phKey)>('CryptImportPublicKeyInfoEx2');

Pointer CryptInitOIDFunctionSet(Pointer<Utf8> pszFuncName, int dwFlags) =>
    _CryptInitOIDFunctionSet(pszFuncName, dwFlags);

late final _CryptInitOIDFunctionSet = _crypt32.lookupFunction<
    Pointer Function(Pointer<Utf8> pszFuncName, Uint32 dwFlags),
    Pointer Function(
        Pointer<Utf8> pszFuncName, int dwFlags)>('CryptInitOIDFunctionSet');
...
int CryptInstallDefaultContext(
    ...
    _CryptInstallDefaultContext(hCryptProv, dwDefaultType, pvDefaultPara,
...
late final _CryptInstallDefaultContext = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        int dwFlags,
        Pointer pvReserved,
        Pointer<Pointer> phDefaultContext)>('CryptInstallDefaultContext');
...
late final _CryptInstallOIDFunctionAddress = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        int cFuncEntry,
        Pointer<CRYPT_OID_FUNC_ENTRY> rgFuncEntry,
        int dwFlags)>('CryptInstallOIDFunctionAddress');

Pointer CryptMemAlloc(int cbSize) => _CryptMemAlloc(cbSize);

late final _CryptMemAlloc = _crypt32.lookupFunction<
    Pointer Function(Uint32 cbSize),
    Pointer Function(int cbSize)>('CryptMemAlloc');

void CryptMemFree(Pointer pv) => _CryptMemFree(pv);

late final _CryptMemFree = _crypt32.lookupFunction<Void Function(Pointer pv),
    void Function(Pointer pv)>('CryptMemFree');

Pointer CryptMemRealloc(Pointer pv, int cbSize) => _CryptMemRealloc(pv, cbSize);

late final _CryptMemRealloc = _crypt32.lookupFunction<
    Pointer Function(Pointer pv, Uint32 cbSize),
    Pointer Function(Pointer pv, int cbSize)>('CryptMemRealloc');
...
int CryptMsgCalculateEncodedLength(
        ...
        int cbData) =>
    _CryptMsgCalculateEncodedLength(dwMsgEncodingType, dwFlags, dwMsgType,
        pvMsgEncodeInfo, pszInnerContentObjID, cbData);
...
late final _CryptMsgCalculateEncodedLength = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer pvMsgEncodeInfo,
        Pointer<Utf8> pszInnerContentObjID,
        int cbData)>('CryptMsgCalculateEncodedLength');

int CryptMsgClose(Pointer hCryptMsg) => _CryptMsgClose(hCryptMsg);

late final _CryptMsgClose = _crypt32.lookupFunction<
    Int32 Function(Pointer hCryptMsg),
    int Function(Pointer hCryptMsg)>('CryptMsgClose');

int CryptMsgControl(
        Pointer hCryptMsg, int dwFlags, int dwCtrlType, Pointer pvCtrlPara) =>
    _CryptMsgControl(hCryptMsg, dwFlags, dwCtrlType, pvCtrlPara);

late final _CryptMsgControl = _crypt32.lookupFunction<
    Int32 Function(Pointer hCryptMsg, Uint32 dwFlags, Uint32 dwCtrlType,
        Pointer pvCtrlPara),
    int Function(Pointer hCryptMsg, int dwFlags, int dwCtrlType,
        Pointer pvCtrlPara)>('CryptMsgControl');

int CryptMsgCountersign(Pointer hCryptMsg, int dwIndex, int cCountersigners,
        Pointer<CMSG_SIGNER_ENCODE_INFO> rgCountersigners) =>
    _CryptMsgCountersign(hCryptMsg, dwIndex, cCountersigners, rgCountersigners);

late final _CryptMsgCountersign = _crypt32.lookupFunction<
    Int32 Function(Pointer hCryptMsg, Uint32 dwIndex, Uint32 cCountersigners,
        Pointer<CMSG_SIGNER_ENCODE_INFO> rgCountersigners),
    int Function(
        Pointer hCryptMsg,
        int dwIndex,
        int cCountersigners,
        Pointer<CMSG_SIGNER_ENCODE_INFO>
            rgCountersigners)>('CryptMsgCountersign');
...
late final _CryptMsgCountersignEncoded = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<CMSG_SIGNER_ENCODE_INFO> rgCountersigners,
        Pointer<Uint8> pbCountersignature,
        Pointer<Uint32> pcbCountersignature)>('CryptMsgCountersignEncoded');

Pointer CryptMsgDuplicate(Pointer hCryptMsg) => _CryptMsgDuplicate(hCryptMsg);

late final _CryptMsgDuplicate = _crypt32.lookupFunction<
    Pointer Function(Pointer hCryptMsg),
    Pointer Function(Pointer hCryptMsg)>('CryptMsgDuplicate');
...
late final _CryptMsgEncodeAndSignCTL = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        int dwFlags,
        Pointer<Uint8> pbEncoded,
        Pointer<Uint32> pcbEncoded)>('CryptMsgEncodeAndSignCTL');
...
int CryptMsgGetAndVerifySigner(
    ...
    _CryptMsgGetAndVerifySigner(hCryptMsg, cSignerStore, rghSignerStore,
        dwFlags, ppSigner, pdwSignerIndex);
...
late final _CryptMsgGetAndVerifySigner = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        int dwFlags,
        Pointer<Pointer<CERT_CONTEXT>> ppSigner,
        Pointer<Uint32> pdwSignerIndex)>('CryptMsgGetAndVerifySigner');

int CryptMsgGetParam(Pointer hCryptMsg, int dwParamType, int dwIndex,
        Pointer pvData, Pointer<Uint32> pcbData) =>
    _CryptMsgGetParam(hCryptMsg, dwParamType, dwIndex, pvData, pcbData);

late final _CryptMsgGetParam = _crypt32.lookupFunction<
    Int32 Function(Pointer hCryptMsg, Uint32 dwParamType, Uint32 dwIndex,
        Pointer pvData, Pointer<Uint32> pcbData),
    int Function(Pointer hCryptMsg, int dwParamType, int dwIndex,
        Pointer pvData, Pointer<Uint32> pcbData)>('CryptMsgGetParam');
...
Pointer CryptMsgOpenToDecode(
    ...
    _CryptMsgOpenToDecode(dwMsgEncodingType, dwFlags, dwMsgType, hCryptProv,
...
late final _CryptMsgOpenToDecode = _crypt32.lookupFunction<
    ...
    Pointer Function(
        ...
        int hCryptProv,
        Pointer<CERT_INFO> pRecipientInfo,
        Pointer<CMSG_STREAM_INFO> pStreamInfo)>('CryptMsgOpenToDecode');
...
Pointer CryptMsgOpenToEncode(
        ...
        Pointer<Utf8> pszInnerContentObjID,
        Pointer<CMSG_STREAM_INFO> pStreamInfo) =>
    _CryptMsgOpenToEncode(dwMsgEncodingType, dwFlags, dwMsgType,
...
late final _CryptMsgOpenToEncode = _crypt32.lookupFunction<
    ...
    Pointer Function(
        ...
        Pointer pvMsgEncodeInfo,
        Pointer<Utf8> pszInnerContentObjID,
        Pointer<CMSG_STREAM_INFO> pStreamInfo)>('CryptMsgOpenToEncode');
...
int CryptMsgSignCTL(
        ...
        Pointer<Uint8> pbEncoded,
        Pointer<Uint32> pcbEncoded) =>
    _CryptMsgSignCTL(dwMsgEncodingType, pbCtlContent, cbCtlContent, pSignInfo,
        dwFlags, pbEncoded, pcbEncoded);
...
late final _CryptMsgSignCTL = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        int dwFlags,
        Pointer<Uint8> pbEncoded,
        Pointer<Uint32> pcbEncoded)>('CryptMsgSignCTL');

int CryptMsgUpdate(
        Pointer hCryptMsg, Pointer<Uint8> pbData, int cbData, int fFinal) =>
    _CryptMsgUpdate(hCryptMsg, pbData, cbData, fFinal);

late final _CryptMsgUpdate = _crypt32.lookupFunction<
    Int32 Function(
        Pointer hCryptMsg, Pointer<Uint8> pbData, Uint32 cbData, Int32 fFinal),
    int Function(Pointer hCryptMsg, Pointer<Uint8> pbData, int cbData,
        int fFinal)>('CryptMsgUpdate');
...
late final _CryptMsgVerifyCountersignatureEncodedEx = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer pvSigner,
        int dwFlags,
        Pointer pvExtra)>('CryptMsgVerifyCountersignatureEncodedEx');
...
late final _CryptQueryObject = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Pointer> phCertStore,
        Pointer<Pointer> phMsg,
        Pointer<Pointer> ppvContext)>('CryptQueryObject');

int CryptRegisterDefaultOIDFunction(int dwEncodingType,
        Pointer<Utf8> pszFuncName, int dwIndex, Pointer<Utf16> pwszDll) =>
...
late final _CryptRegisterDefaultOIDFunction = _crypt32.lookupFunction<
    Int32 Function(Uint32 dwEncodingType, Pointer<Utf8> pszFuncName,
        Uint32 dwIndex, Pointer<Utf16> pwszDll),
    int Function(int dwEncodingType, Pointer<Utf8> pszFuncName, int dwIndex,
        Pointer<Utf16> pwszDll)>('CryptRegisterDefaultOIDFunction');
...
late final _CryptRegisterOIDFunction = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Utf8> pszOID,
        Pointer<Utf16> pwszDll,
        Pointer<Utf8> pszOverrideFuncName)>('CryptRegisterOIDFunction');

int CryptRegisterOIDInfo(Pointer<CRYPT_OID_INFO> pInfo, int dwFlags) =>
    _CryptRegisterOIDInfo(pInfo, dwFlags);

late final _CryptRegisterOIDInfo = _crypt32.lookupFunction<
    Int32 Function(Pointer<CRYPT_OID_INFO> pInfo, Uint32 dwFlags),
    int Function(
        Pointer<CRYPT_OID_INFO> pInfo, int dwFlags)>('CryptRegisterOIDInfo');
...
int CryptRetrieveTimeStamp(
    ...
    _CryptRetrieveTimeStamp(wszUrl, dwRetrievalFlags, dwTimeout, pszHashId,
        pPara, pbData, cbData, ppTsContext, ppTsSigner, phStore);
...
late final _CryptRetrieveTimeStamp = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Pointer<CRYPT_TIMESTAMP_CONTEXT>> ppTsContext,
        Pointer<Pointer<CERT_CONTEXT>> ppTsSigner,
        Pointer<Pointer> phStore)>('CryptRetrieveTimeStamp');

int CryptSetAsyncParam(int hAsync, Pointer<Utf8> pszParamOid, Pointer pvParam,
        Pointer<NativeFunction<PFN_CRYPT_ASYNC_PARAM_FREE_FUNC>> pfnFree) =>
    _CryptSetAsyncParam(hAsync, pszParamOid, pvParam, pfnFree);

late final _CryptSetAsyncParam = _crypt32.lookupFunction<
    Int32 Function(IntPtr hAsync, Pointer<Utf8> pszParamOid, Pointer pvParam,
        Pointer<NativeFunction<PFN_CRYPT_ASYNC_PARAM_FREE_FUNC>> pfnFree),
    int Function(
        int hAsync,
        Pointer<Utf8> pszParamOid,
        Pointer pvParam,
        Pointer<NativeFunction<PFN_CRYPT_ASYNC_PARAM_FREE_FUNC>>
            pfnFree)>('CryptSetAsyncParam');
...
int CryptSetKeyIdentifierProperty(
        ...
        Pointer pvReserved,
        Pointer pvData) =>
    _CryptSetKeyIdentifierProperty(pKeyIdentifier, dwPropId, dwFlags,
        pwszComputerName, pvReserved, pvData);
...
late final _CryptSetKeyIdentifierProperty = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Utf16> pwszComputerName,
        Pointer pvReserved,
        Pointer pvData)>('CryptSetKeyIdentifierProperty');
...
int CryptSetOIDFunctionValue(
        ...
        Pointer<Uint8> pbValueData,
        int cbValueData) =>
    _CryptSetOIDFunctionValue(dwEncodingType, pszFuncName, pszOID,
        pwszValueName, dwValueType, pbValueData, cbValueData);
...
late final _CryptSetOIDFunctionValue = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        int dwValueType,
        Pointer<Uint8> pbValueData,
        int cbValueData)>('CryptSetOIDFunctionValue');
...
late final _CryptSignAndEncodeCertificate = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer pvHashAuxInfo,
        Pointer<Uint8> pbEncoded,
        Pointer<Uint32> pcbEncoded)>('CryptSignAndEncodeCertificate');
...
late final _CryptSignCertificate = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer pvHashAuxInfo,
        Pointer<Uint8> pbSignature,
        Pointer<Uint32> pcbSignature)>('CryptSignCertificate');
...
int CryptSignMessage(
    ...
    _CryptSignMessage(pSignPara, fDetachedSignature, cToBeSigned,
        rgpbToBeSigned, rgcbToBeSigned, pbSignedBlob, pcbSignedBlob);
...
late final _CryptSignMessage = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> rgcbToBeSigned,
        Pointer<Uint8> pbSignedBlob,
        Pointer<Uint32> pcbSignedBlob)>('CryptSignMessage');
...
late final _CryptSignMessageWithKey = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        int cbToBeSigned,
        Pointer<Uint8> pbSignedBlob,
        Pointer<Uint32> pcbSignedBlob)>('CryptSignMessageWithKey');
...
late final _CryptStringToBinary = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> pcbBinary,
        Pointer<Uint32> pdwSkip,
        Pointer<Uint32> pdwFlags)>('CryptStringToBinaryW');

int CryptUninstallDefaultContext(
        Pointer hDefaultContext, int dwFlags, Pointer pvReserved) =>
    _CryptUninstallDefaultContext(hDefaultContext, dwFlags, pvReserved);

late final _CryptUninstallDefaultContext = _crypt32.lookupFunction<
    Int32 Function(Pointer hDefaultContext, Uint32 dwFlags, Pointer pvReserved),
    int Function(Pointer hDefaultContext, int dwFlags,
        Pointer pvReserved)>('CryptUninstallDefaultContext');
...
int CryptUnregisterDefaultOIDFunction(int dwEncodingType,
        Pointer<Utf8> pszFuncName, Pointer<Utf16> pwszDll) =>
    _CryptUnregisterDefaultOIDFunction(dwEncodingType, pszFuncName, pwszDll);

late final _CryptUnregisterDefaultOIDFunction = _crypt32.lookupFunction<
    Int32 Function(Uint32 dwEncodingType, Pointer<Utf8> pszFuncName,
        Pointer<Utf16> pwszDll),
    int Function(int dwEncodingType, Pointer<Utf8> pszFuncName,
        Pointer<Utf16> pwszDll)>('CryptUnregisterDefaultOIDFunction');

int CryptUnregisterOIDFunction(
        int dwEncodingType, Pointer<Utf8> pszFuncName, Pointer<Utf8> pszOID) =>
    _CryptUnregisterOIDFunction(dwEncodingType, pszFuncName, pszOID);

late final _CryptUnregisterOIDFunction = _crypt32.lookupFunction<
    Int32 Function(
        Uint32 dwEncodingType, Pointer<Utf8> pszFuncName, Pointer<Utf8> pszOID),
    int Function(int dwEncodingType, Pointer<Utf8> pszFuncName,
        Pointer<Utf8> pszOID)>('CryptUnregisterOIDFunction');

int CryptUnregisterOIDInfo(Pointer<CRYPT_OID_INFO> pInfo) =>
    _CryptUnregisterOIDInfo(pInfo);

late final _CryptUnregisterOIDInfo = _crypt32.lookupFunction<
    Int32 Function(Pointer<CRYPT_OID_INFO> pInfo),
    int Function(Pointer<CRYPT_OID_INFO> pInfo)>('CryptUnregisterOIDInfo');
...
int CryptVerifyCertificateSignatureEx(
        ...
        int dwFlags,
        Pointer pvExtra) =>
    _CryptVerifyCertificateSignatureEx(hCryptProv, dwCertEncodingType,
        dwSubjectType, pvSubject, dwIssuerType, pvIssuer, dwFlags, pvExtra);
...
late final _CryptVerifyCertificateSignatureEx = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer pvIssuer,
        int dwFlags,
        Pointer pvExtra)>('CryptVerifyCertificateSignatureEx');
...
late final _CryptVerifyDetachedMessageHash = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> rgcbToBeHashed,
        Pointer<Uint8> pbComputedHash,
        Pointer<Uint32> pcbComputedHash)>('CryptVerifyDetachedMessageHash');
...
int CryptVerifyMessageHash(
        ...
        Pointer<Uint8> pbComputedHash,
        Pointer<Uint32> pcbComputedHash) =>
    _CryptVerifyMessageHash(pHashPara, pbHashedBlob, cbHashedBlob, pbToBeHashed,
        pcbToBeHashed, pbComputedHash, pcbComputedHash);
...
late final _CryptVerifyMessageHash = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> pcbToBeHashed,
        Pointer<Uint8> pbComputedHash,
        Pointer<Uint32> pcbComputedHash)>('CryptVerifyMessageHash');
...
int CryptVerifyMessageSignature(
        ...
        Pointer<Uint32> pcbDecoded,
        Pointer<Pointer<CERT_CONTEXT>> ppSignerCert) =>
    _CryptVerifyMessageSignature(pVerifyPara, dwSignerIndex, pbSignedBlob,
...
int CryptVerifyMessageSignatureWithKey(
        ...
        Pointer<Uint8> pbDecoded,
        Pointer<Uint32> pcbDecoded) =>
    _CryptVerifyMessageSignatureWithKey(pVerifyPara, pPublicKeyInfo,
        pbSignedBlob, cbSignedBlob, pbDecoded, pcbDecoded);
...
late final _CryptVerifyMessageSignatureWithKey = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        int cbSignedBlob,
        Pointer<Uint8> pbDecoded,
        Pointer<Uint32> pcbDecoded)>('CryptVerifyMessageSignatureWithKey');
...
int CryptVerifyTimeStampSignature(
        ...
        Pointer<Pointer<CERT_CONTEXT>> ppTsSigner,
        Pointer<Pointer> phStore) =>
    _CryptVerifyTimeStampSignature(pbTSContentInfo, cbTSContentInfo, pbData,
        cbData, hAdditionalStore, ppTsContext, ppTsSigner, phStore);
...
late final _CryptVerifyTimeStampSignature = _crypt32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Pointer<CRYPT_TIMESTAMP_CONTEXT>> ppTsContext,
        Pointer<Pointer<CERT_CONTEXT>> ppTsSigner,
        Pointer<Pointer> phStore)>('CryptVerifyTimeStampSignature');

int PFXExportCertStore(Pointer hStore, Pointer<CRYPTOAPI_BLOB> pPFX,
        Pointer<Utf16> szPassword, int dwFlags) =>
    _PFXExportCertStore(hStore, pPFX, szPassword, dwFlags);

late final _PFXExportCertStore = _crypt32.lookupFunction<
    Int32 Function(Pointer hStore, Pointer<CRYPTOAPI_BLOB> pPFX,
        Pointer<Utf16> szPassword, Uint32 dwFlags),
    int Function(Pointer hStore, Pointer<CRYPTOAPI_BLOB> pPFX,
        Pointer<Utf16> szPassword, int dwFlags)>('PFXExportCertStore');

int PFXExportCertStoreEx(Pointer hStore, Pointer<CRYPTOAPI_BLOB> pPFX,
        Pointer<Utf16> szPassword, Pointer pvPara, int dwFlags) =>
    _PFXExportCertStoreEx(hStore, pPFX, szPassword, pvPara, dwFlags);

late final _PFXExportCertStoreEx = _crypt32.lookupFunction<
    Int32 Function(Pointer hStore, Pointer<CRYPTOAPI_BLOB> pPFX,
        Pointer<Utf16> szPassword, Pointer pvPara, Uint32 dwFlags),
    int Function(
        Pointer hStore,
        Pointer<CRYPTOAPI_BLOB> pPFX,
        Pointer<Utf16> szPassword,
        Pointer pvPara,
        int dwFlags)>('PFXExportCertStoreEx');

Pointer PFXImportCertStore(
        Pointer<CRYPTOAPI_BLOB> pPFX, Pointer<Utf16> szPassword, int dwFlags) =>
    _PFXImportCertStore(pPFX, szPassword, dwFlags);

late final _PFXImportCertStore = _crypt32.lookupFunction<
    Pointer Function(Pointer<CRYPTOAPI_BLOB> pPFX, Pointer<Utf16> szPassword,
        Uint32 dwFlags),
    Pointer Function(Pointer<CRYPTOAPI_BLOB> pPFX, Pointer<Utf16> szPassword,
        int dwFlags)>('PFXImportCertStore');

int PFXIsPFXBlob(Pointer<CRYPTOAPI_BLOB> pPFX) => _PFXIsPFXBlob(pPFX);

late final _PFXIsPFXBlob = _crypt32.lookupFunction<
    Int32 Function(Pointer<CRYPTOAPI_BLOB> pPFX),
    int Function(Pointer<CRYPTOAPI_BLOB> pPFX)>('PFXIsPFXBlob');

int PFXVerifyPassword(
        Pointer<CRYPTOAPI_BLOB> pPFX, Pointer<Utf16> szPassword, int dwFlags) =>
    _PFXVerifyPassword(pPFX, szPassword, dwFlags);

late final _PFXVerifyPassword = _crypt32.lookupFunction<
    Int32 Function(Pointer<CRYPTOAPI_BLOB> pPFX, Pointer<Utf16> szPassword,
        Uint32 dwFlags),
    int Function(Pointer<CRYPTOAPI_BLOB> pPFX, Pointer<Utf16> szPassword,
        int dwFlags)>('PFXVerifyPassword');
...
int FindCertsByIssuer(
        ...
        int dwKeySpec) =>
    _FindCertsByIssuer(pCertChains, pcbCertChains, pcCertChains,
        pbEncodedIssuerName, cbEncodedIssuerName, pwszPurpose, dwKeySpec);
...
late final _FindCertsByIssuer = _wintrust.lookupFunction<
    ...
    int Function(
        ...
        int cbEncodedIssuerName,
        Pointer<Utf16> pwszPurpose,
        int dwKeySpec)>('FindCertsByIssuer');
...
int CryptGetObjectUrl(
        ...
        Pointer pvReserved) =>
    _CryptGetObjectUrl(pszUrlOid, pvPara, dwFlags, pUrlArray, pcbUrlArray,
...
late final _CryptGetObjectUrl = _cryptnet.lookupFunction<
    ...
    int Function(
        ...
        Pointer<CRYPT_URL_INFO> pUrlInfo,
        Pointer<Uint32> pcbUrlInfo,
        Pointer pvReserved)>('CryptGetObjectUrl');
...
int CryptInstallCancelRetrieval(
        ...
        int dwFlags,
        Pointer pvReserved) =>
    _CryptInstallCancelRetrieval(pfnCancel, pvArg, dwFlags, pvReserved);
...
late final _CryptInstallCancelRetrieval = _cryptnet.lookupFunction<
    ...
    int Function(
        ...
        Pointer pvArg,
        int dwFlags,
        Pointer pvReserved)>('CryptInstallCancelRetrieval');
...
int CryptRetrieveObjectByUrl(
    ...
    _CryptRetrieveObjectByUrl(pszUrl, pszObjectOid, dwRetrievalFlags, dwTimeout,
        ppvObject, hAsyncRetrieve, pCredentials, pvVerify, pAuxInfo);
...
int CryptUninstallCancelRetrieval(int dwFlags, Pointer pvReserved) =>
    _CryptUninstallCancelRetrieval(dwFlags, pvReserved);

late final _CryptUninstallCancelRetrieval = _cryptnet.lookupFunction<
    Int32 Function(Uint32 dwFlags, Pointer pvReserved),
    int Function(
        int dwFlags, Pointer pvReserved)>('CryptUninstallCancelRetrieval');
...
int CryptXmlAddObject(
    ...
    _CryptXmlAddObject(
        hSignatureOrObject, dwFlags, rgProperty, cProperty, pEncoded, ppObject);
...
late final _CryptXmlAddObject = _cryptxml.lookupFunction<
    ...
    int Function(
        ...
        int cProperty,
        Pointer<CRYPT_XML_BLOB> pEncoded,
        Pointer<Pointer<CRYPT_XML_OBJECT>> ppObject)>('CryptXmlAddObject');

int CryptXmlClose(Pointer hCryptXml) => _CryptXmlClose(hCryptXml);

late final _CryptXmlClose = _cryptxml.lookupFunction<
    Int32 Function(Pointer hCryptXml),
    int Function(Pointer hCryptXml)>('CryptXmlClose');
...
int CryptXmlCreateReference(
    ...
    _CryptXmlCreateReference(hCryptXml, dwFlags, wszId, wszURI, wszType,
        pDigestMethod, cTransform, rgTransform, phReference);
...
late final _CryptXmlCreateReference = _cryptxml.lookupFunction<
    ...
    int Function(
        ...
        int cTransform,
        Pointer<CRYPT_XML_ALGORITHM> rgTransform,
        Pointer<Pointer> phReference)>('CryptXmlCreateReference');

int CryptXmlDigestReference(Pointer hReference, int dwFlags,
        Pointer<CRYPT_XML_DATA_PROVIDER> pDataProviderIn) =>
    _CryptXmlDigestReference(hReference, dwFlags, pDataProviderIn);

late final _CryptXmlDigestReference = _cryptxml.lookupFunction<
        Int32 Function(Pointer hReference, Uint32 dwFlags,
            Pointer<CRYPT_XML_DATA_PROVIDER> pDataProviderIn),
        int Function(Pointer hReference, int dwFlags,
            Pointer<CRYPT_XML_DATA_PROVIDER> pDataProviderIn)>(
...
int CryptXmlEncode(
    ...
    _CryptXmlEncode(
        hCryptXml, dwCharset, rgProperty, cProperty, pvCallbackState, pfnWrite);
...
int CryptXmlEnumAlgorithmInfo(int dwGroupId, int dwFlags, Pointer pvArg,
        Pointer<NativeFunction<PFN_CRYPT_XML_ENUM_ALG_INFO>> pfnEnumAlgInfo) =>
    _CryptXmlEnumAlgorithmInfo(dwGroupId, dwFlags, pvArg, pfnEnumAlgInfo);
...
late final _CryptXmlEnumAlgorithmInfo = _cryptxml.lookupFunction<
    ...
    int Function(
        ...
        int dwFlags,
        Pointer pvArg,
        Pointer<NativeFunction<PFN_CRYPT_XML_ENUM_ALG_INFO>>
            pfnEnumAlgInfo)>('CryptXmlEnumAlgorithmInfo');

Pointer<CRYPT_XML_ALGORITHM_INFO> CryptXmlFindAlgorithmInfo(
        int dwFindByType, Pointer pvFindBy, int dwGroupId, int dwFlags) =>
    _CryptXmlFindAlgorithmInfo(dwFindByType, pvFindBy, dwGroupId, dwFlags);

late final _CryptXmlFindAlgorithmInfo = _cryptxml.lookupFunction<
    Pointer<CRYPT_XML_ALGORITHM_INFO> Function(Uint32 dwFindByType,
        Pointer pvFindBy, Uint32 dwGroupId, Uint32 dwFlags),
    Pointer<CRYPT_XML_ALGORITHM_INFO> Function(
        int dwFindByType,
        Pointer pvFindBy,
        int dwGroupId,
        int dwFlags)>('CryptXmlFindAlgorithmInfo');

int CryptXmlGetAlgorithmInfo(Pointer<CRYPT_XML_ALGORITHM> pXmlAlgorithm,
        int dwFlags, Pointer<Pointer<CRYPT_XML_ALGORITHM_INFO>> ppAlgInfo) =>
    _CryptXmlGetAlgorithmInfo(pXmlAlgorithm, dwFlags, ppAlgInfo);

late final _CryptXmlGetAlgorithmInfo = _cryptxml.lookupFunction<
    Int32 Function(Pointer<CRYPT_XML_ALGORITHM> pXmlAlgorithm, Uint32 dwFlags,
        Pointer<Pointer<CRYPT_XML_ALGORITHM_INFO>> ppAlgInfo),
    int Function(
        Pointer<CRYPT_XML_ALGORITHM> pXmlAlgorithm,
        int dwFlags,
        Pointer<Pointer<CRYPT_XML_ALGORITHM_INFO>>
            ppAlgInfo)>('CryptXmlGetAlgorithmInfo');

int CryptXmlGetDocContext(
        Pointer hCryptXml, Pointer<Pointer<CRYPT_XML_DOC_CTXT>> ppStruct) =>
    _CryptXmlGetDocContext(hCryptXml, ppStruct);
...
int CryptXmlGetReference(
        Pointer hCryptXml, Pointer<Pointer<CRYPT_XML_REFERENCE>> ppStruct) =>
    _CryptXmlGetReference(hCryptXml, ppStruct);
...
int CryptXmlGetSignature(
        Pointer hCryptXml, Pointer<Pointer<CRYPT_XML_SIGNATURE>> ppStruct) =>
    _CryptXmlGetSignature(hCryptXml, ppStruct);
...
int CryptXmlGetStatus(Pointer hCryptXml, Pointer<CRYPT_XML_STATUS> pStatus) =>
    _CryptXmlGetStatus(hCryptXml, pStatus);

late final _CryptXmlGetStatus = _cryptxml.lookupFunction<
    Int32 Function(Pointer hCryptXml, Pointer<CRYPT_XML_STATUS> pStatus),
    int Function(Pointer hCryptXml,
        Pointer<CRYPT_XML_STATUS> pStatus)>('CryptXmlGetStatus');

int CryptXmlGetTransforms(
        Pointer<Pointer<CRYPT_XML_TRANSFORM_CHAIN_CONFIG>> ppConfig) =>
    _CryptXmlGetTransforms(ppConfig);

late final _CryptXmlGetTransforms = _cryptxml.lookupFunction<
    Int32 Function(Pointer<Pointer<CRYPT_XML_TRANSFORM_CHAIN_CONFIG>> ppConfig),
    int Function(
        Pointer<Pointer<CRYPT_XML_TRANSFORM_CHAIN_CONFIG>>
            ppConfig)>('CryptXmlGetTransforms');

int CryptXmlImportPublicKey(int dwFlags, Pointer<CRYPT_XML_KEY_VALUE> pKeyValue,
        Pointer<IntPtr> phKey) =>
    _CryptXmlImportPublicKey(dwFlags, pKeyValue, phKey);

late final _CryptXmlImportPublicKey = _cryptxml.lookupFunction<
    Int32 Function(Uint32 dwFlags, Pointer<CRYPT_XML_KEY_VALUE> pKeyValue,
        Pointer<IntPtr> phKey),
    int Function(int dwFlags, Pointer<CRYPT_XML_KEY_VALUE> pKeyValue,
        Pointer<IntPtr> phKey)>('CryptXmlImportPublicKey');
...
int CryptXmlOpenToDecode(
    ...
    _CryptXmlOpenToDecode(
        pConfig, dwFlags, rgProperty, cProperty, pEncoded, phCryptXml);
...
late final _CryptXmlOpenToDecode = _cryptxml.lookupFunction<
    ...
    int Function(
        ...
        int cProperty,
        Pointer<CRYPT_XML_BLOB> pEncoded,
        Pointer<Pointer> phCryptXml)>('CryptXmlOpenToDecode');
...
int CryptXmlOpenToEncode(
    ...
    _CryptXmlOpenToEncode(
        pConfig, dwFlags, wszId, rgProperty, cProperty, pEncoded, phSignature);
...
late final _CryptXmlOpenToEncode = _cryptxml.lookupFunction<
    ...
    int Function(
        ...
        int cProperty,
        Pointer<CRYPT_XML_BLOB> pEncoded,
        Pointer<Pointer> phSignature)>('CryptXmlOpenToEncode');

int CryptXmlSetHMACSecret(
        Pointer hSignature, Pointer<Uint8> pbSecret, int cbSecret) =>
    _CryptXmlSetHMACSecret(hSignature, pbSecret, cbSecret);

late final _CryptXmlSetHMACSecret = _cryptxml.lookupFunction<
    Int32 Function(
        Pointer hSignature, Pointer<Uint8> pbSecret, Uint32 cbSecret),
    int Function(Pointer hSignature, Pointer<Uint8> pbSecret,
        int cbSecret)>('CryptXmlSetHMACSecret');
...
int CryptXmlSign(
    ...
    _CryptXmlSign(hSignature, hKey, dwKeySpec, dwFlags, dwKeyInfoSpec,
        pvKeyInfoSpec, pSignatureMethod, pCanonicalization);
...
late final _CryptXmlSign = _cryptxml.lookupFunction<
    ...
    int Function(
        ...
        Pointer pvKeyInfoSpec,
        Pointer<CRYPT_XML_ALGORITHM> pSignatureMethod,
        Pointer<CRYPT_XML_ALGORITHM> pCanonicalization)>('CryptXmlSign');

int CryptXmlVerifySignature(Pointer hSignature, int hKey, int dwFlags) =>
    _CryptXmlVerifySignature(hSignature, hKey, dwFlags);

late final _CryptXmlVerifySignature = _cryptxml.lookupFunction<
    Int32 Function(Pointer hSignature, IntPtr hKey, Uint32 dwFlags),
    int Function(
        Pointer hSignature, int hKey, int dwFlags)>('CryptXmlVerifySignature');
