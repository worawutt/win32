...
typedef CryptXmlDllCloseDigest = Int32 Function(Pointer hDigest);
...
typedef CryptXmlDllCreateKey = Int32 Function(
    Pointer<CRYPT_XML_BLOB> pEncoded, Pointer<IntPtr> phKey);
typedef CryptXmlDllDigestData = Int32 Function(
    Pointer hDigest, Pointer<Uint8> pbData, Uint32 cbData);
...
typedef CryptXmlDllFinalizeDigest = Int32 Function(
    Pointer hDigest, Pointer<Uint8> pbDigest, Uint32 cbDigest);
...
typedef PFNCryptStreamOutputCallback = Int32 Function(
    Pointer pvCallbackCtxt, Pointer<Uint8> pbData, IntPtr cbData, Int32 fFinal);
typedef PFNCryptStreamOutputCallbackEx = Int32 Function(Pointer pvCallbackCtxt,
    Pointer<Uint8> pbData, IntPtr cbData, IntPtr hDescriptor, Int32 fFinal);
typedef PFN_CANCEL_ASYNC_RETRIEVAL_FUNC = Int32 Function(IntPtr hAsyncRetrieve);
typedef PFN_CERT_CHAIN_FIND_BY_ISSUER_CALLBACK = Int32 Function(
    Pointer<CERT_CONTEXT> pCert, Pointer pvFindArg);
...
typedef PFN_CERT_STORE_PROV_CLOSE = Void Function(
    Pointer hStoreProv, Uint32 dwFlags);
typedef PFN_CERT_STORE_PROV_CONTROL = Int32 Function(
    Pointer hStoreProv, Uint32 dwFlags, Uint32 dwCtrlType, Pointer pvCtrlPara);
typedef PFN_CERT_STORE_PROV_DELETE_CERT = Int32 Function(
    Pointer hStoreProv, Pointer<CERT_CONTEXT> pCertContext, Uint32 dwFlags);
typedef PFN_CERT_STORE_PROV_DELETE_CRL = Int32 Function(
    Pointer hStoreProv, Pointer<CRL_CONTEXT> pCrlContext, Uint32 dwFlags);
typedef PFN_CERT_STORE_PROV_DELETE_CTL = Int32 Function(
    Pointer hStoreProv, Pointer<CTL_CONTEXT> pCtlContext, Uint32 dwFlags);
...
typedef PFN_CERT_STORE_PROV_WRITE_CTL = Int32 Function(
    Pointer hStoreProv, Pointer<CTL_CONTEXT> pCtlContext, Uint32 dwFlags);
typedef PFN_CMSG_ALLOC = Pointer Function(IntPtr cb);
...
typedef PFN_CMSG_EXPORT_MAIL_LIST = Int32 Function(
    ...
    Uint32 dwFlags,
    Pointer pvReserved);
typedef PFN_CMSG_FREE = Void Function(Pointer pv);
...
typedef PFN_CMSG_STREAM_OUTPUT = Int32 Function(
    Pointer pvArg, Pointer<Uint8> pbData, Uint32 cbData, Int32 fFinal);
typedef PFN_CRYPT_ALLOC = Pointer Function(IntPtr cbSize);
typedef PFN_CRYPT_ASYNC_PARAM_FREE_FUNC = Void Function(
    Pointer<Utf8> pszParamOid, Pointer pvParam);
...
typedef PFN_CRYPT_ENUM_OID_INFO = Int32 Function(
    Pointer<CRYPT_OID_INFO> pInfo, Pointer pvArg);
...
typedef PFN_CRYPT_EXPORT_PUBLIC_KEY_INFO_FROM_BCRYPT_HANDLE_FUNC
    = Int32 Function(
        IntPtr hBCryptKey,
        Uint32 dwCertEncodingType,
        Pointer<Utf8> pszPublicKeyObjId,
...
typedef PFN_CRYPT_FREE = Void Function(Pointer pv);
...
typedef PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FREE = Void Function(
    Pointer pPluginContext, Pointer<Uint8> pbData);
typedef PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FREE_IDENTIFIER = Void Function(
    Pointer pPluginContext, Pointer<CRYPTOAPI_BLOB> pIdentifier);
typedef PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FREE_PASSWORD = Void Function(
    Pointer pPluginContext, Pointer<Utf16> pwszPassword);
...
typedef PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_RELEASE = Void Function(
    Uint32 dwReason, Pointer pPluginContext);
...
typedef PFN_CRYPT_XML_ENUM_ALG_INFO = Int32 Function(
    Pointer<CRYPT_XML_ALGORITHM_INFO> pInfo, Pointer pvArg);
typedef PFN_CRYPT_XML_WRITE_CALLBACK = Int32 Function(
    Pointer pvCallbackState, Pointer<Uint8> pbData, Uint32 cbData);
...
typedef PFN_FREE_ENCODED_OBJECT_FUNC = Void Function(Pointer<Utf8> pszObjectOid,
    Pointer<CRYPT_BLOB_ARRAY> pObject, Pointer pvFreeContext);
...
typedef PFN_NCRYPT_ALLOC = Pointer Function(IntPtr cbSize);
typedef PFN_NCRYPT_FREE = Void Function(Pointer pv);
