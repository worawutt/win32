...
class ICertificateEnrollmentPolicyServerSetup extends IDispatch {
  ...
  int UnInstall(Pointer<VARIANT> pAuthKeyBasedRenewal) => ptr.ref.lpVtbl.value
          .elementAt(12)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<VARIANT> pAuthKeyBasedRenewal)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<VARIANT> pAuthKeyBasedRenewal)>()(
      ptr.ref.lpVtbl, pAuthKeyBasedRenewal);
}
