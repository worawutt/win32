...
class ICertificateEnrollmentServerSetup extends IDispatch {
  ...
  int GetProperty(int propertyId, Pointer<VARIANT> pPropertyValue) => ptr
          .ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
  ...
  int SetProperty(int propertyId, Pointer<VARIANT> pPropertyValue) => ptr
          .ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
  ...
  int UnInstall(Pointer<VARIANT> pCAConfig, Pointer<VARIANT> pAuthentication) =>
      ptr.ref.lpVtbl.value
              .elementAt(13)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<VARIANT> pCAConfig,
                              Pointer<VARIANT> pAuthentication)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<VARIANT> pCAConfig,
                      Pointer<VARIANT> pAuthentication)>()(
          ptr.ref.lpVtbl, pCAConfig, pAuthentication);
}
