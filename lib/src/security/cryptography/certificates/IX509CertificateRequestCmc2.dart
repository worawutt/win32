...
class IX509CertificateRequestCmc2 extends IX509CertificateRequestCmc {
  ...
  int InitializeFromTemplate(int context, Pointer<COMObject> pPolicyServer,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pPolicyServer,
                      Pointer<COMObject> pTemplate)>()(
          ptr.ref.lpVtbl, context, pPolicyServer, pTemplate);

  int InitializeFromInnerRequestTemplate(Pointer<COMObject> pInnerRequest,
          Pointer<COMObject> pPolicyServer, Pointer<COMObject> pTemplate) =>
      ptr.ref.lpVtbl.value
              .elementAt(64)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pPolicyServer,
                      Pointer<COMObject> pTemplate)>()(
          ptr.ref.lpVtbl, pInnerRequest, pPolicyServer, pTemplate);
  ...
  Pointer<COMObject> get PolicyServer {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppPolicyServer)>()(
  ...
  int CheckCertificateSignature(Pointer<COMObject> pSignerCertificate,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pSignerCertificate,
                      int ValidateCertificateChain)>()(
          ptr.ref.lpVtbl, pSignerCertificate, ValidateCertificateChain);
}
