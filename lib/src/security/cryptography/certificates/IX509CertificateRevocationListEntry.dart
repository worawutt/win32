...
class IX509CertificateRevocationListEntry extends IDispatch {
  ...
  int Initialize(
          int Encoding, Pointer<Utf16> SerialNumber, double RevocationDate) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int Encoding,
                      Pointer<Utf16> SerialNumber, double RevocationDate)>()(
          ptr.ref.lpVtbl, Encoding, SerialNumber, RevocationDate);
