...
class IX509AttributeRenewalCertificate extends IX509Attribute {
  ...
  int InitializeEncode(int Encoding, Pointer<Utf16> strCert) => ptr
          .ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Int32 Encoding, Pointer<Utf16> strCert)>>>()
          .value
          .asFunction<
              int Function(Pointer, int Encoding, Pointer<Utf16> strCert)>()(
      ptr.ref.lpVtbl, Encoding, strCert);
