...
class ICertView2 extends ICertView {
  ...
  int SetTable(int Table) => ptr.ref.lpVtbl.value
      .elementAt(15)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Uint32 Table)>>>()
      .value
      .asFunction<int Function(Pointer, int Table)>()(ptr.ref.lpVtbl, Table);
}
