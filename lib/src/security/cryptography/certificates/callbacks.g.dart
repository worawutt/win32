...
typedef FNCERTSRVBACKUPCLOSE = Int32 Function(Pointer hbc);
typedef FNCERTSRVBACKUPEND = Int32 Function(Pointer hbc);
typedef FNCERTSRVBACKUPFREE = Void Function(Pointer pv);
typedef FNCERTSRVBACKUPGETBACKUPLOGSW = Int32 Function(Pointer hbc,
    Pointer<Pointer<Uint16>> ppwszzBackupLogFiles, Pointer<Uint32> pcbSize);
...
typedef FNCERTSRVBACKUPGETDYNAMICFILELISTW = Int32 Function(Pointer hbc,
    Pointer<Pointer<Uint16>> ppwszzFileList, Pointer<Uint32> pcbSize);
...
typedef FNCERTSRVBACKUPPREPAREW = Int32 Function(Pointer<Utf16> pwszServerName,
    Uint32 grbitJet, Uint32 dwBackupFlags, Pointer<Pointer> phbc);
typedef FNCERTSRVBACKUPREAD = Int32 Function(
    Pointer hbc, Pointer pvBuffer, Uint32 cbBuffer, Pointer<Uint32> pcbRead);
typedef FNCERTSRVBACKUPTRUNCATELOGS = Int32 Function(Pointer hbc);
typedef FNCERTSRVISSERVERONLINEW = Int32 Function(
    Pointer<Utf16> pwszServerName, Pointer<Int32> pfServerOnline);
typedef FNCERTSRVRESTOREEND = Int32 Function(Pointer hbc);
typedef FNCERTSRVRESTOREGETDATABASELOCATIONSW = Int32 Function(
    Pointer hbc,
    Pointer<Pointer<Uint16>> ppwszzDatabaseLocationList,
    Pointer<Uint32> pcbSize);
typedef FNCERTSRVRESTOREPREPAREW = Int32 Function(Pointer<Utf16> pwszServerName,
    Uint32 dwRestoreFlags, Pointer<Pointer> phbc);
typedef FNCERTSRVRESTOREREGISTERCOMPLETE = Int32 Function(
    Pointer hbc, Int32 hrRestoreState);
...
typedef FNIMPORTPFXTOPROVIDERFREEDATA = Void Function(
    Uint32 cCert, Pointer<Pointer<CERT_CONTEXT>> rgpCert);
