...
class ICertRequestD extends IUnknown {
  ...
  int GetCACert(int fchain, Pointer<Utf16> pwszAuthority,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> pwszAuthority,
                      Pointer<CERTTRANSBLOB> pctbOut)>()(
          ptr.ref.lpVtbl, fchain, pwszAuthority, pctbOut);

  int Ping(Pointer<Utf16> pwszAuthority) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
