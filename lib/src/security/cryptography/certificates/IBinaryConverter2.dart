...
class IBinaryConverter2 extends IBinaryConverter {
  ...
  int
      StringArrayToVariantArray(Pointer<VARIANT> pvarStringArray,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<VARIANT> pvarStringArray,
                          Pointer<VARIANT> pvarVariantArray)>()(
              ptr.ref.lpVtbl, pvarStringArray, pvarVariantArray);

  int
      VariantArrayToStringArray(Pointer<VARIANT> pvarVariantArray,
              Pointer<VARIANT> pvarStringArray) =>
          ptr.ref.lpVtbl.value
                  .elementAt(11)
                  .cast<
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<VARIANT> pvarVariantArray,
                          Pointer<VARIANT> pvarStringArray)>()(
              ptr.ref.lpVtbl, pvarVariantArray, pvarStringArray);
}
