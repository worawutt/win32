...
class IX509CertificateRevocationListEntries extends IDispatch {
  ...
  int get_IndexBySerialNumber(
          int Encoding, Pointer<Utf16> SerialNumber, Pointer<Int32> pIndex) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int Encoding,
                      Pointer<Utf16> SerialNumber, Pointer<Int32> pIndex)>()(
          ptr.ref.lpVtbl, Encoding, SerialNumber, pIndex);

  int AddRange(Pointer<COMObject> pValue) => ptr.ref.lpVtbl.value
          .elementAt(14)
          .cast<
              Pointer<
                  NativeFunction<
