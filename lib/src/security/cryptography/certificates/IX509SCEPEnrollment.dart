...
class IX509SCEPEnrollment extends IDispatch {
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int ThumprintEncoding,
                      Pointer<Utf16> strServerCertificates,
                      int Encoding)>()(ptr.ref.lpVtbl, pRequest, strThumbprint,
          ThumprintEncoding, strServerCertificates, Encoding);

  int InitializeForPending(int Context) => ptr.ref.lpVtbl.value
      .elementAt(8)
  ...
  int CreateRequestMessage(int Encoding, Pointer<Pointer<Utf16>> pValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
                  Pointer<
  ...
  int CreateRetrievePendingMessage(
          int Encoding, Pointer<Pointer<Utf16>> pValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(10)
              .cast<
                  Pointer<
  ...
  int ProcessResponseMessage(Pointer<Utf16> strResponse, int Encoding,
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> strResponse,
                              Int32 Encoding, Pointer<Int32> pDisposition)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> strResponse,
                      int Encoding, Pointer<Int32> pDisposition)>()(
          ptr.ref.lpVtbl, strResponse, Encoding, pDisposition);
  ...
  int get_TransactionId(int Encoding, Pointer<Pointer<Utf16>> pValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(19)
              .cast<
                  Pointer<
  ...
  int put_TransactionId(int Encoding, Pointer<Utf16> Value) =>
      ptr.ref.lpVtbl.value
          .elementAt(20)
          .cast<
              Pointer<
