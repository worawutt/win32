...
class ICEnroll2 extends ICEnroll {
  ...
  int addCertTypeToRequest(Pointer<Utf16> CertType) => ptr.ref.lpVtbl.value
          .elementAt(63)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> CertType)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Utf16> CertType)>()(
      ptr.ref.lpVtbl, CertType);

  int addNameValuePairToSignature(Pointer<Utf16> Name, Pointer<Utf16> Value) =>
