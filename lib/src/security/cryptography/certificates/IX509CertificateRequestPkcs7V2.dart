...
class IX509CertificateRequestPkcs7V2 extends IX509CertificateRequestPkcs7 {
  ...
  int CheckCertificateSignature(int ValidateCertificateChain) =>
      ptr.ref.lpVtbl.value
              .elementAt(43)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Int16 ValidateCertificateChain)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int ValidateCertificateChain)>()(
          ptr.ref.lpVtbl, ValidateCertificateChain);
}
