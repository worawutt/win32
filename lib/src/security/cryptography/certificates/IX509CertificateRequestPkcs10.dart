...
class IX509CertificateRequestPkcs10 extends IX509CertificateRequest {
  ...
  int InitializeFromTemplateName(int Context, Pointer<Utf16> strTemplateName) =>
      ptr.ref.lpVtbl.value
              .elementAt(32)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 Context,
                              Pointer<Utf16> strTemplateName)>>>()
              .value
              .asFunction<
                  int Function(
                      Pointer, int Context, Pointer<Utf16> strTemplateName)>()(
          ptr.ref.lpVtbl, Context, strTemplateName);

  int InitializeFromPrivateKey(int Context, Pointer<COMObject> pPrivateKey,
          Pointer<Utf16> strTemplateName) =>
      ptr.ref.lpVtbl.value
              .elementAt(33)
              .cast<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pPrivateKey,
                      Pointer<Utf16> strTemplateName)>()(
          ptr.ref.lpVtbl, Context, pPrivateKey, strTemplateName);

  int InitializeFromPublicKey(int Context, Pointer<COMObject> pPublicKey,
          Pointer<Utf16> strTemplateName) =>
      ptr.ref.lpVtbl.value
              .elementAt(34)
              .cast<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pPublicKey,
                      Pointer<Utf16> strTemplateName)>()(
          ptr.ref.lpVtbl, Context, pPublicKey, strTemplateName);

  int InitializeFromCertificate(int Context, Pointer<Utf16> strCertificate,
          int Encoding, int InheritOptions) =>
      ptr.ref.lpVtbl.value
              .elementAt(35)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      int Encoding,
                      int InheritOptions)>()(
          ptr.ref.lpVtbl, Context, strCertificate, Encoding, InheritOptions);

  int InitializeDecode(Pointer<Utf16> strEncodedData, int Encoding) =>
      ptr.ref.lpVtbl.value
          .elementAt(36)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> strEncodedData,
                          Int32 Encoding)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Utf16> strEncodedData,
                  int Encoding)>()(ptr.ref.lpVtbl, strEncodedData, Encoding);

  int CheckSignature(int AllowedSignatureTypes) => ptr.ref.lpVtbl.value
          .elementAt(37)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 AllowedSignatureTypes)>>>()
          .value
          .asFunction<int Function(Pointer, int AllowedSignatureTypes)>()(
      ptr.ref.lpVtbl, AllowedSignatureTypes);

  int IsSmartCard(Pointer<Int16> pValue) => ptr.ref.lpVtbl.value
      .elementAt(38)
      .cast<
          Pointer<
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int16> pValue)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int16> pValue)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  int get_OldCertificate(int Encoding, Pointer<Pointer<Utf16>> pValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(44)
              .cast<
                  Pointer<
  ...
  set Subject(Pointer<COMObject> value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(Pointer, Pointer<COMObject> pValue)>>>()
            .value
            .asFunction<int Function(Pointer, Pointer<COMObject> pValue)>()(
        ptr.ref.lpVtbl, value);
  ...
  set KeyContainerNamePrefix(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .value
            .asFunction<int Function(Pointer, Pointer<Utf16> Value)>()(
        ptr.ref.lpVtbl, value);
  ...
  int get_RawDataToBeSigned(int Encoding, Pointer<Pointer<Utf16>> pValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(57)
              .cast<
                  Pointer<
  ...
  int get_Signature(int Encoding, Pointer<Pointer<Utf16>> pValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(58)
              .cast<
                  Pointer<
  ...
  int GetCspStatuses(int KeySpec, Pointer<Pointer<COMObject>> ppCspStatuses) =>
      ptr.ref.lpVtbl.value
              .elementAt(59)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 KeySpec,
                              Pointer<Pointer<COMObject>> ppCspStatuses)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int KeySpec,
                      Pointer<Pointer<COMObject>> ppCspStatuses)>()(
          ptr.ref.lpVtbl, KeySpec, ppCspStatuses);
}
