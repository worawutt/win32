...
class IX509CertificateRequest extends IDispatch {
  ...
  int GetInnerRequest(int Level, Pointer<Pointer<COMObject>> ppValue) => ptr
          .ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 Level,
                          Pointer<Pointer<COMObject>> ppValue)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer, int Level, Pointer<Pointer<COMObject>> ppValue)>()(
      ptr.ref.lpVtbl, Level, ppValue);
  ...
  int get_RenewalCertificate(int Encoding, Pointer<Pointer<Utf16>> pValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(21)
              .cast<
                  Pointer<
  ...
  int put_RenewalCertificate(int Encoding, Pointer<Utf16> Value) => ptr
          .ref.lpVtbl.value
          .elementAt(22)
          .cast<
              Pointer<
