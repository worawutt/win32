...
class IX509EnrollmentWebClassFactory extends IDispatch {
  ...
  int CreateObject(
          Pointer<Utf16> strProgID, Pointer<Pointer<COMObject>> ppIUnknown) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> strProgID,
                              Pointer<Pointer<COMObject>> ppIUnknown)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> strProgID,
                      Pointer<Pointer<COMObject>> ppIUnknown)>()(
          ptr.ref.lpVtbl, strProgID, ppIUnknown);
}
