...
class IX509AttributeOSVersion extends IX509Attribute {
  ...
  int InitializeEncode(Pointer<Utf16> strOSVersion) => ptr.ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> strOSVersion)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Utf16> strOSVersion)>()(
      ptr.ref.lpVtbl, strOSVersion);
