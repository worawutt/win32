...
class IX509AttributeExtensions extends IX509Attribute {
  ...
  int InitializeEncode(Pointer<COMObject> pExtensions) => ptr.ref.lpVtbl.value
      .elementAt(10)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> pExtensions)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<COMObject> pExtensions)>()(ptr.ref.lpVtbl, pExtensions);
