...
class ICertPropertyRenewal extends ICertProperty {
  ...
  int Initialize(int Encoding, Pointer<Utf16> strRenewalValue) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, int Encoding, Pointer<Utf16> strRenewalValue)>()(
          ptr.ref.lpVtbl, Encoding, strRenewalValue);

  int
      InitializeFromCertificateHash(int MachineContext, int Encoding,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, int MachineContext, int Encoding,
                          Pointer<Utf16> strCertificate)>()(
              ptr.ref.lpVtbl, MachineContext, Encoding, strCertificate);

  int get_Renewal(int Encoding, Pointer<Pointer<Utf16>> pValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(16)
              .cast<
                  Pointer<
