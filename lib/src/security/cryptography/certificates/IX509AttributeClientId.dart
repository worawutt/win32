...
class IX509AttributeClientId extends IX509Attribute {
  ...
  int InitializeEncode(int ClientId, Pointer<Utf16> strMachineDnsName,
          Pointer<Utf16> strUserSamName, Pointer<Utf16> strProcessName) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> strMachineDnsName,
                      Pointer<Utf16> strUserSamName,
                      Pointer<Utf16> strProcessName)>()(ptr.ref.lpVtbl,
          ClientId, strMachineDnsName, strUserSamName, strProcessName);
