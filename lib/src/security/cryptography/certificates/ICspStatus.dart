...
class ICspStatus extends IDispatch {
  ...
  int Initialize(Pointer<COMObject> pCsp, Pointer<COMObject> pAlgorithm) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<COMObject> pCsp,
                              Pointer<COMObject> pAlgorithm)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pCsp,
                      Pointer<COMObject> pAlgorithm)>()(
          ptr.ref.lpVtbl, pCsp, pAlgorithm);
