...
class ICertPropertyArchivedKeyHash extends ICertProperty {
  ...
  int Initialize(int Encoding, Pointer<Utf16> strArchivedKeyHashValue) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int Encoding,
                      Pointer<Utf16> strArchivedKeyHashValue)>()(
          ptr.ref.lpVtbl, Encoding, strArchivedKeyHashValue);

  int get_ArchivedKeyHash(int Encoding, Pointer<Pointer<Utf16>> pValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(15)
              .cast<
                  Pointer<
