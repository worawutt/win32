...
class ICertConfig2 extends ICertConfig {
  ...
  int SetSharedFolder(Pointer<Utf16> strSharedFolder) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Utf16> strSharedFolder)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> strSharedFolder)>()(
          ptr.ref.lpVtbl, strSharedFolder);
}
