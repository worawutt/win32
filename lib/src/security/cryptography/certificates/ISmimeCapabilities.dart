...
class ISmimeCapabilities extends IDispatch {
  ...
  int AddFromCsp(Pointer<COMObject> pValue) => ptr.ref.lpVtbl.value
          .elementAt(13)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int AddAvailableSmimeCapabilities(int MachineContext) => ptr.ref.lpVtbl.value
      .elementAt(14)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Int16 MachineContext)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int MachineContext)>()(ptr.ref.lpVtbl, MachineContext);
}
