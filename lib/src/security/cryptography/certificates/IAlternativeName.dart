...
class IAlternativeName extends IDispatch {
  ...
  int InitializeFromString(int Type, Pointer<Utf16> strValue) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Int32 Type, Pointer<Utf16> strValue)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int Type, Pointer<Utf16> strValue)>()(
          ptr.ref.lpVtbl, Type, strValue);

  int InitializeFromRawData(
          int Type, int Encoding, Pointer<Utf16> strRawData) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 Type, Int32 Encoding,
                              Pointer<Utf16> strRawData)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int Type, int Encoding,
                      Pointer<Utf16> strRawData)>()(
          ptr.ref.lpVtbl, Type, Encoding, strRawData);

  int InitializeFromOtherName(Pointer<COMObject> pObjectId, int Encoding,
          Pointer<Utf16> strRawData, int ToBeWrapped) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> strRawData,
                      int ToBeWrapped)>()(
          ptr.ref.lpVtbl, pObjectId, Encoding, strRawData, ToBeWrapped);
