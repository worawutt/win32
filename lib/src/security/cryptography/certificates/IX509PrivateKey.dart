...
class IX509PrivateKey extends IDispatch {
  ...
  int Verify(int VerifyType) => ptr.ref.lpVtbl.value
      .elementAt(11)
      .cast<
          Pointer<NativeFunction<Int32 Function(Pointer, Int32 VerifyType)>>>()
      .value
      .asFunction<
          int Function(Pointer, int VerifyType)>()(ptr.ref.lpVtbl, VerifyType);

  int Import(Pointer<Utf16> strExportType, Pointer<Utf16> strEncodedKey,
          int Encoding) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> strExportType,
                              Pointer<Utf16> strEncodedKey, Int32 Encoding)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> strExportType,
                      Pointer<Utf16> strEncodedKey, int Encoding)>()(
          ptr.ref.lpVtbl, strExportType, strEncodedKey, Encoding);

  int Export(Pointer<Utf16> strExportType, int Encoding,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> strExportType,
                      int Encoding, Pointer<Pointer<Utf16>> pstrEncodedKey)>()(
          ptr.ref.lpVtbl, strExportType, Encoding, pstrEncodedKey);

  int ExportPublicKey(Pointer<Pointer<COMObject>> ppPublicKey) => ptr
          .ref.lpVtbl.value
          .elementAt(14)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> ppPublicKey)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> ppPublicKey)>()(
      ptr.ref.lpVtbl, ppPublicKey);
  ...
  int put_Certificate(int Encoding, Pointer<Utf16> Value) =>
      ptr.ref.lpVtbl.value
          .elementAt(48)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Int32 Encoding, Pointer<Utf16> Value)>>>()
          .value
          .asFunction<
              int Function(Pointer, int Encoding,
                  Pointer<Utf16> Value)>()(ptr.ref.lpVtbl, Encoding, Value);
