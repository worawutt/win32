...
class ICertProperty extends IDispatch {
  ...
  int
      InitializeFromCertificate(int MachineContext, int Encoding,
  ...
  int
      RemoveFromCertificate(int MachineContext, int Encoding,
              Pointer<Utf16> strCertificate) =>
          ptr.ref.lpVtbl.value
                  .elementAt(12)
                  .cast<
  ...
  int
      SetValueOnCertificate(int MachineContext, int Encoding,
              Pointer<Utf16> strCertificate) =>
          ptr.ref.lpVtbl.value
                  .elementAt(13)
                  .cast<
