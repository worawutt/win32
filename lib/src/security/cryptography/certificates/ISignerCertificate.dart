...
class ISignerCertificate extends IDispatch {
  ...
  int Initialize(int MachineContext, int VerifyType, int Encoding,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int MachineContext, int VerifyType,
                      int Encoding, Pointer<Utf16> strCertificate)>()(
          ptr.ref.lpVtbl, MachineContext, VerifyType, Encoding, strCertificate);
