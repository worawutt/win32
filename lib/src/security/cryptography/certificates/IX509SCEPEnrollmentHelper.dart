      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> strRequestHeaders,
                      int Context,
                      Pointer<Utf16> strTransactionId)>()(ptr.ref.lpVtbl,
          strServerUrl, strRequestHeaders, Context, strTransactionId);

  int Enroll(int ProcessFlags, Pointer<Int32> pDisposition) => ptr
          .ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 ProcessFlags,
                          Pointer<Int32> pDisposition)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer, int ProcessFlags, Pointer<Int32> pDisposition)>()(
      ptr.ref.lpVtbl, ProcessFlags, pDisposition);

  int FetchPending(int ProcessFlags, Pointer<Int32> pDisposition) => ptr
          .ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
