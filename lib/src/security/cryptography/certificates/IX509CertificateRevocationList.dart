...
class IX509CertificateRevocationList extends IDispatch {
  ...
  int CheckPublicKeySignature(Pointer<COMObject> pPublicKey) => ptr
      .ref.lpVtbl.value
      .elementAt(11)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> pPublicKey)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<COMObject> pPublicKey)>()(ptr.ref.lpVtbl, pPublicKey);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Double> pValue)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Double> pValue)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set ThisUpdate(double value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(16)
        .cast<Pointer<NativeFunction<Int32 Function(Pointer, Double Value)>>>()
        .value
        .asFunction<
  ...
  int get_CRLNumber(int Encoding, Pointer<Pointer<Utf16>> pValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(24)
              .cast<
                  Pointer<
  ...
  int put_CRLNumber(int Encoding, Pointer<Utf16> Value) => ptr.ref.lpVtbl.value
          .elementAt(25)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .value
          .asFunction<
              int Function(Pointer, int Encoding, Pointer<Utf16> Value)>()(
      ptr.ref.lpVtbl, Encoding, Value);
  ...
  set CAVersion(int value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(27)
        .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 pValue)>>>()
        .value
        .asFunction<int Function(Pointer, int pValue)>()(ptr.ref.lpVtbl, value);
