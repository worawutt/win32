...
class IX509EnrollmentStatus extends IDispatch {
  ...
  int AppendText(Pointer<Utf16> strText) => ptr.ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> strText)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Utf16> strText)>()(
      ptr.ref.lpVtbl, strText);
