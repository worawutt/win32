...
class IX509PolicyServerListManager extends IDispatch {
  ...
  int Initialize(int context, int Flags) => ptr.ref.lpVtbl.value
          .elementAt(13)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 context, Int32 Flags)>>>()
          .value
          .asFunction<int Function(Pointer, int context, int Flags)>()(
      ptr.ref.lpVtbl, context, Flags);
}
