...
class IPolicyQualifier extends IDispatch {
  ...
  int InitializeEncode(Pointer<Utf16> strQualifier, int Type) =>
      ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Utf16> strQualifier, Int32 Type)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Utf16> strQualifier,
                  int Type)>()(ptr.ref.lpVtbl, strQualifier, Type);
