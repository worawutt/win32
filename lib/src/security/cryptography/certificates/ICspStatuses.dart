...
class ICspStatuses extends IDispatch {
  ...
  int get_ItemByName(Pointer<Utf16> strCspName, Pointer<Utf16> strAlgorithmName,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> strAlgorithmName,
                      Pointer<Pointer<COMObject>> ppValue)>()(
          ptr.ref.lpVtbl, strCspName, strAlgorithmName, ppValue);

  int get_ItemByOrdinal(int Ordinal, Pointer<Pointer<COMObject>> ppValue) => ptr
          .ref.lpVtbl.value
          .elementAt(14)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 Ordinal,
                          Pointer<Pointer<COMObject>> ppValue)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer, int Ordinal, Pointer<Pointer<COMObject>> ppValue)>()(
      ptr.ref.lpVtbl, Ordinal, ppValue);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int Operations,
                      Pointer<Pointer<COMObject>> ppValue)>()(
          ptr.ref.lpVtbl, strCspName, strAlgorithmName, Operations, ppValue);

  int get_ItemByProvider(
          Pointer<COMObject> pCspStatus, Pointer<Pointer<COMObject>> ppValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(16)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<COMObject> pCspStatus,
                              Pointer<Pointer<COMObject>> ppValue)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pCspStatus,
                      Pointer<Pointer<COMObject>> ppValue)>()(
          ptr.ref.lpVtbl, pCspStatus, ppValue);
}
