...
class IX509AttributeArchiveKeyHash extends IX509Attribute {
  ...
  int InitializeEncodeFromEncryptedKeyBlob(
          int Encoding, Pointer<Utf16> strEncryptedKeyBlob) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int Encoding,
                      Pointer<Utf16> strEncryptedKeyBlob)>()(
          ptr.ref.lpVtbl, Encoding, strEncryptedKeyBlob);
  ...
  int get_EncryptedKeyHashBlob(int Encoding, Pointer<Pointer<Utf16>> pValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(12)
              .cast<
                  Pointer<
