...
class ICertPropertyFriendlyName extends ICertProperty {
  ...
  int Initialize(Pointer<Utf16> strFriendlyName) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Utf16> strFriendlyName)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> strFriendlyName)>()(
          ptr.ref.lpVtbl, strFriendlyName);
