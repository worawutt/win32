...
class IX509EnrollmentHelper extends IDispatch {
  ...
  int AddEnrollmentServer(Pointer<Utf16> strEnrollmentServerURI, int authFlags,
          Pointer<Utf16> strCredential, Pointer<Utf16> strPassword) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      int authFlags,
                      Pointer<Utf16> strCredential,
                      Pointer<Utf16> strPassword)>()(ptr.ref.lpVtbl,
          strEnrollmentServerURI, authFlags, strCredential, strPassword);
