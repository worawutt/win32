...
class ICspInformations extends IDispatch {
  ...
  int get_ItemByName(Pointer<Utf16> strName,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> strName,
                      Pointer<Pointer<COMObject>> ppCspInformation)>()(
          ptr.ref.lpVtbl, strName, ppCspInformation);

  int GetCspStatusFromProviderName(Pointer<Utf16> strProviderName,
          int LegacyKeySpec, Pointer<Pointer<COMObject>> ppValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(15)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      int LegacyKeySpec,
                      Pointer<Pointer<COMObject>> ppValue)>()(
          ptr.ref.lpVtbl, strProviderName, LegacyKeySpec, ppValue);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pCspInformation,
                      Pointer<Pointer<COMObject>> ppValue)>()(
          ptr.ref.lpVtbl, Operations, pCspInformation, ppValue);

  int GetEncryptionCspAlgorithms(Pointer<COMObject> pCspInformation,
          Pointer<Pointer<COMObject>> ppValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(17)
              .cast<
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pCspInformation,
                      Pointer<Pointer<COMObject>> ppValue)>()(
          ptr.ref.lpVtbl, pCspInformation, ppValue);

  int GetHashAlgorithms(Pointer<COMObject> pCspInformation,
          Pointer<Pointer<COMObject>> ppValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(18)
              .cast<
