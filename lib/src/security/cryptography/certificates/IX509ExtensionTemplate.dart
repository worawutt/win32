...
class IX509ExtensionTemplate extends IX509Extension {
  ...
  int
      InitializeEncode(Pointer<COMObject> pTemplateOid, int MajorVersion,
              int MinorVersion) =>
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<COMObject> pTemplateOid,
                          int MajorVersion, int MinorVersion)>()(
              ptr.ref.lpVtbl, pTemplateOid, MajorVersion, MinorVersion);
