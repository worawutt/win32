...
class ICertRequestD2 extends ICertRequestD {
  ...
  int GetCAProperty(Pointer<Utf16> pwszAuthority, int PropId, int PropIndex,
          int PropType, Pointer<CERTTRANSBLOB> pctbPropertyValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
  ...
  int GetCAPropertyInfo(Pointer<Utf16> pwszAuthority, Pointer<Int32> pcProperty,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Int32> pcProperty,
                      Pointer<CERTTRANSBLOB> pctbPropInfo)>()(
          ptr.ref.lpVtbl, pwszAuthority, pcProperty, pctbPropInfo);

  int Ping2(Pointer<Utf16> pwszAuthority) => ptr.ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> pwszAuthority)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Utf16> pwszAuthority)>()(
      ptr.ref.lpVtbl, pwszAuthority);
}
