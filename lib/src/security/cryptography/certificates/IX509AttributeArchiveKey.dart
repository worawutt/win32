...
class IX509AttributeArchiveKey extends IX509Attribute {
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> strCAXCert,
                      Pointer<COMObject> pAlgorithm,
                      int EncryptionStrength)>()(ptr.ref.lpVtbl, pKey, Encoding,
          strCAXCert, pAlgorithm, EncryptionStrength);
  ...
  int get_EncryptedKeyBlob(int Encoding, Pointer<Pointer<Utf16>> pValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(12)
              .cast<
                  Pointer<
