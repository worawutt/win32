...
class IX509ExtensionBasicConstraints extends IX509Extension {
  ...
  int InitializeEncode(int IsCA, int PathLenConstraint) => ptr.ref.lpVtbl.value
          .elementAt(12)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Int16 IsCA, Int32 PathLenConstraint)>>>()
          .value
          .asFunction<int Function(Pointer, int IsCA, int PathLenConstraint)>()(
      ptr.ref.lpVtbl, IsCA, PathLenConstraint);
