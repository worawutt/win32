...
class ICryptAttribute extends IDispatch {
  ...
  int InitializeFromObjectId(Pointer<COMObject> pObjectId) => ptr
          .ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pObjectId)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> pObjectId)>()(
      ptr.ref.lpVtbl, pObjectId);

  int InitializeFromValues(Pointer<COMObject> pAttributes) => ptr
      .ref.lpVtbl.value
      .elementAt(8)
      .cast<
          Pointer<
