...
int CertSelectionGetSerializedBlob(Pointer<CERT_SELECTUI_INPUT> pcsi,
        Pointer<Pointer> ppOutBuffer, Pointer<Uint32> pulOutBufferSize) =>
    _CertSelectionGetSerializedBlob(pcsi, ppOutBuffer, pulOutBufferSize);

late final _CertSelectionGetSerializedBlob = _cryptui.lookupFunction<
    Int32 Function(Pointer<CERT_SELECTUI_INPUT> pcsi,
        Pointer<Pointer> ppOutBuffer, Pointer<Uint32> pulOutBufferSize),
    int Function(
        Pointer<CERT_SELECTUI_INPUT> pcsi,
        Pointer<Pointer> ppOutBuffer,
        Pointer<Uint32> pulOutBufferSize)>('CertSelectionGetSerializedBlob');

int CryptUIDlgCertMgr(Pointer<CRYPTUI_CERT_MGR_STRUCT> pCryptUICertMgr) =>
    _CryptUIDlgCertMgr(pCryptUICertMgr);

late final _CryptUIDlgCertMgr = _cryptui.lookupFunction<
    Int32 Function(Pointer<CRYPTUI_CERT_MGR_STRUCT> pCryptUICertMgr),
    int Function(
        Pointer<CRYPTUI_CERT_MGR_STRUCT> pCryptUICertMgr)>('CryptUIDlgCertMgr');
...
Pointer<CERT_CONTEXT> CryptUIDlgSelectCertificateFromStore(
        ...
        int dwFlags,
        Pointer pvReserved) =>
    _CryptUIDlgSelectCertificateFromStore(hCertStore, hwnd, pwszTitle,
...
late final _CryptUIDlgSelectCertificateFromStore = _cryptui.lookupFunction<
    ...
    Pointer<CERT_CONTEXT> Function(
        ...
        int dwDontUseColumn,
        int dwFlags,
        Pointer pvReserved)>('CryptUIDlgSelectCertificateFromStore');

int CryptUIDlgViewCertificate(
        Pointer<CRYPTUI_VIEWCERTIFICATE_STRUCT> pCertViewInfo,
        Pointer<Int32> pfPropertiesChanged) =>
    _CryptUIDlgViewCertificate(pCertViewInfo, pfPropertiesChanged);

late final _CryptUIDlgViewCertificate = _cryptui.lookupFunction<
    Int32 Function(Pointer<CRYPTUI_VIEWCERTIFICATE_STRUCT> pCertViewInfo,
        Pointer<Int32> pfPropertiesChanged),
    int Function(Pointer<CRYPTUI_VIEWCERTIFICATE_STRUCT> pCertViewInfo,
        Pointer<Int32> pfPropertiesChanged)>('CryptUIDlgViewCertificateW');

int CryptUIDlgViewContext(int dwContextType, Pointer pvContext, int hwnd,
        Pointer<Utf16> pwszTitle, int dwFlags, Pointer pvReserved) =>
...
late final _CryptUIDlgViewContext = _cryptui.lookupFunction<
    Int32 Function(Uint32 dwContextType, Pointer pvContext, IntPtr hwnd,
        Pointer<Utf16> pwszTitle, Uint32 dwFlags, Pointer pvReserved),
    int Function(
        int dwContextType,
        Pointer pvContext,
        int hwnd,
        Pointer<Utf16> pwszTitle,
        int dwFlags,
        Pointer pvReserved)>('CryptUIDlgViewContext');
...
int CryptUIWizDigitalSign(
    ...
    _CryptUIWizDigitalSign(
        dwFlags, hwndParent, pwszWizardTitle, pDigitalSignInfo, ppSignContext);
...
int CryptUIWizExport(
        ...
        Pointer pvoid) =>
    _CryptUIWizExport(dwFlags, hwndParent, pwszWizardTitle, pExportInfo, pvoid);
...
late final _CryptUIWizExport = _cryptui.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Utf16> pwszWizardTitle,
        Pointer<CRYPTUI_WIZ_EXPORT_INFO> pExportInfo,
        Pointer pvoid)>('CryptUIWizExport');

int CryptUIWizFreeDigitalSignContext(
        Pointer<CRYPTUI_WIZ_DIGITAL_SIGN_CONTEXT> pSignContext) =>
    _CryptUIWizFreeDigitalSignContext(pSignContext);

late final _CryptUIWizFreeDigitalSignContext = _cryptui.lookupFunction<
        Int32 Function(Pointer<CRYPTUI_WIZ_DIGITAL_SIGN_CONTEXT> pSignContext),
        int Function(Pointer<CRYPTUI_WIZ_DIGITAL_SIGN_CONTEXT> pSignContext)>(
...
late final _CryptUIWizImport = _cryptui.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Utf16> pwszWizardTitle,
        Pointer<CRYPTUI_WIZ_IMPORT_SRC_INFO> pImportSrc,
        Pointer hDestCertStore)>('CryptUIWizImport');
