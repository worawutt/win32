...
class ICertSrvSetupKeyInformationCollection extends IDispatch {
  ...
  int Add(Pointer<COMObject> pIKeyInformation) => ptr.ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<COMObject> pIKeyInformation)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> pIKeyInformation)>()(
      ptr.ref.lpVtbl, pIKeyInformation);
}
