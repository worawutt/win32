...
typedef APPLY_CONTROL_TOKEN_FN = Int32 Function(
    Pointer<SecHandle> param0, Pointer<SecBufferDesc> param1);
...
typedef CredFreeCredentialsFn = Void Function(
    Uint32 Count, Pointer<Pointer<ENCRYPTED_CREDENTIAL>> Credentials);
...
typedef CredWriteFn = Int32 Function(Pointer<LUID> LogonId, Uint32 CredFlags,
    Pointer<ENCRYPTED_CREDENTIAL> Credential, Uint32 Flags);
...
typedef DECRYPT_MESSAGE_FN = Int32 Function(Pointer<SecHandle> param0,
    Pointer<SecBufferDesc> param1, Uint32 param2, Pointer<Uint32> param3);
typedef DELETE_SECURITY_CONTEXT_FN = Int32 Function(Pointer<SecHandle> param0);
typedef ENCRYPT_MESSAGE_FN = Int32 Function(Pointer<SecHandle> param0,
    Uint32 param1, Pointer<SecBufferDesc> param2, Uint32 param3);
typedef ENUMERATE_SECURITY_PACKAGES_FN_W = Int32 Function(
    Pointer<Uint32> param0, Pointer<Pointer<SecPkgInfo>> param1);
typedef EXPORT_SECURITY_CONTEXT_FN = Int32 Function(Pointer<SecHandle> param0,
    Uint32 param1, Pointer<SecBuffer> param2, Pointer<Pointer> param3);
typedef FREE_CONTEXT_BUFFER_FN = Int32 Function(Pointer param0);
typedef FREE_CREDENTIALS_HANDLE_FN = Int32 Function(Pointer<SecHandle> param0);
typedef IMPERSONATE_SECURITY_CONTEXT_FN = Int32 Function(
    Pointer<SecHandle> param0);
typedef IMPORT_SECURITY_CONTEXT_FN_W = Int32 Function(Pointer<Uint16> param0,
    Pointer<SecBuffer> param1, Pointer param2, Pointer<SecHandle> param3);
...
typedef KspCompleteTokenFn = Int32 Function(
    IntPtr ContextId, Pointer<SecBufferDesc> Token);
typedef KspDeleteContextFn = Int32 Function(
    IntPtr ContextId, Pointer<IntPtr> LsaContextId);
typedef KspGetTokenFn = Int32 Function(IntPtr ContextId,
    Pointer<IntPtr> ImpersonationToken, Pointer<Pointer> RawToken);
typedef KspInitContextFn = Int32 Function(IntPtr ContextId,
    Pointer<SecBuffer> ContextData, Pointer<IntPtr> NewContextId);
typedef KspInitPackageFn = Int32 Function(
    Pointer<SECPKG_KERNEL_FUNCTIONS> FunctionTable);
typedef KspMakeSignatureFn = Int32 Function(IntPtr ContextId, Uint32 fQOP,
    Pointer<SecBufferDesc> Message, Uint32 MessageSeqNo);
typedef KspMapHandleFn = Int32 Function(
    IntPtr ContextId, Pointer<IntPtr> LsaContextId);
typedef KspQueryAttributesFn = Int32 Function(
    IntPtr ContextId, Uint32 Attribute, Pointer Buffer);
typedef KspSealMessageFn = Int32 Function(IntPtr ContextId, Uint32 fQOP,
    Pointer<SecBufferDesc> Message, Uint32 MessageSeqNo);
typedef KspSerializeAuthDataFn = Int32 Function(
    Pointer pvAuthData, Pointer<Uint32> Size, Pointer<Pointer> SerializedData);
typedef KspSetPagingModeFn = Int32 Function(Uint8 PagingMode);
typedef KspUnsealMessageFn = Int32 Function(IntPtr ContextId,
    Pointer<SecBufferDesc> Message, Uint32 MessageSeqNo, Pointer<Uint32> pfQOP);
typedef KspVerifySignatureFn = Int32 Function(IntPtr ContextId,
    Pointer<SecBufferDesc> Message, Uint32 MessageSeqNo, Pointer<Uint32> pfQOP);
typedef LSA_AP_POST_LOGON_USER = Int32 Function(
    Pointer<SECPKG_POST_LOGON_USER_INFO> PostLogonUserInfo);
typedef MAKE_SIGNATURE_FN = Int32 Function(Pointer<SecHandle> param0,
    Uint32 param1, Pointer<SecBufferDesc> param2, Uint32 param3);
typedef PKSEC_CREATE_CONTEXT_LIST = Pointer Function(Int32 Type);
typedef PKSEC_DEREFERENCE_LIST_ENTRY = Void Function(
    Pointer<KSEC_LIST_ENTRY> Entry, Pointer<Uint8> Delete);
typedef PKSEC_INSERT_LIST_ENTRY = Void Function(
    Pointer $List, Pointer<KSEC_LIST_ENTRY> Entry);
typedef PKSEC_LOCATE_PKG_BY_ID = Pointer Function(Uint32 PackageId);
typedef PKSEC_REFERENCE_LIST_ENTRY = Int32 Function(
    Pointer<KSEC_LIST_ENTRY> Entry, Uint32 Signature, Uint8 RemoveNoRef);
...
typedef PLSA_ALLOCATE_LSA_HEAP = Pointer Function(Uint32 Length);
typedef PLSA_ALLOCATE_PRIVATE_HEAP = Pointer Function(IntPtr Length);
typedef PLSA_ALLOCATE_SHARED_MEMORY = Pointer Function(
    Pointer SharedMem, Uint32 Size);
...
typedef PLSA_AP_LOGON_TERMINATED = Void Function(Pointer<LUID> LogonId);
...
typedef PLSA_CALL_PACKAGE_PASSTHROUGH = Int32 Function(
    ...
    Pointer<Uint32> ReturnBufferLength,
    Pointer<Int32> ProtocolStatus);
typedef PLSA_CANCEL_NOTIFICATION = Int32 Function(IntPtr NotifyHandle);
typedef PLSA_CHECK_PROTECTED_USER_BY_TOKEN = Int32 Function(
    IntPtr UserToken, Pointer<Uint8> ProtectedUser);
...
typedef PLSA_CLOSE_SAM_USER = Int32 Function(Pointer UserHandle);
...
typedef PLSA_CREATE_LOGON_SESSION = Int32 Function(Pointer<LUID> LogonId);
typedef PLSA_CREATE_SHARED_MEMORY = Pointer Function(
    Uint32 MaxSize, Uint32 InitialSize);
...
typedef PLSA_CREATE_TOKEN_EX = Int32 Function(
    ...
    Pointer<IntPtr> Token,
    Pointer<Int32> SubStatus);
typedef PLSA_DELETE_CREDENTIAL = Int32 Function(Pointer<LUID> LogonId,
    Uint32 AuthenticationPackage, Pointer<STRING> PrimaryKeyValue);
typedef PLSA_DELETE_LOGON_SESSION = Int32 Function(Pointer<LUID> LogonId);
typedef PLSA_DELETE_SHARED_MEMORY = Uint8 Function(Pointer SharedMem);
typedef PLSA_DUPLICATE_HANDLE = Int32 Function(
    IntPtr SourceHandle, Pointer<IntPtr> DestionationHandle);
...
typedef PLSA_FREE_CLIENT_BUFFER = Int32 Function(
    Pointer<Pointer> ClientRequest, Pointer ClientBaseAddress);
typedef PLSA_FREE_LSA_HEAP = Void Function(Pointer Base);
typedef PLSA_FREE_PRIVATE_HEAP = Void Function(Pointer Base);
typedef PLSA_FREE_SHARED_MEMORY = Void Function(
    Pointer SharedMem, Pointer Memory);
...
typedef PLSA_GET_CALL_INFO = Uint8 Function(Pointer<SECPKG_CALL_INFO> Info);
...
typedef PLSA_GET_CREDENTIALS = Int32 Function(
    ...
    Pointer<STRING> Credentials);
typedef PLSA_GET_EXTENDED_CALL_FLAGS = Int32 Function(Pointer<Uint32> Flags);
...
typedef PLSA_GET_USER_AUTH_DATA = Int32 Function(Pointer UserHandle,
    Pointer<Pointer<Uint8>> UserAuthData, Pointer<Uint32> UserAuthDataSize);
...
typedef PLSA_LOCATE_PKG_BY_ID = Pointer Function(Uint32 PackgeId);
typedef PLSA_MAP_BUFFER = Int32 Function(
    Pointer<SecBuffer> InputBuffer, Pointer<SecBuffer> OutputBuffer);
...
typedef PLSA_OPEN_TOKEN_BY_LOGON_ID = Int32 Function(
    Pointer<LUID> LogonId, Pointer<IntPtr> RetTokenHandle);
typedef PLSA_PROTECT_MEMORY = Void Function(Pointer Buffer, Uint32 BufferSize);
...
typedef PLSA_REDIRECTED_LOGON_INIT = Int32 Function(
    ...
    Uint32 SessionId,
    Pointer<LUID> LogonId);
typedef PLSA_REGISTER_CALLBACK = Int32 Function(Uint32 CallbackId,
...
typedef PSAM_CREDENTIAL_UPDATE_FREE_ROUTINE = Void Function(Pointer p);
...
typedef PSAM_CREDENTIAL_UPDATE_REGISTER_MAPPED_ENTRYPOINTS_ROUTINE = Int32
    Function(Pointer<SAM_REGISTER_MAPPING_TABLE> Table);
...
typedef QUERY_CONTEXT_ATTRIBUTES_EX_FN_W = Int32 Function(
    Pointer<SecHandle> param0, Uint32 param1, Pointer param2, Uint32 param3);
typedef QUERY_CONTEXT_ATTRIBUTES_FN_W = Int32 Function(
    Pointer<SecHandle> param0, Uint32 param1, Pointer param2);
...
typedef QUERY_SECURITY_CONTEXT_TOKEN_FN = Int32 Function(
    Pointer<SecHandle> param0, Pointer<Pointer> param1);
typedef QUERY_SECURITY_PACKAGE_INFO_FN_W = Int32 Function(
    Pointer<Uint16> param0, Pointer<Pointer<SecPkgInfo>> param1);
typedef REVERT_SECURITY_CONTEXT_FN = Int32 Function(Pointer<SecHandle> param0);
typedef SEC_GET_KEY_FN = Void Function(Pointer Arg, Pointer Principal,
    Uint32 KeyVer, Pointer<Pointer> Key, Pointer<Int32> Status);
...
typedef SSL_EMPTY_CACHE_FN_W = Int32 Function(
    Pointer<Utf16> pszTargetName, Uint32 dwFlags);
...
typedef SpApplyControlTokenFn = Int32 Function(
    IntPtr ContextHandle, Pointer<SecBufferDesc> ControlToken);
...
typedef SpCompleteAuthTokenFn = Int32 Function(
    IntPtr ContextHandle, Pointer<SecBufferDesc> InputBuffer);
typedef SpDeleteContextFn = Int32 Function(IntPtr ContextHandle);
typedef SpDeleteCredentialsFn = Int32 Function(
    IntPtr CredentialHandle, Pointer<SecBuffer> Key);
...
typedef SpExportSecurityContextFn = Int32 Function(IntPtr phContext,
    Uint32 fFlags, Pointer<SecBuffer> pPackedContext, Pointer<IntPtr> pToken);
typedef SpFormatCredentialsFn = Int32 Function(
    Pointer<SecBuffer> Credentials, Pointer<SecBuffer> FormattedCredentials);
typedef SpFreeCredentialsHandleFn = Int32 Function(IntPtr CredentialHandle);
typedef SpGetContextTokenFn = Int32 Function(
    IntPtr ContextHandle, Pointer<IntPtr> ImpersonationToken);
...
typedef SpGetCredentialsFn = Int32 Function(
    IntPtr CredentialHandle, Pointer<SecBuffer> Credentials);
typedef SpGetExtendedInformationFn = Int32 Function(
    Int32 Class, Pointer<Pointer<SECPKG_EXTENDED_INFORMATION>> ppInformation);
typedef SpGetInfoFn = Int32 Function(Pointer<SecPkgInfo> PackageInfo);
...
typedef SpGetRemoteCredGuardSupplementalCredsFn = Int32 Function(
    ...
    Pointer<Uint32> SupplementalCredsSize,
    Pointer<Pointer> SupplementalCreds);
typedef SpGetTbalSupplementalCredsFn = Int32 Function(LUID LogonId,
    Pointer<Uint32> SupplementalCredsSize, Pointer<Pointer> SupplementalCreds);
typedef SpGetUserInfoFn = Int32 Function(Pointer<LUID> LogonId, Uint32 Flags,
    Pointer<Pointer<SECURITY_USER_DATA>> UserData);
typedef SpImportSecurityContextFn = Int32 Function(
    Pointer<SecBuffer> pPackedContext, IntPtr Token, Pointer<IntPtr> phContext);
...
typedef SpInitUserModeContextFn = Int32 Function(
    IntPtr ContextHandle, Pointer<SecBuffer> PackedContext);
...
typedef SpQueryContextAttributesFn = Int32 Function(
    IntPtr ContextHandle, Uint32 ContextAttribute, Pointer Buffer);
typedef SpQueryCredentialsAttributesFn = Int32 Function(
    IntPtr CredentialHandle, Uint32 CredentialAttribute, Pointer Buffer);
...
typedef SpSealMessageFn = Int32 Function(
    ...
    Pointer<SecBufferDesc> MessageBuffers,
    Uint32 MessageSequenceNumber);
typedef SpSetContextAttributesFn = Int32 Function(IntPtr ContextHandle,
    Uint32 ContextAttribute, Pointer Buffer, Uint32 BufferSize);
typedef SpSetCredentialsAttributesFn = Int32 Function(IntPtr CredentialHandle,
    Uint32 CredentialAttribute, Pointer Buffer, Uint32 BufferSize);
typedef SpSetExtendedInformationFn = Int32 Function(
    Int32 Class, Pointer<SECPKG_EXTENDED_INFORMATION> Info);
...
typedef SslGetServerIdentityFn = Int32 Function(
    ...
    Uint32 Flags);
typedef VERIFY_SIGNATURE_FN = Int32 Function(Pointer<SecHandle> param0,
    Pointer<SecBufferDesc> param1, Uint32 param2, Pointer<Uint32> param3);
