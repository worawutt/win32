...
class IAssociatedIdentityProvider extends IUnknown {
  ...
  int AssociateIdentity(
          int hwndParent, Pointer<Pointer<COMObject>> ppPropertyStore) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int hwndParent,
                      Pointer<Pointer<COMObject>> ppPropertyStore)>()(
          ptr.ref.lpVtbl, hwndParent, ppPropertyStore);

  int DisassociateIdentity(int hwndParent, Pointer<Utf16> lpszUniqueID) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
  ...
  int ChangeCredential(int hwndParent, Pointer<Utf16> lpszUniqueID) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
