...
class AsyncIIdentityAuthentication extends IUnknown {
  ...
  int Begin_SetIdentityCredential(
          Pointer<Uint8> CredBuffer, int CredBufferLength) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Uint8> CredBuffer,
                              Uint32 CredBufferLength)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint8> CredBuffer,
                      int CredBufferLength)>()(
          ptr.ref.lpVtbl, CredBuffer, CredBufferLength);
  ...
  int
      Begin_ValidateIdentityCredential(
  ...
  int
      Finish_ValidateIdentityCredential(
              Pointer<Pointer<COMObject>> ppIdentityProperties) =>
          ptr.ref.lpVtbl.value
                  .elementAt(6)
                  .cast<
                  ...
                  .asFunction<
                      int Function(Pointer,
                          Pointer<Pointer<COMObject>> ppIdentityProperties)>()(
              ptr.ref.lpVtbl, ppIdentityProperties);
}
