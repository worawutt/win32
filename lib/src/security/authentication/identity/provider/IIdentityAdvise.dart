...
class IIdentityAdvise extends IUnknown {
  ...
  int IdentityUpdated(
          int dwIdentityUpdateEvents, Pointer<Utf16> lpszUniqueID) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint32 dwIdentityUpdateEvents,
                              Pointer<Utf16> lpszUniqueID)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int dwIdentityUpdateEvents,
                      Pointer<Utf16> lpszUniqueID)>()(
          ptr.ref.lpVtbl, dwIdentityUpdateEvents, lpszUniqueID);
}
