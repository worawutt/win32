...
class IIdentityProvider extends IUnknown {
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppPropertyStore,
                      Pointer<PROPVARIANT> pKeywordsToAdd)>()(
          ptr.ref.lpVtbl, lpszUserName, ppPropertyStore, pKeywordsToAdd);

  int Import(Pointer<COMObject> pPropertyStore) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int Delete(Pointer<Utf16> lpszUniqueID,
  ...
  int FindByUniqueID(Pointer<Utf16> lpszUniqueID,
          Pointer<Pointer<COMObject>> ppPropertyStore) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> lpszUniqueID,
                      Pointer<Pointer<COMObject>> ppPropertyStore)>()(
          ptr.ref.lpVtbl, lpszUniqueID, ppPropertyStore);

  int GetProviderPropertyStore(Pointer<Pointer<COMObject>> ppPropertyStore) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
                  Pointer<
  ...
  int Advise(Pointer<COMObject> pIdentityAdvise, int dwIdentityUpdateEvents,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pIdentityAdvise,
                      int dwIdentityUpdateEvents, Pointer<Uint32> pdwCookie)>()(
          ptr.ref.lpVtbl, pIdentityAdvise, dwIdentityUpdateEvents, pdwCookie);
