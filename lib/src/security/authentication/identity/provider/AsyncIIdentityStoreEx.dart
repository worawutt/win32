...
class AsyncIIdentityStoreEx extends IUnknown {
  ...
  int Begin_CreateConnectedIdentity(Pointer<Utf16> LocalName,
          Pointer<Utf16> ConnectedName, Pointer<GUID> ProviderGUID) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> ConnectedName,
                      Pointer<GUID> ProviderGUID)>()(
          ptr.ref.lpVtbl, LocalName, ConnectedName, ProviderGUID);
  ...
  int Begin_DeleteConnectedIdentity(
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> ConnectedName,
                              Pointer<GUID> ProviderGUID)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> ConnectedName,
                      Pointer<GUID> ProviderGUID)>()(
          ptr.ref.lpVtbl, ConnectedName, ProviderGUID);
