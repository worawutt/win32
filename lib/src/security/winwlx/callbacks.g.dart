...
typedef PFNMSGECALLBACK = Uint32 Function(
    Int32 bVerbose, Pointer<Utf16> lpMessage);
typedef PWLX_ASSIGN_SHELL_PROTECTION = Int32 Function(
    IntPtr hWlx, IntPtr hToken, IntPtr hProcess, IntPtr hThread);
typedef PWLX_CHANGE_PASSWORD_NOTIFY = Int32 Function(
    IntPtr hWlx, Pointer<WLX_MPR_NOTIFY_INFO> pMprInfo, Uint32 dwChangeInfo);
...
typedef PWLX_CLOSE_USER_DESKTOP = Int32 Function(
    IntPtr hWlx, Pointer<WLX_DESKTOP> pDesktop, IntPtr hToken);
...
typedef PWLX_GET_OPTION = Int32 Function(
    IntPtr hWlx, Uint32 Option, Pointer<IntPtr> Value);
typedef PWLX_GET_SOURCE_DESKTOP = Int32 Function(
    IntPtr hWlx, Pointer<Pointer<WLX_DESKTOP>> ppDesktop);
typedef PWLX_MESSAGE_BOX = Int32 Function(IntPtr hWlx, IntPtr hwndOwner,
    Pointer<Utf16> lpszText, Pointer<Utf16> lpszTitle, Uint32 fuStyle);
...
typedef PWLX_SAS_NOTIFY = Void Function(IntPtr hWlx, Uint32 dwSasType);
typedef PWLX_SET_CONTEXT_POINTER = Void Function(
    IntPtr hWlx, Pointer pWlxContext);
typedef PWLX_SET_OPTION = Int32 Function(
    IntPtr hWlx, Uint32 Option, IntPtr Value, Pointer<IntPtr> OldValue);
typedef PWLX_SET_RETURN_DESKTOP = Int32 Function(
    IntPtr hWlx, Pointer<WLX_DESKTOP> pDesktop);
typedef PWLX_SET_TIMEOUT = Int32 Function(IntPtr hWlx, Uint32 Timeout);
typedef PWLX_SWITCH_DESKTOP_TO_USER = Int32 Function(IntPtr hWlx);
typedef PWLX_SWITCH_DESKTOP_TO_WINLOGON = Int32 Function(IntPtr hWlx);
typedef PWLX_USE_CTRL_ALT_DEL = Void Function(IntPtr hWlx);
typedef PWLX_WIN31_MIGRATE = Void Function(IntPtr hWlx);
