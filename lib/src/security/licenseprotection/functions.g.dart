...
int RegisterLicenseKeyWithExpiration(
        Pointer<Utf16> licenseKey, int validityInDays, Pointer<Int32> status) =>
    _RegisterLicenseKeyWithExpiration(licenseKey, validityInDays, status);

late final _RegisterLicenseKeyWithExpiration =
    _licenseprotection.lookupFunction<
        Int32 Function(Pointer<Utf16> licenseKey, Uint32 validityInDays,
            Pointer<Int32> status),
        int Function(Pointer<Utf16> licenseKey, int validityInDays,
            Pointer<Int32> status)>('RegisterLicenseKeyWithExpiration');
...
late final _ValidateLicenseKeyProtection = _licenseprotection.lookupFunction<
    Int32 Function(Pointer<Utf16> licenseKey, Pointer<FILETIME> notValidBefore,
        Pointer<FILETIME> notValidAfter, Pointer<Int32> status),
    int Function(
        Pointer<Utf16> licenseKey,
        Pointer<FILETIME> notValidBefore,
        Pointer<FILETIME> notValidAfter,
        Pointer<Int32> status)>('ValidateLicenseKeyProtection');
