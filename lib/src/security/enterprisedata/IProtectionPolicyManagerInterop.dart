      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int targetIdentity,
                      Pointer<GUID> riid,
                      Pointer<Pointer> asyncOperation)>()(ptr.ref.lpVtbl,
          appWindow, sourceIdentity, targetIdentity, riid, asyncOperation);

  int GetForWindow(
          int appWindow, Pointer<GUID> riid, Pointer<Pointer> result) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, IntPtr appWindow,
                              Pointer<GUID> riid, Pointer<Pointer> result)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int appWindow, Pointer<GUID> riid,
                      Pointer<Pointer> result)>()(
          ptr.ref.lpVtbl, appWindow, riid, result);
}
