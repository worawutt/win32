...
class IAzClientContext extends IDispatch {
  ...
  int
      GetBusinessRuleString(Pointer<Pointer<Utf16>> pbstrBusinessRuleString) =>
          ptr.ref.lpVtbl.value
                  .elementAt(8)
                  .cast<
                      Pointer<
              ...
              ptr.ref.lpVtbl, pbstrBusinessRuleString);
  ...
  int GetRoles(Pointer<Utf16> bstrScopeName, Pointer<VARIANT> pvarRoleNames) =>
      ptr.ref.lpVtbl.value
              .elementAt(17)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrScopeName,
                      Pointer<VARIANT> pvarRoleNames)>()(
          ptr.ref.lpVtbl, bstrScopeName, pvarRoleNames);
