...
class IAzAuthorizationStore2 extends IAzAuthorizationStore {
  ...
  int OpenApplication2(Pointer<Utf16> bstrApplicationName, VARIANT varReserved,
  ...
  int CreateApplication2(Pointer<Utf16> bstrApplicationName,
          VARIANT varReserved, Pointer<Pointer<COMObject>> ppApplication) =>
      ptr.ref.lpVtbl.value
              .elementAt(59)
              .cast<
                  Pointer<
