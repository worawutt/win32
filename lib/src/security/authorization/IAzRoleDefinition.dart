...
class IAzRoleDefinition extends IAzTask {
  ...
  int
      RoleAssignments(Pointer<Utf16> bstrScopeName, int bRecursive,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(
                          ...
                          int bRecursive,
                          Pointer<Pointer<COMObject>> ppRoleAssignments)>()(
              ptr.ref.lpVtbl, bstrScopeName, bRecursive, ppRoleAssignments);

  int AddRoleDefinition(Pointer<Utf16> bstrRoleDefinition) =>
      ptr.ref.lpVtbl.value
              .elementAt(34)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Utf16> bstrRoleDefinition)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrRoleDefinition)>()(
          ptr.ref.lpVtbl, bstrRoleDefinition);

  int DeleteRoleDefinition(Pointer<Utf16> bstrRoleDefinition) =>
      ptr.ref.lpVtbl.value
              .elementAt(35)
              .cast<
                  Pointer<
