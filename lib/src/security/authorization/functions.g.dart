...
late final _AuthzAccessCheck = _authz.lookupFunction<
    ...
    int Function(
        ...
        int OptionalSecurityDescriptorCount,
        Pointer<AUTHZ_ACCESS_REPLY> pReply,
        Pointer<IntPtr> phAccessCheckResults)>('AuthzAccessCheck');
...
int AuthzAddSidsToContext(
    ...
    _AuthzAddSidsToContext(hAuthzClientContext, Sids, SidCount, RestrictedSids,
        RestrictedSidCount, phNewAuthzClientContext);
...
late final _AuthzAddSidsToContext = _authz.lookupFunction<
    ...
    int Function(
        ...
        Pointer<SID_AND_ATTRIBUTES> RestrictedSids,
        int RestrictedSidCount,
        Pointer<IntPtr> phNewAuthzClientContext)>('AuthzAddSidsToContext');
...
late final _AuthzCachedAccessCheck = _authz.lookupFunction<
    ...
    int Function(
        ...
        Pointer<AUTHZ_ACCESS_REQUEST> pRequest,
        int hAuditEvent,
        Pointer<AUTHZ_ACCESS_REPLY> pReply)>('AuthzCachedAccessCheck');
...
int AuthzEnumerateSecurityEventSources(
    ...
    _AuthzEnumerateSecurityEventSources(dwFlags, Buffer, pdwCount, pdwLength);
...
late final _AuthzEnumerateSecurityEventSources = _authz.lookupFunction<
    ...
    int Function(
        ...
        Pointer<AUTHZ_SOURCE_SCHEMA_REGISTRATION> Buffer,
        Pointer<Uint32> pdwCount,
        Pointer<Uint32> pdwLength)>('AuthzEnumerateSecurityEventSources');
...
int AuthzEvaluateSacl(
    ...
    _AuthzEvaluateSacl(AuthzClientContext, pRequest, Sacl, GrantedAccess,
        AccessGranted, pbGenerateAudit);
...
late final _AuthzEvaluateSacl = _authz.lookupFunction<
    ...
    int Function(
        ...
        int GrantedAccess,
        int AccessGranted,
        Pointer<Int32> pbGenerateAudit)>('AuthzEvaluateSacl');

int AuthzFreeAuditEvent(int hAuditEvent) => _AuthzFreeAuditEvent(hAuditEvent);

late final _AuthzFreeAuditEvent = _authz.lookupFunction<
    Int32 Function(IntPtr hAuditEvent),
    int Function(int hAuditEvent)>('AuthzFreeAuditEvent');
...
int AuthzFreeContext(int hAuthzClientContext) =>
    _AuthzFreeContext(hAuthzClientContext);

late final _AuthzFreeContext = _authz.lookupFunction<
    Int32 Function(IntPtr hAuthzClientContext),
    int Function(int hAuthzClientContext)>('AuthzFreeContext');

int AuthzFreeHandle(int hAccessCheckResults) =>
    _AuthzFreeHandle(hAccessCheckResults);

late final _AuthzFreeHandle = _authz.lookupFunction<
    Int32 Function(IntPtr hAccessCheckResults),
    int Function(int hAccessCheckResults)>('AuthzFreeHandle');

int AuthzFreeResourceManager(int hAuthzResourceManager) =>
    _AuthzFreeResourceManager(hAuthzResourceManager);

late final _AuthzFreeResourceManager = _authz.lookupFunction<
    Int32 Function(IntPtr hAuthzResourceManager),
    int Function(int hAuthzResourceManager)>('AuthzFreeResourceManager');

int AuthzGetInformationFromContext(int hAuthzClientContext, int InfoClass,
        int BufferSize, Pointer<Uint32> pSizeRequired, Pointer Buffer) =>
    _AuthzGetInformationFromContext(
        hAuthzClientContext, InfoClass, BufferSize, pSizeRequired, Buffer);

late final _AuthzGetInformationFromContext = _authz.lookupFunction<
    Int32 Function(IntPtr hAuthzClientContext, Int32 InfoClass,
        Uint32 BufferSize, Pointer<Uint32> pSizeRequired, Pointer Buffer),
    int Function(
        int hAuthzClientContext,
        int InfoClass,
        int BufferSize,
        Pointer<Uint32> pSizeRequired,
        Pointer Buffer)>('AuthzGetInformationFromContext');

int AuthzInitializeCompoundContext(int UserContext, int DeviceContext,
...
late final _AuthzInitializeCompoundContext = _authz.lookupFunction<
    Int32 Function(IntPtr UserContext, IntPtr DeviceContext,
        Pointer<IntPtr> phCompoundContext),
    int Function(int UserContext, int DeviceContext,
        Pointer<IntPtr> phCompoundContext)>('AuthzInitializeCompoundContext');
...
int AuthzInitializeContextFromAuthzContext(
        ...
        Pointer<IntPtr> phNewAuthzClientContext) =>
    _AuthzInitializeContextFromAuthzContext(Flags, hAuthzClientContext,
        pExpirationTime, Identifier, DynamicGroupArgs, phNewAuthzClientContext);
...
int AuthzInitializeContextFromSid(
    ...
    _AuthzInitializeContextFromSid(Flags, UserSid, hAuthzResourceManager,
        pExpirationTime, Identifier, DynamicGroupArgs, phAuthzClientContext);
...
late final _AuthzInitializeContextFromSid = _authz.lookupFunction<
    ...
    int Function(
        ...
        LUID Identifier,
        Pointer DynamicGroupArgs,
        Pointer<IntPtr> phAuthzClientContext)>('AuthzInitializeContextFromSid');
...
int AuthzInitializeContextFromToken(
        ...
        Pointer DynamicGroupArgs,
        Pointer<IntPtr> phAuthzClientContext) =>
    _AuthzInitializeContextFromToken(Flags, TokenHandle, hAuthzResourceManager,
        pExpirationTime, Identifier, DynamicGroupArgs, phAuthzClientContext);
...
int AuthzInitializeRemoteResourceManager(
    ...
    _AuthzInitializeRemoteResourceManager(pRpcInitInfo, phAuthzResourceManager);

late final _AuthzInitializeRemoteResourceManager = _authz.lookupFunction<
        Int32 Function(Pointer<AUTHZ_RPC_INIT_INFO_CLIENT> pRpcInitInfo,
            Pointer<IntPtr> phAuthzResourceManager),
        int Function(Pointer<AUTHZ_RPC_INIT_INFO_CLIENT> pRpcInitInfo,
            Pointer<IntPtr> phAuthzResourceManager)>(
    'AuthzInitializeRemoteResourceManager');

int AuthzInitializeResourceManager(
        int Flags,
        Pointer<NativeFunction<PFN_AUTHZ_DYNAMIC_ACCESS_CHECK>>
            pfnDynamicAccessCheck,
        Pointer<NativeFunction<PFN_AUTHZ_COMPUTE_DYNAMIC_GROUPS>>
            pfnComputeDynamicGroups,
        Pointer<NativeFunction<PFN_AUTHZ_FREE_DYNAMIC_GROUPS>>
...
int AuthzInitializeResourceManagerEx(
    ...
    _AuthzInitializeResourceManagerEx(
        Flags, pAuthzInitInfo, phAuthzResourceManager);

late final _AuthzInitializeResourceManagerEx = _authz.lookupFunction<
        Int32 Function(Uint32 Flags, Pointer<AUTHZ_INIT_INFO> pAuthzInitInfo,
            Pointer<IntPtr> phAuthzResourceManager),
        int Function(int Flags, Pointer<AUTHZ_INIT_INFO> pAuthzInitInfo,
            Pointer<IntPtr> phAuthzResourceManager)>(
    'AuthzInitializeResourceManagerEx');

int AuthzInstallSecurityEventSource(
        int dwFlags, Pointer<AUTHZ_SOURCE_SCHEMA_REGISTRATION> pRegistration) =>
    _AuthzInstallSecurityEventSource(dwFlags, pRegistration);
...
int AuthzModifyClaims(
    ...
    _AuthzModifyClaims(
        hAuthzClientContext, ClaimClass, pClaimOperations, pClaims);
...
int AuthzModifySecurityAttributes(
    ...
    _AuthzModifySecurityAttributes(
        hAuthzClientContext, pOperations, pAttributes);

late final _AuthzModifySecurityAttributes = _authz.lookupFunction<
        Int32 Function(IntPtr hAuthzClientContext, Pointer<Int32> pOperations,
            Pointer<AUTHZ_SECURITY_ATTRIBUTES_INFORMATION> pAttributes),
        int Function(int hAuthzClientContext, Pointer<Int32> pOperations,
            Pointer<AUTHZ_SECURITY_ATTRIBUTES_INFORMATION> pAttributes)>(
    'AuthzModifySecurityAttributes');

int AuthzModifySids(int hAuthzClientContext, int SidClass,
        Pointer<Int32> pSidOperations, Pointer<TOKEN_GROUPS> pSids) =>
    _AuthzModifySids(hAuthzClientContext, SidClass, pSidOperations, pSids);

late final _AuthzModifySids = _authz.lookupFunction<
    Int32 Function(IntPtr hAuthzClientContext, Int32 SidClass,
        Pointer<Int32> pSidOperations, Pointer<TOKEN_GROUPS> pSids),
    int Function(
        int hAuthzClientContext,
        int SidClass,
        Pointer<Int32> pSidOperations,
        Pointer<TOKEN_GROUPS> pSids)>('AuthzModifySids');
...
late final _AuthzOpenObjectAudit = _authz.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Pointer<SECURITY_DESCRIPTOR>> OptionalSecurityDescriptorArray,
        int OptionalSecurityDescriptorCount,
        Pointer<AUTHZ_ACCESS_REPLY> pReply)>('AuthzOpenObjectAudit');
...
int AuthzRegisterCapChangeNotification(
    ...
    _AuthzRegisterCapChangeNotification(
        phCapChangeSubscription, pfnCapChangeCallback, pCallbackContext);
...
late final _AuthzRegisterCapChangeNotification = _authz.lookupFunction<
    ...
    int Function(
        Pointer<Pointer<AUTHZ_CAP_CHANGE_SUBSCRIPTION_HANDLE__>>
            phCapChangeSubscription,
        Pointer<NativeFunction<LPTHREAD_START_ROUTINE>> pfnCapChangeCallback,
        Pointer pCallbackContext)>('AuthzRegisterCapChangeNotification');

int AuthzRegisterSecurityEventSource(int dwFlags,
        Pointer<Utf16> szEventSourceName, Pointer<IntPtr> phEventProvider) =>
...
late final _AuthzRegisterSecurityEventSource = _authz.lookupFunction<
    Int32 Function(Uint32 dwFlags, Pointer<Utf16> szEventSourceName,
        Pointer<IntPtr> phEventProvider),
    int Function(int dwFlags, Pointer<Utf16> szEventSourceName,
        Pointer<IntPtr> phEventProvider)>('AuthzRegisterSecurityEventSource');

int AuthzReportSecurityEvent(int dwFlags, int hEventProvider, int dwAuditId,
        int pUserSid, int dwCount) =>
...
late final _AuthzReportSecurityEvent = _authz.lookupFunction<
    Int32 Function(Uint32 dwFlags, IntPtr hEventProvider, Uint32 dwAuditId,
        IntPtr pUserSid, Uint32 dwCount),
    int Function(int dwFlags, int hEventProvider, int dwAuditId, int pUserSid,
        int dwCount)>('AuthzReportSecurityEvent');

int AuthzReportSecurityEventFromParams(int dwFlags, int hEventProvider,
        int dwAuditId, int pUserSid, Pointer<AUDIT_PARAMS> pParams) =>
...
late final _AuthzReportSecurityEventFromParams = _authz.lookupFunction<
    Int32 Function(Uint32 dwFlags, IntPtr hEventProvider, Uint32 dwAuditId,
        IntPtr pUserSid, Pointer<AUDIT_PARAMS> pParams),
    int Function(int dwFlags, int hEventProvider, int dwAuditId, int pUserSid,
        Pointer<AUDIT_PARAMS> pParams)>('AuthzReportSecurityEventFromParams');
...
int AuthzSetAppContainerInformation(
    ...
    _AuthzSetAppContainerInformation(hAuthzClientContext, pAppContainerSid,
        CapabilityCount, pCapabilitySids);

late final _AuthzSetAppContainerInformation = _authz.lookupFunction<
    Int32 Function(IntPtr hAuthzClientContext, IntPtr pAppContainerSid,
        Uint32 CapabilityCount, Pointer<SID_AND_ATTRIBUTES> pCapabilitySids),
    int Function(
        int hAuthzClientContext,
        int pAppContainerSid,
        int CapabilityCount,
        Pointer<SID_AND_ATTRIBUTES>
            pCapabilitySids)>('AuthzSetAppContainerInformation');

int AuthzUninstallSecurityEventSource(
        int dwFlags, Pointer<Utf16> szEventSourceName) =>
    _AuthzUninstallSecurityEventSource(dwFlags, szEventSourceName);

late final _AuthzUninstallSecurityEventSource = _authz.lookupFunction<
    Int32 Function(Uint32 dwFlags, Pointer<Utf16> szEventSourceName),
    int Function(int dwFlags,
        Pointer<Utf16> szEventSourceName)>('AuthzUninstallSecurityEventSource');

int AuthzUnregisterCapChangeNotification(
        Pointer<AUTHZ_CAP_CHANGE_SUBSCRIPTION_HANDLE__>
            hCapChangeSubscription) =>
    _AuthzUnregisterCapChangeNotification(hCapChangeSubscription);
...
late final _AuthzUnregisterCapChangeNotification = _authz.lookupFunction<
    ...
    int Function(
        Pointer<AUTHZ_CAP_CHANGE_SUBSCRIPTION_HANDLE__>
            hCapChangeSubscription)>('AuthzUnregisterCapChangeNotification');

int AuthzUnregisterSecurityEventSource(
        int dwFlags, Pointer<IntPtr> phEventProvider) =>
    _AuthzUnregisterSecurityEventSource(dwFlags, phEventProvider);

late final _AuthzUnregisterSecurityEventSource = _authz.lookupFunction<
    Int32 Function(Uint32 dwFlags, Pointer<IntPtr> phEventProvider),
    int Function(int dwFlags,
        Pointer<IntPtr> phEventProvider)>('AuthzUnregisterSecurityEventSource');
...
void BuildExplicitAccessWithName(
        ...
        int AccessMode,
        int Inheritance) =>
    _BuildExplicitAccessWithName(pExplicitAccess, pTrusteeName,
...
late final _BuildExplicitAccessWithName = _advapi32.lookupFunction<
    ...
    void Function(
        ...
        int AccessPermissions,
        int AccessMode,
        int Inheritance)>('BuildExplicitAccessWithNameW');
...
void BuildImpersonateExplicitAccessWithName(
        ...
        int AccessMode,
        int Inheritance) =>
    _BuildImpersonateExplicitAccessWithName(pExplicitAccess, pTrusteeName,
        pTrustee, AccessPermissions, AccessMode, Inheritance);
...
late final _BuildImpersonateExplicitAccessWithName = _advapi32.lookupFunction<
    ...
    void Function(
        ...
        int AccessPermissions,
        int AccessMode,
        int Inheritance)>('BuildImpersonateExplicitAccessWithNameW');

void BuildImpersonateTrustee(
        Pointer<TRUSTEE_> pTrustee, Pointer<TRUSTEE_> pImpersonateTrustee) =>
    _BuildImpersonateTrustee(pTrustee, pImpersonateTrustee);

late final _BuildImpersonateTrustee = _advapi32.lookupFunction<
    Void Function(
        Pointer<TRUSTEE_> pTrustee, Pointer<TRUSTEE_> pImpersonateTrustee),
    void Function(Pointer<TRUSTEE_> pTrustee,
        Pointer<TRUSTEE_> pImpersonateTrustee)>('BuildImpersonateTrusteeW');
...
void BuildTrusteeWithName(Pointer<TRUSTEE_> pTrustee, Pointer<Utf16> pName) =>
    _BuildTrusteeWithName(pTrustee, pName);

late final _BuildTrusteeWithName = _advapi32.lookupFunction<
    Void Function(Pointer<TRUSTEE_> pTrustee, Pointer<Utf16> pName),
    void Function(Pointer<TRUSTEE_> pTrustee,
        Pointer<Utf16> pName)>('BuildTrusteeWithNameW');
...
void BuildTrusteeWithObjectsAndName(
        ...
        Pointer<Utf16> Name) =>
    _BuildTrusteeWithObjectsAndName(pTrustee, pObjName, ObjectType,
        ObjectTypeName, InheritedObjectTypeName, Name);
...
late final _BuildTrusteeWithObjectsAndName = _advapi32.lookupFunction<
    ...
    void Function(
        ...
        Pointer<Utf16> ObjectTypeName,
        Pointer<Utf16> InheritedObjectTypeName,
        Pointer<Utf16> Name)>('BuildTrusteeWithObjectsAndNameW');
...
late final _BuildTrusteeWithObjectsAndSid = _advapi32.lookupFunction<
    ...
    void Function(
        ...
        Pointer<GUID> pObjectGuid,
        Pointer<GUID> pInheritedObjectGuid,
        int pSid)>('BuildTrusteeWithObjectsAndSidW');

void BuildTrusteeWithSid(Pointer<TRUSTEE_> pTrustee, int pSid) =>
    _BuildTrusteeWithSid(pTrustee, pSid);

late final _BuildTrusteeWithSid = _advapi32.lookupFunction<
    Void Function(Pointer<TRUSTEE_> pTrustee, IntPtr pSid),
    void Function(
        Pointer<TRUSTEE_> pTrustee, int pSid)>('BuildTrusteeWithSidW');
...
int ConvertSidToStringSid(int Sid, Pointer<Pointer<Utf16>> StringSid) =>
    _ConvertSidToStringSid(Sid, StringSid);

late final _ConvertSidToStringSid = _advapi32.lookupFunction<
    Int32 Function(IntPtr Sid, Pointer<Pointer<Utf16>> StringSid),
    int Function(
        int Sid, Pointer<Pointer<Utf16>> StringSid)>('ConvertSidToStringSidW');
...
int ConvertStringSidToSid(Pointer<Utf16> StringSid, Pointer<IntPtr> Sid) =>
    _ConvertStringSidToSid(StringSid, Sid);

late final _ConvertStringSidToSid = _advapi32.lookupFunction<
    Int32 Function(Pointer<Utf16> StringSid, Pointer<IntPtr> Sid),
    int Function(Pointer<Utf16> StringSid,
        Pointer<IntPtr> Sid)>('ConvertStringSidToSidW');

int FreeInheritedFromArray(Pointer<INHERITED_FROM> pInheritArray, int AceCnt,
        Pointer<FN_OBJECT_MGR_FUNCTIONS> pfnArray) =>
    _FreeInheritedFromArray(pInheritArray, AceCnt, pfnArray);

late final _FreeInheritedFromArray = _advapi32.lookupFunction<
    Uint32 Function(Pointer<INHERITED_FROM> pInheritArray, Uint16 AceCnt,
        Pointer<FN_OBJECT_MGR_FUNCTIONS> pfnArray),
    int Function(Pointer<INHERITED_FROM> pInheritArray, int AceCnt,
        Pointer<FN_OBJECT_MGR_FUNCTIONS> pfnArray)>('FreeInheritedFromArray');
...
late final _GetAuditedPermissionsFromAcl = _advapi32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<TRUSTEE_> pTrustee,
        Pointer<Uint32> pSuccessfulAuditedRights,
        Pointer<Uint32> pFailedAuditRights)>('GetAuditedPermissionsFromAclW');

int GetEffectiveRightsFromAcl(Pointer<ACL> pacl, Pointer<TRUSTEE_> pTrustee,
        Pointer<Uint32> pAccessRights) =>
    _GetEffectiveRightsFromAcl(pacl, pTrustee, pAccessRights);

late final _GetEffectiveRightsFromAcl = _advapi32.lookupFunction<
    Uint32 Function(Pointer<ACL> pacl, Pointer<TRUSTEE_> pTrustee,
        Pointer<Uint32> pAccessRights),
    int Function(Pointer<ACL> pacl, Pointer<TRUSTEE_> pTrustee,
        Pointer<Uint32> pAccessRights)>('GetEffectiveRightsFromAclW');
...
late final _GetExplicitEntriesFromAcl = _advapi32.lookupFunction<
    Uint32 Function(Pointer<ACL> pacl, Pointer<Uint32> pcCountOfExplicitEntries,
        Pointer<Pointer<EXPLICIT_ACCESS_>> pListOfExplicitEntries),
    int Function(
        Pointer<ACL> pacl,
        Pointer<Uint32> pcCountOfExplicitEntries,
        Pointer<Pointer<EXPLICIT_ACCESS_>>
            pListOfExplicitEntries)>('GetExplicitEntriesFromAclW');
...
late final _GetInheritanceSource = _advapi32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<FN_OBJECT_MGR_FUNCTIONS> pfnArray,
        Pointer<GENERIC_MAPPING> pGenericMapping,
        Pointer<INHERITED_FROM> pInheritArray)>('GetInheritanceSourceW');

int GetMultipleTrusteeOperation(Pointer<TRUSTEE_> pTrustee) =>
    _GetMultipleTrusteeOperation(pTrustee);

late final _GetMultipleTrusteeOperation = _advapi32.lookupFunction<
    Int32 Function(Pointer<TRUSTEE_> pTrustee),
    int Function(Pointer<TRUSTEE_> pTrustee)>('GetMultipleTrusteeOperationW');

Pointer<TRUSTEE_> GetMultipleTrustee(Pointer<TRUSTEE_> pTrustee) =>
    _GetMultipleTrustee(pTrustee);

late final _GetMultipleTrustee = _advapi32.lookupFunction<
    Pointer<TRUSTEE_> Function(Pointer<TRUSTEE_> pTrustee),
    Pointer<TRUSTEE_> Function(
        Pointer<TRUSTEE_> pTrustee)>('GetMultipleTrusteeW');
...
int GetNamedSecurityInfo(
    ...
    _GetNamedSecurityInfo(pObjectName, ObjectType, SecurityInfo, ppsidOwner,
...
int GetSecurityInfo(
        ...
        Pointer<Pointer<ACL>> ppSacl,
        Pointer<Pointer<SECURITY_DESCRIPTOR>> ppSecurityDescriptor) =>
    _GetSecurityInfo(handle, ObjectType, SecurityInfo, ppsidOwner, ppsidGroup,
...
int GetTrusteeForm(Pointer<TRUSTEE_> pTrustee) => _GetTrusteeForm(pTrustee);

late final _GetTrusteeForm = _advapi32.lookupFunction<
    Int32 Function(Pointer<TRUSTEE_> pTrustee),
    int Function(Pointer<TRUSTEE_> pTrustee)>('GetTrusteeFormW');

Pointer<Utf16> GetTrusteeName(Pointer<TRUSTEE_> pTrustee) =>
    _GetTrusteeName(pTrustee);

late final _GetTrusteeName = _advapi32.lookupFunction<
    Pointer<Utf16> Function(Pointer<TRUSTEE_> pTrustee),
    Pointer<Utf16> Function(Pointer<TRUSTEE_> pTrustee)>('GetTrusteeNameW');

int GetTrusteeType(Pointer<TRUSTEE_> pTrustee) => _GetTrusteeType(pTrustee);

late final _GetTrusteeType = _advapi32.lookupFunction<
    Int32 Function(Pointer<TRUSTEE_> pTrustee),
    int Function(Pointer<TRUSTEE_> pTrustee)>('GetTrusteeTypeW');
...
late final _LookupSecurityDescriptorParts = _advapi32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> pcCountOfAuditEntries,
        Pointer<Pointer<EXPLICIT_ACCESS_>> ppListOfAuditEntries,
        Pointer<SECURITY_DESCRIPTOR> pSD)>('LookupSecurityDescriptorPartsW');
...
late final _SetEntriesInAcl = _advapi32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<EXPLICIT_ACCESS_> pListOfExplicitEntries,
        Pointer<ACL> OldAcl,
        Pointer<Pointer<ACL>> NewAcl)>('SetEntriesInAclW');
...
int SetNamedSecurityInfo(
        ...
        Pointer<ACL> pDacl,
        Pointer<ACL> pSacl) =>
    _SetNamedSecurityInfo(pObjectName, ObjectType, SecurityInfo, psidOwner,
...
late final _SetNamedSecurityInfo = _advapi32.lookupFunction<
    ...
    int Function(
        ...
        int psidGroup,
        Pointer<ACL> pDacl,
        Pointer<ACL> pSacl)>('SetNamedSecurityInfoW');

int SetSecurityInfo(int handle, int ObjectType, int SecurityInfo, int psidOwner,
        int psidGroup, Pointer<ACL> pDacl, Pointer<ACL> pSacl) =>
    _SetSecurityInfo(
...
late final _SetSecurityInfo = _advapi32.lookupFunction<
    ...
    int Function(
        ...
        int psidGroup,
        Pointer<ACL> pDacl,
        Pointer<ACL> pSacl)>('SetSecurityInfo');
...
late final _TreeResetNamedSecurityInfo = _advapi32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<NativeFunction<FN_PROGRESS>> fnProgress,
        int ProgressInvokeSetting,
        Pointer Args)>('TreeResetNamedSecurityInfoW');
...
late final _TreeSetNamedSecurityInfo = _advapi32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<NativeFunction<FN_PROGRESS>> fnProgress,
        int ProgressInvokeSetting,
        Pointer Args)>('TreeSetNamedSecurityInfoW');
