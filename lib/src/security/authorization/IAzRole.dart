...
class IAzRole extends IDispatch {
  ...
  int AddTask(Pointer<Utf16> bstrProp, VARIANT varReserved) => ptr
      .ref.lpVtbl.value
      .elementAt(15)
      .cast<
          Pointer<
  ...
  int DeleteTask(Pointer<Utf16> bstrProp, VARIANT varReserved) => ptr
      .ref.lpVtbl.value
      .elementAt(16)
      .cast<
          Pointer<
  ...
  int AddOperation(Pointer<Utf16> bstrProp, VARIANT varReserved) => ptr
      .ref.lpVtbl.value
      .elementAt(17)
      .cast<
          Pointer<
  ...
  int DeleteOperation(Pointer<Utf16> bstrProp, VARIANT varReserved) => ptr
      .ref.lpVtbl.value
      .elementAt(18)
      .cast<
          Pointer<
