...
class IAzApplication2 extends IAzApplication {
  ...
  int InitializeClientContext2(Pointer<Utf16> IdentifyingString,
          VARIANT varReserved, Pointer<Pointer<COMObject>> ppClientContext) =>
      ptr.ref.lpVtbl.value
              .elementAt(69)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      VARIANT varReserved,
                      Pointer<Pointer<COMObject>> ppClientContext)>()(
          ptr.ref.lpVtbl, IdentifyingString, varReserved, ppClientContext);
}
