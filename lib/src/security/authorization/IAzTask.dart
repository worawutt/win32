...
class IAzTask extends IDispatch {
  ...
  set IsRoleDefinition(int value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(20)
        .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 fProp)>>>()
        .value
        .asFunction<int Function(Pointer, int fProp)>()(ptr.ref.lpVtbl, value);
  ...
  int AddOperation(Pointer<Utf16> bstrOp, VARIANT varReserved) => ptr
      .ref.lpVtbl.value
      .elementAt(23)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Pointer<Utf16> bstrOp, VARIANT varReserved)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<Utf16> bstrOp,
              VARIANT varReserved)>()(ptr.ref.lpVtbl, bstrOp, varReserved);

  int DeleteOperation(Pointer<Utf16> bstrOp, VARIANT varReserved) => ptr
      .ref.lpVtbl.value
      .elementAt(24)
      .cast<
          Pointer<
  ...
  int AddTask(Pointer<Utf16> bstrTask, VARIANT varReserved) => ptr
      .ref.lpVtbl.value
      .elementAt(25)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Utf16> bstrTask,
                      VARIANT varReserved)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<Utf16> bstrTask,
              VARIANT varReserved)>()(ptr.ref.lpVtbl, bstrTask, varReserved);

  int DeleteTask(Pointer<Utf16> bstrTask, VARIANT varReserved) => ptr
      .ref.lpVtbl.value
      .elementAt(26)
      .cast<
          Pointer<
