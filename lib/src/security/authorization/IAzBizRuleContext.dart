...
class IAzBizRuleContext extends IDispatch {
  ...
  set BusinessRuleResult(int value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(7)
        .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 bResult)>>>()
        .value
        .asFunction<
            int Function(Pointer, int bResult)>()(ptr.ref.lpVtbl, value);
    ...
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(
                            Pointer, Pointer<Utf16> bstrBusinessRuleString)>>>()
            .value
            .asFunction<
                int Function(Pointer, Pointer<Utf16> bstrBusinessRuleString)>()(
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<Utf16>>
                      pbstrBusinessRuleString)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  int
      GetParameter(Pointer<Utf16> bstrParameterName,
