...
class ISecurityInformation4 extends IUnknown {
  ...
  int
      GetSecondarySecurity(Pointer<Pointer<SECURITY_OBJECT>> pSecurityObjects,
                  ...
                  .cast<
                      Pointer<
                          NativeFunction<
                              Int32 Function(
                                  Pointer,
                                  Pointer<Pointer<SECURITY_OBJECT>>
                                      pSecurityObjects,
                                  Pointer<Uint32> pSecurityObjectCount)>>>()
                  .value
                  .asFunction<
                      int Function(
                          ...
                          Pointer<Uint32> pSecurityObjectCount)>()(
              ptr.ref.lpVtbl, pSecurityObjects, pSecurityObjectCount);
}
