...
class ISecurityObjectTypeInfo extends IUnknown {
  ...
  int
      GetInheritSource(int si, Pointer<ACL> pACL,
                      ...
                      Pointer<
                          NativeFunction<
                              Int32 Function(
                                  ...
                                  Uint32 si,
                                  Pointer<ACL> pACL,
                                  Pointer<Pointer<INHERITED_FROM>>
                                      ppInheritArray)>>>()
                  .value
                  .asFunction<
                      int Function(Pointer, int si, Pointer<ACL> pACL,
                          Pointer<Pointer<INHERITED_FROM>> ppInheritArray)>()(
              ptr.ref.lpVtbl, si, pACL, ppInheritArray);
}
