...
class IAzClientContext3 extends IAzClientContext2 {
  ...
  int AccessCheck2(Pointer<Utf16> bstrObjectName, Pointer<Utf16> bstrScopeName,
          int lOperation, Pointer<Uint32> plResult) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int lOperation,
                      Pointer<Uint32> plResult)>()(
          ptr.ref.lpVtbl, bstrObjectName, bstrScopeName, lOperation, plResult);

  int IsInRoleAssignment(Pointer<Utf16> bstrScopeName,
          Pointer<Utf16> bstrRoleName, Pointer<Int16> pbIsInRole) =>
      ptr.ref.lpVtbl.value
              .elementAt(27)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> bstrRoleName,
                      Pointer<Int16> pbIsInRole)>()(
          ptr.ref.lpVtbl, bstrScopeName, bstrRoleName, pbIsInRole);

  int GetOperations(Pointer<Utf16> bstrScopeName,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrScopeName,
                      Pointer<Pointer<COMObject>> ppOperationCollection)>()(
          ptr.ref.lpVtbl, bstrScopeName, ppOperationCollection);

  int GetTasks(Pointer<Utf16> bstrScopeName,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrScopeName,
                      Pointer<Pointer<COMObject>> ppTaskCollection)>()(
          ptr.ref.lpVtbl, bstrScopeName, ppTaskCollection);
  ...
  Pointer<COMObject> get BizRuleParameters {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppBizRuleParam)>()(
      ...
      final hr = ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(
                  Pointer,
                  Pointer<Pointer<COMObject>>
                      ppBizRuleInterfaces)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  int
      GetGroups(Pointer<Utf16> bstrScopeName, int ulOptions,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(Pointer, Pointer<Utf16> bstrScopeName,
                          int ulOptions, Pointer<VARIANT> pGroupArray)>()(
              ptr.ref.lpVtbl, bstrScopeName, ulOptions, pGroupArray);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<VARIANT> pStringSidArray)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<VARIANT> pStringSidArray)>()(
          ptr.ref.lpVtbl, retValuePtr);
