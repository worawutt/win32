...
class IWaaSAssessor extends IUnknown {
  ...
  int GetOSUpdateAssessment(Pointer<OSUpdateAssessment> result) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<OSUpdateAssessment> result)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<OSUpdateAssessment> result)>()(
