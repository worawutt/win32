...
class ITsSbOrchestration extends ITsSbPlugin {
  ...
  int PrepareTargetForConnect(Pointer<COMObject> pConnection,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pConnection,
                      Pointer<COMObject> pOrchestrationNotifySink)>()(
          ptr.ref.lpVtbl, pConnection, pOrchestrationNotifySink);
}
