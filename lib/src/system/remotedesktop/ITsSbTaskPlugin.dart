...
class ITsSbTaskPlugin extends ITsSbPlugin {
  ...
  int InitializeTaskPlugin(Pointer<COMObject> pITsSbTaskPluginNotifySink) => ptr
          .ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<COMObject> pITsSbTaskPluginNotifySink)>()(
      ptr.ref.lpVtbl, pITsSbTaskPluginNotifySink);

  int SetTaskQueue(Pointer<Utf16> pszHostName, int SbTaskInfoSize,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int SbTaskInfoSize,
                      Pointer<Pointer<COMObject>> pITsSbTaskInfo)>()(
          ptr.ref.lpVtbl, pszHostName, SbTaskInfoSize, pITsSbTaskInfo);
}
