...
class ITsSbResourceNotification extends IUnknown {
  ...
  int NotifySessionChange(int changeType, Pointer<COMObject> pSession) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, int changeType, Pointer<COMObject> pSession)>()(
          ptr.ref.lpVtbl, changeType, pSession);

  int NotifyTargetChange(int TargetChangeType, Pointer<COMObject> pTarget) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint32 TargetChangeType,
                              Pointer<COMObject> pTarget)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int TargetChangeType,
                      Pointer<COMObject> pTarget)>()(
          ptr.ref.lpVtbl, TargetChangeType, pTarget);

  int NotifyClientConnectionStateChange(
          int ChangeType, Pointer<COMObject> pConnection) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, int ChangeType,
                      Pointer<COMObject> pConnection)>()(
          ptr.ref.lpVtbl, ChangeType, pConnection);
}
