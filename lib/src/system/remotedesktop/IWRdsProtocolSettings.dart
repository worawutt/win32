...
class IWRdsProtocolSettings extends IUnknown {
  ...
  int GetSettings(int WRdsSettingType, int WRdsSettingLevel,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<WRDS_SETTINGS> pWRdsSettings)>()(
          ptr.ref.lpVtbl, WRdsSettingType, WRdsSettingLevel, pWRdsSettings);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int WRdsConnectionSettingLevel,
                      Pointer<WRDS_CONNECTION_SETTINGS>
                          pWRdsConnectionSettings)>()(ptr.ref.lpVtbl,
          pWRdsSettings, WRdsConnectionSettingLevel, pWRdsConnectionSettings);
}
