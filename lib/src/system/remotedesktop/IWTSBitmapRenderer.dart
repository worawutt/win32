...
class IWTSBitmapRenderer extends IUnknown {
  ...
  int Render(GUID imageFormat, int dwWidth, int dwHeight, int cbStride,
          int cbImageBuffer, Pointer<Uint8> pImageBuffer) =>
  ...
  int GetRendererStatistics(Pointer<BITMAP_RENDERER_STATISTICS> pStatistics) =>
      ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer,
                  Pointer<BITMAP_RENDERER_STATISTICS>
                      pStatistics)>()(ptr.ref.lpVtbl, pStatistics);
