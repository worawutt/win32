...
class IWorkspace extends IUnknown {
  ...
  int GetWorkspaceNames(Pointer<Pointer<SAFEARRAY>> psaWkspNames) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<SAFEARRAY>> psaWkspNames)>()(
          ptr.ref.lpVtbl, psaWkspNames);

  int StartRemoteApplication(
          Pointer<Utf16> bstrWorkspaceId, Pointer<SAFEARRAY> psaParams) =>
      ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> bstrWorkspaceId,
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<SAFEARRAY>
                      psaParams)>()(ptr.ref.lpVtbl, bstrWorkspaceId, psaParams);

  int GetProcessId(Pointer<Uint32> pulProcessId) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Uint32> pulProcessId)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Uint32> pulProcessId)>()(
      ptr.ref.lpVtbl, pulProcessId);
}
