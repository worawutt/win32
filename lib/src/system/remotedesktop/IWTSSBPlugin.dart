...
class IWTSSBPlugin extends IUnknown {
  ...
  int Initialize(Pointer<Uint32> PluginCapabilities) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Uint32> PluginCapabilities)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Uint32> PluginCapabilities)>()(
      ptr.ref.lpVtbl, PluginCapabilities);

  int WTSSBX_MachineChangeNotification(int NotificationType, int MachineId,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int NotificationType, int MachineId,
                      Pointer<WTSSBX_MACHINE_INFO> pMachineInfo)>()(
          ptr.ref.lpVtbl, NotificationType, MachineId, pMachineInfo);

  int WTSSBX_SessionChangeNotification(int NotificationType, int MachineId,
          int NumOfSessions, Pointer<WTSSBX_SESSION_INFO> SessionInfo) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> ApplicationType,
                      Pointer<Utf16> FarmName,
                      Pointer<Int32> pMachineId)>()(ptr.ref.lpVtbl, UserName,
          DomainName, ApplicationType, FarmName, pMachineId);
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              ...
                              Pointer<WTSSBX_IP_ADDRESS> RedirectorInternalIP,
                              Pointer<Uint32> pSessionId,
                              Pointer<WTSSBX_MACHINE_CONNECT_INFO>
                                  pMachineConnectInfo)>>>()
              .value
              .asFunction<
                  int Function(
