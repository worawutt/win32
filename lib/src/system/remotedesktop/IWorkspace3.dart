...
class IWorkspace3 extends IWorkspace2 {
  ...
  int SetClaimsToken(Pointer<Utf16> bstrAccessToken,
          int ullAccessTokenExpiration, Pointer<Utf16> bstrRefreshToken) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> bstrRefreshToken)>()(ptr.ref.lpVtbl,
          bstrAccessToken, ullAccessTokenExpiration, bstrRefreshToken);
}
