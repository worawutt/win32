      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> bstrEventLogUploadAddress,
                      Pointer<Uint32> pdwCookie,
                      GUID correlationId)>()(ptr.ref.lpVtbl, pUnk,
          bstrEventLogUploadAddress, pdwCookie, correlationId);

  int RemoveResourceEx(int dwCookieConnection, GUID correlationId) =>
      ptr.ref.lpVtbl.value
              .elementAt(6)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, int dwCookieConnection, GUID correlationId)>()(
          ptr.ref.lpVtbl, dwCookieConnection, correlationId);
}
