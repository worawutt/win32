...
class ITSGAccountingEngine extends IUnknown {
  ...
  int DoAccounting(int accountingDataType, AAAccountingData accountingData) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 accountingDataType,
                              AAAccountingData accountingData)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int accountingDataType,
                      AAAccountingData accountingData)>()(
          ptr.ref.lpVtbl, accountingDataType, accountingData);
}
