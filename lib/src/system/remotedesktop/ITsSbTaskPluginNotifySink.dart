...
class ITsSbTaskPluginNotifySink extends ITsSbBaseNotifySink {
  ...
  int OnDeleteTaskTime(
          Pointer<Utf16> szTargetName, Pointer<Utf16> szTaskIdentifier) =>
      ptr.ref.lpVtbl.value
              .elementAt(6)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> szTargetName,
                              Pointer<Utf16> szTaskIdentifier)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> szTargetName,
                      Pointer<Utf16> szTaskIdentifier)>()(
          ptr.ref.lpVtbl, szTargetName, szTaskIdentifier);

  int
      OnUpdateTaskStatus(Pointer<Utf16> szTargetName,
              Pointer<Utf16> TaskIdentifier, int TaskStatus) =>
          ptr.ref.lpVtbl.value
                  .elementAt(7)
                  .cast<
                      Pointer<
                  ...
                  .asFunction<
                      int Function(Pointer, Pointer<Utf16> szTargetName,
                          Pointer<Utf16> TaskIdentifier, int TaskStatus)>()(
              ptr.ref.lpVtbl, szTargetName, TaskIdentifier, TaskStatus);

  int OnReportTasks(Pointer<Utf16> szHostName) => ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> szHostName)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Utf16> szHostName)>()(
      ptr.ref.lpVtbl, szHostName);
}
