...
class IWRdsProtocolListener extends IUnknown {
  ...
  int GetSettings(int WRdsListenerSettingLevel,
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              ...
                              Pointer<WRDS_LISTENER_SETTINGS>
                                  pWRdsListenerSettings)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int WRdsListenerSettingLevel,
                      Pointer<WRDS_LISTENER_SETTINGS> pWRdsListenerSettings)>()(
          ptr.ref.lpVtbl, WRdsListenerSettingLevel, pWRdsListenerSettings);

  int StartListen(Pointer<COMObject> pCallback) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
