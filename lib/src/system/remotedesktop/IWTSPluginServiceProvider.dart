...
class IWTSPluginServiceProvider extends IUnknown {
  ...
  int GetService(GUID ServiceId, Pointer<Pointer<COMObject>> ppunkObject) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, GUID ServiceId,
                              Pointer<Pointer<COMObject>> ppunkObject)>>>()
              .value
              .asFunction<
                  int Function(Pointer, GUID ServiceId,
                      Pointer<Pointer<COMObject>> ppunkObject)>()(
          ptr.ref.lpVtbl, ServiceId, ppunkObject);
}
