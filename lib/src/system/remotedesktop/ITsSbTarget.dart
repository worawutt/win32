...
class ITsSbTarget extends IUnknown {
  ...
  set TargetName(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .value
        .asFunction<
            int Function(Pointer, Pointer<Utf16> Val)>()(ptr.ref.lpVtbl, value);
  ...
  Pointer<Utf16> get TargetFQDN {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> TargetFqdnName)>()(
  ...
  Pointer<Utf16> get TargetNetbios {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> TargetNetbiosName)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  int get_IpAddresses(Pointer<TSSD_ConnectionPoint> SOCKADDR,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<TSSD_ConnectionPoint> SOCKADDR,
                      Pointer<Uint32> numAddresses)>()(
          ptr.ref.lpVtbl, SOCKADDR, numAddresses);

  int put_IpAddresses(
          Pointer<TSSD_ConnectionPoint> SOCKADDR, int numAddresses) =>
      ptr.ref.lpVtbl.value
          .elementAt(12)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(Pointer, Pointer<TSSD_ConnectionPoint> SOCKADDR,
                  int numAddresses)>()(ptr.ref.lpVtbl, SOCKADDR, numAddresses);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Uint32> pNumSessions)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Uint32> pNumSessions)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  int get NumPendingConnections {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Uint32> pNumPendingConnections)>()(
          ptr.ref.lpVtbl, retValuePtr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Uint32> pTargetLoad)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Uint32> pTargetLoad)>()(ptr.ref.lpVtbl, retValuePtr);
