...
class IAudioInputEndpointRT extends IUnknown {
  ...
  void
      GetInputDataPointer(Pointer<APO_CONNECTION_PROPERTY> pConnectionProperty,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      void Function(
                          ...
                          Pointer<AE_CURRENT_POSITION> pAeTimeStamp)>()(
              ptr.ref.lpVtbl, pConnectionProperty, pAeTimeStamp);

  void ReleaseInputDataPointer(int u32FrameCount, int pDataPointer) => ptr
      .ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
              NativeFunction<
                  Void Function(
                      Pointer, Uint32 u32FrameCount, IntPtr pDataPointer)>>>()
      .value
      .asFunction<
          void Function(Pointer, int u32FrameCount,
              int pDataPointer)>()(ptr.ref.lpVtbl, u32FrameCount, pDataPointer);
