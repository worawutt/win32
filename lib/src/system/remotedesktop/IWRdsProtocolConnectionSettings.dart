...
class IWRdsProtocolConnectionSettings extends IUnknown {
  ...
  int
      SetConnectionSetting(GUID PropertyID,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, GUID PropertyID,
                          Pointer<WTS_PROPERTY_VALUE> pPropertyEntriesIn)>()(
              ptr.ref.lpVtbl, PropertyID, pPropertyEntriesIn);

  int
      GetConnectionSetting(GUID PropertyID,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(Pointer, GUID PropertyID,
                          Pointer<WTS_PROPERTY_VALUE> pPropertyEntriesOut)>()(
              ptr.ref.lpVtbl, PropertyID, pPropertyEntriesOut);
}
