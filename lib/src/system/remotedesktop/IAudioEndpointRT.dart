...
class IAudioEndpointRT extends IUnknown {
  ...
  void
      GetCurrentPadding(Pointer<Int64> pPadding,
                      ...
                      Pointer<
                          NativeFunction<
                              Void Function(
                                  ...
                                  Pointer<AE_CURRENT_POSITION>
                                      pAeCurrentPosition)>>>()
                  .value
                  .asFunction<
                      void Function(Pointer, Pointer<Int64> pPadding,
                          Pointer<AE_CURRENT_POSITION> pAeCurrentPosition)>()(
              ptr.ref.lpVtbl, pPadding, pAeCurrentPosition);
