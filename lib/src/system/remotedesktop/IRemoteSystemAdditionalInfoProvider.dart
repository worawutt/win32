...
class IRemoteSystemAdditionalInfoProvider extends IUnknown {
  ...
  int
      GetAdditionalInfo(Pointer<IntPtr> deduplicationId, Pointer<GUID> riid,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<IntPtr> deduplicationId,
                          Pointer<GUID> riid, Pointer<Pointer> mapView)>()(
              ptr.ref.lpVtbl, deduplicationId, riid, mapView);
}
