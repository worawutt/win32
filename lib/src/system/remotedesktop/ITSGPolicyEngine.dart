...
class ITSGPolicyEngine extends IUnknown {
  ...
  int IsQuarantineEnabled(Pointer<Int32> quarantineEnabled) =>
      ptr.ref.lpVtbl.value
              .elementAt(6)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Int32> quarantineEnabled)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> quarantineEnabled)>()(
          ptr.ref.lpVtbl, quarantineEnabled);
}
