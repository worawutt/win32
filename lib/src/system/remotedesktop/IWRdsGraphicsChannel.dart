...
class IWRdsGraphicsChannel extends IUnknown {
  ...
  int Write(int cbSize, Pointer<Uint8> pBuffer, Pointer<COMObject> pContext) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int cbSize, Pointer<Uint8> pBuffer,
                      Pointer<COMObject> pContext)>()(
          ptr.ref.lpVtbl, cbSize, pBuffer, pContext);
  ...
  int
      Open(Pointer<COMObject> pChannelEvents,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<COMObject> pChannelEvents,
                          Pointer<COMObject> pOpenContext)>()(
              ptr.ref.lpVtbl, pChannelEvents, pOpenContext);
}
