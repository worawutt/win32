...
class IRemoteDesktopClientActions extends IDispatch {
  ...
  int ExecuteRemoteAction(int remoteAction) => ptr.ref.lpVtbl.value
      .elementAt(9)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Int32 remoteAction)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int remoteAction)>()(ptr.ref.lpVtbl, remoteAction);

  int GetSnapshot(int snapshotEncoding, int snapshotFormat, int snapshotWidth,
          int snapshotHeight, Pointer<Pointer<Utf16>> snapshotData) =>
