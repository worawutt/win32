...
class IAudioOutputEndpointRT extends IUnknown {
  ...
  int GetOutputDataPointer(
          int u32FrameCount, Pointer<AE_CURRENT_POSITION> pAeTimeStamp) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          IntPtr Function(Pointer, Uint32 u32FrameCount,
                              Pointer<AE_CURRENT_POSITION> pAeTimeStamp)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int u32FrameCount,
                      Pointer<AE_CURRENT_POSITION> pAeTimeStamp)>()(
          ptr.ref.lpVtbl, u32FrameCount, pAeTimeStamp);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  void Function(Pointer,
                      Pointer<APO_CONNECTION_PROPERTY> pConnectionProperty)>()(
          ptr.ref.lpVtbl, pConnectionProperty);
