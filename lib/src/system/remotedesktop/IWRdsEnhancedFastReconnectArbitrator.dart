...
class IWRdsEnhancedFastReconnectArbitrator extends IUnknown {
  ...
  int GetSessionForEnhancedFastReconnect(Pointer<Int32> pSessionIdArray,
          int dwSessionCount, Pointer<Int32> pResultSessionId) =>
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> pSessionIdArray,
                      int dwSessionCount, Pointer<Int32> pResultSessionId)>()(
          ptr.ref.lpVtbl, pSessionIdArray, dwSessionCount, pResultSessionId);
}
