...
class ITsSbLoadBalancingNotifySink extends ITsSbBaseNotifySink {
  ...
  int OnGetMostSuitableTarget(
          Pointer<COMObject> pLBResult, int fIsNewConnection) =>
      ptr
              .ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<COMObject> pLBResult,
                              Int32 fIsNewConnection)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pLBResult,
                      int fIsNewConnection)>()(
          ptr.ref.lpVtbl, pLBResult, fIsNewConnection);
}
