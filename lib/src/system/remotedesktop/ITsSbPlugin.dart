...
class ITsSbPlugin extends IUnknown {
  ...
  int Initialize(Pointer<COMObject> pProvider, Pointer<COMObject> pNotifySink,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pNotifySink,
                      Pointer<COMObject> pPropertySet)>()(
          ptr.ref.lpVtbl, pProvider, pNotifySink, pPropertySet);

  int Terminate(int hr) => ptr.ref.lpVtbl.value
      .elementAt(4)
