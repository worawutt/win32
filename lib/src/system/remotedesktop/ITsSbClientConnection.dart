...
class ITsSbClientConnection extends IUnknown {
  ...
  int PutContext(Pointer<Utf16> contextId, VARIANT context,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> contextId,
                      VARIANT context, Pointer<VARIANT> existingContext)>()(
          ptr.ref.lpVtbl, contextId, context, existingContext);

  int GetContext(Pointer<Utf16> contextId, Pointer<VARIANT> context) => ptr
      .ref.lpVtbl.value
      .elementAt(9)
      .cast<
          Pointer<
      ...
      .asFunction<
          int Function(Pointer, Pointer<Utf16> contextId,
              Pointer<VARIANT> context)>()(ptr.ref.lpVtbl, contextId, context);
  ...
  Pointer<COMObject> get Environment {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppEnvironment)>()(
          ptr.ref.lpVtbl, retValuePtr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> ppVal)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> ppVal)>()(
          ptr.ref.lpVtbl, retValuePtr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> pRdFarmType)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int32> pRdFarmType)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  Pointer<Int8> get UserSidString {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Int8>> pszUserSidString)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  int GetDisconnectedSession(Pointer<Pointer<COMObject>> ppSession) => ptr
          .ref.lpVtbl.value
          .elementAt(17)
          .cast<
              Pointer<
          ...
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> ppSession)>()(
      ptr.ref.lpVtbl, ppSession);
}
