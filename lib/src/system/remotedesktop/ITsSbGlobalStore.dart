...
class ITsSbGlobalStore extends IUnknown {
  ...
  int QueryTarget(Pointer<Utf16> ProviderName, Pointer<Utf16> TargetName,
          Pointer<Utf16> FarmName, Pointer<Pointer<COMObject>> ppTarget) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> FarmName,
                      Pointer<Pointer<COMObject>> ppTarget)>()(
          ptr.ref.lpVtbl, ProviderName, TargetName, FarmName, ppTarget);

  int QuerySessionBySessionId(Pointer<Utf16> ProviderName, int dwSessionId,
          Pointer<Utf16> TargetName, Pointer<Pointer<COMObject>> ppSession) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> TargetName,
                      Pointer<Pointer<COMObject>> ppSession)>()(
          ptr.ref.lpVtbl, ProviderName, dwSessionId, TargetName, ppSession);

  int EnumerateFarms(Pointer<Utf16> ProviderName, Pointer<Uint32> pdwCount,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint32> pdwCount,
                      Pointer<Pointer<SAFEARRAY>> pVal)>()(
          ptr.ref.lpVtbl, ProviderName, pdwCount, pVal);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint32> pdwCount,
                      Pointer<Pointer<Pointer<COMObject>>> pVal)>()(
          ptr.ref.lpVtbl, ProviderName, FarmName, EnvName, pdwCount, pVal);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint32> pdwCount,
                      Pointer<Pointer<Pointer<COMObject>>> ppVal)>()(
          ptr.ref.lpVtbl, ProviderName, pdwCount, ppVal);
