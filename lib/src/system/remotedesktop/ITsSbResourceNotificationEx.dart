...
class ITsSbResourceNotificationEx extends IUnknown {
  ...
  int NotifySessionChangeEx(Pointer<Utf16> targetName, Pointer<Utf16> userName,
          Pointer<Utf16> domain, int sessionId, int sessionState) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> domain,
                      int sessionId,
                      int sessionState)>()(ptr.ref.lpVtbl, targetName, userName,
          domain, sessionId, sessionState);

  int NotifyTargetChangeEx(Pointer<Utf16> targetName, int targetChangeType) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
          ...
          ptr.ref.lpVtbl, targetName, targetChangeType);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> poolName,
                      Pointer<Utf16> targetName,
                      int connectionChangeType)>()(ptr.ref.lpVtbl, userName,
          domain, initialProgram, poolName, targetName, connectionChangeType);
}
