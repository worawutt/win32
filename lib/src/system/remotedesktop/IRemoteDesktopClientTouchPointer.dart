...
class IRemoteDesktopClientTouchPointer extends IDispatch {
  ...
  set EventsEnabled(int value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<Int32 Function(Pointer, Int16 eventsEnabled)>>>()
        .value
        .asFunction<
            int Function(Pointer, int eventsEnabled)>()(ptr.ref.lpVtbl, value);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int16> eventsEnabled)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int16> eventsEnabled)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  set PointerSpeed(int value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<Int32 Function(Pointer, Uint32 pointerSpeed)>>>()
        .value
        .asFunction<
            int Function(Pointer, int pointerSpeed)>()(ptr.ref.lpVtbl, value);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Uint32> pointerSpeed)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Uint32> pointerSpeed)>()(ptr.ref.lpVtbl, retValuePtr);
