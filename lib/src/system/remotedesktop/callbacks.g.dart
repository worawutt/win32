...
typedef PCHANNEL_INIT_EVENT_FN = Void Function(
    Pointer pInitHandle, Uint32 event, Pointer pData, Uint32 dataLength);
typedef PCHANNEL_OPEN_EVENT_FN = Void Function(Uint32 openHandle, Uint32 event,
    Pointer pData, Uint32 dataLength, Uint32 totalLength, Uint32 dataFlags);
typedef PVIRTUALCHANNELCLOSE = Uint32 Function(Uint32 openHandle);
...
typedef PVIRTUALCHANNELWRITE = Uint32 Function(
    Uint32 openHandle, Pointer pData, Uint32 dataLength, Pointer pUserData);
