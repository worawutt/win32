  ...
  set TerminalServicesProfilePath(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(Pointer, Pointer<Utf16> pNewVal)>>>()
            .value
            .asFunction<int Function(Pointer, Pointer<Utf16> pNewVal)>()(
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> pNewVal)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> pNewVal)>()(
          ptr.ref.lpVtbl, retValuePtr);
