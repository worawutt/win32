...
class IWTSBitmapRendererCallback extends IUnknown {
  ...
  int OnTargetSizeChanged(RECT rcNewSize) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, RECT rcNewSize)>>>()
      .value
      .asFunction<
          int Function(Pointer, RECT rcNewSize)>()(ptr.ref.lpVtbl, rcNewSize);
}
