...
class ITsSbProvider extends IUnknown {
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> EnvironmentName,
                      Pointer<Pointer<COMObject>> ppTarget)>()(
          ptr.ref.lpVtbl, TargetName, EnvironmentName, ppTarget);

  int CreateLoadBalanceResultObject(
          Pointer<Utf16> TargetName, Pointer<Pointer<COMObject>> ppLBResult) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> TargetName,
                      Pointer<Pointer<COMObject>> ppLBResult)>()(
          ptr.ref.lpVtbl, TargetName, ppLBResult);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int SessionId,
                      Pointer<Pointer<COMObject>> ppSession)>()(
          ptr.ref.lpVtbl, TargetName, UserName, Domain, SessionId, ppSession);

  int CreatePluginPropertySet(Pointer<Pointer<COMObject>> ppPropertySet) =>
      ptr.ref.lpVtbl.value
              .elementAt(6)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppPropertySet)>()(
          ptr.ref.lpVtbl, ppPropertySet);
  ...
  int CreateEnvironmentObject(Pointer<Utf16> Name, int ServerWeight,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> Name, int ServerWeight,
                      Pointer<Pointer<COMObject>> ppEnvironment)>()(
          ptr.ref.lpVtbl, Name, ServerWeight, ppEnvironment);

  int GetResourcePluginStore(Pointer<Pointer<COMObject>> ppStore) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
                  Pointer<
  ...
  int GetFilterPluginStore(Pointer<Pointer<COMObject>> ppStore) =>
      ptr.ref.lpVtbl.value
              .elementAt(10)
              .cast<
                  Pointer<
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int notificationType,
                      Pointer<Utf16> ResourceToMonitor,
                      Pointer<COMObject> pPluginNotification)>()(ptr.ref.lpVtbl,
          notificationType, ResourceToMonitor, pPluginNotification);

  int UnRegisterForNotification(
          int notificationType, Pointer<Utf16> ResourceToMonitor) =>
      ptr.ref.lpVtbl.value
              .elementAt(12)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint32 notificationType,
                              Pointer<Utf16> ResourceToMonitor)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int notificationType,
                      Pointer<Utf16> ResourceToMonitor)>()(
          ptr.ref.lpVtbl, notificationType, ResourceToMonitor);

  int GetInstanceOfGlobalStore(Pointer<Pointer<COMObject>> ppGlobalStore) => ptr
          .ref.lpVtbl.value
          .elementAt(13)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<COMObject>> ppGlobalStore)>()(
      ptr.ref.lpVtbl, ppGlobalStore);
