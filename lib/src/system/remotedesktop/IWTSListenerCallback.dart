...
class IWTSListenerCallback extends IUnknown {
  ...
  int OnNewChannelConnection(Pointer<COMObject> pChannel, Pointer<Utf16> data,
          Pointer<Int32> pbAccept, Pointer<Pointer<COMObject>> ppCallback) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Int32> pbAccept,
                      Pointer<Pointer<COMObject>> ppCallback)>()(
          ptr.ref.lpVtbl, pChannel, data, pbAccept, ppCallback);
}
