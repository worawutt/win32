...
class IProviderConverter extends IUnknown {
  ...
  int Initialize(Pointer<COMObject> pISyncProvider) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<COMObject> pISyncProvider)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> pISyncProvider)>()(
      ptr.ref.lpVtbl, pISyncProvider);
}
