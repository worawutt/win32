...
class ISyncChangeBatch extends ISyncChangeBatchBase {
  ...
  int EndUnorderedGroup(
          Pointer<COMObject> pMadeWithKnowledge, int fAllChangesForKnowledge) =>
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pMadeWithKnowledge,
                      int fAllChangesForKnowledge)>()(
          ptr.ref.lpVtbl, pMadeWithKnowledge, fAllChangesForKnowledge);
