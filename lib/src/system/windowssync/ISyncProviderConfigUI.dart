...
class ISyncProviderConfigUI extends IUnknown {
  ...
  int Init(Pointer<GUID> pguidInstanceId, Pointer<GUID> pguidContentType,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(Pointer,
                          Pointer<Pointer<COMObject>> ppConfigUIProperties)>()(
              ptr.ref.lpVtbl, ppConfigUIProperties);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pUnkContext,
                      Pointer<Pointer<COMObject>> ppProviderInfo)>()(
          ptr.ref.lpVtbl, hwndParent, pUnkContext, ppProviderInfo);

  int ModifySyncProvider(int hwndParent, Pointer<COMObject> pUnkContext,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pUnkContext,
                      Pointer<COMObject> pProviderInfo)>()(
          ptr.ref.lpVtbl, hwndParent, pUnkContext, pProviderInfo);
}
