...
class IEnumSyncProviderInfos extends IUnknown {
  ...
  int Next(int cInstances, Pointer<Pointer<COMObject>> ppSyncProviderInfo,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppSyncProviderInfo,
                      Pointer<Uint32> pcFetched)>()(
          ptr.ref.lpVtbl, cInstances, ppSyncProviderInfo, pcFetched);

  int Skip(int cInstances) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<NativeFunction<Int32 Function(Pointer, Uint32 cInstances)>>>()
      .value
      .asFunction<
          int Function(Pointer, int cInstances)>()(ptr.ref.lpVtbl, cInstances);
