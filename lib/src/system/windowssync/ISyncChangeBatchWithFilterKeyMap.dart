...
class ISyncChangeBatchWithFilterKeyMap extends IUnknown {
  ...
  int GetFilterKeyMap(Pointer<Pointer<COMObject>> ppIFilterKeyMap) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<COMObject>> ppIFilterKeyMap)>()(
      ptr.ref.lpVtbl, ppIFilterKeyMap);

  int SetFilterKeyMap(Pointer<COMObject> pIFilterKeyMap) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<COMObject> pIFilterKeyMap)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> pIFilterKeyMap)>()(
      ptr.ref.lpVtbl, pIFilterKeyMap);

  int SetFilterForgottenKnowledge(
          int dwFilterKey, Pointer<COMObject> pFilterForgottenKnowledge) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int dwFilterKey,
                      Pointer<COMObject> pFilterForgottenKnowledge)>()(
          ptr.ref.lpVtbl, dwFilterKey, pFilterForgottenKnowledge);
