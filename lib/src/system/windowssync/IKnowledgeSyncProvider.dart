...
class IKnowledgeSyncProvider extends ISyncProvider {
  ...
  int BeginSession(int role, Pointer<COMObject> pSessionState) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 role,
                              Pointer<COMObject> pSessionState)>>>()
              .value
              .asFunction<
                  int Function(
                      Pointer, int role, Pointer<COMObject> pSessionState)>()(
          ptr.ref.lpVtbl, role, pSessionState);

  int GetSyncBatchParameters(Pointer<Pointer<COMObject>> ppSyncKnowledge,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppSyncKnowledge,
                      Pointer<Uint32> pdwRequestedBatchSize)>()(
          ptr.ref.lpVtbl, ppSyncKnowledge, pdwRequestedBatchSize);
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              ...
                              Pointer<COMObject> pUnkDataRetriever,
                              Pointer<COMObject> pCallback,
                              Pointer<SYNC_SESSION_STATISTICS>
  ...
  int EndSession(Pointer<COMObject> pSessionState) =>
      ptr.ref.lpVtbl.value
              .elementAt(10)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<COMObject> pSessionState)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pSessionState)>()(
          ptr.ref.lpVtbl, pSessionState);
}
