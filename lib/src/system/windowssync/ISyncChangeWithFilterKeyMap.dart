...
class ISyncChangeWithFilterKeyMap extends IUnknown {
  ...
  int GetFilterCount(Pointer<Uint32> pdwFilterCount) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Uint32> pdwFilterCount)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> pdwFilterCount)>()(
          ptr.ref.lpVtbl, pdwFilterCount);

  int GetFilterChange(
          int dwFilterKey, Pointer<SYNC_FILTER_CHANGE> pFilterChange) =>
      ptr
              .ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint32 dwFilterKey,
                              Pointer<SYNC_FILTER_CHANGE> pFilterChange)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int dwFilterKey,
                      Pointer<SYNC_FILTER_CHANGE> pFilterChange)>()(
          ptr.ref.lpVtbl, dwFilterKey, pFilterChange);

  int GetAllChangeUnitsPresentFlag(Pointer<Int32> pfAllChangeUnitsPresent) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Int32> pfAllChangeUnitsPresent)>()(
          ptr.ref.lpVtbl, pfAllChangeUnitsPresent);

  int GetFilterForgottenKnowledge(int dwFilterKey,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>>
                          ppIFilterForgottenKnowledge)>()(
          ptr.ref.lpVtbl, dwFilterKey, ppIFilterForgottenKnowledge);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pNewMoveins,
                      Pointer<Pointer<COMObject>>
                          ppLearnedForgottenKnowledge)>()(ptr.ref.lpVtbl,
          pDestinationKnowledge, pNewMoveins, ppLearnedForgottenKnowledge);
