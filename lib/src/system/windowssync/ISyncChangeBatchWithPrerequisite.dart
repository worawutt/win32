...
class ISyncChangeBatchWithPrerequisite extends ISyncChangeBatchBase {
  ...
  int SetPrerequisiteKnowledge(Pointer<COMObject> pPrerequisiteKnowledge) => ptr
          .ref.lpVtbl.value
          .elementAt(17)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<COMObject> pPrerequisiteKnowledge)>()(
      ptr.ref.lpVtbl, pPrerequisiteKnowledge);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pDestinationKnowledge,
                      Pointer<Pointer<COMObject>>
                          ppLearnedWithPrerequisiteKnowledge)>()(ptr.ref.lpVtbl,
          pDestinationKnowledge, ppLearnedWithPrerequisiteKnowledge);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>>
                          ppLearnedForgottenKnowledge)>()(
          ptr.ref.lpVtbl, ppLearnedForgottenKnowledge);
}
