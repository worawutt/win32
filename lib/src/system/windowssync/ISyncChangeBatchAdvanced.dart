...
class ISyncChangeBatchAdvanced extends IUnknown {
  ...
  int GetFilterInfo(Pointer<Pointer<COMObject>> ppFilterInfo) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppFilterInfo)>()(
          ptr.ref.lpVtbl, ppFilterInfo);
  ...
  int ConvertFullEnumerationChangeBatchToRegularChangeBatch(
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppChangeBatch)>()(
          ptr.ref.lpVtbl, ppChangeBatch);

  int GetUpperBoundItemId(Pointer<Uint8> pbItemId, Pointer<Uint32> pcbIdSize) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(Pointer,
                          Pointer<Int32> pfBatchKnowledgeShouldBeApplied)>()(
              ptr.ref.lpVtbl, pfBatchKnowledgeShouldBeApplied);
}
