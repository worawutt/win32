...
class IEnumSyncChangeUnits extends IUnknown {
  ...
  int Next(int cChanges, Pointer<Pointer<COMObject>> ppChangeUnit,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppChangeUnit,
                      Pointer<Uint32> pcFetched)>()(
          ptr.ref.lpVtbl, cChanges, ppChangeUnit, pcFetched);

  int Skip(int cChanges) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Uint32 cChanges)>>>()
      .value
      .asFunction<
          int Function(Pointer, int cChanges)>()(ptr.ref.lpVtbl, cChanges);
