      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppSyncProviderConfigUIInfo,
                      Pointer<Uint32> pcFetched)>()(
          ptr.ref.lpVtbl, cFactories, ppSyncProviderConfigUIInfo, pcFetched);

  int Skip(int cFactories) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<NativeFunction<Int32 Function(Pointer, Uint32 cFactories)>>>()
      .value
      .asFunction<
          int Function(Pointer, int cFactories)>()(ptr.ref.lpVtbl, cFactories);
