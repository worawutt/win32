...
class ISyncProviderRegistration extends IUnknown {
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer,
                              Pointer<SyncProviderConfigUIConfiguration>
                                  pConfigUIConfig,
                              Pointer<Pointer<COMObject>> ppConfigUIInfo)>>>()
              .value
              .asFunction<
                  int Function(
                      ...
                      Pointer<SyncProviderConfigUIConfiguration> pConfigUIConfig,
                      Pointer<Pointer<COMObject>> ppConfigUIInfo)>()(
          ptr.ref.lpVtbl, pConfigUIConfig, ppConfigUIInfo);

  int UnregisterSyncProviderConfigUI(Pointer<GUID> pguidInstanceId) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<GUID> pguidInstanceId)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<GUID> pguidInstanceId)>()(
          ptr.ref.lpVtbl, pguidInstanceId);
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer,
                              Pointer<SyncProviderConfiguration>
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<SyncProviderConfiguration> pProviderConfiguration,
                      Pointer<Pointer<COMObject>> ppProviderInfo)>()(
          ptr.ref.lpVtbl, pProviderConfiguration, ppProviderInfo);

  int UnregisterSyncProvider(Pointer<GUID> pguidInstanceId) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
  ...
  int GetSyncProviderConfigUIInfoforProvider(
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<GUID> pguidProviderInstanceId,
                      Pointer<Pointer<COMObject>> ppProviderConfigUIInfo)>()(
          ptr.ref.lpVtbl, pguidProviderInstanceId, ppProviderConfigUIInfo);
  ...
  int GetSyncProviderInfo(Pointer<GUID> pguidInstanceId,
          Pointer<Pointer<COMObject>> ppProviderInfo) =>
      ptr.ref.lpVtbl.value
              .elementAt(10)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<GUID> pguidInstanceId,
                              Pointer<Pointer<COMObject>> ppProviderInfo)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<GUID> pguidInstanceId,
                      Pointer<Pointer<COMObject>> ppProviderInfo)>()(
          ptr.ref.lpVtbl, pguidInstanceId, ppProviderInfo);

  int GetSyncProviderFromInstanceId(Pointer<GUID> pguidInstanceId,
          int dwClsContext, Pointer<Pointer<COMObject>> ppSyncProvider) =>
      ptr.ref.lpVtbl.value
              .elementAt(11)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      int dwClsContext,
                      Pointer<Pointer<COMObject>> ppSyncProvider)>()(
          ptr.ref.lpVtbl, pguidInstanceId, dwClsContext, ppSyncProvider);

  int GetSyncProviderConfigUIInfo(Pointer<GUID> pguidInstanceId,
          Pointer<Pointer<COMObject>> ppConfigUIInfo) =>
      ptr.ref.lpVtbl.value
              .elementAt(12)
              .cast<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<GUID> pguidInstanceId,
                      Pointer<Pointer<COMObject>> ppConfigUIInfo)>()(
          ptr.ref.lpVtbl, pguidInstanceId, ppConfigUIInfo);

  int GetSyncProviderConfigUIFromInstanceId(Pointer<GUID> pguidInstanceId,
          int dwClsContext, Pointer<Pointer<COMObject>> ppConfigUI) =>
      ptr.ref.lpVtbl.value
              .elementAt(13)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      int dwClsContext,
                      Pointer<Pointer<COMObject>> ppConfigUI)>()(
          ptr.ref.lpVtbl, pguidInstanceId, dwClsContext, ppConfigUI);

  int GetSyncProviderState(
          Pointer<GUID> pguidInstanceId, Pointer<Uint32> pdwStateFlags) =>
      ptr.ref.lpVtbl.value
              .elementAt(14)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<GUID> pguidInstanceId,
                      Pointer<Uint32> pdwStateFlags)>()(
          ptr.ref.lpVtbl, pguidInstanceId, pdwStateFlags);

  int SetSyncProviderState(Pointer<GUID> pguidInstanceId, int dwStateFlagsMask,
          int dwStateFlags) =>
      ptr.ref.lpVtbl.value
              .elementAt(15)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<GUID> pguidInstanceId,
                              Uint32 dwStateFlagsMask, Uint32 dwStateFlags)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<GUID> pguidInstanceId,
                      int dwStateFlagsMask, int dwStateFlags)>()(
          ptr.ref.lpVtbl, pguidInstanceId, dwStateFlagsMask, dwStateFlags);

  int RegisterForEvent(Pointer<IntPtr> phEvent) => ptr.ref.lpVtbl.value
          .elementAt(16)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<IntPtr> phEvent)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<IntPtr> phEvent)>()(
      ptr.ref.lpVtbl, phEvent);

  int RevokeEvent(int hEvent) => ptr.ref.lpVtbl.value
      .elementAt(17)
  ...
  int GetChange(int hEvent, Pointer<Pointer<COMObject>> ppChange) => ptr
          .ref.lpVtbl.value
          .elementAt(18)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, IntPtr hEvent,
                          Pointer<Pointer<COMObject>> ppChange)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer, int hEvent, Pointer<Pointer<COMObject>> ppChange)>()(
      ptr.ref.lpVtbl, hEvent, ppChange);
}
