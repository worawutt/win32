          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(
                          ...
                          int cClockVectorElements,
                          Pointer<Pointer<COMObject>> ppiClockVectorElements,
                          Pointer<Uint32> pcFetched)>()(ptr.ref.lpVtbl,
              cClockVectorElements, ppiClockVectorElements, pcFetched);

  int Skip(int cSyncVersions) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Uint32 cSyncVersions)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int cSyncVersions)>()(ptr.ref.lpVtbl, cSyncVersions);
