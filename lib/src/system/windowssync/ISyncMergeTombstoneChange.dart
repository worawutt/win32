...
class ISyncMergeTombstoneChange extends IUnknown {
  ...
  int GetWinnerItemId(
          Pointer<Uint8> pbWinnerItemId, Pointer<Uint32> pcbIdSize) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Uint8> pbWinnerItemId,
                              Pointer<Uint32> pcbIdSize)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint8> pbWinnerItemId,
                      Pointer<Uint32> pcbIdSize)>()(
          ptr.ref.lpVtbl, pbWinnerItemId, pcbIdSize);
}
