...
class IChangeUnitListFilterInfo extends ISyncFilterInfo {
  ...
  int Initialize(
          Pointer<Pointer<Uint8>> ppbChangeUnitIds, int dwChangeUnitCount) =>
      ptr
              .ref.lpVtbl.value
              .elementAt(4)
              .cast<
          ...
          ptr.ref.lpVtbl, ppbChangeUnitIds, dwChangeUnitCount);

  int GetChangeUnitIdCount(Pointer<Uint32> pdwChangeUnitIdCount) => ptr
          .ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Uint32> pdwChangeUnitIdCount)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Uint32> pdwChangeUnitIdCount)>()(
      ptr.ref.lpVtbl, pdwChangeUnitIdCount);

  int GetChangeUnitId(int dwChangeUnitIdIndex, Pointer<Uint8> pbChangeUnitId,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint8> pbChangeUnitId,
                      Pointer<Uint32> pcbIdSize)>()(
          ptr.ref.lpVtbl, dwChangeUnitIdIndex, pbChangeUnitId, pcbIdSize);
}
