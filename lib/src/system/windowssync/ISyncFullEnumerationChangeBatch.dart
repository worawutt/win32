      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>>
                          ppLearnedKnowledgeAfterRecoveryComplete)>()(
          ptr.ref.lpVtbl, ppLearnedKnowledgeAfterRecoveryComplete);

  int GetClosedLowerBoundItemId(
          Pointer<Uint8> pbClosedLowerBoundItemId, Pointer<Uint32> pcbIdSize) =>
      ptr.ref.lpVtbl.value
              .elementAt(18)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint8> pbClosedLowerBoundItemId,
                      Pointer<Uint32> pcbIdSize)>()(
          ptr.ref.lpVtbl, pbClosedLowerBoundItemId, pcbIdSize);

  int GetClosedUpperBoundItemId(
          Pointer<Uint8> pbClosedUpperBoundItemId, Pointer<Uint32> pcbIdSize) =>
      ptr.ref.lpVtbl.value
              .elementAt(19)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint8> pbClosedUpperBoundItemId,
                      Pointer<Uint32> pcbIdSize)>()(
          ptr.ref.lpVtbl, pbClosedUpperBoundItemId, pcbIdSize);
}
