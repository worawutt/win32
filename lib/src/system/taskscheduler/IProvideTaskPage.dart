...
class IProvideTaskPage extends IUnknown {
  ...
  int
      GetPage(int tpType, int fPersistChanges, Pointer<IntPtr> phPage) =>
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, int tpType, int fPersistChanges,
                          Pointer<IntPtr> phPage)>()(
              ptr.ref.lpVtbl, tpType, fPersistChanges, phPage);
}
