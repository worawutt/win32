...
class ITriggerCollection extends IDispatch {
  ...
  int get_Item(int index, Pointer<Pointer<COMObject>> ppTrigger) => ptr
          .ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, int index, Pointer<Pointer<COMObject>> ppTrigger)>()(
      ptr.ref.lpVtbl, index, ppTrigger);
  ...
  int Create(int type, Pointer<Pointer<COMObject>> ppTrigger) => ptr
          .ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, int type, Pointer<Pointer<COMObject>> ppTrigger)>()(
      ptr.ref.lpVtbl, type, ppTrigger);
