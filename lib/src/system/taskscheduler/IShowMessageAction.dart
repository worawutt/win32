  ...
  set Title(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(Pointer, Pointer<Utf16> title)>>>()
            .value
            .asFunction<int Function(Pointer, Pointer<Utf16> title)>()(
  ...
  Pointer<Utf16> get MessageBody {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> pMessageBody)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set MessageBody(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(Pointer, Pointer<Utf16> messageBody)>>>()
            .value
            .asFunction<int Function(Pointer, Pointer<Utf16> messageBody)>()(
        ptr.ref.lpVtbl, value);
