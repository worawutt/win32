...
class IExecAction2 extends IExecAction {
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Int16> pHideAppWindow)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int16> pHideAppWindow)>()(
  ...
  set HideAppWindow(int value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<Int32 Function(Pointer, Int16 hideAppWindow)>>>()
        .value
        .asFunction<
            int Function(Pointer, int hideAppWindow)>()(ptr.ref.lpVtbl, value);
