...
class ITaskNamedValueCollection extends IDispatch {
  ...
  int get_Item(int index, Pointer<Pointer<COMObject>> ppPair) => ptr
          .ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, int index, Pointer<Pointer<COMObject>> ppPair)>()(
      ptr.ref.lpVtbl, index, ppPair);
  ...
  int Create(Pointer<Utf16> name, Pointer<Utf16> value,
          Pointer<Pointer<COMObject>> ppPair) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> value,
                      Pointer<Pointer<COMObject>> ppPair)>()(
          ptr.ref.lpVtbl, name, value, ppPair);
