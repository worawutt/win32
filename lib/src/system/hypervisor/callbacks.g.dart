...
typedef FOUND_IMAGE_CALLBACK = Int32 Function(
    Pointer Context, Pointer<DOS_IMAGE_INFO> ImageInfo);
...
typedef HDV_PCI_DEVICE_INITIALIZE = Int32 Function(Pointer deviceContext);
...
typedef HDV_PCI_DEVICE_START = Int32 Function(Pointer deviceContext);
typedef HDV_PCI_DEVICE_STOP = Void Function(Pointer deviceContext);
typedef HDV_PCI_DEVICE_TEARDOWN = Void Function(Pointer deviceContext);
typedef HDV_PCI_READ_CONFIG_SPACE = Int32 Function(
    Pointer deviceContext, Uint32 offset, Pointer<Uint32> value);
typedef HDV_PCI_READ_INTERCEPTED_MEMORY = Int32 Function(Pointer deviceContext,
    Int32 barIndex, Uint64 offset, Uint64 length, Pointer<Uint8> value);
typedef HDV_PCI_WRITE_CONFIG_SPACE = Int32 Function(
    Pointer deviceContext, Uint32 offset, Uint32 value);
typedef HDV_PCI_WRITE_INTERCEPTED_MEMORY = Int32 Function(Pointer deviceContext,
    Int32 barIndex, Uint64 offset, Uint64 length, Pointer<Uint8> value);
...
typedef WHV_EMULATOR_IO_PORT_CALLBACK = Int32 Function(
    Pointer Context, Pointer<WHV_EMULATOR_IO_ACCESS_INFO> IoAccess);
typedef WHV_EMULATOR_MEMORY_CALLBACK = Int32 Function(
    Pointer Context, Pointer<WHV_EMULATOR_MEMORY_ACCESS_INFO> MemoryAccess);
