      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int appWindow, Pointer<GUID> riid,
                      Pointer<Pointer> accountsSettingsPane)>()(
          ptr.ref.lpVtbl, appWindow, riid, accountsSettingsPane);

  int
      ShowManageAccountsForWindowAsync(int appWindow, Pointer<GUID> riid,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(Pointer, int appWindow, Pointer<GUID> riid,
                          Pointer<Pointer> asyncAction)>()(
              ptr.ref.lpVtbl, appWindow, riid, asyncAction);

  int
      ShowAddAccountForWindowAsync(int appWindow, Pointer<GUID> riid,
              Pointer<Pointer> asyncAction) =>
          ptr.ref.lpVtbl.value
                  .elementAt(8)
                  .cast<
