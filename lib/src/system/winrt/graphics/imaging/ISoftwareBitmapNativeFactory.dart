...
class ISoftwareBitmapNativeFactory extends IInspectable {
  ...
  int CreateFromWICBitmap(Pointer<COMObject> data, int forceReadOnly,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> riid,
                      Pointer<Pointer> ppv)>()(
          ptr.ref.lpVtbl, data, forceReadOnly, riid, ppv);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<MFVideoArea> minDisplayAperture,
                      Pointer<GUID> riid,
                      Pointer<Pointer> ppv)>()(ptr.ref.lpVtbl, data, subtype,
          width, height, forceReadOnly, minDisplayAperture, riid, ppv);
}
