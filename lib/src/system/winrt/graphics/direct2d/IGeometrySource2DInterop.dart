...
class IGeometrySource2DInterop extends IUnknown {
  ...
  int GetGeometry(Pointer<Pointer<COMObject>> value) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int TryGetGeometryUsingFactory(
          Pointer<COMObject> factory, Pointer<Pointer<COMObject>> value) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
