...
class ISurfaceImageSourceNativeWithD2D extends IUnknown {
  ...
  int SetDevice(Pointer<COMObject> device) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> device)>()(
      ptr.ref.lpVtbl, device);

  int BeginDraw(Pointer<RECT> updateRect, Pointer<GUID> iid,
          Pointer<Pointer> updateObject, Pointer<POINT> offset) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer> updateObject,
                      Pointer<POINT> offset)>()(
          ptr.ref.lpVtbl, updateRect, iid, updateObject, offset);
