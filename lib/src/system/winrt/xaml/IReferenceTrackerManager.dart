...
class IReferenceTrackerManager extends IUnknown {
  ...
  int FindTrackerTargetsCompleted(int findFailed) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<NativeFunction<Int32 Function(Pointer, Uint8 findFailed)>>>()
      .value
      .asFunction<
          int Function(Pointer, int findFailed)>()(ptr.ref.lpVtbl, findFailed);
  ...
  int SetReferenceTrackerHost(Pointer<COMObject> value) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
