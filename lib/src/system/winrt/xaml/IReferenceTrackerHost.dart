...
class IReferenceTrackerHost extends IUnknown {
  ...
  int DisconnectUnusedReferenceSources(int options) => ptr.ref.lpVtbl.value
      .elementAt(3)
  ...
  int GetTrackerTarget(Pointer<COMObject> unknown,
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<COMObject> unknown,
                              Pointer<Pointer<COMObject>> newReference)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> unknown,
                      Pointer<Pointer<COMObject>> newReference)>()(
          ptr.ref.lpVtbl, unknown, newReference);

  int AddMemoryPressure(int bytesAllocated) => ptr.ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Uint64 bytesAllocated)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int bytesAllocated)>()(ptr.ref.lpVtbl, bytesAllocated);

  int RemoveMemoryPressure(int bytesAllocated) => ptr.ref.lpVtbl.value
      .elementAt(8)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Uint64 bytesAllocated)>>>()
