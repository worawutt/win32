...
class ISwapChainPanelNative2 extends ISwapChainPanelNative {
  ...
  int SetSwapChainHandle(int swapChainHandle) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, IntPtr swapChainHandle)>>>()
          .value
          .asFunction<int Function(Pointer, int swapChainHandle)>()(
      ptr.ref.lpVtbl, swapChainHandle);
}
