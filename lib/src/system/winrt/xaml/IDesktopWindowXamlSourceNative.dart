...
class IDesktopWindowXamlSourceNative extends IUnknown {
  ...
  int AttachToWindow(int parentWnd) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<NativeFunction<Int32 Function(Pointer, IntPtr parentWnd)>>>()
      .value
      .asFunction<
          int Function(Pointer, int parentWnd)>()(ptr.ref.lpVtbl, parentWnd);
