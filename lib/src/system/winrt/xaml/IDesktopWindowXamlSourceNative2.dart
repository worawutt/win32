...
class IDesktopWindowXamlSourceNative2 extends IDesktopWindowXamlSourceNative {
  ...
  int PreTranslateMessage(Pointer<MSG> message, Pointer<Int32> result) => ptr
      .ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Pointer<MSG> message, Pointer<Int32> result)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<MSG> message,
              Pointer<Int32> result)>()(ptr.ref.lpVtbl, message, result);
}
