...
class IIsolatedEnvironmentInterop extends IUnknown {
  ...
  int GetHostHwndInterop(int containerHwnd, Pointer<IntPtr> hostHwnd) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, IntPtr containerHwnd,
                              Pointer<IntPtr> hostHwnd)>>>()
              .value
              .asFunction<
                  int Function(
                      Pointer, int containerHwnd, Pointer<IntPtr> hostHwnd)>()(
          ptr.ref.lpVtbl, containerHwnd, hostHwnd);
}
