...
void HSTRING_UserFree(Pointer<Uint32> param0, Pointer<IntPtr> param1) =>
    _HSTRING_UserFree(param0, param1);
...
late final _HSTRING_UserFree =
    _api_ms_win_core_winrt_string_l1_1_0.lookupFunction<
        ...
        void Function(Pointer<Uint32> param0,
            Pointer<IntPtr> param1)>('HSTRING_UserFree');

void HSTRING_UserFree64(Pointer<Uint32> param0, Pointer<IntPtr> param1) =>
    _HSTRING_UserFree64(param0, param1);

late final _HSTRING_UserFree64 =
    _api_ms_win_core_winrt_string_l1_1_0.lookupFunction<
        Void Function(Pointer<Uint32> param0, Pointer<IntPtr> param1),
        void Function(Pointer<Uint32> param0,
            Pointer<IntPtr> param1)>('HSTRING_UserFree64');

Pointer<Uint8> HSTRING_UserMarshal(Pointer<Uint32> param0,
        Pointer<Uint8> param1, Pointer<IntPtr> param2) =>
    _HSTRING_UserMarshal(param0, param1, param2);
...
late final _HSTRING_UserMarshal =
    _api_ms_win_core_winrt_string_l1_1_0.lookupFunction<
        ...
        Pointer<Uint8> Function(Pointer<Uint32> param0, Pointer<Uint8> param1,
            Pointer<IntPtr> param2)>('HSTRING_UserMarshal');

Pointer<Uint8> HSTRING_UserMarshal64(Pointer<Uint32> param0,
        Pointer<Uint8> param1, Pointer<IntPtr> param2) =>
    _HSTRING_UserMarshal64(param0, param1, param2);
...
late final _HSTRING_UserMarshal64 =
    _api_ms_win_core_winrt_string_l1_1_0.lookupFunction<
        Pointer<Uint8> Function(Pointer<Uint32> param0, Pointer<Uint8> param1,
            Pointer<IntPtr> param2),
        Pointer<Uint8> Function(Pointer<Uint32> param0, Pointer<Uint8> param1,
            Pointer<IntPtr> param2)>('HSTRING_UserMarshal64');

int HSTRING_UserSize(
        Pointer<Uint32> param0, int param1, Pointer<IntPtr> param2) =>
    _HSTRING_UserSize(param0, param1, param2);
...
late final _HSTRING_UserSize =
    _api_ms_win_core_winrt_string_l1_1_0.lookupFunction<
        ...
        int Function(Pointer<Uint32> param0, int param1,
            Pointer<IntPtr> param2)>('HSTRING_UserSize');

int HSTRING_UserSize64(
        Pointer<Uint32> param0, int param1, Pointer<IntPtr> param2) =>
    _HSTRING_UserSize64(param0, param1, param2);
...
late final _HSTRING_UserSize64 =
    _api_ms_win_core_winrt_string_l1_1_0.lookupFunction<
        Uint32 Function(
            Pointer<Uint32> param0, Uint32 param1, Pointer<IntPtr> param2),
        int Function(Pointer<Uint32> param0, int param1,
            Pointer<IntPtr> param2)>('HSTRING_UserSize64');

Pointer<Uint8> HSTRING_UserUnmarshal(Pointer<Uint32> param0,
        Pointer<Uint8> param1, Pointer<IntPtr> param2) =>
    _HSTRING_UserUnmarshal(param0, param1, param2);
...
late final _HSTRING_UserUnmarshal =
    _api_ms_win_core_winrt_string_l1_1_0.lookupFunction<
        Pointer<Uint8> Function(Pointer<Uint32> param0, Pointer<Uint8> param1,
            Pointer<IntPtr> param2),
        Pointer<Uint8> Function(Pointer<Uint32> param0, Pointer<Uint8> param1,
            Pointer<IntPtr> param2)>('HSTRING_UserUnmarshal');

Pointer<Uint8> HSTRING_UserUnmarshal64(Pointer<Uint32> param0,
        Pointer<Uint8> param1, Pointer<IntPtr> param2) =>
    _HSTRING_UserUnmarshal64(param0, param1, param2);
...
late final _HSTRING_UserUnmarshal64 =
    _api_ms_win_core_winrt_string_l1_1_0.lookupFunction<
        Pointer<Uint8> Function(Pointer<Uint32> param0, Pointer<Uint8> param1,
            Pointer<IntPtr> param2),
        Pointer<Uint8> Function(Pointer<Uint32> param0, Pointer<Uint8> param1,
            Pointer<IntPtr> param2)>('HSTRING_UserUnmarshal64');
...
int WindowsCreateStringReference(Pointer<Utf16> sourceString, int length,
        Pointer<HSTRING_HEADER> hstringHeader, Pointer<IntPtr> string) =>
...
late final _WindowsCreateStringReference =
    _api_ms_win_core_winrt_string_l1_1_0.lookupFunction<
        ...
        int Function(
            ...
            Pointer<IntPtr> string)>('WindowsCreateStringReference');
...
late final _WindowsInspectString =
    _api_ms_win_core_winrt_string_l1_1_0.lookupFunction<
        ...
        int Function(
            ...
            Pointer context,
            Pointer<Uint32> length,
            Pointer<IntPtr> targetStringAddress)>('WindowsInspectString');
...
late final _RoRegisterActivationFactories =
    _api_ms_win_core_winrt_l1_1_0.lookupFunction<
        ...
        int Function(
            ...
            Pointer<IntPtr> activationFactoryCallbacks,
            int count,
            Pointer<IntPtr> cookie)>('RoRegisterActivationFactories');

int RoRegisterForApartmentShutdown(Pointer<COMObject> callbackObject,
        Pointer<Uint64> apartmentIdentifier, Pointer<IntPtr> regCookie) =>
    _RoRegisterForApartmentShutdown(
        callbackObject, apartmentIdentifier, regCookie);

late final _RoRegisterForApartmentShutdown =
    _api_ms_win_core_winrt_l1_1_0.lookupFunction<
        Int32 Function(Pointer<COMObject> callbackObject,
            Pointer<Uint64> apartmentIdentifier, Pointer<IntPtr> regCookie),
        int Function(
            Pointer<COMObject> callbackObject,
            Pointer<Uint64> apartmentIdentifier,
            Pointer<IntPtr> regCookie)>('RoRegisterForApartmentShutdown');

void RoRevokeActivationFactories(int cookie) =>
    _RoRevokeActivationFactories(cookie);

late final _RoRevokeActivationFactories = _api_ms_win_core_winrt_l1_1_0
    .lookupFunction<Void Function(IntPtr cookie), void Function(int cookie)>(
...
int RoUnregisterForApartmentShutdown(int regCookie) =>
    _RoUnregisterForApartmentShutdown(regCookie);

late final _RoUnregisterForApartmentShutdown =
    _api_ms_win_core_winrt_l1_1_0.lookupFunction<
        Int32 Function(IntPtr regCookie),
        int Function(int regCookie)>('RoUnregisterForApartmentShutdown');
...
int RoGetBufferMarshaler(Pointer<Pointer<COMObject>> bufferMarshaler) =>
    _RoGetBufferMarshaler(bufferMarshaler);

late final _RoGetBufferMarshaler =
    _api_ms_win_core_winrt_robuffer_l1_1_0.lookupFunction<
            Int32 Function(Pointer<Pointer<COMObject>> bufferMarshaler),
            int Function(Pointer<Pointer<COMObject>> bufferMarshaler)>(
...
int RoCaptureErrorContext(int hr) => _RoCaptureErrorContext(hr);

late final _RoCaptureErrorContext = _api_ms_win_core_winrt_error_l1_1_0
    .lookupFunction<Int32 Function(Int32 hr), int Function(int hr)>(
        'RoCaptureErrorContext');

void RoFailFastWithErrorContext(int hrError) =>
    _RoFailFastWithErrorContext(hrError);

late final _RoFailFastWithErrorContext = _api_ms_win_core_winrt_error_l1_1_0
    .lookupFunction<Void Function(Int32 hrError), void Function(int hrError)>(
        'RoFailFastWithErrorContext');

int RoGetErrorReportingFlags(Pointer<Uint32> pflags) =>
    _RoGetErrorReportingFlags(pflags);

late final _RoGetErrorReportingFlags =
    _api_ms_win_core_winrt_error_l1_1_0.lookupFunction<
        Int32 Function(Pointer<Uint32> pflags),
        int Function(Pointer<Uint32> pflags)>('RoGetErrorReportingFlags');

int RoOriginateError(int error, int cchMax, Pointer<Utf16> message) =>
    _RoOriginateError(error, cchMax, message);

late final _RoOriginateError =
    _api_ms_win_core_winrt_error_l1_1_0.lookupFunction<
        Int32 Function(Int32 error, Uint32 cchMax, Pointer<Utf16> message),
        int Function(int error, int cchMax,
            Pointer<Utf16> message)>('RoOriginateErrorW');

int RoResolveRestrictedErrorInfoReference(Pointer<Utf16> reference,
        Pointer<Pointer<COMObject>> ppRestrictedErrorInfo) =>
    _RoResolveRestrictedErrorInfoReference(reference, ppRestrictedErrorInfo);

late final _RoResolveRestrictedErrorInfoReference =
    _api_ms_win_core_winrt_error_l1_1_0.lookupFunction<
            Int32 Function(Pointer<Utf16> reference,
                Pointer<Pointer<COMObject>> ppRestrictedErrorInfo),
            int Function(Pointer<Utf16> reference,
                Pointer<Pointer<COMObject>> ppRestrictedErrorInfo)>(
        'RoResolveRestrictedErrorInfoReference');

int RoSetErrorReportingFlags(int flags) => _RoSetErrorReportingFlags(flags);

late final _RoSetErrorReportingFlags = _api_ms_win_core_winrt_error_l1_1_0
    .lookupFunction<Int32 Function(Uint32 flags), int Function(int flags)>(
        'RoSetErrorReportingFlags');

int RoTransformError(
        int oldError, int newError, int cchMax, Pointer<Utf16> message) =>
    _RoTransformError(oldError, newError, cchMax, message);

late final _RoTransformError =
    _api_ms_win_core_winrt_error_l1_1_0.lookupFunction<
        Int32 Function(Int32 oldError, Int32 newError, Uint32 cchMax,
            Pointer<Utf16> message),
        int Function(int oldError, int newError, int cchMax,
            Pointer<Utf16> message)>('RoTransformErrorW');

int SetRestrictedErrorInfo(Pointer<COMObject> pRestrictedErrorInfo) =>
    _SetRestrictedErrorInfo(pRestrictedErrorInfo);

late final _SetRestrictedErrorInfo =
    _api_ms_win_core_winrt_error_l1_1_0.lookupFunction<
        Int32 Function(Pointer<COMObject> pRestrictedErrorInfo),
        int Function(
            Pointer<COMObject> pRestrictedErrorInfo)>('SetRestrictedErrorInfo');
...
int RoGetMatchingRestrictedErrorInfo(
        int hrIn, Pointer<Pointer<COMObject>> ppRestrictedErrorInfo) =>
    _RoGetMatchingRestrictedErrorInfo(hrIn, ppRestrictedErrorInfo);

late final _RoGetMatchingRestrictedErrorInfo =
    _api_ms_win_core_winrt_error_l1_1_1.lookupFunction<
            Int32 Function(
                Int32 hrIn, Pointer<Pointer<COMObject>> ppRestrictedErrorInfo),
            int Function(
                int hrIn, Pointer<Pointer<COMObject>> ppRestrictedErrorInfo)>(
...
int RoInspectCapturedStackBackTrace(
    ...
    _RoInspectCapturedStackBackTrace(targetErrorInfoAddress, machine,
        readMemoryCallback, context, frameCount, targetBackTraceAddress);
...
late final _RoInspectCapturedStackBackTrace =
    _api_ms_win_core_winrt_error_l1_1_1.lookupFunction<
            Int32 Function(
                ...
                Uint16 machine,
                Pointer<NativeFunction<PINSPECT_MEMORY_CALLBACK>>
                    readMemoryCallback,
                Pointer context,
                Pointer<Uint32> frameCount,
                Pointer<IntPtr> targetBackTraceAddress),
...
int RoInspectThreadErrorInfo(
    ...
    _RoInspectThreadErrorInfo(targetTebAddress, machine, readMemoryCallback,
        context, targetErrorInfoAddress);
...
int RoOriginateLanguageException(
        int error, int message, Pointer<COMObject> languageException) =>
    _RoOriginateLanguageException(error, message, languageException);

late final _RoOriginateLanguageException = _api_ms_win_core_winrt_error_l1_1_1
    .lookupFunction<
            Int32 Function(Int32 error, IntPtr message,
                Pointer<COMObject> languageException),
            int Function(
                int error, int message, Pointer<COMObject> languageException)>(
        'RoOriginateLanguageException');

int RoReportFailedDelegate(Pointer<COMObject> punkDelegate,
        Pointer<COMObject> pRestrictedErrorInfo) =>
    _RoReportFailedDelegate(punkDelegate, pRestrictedErrorInfo);

late final _RoReportFailedDelegate =
    _api_ms_win_core_winrt_error_l1_1_1.lookupFunction<
        Int32 Function(Pointer<COMObject> punkDelegate,
            Pointer<COMObject> pRestrictedErrorInfo),
        int Function(Pointer<COMObject> punkDelegate,
            Pointer<COMObject> pRestrictedErrorInfo)>('RoReportFailedDelegate');

int RoReportUnhandledError(Pointer<COMObject> pRestrictedErrorInfo) =>
    _RoReportUnhandledError(pRestrictedErrorInfo);
...
void RoFreeParameterizedTypeExtra(int extra) =>
    _RoFreeParameterizedTypeExtra(extra);

late final _RoFreeParameterizedTypeExtra =
    _api_ms_win_core_winrt_roparameterizediid_l1_1_0.lookupFunction<
        Void Function(IntPtr extra),
        void Function(int extra)>('RoFreeParameterizedTypeExtra');
...
int RoGetParameterizedTypeInstanceIID(
    ...
    _RoGetParameterizedTypeInstanceIID(
        nameElementCount, nameElements, metaDataLocator, iid, pExtra);
...
late final _RoGetParameterizedTypeInstanceIID =
    _api_ms_win_core_winrt_roparameterizediid_l1_1_0.lookupFunction<
        ...
        int Function(
            ...
            Pointer<COMObject> metaDataLocator,
            Pointer<GUID> iid,
            Pointer<IntPtr> pExtra)>('RoGetParameterizedTypeInstanceIID');

Pointer<Utf8> RoParameterizedTypeExtraGetTypeSignature(int extra) =>
    _RoParameterizedTypeExtraGetTypeSignature(extra);

late final _RoParameterizedTypeExtraGetTypeSignature =
    _api_ms_win_core_winrt_roparameterizediid_l1_1_0.lookupFunction<
        Pointer<Utf8> Function(IntPtr extra),
        Pointer<Utf8> Function(
            int extra)>('RoParameterizedTypeExtraGetTypeSignature');
...
int RoGetServerActivatableClasses(int serverName,
        Pointer<Pointer<IntPtr>> activatableClassIds, Pointer<Uint32> count) =>
    _RoGetServerActivatableClasses(serverName, activatableClassIds, count);
...
late final _RoGetServerActivatableClasses =
    _api_ms_win_core_winrt_registration_l1_1_0.lookupFunction<
        ...
        int Function(
            int serverName,
            Pointer<Pointer<IntPtr>> activatableClassIds,
            Pointer<Uint32> count)>('RoGetServerActivatableClasses');
...
int CreateRandomAccessStreamOnFile(Pointer<Utf16> filePath, int accessMode,
        Pointer<GUID> riid, Pointer<Pointer> ppv) =>
    _CreateRandomAccessStreamOnFile(filePath, accessMode, riid, ppv);

late final _CreateRandomAccessStreamOnFile =
    _api_ms_win_shcore_stream_winrt_l1_1_0.lookupFunction<
        Int32 Function(Pointer<Utf16> filePath, Uint32 accessMode,
            Pointer<GUID> riid, Pointer<Pointer> ppv),
        int Function(
            Pointer<Utf16> filePath,
            int accessMode,
            Pointer<GUID> riid,
            Pointer<Pointer> ppv)>('CreateRandomAccessStreamOnFile');

int CreateRandomAccessStreamOverStream(Pointer<COMObject> stream, int options,
        Pointer<GUID> riid, Pointer<Pointer> ppv) =>
    _CreateRandomAccessStreamOverStream(stream, options, riid, ppv);

late final _CreateRandomAccessStreamOverStream =
    _api_ms_win_shcore_stream_winrt_l1_1_0.lookupFunction<
        Int32 Function(Pointer<COMObject> stream, Int32 options,
            Pointer<GUID> riid, Pointer<Pointer> ppv),
        int Function(Pointer<COMObject> stream, int options, Pointer<GUID> riid,
            Pointer<Pointer> ppv)>('CreateRandomAccessStreamOverStream');

int CreateStreamOverRandomAccessStream(Pointer<COMObject> randomAccessStream,
        Pointer<GUID> riid, Pointer<Pointer> ppv) =>
    _CreateStreamOverRandomAccessStream(randomAccessStream, riid, ppv);

late final _CreateStreamOverRandomAccessStream =
    _api_ms_win_shcore_stream_winrt_l1_1_0.lookupFunction<
        Int32 Function(Pointer<COMObject> randomAccessStream,
            Pointer<GUID> riid, Pointer<Pointer> ppv),
        int Function(Pointer<COMObject> randomAccessStream, Pointer<GUID> riid,
            Pointer<Pointer> ppv)>('CreateStreamOverRandomAccessStream');
