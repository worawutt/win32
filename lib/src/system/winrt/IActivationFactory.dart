...
class IActivationFactory extends IInspectable {
  ...
  int ActivateInstance(Pointer<Pointer<COMObject>> instance) => ptr
          .ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> instance)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> instance)>()(
      ptr.ref.lpVtbl, instance);
}
