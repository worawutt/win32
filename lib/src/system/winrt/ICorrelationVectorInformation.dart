...
class ICorrelationVectorInformation extends IInspectable {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<IntPtr> cv)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<IntPtr> cv)>()(
  ...
  set NextCorrelationVectorForThread(int value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(8)
        .cast<Pointer<NativeFunction<Int32 Function(Pointer, IntPtr cv)>>>()
        .value
        .asFunction<int Function(Pointer, int cv)>()(ptr.ref.lpVtbl, value);
