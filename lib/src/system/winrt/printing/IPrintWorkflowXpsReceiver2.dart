...
class IPrintWorkflowXpsReceiver2 extends IPrintWorkflowXpsReceiver {
  ...
  int Failed(int XpsError) => ptr.ref.lpVtbl.value
      .elementAt(8)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 XpsError)>>>()
      .value
      .asFunction<
          int Function(Pointer, int XpsError)>()(ptr.ref.lpVtbl, XpsError);
}
