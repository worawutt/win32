...
class IPrintWorkflowObjectModelSourceFileContentNative extends IUnknown {
  ...
  int StartXpsOMGeneration(Pointer<COMObject> receiver) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> receiver)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> receiver)>()(
      ptr.ref.lpVtbl, receiver);
