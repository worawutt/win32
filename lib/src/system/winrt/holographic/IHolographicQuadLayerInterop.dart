// IHolographicQuadLayerInterop.dart
...
/// @nodoc
const IID_IHolographicQuadLayerInterop =
...
class IHolographicQuadLayerInterop extends IInspectable {
  ...
  IHolographicQuadLayerInterop(Pointer<COMObject> ptr) : super(ptr);

  int
      CreateDirect3D12ContentBufferResource(
              Pointer<COMObject> pDevice,
              Pointer<D3D12_RESOURCE_DESC> pTexture2DDesc,
              Pointer<Pointer<COMObject>> ppTexture2DResource) =>
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(
                          ...
                          Pointer<D3D12_RESOURCE_DESC> pTexture2DDesc,
                          Pointer<Pointer<COMObject>> ppTexture2DResource)>()(
              ptr.ref.lpVtbl, pDevice, pTexture2DDesc, ppTexture2DResource);
