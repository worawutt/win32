...
class IUserActivityRequestManagerInterop extends IInspectable {
  ...
  int GetForWindow(int window, Pointer<GUID> iid, Pointer<Pointer> value) => ptr
      .ref.lpVtbl.value
      .elementAt(6)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, IntPtr window, Pointer<GUID> iid,
                      Pointer<Pointer> value)>>>()
      .value
      .asFunction<
          int Function(Pointer, int window, Pointer<GUID> iid,
              Pointer<Pointer> value)>()(ptr.ref.lpVtbl, window, iid, value);
}
