...
class IRoMetaDataLocator {
  ...
  int Locate(
          Pointer<Utf16> nameElement, Pointer<COMObject> metaDataDestination) =>
      ptr.ref.lpVtbl.value
              .elementAt(0)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> nameElement,
                              Pointer<COMObject> metaDataDestination)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> nameElement,
                      Pointer<COMObject> metaDataDestination)>()(
          ptr.ref.lpVtbl, nameElement, metaDataDestination);
}
