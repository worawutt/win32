...
class IApartmentShutdown extends IUnknown {
  ...
  void OnUninitialize(int ui64ApartmentIdentifier) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Void Function(
                              Pointer, Uint64 ui64ApartmentIdentifier)>>>()
              .value
              .asFunction<
                  void Function(Pointer, int ui64ApartmentIdentifier)>()(
          ptr.ref.lpVtbl, ui64ApartmentIdentifier);
}
