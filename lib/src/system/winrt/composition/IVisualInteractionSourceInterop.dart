...
class IVisualInteractionSourceInterop extends IUnknown {
  ...
  int TryRedirectForManipulation(Pointer<POINTER_INFO> pointerInfo) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<POINTER_INFO> pointerInfo)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<POINTER_INFO> pointerInfo)>()(
          ptr.ref.lpVtbl, pointerInfo);
}
