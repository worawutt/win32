...
class IPlayToManagerInterop extends IInspectable {
  ...
  int GetForWindow(
          int appWindow, Pointer<GUID> riid, Pointer<Pointer> playToManager) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int appWindow, Pointer<GUID> riid,
                      Pointer<Pointer> playToManager)>()(
          ptr.ref.lpVtbl, appWindow, riid, playToManager);

  int ShowPlayToUIForWindow(int appWindow) => ptr.ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<NativeFunction<Int32 Function(Pointer, IntPtr appWindow)>>>()
      .value
      .asFunction<
          int Function(Pointer, int appWindow)>()(ptr.ref.lpVtbl, appWindow);
}
