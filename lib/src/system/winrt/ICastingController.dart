...
class ICastingController extends IUnknown {
  ...
  int
      Initialize(Pointer<COMObject> castingEngine,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<COMObject> castingEngine,
                          Pointer<COMObject> castingSource)>()(
              ptr.ref.lpVtbl, castingEngine, castingSource);
  ...
  int Advise(Pointer<COMObject> eventHandler, Pointer<Uint32> cookie) => ptr
      .ref.lpVtbl.value
      .elementAt(6)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> eventHandler,
                      Pointer<Uint32> cookie)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<COMObject> eventHandler,
              Pointer<Uint32> cookie)>()(ptr.ref.lpVtbl, eventHandler, cookie);
