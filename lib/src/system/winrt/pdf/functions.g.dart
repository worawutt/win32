...
int PdfCreateRenderer(
        Pointer<COMObject> pDevice, Pointer<Pointer<COMObject>> ppRenderer) =>
    _PdfCreateRenderer(pDevice, ppRenderer);

late final _PdfCreateRenderer = _windows_data_pdf.lookupFunction<
    Int32 Function(
        Pointer<COMObject> pDevice, Pointer<Pointer<COMObject>> ppRenderer),
    int Function(Pointer<COMObject> pDevice,
        Pointer<Pointer<COMObject>> ppRenderer)>('PdfCreateRenderer');
