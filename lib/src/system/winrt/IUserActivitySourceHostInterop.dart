...
class IUserActivitySourceHostInterop extends IInspectable {
  ...
  int SetActivitySourceHost(int activitySourceHost) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, IntPtr activitySourceHost)>>>()
          .value
          .asFunction<int Function(Pointer, int activitySourceHost)>()(
      ptr.ref.lpVtbl, activitySourceHost);
}
