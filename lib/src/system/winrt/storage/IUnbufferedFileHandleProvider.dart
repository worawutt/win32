...
class IUnbufferedFileHandleProvider extends IUnknown {
  ...
  int OpenUnbufferedFileHandle(
          Pointer<COMObject> oplockBreakCallback, Pointer<IntPtr> fileHandle) =>
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> oplockBreakCallback,
                      Pointer<IntPtr> fileHandle)>()(
          ptr.ref.lpVtbl, oplockBreakCallback, fileHandle);
