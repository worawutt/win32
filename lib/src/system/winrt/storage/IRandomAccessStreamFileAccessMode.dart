...
class IRandomAccessStreamFileAccessMode extends IUnknown {
  ...
  int GetMode(Pointer<Uint32> fileAccessMode) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Uint32> fileAccessMode)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> fileAccessMode)>()(
          ptr.ref.lpVtbl, fileAccessMode);
}
