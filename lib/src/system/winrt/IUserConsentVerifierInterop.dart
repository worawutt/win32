...
class IUserConsentVerifierInterop extends IInspectable {
  ...
  int RequestVerificationForWindowAsync(int appWindow, int message,
          Pointer<GUID> riid, Pointer<Pointer> asyncOperation) =>
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int appWindow, int message,
                      Pointer<GUID> riid, Pointer<Pointer> asyncOperation)>()(
          ptr.ref.lpVtbl, appWindow, message, riid, asyncOperation);
}
