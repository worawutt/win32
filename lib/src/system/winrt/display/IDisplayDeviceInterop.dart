      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int Name,
                      Pointer<IntPtr> pHandle)>()(
          ptr.ref.lpVtbl, pObject, pSecurityAttributes, Access, Name, pHandle);

  int OpenSharedHandle(int NTHandle, GUID riid, Pointer<Pointer> ppvObj) => ptr
          .ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, IntPtr NTHandle, GUID riid,
                          Pointer<Pointer> ppvObj)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer, int NTHandle, GUID riid, Pointer<Pointer> ppvObj)>()(
