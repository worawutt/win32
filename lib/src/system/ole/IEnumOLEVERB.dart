...
/// @nodoc
const IID_IEnumOLEVERB = '{00000104-0000-0000-C000-000000000046}';

/// {@category Interface}
/// {@category com}
class IEnumOLEVERB extends IUnknown {
  // vtable begins at 3, is 4 entries long.
  IEnumOLEVERB(Pointer<COMObject> ptr) : super(ptr);

  int Next(int celt, Pointer<OLEVERB> rgelt, Pointer<Uint32> pceltFetched) =>
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer,
                              Uint32 celt,
                              Pointer<OLEVERB> rgelt,
                              Pointer<Uint32> pceltFetched)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int celt, Pointer<OLEVERB> rgelt,
                      Pointer<Uint32> pceltFetched)>()(
