...
/// @nodoc
const IID_IPicture2 = '{F5185DD8-2012-4B0B-AAD9-F052C6BD482B}';

/// {@category Interface}
/// {@category com}
class IPicture2 extends IUnknown {
  // vtable begins at 3, is 14 entries long.
  IPicture2(Pointer<COMObject> ptr) : super(ptr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<IntPtr> phPal)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<IntPtr> phPal)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  int set_hPal(int hPal) => ptr.ref.lpVtbl.value
      .elementAt(9)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, IntPtr hPal)>>>()
      .value
  ...
  int SelectPicture(
          int hDCIn, Pointer<IntPtr> phDCOut, Pointer<IntPtr> phBmpOut) =>
      ptr
              .ref.lpVtbl.value
              .elementAt(11)
              .cast<
