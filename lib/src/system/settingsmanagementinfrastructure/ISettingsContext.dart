...
class ISettingsContext extends IUnknown {
  ...
  int Serialize(Pointer<COMObject> pStream, Pointer<COMObject> pTarget) => ptr
      .ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
      ...
      .asFunction<
          int Function(Pointer, Pointer<COMObject> pStream,
              Pointer<COMObject> pTarget)>()(ptr.ref.lpVtbl, pStream, pTarget);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<Pointer<COMObject>>> pppResults,
                      Pointer<IntPtr> pcResultCount)>()(
          ptr.ref.lpVtbl, pStream, pTarget, pppResults, pcResultCount);

  int SetUserData(Pointer pUserData) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<NativeFunction<Int32 Function(Pointer, Pointer pUserData)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, Pointer pUserData)>()(ptr.ref.lpVtbl, pUserData);

  int GetUserData(Pointer<Pointer> pUserData) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Pointer> pUserData)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Pointer> pUserData)>()(
      ptr.ref.lpVtbl, pUserData);

  int GetNamespaces(Pointer<Pointer<COMObject>> ppNamespaceIds) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppNamespaceIds)>()(
          ptr.ref.lpVtbl, ppNamespaceIds);
  ...
  int RevertSetting(Pointer<COMObject> pIdentity, Pointer<Utf16> pwzSetting) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<COMObject> pIdentity,
                              Pointer<Utf16> pwzSetting)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pIdentity,
                      Pointer<Utf16> pwzSetting)>()(
          ptr.ref.lpVtbl, pIdentity, pwzSetting);
}
