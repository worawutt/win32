...
typedef LPMAPIDELETEMAIL = Uint32 Function(IntPtr lhSession, IntPtr ulUIParam,
    Pointer<Utf8> lpszMessageID, Uint32 flFlags, Uint32 ulReserved);
typedef LPMAPIDETAILS = Uint32 Function(IntPtr lhSession, IntPtr ulUIParam,
    Pointer<MapiRecipDesc> lpRecip, Uint32 flFlags, Uint32 ulReserved);
...
typedef LPMAPIFREEBUFFER = Uint32 Function(Pointer pv);
typedef LPMAPILOGOFF = Uint32 Function(
    IntPtr lhSession, IntPtr ulUIParam, Uint32 flFlags, Uint32 ulReserved);
...
typedef LPMAPISENDDOCUMENTS = Uint32 Function(
    ...
    Uint32 ulReserved);
typedef LPMAPISENDMAIL = Uint32 Function(IntPtr lhSession, IntPtr ulUIParam,
    Pointer<MapiMessage> lpMessage, Uint32 flFlags, Uint32 ulReserved);
typedef LPMAPISENDMAILW = Uint32 Function(IntPtr lhSession, IntPtr ulUIParam,
    Pointer<MapiMessage> lpMessage, Uint32 flFlags, Uint32 ulReserved);
