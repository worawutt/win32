...
class IWSCProductList extends IDispatch {
  ...
  int Initialize(int provider) => ptr.ref.lpVtbl.value
      .elementAt(7)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 provider)>>>()
      .value
      .asFunction<
          int Function(Pointer, int provider)>()(ptr.ref.lpVtbl, provider);
  ...
  int get_Item(int index, Pointer<Pointer<COMObject>> pVal) => ptr
      .ref.lpVtbl.value
      .elementAt(9)
      .cast<
          Pointer<
