...
class IWSCDefaultProduct extends IDispatch {
  ...
  int SetDefaultProduct(int eType, Pointer<Utf16> pGuid) => ptr.ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Int32 eType, Pointer<Utf16> pGuid)>>>()
          .value
          .asFunction<int Function(Pointer, int eType, Pointer<Utf16> pGuid)>()(
      ptr.ref.lpVtbl, eType, pGuid);
}
