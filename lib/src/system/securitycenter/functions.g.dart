...
int WscGetAntiMalwareUri(Pointer<Pointer<Utf16>> ppszUri) =>
    _WscGetAntiMalwareUri(ppszUri);

late final _WscGetAntiMalwareUri = _wscapi.lookupFunction<
    Int32 Function(Pointer<Pointer<Utf16>> ppszUri),
    int Function(Pointer<Pointer<Utf16>> ppszUri)>('WscGetAntiMalwareUri');

int WscGetSecurityProviderHealth(int Providers, Pointer<Int32> pHealth) =>
    _WscGetSecurityProviderHealth(Providers, pHealth);

late final _WscGetSecurityProviderHealth = _wscapi.lookupFunction<
    Int32 Function(Uint32 Providers, Pointer<Int32> pHealth),
    int Function(
        int Providers, Pointer<Int32> pHealth)>('WscGetSecurityProviderHealth');
...
int WscRegisterForChanges(
    ...
    _WscRegisterForChanges(
        Reserved, phCallbackRegistration, lpCallbackAddress, pContext);
...
late final _WscRegisterForChanges = _wscapi.lookupFunction<
    ...
    int Function(
        ...
        Pointer<IntPtr> phCallbackRegistration,
        Pointer<NativeFunction<LPTHREAD_START_ROUTINE>> lpCallbackAddress,
        Pointer pContext)>('WscRegisterForChanges');
...
int WscUnRegisterChanges(int hRegistrationHandle) =>
    _WscUnRegisterChanges(hRegistrationHandle);

late final _WscUnRegisterChanges = _wscapi.lookupFunction<
    Int32 Function(IntPtr hRegistrationHandle),
    int Function(int hRegistrationHandle)>('WscUnRegisterChanges');
