...
int RegConnectRegistryEx(Pointer<Utf16> lpMachineName, int hKey, int Flags,
        Pointer<IntPtr> phkResult) =>
    _RegConnectRegistryEx(lpMachineName, hKey, Flags, phkResult);

late final _RegConnectRegistryEx = _advapi32.lookupFunction<
    Int32 Function(Pointer<Utf16> lpMachineName, IntPtr hKey, Uint32 Flags,
        Pointer<IntPtr> phkResult),
    int Function(Pointer<Utf16> lpMachineName, int hKey, int Flags,
        Pointer<IntPtr> phkResult)>('RegConnectRegistryExW');
...
late final _RegGetKeySecurity = _advapi32.lookupFunction<
    ...
    int Function(
        ...
        int SecurityInformation,
        Pointer<SECURITY_DESCRIPTOR> pSecurityDescriptor,
        Pointer<Uint32> lpcbSecurityDescriptor)>('RegGetKeySecurity');
...
int RegSetKeySecurity(int hKey, int SecurityInformation,
        Pointer<SECURITY_DESCRIPTOR> pSecurityDescriptor) =>
    _RegSetKeySecurity(hKey, SecurityInformation, pSecurityDescriptor);

late final _RegSetKeySecurity = _advapi32.lookupFunction<
    Uint32 Function(IntPtr hKey, Uint32 SecurityInformation,
        Pointer<SECURITY_DESCRIPTOR> pSecurityDescriptor),
    int Function(int hKey, int SecurityInformation,
        Pointer<SECURITY_DESCRIPTOR> pSecurityDescriptor)>('RegSetKeySecurity');
