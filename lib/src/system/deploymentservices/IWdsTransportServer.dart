...
class IWdsTransportServer extends IDispatch {
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer,
                              Pointer<Pointer<COMObject>>
                                  ppWdsTransportNamespaceManager)>>>()
              .value
              .asFunction<
                  int Function(
                      Pointer,
  ...
  int DisconnectClient(int ulClientId, int DisconnectionType) => ptr
          .ref.lpVtbl.value
          .elementAt(11)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Uint32 ulClientId,
                          Int32 DisconnectionType)>>>()
          .value
          .asFunction<
              int Function(Pointer, int ulClientId, int DisconnectionType)>()(
      ptr.ref.lpVtbl, ulClientId, DisconnectionType);
}
