      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Uint32> pulMinimumClients)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> pulMinimumClients)>()(
  ...
  set MinimumClients(int value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(Pointer, Uint32 ulMinimumClients)>>>()
            .value
            .asFunction<int Function(Pointer, int ulMinimumClients)>()(
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Double> pStartTime)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Double> pStartTime)>()(ptr.ref.lpVtbl, retValuePtr);
