  ...
  Pointer<Utf16> get FileName {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> pbszFileName)>()(
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Uint32> pulTimeout)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Uint32> pulTimeout)>()(ptr.ref.lpVtbl, retValuePtr);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Uint64> pul64CurrentOffset)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint64> pul64CurrentOffset)>()(
          ptr.ref.lpVtbl, retValuePtr);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Uint64> pul64FileSize)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint64> pul64FileSize)>()(
          ptr.ref.lpVtbl, retValuePtr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Uint32> pulBlockSize)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Uint32> pulBlockSize)>()(ptr.ref.lpVtbl, retValuePtr);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Uint32> pulWindowSize)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> pulWindowSize)>()(
          ptr.ref.lpVtbl, retValuePtr);
