...
class IWdsTransportDiagnosticsPolicy extends IWdsTransportCacheable {
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Uint32> pulComponents)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> pulComponents)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set Components(int value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<Int32 Function(Pointer, Uint32 ulComponents)>>>()
        .value
        .asFunction<
            int Function(Pointer, int ulComponents)>()(ptr.ref.lpVtbl, value);
