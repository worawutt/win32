...
class IWdsTransportSetupManager extends IDispatch {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Uint64> pullVersion)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Uint64> pullVersion)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  int get InstalledFeatures {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Uint32> pulInstalledFeatures)>()(
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Uint32> pulProtocols)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Uint32> pulProtocols)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  int DeregisterContentProvider(Pointer<Utf16> bszName) => ptr.ref.lpVtbl.value
          .elementAt(11)
          .cast<
              Pointer<
                  NativeFunction<
