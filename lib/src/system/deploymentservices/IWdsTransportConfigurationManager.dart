...
class IWdsTransportConfigurationManager extends IDispatch {
  ...
  int get_WdsTransportServicesRunning(
          int bRealtimeStatus, Pointer<Int16> pbServicesRunning) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int16 bRealtimeStatus,
                              Pointer<Int16> pbServicesRunning)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int bRealtimeStatus,
                      Pointer<Int16> pbServicesRunning)>()(
          ptr.ref.lpVtbl, bRealtimeStatus, pbServicesRunning);
  ...
  int NotifyWdsTransportServices(int ServiceNotification) => ptr
          .ref.lpVtbl.value
          .elementAt(15)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 ServiceNotification)>>>()
          .value
          .asFunction<int Function(Pointer, int ServiceNotification)>()(
      ptr.ref.lpVtbl, ServiceNotification);
}
