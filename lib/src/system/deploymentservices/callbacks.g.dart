...
typedef PFN_WdsCliCallback = Void Function(
    Uint32 dwMessageId, IntPtr wParam, IntPtr lParam, Pointer pvUserData);
...
typedef PFN_WdsTransportClientReceiveMetadata = Void Function(
    IntPtr hSessionKey, Pointer pCallerData, Pointer pMetadata, Uint32 ulSize);
typedef PFN_WdsTransportClientSessionComplete = Void Function(
    IntPtr hSessionKey, Pointer pCallerData, Uint32 dwError);
...
typedef PFN_WdsTransportClientSessionStart = Void Function(
    IntPtr hSessionKey, Pointer pCallerData, Pointer<Uint64> ullFileSize);
typedef PFN_WdsTransportClientSessionStartEx = Void Function(IntPtr hSessionKey,
    Pointer pCallerData, Pointer<TRANSPORTCLIENT_SESSION_INFO> Info);
