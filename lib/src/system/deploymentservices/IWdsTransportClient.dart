...
class IWdsTransportClient extends IDispatch {
  ...
  Pointer<Utf16> get MacAddress {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> pbszMacAddress)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  Pointer<Utf16> get IpAddress {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> pbszIpAddress)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  int get PercentCompletion {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Uint32> pulPercentCompletion)>()(
          ptr.ref.lpVtbl, retValuePtr);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Uint32> pulJoinDuration)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> pulJoinDuration)>()(
          ptr.ref.lpVtbl, retValuePtr);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Uint32> pulCpuUtilization)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> pulCpuUtilization)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  int get MemoryUtilization {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Uint32> pulMemoryUtilization)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  int get NetworkUtilization {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Uint32> pulNetworkUtilization)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  Pointer<Utf16> get UserIdentity {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> pbszUserIdentity)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  int Disconnect(int DisconnectionType) => ptr.ref.lpVtbl.value
          .elementAt(18)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 DisconnectionType)>>>()
          .value
          .asFunction<int Function(Pointer, int DisconnectionType)>()(
      ptr.ref.lpVtbl, DisconnectionType);
}
