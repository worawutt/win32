...
class IWdsTransportNamespaceManager extends IDispatch {
  ...
  int RetrieveNamespace(Pointer<Utf16> bszNamespaceName,
          Pointer<Pointer<COMObject>> ppWdsTransportNamespace) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bszNamespaceName,
                      Pointer<Pointer<COMObject>> ppWdsTransportNamespace)>()(
          ptr.ref.lpVtbl, bszNamespaceName, ppWdsTransportNamespace);
