...
int CloseDesktop(int hDesktop) => _CloseDesktop(hDesktop);

late final _CloseDesktop = _user32.lookupFunction<
    Int32 Function(IntPtr hDesktop),
    int Function(int hDesktop)>('CloseDesktop');

int CloseWindowStation(int hWinSta) => _CloseWindowStation(hWinSta);

late final _CloseWindowStation = _user32.lookupFunction<
    Int32 Function(IntPtr hWinSta),
    int Function(int hWinSta)>('CloseWindowStation');
...
int EnumDesktops(int hwinsta,
        Pointer<NativeFunction<DESKTOPENUMPROCW>> lpEnumFunc, int lParam) =>
    _EnumDesktops(hwinsta, lpEnumFunc, lParam);

late final _EnumDesktops = _user32.lookupFunction<
    Int32 Function(IntPtr hwinsta,
        Pointer<NativeFunction<DESKTOPENUMPROCW>> lpEnumFunc, IntPtr lParam),
    int Function(
        int hwinsta,
        Pointer<NativeFunction<DESKTOPENUMPROCW>> lpEnumFunc,
        int lParam)>('EnumDesktopsW');

int EnumWindowStations(
        Pointer<NativeFunction<WINSTAENUMPROCW>> lpEnumFunc, int lParam) =>
    _EnumWindowStations(lpEnumFunc, lParam);

late final _EnumWindowStations = _user32.lookupFunction<
    Int32 Function(
        Pointer<NativeFunction<WINSTAENUMPROCW>> lpEnumFunc, IntPtr lParam),
    int Function(Pointer<NativeFunction<WINSTAENUMPROCW>> lpEnumFunc,
        int lParam)>('EnumWindowStationsW');
...
int SetProcessWindowStation(int hWinSta) => _SetProcessWindowStation(hWinSta);

late final _SetProcessWindowStation = _user32.lookupFunction<
    Int32 Function(IntPtr hWinSta),
    int Function(int hWinSta)>('SetProcessWindowStation');

int SetThreadDesktop(int hDesktop) => _SetThreadDesktop(hDesktop);

late final _SetThreadDesktop = _user32.lookupFunction<
    Int32 Function(IntPtr hDesktop),
    int Function(int hDesktop)>('SetThreadDesktop');
