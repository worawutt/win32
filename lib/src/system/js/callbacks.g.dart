...
typedef JsBackgroundWorkItemCallback = Void Function(Pointer callbackState);
typedef JsBeforeCollectCallback = Void Function(Pointer callbackState);
typedef JsFinalizeCallback = Void Function(Pointer data);
typedef JsMemoryAllocationCallback = Bool Function(
    Pointer callbackState, Int32 allocationEvent, IntPtr allocationSize);
