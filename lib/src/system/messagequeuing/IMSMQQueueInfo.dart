...
/// @nodoc
const IID_IMSMQQueueInfo = '{D7D6E07B-DCCD-11D0-AA4B-0060970DEBAE}';

/// {@category Interface}
/// {@category com}
class IMSMQQueueInfo extends IDispatch {
  // vtable begins at 7, is 30 entries long.
  IMSMQQueueInfo(Pointer<COMObject> ptr) : super(ptr);
...
/// @nodoc
const CLSID_MSMQQueueInfo = '{D7D6E07C-DCCD-11D0-AA4B-0060970DEBAE}';

/// {@category com}
class MSMQQueueInfo extends IMSMQQueueInfo {
  MSMQQueueInfo(Pointer<COMObject> ptr) : super(ptr);

  factory MSMQQueueInfo.createInstance() {
    final ptr = calloc<COMObject>();
    final clsid = calloc<GUID>()..ref.setGUID(CLSID_MSMQQueueInfo);
    final iid = calloc<GUID>()..ref.setGUID(IID_IMSMQQueueInfo);
