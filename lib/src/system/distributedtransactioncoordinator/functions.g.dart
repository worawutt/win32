...
int DtcGetTransactionManager(
    ...
    _DtcGetTransactionManager(i_pszHost, i_pszTmName, i_riid, i_dwReserved1,
        i_wcbReserved2, i_pvReserved2, o_ppvObject);
...
late final _DtcGetTransactionManager = _xolehlp.lookupFunction<
    ...
    int Function(
        ...
        int i_wcbReserved2,
        Pointer i_pvReserved2,
        Pointer<Pointer> o_ppvObject)>('DtcGetTransactionManager');
...
int DtcGetTransactionManagerC(
        ...
        Pointer i_pvReserved2,
        Pointer<Pointer> o_ppvObject) =>
    _DtcGetTransactionManagerC(i_pszHost, i_pszTmName, i_riid, i_dwReserved1,
        i_wcbReserved2, i_pvReserved2, o_ppvObject);
...
late final _DtcGetTransactionManagerC = _xolehlp.lookupFunction<
    ...
    int Function(
        ...
        int i_wcbReserved2,
        Pointer i_pvReserved2,
        Pointer<Pointer> o_ppvObject)>('DtcGetTransactionManagerC');
...
int DtcGetTransactionManagerEx(
        ...
        Pointer<Pointer> o_ppvObject) =>
    _DtcGetTransactionManagerEx(i_pwszHost, i_pwszTmName, i_riid, i_grfOptions,
        i_pvConfigParams, o_ppvObject);
...
late final _DtcGetTransactionManagerEx = _xolehlp.lookupFunction<
    ...
    int Function(
        ...
        int i_grfOptions,
        Pointer i_pvConfigParams,
        Pointer<Pointer> o_ppvObject)>('DtcGetTransactionManagerExW');
