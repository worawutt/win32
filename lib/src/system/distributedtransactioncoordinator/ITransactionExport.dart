...
class ITransactionExport extends IUnknown {
  ...
  int Export(Pointer<COMObject> punkTransaction,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> punkTransaction,
                      Pointer<Uint32> pcbTransactionCookie)>()(
          ptr.ref.lpVtbl, punkTransaction, pcbTransactionCookie);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int cbTransactionCookie,
                      Pointer<Uint8> rgbTransactionCookie,
                      Pointer<Uint32> pcbUsed)>()(ptr.ref.lpVtbl,
          punkTransaction, cbTransactionCookie, rgbTransactionCookie, pcbUsed);
}
