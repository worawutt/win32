      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Int32> pisoLevel,
                      Pointer<xid_t> pXid,
                      Pointer<Pointer<COMObject>> ppEnlist)>()(ptr.ref.lpVtbl,
          pTransaction, pResAsync, pUOW, pisoLevel, pXid, ppEnlist);

  int Reenlist2(Pointer<xid_t> pXid, int dwTimeout, Pointer<Int32> pXactStat) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<xid_t> pXid,
                              Uint32 dwTimeout, Pointer<Int32> pXactStat)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<xid_t> pXid, int dwTimeout,
                      Pointer<Int32> pXactStat)>()(
          ptr.ref.lpVtbl, pXid, dwTimeout, pXactStat);
}
