...
class ITransactionLastEnlistmentAsync extends IUnknown {
  ...
  int TransactionOutcome(int XactStat, Pointer<BOID> pboidReason) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 XactStat,
                          Pointer<BOID> pboidReason)>>>()
          .value
          .asFunction<
              int Function(Pointer, int XactStat, Pointer<BOID> pboidReason)>()(
      ptr.ref.lpVtbl, XactStat, pboidReason);
}
