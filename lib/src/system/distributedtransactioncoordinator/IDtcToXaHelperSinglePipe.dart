...
class IDtcToXaHelperSinglePipe extends IUnknown {
  ...
  int XARMCreate(Pointer<Utf8> pszDSN, Pointer<Utf8> pszClientDll,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf8> pszClientDll,
                      Pointer<Uint32> pdwRMCookie)>()(
          ptr.ref.lpVtbl, pszDSN, pszClientDll, pdwRMCookie);

  int ConvertTridToXID(
          Pointer<Uint32> pdwITrans, int dwRMCookie, Pointer<xid_t> pxid) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Uint32> pdwITrans,
                              Uint32 dwRMCookie, Pointer<xid_t> pxid)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> pdwITrans,
                      int dwRMCookie, Pointer<xid_t> pxid)>()(
          ptr.ref.lpVtbl, pdwITrans, dwRMCookie, pxid);
  ...
  void ReleaseRMCookie(int i_dwRMCookie, int i_fNormal) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Void Function(
                          Pointer, Uint32 i_dwRMCookie, Int32 i_fNormal)>>>()
          .value
          .asFunction<
              void Function(Pointer, int i_dwRMCookie, int i_fNormal)>()(
      ptr.ref.lpVtbl, i_dwRMCookie, i_fNormal);
}
