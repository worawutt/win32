...
class IDtcLuRecoveryInitiatedByLu extends IUnknown {
  ...
  int GetObjectToHandleWorkFromLu(Pointer<Pointer<COMObject>> ppWork) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<COMObject>> ppWork)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<COMObject>> ppWork)>()(
          ptr.ref.lpVtbl, ppWork);
}
