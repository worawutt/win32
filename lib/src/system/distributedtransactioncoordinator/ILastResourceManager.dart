...
class ILastResourceManager extends IUnknown {
  ...
  int TransactionCommitted(Pointer<Uint8> pPrepInfo, int cbPrepInfo) => ptr
      .ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Pointer<Uint8> pPrepInfo, Uint32 cbPrepInfo)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<Uint8> pPrepInfo,
              int cbPrepInfo)>()(ptr.ref.lpVtbl, pPrepInfo, cbPrepInfo);
