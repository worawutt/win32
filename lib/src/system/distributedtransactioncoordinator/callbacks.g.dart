...
typedef DTC_INSTALL_CLIENT = Int32 Function(Pointer<Int8> i_pszRemoteTmHostName,
    Uint32 i_dwProtocol, Uint32 i_dwOverwrite);
typedef XA_CLOSE_EPT = Int32 Function(
    Pointer<Utf8> param0, Int32 param1, Int32 param2);
typedef XA_COMMIT_EPT = Int32 Function(
    Pointer<xid_t> param0, Int32 param1, Int32 param2);
typedef XA_COMPLETE_EPT = Int32 Function(
    Pointer<Int32> param0, Pointer<Int32> param1, Int32 param2, Int32 param3);
...
typedef XA_RECOVER_EPT = Int32 Function(
    Pointer<xid_t> param0, Int32 param1, Int32 param2, Int32 param3);
