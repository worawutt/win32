...
class ITransactionImportWhereabouts extends IUnknown {
  ...
  int GetWhereaboutsSize(Pointer<Uint32> pcbWhereabouts) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Uint32> pcbWhereabouts)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> pcbWhereabouts)>()(
          ptr.ref.lpVtbl, pcbWhereabouts);

  int GetWhereabouts(int cbWhereabouts, Pointer<Uint8> rgbWhereabouts,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint8> rgbWhereabouts,
                      Pointer<Uint32> pcbUsed)>()(
          ptr.ref.lpVtbl, cbWhereabouts, rgbWhereabouts, pcbUsed);
}
