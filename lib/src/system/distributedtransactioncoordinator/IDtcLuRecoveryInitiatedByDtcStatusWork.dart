...
class IDtcLuRecoveryInitiatedByDtcStatusWork extends IUnknown {
  ...
  int HandleCheckLuStatus(int lRecoverySeqNum) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Int32 lRecoverySeqNum)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int lRecoverySeqNum)>()(ptr.ref.lpVtbl, lRecoverySeqNum);
}
