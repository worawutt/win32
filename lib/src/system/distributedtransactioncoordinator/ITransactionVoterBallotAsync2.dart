...
class ITransactionVoterBallotAsync2 extends IUnknown {
  ...
  int VoteRequestDone(int hr, Pointer<BOID> pboidReason) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Int32 hr, Pointer<BOID> pboidReason)>>>()
          .value
          .asFunction<
              int Function(Pointer, int hr, Pointer<BOID> pboidReason)>()(
      ptr.ref.lpVtbl, hr, pboidReason);
}
