...
class IRMHelper extends IUnknown {
  ...
  int RMCount(int dwcTotalNumberOfRMs) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Uint32 dwcTotalNumberOfRMs)>>>()
          .value
          .asFunction<int Function(Pointer, int dwcTotalNumberOfRMs)>()(
      ptr.ref.lpVtbl, dwcTotalNumberOfRMs);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf8> pszOpenString,
                      Pointer<Utf8> pszCloseString,
                      GUID guidRMRecovery)>()(ptr.ref.lpVtbl, pXa_Switch,
          fCDeclCallingConv, pszOpenString, pszCloseString, guidRMRecovery);
}
