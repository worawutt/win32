...
class IDtcLuRecoveryInitiatedByDtc extends IUnknown {
  ...
  int GetWork(Pointer<Int32> pWork, Pointer<Pointer> ppv) => ptr
      .ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Pointer<Int32> pWork, Pointer<Pointer> ppv)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<Int32> pWork,
              Pointer<Pointer> ppv)>()(ptr.ref.lpVtbl, pWork, ppv);
}
