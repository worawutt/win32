...
class ITransactionImport extends IUnknown {
  ...
  int Import(int cbTransactionCookie, Pointer<Uint8> rgbTransactionCookie,
          Pointer<GUID> piid, Pointer<Pointer> ppvTransaction) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint8> rgbTransactionCookie,
                      Pointer<GUID> piid,
                      Pointer<Pointer> ppvTransaction)>()(ptr.ref.lpVtbl,
          cbTransactionCookie, rgbTransactionCookie, piid, ppvTransaction);
}
