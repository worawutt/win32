...
class ITransactionExportFactory extends IUnknown {
  ...
  int GetRemoteClassId(Pointer<GUID> pclsid) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
  ...
  int Create(int cbWhereabouts, Pointer<Uint8> rgbWhereabouts,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint8> rgbWhereabouts,
                      Pointer<Pointer<COMObject>> ppExport)>()(
          ptr.ref.lpVtbl, cbWhereabouts, rgbWhereabouts, ppExport);
}
