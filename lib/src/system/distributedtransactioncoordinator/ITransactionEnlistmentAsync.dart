...
class ITransactionEnlistmentAsync extends IUnknown {
  ...
  int PrepareRequestDone(
          int hr, Pointer<COMObject> pmk, Pointer<BOID> pboidReason) =>
      ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 hr, Pointer<COMObject> pmk,
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<BOID>
                      pboidReason)>()(ptr.ref.lpVtbl, hr, pmk, pboidReason);

  int CommitRequestDone(int hr) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 hr)>>>()
      .value
      .asFunction<int Function(Pointer, int hr)>()(ptr.ref.lpVtbl, hr);

  int AbortRequestDone(int hr) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 hr)>>>()
      .value
      .asFunction<int Function(Pointer, int hr)>()(ptr.ref.lpVtbl, hr);
