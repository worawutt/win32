...
class IDtcToXaHelperFactory extends IUnknown {
  ...
  int Create(Pointer<Utf8> pszDSN, Pointer<Utf8> pszClientDllName,
          Pointer<GUID> pguidRm, Pointer<Pointer<COMObject>> ppXaHelper) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> pguidRm,
                      Pointer<Pointer<COMObject>> ppXaHelper)>()(
          ptr.ref.lpVtbl, pszDSN, pszClientDllName, pguidRm, ppXaHelper);
}
