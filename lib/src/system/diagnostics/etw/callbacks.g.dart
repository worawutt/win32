...
typedef PEVENT_CALLBACK = Void Function(Pointer<EVENT_TRACE> pEvent);
...
typedef WMIDPREQUEST = Uint32 Function(Int32 RequestCode,
    Pointer RequestContext, Pointer<Uint32> BufferSize, Pointer Buffer);
