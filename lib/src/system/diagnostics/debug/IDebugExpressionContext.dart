      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int dwFlags,
                      Pointer<Pointer<COMObject>> ppe)>()(
          ptr.ref.lpVtbl, pstrCode, nRadix, pstrDelimiter, dwFlags, ppe);

  int GetLanguageInfo(Pointer<Pointer<Utf16>> pbstrLanguageName,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<Utf16>> pbstrLanguageName,
                      Pointer<GUID> pLanguageID)>()(
          ptr.ref.lpVtbl, pbstrLanguageName, pLanguageID);
}
