      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppiunkItem,
                      Pointer<Pointer<COMObject>> ppti)>()(
          ptr.ref.lpVtbl, pstrName, dwReturnMask, ppiunkItem, ppti);

  int GetDocVersionString(Pointer<Pointer<Utf16>> pbstrVersion) => ptr
          .ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<Utf16>> pbstrVersion)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<Utf16>> pbstrVersion)>()(
      ptr.ref.lpVtbl, pbstrVersion);
  ...
  int OnScriptTerminate(
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<VARIANT> pvarResult,
                              Pointer<EXCEPINFO> pexcepinfo)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<VARIANT> pvarResult,
                      Pointer<EXCEPINFO> pexcepinfo)>()(
          ptr.ref.lpVtbl, pvarResult, pexcepinfo);

  int OnStateChange(int ssScriptState) => ptr.ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Int32 ssScriptState)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int ssScriptState)>()(ptr.ref.lpVtbl, ssScriptState);
