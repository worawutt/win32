      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint32> pdwSupportedOptions,
                      Pointer<Uint32> pdwEnabledOptions)>()(
          ptr.ref.lpVtbl, riid, pdwSupportedOptions, pdwEnabledOptions);

  int
      SetInterfaceSafetyOptions(
              Pointer<GUID> riid, int dwOptionSetMask, int dwEnabledOptions) =>
          ptr.ref.lpVtbl.value
                  .elementAt(4)
                  .cast<
                      Pointer<
              ...
              ptr.ref.lpVtbl, riid, dwOptionSetMask, dwEnabledOptions);
}
