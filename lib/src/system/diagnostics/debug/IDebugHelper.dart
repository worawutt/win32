...
class IDebugHelper extends IUnknown {
  ...
  int CreatePropertyBrowser(Pointer<VARIANT> pvar, Pointer<Utf16> bstrName,
          Pointer<COMObject> pdat, Pointer<Pointer<COMObject>> ppdob) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pdat,
                      Pointer<Pointer<COMObject>> ppdob)>()(
          ptr.ref.lpVtbl, pvar, bstrName, pdat, ppdob);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pdf,
                      Pointer<Pointer<COMObject>> ppdob)>()(
          ptr.ref.lpVtbl, pvar, bstrName, pdat, pdf, ppdob);

  int CreateSimpleConnectionPoint(
          Pointer<COMObject> pdisp, Pointer<Pointer<COMObject>> ppscp) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
