...
class ICodeAddressConcept extends IUnknown {
  ...
  int GetContainingSymbol(Pointer<COMObject> pContextObject,
      ...
      ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pContextObject,
                          Pointer<Pointer<COMObject>> ppSymbol)>>>()
          .value
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<COMObject>>
                      ppSymbol)>()(ptr.ref.lpVtbl, pContextObject, ppSymbol);
}
