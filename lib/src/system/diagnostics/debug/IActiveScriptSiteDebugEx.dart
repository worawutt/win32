...
class IActiveScriptSiteDebugEx extends IUnknown {
  ...
  int
      OnCanNotJITScriptErrorDebug(Pointer<COMObject> pErrorDebug,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<COMObject> pErrorDebug,
                          Pointer<Int32> pfCallOnScriptErrorWhenContinuing)>()(
              ptr.ref.lpVtbl, pErrorDebug, pfCallOnScriptErrorWhenContinuing);
}
