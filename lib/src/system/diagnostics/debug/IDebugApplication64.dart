...
class IDebugApplication64 extends IRemoteDebugApplication {
  ...
  int SetName(Pointer<Utf16> pstrName) => ptr.ref.lpVtbl.value
          .elementAt(14)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> pstrName)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Utf16> pstrName)>()(
      ptr.ref.lpVtbl, pstrName);
  ...
  int DebugOutput(Pointer<Utf16> pstr) => ptr.ref.lpVtbl.value
      .elementAt(16)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Utf16> pstr)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<Utf16> pstr)>()(ptr.ref.lpVtbl, pstr);
  ...
  int HandleBreakPoint(int br, Pointer<Int32> pbra) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Int32 br, Pointer<Int32> pbra)>>>()
              .value
              .asFunction<int Function(Pointer, int br, Pointer<Int32> pbra)>()(
          ptr.ref.lpVtbl, br, pbra);
  ...
  int
      GetBreakFlags(Pointer<Uint32> pabf,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<Uint32> pabf,
                          Pointer<Pointer<COMObject>> pprdatSteppingThread)>()(
              ptr.ref.lpVtbl, pabf, pprdatSteppingThread);

  int GetCurrentThread(Pointer<Pointer<COMObject>> pat) => ptr.ref.lpVtbl.value
      .elementAt(21)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Pointer<COMObject>> pat)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, Pointer<Pointer<COMObject>> pat)>()(ptr.ref.lpVtbl, pat);

  int CreateAsyncDebugOperation(
          Pointer<COMObject> psdo, Pointer<Pointer<COMObject>> ppado) =>
      ptr.ref.lpVtbl.value
              .elementAt(22)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<COMObject> psdo,
                              Pointer<Pointer<COMObject>> ppado)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> psdo,
                      Pointer<Pointer<COMObject>> ppado)>()(
          ptr.ref.lpVtbl, psdo, ppado);

  int AddStackFrameSniffer(
          Pointer<COMObject> pdsfs, Pointer<Uint32> pdwCookie) =>
      ptr.ref.lpVtbl.value
              .elementAt(23)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<COMObject> pdsfs,
                              Pointer<Uint32> pdwCookie)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pdsfs,
                      Pointer<Uint32> pdwCookie)>()(
          ptr.ref.lpVtbl, pdsfs, pdwCookie);

  int RemoveStackFrameSniffer(int dwCookie) => ptr.ref.lpVtbl.value
      .elementAt(24)
  ...
  int CreateApplicationNode(Pointer<Pointer<COMObject>> ppdanNew) => ptr
          .ref.lpVtbl.value
          .elementAt(27)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> ppdanNew)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> ppdanNew)>()(
      ptr.ref.lpVtbl, ppdanNew);

  int FireDebuggerEvent(Pointer<GUID> riid, Pointer<COMObject> punk) => ptr
      .ref.lpVtbl.value
      .elementAt(28)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Pointer<GUID> riid, Pointer<COMObject> punk)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<GUID> riid,
              Pointer<COMObject> punk)>()(ptr.ref.lpVtbl, riid, punk);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Int32> pbra,
                      Pointer<Int32> perra,
                      Pointer<Int32> pfCallOnScriptError)>()(ptr.ref.lpVtbl,
          pErrorDebug, pScriptSite, pbra, perra, pfCallOnScriptError);
  ...
  int AddGlobalExpressionContextProvider(
          Pointer<COMObject> pdsfs, Pointer<Uint64> pdwCookie) =>
      ptr.ref.lpVtbl.value
              .elementAt(32)
              .cast<
                  Pointer<
  ...
  int RemoveGlobalExpressionContextProvider(int dwCookie) => ptr
      .ref.lpVtbl.value
      .elementAt(33)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Uint64 dwCookie)>>>()
      .value
      .asFunction<
          int Function(Pointer, int dwCookie)>()(ptr.ref.lpVtbl, dwCookie);
}
