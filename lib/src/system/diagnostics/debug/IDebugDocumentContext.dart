...
class IDebugDocumentContext extends IUnknown {
  ...
  int GetDocument(Pointer<Pointer<COMObject>> ppsd) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Pointer<COMObject>> ppsd)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<Pointer<COMObject>> ppsd)>()(ptr.ref.lpVtbl, ppsd);

  int EnumCodeContexts(Pointer<Pointer<COMObject>> ppescc) =>
