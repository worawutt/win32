...
class IDataModelScriptClient extends IUnknown {
  ...
  int ReportError(int errClass, int hrFail, Pointer<Utf16> message, int line,
          int position) =>
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int errClass, int hrFail,
                      Pointer<Utf16> message, int line, int position)>()(
          ptr.ref.lpVtbl, errClass, hrFail, message, line, position);
}
