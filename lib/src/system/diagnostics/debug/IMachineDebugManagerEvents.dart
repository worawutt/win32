...
class IMachineDebugManagerEvents extends IUnknown {
  ...
  int onAddApplication(Pointer<COMObject> pda, int dwAppCookie) => ptr
      .ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Pointer<COMObject> pda, Uint32 dwAppCookie)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<COMObject> pda,
              int dwAppCookie)>()(ptr.ref.lpVtbl, pda, dwAppCookie);

  int onRemoveApplication(Pointer<COMObject> pda, int dwAppCookie) => ptr
      .ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
