...
class IJsDebugStackWalker extends IUnknown {
  ...
  int GetNext(Pointer<Pointer<COMObject>> ppFrame) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> ppFrame)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> ppFrame)>()(
      ptr.ref.lpVtbl, ppFrame);
}
