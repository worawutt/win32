...
class IEnumDebugExpressionContexts extends IUnknown {
  ...
  int Next(int celt, Pointer<Pointer<COMObject>> ppdec,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppdec,
                      Pointer<Uint32> pceltFetched)>()(
          ptr.ref.lpVtbl, celt, ppdec, pceltFetched);
  ...
  int Clone(Pointer<Pointer<COMObject>> ppedec) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
