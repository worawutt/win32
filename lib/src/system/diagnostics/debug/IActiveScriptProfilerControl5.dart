...
class IActiveScriptProfilerControl5 extends IActiveScriptProfilerControl4 {
  ...
  int EnumHeap2(int enumFlags, Pointer<Pointer<COMObject>> ppEnum) =>
      ptr.ref.lpVtbl.value
              .elementAt(10)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint32 enumFlags,
                              Pointer<Pointer<COMObject>> ppEnum)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int enumFlags,
                      Pointer<Pointer<COMObject>> ppEnum)>()(
          ptr.ref.lpVtbl, enumFlags, ppEnum);
}
