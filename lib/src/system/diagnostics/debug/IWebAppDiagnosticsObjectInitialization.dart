...
class IWebAppDiagnosticsObjectInitialization extends IUnknown {
  ...
  int Initialize(int hPassedHandle, Pointer<COMObject> pDebugApplication) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, IntPtr hPassedHandle,
                              Pointer<COMObject> pDebugApplication)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int hPassedHandle,
                      Pointer<COMObject> pDebugApplication)>()(
          ptr.ref.lpVtbl, hPassedHandle, pDebugApplication);
}
