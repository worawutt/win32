...
class IActiveScriptErrorDebug110 extends IUnknown {
  ...
  int GetExceptionThrownKind(Pointer<Int32> pExceptionKind) => ptr
      .ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Int32> pExceptionKind)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<Int32> pExceptionKind)>()(ptr.ref.lpVtbl, pExceptionKind);
}
