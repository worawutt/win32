...
class IModelKeyReference2 extends IModelKeyReference {
  ...
  int OverrideContextObject(Pointer<COMObject> newContextObject) => ptr
          .ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<COMObject> newContextObject)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> newContextObject)>()(
      ptr.ref.lpVtbl, newContextObject);
}
