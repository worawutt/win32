...
class ISimpleConnectionPoint extends IUnknown {
  ...
  int GetEventCount(Pointer<Uint32> pulCount) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int DescribeEvents(int iEvent, int cEvents, Pointer<Int32> prgid,
          Pointer<Pointer<Utf16>> prgbstr, Pointer<Uint32> pcEventsFetched) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<Utf16>> prgbstr,
                      Pointer<Uint32> pcEventsFetched)>()(
          ptr.ref.lpVtbl, iEvent, cEvents, prgid, prgbstr, pcEventsFetched);

  int Advise(Pointer<COMObject> pdisp, Pointer<Uint32> pdwCookie) => ptr
      .ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
      ...
      .value
      .asFunction<
          int Function(Pointer, Pointer<COMObject> pdisp,
              Pointer<Uint32> pdwCookie)>()(ptr.ref.lpVtbl, pdisp, pdwCookie);
