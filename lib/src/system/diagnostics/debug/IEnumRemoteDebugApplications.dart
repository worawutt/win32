...
class IEnumRemoteDebugApplications extends IUnknown {
  ...
  int Next(int celt, Pointer<Pointer<COMObject>> ppda,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppda,
                      Pointer<Uint32> pceltFetched)>()(
          ptr.ref.lpVtbl, celt, ppda, pceltFetched);
  ...
  int Clone(Pointer<Pointer<COMObject>> ppessd) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> ppessd)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> ppessd)>()(
      ptr.ref.lpVtbl, ppessd);
}
