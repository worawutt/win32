...
class IDebugHostErrorSink extends IUnknown {
  ...
  int ReportError(int errClass, int hrError, Pointer<Utf16> message) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 errClass, Int32 hrError,
                              Pointer<Utf16> message)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int errClass, int hrError,
                      Pointer<Utf16> message)>()(
          ptr.ref.lpVtbl, errClass, hrError, message);
}
