      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> conceptId,
                      Pointer<COMObject> conceptInterface,
                      Pointer<COMObject> conceptMetadata)>()(ptr.ref.lpVtbl,
          contextObject, conceptId, conceptInterface, conceptMetadata);

  int NotifyParent(Pointer<COMObject> parentModel) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> parentModel)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<COMObject> parentModel)>()(ptr.ref.lpVtbl, parentModel);

  int NotifyParentChange(Pointer<COMObject> parentModel) => ptr.ref.lpVtbl.value
      .elementAt(6)
      .cast<
          Pointer<
              NativeFunction<
