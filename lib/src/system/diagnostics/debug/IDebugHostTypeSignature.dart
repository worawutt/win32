...
class IDebugHostTypeSignature extends IUnknown {
  ...
  int IsMatch(Pointer<COMObject> type, Pointer<Bool> isMatch,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Bool> isMatch,
                      Pointer<Pointer<COMObject>> wildcardMatches)>()(
          ptr.ref.lpVtbl, type, isMatch, wildcardMatches);

  int CompareAgainst(Pointer<COMObject> typeSignature, Pointer<Int32> result) =>
      ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<Int32>
                      result)>()(ptr.ref.lpVtbl, typeSignature, result);
}
