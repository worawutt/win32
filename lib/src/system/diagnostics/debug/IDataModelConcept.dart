      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> matchingTypeSignature,
                      Pointer<COMObject> wildcardMatches)>()(
          ptr.ref.lpVtbl, modelObject, matchingTypeSignature, wildcardMatches);

  int GetName(Pointer<Pointer<Utf16>> modelName) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<Utf16>> modelName)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<Utf16>> modelName)>()(
