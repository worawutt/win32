      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> metadata,
                      Pointer<Bool> hasKey)>()(
          ptr.ref.lpVtbl, contextObject, key, keyValue, metadata, hasKey);

  int SetKey(Pointer<COMObject> contextObject, Pointer<Utf16> key,
          Pointer<COMObject> keyValue, Pointer<COMObject> metadata) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> keyValue,
                      Pointer<COMObject> metadata)>()(
          ptr.ref.lpVtbl, contextObject, key, keyValue, metadata);

  int
      EnumerateKeys(Pointer<COMObject> contextObject,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(Pointer, Pointer<COMObject> contextObject,
                          Pointer<Pointer<COMObject>> ppEnumerator)>()(
              ptr.ref.lpVtbl, contextObject, ppEnumerator);
}
