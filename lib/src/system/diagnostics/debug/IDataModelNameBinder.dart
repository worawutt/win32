      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> value,
                      Pointer<Pointer<COMObject>> metadata)>()(
          ptr.ref.lpVtbl, contextObject, name, value, metadata);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> reference,
                      Pointer<Pointer<COMObject>> metadata)>()(
          ptr.ref.lpVtbl, contextObject, name, reference, metadata);

  int EnumerateValues(Pointer<COMObject> contextObject,
      ...
      ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> contextObject,
                          Pointer<Pointer<COMObject>> enumerator)>>>()
          .value
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<COMObject>>
                      enumerator)>()(ptr.ref.lpVtbl, contextObject, enumerator);

  int EnumerateReferences(Pointer<COMObject> contextObject,
          Pointer<Pointer<COMObject>> enumerator) =>
      ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
