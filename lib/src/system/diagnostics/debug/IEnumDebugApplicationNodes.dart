...
class IEnumDebugApplicationNodes extends IUnknown {
  ...
  int Next(int celt, Pointer<Pointer<COMObject>> pprddp,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> pprddp,
                      Pointer<Uint32> pceltFetched)>()(
          ptr.ref.lpVtbl, celt, pprddp, pceltFetched);
  ...
  int Clone(Pointer<Pointer<COMObject>> pperddp) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
