...
class IActiveScriptSIPInfo extends IUnknown {
  ...
  int GetSIPOID(Pointer<GUID> poid_sip) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<GUID> poid_sip)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<GUID> poid_sip)>()(
      ptr.ref.lpVtbl, poid_sip);
}
