...
typedef DIGEST_FUNCTION = Int32 Function(
    Pointer refdata, Pointer<Uint8> pData, Uint32 dwLength);
...
typedef PCOGETACTIVATIONSTATE = Int32 Function(
    GUID param0, Uint32 param1, Pointer<Uint32> param2);
typedef PCOGETCALLSTATE = Int32 Function(Int32 param0, Pointer<Uint32> param1);
typedef PDBGHELP_CREATE_USER_DUMP_CALLBACK = Int32 Function(Uint32 DataType,
    Pointer<Pointer> Data, Pointer<Uint32> DataLength, Pointer UserData);
typedef PDEBUG_EXTENSION_CALL = Int32 Function(
    Pointer<COMObject> Client, Pointer<Utf8> Args);
typedef PDEBUG_EXTENSION_CANUNLOAD = Int32 Function();
typedef PDEBUG_EXTENSION_INITIALIZE = Int32 Function(
    Pointer<Uint32> Version, Pointer<Uint32> Flags);
...
typedef PDEBUG_EXTENSION_KNOWN_STRUCT_EX = Int32 Function(
    ...
    Pointer<Utf8> Buffer,
    Pointer<Uint32> BufferChars);
typedef PDEBUG_EXTENSION_NOTIFY = Void Function(Uint32 Notify, Uint64 Argument);
...
typedef PDEBUG_STACK_PROVIDER_BEGINTHREADSTACKRECONSTRUCTION = Int32 Function(
    Uint32 StreamType, Pointer MiniDumpStreamBuffer, Uint32 BufferSize);
...
typedef PENUMDIRTREE_CALLBACK = Int32 Function(
    Pointer<Utf8> FilePath, Pointer CallerData);
typedef PENUMDIRTREE_CALLBACKW = Int32 Function(
    Pointer<Utf16> FilePath, Pointer CallerData);
...
typedef PENUMSOURCEFILETOKENSCALLBACK = Int32 Function(
    Pointer token, IntPtr size);
typedef PFINDFILEINPATHCALLBACK = Int32 Function(
    Pointer<Utf8> filename, Pointer context);
typedef PFINDFILEINPATHCALLBACKW = Int32 Function(
    Pointer<Utf16> filename, Pointer context);
typedef PFIND_DEBUG_FILE_CALLBACK = Int32 Function(
    IntPtr FileHandle, Pointer<Utf8> FileName, Pointer CallerData);
typedef PFIND_DEBUG_FILE_CALLBACKW = Int32 Function(
    IntPtr FileHandle, Pointer<Utf16> FileName, Pointer CallerData);
...
typedef PSYMBOLSERVERBYINDEXPROC = Int32 Function(Pointer<Utf8> param0,
    Pointer<Utf8> param1, Pointer<Utf8> param2, Pointer<Utf8> param3);
typedef PSYMBOLSERVERBYINDEXPROCW = Int32 Function(Pointer<Utf16> param0,
    Pointer<Utf16> param1, Pointer<Utf16> param2, Pointer<Utf16> param3);
typedef PSYMBOLSERVERCALLBACKPROC = Int32 Function(
    IntPtr action, Uint64 data, Uint64 context);
...
typedef PSYMBOLSERVERDELTANAMEW = Int32 Function(
    ...
    IntPtr param8);
typedef PSYMBOLSERVERGETINDEXSTRING = Int32 Function(Pointer param0,
    Uint32 param1, Uint32 param2, Pointer<Utf8> param3, IntPtr param4);
typedef PSYMBOLSERVERGETINDEXSTRINGW = Int32 Function(Pointer param0,
    Uint32 param1, Uint32 param2, Pointer<Utf16> param3, IntPtr param4);
typedef PSYMBOLSERVERGETOPTIONDATAPROC = Int32 Function(
    IntPtr param0, Pointer<Uint64> param1);
...
typedef PSYMBOLSERVERGETSUPPLEMENTW = Int32 Function(
    ...
    IntPtr param4);
typedef PSYMBOLSERVERGETVERSION = Int32 Function(Pointer<API_VERSION> param0);
typedef PSYMBOLSERVERISSTORE = Int32 Function(Pointer<Utf8> param0);
typedef PSYMBOLSERVERISSTOREW = Int32 Function(Pointer<Utf16> param0);
typedef PSYMBOLSERVERMESSAGEPROC = Int32 Function(
    IntPtr action, Uint64 data, Uint64 context);
typedef PSYMBOLSERVEROPENPROC = Int32 Function();
typedef PSYMBOLSERVERPINGPROC = Int32 Function(Pointer<Utf8> param0);
typedef PSYMBOLSERVERPINGPROCW = Int32 Function(Pointer<Utf16> param0);
typedef PSYMBOLSERVERPINGPROCWEX = Int32 Function(Pointer<Utf16> param0);
...
typedef PSYMBOL_FUNCENTRY_CALLBACK = Pointer Function(
    IntPtr hProcess, Uint32 AddrBase, Pointer UserContext);
typedef PSYMBOL_FUNCENTRY_CALLBACK64 = Pointer Function(
    IntPtr hProcess, Uint64 AddrBase, Uint64 UserContext);
typedef PSYMBOL_REGISTERED_CALLBACK64 = Int32 Function(IntPtr hProcess,
    Uint32 ActionCode, Uint64 CallbackData, Uint64 UserContext);
typedef PSYM_DUMP_FIELD_CALLBACK = Uint32 Function(
    Pointer<FIELD_INFO> pField, Pointer UserContext);
...
typedef PSYM_ENUMLINES_CALLBACK = Int32 Function(
    Pointer<SRCCODEINFO> LineInfo, Pointer UserContext);
typedef PSYM_ENUMLINES_CALLBACKW = Int32 Function(
    Pointer<SRCCODEINFO> LineInfo, Pointer UserContext);
typedef PSYM_ENUMMODULES_CALLBACK64 = Int32 Function(
    Pointer<Utf8> ModuleName, Uint64 BaseOfDll, Pointer UserContext);
typedef PSYM_ENUMMODULES_CALLBACKW64 = Int32 Function(
    Pointer<Utf16> ModuleName, Uint64 BaseOfDll, Pointer UserContext);
typedef PSYM_ENUMPROCESSES_CALLBACK = Int32 Function(
    IntPtr hProcess, Pointer UserContext);
typedef PSYM_ENUMSOURCEFILES_CALLBACK = Int32 Function(
    Pointer<SOURCEFILE> pSourceFile, Pointer UserContext);
typedef PSYM_ENUMSOURCEFILES_CALLBACKW = Int32 Function(
    Pointer<SOURCEFILE> pSourceFile, Pointer UserContext);
typedef PSYM_ENUMSYMBOLS_CALLBACK64 = Int32 Function(Pointer<Utf8> SymbolName,
    Uint64 SymbolAddress, Uint32 SymbolSize, Pointer UserContext);
typedef PSYM_ENUMSYMBOLS_CALLBACK64W = Int32 Function(Pointer<Utf16> SymbolName,
    Uint64 SymbolAddress, Uint32 SymbolSize, Pointer UserContext);
typedef PTRANSLATE_ADDRESS_ROUTINE64 = Uint64 Function(
    IntPtr hProcess, IntPtr hThread, Pointer<ADDRESS64> lpaddr);
...
typedef PWINDBG_DISASM = Uint32 Function(Pointer<IntPtr> lpOffset,
    Pointer<Utf8> lpBuffer, Uint32 fShowEffectiveAddress);
typedef PWINDBG_DISASM32 = Uint32 Function(Pointer<Uint32> lpOffset,
    Pointer<Utf8> lpBuffer, Uint32 fShowEffectiveAddress);
typedef PWINDBG_DISASM64 = Uint32 Function(Pointer<Uint64> lpOffset,
    Pointer<Utf8> lpBuffer, Uint32 fShowEffectiveAddress);
...
typedef PWINDBG_EXTENSION_ROUTINE64 = Void Function(
    ...
    Uint32 dwProcessor,
    Pointer<Utf8> lpArgumentString);
typedef PWINDBG_GET_EXPRESSION = IntPtr Function(Pointer<Utf8> lpExpression);
typedef PWINDBG_GET_EXPRESSION32 = Uint32 Function(Pointer<Utf8> lpExpression);
typedef PWINDBG_GET_EXPRESSION64 = Uint64 Function(Pointer<Utf8> lpExpression);
typedef PWINDBG_GET_SYMBOL = Void Function(
    Pointer offset, Pointer<Utf8> pchBuffer, Pointer<IntPtr> pDisplacement);
typedef PWINDBG_GET_SYMBOL32 = Void Function(
    Uint32 offset, Pointer<Utf8> pchBuffer, Pointer<Uint32> pDisplacement);
typedef PWINDBG_GET_SYMBOL64 = Void Function(
    Uint64 offset, Pointer<Utf8> pchBuffer, Pointer<Uint64> pDisplacement);
typedef PWINDBG_GET_THREAD_CONTEXT_ROUTINE = Uint32 Function(
    Uint32 Processor, Pointer<CONTEXT> lpContext, Uint32 cbSizeOfContext);
typedef PWINDBG_IOCTL_ROUTINE = Uint32 Function(
    Uint16 IoctlType, Pointer lpvData, Uint32 cbSize);
...
typedef PWINDBG_OLDKD_READ_PHYSICAL_MEMORY = Uint32 Function(
    Uint64 address, Pointer buffer, Uint32 count, Pointer<Uint32> bytesread);
typedef PWINDBG_OLDKD_WRITE_PHYSICAL_MEMORY = Uint32 Function(Uint64 address,
    Pointer buffer, Uint32 length, Pointer<Uint32> byteswritten);
typedef PWINDBG_OLD_EXTENSION_ROUTINE = Void Function(
    Uint32 dwCurrentPc,
    Pointer<WINDBG_EXTENSION_APIS> lpExtensionApis,
    Pointer<Utf8> lpArgumentString);
typedef PWINDBG_OUTPUT_ROUTINE = Void Function(Pointer<Utf8> lpFormat);
typedef PWINDBG_READ_PROCESS_MEMORY_ROUTINE = Uint32 Function(
    IntPtr offset, Pointer lpBuffer, Uint32 cb, Pointer<Uint32> lpcbBytesRead);
typedef PWINDBG_READ_PROCESS_MEMORY_ROUTINE32 = Uint32 Function(
    Uint32 offset, Pointer lpBuffer, Uint32 cb, Pointer<Uint32> lpcbBytesRead);
typedef PWINDBG_READ_PROCESS_MEMORY_ROUTINE64 = Uint32 Function(
    Uint64 offset, Pointer lpBuffer, Uint32 cb, Pointer<Uint32> lpcbBytesRead);
...
typedef PWINDBG_STACKTRACE_ROUTINE64 = Uint32 Function(
    ...
    Uint32 Frames);
typedef PWINDBG_WRITE_PROCESS_MEMORY_ROUTINE = Uint32 Function(IntPtr offset,
    Pointer lpBuffer, Uint32 cb, Pointer<Uint32> lpcbBytesWritten);
typedef PWINDBG_WRITE_PROCESS_MEMORY_ROUTINE32 = Uint32 Function(Uint32 offset,
    Pointer lpBuffer, Uint32 cb, Pointer<Uint32> lpcbBytesWritten);
typedef PWINDBG_WRITE_PROCESS_MEMORY_ROUTINE64 = Uint32 Function(Uint64 offset,
    Pointer lpBuffer, Uint32 cb, Pointer<Uint32> lpcbBytesWritten);
typedef SYMADDSOURCESTREAM = Int32 Function(IntPtr param0, Uint64 param1,
    Pointer<Utf8> param2, Pointer<Uint8> param3, IntPtr param4);
typedef WHEA_ERROR_SOURCE_CORRECT_DEVICE_DRIVER = Int32 Function(
    Pointer ErrorSourceDesc, Pointer<Uint32> MaximumSectionLength);
typedef WHEA_ERROR_SOURCE_INITIALIZE_DEVICE_DRIVER = Int32 Function(
    Pointer Context, Uint32 ErrorSourceId);
