...
class IActiveScriptProperty extends IUnknown {
  ...
  int GetProperty(int dwProperty, Pointer<VARIANT> pvarIndex,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<VARIANT> pvarIndex,
                      Pointer<VARIANT> pvarValue)>()(
          ptr.ref.lpVtbl, dwProperty, pvarIndex, pvarValue);

  int SetProperty(int dwProperty, Pointer<VARIANT> pvarIndex,
          Pointer<VARIANT> pvarValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
