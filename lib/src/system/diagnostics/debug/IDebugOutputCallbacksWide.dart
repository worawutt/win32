...
class IDebugOutputCallbacksWide extends IUnknown {
  ...
  int Output(int Mask, Pointer<Utf16> Text) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Uint32 Mask, Pointer<Utf16> Text)>>>()
      .value
      .asFunction<
          int Function(Pointer, int Mask,
              Pointer<Utf16> Text)>()(ptr.ref.lpVtbl, Mask, Text);
}
