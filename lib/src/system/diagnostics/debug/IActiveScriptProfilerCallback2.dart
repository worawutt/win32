...
class IActiveScriptProfilerCallback2 extends IActiveScriptProfilerCallback {
  ...
  int OnFunctionEnterByName(Pointer<Utf16> pwszFunctionName, int type) => ptr
      .ref.lpVtbl.value
      .elementAt(9)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Pointer<Utf16> pwszFunctionName, Int32 type)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<Utf16> pwszFunctionName,
              int type)>()(ptr.ref.lpVtbl, pwszFunctionName, type);

  int OnFunctionExitByName(Pointer<Utf16> pwszFunctionName, int type) => ptr
      .ref.lpVtbl.value
      .elementAt(10)
      .cast<
          Pointer<
