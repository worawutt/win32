...
class IDebugDocumentProvider extends IDebugDocumentInfo {
  ...
  int GetDocument(Pointer<Pointer<COMObject>> ppssd) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> ppssd)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> ppssd)>()(
      ptr.ref.lpVtbl, ppssd);
}
