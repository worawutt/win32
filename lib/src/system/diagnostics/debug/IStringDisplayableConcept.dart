...
class IStringDisplayableConcept extends IUnknown {
  ...
  int ToDisplayString(Pointer<COMObject> contextObject,
          Pointer<COMObject> metadata, Pointer<Pointer<Utf16>> displayString) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> metadata,
                      Pointer<Pointer<Utf16>> displayString)>()(
          ptr.ref.lpVtbl, contextObject, metadata, displayString);
}
