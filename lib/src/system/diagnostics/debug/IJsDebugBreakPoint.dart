...
class IJsDebugBreakPoint extends IUnknown {
  ...
  int IsEnabled(Pointer<Int32> pIsEnabled) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> pIsEnabled)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Int32> pIsEnabled)>()(
      ptr.ref.lpVtbl, pIsEnabled);
