...
class IEnumDebugPropertyInfo extends IUnknown {
  ...
  int Next(int celt, Pointer<DebugPropertyInfo> pi,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int celt, Pointer<DebugPropertyInfo> pi,
                      Pointer<Uint32> pcEltsfetched)>()(
          ptr.ref.lpVtbl, celt, pi, pcEltsfetched);
  ...
  int Clone(Pointer<Pointer<COMObject>> ppepi) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> ppepi)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> ppepi)>()(
      ptr.ref.lpVtbl, ppepi);
