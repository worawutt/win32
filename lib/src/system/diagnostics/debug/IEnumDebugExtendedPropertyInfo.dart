...
class IEnumDebugExtendedPropertyInfo extends IUnknown {
  ...
  int Next(int celt, Pointer<ExtendedDebugPropertyInfo> rgExtendedPropertyInfo,
      ...
      ptr.ref.lpVtbl.value
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer,
                              Uint32 celt,
                              Pointer<ExtendedDebugPropertyInfo>
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint32> pceltFetched)>()(
          ptr.ref.lpVtbl, celt, rgExtendedPropertyInfo, pceltFetched);
  ...
  int Clone(Pointer<Pointer<COMObject>> pedpe) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> pedpe)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> pedpe)>()(
      ptr.ref.lpVtbl, pedpe);
