...
class IDataModelScriptDebugStack extends IUnknown {
  ...
  int GetStackFrame(int frameNumber, Pointer<Pointer<COMObject>> stackFrame) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint64 frameNumber,
                              Pointer<Pointer<COMObject>> stackFrame)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int frameNumber,
                      Pointer<Pointer<COMObject>> stackFrame)>()(
          ptr.ref.lpVtbl, frameNumber, stackFrame);
}
