...
class IDebugStackFrameSnifferEx32 extends IDebugStackFrameSniffer {
  ...
  int EnumStackFramesEx32(int dwSpMin, Pointer<Pointer<COMObject>> ppedsf) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint32 dwSpMin,
                              Pointer<Pointer<COMObject>> ppedsf)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int dwSpMin,
                      Pointer<Pointer<COMObject>> ppedsf)>()(
          ptr.ref.lpVtbl, dwSpMin, ppedsf);
}
