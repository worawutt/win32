...
int RtlAddGrowableFunctionTable(
        ...
        int RangeBase,
        int RangeEnd) =>
    _RtlAddGrowableFunctionTable(DynamicTable, FunctionTable, EntryCount,
...
late final _RtlAddGrowableFunctionTable = _ntdll.lookupFunction<
    ...
    int Function(
        ...
        int MaximumEntryCount,
        int RangeBase,
        int RangeEnd)>('RtlAddGrowableFunctionTable');

void RtlDeleteGrowableFunctionTable(Pointer DynamicTable) =>
    _RtlDeleteGrowableFunctionTable(DynamicTable);

late final _RtlDeleteGrowableFunctionTable = _ntdll.lookupFunction<
    Void Function(Pointer DynamicTable),
    void Function(Pointer DynamicTable)>('RtlDeleteGrowableFunctionTable');

void RtlGrowFunctionTable(Pointer DynamicTable, int NewEntryCount) =>
    _RtlGrowFunctionTable(DynamicTable, NewEntryCount);

late final _RtlGrowFunctionTable = _ntdll.lookupFunction<
    Void Function(Pointer DynamicTable, Uint32 NewEntryCount),
    void Function(
        Pointer DynamicTable, int NewEntryCount)>('RtlGrowFunctionTable');
...
int DebugConnect(Pointer<Utf8> RemoteOptions, Pointer<GUID> InterfaceId,
        Pointer<Pointer> Interface) =>
    _DebugConnect(RemoteOptions, InterfaceId, Interface);

late final _DebugConnect = _dbgeng.lookupFunction<
    Int32 Function(Pointer<Utf8> RemoteOptions, Pointer<GUID> InterfaceId,
        Pointer<Pointer> Interface),
    int Function(Pointer<Utf8> RemoteOptions, Pointer<GUID> InterfaceId,
        Pointer<Pointer> Interface)>('DebugConnect');

int DebugConnectWide(Pointer<Utf16> RemoteOptions, Pointer<GUID> InterfaceId,
        Pointer<Pointer> Interface) =>
    _DebugConnectWide(RemoteOptions, InterfaceId, Interface);

late final _DebugConnectWide = _dbgeng.lookupFunction<
    Int32 Function(Pointer<Utf16> RemoteOptions, Pointer<GUID> InterfaceId,
        Pointer<Pointer> Interface),
    int Function(Pointer<Utf16> RemoteOptions, Pointer<GUID> InterfaceId,
        Pointer<Pointer> Interface)>('DebugConnectWide');

int DebugCreate(Pointer<GUID> InterfaceId, Pointer<Pointer> Interface) =>
    _DebugCreate(InterfaceId, Interface);

late final _DebugCreate = _dbgeng.lookupFunction<
    Int32 Function(Pointer<GUID> InterfaceId, Pointer<Pointer> Interface),
    int Function(
        Pointer<GUID> InterfaceId, Pointer<Pointer> Interface)>('DebugCreate');

int DebugCreateEx(Pointer<GUID> InterfaceId, int DbgEngOptions,
        Pointer<Pointer> Interface) =>
    _DebugCreateEx(InterfaceId, DbgEngOptions, Interface);

late final _DebugCreateEx = _dbgeng.lookupFunction<
    Int32 Function(Pointer<GUID> InterfaceId, Uint32 DbgEngOptions,
        Pointer<Pointer> Interface),
    int Function(Pointer<GUID> InterfaceId, int DbgEngOptions,
        Pointer<Pointer> Interface)>('DebugCreateEx');
...
int CreateDataModelManager(
        Pointer<COMObject> debugHost, Pointer<Pointer<COMObject>> manager) =>
    _CreateDataModelManager(debugHost, manager);

late final _CreateDataModelManager = _dbgmodel.lookupFunction<
    Int32 Function(
        Pointer<COMObject> debugHost, Pointer<Pointer<COMObject>> manager),
    int Function(Pointer<COMObject> debugHost,
        Pointer<Pointer<COMObject>> manager)>('CreateDataModelManager');
...
int DecodeRemotePointer(
        int ProcessHandle, Pointer Ptr, Pointer<Pointer> DecodedPtr) =>
    _DecodeRemotePointer(ProcessHandle, Ptr, DecodedPtr);

late final _DecodeRemotePointer = _api_ms_win_core_util_l1_1_1.lookupFunction<
    Int32 Function(
        IntPtr ProcessHandle, Pointer Ptr, Pointer<Pointer> DecodedPtr),
    int Function(int ProcessHandle, Pointer Ptr,
        Pointer<Pointer> DecodedPtr)>('DecodeRemotePointer');

int EncodeRemotePointer(
        int ProcessHandle, Pointer Ptr, Pointer<Pointer> EncodedPtr) =>
    _EncodeRemotePointer(ProcessHandle, Ptr, EncodedPtr);

late final _EncodeRemotePointer = _api_ms_win_core_util_l1_1_1.lookupFunction<
    Int32 Function(
        IntPtr ProcessHandle, Pointer Ptr, Pointer<Pointer> EncodedPtr),
    int Function(int ProcessHandle, Pointer Ptr,
        Pointer<Pointer> EncodedPtr)>('EncodeRemotePointer');
...
void TerminateProcessOnMemoryExhaustion(int FailedAllocationSize) =>
    _TerminateProcessOnMemoryExhaustion(FailedAllocationSize);
...
int DbgHelpCreateUserDump(
        ...
        Pointer UserData) =>
    _DbgHelpCreateUserDump(FileName, Callback, UserData);
...
late final _DbgHelpCreateUserDump = _dbghelp.lookupFunction<
    ...
    int Function(
        Pointer<Utf16> FileName,
        Pointer<NativeFunction<PDBGHELP_CREATE_USER_DUMP_CALLBACK>> Callback,
        Pointer UserData)>('DbgHelpCreateUserDumpW');
...
int EnumDirTree(
        ...
        Pointer data) =>
    _EnumDirTree(hProcess, RootPath, InputPathName, OutputPathBuffer, cb, data);
...
int EnumerateLoadedModules64(
        ...
        Pointer UserContext) =>
    _EnumerateLoadedModules64(hProcess, EnumLoadedModulesCallback, UserContext);
...
late final _EnumerateLoadedModules64 = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        Pointer<NativeFunction<PENUMLOADED_MODULES_CALLBACK64>>
            EnumLoadedModulesCallback,
        Pointer UserContext)>('EnumerateLoadedModules64');
...
int EnumerateLoadedModulesEx(
        ...
        Pointer<NativeFunction<PENUMLOADED_MODULES_CALLBACKW64>>
            EnumLoadedModulesCallback,
        Pointer UserContext) =>
    _EnumerateLoadedModulesEx(hProcess, EnumLoadedModulesCallback, UserContext);
...
late final _EnumerateLoadedModulesEx = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        Pointer<NativeFunction<PENUMLOADED_MODULES_CALLBACKW64>>
            EnumLoadedModulesCallback,
        Pointer UserContext)>('EnumerateLoadedModulesExW');
...
late final _EnumerateLoadedModulesW64 = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        Pointer<NativeFunction<PENUMLOADED_MODULES_CALLBACKW64>>
            EnumLoadedModulesCallback,
        Pointer UserContext)>('EnumerateLoadedModulesW64');

int FindDebugInfoFile(Pointer<Utf8> FileName, Pointer<Utf8> SymbolPath,
        Pointer<Utf8> DebugFilePath) =>
    _FindDebugInfoFile(FileName, SymbolPath, DebugFilePath);

late final _FindDebugInfoFile = _dbghelp.lookupFunction<
    IntPtr Function(Pointer<Utf8> FileName, Pointer<Utf8> SymbolPath,
        Pointer<Utf8> DebugFilePath),
    int Function(Pointer<Utf8> FileName, Pointer<Utf8> SymbolPath,
        Pointer<Utf8> DebugFilePath)>('FindDebugInfoFile');
...
late final _FindDebugInfoFileEx = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Utf16> DebugFilePath,
        Pointer<NativeFunction<PFIND_DEBUG_FILE_CALLBACKW>> Callback,
        Pointer CallerData)>('FindDebugInfoFileExW');

int FindExecutableImage(Pointer<Utf8> FileName, Pointer<Utf8> SymbolPath,
        Pointer<Utf8> ImageFilePath) =>
    _FindExecutableImage(FileName, SymbolPath, ImageFilePath);

late final _FindExecutableImage = _dbghelp.lookupFunction<
    IntPtr Function(Pointer<Utf8> FileName, Pointer<Utf8> SymbolPath,
        Pointer<Utf8> ImageFilePath),
    int Function(Pointer<Utf8> FileName, Pointer<Utf8> SymbolPath,
        Pointer<Utf8> ImageFilePath)>('FindExecutableImage');
...
late final _FindExecutableImageEx = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Utf16> ImageFilePath,
        Pointer<NativeFunction<PFIND_EXE_FILE_CALLBACKW>> Callback,
        Pointer CallerData)>('FindExecutableImageExW');
...
late final _FindFileInPath = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        int three,
        int flags,
        Pointer<Utf8> FilePath)>('FindFileInPath');
...
late final _FindFileInSearchPath = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        int two,
        int three,
        Pointer<Utf8> FilePath)>('FindFileInSearchPath');
...
int GetTimestampForLoadedLibrary(int Module) =>
    _GetTimestampForLoadedLibrary(Module);

late final _GetTimestampForLoadedLibrary = _dbghelp.lookupFunction<
    Uint32 Function(IntPtr Module),
    int Function(int Module)>('GetTimestampForLoadedLibrary');

Pointer ImageDirectoryEntryToData(Pointer Base, int MappedAsImage,
        int DirectoryEntry, Pointer<Uint32> Size) =>
    _ImageDirectoryEntryToData(Base, MappedAsImage, DirectoryEntry, Size);

late final _ImageDirectoryEntryToData = _dbghelp.lookupFunction<
    Pointer Function(Pointer Base, Uint8 MappedAsImage, Uint32 DirectoryEntry,
        Pointer<Uint32> Size),
    Pointer Function(Pointer Base, int MappedAsImage, int DirectoryEntry,
        Pointer<Uint32> Size)>('ImageDirectoryEntryToData');
...
Pointer<IMAGE_NT_HEADERS64> ImageNtHeader(Pointer Base) => _ImageNtHeader(Base);

late final _ImageNtHeader = _dbghelp.lookupFunction<
    Pointer<IMAGE_NT_HEADERS64> Function(Pointer Base),
    Pointer<IMAGE_NT_HEADERS64> Function(Pointer Base)>('ImageNtHeader');

Pointer<IMAGE_SECTION_HEADER> ImageRvaToSection(
        Pointer<IMAGE_NT_HEADERS64> NtHeaders, Pointer Base, int Rva) =>
    _ImageRvaToSection(NtHeaders, Base, Rva);

late final _ImageRvaToSection = _dbghelp.lookupFunction<
    Pointer<IMAGE_SECTION_HEADER> Function(
        Pointer<IMAGE_NT_HEADERS64> NtHeaders, Pointer Base, Uint32 Rva),
    Pointer<IMAGE_SECTION_HEADER> Function(
        Pointer<IMAGE_NT_HEADERS64> NtHeaders,
        Pointer Base,
        int Rva)>('ImageRvaToSection');

Pointer ImageRvaToVa(Pointer<IMAGE_NT_HEADERS64> NtHeaders, Pointer Base,
        int Rva, Pointer<Pointer<IMAGE_SECTION_HEADER>> LastRvaSection) =>
    _ImageRvaToVa(NtHeaders, Base, Rva, LastRvaSection);

late final _ImageRvaToVa = _dbghelp.lookupFunction<
    Pointer Function(Pointer<IMAGE_NT_HEADERS64> NtHeaders, Pointer Base,
        Uint32 Rva, Pointer<Pointer<IMAGE_SECTION_HEADER>> LastRvaSection),
    Pointer Function(
        Pointer<IMAGE_NT_HEADERS64> NtHeaders,
        Pointer Base,
        int Rva,
        Pointer<Pointer<IMAGE_SECTION_HEADER>> LastRvaSection)>('ImageRvaToVa');
...
Pointer<API_VERSION> ImagehlpApiVersionEx(Pointer<API_VERSION> AppVersion) =>
    _ImagehlpApiVersionEx(AppVersion);

late final _ImagehlpApiVersionEx = _dbghelp.lookupFunction<
    Pointer<API_VERSION> Function(Pointer<API_VERSION> AppVersion),
    Pointer<API_VERSION> Function(
        Pointer<API_VERSION> AppVersion)>('ImagehlpApiVersionEx');

int MakeSureDirectoryPathExists(Pointer<Utf8> DirPath) =>
    _MakeSureDirectoryPathExists(DirPath);

late final _MakeSureDirectoryPathExists = _dbghelp.lookupFunction<
    Int32 Function(Pointer<Utf8> DirPath),
    int Function(Pointer<Utf8> DirPath)>('MakeSureDirectoryPathExists');
...
int MiniDumpReadDumpStream(
    ...
    _MiniDumpReadDumpStream(
        BaseOfDump, StreamNumber, Dir, StreamPointer, StreamSize);
...
late final _MiniDumpReadDumpStream = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Pointer<MINIDUMP_DIRECTORY>> Dir,
        Pointer<Pointer> StreamPointer,
        Pointer<Uint32> StreamSize)>('MiniDumpReadDumpStream');
...
int MiniDumpWriteDump(
    ...
    _MiniDumpWriteDump(hProcess, ProcessId, hFile, DumpType, ExceptionParam,
...
int RangeMapAddPeImageSections(
        ...
        int UserTag,
        int MappingFlags) =>
    _RangeMapAddPeImageSections(RmapHandle, ImageName, MappedImage,
        MappingBytes, ImageBase, UserTag, MappingFlags);
...
late final _RangeMapAddPeImageSections = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        int ImageBase,
        int UserTag,
        int MappingFlags)>('RangeMapAddPeImageSections');
...
void RangeMapFree(Pointer RmapHandle) => _RangeMapFree(RmapHandle);

late final _RangeMapFree = _dbghelp.lookupFunction<
    Void Function(Pointer RmapHandle),
    void Function(Pointer RmapHandle)>('RangeMapFree');

int RangeMapRead(Pointer RmapHandle, int Offset, Pointer Buffer,
        int RequestBytes, int Flags, Pointer<Uint32> DoneBytes) =>
    _RangeMapRead(RmapHandle, Offset, Buffer, RequestBytes, Flags, DoneBytes);

late final _RangeMapRead = _dbghelp.lookupFunction<
    Int32 Function(Pointer RmapHandle, Uint64 Offset, Pointer Buffer,
        Uint32 RequestBytes, Uint32 Flags, Pointer<Uint32> DoneBytes),
    int Function(
        Pointer RmapHandle,
        int Offset,
        Pointer Buffer,
        int RequestBytes,
        int Flags,
        Pointer<Uint32> DoneBytes)>('RangeMapRead');

int RangeMapRemove(Pointer RmapHandle, int UserTag) =>
    _RangeMapRemove(RmapHandle, UserTag);

late final _RangeMapRemove = _dbghelp.lookupFunction<
    Int32 Function(Pointer RmapHandle, Uint64 UserTag),
    int Function(Pointer RmapHandle, int UserTag)>('RangeMapRemove');

int RangeMapWrite(Pointer RmapHandle, int Offset, Pointer Buffer,
        int RequestBytes, int Flags, Pointer<Uint32> DoneBytes) =>
    _RangeMapWrite(RmapHandle, Offset, Buffer, RequestBytes, Flags, DoneBytes);
...
late final _RangeMapWrite = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        int RequestBytes,
        int Flags,
        Pointer<Uint32> DoneBytes)>('RangeMapWrite');

void RemoveInvalidModuleList(int hProcess) =>
    _RemoveInvalidModuleList(hProcess);

late final _RemoveInvalidModuleList = _dbghelp.lookupFunction<
    Void Function(IntPtr hProcess),
    void Function(int hProcess)>('RemoveInvalidModuleList');

int ReportSymbolLoadSummary(int hProcess, Pointer<Utf16> pLoadModule,
        Pointer<DBGHELP_DATA_REPORT_STRUCT> pSymbolData) =>
    _ReportSymbolLoadSummary(hProcess, pLoadModule, pSymbolData);

late final _ReportSymbolLoadSummary = _dbghelp.lookupFunction<
        Int32 Function(IntPtr hProcess, Pointer<Utf16> pLoadModule,
            Pointer<DBGHELP_DATA_REPORT_STRUCT> pSymbolData),
        int Function(int hProcess, Pointer<Utf16> pLoadModule,
            Pointer<DBGHELP_DATA_REPORT_STRUCT> pSymbolData)>(
    'ReportSymbolLoadSummary');

int SearchTreeForFile(Pointer<Utf16> RootPath, Pointer<Utf16> InputPathName,
        Pointer<Utf16> OutputPathBuffer) =>
    _SearchTreeForFile(RootPath, InputPathName, OutputPathBuffer);

late final _SearchTreeForFile = _dbghelp.lookupFunction<
    Int32 Function(Pointer<Utf16> RootPath, Pointer<Utf16> InputPathName,
        Pointer<Utf16> OutputPathBuffer),
    int Function(Pointer<Utf16> RootPath, Pointer<Utf16> InputPathName,
        Pointer<Utf16> OutputPathBuffer)>('SearchTreeForFileW');

void SetCheckUserInterruptShared(
        Pointer<NativeFunction<LPCALL_BACK_USER_INTERRUPT_ROUTINE>>
            lpStartAddress) =>
    _SetCheckUserInterruptShared(lpStartAddress);
...
late final _SetCheckUserInterruptShared = _dbghelp.lookupFunction<
    ...
    void Function(
        Pointer<NativeFunction<LPCALL_BACK_USER_INTERRUPT_ROUTINE>>
            lpStartAddress)>('SetCheckUserInterruptShared');

void SetSymLoadError(int error) => _SetSymLoadError(error);

late final _SetSymLoadError = _dbghelp.lookupFunction<
    Void Function(Uint32 error), void Function(int error)>('SetSymLoadError');
...
int StackWalk64(
        ...
        Pointer<NativeFunction<PREAD_PROCESS_MEMORY_ROUTINE64>>
            ReadMemoryRoutine,
        Pointer<NativeFunction<PFUNCTION_TABLE_ACCESS_ROUTINE64>>
            FunctionTableAccessRoutine,
        Pointer<NativeFunction<PGET_MODULE_BASE_ROUTINE64>>
            GetModuleBaseRoutine,
        Pointer<NativeFunction<PTRANSLATE_ADDRESS_ROUTINE64>>
            TranslateAddress) =>
    _StackWalk64(
        MachineType,
        hProcess,
...
late final _StackWalkEx = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        Pointer<NativeFunction<PGET_MODULE_BASE_ROUTINE64>>
            GetModuleBaseRoutine,
        Pointer<NativeFunction<PTRANSLATE_ADDRESS_ROUTINE64>> TranslateAddress,
        int Flags)>('StackWalkEx');

int SymAddSourceStream(int hProcess, int Base, Pointer<Utf16> FileSpec,
        Pointer<Uint8> Buffer, int Size) =>
    _SymAddSourceStream(hProcess, Base, FileSpec, Buffer, Size);

late final _SymAddSourceStream = _dbghelp.lookupFunction<
    Int32 Function(IntPtr hProcess, Uint64 Base, Pointer<Utf16> FileSpec,
        Pointer<Uint8> Buffer, IntPtr Size),
    int Function(int hProcess, int Base, Pointer<Utf16> FileSpec,
        Pointer<Uint8> Buffer, int Size)>('SymAddSourceStreamW');

int SymAddSymbol(int hProcess, int BaseOfDll, Pointer<Utf16> Name, int Address,
        int Size, int Flags) =>
    _SymAddSymbol(hProcess, BaseOfDll, Name, Address, Size, Flags);

late final _SymAddSymbol = _dbghelp.lookupFunction<
    Int32 Function(IntPtr hProcess, Uint64 BaseOfDll, Pointer<Utf16> Name,
        Uint64 Address, Uint32 Size, Uint32 Flags),
    int Function(int hProcess, int BaseOfDll, Pointer<Utf16> Name, int Address,
        int Size, int Flags)>('SymAddSymbolW');

int SymAddrIncludeInlineTrace(int hProcess, int Address) =>
    _SymAddrIncludeInlineTrace(hProcess, Address);

late final _SymAddrIncludeInlineTrace = _dbghelp.lookupFunction<
    Uint32 Function(IntPtr hProcess, Uint64 Address),
    int Function(int hProcess, int Address)>('SymAddrIncludeInlineTrace');
...
int SymCompareInlineTrace(int hProcess, int Address1, int InlineContext1,
        int RetAddress1, int Address2, int RetAddress2) =>
...
late final _SymCompareInlineTrace = _dbghelp.lookupFunction<
    Uint32 Function(IntPtr hProcess, Uint64 Address1, Uint32 InlineContext1,
        Uint64 RetAddress1, Uint64 Address2, Uint64 RetAddress2),
    int Function(
        int hProcess,
        int Address1,
        int InlineContext1,
        int RetAddress1,
        int Address2,
        int RetAddress2)>('SymCompareInlineTrace');

int SymDeleteSymbol(int hProcess, int BaseOfDll, Pointer<Utf16> Name,
        int Address, int Flags) =>
    _SymDeleteSymbol(hProcess, BaseOfDll, Name, Address, Flags);

late final _SymDeleteSymbol = _dbghelp.lookupFunction<
    Int32 Function(IntPtr hProcess, Uint64 BaseOfDll, Pointer<Utf16> Name,
        Uint64 Address, Uint32 Flags),
    int Function(int hProcess, int BaseOfDll, Pointer<Utf16> Name, int Address,
        int Flags)>('SymDeleteSymbolW');
...
int SymEnumLines(
        ...
        Pointer UserContext) =>
    _SymEnumLines(hProcess, Base, Obj, File, EnumLinesCallback, UserContext);
...
late final _SymEnumLines = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Utf16> File,
        Pointer<NativeFunction<PSYM_ENUMLINES_CALLBACKW>> EnumLinesCallback,
        Pointer UserContext)>('SymEnumLinesW');

int SymEnumProcesses(
        Pointer<NativeFunction<PSYM_ENUMPROCESSES_CALLBACK>>
            EnumProcessesCallback,
        Pointer UserContext) =>
    _SymEnumProcesses(EnumProcessesCallback, UserContext);
...
late final _SymEnumProcesses = _dbghelp.lookupFunction<
    ...
    int Function(
        Pointer<NativeFunction<PSYM_ENUMPROCESSES_CALLBACK>>
            EnumProcessesCallback,
        Pointer UserContext)>('SymEnumProcesses');

int SymEnumSourceFileTokens(int hProcess, int Base,
        Pointer<NativeFunction<PENUMSOURCEFILETOKENSCALLBACK>> Callback) =>
    _SymEnumSourceFileTokens(hProcess, Base, Callback);

late final _SymEnumSourceFileTokens = _dbghelp.lookupFunction<
        Int32 Function(IntPtr hProcess, Uint64 Base,
            Pointer<NativeFunction<PENUMSOURCEFILETOKENSCALLBACK>> Callback),
        int Function(int hProcess, int Base,
            Pointer<NativeFunction<PENUMSOURCEFILETOKENSCALLBACK>> Callback)>(
...
int SymEnumSourceFiles(
        ...
        Pointer UserContext) =>
    _SymEnumSourceFiles(hProcess, ModBase, Mask, cbSrcFiles, UserContext);
...
late final _SymEnumSourceFiles = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Utf16> Mask,
        Pointer<NativeFunction<PSYM_ENUMSOURCEFILES_CALLBACKW>> cbSrcFiles,
        Pointer UserContext)>('SymEnumSourceFilesW');
...
late final _SymEnumSourceLines = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        int Flags,
        Pointer<NativeFunction<PSYM_ENUMLINES_CALLBACKW>> EnumLinesCallback,
        Pointer UserContext)>('SymEnumSourceLinesW');
...
int SymEnumSym(
        ...
        Pointer<NativeFunction<PSYM_ENUMERATESYMBOLS_CALLBACK>>
            EnumSymbolsCallback,
        Pointer UserContext) =>
    _SymEnumSym(hProcess, BaseOfDll, EnumSymbolsCallback, UserContext);
...
late final _SymEnumSym = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        Pointer<NativeFunction<PSYM_ENUMERATESYMBOLS_CALLBACK>>
            EnumSymbolsCallback,
        Pointer UserContext)>('SymEnumSym');

int SymEnumSymbolsEx(
        int hProcess,
        int BaseOfDll,
        Pointer<Utf16> Mask,
        Pointer<NativeFunction<PSYM_ENUMERATESYMBOLS_CALLBACKW>>
            EnumSymbolsCallback,
        Pointer UserContext,
        int Options) =>
    _SymEnumSymbolsEx(
...
int SymEnumSymbolsForAddr(
        ...
        Pointer<NativeFunction<PSYM_ENUMERATESYMBOLS_CALLBACKW>>
            EnumSymbolsCallback,
        Pointer UserContext) =>
    _SymEnumSymbolsForAddr(hProcess, Address, EnumSymbolsCallback, UserContext);
...
late final _SymEnumSymbolsForAddr = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        Pointer<NativeFunction<PSYM_ENUMERATESYMBOLS_CALLBACKW>>
            EnumSymbolsCallback,
        Pointer UserContext)>('SymEnumSymbolsForAddrW');
...
late final _SymEnumTypesByName = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        Pointer<NativeFunction<PSYM_ENUMERATESYMBOLS_CALLBACKW>>
            EnumSymbolsCallback,
        Pointer UserContext)>('SymEnumTypesByNameW');
...
int SymEnumTypes(
        ...
        Pointer<NativeFunction<PSYM_ENUMERATESYMBOLS_CALLBACKW>>
            EnumSymbolsCallback,
        Pointer UserContext) =>
    _SymEnumTypes(hProcess, BaseOfDll, EnumSymbolsCallback, UserContext);
...
late final _SymEnumTypes = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        Pointer<NativeFunction<PSYM_ENUMERATESYMBOLS_CALLBACKW>>
            EnumSymbolsCallback,
        Pointer UserContext)>('SymEnumTypesW');

int SymEnumerateModules64(
        int hProcess,
        Pointer<NativeFunction<PSYM_ENUMMODULES_CALLBACK64>>
            EnumModulesCallback,
        Pointer UserContext) =>
...
late final _SymEnumerateModules64 = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        Pointer<NativeFunction<PSYM_ENUMMODULES_CALLBACK64>>
            EnumModulesCallback,
        Pointer UserContext)>('SymEnumerateModules64');

int SymEnumerateModulesW64(
        int hProcess,
        Pointer<NativeFunction<PSYM_ENUMMODULES_CALLBACKW64>>
            EnumModulesCallback,
        Pointer UserContext) =>
    _SymEnumerateModulesW64(hProcess, EnumModulesCallback, UserContext);
...
late final _SymEnumerateModulesW64 = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        Pointer<NativeFunction<PSYM_ENUMMODULES_CALLBACKW64>>
            EnumModulesCallback,
        Pointer UserContext)>('SymEnumerateModulesW64');

int SymEnumerateSymbols64(
        int hProcess,
        int BaseOfDll,
        Pointer<NativeFunction<PSYM_ENUMSYMBOLS_CALLBACK64>>
            EnumSymbolsCallback,
        Pointer UserContext) =>
...
late final _SymEnumerateSymbols64 = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        Pointer<NativeFunction<PSYM_ENUMSYMBOLS_CALLBACK64>>
            EnumSymbolsCallback,
        Pointer UserContext)>('SymEnumerateSymbols64');

int SymEnumerateSymbolsW64(
        int hProcess,
        int BaseOfDll,
        Pointer<NativeFunction<PSYM_ENUMSYMBOLS_CALLBACK64W>>
            EnumSymbolsCallback,
        Pointer UserContext) =>
...
late final _SymEnumerateSymbolsW64 = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        Pointer<NativeFunction<PSYM_ENUMSYMBOLS_CALLBACK64W>>
            EnumSymbolsCallback,
        Pointer UserContext)>('SymEnumerateSymbolsW64');
...
late final _SymFindDebugInfoFile = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Utf16> DebugFilePath,
        Pointer<NativeFunction<PFIND_DEBUG_FILE_CALLBACKW>> Callback,
        Pointer CallerData)>('SymFindDebugInfoFileW');
...
late final _SymFindExecutableImage = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Utf16> ImageFilePath,
        Pointer<NativeFunction<PFIND_EXE_FILE_CALLBACKW>> Callback,
        Pointer CallerData)>('SymFindExecutableImageW');
...
int SymFindFileInPath(
        ...
        Pointer context) =>
    _SymFindFileInPath(hprocess, SearchPathA, FileName, id, two, three, flags,
        FoundFile, callback, context);
...
late final _SymFindFileInPath = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Utf16> FoundFile,
        Pointer<NativeFunction<PFINDFILEINPATHCALLBACKW>> callback,
        Pointer context)>('SymFindFileInPathW');
...
int SymFromIndex(
        int hProcess, int BaseOfDll, int Index, Pointer<SYMBOL_INFO> Symbol) =>
    _SymFromIndex(hProcess, BaseOfDll, Index, Symbol);
...
late final _SymFromIndex = _dbghelp.lookupFunction<
    ...
    int Function(int hProcess, int BaseOfDll, int Index,
        Pointer<SYMBOL_INFO> Symbol)>('SymFromIndexW');

int SymFromInlineContext(int hProcess, int Address, int InlineContext,
        Pointer<Uint64> Displacement, Pointer<SYMBOL_INFO> Symbol) =>
...
late final _SymFromInlineContext = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        Pointer<SYMBOL_INFO> Symbol)>('SymFromInlineContextW');

int SymFromName(
        int hProcess, Pointer<Utf16> Name, Pointer<SYMBOL_INFO> Symbol) =>
    _SymFromName(hProcess, Name, Symbol);

late final _SymFromName = _dbghelp.lookupFunction<
    Int32 Function(
        IntPtr hProcess, Pointer<Utf16> Name, Pointer<SYMBOL_INFO> Symbol),
    int Function(int hProcess, Pointer<Utf16> Name,
        Pointer<SYMBOL_INFO> Symbol)>('SymFromNameW');
...
Pointer SymFunctionTableAccess64(int hProcess, int AddrBase) =>
    _SymFunctionTableAccess64(hProcess, AddrBase);

late final _SymFunctionTableAccess64 = _dbghelp.lookupFunction<
    Pointer Function(IntPtr hProcess, Uint64 AddrBase),
    Pointer Function(int hProcess, int AddrBase)>('SymFunctionTableAccess64');
...
late final _SymFunctionTableAccess64AccessRoutines = _dbghelp.lookupFunction<
    ...
    Pointer Function(
        ...
        Pointer<NativeFunction<PREAD_PROCESS_MEMORY_ROUTINE64>>
            ReadMemoryRoutine,
        Pointer<NativeFunction<PGET_MODULE_BASE_ROUTINE64>>
            GetModuleBaseRoutine)>('SymFunctionTableAccess64AccessRoutines');
...
int SymGetFileLineOffsets64(int hProcess, Pointer<Utf8> ModuleName,
        Pointer<Utf8> FileName, Pointer<Uint64> Buffer, int BufferLines) =>
...
late final _SymGetFileLineOffsets64 = _dbghelp.lookupFunction<
    Uint32 Function(IntPtr hProcess, Pointer<Utf8> ModuleName,
        Pointer<Utf8> FileName, Pointer<Uint64> Buffer, Uint32 BufferLines),
    int Function(int hProcess, Pointer<Utf8> ModuleName, Pointer<Utf8> FileName,
        Pointer<Uint64> Buffer, int BufferLines)>('SymGetFileLineOffsets64');

Pointer<Utf16> SymGetHomeDirectory(int type, Pointer<Utf16> dir, int size) =>
    _SymGetHomeDirectory(type, dir, size);

late final _SymGetHomeDirectory = _dbghelp.lookupFunction<
    Pointer<Utf16> Function(Int32 type, Pointer<Utf16> dir, IntPtr size),
    Pointer<Utf16> Function(
        int type, Pointer<Utf16> dir, int size)>('SymGetHomeDirectoryW');

int SymGetLineFromAddr64(int hProcess, int qwAddr,
        Pointer<Uint32> pdwDisplacement, Pointer<IMAGEHLP_LINE64> Line64) =>
    _SymGetLineFromAddr64(hProcess, qwAddr, pdwDisplacement, Line64);

late final _SymGetLineFromAddr64 = _dbghelp.lookupFunction<
    Int32 Function(IntPtr hProcess, Uint64 qwAddr,
        Pointer<Uint32> pdwDisplacement, Pointer<IMAGEHLP_LINE64> Line64),
    int Function(int hProcess, int qwAddr, Pointer<Uint32> pdwDisplacement,
        Pointer<IMAGEHLP_LINE64> Line64)>('SymGetLineFromAddr64');

int SymGetLineFromAddrW64(int hProcess, int dwAddr,
        Pointer<Uint32> pdwDisplacement, Pointer<IMAGEHLP_LINEW64> Line) =>
    _SymGetLineFromAddrW64(hProcess, dwAddr, pdwDisplacement, Line);

late final _SymGetLineFromAddrW64 = _dbghelp.lookupFunction<
    Int32 Function(IntPtr hProcess, Uint64 dwAddr,
        Pointer<Uint32> pdwDisplacement, Pointer<IMAGEHLP_LINEW64> Line),
    int Function(int hProcess, int dwAddr, Pointer<Uint32> pdwDisplacement,
        Pointer<IMAGEHLP_LINEW64> Line)>('SymGetLineFromAddrW64');
...
int SymGetLineFromInlineContext(
    ...
    _SymGetLineFromInlineContext(hProcess, dwAddr, InlineContext,
        qwModuleBaseAddress, pdwDisplacement, Line);
...
late final _SymGetLineFromInlineContext = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        int qwModuleBaseAddress,
        Pointer<Uint32> pdwDisplacement,
        Pointer<IMAGEHLP_LINEW64> Line)>('SymGetLineFromInlineContextW');
...
late final _SymGetLineFromName64 = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        int dwLineNumber,
        Pointer<Int32> plDisplacement,
        Pointer<IMAGEHLP_LINE64> Line)>('SymGetLineFromName64');
...
late final _SymGetLineFromNameW64 = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        int dwLineNumber,
        Pointer<Int32> plDisplacement,
        Pointer<IMAGEHLP_LINEW64> Line)>('SymGetLineFromNameW64');

int SymGetLineNext64(int hProcess, Pointer<IMAGEHLP_LINE64> Line) =>
    _SymGetLineNext64(hProcess, Line);

late final _SymGetLineNext64 = _dbghelp.lookupFunction<
    Int32 Function(IntPtr hProcess, Pointer<IMAGEHLP_LINE64> Line),
    int Function(
        int hProcess, Pointer<IMAGEHLP_LINE64> Line)>('SymGetLineNext64');

int SymGetLineNextW64(int hProcess, Pointer<IMAGEHLP_LINEW64> Line) =>
    _SymGetLineNextW64(hProcess, Line);

late final _SymGetLineNextW64 = _dbghelp.lookupFunction<
    Int32 Function(IntPtr hProcess, Pointer<IMAGEHLP_LINEW64> Line),
    int Function(
        int hProcess, Pointer<IMAGEHLP_LINEW64> Line)>('SymGetLineNextW64');

int SymGetLinePrev64(int hProcess, Pointer<IMAGEHLP_LINE64> Line) =>
    _SymGetLinePrev64(hProcess, Line);

late final _SymGetLinePrev64 = _dbghelp.lookupFunction<
    Int32 Function(IntPtr hProcess, Pointer<IMAGEHLP_LINE64> Line),
    int Function(
        int hProcess, Pointer<IMAGEHLP_LINE64> Line)>('SymGetLinePrev64');

int SymGetLinePrevW64(int hProcess, Pointer<IMAGEHLP_LINEW64> Line) =>
    _SymGetLinePrevW64(hProcess, Line);

late final _SymGetLinePrevW64 = _dbghelp.lookupFunction<
    Int32 Function(IntPtr hProcess, Pointer<IMAGEHLP_LINEW64> Line),
    int Function(
        int hProcess, Pointer<IMAGEHLP_LINEW64> Line)>('SymGetLinePrevW64');

int SymGetModuleBase64(int hProcess, int qwAddr) =>
    _SymGetModuleBase64(hProcess, qwAddr);

late final _SymGetModuleBase64 = _dbghelp.lookupFunction<
    Uint64 Function(IntPtr hProcess, Uint64 qwAddr),
    int Function(int hProcess, int qwAddr)>('SymGetModuleBase64');

int SymGetModuleInfo64(
        int hProcess, int qwAddr, Pointer<IMAGEHLP_MODULE64> ModuleInfo) =>
    _SymGetModuleInfo64(hProcess, qwAddr, ModuleInfo);

late final _SymGetModuleInfo64 = _dbghelp.lookupFunction<
    Int32 Function(
        IntPtr hProcess, Uint64 qwAddr, Pointer<IMAGEHLP_MODULE64> ModuleInfo),
    int Function(int hProcess, int qwAddr,
        Pointer<IMAGEHLP_MODULE64> ModuleInfo)>('SymGetModuleInfo64');

int SymGetModuleInfoW64(
        int hProcess, int qwAddr, Pointer<IMAGEHLP_MODULEW64> ModuleInfo) =>
    _SymGetModuleInfoW64(hProcess, qwAddr, ModuleInfo);

late final _SymGetModuleInfoW64 = _dbghelp.lookupFunction<
    Int32 Function(
        IntPtr hProcess, Uint64 qwAddr, Pointer<IMAGEHLP_MODULEW64> ModuleInfo),
    int Function(int hProcess, int qwAddr,
        Pointer<IMAGEHLP_MODULEW64> ModuleInfo)>('SymGetModuleInfoW64');
...
int SymGetOmaps(
    ...
    _SymGetOmaps(hProcess, BaseOfDll, OmapTo, cOmapTo, OmapFrom, cOmapFrom);
...
late final _SymGetOmaps = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint64> cOmapTo,
        Pointer<Pointer<OMAP>> OmapFrom,
        Pointer<Uint64> cOmapFrom)>('SymGetOmaps');
...
int SymGetScope(
        int hProcess, int BaseOfDll, int Index, Pointer<SYMBOL_INFO> Symbol) =>
    _SymGetScope(hProcess, BaseOfDll, Index, Symbol);

late final _SymGetScope = _dbghelp.lookupFunction<
    Int32 Function(IntPtr hProcess, Uint64 BaseOfDll, Uint32 Index,
        Pointer<SYMBOL_INFO> Symbol),
    int Function(int hProcess, int BaseOfDll, int Index,
        Pointer<SYMBOL_INFO> Symbol)>('SymGetScopeW');

int SymGetSearchPath(
        int hProcess, Pointer<Utf16> SearchPathA, int SearchPathLength) =>
    _SymGetSearchPath(hProcess, SearchPathA, SearchPathLength);

late final _SymGetSearchPath = _dbghelp.lookupFunction<
    Int32 Function(
        IntPtr hProcess, Pointer<Utf16> SearchPathA, Uint32 SearchPathLength),
    int Function(int hProcess, Pointer<Utf16> SearchPathA,
        int SearchPathLength)>('SymGetSearchPathW');
...
int SymGetSourceFileChecksum(
    ...
    _SymGetSourceFileChecksum(hProcess, Base, FileSpec, pCheckSumType,
        pChecksum, checksumSize, pActualBytesWritten);
...
late final _SymGetSourceFileChecksum = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint8> pChecksum,
        int checksumSize,
        Pointer<Uint32> pActualBytesWritten)>('SymGetSourceFileChecksumW');
...
int SymGetSourceFileFromTokenByTokenName(
    ...
    _SymGetSourceFileFromTokenByTokenName(
        hProcess, Token, TokenName, Params, FilePath, Size);

late final _SymGetSourceFileFromTokenByTokenName = _dbghelp.lookupFunction<
    Int32 Function(IntPtr hProcess, Pointer Token, Pointer<Utf16> TokenName,
        Pointer<Utf16> Params, Pointer<Utf16> FilePath, Uint32 Size),
    int Function(
        int hProcess,
        Pointer Token,
        Pointer<Utf16> TokenName,
        Pointer<Utf16> Params,
        Pointer<Utf16> FilePath,
        int Size)>('SymGetSourceFileFromTokenByTokenNameW');

int SymGetSourceFileFromToken(int hProcess, Pointer Token,
        Pointer<Utf16> Params, Pointer<Utf16> FilePath, int Size) =>
    _SymGetSourceFileFromToken(hProcess, Token, Params, FilePath, Size);

late final _SymGetSourceFileFromToken = _dbghelp.lookupFunction<
    Int32 Function(IntPtr hProcess, Pointer Token, Pointer<Utf16> Params,
        Pointer<Utf16> FilePath, Uint32 Size),
    int Function(int hProcess, Pointer Token, Pointer<Utf16> Params,
        Pointer<Utf16> FilePath, int Size)>('SymGetSourceFileFromTokenW');
...
int SymGetSourceFileTokenByTokenName(
    ...
    _SymGetSourceFileTokenByTokenName(
        hProcess, Base, FileSpec, TokenName, TokenParameters, Token, Size);
...
late final _SymGetSourceFileTokenByTokenName = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Utf16> TokenParameters,
        Pointer<Pointer> Token,
        Pointer<Uint32> Size)>('SymGetSourceFileTokenByTokenNameW');

int SymGetSourceFileToken(int hProcess, int Base, Pointer<Utf16> FileSpec,
        Pointer<Pointer> Token, Pointer<Uint32> Size) =>
    _SymGetSourceFileToken(hProcess, Base, FileSpec, Token, Size);
...
late final _SymGetSourceFileToken = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Utf16> FileSpec,
        Pointer<Pointer> Token,
        Pointer<Uint32> Size)>('SymGetSourceFileTokenW');

int SymGetSourceFile(int hProcess, int Base, Pointer<Utf16> Params,
        Pointer<Utf16> FileSpec, Pointer<Utf16> FilePath, int Size) =>
    _SymGetSourceFile(hProcess, Base, Params, FileSpec, FilePath, Size);

late final _SymGetSourceFile = _dbghelp.lookupFunction<
    Int32 Function(IntPtr hProcess, Uint64 Base, Pointer<Utf16> Params,
        Pointer<Utf16> FileSpec, Pointer<Utf16> FilePath, Uint32 Size),
    int Function(
        int hProcess,
        int Base,
        Pointer<Utf16> Params,
        Pointer<Utf16> FileSpec,
        Pointer<Utf16> FilePath,
        int Size)>('SymGetSourceFileW');

int SymGetSourceVarFromToken(int hProcess, Pointer Token, Pointer<Utf16> Params,
        Pointer<Utf16> VarName, Pointer<Utf16> Value, int Size) =>
    _SymGetSourceVarFromToken(hProcess, Token, Params, VarName, Value, Size);

late final _SymGetSourceVarFromToken = _dbghelp.lookupFunction<
    Int32 Function(IntPtr hProcess, Pointer Token, Pointer<Utf16> Params,
        Pointer<Utf16> VarName, Pointer<Utf16> Value, Uint32 Size),
    int Function(
        int hProcess,
        Pointer Token,
        Pointer<Utf16> Params,
        ...
        Pointer<Utf16> Value,
        int Size)>('SymGetSourceVarFromTokenW');

int SymGetSymFromAddr64(int hProcess, int qwAddr,
        Pointer<Uint64> pdwDisplacement, Pointer<IMAGEHLP_SYMBOL64> Symbol) =>
    _SymGetSymFromAddr64(hProcess, qwAddr, pdwDisplacement, Symbol);

late final _SymGetSymFromAddr64 = _dbghelp.lookupFunction<
    Int32 Function(IntPtr hProcess, Uint64 qwAddr,
        Pointer<Uint64> pdwDisplacement, Pointer<IMAGEHLP_SYMBOL64> Symbol),
    int Function(int hProcess, int qwAddr, Pointer<Uint64> pdwDisplacement,
        Pointer<IMAGEHLP_SYMBOL64> Symbol)>('SymGetSymFromAddr64');

int SymGetSymFromName64(
        int hProcess, Pointer<Utf8> Name, Pointer<IMAGEHLP_SYMBOL64> Symbol) =>
    _SymGetSymFromName64(hProcess, Name, Symbol);

late final _SymGetSymFromName64 = _dbghelp.lookupFunction<
    Int32 Function(
        IntPtr hProcess, Pointer<Utf8> Name, Pointer<IMAGEHLP_SYMBOL64> Symbol),
    int Function(int hProcess, Pointer<Utf8> Name,
        Pointer<IMAGEHLP_SYMBOL64> Symbol)>('SymGetSymFromName64');

int SymGetSymNext64(int hProcess, Pointer<IMAGEHLP_SYMBOL64> Symbol) =>
    _SymGetSymNext64(hProcess, Symbol);

late final _SymGetSymNext64 = _dbghelp.lookupFunction<
    Int32 Function(IntPtr hProcess, Pointer<IMAGEHLP_SYMBOL64> Symbol),
    int Function(
        int hProcess, Pointer<IMAGEHLP_SYMBOL64> Symbol)>('SymGetSymNext64');

int SymGetSymPrev64(int hProcess, Pointer<IMAGEHLP_SYMBOL64> Symbol) =>
    _SymGetSymPrev64(hProcess, Symbol);

late final _SymGetSymPrev64 = _dbghelp.lookupFunction<
    Int32 Function(IntPtr hProcess, Pointer<IMAGEHLP_SYMBOL64> Symbol),
    int Function(
        int hProcess, Pointer<IMAGEHLP_SYMBOL64> Symbol)>('SymGetSymPrev64');
...
int SymGetSymbolFile(
        ...
        int cDbgFile) =>
    _SymGetSymbolFile(hProcess, SymPath, ImageFile, Type, SymbolFile,
        cSymbolFile, DbgFile, cDbgFile);
...
late final _SymGetSymbolFile = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        int cSymbolFile,
        Pointer<Utf16> DbgFile,
        int cDbgFile)>('SymGetSymbolFileW');

int SymGetTypeFromName(int hProcess, int BaseOfDll, Pointer<Utf16> Name,
        Pointer<SYMBOL_INFO> Symbol) =>
    _SymGetTypeFromName(hProcess, BaseOfDll, Name, Symbol);

late final _SymGetTypeFromName = _dbghelp.lookupFunction<
    Int32 Function(IntPtr hProcess, Uint64 BaseOfDll, Pointer<Utf16> Name,
        Pointer<SYMBOL_INFO> Symbol),
    int Function(int hProcess, int BaseOfDll, Pointer<Utf16> Name,
        Pointer<SYMBOL_INFO> Symbol)>('SymGetTypeFromNameW');

int SymGetTypeInfo(
        int hProcess, int ModBase, int TypeId, int GetType, Pointer pInfo) =>
    _SymGetTypeInfo(hProcess, ModBase, TypeId, GetType, pInfo);

late final _SymGetTypeInfo = _dbghelp.lookupFunction<
    Int32 Function(IntPtr hProcess, Uint64 ModBase, Uint32 TypeId,
        Int32 GetType, Pointer pInfo),
    int Function(int hProcess, int ModBase, int TypeId, int GetType,
        Pointer pInfo)>('SymGetTypeInfo');

int SymGetTypeInfoEx(int hProcess, int ModBase,
        Pointer<IMAGEHLP_GET_TYPE_INFO_PARAMS> Params) =>
    _SymGetTypeInfoEx(hProcess, ModBase, Params);

late final _SymGetTypeInfoEx = _dbghelp.lookupFunction<
    Int32 Function(IntPtr hProcess, Uint64 ModBase,
        Pointer<IMAGEHLP_GET_TYPE_INFO_PARAMS> Params),
    int Function(int hProcess, int ModBase,
        Pointer<IMAGEHLP_GET_TYPE_INFO_PARAMS> Params)>('SymGetTypeInfoEx');

int SymGetUnwindInfo(
        int hProcess, int Address, Pointer Buffer, Pointer<Uint32> Size) =>
    _SymGetUnwindInfo(hProcess, Address, Buffer, Size);

late final _SymGetUnwindInfo = _dbghelp.lookupFunction<
    Int32 Function(
        IntPtr hProcess, Uint64 Address, Pointer Buffer, Pointer<Uint32> Size),
    int Function(int hProcess, int Address, Pointer Buffer,
        Pointer<Uint32> Size)>('SymGetUnwindInfo');
...
int SymLoadModule64(int hProcess, int hFile, Pointer<Utf8> ImageName,
        Pointer<Utf8> ModuleName, int BaseOfDll, int SizeOfDll) =>
    _SymLoadModule64(
        hProcess, hFile, ImageName, ModuleName, BaseOfDll, SizeOfDll);

late final _SymLoadModule64 = _dbghelp.lookupFunction<
    Uint64 Function(IntPtr hProcess, IntPtr hFile, Pointer<Utf8> ImageName,
        Pointer<Utf8> ModuleName, Uint64 BaseOfDll, Uint32 SizeOfDll),
    int Function(
        int hProcess,
        int hFile,
...
int SymMatchFileName(
    ...
    _SymMatchFileName(FileName, Match, FileNameStop, MatchStop);
...
late final _SymMatchFileName = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Utf16> Match,
        Pointer<Pointer<Utf16>> FileNameStop,
        Pointer<Pointer<Utf16>> MatchStop)>('SymMatchFileNameW');

int SymMatchString(
        Pointer<Utf16> string, Pointer<Utf16> expression, int fCase) =>
    _SymMatchString(string, expression, fCase);

late final _SymMatchString = _dbghelp.lookupFunction<
    Int32 Function(
        Pointer<Utf16> string, Pointer<Utf16> expression, Int32 fCase),
    int Function(Pointer<Utf16> string, Pointer<Utf16> expression,
        int fCase)>('SymMatchStringW');

int SymNext(int hProcess, Pointer<SYMBOL_INFO> siw) => _SymNext(hProcess, siw);

late final _SymNext = _dbghelp.lookupFunction<
    Int32 Function(IntPtr hProcess, Pointer<SYMBOL_INFO> siw),
    int Function(int hProcess, Pointer<SYMBOL_INFO> siw)>('SymNextW');

int SymPrev(int hProcess, Pointer<SYMBOL_INFO> siw) => _SymPrev(hProcess, siw);

late final _SymPrev = _dbghelp.lookupFunction<
    Int32 Function(IntPtr hProcess, Pointer<SYMBOL_INFO> siw),
    int Function(int hProcess, Pointer<SYMBOL_INFO> siw)>('SymPrevW');
...
int SymQueryInlineTrace(
    ...
    _SymQueryInlineTrace(hProcess, StartAddress, StartContext, StartRetAddress,
        CurAddress, CurContext, CurFrameIndex);
...
late final _SymQueryInlineTrace = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        int CurAddress,
        Pointer<Uint32> CurContext,
        Pointer<Uint32> CurFrameIndex)>('SymQueryInlineTrace');

int SymRefreshModuleList(int hProcess) => _SymRefreshModuleList(hProcess);

late final _SymRefreshModuleList = _dbghelp.lookupFunction<
    Int32 Function(IntPtr hProcess),
    int Function(int hProcess)>('SymRefreshModuleList');

int SymRegisterCallback64(
        int hProcess,
        Pointer<NativeFunction<PSYMBOL_REGISTERED_CALLBACK64>> CallbackFunction,
        int UserContext) =>
    _SymRegisterCallback64(hProcess, CallbackFunction, UserContext);
...
late final _SymRegisterCallback64 = _dbghelp.lookupFunction<
    ...
    int Function(
        int hProcess,
        Pointer<NativeFunction<PSYMBOL_REGISTERED_CALLBACK64>> CallbackFunction,
        int UserContext)>('SymRegisterCallback64');

int SymRegisterCallbackW64(
        int hProcess,
        Pointer<NativeFunction<PSYMBOL_REGISTERED_CALLBACK64>> CallbackFunction,
        int UserContext) =>
    _SymRegisterCallbackW64(hProcess, CallbackFunction, UserContext);
...
late final _SymRegisterCallbackW64 = _dbghelp.lookupFunction<
    ...
    int Function(
        int hProcess,
        Pointer<NativeFunction<PSYMBOL_REGISTERED_CALLBACK64>> CallbackFunction,
        int UserContext)>('SymRegisterCallbackW64');
...
late final _SymRegisterFunctionEntryCallback64 = _dbghelp.lookupFunction<
    ...
    int Function(
        int hProcess,
        Pointer<NativeFunction<PSYMBOL_FUNCENTRY_CALLBACK64>> CallbackFunction,
        int UserContext)>('SymRegisterFunctionEntryCallback64');
...
int SymSearch(
        ...
        Pointer UserContext,
        int Options) =>
    _SymSearch(hProcess, BaseOfDll, Index, SymTag, Mask, Address,
...
late final _SymSearch = _dbghelp.lookupFunction<
    ...
    int Function(
        ...
        Pointer<NativeFunction<PSYM_ENUMERATESYMBOLS_CALLBACKW>>
            EnumSymbolsCallback,
        Pointer UserContext,
        int Options)>('SymSearchW');

int SymSetContext(int hProcess, Pointer<IMAGEHLP_STACK_FRAME> StackFrame,
        Pointer Context) =>
    _SymSetContext(hProcess, StackFrame, Context);

late final _SymSetContext = _dbghelp.lookupFunction<
    Int32 Function(IntPtr hProcess, Pointer<IMAGEHLP_STACK_FRAME> StackFrame,
        Pointer Context),
    int Function(int hProcess, Pointer<IMAGEHLP_STACK_FRAME> StackFrame,
        Pointer Context)>('SymSetContext');
...
Pointer<Utf16> SymSetHomeDirectory(int hProcess, Pointer<Utf16> dir) =>
    _SymSetHomeDirectory(hProcess, dir);

late final _SymSetHomeDirectory = _dbghelp.lookupFunction<
    Pointer<Utf16> Function(IntPtr hProcess, Pointer<Utf16> dir),
    Pointer<Utf16> Function(
        int hProcess, Pointer<Utf16> dir)>('SymSetHomeDirectoryW');
...
Pointer<Utf16> SymSrvDeltaName(int hProcess, Pointer<Utf16> SymPath,
        Pointer<Utf16> Type, Pointer<Utf16> File1, Pointer<Utf16> File2) =>
    _SymSrvDeltaName(hProcess, SymPath, Type, File1, File2);

late final _SymSrvDeltaName = _dbghelp.lookupFunction<
    Pointer<Utf16> Function(IntPtr hProcess, Pointer<Utf16> SymPath,
        Pointer<Utf16> Type, Pointer<Utf16> File1, Pointer<Utf16> File2),
    Pointer<Utf16> Function(
        int hProcess,
        Pointer<Utf16> SymPath,
        Pointer<Utf16> Type,
        Pointer<Utf16> File1,
        Pointer<Utf16> File2)>('SymSrvDeltaNameW');

int SymSrvGetFileIndexInfo(
        Pointer<Utf16> File, Pointer<SYMSRV_INDEX_INFO> Info, int Flags) =>
    _SymSrvGetFileIndexInfo(File, Info, Flags);

late final _SymSrvGetFileIndexInfo = _dbghelp.lookupFunction<
    Int32 Function(
        Pointer<Utf16> File, Pointer<SYMSRV_INDEX_INFO> Info, Uint32 Flags),
    int Function(Pointer<Utf16> File, Pointer<SYMSRV_INDEX_INFO> Info,
        int Flags)>('SymSrvGetFileIndexInfoW');

int SymSrvGetFileIndexString(int hProcess, Pointer<Utf16> SrvPath,
        Pointer<Utf16> File, Pointer<Utf16> Index, int Size, int Flags) =>
    _SymSrvGetFileIndexString(hProcess, SrvPath, File, Index, Size, Flags);

late final _SymSrvGetFileIndexString = _dbghelp.lookupFunction<
    Int32 Function(IntPtr hProcess, Pointer<Utf16> SrvPath, Pointer<Utf16> File,
        Pointer<Utf16> Index, IntPtr Size, Uint32 Flags),
    int Function(
        int hProcess,
        ...
        Pointer<Utf16> Index,
        int Size,
        int Flags)>('SymSrvGetFileIndexStringW');

int SymSrvGetFileIndexes(Pointer<Utf16> File, Pointer<GUID> Id,
        Pointer<Uint32> Val1, Pointer<Uint32> Val2, int Flags) =>
    _SymSrvGetFileIndexes(File, Id, Val1, Val2, Flags);

late final _SymSrvGetFileIndexes = _dbghelp.lookupFunction<
    Int32 Function(Pointer<Utf16> File, Pointer<GUID> Id, Pointer<Uint32> Val1,
        Pointer<Uint32> Val2, Uint32 Flags),
    int Function(Pointer<Utf16> File, Pointer<GUID> Id, Pointer<Uint32> Val1,
        Pointer<Uint32> Val2, int Flags)>('SymSrvGetFileIndexesW');

Pointer<Utf16> SymSrvGetSupplement(int hProcess, Pointer<Utf16> SymPath,
        Pointer<Utf16> Node, Pointer<Utf16> File) =>
    _SymSrvGetSupplement(hProcess, SymPath, Node, File);

late final _SymSrvGetSupplement = _dbghelp.lookupFunction<
    Pointer<Utf16> Function(IntPtr hProcess, Pointer<Utf16> SymPath,
        Pointer<Utf16> Node, Pointer<Utf16> File),
    Pointer<Utf16> Function(int hProcess, Pointer<Utf16> SymPath,
        Pointer<Utf16> Node, Pointer<Utf16> File)>('SymSrvGetSupplementW');

int SymSrvIsStore(int hProcess, Pointer<Utf16> path) =>
    _SymSrvIsStore(hProcess, path);

late final _SymSrvIsStore = _dbghelp.lookupFunction<
    Int32 Function(IntPtr hProcess, Pointer<Utf16> path),
    int Function(int hProcess, Pointer<Utf16> path)>('SymSrvIsStoreW');

Pointer<Utf16> SymSrvStoreFile(
        int hProcess, Pointer<Utf16> SrvPath, Pointer<Utf16> File, int Flags) =>
    _SymSrvStoreFile(hProcess, SrvPath, File, Flags);

late final _SymSrvStoreFile = _dbghelp.lookupFunction<
    Pointer<Utf16> Function(IntPtr hProcess, Pointer<Utf16> SrvPath,
        Pointer<Utf16> File, Uint32 Flags),
    Pointer<Utf16> Function(int hProcess, Pointer<Utf16> SrvPath,
        Pointer<Utf16> File, int Flags)>('SymSrvStoreFileW');

Pointer<Utf16> SymSrvStoreSupplement(int hProcess, Pointer<Utf16> SymPath,
        Pointer<Utf16> Node, Pointer<Utf16> File, int Flags) =>
    _SymSrvStoreSupplement(hProcess, SymPath, Node, File, Flags);

late final _SymSrvStoreSupplement = _dbghelp.lookupFunction<
    Pointer<Utf16> Function(IntPtr hProcess, Pointer<Utf16> SymPath,
        Pointer<Utf16> Node, Pointer<Utf16> File, Uint32 Flags),
    Pointer<Utf16> Function(
        int hProcess,
        Pointer<Utf16> SymPath,
        Pointer<Utf16> Node,
        Pointer<Utf16> File,
        int Flags)>('SymSrvStoreSupplementW');

int SymUnDName64(Pointer<IMAGEHLP_SYMBOL64> sym, Pointer<Utf8> UnDecName,
        int UnDecNameLength) =>
    _SymUnDName64(sym, UnDecName, UnDecNameLength);

late final _SymUnDName64 = _dbghelp.lookupFunction<
    Int32 Function(Pointer<IMAGEHLP_SYMBOL64> sym, Pointer<Utf8> UnDecName,
        Uint32 UnDecNameLength),
    int Function(Pointer<IMAGEHLP_SYMBOL64> sym, Pointer<Utf8> UnDecName,
        int UnDecNameLength)>('SymUnDName64');
...
int BindImage(Pointer<Utf8> ImageName, Pointer<Utf8> DllPath,
        Pointer<Utf8> SymbolPath) =>
    _BindImage(ImageName, DllPath, SymbolPath);

late final _BindImage = _imagehlp.lookupFunction<
    Int32 Function(Pointer<Utf8> ImageName, Pointer<Utf8> DllPath,
        Pointer<Utf8> SymbolPath),
    int Function(Pointer<Utf8> ImageName, Pointer<Utf8> DllPath,
        Pointer<Utf8> SymbolPath)>('BindImage');
...
int BindImageEx(
    ...
    _BindImageEx(Flags, ImageName, DllPath, SymbolPath, StatusRoutine);
...
Pointer<IMAGE_NT_HEADERS64> CheckSumMappedFile(Pointer BaseAddress,
        int FileLength, Pointer<Uint32> HeaderSum, Pointer<Uint32> CheckSum) =>
    _CheckSumMappedFile(BaseAddress, FileLength, HeaderSum, CheckSum);

late final _CheckSumMappedFile = _imagehlp.lookupFunction<
    Pointer<IMAGE_NT_HEADERS64> Function(Pointer BaseAddress, Uint32 FileLength,
        Pointer<Uint32> HeaderSum, Pointer<Uint32> CheckSum),
    Pointer<IMAGE_NT_HEADERS64> Function(
        Pointer BaseAddress,
        int FileLength,
        Pointer<Uint32> HeaderSum,
        Pointer<Uint32> CheckSum)>('CheckSumMappedFile');

int GetImageConfigInformation(Pointer<LOADED_IMAGE> LoadedImage,
        Pointer<IMAGE_LOAD_CONFIG_DIRECTORY64> ImageConfigInformation) =>
    _GetImageConfigInformation(LoadedImage, ImageConfigInformation);

late final _GetImageConfigInformation = _imagehlp.lookupFunction<
        Int32 Function(Pointer<LOADED_IMAGE> LoadedImage,
            Pointer<IMAGE_LOAD_CONFIG_DIRECTORY64> ImageConfigInformation),
        int Function(Pointer<LOADED_IMAGE> LoadedImage,
            Pointer<IMAGE_LOAD_CONFIG_DIRECTORY64> ImageConfigInformation)>(
    'GetImageConfigInformation');

int GetImageUnusedHeaderBytes(Pointer<LOADED_IMAGE> LoadedImage,
        Pointer<Uint32> SizeUnusedHeaderBytes) =>
    _GetImageUnusedHeaderBytes(LoadedImage, SizeUnusedHeaderBytes);

late final _GetImageUnusedHeaderBytes = _imagehlp.lookupFunction<
    Uint32 Function(Pointer<LOADED_IMAGE> LoadedImage,
        Pointer<Uint32> SizeUnusedHeaderBytes),
    int Function(Pointer<LOADED_IMAGE> LoadedImage,
        Pointer<Uint32> SizeUnusedHeaderBytes)>('GetImageUnusedHeaderBytes');

int ImageAddCertificate(int FileHandle, Pointer<WIN_CERTIFICATE> Certificate,
        Pointer<Uint32> Index) =>
    _ImageAddCertificate(FileHandle, Certificate, Index);

late final _ImageAddCertificate = _imagehlp.lookupFunction<
    Int32 Function(IntPtr FileHandle, Pointer<WIN_CERTIFICATE> Certificate,
        Pointer<Uint32> Index),
    int Function(int FileHandle, Pointer<WIN_CERTIFICATE> Certificate,
        Pointer<Uint32> Index)>('ImageAddCertificate');
...
late final _ImageEnumerateCertificates = _imagehlp.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> CertificateCount,
        Pointer<Uint32> Indices,
        int IndexCount)>('ImageEnumerateCertificates');

int ImageGetCertificateData(int FileHandle, int CertificateIndex,
        Pointer<WIN_CERTIFICATE> Certificate, Pointer<Uint32> RequiredLength) =>
...
late final _ImageGetCertificateData = _imagehlp.lookupFunction<
    Int32 Function(IntPtr FileHandle, Uint32 CertificateIndex,
        Pointer<WIN_CERTIFICATE> Certificate, Pointer<Uint32> RequiredLength),
    int Function(
        int FileHandle,
        int CertificateIndex,
        Pointer<WIN_CERTIFICATE> Certificate,
        Pointer<Uint32> RequiredLength)>('ImageGetCertificateData');

int ImageGetCertificateHeader(int FileHandle, int CertificateIndex,
        Pointer<WIN_CERTIFICATE> Certificateheader) =>
    _ImageGetCertificateHeader(FileHandle, CertificateIndex, Certificateheader);

late final _ImageGetCertificateHeader = _imagehlp.lookupFunction<
        Int32 Function(IntPtr FileHandle, Uint32 CertificateIndex,
            Pointer<WIN_CERTIFICATE> Certificateheader),
        int Function(int FileHandle, int CertificateIndex,
            Pointer<WIN_CERTIFICATE> Certificateheader)>(
...
late final _ImageGetDigestStream = _imagehlp.lookupFunction<
    ...
    int Function(
        ...
        int DigestLevel,
        Pointer<NativeFunction<DIGEST_FUNCTION>> DigestFunction,
        Pointer DigestHandle)>('ImageGetDigestStream');

Pointer<LOADED_IMAGE> ImageLoad(Pointer<Utf8> DllName, Pointer<Utf8> DllPath) =>
    _ImageLoad(DllName, DllPath);

late final _ImageLoad = _imagehlp.lookupFunction<
    Pointer<LOADED_IMAGE> Function(
        Pointer<Utf8> DllName, Pointer<Utf8> DllPath),
    Pointer<LOADED_IMAGE> Function(
        Pointer<Utf8> DllName, Pointer<Utf8> DllPath)>('ImageLoad');

int ImageRemoveCertificate(int FileHandle, int Index) =>
    _ImageRemoveCertificate(FileHandle, Index);

late final _ImageRemoveCertificate = _imagehlp.lookupFunction<
    Int32 Function(IntPtr FileHandle, Uint32 Index),
    int Function(int FileHandle, int Index)>('ImageRemoveCertificate');

int ImageUnload(Pointer<LOADED_IMAGE> LoadedImage) => _ImageUnload(LoadedImage);

late final _ImageUnload = _imagehlp.lookupFunction<
    Int32 Function(Pointer<LOADED_IMAGE> LoadedImage),
    int Function(Pointer<LOADED_IMAGE> LoadedImage)>('ImageUnload');

int MapAndLoad(Pointer<Utf8> ImageName, Pointer<Utf8> DllPath,
        Pointer<LOADED_IMAGE> LoadedImage, int DotDll, int ReadOnly) =>
    _MapAndLoad(ImageName, DllPath, LoadedImage, DotDll, ReadOnly);

late final _MapAndLoad = _imagehlp.lookupFunction<
    Int32 Function(Pointer<Utf8> ImageName, Pointer<Utf8> DllPath,
        Pointer<LOADED_IMAGE> LoadedImage, Int32 DotDll, Int32 ReadOnly),
    int Function(
        Pointer<Utf8> ImageName,
        Pointer<Utf8> DllPath,
        Pointer<LOADED_IMAGE> LoadedImage,
        int DotDll,
        int ReadOnly)>('MapAndLoad');

int MapFileAndCheckSum(Pointer<Utf16> Filename, Pointer<Uint32> HeaderSum,
        Pointer<Uint32> CheckSum) =>
    _MapFileAndCheckSum(Filename, HeaderSum, CheckSum);

late final _MapFileAndCheckSum = _imagehlp.lookupFunction<
    Uint32 Function(Pointer<Utf16> Filename, Pointer<Uint32> HeaderSum,
        Pointer<Uint32> CheckSum),
    int Function(Pointer<Utf16> Filename, Pointer<Uint32> HeaderSum,
        Pointer<Uint32> CheckSum)>('MapFileAndCheckSumW');
...
late final _ReBaseImage64 = _imagehlp.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> NewImageSize,
        Pointer<Uint64> NewImageBase,
        int TimeStamp)>('ReBaseImage64');

int SetImageConfigInformation(Pointer<LOADED_IMAGE> LoadedImage,
        Pointer<IMAGE_LOAD_CONFIG_DIRECTORY64> ImageConfigInformation) =>
    _SetImageConfigInformation(LoadedImage, ImageConfigInformation);
...
int TouchFileTimes(int FileHandle, Pointer<SYSTEMTIME> pSystemTime) =>
    _TouchFileTimes(FileHandle, pSystemTime);

late final _TouchFileTimes = _imagehlp.lookupFunction<
    Int32 Function(IntPtr FileHandle, Pointer<SYSTEMTIME> pSystemTime),
    int Function(
        int FileHandle, Pointer<SYSTEMTIME> pSystemTime)>('TouchFileTimes');

int UnMapAndLoad(Pointer<LOADED_IMAGE> LoadedImage) =>
    _UnMapAndLoad(LoadedImage);

late final _UnMapAndLoad = _imagehlp.lookupFunction<
    Int32 Function(Pointer<LOADED_IMAGE> LoadedImage),
    int Function(Pointer<LOADED_IMAGE> LoadedImage)>('UnMapAndLoad');

int UpdateDebugInfoFile(Pointer<Utf8> ImageFileName, Pointer<Utf8> SymbolPath,
        Pointer<Utf8> DebugFilePath, Pointer<IMAGE_NT_HEADERS32> NtHeaders) =>
    _UpdateDebugInfoFile(ImageFileName, SymbolPath, DebugFilePath, NtHeaders);

late final _UpdateDebugInfoFile = _imagehlp.lookupFunction<
    Int32 Function(Pointer<Utf8> ImageFileName, Pointer<Utf8> SymbolPath,
        Pointer<Utf8> DebugFilePath, Pointer<IMAGE_NT_HEADERS32> NtHeaders),
    int Function(
        Pointer<Utf8> ImageFileName,
        Pointer<Utf8> SymbolPath,
        Pointer<Utf8> DebugFilePath,
        Pointer<IMAGE_NT_HEADERS32> NtHeaders)>('UpdateDebugInfoFile');
