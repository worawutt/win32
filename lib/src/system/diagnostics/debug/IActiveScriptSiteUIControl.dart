...
class IActiveScriptSiteUIControl extends IUnknown {
  ...
  int GetUIBehavior(int UicItem, Pointer<Int32> pUicHandling) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 UicItem,
                              Pointer<Int32> pUicHandling)>>>()
              .value
              .asFunction<
                  int Function(
                      Pointer, int UicItem, Pointer<Int32> pUicHandling)>()(
          ptr.ref.lpVtbl, UicItem, pUicHandling);
}
