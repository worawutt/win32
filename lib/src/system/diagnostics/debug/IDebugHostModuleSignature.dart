...
class IDebugHostModuleSignature extends IUnknown {
  ...
  int IsMatch(Pointer<COMObject> pModule, Pointer<Bool> isMatch) => ptr
      .ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> pModule,
                      Pointer<Bool> isMatch)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<COMObject> pModule,
              Pointer<Bool> isMatch)>()(ptr.ref.lpVtbl, pModule, isMatch);
}
