...
class IApplicationDebugger extends IUnknown {
  ...
  int onHandleBreakPoint(
          Pointer<COMObject> prpt, int br, Pointer<COMObject> pError) =>
      ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> prpt, Int32 br,
          ...
          .asFunction<
              int Function(
                  ...
                  int br,
                  Pointer<COMObject>
                      pError)>()(ptr.ref.lpVtbl, prpt, br, pError);
  ...
  int onDebuggerEvent(Pointer<GUID> riid, Pointer<COMObject> punk) => ptr
      .ref.lpVtbl.value
      .elementAt(8)
      .cast<
          Pointer<
