...
class IActiveScriptErrorDebug extends IActiveScriptError {
  ...
  int GetDocumentContext(Pointer<Pointer<COMObject>> ppssc) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<COMObject>> ppssc)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<COMObject>> ppssc)>()(
          ptr.ref.lpVtbl, ppssc);

  int GetStackFrame(Pointer<Pointer<COMObject>> ppdsf) => ptr.ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> ppdsf)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> ppdsf)>()(
      ptr.ref.lpVtbl, ppdsf);
}
