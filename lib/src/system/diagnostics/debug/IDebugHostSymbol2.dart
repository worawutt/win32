...
class IDebugHostSymbol2 extends IDebugHostSymbol {
  ...
  int GetLanguage(Pointer<Int32> pKind) => ptr.ref.lpVtbl.value
      .elementAt(10)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Int32> pKind)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<Int32> pKind)>()(ptr.ref.lpVtbl, pKind);
}
