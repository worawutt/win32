...
class IDebugHostSymbols extends IUnknown {
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> module,
                      Pointer<Pointer<COMObject>> typeSignature)>()(
          ptr.ref.lpVtbl, signatureSpecification, module, typeSignature);
  ...
  int EnumerateModules(
          Pointer<COMObject> context, Pointer<Pointer<COMObject>> moduleEnum) =>
      ptr.ref.lpVtbl.value
              .elementAt(6)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> context,
                      Pointer<Pointer<COMObject>> moduleEnum)>()(
          ptr.ref.lpVtbl, context, moduleEnum);

  int FindModuleByName(Pointer<COMObject> context, Pointer<Utf16> moduleName,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> moduleName,
                      Pointer<Pointer<COMObject>> module)>()(
          ptr.ref.lpVtbl, context, moduleName, module);

  int FindModuleByLocation(Pointer<COMObject> context, Location moduleLocation,
          Pointer<Pointer<COMObject>> module) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
              ...
              .asFunction<
                  int Function(
                      ...
                      Location moduleLocation,
                      Pointer<Pointer<COMObject>> module)>()(
          ptr.ref.lpVtbl, context, moduleLocation, module);
