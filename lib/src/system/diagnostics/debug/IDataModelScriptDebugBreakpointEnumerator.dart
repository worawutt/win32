...
class IDataModelScriptDebugBreakpointEnumerator extends IUnknown {
  ...
  int GetNext(Pointer<Pointer<COMObject>> breakpoint) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> breakpoint)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> breakpoint)>()(
      ptr.ref.lpVtbl, breakpoint);
}
