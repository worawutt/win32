      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<ScriptDebugPosition> positionSpanEnd,
                      Pointer<Pointer<Utf16>> lineText)>()(
          ptr.ref.lpVtbl, position, positionSpanEnd, lineText);

  int IsTransitionPoint(Pointer<Bool> isTransitionPoint) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Bool> isTransitionPoint)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Bool> isTransitionPoint)>()(
          ptr.ref.lpVtbl, isTransitionPoint);

  int GetTransition(Pointer<Pointer<COMObject>> transitionScript,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> transitionScript,
                      Pointer<Bool> isTransitionContiguous)>()(
          ptr.ref.lpVtbl, transitionScript, isTransitionContiguous);

  int Evaluate(Pointer<Utf16> pwszExpression,
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> pwszExpression,
                              Pointer<Pointer<COMObject>> ppResult)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> pwszExpression,
                      Pointer<Pointer<COMObject>> ppResult)>()(
          ptr.ref.lpVtbl, pwszExpression, ppResult);

  int EnumerateLocals(Pointer<Pointer<COMObject>> variablesEnum) => ptr
          .ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<COMObject>> variablesEnum)>()(
      ptr.ref.lpVtbl, variablesEnum);

  int EnumerateArguments(Pointer<Pointer<COMObject>> variablesEnum) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
                  Pointer<
