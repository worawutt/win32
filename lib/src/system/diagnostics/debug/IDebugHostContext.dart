...
class IDebugHostContext extends IUnknown {
  ...
  int IsEqualTo(Pointer<COMObject> pContext, Pointer<Bool> pIsEqual) => ptr
      .ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
      ...
      .value
      .asFunction<
          int Function(Pointer, Pointer<COMObject> pContext,
              Pointer<Bool> pIsEqual)>()(ptr.ref.lpVtbl, pContext, pIsEqual);
}
