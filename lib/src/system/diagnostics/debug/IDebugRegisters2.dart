...
class IDebugRegisters2 extends IUnknown {
  ...
  int GetIndexByNameWide(Pointer<Utf16> Name, Pointer<Uint32> Index) => ptr
      .ref.lpVtbl.value
      .elementAt(15)
      .cast<
          Pointer<
  ...
  int GetNumberPseudoRegisters(Pointer<Uint32> Number) => ptr.ref.lpVtbl.value
          .elementAt(16)
          .cast<
              Pointer<
                  NativeFunction<
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint32> NameSize,
                      Pointer<Uint64> TypeModule,
                      Pointer<Uint32> TypeId)>()(ptr.ref.lpVtbl, Register,
          NameBuffer, NameBufferSize, NameSize, TypeModule, TypeId);
  ...
  int GetPseudoIndexByName(Pointer<Utf8> Name, Pointer<Uint32> Index) => ptr
      .ref.lpVtbl.value
      .elementAt(19)
      .cast<
          Pointer<
  ...
  int GetPseudoIndexByNameWide(Pointer<Utf16> Name, Pointer<Uint32> Index) =>
      ptr.ref.lpVtbl.value
          .elementAt(20)
          .cast<
              Pointer<
  ...
  int GetPseudoValues(int Source, int Count, Pointer<Uint32> Indices, int Start,
          Pointer<DEBUG_VALUE> Values) =>
      ptr.ref.lpVtbl.value
              .elementAt(21)
              .cast<
              ...
              .asFunction<
                  int Function(
                      ...
                      int Start,
                      Pointer<DEBUG_VALUE> Values)>()(
          ptr.ref.lpVtbl, Source, Count, Indices, Start, Values);

  int SetPseudoValues(int Source, int Count, Pointer<Uint32> Indices, int Start,
          Pointer<DEBUG_VALUE> Values) =>
      ptr.ref.lpVtbl.value
              .elementAt(22)
              .cast<
  ...
  int GetValues2(int Source, int Count, Pointer<Uint32> Indices, int Start,
          Pointer<DEBUG_VALUE> Values) =>
      ptr.ref.lpVtbl.value
              .elementAt(23)
              .cast<
  ...
  int SetValues2(int Source, int Count, Pointer<Uint32> Indices, int Start,
          Pointer<DEBUG_VALUE> Values) =>
      ptr.ref.lpVtbl.value
              .elementAt(24)
              .cast<
  ...
  int OutputRegisters2(int OutputControl, int Source, int Flags) => ptr
      .ref.lpVtbl.value
      .elementAt(25)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Uint32 OutputControl, Uint32 Source,
                      Uint32 Flags)>>>()
      .value
      .asFunction<
          int Function(Pointer, int OutputControl, int Source,
              int Flags)>()(ptr.ref.lpVtbl, OutputControl, Source, Flags);

  int GetInstructionOffset2(int Source, Pointer<Uint64> Offset) =>
      ptr.ref.lpVtbl.value
          .elementAt(26)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Uint32 Source, Pointer<Uint64> Offset)>>>()
          .value
          .asFunction<
              int Function(Pointer, int Source,
                  Pointer<Uint64> Offset)>()(ptr.ref.lpVtbl, Source, Offset);

  int GetStackOffset2(int Source, Pointer<Uint64> Offset) =>
      ptr.ref.lpVtbl.value
          .elementAt(27)
          .cast<
              Pointer<
  ...
  int GetFrameOffset2(int Source, Pointer<Uint64> Offset) =>
      ptr.ref.lpVtbl.value
          .elementAt(28)
          .cast<
              Pointer<
