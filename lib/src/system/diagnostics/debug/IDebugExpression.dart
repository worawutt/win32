...
class IDebugExpression extends IUnknown {
  ...
  int Start(Pointer<COMObject> pdecb) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pdecb)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> pdecb)>()(
      ptr.ref.lpVtbl, pdecb);
  ...
  int GetResultAsString(
          Pointer<Int32> phrResult, Pointer<Pointer<Utf16>> pbstrResult) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Int32> phrResult,
                      Pointer<Pointer<Utf16>> pbstrResult)>()(
          ptr.ref.lpVtbl, phrResult, pbstrResult);

  int GetResultAsDebugProperty(
          Pointer<Int32> phrResult, Pointer<Pointer<COMObject>> ppdp) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
