...
class IPerPropertyBrowsing2 extends IUnknown {
  ...
  int MapPropertyToPage(int dispid, Pointer<GUID> pClsidPropPage) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, int dispid, Pointer<GUID> pClsidPropPage)>()(
          ptr.ref.lpVtbl, dispid, pClsidPropPage);

  int GetPredefinedStrings(int dispid, Pointer<CALPOLESTR> pCaStrings,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<CALPOLESTR> pCaStrings,
                      Pointer<CADWORD> pCaCookies)>()(
          ptr.ref.lpVtbl, dispid, pCaStrings, pCaCookies);

  int SetPredefinedValue(int dispid, int dwCookie) =>
      ptr.ref.lpVtbl.value
              .elementAt(6)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Int32 dispid, Uint32 dwCookie)>>>()
              .value
              .asFunction<int Function(Pointer, int dispid, int dwCookie)>()(
          ptr.ref.lpVtbl, dispid, dwCookie);
}
