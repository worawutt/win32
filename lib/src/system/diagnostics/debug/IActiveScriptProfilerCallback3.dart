...
class IActiveScriptProfilerCallback3 extends IActiveScriptProfilerCallback2 {
  ...
  int SetWebWorkerId(int webWorkerId) => ptr.ref.lpVtbl.value
      .elementAt(11)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Uint32 webWorkerId)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int webWorkerId)>()(ptr.ref.lpVtbl, webWorkerId);
}
