...
class IEnumRemoteDebugApplicationThreads extends IUnknown {
  ...
  int Next(int celt, Pointer<Pointer<COMObject>> pprdat,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> pprdat,
                      Pointer<Uint32> pceltFetched)>()(
          ptr.ref.lpVtbl, celt, pprdat, pceltFetched);
  ...
  int Clone(Pointer<Pointer<COMObject>> pperdat) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
