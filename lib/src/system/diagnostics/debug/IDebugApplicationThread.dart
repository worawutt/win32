...
class IDebugApplicationThread extends IRemoteDebugApplicationThread {
  ...
  int SynchronousCallIntoThread32(
          Pointer<COMObject> pstcb, int dwParam1, int dwParam2, int dwParam3) =>
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pstcb, int dwParam1,
                      int dwParam2, int dwParam3)>()(
          ptr.ref.lpVtbl, pstcb, dwParam1, dwParam2, dwParam3);
  ...
  int SetDescription(Pointer<Utf16> pstrDescription) =>
      ptr.ref.lpVtbl.value
              .elementAt(15)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> pstrDescription)>()(
          ptr.ref.lpVtbl, pstrDescription);

  int SetStateString(Pointer<Utf16> pstrState) => ptr.ref.lpVtbl.value
          .elementAt(16)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> pstrState)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Utf16> pstrState)>()(
      ptr.ref.lpVtbl, pstrState);
}
