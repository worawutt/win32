...
class IDebugExtendedProperty extends IDebugProperty {
  ...
  int GetExtendedPropertyInfo(int dwFieldSpec, int nRadix,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<ExtendedDebugPropertyInfo>
                          pExtendedPropertyInfo)>()(
          ptr.ref.lpVtbl, dwFieldSpec, nRadix, pExtendedPropertyInfo);

  int EnumExtendedMembers(
          int dwFieldSpec, int nRadix, Pointer<Pointer<COMObject>> ppeepi) =>
      ptr.ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Uint32 dwFieldSpec, Uint32 nRadix,
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<COMObject>>
                      ppeepi)>()(ptr.ref.lpVtbl, dwFieldSpec, nRadix, ppeepi);
}
