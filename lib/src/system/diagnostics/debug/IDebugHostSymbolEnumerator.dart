...
class IDebugHostSymbolEnumerator extends IUnknown {
  ...
  int GetNext(Pointer<Pointer<COMObject>> symbol) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> symbol)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> symbol)>()(
      ptr.ref.lpVtbl, symbol);
}
