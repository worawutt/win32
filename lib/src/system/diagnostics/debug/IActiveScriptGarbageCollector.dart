...
class IActiveScriptGarbageCollector extends IUnknown {
  ...
  int CollectGarbage(int scriptgctype) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Int32 scriptgctype)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int scriptgctype)>()(ptr.ref.lpVtbl, scriptgctype);
}
