...
class IDataModelScriptHostContext extends IUnknown {
  ...
  int NotifyScriptChange(Pointer<COMObject> script, int changeKind) => ptr
      .ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Pointer<COMObject> script, Int32 changeKind)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<COMObject> script,
              int changeKind)>()(ptr.ref.lpVtbl, script, changeKind);

  int GetNamespaceObject(Pointer<Pointer<COMObject>> namespaceObject) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> namespaceObject)>()(
          ptr.ref.lpVtbl, namespaceObject);
}
