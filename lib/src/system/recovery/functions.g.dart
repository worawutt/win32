...
void ApplicationRecoveryFinished(int bSuccess) =>
    _ApplicationRecoveryFinished(bSuccess);

late final _ApplicationRecoveryFinished = _kernel32.lookupFunction<
    Void Function(Int32 bSuccess),
    void Function(int bSuccess)>('ApplicationRecoveryFinished');

int ApplicationRecoveryInProgress(Pointer<Int32> pbCancelled) =>
    _ApplicationRecoveryInProgress(pbCancelled);

late final _ApplicationRecoveryInProgress = _kernel32.lookupFunction<
    Int32 Function(Pointer<Int32> pbCancelled),
    int Function(Pointer<Int32> pbCancelled)>('ApplicationRecoveryInProgress');
...
late final _GetApplicationRecoveryCallback = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Pointer> ppvParameter,
        Pointer<Uint32> pdwPingInterval,
        Pointer<Uint32> pdwFlags)>('GetApplicationRecoveryCallback');

int GetApplicationRestartSettings(int hProcess, Pointer<Utf16> pwzCommandline,
        Pointer<Uint32> pcchSize, Pointer<Uint32> pdwFlags) =>
...
late final _GetApplicationRestartSettings = _kernel32.lookupFunction<
    Int32 Function(IntPtr hProcess, Pointer<Utf16> pwzCommandline,
        Pointer<Uint32> pcchSize, Pointer<Uint32> pdwFlags),
    int Function(
        int hProcess,
        Pointer<Utf16> pwzCommandline,
        Pointer<Uint32> pcchSize,
        Pointer<Uint32> pdwFlags)>('GetApplicationRestartSettings');
...
late final _RegisterApplicationRecoveryCallback = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        Pointer pvParameter,
        int dwPingInterval,
        int dwFlags)>('RegisterApplicationRecoveryCallback');

int RegisterApplicationRestart(Pointer<Utf16> pwzCommandline, int dwFlags) =>
    _RegisterApplicationRestart(pwzCommandline, dwFlags);

late final _RegisterApplicationRestart = _kernel32.lookupFunction<
    Int32 Function(Pointer<Utf16> pwzCommandline, Uint32 dwFlags),
    int Function(Pointer<Utf16> pwzCommandline,
        int dwFlags)>('RegisterApplicationRestart');
