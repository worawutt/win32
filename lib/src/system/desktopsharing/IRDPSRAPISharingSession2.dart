...
class IRDPSRAPISharingSession2 extends IRDPSRAPISharingSession {
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> bstrGroup,
                      Pointer<Utf16> bstrAuthenticatedAttendeeName)>()(
          ptr.ref.lpVtbl, pStream, bstrGroup, bstrAuthenticatedAttendeeName);
  ...
  int SendControlLevelChangeResponse(
          Pointer<COMObject> pAttendee, int RequestedLevel, int ReasonCode) =>
      ptr.ref.lpVtbl.value
              .elementAt(23)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<COMObject> pAttendee,
                              Int32 RequestedLevel, Int32 ReasonCode)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pAttendee,
                      int RequestedLevel, int ReasonCode)>()(
          ptr.ref.lpVtbl, pAttendee, RequestedLevel, ReasonCode);
}
