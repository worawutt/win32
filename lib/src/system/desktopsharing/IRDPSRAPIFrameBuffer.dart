...
class IRDPSRAPIFrameBuffer extends IDispatch {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> plWidth)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> plWidth)>()(
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> plHeight)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> plHeight)>()(
          ptr.ref.lpVtbl, retValuePtr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> plBpp)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> plBpp)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  int GetFrameBufferBits(int x, int y, int Width, int Heigth,
      ...
      ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 x, Int32 y, Int32 Width,
                          Int32 Heigth, Pointer<Pointer<SAFEARRAY>> ppBits)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer,
                  ...
                  Pointer<Pointer<SAFEARRAY>>
                      ppBits)>()(ptr.ref.lpVtbl, x, y, Width, Heigth, ppBits);
}
