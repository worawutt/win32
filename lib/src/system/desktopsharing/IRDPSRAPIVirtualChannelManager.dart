...
class IRDPSRAPIVirtualChannelManager extends IDispatch {
  ...
  int get_Item(VARIANT item, Pointer<Pointer<COMObject>> pChannel) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, VARIANT item,
                              Pointer<Pointer<COMObject>> pChannel)>>>()
              .value
              .asFunction<
                  int Function(Pointer, VARIANT item,
                      Pointer<Pointer<COMObject>> pChannel)>()(
          ptr.ref.lpVtbl, item, pChannel);

  int CreateVirtualChannel(Pointer<Utf16> bstrChannelName, int Priority,
          int ChannelFlags, Pointer<Pointer<COMObject>> ppChannel) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      int ChannelFlags,
                      Pointer<Pointer<COMObject>> ppChannel)>()(
          ptr.ref.lpVtbl, bstrChannelName, Priority, ChannelFlags, ppChannel);
}
