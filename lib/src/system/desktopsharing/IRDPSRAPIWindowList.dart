...
class IRDPSRAPIWindowList extends IDispatch {
  ...
  int get_Item(int item, Pointer<Pointer<COMObject>> pWindow) => ptr
          .ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 item,
                          Pointer<Pointer<COMObject>> pWindow)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer, int item, Pointer<Pointer<COMObject>> pWindow)>()(
      ptr.ref.lpVtbl, item, pWindow);
}
