...
class IRDPSRAPISharingSession extends IDispatch {
  ...
  set ColorDepth(int value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<Int32 Function(Pointer, Int32 colorDepth)>>>()
        .value
        .asFunction<
            int Function(Pointer, int colorDepth)>()(ptr.ref.lpVtbl, value);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> pColorDepth)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int32> pColorDepth)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  int ConnectToClient(Pointer<Utf16> bstrConnectionString) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Utf16> bstrConnectionString)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrConnectionString)>()(
          ptr.ref.lpVtbl, bstrConnectionString);

  int SetDesktopSharedRect(int left, int top, int right, int bottom) =>
      ptr.ref.lpVtbl.value
          .elementAt(19)
          .cast<
              Pointer<
  ...
  int GetDesktopSharedRect(Pointer<Int32> pleft, Pointer<Int32> ptop,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Int32> pright,
                      Pointer<Int32> pbottom)>()(
          ptr.ref.lpVtbl, pleft, ptop, pright, pbottom);
}
