...
class IRDPSRAPISessionProperties extends IDispatch {
  ...
  int get_Property(Pointer<Utf16> PropertyName, Pointer<VARIANT> pVal) =>
      ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(Pointer, Pointer<Utf16> PropertyName,
                  Pointer<VARIANT> pVal)>()(ptr.ref.lpVtbl, PropertyName, pVal);

  int put_Property(Pointer<Utf16> PropertyName, VARIANT newVal) => ptr
      .ref.lpVtbl.value
      .elementAt(8)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Pointer<Utf16> PropertyName, VARIANT newVal)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<Utf16> PropertyName,
              VARIANT newVal)>()(ptr.ref.lpVtbl, PropertyName, newVal);
}
