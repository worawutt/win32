...
class IRDPSRAPIAudioStream extends IUnknown {
  ...
  int Initialize(Pointer<Int64> pnPeriodInHundredNsIntervals) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Int64> pnPeriodInHundredNsIntervals)>()(
          ptr.ref.lpVtbl, pnPeriodInHundredNsIntervals);
  ...
  int GetBuffer(Pointer<Pointer<Uint8>> ppbData, Pointer<Uint32> pcbData,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<Uint8>> ppbData,
                      Pointer<Uint32> pcbData, Pointer<Uint64> pTimestamp)>()(
          ptr.ref.lpVtbl, ppbData, pcbData, pTimestamp);
