...
class IRDPSRAPIClipboardUseEvents extends IUnknown {
  ...
  int OnPasteFromClipboard(int clipboardFormat, Pointer<COMObject> pAttendee,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int clipboardFormat,
                      Pointer<COMObject> pAttendee, Pointer<Int16> pRetVal)>()(
          ptr.ref.lpVtbl, clipboardFormat, pAttendee, pRetVal);
}
