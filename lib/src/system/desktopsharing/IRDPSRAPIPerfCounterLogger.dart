...
class IRDPSRAPIPerfCounterLogger extends IUnknown {
  ...
  int LogValue(int lValue) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int64 lValue)>>>()
      .value
      .asFunction<int Function(Pointer, int lValue)>()(ptr.ref.lpVtbl, lValue);
}
