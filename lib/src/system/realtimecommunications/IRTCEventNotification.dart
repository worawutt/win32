...
class IRTCEventNotification extends IUnknown {
  ...
  int Event(int RTCEvent, Pointer<COMObject> pEvent) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Int32 RTCEvent, Pointer<COMObject> pEvent)>>>()
      .value
      .asFunction<
          int Function(Pointer, int RTCEvent,
              Pointer<COMObject> pEvent)>()(ptr.ref.lpVtbl, RTCEvent, pEvent);
}
