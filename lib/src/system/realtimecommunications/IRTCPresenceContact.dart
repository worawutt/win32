...
class IRTCPresenceContact extends IUnknown {
  ...
  Pointer<Utf16> get PresentityURI {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> pbstrPresentityURI)>()(
    ...
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(
                            Pointer, Pointer<Utf16> bstrPresentityURI)>>>()
            .value
            .asFunction<
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int16> pfPersistent)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int16> pfPersistent)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  set Persistent(int value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<Int32 Function(Pointer, Int16 fPersistent)>>>()
        .value
        .asFunction<
            int Function(Pointer, int fPersistent)>()(ptr.ref.lpVtbl, value);
