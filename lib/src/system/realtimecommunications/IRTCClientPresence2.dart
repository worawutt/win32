...
class IRTCClientPresence2 extends IRTCClientPresence {
  ...
  int EnablePresenceEx(
          Pointer<COMObject> pProfile, VARIANT varStorage, int lFlags) =>
              ...
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pProfile,
                          VARIANT varStorage, Int32 lFlags)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer,
                  ...
                  VARIANT varStorage,
                  int lFlags)>()(ptr.ref.lpVtbl, pProfile, varStorage, lFlags);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int lFlags,
                      Pointer<Pointer<COMObject>> ppGroup)>()(
          ptr.ref.lpVtbl, bstrGroupName, bstrData, pProfile, lFlags, ppGroup);

  int RemoveGroup(Pointer<COMObject> pGroup) => ptr.ref.lpVtbl.value
          .elementAt(24)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pGroup)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> pGroup)>()(
      ptr.ref.lpVtbl, pGroup);

  int EnumerateGroups(Pointer<Pointer<COMObject>> ppEnum) =>
      ptr.ref.lpVtbl.value
              .elementAt(25)
              .cast<
                  Pointer<
  ...
  int get_Group(
          Pointer<Utf16> bstrGroupName, Pointer<Pointer<COMObject>> ppGroup) =>
      ptr.ref.lpVtbl.value
              .elementAt(27)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrGroupName,
                      Pointer<Pointer<COMObject>> ppGroup)>()(
          ptr.ref.lpVtbl, bstrGroupName, ppGroup);
  ...
  int get_WatcherEx(int enMode, Pointer<Utf16> bstrPresentityURI,
          Pointer<Pointer<COMObject>> ppWatcher) =>
      ptr.ref.lpVtbl.value
              .elementAt(29)
              .cast<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> bstrPresentityURI,
                      Pointer<Pointer<COMObject>> ppWatcher)>()(
          ptr.ref.lpVtbl, enMode, bstrPresentityURI, ppWatcher);

  int put_PresenceProperty(int enProperty, Pointer<Utf16> bstrProperty) =>
      ptr.ref.lpVtbl.value
              .elementAt(30)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 enProperty,
                              Pointer<Utf16> bstrProperty)>>>()
              .value
              .asFunction<
                  int Function(
                      Pointer, int enProperty, Pointer<Utf16> bstrProperty)>()(
          ptr.ref.lpVtbl, enProperty, bstrProperty);

  int get_PresenceProperty(
          int enProperty, Pointer<Pointer<Utf16>> pbstrProperty) =>
      ptr
              .ref.lpVtbl.value
              .elementAt(31)
              .cast<
              ...
              .value
              .asFunction<
                  int Function(Pointer, int enProperty,
                      Pointer<Pointer<Utf16>> pbstrProperty)>()(
          ptr.ref.lpVtbl, enProperty, pbstrProperty);

  int SetPresenceData(Pointer<Utf16> bstrNamespace, Pointer<Utf16> bstrData) =>
      ptr.ref.lpVtbl.value
              .elementAt(32)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> bstrNamespace,
                              Pointer<Utf16> bstrData)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrNamespace,
                      Pointer<Utf16> bstrData)>()(
          ptr.ref.lpVtbl, bstrNamespace, bstrData);

  int GetPresenceData(Pointer<Pointer<Utf16>> pbstrNamespace,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<Utf16>> pbstrNamespace,
                      Pointer<Pointer<Utf16>> pbstrData)>()(
          ptr.ref.lpVtbl, pbstrNamespace, pbstrData);
