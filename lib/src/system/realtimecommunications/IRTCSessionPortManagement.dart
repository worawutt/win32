...
class IRTCSessionPortManagement extends IUnknown {
  ...
  int SetPortManager(Pointer<COMObject> pPortManager) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> pPortManager)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<COMObject> pPortManager)>()(ptr.ref.lpVtbl, pPortManager);
}
