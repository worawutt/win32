...
class IRTCBuddy2 extends IRTCBuddy {
  ...
  int EnumeratePresenceDevices(Pointer<Pointer<COMObject>> ppEnumDevices) => ptr
          .ref.lpVtbl.value
          .elementAt(18)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<COMObject>> ppEnumDevices)>()(
      ptr.ref.lpVtbl, ppEnumDevices);
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<COMObject>>
                      ppDevicesCollection)>()(ptr.ref.lpVtbl, retValuePtr);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Int32> penSubscriptionType)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> penSubscriptionType)>()(
          ptr.ref.lpVtbl, retValuePtr);
