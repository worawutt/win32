...
class IRTCSessionStateChangeEvent2 extends IRTCSessionStateChangeEvent {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int16> pfIsForked)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int16> pfIsForked)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  int
      GetRemoteSessionDescription(Pointer<Pointer<Utf16>> pbstrContentType,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(
                          ...
                          Pointer<Pointer<Utf16>> pbstrContentType,
                          Pointer<Pointer<Utf16>> pbstrSessionDescription)>()(
              ptr.ref.lpVtbl, pbstrContentType, pbstrSessionDescription);
}
