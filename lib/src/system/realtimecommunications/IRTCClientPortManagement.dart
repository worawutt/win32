...
class IRTCClientPortManagement extends IUnknown {
  ...
  int StartListenAddressAndPort(
          Pointer<Utf16> bstrInternalLocalAddress, int lInternalLocalPort) =>
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrInternalLocalAddress,
                      int lInternalLocalPort)>()(
          ptr.ref.lpVtbl, bstrInternalLocalAddress, lInternalLocalPort);
  ...
  int GetPortRange(int enPortType, Pointer<Int32> plMinValue,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int enPortType,
                      Pointer<Int32> plMinValue, Pointer<Int32> plMaxValue)>()(
          ptr.ref.lpVtbl, enPortType, plMinValue, plMaxValue);
}
