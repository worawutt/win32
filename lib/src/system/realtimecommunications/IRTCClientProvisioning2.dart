...
class IRTCClientProvisioning2 extends IRTCClientProvisioning {
  ...
  int EnableProfileEx(
          Pointer<COMObject> pProfile, int lRegisterFlags, int lRoamingFlags) =>
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<COMObject> pProfile,
                              Int32 lRegisterFlags, Int32 lRoamingFlags)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pProfile,
                      int lRegisterFlags, int lRoamingFlags)>()(
          ptr.ref.lpVtbl, pProfile, lRegisterFlags, lRoamingFlags);
}
