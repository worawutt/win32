...
class ITransportSettingsInternal extends IUnknown {
  ...
  int ApplySetting(Pointer<TRANSPORT_SETTING> Setting) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<TRANSPORT_SETTING> Setting)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<TRANSPORT_SETTING> Setting)>()(
      ptr.ref.lpVtbl, Setting);

  int QuerySetting(Pointer<TRANSPORT_SETTING> Setting) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
