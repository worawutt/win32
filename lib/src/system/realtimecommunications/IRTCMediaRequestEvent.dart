...
class IRTCMediaRequestEvent extends IDispatch {
  ...
  int Accept(int lMediaTypes) => ptr.ref.lpVtbl.value
      .elementAt(10)
      .cast<
          Pointer<NativeFunction<Int32 Function(Pointer, Int32 lMediaTypes)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int lMediaTypes)>()(ptr.ref.lpVtbl, lMediaTypes);
