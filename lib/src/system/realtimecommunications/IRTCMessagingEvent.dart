  ...
  Pointer<COMObject> get Participant {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppParticipant)>()(
          ptr.ref.lpVtbl, retValuePtr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> penEventType)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int32> penEventType)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  Pointer<Utf16> get Message {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> pbstrMessage)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  Pointer<Utf16> get MessageHeader {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> pbstrMessageHeader)>()(
          ptr.ref.lpVtbl, retValuePtr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> penUserStatus)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int32> penUserStatus)>()(ptr.ref.lpVtbl, retValuePtr);
