...
class IAssemblyCache extends IUnknown {
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<FUSION_INSTALL_REFERENCE> pRefData,
                      Pointer<Uint32> pulDisposition)>()(
          ptr.ref.lpVtbl, dwFlags, pszAssemblyName, pRefData, pulDisposition);

  int QueryAssemblyInfo(int dwFlags, Pointer<Utf16> pszAssemblyName,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> pszAssemblyName,
                      Pointer<ASSEMBLY_INFO> pAsmInfo)>()(
          ptr.ref.lpVtbl, dwFlags, pszAssemblyName, pAsmInfo);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppAsmItem,
                      Pointer<Utf16> pszAssemblyName)>()(
          ptr.ref.lpVtbl, dwFlags, pvReserved, ppAsmItem, pszAssemblyName);

  int Reserved(Pointer<Pointer<COMObject>> ppUnk) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int InstallAssembly(int dwFlags, Pointer<Utf16> pszManifestFilePath,
          Pointer<FUSION_INSTALL_REFERENCE> pRefData) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> pszManifestFilePath,
                      Pointer<FUSION_INSTALL_REFERENCE> pRefData)>()(
          ptr.ref.lpVtbl, dwFlags, pszManifestFilePath, pRefData);
}
