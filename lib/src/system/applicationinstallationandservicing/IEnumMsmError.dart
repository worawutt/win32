...
class IEnumMsmError extends IUnknown {
  ...
  int Next(int cFetch, Pointer<Pointer<COMObject>> rgmsmErrors,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> rgmsmErrors,
                      Pointer<Uint32> pcFetched)>()(
          ptr.ref.lpVtbl, cFetch, rgmsmErrors, pcFetched);
  ...
  int Clone(Pointer<Pointer<COMObject>> pemsmErrors) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> pemsmErrors)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> pemsmErrors)>()(
      ptr.ref.lpVtbl, pemsmErrors);
}
