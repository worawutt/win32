      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int dwFormatFlags,
                      Pointer<Pointer<COMObject>> ppIStream,
                      Pointer<Uint64> puliMaxSize)>()(ptr.ref.lpVtbl, dwFlags,
          pszStreamName, dwFormat, dwFormatFlags, ppIStream, puliMaxSize);

  int Commit(int dwFlags, Pointer<Uint32> pulDisposition) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, int dwFlags, Pointer<Uint32> pulDisposition)>()(
          ptr.ref.lpVtbl, dwFlags, pulDisposition);
