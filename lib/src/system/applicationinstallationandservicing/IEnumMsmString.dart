...
class IEnumMsmString extends IUnknown {
  ...
  int Next(int cFetch, Pointer<Pointer<Utf16>> rgbstrStrings,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<Utf16>> rgbstrStrings,
                      Pointer<Uint32> pcFetched)>()(
          ptr.ref.lpVtbl, cFetch, rgbstrStrings, pcFetched);
  ...
  int Clone(Pointer<Pointer<COMObject>> pemsmStrings) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<COMObject>> pemsmStrings)>()(
      ptr.ref.lpVtbl, pemsmStrings);
}
