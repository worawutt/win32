...
typedef INSTALLUI_HANDLERW = Int32 Function(
    Pointer pvContext, Uint32 iMessageType, Pointer<Utf16> szMessage);
...
typedef LPEVALCOMCALLBACK = Int32 Function(
    Int32 iStatus, Pointer<Utf16> szData, Pointer pContext);
typedef PINSTALLUI_HANDLER_RECORD = Int32 Function(
    Pointer pvContext, Uint32 iMessageType, Uint32 hRecord);
typedef PPATCH_PROGRESS_CALLBACK = Int32 Function(
    Pointer CallbackContext, Uint32 CurrentPosition, Uint32 MaximumPosition);
