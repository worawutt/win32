...
class IStringCollection extends IDispatch {
  ...
  int get_Item(int index, Pointer<Pointer<Utf16>> retval) => ptr
      .ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Int32 index, Pointer<Pointer<Utf16>> retval)>>>()
      .value
      .asFunction<
          int Function(Pointer, int index,
              Pointer<Pointer<Utf16>> retval)>()(ptr.ref.lpVtbl, index, retval);

  int put_Item(int index, Pointer<Utf16> value) => ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Int32 index, Pointer<Utf16> value)>>>()
          .value
  ...
  int Add(Pointer<Utf16> value, Pointer<Int32> retval) => ptr.ref.lpVtbl.value
      .elementAt(12)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Pointer<Utf16> value, Pointer<Int32> retval)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<Utf16> value,
              Pointer<Int32> retval)>()(ptr.ref.lpVtbl, value, retval);
  ...
  int Copy(Pointer<Pointer<COMObject>> retval) => ptr.ref.lpVtbl.value
          .elementAt(14)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int Insert(int index, Pointer<Utf16> value) => ptr.ref.lpVtbl.value
          .elementAt(15)
          .cast<
              Pointer<
                  NativeFunction<
