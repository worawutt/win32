...
class IWindowsDriverUpdate2 extends IWindowsDriverUpdate {
  ...
  int CopyToCache(Pointer<COMObject> pFiles) => ptr.ref.lpVtbl.value
          .elementAt(63)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pFiles)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> pFiles)>()(
      ptr.ref.lpVtbl, pFiles);
}
