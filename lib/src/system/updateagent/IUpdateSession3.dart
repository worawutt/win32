...
class IUpdateSession3 extends IUpdateSession2 {
  ...
  int CreateUpdateServiceManager(Pointer<Pointer<COMObject>> retval) =>
  ...
  int QueryHistory(Pointer<Utf16> criteria, int startIndex, int count,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> criteria, int startIndex,
                      int count, Pointer<Pointer<COMObject>> retval)>()(
          ptr.ref.lpVtbl, criteria, startIndex, count, retval);
}
