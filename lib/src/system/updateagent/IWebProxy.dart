...
class IWebProxy extends IDispatch {
  ...
  int SetPassword(Pointer<Utf16> value) => ptr.ref.lpVtbl.value
      .elementAt(16)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Utf16> value)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<Utf16> value)>()(ptr.ref.lpVtbl, value);

  int PromptForCredentials(
          Pointer<COMObject> parentWindow, Pointer<Utf16> title) =>
      ptr
          .ref.lpVtbl.value
          .elementAt(17)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> parentWindow,
                          Pointer<Utf16> title)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> parentWindow,
                  Pointer<Utf16> title)>()(ptr.ref.lpVtbl, parentWindow, title);

  int PromptForCredentialsFromHwnd(int parentWindow, Pointer<Utf16> title) =>
      ptr.ref.lpVtbl.value
          .elementAt(18)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, IntPtr parentWindow,
                          Pointer<Utf16> title)>>>()
          .value
          .asFunction<
              int Function(Pointer, int parentWindow,
                  Pointer<Utf16> title)>()(ptr.ref.lpVtbl, parentWindow, title);
