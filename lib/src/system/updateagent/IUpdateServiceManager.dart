...
class IUpdateServiceManager extends IDispatch {
  ...
  int AddService(Pointer<Utf16> serviceID, Pointer<Utf16> authorizationCabPath,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> authorizationCabPath,
                      Pointer<Pointer<COMObject>> retval)>()(
          ptr.ref.lpVtbl, serviceID, authorizationCabPath, retval);

  int RegisterServiceWithAU(Pointer<Utf16> serviceID) => ptr.ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> serviceID)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Utf16> serviceID)>()(
      ptr.ref.lpVtbl, serviceID);

  int RemoveService(Pointer<Utf16> serviceID) => ptr.ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int UnregisterServiceWithAU(Pointer<Utf16> serviceID) => ptr.ref.lpVtbl.value
          .elementAt(11)
          .cast<
              Pointer<
                  NativeFunction<
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int flags,
                      Pointer<Pointer<COMObject>> ppService)>()(
          ptr.ref.lpVtbl, serviceName, scanFileLocation, flags, ppService);

  int SetOption(Pointer<Utf16> optionName, VARIANT optionValue) => ptr
      .ref.lpVtbl.value
      .elementAt(13)
      .cast<
          Pointer<
      ...
      .asFunction<
          int Function(Pointer, Pointer<Utf16> optionName,
              VARIANT optionValue)>()(ptr.ref.lpVtbl, optionName, optionValue);
}
