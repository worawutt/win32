...
class IUpdateInstaller extends IDispatch {
  ...
  set ParentHwnd(int value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(12)
        .cast<Pointer<NativeFunction<Int32 Function(Pointer, IntPtr value)>>>()
        .value
        .asFunction<int Function(Pointer, int value)>()(ptr.ref.lpVtbl, value);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      VARIANT state,
                      Pointer<Pointer<COMObject>> retval)>()(
          ptr.ref.lpVtbl, onProgressChanged, onCompleted, state, retval);
  ...
  int EndInstall(
          Pointer<COMObject> value, Pointer<Pointer<COMObject>> retval) =>
      ptr.ref.lpVtbl.value
              .elementAt(19)
              .cast<
                  Pointer<
  ...
  int Install(Pointer<Pointer<COMObject>> retval) => ptr.ref.lpVtbl.value
          .elementAt(21)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int RunWizard(
          Pointer<Utf16> dialogTitle, Pointer<Pointer<COMObject>> retval) =>
      ptr.ref.lpVtbl.value
              .elementAt(22)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> dialogTitle,
                              Pointer<Pointer<COMObject>> retval)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> dialogTitle,
                      Pointer<Pointer<COMObject>> retval)>()(
          ptr.ref.lpVtbl, dialogTitle, retval);
  ...
  int Uninstall(Pointer<Pointer<COMObject>> retval) => ptr.ref.lpVtbl.value
          .elementAt(24)
          .cast<
              Pointer<
                  NativeFunction<
