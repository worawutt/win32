...
class IUpdateSession extends IDispatch {
  ...
  int CreateUpdateSearcher(Pointer<Pointer<COMObject>> retval) =>
      ptr.ref.lpVtbl.value
              .elementAt(12)
              .cast<
                  Pointer<
  ...
  int CreateUpdateDownloader(Pointer<Pointer<COMObject>> retval) => ptr
          .ref.lpVtbl.value
          .elementAt(13)
          .cast<
              Pointer<
  ...
  int CreateUpdateInstaller(Pointer<Pointer<COMObject>> retval) =>
      ptr.ref.lpVtbl.value
              .elementAt(14)
              .cast<
                  Pointer<
