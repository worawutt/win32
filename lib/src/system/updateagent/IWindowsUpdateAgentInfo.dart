...
class IWindowsUpdateAgentInfo extends IDispatch {
  ...
  int GetInfo(VARIANT varInfoIdentifier, Pointer<VARIANT> retval) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, VARIANT varInfoIdentifier,
                              Pointer<VARIANT> retval)>>>()
              .value
              .asFunction<
                  int Function(Pointer, VARIANT varInfoIdentifier,
                      Pointer<VARIANT> retval)>()(
          ptr.ref.lpVtbl, varInfoIdentifier, retval);
}
