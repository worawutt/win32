...
class IDownloadProgressChangedCallback extends IUnknown {
  ...
  int
      Invoke(Pointer<COMObject> downloadJob, Pointer<COMObject> callbackArgs) =>
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<COMObject> downloadJob,
                          Pointer<COMObject> callbackArgs)>()(
              ptr.ref.lpVtbl, downloadJob, callbackArgs);
}
