...
class IDownloadProgress extends IDispatch {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<DECIMAL> retval)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<DECIMAL> retval)>()(
  ...
  int GetUpdateResult(int updateIndex, Pointer<Pointer<COMObject>> retval) =>
      ptr.ref.lpVtbl.value
              .elementAt(13)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 updateIndex,
                              Pointer<Pointer<COMObject>> retval)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int updateIndex,
                      Pointer<Pointer<COMObject>> retval)>()(
          ptr.ref.lpVtbl, updateIndex, retval);
