...
class IUpdateCollection extends IDispatch {
  ...
  int put_Item(int index, Pointer<COMObject> value) => ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Int32 index, Pointer<COMObject> value)>>>()
          .value
          .asFunction<
  ...
  int Add(Pointer<COMObject> value, Pointer<Int32> retval) =>
  ...
  int Insert(int index, Pointer<COMObject> value) => ptr.ref.lpVtbl.value
          .elementAt(15)
          .cast<
              Pointer<
                  NativeFunction<
