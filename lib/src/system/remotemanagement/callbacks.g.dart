...
typedef WSMAN_PLUGIN_AUTHORIZE_USER = Void Function(Pointer pluginContext,
    Pointer<WSMAN_SENDER_DETAILS> senderDetails, Uint32 flags);
...
typedef WSMAN_PLUGIN_RELEASE_COMMAND_CONTEXT = Void Function(
    Pointer shellContext, Pointer commandContext);
...
typedef WSMAN_PLUGIN_SHUTDOWN = Uint32 Function(
    Pointer pluginContext, Uint32 flags, Uint32 reason);
