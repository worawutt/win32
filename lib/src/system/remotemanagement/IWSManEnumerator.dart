...
class IWSManEnumerator extends IDispatch {
  ...
  int ReadItem(Pointer<Pointer<Utf16>> resource) => ptr.ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Pointer<Utf16>> resource)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<Pointer<Utf16>> resource)>()(ptr.ref.lpVtbl, resource);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int16> eos)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int16> eos)>()(
