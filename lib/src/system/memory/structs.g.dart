...
extension MEM_EXTENDED_PARAMETER_Extension_1 on MEM_EXTENDED_PARAMETER {
  ...
  Pointer get Pointer_ => this.Anonymous2.Pointer_;
  set Pointer_(Pointer value) => this.Anonymous2.Pointer_ = value;

  int get Size => this.Anonymous2.Size;
  set Size(int value) => this.Anonymous2.Size = value;

  int get Handle_ => this.Anonymous2.Handle_;
  set Handle_(int value) => this.Anonymous2.Handle_ = value;
