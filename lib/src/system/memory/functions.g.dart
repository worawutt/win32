...
int AddSecureMemoryCacheCallback(
    ...
    _AddSecureMemoryCacheCallback(pfnCallBack);

late final _AddSecureMemoryCacheCallback = _kernel32.lookupFunction<
    Int32 Function(
        Pointer<NativeFunction<PSECURE_MEMORY_CACHE_CALLBACK>> pfnCallBack),
    int Function(
        Pointer<NativeFunction<PSECURE_MEMORY_CACHE_CALLBACK>>
            pfnCallBack)>('AddSecureMemoryCacheCallback');

int AllocateUserPhysicalPages(int hProcess, Pointer<IntPtr> NumberOfPages,
        Pointer<IntPtr> PageArray) =>
    _AllocateUserPhysicalPages(hProcess, NumberOfPages, PageArray);

late final _AllocateUserPhysicalPages = _kernel32.lookupFunction<
    Int32 Function(IntPtr hProcess, Pointer<IntPtr> NumberOfPages,
        Pointer<IntPtr> PageArray),
    int Function(int hProcess, Pointer<IntPtr> NumberOfPages,
        Pointer<IntPtr> PageArray)>('AllocateUserPhysicalPages');

int AllocateUserPhysicalPagesNuma(int hProcess, Pointer<IntPtr> NumberOfPages,
        Pointer<IntPtr> PageArray, int nndPreferred) =>
...
late final _AllocateUserPhysicalPagesNuma = _kernel32.lookupFunction<
    Int32 Function(IntPtr hProcess, Pointer<IntPtr> NumberOfPages,
        Pointer<IntPtr> PageArray, Uint32 nndPreferred),
    int Function(
        int hProcess,
        Pointer<IntPtr> NumberOfPages,
        Pointer<IntPtr> PageArray,
        int nndPreferred)>('AllocateUserPhysicalPagesNuma');
...
late final _CreateFileMappingFromApp = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        int PageProtection,
        int MaximumSize,
        Pointer<Utf16> Name)>('CreateFileMappingFromApp');
...
int CreateFileMappingNuma(
        ...
        int nndPreferred) =>
    _CreateFileMappingNuma(hFile, lpFileMappingAttributes, flProtect,
...
late final _CreateFileMappingNuma = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        int dwMaximumSizeLow,
        Pointer<Utf16> lpName,
        int nndPreferred)>('CreateFileMappingNumaW');
...
int CreateFileMapping(
        ...
        int dwMaximumSizeLow,
        Pointer<Utf16> lpName) =>
    _CreateFileMapping(hFile, lpFileMappingAttributes, flProtect,
...
late final _CreateFileMapping = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        int dwMaximumSizeHigh,
        int dwMaximumSizeLow,
        Pointer<Utf16> lpName)>('CreateFileMappingW');

int CreateMemoryResourceNotification(int NotificationType) =>
    _CreateMemoryResourceNotification(NotificationType);

late final _CreateMemoryResourceNotification = _kernel32.lookupFunction<
    IntPtr Function(Int32 NotificationType),
    int Function(int NotificationType)>('CreateMemoryResourceNotification');

int DiscardVirtualMemory(Pointer VirtualAddress, int Size) =>
    _DiscardVirtualMemory(VirtualAddress, Size);

late final _DiscardVirtualMemory = _kernel32.lookupFunction<
    Uint32 Function(Pointer VirtualAddress, IntPtr Size),
    int Function(Pointer VirtualAddress, int Size)>('DiscardVirtualMemory');

int FlushViewOfFile(Pointer lpBaseAddress, int dwNumberOfBytesToFlush) =>
    _FlushViewOfFile(lpBaseAddress, dwNumberOfBytesToFlush);

late final _FlushViewOfFile = _kernel32.lookupFunction<
    Int32 Function(Pointer lpBaseAddress, IntPtr dwNumberOfBytesToFlush),
    int Function(
        Pointer lpBaseAddress, int dwNumberOfBytesToFlush)>('FlushViewOfFile');

int FreeUserPhysicalPages(int hProcess, Pointer<IntPtr> NumberOfPages,
        Pointer<IntPtr> PageArray) =>
    _FreeUserPhysicalPages(hProcess, NumberOfPages, PageArray);

late final _FreeUserPhysicalPages = _kernel32.lookupFunction<
    Int32 Function(IntPtr hProcess, Pointer<IntPtr> NumberOfPages,
        Pointer<IntPtr> PageArray),
    int Function(int hProcess, Pointer<IntPtr> NumberOfPages,
        Pointer<IntPtr> PageArray)>('FreeUserPhysicalPages');
...
int GetMemoryErrorHandlingCapabilities(Pointer<Uint32> Capabilities) =>
    _GetMemoryErrorHandlingCapabilities(Capabilities);

late final _GetMemoryErrorHandlingCapabilities = _kernel32.lookupFunction<
    Int32 Function(Pointer<Uint32> Capabilities),
    int Function(
        Pointer<Uint32> Capabilities)>('GetMemoryErrorHandlingCapabilities');
...
late final _GetProcessWorkingSetSizeEx = _kernel32.lookupFunction<
    Int32 Function(IntPtr hProcess, Pointer<IntPtr> lpMinimumWorkingSetSize,
        Pointer<IntPtr> lpMaximumWorkingSetSize, Pointer<Uint32> Flags),
    int Function(
        int hProcess,
        Pointer<IntPtr> lpMinimumWorkingSetSize,
        Pointer<IntPtr> lpMaximumWorkingSetSize,
        Pointer<Uint32> Flags)>('GetProcessWorkingSetSizeEx');

int GetSystemFileCacheSize(Pointer<IntPtr> lpMinimumFileCacheSize,
        Pointer<IntPtr> lpMaximumFileCacheSize, Pointer<Uint32> lpFlags) =>
...
late final _GetSystemFileCacheSize = _kernel32.lookupFunction<
    Int32 Function(Pointer<IntPtr> lpMinimumFileCacheSize,
        Pointer<IntPtr> lpMaximumFileCacheSize, Pointer<Uint32> lpFlags),
    int Function(
        Pointer<IntPtr> lpMinimumFileCacheSize,
        Pointer<IntPtr> lpMaximumFileCacheSize,
        Pointer<Uint32> lpFlags)>('GetSystemFileCacheSize');
...
int GetWriteWatch(
    ...
    _GetWriteWatch(dwFlags, lpBaseAddress, dwRegionSize, lpAddresses, lpdwCount,
        lpdwGranularity);
...
late final _GetWriteWatch = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Pointer> lpAddresses,
        Pointer<IntPtr> lpdwCount,
        Pointer<Uint32> lpdwGranularity)>('GetWriteWatch');
...
int GlobalFlags(int hMem) => _GlobalFlags(hMem);

late final _GlobalFlags = _kernel32.lookupFunction<Uint32 Function(IntPtr hMem),
    int Function(int hMem)>('GlobalFlags');
...
int GlobalHandle(Pointer pMem) => _GlobalHandle(pMem);

late final _GlobalHandle = _kernel32.lookupFunction<
    IntPtr Function(Pointer pMem), int Function(Pointer pMem)>('GlobalHandle');
...
int GlobalReAlloc(int hMem, int dwBytes, int uFlags) =>
    _GlobalReAlloc(hMem, dwBytes, uFlags);

late final _GlobalReAlloc = _kernel32.lookupFunction<
    IntPtr Function(IntPtr hMem, IntPtr dwBytes, Uint32 uFlags),
    int Function(int hMem, int dwBytes, int uFlags)>('GlobalReAlloc');
...
int HeapSummary(int hHeap, int dwFlags, Pointer<HEAP_SUMMARY> lpSummary) =>
    _HeapSummary(hHeap, dwFlags, lpSummary);

late final _HeapSummary = _kernel32.lookupFunction<
    Int32 Function(
        IntPtr hHeap, Uint32 dwFlags, Pointer<HEAP_SUMMARY> lpSummary),
    int Function(int hHeap, int dwFlags,
        Pointer<HEAP_SUMMARY> lpSummary)>('HeapSummary');
...
int IsBadCodePtr(Pointer lpfn) => _IsBadCodePtr(lpfn);

late final _IsBadCodePtr = _kernel32.lookupFunction<
    Int32 Function(Pointer lpfn), int Function(Pointer lpfn)>('IsBadCodePtr');

int IsBadReadPtr(Pointer lp, int ucb) => _IsBadReadPtr(lp, ucb);

late final _IsBadReadPtr = _kernel32.lookupFunction<
    Int32 Function(Pointer lp, IntPtr ucb),
    int Function(Pointer lp, int ucb)>('IsBadReadPtr');

int IsBadStringPtr(Pointer<Utf16> lpsz, int ucchMax) =>
    _IsBadStringPtr(lpsz, ucchMax);

late final _IsBadStringPtr = _kernel32.lookupFunction<
    Int32 Function(Pointer<Utf16> lpsz, IntPtr ucchMax),
    int Function(Pointer<Utf16> lpsz, int ucchMax)>('IsBadStringPtrW');

int IsBadWritePtr(Pointer lp, int ucb) => _IsBadWritePtr(lp, ucb);

late final _IsBadWritePtr = _kernel32.lookupFunction<
    Int32 Function(Pointer lp, IntPtr ucb),
    int Function(Pointer lp, int ucb)>('IsBadWritePtr');

int LocalAlloc(int uFlags, int uBytes) => _LocalAlloc(uFlags, uBytes);

late final _LocalAlloc = _kernel32.lookupFunction<
    IntPtr Function(Uint32 uFlags, IntPtr uBytes),
    int Function(int uFlags, int uBytes)>('LocalAlloc');

int LocalFlags(int hMem) => _LocalFlags(hMem);

late final _LocalFlags = _kernel32.lookupFunction<Uint32 Function(IntPtr hMem),
    int Function(int hMem)>('LocalFlags');
...
int LocalHandle(Pointer pMem) => _LocalHandle(pMem);

late final _LocalHandle = _kernel32.lookupFunction<
    IntPtr Function(Pointer pMem), int Function(Pointer pMem)>('LocalHandle');

Pointer LocalLock(int hMem) => _LocalLock(hMem);

late final _LocalLock = _kernel32.lookupFunction<Pointer Function(IntPtr hMem),
    Pointer Function(int hMem)>('LocalLock');

int LocalReAlloc(int hMem, int uBytes, int uFlags) =>
    _LocalReAlloc(hMem, uBytes, uFlags);

late final _LocalReAlloc = _kernel32.lookupFunction<
    IntPtr Function(IntPtr hMem, IntPtr uBytes, Uint32 uFlags),
    int Function(int hMem, int uBytes, int uFlags)>('LocalReAlloc');

int LocalSize(int hMem) => _LocalSize(hMem);

late final _LocalSize = _kernel32.lookupFunction<IntPtr Function(IntPtr hMem),
    int Function(int hMem)>('LocalSize');

int LocalUnlock(int hMem) => _LocalUnlock(hMem);

late final _LocalUnlock = _kernel32.lookupFunction<Int32 Function(IntPtr hMem),
    int Function(int hMem)>('LocalUnlock');

int MapUserPhysicalPages(
        Pointer VirtualAddress, int NumberOfPages, Pointer<IntPtr> PageArray) =>
    _MapUserPhysicalPages(VirtualAddress, NumberOfPages, PageArray);

late final _MapUserPhysicalPages = _kernel32.lookupFunction<
    Int32 Function(Pointer VirtualAddress, IntPtr NumberOfPages,
        Pointer<IntPtr> PageArray),
    int Function(Pointer VirtualAddress, int NumberOfPages,
        Pointer<IntPtr> PageArray)>('MapUserPhysicalPages');

int MapUserPhysicalPagesScatter(Pointer<Pointer> VirtualAddresses,
        int NumberOfPages, Pointer<IntPtr> PageArray) =>
    _MapUserPhysicalPagesScatter(VirtualAddresses, NumberOfPages, PageArray);

late final _MapUserPhysicalPagesScatter = _kernel32.lookupFunction<
    Int32 Function(Pointer<Pointer> VirtualAddresses, IntPtr NumberOfPages,
        Pointer<IntPtr> PageArray),
    int Function(Pointer<Pointer> VirtualAddresses, int NumberOfPages,
        Pointer<IntPtr> PageArray)>('MapUserPhysicalPagesScatter');

Pointer MapViewOfFile(int hFileMappingObject, int dwDesiredAccess,
        int dwFileOffsetHigh, int dwFileOffsetLow, int dwNumberOfBytesToMap) =>
    _MapViewOfFile(hFileMappingObject, dwDesiredAccess, dwFileOffsetHigh,
...
late final _MapViewOfFile = _kernel32.lookupFunction<
    ...
    Pointer Function(
        ...
        int dwFileOffsetLow,
        int dwNumberOfBytesToMap)>('MapViewOfFile');
...
Pointer MapViewOfFileEx(
        ...
        Pointer lpBaseAddress) =>
    _MapViewOfFileEx(hFileMappingObject, dwDesiredAccess, dwFileOffsetHigh,
...
late final _MapViewOfFileEx = _kernel32.lookupFunction<
    ...
    Pointer Function(
        ...
        int dwFileOffsetLow,
        int dwNumberOfBytesToMap,
        Pointer lpBaseAddress)>('MapViewOfFileEx');
...
Pointer MapViewOfFileExNuma(
        ...
        Pointer lpBaseAddress,
        int nndPreferred) =>
    _MapViewOfFileExNuma(hFileMappingObject, dwDesiredAccess, dwFileOffsetHigh,
...
late final _MapViewOfFileExNuma = _kernel32.lookupFunction<
    ...
    Pointer Function(
        ...
        int dwNumberOfBytesToMap,
        Pointer lpBaseAddress,
        int nndPreferred)>('MapViewOfFileExNuma');

Pointer MapViewOfFileFromApp(int hFileMappingObject, int DesiredAccess,
        int FileOffset, int NumberOfBytesToMap) =>
    _MapViewOfFileFromApp(
        hFileMappingObject, DesiredAccess, FileOffset, NumberOfBytesToMap);

late final _MapViewOfFileFromApp = _kernel32.lookupFunction<
    Pointer Function(IntPtr hFileMappingObject, Uint32 DesiredAccess,
        Uint64 FileOffset, IntPtr NumberOfBytesToMap),
    Pointer Function(int hFileMappingObject, int DesiredAccess, int FileOffset,
        int NumberOfBytesToMap)>('MapViewOfFileFromApp');

int OfferVirtualMemory(Pointer VirtualAddress, int Size, int Priority) =>
    _OfferVirtualMemory(VirtualAddress, Size, Priority);

late final _OfferVirtualMemory = _kernel32.lookupFunction<
    Uint32 Function(Pointer VirtualAddress, IntPtr Size, Int32 Priority),
    int Function(
        Pointer VirtualAddress, int Size, int Priority)>('OfferVirtualMemory');

int OpenFileMapping(
        int dwDesiredAccess, int bInheritHandle, Pointer<Utf16> lpName) =>
    _OpenFileMapping(dwDesiredAccess, bInheritHandle, lpName);
...
late final _OpenFileMapping = _kernel32.lookupFunction<
    ...
    int Function(int dwDesiredAccess, int bInheritHandle,
        Pointer<Utf16> lpName)>('OpenFileMappingW');

int PrefetchVirtualMemory(int hProcess, int NumberOfEntries,
        Pointer<WIN32_MEMORY_RANGE_ENTRY> VirtualAddresses, int Flags) =>
    _PrefetchVirtualMemory(hProcess, NumberOfEntries, VirtualAddresses, Flags);

late final _PrefetchVirtualMemory = _kernel32.lookupFunction<
    Int32 Function(IntPtr hProcess, IntPtr NumberOfEntries,
        Pointer<WIN32_MEMORY_RANGE_ENTRY> VirtualAddresses, Uint32 Flags),
    int Function(
        int hProcess,
        int NumberOfEntries,
        Pointer<WIN32_MEMORY_RANGE_ENTRY> VirtualAddresses,
        int Flags)>('PrefetchVirtualMemory');

int QueryMemoryResourceNotification(
        int ResourceNotificationHandle, Pointer<Int32> ResourceState) =>
    _QueryMemoryResourceNotification(ResourceNotificationHandle, ResourceState);

late final _QueryMemoryResourceNotification = _kernel32.lookupFunction<
    Int32 Function(
        IntPtr ResourceNotificationHandle, Pointer<Int32> ResourceState),
    int Function(int ResourceNotificationHandle,
        Pointer<Int32> ResourceState)>('QueryMemoryResourceNotification');

int ReclaimVirtualMemory(Pointer VirtualAddress, int Size) =>
    _ReclaimVirtualMemory(VirtualAddress, Size);

late final _ReclaimVirtualMemory = _kernel32.lookupFunction<
    Uint32 Function(Pointer VirtualAddress, IntPtr Size),
    int Function(Pointer VirtualAddress, int Size)>('ReclaimVirtualMemory');

Pointer RegisterBadMemoryNotification(
        Pointer<NativeFunction<PBAD_MEMORY_CALLBACK_ROUTINE>> Callback) =>
    _RegisterBadMemoryNotification(Callback);
...
int RemoveSecureMemoryCacheCallback(
        Pointer<NativeFunction<PSECURE_MEMORY_CACHE_CALLBACK>> pfnCallBack) =>
    _RemoveSecureMemoryCacheCallback(pfnCallBack);
...
late final _RemoveSecureMemoryCacheCallback = _kernel32.lookupFunction<
    ...
    int Function(
        Pointer<NativeFunction<PSECURE_MEMORY_CACHE_CALLBACK>>
            pfnCallBack)>('RemoveSecureMemoryCacheCallback');

int ResetWriteWatch(Pointer lpBaseAddress, int dwRegionSize) =>
    _ResetWriteWatch(lpBaseAddress, dwRegionSize);

late final _ResetWriteWatch = _kernel32.lookupFunction<
    Uint32 Function(Pointer lpBaseAddress, IntPtr dwRegionSize),
    int Function(Pointer lpBaseAddress, int dwRegionSize)>('ResetWriteWatch');

int RtlCompareMemory(Pointer Source1, Pointer Source2, int Length) =>
    _RtlCompareMemory(Source1, Source2, Length);

late final _RtlCompareMemory = _kernel32.lookupFunction<
    IntPtr Function(Pointer Source1, Pointer Source2, IntPtr Length),
    int Function(
        Pointer Source1, Pointer Source2, int Length)>('RtlCompareMemory');

int SetProcessWorkingSetSizeEx(int hProcess, int dwMinimumWorkingSetSize,
        int dwMaximumWorkingSetSize, int Flags) =>
...
late final _SetProcessWorkingSetSizeEx = _kernel32.lookupFunction<
    Int32 Function(IntPtr hProcess, IntPtr dwMinimumWorkingSetSize,
        IntPtr dwMaximumWorkingSetSize, Uint32 Flags),
    int Function(int hProcess, int dwMinimumWorkingSetSize,
        int dwMaximumWorkingSetSize, int Flags)>('SetProcessWorkingSetSizeEx');

int SetSystemFileCacheSize(
        int MinimumFileCacheSize, int MaximumFileCacheSize, int Flags) =>
    _SetSystemFileCacheSize(MinimumFileCacheSize, MaximumFileCacheSize, Flags);

late final _SetSystemFileCacheSize = _kernel32.lookupFunction<
    Int32 Function(
        IntPtr MinimumFileCacheSize, IntPtr MaximumFileCacheSize, Uint32 Flags),
    int Function(int MinimumFileCacheSize, int MaximumFileCacheSize,
        int Flags)>('SetSystemFileCacheSize');

int UnmapViewOfFile(Pointer lpBaseAddress) => _UnmapViewOfFile(lpBaseAddress);

late final _UnmapViewOfFile = _kernel32.lookupFunction<
    Int32 Function(Pointer lpBaseAddress),
    int Function(Pointer lpBaseAddress)>('UnmapViewOfFile');

int UnmapViewOfFileEx(Pointer BaseAddress, int UnmapFlags) =>
    _UnmapViewOfFileEx(BaseAddress, UnmapFlags);

late final _UnmapViewOfFileEx = _kernel32.lookupFunction<
    Int32 Function(Pointer BaseAddress, Uint32 UnmapFlags),
    int Function(Pointer BaseAddress, int UnmapFlags)>('UnmapViewOfFileEx');

int UnregisterBadMemoryNotification(Pointer RegistrationHandle) =>
    _UnregisterBadMemoryNotification(RegistrationHandle);

late final _UnregisterBadMemoryNotification = _kernel32.lookupFunction<
    Int32 Function(Pointer RegistrationHandle),
    int Function(
        Pointer RegistrationHandle)>('UnregisterBadMemoryNotification');
...
Pointer VirtualAllocExNuma(int hProcess, Pointer lpAddress, int dwSize,
...
late final _VirtualAllocExNuma = _kernel32.lookupFunction<
    ...
    Pointer Function(
        ...
        int flProtect,
        int nndPreferred)>('VirtualAllocExNuma');
...
int VirtualProtect(Pointer lpAddress, int dwSize, int flNewProtect,
...
late final _VirtualProtect = _kernel32.lookupFunction<
    Int32 Function(Pointer lpAddress, IntPtr dwSize, Uint32 flNewProtect,
        Pointer<Uint32> lpflOldProtect),
    int Function(Pointer lpAddress, int dwSize, int flNewProtect,
        Pointer<Uint32> lpflOldProtect)>('VirtualProtect');

int VirtualProtectEx(int hProcess, Pointer lpAddress, int dwSize,
...
late final _VirtualProtectEx = _kernel32.lookupFunction<
    Int32 Function(IntPtr hProcess, Pointer lpAddress, IntPtr dwSize,
        Uint32 flNewProtect, Pointer<Uint32> lpflOldProtect),
    int Function(int hProcess, Pointer lpAddress, int dwSize, int flNewProtect,
        Pointer<Uint32> lpflOldProtect)>('VirtualProtectEx');
