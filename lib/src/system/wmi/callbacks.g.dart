...
typedef MI_CancelCallback = Void Function(Int32 reason, Pointer callbackData);
...
typedef MI_Module_Load = Void Function(
    Pointer<Pointer<MI_Module_Self>> self, Pointer<MI_Context> context);
typedef MI_Module_Unload = Void Function(
    Pointer<MI_Module_Self> self, Pointer<MI_Context> context);
...
typedef MI_ProviderFT_Load = Void Function(Pointer<Pointer> self,
    Pointer<MI_Module_Self> selfModule, Pointer<MI_Context> context);
...
typedef MI_ProviderFT_Unload = Void Function(
    Pointer self, Pointer<MI_Context> context);
