...
class IWbemStatusCodeText extends IUnknown {
  ...
  int GetErrorCodeText(int hRes, int LocaleId, int lFlags,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int hRes, int LocaleId, int lFlags,
                      Pointer<Pointer<Utf16>> MessageText)>()(
          ptr.ref.lpVtbl, hRes, LocaleId, lFlags, MessageText);

  int GetFacilityCodeText(int hRes, int LocaleId, int lFlags,
          Pointer<Pointer<Utf16>> MessageText) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
