...
class IWbemObjectTextSrc extends IUnknown {
  ...
  int GetText(int lFlags, Pointer<COMObject> pObj, int uObjTextFormat,
          Pointer<COMObject> pCtx, Pointer<Pointer<Utf16>> strText) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pCtx,
                      Pointer<Pointer<Utf16>> strText)>()(
          ptr.ref.lpVtbl, lFlags, pObj, uObjTextFormat, pCtx, strText);

  int CreateFromText(int lFlags, Pointer<Utf16> strText, int uObjTextFormat,
          Pointer<COMObject> pCtx, Pointer<Pointer<COMObject>> pNewObj) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pCtx,
                      Pointer<Pointer<COMObject>> pNewObj)>()(
          ptr.ref.lpVtbl, lFlags, strText, uObjTextFormat, pCtx, pNewObj);
}
