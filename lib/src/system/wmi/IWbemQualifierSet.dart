...
class IWbemQualifierSet extends IUnknown {
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> wszName, int lFlags,
                      Pointer<VARIANT> pVal, Pointer<Int32> plFlavor)>()(
          ptr.ref.lpVtbl, wszName, lFlags, pVal, plFlavor);

  int Put(Pointer<Utf16> wszName, Pointer<VARIANT> pVal, int lFlavor) =>
      ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> wszName,
                          Pointer<VARIANT> pVal, Int32 lFlavor)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer,
                  Pointer<Utf16> wszName,
                  Pointer<VARIANT> pVal,
                  int lFlavor)>()(ptr.ref.lpVtbl, wszName, pVal, lFlavor);
  ...
  int Next(int lFlags, Pointer<Pointer<Utf16>> pstrName, Pointer<VARIANT> pVal,
          Pointer<Int32> plFlavor) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<VARIANT> pVal,
                      Pointer<Int32> plFlavor)>()(
          ptr.ref.lpVtbl, lFlags, pstrName, pVal, plFlavor);
