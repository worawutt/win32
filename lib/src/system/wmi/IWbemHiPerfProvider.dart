...
class IWbemHiPerfProvider extends IUnknown {
  ...
  int QueryInstances(Pointer<COMObject> pNamespace, Pointer<Utf16> wszClass,
          int lFlags, Pointer<COMObject> pCtx, Pointer<COMObject> pSink) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pCtx,
                      Pointer<COMObject> pSink)>()(
          ptr.ref.lpVtbl, pNamespace, wszClass, lFlags, pCtx, pSink);

  int CreateRefresher(Pointer<COMObject> pNamespace, int lFlags,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pNamespace,
                      int lFlags, Pointer<Pointer<COMObject>> ppRefresher)>()(
          ptr.ref.lpVtbl, pNamespace, lFlags, ppRefresher);
  ...
  int CreateRefreshableObject(
      ...
      ptr.ref.lpVtbl.value
          ...
          pTemplate, pRefresher, lFlags, pContext, ppRefreshable, plId);

  int StopRefreshing(Pointer<COMObject> pRefresher, int lId, int lFlags) =>
      ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pRefresher,
                          Int32 lId, Int32 lFlags)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> pRefresher, int lId,
                  int lFlags)>()(ptr.ref.lpVtbl, pRefresher, lId, lFlags);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pHiPerfEnum,
                      Pointer<Int32> plId)>()(ptr.ref.lpVtbl, pNamespace,
          wszClass, pRefresher, lFlags, pContext, pHiPerfEnum, plId);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int lFlags,
                      Pointer<COMObject> pContext)>()(
          ptr.ref.lpVtbl, pNamespace, lNumObjects, apObj, lFlags, pContext);
}
