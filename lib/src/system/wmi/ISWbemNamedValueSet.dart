...
class ISWbemNamedValueSet extends IDispatch {
  ...
  int
      Item(Pointer<Utf16> strName, int iFlags,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<Utf16> strName, int iFlags,
                          Pointer<Pointer<COMObject>> objWbemNamedValue)>()(
              ptr.ref.lpVtbl, strName, iFlags, objWbemNamedValue);
  ...
  int
      Add(Pointer<Utf16> strName, Pointer<VARIANT> varValue, int iFlags,
              Pointer<Pointer<COMObject>> objWbemNamedValue) =>
          ptr.ref.lpVtbl.value
                  .elementAt(10)
                  .cast<
                  ...
                  .asFunction<
                      int Function(
                          ...
                          int iFlags,
                          Pointer<Pointer<COMObject>> objWbemNamedValue)>()(
              ptr.ref.lpVtbl, strName, varValue, iFlags, objWbemNamedValue);

  int Remove(Pointer<Utf16> strName, int iFlags) => ptr.ref.lpVtbl.value
          .elementAt(11)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Utf16> strName, Int32 iFlags)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Utf16> strName, int iFlags)>()(
      ptr.ref.lpVtbl, strName, iFlags);

  int Clone(Pointer<Pointer<COMObject>> objWbemNamedValueSet) => ptr
          .ref.lpVtbl.value
          .elementAt(12)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<COMObject>> objWbemNamedValueSet)>()(
      ptr.ref.lpVtbl, objWbemNamedValueSet);
