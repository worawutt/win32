...
class IWbemLevel1Login extends IUnknown {
  ...
  int
      EstablishPosition(Pointer<Utf16> wszLocaleList, int dwNumLocales,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<Utf16> wszLocaleList,
                          int dwNumLocales, Pointer<Uint32> reserved)>()(
              ptr.ref.lpVtbl, wszLocaleList, dwNumLocales, reserved);

  int
      RequestChallenge(Pointer<Utf16> wszNetworkResource,
              Pointer<Utf16> wszUser, Pointer<Uint8> Nonce) =>
          ptr.ref.lpVtbl.value
                  .elementAt(4)
                  .cast<
                      Pointer<
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<Utf16> wszNetworkResource,
                          Pointer<Utf16> wszUser, Pointer<Uint8> Nonce)>()(
              ptr.ref.lpVtbl, wszNetworkResource, wszUser, Nonce);
