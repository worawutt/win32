...
class ISWbemServices extends IDispatch {
  ...
  int Delete(Pointer<Utf16> strObjectPath, int iFlags,
          Pointer<COMObject> objWbemNamedValueSet) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> strObjectPath,
                      int iFlags, Pointer<COMObject> objWbemNamedValueSet)>()(
          ptr.ref.lpVtbl, strObjectPath, iFlags, objWbemNamedValueSet);
