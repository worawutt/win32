...
class IWbemProviderInitSink extends IUnknown {
  ...
  int SetStatus(int lStatus, int lFlags) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 lStatus, Int32 lFlags)>>>()
          .value
          .asFunction<int Function(Pointer, int lStatus, int lFlags)>()(
      ptr.ref.lpVtbl, lStatus, lFlags);
}
