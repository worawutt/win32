...
class ISWbemEventSource extends IDispatch {
  ...
  int NextEvent(int iTimeoutMs, Pointer<Pointer<COMObject>> objWbemObject) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 iTimeoutMs,
                              Pointer<Pointer<COMObject>> objWbemObject)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int iTimeoutMs,
                      Pointer<Pointer<COMObject>> objWbemObject)>()(
          ptr.ref.lpVtbl, iTimeoutMs, objWbemObject);
