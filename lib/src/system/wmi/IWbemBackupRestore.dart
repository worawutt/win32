...
class IWbemBackupRestore extends IUnknown {
  ...
  int Backup(Pointer<Utf16> strBackupToFile, int lFlags) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Utf16> strBackupToFile,
                      Int32 lFlags)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<Utf16> strBackupToFile,
              int lFlags)>()(ptr.ref.lpVtbl, strBackupToFile, lFlags);

  int Restore(Pointer<Utf16> strRestoreFromFile, int lFlags) => ptr
      .ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Utf16> strRestoreFromFile,
                      Int32 lFlags)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<Utf16> strRestoreFromFile,
              int lFlags)>()(ptr.ref.lpVtbl, strRestoreFromFile, lFlags);
}
