...
class ISWbemObject extends IDispatch {
  ...
  int
      Put_(int iFlags, Pointer<COMObject> objWbemNamedValueSet,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(
                          ...
                          Pointer<COMObject> objWbemNamedValueSet,
                          Pointer<Pointer<COMObject>> objWbemObjectPath)>()(
              ptr.ref.lpVtbl, iFlags, objWbemNamedValueSet, objWbemObjectPath);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int iFlags,
                      Pointer<COMObject> objWbemNamedValueSet,
                      Pointer<COMObject> objWbemAsyncContext)>()(ptr.ref.lpVtbl,
          objWbemSink, iFlags, objWbemNamedValueSet, objWbemAsyncContext);

  int Delete_(int iFlags, Pointer<COMObject> objWbemNamedValueSet) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 iFlags,
                              Pointer<COMObject> objWbemNamedValueSet)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int iFlags,
                      Pointer<COMObject> objWbemNamedValueSet)>()(
          ptr.ref.lpVtbl, iFlags, objWbemNamedValueSet);
  ...
  int Instances_(int iFlags, Pointer<COMObject> objWbemNamedValueSet,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> objWbemNamedValueSet,
                      Pointer<Pointer<COMObject>> objWbemObjectSet)>()(
          ptr.ref.lpVtbl, iFlags, objWbemNamedValueSet, objWbemObjectSet);
  ...
  int Subclasses_(int iFlags, Pointer<COMObject> objWbemNamedValueSet,
          Pointer<Pointer<COMObject>> objWbemObjectSet) =>
      ptr.ref.lpVtbl.value
              .elementAt(13)
              .cast<
  ...
  int Clone_(Pointer<Pointer<COMObject>> objWbemObject) => ptr.ref.lpVtbl.value
          .elementAt(21)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<COMObject>> objWbemObject)>()(
      ptr.ref.lpVtbl, objWbemObject);

  int GetObjectText_(int iFlags, Pointer<Pointer<Utf16>> strObjectText) =>
      ptr.ref.lpVtbl.value
              .elementAt(22)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, int iFlags,
                      Pointer<Pointer<Utf16>> strObjectText)>()(
          ptr.ref.lpVtbl, iFlags, strObjectText);

  int SpawnDerivedClass_(
          int iFlags, Pointer<Pointer<COMObject>> objWbemObject) =>
      ptr.ref.lpVtbl.value
              .elementAt(23)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, int iFlags,
                      Pointer<Pointer<COMObject>> objWbemObject)>()(
          ptr.ref.lpVtbl, iFlags, objWbemObject);

  int SpawnInstance_(int iFlags, Pointer<Pointer<COMObject>> objWbemObject) =>
      ptr.ref.lpVtbl.value
              .elementAt(24)
              .cast<
                  Pointer<
  ...
  int
      CompareTo_(Pointer<COMObject> objWbemObject, int iFlags,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<COMObject> objWbemObject,
                          int iFlags, Pointer<Int16> bResult)>()(
              ptr.ref.lpVtbl, objWbemObject, iFlags, bResult);
      ...
      final hr = ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(
                  Pointer,
                  Pointer<Pointer<COMObject>>
                      objWbemQualifierSet)>()(ptr.ref.lpVtbl, retValuePtr);
      ...
      final hr = ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(
                  Pointer,
                  Pointer<Pointer<COMObject>>
                      objWbemPropertySet)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  Pointer<COMObject> get Methods_ {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> objWbemMethodSet)>()(
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<VARIANT> strClassNameArray)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<VARIANT> strClassNameArray)>()(
          ptr.ref.lpVtbl, retValuePtr);
      ...
      final hr = ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(
                  Pointer,
                  Pointer<Pointer<COMObject>>
                      objWbemObjectPath)>()(ptr.ref.lpVtbl, retValuePtr);
