...
class ISWbemRefreshableItem extends IDispatch {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> iIndex)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> iIndex)>()(
  ...
  Pointer<COMObject> get Refresher {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> objWbemRefresher)>()(
          ptr.ref.lpVtbl, retValuePtr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int16> bIsSet)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int16> bIsSet)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  Pointer<COMObject> get ObjectSet {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> objWbemObjectSet)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  int Remove(int iFlags) => ptr.ref.lpVtbl.value
      .elementAt(12)
