      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Int32> iImpersonationLevel)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> iImpersonationLevel)>()(
  ...
  set ImpersonationLevel(int value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(Pointer, Int32 iImpersonationLevel)>>>()
            .value
            .asFunction<int Function(Pointer, int iImpersonationLevel)>()(
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Int32> iAuthenticationLevel)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> iAuthenticationLevel)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set AuthenticationLevel(int value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(Pointer, Int32 iAuthenticationLevel)>>>()
            .value
            .asFunction<int Function(Pointer, int iAuthenticationLevel)>()(
        ptr.ref.lpVtbl, value);
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<COMObject>>
                      objWbemPrivilegeSet)>()(ptr.ref.lpVtbl, retValuePtr);
