...
class IWbemDecoupledBasicEventProvider extends IWbemDecoupledRegistrar {
  ...
  int GetSink(int a_Flags, Pointer<COMObject> a_Context,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> a_Context,
                      Pointer<Pointer<COMObject>> a_Sink)>()(
          ptr.ref.lpVtbl, a_Flags, a_Context, a_Sink);

  int GetService(int a_Flags, Pointer<COMObject> a_Context,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> a_Context,
                      Pointer<Pointer<COMObject>> a_Service)>()(
          ptr.ref.lpVtbl, a_Flags, a_Context, a_Service);
}
