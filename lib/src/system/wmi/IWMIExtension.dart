...
class IWMIExtension extends IDispatch {
  ...
  Pointer<Utf16> get WMIObjectPath {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> strWMIObjectPath)>()(
  ...
  int GetWMIObject(Pointer<Pointer<COMObject>> objWMIObject) => ptr
          .ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<COMObject>> objWMIObject)>()(
      ptr.ref.lpVtbl, objWMIObject);

  int GetWMIServices(Pointer<Pointer<COMObject>> objWMIServices) => ptr
          .ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<COMObject>> objWMIServices)>()(
      ptr.ref.lpVtbl, objWMIServices);
}
