...
class IWbemProviderIdentity extends IUnknown {
  ...
  int SetRegistrationObject(int lFlags, Pointer<COMObject> pProvReg) => ptr
      .ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Int32 lFlags, Pointer<COMObject> pProvReg)>>>()
      .value
      .asFunction<
          int Function(Pointer, int lFlags,
              Pointer<COMObject> pProvReg)>()(ptr.ref.lpVtbl, lFlags, pProvReg);
}
