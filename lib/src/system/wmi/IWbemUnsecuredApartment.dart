...
class IWbemUnsecuredApartment extends IUnsecuredApartment {
  ...
  int CreateSinkStub(Pointer<COMObject> pSink, int dwFlags,
          Pointer<Utf16> wszReserved, Pointer<Pointer<COMObject>> ppStub) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> wszReserved,
                      Pointer<Pointer<COMObject>> ppStub)>()(
          ptr.ref.lpVtbl, pSink, dwFlags, wszReserved, ppStub);
}
