...
class ISWbemObjectSet extends IDispatch {
  ...
  int Item(Pointer<Utf16> strObjectPath, int iFlags,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> strObjectPath,
                      int iFlags, Pointer<Pointer<COMObject>> objWbemObject)>()(
          ptr.ref.lpVtbl, strObjectPath, iFlags, objWbemObject);
  ...
  int ItemIndex(int lIndex, Pointer<Pointer<COMObject>> objWbemObject) =>
      ptr.ref.lpVtbl.value
              .elementAt(11)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, int lIndex,
                      Pointer<Pointer<COMObject>> objWbemObject)>()(
          ptr.ref.lpVtbl, lIndex, objWbemObject);
}
