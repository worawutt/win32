...
class ISWbemQualifierSet extends IDispatch {
  ...
  int Item(Pointer<Utf16> name, int iFlags,
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> name, Int32 iFlags,
                              Pointer<Pointer<COMObject>> objWbemQualifier)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> name, int iFlags,
                      Pointer<Pointer<COMObject>> objWbemQualifier)>()(
          ptr.ref.lpVtbl, name, iFlags, objWbemQualifier);
