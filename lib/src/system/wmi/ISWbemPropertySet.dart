...
class ISWbemPropertySet extends IDispatch {
  ...
  int Item(Pointer<Utf16> strName, int iFlags,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> strName, int iFlags,
                      Pointer<Pointer<COMObject>> objWbemProperty)>()(
          ptr.ref.lpVtbl, strName, iFlags, objWbemProperty);
  ...
  int Add(Pointer<Utf16> strName, int iCIMType, int bIsArray, int iFlags,
          Pointer<Pointer<COMObject>> objWbemProperty) =>
      ptr.ref.lpVtbl.value
              .elementAt(10)
              .cast<
              ...
              .asFunction<
                  int Function(
                      ...
                      int iFlags,
                      Pointer<Pointer<COMObject>> objWbemProperty)>()(
          ptr.ref.lpVtbl, strName, iCIMType, bIsArray, iFlags, objWbemProperty);
