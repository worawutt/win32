...
class IWbemClientConnectionTransport extends IUnknown {
  ...
  int Cancel(int lFlags, Pointer<COMObject> pHandler) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Int32 lFlags, Pointer<COMObject> pHandler)>>>()
      .value
      .asFunction<
          int Function(Pointer, int lFlags,
              Pointer<COMObject> pHandler)>()(ptr.ref.lpVtbl, lFlags, pHandler);
}
