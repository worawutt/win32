...
class ISWbemObjectEx extends ISWbemObject {
  ...
  int Refresh_(int iFlags, Pointer<COMObject> objWbemNamedValueSet) =>
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int iFlags,
                      Pointer<COMObject> objWbemNamedValueSet,
                      Pointer<Pointer<Utf16>> bsText)>()(ptr.ref.lpVtbl,
          iObjectTextFormat, iFlags, objWbemNamedValueSet, bsText);

  int SetFromText_(Pointer<Utf16> bsText, int iObjectTextFormat, int iFlags,
          Pointer<COMObject> objWbemNamedValueSet) =>
      ptr.ref.lpVtbl.value
              .elementAt(35)
              .cast<
