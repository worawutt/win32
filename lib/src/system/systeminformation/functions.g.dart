...
int GetFirmwareType(Pointer<Int32> FirmwareType) =>
    _GetFirmwareType(FirmwareType);

late final _GetFirmwareType = _kernel32.lookupFunction<
    Int32 Function(Pointer<Int32> FirmwareType),
    int Function(Pointer<Int32> FirmwareType)>('GetFirmwareType');
...
late final _GetSystemCpuSetInformation = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> ReturnedLength,
        int Process,
        int Flags)>('GetSystemCpuSetInformation');
...
late final _SetComputerNameEx2 = _kernel32.lookupFunction<
    Int32 Function(Int32 NameType, Uint32 Flags, Pointer<Utf16> lpBuffer),
...
late final _SetComputerNameEx = _kernel32.lookupFunction<
    Int32 Function(Int32 NameType, Pointer<Utf16> lpBuffer),
