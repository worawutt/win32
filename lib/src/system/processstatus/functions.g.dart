...
int GetProcessMemoryInfo(
        int Process, Pointer<PROCESS_MEMORY_COUNTERS> ppsmemCounters, int cb) =>
    _K32GetProcessMemoryInfo(Process, ppsmemCounters, cb);

late final _K32GetProcessMemoryInfo = _kernel32.lookupFunction<
    Int32 Function(IntPtr Process,
        Pointer<PROCESS_MEMORY_COUNTERS> ppsmemCounters, Uint32 cb),
    int Function(int Process, Pointer<PROCESS_MEMORY_COUNTERS> ppsmemCounters,
        int cb)>('K32GetProcessMemoryInfo');

int GetWsChanges(int hProcess, Pointer<PSAPI_WS_WATCH_INFORMATION> lpWatchInfo,
        int cb) =>
    _K32GetWsChanges(hProcess, lpWatchInfo, cb);

late final _K32GetWsChanges = _kernel32.lookupFunction<
    Int32 Function(IntPtr hProcess,
        Pointer<PSAPI_WS_WATCH_INFORMATION> lpWatchInfo, Uint32 cb),
    int Function(int hProcess, Pointer<PSAPI_WS_WATCH_INFORMATION> lpWatchInfo,
        int cb)>('K32GetWsChanges');

int GetWsChangesEx(
        int hProcess,
        Pointer<PSAPI_WS_WATCH_INFORMATION_EX> lpWatchInfoEx,
        Pointer<Uint32> cb) =>
    _K32GetWsChangesEx(hProcess, lpWatchInfoEx, cb);
...
late final _K32GetWsChangesEx = _kernel32.lookupFunction<
    ...
    int Function(
        int hProcess,
        Pointer<PSAPI_WS_WATCH_INFORMATION_EX> lpWatchInfoEx,
        Pointer<Uint32> cb)>('K32GetWsChangesEx');

int InitializeProcessForWsWatch(int hProcess) =>
    _K32InitializeProcessForWsWatch(hProcess);

late final _K32InitializeProcessForWsWatch = _kernel32.lookupFunction<
    Int32 Function(IntPtr hProcess),
    int Function(int hProcess)>('K32InitializeProcessForWsWatch');

int QueryWorkingSet(int hProcess, Pointer pv, int cb) =>
    _K32QueryWorkingSet(hProcess, pv, cb);

late final _K32QueryWorkingSet = _kernel32.lookupFunction<
    Int32 Function(IntPtr hProcess, Pointer pv, Uint32 cb),
    int Function(int hProcess, Pointer pv, int cb)>('K32QueryWorkingSet');

int QueryWorkingSetEx(int hProcess, Pointer pv, int cb) =>
    _K32QueryWorkingSetEx(hProcess, pv, cb);

late final _K32QueryWorkingSetEx = _kernel32.lookupFunction<
    Int32 Function(IntPtr hProcess, Pointer pv, Uint32 cb),
    int Function(int hProcess, Pointer pv, int cb)>('K32QueryWorkingSetEx');
