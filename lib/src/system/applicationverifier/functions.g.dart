...
int VerifierEnumerateResource(
        ...
        int Flags,
        int ResourceType,
        Pointer<NativeFunction<AVRF_RESOURCE_ENUMERATE_CALLBACK>>
            ResourceCallback,
        Pointer EnumerationContext) =>
    _VerifierEnumerateResource(
        Process, Flags, ResourceType, ResourceCallback, EnumerationContext);
...
late final _VerifierEnumerateResource = _verifier.lookupFunction<
    ...
    int Function(
        ...
        Pointer<NativeFunction<AVRF_RESOURCE_ENUMERATE_CALLBACK>>
            ResourceCallback,
        Pointer EnumerationContext)>('VerifierEnumerateResource');
