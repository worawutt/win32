      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Int32> pIsLinkResolved)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> pIsLinkResolved)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set IsLinkResolved(int value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(Pointer, Int32 isLinkResolved)>>>()
            .value
            .asFunction<int Function(Pointer, int isLinkResolved)>()(
        ptr.ref.lpVtbl, value);
  ...
  Pointer<Utf16> get ServerPerson {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> ppServerPersonId)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set ServerPerson(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<
                    Int32 Function(Pointer, Pointer<Utf16> pServerPersonId)>>>()
        .value
        .asFunction<
            int Function(Pointer,
                Pointer<Utf16> pServerPersonId)>()(ptr.ref.lpVtbl, value);
