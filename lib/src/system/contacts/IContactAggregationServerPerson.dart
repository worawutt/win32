...
class IContactAggregationServerPerson extends IUnknown {
  ...
  set AggregateId(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .asFunction<
            int Function(
                Pointer, Pointer<Utf16> pAggregateId)>()(ptr.ref.lpVtbl, value);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<Utf16>> ppAntiLink)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<Utf16>> ppAntiLink)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set AntiLink(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(Pointer, Pointer<Utf16> pAntiLink)>>>()
            .value
            .asFunction<int Function(Pointer, Pointer<Utf16> pAntiLink)>()(
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Uint32> pFavoriteOrder)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> pFavoriteOrder)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set FavoriteOrder(int value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(Pointer, Uint32 favoriteOrder)>>>()
            .value
            .asFunction<int Function(Pointer, int favoriteOrder)>()(
        ptr.ref.lpVtbl, value);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> pIsTombstone)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int32> pIsTombstone)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  set IsTombstone(int value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<Int32 Function(Pointer, Int32 isTombstone)>>>()
        .value
        .asFunction<
            int Function(Pointer, int isTombstone)>()(ptr.ref.lpVtbl, value);
  ...
  Pointer<Utf16> get LinkedAggregateId {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> ppLinkedAggregateId)>()(
          ptr.ref.lpVtbl, retValuePtr);
    ...
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(
                            Pointer, Pointer<Utf16> pLinkedAggregateId)>>>()
            .value
            .asFunction<
                int Function(Pointer, Pointer<Utf16> pLinkedAggregateId)>()(
        ptr.ref.lpVtbl, value);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<Utf16>> ppObjectId)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<Utf16>> ppObjectId)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set ObjectId(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(Pointer, Pointer<Utf16> pObjectId)>>>()
            .value
            .asFunction<int Function(Pointer, Pointer<Utf16> pObjectId)>()(
        ptr.ref.lpVtbl, value);
