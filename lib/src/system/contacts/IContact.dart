...
class IContact extends IUnknown {
  ...
  int GetContactID(Pointer<Utf16> pszContactID, int cchContactID,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int cchContactID,
                      Pointer<Uint32> pdwcchContactIDRequired)>()(
          ptr.ref.lpVtbl, pszContactID, cchContactID, pdwcchContactIDRequired);

  int GetPath(Pointer<Utf16> pszPath, int cchPath,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> pszPath, int cchPath,
                      Pointer<Uint32> pdwcchPathRequired)>()(
          ptr.ref.lpVtbl, pszPath, cchPath, pdwcchPathRequired);

  int CommitChanges(int dwCommitFlags) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Uint32 dwCommitFlags)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int dwCommitFlags)>()(ptr.ref.lpVtbl, dwCommitFlags);
}
