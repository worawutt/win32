...
class IContactAggregationContactCollection extends IUnknown {
  ...
  int FindFirst(Pointer<Pointer<COMObject>> ppItem) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int FindNext(Pointer<Pointer<COMObject>> ppItem) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<CONTACT_AGGREGATION_BLOB> pIdentityHash,
                      Pointer<Pointer<COMObject>> ppItem)>()(
          ptr.ref.lpVtbl, pSourceType, pAccountId, pIdentityHash, ppItem);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<CONTACT_AGGREGATION_BLOB> pRemoteObjectId,
                      Pointer<Pointer<COMObject>> ppItem)>()(
          ptr.ref.lpVtbl, pSourceType, pAccountId, pRemoteObjectId, ppItem);
}
