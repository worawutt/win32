...
class IProgressNotify extends IUnknown {
  ...
  int OnProgress(int dwProgressCurrent, int dwProgressMaximum, int fAccurate,
          int fOwner) =>
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int dwProgressCurrent,
                      int dwProgressMaximum, int fAccurate, int fOwner)>()(
          ptr.ref.lpVtbl,
          dwProgressCurrent,
          dwProgressMaximum,
          fAccurate,
