...
class ISequentialStream extends IUnknown {
  ...
  int Read(Pointer pv, int cb, Pointer<Uint32> pcbRead) => ptr.ref.lpVtbl.value      .elementAt(3)
      .cast<Pointer<NativeFunction<_Read_Native>>>()
      .value
      .asFunction<_Read_Dart>()(ptr.ref.lpVtbl, pv, cb, pcbRead);

  int Write(Pointer pv, int cb, Pointer<Uint32> pcbWritten) => ptr.ref.lpVtbl.value      .elementAt(4)
