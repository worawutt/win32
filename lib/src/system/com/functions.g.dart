...
int BindMoniker(Pointer<COMObject> pmk, int grfOpt, Pointer<GUID> iidResult,
        Pointer<Pointer> ppvResult) =>
    _BindMoniker(pmk, grfOpt, iidResult, ppvResult);

late final _BindMoniker = _ole32.lookupFunction<
    Int32 Function(Pointer<COMObject> pmk, Uint32 grfOpt,
        Pointer<GUID> iidResult, Pointer<Pointer> ppvResult),
    int Function(Pointer<COMObject> pmk, int grfOpt, Pointer<GUID> iidResult,
        Pointer<Pointer> ppvResult)>('BindMoniker');
...
int CoAllowSetForegroundWindow(Pointer<COMObject> pUnk, Pointer lpvReserved) =>
    _CoAllowSetForegroundWindow(pUnk, lpvReserved);

late final _CoAllowSetForegroundWindow = _ole32.lookupFunction<
    Int32 Function(Pointer<COMObject> pUnk, Pointer lpvReserved),
    int Function(Pointer<COMObject> pUnk,
        Pointer lpvReserved)>('CoAllowSetForegroundWindow');

int CoAllowUnmarshalerCLSID(Pointer<GUID> clsid) =>
    _CoAllowUnmarshalerCLSID(clsid);

late final _CoAllowUnmarshalerCLSID = _ole32.lookupFunction<
    Int32 Function(Pointer<GUID> clsid),
    int Function(Pointer<GUID> clsid)>('CoAllowUnmarshalerCLSID');
...
int CoCancelCall(int dwThreadId, int ulTimeout) =>
    _CoCancelCall(dwThreadId, ulTimeout);

late final _CoCancelCall = _ole32.lookupFunction<
    Int32 Function(Uint32 dwThreadId, Uint32 ulTimeout),
    int Function(int dwThreadId, int ulTimeout)>('CoCancelCall');

int CoCopyProxy(
        Pointer<COMObject> pProxy, Pointer<Pointer<COMObject>> ppCopy) =>
    _CoCopyProxy(pProxy, ppCopy);

late final _CoCopyProxy = _ole32.lookupFunction<
    Int32 Function(
        Pointer<COMObject> pProxy, Pointer<Pointer<COMObject>> ppCopy),
    int Function(Pointer<COMObject> pProxy,
        Pointer<Pointer<COMObject>> ppCopy)>('CoCopyProxy');

int CoCreateFreeThreadedMarshaler(Pointer<COMObject> punkOuter,
        Pointer<Pointer<COMObject>> ppunkMarshal) =>
    _CoCreateFreeThreadedMarshaler(punkOuter, ppunkMarshal);

late final _CoCreateFreeThreadedMarshaler = _ole32.lookupFunction<
    Int32 Function(
        Pointer<COMObject> punkOuter, Pointer<Pointer<COMObject>> ppunkMarshal),
    int Function(
        Pointer<COMObject> punkOuter,
        Pointer<Pointer<COMObject>>
            ppunkMarshal)>('CoCreateFreeThreadedMarshaler');
...
int CoCreateInstanceFromApp(
    ...
    _CoCreateInstanceFromApp(
        Clsid, punkOuter, dwClsCtx, reserved, dwCount, pResults);
...
late final _CoCreateInstanceFromApp = _ole32.lookupFunction<
    ...
    int Function(
        ...
        Pointer reserved,
        int dwCount,
        Pointer<MULTI_QI> pResults)>('CoCreateInstanceFromApp');
...
int CoDisableCallCancellation(Pointer pReserved) =>
    _CoDisableCallCancellation(pReserved);

late final _CoDisableCallCancellation = _ole32.lookupFunction<
    Int32 Function(Pointer pReserved),
    int Function(Pointer pReserved)>('CoDisableCallCancellation');

int CoDisconnectContext(int dwTimeout) => _CoDisconnectContext(dwTimeout);

late final _CoDisconnectContext = _ole32.lookupFunction<
    Int32 Function(Uint32 dwTimeout),
    int Function(int dwTimeout)>('CoDisconnectContext');

int CoDisconnectObject(Pointer<COMObject> pUnk, int dwReserved) =>
    _CoDisconnectObject(pUnk, dwReserved);

late final _CoDisconnectObject = _ole32.lookupFunction<
    Int32 Function(Pointer<COMObject> pUnk, Uint32 dwReserved),
    int Function(
        Pointer<COMObject> pUnk, int dwReserved)>('CoDisconnectObject');

int CoDosDateTimeToFileTime(
        int nDosDate, int nDosTime, Pointer<FILETIME> lpFileTime) =>
    _CoDosDateTimeToFileTime(nDosDate, nDosTime, lpFileTime);

late final _CoDosDateTimeToFileTime = _ole32.lookupFunction<
    Int32 Function(
        Uint16 nDosDate, Uint16 nDosTime, Pointer<FILETIME> lpFileTime),
    int Function(int nDosDate, int nDosTime,
        Pointer<FILETIME> lpFileTime)>('CoDosDateTimeToFileTime');

int CoEnableCallCancellation(Pointer pReserved) =>
    _CoEnableCallCancellation(pReserved);

late final _CoEnableCallCancellation = _ole32.lookupFunction<
    Int32 Function(Pointer pReserved),
    int Function(Pointer pReserved)>('CoEnableCallCancellation');

int CoFileTimeNow(Pointer<FILETIME> lpFileTime) => _CoFileTimeNow(lpFileTime);

late final _CoFileTimeNow = _ole32.lookupFunction<
    Int32 Function(Pointer<FILETIME> lpFileTime),
    int Function(Pointer<FILETIME> lpFileTime)>('CoFileTimeNow');

int CoFileTimeToDosDateTime(Pointer<FILETIME> lpFileTime,
        Pointer<Uint16> lpDosDate, Pointer<Uint16> lpDosTime) =>
    _CoFileTimeToDosDateTime(lpFileTime, lpDosDate, lpDosTime);

late final _CoFileTimeToDosDateTime = _ole32.lookupFunction<
    Int32 Function(Pointer<FILETIME> lpFileTime, Pointer<Uint16> lpDosDate,
        Pointer<Uint16> lpDosTime),
    int Function(Pointer<FILETIME> lpFileTime, Pointer<Uint16> lpDosDate,
        Pointer<Uint16> lpDosTime)>('CoFileTimeToDosDateTime');
...
void CoFreeLibrary(int hInst) => _CoFreeLibrary(hInst);

late final _CoFreeLibrary = _ole32.lookupFunction<Void Function(IntPtr hInst),
    void Function(int hInst)>('CoFreeLibrary');
...
void CoFreeUnusedLibrariesEx(int dwUnloadDelay, int dwReserved) =>
    _CoFreeUnusedLibrariesEx(dwUnloadDelay, dwReserved);

late final _CoFreeUnusedLibrariesEx = _ole32.lookupFunction<
    Void Function(Uint32 dwUnloadDelay, Uint32 dwReserved),
    void Function(
        int dwUnloadDelay, int dwReserved)>('CoFreeUnusedLibrariesEx');
...
int CoGetCallContext(Pointer<GUID> riid, Pointer<Pointer> ppInterface) =>
    _CoGetCallContext(riid, ppInterface);

late final _CoGetCallContext = _ole32.lookupFunction<
    Int32 Function(Pointer<GUID> riid, Pointer<Pointer> ppInterface),
    int Function(
        Pointer<GUID> riid, Pointer<Pointer> ppInterface)>('CoGetCallContext');

int CoGetCallerTID(Pointer<Uint32> lpdwTID) => _CoGetCallerTID(lpdwTID);

late final _CoGetCallerTID = _ole32.lookupFunction<
    Int32 Function(Pointer<Uint32> lpdwTID),
    int Function(Pointer<Uint32> lpdwTID)>('CoGetCallerTID');

int CoGetCancelObject(
        int dwThreadId, Pointer<GUID> iid, Pointer<Pointer> ppUnk) =>
    _CoGetCancelObject(dwThreadId, iid, ppUnk);

late final _CoGetCancelObject = _ole32.lookupFunction<
    Int32 Function(
        Uint32 dwThreadId, Pointer<GUID> iid, Pointer<Pointer> ppUnk),
    int Function(int dwThreadId, Pointer<GUID> iid,
        Pointer<Pointer> ppUnk)>('CoGetCancelObject');
...
int CoGetContextToken(Pointer<IntPtr> pToken) => _CoGetContextToken(pToken);

late final _CoGetContextToken = _ole32.lookupFunction<
    Int32 Function(Pointer<IntPtr> pToken),
    int Function(Pointer<IntPtr> pToken)>('CoGetContextToken');

int CoGetCurrentLogicalThreadId(Pointer<GUID> pguid) =>
    _CoGetCurrentLogicalThreadId(pguid);

late final _CoGetCurrentLogicalThreadId = _ole32.lookupFunction<
    Int32 Function(Pointer<GUID> pguid),
    int Function(Pointer<GUID> pguid)>('CoGetCurrentLogicalThreadId');
...
int CoGetMalloc(int dwMemContext, Pointer<Pointer<COMObject>> ppMalloc) =>
    _CoGetMalloc(dwMemContext, ppMalloc);

late final _CoGetMalloc = _ole32.lookupFunction<
    Int32 Function(Uint32 dwMemContext, Pointer<Pointer<COMObject>> ppMalloc),
    int Function(
        int dwMemContext, Pointer<Pointer<COMObject>> ppMalloc)>('CoGetMalloc');

int CoGetObject(Pointer<Utf16> pszName, Pointer<BIND_OPTS> pBindOptions,
        Pointer<GUID> riid, Pointer<Pointer> ppv) =>
    _CoGetObject(pszName, pBindOptions, riid, ppv);

late final _CoGetObject = _ole32.lookupFunction<
    Int32 Function(Pointer<Utf16> pszName, Pointer<BIND_OPTS> pBindOptions,
        Pointer<GUID> riid, Pointer<Pointer> ppv),
    int Function(Pointer<Utf16> pszName, Pointer<BIND_OPTS> pBindOptions,
        Pointer<GUID> riid, Pointer<Pointer> ppv)>('CoGetObject');

int CoGetObjectContext(Pointer<GUID> riid, Pointer<Pointer> ppv) =>
    _CoGetObjectContext(riid, ppv);

late final _CoGetObjectContext = _ole32.lookupFunction<
    Int32 Function(Pointer<GUID> riid, Pointer<Pointer> ppv),
    int Function(
        Pointer<GUID> riid, Pointer<Pointer> ppv)>('CoGetObjectContext');

int CoGetPSClsid(Pointer<GUID> riid, Pointer<GUID> pClsid) =>
    _CoGetPSClsid(riid, pClsid);

late final _CoGetPSClsid = _ole32.lookupFunction<
    Int32 Function(Pointer<GUID> riid, Pointer<GUID> pClsid),
    int Function(Pointer<GUID> riid, Pointer<GUID> pClsid)>('CoGetPSClsid');

int CoGetSystemSecurityPermissions(
        int comSDType, Pointer<Pointer<SECURITY_DESCRIPTOR>> ppSD) =>
    _CoGetSystemSecurityPermissions(comSDType, ppSD);

late final _CoGetSystemSecurityPermissions = _ole32.lookupFunction<
    Int32 Function(Int32 comSDType, Pointer<Pointer<SECURITY_DESCRIPTOR>> ppSD),
    int Function(
        int comSDType,
        Pointer<Pointer<SECURITY_DESCRIPTOR>>
            ppSD)>('CoGetSystemSecurityPermissions');

int CoGetTreatAsClass(Pointer<GUID> clsidOld, Pointer<GUID> pClsidNew) =>
    _CoGetTreatAsClass(clsidOld, pClsidNew);

late final _CoGetTreatAsClass = _ole32.lookupFunction<
    Int32 Function(Pointer<GUID> clsidOld, Pointer<GUID> pClsidNew),
    int Function(
        Pointer<GUID> clsidOld, Pointer<GUID> pClsidNew)>('CoGetTreatAsClass');
...
int CoInitialize(Pointer pvReserved) => _CoInitialize(pvReserved);

late final _CoInitialize = _ole32.lookupFunction<
    Int32 Function(Pointer pvReserved),
    int Function(Pointer pvReserved)>('CoInitialize');
...
int CoInvalidateRemoteMachineBindings(Pointer<Utf16> pszMachineName) =>
    _CoInvalidateRemoteMachineBindings(pszMachineName);

late final _CoInvalidateRemoteMachineBindings = _ole32.lookupFunction<
    Int32 Function(Pointer<Utf16> pszMachineName),
    int Function(
        Pointer<Utf16> pszMachineName)>('CoInvalidateRemoteMachineBindings');

int CoIsHandlerConnected(Pointer<COMObject> pUnk) =>
    _CoIsHandlerConnected(pUnk);

late final _CoIsHandlerConnected = _ole32.lookupFunction<
    Int32 Function(Pointer<COMObject> pUnk),
    int Function(Pointer<COMObject> pUnk)>('CoIsHandlerConnected');
...
int CoLoadLibrary(Pointer<Utf16> lpszLibName, int bAutoFree) =>
    _CoLoadLibrary(lpszLibName, bAutoFree);

late final _CoLoadLibrary = _ole32.lookupFunction<
    IntPtr Function(Pointer<Utf16> lpszLibName, Int32 bAutoFree),
    int Function(Pointer<Utf16> lpszLibName, int bAutoFree)>('CoLoadLibrary');

int CoLockObjectExternal(
        Pointer<COMObject> pUnk, int fLock, int fLastUnlockReleases) =>
    _CoLockObjectExternal(pUnk, fLock, fLastUnlockReleases);

late final _CoLockObjectExternal = _ole32.lookupFunction<
    Int32 Function(
        Pointer<COMObject> pUnk, Int32 fLock, Int32 fLastUnlockReleases),
    int Function(Pointer<COMObject> pUnk, int fLock,
        int fLastUnlockReleases)>('CoLockObjectExternal');

int CoQueryAuthenticationServices(Pointer<Uint32> pcAuthSvc,
        Pointer<Pointer<SOLE_AUTHENTICATION_SERVICE>> asAuthSvc) =>
    _CoQueryAuthenticationServices(pcAuthSvc, asAuthSvc);

late final _CoQueryAuthenticationServices = _ole32.lookupFunction<
        Int32 Function(Pointer<Uint32> pcAuthSvc,
            Pointer<Pointer<SOLE_AUTHENTICATION_SERVICE>> asAuthSvc),
        int Function(Pointer<Uint32> pcAuthSvc,
            Pointer<Pointer<SOLE_AUTHENTICATION_SERVICE>> asAuthSvc)>(
...
int CoQueryClientBlanket(
    ...
    _CoQueryClientBlanket(pAuthnSvc, pAuthzSvc, pServerPrincName, pAuthnLevel,
...
late final _CoQueryClientBlanket = _ole32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> pImpLevel,
        Pointer<Pointer> pPrivs,
        Pointer<Uint32> pCapabilities)>('CoQueryClientBlanket');
...
int CoQueryProxyBlanket(
    ...
    _CoQueryProxyBlanket(pProxy, pwAuthnSvc, pAuthzSvc, pServerPrincName,
...
late final _CoQueryProxyBlanket = _ole32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> pImpLevel,
        Pointer<Pointer> pAuthInfo,
        Pointer<Uint32> pCapabilites)>('CoQueryProxyBlanket');

int CoRegisterActivationFilter(Pointer<COMObject> pActivationFilter) =>
    _CoRegisterActivationFilter(pActivationFilter);

late final _CoRegisterActivationFilter = _ole32.lookupFunction<
    Int32 Function(Pointer<COMObject> pActivationFilter),
    int Function(
        Pointer<COMObject> pActivationFilter)>('CoRegisterActivationFilter');
...
int CoRegisterClassObject(Pointer<GUID> rclsid, Pointer<COMObject> pUnk,
        int dwClsContext, int flags, Pointer<Uint32> lpdwRegister) =>
    _CoRegisterClassObject(rclsid, pUnk, dwClsContext, flags, lpdwRegister);

late final _CoRegisterClassObject = _ole32.lookupFunction<
    Int32 Function(Pointer<GUID> rclsid, Pointer<COMObject> pUnk,
        Uint32 dwClsContext, Uint32 flags, Pointer<Uint32> lpdwRegister),
    int Function(
        Pointer<GUID> rclsid,
        Pointer<COMObject> pUnk,
        int dwClsContext,
        int flags,
        Pointer<Uint32> lpdwRegister)>('CoRegisterClassObject');

int CoRegisterDeviceCatalog(
        Pointer<Utf16> deviceInstanceId, Pointer<IntPtr> cookie) =>
    _CoRegisterDeviceCatalog(deviceInstanceId, cookie);

late final _CoRegisterDeviceCatalog = _ole32.lookupFunction<
    Int32 Function(Pointer<Utf16> deviceInstanceId, Pointer<IntPtr> cookie),
    int Function(Pointer<Utf16> deviceInstanceId,
        Pointer<IntPtr> cookie)>('CoRegisterDeviceCatalog');

int CoRegisterInitializeSpy(
        Pointer<COMObject> pSpy, Pointer<Uint64> puliCookie) =>
    _CoRegisterInitializeSpy(pSpy, puliCookie);

late final _CoRegisterInitializeSpy = _ole32.lookupFunction<
    Int32 Function(Pointer<COMObject> pSpy, Pointer<Uint64> puliCookie),
    int Function(Pointer<COMObject> pSpy,
        Pointer<Uint64> puliCookie)>('CoRegisterInitializeSpy');

int CoRegisterMallocSpy(Pointer<COMObject> pMallocSpy) =>
    _CoRegisterMallocSpy(pMallocSpy);

late final _CoRegisterMallocSpy = _ole32.lookupFunction<
    Int32 Function(Pointer<COMObject> pMallocSpy),
    int Function(Pointer<COMObject> pMallocSpy)>('CoRegisterMallocSpy');

int CoRegisterPSClsid(Pointer<GUID> riid, Pointer<GUID> rclsid) =>
    _CoRegisterPSClsid(riid, rclsid);

late final _CoRegisterPSClsid = _ole32.lookupFunction<
    Int32 Function(Pointer<GUID> riid, Pointer<GUID> rclsid),
    int Function(
        Pointer<GUID> riid, Pointer<GUID> rclsid)>('CoRegisterPSClsid');

int CoRegisterSurrogate(Pointer<COMObject> pSurrogate) =>
    _CoRegisterSurrogate(pSurrogate);

late final _CoRegisterSurrogate = _ole32.lookupFunction<
    Int32 Function(Pointer<COMObject> pSurrogate),
    int Function(Pointer<COMObject> pSurrogate)>('CoRegisterSurrogate');
...
int CoRevokeClassObject(int dwRegister) => _CoRevokeClassObject(dwRegister);

late final _CoRevokeClassObject = _ole32.lookupFunction<
    Int32 Function(Uint32 dwRegister),
    int Function(int dwRegister)>('CoRevokeClassObject');

int CoRevokeDeviceCatalog(int cookie) => _CoRevokeDeviceCatalog(cookie);

late final _CoRevokeDeviceCatalog = _ole32.lookupFunction<
    Int32 Function(IntPtr cookie),
    int Function(int cookie)>('CoRevokeDeviceCatalog');

int CoRevokeInitializeSpy(int uliCookie) => _CoRevokeInitializeSpy(uliCookie);

late final _CoRevokeInitializeSpy = _ole32.lookupFunction<
    Int32 Function(Uint64 uliCookie),
    int Function(int uliCookie)>('CoRevokeInitializeSpy');
...
int CoSetCancelObject(Pointer<COMObject> pUnk) => _CoSetCancelObject(pUnk);

late final _CoSetCancelObject = _ole32.lookupFunction<
    Int32 Function(Pointer<COMObject> pUnk),
    int Function(Pointer<COMObject> pUnk)>('CoSetCancelObject');
...
int CoSwitchCallContext(Pointer<COMObject> pNewObject,
        Pointer<Pointer<COMObject>> ppOldObject) =>
    _CoSwitchCallContext(pNewObject, ppOldObject);

late final _CoSwitchCallContext = _ole32.lookupFunction<
    Int32 Function(
        Pointer<COMObject> pNewObject, Pointer<Pointer<COMObject>> ppOldObject),
    int Function(Pointer<COMObject> pNewObject,
        Pointer<Pointer<COMObject>> ppOldObject)>('CoSwitchCallContext');
...
int CoTreatAsClass(Pointer<GUID> clsidOld, Pointer<GUID> clsidNew) =>
    _CoTreatAsClass(clsidOld, clsidNew);

late final _CoTreatAsClass = _ole32.lookupFunction<
    Int32 Function(Pointer<GUID> clsidOld, Pointer<GUID> clsidNew),
    int Function(
        Pointer<GUID> clsidOld, Pointer<GUID> clsidNew)>('CoTreatAsClass');
...
int CreateAntiMoniker(Pointer<Pointer<COMObject>> ppmk) =>
    _CreateAntiMoniker(ppmk);

late final _CreateAntiMoniker = _ole32.lookupFunction<
    Int32 Function(Pointer<Pointer<COMObject>> ppmk),
    int Function(Pointer<Pointer<COMObject>> ppmk)>('CreateAntiMoniker');

int CreateBindCtx(int reserved, Pointer<Pointer<COMObject>> ppbc) =>
    _CreateBindCtx(reserved, ppbc);
...
int CreateClassMoniker(
        Pointer<GUID> rclsid, Pointer<Pointer<COMObject>> ppmk) =>
    _CreateClassMoniker(rclsid, ppmk);

late final _CreateClassMoniker = _ole32.lookupFunction<
    Int32 Function(Pointer<GUID> rclsid, Pointer<Pointer<COMObject>> ppmk),
    int Function(Pointer<GUID> rclsid,
        Pointer<Pointer<COMObject>> ppmk)>('CreateClassMoniker');

int CreateDataAdviseHolder(Pointer<Pointer<COMObject>> ppDAHolder) =>
    _CreateDataAdviseHolder(ppDAHolder);

late final _CreateDataAdviseHolder = _ole32.lookupFunction<
    Int32 Function(Pointer<Pointer<COMObject>> ppDAHolder),
    int Function(
        Pointer<Pointer<COMObject>> ppDAHolder)>('CreateDataAdviseHolder');

int CreateDataCache(Pointer<COMObject> pUnkOuter, Pointer<GUID> rclsid,
        Pointer<GUID> iid, Pointer<Pointer> ppv) =>
    _CreateDataCache(pUnkOuter, rclsid, iid, ppv);

late final _CreateDataCache = _ole32.lookupFunction<
    Int32 Function(Pointer<COMObject> pUnkOuter, Pointer<GUID> rclsid,
        Pointer<GUID> iid, Pointer<Pointer> ppv),
    int Function(Pointer<COMObject> pUnkOuter, Pointer<GUID> rclsid,
        Pointer<GUID> iid, Pointer<Pointer> ppv)>('CreateDataCache');

int CreateFileMoniker(
        Pointer<Utf16> lpszPathName, Pointer<Pointer<COMObject>> ppmk) =>
    _CreateFileMoniker(lpszPathName, ppmk);

late final _CreateFileMoniker = _ole32.lookupFunction<
    Int32 Function(
        Pointer<Utf16> lpszPathName, Pointer<Pointer<COMObject>> ppmk),
    int Function(Pointer<Utf16> lpszPathName,
        Pointer<Pointer<COMObject>> ppmk)>('CreateFileMoniker');

int CreateGenericComposite(
        Pointer<COMObject> pmkFirst,
        Pointer<COMObject> pmkRest,
        Pointer<Pointer<COMObject>> ppmkComposite) =>
    _CreateGenericComposite(pmkFirst, pmkRest, ppmkComposite);

late final _CreateGenericComposite = _ole32.lookupFunction<
    Int32 Function(Pointer<COMObject> pmkFirst, Pointer<COMObject> pmkRest,
        Pointer<Pointer<COMObject>> ppmkComposite),
    int Function(Pointer<COMObject> pmkFirst, Pointer<COMObject> pmkRest,
        Pointer<Pointer<COMObject>> ppmkComposite)>('CreateGenericComposite');

int CreateItemMoniker(Pointer<Utf16> lpszDelim, Pointer<Utf16> lpszItem,
        Pointer<Pointer<COMObject>> ppmk) =>
    _CreateItemMoniker(lpszDelim, lpszItem, ppmk);

late final _CreateItemMoniker = _ole32.lookupFunction<
    Int32 Function(Pointer<Utf16> lpszDelim, Pointer<Utf16> lpszItem,
        Pointer<Pointer<COMObject>> ppmk),
    int Function(Pointer<Utf16> lpszDelim, Pointer<Utf16> lpszItem,
        Pointer<Pointer<COMObject>> ppmk)>('CreateItemMoniker');

int CreateObjrefMoniker(
        Pointer<COMObject> punk, Pointer<Pointer<COMObject>> ppmk) =>
    _CreateObjrefMoniker(punk, ppmk);

late final _CreateObjrefMoniker = _ole32.lookupFunction<
    Int32 Function(Pointer<COMObject> punk, Pointer<Pointer<COMObject>> ppmk),
    int Function(Pointer<COMObject> punk,
        Pointer<Pointer<COMObject>> ppmk)>('CreateObjrefMoniker');

int CreatePointerMoniker(
        Pointer<COMObject> punk, Pointer<Pointer<COMObject>> ppmk) =>
    _CreatePointerMoniker(punk, ppmk);

late final _CreatePointerMoniker = _ole32.lookupFunction<
    Int32 Function(Pointer<COMObject> punk, Pointer<Pointer<COMObject>> ppmk),
    int Function(Pointer<COMObject> punk,
        Pointer<Pointer<COMObject>> ppmk)>('CreatePointerMoniker');
...
int GetRunningObjectTable(int reserved, Pointer<Pointer<COMObject>> pprot) =>
    _GetRunningObjectTable(reserved, pprot);
...
int MkParseDisplayName(Pointer<COMObject> pbc, Pointer<Utf16> szUserName,
        Pointer<Uint32> pchEaten, Pointer<Pointer<COMObject>> ppmk) =>
    _MkParseDisplayName(pbc, szUserName, pchEaten, ppmk);

late final _MkParseDisplayName = _ole32.lookupFunction<
    Int32 Function(Pointer<COMObject> pbc, Pointer<Utf16> szUserName,
        Pointer<Uint32> pchEaten, Pointer<Pointer<COMObject>> ppmk),
    int Function(
        Pointer<COMObject> pbc,
        Pointer<Utf16> szUserName,
        Pointer<Uint32> pchEaten,
        Pointer<Pointer<COMObject>> ppmk)>('MkParseDisplayName');
...
int CreateIUriBuilder(Pointer<COMObject> pIUri, int dwFlags, int dwReserved,
        Pointer<Pointer<COMObject>> ppIUriBuilder) =>
    _CreateIUriBuilder(pIUri, dwFlags, dwReserved, ppIUriBuilder);

late final _CreateIUriBuilder = _urlmon.lookupFunction<
    Int32 Function(Pointer<COMObject> pIUri, Uint32 dwFlags, IntPtr dwReserved,
        Pointer<Pointer<COMObject>> ppIUriBuilder),
    int Function(Pointer<COMObject> pIUri, int dwFlags, int dwReserved,
        Pointer<Pointer<COMObject>> ppIUriBuilder)>('CreateIUriBuilder');

int CreateUri(Pointer<Utf16> pwzURI, int dwFlags, int dwReserved,
        Pointer<Pointer<COMObject>> ppURI) =>
    _CreateUri(pwzURI, dwFlags, dwReserved, ppURI);

late final _CreateUri = _urlmon.lookupFunction<
    Int32 Function(Pointer<Utf16> pwzURI, Uint32 dwFlags, IntPtr dwReserved,
        Pointer<Pointer<COMObject>> ppURI),
    int Function(Pointer<Utf16> pwzURI, int dwFlags, int dwReserved,
        Pointer<Pointer<COMObject>> ppURI)>('CreateUri');
...
int CreateUriWithFragment(Pointer<Utf16> pwzURI, Pointer<Utf16> pwzFragment,
        int dwFlags, int dwReserved, Pointer<Pointer<COMObject>> ppURI) =>
    _CreateUriWithFragment(pwzURI, pwzFragment, dwFlags, dwReserved, ppURI);

late final _CreateUriWithFragment = _urlmon.lookupFunction<
    Int32 Function(Pointer<Utf16> pwzURI, Pointer<Utf16> pwzFragment,
        Uint32 dwFlags, IntPtr dwReserved, Pointer<Pointer<COMObject>> ppURI),
    int Function(
        Pointer<Utf16> pwzURI,
        Pointer<Utf16> pwzFragment,
        int dwFlags,
        int dwReserved,
        Pointer<Pointer<COMObject>> ppURI)>('CreateUriWithFragment');
...
int GetErrorInfo(int dwReserved, Pointer<Pointer<COMObject>> pperrinfo) =>
    _GetErrorInfo(dwReserved, pperrinfo);

late final _GetErrorInfo = _oleaut32.lookupFunction<
    Int32 Function(Uint32 dwReserved, Pointer<Pointer<COMObject>> pperrinfo),
    int Function(
        int dwReserved, Pointer<Pointer<COMObject>> pperrinfo)>('GetErrorInfo');

int SetErrorInfo(int dwReserved, Pointer<COMObject> perrinfo) =>
    _SetErrorInfo(dwReserved, perrinfo);

late final _SetErrorInfo = _oleaut32.lookupFunction<
    Int32 Function(Uint32 dwReserved, Pointer<COMObject> perrinfo),
    int Function(int dwReserved, Pointer<COMObject> perrinfo)>('SetErrorInfo');
