...
class IEnumConnections extends IUnknown {
  ...
  int Next(int cConnections, Pointer<CONNECTDATA> rgcd,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int cConnections,
                      Pointer<CONNECTDATA> rgcd, Pointer<Uint32> pcFetched)>()(
          ptr.ref.lpVtbl, cConnections, rgcd, pcFetched);

  int Skip(int cConnections) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Uint32 cConnections)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int cConnections)>()(ptr.ref.lpVtbl, cConnections);
