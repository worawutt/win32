...
class AsyncIPipeByte extends IUnknown {
  ...
  int Finish_Pull(Pointer<Uint8> buf, Pointer<Uint32> pcReturned) => ptr.ref.lpVtbl.value      .elementAt(4)
      .cast<Pointer<NativeFunction<_Finish_Pull_Native>>>()
      .value
      .asFunction<_Finish_Pull_Dart>()(ptr.ref.lpVtbl, buf, pcReturned);

  int Begin_Push(Pointer<Uint8> buf, int cSent) => ptr.ref.lpVtbl.value      .elementAt(5)
