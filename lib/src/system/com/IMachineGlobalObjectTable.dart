...
class IMachineGlobalObjectTable extends IUnknown {
  ...
  int RegisterObject(
          ...
          Pointer<Pointer<MachineGlobalObjectTableRegistrationToken__>>
              token) =>
      ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<COMObject> object,
                  Pointer<Pointer<MachineGlobalObjectTableRegistrationToken__>>
                      token)>()(ptr.ref.lpVtbl, clsid, identifier, object, token);

  int GetObject(Pointer<GUID> clsid, Pointer<Utf16> identifier,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> riid,
                      Pointer<Pointer> ppv)>()(
          ptr.ref.lpVtbl, clsid, identifier, riid, ppv);
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer,
                          Pointer<MachineGlobalObjectTableRegistrationToken__>
                              token)>>>()
          .value
          .asFunction<
              int Function(
