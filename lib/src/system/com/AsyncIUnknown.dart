...
class AsyncIUnknown extends IUnknown {
  ...
  int Begin_QueryInterface(Pointer<GUID> riid) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
  ...
  int Finish_QueryInterface(Pointer<Pointer> ppvObject) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Pointer> ppvObject)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Pointer> ppvObject)>()(
      ptr.ref.lpVtbl, ppvObject);
