...
class ISynchronizeEvent extends ISynchronizeHandle {
  ...
  int SetEventHandle(Pointer<IntPtr> ph) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<IntPtr> ph)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<IntPtr> ph)>()(ptr.ref.lpVtbl, ph);
}
