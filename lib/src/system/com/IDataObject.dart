...
class IDataObject extends IUnknown {
  ...
  int GetData(Pointer<FORMATETC> pformatetcIn, Pointer<STGMEDIUM> pmedium) =>
      ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<FORMATETC> pformatetcIn,
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<STGMEDIUM>
                      pmedium)>()(ptr.ref.lpVtbl, pformatetcIn, pmedium);

  int GetDataHere(Pointer<FORMATETC> pformatetc, Pointer<STGMEDIUM> pmedium) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<FORMATETC> pformatetc,
                      Pointer<STGMEDIUM> pmedium)>()(
          ptr.ref.lpVtbl, pformatetc, pmedium);

  int QueryGetData(Pointer<FORMATETC> pformatetc) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<
      ...
      .asFunction<
          int Function(Pointer,
              Pointer<FORMATETC> pformatetc)>()(ptr.ref.lpVtbl, pformatetc);

  int
      GetCanonicalFormatEtc(Pointer<FORMATETC> pformatectIn,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<FORMATETC> pformatectIn,
                          Pointer<FORMATETC> pformatetcOut)>()(
              ptr.ref.lpVtbl, pformatectIn, pformatetcOut);
  ...
  int EnumFormatEtc(
          int dwDirection, Pointer<Pointer<COMObject>> ppenumFormatEtc) =>
      ptr
              .ref.lpVtbl.value
              .elementAt(8)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint32 dwDirection,
                              Pointer<Pointer<COMObject>> ppenumFormatEtc)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int dwDirection,
                      Pointer<Pointer<COMObject>> ppenumFormatEtc)>()(
          ptr.ref.lpVtbl, dwDirection, ppenumFormatEtc);

  int DAdvise(Pointer<FORMATETC> pformatetc, int advf,
          Pointer<COMObject> pAdvSink, Pointer<Uint32> pdwConnection) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pAdvSink,
                      Pointer<Uint32> pdwConnection)>()(
          ptr.ref.lpVtbl, pformatetc, advf, pAdvSink, pdwConnection);

  int DUnadvise(int dwConnection) => ptr.ref.lpVtbl.value
      .elementAt(10)
      .cast<
          Pointer<
  ...
  int EnumDAdvise(Pointer<Pointer<COMObject>> ppenumAdvise) =>
      ptr.ref.lpVtbl.value
              .elementAt(11)
              .cast<
                  Pointer<
