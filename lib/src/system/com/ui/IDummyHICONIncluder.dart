...
class IDummyHICONIncluder extends IUnknown {
  ...
  int Dummy(int h1, int h2) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, IntPtr h1, IntPtr h2)>>>()
      .value
      .asFunction<
          int Function(Pointer, int h1, int h2)>()(ptr.ref.lpVtbl, h1, h2);
}
