...
class IConnectionPoint extends IUnknown {
  ...
  int GetConnectionInterface(Pointer<GUID> pIID) => ptr.ref.lpVtbl.value      .elementAt(3)
      .cast<Pointer<NativeFunction<_GetConnectionInterface_Native>>>()
      .value
      .asFunction<_GetConnectionInterface_Dart>()(ptr.ref.lpVtbl, pIID);

  int GetConnectionPointContainer(Pointer<COMObject> ppCPC) => ptr.ref.lpVtbl.value      .elementAt(4)
  ...
  int Advise(COMObject pUnkSink, Pointer<Uint32> pdwCookie) => ptr.ref.lpVtbl.value      .elementAt(5)
      .cast<Pointer<NativeFunction<_Advise_Native>>>()
      .value
      .asFunction<_Advise_Dart>()(ptr.ref.lpVtbl, pUnkSink, pdwCookie);

  int Unadvise(int dwCookie) => ptr.ref.lpVtbl.value      .elementAt(6)
      .cast<Pointer<NativeFunction<_Unadvise_Native>>>()
      .value
      .asFunction<_Unadvise_Dart>()(ptr.ref.lpVtbl, dwCookie);

  int EnumConnections(Pointer<COMObject> ppEnum) => ptr.ref.lpVtbl.value      .elementAt(7)
