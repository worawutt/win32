...
class IForegroundTransfer extends IUnknown {
  ...
  int AllowForegroundTransfer(Pointer lpvReserved) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer lpvReserved)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, Pointer lpvReserved)>()(ptr.ref.lpVtbl, lpvReserved);
}
