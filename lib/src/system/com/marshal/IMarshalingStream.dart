...
class IMarshalingStream extends IStream {
  ...
  int GetMarshalingContextAttribute(
          int attribute, Pointer<IntPtr> pAttributeValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(14)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 attribute,
                              Pointer<IntPtr> pAttributeValue)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int attribute,
                      Pointer<IntPtr> pAttributeValue)>()(
          ptr.ref.lpVtbl, attribute, pAttributeValue);
}
