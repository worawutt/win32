...
class IInterfaceRelated extends IUnknown {
  ...
  int SetIID(Pointer<GUID> iid) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<NativeFunction<Int32 Function(Pointer, Pointer<GUID> iid)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<GUID> iid)>()(ptr.ref.lpVtbl, iid);
