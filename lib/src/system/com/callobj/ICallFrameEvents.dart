...
class ICallFrameEvents extends IUnknown {
  ...
  int OnCall(Pointer<COMObject> pFrame) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pFrame)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> pFrame)>()(
      ptr.ref.lpVtbl, pFrame);
}
