...
class ICallInterceptor extends ICallIndirect {
  ...
  int RegisterSink(Pointer<COMObject> psink) => ptr.ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetRegisteredSink(Pointer<Pointer<COMObject>> ppsink) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<COMObject>> ppsink)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<COMObject>> ppsink)>()(
          ptr.ref.lpVtbl, ppsink);
}
