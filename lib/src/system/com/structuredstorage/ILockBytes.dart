...
class ILockBytes extends IUnknown {
  ...
  int ReadAt(int ulOffset, Pointer pv, int cb, Pointer<Uint32> pcbRead) =>
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint64 ulOffset, Pointer pv,
                              Uint32 cb, Pointer<Uint32> pcbRead)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int ulOffset, Pointer pv, int cb,
                      Pointer<Uint32> pcbRead)>()(
          ptr.ref.lpVtbl, ulOffset, pv, cb, pcbRead);

  int WriteAt(int ulOffset, Pointer pv, int cb, Pointer<Uint32> pcbWritten) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
  ...
  int SetSize(int cb) => ptr.ref.lpVtbl.value
      .elementAt(6)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Uint64 cb)>>>()
      .value
