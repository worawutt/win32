...
int CoGetInstanceFromFile(
    ...
    _CoGetInstanceFromFile(pServerInfo, pClsid, punkOuter, dwClsCtx, grfMode,
        pwszName, dwCount, pResults);
...
late final _CoGetInstanceFromFile = _ole32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Utf16> pwszName,
        int dwCount,
        Pointer<MULTI_QI> pResults)>('CoGetInstanceFromFile');
...
int CoGetInstanceFromIStorage(
    ...
    _CoGetInstanceFromIStorage(
        pServerInfo, pClsid, punkOuter, dwClsCtx, pstg, dwCount, pResults);
...
late final _CoGetInstanceFromIStorage = _ole32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<COMObject> pstg,
        int dwCount,
        Pointer<MULTI_QI> pResults)>('CoGetInstanceFromIStorage');

int CoGetInterfaceAndReleaseStream(
        Pointer<COMObject> pStm, Pointer<GUID> iid, Pointer<Pointer> ppv) =>
    _CoGetInterfaceAndReleaseStream(pStm, iid, ppv);

late final _CoGetInterfaceAndReleaseStream = _ole32.lookupFunction<
    Int32 Function(
        Pointer<COMObject> pStm, Pointer<GUID> iid, Pointer<Pointer> ppv),
    int Function(Pointer<COMObject> pStm, Pointer<GUID> iid,
        Pointer<Pointer> ppv)>('CoGetInterfaceAndReleaseStream');

int CreateILockBytesOnHGlobal(int hGlobal, int fDeleteOnRelease,
        Pointer<Pointer<COMObject>> pplkbyt) =>
    _CreateILockBytesOnHGlobal(hGlobal, fDeleteOnRelease, pplkbyt);
...
late final _CreateILockBytesOnHGlobal = _ole32.lookupFunction<
    ...
    int Function(int hGlobal, int fDeleteOnRelease,
        Pointer<Pointer<COMObject>> pplkbyt)>('CreateILockBytesOnHGlobal');
...
int FmtIdToPropStgName(Pointer<GUID> pfmtid, Pointer<Utf16> oszName) =>
    _FmtIdToPropStgName(pfmtid, oszName);

late final _FmtIdToPropStgName = _ole32.lookupFunction<
    Int32 Function(Pointer<GUID> pfmtid, Pointer<Utf16> oszName),
    int Function(
        Pointer<GUID> pfmtid, Pointer<Utf16> oszName)>('FmtIdToPropStgName');

int FreePropVariantArray(int cVariants, Pointer<PROPVARIANT> rgvars) =>
    _FreePropVariantArray(cVariants, rgvars);

late final _FreePropVariantArray = _ole32.lookupFunction<
    Int32 Function(Uint32 cVariants, Pointer<PROPVARIANT> rgvars),
    int Function(
        int cVariants, Pointer<PROPVARIANT> rgvars)>('FreePropVariantArray');

int GetConvertStg(Pointer<COMObject> pStg) => _GetConvertStg(pStg);

late final _GetConvertStg = _ole32.lookupFunction<
    Int32 Function(Pointer<COMObject> pStg),
    int Function(Pointer<COMObject> pStg)>('GetConvertStg');

int GetHGlobalFromILockBytes(
        Pointer<COMObject> plkbyt, Pointer<IntPtr> phglobal) =>
    _GetHGlobalFromILockBytes(plkbyt, phglobal);

late final _GetHGlobalFromILockBytes = _ole32.lookupFunction<
    Int32 Function(Pointer<COMObject> plkbyt, Pointer<IntPtr> phglobal),
    int Function(Pointer<COMObject> plkbyt,
        Pointer<IntPtr> phglobal)>('GetHGlobalFromILockBytes');
...
int PropStgNameToFmtId(Pointer<Utf16> oszName, Pointer<GUID> pfmtid) =>
    _PropStgNameToFmtId(oszName, pfmtid);

late final _PropStgNameToFmtId = _ole32.lookupFunction<
    Int32 Function(Pointer<Utf16> oszName, Pointer<GUID> pfmtid),
    int Function(
        Pointer<Utf16> oszName, Pointer<GUID> pfmtid)>('PropStgNameToFmtId');
...
int PropVariantCopy(
        Pointer<PROPVARIANT> pvarDest, Pointer<PROPVARIANT> pvarSrc) =>
    _PropVariantCopy(pvarDest, pvarSrc);

late final _PropVariantCopy = _ole32.lookupFunction<
    Int32 Function(Pointer<PROPVARIANT> pvarDest, Pointer<PROPVARIANT> pvarSrc),
    int Function(Pointer<PROPVARIANT> pvarDest,
        Pointer<PROPVARIANT> pvarSrc)>('PropVariantCopy');

int ReadClassStg(Pointer<COMObject> pStg, Pointer<GUID> pclsid) =>
    _ReadClassStg(pStg, pclsid);

late final _ReadClassStg = _ole32.lookupFunction<
    Int32 Function(Pointer<COMObject> pStg, Pointer<GUID> pclsid),
    int Function(
        Pointer<COMObject> pStg, Pointer<GUID> pclsid)>('ReadClassStg');

int ReadClassStm(Pointer<COMObject> pStm, Pointer<GUID> pclsid) =>
    _ReadClassStm(pStm, pclsid);

late final _ReadClassStm = _ole32.lookupFunction<
    Int32 Function(Pointer<COMObject> pStm, Pointer<GUID> pclsid),
    int Function(
        Pointer<COMObject> pStm, Pointer<GUID> pclsid)>('ReadClassStm');

int ReadFmtUserTypeStg(Pointer<COMObject> pstg, Pointer<Uint16> pcf,
        Pointer<Pointer<Utf16>> lplpszUserType) =>
    _ReadFmtUserTypeStg(pstg, pcf, lplpszUserType);

late final _ReadFmtUserTypeStg = _ole32.lookupFunction<
    Int32 Function(Pointer<COMObject> pstg, Pointer<Uint16> pcf,
        Pointer<Pointer<Utf16>> lplpszUserType),
    int Function(Pointer<COMObject> pstg, Pointer<Uint16> pcf,
        Pointer<Pointer<Utf16>> lplpszUserType)>('ReadFmtUserTypeStg');

int SetConvertStg(Pointer<COMObject> pStg, int fConvert) =>
    _SetConvertStg(pStg, fConvert);

late final _SetConvertStg = _ole32.lookupFunction<
    Int32 Function(Pointer<COMObject> pStg, Int32 fConvert),
    int Function(Pointer<COMObject> pStg, int fConvert)>('SetConvertStg');
...
int StgCreateDocfile(Pointer<Utf16> pwcsName, int grfMode, int reserved,
        Pointer<Pointer<COMObject>> ppstgOpen) =>
    _StgCreateDocfile(pwcsName, grfMode, reserved, ppstgOpen);

late final _StgCreateDocfile = _ole32.lookupFunction<
    Int32 Function(Pointer<Utf16> pwcsName, Uint32 grfMode, Uint32 reserved,
        Pointer<Pointer<COMObject>> ppstgOpen),
    int Function(Pointer<Utf16> pwcsName, int grfMode, int reserved,
        Pointer<Pointer<COMObject>> ppstgOpen)>('StgCreateDocfile');

int StgCreateDocfileOnILockBytes(Pointer<COMObject> plkbyt, int grfMode,
        int reserved, Pointer<Pointer<COMObject>> ppstgOpen) =>
    _StgCreateDocfileOnILockBytes(plkbyt, grfMode, reserved, ppstgOpen);

late final _StgCreateDocfileOnILockBytes = _ole32.lookupFunction<
    Int32 Function(Pointer<COMObject> plkbyt, Uint32 grfMode, Uint32 reserved,
        Pointer<Pointer<COMObject>> ppstgOpen),
    int Function(Pointer<COMObject> plkbyt, int grfMode, int reserved,
        Pointer<Pointer<COMObject>> ppstgOpen)>('StgCreateDocfileOnILockBytes');

int StgCreatePropSetStg(Pointer<COMObject> pStorage, int dwReserved,
        Pointer<Pointer<COMObject>> ppPropSetStg) =>
    _StgCreatePropSetStg(pStorage, dwReserved, ppPropSetStg);

late final _StgCreatePropSetStg = _ole32.lookupFunction<
    Int32 Function(Pointer<COMObject> pStorage, Uint32 dwReserved,
        Pointer<Pointer<COMObject>> ppPropSetStg),
    int Function(Pointer<COMObject> pStorage, int dwReserved,
        Pointer<Pointer<COMObject>> ppPropSetStg)>('StgCreatePropSetStg');
...
int StgCreatePropStg(
    ...
    _StgCreatePropStg(pUnk, fmtid, pclsid, grfFlags, dwReserved, ppPropStg);
...
late final _StgCreatePropStg = _ole32.lookupFunction<
    ...
    int Function(
        ...
        int grfFlags,
        int dwReserved,
        Pointer<Pointer<COMObject>> ppPropStg)>('StgCreatePropStg');
...
int StgCreateStorageEx(
    ...
    _StgCreateStorageEx(pwcsName, grfMode, stgfmt, grfAttrs, pStgOptions,
        pSecurityDescriptor, riid, ppObjectOpen);
...
late final _StgCreateStorageEx = _ole32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<SECURITY_DESCRIPTOR> pSecurityDescriptor,
        Pointer<GUID> riid,
        Pointer<Pointer> ppObjectOpen)>('StgCreateStorageEx');
...
int StgIsStorageFile(Pointer<Utf16> pwcsName) => _StgIsStorageFile(pwcsName);

late final _StgIsStorageFile = _ole32.lookupFunction<
    Int32 Function(Pointer<Utf16> pwcsName),
    int Function(Pointer<Utf16> pwcsName)>('StgIsStorageFile');

int StgIsStorageILockBytes(Pointer<COMObject> plkbyt) =>
    _StgIsStorageILockBytes(plkbyt);

late final _StgIsStorageILockBytes = _ole32.lookupFunction<
    Int32 Function(Pointer<COMObject> plkbyt),
    int Function(Pointer<COMObject> plkbyt)>('StgIsStorageILockBytes');
...
int StgOpenPropStg(Pointer<COMObject> pUnk, Pointer<GUID> fmtid, int grfFlags,
        int dwReserved, Pointer<Pointer<COMObject>> ppPropStg) =>
    _StgOpenPropStg(pUnk, fmtid, grfFlags, dwReserved, ppPropStg);
...
late final _StgOpenPropStg = _ole32.lookupFunction<
    ...
    int Function(
        ...
        int grfFlags,
        int dwReserved,
        Pointer<Pointer<COMObject>> ppPropStg)>('StgOpenPropStg');
...
late final _StgOpenStorage = _ole32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Pointer<Uint16>> snbExclude,
        int reserved,
        Pointer<Pointer<COMObject>> ppstgOpen)>('StgOpenStorage');
...
int StgOpenStorageEx(
        ...
        Pointer<GUID> riid,
        Pointer<Pointer> ppObjectOpen) =>
    _StgOpenStorageEx(pwcsName, grfMode, stgfmt, grfAttrs, pStgOptions,
        pSecurityDescriptor, riid, ppObjectOpen);
...
late final _StgOpenStorageEx = _ole32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<SECURITY_DESCRIPTOR> pSecurityDescriptor,
        Pointer<GUID> riid,
        Pointer<Pointer> ppObjectOpen)>('StgOpenStorageEx');
...
late final _StgOpenStorageOnILockBytes = _ole32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Pointer<Uint16>> snbExclude,
        int reserved,
        Pointer<Pointer<COMObject>> ppstgOpen)>('StgOpenStorageOnILockBytes');
...
int StgSetTimes(Pointer<Utf16> lpszName, Pointer<FILETIME> pctime,
        Pointer<FILETIME> patime, Pointer<FILETIME> pmtime) =>
    _StgSetTimes(lpszName, pctime, patime, pmtime);

late final _StgSetTimes = _ole32.lookupFunction<
    Int32 Function(Pointer<Utf16> lpszName, Pointer<FILETIME> pctime,
        Pointer<FILETIME> patime, Pointer<FILETIME> pmtime),
    int Function(Pointer<Utf16> lpszName, Pointer<FILETIME> pctime,
        Pointer<FILETIME> patime, Pointer<FILETIME> pmtime)>('StgSetTimes');

int WriteClassStg(Pointer<COMObject> pStg, Pointer<GUID> rclsid) =>
    _WriteClassStg(pStg, rclsid);

late final _WriteClassStg = _ole32.lookupFunction<
    Int32 Function(Pointer<COMObject> pStg, Pointer<GUID> rclsid),
    int Function(
        Pointer<COMObject> pStg, Pointer<GUID> rclsid)>('WriteClassStg');

int WriteClassStm(Pointer<COMObject> pStm, Pointer<GUID> rclsid) =>
    _WriteClassStm(pStm, rclsid);

late final _WriteClassStm = _ole32.lookupFunction<
    Int32 Function(Pointer<COMObject> pStm, Pointer<GUID> rclsid),
    int Function(
        Pointer<COMObject> pStm, Pointer<GUID> rclsid)>('WriteClassStm');

int WriteFmtUserTypeStg(
        Pointer<COMObject> pstg, int cf, Pointer<Utf16> lpszUserType) =>
    _WriteFmtUserTypeStg(pstg, cf, lpszUserType);

late final _WriteFmtUserTypeStg = _ole32.lookupFunction<
    Int32 Function(
        Pointer<COMObject> pstg, Uint16 cf, Pointer<Utf16> lpszUserType),
    int Function(Pointer<COMObject> pstg, int cf,
        Pointer<Utf16> lpszUserType)>('WriteFmtUserTypeStg');
...
int StgDeserializePropVariant(Pointer<SERIALIZEDPROPERTYVALUE> pprop, int cbMax,
        Pointer<PROPVARIANT> ppropvar) =>
    _StgDeserializePropVariant(pprop, cbMax, ppropvar);

late final _StgDeserializePropVariant = _propsys.lookupFunction<
    Int32 Function(Pointer<SERIALIZEDPROPERTYVALUE> pprop, Uint32 cbMax,
        Pointer<PROPVARIANT> ppropvar),
    int Function(Pointer<SERIALIZEDPROPERTYVALUE> pprop, int cbMax,
        Pointer<PROPVARIANT> ppropvar)>('StgDeserializePropVariant');

int StgSerializePropVariant(
        Pointer<PROPVARIANT> ppropvar,
        Pointer<Pointer<SERIALIZEDPROPERTYVALUE>> ppProp,
        Pointer<Uint32> pcb) =>
    _StgSerializePropVariant(ppropvar, ppProp, pcb);

late final _StgSerializePropVariant = _propsys.lookupFunction<
    Int32 Function(Pointer<PROPVARIANT> ppropvar,
        Pointer<Pointer<SERIALIZEDPROPERTYVALUE>> ppProp, Pointer<Uint32> pcb),
    int Function(
        Pointer<PROPVARIANT> ppropvar,
        Pointer<Pointer<SERIALIZEDPROPERTYVALUE>> ppProp,
        Pointer<Uint32> pcb)>('StgSerializePropVariant');
