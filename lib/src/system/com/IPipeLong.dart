...
class IPipeLong extends IUnknown {
  ...
  int Pull(Pointer<Int32> buf, int cRequest, Pointer<Uint32> pcReturned) => ptr.ref.lpVtbl.value      .elementAt(3)
      .cast<Pointer<NativeFunction<_Pull_Native>>>()
      .value
      .asFunction<_Pull_Dart>()(ptr.ref.lpVtbl, buf, cRequest, pcReturned);

  int Push(Pointer<Int32> buf, int cSent) => ptr.ref.lpVtbl.value      .elementAt(4)
