...
class ITimeAndNoticeControl extends IUnknown {
  ...
  int SuppressChanges(int res1, int res2) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Uint32 res1, Uint32 res2)>>>()
          .value
          .asFunction<int Function(Pointer, int res1, int res2)>()(
      ptr.ref.lpVtbl, res1, res2);
}
