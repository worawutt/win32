...
class IRpcProxyBuffer extends IUnknown {
  ...
  int Connect(Pointer<COMObject> pRpcChannelBuffer) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<COMObject> pRpcChannelBuffer)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> pRpcChannelBuffer)>()(
      ptr.ref.lpVtbl, pRpcChannelBuffer);
