...
class ICatInformation extends IUnknown {
  ...
  int
      EnumCategories(
              int lcid, Pointer<Pointer<COMObject>> ppenumCategoryInfo) =>
          ptr.ref.lpVtbl.value
              ...
              ptr.ref.lpVtbl, lcid, ppenumCategoryInfo);

  int GetCategoryDesc(
          Pointer<GUID> rcatid, int lcid, Pointer<Pointer<Utf16>> pszDesc) =>
      ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<GUID> rcatid, Uint32 lcid,
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<Utf16>>
                      pszDesc)>()(ptr.ref.lpVtbl, rcatid, lcid, pszDesc);
  ...
  int IsClassOfCategories(Pointer<GUID> rclsid, int cImplemented,
          Pointer<GUID> rgcatidImpl, int cRequired, Pointer<GUID> rgcatidReq) =>
      ptr.ref.lpVtbl.value
              .elementAt(6)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> rgcatidImpl,
                      int cRequired,
                      Pointer<GUID> rgcatidReq)>()(ptr.ref.lpVtbl, rclsid,
          cImplemented, rgcatidImpl, cRequired, rgcatidReq);

  int EnumImplCategoriesOfClass(
          Pointer<GUID> rclsid, Pointer<Pointer<COMObject>> ppenumCatid) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<GUID> rclsid,
                      Pointer<Pointer<COMObject>> ppenumCatid)>()(
          ptr.ref.lpVtbl, rclsid, ppenumCatid);
