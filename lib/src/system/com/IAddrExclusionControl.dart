...
class IAddrExclusionControl extends IUnknown {
  ...
  int GetCurrentAddrExclusionList(
          Pointer<GUID> riid, Pointer<Pointer> ppEnumerator) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<GUID> riid,
                      Pointer<Pointer> ppEnumerator)>()(
          ptr.ref.lpVtbl, riid, ppEnumerator);

  int UpdateAddrExclusionList(Pointer<COMObject> pEnumerator) => ptr
      .ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> pEnumerator)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<COMObject> pEnumerator)>()(ptr.ref.lpVtbl, pEnumerator);
}
