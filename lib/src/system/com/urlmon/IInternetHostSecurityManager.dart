...
class IInternetHostSecurityManager extends IUnknown {
  ...
  int
      GetSecurityId(Pointer<Uint8> pbSecurityId, Pointer<Uint32> pcbSecurityId,
              int dwReserved) =>
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<Uint8> pbSecurityId,
                          Pointer<Uint32> pcbSecurityId, int dwReserved)>()(
              ptr.ref.lpVtbl, pbSecurityId, pcbSecurityId, dwReserved);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int cbContext,
                      int dwFlags,
                      int dwReserved)>()(ptr.ref.lpVtbl, dwAction, pPolicy,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint8> pContext,
                      int cbContext,
                      int dwReserved)>()(ptr.ref.lpVtbl, guidKey, ppPolicy,
