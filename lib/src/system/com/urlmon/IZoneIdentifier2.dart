...
class IZoneIdentifier2 extends IZoneIdentifier {
  ...
  int SetLastWriterPackageFamilyName(Pointer<Utf16> packageFamilyName) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
  ...
  int GetAppZoneId(Pointer<Uint32> zone) => ptr.ref.lpVtbl.value
      .elementAt(9)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Uint32> zone)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<Uint32> zone)>()(ptr.ref.lpVtbl, zone);

  int SetAppZoneId(int zone) => ptr.ref.lpVtbl.value
      .elementAt(10)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Uint32 zone)>>>()
      .value
      .asFunction<int Function(Pointer, int zone)>()(ptr.ref.lpVtbl, zone);
