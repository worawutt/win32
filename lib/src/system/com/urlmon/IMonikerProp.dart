...
class IMonikerProp extends IUnknown {
  ...
  int PutProperty(int mkp, Pointer<Utf16> val) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Int32 mkp, Pointer<Utf16> val)>>>()
              .value
              .asFunction<int Function(Pointer, int mkp, Pointer<Utf16> val)>()(
          ptr.ref.lpVtbl, mkp, val);
}
