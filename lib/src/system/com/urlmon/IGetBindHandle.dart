...
class IGetBindHandle extends IUnknown {
  ...
  int GetBindHandle(int enumRequestedHandle, Pointer<IntPtr> pRetHandle) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 enumRequestedHandle,
                              Pointer<IntPtr> pRetHandle)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int enumRequestedHandle,
                      Pointer<IntPtr> pRetHandle)>()(
          ptr.ref.lpVtbl, enumRequestedHandle, pRetHandle);
}
