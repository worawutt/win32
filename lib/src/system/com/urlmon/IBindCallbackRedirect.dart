...
class IBindCallbackRedirect extends IUnknown {
  ...
  int Redirect(Pointer<Utf16> lpcUrl, Pointer<Int16> vbCancel) =>
      ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> lpcUrl,
                          Pointer<Int16> vbCancel)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Utf16> lpcUrl,
                  Pointer<Int16> vbCancel)>()(ptr.ref.lpVtbl, lpcUrl, vbCancel);
}
