...
class IWinInetFileStream extends IUnknown {
  ...
  int SetHandleForUnlock(int hWinInetLockHandle, int dwReserved) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, IntPtr hWinInetLockHandle,
                          IntPtr dwReserved)>>>()
          .value
          .asFunction<
              int Function(Pointer, int hWinInetLockHandle, int dwReserved)>()(
      ptr.ref.lpVtbl, hWinInetLockHandle, dwReserved);

  int SetDeleteFile(int dwReserved) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
