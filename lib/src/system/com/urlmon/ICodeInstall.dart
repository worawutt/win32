...
class ICodeInstall extends IWindowForBindingUI {
  ...
  int OnCodeInstallProblem(int ulStatusCode, Pointer<Utf16> szDestination,
          Pointer<Utf16> szSource, int dwReserved) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> szSource,
                      int dwReserved)>()(
          ptr.ref.lpVtbl, ulStatusCode, szDestination, szSource, dwReserved);
}
