...
class IUriBuilderFactory extends IUnknown {
  ...
  int
      CreateIUriBuilder(int dwFlags, int dwReserved,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, int dwFlags, int dwReserved,
                          Pointer<Pointer<COMObject>> ppIUriBuilder)>()(
              ptr.ref.lpVtbl, dwFlags, dwReserved, ppIUriBuilder);

  int
      CreateInitializedIUriBuilder(int dwFlags, int dwReserved,
              Pointer<Pointer<COMObject>> ppIUriBuilder) =>
          ptr.ref.lpVtbl.value
                  .elementAt(4)
                  .cast<
