...
class IEncodingFilterFactory extends IUnknown {
  ...
  int FindBestFilter(Pointer<Utf16> pwzCodeIn, Pointer<Utf16> pwzCodeOut,
          DATAINFO info, Pointer<Pointer<COMObject>> ppDF) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      DATAINFO info,
                      Pointer<Pointer<COMObject>> ppDF)>()(
          ptr.ref.lpVtbl, pwzCodeIn, pwzCodeOut, info, ppDF);

  int GetDefaultFilter(Pointer<Utf16> pwzCodeIn, Pointer<Utf16> pwzCodeOut,
          Pointer<Pointer<COMObject>> ppDF) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> pwzCodeOut,
                      Pointer<Pointer<COMObject>> ppDF)>()(
          ptr.ref.lpVtbl, pwzCodeIn, pwzCodeOut, ppDF);
}
