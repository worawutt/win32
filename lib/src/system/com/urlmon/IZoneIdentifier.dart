...
class IZoneIdentifier extends IUnknown {
  ...
  int GetId(Pointer<Uint32> pdwZone) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int SetId(int dwZone) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Uint32 dwZone)>>>()
      .value
      .asFunction<int Function(Pointer, int dwZone)>()(ptr.ref.lpVtbl, dwZone);
