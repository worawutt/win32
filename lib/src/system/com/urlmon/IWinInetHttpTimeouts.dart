...
class IWinInetHttpTimeouts extends IUnknown {
  ...
  int GetRequestTimeouts(Pointer<Uint32> pdwConnectTimeout,
          Pointer<Uint32> pdwSendTimeout, Pointer<Uint32> pdwReceiveTimeout) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint32> pdwSendTimeout,
                      Pointer<Uint32> pdwReceiveTimeout)>()(
          ptr.ref.lpVtbl, pdwConnectTimeout, pdwSendTimeout, pdwReceiveTimeout);
}
