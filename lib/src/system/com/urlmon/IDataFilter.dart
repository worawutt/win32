...
class IDataFilter extends IUnknown {
  ...
  int SetEncodingLevel(int dwEncLevel) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<NativeFunction<Int32 Function(Pointer, Uint32 dwEncLevel)>>>()
      .value
      .asFunction<
          int Function(Pointer, int dwEncLevel)>()(ptr.ref.lpVtbl, dwEncLevel);
}
