...
class IInternetZoneManagerEx extends IInternetZoneManager {
  ...
  int GetZoneActionPolicyEx(int dwZone, int dwAction, Pointer<Uint8> pPolicy,
          int cbPolicy, int urlZoneReg, int dwFlags) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int cbPolicy,
                      int urlZoneReg,
                      int dwFlags)>()(ptr.ref.lpVtbl, dwZone, dwAction, pPolicy,
          cbPolicy, urlZoneReg, dwFlags);

  int SetZoneActionPolicyEx(int dwZone, int dwAction, Pointer<Uint8> pPolicy,
          int cbPolicy, int urlZoneReg, int dwFlags) =>
      ptr.ref.lpVtbl.value
              .elementAt(16)
              .cast<
