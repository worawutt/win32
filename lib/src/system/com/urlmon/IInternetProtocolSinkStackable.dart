...
class IInternetProtocolSinkStackable extends IUnknown {
  ...
  int SwitchSink(Pointer<COMObject> pOIProtSink) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> pOIProtSink)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<COMObject> pOIProtSink)>()(ptr.ref.lpVtbl, pOIProtSink);
