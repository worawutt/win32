...
class IHttpSecurity extends IWindowForBindingUI {
  ...
  int OnSecurityProblem(int dwProblem) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<NativeFunction<Int32 Function(Pointer, Uint32 dwProblem)>>>()
      .value
      .asFunction<
          int Function(Pointer, int dwProblem)>()(ptr.ref.lpVtbl, dwProblem);
}
