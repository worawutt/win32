...
class IHttpNegotiate3 extends IHttpNegotiate2 {
  ...
  int GetSerializedClientCertContext(
          Pointer<Pointer<Uint8>> ppbCert, Pointer<Uint32> pcbCert) =>
      ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Pointer<Uint8>> ppbCert,
                          Pointer<Uint32> pcbCert)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<Uint8>> ppbCert,
                  Pointer<Uint32> pcbCert)>()(ptr.ref.lpVtbl, ppbCert, pcbCert);
}
