  ...
  Pointer<Utf16> get EventClassName {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> pbstrEventClassName)>()(
          ptr.ref.lpVtbl, retValuePtr);
    ...
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(
                            Pointer, Pointer<Utf16> bstrEventClassName)>>>()
            .value
            .asFunction<
                int Function(Pointer, Pointer<Utf16> bstrEventClassName)>()(
        ptr.ref.lpVtbl, value);
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<Utf16>>
                      pbstrFiringInterfaceID)>()(ptr.ref.lpVtbl, retValuePtr);
    ...
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(
                            Pointer, Pointer<Utf16> bstrFiringInterfaceID)>>>()
            .value
            .asFunction<
                int Function(Pointer, Pointer<Utf16> bstrFiringInterfaceID)>()(
        ptr.ref.lpVtbl, value);
      ...
      final hr = ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(
                  Pointer,
                  Pointer<Pointer<Utf16>>
                      pbstrCustomConfigCLSID)>()(ptr.ref.lpVtbl, retValuePtr);
    ...
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(
                            Pointer, Pointer<Utf16> bstrCustomConfigCLSID)>>>()
            .value
            .asFunction<
                int Function(Pointer, Pointer<Utf16> bstrCustomConfigCLSID)>()(
        ptr.ref.lpVtbl, value);
  ...
  Pointer<Utf16> get TypeLib {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> pbstrTypeLib)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set TypeLib(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(Pointer, Pointer<Utf16> bstrTypeLib)>>>()
            .value
            .asFunction<int Function(Pointer, Pointer<Utf16> bstrTypeLib)>()(
        ptr.ref.lpVtbl, value);
