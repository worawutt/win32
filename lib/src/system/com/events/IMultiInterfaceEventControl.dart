...
class IMultiInterfaceEventControl extends IUnknown {
  ...
  int SetMultiInterfacePublisherFilter(Pointer<COMObject> classFilter) => ptr
      .ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> classFilter)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<COMObject> classFilter)>()(ptr.ref.lpVtbl, classFilter);
  ...
  int SetDefaultQuery(Pointer<GUID> eventIID, Pointer<Utf16> bstrMethodName,
          Pointer<Utf16> bstrCriteria, Pointer<Int32> errorIndex) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> bstrCriteria,
                      Pointer<Int32> errorIndex)>()(
          ptr.ref.lpVtbl, eventIID, bstrMethodName, bstrCriteria, errorIndex);
  ...
  int get AllowInprocActivation {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Int32> pfAllowInprocActivation)>()(
  ...
  set AllowInprocActivation(int value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<
                    Int32 Function(Pointer, Int32 fAllowInprocActivation)>>>()
        .value
        .asFunction<
            int Function(
                Pointer, int fAllowInprocActivation)>()(ptr.ref.lpVtbl, value);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Int32> pfFireInParallel)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> pfFireInParallel)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set FireInParallel(int value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(Pointer, Int32 fFireInParallel)>>>()
            .value
            .asFunction<int Function(Pointer, int fFireInParallel)>()(
        ptr.ref.lpVtbl, value);
