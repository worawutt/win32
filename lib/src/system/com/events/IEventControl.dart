...
class IEventControl extends IDispatch {
  ...
  int SetPublisherFilter(
          Pointer<Utf16> methodName, Pointer<COMObject> pPublisherFilter) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> methodName,
                              Pointer<COMObject> pPublisherFilter)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> methodName,
                      Pointer<COMObject> pPublisherFilter)>()(
          ptr.ref.lpVtbl, methodName, pPublisherFilter);
  ...
  int SetDefaultQuery(Pointer<Utf16> methodName, Pointer<Utf16> criteria,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> methodName,
                      Pointer<Utf16> criteria, Pointer<Int32> errorIndex)>()(
          ptr.ref.lpVtbl, methodName, criteria, errorIndex);
}
