...
class IMultiInterfacePublisherFilter extends IUnknown {
  ...
  int Initialize(Pointer<COMObject> pEIC) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pEIC)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> pEIC)>()(
      ptr.ref.lpVtbl, pEIC);

  int PrepareToFire(Pointer<GUID> iid, Pointer<Utf16> methodName,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> methodName,
                      Pointer<COMObject> firingControl)>()(
          ptr.ref.lpVtbl, iid, methodName, firingControl);
}
