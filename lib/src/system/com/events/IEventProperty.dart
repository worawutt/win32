...
class IEventProperty extends IDispatch {
  ...
  set Name(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .asFunction<
            int Function(
                Pointer, Pointer<Utf16> propertyName)>()(ptr.ref.lpVtbl, value);

    if (FAILED(hr)) throw WindowsException(hr);
  }

  int get_Value(Pointer<VARIANT> propertyValue) => ptr.ref.lpVtbl.value
      .elementAt(9)
      .cast<
          Pointer<
              NativeFunction<
      ...
      .asFunction<
          int Function(Pointer,
              Pointer<VARIANT> propertyValue)>()(ptr.ref.lpVtbl, propertyValue);

  int put_Value(Pointer<VARIANT> propertyValue) => ptr.ref.lpVtbl.value
      .elementAt(10)
      .cast<
          Pointer<
              NativeFunction<
