...
class IEventObjectChange2 extends IUnknown {
  ...
  int ChangedSubscription(Pointer<COMEVENTSYSCHANGEINFO> pInfo) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<COMEVENTSYSCHANGEINFO> pInfo)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMEVENTSYSCHANGEINFO> pInfo)>()(
      ptr.ref.lpVtbl, pInfo);

  int ChangedEventClass(Pointer<COMEVENTSYSCHANGEINFO> pInfo) => ptr
          .ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
