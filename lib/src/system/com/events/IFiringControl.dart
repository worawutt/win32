...
class IFiringControl extends IDispatch {
  ...
  int FireSubscription(Pointer<COMObject> subscription) => ptr.ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> subscription)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<COMObject> subscription)>()(ptr.ref.lpVtbl, subscription);
}
