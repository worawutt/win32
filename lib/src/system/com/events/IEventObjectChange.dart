...
class IEventObjectChange extends IUnknown {
  ...
  int ChangedSubscription(int changeType, Pointer<Utf16> bstrSubscriptionID) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 changeType,
                              Pointer<Utf16> bstrSubscriptionID)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int changeType,
                      Pointer<Utf16> bstrSubscriptionID)>()(
          ptr.ref.lpVtbl, changeType, bstrSubscriptionID);

  int ChangedEventClass(int changeType, Pointer<Utf16> bstrEventClassID) => ptr
          .ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, int changeType, Pointer<Utf16> bstrEventClassID)>()(
      ptr.ref.lpVtbl, changeType, bstrEventClassID);

  int ChangedPublisher(int changeType, Pointer<Utf16> bstrPublisherID) => ptr
          .ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, int changeType, Pointer<Utf16> bstrPublisherID)>()(
      ptr.ref.lpVtbl, changeType, bstrPublisherID);
}
