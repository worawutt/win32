...
class ITypeLib2 extends ITypeLib {
  ...
  int GetLibStatistics(
          Pointer<Uint32> pcUniqueNames, Pointer<Uint32> pcchUniqueNames) =>
      ptr.ref.lpVtbl.value
              .elementAt(14)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Uint32> pcUniqueNames,
                              Pointer<Uint32> pcchUniqueNames)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> pcUniqueNames,
                      Pointer<Uint32> pcchUniqueNames)>()(
          ptr.ref.lpVtbl, pcUniqueNames, pcchUniqueNames);
