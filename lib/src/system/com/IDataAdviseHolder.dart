...
class IDataAdviseHolder extends IUnknown {
  ...
  int Advise(Pointer<COMObject> pDataObject, Pointer<FORMATETC> pFetc, int advf,
          Pointer<COMObject> pAdvise, Pointer<Uint32> pdwConnection) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pAdvise,
                      Pointer<Uint32> pdwConnection)>()(
          ptr.ref.lpVtbl, pDataObject, pFetc, advf, pAdvise, pdwConnection);
  ...
  int SendOnDataChange(
          Pointer<COMObject> pDataObject, int dwReserved, int advf) =>
      ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<COMObject> pDataObject,
                  int dwReserved,
                  int advf)>()(ptr.ref.lpVtbl, pDataObject, dwReserved, advf);
}
