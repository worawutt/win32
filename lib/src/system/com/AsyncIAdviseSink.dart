...
class AsyncIAdviseSink extends IUnknown {
  ...
  void Begin_OnDataChange(
          Pointer<FORMATETC> pFormatetc, Pointer<STGMEDIUM> pStgmed) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Void Function(Pointer, Pointer<FORMATETC> pFormatetc,
                              Pointer<STGMEDIUM> pStgmed)>>>()
              .value
              .asFunction<
                  void Function(Pointer, Pointer<FORMATETC> pFormatetc,
                      Pointer<STGMEDIUM> pStgmed)>()(
          ptr.ref.lpVtbl, pFormatetc, pStgmed);
  ...
  void Begin_OnViewChange(int dwAspect, int lindex) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Void Function(Pointer, Uint32 dwAspect, Int32 lindex)>>>()
          .value
          .asFunction<void Function(Pointer, int dwAspect, int lindex)>()(
      ptr.ref.lpVtbl, dwAspect, lindex);
  ...
  void Begin_OnRename(Pointer<COMObject> pmk) => ptr.ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<
              NativeFunction<Void Function(Pointer, Pointer<COMObject> pmk)>>>()
      .value
      .asFunction<
          void Function(
              Pointer, Pointer<COMObject> pmk)>()(ptr.ref.lpVtbl, pmk);
