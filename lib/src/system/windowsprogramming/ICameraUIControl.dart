...
class ICameraUIControl extends IUnknown {
  ...
  int Suspend(Pointer<Int32> pbDeferralRequired) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Int32> pbDeferralRequired)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Int32> pbDeferralRequired)>()(
      ptr.ref.lpVtbl, pbDeferralRequired);
  ...
  int GetCurrentViewType(Pointer<Int32> pViewType) => ptr.ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> pViewType)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Int32> pViewType)>()(
      ptr.ref.lpVtbl, pViewType);

  int GetActiveItem(Pointer<Pointer<Utf16>> pbstrActiveItemPath) => ptr
          .ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<Utf16>> pbstrActiveItemPath)>()(
      ptr.ref.lpVtbl, pbstrActiveItemPath);

  int GetSelectedItems(Pointer<Pointer<SAFEARRAY>> ppSelectedItemPaths) => ptr
          .ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<SAFEARRAY>> ppSelectedItemPaths)>()(
      ptr.ref.lpVtbl, ppSelectedItemPaths);

  int RemoveCapturedItem(Pointer<Utf16> pszPath) => ptr.ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
                  NativeFunction<
