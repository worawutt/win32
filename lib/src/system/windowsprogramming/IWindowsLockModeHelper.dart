...
class IWindowsLockModeHelper extends IUnknown {
  ...
  int GetSMode(Pointer<Int32> isSmode) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> isSmode)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Int32> isSmode)>()(
      ptr.ref.lpVtbl, isSmode);
}
