...
class IEditionUpgradeBroker extends IUnknown {
  ...
  int InitializeParentWindow(int parentHandle) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Uint32 parentHandle)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int parentHandle)>()(ptr.ref.lpVtbl, parentHandle);

  int UpdateOperatingSystem(Pointer<Utf16> parameter) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> parameter)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Utf16> parameter)>()(
      ptr.ref.lpVtbl, parameter);
