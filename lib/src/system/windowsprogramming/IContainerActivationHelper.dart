...
class IContainerActivationHelper extends IUnknown {
  ...
  int CanActivateClientVM(Pointer<Int16> isAllowed) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int16> isAllowed)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Int16> isAllowed)>()(
