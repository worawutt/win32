...
typedef APPLICATION_RECOVERY_CALLBACK = Uint32 Function(Pointer pvParameter);
typedef ENUM_CALLBACK = Void Function(
    Pointer<DCISURFACEINFO> lpSurfaceInfo, Pointer lpContext);
typedef PDELAYLOAD_FAILURE_DLL_CALLBACK = Pointer Function(
    Uint32 NotificationReason, Pointer<DELAYLOAD_INFO> DelayloadInfo);
typedef PFEATURE_STATE_CHANGE_CALLBACK = Void Function(Pointer context);
typedef PFIBER_CALLOUT_ROUTINE = Pointer Function(Pointer lpParameter);
typedef PIO_APC_ROUTINE = Void Function(Pointer ApcContext,
    Pointer<IO_STATUS_BLOCK> IoStatusBlock, Uint32 Reserved);
...
typedef PWLDP_ISAPPAPPROVEDBYPOLICY_API = Int32 Function(
    Pointer<Utf16> PackageFamilyName, Uint64 PackageVersion);
...
typedef PWLDP_QUERYDYNAMICODETRUST_API = Int32 Function(
    IntPtr fileHandle, Pointer baseImage, Uint32 imageSize);
typedef PWLDP_QUERYPOLICYSETTINGENABLED2_API = Int32 Function(
    Pointer<Utf16> Setting, Pointer<Int32> Enabled);
typedef PWLDP_QUERYPOLICYSETTINGENABLED_API = Int32 Function(
    Int32 Setting, Pointer<Int32> Enabled);
...
typedef PWLDP_SETDYNAMICCODETRUST_API = Int32 Function(IntPtr hFileHandle);
...
typedef WINWATCHNOTIFYPROC = Void Function(
    IntPtr hww, IntPtr hwnd, Uint32 code, IntPtr lParam);
