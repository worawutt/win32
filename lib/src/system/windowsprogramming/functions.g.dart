...
int NtClose(int Handle_) => _NtClose(Handle_);

late final _NtClose = _ntdll.lookupFunction<Int32 Function(IntPtr Handle_),
    int Function(int Handle_)>('NtClose');
...
int NtQueryObject(
    ...
    _NtQueryObject(Handle_, ObjectInformationClass, ObjectInformation,
...
int NtWaitForSingleObject(int Handle_, int Alertable, Pointer<Int64> Timeout) =>
    _NtWaitForSingleObject(Handle_, Alertable, Timeout);

late final _NtWaitForSingleObject = _ntdll.lookupFunction<
    Int32 Function(IntPtr Handle_, Uint8 Alertable, Pointer<Int64> Timeout),
    int Function(int Handle_, int Alertable,
...
int RtlCharToInteger(Pointer<Int8> String_, int Base, Pointer<Uint32> Value) =>
    _RtlCharToInteger(String_, Base, Value);

late final _RtlCharToInteger = _ntdll.lookupFunction<
    Int32 Function(Pointer<Int8> String_, Uint32 Base, Pointer<Uint32> Value),
    int Function(Pointer<Int8> String_, int Base,
