...
class IMtsEventInfo extends IDispatch {
  ...
  Pointer<Utf16> get DisplayName {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> sDisplayName)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  Pointer<Utf16> get EventID {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> sGuidEventID)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  int get_Value(Pointer<Utf16> sKey, Pointer<VARIANT> pVal) => ptr
      .ref.lpVtbl.value
      .elementAt(11)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Pointer<Utf16> sKey, Pointer<VARIANT> pVal)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<Utf16> sKey,
              Pointer<VARIANT> pVal)>()(ptr.ref.lpVtbl, sKey, pVal);
}
