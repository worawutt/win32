...
class IServiceSysTxnConfig extends IServiceTransactionConfig {
  ...
  int ConfigureBYOTSysTxn(Pointer<COMObject> pTxProxy) => ptr.ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pTxProxy)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> pTxProxy)>()(
      ptr.ref.lpVtbl, pTxProxy);
}
