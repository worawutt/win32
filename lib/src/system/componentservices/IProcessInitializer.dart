...
class IProcessInitializer extends IUnknown {
  ...
  int Startup(Pointer<COMObject> punkProcessControl) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<COMObject> punkProcessControl)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> punkProcessControl)>()(
      ptr.ref.lpVtbl, punkProcessControl);
