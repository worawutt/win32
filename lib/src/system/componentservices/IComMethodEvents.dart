...
class IComMethodEvents extends IUnknown {
  ...
  int OnMethodCall(Pointer<COMSVCSEVENTINFO> pInfo, int oid,
          Pointer<GUID> guidCid, Pointer<GUID> guidRid, int iMeth) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> guidRid,
                      int iMeth)>()(
          ptr.ref.lpVtbl, pInfo, oid, guidCid, guidRid, iMeth);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int iMeth,
                      int hresult)>()(
          ptr.ref.lpVtbl, pInfo, oid, guidCid, guidRid, iMeth, hresult);

  int OnMethodException(Pointer<COMSVCSEVENTINFO> pInfo, int oid,
          Pointer<GUID> guidCid, Pointer<GUID> guidRid, int iMeth) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
