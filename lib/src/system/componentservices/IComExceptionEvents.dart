...
class IComExceptionEvents extends IUnknown {
  ...
  int OnExceptionUser(Pointer<COMSVCSEVENTINFO> pInfo, int code, int address,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<COMSVCSEVENTINFO> pInfo,
                      int code, int address, Pointer<Utf16> pszStackTrace)>()(
          ptr.ref.lpVtbl, pInfo, code, address, pszStackTrace);
}
