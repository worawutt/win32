...
class IServiceComTIIntrinsicsConfig extends IUnknown {
  ...
  int ComTIIntrinsicsConfig(int comtiIntrinsicsConfig) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 comtiIntrinsicsConfig)>>>()
          .value
          .asFunction<int Function(Pointer, int comtiIntrinsicsConfig)>()(
      ptr.ref.lpVtbl, comtiIntrinsicsConfig);
}
