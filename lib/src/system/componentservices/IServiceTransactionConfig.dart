...
class IServiceTransactionConfig extends IServiceTransactionConfigBase {
  ...
  int ConfigureBYOT(Pointer<COMObject> pITxByot) => ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pITxByot)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> pITxByot)>()(
      ptr.ref.lpVtbl, pITxByot);
}
