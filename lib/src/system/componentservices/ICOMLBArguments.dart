...
class ICOMLBArguments extends IUnknown {
  ...
  int SetCLSID(Pointer<GUID> pCLSID) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<GUID> pCLSID)>>>()
  ...
  int GetMachineName(int cchSvr, Pointer<Utf16> szServerName) => ptr
          .ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Uint32 cchSvr,
                          Pointer<Utf16> szServerName)>>>()
          .value
          .asFunction<
              int Function(Pointer, int cchSvr, Pointer<Utf16> szServerName)>()(
      ptr.ref.lpVtbl, cchSvr, szServerName);

  int SetMachineName(int cchSvr, Pointer<Utf16> szServerName) => ptr
          .ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
