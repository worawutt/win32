...
class IObjectContextInfo2 extends IObjectContextInfo {
  ...
  int GetPartitionId(Pointer<GUID> pGuid) => ptr.ref.lpVtbl.value
      .elementAt(8)
      .cast<
          Pointer<
  ...
  int GetApplicationId(Pointer<GUID> pGuid) => ptr.ref.lpVtbl.value
      .elementAt(9)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<GUID> pGuid)>>>()
  ...
  int GetApplicationInstanceId(Pointer<GUID> pGuid) => ptr.ref.lpVtbl.value
      .elementAt(10)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<GUID> pGuid)>>>()
