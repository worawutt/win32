...
class IMtsEvents extends IDispatch {
  ...
  int PostEvent(Pointer<VARIANT> vEvent) => ptr.ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<VARIANT> vEvent)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<VARIANT> vEvent)>()(
      ptr.ref.lpVtbl, vEvent);
  ...
  int GetProcessID(Pointer<Int32> id) => ptr.ref.lpVtbl.value
      .elementAt(11)
      .cast<
          Pointer<NativeFunction<Int32 Function(Pointer, Pointer<Int32> id)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<Int32> id)>()(ptr.ref.lpVtbl, id);
}
