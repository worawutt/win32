...
class IComTransactionEvents extends IUnknown {
  ...
  int OnTransactionStart(Pointer<COMSVCSEVENTINFO> pInfo, Pointer<GUID> guidTx,
          Pointer<GUID> tsid, int fRoot) =>
      ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<GUID> guidTx,
                  Pointer<GUID> tsid,
                  int fRoot)>()(ptr.ref.lpVtbl, pInfo, guidTx, tsid, fRoot);

  int OnTransactionPrepare(Pointer<COMSVCSEVENTINFO> pInfo,
