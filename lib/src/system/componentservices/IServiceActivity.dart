...
class IServiceActivity extends IUnknown {
  ...
  int SynchronousCall(Pointer<COMObject> pIServiceCall) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<COMObject> pIServiceCall)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pIServiceCall)>()(
          ptr.ref.lpVtbl, pIServiceCall);

  int AsynchronousCall(Pointer<COMObject> pIServiceCall) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
