...
class IComTrackingInfoObject extends IUnknown {
  ...
  int GetValue(Pointer<Utf16> szPropertyName, Pointer<VARIANT> pvarOut) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> szPropertyName,
                              Pointer<VARIANT> pvarOut)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> szPropertyName,
                      Pointer<VARIANT> pvarOut)>()(
          ptr.ref.lpVtbl, szPropertyName, pvarOut);
}
