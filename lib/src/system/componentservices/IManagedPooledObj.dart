...
class IManagedPooledObj extends IUnknown {
  ...
  int SetHeld(int m_bHeld) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 m_bHeld)>>>()
      .value
      .asFunction<
          int Function(Pointer, int m_bHeld)>()(ptr.ref.lpVtbl, m_bHeld);
}
