...
class ISecurityCallContext extends IDispatch {
  ...
  int IsCallerInRole(Pointer<Utf16> bstrRole, Pointer<Int16> pfInRole) => ptr
      .ref.lpVtbl.value
      .elementAt(10)
      .cast<
          Pointer<
      ...
      .asFunction<
          int Function(Pointer, Pointer<Utf16> bstrRole,
              Pointer<Int16> pfInRole)>()(ptr.ref.lpVtbl, bstrRole, pfInRole);

  int IsSecurityEnabled(Pointer<Int16> pfIsEnabled) => ptr.ref.lpVtbl.value
          .elementAt(11)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int16> pfIsEnabled)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Int16> pfIsEnabled)>()(
      ptr.ref.lpVtbl, pfIsEnabled);

  int IsUserInRole(Pointer<VARIANT> pUser, Pointer<Utf16> bstrRole,
          Pointer<Int16> pfInRole) =>
      ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<VARIANT> pUser,
                          Pointer<Utf16> bstrRole, Pointer<Int16> pfInRole)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer,
                  ...
                  Pointer<Int16>
                      pfInRole)>()(ptr.ref.lpVtbl, pUser, bstrRole, pfInRole);
}
