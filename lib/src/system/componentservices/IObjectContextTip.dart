...
class IObjectContextTip extends IUnknown {
  ...
  int GetTipUrl(Pointer<Pointer<Utf16>> pTipUrl) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Pointer<Utf16>> pTipUrl)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<Pointer<Utf16>> pTipUrl)>()(ptr.ref.lpVtbl, pTipUrl);
}
