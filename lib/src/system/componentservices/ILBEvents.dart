...
class ILBEvents extends IUnknown {
  ...
  int TargetUp(Pointer<Utf16> bstrServerName, Pointer<Utf16> bstrClsidEng) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrServerName,
                      Pointer<Utf16> bstrClsidEng)>()(
          ptr.ref.lpVtbl, bstrServerName, bstrClsidEng);

  int TargetDown(Pointer<Utf16> bstrServerName, Pointer<Utf16> bstrClsidEng) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
  ...
  int EngineDefined(Pointer<Utf16> bstrPropName, Pointer<VARIANT> varPropValue,
          Pointer<Utf16> bstrClsidEng) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<VARIANT> varPropValue,
                      Pointer<Utf16> bstrClsidEng)>()(
          ptr.ref.lpVtbl, bstrPropName, varPropValue, bstrClsidEng);
}
