...
class ICOMAdminCatalog2 extends ICOMAdminCatalog {
  ...
  int GetApplicationInstanceIDFromProcessID(
          int lProcessID, Pointer<Pointer<Utf16>> pbstrApplicationInstanceID) =>
      ptr.ref.lpVtbl.value
              .elementAt(34)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, int lProcessID,
                      Pointer<Pointer<Utf16>> pbstrApplicationInstanceID)>()(
          ptr.ref.lpVtbl, lProcessID, pbstrApplicationInstanceID);
  ...
  int ShutdownApplicationInstances(
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<VARIANT> pVarApplicationInstanceID)>()(
          ptr.ref.lpVtbl, pVarApplicationInstanceID);

  int PauseApplicationInstances(Pointer<VARIANT> pVarApplicationInstanceID) =>
      ptr.ref.lpVtbl.value
              .elementAt(36)
              .cast<
                  Pointer<
  ...
  int ResumeApplicationInstances(Pointer<VARIANT> pVarApplicationInstanceID) =>
      ptr.ref.lpVtbl.value
              .elementAt(37)
              .cast<
                  Pointer<
  ...
  int RecycleApplicationInstances(
          Pointer<VARIANT> pVarApplicationInstanceID, int lReasonCode) =>
      ptr.ref.lpVtbl.value
              .elementAt(38)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<VARIANT> pVarApplicationInstanceID,
                      int lReasonCode)>()(
          ptr.ref.lpVtbl, pVarApplicationInstanceID, lReasonCode);

  int AreApplicationInstancesPaused(Pointer<VARIANT> pVarApplicationInstanceID,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<VARIANT> pVarApplicationInstanceID,
                      Pointer<Int16> pVarBoolPaused)>()(
          ptr.ref.lpVtbl, pVarApplicationInstanceID, pVarBoolPaused);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> bstrDirectory,
                      int lMaxImages,
                      Pointer<Pointer<Utf16>> pbstrDumpFile)>()(ptr.ref.lpVtbl,
          bstrApplicationInstanceID, bstrDirectory, lMaxImages, pbstrDumpFile);
  ...
  int get IsApplicationInstanceDumpSupported {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Int16> pVarBoolDumpSupported)>()(
  ...
  int DeleteServiceForApplication(Pointer<Utf16> bstrApplicationIDOrName) => ptr
          .ref.lpVtbl.value
          .elementAt(43)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Utf16> bstrApplicationIDOrName)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Utf16> bstrApplicationIDOrName)>()(
      ptr.ref.lpVtbl, bstrApplicationIDOrName);

  int GetPartitionID(Pointer<Utf16> bstrApplicationIDOrName,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrApplicationIDOrName,
                      Pointer<Pointer<Utf16>> pbstrPartitionID)>()(
          ptr.ref.lpVtbl, bstrApplicationIDOrName, pbstrPartitionID);

  int GetPartitionName(Pointer<Utf16> bstrApplicationIDOrName,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrApplicationIDOrName,
                      Pointer<Pointer<Utf16>> pbstrPartitionName)>()(
          ptr.ref.lpVtbl, bstrApplicationIDOrName, pbstrPartitionName);
    ...
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(
                            Pointer, Pointer<Utf16> bstrPartitionIDOrName)>>>()
            .value
            .asFunction<
                int Function(Pointer, Pointer<Utf16> bstrPartitionIDOrName)>()(
        ptr.ref.lpVtbl, value);
  ...
  Pointer<Utf16> get CurrentPartitionID {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> pbstrPartitionID)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  Pointer<Utf16> get CurrentPartitionName {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> pbstrPartitionName)>()(
          ptr.ref.lpVtbl, retValuePtr);
      ...
      final hr = ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(
                  Pointer,
                  Pointer<Pointer<Utf16>>
                      pbstrGlobalPartitionID)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  int IsSafeToDelete(
          Pointer<Utf16> bstrDllName, Pointer<Int32> pCOMAdminInUse) =>
      ptr.ref.lpVtbl.value
              .elementAt(55)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> bstrDllName,
                              Pointer<Int32> pCOMAdminInUse)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrDllName,
                      Pointer<Int32> pCOMAdminInUse)>()(
          ptr.ref.lpVtbl, bstrDllName, pCOMAdminInUse);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> bstrApplicationIDOrName,
                      Pointer<VARIANT> pVarCLSIDOrProgID,
                      Pointer<VARIANT> pVarComponentType)>()(ptr.ref.lpVtbl,
          bstrApplicationIDOrName, pVarCLSIDOrProgID, pVarComponentType);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int16> pbIs64Bit)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int16> pbIs64Bit)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  int ExportPartition(Pointer<Utf16> bstrPartitionIDOrName,
          Pointer<Utf16> bstrPartitionFileName, int lOptions) =>
      ptr.ref.lpVtbl.value
              .elementAt(60)
              .cast<
                  Pointer<
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> bstrUserID,
                      Pointer<Utf16> bstrPassword,
                      Pointer<Utf16> bstrRSN)>()(ptr.ref.lpVtbl, bstrFileName,
          bstrDestDirectory, lOptions, bstrUserID, bstrPassword, bstrRSN);

  int QueryApplicationFile2(Pointer<Utf16> bstrApplicationFile,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrApplicationFile,
                      Pointer<Pointer<COMObject>> ppFilesForImport)>()(
          ptr.ref.lpVtbl, bstrApplicationFile, ppFilesForImport);

  int
      GetComponentVersionCount(Pointer<Utf16> bstrCLSIDOrProgID,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<Utf16> bstrCLSIDOrProgID,
                          Pointer<Int32> plVersionCount)>()(
              ptr.ref.lpVtbl, bstrCLSIDOrProgID, plVersionCount);
}
