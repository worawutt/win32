...
class IContextProperties extends IUnknown {
  ...
  int SetProperty(Pointer<Utf16> name, VARIANT property) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Utf16> name, VARIANT property)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Utf16> name, VARIANT property)>()(
      ptr.ref.lpVtbl, name, property);

  int RemoveProperty(Pointer<Utf16> name) => ptr.ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<
