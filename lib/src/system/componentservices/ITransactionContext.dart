...
class ITransactionContext extends IDispatch {
  ...
  int CreateInstance(Pointer<Utf16> pszProgId, Pointer<VARIANT> pObject) => ptr
      .ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<
      ...
      .value
      .asFunction<
          int Function(Pointer, Pointer<Utf16> pszProgId,
              Pointer<VARIANT> pObject)>()(ptr.ref.lpVtbl, pszProgId, pObject);
