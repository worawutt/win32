...
class ISystemAppEventData extends IUnknown {
  ...
  int OnDataChanged(int dwPID, int dwMask, int dwNumberSinks,
          Pointer<Utf16> bstrDwMethodMask, int dwReason, int u64TraceHandle) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> bstrDwMethodMask,
                      int dwReason,
                      int u64TraceHandle)>()(ptr.ref.lpVtbl, dwPID, dwMask,
          dwNumberSinks, bstrDwMethodMask, dwReason, u64TraceHandle);
}
