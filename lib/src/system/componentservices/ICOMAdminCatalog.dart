...
class ICOMAdminCatalog extends IDispatch {
  ...
  int
      GetCollection(Pointer<Utf16> bstrCollName,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<Utf16> bstrCollName,
                          Pointer<Pointer<COMObject>> ppCatalogCollection)>()(
              ptr.ref.lpVtbl, bstrCollName, ppCatalogCollection);

  int
      Connect(Pointer<Utf16> bstrCatalogServerName,
              Pointer<Pointer<COMObject>> ppCatalogCollection) =>
          ptr.ref.lpVtbl.value
                  .elementAt(8)
                  .cast<
                  ...
                  .asFunction<
                      int Function(
                          ...
                          Pointer<Utf16> bstrCatalogServerName,
                          Pointer<Pointer<COMObject>> ppCatalogCollection)>()(
              ptr.ref.lpVtbl, bstrCatalogServerName, ppCatalogCollection);
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(
                          ...
                          Pointer<Pointer<SAFEARRAY>> ppsaVarQuery,
                          Pointer<Pointer<COMObject>> ppCatalogCollection)>()(
              ptr.ref.lpVtbl, bstrCollName, ppsaVarQuery, ppCatalogCollection);

  int
      ImportComponent(Pointer<Utf16> bstrApplIDOrName,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<Utf16> bstrApplIDOrName,
                          Pointer<Utf16> bstrCLSIDOrProgID)>()(
              ptr.ref.lpVtbl, bstrApplIDOrName, bstrCLSIDOrProgID);

  int InstallComponent(Pointer<Utf16> bstrApplIDOrName, Pointer<Utf16> bstrDLL,
          Pointer<Utf16> bstrTLB, Pointer<Utf16> bstrPSDLL) =>
      ptr.ref.lpVtbl.value
              .elementAt(13)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> bstrTLB,
                      Pointer<Utf16> bstrPSDLL)>()(
          ptr.ref.lpVtbl, bstrApplIDOrName, bstrDLL, bstrTLB, bstrPSDLL);

  int ShutdownApplication(Pointer<Utf16> bstrApplIDOrName) =>
      ptr.ref.lpVtbl.value
              .elementAt(14)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Utf16> bstrApplIDOrName)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrApplIDOrName)>()(
          ptr.ref.lpVtbl, bstrApplIDOrName);

  int ExportApplication(Pointer<Utf16> bstrApplIDOrName,
          Pointer<Utf16> bstrApplicationFile, int lOptions) =>
      ptr.ref.lpVtbl.value
              .elementAt(15)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrApplIDOrName,
                      Pointer<Utf16> bstrApplicationFile, int lOptions)>()(
          ptr.ref.lpVtbl, bstrApplIDOrName, bstrApplicationFile, lOptions);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<SAFEARRAY>> ppsaVarFileNames,
                      Pointer<Pointer<SAFEARRAY>> ppsaVarCLSIDs)>()(
          ptr.ref.lpVtbl, bstrApplIDOrName, ppsaVarFileNames, ppsaVarCLSIDs);
  ...
  int BackupREGDB(Pointer<Utf16> bstrBackupFilePath) => ptr.ref.lpVtbl.value
          .elementAt(25)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Utf16> bstrBackupFilePath)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Utf16> bstrBackupFilePath)>()(
      ptr.ref.lpVtbl, bstrBackupFilePath);

  int RestoreREGDB(Pointer<Utf16> bstrBackupFilePath) => ptr.ref.lpVtbl.value
          .elementAt(26)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int StartApplication(Pointer<Utf16> bstrApplIdOrName) =>
      ptr.ref.lpVtbl.value
              .elementAt(28)
              .cast<
                  Pointer<
  ...
  int ServiceCheck(int lService, Pointer<Int32> plStatus) => ptr
          .ref.lpVtbl.value
          .elementAt(29)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Int32 lService, Pointer<Int32> plStatus)>>>()
          .value
          .asFunction<
              int Function(Pointer, int lService, Pointer<Int32> plStatus)>()(
      ptr.ref.lpVtbl, lService, plStatus);
  ...
  int InstallEventClass(Pointer<Utf16> bstrApplIdOrName, Pointer<Utf16> bstrDLL,
          Pointer<Utf16> bstrTLB, Pointer<Utf16> bstrPSDLL) =>
      ptr.ref.lpVtbl.value
              .elementAt(31)
              .cast<
