...
class IAppDomainHelper extends IDispatch {
  ...
  int
      Initialize(Pointer<COMObject> pUnkAD, int MIDL__IAppDomainHelper0000,
              Pointer pPool) =>
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<COMObject> pUnkAD,
                          int MIDL__IAppDomainHelper0000, Pointer pPool)>()(
              ptr.ref.lpVtbl, pUnkAD, MIDL__IAppDomainHelper0000, pPool);

  int
      DoCallback(Pointer<COMObject> pUnkAD, int MIDL__IAppDomainHelper0001,
              Pointer pPool) =>
          ptr.ref.lpVtbl.value
                  .elementAt(8)
                  .cast<
                  ...
                  .asFunction<
                      int Function(Pointer, Pointer<COMObject> pUnkAD,
                          int MIDL__IAppDomainHelper0001, Pointer pPool)>()(
              ptr.ref.lpVtbl, pUnkAD, MIDL__IAppDomainHelper0001, pPool);
}
