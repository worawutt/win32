...
class IComTrackingInfoProperties extends IUnknown {
  ...
  int PropCount(Pointer<Uint32> pCount) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetPropName(int ulIndex, Pointer<Pointer<Utf16>> ppszPropName) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int ulIndex,
                      Pointer<Pointer<Utf16>> ppszPropName)>()(
          ptr.ref.lpVtbl, ulIndex, ppszPropName);
}
