...
class IComObjectConstructionEvents extends IUnknown {
  ...
  int OnObjectConstruct(Pointer<COMSVCSEVENTINFO> pInfo,
          Pointer<GUID> guidObject, Pointer<Utf16> sConstructString, int oid) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> sConstructString,
                      int oid)>()(
          ptr.ref.lpVtbl, pInfo, guidObject, sConstructString, oid);
}
