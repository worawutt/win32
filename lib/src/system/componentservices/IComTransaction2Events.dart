...
class IComTransaction2Events extends IUnknown {
  ...
  int OnTransactionStart2(Pointer<COMSVCSEVENTINFO> pInfo, Pointer<GUID> guidTx,
          Pointer<GUID> tsid, int fRoot, int nIsolationLevel) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int fRoot,
                      int nIsolationLevel)>()(
          ptr.ref.lpVtbl, pInfo, guidTx, tsid, fRoot, nIsolationLevel);

  int OnTransactionPrepare2(Pointer<COMSVCSEVENTINFO> pInfo,
          Pointer<GUID> guidTx, int fVoteYes) =>
      ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMSVCSEVENTINFO> pInfo,
                          Pointer<GUID> guidTx, Int32 fVoteYes)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer,
                  Pointer<COMSVCSEVENTINFO> pInfo,
                  Pointer<GUID> guidTx,
                  int fVoteYes)>()(ptr.ref.lpVtbl, pInfo, guidTx, fVoteYes);

  int OnTransactionAbort2(
          Pointer<COMSVCSEVENTINFO> pInfo, Pointer<GUID> guidTx) =>
      ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(Pointer, Pointer<COMSVCSEVENTINFO> pInfo,
                  Pointer<GUID> guidTx)>()(ptr.ref.lpVtbl, pInfo, guidTx);
