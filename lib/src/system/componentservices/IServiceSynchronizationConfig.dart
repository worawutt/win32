...
class IServiceSynchronizationConfig extends IUnknown {
  ...
  int ConfigureSynchronization(int synchConfig) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<NativeFunction<Int32 Function(Pointer, Int32 synchConfig)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int synchConfig)>()(ptr.ref.lpVtbl, synchConfig);
}
