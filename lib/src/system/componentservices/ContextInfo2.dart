...
class ContextInfo2 extends ContextInfo {
  ...
  int GetPartitionId(Pointer<Pointer<Utf16>> MIDL__ContextInfo20000) => ptr
          .ref.lpVtbl.value
          .elementAt(12)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<Utf16>> MIDL__ContextInfo20000)>()(
      ptr.ref.lpVtbl, MIDL__ContextInfo20000);

  int GetApplicationId(Pointer<Pointer<Utf16>> MIDL__ContextInfo20001) => ptr
          .ref.lpVtbl.value
          .elementAt(13)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<Utf16>> MIDL__ContextInfo20001)>()(
      ptr.ref.lpVtbl, MIDL__ContextInfo20001);
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(Pointer,
                          Pointer<Pointer<Utf16>> MIDL__ContextInfo20002)>()(
              ptr.ref.lpVtbl, MIDL__ContextInfo20002);
}
