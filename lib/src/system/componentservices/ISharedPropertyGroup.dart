...
class ISharedPropertyGroup extends IDispatch {
  ...
  int CreatePropertyByPosition(int Index, Pointer<Int16> fExists,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int Index, Pointer<Int16> fExists,
                      Pointer<Pointer<COMObject>> ppProp)>()(
          ptr.ref.lpVtbl, Index, fExists, ppProp);

  int get_PropertyByPosition(
          int Index, Pointer<Pointer<COMObject>> ppProperty) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, int Index,
                      Pointer<Pointer<COMObject>> ppProperty)>()(
          ptr.ref.lpVtbl, Index, ppProperty);

  int CreateProperty(Pointer<Utf16> Name, Pointer<Int16> fExists,
          Pointer<Pointer<COMObject>> ppProp) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Int16> fExists,
                      Pointer<Pointer<COMObject>> ppProp)>()(
          ptr.ref.lpVtbl, Name, fExists, ppProp);

  int get_Property(
          Pointer<Utf16> Name, Pointer<Pointer<COMObject>> ppProperty) =>
      ptr.ref.lpVtbl.value
              .elementAt(10)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> Name,
                      Pointer<Pointer<COMObject>> ppProperty)>()(
          ptr.ref.lpVtbl, Name, ppProperty);
}
