...
class IComObjectPool2Events extends IUnknown {
  ...
  int OnObjPoolPutObject2(Pointer<COMSVCSEVENTINFO> pInfo,
          Pointer<GUID> guidObject, int nReason, int dwAvailable, int oid) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int dwAvailable,
                      int oid)>()(
          ptr.ref.lpVtbl, pInfo, guidObject, nReason, dwAvailable, oid);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int dwAvailable,
                      int oid,
                      Pointer<GUID> guidPartition)>()(ptr.ref.lpVtbl, pInfo,
          guidActivity, guidObject, dwAvailable, oid, guidPartition);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> guidTx,
                      int objid)>()(
          ptr.ref.lpVtbl, pInfo, guidActivity, guidObject, guidTx, objid);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int objid,
                      Pointer<GUID> guidPartition)>()(ptr.ref.lpVtbl, pInfo,
          guidActivity, guidObject, guidTx, objid, guidPartition);
}
