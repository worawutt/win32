...
class IObjectContext extends IUnknown {
  ...
  int CreateInstance(
      ...
      ptr.ref.lpVtbl.value
          ...
          .value
          .asFunction<
              int Function(Pointer, Pointer<GUID> rclsid, Pointer<GUID> riid,
                  Pointer<Pointer> ppv)>()(ptr.ref.lpVtbl, rclsid, riid, ppv);
  ...
  int IsCallerInRole(Pointer<Utf16> bstrRole, Pointer<Int32> pfIsInRole) =>
      ptr.ref.lpVtbl.value
              .elementAt(10)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrRole,
                      Pointer<Int32> pfIsInRole)>()(
          ptr.ref.lpVtbl, bstrRole, pfIsInRole);
}
