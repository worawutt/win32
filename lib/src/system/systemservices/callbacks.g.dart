...
typedef APC_CALLBACK_FUNCTION = Void Function(
    Uint32 param0, Pointer param1, Pointer param2);
typedef PEXCEPTION_FILTER = Int32 Function(
    Pointer<EXCEPTION_POINTERS> ExceptionPointers, Pointer EstablisherFrame);
typedef PIMAGE_TLS_CALLBACK = Void Function(
    Pointer DllHandle, Uint32 Reason, Pointer Reserved);
