...
int GetNamedPipeServerProcessId(int Pipe, Pointer<Uint32> ServerProcessId) =>
    _GetNamedPipeServerProcessId(Pipe, ServerProcessId);
...
late final _GetNamedPipeServerProcessId = _kernel32.lookupFunction<
    ...
    int Function(int Pipe,
        Pointer<Uint32> ServerProcessId)>('GetNamedPipeServerProcessId');

int GetNamedPipeServerSessionId(int Pipe, Pointer<Uint32> ServerSessionId) =>
    _GetNamedPipeServerSessionId(Pipe, ServerSessionId);

late final _GetNamedPipeServerSessionId = _kernel32.lookupFunction<
    Int32 Function(IntPtr Pipe, Pointer<Uint32> ServerSessionId),
    int Function(int Pipe,
        Pointer<Uint32> ServerSessionId)>('GetNamedPipeServerSessionId');
...
int WaitNamedPipe(Pointer<Utf16> lpNamedPipeName, int nTimeOut) =>
    _WaitNamedPipe(lpNamedPipeName, nTimeOut);

late final _WaitNamedPipe = _kernel32.lookupFunction<
    Int32 Function(Pointer<Utf16> lpNamedPipeName, Uint32 nTimeOut),
    int Function(
        Pointer<Utf16> lpNamedPipeName, int nTimeOut)>('WaitNamedPipeW');
...
int ImpersonateNamedPipeClient(int hNamedPipe) =>
    _ImpersonateNamedPipeClient(hNamedPipe);

late final _ImpersonateNamedPipeClient = _advapi32.lookupFunction<
    Int32 Function(IntPtr hNamedPipe),
    int Function(int hNamedPipe)>('ImpersonateNamedPipeClient');
