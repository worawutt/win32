...
typedef CS_TYPE_TO_NETCS_ROUTINE = Void Function(
    ...
    Pointer<Uint32> pStatus);
typedef EXPR_EVAL = Void Function(Pointer<MIDL_STUB_MESSAGE> param0);
typedef GENERIC_BINDING_ROUTINE = Pointer Function(Pointer param0);
typedef GENERIC_UNBIND_ROUTINE = Void Function(
    Pointer param0, Pointer<Uint8> param1);
...
typedef I_RpcPerformCalloutFn = Int32 Function(
    Pointer Context, Pointer<RDR_CALLOUT_STATE> CallOutState, Int32 Stage);
typedef I_RpcProxyFilterIfFn = Int32 Function(Pointer Context,
    Pointer<GUID> IfUuid, Uint16 IfMajorVersion, Pointer<Int32> fAllow);
typedef I_RpcProxyGetClientAddressFn = Int32 Function(
    Pointer Context, Pointer<Utf8> Buffer, Pointer<Uint32> BufferLength);
...
typedef I_RpcProxyIsValidMachineFn = Int32 Function(
    Pointer<Uint16> Machine, Pointer<Uint16> DotMachine, Uint32 PortNumber);
typedef I_RpcProxyUpdatePerfCounterBackendServerFn = Void Function(
    Pointer<Uint16> MachineName, Int32 IsConnectEvent);
typedef I_RpcProxyUpdatePerfCounterFn = Void Function(
    Int32 Counter, Int32 ModifyTrend, Uint32 Size);
typedef MIDL_ES_ALLOC = Void Function(
    Pointer state, Pointer<Pointer<Int8>> pbuffer, Pointer<Uint32> psize);
typedef MIDL_ES_READ = Void Function(
    Pointer state, Pointer<Pointer<Int8>> pbuffer, Pointer<Uint32> psize);
typedef MIDL_ES_WRITE = Void Function(
    Pointer state, Pointer<Utf8> buffer, Uint32 size);
typedef NDR_NOTIFY2_ROUTINE = Void Function(Uint8 flag);
typedef NDR_NOTIFY_ROUTINE = Void Function();
typedef NDR_RUNDOWN = Void Function(Pointer context);
typedef PFN_RPCNOTIFICATION_ROUTINE = Void Function(
    Pointer<RPC_ASYNC_STATE> pAsync, Pointer Context, Int32 Event);
typedef PRPC_RUNDOWN = Void Function(Pointer AssociationContext);
typedef RPCLT_PDU_FILTER_FUNC = Void Function(
    Pointer Buffer, Uint32 BufferLength, Int32 fDatagram);
typedef RPC_ADDRESS_CHANGE_FN = Void Function(Pointer arg);
...
typedef RPC_BLOCKING_FN = Int32 Function(
    Pointer hWnd, Pointer Context, Pointer hSyncEvent);
typedef RPC_CLIENT_ALLOC = Pointer Function(IntPtr Size);
typedef RPC_CLIENT_FREE = Void Function(Pointer Ptr);
typedef RPC_DISPATCH_FUNCTION = Void Function(Pointer<RPC_MESSAGE> Message);
...
typedef RPC_HTTP_PROXY_FREE_STRING = Void Function(Pointer<Uint16> String_);
typedef RPC_IF_CALLBACK_FN = Int32 Function(
    Pointer InterfaceUuid, Pointer Context);
typedef RPC_INTERFACE_GROUP_IDLE_CALLBACK_FN = Void Function(
    Pointer IfGroup, Pointer IdleCallbackContext, Uint32 IsGroupIdle);
typedef RPC_MGMT_AUTHORIZATION_FN = Int32 Function(Pointer ClientBinding,
    Uint32 RequestedMgmtOperation, Pointer<Int32> Status);
...
typedef RPC_OBJECT_INQ_FN = Void Function(
    Pointer<GUID> ObjectUuid, Pointer<GUID> TypeUuid, Pointer<Int32> Status);
typedef RPC_SECURITY_CALLBACK_FN = Void Function(Pointer Context);
...
typedef STUB_THUNK = Void Function(Pointer<MIDL_STUB_MESSAGE> param0);
...
typedef USER_MARSHAL_MARSHALLING_ROUTINE = Pointer<Uint8> Function(
    Pointer<Uint32> param0, Pointer<Uint8> param1, Pointer param2);
typedef USER_MARSHAL_SIZING_ROUTINE = Uint32 Function(
    Pointer<Uint32> param0, Uint32 param1, Pointer param2);
typedef USER_MARSHAL_UNMARSHALLING_ROUTINE = Pointer<Uint8> Function(
    Pointer<Uint32> param0, Pointer<Uint8> param1, Pointer param2);
typedef XMIT_HELPER_ROUTINE = Void Function(Pointer<MIDL_STUB_MESSAGE> param0);
