...
class RPC_ASYNC_NOTIFICATION_INFO extends Union {
  ...
  external _RPC_ASYNC_NOTIFICATION_INFO__IntPtr_e__Struct IntPtr_;
...
extension RPC_ASYNC_NOTIFICATION_INFO_Extension_2
    on RPC_ASYNC_NOTIFICATION_INFO {
  int get hWnd => this.IntPtr_.hWnd;
  set hWnd(int value) => this.IntPtr_.hWnd = value;

  int get Msg => this.IntPtr_.Msg;
  set Msg(int value) => this.IntPtr_.Msg = value;
}
