...
typedef DEBUGEVENTPROC = Uint32 Function(
    Pointer<DEBUG_EVENT> param0, Pointer param1);
typedef PROCESSENUMPROC = Int32 Function(
    Uint32 dwProcessId, Uint32 dwAttributes, IntPtr lpUserDefined);
typedef TASKENUMPROC = Int32 Function(
    Uint32 dwThreadId, Uint16 hMod16, Uint16 hTask16, IntPtr lpUserDefined);
...
typedef VDMBREAKTHREADPROC = Int32 Function(IntPtr param0);
typedef VDMDETECTWOWPROC = Int32 Function();
typedef VDMENUMPROCESSWOWPROC = Int32 Function(
    Pointer<NativeFunction<PROCESSENUMPROC>> param0, IntPtr param1);
typedef VDMENUMTASKWOWEXPROC = Int32 Function(Uint32 param0,
    Pointer<NativeFunction<TASKENUMPROCEX>> param1, IntPtr param2);
typedef VDMENUMTASKWOWPROC = Int32 Function(
    Uint32 param0, Pointer<NativeFunction<TASKENUMPROC>> param1, IntPtr param2);
...
typedef VDMGETCONTEXTPROC = Int32 Function(
    IntPtr param0, IntPtr param1, Pointer<VDMCONTEXT> param2);
typedef VDMGETDBGFLAGSPROC = Uint32 Function(IntPtr param0);
typedef VDMGETMODULESELECTORPROC = Int32 Function(IntPtr param0, IntPtr param1,
    Uint32 param2, Pointer<Utf8> param3, Pointer<Uint16> param4);
typedef VDMGETPOINTERPROC = Uint32 Function(
    IntPtr param0, IntPtr param1, Uint16 param2, Uint32 param3, Int32 param4);
typedef VDMGETSEGMENTINFOPROC = Int32 Function(
    Uint16 param0, Uint32 param1, Int32 param2, VDM_SEGINFO param3);
...
typedef VDMGETTHREADSELECTORENTRYPROC = Int32 Function(
    IntPtr param0, IntPtr param1, Uint32 param2, Pointer<VDMLDT_ENTRY> param3);
...
typedef VDMGLOBALNEXTPROC = Int32 Function(
    ...
    Pointer<NativeFunction<DEBUGEVENTPROC>> param4,
    Pointer param5);
typedef VDMISMODULELOADEDPROC = Int32 Function(Pointer<Utf8> param0);
...
typedef VDMMODULENEXTPROC = Int32 Function(
    ...
    Pointer<NativeFunction<DEBUGEVENTPROC>> param3,
    Pointer param4);
typedef VDMPROCESSEXCEPTIONPROC = Int32 Function(Pointer<DEBUG_EVENT> param0);
typedef VDMSETCONTEXTPROC = Int32 Function(
    IntPtr param0, IntPtr param1, Pointer<VDMCONTEXT> param2);
typedef VDMSETDBGFLAGSPROC = Int32 Function(IntPtr param0, Uint32 param1);
typedef VDMSTARTTASKINWOWPROC = Int32 Function(
    Uint32 param0, Pointer<Utf8> param1, Uint16 param2);
typedef VDMTERMINATETASKINWOWPROC = Int32 Function(
    Uint32 param0, Uint16 param1);
