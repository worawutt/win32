...
int CreateJobSet(int NumJob, Pointer<JOB_SET_ARRAY> UserJobSet, int Flags) =>
    _CreateJobSet(NumJob, UserJobSet, Flags);

late final _CreateJobSet = _kernel32.lookupFunction<
    Int32 Function(
        Uint32 NumJob, Pointer<JOB_SET_ARRAY> UserJobSet, Uint32 Flags),
    int Function(int NumJob, Pointer<JOB_SET_ARRAY> UserJobSet,
        int Flags)>('CreateJobSet');
