...
class IProvideWinSATResultsInfo extends IDispatch {
  ...
  int GetAssessmentInfo(int assessment, Pointer<Pointer<COMObject>> ppinfo) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 assessment,
                              Pointer<Pointer<COMObject>> ppinfo)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int assessment,
                      Pointer<Pointer<COMObject>> ppinfo)>()(
          ptr.ref.lpVtbl, assessment, ppinfo);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<VARIANT> fileTime)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<VARIANT> fileTime)>()(ptr.ref.lpVtbl, retValuePtr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Float> level)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Float> level)>()(
          ptr.ref.lpVtbl, retValuePtr);
