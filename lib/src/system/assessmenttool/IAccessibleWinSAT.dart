...
class IAccessibleWinSAT extends IAccessible {
  ...
  int SetAccessiblityData(Pointer<Utf16> wsName, Pointer<Utf16> wsValue,
      ...
      ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> wsName,
                          Pointer<Utf16> wsValue, Pointer<Utf16> wsDesc)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer,
                  ...
                  Pointer<Utf16>
                      wsDesc)>()(ptr.ref.lpVtbl, wsName, wsValue, wsDesc);
}
