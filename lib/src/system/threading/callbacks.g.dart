...
typedef LPFIBER_START_ROUTINE = Void Function(Pointer lpFiberParameter);
typedef LPTHREAD_START_ROUTINE = Uint32 Function(Pointer lpThreadParameter);
typedef PFLS_CALLBACK_FUNCTION = Void Function(Pointer lpFlsData);
typedef PINIT_ONCE_FN = Int32 Function(Pointer<RTL_RUN_ONCE> InitOnce,
    Pointer Parameter, Pointer<Pointer> Context);
typedef PPS_POST_PROCESS_INIT_ROUTINE = Void Function();
typedef PRTL_UMS_SCHEDULER_ENTRY_POINT = Void Function(
    Int32 Reason, IntPtr ActivationPayload, Pointer SchedulerParam);
typedef PTIMERAPCROUTINE = Void Function(Pointer lpArgToCompletionRoutine,
    Uint32 dwTimerLowValue, Uint32 dwTimerHighValue);
typedef PTP_CLEANUP_GROUP_CANCEL_CALLBACK = Void Function(
    Pointer ObjectContext, Pointer CleanupContext);
typedef PTP_SIMPLE_CALLBACK = Void Function(
    Pointer<TP_CALLBACK_INSTANCE> Instance, Pointer Context);
...
typedef WAITORTIMERCALLBACK = Void Function(Pointer param0, Uint8 param1);
