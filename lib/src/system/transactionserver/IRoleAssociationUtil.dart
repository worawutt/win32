...
class IRoleAssociationUtil extends IDispatch {
  ...
  int AssociateRole(Pointer<Utf16> bstrRoleID) => ptr.ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> bstrRoleID)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Utf16> bstrRoleID)>()(
      ptr.ref.lpVtbl, bstrRoleID);

  int AssociateRoleByName(Pointer<Utf16> bstrRoleName) => ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .value
          .asFunction<int Function(Pointer, Pointer<Utf16> bstrRoleName)>()(
      ptr.ref.lpVtbl, bstrRoleName);
}
