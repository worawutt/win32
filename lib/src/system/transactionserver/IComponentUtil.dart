      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> bstrTypelibFile,
                      Pointer<Utf16> bstrProxyStubDLLFile)>()(
          ptr.ref.lpVtbl, bstrDLLFile, bstrTypelibFile, bstrProxyStubDLLFile);

  int ImportComponent(Pointer<Utf16> bstrCLSID) => ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
      ...
      ptr.ref.lpVtbl, bstrCLSID);

  int ImportComponentByName(Pointer<Utf16> bstrProgID) => ptr.ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .value
          .asFunction<int Function(Pointer, Pointer<Utf16> bstrProgID)>()(
      ptr.ref.lpVtbl, bstrProgID);

  int GetCLSIDs(Pointer<Utf16> bstrDLLFile, Pointer<Utf16> bstrTypelibFile,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> bstrTypelibFile,
                      Pointer<Pointer<SAFEARRAY>> aCLSIDs)>()(
          ptr.ref.lpVtbl, bstrDLLFile, bstrTypelibFile, aCLSIDs);
}
