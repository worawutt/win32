...
late final _ChangeServiceConfig = _advapi32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Utf16> lpServiceStartName,
        Pointer<Utf16> lpPassword,
        Pointer<Utf16> lpDisplayName)>('ChangeServiceConfigW');
...
late final _CreateService = _advapi32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Utf16> lpDependencies,
        Pointer<Utf16> lpServiceStartName,
        Pointer<Utf16> lpPassword)>('CreateServiceW');
...
Pointer LockServiceDatabase(int hSCManager) => _LockServiceDatabase(hSCManager);

late final _LockServiceDatabase = _advapi32.lookupFunction<
    Pointer Function(IntPtr hSCManager),
    Pointer Function(int hSCManager)>('LockServiceDatabase');
...
late final _QueryServiceLockStatus = _advapi32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<QUERY_SERVICE_LOCK_STATUS> lpLockStatus,
        int cbBufSize,
        Pointer<Uint32> pcbBytesNeeded)>('QueryServiceLockStatusW');
...
int SetServiceBits(int hServiceStatus, int dwServiceBits, int bSetBitsOn,
...
late final _SetServiceBits = _advapi32.lookupFunction<
    Int32 Function(IntPtr hServiceStatus, Uint32 dwServiceBits,
        Int32 bSetBitsOn, Int32 bUpdateImmediately),
    int Function(int hServiceStatus, int dwServiceBits, int bSetBitsOn,
        int bUpdateImmediately)>('SetServiceBits');
...
int UnlockServiceDatabase(Pointer ScLock) => _UnlockServiceDatabase(ScLock);

late final _UnlockServiceDatabase = _advapi32.lookupFunction<
    Int32 Function(Pointer ScLock),
    int Function(Pointer ScLock)>('UnlockServiceDatabase');

int WaitServiceState(
        int hService, int dwNotify, int dwTimeout, int hCancelEvent) =>
    _WaitServiceState(hService, dwNotify, dwTimeout, hCancelEvent);

late final _WaitServiceState = _advapi32.lookupFunction<
    Uint32 Function(IntPtr hService, Uint32 dwNotify, Uint32 dwTimeout,
        IntPtr hCancelEvent),
    int Function(int hService, int dwNotify, int dwTimeout,
        int hCancelEvent)>('WaitServiceState');
