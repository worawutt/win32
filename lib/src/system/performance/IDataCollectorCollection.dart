...
class IDataCollectorCollection extends IDispatch {
  ...
  int get_Item(VARIANT index, Pointer<Pointer<COMObject>> collector) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, VARIANT index,
                      Pointer<Pointer<COMObject>> collector)>()(
          ptr.ref.lpVtbl, index, collector);
  ...
  int Add(Pointer<COMObject> collector) => ptr.ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> collector)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> collector)>()(
      ptr.ref.lpVtbl, collector);

  int Remove(VARIANT collector) => ptr.ref.lpVtbl.value
      .elementAt(11)
      .cast<
          Pointer<NativeFunction<Int32 Function(Pointer, VARIANT collector)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, VARIANT collector)>()(ptr.ref.lpVtbl, collector);
  ...
  int AddRange(Pointer<COMObject> collectors) => ptr.ref.lpVtbl.value
      .elementAt(13)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> collectors)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<COMObject> collectors)>()(ptr.ref.lpVtbl, collectors);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> pValidation,
                      Pointer<Pointer<COMObject>> pCollector)>()(
          ptr.ref.lpVtbl, bstrXml, pValidation, pCollector);

  int CreateDataCollector(int Type, Pointer<Pointer<COMObject>> Collector) =>
      ptr.ref.lpVtbl.value
              .elementAt(15)
              .cast<
                  Pointer<
