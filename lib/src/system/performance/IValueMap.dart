...
class IValueMap extends IDispatch {
  ...
  int get_Item(VARIANT index, Pointer<Pointer<COMObject>> value) => ptr
          .ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, VARIANT index, Pointer<Pointer<COMObject>> value)>()(
  ...
  int Add(VARIANT value) => ptr.ref.lpVtbl.value
      .elementAt(16)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, VARIANT value)>>>()
      .value
      .asFunction<
  ...
  int Remove(VARIANT value) => ptr.ref.lpVtbl.value
      .elementAt(17)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, VARIANT value)>>>()
      .value
      .asFunction<
  ...
  int AddRange(Pointer<COMObject> map) => ptr.ref.lpVtbl.value
          .elementAt(19)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> map)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> map)>()(
      ptr.ref.lpVtbl, map);

  int CreateValueMapItem(Pointer<Pointer<COMObject>> Item) => ptr
      .ref.lpVtbl.value
      .elementAt(20)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Pointer<COMObject>> Item)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<Pointer<COMObject>> Item)>()(ptr.ref.lpVtbl, Item);
}
