...
class IGPMRSOP extends IDispatch {
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<Utf16>> bstrVal)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<Utf16>> bstrVal)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set LoggingComputer(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(Pointer, Pointer<Utf16> bstrVal)>>>()
            .value
            .asFunction<int Function(Pointer, Pointer<Utf16> bstrVal)>()(
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> lVal)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> lVal)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  set PlanningUserWMIFilters(VARIANT value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(25)
        .cast<
            Pointer<NativeFunction<Int32 Function(Pointer, VARIANT varVal)>>>()
        .value
        .asFunction<
            int Function(Pointer, VARIANT varVal)>()(ptr.ref.lpVtbl, value);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<VARIANT> varVal)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<VARIANT> varVal)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  int LoggingEnumerateUsers(Pointer<VARIANT> varVal) => ptr.ref.lpVtbl.value
          .elementAt(37)
          .cast<
              Pointer<
                  NativeFunction<
