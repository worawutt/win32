...
class IGPMDomain extends IDispatch {
  ...
  int CreateGPO(Pointer<Pointer<COMObject>> ppNewGPO) => ptr.ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> ppNewGPO)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> ppNewGPO)>()(
      ptr.ref.lpVtbl, ppNewGPO);

  int GetGPO(Pointer<Utf16> bstrGuid, Pointer<Pointer<COMObject>> ppGPO) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrGuid,
                      Pointer<Pointer<COMObject>> ppGPO)>()(
          ptr.ref.lpVtbl, bstrGuid, ppGPO);

  int
      SearchGPOs(Pointer<COMObject> pIGPMSearchCriteria,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(
                          ...
                          Pointer<COMObject> pIGPMSearchCriteria,
                          Pointer<Pointer<COMObject>> ppIGPMGPOCollection)>()(
              ptr.ref.lpVtbl, pIGPMSearchCriteria, ppIGPMGPOCollection);
  ...
  int GetSOM(Pointer<Utf16> bstrPath, Pointer<Pointer<COMObject>> ppSOM) =>
      ptr.ref.lpVtbl.value
              .elementAt(13)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrPath,
                      Pointer<Pointer<COMObject>> ppSOM)>()(
          ptr.ref.lpVtbl, bstrPath, ppSOM);

  int
      SearchSOMs(Pointer<COMObject> pIGPMSearchCriteria,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(
                          ...
                          Pointer<COMObject> pIGPMSearchCriteria,
                          Pointer<Pointer<COMObject>> ppIGPMSOMCollection)>()(
              ptr.ref.lpVtbl, pIGPMSearchCriteria, ppIGPMSOMCollection);

  int GetWMIFilter(
          Pointer<Utf16> bstrPath, Pointer<Pointer<COMObject>> ppWMIFilter) =>
      ptr.ref.lpVtbl.value
              .elementAt(15)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrPath,
                      Pointer<Pointer<COMObject>> ppWMIFilter)>()(
          ptr.ref.lpVtbl, bstrPath, ppWMIFilter);

  int SearchWMIFilters(Pointer<COMObject> pIGPMSearchCriteria,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pIGPMSearchCriteria,
                      Pointer<Pointer<COMObject>> ppIGPMWMIFilterCollection)>()(
          ptr.ref.lpVtbl, pIGPMSearchCriteria, ppIGPMWMIFilterCollection);
}
