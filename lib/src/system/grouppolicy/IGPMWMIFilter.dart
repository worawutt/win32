...
class IGPMWMIFilter extends IDispatch {
  ...
  int GetQueryList(Pointer<VARIANT> pQryList) => ptr.ref.lpVtbl.value
          .elementAt(12)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<VARIANT> pQryList)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<VARIANT> pQryList)>()(
      ptr.ref.lpVtbl, pQryList);
