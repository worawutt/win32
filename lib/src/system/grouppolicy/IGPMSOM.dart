...
class IGPMSOM extends IDispatch {
  ...
  int CreateGPOLink(int lLinkPos, Pointer<COMObject> pGPO,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int lLinkPos, Pointer<COMObject> pGPO,
                      Pointer<Pointer<COMObject>> ppNewGPOLink)>()(
          ptr.ref.lpVtbl, lLinkPos, pGPO, ppNewGPOLink);
  ...
  int GetGPOLinks(Pointer<Pointer<COMObject>> ppGPOLinks) => ptr
          .ref.lpVtbl.value
          .elementAt(13)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> ppGPOLinks)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> ppGPOLinks)>()(
      ptr.ref.lpVtbl, ppGPOLinks);

  int GetInheritedGPOLinks(Pointer<Pointer<COMObject>> ppGPOLinks) => ptr
          .ref.lpVtbl.value
          .elementAt(14)
          .cast<
              Pointer<
