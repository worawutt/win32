...
class IGPMBackupDirEx extends IDispatch {
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Int32> pgpmBackupType)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> pgpmBackupType)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  int GetBackup(Pointer<Utf16> bstrID, Pointer<VARIANT> pvarBackup) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> bstrID,
                              Pointer<VARIANT> pvarBackup)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrID,
                      Pointer<VARIANT> pvarBackup)>()(
          ptr.ref.lpVtbl, bstrID, pvarBackup);

  int SearchBackups(Pointer<COMObject> pIGPMSearchCriteria,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pIGPMSearchCriteria,
                      Pointer<VARIANT> pvarBackupCollection)>()(
          ptr.ref.lpVtbl, pIGPMSearchCriteria, pvarBackupCollection);
}
