...
class IGPMSitesContainer extends IDispatch {
  ...
  int GetSite(Pointer<Utf16> bstrSiteName, Pointer<Pointer<COMObject>> ppSOM) =>
      ptr.ref.lpVtbl.value
              .elementAt(10)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> bstrSiteName,
                              Pointer<Pointer<COMObject>> ppSOM)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrSiteName,
                      Pointer<Pointer<COMObject>> ppSOM)>()(
          ptr.ref.lpVtbl, bstrSiteName, ppSOM);

  int
      SearchSites(Pointer<COMObject> pIGPMSearchCriteria,
