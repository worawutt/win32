...
class IGPM2 extends IGPM {
  ...
  int
      GetBackupDirEx(Pointer<Utf16> bstrBackupDir, int backupDirType,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(
                          ...
                          int backupDirType,
                          Pointer<Pointer<COMObject>> ppIGPMBackupDirEx)>()(
              ptr.ref.lpVtbl, bstrBackupDir, backupDirType, ppIGPMBackupDirEx);

  int InitializeReportingEx(Pointer<Utf16> bstrAdmPath, int reportingOptions) =>
      ptr.ref.lpVtbl.value
              .elementAt(20)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrAdmPath,
                      int reportingOptions)>()(
          ptr.ref.lpVtbl, bstrAdmPath, reportingOptions);
}
