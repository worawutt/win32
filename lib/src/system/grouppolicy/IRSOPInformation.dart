...
class IRSOPInformation extends IUnknown {
  ...
  int GetNamespace(int dwSection, Pointer<Utf16> pszName, int cchMaxLength) =>
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint32 dwSection,
                              Pointer<Utf16> pszName, Int32 cchMaxLength)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int dwSection, Pointer<Utf16> pszName,
                      int cchMaxLength)>()(
          ptr.ref.lpVtbl, dwSection, pszName, cchMaxLength);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> pszEventTime,
                      int dwEventID,
                      Pointer<Pointer<Utf16>> ppszText)>()(ptr.ref.lpVtbl,
          pszEventSource, pszEventLogName, pszEventTime, dwEventID, ppszText);
}
