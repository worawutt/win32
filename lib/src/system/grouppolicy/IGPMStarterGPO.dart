    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Double> pVal)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Double> pVal)>()(
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Uint16> pVal)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Uint16> pVal)>()(
          ptr.ref.lpVtbl, retValuePtr);
