...
class IGPMDomain2 extends IGPMDomain {
  ...
  int CreateStarterGPO(Pointer<Pointer<COMObject>> ppnewTemplate) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppnewTemplate)>()(
          ptr.ref.lpVtbl, ppnewTemplate);

  int CreateGPOFromStarterGPO(Pointer<COMObject> pGPOTemplate,
      ...
      ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pGPOTemplate,
                          Pointer<Pointer<COMObject>> ppnewGPO)>>>()
          .value
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<COMObject>>
                      ppnewGPO)>()(ptr.ref.lpVtbl, pGPOTemplate, ppnewGPO);

  int GetStarterGPO(
          Pointer<Utf16> bstrGuid, Pointer<Pointer<COMObject>> ppTemplate) =>
      ptr.ref.lpVtbl.value
              .elementAt(19)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrGuid,
                      Pointer<Pointer<COMObject>> ppTemplate)>()(
          ptr.ref.lpVtbl, bstrGuid, ppTemplate);

  int SearchStarterGPOs(Pointer<COMObject> pIGPMSearchCriteria,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pIGPMSearchCriteria,
                      Pointer<Pointer<COMObject>> ppIGPMTemplateCollection)>()(
          ptr.ref.lpVtbl, pIGPMSearchCriteria, ppIGPMTemplateCollection);
