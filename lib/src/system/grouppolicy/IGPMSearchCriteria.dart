...
class IGPMSearchCriteria extends IDispatch {
  ...
  int Add(int searchProperty, int searchOperation, VARIANT varValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 searchProperty,
                              Int32 searchOperation, VARIANT varValue)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int searchProperty, int searchOperation,
                      VARIANT varValue)>()(
          ptr.ref.lpVtbl, searchProperty, searchOperation, varValue);
}
