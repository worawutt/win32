  ...
  Pointer<Utf16> get BackupDir {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> pbstrBackupDir)>()(
  ...
  Pointer<Utf16> get Comment {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> pbstrComment)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  Pointer<Utf16> get Domain {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> pbstrTemplateDomain)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  Pointer<Utf16> get StarterGPOID {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> pbstrTemplateID)>()(
          ptr.ref.lpVtbl, retValuePtr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Double> pTimestamp)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Double> pTimestamp)>()(ptr.ref.lpVtbl, retValuePtr);
