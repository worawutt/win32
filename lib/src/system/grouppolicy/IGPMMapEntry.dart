      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Int32> pgpmDestOption)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> pgpmDestOption)>()(
          ptr.ref.lpVtbl, retValuePtr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> pgpmEntryType)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int32> pgpmEntryType)>()(ptr.ref.lpVtbl, retValuePtr);
