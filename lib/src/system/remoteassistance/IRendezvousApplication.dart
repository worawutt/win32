...
class IRendezvousApplication extends IUnknown {
  ...
  int SetRendezvousSession(Pointer<COMObject> pRendezvousSession) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<COMObject> pRendezvousSession)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> pRendezvousSession)>()(
      ptr.ref.lpVtbl, pRendezvousSession);
}
