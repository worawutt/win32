...
late final _EnumResourceLanguagesEx = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        int lParam,
        int dwFlags,
        int LangId)>('EnumResourceLanguagesExW');
...
int EnumResourceLanguages(
        ...
        Pointer<NativeFunction<ENUMRESLANGPROCW>> lpEnumFunc,
        int lParam) =>
    _EnumResourceLanguages(hModule, lpType, lpName, lpEnumFunc, lParam);

late final _EnumResourceLanguages = _kernel32.lookupFunction<
    Int32 Function(IntPtr hModule, Pointer<Utf16> lpType, Pointer<Utf16> lpName,
        Pointer<NativeFunction<ENUMRESLANGPROCW>> lpEnumFunc, IntPtr lParam),
    int Function(
        int hModule,
        Pointer<Utf16> lpType,
        Pointer<Utf16> lpName,
        Pointer<NativeFunction<ENUMRESLANGPROCW>> lpEnumFunc,
        int lParam)>('EnumResourceLanguagesW');
...
int EnumResourceNamesEx(
        ...
        int dwFlags,
        int LangId) =>
    _EnumResourceNamesEx(hModule, lpType, lpEnumFunc, lParam, dwFlags, LangId);
...
late final _EnumResourceNamesEx = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        int lParam,
        int dwFlags,
        int LangId)>('EnumResourceNamesExW');

int EnumResourceNames(int hModule, Pointer<Utf16> lpType,
        Pointer<NativeFunction<ENUMRESNAMEPROCW>> lpEnumFunc, int lParam) =>
...
late final _EnumResourceNames = _kernel32.lookupFunction<
    Int32 Function(IntPtr hModule, Pointer<Utf16> lpType,
        Pointer<NativeFunction<ENUMRESNAMEPROCW>> lpEnumFunc, IntPtr lParam),
    int Function(
        int hModule,
        Pointer<Utf16> lpType,
        Pointer<NativeFunction<ENUMRESNAMEPROCW>> lpEnumFunc,
...
int EnumResourceTypesEx(
        ...
        int dwFlags,
        int LangId) =>
    _EnumResourceTypesEx(hModule, lpEnumFunc, lParam, dwFlags, LangId);
...
late final _EnumResourceTypesEx = _kernel32.lookupFunction<
    ...
    int Function(
        ...
        int lParam,
        int dwFlags,
        int LangId)>('EnumResourceTypesExW');

int EnumResourceTypes(int hModule,
        Pointer<NativeFunction<ENUMRESTYPEPROCW>> lpEnumFunc, int lParam) =>
...
late final _EnumResourceTypes = _kernel32.lookupFunction<
    Int32 Function(IntPtr hModule,
        Pointer<NativeFunction<ENUMRESTYPEPROCW>> lpEnumFunc, IntPtr lParam),
    int Function(
        int hModule,
        Pointer<NativeFunction<ENUMRESTYPEPROCW>> lpEnumFunc,
...
int FreeResource(int hResData) => _FreeResource(hResData);

late final _FreeResource = _kernel32.lookupFunction<
    Int32 Function(IntPtr hResData),
    int Function(int hResData)>('FreeResource');
...
int LoadModule(Pointer<Utf8> lpModuleName, Pointer lpParameterBlock) =>
    _LoadModule(lpModuleName, lpParameterBlock);

late final _LoadModule = _kernel32.lookupFunction<
    Uint32 Function(Pointer<Utf8> lpModuleName, Pointer lpParameterBlock),
    int Function(
        Pointer<Utf8> lpModuleName, Pointer lpParameterBlock)>('LoadModule');

int LoadPackagedLibrary(Pointer<Utf16> lpwLibFileName, int Reserved) =>
    _LoadPackagedLibrary(lpwLibFileName, Reserved);

late final _LoadPackagedLibrary = _kernel32.lookupFunction<
    IntPtr Function(Pointer<Utf16> lpwLibFileName, Uint32 Reserved),
    int Function(
        Pointer<Utf16> lpwLibFileName, int Reserved)>('LoadPackagedLibrary');
...
int SetDllDirectory(Pointer<Utf16> lpPathName) => _SetDllDirectory(lpPathName);
