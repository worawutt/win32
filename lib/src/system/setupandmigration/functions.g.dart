...
int OOBEComplete(Pointer<Int32> isOOBEComplete) =>
    _OOBEComplete(isOOBEComplete);

late final _OOBEComplete = _kernel32.lookupFunction<
    Int32 Function(Pointer<Int32> isOOBEComplete),
    int Function(Pointer<Int32> isOOBEComplete)>('OOBEComplete');
...
late final _RegisterWaitUntilOOBECompleted = _kernel32.lookupFunction<
    ...
    int Function(
        Pointer<NativeFunction<OOBE_COMPLETED_CALLBACK>> OOBECompletedCallback,
        Pointer CallbackContext,
        Pointer<Pointer> WaitHandle)>('RegisterWaitUntilOOBECompleted');

int UnregisterWaitUntilOOBECompleted(Pointer WaitHandle) =>
    _UnregisterWaitUntilOOBECompleted(WaitHandle);

late final _UnregisterWaitUntilOOBECompleted = _kernel32.lookupFunction<
    Int32 Function(Pointer WaitHandle),
    int Function(Pointer WaitHandle)>('UnregisterWaitUntilOOBECompleted');
