...
class IMAPIContainer extends IMAPIProp {
  ...
  int GetContentsTable(int ulFlags, Pointer<Pointer<COMObject>> lppTable) =>
  ...
  int GetHierarchyTable(int ulFlags, Pointer<Pointer<COMObject>> lppTable) =>
      ptr.ref.lpVtbl.value
              .elementAt(15)
              .cast<
                  Pointer<
  ...
  int SetSearchCriteria(Pointer<SRestriction> lpRestriction,
          Pointer<SBinaryArray> lpContainerList, int ulSearchFlags) =>
      ptr.ref.lpVtbl.value
              .elementAt(17)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<SBinaryArray> lpContainerList,
                      int ulSearchFlags)>()(
          ptr.ref.lpVtbl, lpRestriction, lpContainerList, ulSearchFlags);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<SRestriction>> lppRestriction,
                      Pointer<Pointer<SBinaryArray>> lppContainerList,
                      Pointer<Uint32> lpulSearchState)>()(ptr.ref.lpVtbl,
          ulFlags, lppRestriction, lppContainerList, lpulSearchState);
}
