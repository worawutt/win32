...
typedef CALLERRELEASE = Void Function(Uint32 ulCallerData,
    Pointer<COMObject> lpTblData, Pointer<COMObject> lpVue);
typedef FNIDLE = Int32 Function(Pointer param0);
typedef IWABOBJECT_AddRef_METHOD = Uint32 Function();
typedef IWABOBJECT_AllocateBuffer_METHOD = Int32 Function(
    Uint32 cbSize, Pointer<Pointer> lppBuffer);
typedef IWABOBJECT_AllocateMore_METHOD = Int32 Function(
    Uint32 cbSize, Pointer lpObject, Pointer<Pointer> lppBuffer);
typedef IWABOBJECT_Backup_METHOD = Int32 Function(Pointer<Utf8> lpFileName);
typedef IWABOBJECT_Find_METHOD = Int32 Function(
    Pointer<COMObject> lpIAB, IntPtr hWnd);
typedef IWABOBJECT_FreeBuffer_METHOD = Int32 Function(Pointer lpBuffer);
typedef IWABOBJECT_GetLastError_METHOD = Int32 Function(
    Int32 hResult, Uint32 ulFlags, Pointer<Pointer<MAPIERROR>> lppMAPIError);
typedef IWABOBJECT_GetMe_METHOD = Int32 Function(
    ...
    IntPtr hwnd);
typedef IWABOBJECT_Import_METHOD = Int32 Function(Pointer<Utf8> lpWIP);
...
typedef IWABOBJECT_SetMe_METHOD = Int32 Function(
    Pointer<COMObject> lpIAB, Uint32 ulFlags, SBinary sbEID, IntPtr hwnd);
typedef IWABOBJECT_VCardCreate_METHOD = Int32 Function(Pointer<COMObject> lpIAB,
    Uint32 ulFlags, Pointer<Utf8> lpszVCard, Pointer<COMObject> lpMailUser);
typedef IWABOBJECT_VCardDisplay_METHOD = Int32 Function(
    Pointer<COMObject> lpIAB, IntPtr hWnd, Pointer<Utf8> lpszFileName);
...
typedef LPDISPATCHNOTIFICATIONS = Int32 Function(Uint32 ulFlags);
typedef LPFNABSDI = Int32 Function(IntPtr ulUIParam, Pointer lpvmsg);
typedef LPFNBUTTON = Int32 Function(IntPtr ulUIParam, Pointer lpvContext,
    Uint32 cbEntryID, Pointer<ENTRYID> lpSelection, Uint32 ulFlags);
typedef LPFNDISMISS = Void Function(IntPtr ulUIParam, Pointer lpvContext);
typedef LPFREEBUFFER = Uint32 Function(Pointer lpBuffer);
typedef LPNOTIFCALLBACK = Int32 Function(Pointer lpvContext,
    Uint32 cNotification, Pointer<NOTIFICATION> lpNotifications);
...
typedef LPWABALLOCATEBUFFER = Int32 Function(
    Pointer<COMObject> lpWABObject, Uint32 cbSize, Pointer<Pointer> lppBuffer);
typedef LPWABALLOCATEMORE = Int32 Function(Pointer<COMObject> lpWABObject,
    Uint32 cbSize, Pointer lpObject, Pointer<Pointer> lppBuffer);
typedef LPWABFREEBUFFER = Uint32 Function(
    Pointer<COMObject> lpWABObject, Pointer lpBuffer);
