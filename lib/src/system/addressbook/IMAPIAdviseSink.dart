...
class IMAPIAdviseSink extends IUnknown {
  ...
  int OnNotify(int cNotif, Pointer<NOTIFICATION> lpNotifications) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Uint32 Function(Pointer, Uint32 cNotif,
                              Pointer<NOTIFICATION> lpNotifications)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int cNotif,
                      Pointer<NOTIFICATION> lpNotifications)>()(
          ptr.ref.lpVtbl, cNotif, lpNotifications);
}
