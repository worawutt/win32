...
class IXblIdpAuthTokenResult2 extends IUnknown {
  ...
  int GetModernGamertag(Pointer<Pointer<Utf16>> value) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
      ...
      .asFunction<
          int Function(
              Pointer, Pointer<Pointer<Utf16>> value)>()(ptr.ref.lpVtbl, value);

  int GetModernGamertagSuffix(Pointer<Pointer<Utf16>> value) => ptr
      .ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
  ...
  int GetUniqueModernGamertag(Pointer<Pointer<Utf16>> value) => ptr
      .ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
