...
class IGameExplorer extends IUnknown {
  ...
  int RemoveGame(GUID guidInstanceID) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, GUID guidInstanceID)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, GUID guidInstanceID)>()(ptr.ref.lpVtbl, guidInstanceID);

  int UpdateGame(GUID guidInstanceID) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, GUID guidInstanceID)>>>()
  ...
  int
      VerifyAccess(
              Pointer<Utf16> bstrGDFBinaryPath, Pointer<Int32> pfHasAccess) =>
          ptr.ref.lpVtbl.value
                  .elementAt(6)
                  .cast<
                      Pointer<
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<Utf16> bstrGDFBinaryPath,
                          Pointer<Int32> pfHasAccess)>()(
              ptr.ref.lpVtbl, bstrGDFBinaryPath, pfHasAccess);
}
