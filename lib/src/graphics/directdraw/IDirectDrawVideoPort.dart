...
class IDirectDrawVideoPort extends IUnknown {
  ...
  int GetColorControls(Pointer<DDCOLORCONTROL> param0) => ptr.ref.lpVtbl.value
      ...
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<DDCOLORCONTROL> param0)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<DDCOLORCONTROL> param0)>()(ptr.ref.lpVtbl, param0);
  ...
  int GetInputFormats(Pointer<Uint32> lpNumFormats,
      ...
      ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Uint32> lpNumFormats,
                          Pointer<DDPIXELFORMAT> param1, Uint32 param2)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer,
                  ...
                  int param2)>()(ptr.ref.lpVtbl, lpNumFormats, param1, param2);
  ...
  int SetTargetSurface(Pointer<COMObject> param0, int param1) => ptr
      .ref.lpVtbl.value
      .elementAt(12)
      .cast<
          Pointer<
  ...
  int StartVideo(Pointer<DDVIDEOPORTINFO> param0) => ptr.ref.lpVtbl.value
      ...
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<DDVIDEOPORTINFO> param0)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<DDVIDEOPORTINFO> param0)>()(ptr.ref.lpVtbl, param0);
