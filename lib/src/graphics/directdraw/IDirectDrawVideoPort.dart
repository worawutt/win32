...
typedef _GetInputFormats_Native = Int32 Function(
  Pointer,
  Pointer<Uint32> lpNumFormats, 
  Pointer<DDPIXELFORMAT> param1, 
  Uint32 param2
);
typedef _GetInputFormats_Dart = int Function(
  Pointer,
  Pointer<Uint32> lpNumFormats, 
  Pointer<DDPIXELFORMAT> param1, 
  int param2
...
typedef _GetVideoLine_Dart = int Function(
  Pointer,
  Pointer<Uint32> param0
);
...
typedef _StopVideo_Native = Int32 Function(
  Pointer);
typedef _StopVideo_Dart = int Function(
  Pointer);
...
class IDirectDrawVideoPort extends IUnknown {
  ...
  int Flip(COMObject param0, int param1) => ptr.ref.lpVtbl.value      .elementAt(3)
      .cast<Pointer<NativeFunction<_Flip_Native>>>()
      .value
      .asFunction<_Flip_Dart>()(ptr.ref.lpVtbl, param0, param1);

  int GetBandwidthInfo(Pointer<DDPIXELFORMAT> param0, int param1, int param2, int param3, Pointer<DDVIDEOPORTBANDWIDTH> param4) => ptr.ref.lpVtbl.value      .elementAt(4)
      .cast<Pointer<NativeFunction<_GetBandwidthInfo_Native>>>()
      .value
      .asFunction<_GetBandwidthInfo_Dart>()(ptr.ref.lpVtbl, param0, param1, param2, param3, param4);

  int GetColorControls(Pointer<DDCOLORCONTROL> param0) => ptr.ref.lpVtbl.value      .elementAt(5)
      .cast<Pointer<NativeFunction<_GetColorControls_Native>>>()
      .value
      .asFunction<_GetColorControls_Dart>()(ptr.ref.lpVtbl, param0);

  int GetInputFormats(Pointer<Uint32> lpNumFormats, Pointer<DDPIXELFORMAT> param1, int param2) => ptr.ref.lpVtbl.value      .elementAt(6)
      .cast<Pointer<NativeFunction<_GetInputFormats_Native>>>()
      .value
      .asFunction<_GetInputFormats_Dart>()(ptr.ref.lpVtbl, lpNumFormats, param1, param2);

  int GetOutputFormats(Pointer<DDPIXELFORMAT> param0, Pointer<Uint32> lpNumFormats, Pointer<DDPIXELFORMAT> param2, int param3) => ptr.ref.lpVtbl.value      .elementAt(7)
      .cast<Pointer<NativeFunction<_GetOutputFormats_Native>>>()
      .value
      .asFunction<_GetOutputFormats_Dart>()(ptr.ref.lpVtbl, param0, lpNumFormats, param2, param3);

  int GetFieldPolarity(Pointer<Int32> param0) => ptr.ref.lpVtbl.value      .elementAt(8)
      .cast<Pointer<NativeFunction<_GetFieldPolarity_Native>>>()
      .value
      .asFunction<_GetFieldPolarity_Dart>()(ptr.ref.lpVtbl, param0);

  int GetVideoLine(Pointer<Uint32> param0) => ptr.ref.lpVtbl.value      .elementAt(9)
      .cast<Pointer<NativeFunction<_GetVideoLine_Native>>>()
      .value
      .asFunction<_GetVideoLine_Dart>()(ptr.ref.lpVtbl, param0);

  int GetVideoSignalStatus(Pointer<Uint32> param0) => ptr.ref.lpVtbl.value      .elementAt(10)
      .cast<Pointer<NativeFunction<_GetVideoSignalStatus_Native>>>()
      .value
      .asFunction<_GetVideoSignalStatus_Dart>()(ptr.ref.lpVtbl, param0);

  int SetColorControls(Pointer<DDCOLORCONTROL> param0) => ptr.ref.lpVtbl.value      .elementAt(11)
      .cast<Pointer<NativeFunction<_SetColorControls_Native>>>()
      .value
      .asFunction<_SetColorControls_Dart>()(ptr.ref.lpVtbl, param0);

  int SetTargetSurface(COMObject param0, int param1) => ptr.ref.lpVtbl.value      .elementAt(12)
      .cast<Pointer<NativeFunction<_SetTargetSurface_Native>>>()
      .value
      .asFunction<_SetTargetSurface_Dart>()(ptr.ref.lpVtbl, param0, param1);

  int StartVideo(Pointer<DDVIDEOPORTINFO> param0) => ptr.ref.lpVtbl.value      .elementAt(13)
      .cast<Pointer<NativeFunction<_StartVideo_Native>>>()
      .value
      .asFunction<_StartVideo_Dart>()(ptr.ref.lpVtbl, param0);

  int StopVideo() => ptr.ref.lpVtbl.value      .elementAt(14)
      .cast<Pointer<NativeFunction<_StopVideo_Native>>>()
      .value
      .asFunction<_StopVideo_Dart>()(ptr.ref.lpVtbl);

  int UpdateVideo(Pointer<DDVIDEOPORTINFO> param0) => ptr.ref.lpVtbl.value      .elementAt(15)
      .cast<Pointer<NativeFunction<_UpdateVideo_Native>>>()
      .value
      .asFunction<_UpdateVideo_Dart>()(ptr.ref.lpVtbl, param0);

  int WaitForSync(int param0, int param1, int param2) => ptr.ref.lpVtbl.value      .elementAt(16)
