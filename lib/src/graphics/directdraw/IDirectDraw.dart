...
class IDirectDraw extends IUnknown {
  ...
  int SetDisplayMode(int param0, int param1, int param2) => ptr.ref.lpVtbl.value      .elementAt(21)
      .cast<Pointer<NativeFunction<_SetDisplayMode_Native>>>()
      .value
      .asFunction<_SetDisplayMode_Dart>()(ptr.ref.lpVtbl, param0, param1, param2);
