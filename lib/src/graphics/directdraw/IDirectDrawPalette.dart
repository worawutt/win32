...
typedef _GetEntries_Native = Int32 Function(
  Pointer,
  Uint32 param0, 
  Uint32 param1, 
  Uint32 param2, 
...
typedef _GetEntries_Dart = int Function(
  Pointer,
  int param0, 
  int param1, 
  int param2, 
...
typedef _SetEntries_Native = Int32 Function(
  Pointer,
  Uint32 param0, 
  Uint32 param1, 
  Uint32 param2, 
...
typedef _SetEntries_Dart = int Function(
  Pointer,
  int param0, 
  int param1, 
  int param2, 
...
class IDirectDrawPalette extends IUnknown {
  ...
  int GetCaps(Pointer<Uint32> param0) => ptr.ref.lpVtbl.value      .elementAt(3)
      .cast<Pointer<NativeFunction<_GetCaps_Native>>>()
      .value
      .asFunction<_GetCaps_Dart>()(ptr.ref.lpVtbl, param0);

  int GetEntries(int param0, int param1, int param2, Pointer<PALETTEENTRY> param3) => ptr.ref.lpVtbl.value      .elementAt(4)
      .cast<Pointer<NativeFunction<_GetEntries_Native>>>()
      .value
      .asFunction<_GetEntries_Dart>()(ptr.ref.lpVtbl, param0, param1, param2, param3);

  int Initialize(COMObject param0, int param1, Pointer<PALETTEENTRY> param2) => ptr.ref.lpVtbl.value      .elementAt(5)
      .cast<Pointer<NativeFunction<_Initialize_Native>>>()
      .value
      .asFunction<_Initialize_Dart>()(ptr.ref.lpVtbl, param0, param1, param2);

  int SetEntries(int param0, int param1, int param2, Pointer<PALETTEENTRY> param3) => ptr.ref.lpVtbl.value      .elementAt(6)
      .cast<Pointer<NativeFunction<_SetEntries_Native>>>()
      .value
      .asFunction<_SetEntries_Dart>()(ptr.ref.lpVtbl, param0, param1, param2, param3);
