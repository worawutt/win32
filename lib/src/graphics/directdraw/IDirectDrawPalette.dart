...
class IDirectDrawPalette extends IUnknown {
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint32 param0, Uint32 param1,
                              Uint32 param2, Pointer<PALETTEENTRY> param3)>>>()
              .value
              .asFunction<
  ...
  int Initialize(Pointer<COMObject> param0, int param1,
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<COMObject> param0,
                              Uint32 param1, Pointer<PALETTEENTRY> param2)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> param0, int param1,
                      Pointer<PALETTEENTRY> param2)>()(
