...
class IDirectDraw2 extends IUnknown {
  ...
  int CreateSurface(Pointer<DDSURFACEDESC> param0, Pointer<COMObject> param1, COMObject param2) => ptr.ref.lpVtbl.value      .elementAt(6)
  ...
  int EnumDisplayModes(int param0, Pointer<DDSURFACEDESC> param1, Pointer param2, Pointer<NativeFunction<LPDDENUMMODESCALLBACK>> param3) => ptr.ref.lpVtbl.value      .elementAt(8)
  ...
  int EnumSurfaces(int param0, Pointer<DDSURFACEDESC> param1, Pointer param2, Pointer<NativeFunction<LPDDENUMSURFACESCALLBACK>> param3) => ptr.ref.lpVtbl.value      .elementAt(9)
  ...
  int GetDisplayMode(Pointer<DDSURFACEDESC> param0) => ptr.ref.lpVtbl.value      .elementAt(12)
  ...
  int GetAvailableVidMem(Pointer<DDSCAPS> param0, Pointer<Uint32> param1, Pointer<Uint32> param2) => ptr.ref.lpVtbl.value      .elementAt(23)
