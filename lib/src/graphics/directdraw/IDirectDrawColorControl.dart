...
class IDirectDrawColorControl extends IUnknown {
  ...
  int GetColorControls(Pointer<DDCOLORCONTROL> param0) => ptr.ref.lpVtbl.value      .elementAt(3)
      .cast<Pointer<NativeFunction<_GetColorControls_Native>>>()
      .value
      .asFunction<_GetColorControls_Dart>()(ptr.ref.lpVtbl, param0);

  int SetColorControls(Pointer<DDCOLORCONTROL> param0) => ptr.ref.lpVtbl.value      .elementAt(4)
