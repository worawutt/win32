...
typedef _GetHWnd_Native = Int32 Function(
  Pointer,
...
typedef _SetHWnd_Dart = int Function(
  Pointer,
  int param0, 
  int param1
);
...
class IDirectDrawClipper extends IUnknown {
  ...
  int GetClipList(Pointer<RECT> param0, Pointer<RGNDATA> param1, Pointer<Uint32> param2) => ptr.ref.lpVtbl.value      .elementAt(3)
      .cast<Pointer<NativeFunction<_GetClipList_Native>>>()
      .value
      .asFunction<_GetClipList_Dart>()(ptr.ref.lpVtbl, param0, param1, param2);

  int GetHWnd(Pointer<IntPtr> param0) => ptr.ref.lpVtbl.value      .elementAt(4)
      .cast<Pointer<NativeFunction<_GetHWnd_Native>>>()
      .value
      .asFunction<_GetHWnd_Dart>()(ptr.ref.lpVtbl, param0);

  int Initialize(COMObject param0, int param1) => ptr.ref.lpVtbl.value      .elementAt(5)
      .cast<Pointer<NativeFunction<_Initialize_Native>>>()
      .value
      .asFunction<_Initialize_Dart>()(ptr.ref.lpVtbl, param0, param1);

  int IsClipListChanged(Pointer<Int32> param0) => ptr.ref.lpVtbl.value      .elementAt(6)
      .cast<Pointer<NativeFunction<_IsClipListChanged_Native>>>()
      .value
      .asFunction<_IsClipListChanged_Dart>()(ptr.ref.lpVtbl, param0);

  int SetClipList(Pointer<RGNDATA> param0, int param1) => ptr.ref.lpVtbl.value      .elementAt(7)
      .cast<Pointer<NativeFunction<_SetClipList_Native>>>()
      .value
      .asFunction<_SetClipList_Dart>()(ptr.ref.lpVtbl, param0, param1);

  int SetHWnd(int param0, int param1) => ptr.ref.lpVtbl.value      .elementAt(8)
