...
typedef LPCLIPPERCALLBACK = Uint32 Function(Pointer<COMObject> lpDDClipper,
    IntPtr hWnd, Uint32 code, Pointer lpContext);
...
typedef LPDDENUMSURFACESCALLBACK = Int32 Function(
    Pointer<COMObject> param0, Pointer<DDSURFACEDESC> param1, Pointer param2);
typedef LPDDENUMSURFACESCALLBACK2 = Int32 Function(
    Pointer<COMObject> param0, Pointer<DDSURFACEDESC2> param1, Pointer param2);
...
typedef PDD_SETMODE = Uint32 Function(Pointer<DD_SETMODEDATA> param0);
...
typedef PDX_BOBNEXTFIELD = Uint32 Function(
    Pointer param0, Pointer<DDBOBNEXTFIELDINFO> param1, Pointer param2);
typedef PDX_ENABLEIRQ = Uint32 Function(
    Pointer param0, Pointer<DDENABLEIRQINFO> param1, Pointer param2);
typedef PDX_FLIPOVERLAY = Uint32 Function(
    Pointer param0, Pointer<DDFLIPOVERLAYINFO> param1, Pointer param2);
typedef PDX_FLIPVIDEOPORT = Uint32 Function(
    Pointer param0, Pointer<DDFLIPVIDEOPORTINFO> param1, Pointer param2);
...
typedef PDX_GETIRQINFO = Uint32 Function(
    Pointer param0, Pointer param1, Pointer<DDGETIRQINFO> param2);
typedef PDX_GETPOLARITY = Uint32 Function(Pointer param0,
    Pointer<DDGETPOLARITYININFO> param1, Pointer<DDGETPOLARITYOUTINFO> param2);
...
typedef PDX_GETTRANSFERSTATUS = Uint32 Function(
    Pointer param0, Pointer param1, Pointer<DDGETTRANSFERSTATUSOUTINFO> param2);
typedef PDX_IRQCALLBACK = Void Function(Pointer<DX_IRQDATA> pIrqData);
typedef PDX_LOCK = Uint32 Function(Pointer param0, Pointer<DDLOCKININFO> param1,
    Pointer<DDLOCKOUTINFO> param2);
typedef PDX_SETSTATE = Uint32 Function(Pointer param0,
    Pointer<DDSETSTATEININFO> param1, Pointer<DDSETSTATEOUTINFO> param2);
typedef PDX_SKIPNEXTFIELD = Uint32 Function(
    Pointer param0, Pointer<DDSKIPNEXTFIELDINFO> param1, Pointer param2);
typedef PDX_TRANSFER = Uint32 Function(Pointer param0,
    Pointer<DDTRANSFERININFO> param1, Pointer<DDTRANSFEROUTINFO> param2);
