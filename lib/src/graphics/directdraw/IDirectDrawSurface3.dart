...
class IDirectDrawSurface3 extends IUnknown {
  ...
  int EnumAttachedSurfaces(Pointer param0, Pointer<NativeFunction<LPDDENUMSURFACESCALLBACK>> param1) => ptr.ref.lpVtbl.value      .elementAt(9)
  ...
  int EnumOverlayZOrders(int param0, Pointer param1, Pointer<NativeFunction<LPDDENUMSURFACESCALLBACK>> param2) => ptr.ref.lpVtbl.value      .elementAt(10)
  ...
  int GetAttachedSurface(Pointer<DDSCAPS> param0, Pointer<COMObject> param1) => ptr.ref.lpVtbl.value      .elementAt(12)
  ...
  int GetCaps(Pointer<DDSCAPS> param0) => ptr.ref.lpVtbl.value      .elementAt(14)
  ...
  int GetSurfaceDesc(Pointer<DDSURFACEDESC> param0) => ptr.ref.lpVtbl.value      .elementAt(22)
      .cast<Pointer<NativeFunction<_GetSurfaceDesc_Native>>>()
      .value
      .asFunction<_GetSurfaceDesc_Dart>()(ptr.ref.lpVtbl, param0);

  int Initialize(COMObject param0, Pointer<DDSURFACEDESC> param1) => ptr.ref.lpVtbl.value      .elementAt(23)
  ...
  int Lock(Pointer<RECT> param0, Pointer<DDSURFACEDESC> param1, int param2, int param3) => ptr.ref.lpVtbl.value      .elementAt(25)
  ...
  int Unlock(Pointer param0) => ptr.ref.lpVtbl.value      .elementAt(32)
  ...
  int SetSurfaceDesc(Pointer<DDSURFACEDESC> param0, int param1) => ptr.ref.lpVtbl.value      .elementAt(39)
