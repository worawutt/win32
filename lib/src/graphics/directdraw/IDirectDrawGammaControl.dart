...
class IDirectDrawGammaControl extends IUnknown {
  ...
  int GetGammaRamp(int param0, Pointer<DDGAMMARAMP> param1) => ptr.ref.lpVtbl.value      .elementAt(3)
      .cast<Pointer<NativeFunction<_GetGammaRamp_Native>>>()
      .value
      .asFunction<_GetGammaRamp_Dart>()(ptr.ref.lpVtbl, param0, param1);

  int SetGammaRamp(int param0, Pointer<DDGAMMARAMP> param1) => ptr.ref.lpVtbl.value      .elementAt(4)
