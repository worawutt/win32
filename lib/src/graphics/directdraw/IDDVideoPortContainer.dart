...
typedef _GetVideoPortConnectInfo_Native = Int32 Function(
  Pointer,
  Uint32 param0, 
  Pointer<Uint32> pcInfo, 
  Pointer<DDVIDEOPORTCONNECT> param2
);
typedef _GetVideoPortConnectInfo_Dart = int Function(
  Pointer,
  int param0, 
  Pointer<Uint32> pcInfo, 
  Pointer<DDVIDEOPORTCONNECT> param2
...
class IDDVideoPortContainer extends IUnknown {
  ...
  int CreateVideoPort(int param0, Pointer<DDVIDEOPORTDESC> param1, Pointer<COMObject> param2, COMObject param3) => ptr.ref.lpVtbl.value      .elementAt(3)
      .cast<Pointer<NativeFunction<_CreateVideoPort_Native>>>()
      .value
      .asFunction<_CreateVideoPort_Dart>()(ptr.ref.lpVtbl, param0, param1, param2, param3);

  int EnumVideoPorts(int param0, Pointer<DDVIDEOPORTCAPS> param1, Pointer param2, Pointer<NativeFunction<LPDDENUMVIDEOCALLBACK>> param3) => ptr.ref.lpVtbl.value      .elementAt(4)
      .cast<Pointer<NativeFunction<_EnumVideoPorts_Native>>>()
      .value
      .asFunction<_EnumVideoPorts_Dart>()(ptr.ref.lpVtbl, param0, param1, param2, param3);

  int GetVideoPortConnectInfo(int param0, Pointer<Uint32> pcInfo, Pointer<DDVIDEOPORTCONNECT> param2) => ptr.ref.lpVtbl.value      .elementAt(5)
      .cast<Pointer<NativeFunction<_GetVideoPortConnectInfo_Native>>>()
      .value
      .asFunction<_GetVideoPortConnectInfo_Dart>()(ptr.ref.lpVtbl, param0, pcInfo, param2);

  int QueryVideoPortStatus(int param0, Pointer<DDVIDEOPORTSTATUS> param1) => ptr.ref.lpVtbl.value      .elementAt(6)
