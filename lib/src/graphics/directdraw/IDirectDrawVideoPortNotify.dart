...
typedef _ReleaseNotification_Dart = int Function(
  Pointer,
  int param0
);
...
class IDirectDrawVideoPortNotify extends IUnknown {
  ...
  int AcquireNotification(Pointer<IntPtr> param0, Pointer<DDVIDEOPORTNOTIFY> param1) => ptr.ref.lpVtbl.value      .elementAt(3)
      .cast<Pointer<NativeFunction<_AcquireNotification_Native>>>()
      .value
      .asFunction<_AcquireNotification_Dart>()(ptr.ref.lpVtbl, param0, param1);

  int ReleaseNotification(int param0) => ptr.ref.lpVtbl.value      .elementAt(4)
