...
int DirectDrawCreate(Pointer<GUID> lpGUID, Pointer<Pointer<COMObject>> lplpDD,
        Pointer<COMObject> pUnkOuter) =>
    _DirectDrawCreate(lpGUID, lplpDD, pUnkOuter);

late final _DirectDrawCreate = _ddraw.lookupFunction<
    Int32 Function(Pointer<GUID> lpGUID, Pointer<Pointer<COMObject>> lplpDD,
        Pointer<COMObject> pUnkOuter),
    int Function(Pointer<GUID> lpGUID, Pointer<Pointer<COMObject>> lplpDD,
        Pointer<COMObject> pUnkOuter)>('DirectDrawCreate');
...
late final _DirectDrawCreateClipper = _ddraw.lookupFunction<
    Int32 Function(Uint32 dwFlags, Pointer<Pointer<COMObject>> lplpDDClipper,
        Pointer<COMObject> pUnkOuter),
    int Function(int dwFlags, Pointer<Pointer<COMObject>> lplpDDClipper,
        Pointer<COMObject> pUnkOuter)>('DirectDrawCreateClipper');

int DirectDrawCreateEx(Pointer<GUID> lpGuid, Pointer<Pointer> lplpDD,
        Pointer<GUID> iid, Pointer<COMObject> pUnkOuter) =>
...
late final _DirectDrawCreateEx = _ddraw.lookupFunction<
    ...
    int Function(Pointer<GUID> lpGuid, Pointer<Pointer> lplpDD,
        Pointer<GUID> iid, Pointer<COMObject> pUnkOuter)>('DirectDrawCreateEx');
