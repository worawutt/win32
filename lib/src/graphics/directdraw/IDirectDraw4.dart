...
class IDirectDraw4 extends IUnknown {
  ...
  int EnumSurfaces(int param0, Pointer<DDSURFACEDESC2> param1, Pointer param2, Pointer<NativeFunction<LPDDENUMSURFACESCALLBACK2>> param3) => ptr.ref.lpVtbl.value      .elementAt(9)
  ...
  int GetDeviceIdentifier(Pointer<DDDEVICEIDENTIFIER> param0, int param1) => ptr.ref.lpVtbl.value      .elementAt(27)
