...
class DDENABLEIRQINFO extends Struct {
  @Uint32() external int dwIRQSources;
...
class DDFLIPVIDEOPORTINFO extends Struct {
  ...
  external Pointer<DDSURFACEDATA> lpCurrentSurface;
  external Pointer<DDSURFACEDATA> lpTargetSurface;
  @Uint32() external int dwFlipVPFlags;
}
...
class DDGETCURRENTAUTOFLIPOUTINFO extends Struct {
  ...
  @Uint32() external int dwVBISurfaceIndex;
}
...
class DDGETTRANSFERSTATUSOUTINFO extends Struct {
  @IntPtr() external int dwTransferID;
}
...
class DDHAL_ADDATTACHEDSURFACEDATA extends Struct {
  ...
  external Pointer<NativeFunction<LPDDHALSURFCB_ADDATTACHEDSURFACE>> AddAttachedSurface;
}
...
class DDHAL_CANCREATEVPORTDATA extends Struct {
  ...
  @Int32() external int ddRVal;
  external Pointer<NativeFunction<LPDDHALVPORTCB_CANCREATEVIDEOPORT>> CanCreateVideoPort;
}
...
class DDHAL_CREATEVPORTDATA extends Struct {
  ...
  @Int32() external int ddRVal;
  external Pointer<NativeFunction<LPDDHALVPORTCB_CREATEVIDEOPORT>> CreateVideoPort;
}
...
class DDHAL_DDCALLBACKS extends Struct {
  ...
  external Pointer<NativeFunction<LPDDHAL_WAITFORVERTICALBLANK>> WaitForVerticalBlank;
  external Pointer<NativeFunction<LPDDHAL_CANCREATESURFACE>> CanCreateSurface;
  external Pointer<NativeFunction<LPDDHAL_CREATEPALETTE>> CreatePalette;
...
class DDHAL_DDEXEBUFCALLBACKS extends Struct {
  @Uint32() external int dwSize;
  @Uint32() external int dwFlags;
  external Pointer<NativeFunction<LPDDHALEXEBUFCB_CANCREATEEXEBUF>> CanCreateExecuteBuffer;
  external Pointer<NativeFunction<LPDDHALEXEBUFCB_CREATEEXEBUF>> CreateExecuteBuffer;
  external Pointer<NativeFunction<LPDDHALEXEBUFCB_DESTROYEXEBUF>> DestroyExecuteBuffer;
  external Pointer<NativeFunction<LPDDHALEXEBUFCB_LOCKEXEBUF>> LockExecuteBuffer;
  external Pointer<NativeFunction<LPDDHALEXEBUFCB_UNLOCKEXEBUF>> UnlockExecuteBuffer;
}
...
class DDHAL_DDKERNELCALLBACKS extends Struct {
  ...
  external Pointer<NativeFunction<LPDDHALKERNELCB_SYNCVIDEOPORT>> SyncVideoPortData;
}
...
class DDHAL_DDMISCELLANEOUSCALLBACKS extends Struct {
  @Uint32() external int dwSize;
  @Uint32() external int dwFlags;
  external Pointer<NativeFunction<LPDDHAL_GETAVAILDRIVERMEMORY>> GetAvailDriverMemory;
  external Pointer<NativeFunction<LPDDHAL_UPDATENONLOCALHEAP>> UpdateNonLocalHeap;
  external Pointer<NativeFunction<LPDDHAL_GETHEAPALIGNMENT>> GetHeapAlignment;
  external Pointer<NativeFunction<LPDDHALSURFCB_GETBLTSTATUS>> GetSysmemBltStatus;
}
...
class DDHAL_DDMOTIONCOMPCALLBACKS extends Struct {
  ...
  external Pointer<NativeFunction<LPDDHALMOCOMPCB_CREATE>> CreateMoComp;
  external Pointer<NativeFunction<LPDDHALMOCOMPCB_GETCOMPBUFFINFO>> GetMoCompBuffInfo;
  external Pointer<NativeFunction<LPDDHALMOCOMPCB_GETINTERNALINFO>> GetInternalMoCompInfo;
  external Pointer<NativeFunction<LPDDHALMOCOMPCB_BEGINFRAME>> BeginMoCompFrame;
  ...
  external Pointer<NativeFunction<LPDDHALMOCOMPCB_QUERYSTATUS>> QueryMoCompStatus;
...
class DDHAL_DDSURFACECALLBACKS extends Struct {
  ...
  external Pointer<NativeFunction<LPDDHALSURFCB_SETOVERLAYPOSITION>> SetOverlayPosition;
...
class DDHAL_DDVIDEOPORTCALLBACKS extends Struct {
  ...
  external Pointer<NativeFunction<LPDDHALVPORTCB_GETBANDWIDTH>> GetVideoPortBandwidth;
  external Pointer<NativeFunction<LPDDHALVPORTCB_GETINPUTFORMATS>> GetVideoPortInputFormats;
  external Pointer<NativeFunction<LPDDHALVPORTCB_GETOUTPUTFORMATS>> GetVideoPortOutputFormats;
  ...
  external Pointer<NativeFunction<LPDDHALVPORTCB_GETVPORTCONNECT>> GetVideoPortConnectInfo;
  external Pointer<NativeFunction<LPDDHALVPORTCB_DESTROYVPORT>> DestroyVideoPort;
  external Pointer<NativeFunction<LPDDHALVPORTCB_GETFLIPSTATUS>> GetVideoPortFlipStatus;
  external Pointer<NativeFunction<LPDDHALVPORTCB_UPDATE>> UpdateVideoPort;
  external Pointer<NativeFunction<LPDDHALVPORTCB_WAITFORSYNC>> WaitForVideoPortSync;
  external Pointer<NativeFunction<LPDDHALVPORTCB_GETSIGNALSTATUS>> GetVideoSignalStatus;
...
class DDLOCKOUTINFO extends Struct {
  @IntPtr() external int dwSurfacePtr;
}
...
class DDSETSTATEOUTINFO extends Struct {
  @Int32() external int bSoftwareAutoflip;
  @Uint32() external int dwSurfaceIndex;
  @Uint32() external int dwVBISurfaceIndex;
}
...
class DDSKIPNEXTFIELDINFO extends Struct {
  external Pointer<DDVIDEOPORTDATA> lpVideoPortData;
  @Uint32() external int dwSkipFlags;
}
...
class DDSURFACEDATA extends Struct {
  ...
  @Uint32() external int dwFormatFlags;
  @Uint32() external int dwFormatFourCC;
  @Uint32() external int dwFormatBitCount;
  @Uint32() external int dwRBitMask;
  @Uint32() external int dwGBitMask;
  @Uint32() external int dwBBitMask;
  @Uint32() external int dwDriverReserved1;
...
class DDTRANSFERININFO extends Struct {
  external Pointer<DDSURFACEDATA> lpSurfaceData;
  @Uint32() external int dwStartLine;
  @Uint32() external int dwEndLine;
  @IntPtr() external int dwTransferID;
  @Uint32() external int dwTransferFlags;
  external Pointer<MDL> lpDestMDL;
}

/// {@category Struct}
class DDTRANSFEROUTINFO extends Struct {
  @Uint32() external int dwBufferPolarity;
}
...
class DXAPI_INTERFACE extends Struct {
  ...
  external Pointer<NativeFunction<PDX_GETPREVIOUSAUTOFLIP>> DxGetPreviousAutoflip;
...
class DX_IRQDATA extends Struct {
  @Uint32() external int dwIrqFlags;
}
...
class MDL extends Struct {
  ...
  @Int16() external int MdlSize;
  @Int16() external int MdlFlags;
  external Pointer<Uint32> Process;
  external Pointer<Uint32> lpMappedSystemVa;
  external Pointer<Uint32> lpStartVa;
  @Uint32() external int ByteCount;
  @Uint32() external int ByteOffset;
}
