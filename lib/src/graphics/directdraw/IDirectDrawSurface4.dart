...
class IDirectDrawSurface4 extends IUnknown {
  ...
  int EnumAttachedSurfaces(Pointer param0, Pointer<NativeFunction<LPDDENUMSURFACESCALLBACK2>> param1) => ptr.ref.lpVtbl.value      .elementAt(9)
  ...
  int EnumOverlayZOrders(int param0, Pointer param1, Pointer<NativeFunction<LPDDENUMSURFACESCALLBACK2>> param2) => ptr.ref.lpVtbl.value      .elementAt(10)
