      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int dwOptions,
                      Pointer<COMObject> pIStream,
                      Pointer<Pointer<COMObject>> ppIReader)>()(ptr.ref.lpVtbl,
          guidMetadataFormat, pguidVendor, dwOptions, pIStream, ppIReader);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pIStream,
                      Pointer<Pointer<COMObject>> ppIReader)>()(ptr.ref.lpVtbl,
          guidContainerFormat, pguidVendor, dwOptions, pIStream, ppIReader);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> pguidVendor,
                      int dwMetadataOptions,
                      Pointer<Pointer<COMObject>> ppIWriter)>()(ptr.ref.lpVtbl,
          guidMetadataFormat, pguidVendor, dwMetadataOptions, ppIWriter);

  int CreateMetadataWriterFromReader(Pointer<COMObject> pIReader,
          Pointer<GUID> pguidVendor, Pointer<Pointer<COMObject>> ppIWriter) =>
      ptr.ref.lpVtbl.value
              .elementAt(31)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> pguidVendor,
                      Pointer<Pointer<COMObject>> ppIWriter)>()(
          ptr.ref.lpVtbl, pIReader, pguidVendor, ppIWriter);

  int
      CreateQueryReaderFromBlockReader(Pointer<COMObject> pIBlockReader,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<COMObject> pIBlockReader,
                          Pointer<Pointer<COMObject>> ppIQueryReader)>()(
              ptr.ref.lpVtbl, pIBlockReader, ppIQueryReader);

  int
      CreateQueryWriterFromBlockWriter(Pointer<COMObject> pIBlockWriter,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<COMObject> pIBlockWriter,
                          Pointer<Pointer<COMObject>> ppIQueryWriter)>()(
              ptr.ref.lpVtbl, pIBlockWriter, ppIQueryWriter);

  int CreateEncoderPropertyBag(Pointer<PROPBAG2> ppropOptions, int cCount,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int cCount,
                      Pointer<Pointer<COMObject>> ppIPropertyBag)>()(
          ptr.ref.lpVtbl, ppropOptions, cCount, ppIPropertyBag);
}
