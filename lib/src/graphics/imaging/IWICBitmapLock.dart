...
class IWICBitmapLock extends IUnknown {
  ...
  int GetStride(Pointer<Uint32> pcbStride) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Uint32> pcbStride)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Uint32> pcbStride)>()(
      ptr.ref.lpVtbl, pcbStride);

  int GetDataPointer(
          Pointer<Uint32> pcbBufferSize, Pointer<Pointer<Uint8>> ppbData) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Uint32> pcbBufferSize,
                              Pointer<Pointer<Uint8>> ppbData)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> pcbBufferSize,
                      Pointer<Pointer<Uint8>> ppbData)>()(
          ptr.ref.lpVtbl, pcbBufferSize, ppbData);
