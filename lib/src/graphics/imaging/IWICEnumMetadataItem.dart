...
class IWICEnumMetadataItem extends IUnknown {
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<PROPVARIANT> rgeltValue,
                      Pointer<Uint32> pceltFetched)>()(
          ptr.ref.lpVtbl, celt, rgeltSchema, rgeltId, rgeltValue, pceltFetched);
  ...
  int Clone(Pointer<Pointer<COMObject>> ppIEnumMetadataItem) => ptr
          .ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<COMObject>> ppIEnumMetadataItem)>()(
      ptr.ref.lpVtbl, ppIEnumMetadataItem);
}
