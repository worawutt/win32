...
class IWICDevelopRawNotificationCallback extends IUnknown {
  ...
  int Notify(int NotificationMask) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Uint32 NotificationMask)>>>()
          .value
          .asFunction<int Function(Pointer, int NotificationMask)>()(
      ptr.ref.lpVtbl, NotificationMask);
}
