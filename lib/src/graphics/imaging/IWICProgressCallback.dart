...
class IWICProgressCallback extends IUnknown {
  ...
  int Notify(int uFrameNum, int operation, double dblProgress) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Uint32 uFrameNum, Int32 operation,
                          Double dblProgress)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer, int uFrameNum, int operation, double dblProgress)>()(
      ptr.ref.lpVtbl, uFrameNum, operation, dblProgress);
}
