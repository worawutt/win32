...
class IWICDdsEncoder extends IUnknown {
  ...
  int SetParameters(Pointer<WICDdsParameters> pParameters) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<WICDdsParameters> pParameters)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<WICDdsParameters> pParameters)>()(
      ptr.ref.lpVtbl, pParameters);

  int GetParameters(Pointer<WICDdsParameters> pParameters) => ptr
          .ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint32> pMipLevel,
                      Pointer<Uint32> pSliceIndex)>()(
          ptr.ref.lpVtbl, ppIFrameEncode, pArrayIndex, pMipLevel, pSliceIndex);
}
