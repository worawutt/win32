...
class IWICPlanarFormatConverter extends IWICBitmapSource {
  ...
  int CanConvert(Pointer<GUID> pSrcPixelFormats, int cSrcPlanes,
          Pointer<GUID> dstPixelFormat, Pointer<Int32> pfCanConvert) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      int cSrcPlanes,
                      Pointer<GUID> dstPixelFormat,
                      Pointer<Int32> pfCanConvert)>()(ptr.ref.lpVtbl,
          pSrcPixelFormats, cSrcPlanes, dstPixelFormat, pfCanConvert);
}
