...
class IWICMetadataWriterInfo extends IWICMetadataHandlerInfo {
  ...
  int GetHeader(Pointer<GUID> guidContainerFormat, int cbSize,
          Pointer<WICMetadataHeader> pHeader, Pointer<Uint32> pcbActual) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<WICMetadataHeader> pHeader,
                      Pointer<Uint32> pcbActual)>()(
          ptr.ref.lpVtbl, guidContainerFormat, cbSize, pHeader, pcbActual);

  int CreateInstance(Pointer<Pointer<COMObject>> ppIWriter) => ptr
          .ref.lpVtbl.value
          .elementAt(19)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> ppIWriter)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> ppIWriter)>()(
      ptr.ref.lpVtbl, ppIWriter);
}
