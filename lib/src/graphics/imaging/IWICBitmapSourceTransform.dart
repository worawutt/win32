...
class IWICBitmapSourceTransform extends IUnknown {
  ...
  int GetClosestSize(Pointer<Uint32> puiWidth, Pointer<Uint32> puiHeight) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
  ...
  int GetClosestPixelFormat(Pointer<GUID> pguidDstFormat) => ptr
          .ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<GUID> pguidDstFormat)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<GUID> pguidDstFormat)>()(
      ptr.ref.lpVtbl, pguidDstFormat);

  int DoesSupportTransform(int dstTransform, Pointer<Int32> pfIsSupported) =>
      ptr.ref.lpVtbl.value
              .elementAt(6)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 dstTransform,
                              Pointer<Int32> pfIsSupported)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int dstTransform,
                      Pointer<Int32> pfIsSupported)>()(
          ptr.ref.lpVtbl, dstTransform, pfIsSupported);
}
