...
class IWICImageEncoder extends IUnknown {
  ...
  int WriteFrame(Pointer<COMObject> pImage, Pointer<COMObject> pFrameEncode,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pFrameEncode,
                      Pointer<WICImageParameters> pImageParameters)>()(
          ptr.ref.lpVtbl, pImage, pFrameEncode, pImageParameters);
  ...
  int WriteThumbnail(Pointer<COMObject> pImage, Pointer<COMObject> pEncoder,
          Pointer<WICImageParameters> pImageParameters) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pEncoder,
                      Pointer<WICImageParameters> pImageParameters)>()(
          ptr.ref.lpVtbl, pImage, pEncoder, pImageParameters);
}
