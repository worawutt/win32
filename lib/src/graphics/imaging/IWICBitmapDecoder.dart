...
class IWICBitmapDecoder extends IUnknown {
  ...
  int QueryCapability(
          Pointer<COMObject> pIStream, Pointer<Uint32> pdwCapability) =>
      ptr
              .ref.lpVtbl.value
              .elementAt(3)
              .cast<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pIStream,
                      Pointer<Uint32> pdwCapability)>()(
          ptr.ref.lpVtbl, pIStream, pdwCapability);

  int Initialize(Pointer<COMObject> pIStream, int cacheOptions) =>
      ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(Pointer, Pointer<COMObject> pIStream,
                  int cacheOptions)>()(ptr.ref.lpVtbl, pIStream, cacheOptions);
  ...
  int GetDecoderInfo(Pointer<Pointer<COMObject>> ppIDecoderInfo) => ptr
          .ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<COMObject>> ppIDecoderInfo)>()(
      ptr.ref.lpVtbl, ppIDecoderInfo);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer,
                      Pointer<Pointer<COMObject>> ppIMetadataQueryReader)>()(
          ptr.ref.lpVtbl, ppIMetadataQueryReader);

  int GetPreview(Pointer<Pointer<COMObject>> ppIBitmapSource) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppIBitmapSource)>()(
          ptr.ref.lpVtbl, ppIBitmapSource);

  int GetColorContexts(int cCount, Pointer<Pointer<COMObject>> ppIColorContexts,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppIColorContexts,
                      Pointer<Uint32> pcActualCount)>()(
          ptr.ref.lpVtbl, cCount, ppIColorContexts, pcActualCount);

  int GetThumbnail(Pointer<Pointer<COMObject>> ppIThumbnail) => ptr
          .ref.lpVtbl.value
          .elementAt(11)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<COMObject>> ppIThumbnail)>()(
      ptr.ref.lpVtbl, ppIThumbnail);

  int GetFrameCount(Pointer<Uint32> pCount) => ptr.ref.lpVtbl.value
          .elementAt(12)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetFrame(int index, Pointer<Pointer<COMObject>> ppIBitmapFrame) =>
      ptr.ref.lpVtbl.value
              .elementAt(13)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, int index,
                      Pointer<Pointer<COMObject>> ppIBitmapFrame)>()(
          ptr.ref.lpVtbl, index, ppIBitmapFrame);
}
