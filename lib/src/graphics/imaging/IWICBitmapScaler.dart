...
class IWICBitmapScaler extends IWICBitmapSource {
  ...
  int Initialize(
          Pointer<COMObject> pISource, int uiWidth, int uiHeight, int mode) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<COMObject> pISource,
                              Uint32 uiWidth, Uint32 uiHeight, Int32 mode)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pISource,
                      int uiWidth, int uiHeight, int mode)>()(
          ptr.ref.lpVtbl, pISource, uiWidth, uiHeight, mode);
}
