...
class IWICMetadataReaderInfo extends IWICMetadataHandlerInfo {
  ...
  int GetPatterns(
      ...
      ptr.ref.lpVtbl.value
          ...
          guidContainerFormat, cbSize, pPattern, pcCount, pcbActual);

  int MatchesPattern(Pointer<GUID> guidContainerFormat,
          Pointer<COMObject> pIStream, Pointer<Int32> pfMatches) =>
      ptr.ref.lpVtbl.value
              .elementAt(19)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<GUID> guidContainerFormat,
                      Pointer<COMObject> pIStream, Pointer<Int32> pfMatches)>()(
          ptr.ref.lpVtbl, guidContainerFormat, pIStream, pfMatches);

  int CreateInstance(Pointer<Pointer<COMObject>> ppIReader) => ptr
          .ref.lpVtbl.value
          .elementAt(20)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> ppIReader)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> ppIReader)>()(
      ptr.ref.lpVtbl, ppIReader);
}
