...
class IWICFormatConverterInfo extends IWICComponentInfo {
  ...
  int GetPixelFormats(int cFormats, Pointer<GUID> pPixelFormatGUIDs,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> pPixelFormatGUIDs,
                      Pointer<Uint32> pcActual)>()(
          ptr.ref.lpVtbl, cFormats, pPixelFormatGUIDs, pcActual);

  int CreateInstance(Pointer<Pointer<COMObject>> ppIConverter) =>
      ptr.ref.lpVtbl.value
              .elementAt(12)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppIConverter)>()(
          ptr.ref.lpVtbl, ppIConverter);
}
