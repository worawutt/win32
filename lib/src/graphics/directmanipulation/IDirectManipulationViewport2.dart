...
class IDirectManipulationViewport2 extends IDirectManipulationViewport {
  ...
  int AddBehavior(Pointer<COMObject> behavior, Pointer<Uint32> cookie) =>
      ptr.ref.lpVtbl.value
          .elementAt(31)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> behavior,
                          Pointer<Uint32> cookie)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> behavior,
                  Pointer<Uint32> cookie)>()(ptr.ref.lpVtbl, behavior, cookie);

  int RemoveBehavior(int cookie) => ptr.ref.lpVtbl.value
      .elementAt(32)
