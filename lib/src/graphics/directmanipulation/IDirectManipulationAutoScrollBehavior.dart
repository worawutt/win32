...
class IDirectManipulationAutoScrollBehavior extends IUnknown {
  ...
  int SetConfiguration(int motionTypes, int scrollMotion) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Int32 motionTypes, Int32 scrollMotion)>>>()
          .value
          .asFunction<
              int Function(Pointer, int motionTypes, int scrollMotion)>()(
      ptr.ref.lpVtbl, motionTypes, scrollMotion);
}
