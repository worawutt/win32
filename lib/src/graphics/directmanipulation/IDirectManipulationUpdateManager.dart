...
class IDirectManipulationUpdateManager extends IUnknown {
  ...
  int RegisterWaitHandleCallback(int handle, Pointer<COMObject> eventHandler,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> eventHandler,
                      Pointer<Uint32> cookie)>()(
          ptr.ref.lpVtbl, handle, eventHandler, cookie);

  int UnregisterWaitHandleCallback(int cookie) => ptr.ref.lpVtbl.value
      .elementAt(4)
  ...
  int Update(Pointer<COMObject> frameInfo) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> frameInfo)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> frameInfo)>()(
      ptr.ref.lpVtbl, frameInfo);
}
