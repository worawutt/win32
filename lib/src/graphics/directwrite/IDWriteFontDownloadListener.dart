...
class IDWriteFontDownloadListener extends IUnknown {
  ...
  void
      DownloadCompleted(Pointer<COMObject> downloadQueue,
              Pointer<COMObject> context, int downloadResult) =>
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      void Function(Pointer, Pointer<COMObject> downloadQueue,
                          Pointer<COMObject> context, int downloadResult)>()(
              ptr.ref.lpVtbl, downloadQueue, context, downloadResult);
}
