      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> fontCollection,
                      Pointer<Pointer<COMObject>> font)>()(
          ptr.ref.lpVtbl, logFont, fontCollection, font);

  int GetFontSignature_1(
          Pointer<COMObject> fontFace, Pointer<FONTSIGNATURE> fontSignature) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> fontFace,
                      Pointer<FONTSIGNATURE> fontSignature)>()(
          ptr.ref.lpVtbl, fontFace, fontSignature);

  int GetFontSignature(
          Pointer<COMObject> font, Pointer<FONTSIGNATURE> fontSignature) =>
      ptr.ref.lpVtbl.value
              .elementAt(10)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> font,
                      Pointer<FONTSIGNATURE> fontSignature)>()(
          ptr.ref.lpVtbl, font, fontSignature);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> fontSet,
                      Pointer<Pointer<COMObject>> filteredSet)>()(
          ptr.ref.lpVtbl, logFont, fontSet, filteredSet);
}
