...
class IDWriteTextAnalyzer1 extends IDWriteTextAnalyzer {
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              ...
                              Pointer<Float> glyphAdvances,
                              Pointer<DWRITE_GLYPH_OFFSET> glyphOffsets,
                              Pointer<DWRITE_SHAPING_GLYPH_PROPERTIES>
                                  glyphProperties,
                              Pointer<Float> modifiedGlyphAdvances,
  ...
  int AnalyzeVerticalGlyphOrientation(Pointer<COMObject> analysisSource,
  ...
  int GetGlyphOrientationTransform(int glyphOrientationAngle, int isSideways,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int glyphOrientationAngle,
                      int isSideways, Pointer<DWRITE_MATRIX> transform)>()(
          ptr.ref.lpVtbl, glyphOrientationAngle, isSideways, transform);

  int GetScriptProperties(DWRITE_SCRIPT_ANALYSIS scriptAnalysis,
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer,
                              DWRITE_SCRIPT_ANALYSIS scriptAnalysis,
                              Pointer<DWRITE_SCRIPT_PROPERTIES>
                                  scriptProperties)>>>()
              .value
              .asFunction<
                  int Function(Pointer, DWRITE_SCRIPT_ANALYSIS scriptAnalysis,
                      Pointer<DWRITE_SCRIPT_PROPERTIES> scriptProperties)>()(
          ptr.ref.lpVtbl, scriptAnalysis, scriptProperties);
      ...
      ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<Uint16> clusterMap,
                  Pointer<DWRITE_SHAPING_GLYPH_PROPERTIES> glyphProperties,
                  Pointer<DWRITE_JUSTIFICATION_OPPORTUNITY> justificationOpportunities)>()(ptr.ref.lpVtbl, fontFace, fontEmSize, scriptAnalysis, textLength, glyphCount, textString, clusterMap, glyphProperties, justificationOpportunities);
      ...
      ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<DWRITE_GLYPH_OFFSET> glyphOffsets,
                  Pointer<Float> justifiedGlyphAdvances,
                  Pointer<DWRITE_GLYPH_OFFSET> justifiedGlyphOffsets)>()(ptr.ref.lpVtbl, lineWidth, glyphCount, justificationOpportunities, glyphAdvances, glyphOffsets, justifiedGlyphAdvances, justifiedGlyphOffsets);

  int GetJustifiedGlyphs(Pointer<COMObject> fontFace, double fontEmSize, DWRITE_SCRIPT_ANALYSIS scriptAnalysis, int textLength, int glyphCount, int maxGlyphCount, Pointer<Uint16> clusterMap, Pointer<Uint16> glyphIndices, Pointer<Float> glyphAdvances, Pointer<Float> justifiedGlyphAdvances, Pointer<DWRITE_GLYPH_OFFSET> justifiedGlyphOffsets, Pointer<DWRITE_SHAPING_GLYPH_PROPERTIES> glyphProperties, Pointer<Uint32> actualGlyphCount, Pointer<Uint16> modifiedClusterMap, Pointer<Uint16> modifiedGlyphIndices, Pointer<Float> modifiedGlyphAdvances, Pointer<DWRITE_GLYPH_OFFSET> modifiedGlyphOffsets) => ptr
          .ref.lpVtbl.value
          .elementAt(18)
          .cast<
              Pointer<
