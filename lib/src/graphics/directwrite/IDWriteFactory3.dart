...
class IDWriteFactory3 extends IDWriteFactory2 {
  ...
  int GetSystemFontSet(Pointer<Pointer<COMObject>> fontSet) =>
      ptr.ref.lpVtbl.value
              .elementAt(35)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<COMObject>> fontSet)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<COMObject>> fontSet)>()(
          ptr.ref.lpVtbl, fontSet);

  int CreateFontSetBuilder(Pointer<Pointer<COMObject>> fontSetBuilder) =>
      ptr.ref.lpVtbl.value
              .elementAt(36)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> fontSetBuilder)>()(
          ptr.ref.lpVtbl, fontSetBuilder);

  int CreateFontCollectionFromFontSet(Pointer<COMObject> fontSet,
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<COMObject> fontSet,
                              Pointer<Pointer<COMObject>> fontCollection)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> fontSet,
                      Pointer<Pointer<COMObject>> fontCollection)>()(
          ptr.ref.lpVtbl, fontSet, fontCollection);

  int GetSystemFontCollection_1(int includeDownloadableFonts,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> fontCollection,
                      int checkForUpdates)>()(ptr.ref.lpVtbl,
          includeDownloadableFonts, fontCollection, checkForUpdates);

  int GetFontDownloadQueue(Pointer<Pointer<COMObject>> fontDownloadQueue) => ptr
          .ref.lpVtbl.value
          .elementAt(39)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<COMObject>> fontDownloadQueue)>()(
      ptr.ref.lpVtbl, fontDownloadQueue);
}
