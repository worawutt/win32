...
class IDWriteTextAnalysisSource extends IUnknown {
  ...
  int GetTextAtPosition(int textPosition, Pointer<Pointer<Uint16>> textString,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<Uint16>> textString,
                      Pointer<Uint32> textLength)>()(
          ptr.ref.lpVtbl, textPosition, textString, textLength);

  int GetTextBeforePosition(int textPosition,
          Pointer<Pointer<Uint16>> textString, Pointer<Uint32> textLength) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
  ...
  int GetLocaleName(int textPosition, Pointer<Uint32> textLength,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint32> textLength,
                      Pointer<Pointer<Uint16>> localeName)>()(
          ptr.ref.lpVtbl, textPosition, textLength, localeName);

  int
      GetNumberSubstitution(int textPosition, Pointer<Uint32> textLength,
