...
class IDWriteRemoteFontFileStream extends IDWriteFontFileStream {
  ...
  int GetLocalFileSize(Pointer<Uint64> localFileSize) => ptr.ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Uint64> localFileSize)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<Uint64> localFileSize)>()(ptr.ref.lpVtbl, localFileSize);

  int GetFileFragmentLocality(int fileOffset, int fragmentSize,
          Pointer<Int32> isLocal, Pointer<Uint64> partialSize) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int fileOffset, int fragmentSize,
                      Pointer<Int32> isLocal, Pointer<Uint64> partialSize)>()(
          ptr.ref.lpVtbl, fileOffset, fragmentSize, isLocal, partialSize);
