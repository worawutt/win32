...
class IDWriteFactory6 extends IDWriteFactory5 {
  ...
  int CreateFontResource(Pointer<COMObject> fontFile, int faceIndex,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int faceIndex,
                      Pointer<Pointer<COMObject>> fontResource)>()(
          ptr.ref.lpVtbl, fontFile, faceIndex, fontResource);

  int
      GetSystemFontSet_1(int includeDownloadableFonts,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, int includeDownloadableFonts,
                          Pointer<Pointer<COMObject>> fontSet)>()(
              ptr.ref.lpVtbl, includeDownloadableFonts, fontSet);

  int GetSystemFontCollection_2(int includeDownloadableFonts,
          int fontFamilyModel, Pointer<Pointer<COMObject>> fontCollection) =>
      ptr.ref.lpVtbl.value
              .elementAt(51)
              .cast<
                  Pointer<
  ...
  int CreateFontCollectionFromFontSet_1(Pointer<COMObject> fontSet,
          int fontFamilyModel, Pointer<Pointer<COMObject>> fontCollection) =>
      ptr.ref.lpVtbl.value
              .elementAt(52)
              .cast<
              ...
              .asFunction<
                  int Function(
                      ...
                      int fontFamilyModel,
                      Pointer<Pointer<COMObject>> fontCollection)>()(
          ptr.ref.lpVtbl, fontSet, fontFamilyModel, fontCollection);

  int CreateFontSetBuilder_2(Pointer<Pointer<COMObject>> fontSetBuilder) =>
      ptr.ref.lpVtbl.value
              .elementAt(53)
              .cast<
                  Pointer<
