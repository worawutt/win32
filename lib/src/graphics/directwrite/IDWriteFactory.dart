...
class IDWriteFactory extends IUnknown {
  ...
  int GetSystemFontCollection(
          Pointer<Pointer<COMObject>> fontCollection, int checkForUpdates) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> fontCollection,
                      int checkForUpdates)>()(
          ptr.ref.lpVtbl, fontCollection, checkForUpdates);
  ...
  int RegisterFontCollectionLoader(Pointer<COMObject> fontCollectionLoader) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<COMObject> fontCollectionLoader)>()(
          ptr.ref.lpVtbl, fontCollectionLoader);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<FILETIME> lastWriteTime,
                      Pointer<Pointer<COMObject>> fontFile)>()(
          ptr.ref.lpVtbl, filePath, lastWriteTime, fontFile);
  ...
  int CreateRenderingParams(Pointer<Pointer<COMObject>> renderingParams) =>
      ptr.ref.lpVtbl.value
              .elementAt(10)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> renderingParams)>()(
          ptr.ref.lpVtbl, renderingParams);

  int CreateMonitorRenderingParams(
          int monitor, Pointer<Pointer<COMObject>> renderingParams) =>
      ptr.ref.lpVtbl.value
              .elementAt(11)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, IntPtr monitor,
                              Pointer<Pointer<COMObject>> renderingParams)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int monitor,
                      Pointer<Pointer<COMObject>> renderingParams)>()(
          ptr.ref.lpVtbl, monitor, renderingParams);
  ...
  int RegisterFontFileLoader(Pointer<COMObject> fontFileLoader) =>
      ptr.ref.lpVtbl.value
              .elementAt(13)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> fontFileLoader)>()(
          ptr.ref.lpVtbl, fontFileLoader);

  int UnregisterFontFileLoader(Pointer<COMObject> fontFileLoader) =>
      ptr.ref.lpVtbl.value
              .elementAt(14)
              .cast<
                  Pointer<
  ...
  int CreateTypography(Pointer<Pointer<COMObject>> typography) => ptr
          .ref.lpVtbl.value
          .elementAt(16)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> typography)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> typography)>()(
      ptr.ref.lpVtbl, typography);

  int GetGdiInterop(Pointer<Pointer<COMObject>> gdiInterop) => ptr
          .ref.lpVtbl.value
          .elementAt(17)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> gdiInterop)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> gdiInterop)>()(
      ptr.ref.lpVtbl, gdiInterop);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      double maxWidth,
                      double maxHeight,
                      Pointer<Pointer<COMObject>> textLayout)>()(ptr.ref.lpVtbl,
          string, stringLength, textFormat, maxWidth, maxHeight, textLayout);
  ...
  int CreateEllipsisTrimmingSign(Pointer<COMObject> textFormat,
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<COMObject> textFormat,
                              Pointer<Pointer<COMObject>> trimmingSign)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> textFormat,
                      Pointer<Pointer<COMObject>> trimmingSign)>()(
          ptr.ref.lpVtbl, textFormat, trimmingSign);

  int CreateTextAnalyzer(Pointer<Pointer<COMObject>> textAnalyzer) => ptr
          .ref.lpVtbl.value
          .elementAt(21)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<COMObject>> textAnalyzer)>()(
      ptr.ref.lpVtbl, textAnalyzer);
