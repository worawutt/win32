...
class IDWriteFontSet1 extends IDWriteFontSet {
  ...
  int GetFirstFontResources(Pointer<Pointer<COMObject>> filteredFontSet) =>
      ptr.ref.lpVtbl.value
              .elementAt(14)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> filteredFontSet)>()(
          ptr.ref.lpVtbl, filteredFontSet);

  int GetFilteredFonts_2(Pointer<Uint32> indices, int indexCount,
          Pointer<Pointer<COMObject>> filteredFontSet) =>
      ptr.ref.lpVtbl.value
              .elementAt(15)
              .cast<
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> indices, int indexCount,
                      Pointer<Pointer<COMObject>> filteredFontSet)>()(
          ptr.ref.lpVtbl, indices, indexCount, filteredFontSet);
  ...
  int CreateFontResource(
          int listIndex, Pointer<Pointer<COMObject>> fontResource) =>
      ptr
              .ref.lpVtbl.value
              .elementAt(23)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint32 listIndex,
                              Pointer<Pointer<COMObject>> fontResource)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int listIndex,
                      Pointer<Pointer<COMObject>> fontResource)>()(
          ptr.ref.lpVtbl, listIndex, fontResource);

  int CreateFontFace(int listIndex, Pointer<Pointer<COMObject>> fontFace) =>
      ptr.ref.lpVtbl.value
              .elementAt(24)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, int listIndex,
                      Pointer<Pointer<COMObject>> fontFace)>()(
          ptr.ref.lpVtbl, listIndex, fontFace);

  int GetFontLocality(int listIndex) => ptr.ref.lpVtbl.value
      .elementAt(25)
      .cast<
          Pointer<NativeFunction<Int32 Function(Pointer, Uint32 listIndex)>>>()
      .value
      .asFunction<
          int Function(Pointer, int listIndex)>()(ptr.ref.lpVtbl, listIndex);
}
