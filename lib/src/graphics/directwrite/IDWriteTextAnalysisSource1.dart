...
class IDWriteTextAnalysisSource1 extends IDWriteTextAnalysisSource {
  ...
  int GetVerticalGlyphOrientation(int textPosition, Pointer<Uint32> textLength,
          Pointer<Int32> glyphOrientation, Pointer<Uint8> bidiLevel) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint32> textLength,
                      Pointer<Int32> glyphOrientation,
                      Pointer<Uint8> bidiLevel)>()(ptr.ref.lpVtbl, textPosition,
          textLength, glyphOrientation, bidiLevel);
}
