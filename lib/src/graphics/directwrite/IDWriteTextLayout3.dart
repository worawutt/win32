...
class IDWriteTextLayout3 extends IDWriteTextLayout2 {
  ...
  int SetLineSpacing_1(Pointer<DWRITE_LINE_SPACING> lineSpacingOptions) => ptr
          .ref.lpVtbl.value
          .elementAt(81)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<DWRITE_LINE_SPACING> lineSpacingOptions)>()(
      ptr.ref.lpVtbl, lineSpacingOptions);

  int GetLineSpacing_1(Pointer<DWRITE_LINE_SPACING> lineSpacingOptions) => ptr
          .ref.lpVtbl.value
          .elementAt(82)
          .cast<
              Pointer<
  ...
  int GetLineMetrics_1(Pointer<DWRITE_LINE_METRICS1> lineMetrics,
          int maxLineCount, Pointer<Uint32> actualLineCount) =>
