...
class IDWriteRemoteFontFileLoader extends IDWriteFontFileLoader {
  ...
  int GetLocalityFromKey(Pointer fontFileReferenceKey,
          int fontFileReferenceKeySize, Pointer<Int32> locality) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer fontFileReferenceKey,
                      int fontFileReferenceKeySize, Pointer<Int32> locality)>()(
          ptr.ref.lpVtbl,
          fontFileReferenceKey,
          fontFileReferenceKeySize,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> fontFileUrl,
                      Pointer<Pointer<COMObject>> fontFile)>()(
          ptr.ref.lpVtbl, factory, baseUrl, fontFileUrl, fontFile);
}
