...
class IDWriteFontSetBuilder1 extends IDWriteFontSetBuilder {
  ...
  int AddFontFile(Pointer<COMObject> fontFile) => ptr.ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> fontFile)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> fontFile)>()(
