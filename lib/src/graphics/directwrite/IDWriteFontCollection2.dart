...
class IDWriteFontCollection2 extends IDWriteFontCollection1 {
  ...
  int GetFontFamily_2(int index, Pointer<Pointer<COMObject>> fontFamily) =>
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<DWRITE_FONT_AXIS_VALUE> fontAxisValues,
                      int fontAxisValueCount,
                      Pointer<Pointer<COMObject>> fontList)>()(ptr.ref.lpVtbl,
          familyName, fontAxisValues, fontAxisValueCount, fontList);
  ...
  int GetFontSet_1(Pointer<Pointer<COMObject>> fontSet) => ptr.ref.lpVtbl.value
          .elementAt(12)
          .cast<
              Pointer<
                  NativeFunction<
