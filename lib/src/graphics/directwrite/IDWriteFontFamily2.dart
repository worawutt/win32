...
class IDWriteFontFamily2 extends IDWriteFontFamily1 {
  ...
  int GetMatchingFonts_1(Pointer<DWRITE_FONT_AXIS_VALUE> fontAxisValues,
          int fontAxisValueCount, Pointer<Pointer<COMObject>> matchingFonts) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> matchingFonts)>()(
          ptr.ref.lpVtbl, fontAxisValues, fontAxisValueCount, matchingFonts);

  int GetFontSet(Pointer<Pointer<COMObject>> fontSet) => ptr.ref.lpVtbl.value
          .elementAt(13)
          .cast<
              Pointer<
                  NativeFunction<
