...
class IDWriteFontFace extends IUnknown {
  ...
  int GetFiles(Pointer<Uint32> numberOfFiles,
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Uint32> numberOfFiles,
                              Pointer<Pointer<COMObject>> fontFiles)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> numberOfFiles,
                      Pointer<Pointer<COMObject>> fontFiles)>()(
          ptr.ref.lpVtbl, numberOfFiles, fontFiles);
  ...
  void GetMetrics(Pointer<DWRITE_FONT_METRICS> fontFaceMetrics) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  void Function(
                      Pointer, Pointer<DWRITE_FONT_METRICS> fontFaceMetrics)>()(
          ptr.ref.lpVtbl, fontFaceMetrics);
  ...
  int GetDesignGlyphMetrics(Pointer<Uint16> glyphIndices, int glyphCount,
          Pointer<DWRITE_GLYPH_METRICS> glyphMetrics, int isSideways) =>
      ptr.ref.lpVtbl.value
              .elementAt(10)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<DWRITE_GLYPH_METRICS> glyphMetrics,
                      int isSideways)>()(
          ptr.ref.lpVtbl, glyphIndices, glyphCount, glyphMetrics, isSideways);

  int GetGlyphIndices(Pointer<Uint32> codePoints, int codePointCount,
          Pointer<Uint16> glyphIndices) =>
      ptr.ref.lpVtbl.value
              .elementAt(11)
              .cast<
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> codePoints,
                      int codePointCount, Pointer<Uint16> glyphIndices)>()(
          ptr.ref.lpVtbl, codePoints, codePointCount, glyphIndices);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint32> tableSize,
                      Pointer<Pointer> tableContext,
                      Pointer<Int32> exists)>()(ptr.ref.lpVtbl,
          openTypeTableTag, tableData, tableSize, tableContext, exists);

  void ReleaseFontTable(Pointer tableContext) => ptr.ref.lpVtbl.value
      .elementAt(13)
      .cast<
          Pointer<
              NativeFunction<Void Function(Pointer, Pointer tableContext)>>>()
      .value
      .asFunction<
          void Function(
              Pointer, Pointer tableContext)>()(ptr.ref.lpVtbl, tableContext);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int measuringMode,
                      Pointer<COMObject> renderingParams,
                      Pointer<Int32> renderingMode)>()(ptr.ref.lpVtbl, emSize,
          pixelsPerDip, measuringMode, renderingParams, renderingMode);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<DWRITE_MATRIX> transform,
                      Pointer<DWRITE_FONT_METRICS> fontFaceMetrics)>()(
          ptr.ref.lpVtbl, emSize, pixelsPerDip, transform, fontFaceMetrics);
