...
class IDWriteFontFace6 extends IDWriteFontFace5 {
  ...
  int GetFamilyNames_1(
          int fontFamilyModel, Pointer<Pointer<COMObject>> names) =>
      ptr.ref.lpVtbl.value
              .elementAt(58)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 fontFamilyModel,
                              Pointer<Pointer<COMObject>> names)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int fontFamilyModel,
                      Pointer<Pointer<COMObject>> names)>()(
          ptr.ref.lpVtbl, fontFamilyModel, names);

  int GetFaceNames_1(int fontFamilyModel, Pointer<Pointer<COMObject>> names) =>
      ptr.ref.lpVtbl.value
              .elementAt(59)
              .cast<
                  Pointer<
