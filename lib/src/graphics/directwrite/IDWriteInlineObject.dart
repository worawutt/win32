...
class IDWriteInlineObject extends IUnknown {
  ...
  int GetMetrics(Pointer<DWRITE_INLINE_OBJECT_METRICS> metrics) => ptr
          .ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<DWRITE_INLINE_OBJECT_METRICS> metrics)>()(
      ptr.ref.lpVtbl, metrics);
  ...
  int GetBreakConditions(Pointer<Int32> breakConditionBefore,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Int32> breakConditionBefore,
                      Pointer<Int32> breakConditionAfter)>()(
          ptr.ref.lpVtbl, breakConditionBefore, breakConditionAfter);
}
