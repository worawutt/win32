...
class IDWriteFontFace2 extends IDWriteFontFace1 {
  ...
  int GetPaletteEntries(int colorPaletteIndex, int firstEntryIndex,
          int entryCount, Pointer<DWRITE_COLOR_F> paletteEntries) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int firstEntryIndex,
                      int entryCount,
                      Pointer<DWRITE_COLOR_F> paletteEntries)>()(ptr.ref.lpVtbl,
