...
class IDWriteFontFace4 extends IDWriteFontFace3 {
  ...
  int GetGlyphImageFormats_1(int glyphId, int pixelsPerEmFirst,
          int pixelsPerEmLast, Pointer<Uint32> glyphImageFormats) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int pixelsPerEmLast,
                      Pointer<Uint32> glyphImageFormats)>()(ptr.ref.lpVtbl,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int glyphImageFormat,
                      Pointer<DWRITE_GLYPH_IMAGE_DATA> glyphData,
                      Pointer<Pointer> glyphDataContext)>()(ptr.ref.lpVtbl,
          glyphId, pixelsPerEm, glyphImageFormat, glyphData, glyphDataContext);

  void ReleaseGlyphImageData(Pointer glyphDataContext) => ptr.ref.lpVtbl.value
          .elementAt(52)
          .cast<
              Pointer<
                  NativeFunction<
                      Void Function(Pointer, Pointer glyphDataContext)>>>()
          .value
          .asFunction<void Function(Pointer, Pointer glyphDataContext)>()(
      ptr.ref.lpVtbl, glyphDataContext);
}
