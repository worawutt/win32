...
class IDWriteFontFile extends IUnknown {
  ...
  int GetReferenceKey(Pointer<Pointer> fontFileReferenceKey,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer> fontFileReferenceKey,
                      Pointer<Uint32> fontFileReferenceKeySize)>()(
          ptr.ref.lpVtbl, fontFileReferenceKey, fontFileReferenceKeySize);

  int GetLoader(Pointer<Pointer<COMObject>> fontFileLoader) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> fontFileLoader)>()(
          ptr.ref.lpVtbl, fontFileLoader);

  int Analyze(Pointer<Int32> isSupportedFontType, Pointer<Int32> fontFileType,
          Pointer<Int32> fontFaceType, Pointer<Uint32> numberOfFaces) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Int32> fontFileType,
                      Pointer<Int32> fontFaceType,
                      Pointer<Uint32> numberOfFaces)>()(ptr.ref.lpVtbl,
