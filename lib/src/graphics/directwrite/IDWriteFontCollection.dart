...
class IDWriteFontCollection extends IUnknown {
  ...
  int GetFontFamily(int index, Pointer<Pointer<COMObject>> fontFamily) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int index,
                      Pointer<Pointer<COMObject>> fontFamily)>()(
          ptr.ref.lpVtbl, index, fontFamily);

  int FindFamilyName(Pointer<Utf16> familyName, Pointer<Uint32> index,
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> familyName,
                              Pointer<Uint32> index, Pointer<Int32> exists)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> familyName,
                      Pointer<Uint32> index, Pointer<Int32> exists)>()(
          ptr.ref.lpVtbl, familyName, index, exists);

  int GetFontFromFontFace(
          Pointer<COMObject> fontFace, Pointer<Pointer<COMObject>> font) =>
      ptr.ref.lpVtbl.value
              .elementAt(6)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> fontFace,
                      Pointer<Pointer<COMObject>> font)>()(
          ptr.ref.lpVtbl, fontFace, font);
}
