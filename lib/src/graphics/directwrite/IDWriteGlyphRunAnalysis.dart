...
class IDWriteGlyphRunAnalysis extends IUnknown {
  ...
  int GetAlphaTextureBounds(int textureType, Pointer<RECT> textureBounds) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 textureType,
                              Pointer<RECT> textureBounds)>>>()
              .value
              .asFunction<
                  int Function(
                      Pointer, int textureType, Pointer<RECT> textureBounds)>()(
          ptr.ref.lpVtbl, textureType, textureBounds);

  int CreateAlphaTexture(int textureType, Pointer<RECT> textureBounds,
          Pointer<Uint8> alphaValues, int bufferSize) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint8> alphaValues,
                      int bufferSize)>()(
          ptr.ref.lpVtbl, textureType, textureBounds, alphaValues, bufferSize);
