...
class IDWriteTextAnalyzer2 extends IDWriteTextAnalyzer1 {
  ...
  int GetGlyphOrientationTransform_1(int glyphOrientationAngle, int isSideways,
          double originX, double originY, Pointer<DWRITE_MATRIX> transform) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      double originX,
                      double originY,
                      Pointer<DWRITE_MATRIX> transform)>()(ptr.ref.lpVtbl,
          glyphOrientationAngle, isSideways, originX, originY, transform);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int maxTagCount,
                      Pointer<Uint32> actualTagCount,
                      Pointer<Uint32> tags)>()(ptr.ref.lpVtbl, fontFace,
          scriptAnalysis, localeName, maxTagCount, actualTagCount, tags);
