...
class IDWriteFontFace1 extends IDWriteFontFace {
  ...
  void GetMetrics_1(Pointer<DWRITE_FONT_METRICS1> fontMetrics) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  void Function(
                      Pointer, Pointer<DWRITE_FONT_METRICS1> fontMetrics)>()(
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<DWRITE_MATRIX> transform,
                      Pointer<DWRITE_FONT_METRICS1> fontMetrics)>()(
          ptr.ref.lpVtbl, emSize, pixelsPerDip, transform, fontMetrics);

  void GetCaretMetrics(Pointer<DWRITE_CARET_METRICS> caretMetrics) => ptr
          .ref.lpVtbl.value
          .elementAt(20)
          .cast<
              Pointer<
          ...
          .asFunction<
              void Function(
                  Pointer, Pointer<DWRITE_CARET_METRICS> caretMetrics)>()(
      ptr.ref.lpVtbl, caretMetrics);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<DWRITE_UNICODE_RANGE> unicodeRanges,
                      Pointer<Uint32> actualRangeCount)>()(
          ptr.ref.lpVtbl, maxRangeCount, unicodeRanges, actualRangeCount);
  ...
  int GetDesignGlyphAdvances(int glyphCount, Pointer<Uint16> glyphIndices,
          Pointer<Int32> glyphAdvances, int isSideways) =>
      ptr.ref.lpVtbl.value
              .elementAt(23)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Int32> glyphAdvances,
                      int isSideways)>()(
          ptr.ref.lpVtbl, glyphCount, glyphIndices, glyphAdvances, isSideways);
  ...
  int GetKerningPairAdjustments(int glyphCount, Pointer<Uint16> glyphIndices,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint16> glyphIndices,
                      Pointer<Int32> glyphAdvanceAdjustments)>()(
          ptr.ref.lpVtbl, glyphCount, glyphIndices, glyphAdvanceAdjustments);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int glyphCount,
                      Pointer<Uint16> nominalGlyphIndices,
                      Pointer<Uint16> verticalGlyphIndices)>()(ptr.ref.lpVtbl,
