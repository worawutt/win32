...
class IDWriteFontFace5 extends IDWriteFontFace4 {
  ...
  int GetFontAxisValues(Pointer<DWRITE_FONT_AXIS_VALUE> fontAxisValues,
  ...
  int Equals(Pointer<COMObject> fontFace) => ptr.ref.lpVtbl.value
          .elementAt(57)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> fontFace)>()(
