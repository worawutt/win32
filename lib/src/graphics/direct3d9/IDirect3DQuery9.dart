...
typedef _Issue_Native = Int32 Function(
  Pointer,
  Uint32 dwIssueFlags
);
typedef _Issue_Dart = int Function(
  Pointer,
  int dwIssueFlags
);
...
class IDirect3DQuery9 extends IUnknown {
  ...
  int GetType() => ptr.ref.lpVtbl.value      .elementAt(4)
      .cast<Pointer<NativeFunction<_GetType_Native>>>()
      .value
      .asFunction<_GetType_Dart>()(ptr.ref.lpVtbl);

  int GetDataSize() => ptr.ref.lpVtbl.value      .elementAt(5)
      .cast<Pointer<NativeFunction<_GetDataSize_Native>>>()
      .value
      .asFunction<_GetDataSize_Dart>()(ptr.ref.lpVtbl);

  int Issue(int dwIssueFlags) => ptr.ref.lpVtbl.value      .elementAt(6)
      .cast<Pointer<NativeFunction<_Issue_Native>>>()
      .value
      .asFunction<_Issue_Dart>()(ptr.ref.lpVtbl, dwIssueFlags);

  int GetData(Pointer pData, int dwSize, int dwGetDataFlags) => ptr.ref.lpVtbl.value      .elementAt(7)
      .cast<Pointer<NativeFunction<_GetData_Native>>>()
      .value
      .asFunction<_GetData_Dart>()(ptr.ref.lpVtbl, pData, dwSize, dwGetDataFlags);
