...
class IDirect3DQuery9 extends IUnknown {
  ...
  int Issue(int dwIssueFlags) => ptr.ref.lpVtbl.value
      ...
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Uint32 dwIssueFlags)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int dwIssueFlags)>()(ptr.ref.lpVtbl, dwIssueFlags);
  ...
  int GetData(Pointer pData, int dwSize, int dwGetDataFlags) => ptr
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer pData, Uint32 dwSize,
                          Uint32 dwGetDataFlags)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer, Pointer pData, int dwSize, int dwGetDataFlags)>()(
