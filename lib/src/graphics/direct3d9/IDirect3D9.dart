...
class IDirect3D9 extends IUnknown {
  ...
  int RegisterSoftwareDevice(Pointer pInitializeFunction) => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer pInitializeFunction)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer pInitializeFunction)>()(
  ...
  int GetAdapterIdentifier(int Adapter, int Flags,
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint32 Adapter, Uint32 Flags,
                              Pointer<D3DADAPTER_IDENTIFIER9> pIdentifier)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int Adapter, int Flags,
                      Pointer<D3DADAPTER_IDENTIFIER9> pIdentifier)>()(
          ptr.ref.lpVtbl, Adapter, Flags, pIdentifier);

  int GetAdapterModeCount(int Adapter, int Format) =>
      ptr.ref.lpVtbl.value
              .elementAt(6)
              .cast<
                  Pointer<
                      NativeFunction<
                          Uint32 Function(
                              Pointer, Uint32 Adapter, Uint32 Format)>>>()
              .value
              .asFunction<int Function(Pointer, int Adapter, int Format)>()(
          ptr.ref.lpVtbl, Adapter, Format);
  ...
  int EnumAdapterModes(
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint32 Adapter, Uint32 Format,
                              Uint32 Mode, Pointer<D3DDISPLAYMODE> pMode)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int Adapter, int Format, int Mode,
                      Pointer<D3DDISPLAYMODE> pMode)>()(
          ptr.ref.lpVtbl, Adapter, Format, Mode, pMode);

  int GetAdapterDisplayMode(int Adapter, Pointer<D3DDISPLAYMODE> pMode) => ptr
      .ref.lpVtbl.value
      .elementAt(8)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Uint32 Adapter,
                      Pointer<D3DDISPLAYMODE> pMode)>>>()
      .value
      .asFunction<
          int Function(Pointer, int Adapter,
              Pointer<D3DDISPLAYMODE> pMode)>()(ptr.ref.lpVtbl, Adapter, pMode);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int bWindowed)>()(ptr.ref.lpVtbl, Adapter, DevType,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int Usage,
                      int RType,
                      int CheckFormat)>()(ptr.ref.lpVtbl, Adapter, DeviceType,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int DepthStencilFormat)>()(ptr.ref.lpVtbl, Adapter,
  ...
  int
      CheckDeviceFormatConversion(int Adapter, int DeviceType, int SourceFormat,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, int Adapter, int DeviceType,
                          int SourceFormat, int TargetFormat)>()(
              ptr.ref.lpVtbl, Adapter, DeviceType, SourceFormat, TargetFormat);

  int GetDeviceCaps(int Adapter, int DeviceType, Pointer<D3DCAPS9> pCaps) => ptr
          .ref.lpVtbl.value
          .elementAt(14)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Uint32 Adapter, Uint32 DeviceType,
  ...
  int GetAdapterMonitor(int Adapter) => ptr.ref.lpVtbl.value
      .elementAt(15)
      .cast<Pointer<NativeFunction<IntPtr Function(Pointer, Uint32 Adapter)>>>()
      .value
      .asFunction<
          int Function(Pointer, int Adapter)>()(ptr.ref.lpVtbl, Adapter);
