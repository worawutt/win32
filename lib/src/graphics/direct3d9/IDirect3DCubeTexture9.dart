...
class IDirect3DCubeTexture9 extends IDirect3DBaseTexture9 {
  ...
  int GetLevelDesc(int Level, Pointer<D3DSURFACE_DESC> pDesc) => ptr
      .ref.lpVtbl.value
      .elementAt(17)
      .cast<
          Pointer<
      ...
      .asFunction<
          int Function(Pointer, int Level,
              Pointer<D3DSURFACE_DESC> pDesc)>()(ptr.ref.lpVtbl, Level, pDesc);

  int GetCubeMapSurface(int FaceType, int Level,
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 FaceType, Uint32 Level,
                              Pointer<Pointer<COMObject>> ppCubeMapSurface)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int FaceType, int Level,
                      Pointer<Pointer<COMObject>> ppCubeMapSurface)>()(
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 FaceType, Uint32 Level)>>>()
          .value
          .asFunction<int Function(Pointer, int FaceType, int Level)>()(
      ptr.ref.lpVtbl, FaceType, Level);
  ...
  int AddDirtyRect(int FaceType, Pointer<RECT> pDirtyRect) => ptr
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 FaceType,
                          Pointer<RECT> pDirtyRect)>>>()
          .value
          .asFunction<
              int Function(Pointer, int FaceType, Pointer<RECT> pDirtyRect)>()(
      ptr.ref.lpVtbl, FaceType, pDirtyRect);
}
