  ...
  int GetAdapterModeCountEx(
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Uint32 Function(Pointer, Uint32 Adapter,
  ...
  int GetAdapterLUID(int Adapter, Pointer<LUID> pLUID) => ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Uint32 Adapter, Pointer<LUID> pLUID)>>>()
          .value
          .asFunction<
              int Function(Pointer, int Adapter, Pointer<LUID> pLUID)>()(
      ptr.ref.lpVtbl, Adapter, pLUID);
}
