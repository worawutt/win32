...
class IDirect3DTexture9 extends IDirect3DBaseTexture9 {
  ...
  int GetSurfaceLevel(int Level, Pointer<Pointer<COMObject>> ppSurfaceLevel) =>
  ...
  int AddDirtyRect(Pointer<RECT> pDirtyRect) => ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<RECT> pDirtyRect)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<RECT> pDirtyRect)>()(
      ptr.ref.lpVtbl, pDirtyRect);
}
