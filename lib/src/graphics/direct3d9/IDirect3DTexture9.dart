...
typedef _GetSurfaceLevel_Native = Int32 Function(
  Pointer,
  Uint32 Level, 
  Pointer<COMObject> ppSurfaceLevel
);
...
class IDirect3DTexture9 extends IDirect3DBaseTexture9 {
  ...
  int GetSurfaceLevel(int Level, Pointer<COMObject> ppSurfaceLevel) => ptr.ref.lpVtbl.value      .elementAt(18)
      .cast<Pointer<NativeFunction<_GetSurfaceLevel_Native>>>()
      .value
      .asFunction<_GetSurfaceLevel_Dart>()(ptr.ref.lpVtbl, Level, ppSurfaceLevel);

  int LockRect(int Level, Pointer<D3DLOCKED_RECT> pLockedRect, Pointer<RECT> pRect, int Flags) => ptr.ref.lpVtbl.value      .elementAt(19)
      .cast<Pointer<NativeFunction<_LockRect_Native>>>()
      .value
      .asFunction<_LockRect_Dart>()(ptr.ref.lpVtbl, Level, pLockedRect, pRect, Flags);

  int UnlockRect(int Level) => ptr.ref.lpVtbl.value      .elementAt(20)
      .cast<Pointer<NativeFunction<_UnlockRect_Native>>>()
      .value
      .asFunction<_UnlockRect_Dart>()(ptr.ref.lpVtbl, Level);

  int AddDirtyRect(Pointer<RECT> pDirtyRect) => ptr.ref.lpVtbl.value      .elementAt(21)
