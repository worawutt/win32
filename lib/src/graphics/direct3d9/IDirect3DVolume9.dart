...
typedef _LockBox_Native = Int32 Function(
  Pointer,
  Pointer<D3DLOCKED_BOX> pLockedVolume, 
  Pointer<D3DBOX> pBox, 
  Uint32 Flags
);
typedef _LockBox_Dart = int Function(
  Pointer,
  Pointer<D3DLOCKED_BOX> pLockedVolume, 
  Pointer<D3DBOX> pBox, 
  int Flags
...
typedef _UnlockBox_Native = Int32 Function(
  Pointer);
typedef _UnlockBox_Dart = int Function(
  Pointer);
...
class IDirect3DVolume9 extends IUnknown {
  ...
  int GetDevice(Pointer<COMObject> ppDevice) => ptr.ref.lpVtbl.value      .elementAt(3)
      .cast<Pointer<NativeFunction<_GetDevice_Native>>>()
      .value
      .asFunction<_GetDevice_Dart>()(ptr.ref.lpVtbl, ppDevice);

  int SetPrivateData(Pointer<GUID> refguid, Pointer pData, int SizeOfData, int Flags) => ptr.ref.lpVtbl.value      .elementAt(4)
      .cast<Pointer<NativeFunction<_SetPrivateData_Native>>>()
      .value
      .asFunction<_SetPrivateData_Dart>()(ptr.ref.lpVtbl, refguid, pData, SizeOfData, Flags);

  int GetPrivateData(Pointer<GUID> refguid, Pointer pData, Pointer<Uint32> pSizeOfData) => ptr.ref.lpVtbl.value      .elementAt(5)
      .cast<Pointer<NativeFunction<_GetPrivateData_Native>>>()
      .value
      .asFunction<_GetPrivateData_Dart>()(ptr.ref.lpVtbl, refguid, pData, pSizeOfData);

  int FreePrivateData(Pointer<GUID> refguid) => ptr.ref.lpVtbl.value      .elementAt(6)
      .cast<Pointer<NativeFunction<_FreePrivateData_Native>>>()
      .value
      .asFunction<_FreePrivateData_Dart>()(ptr.ref.lpVtbl, refguid);

  int GetContainer(Pointer<GUID> riid, Pointer<Pointer> ppContainer) => ptr.ref.lpVtbl.value      .elementAt(7)
      .cast<Pointer<NativeFunction<_GetContainer_Native>>>()
      .value
      .asFunction<_GetContainer_Dart>()(ptr.ref.lpVtbl, riid, ppContainer);

  int GetDesc(Pointer<D3DVOLUME_DESC> pDesc) => ptr.ref.lpVtbl.value      .elementAt(8)
      .cast<Pointer<NativeFunction<_GetDesc_Native>>>()
      .value
      .asFunction<_GetDesc_Dart>()(ptr.ref.lpVtbl, pDesc);

  int LockBox(Pointer<D3DLOCKED_BOX> pLockedVolume, Pointer<D3DBOX> pBox, int Flags) => ptr.ref.lpVtbl.value      .elementAt(9)
      .cast<Pointer<NativeFunction<_LockBox_Native>>>()
      .value
      .asFunction<_LockBox_Dart>()(ptr.ref.lpVtbl, pLockedVolume, pBox, Flags);

  int UnlockBox() => ptr.ref.lpVtbl.value      .elementAt(10)
