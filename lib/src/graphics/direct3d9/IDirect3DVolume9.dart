...
class IDirect3DVolume9 extends IUnknown {
  ...
  int
      SetPrivateData(Pointer<GUID> refguid, Pointer pData, int SizeOfData,
              int Flags) =>
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<GUID> refguid,
  ...
  int GetPrivateData(
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<GUID> refguid,
                              Pointer pData, Pointer<Uint32> pSizeOfData)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<GUID> refguid, Pointer pData,
  ...
  int FreePrivateData(Pointer<GUID> refguid) => ptr.ref.lpVtbl.value
      ...
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<GUID> refguid)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, Pointer<GUID> refguid)>()(ptr.ref.lpVtbl, refguid);

  int GetContainer(Pointer<GUID> riid, Pointer<Pointer> ppContainer) => ptr
          .ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<GUID> riid, Pointer<Pointer> ppContainer)>()(
      ptr.ref.lpVtbl, riid, ppContainer);
  ...
  int GetDesc(Pointer<D3DVOLUME_DESC> pDesc) => ptr.ref.lpVtbl.value
      ...
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<D3DVOLUME_DESC> pDesc)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, Pointer<D3DVOLUME_DESC> pDesc)>()(ptr.ref.lpVtbl, pDesc);
      ...
      ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<D3DLOCKED_BOX> pLockedVolume,
                  Pointer<D3DBOX> pBox,
                  int Flags)>()(ptr.ref.lpVtbl, pLockedVolume, pBox, Flags);
