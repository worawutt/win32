...
typedef _GetVolumeLevel_Native = Int32 Function(
  Pointer,
  Uint32 Level, 
  Pointer<COMObject> ppVolumeLevel
);
...
class IDirect3DVolumeTexture9 extends IDirect3DBaseTexture9 {
  ...
  int GetLevelDesc(int Level, Pointer<D3DVOLUME_DESC> pDesc) => ptr.ref.lpVtbl.value      .elementAt(17)
      .cast<Pointer<NativeFunction<_GetLevelDesc_Native>>>()
      .value
      .asFunction<_GetLevelDesc_Dart>()(ptr.ref.lpVtbl, Level, pDesc);

  int GetVolumeLevel(int Level, Pointer<COMObject> ppVolumeLevel) => ptr.ref.lpVtbl.value      .elementAt(18)
      .cast<Pointer<NativeFunction<_GetVolumeLevel_Native>>>()
      .value
      .asFunction<_GetVolumeLevel_Dart>()(ptr.ref.lpVtbl, Level, ppVolumeLevel);

  int LockBox(int Level, Pointer<D3DLOCKED_BOX> pLockedVolume, Pointer<D3DBOX> pBox, int Flags) => ptr.ref.lpVtbl.value      .elementAt(19)
      .cast<Pointer<NativeFunction<_LockBox_Native>>>()
      .value
      .asFunction<_LockBox_Dart>()(ptr.ref.lpVtbl, Level, pLockedVolume, pBox, Flags);

  int UnlockBox(int Level) => ptr.ref.lpVtbl.value      .elementAt(20)
      .cast<Pointer<NativeFunction<_UnlockBox_Native>>>()
      .value
      .asFunction<_UnlockBox_Dart>()(ptr.ref.lpVtbl, Level);

  int AddDirtyBox(Pointer<D3DBOX> pDirtyBox) => ptr.ref.lpVtbl.value      .elementAt(21)
