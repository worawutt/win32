...
class IDirect3DVolumeTexture9 extends IDirect3DBaseTexture9 {
  ...
  int GetLevelDesc(int Level, Pointer<D3DVOLUME_DESC> pDesc) => ptr
      .ref.lpVtbl.value
      .elementAt(17)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Uint32 Level, Pointer<D3DVOLUME_DESC> pDesc)>>>()
      .value
      .asFunction<
          int Function(Pointer, int Level,
              Pointer<D3DVOLUME_DESC> pDesc)>()(ptr.ref.lpVtbl, Level, pDesc);

  int GetVolumeLevel(int Level, Pointer<Pointer<COMObject>> ppVolumeLevel) =>
      ptr.ref.lpVtbl.value
              .elementAt(18)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint32 Level,
                              Pointer<Pointer<COMObject>> ppVolumeLevel)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int Level,
                      Pointer<Pointer<COMObject>> ppVolumeLevel)>()(
          ptr.ref.lpVtbl, Level, ppVolumeLevel);
  ...
  int AddDirtyBox(Pointer<D3DBOX> pDirtyBox) => ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<D3DBOX> pDirtyBox)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<D3DBOX> pDirtyBox)>()(
      ptr.ref.lpVtbl, pDirtyBox);
}
