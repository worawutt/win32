...
typedef _SetPriority_Native = Uint32 Function(
  Pointer,
  Uint32 PriorityNew
);
...
typedef _GetPriority_Native = Uint32 Function(
  Pointer);
typedef _GetPriority_Dart = int Function(
  Pointer);

typedef _PreLoad_Native = Void Function(
  Pointer);
typedef _PreLoad_Dart = void Function(
  Pointer);
