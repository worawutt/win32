...
class IDirect3DVertexBuffer9 extends IDirect3DResource9 {
  ...
  int Lock(int OffsetToLock, int SizeToLock, Pointer<Pointer> ppbData, int Flags) => ptr.ref.lpVtbl.value      .elementAt(11)
      .cast<Pointer<NativeFunction<_Lock_Native>>>()
      .value
      .asFunction<_Lock_Dart>()(ptr.ref.lpVtbl, OffsetToLock, SizeToLock, ppbData, Flags);

  int Unlock() => ptr.ref.lpVtbl.value      .elementAt(12)
      .cast<Pointer<NativeFunction<_Unlock_Native>>>()
      .value
      .asFunction<_Unlock_Dart>()(ptr.ref.lpVtbl);

  int GetDesc(Pointer<D3DVERTEXBUFFER_DESC> pDesc) => ptr.ref.lpVtbl.value      .elementAt(13)
