...
class IDirect3DSwapChain9Ex extends IDirect3DSwapChain9 {
  ...
  int GetPresentStats(Pointer<D3DPRESENTSTATS> pPresentationStatistics) => ptr
          .ref.lpVtbl.value
          .elementAt(11)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<D3DPRESENTSTATS> pPresentationStatistics)>()(
      ptr.ref.lpVtbl, pPresentationStatistics);

  int GetDisplayModeEx(
          Pointer<D3DDISPLAYMODEEX> pMode, Pointer<Int32> pRotation) =>
      ptr
          .ref.lpVtbl.value
          .elementAt(12)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<D3DDISPLAYMODEEX> pMode,
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<Int32>
                      pRotation)>()(ptr.ref.lpVtbl, pMode, pRotation);
}
