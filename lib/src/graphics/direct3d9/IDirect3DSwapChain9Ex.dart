...
class IDirect3DSwapChain9Ex extends IDirect3DSwapChain9 {
  ...
  int GetLastPresentCount(Pointer<Uint32> pLastPresentCount) => ptr.ref.lpVtbl.value      .elementAt(10)
      .cast<Pointer<NativeFunction<_GetLastPresentCount_Native>>>()
      .value
      .asFunction<_GetLastPresentCount_Dart>()(ptr.ref.lpVtbl, pLastPresentCount);

  int GetPresentStats(Pointer<D3DPRESENTSTATS> pPresentationStatistics) => ptr.ref.lpVtbl.value      .elementAt(11)
      .cast<Pointer<NativeFunction<_GetPresentStats_Native>>>()
      .value
      .asFunction<_GetPresentStats_Dart>()(ptr.ref.lpVtbl, pPresentationStatistics);

  int GetDisplayModeEx(Pointer<D3DDISPLAYMODEEX> pMode, Pointer<Uint32> pRotation) => ptr.ref.lpVtbl.value      .elementAt(12)
      .cast<Pointer<NativeFunction<_GetDisplayModeEx_Native>>>()
      .value
      .asFunction<_GetDisplayModeEx_Dart>()(ptr.ref.lpVtbl, pMode, pRotation);
