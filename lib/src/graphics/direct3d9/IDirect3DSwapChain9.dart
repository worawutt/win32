...
class IDirect3DSwapChain9 extends IUnknown {
  ...
  int Present(Pointer<RECT> pSourceRect, Pointer<RECT> pDestRect, int hDestWindowOverride, Pointer<RGNDATA> pDirtyRegion, int dwFlags) => ptr.ref.lpVtbl.value      .elementAt(3)
      .cast<Pointer<NativeFunction<_Present_Native>>>()
      .value
      .asFunction<_Present_Dart>()(ptr.ref.lpVtbl, pSourceRect, pDestRect, hDestWindowOverride, pDirtyRegion, dwFlags);

  int GetFrontBufferData(COMObject pDestSurface) => ptr.ref.lpVtbl.value      .elementAt(4)
      .cast<Pointer<NativeFunction<_GetFrontBufferData_Native>>>()
      .value
      .asFunction<_GetFrontBufferData_Dart>()(ptr.ref.lpVtbl, pDestSurface);

  int GetBackBuffer(int iBackBuffer, int Type, Pointer<COMObject> ppBackBuffer) => ptr.ref.lpVtbl.value      .elementAt(5)
      .cast<Pointer<NativeFunction<_GetBackBuffer_Native>>>()
      .value
      .asFunction<_GetBackBuffer_Dart>()(ptr.ref.lpVtbl, iBackBuffer, Type, ppBackBuffer);

  int GetRasterStatus(Pointer<D3DRASTER_STATUS> pRasterStatus) => ptr.ref.lpVtbl.value      .elementAt(6)
      .cast<Pointer<NativeFunction<_GetRasterStatus_Native>>>()
      .value
      .asFunction<_GetRasterStatus_Dart>()(ptr.ref.lpVtbl, pRasterStatus);

  int GetDisplayMode(Pointer<D3DDISPLAYMODE> pMode) => ptr.ref.lpVtbl.value      .elementAt(7)
      .cast<Pointer<NativeFunction<_GetDisplayMode_Native>>>()
      .value
      .asFunction<_GetDisplayMode_Dart>()(ptr.ref.lpVtbl, pMode);

  int GetDevice(Pointer<COMObject> ppDevice) => ptr.ref.lpVtbl.value      .elementAt(8)
      .cast<Pointer<NativeFunction<_GetDevice_Native>>>()
      .value
      .asFunction<_GetDevice_Dart>()(ptr.ref.lpVtbl, ppDevice);

  int GetPresentParameters(Pointer<D3DPRESENT_PARAMETERS> pPresentationParameters) => ptr.ref.lpVtbl.value      .elementAt(9)
      .cast<Pointer<NativeFunction<_GetPresentParameters_Native>>>()
      .value
      .asFunction<_GetPresentParameters_Dart>()(ptr.ref.lpVtbl, pPresentationParameters);
