...
class IDirect3DSwapChain9 extends IUnknown {
  ...
  int GetFrontBufferData(Pointer<COMObject> pDestSurface) => ptr
      .ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> pDestSurface)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<COMObject> pDestSurface)>()(ptr.ref.lpVtbl, pDestSurface);

  int
      GetBackBuffer(int iBackBuffer, int Type,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, int iBackBuffer, int Type,
                          Pointer<Pointer<COMObject>> ppBackBuffer)>()(
              ptr.ref.lpVtbl, iBackBuffer, Type, ppBackBuffer);

  int GetRasterStatus(Pointer<D3DRASTER_STATUS> pRasterStatus) => ptr
          .ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<D3DRASTER_STATUS> pRasterStatus)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<D3DRASTER_STATUS> pRasterStatus)>()(
      ptr.ref.lpVtbl, pRasterStatus);
  ...
  int GetDisplayMode(Pointer<D3DDISPLAYMODE> pMode) => ptr.ref.lpVtbl.value
      ...
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<D3DDISPLAYMODE> pMode)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, Pointer<D3DDISPLAYMODE> pMode)>()(ptr.ref.lpVtbl, pMode);
