...
class IDirect3DDevice9Ex extends IDirect3DDevice9 {
  ...
  int SetConvolutionMonoKernel(
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint32 width, Uint32 height,
                              Pointer<Float> rows, Pointer<Float> columns)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int width, int height,
                      Pointer<Float> rows, Pointer<Float> columns)>()(
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int Operation,
                      int Xoffset,
                      int Yoffset)>()(ptr.ref.lpVtbl, pSrc, pDst, pSrcRectDescs,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int hDestWindowOverride,
                      Pointer<RGNDATA> pDirtyRegion,
                      int dwFlags)>()(ptr.ref.lpVtbl, pSourceRect, pDestRect,
  ...
  int GetGPUThreadPriority(Pointer<Int32> pPriority) => ptr.ref.lpVtbl.value
      ...
      ptr.ref.lpVtbl, pPriority);

  int SetGPUThreadPriority(int Priority) => ptr.ref.lpVtbl.value
      .elementAt(123)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 Priority)>>>()
      .value
      .asFunction<
          int Function(Pointer, int Priority)>()(ptr.ref.lpVtbl, Priority);

  int WaitForVBlank(int iSwapChain) => ptr.ref.lpVtbl.value
      .elementAt(124)
      .cast<
          Pointer<NativeFunction<Int32 Function(Pointer, Uint32 iSwapChain)>>>()
      .value
      .asFunction<
          int Function(Pointer, int iSwapChain)>()(ptr.ref.lpVtbl, iSwapChain);

  int CheckResourceResidency(
          Pointer<Pointer<COMObject>> pResourceArray, int NumResources) =>
      ptr.ref.lpVtbl.value
              .elementAt(125)
              .cast<
                  Pointer<
  ...
  int SetMaximumFrameLatency(int MaxLatency) => ptr.ref.lpVtbl.value
      .elementAt(126)
      .cast<
          Pointer<NativeFunction<Int32 Function(Pointer, Uint32 MaxLatency)>>>()
      .value
      .asFunction<
          int Function(Pointer, int MaxLatency)>()(ptr.ref.lpVtbl, MaxLatency);
  ...
  int GetMaximumFrameLatency(Pointer<Uint32> pMaxLatency) => ptr
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Uint32> pMaxLatency)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Uint32> pMaxLatency)>()(
      ptr.ref.lpVtbl, pMaxLatency);
  ...
  int CheckDeviceState(int hDestinationWindow) => ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, IntPtr hDestinationWindow)>>>()
          .value
          .asFunction<int Function(Pointer, int hDestinationWindow)>()(
      ptr.ref.lpVtbl, hDestinationWindow);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppSurface,
                      Pointer<IntPtr> pSharedHandle,
                      int Usage)>()(ptr.ref.lpVtbl, Width, Height, Format, Pool,
  ...
  int
      ResetEx(Pointer<D3DPRESENT_PARAMETERS> pPresentationParameters,
