...
/// @nodoc
const IID_IDirect3DVertexDeclaration9 = '{DD13C59C-36FA-4098-A8FB-C7ED39DC8546}';
...
class IDirect3DVertexDeclaration9 extends IUnknown {
  ...
  int GetDeclaration(Pointer<D3DVERTEXELEMENT9> pElement, Pointer<Uint32> pNumElements) => ptr.ref.lpVtbl.value      .elementAt(4)
      .cast<Pointer<NativeFunction<_GetDeclaration_Native>>>()
      .value
      .asFunction<_GetDeclaration_Dart>()(ptr.ref.lpVtbl, pElement, pNumElements);
