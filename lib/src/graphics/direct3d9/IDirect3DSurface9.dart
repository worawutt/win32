...
class IDirect3DSurface9 extends IDirect3DResource9 {
  ...
  int GetContainer(Pointer<GUID> riid, Pointer<Pointer> ppContainer) => ptr.ref.lpVtbl.value      .elementAt(11)
      .cast<Pointer<NativeFunction<_GetContainer_Native>>>()
      .value
      .asFunction<_GetContainer_Dart>()(ptr.ref.lpVtbl, riid, ppContainer);

  int GetDesc(Pointer<D3DSURFACE_DESC> pDesc) => ptr.ref.lpVtbl.value      .elementAt(12)
      .cast<Pointer<NativeFunction<_GetDesc_Native>>>()
      .value
      .asFunction<_GetDesc_Dart>()(ptr.ref.lpVtbl, pDesc);

  int LockRect(Pointer<D3DLOCKED_RECT> pLockedRect, Pointer<RECT> pRect, int Flags) => ptr.ref.lpVtbl.value      .elementAt(13)
      .cast<Pointer<NativeFunction<_LockRect_Native>>>()
      .value
      .asFunction<_LockRect_Dart>()(ptr.ref.lpVtbl, pLockedRect, pRect, Flags);

  int UnlockRect() => ptr.ref.lpVtbl.value      .elementAt(14)
      .cast<Pointer<NativeFunction<_UnlockRect_Native>>>()
      .value
      .asFunction<_UnlockRect_Dart>()(ptr.ref.lpVtbl);

  int GetDC(Pointer<IntPtr> phdc) => ptr.ref.lpVtbl.value      .elementAt(15)
      .cast<Pointer<NativeFunction<_GetDC_Native>>>()
      .value
      .asFunction<_GetDC_Dart>()(ptr.ref.lpVtbl, phdc);

  int ReleaseDC(int hdc) => ptr.ref.lpVtbl.value      .elementAt(16)
