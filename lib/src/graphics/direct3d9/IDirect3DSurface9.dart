...
class IDirect3DSurface9 extends IDirect3DResource9 {
  ...
  int GetDesc(Pointer<D3DSURFACE_DESC> pDesc) => ptr.ref.lpVtbl.value
      ...
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<D3DSURFACE_DESC> pDesc)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<D3DSURFACE_DESC> pDesc)>()(ptr.ref.lpVtbl, pDesc);
      ...
      ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<D3DLOCKED_RECT> pLockedRect,
                  Pointer<RECT> pRect,
                  int Flags)>()(ptr.ref.lpVtbl, pLockedRect, pRect, Flags);
  ...
  int GetDC(Pointer<IntPtr> phdc) => ptr.ref.lpVtbl.value
      ...
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<IntPtr> phdc)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<IntPtr> phdc)>()(ptr.ref.lpVtbl, phdc);
