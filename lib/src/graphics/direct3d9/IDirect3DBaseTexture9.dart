...
class IDirect3DBaseTexture9 extends IDirect3DResource9 {
  ...
  int SetLOD(int LODNew) => ptr.ref.lpVtbl.value
      .elementAt(11)
      .cast<Pointer<NativeFunction<Uint32 Function(Pointer, Uint32 LODNew)>>>()
      .value
      .asFunction<int Function(Pointer, int LODNew)>()(ptr.ref.lpVtbl, LODNew);
  ...
  int SetAutoGenFilterType(int FilterType) => ptr.ref.lpVtbl.value
      .elementAt(14)
      .cast<
          Pointer<NativeFunction<Int32 Function(Pointer, Int32 FilterType)>>>()
      .value
      .asFunction<
          int Function(Pointer, int FilterType)>()(ptr.ref.lpVtbl, FilterType);
