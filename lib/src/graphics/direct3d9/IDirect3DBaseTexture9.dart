...
typedef _SetLOD_Native = Uint32 Function(
  Pointer,
  Uint32 LODNew
);
...
typedef _GetLOD_Native = Uint32 Function(
  Pointer);
typedef _GetLOD_Dart = int Function(
  Pointer);

typedef _GetLevelCount_Native = Uint32 Function(
  Pointer);
typedef _GetLevelCount_Dart = int Function(
  Pointer);
...
typedef _SetAutoGenFilterType_Dart = int Function(
  Pointer,
  int FilterType
);

typedef _GetAutoGenFilterType_Native = Uint32 Function(
  Pointer);
typedef _GetAutoGenFilterType_Dart = int Function(
  Pointer);

typedef _GenerateMipSubLevels_Native = Void Function(
  Pointer);
typedef _GenerateMipSubLevels_Dart = void Function(
  Pointer);
