...
class IDirect3DDevice9On12 extends IUnknown {
  ...
  int GetD3D12Device(Pointer<GUID> riid, Pointer<Pointer> ppvDevice) => ptr
      .ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
      ...
      .asFunction<
          int Function(Pointer, Pointer<GUID> riid,
              Pointer<Pointer> ppvDevice)>()(ptr.ref.lpVtbl, riid, ppvDevice);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> riid,
                      Pointer<Pointer> ppvResource12)>()(
          ptr.ref.lpVtbl, pResource, pCommandQueue, riid, ppvResource12);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint64> pSignalValues,
                      Pointer<Pointer<COMObject>> ppFences)>()(
          ptr.ref.lpVtbl, pResource, NumSync, pSignalValues, ppFences);
}
