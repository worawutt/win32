...
Pointer<COMObject> Direct3DCreate9On12(int SDKVersion,
        Pointer<D3D9ON12_ARGS> pOverrideList, int NumOverrideEntries) =>
...
late final _Direct3DCreate9On12 = _d3d9.lookupFunction<
    Pointer<COMObject> Function(Uint32 SDKVersion,
        Pointer<D3D9ON12_ARGS> pOverrideList, Uint32 NumOverrideEntries),
    Pointer<COMObject> Function(
        int SDKVersion,
        Pointer<D3D9ON12_ARGS> pOverrideList,
        int NumOverrideEntries)>('Direct3DCreate9On12');
