...
class IDXGISwapChain4 extends IDXGISwapChain3 {
  ...
  int SetHDRMetaData(int Type, int Size, Pointer pMetaData) => ptr
      .ref.lpVtbl.value
      .elementAt(40)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Int32 Type, Uint32 Size, Pointer pMetaData)>>>()
      .value
      .asFunction<
          int Function(Pointer, int Type, int Size,
              Pointer pMetaData)>()(ptr.ref.lpVtbl, Type, Size, pMetaData);
}
