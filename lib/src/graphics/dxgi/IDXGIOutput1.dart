...
class IDXGIOutput1 extends IDXGIOutput {
  ...
  int GetDisplayModeList1(int EnumFormat, int Flags, Pointer<Uint32> pNumModes,
  ...
  int GetDisplaySurfaceData1(Pointer<COMObject> pDestination) => ptr
      .ref.lpVtbl.value
      .elementAt(21)
      .cast<
          Pointer<
  ...
  int
      DuplicateOutput(Pointer<COMObject> pDevice,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(Pointer, Pointer<COMObject> pDevice,
                          Pointer<Pointer<COMObject>> ppOutputDuplication)>()(
              ptr.ref.lpVtbl, pDevice, ppOutputDuplication);
}
