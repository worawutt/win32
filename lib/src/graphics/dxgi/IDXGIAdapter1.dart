...
class IDXGIAdapter1 extends IDXGIAdapter {
  ...
  int GetDesc1(Pointer<DXGI_ADAPTER_DESC1> pDesc) => ptr.ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<DXGI_ADAPTER_DESC1> pDesc)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<DXGI_ADAPTER_DESC1> pDesc)>()(
