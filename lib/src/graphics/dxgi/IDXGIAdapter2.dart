...
class IDXGIAdapter2 extends IDXGIAdapter1 {
  ...
  int GetDesc2(Pointer<DXGI_ADAPTER_DESC2> pDesc) => ptr.ref.lpVtbl.value
          .elementAt(11)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<DXGI_ADAPTER_DESC2> pDesc)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<DXGI_ADAPTER_DESC2> pDesc)>()(
