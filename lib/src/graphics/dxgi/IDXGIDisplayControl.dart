...
class IDXGIDisplayControl extends IUnknown {
  ...
  void SetStereoEnabled(int enabled) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<Pointer<NativeFunction<Void Function(Pointer, Int32 enabled)>>>()
      .value
      .asFunction<
          void Function(Pointer, int enabled)>()(ptr.ref.lpVtbl, enabled);
}
