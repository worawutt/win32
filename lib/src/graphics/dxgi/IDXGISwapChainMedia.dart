...
class IDXGISwapChainMedia extends IUnknown {
  ...
  int GetFrameStatisticsMedia(Pointer<DXGI_FRAME_STATISTICS_MEDIA> pStats) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<DXGI_FRAME_STATISTICS_MEDIA> pStats)>()(
          ptr.ref.lpVtbl, pStats);

  int SetPresentDuration(int Duration) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Uint32 Duration)>>>()
      .value
      .asFunction<
          int Function(Pointer, int Duration)>()(ptr.ref.lpVtbl, Duration);
