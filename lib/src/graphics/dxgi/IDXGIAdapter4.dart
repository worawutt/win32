...
class IDXGIAdapter4 extends IDXGIAdapter3 {
  ...
  int GetDesc3(Pointer<DXGI_ADAPTER_DESC3> pDesc) => ptr.ref.lpVtbl.value
          .elementAt(18)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<DXGI_ADAPTER_DESC3> pDesc)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<DXGI_ADAPTER_DESC3> pDesc)>()(
