...
class IDXGIOutput6 extends IDXGIOutput5 {
  ...
  int GetDesc1(Pointer<DXGI_OUTPUT_DESC1> pDesc) => ptr.ref.lpVtbl.value
      .elementAt(27)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<DXGI_OUTPUT_DESC1> pDesc)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<DXGI_OUTPUT_DESC1> pDesc)>()(ptr.ref.lpVtbl, pDesc);

  int CheckHardwareCompositionSupport(Pointer<Uint32> pFlags) =>
