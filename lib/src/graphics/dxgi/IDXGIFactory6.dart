...
class IDXGIFactory6 extends IDXGIFactory5 {
  ...
  int EnumAdapterByGpuPreference(int Adapter, int GpuPreference,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int Adapter, int GpuPreference,
                      Pointer<GUID> riid, Pointer<Pointer> ppvAdapter)>()(
          ptr.ref.lpVtbl, Adapter, GpuPreference, riid, ppvAdapter);
}
