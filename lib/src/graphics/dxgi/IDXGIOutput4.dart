...
class IDXGIOutput4 extends IDXGIOutput3 {
  ...
  int CheckOverlayColorSpaceSupport(int Format, int ColorSpace,
          Pointer<COMObject> pConcernedDevice, Pointer<Uint32> pFlags) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pConcernedDevice,
                      Pointer<Uint32> pFlags)>()(
          ptr.ref.lpVtbl, Format, ColorSpace, pConcernedDevice, pFlags);
}
