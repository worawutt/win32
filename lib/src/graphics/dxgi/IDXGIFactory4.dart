...
class IDXGIFactory4 extends IDXGIFactory3 {
  ...
  int
      EnumAdapterByLuid(LUID AdapterLuid, Pointer<GUID> riid,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, LUID AdapterLuid,
                          Pointer<GUID> riid, Pointer<Pointer> ppvAdapter)>()(
              ptr.ref.lpVtbl, AdapterLuid, riid, ppvAdapter);

  int EnumWarpAdapter(Pointer<GUID> riid, Pointer<Pointer> ppvAdapter) => ptr
      .ref.lpVtbl.value
      .elementAt(27)
      .cast<
          Pointer<
      ...
      .asFunction<
          int Function(Pointer, Pointer<GUID> riid,
              Pointer<Pointer> ppvAdapter)>()(ptr.ref.lpVtbl, riid, ppvAdapter);
}
