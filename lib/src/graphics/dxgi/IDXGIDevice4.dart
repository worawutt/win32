...
class IDXGIDevice4 extends IDXGIDevice3 {
  ...
  int OfferResources1(int NumResources, Pointer<Pointer<COMObject>> ppResources,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int Priority,
                      int Flags)>()(
          ptr.ref.lpVtbl, NumResources, ppResources, Priority, Flags);

  int ReclaimResources1(int NumResources,
          Pointer<Pointer<COMObject>> ppResources, Pointer<Int32> pResults) =>
      ptr.ref.lpVtbl.value
              .elementAt(19)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppResources,
                      Pointer<Int32> pResults)>()(
          ptr.ref.lpVtbl, NumResources, ppResources, pResults);
}
