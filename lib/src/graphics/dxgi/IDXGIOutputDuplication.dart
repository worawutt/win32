...
class IDXGIOutputDuplication extends IDXGIObject {
  ...
  void GetDesc(Pointer<DXGI_OUTDUPL_DESC> pDesc) => ptr.ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<
              NativeFunction<
                  Void Function(Pointer, Pointer<DXGI_OUTDUPL_DESC> pDesc)>>>()
      .value
      .asFunction<
          void Function(Pointer,
              Pointer<DXGI_OUTDUPL_DESC> pDesc)>()(ptr.ref.lpVtbl, pDesc);
  ...
  int MapDesktopSurface(Pointer<DXGI_MAPPED_RECT> pLockedRect) => ptr
          .ref.lpVtbl.value
          .elementAt(12)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<DXGI_MAPPED_RECT> pLockedRect)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<DXGI_MAPPED_RECT> pLockedRect)>()(
      ptr.ref.lpVtbl, pLockedRect);
