...
class IDXGIDevice extends IDXGIObject {
  ...
  int GetAdapter(Pointer<Pointer<COMObject>> pAdapter) => ptr.ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> pAdapter)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> pAdapter)>()(
      ptr.ref.lpVtbl, pAdapter);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int Usage,
                      Pointer<DXGI_SHARED_RESOURCE> pSharedResource,
                      Pointer<Pointer<COMObject>> ppSurface)>()(ptr.ref.lpVtbl,
          pDesc, NumSurfaces, Usage, pSharedResource, ppSurface);

  int QueryResourceResidency(Pointer<Pointer<COMObject>> ppResources,
          Pointer<Int32> pResidencyStatus, int NumResources) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<COMObject>> ppResources,
                      Pointer<Int32> pResidencyStatus, int NumResources)>()(
          ptr.ref.lpVtbl, ppResources, pResidencyStatus, NumResources);
