...
int CommonPropertySheetUI(
    ...
    _CommonPropertySheetUI(hWndOwner, pfnPropSheetUI, lParam, pResult);
...
late final _CommonPropertySheetUI = _compstui.lookupFunction<
    ...
    int Function(
        ...
        Pointer<NativeFunction<PFNPROPSHEETUI>> pfnPropSheetUI,
        int lParam,
        Pointer<Uint32> pResult)>('CommonPropertySheetUIW');

int GetCPSUIUserData(int hDlg) => _GetCPSUIUserData(hDlg);

late final _GetCPSUIUserData = _compstui.lookupFunction<
    IntPtr Function(IntPtr hDlg), int Function(int hDlg)>('GetCPSUIUserData');

int SetCPSUIUserData(int hDlg, int CPSUIUserData) =>
    _SetCPSUIUserData(hDlg, CPSUIUserData);

late final _SetCPSUIUserData = _compstui.lookupFunction<
    Int32 Function(IntPtr hDlg, IntPtr CPSUIUserData),
    int Function(int hDlg, int CPSUIUserData)>('SetCPSUIUserData');
...
int AddMonitor(Pointer<Utf16> pName, int Level, Pointer<Uint8> pMonitors) =>
    _AddMonitor(pName, Level, pMonitors);

late final _AddMonitor = _winspool.lookupFunction<
    Int32 Function(
        Pointer<Utf16> pName, Uint32 Level, Pointer<Uint8> pMonitors),
    int Function(Pointer<Utf16> pName, int Level,
        Pointer<Uint8> pMonitors)>('AddMonitorW');

int AddPort(Pointer<Utf16> pName, int hWnd, Pointer<Utf16> pMonitorName) =>
    _AddPort(pName, hWnd, pMonitorName);

late final _AddPort = _winspool.lookupFunction<
    Int32 Function(
        Pointer<Utf16> pName, IntPtr hWnd, Pointer<Utf16> pMonitorName),
    int Function(Pointer<Utf16> pName, int hWnd,
        Pointer<Utf16> pMonitorName)>('AddPortW');

int AddPrintProcessor(Pointer<Utf16> pName, Pointer<Utf16> pEnvironment,
        Pointer<Utf16> pPathName, Pointer<Utf16> pPrintProcessorName) =>
    _AddPrintProcessor(pName, pEnvironment, pPathName, pPrintProcessorName);

late final _AddPrintProcessor = _winspool.lookupFunction<
    Int32 Function(Pointer<Utf16> pName, Pointer<Utf16> pEnvironment,
        Pointer<Utf16> pPathName, Pointer<Utf16> pPrintProcessorName),
    int Function(
        Pointer<Utf16> pName,
        Pointer<Utf16> pEnvironment,
        Pointer<Utf16> pPathName,
        Pointer<Utf16> pPrintProcessorName)>('AddPrintProcessorW');

int AddPrintProvidor(
        Pointer<Utf16> pName, int Level, Pointer<Uint8> pProvidorInfo) =>
    _AddPrintProvidor(pName, Level, pProvidorInfo);

late final _AddPrintProvidor = _winspool.lookupFunction<
    Int32 Function(
        Pointer<Utf16> pName, Uint32 Level, Pointer<Uint8> pProvidorInfo),
    int Function(Pointer<Utf16> pName, int Level,
        Pointer<Uint8> pProvidorInfo)>('AddPrintProvidorW');
...
int AddPrinterDriverEx(Pointer<Utf16> pName, int Level,
        Pointer<Uint8> lpbDriverInfo, int dwFileCopyFlags) =>
    _AddPrinterDriverEx(pName, Level, lpbDriverInfo, dwFileCopyFlags);

late final _AddPrinterDriverEx = _winspool.lookupFunction<
    Int32 Function(Pointer<Utf16> pName, Uint32 Level,
        Pointer<Uint8> lpbDriverInfo, Uint32 dwFileCopyFlags),
    int Function(Pointer<Utf16> pName, int Level, Pointer<Uint8> lpbDriverInfo,
        int dwFileCopyFlags)>('AddPrinterDriverExW');

int AddPrinterDriver(
        Pointer<Utf16> pName, int Level, Pointer<Uint8> pDriverInfo) =>
    _AddPrinterDriver(pName, Level, pDriverInfo);

late final _AddPrinterDriver = _winspool.lookupFunction<
    Int32 Function(
        Pointer<Utf16> pName, Uint32 Level, Pointer<Uint8> pDriverInfo),
    int Function(Pointer<Utf16> pName, int Level,
        Pointer<Uint8> pDriverInfo)>('AddPrinterDriverW');
...
int CorePrinterDriverInstalled(
    ...
    _CorePrinterDriverInstalled(pszServer, pszEnvironment, CoreDriverGUID,
...
late final _CorePrinterDriverInstalled = _winspool.lookupFunction<
    ...
    int Function(
        ...
        FILETIME ftDriverDate,
        int dwlDriverVersion,
        Pointer<Int32> pbDriverInstalled)>('CorePrinterDriverInstalledW');
...
int CreatePrintAsyncNotifyChannel(
    ...
    _CreatePrintAsyncNotifyChannel(pszName, pNotificationType, eUserFilter,
        eConversationStyle, pCallback, ppIAsynchNotification);
...
int CreatePrinterIC(int hPrinter, Pointer<DEVMODE> pDevMode) =>
    _CreatePrinterIC(hPrinter, pDevMode);

late final _CreatePrinterIC = _winspool.lookupFunction<
    IntPtr Function(IntPtr hPrinter, Pointer<DEVMODE> pDevMode),
    int Function(int hPrinter, Pointer<DEVMODE> pDevMode)>('CreatePrinterIC');
...
int DeleteJobNamedProperty(int hPrinter, int JobId, Pointer<Utf16> pszName) =>
    _DeleteJobNamedProperty(hPrinter, JobId, pszName);

late final _DeleteJobNamedProperty = _winspool.lookupFunction<
    Uint32 Function(IntPtr hPrinter, Uint32 JobId, Pointer<Utf16> pszName),
    int Function(int hPrinter, int JobId,
        Pointer<Utf16> pszName)>('DeleteJobNamedProperty');

int DeleteMonitor(Pointer<Utf16> pName, Pointer<Utf16> pEnvironment,
        Pointer<Utf16> pMonitorName) =>
    _DeleteMonitor(pName, pEnvironment, pMonitorName);

late final _DeleteMonitor = _winspool.lookupFunction<
    Int32 Function(Pointer<Utf16> pName, Pointer<Utf16> pEnvironment,
        Pointer<Utf16> pMonitorName),
    int Function(Pointer<Utf16> pName, Pointer<Utf16> pEnvironment,
        Pointer<Utf16> pMonitorName)>('DeleteMonitorW');

int DeletePort(Pointer<Utf16> pName, int hWnd, Pointer<Utf16> pPortName) =>
    _DeletePort(pName, hWnd, pPortName);

late final _DeletePort = _winspool.lookupFunction<
    Int32 Function(Pointer<Utf16> pName, IntPtr hWnd, Pointer<Utf16> pPortName),
    int Function(Pointer<Utf16> pName, int hWnd,
        Pointer<Utf16> pPortName)>('DeletePortW');

int DeletePrintProcessor(Pointer<Utf16> pName, Pointer<Utf16> pEnvironment,
        Pointer<Utf16> pPrintProcessorName) =>
    _DeletePrintProcessor(pName, pEnvironment, pPrintProcessorName);

late final _DeletePrintProcessor = _winspool.lookupFunction<
    Int32 Function(Pointer<Utf16> pName, Pointer<Utf16> pEnvironment,
        Pointer<Utf16> pPrintProcessorName),
    int Function(Pointer<Utf16> pName, Pointer<Utf16> pEnvironment,
        Pointer<Utf16> pPrintProcessorName)>('DeletePrintProcessorW');

int DeletePrintProvidor(Pointer<Utf16> pName, Pointer<Utf16> pEnvironment,
        Pointer<Utf16> pPrintProvidorName) =>
    _DeletePrintProvidor(pName, pEnvironment, pPrintProvidorName);

late final _DeletePrintProvidor = _winspool.lookupFunction<
    Int32 Function(Pointer<Utf16> pName, Pointer<Utf16> pEnvironment,
        Pointer<Utf16> pPrintProvidorName),
    int Function(Pointer<Utf16> pName, Pointer<Utf16> pEnvironment,
        Pointer<Utf16> pPrintProvidorName)>('DeletePrintProvidorW');
...
int DeletePrinterDriverEx(Pointer<Utf16> pName, Pointer<Utf16> pEnvironment,
        Pointer<Utf16> pDriverName, int dwDeleteFlag, int dwVersionFlag) =>
...
late final _DeletePrinterDriverEx = _winspool.lookupFunction<
    Int32 Function(Pointer<Utf16> pName, Pointer<Utf16> pEnvironment,
        Pointer<Utf16> pDriverName, Uint32 dwDeleteFlag, Uint32 dwVersionFlag),
    int Function(
        Pointer<Utf16> pName,
        Pointer<Utf16> pEnvironment,
        Pointer<Utf16> pDriverName,
        int dwDeleteFlag,
        int dwVersionFlag)>('DeletePrinterDriverExW');

int DeletePrinterDriverPackage(Pointer<Utf16> pszServer,
        Pointer<Utf16> pszInfPath, Pointer<Utf16> pszEnvironment) =>
    _DeletePrinterDriverPackage(pszServer, pszInfPath, pszEnvironment);

late final _DeletePrinterDriverPackage = _winspool.lookupFunction<
    Int32 Function(Pointer<Utf16> pszServer, Pointer<Utf16> pszInfPath,
        Pointer<Utf16> pszEnvironment),
    int Function(Pointer<Utf16> pszServer, Pointer<Utf16> pszInfPath,
        Pointer<Utf16> pszEnvironment)>('DeletePrinterDriverPackageW');

int DeletePrinterDriver(Pointer<Utf16> pName, Pointer<Utf16> pEnvironment,
        Pointer<Utf16> pDriverName) =>
    _DeletePrinterDriver(pName, pEnvironment, pDriverName);

late final _DeletePrinterDriver = _winspool.lookupFunction<
    Int32 Function(Pointer<Utf16> pName, Pointer<Utf16> pEnvironment,
        Pointer<Utf16> pDriverName),
    int Function(Pointer<Utf16> pName, Pointer<Utf16> pEnvironment,
        Pointer<Utf16> pDriverName)>('DeletePrinterDriverW');

int DeletePrinterIC(int hPrinterIC) => _DeletePrinterIC(hPrinterIC);

late final _DeletePrinterIC = _winspool.lookupFunction<
    Int32 Function(IntPtr hPrinterIC),
    int Function(int hPrinterIC)>('DeletePrinterIC');
...
int DevQueryPrint(
        int hPrinter, Pointer<DEVMODE> pDevMode, Pointer<Uint32> pResID) =>
    _DevQueryPrint(hPrinter, pDevMode, pResID);

late final _DevQueryPrint = _winspool.lookupFunction<
    Int32 Function(
        IntPtr hPrinter, Pointer<DEVMODE> pDevMode, Pointer<Uint32> pResID),
    int Function(int hPrinter, Pointer<DEVMODE> pDevMode,
        Pointer<Uint32> pResID)>('DevQueryPrint');

int DevQueryPrintEx(Pointer<DEVQUERYPRINT_INFO> pDQPInfo) =>
    _DevQueryPrintEx(pDQPInfo);

late final _DevQueryPrintEx = _winspool.lookupFunction<
    Int32 Function(Pointer<DEVQUERYPRINT_INFO> pDQPInfo),
    int Function(Pointer<DEVQUERYPRINT_INFO> pDQPInfo)>('DevQueryPrintEx');
...
int EnumJobNamedProperties(
    ...
    _EnumJobNamedProperties(hPrinter, JobId, pcProperties, ppProperties);

late final _EnumJobNamedProperties = _winspool.lookupFunction<
    Uint32 Function(IntPtr hPrinter, Uint32 JobId, Pointer<Uint32> pcProperties,
        Pointer<Pointer<PrintNamedProperty>> ppProperties),
    int Function(
        int hPrinter,
        int JobId,
        Pointer<Uint32> pcProperties,
        Pointer<Pointer<PrintNamedProperty>>
            ppProperties)>('EnumJobNamedProperties');
...
int EnumMonitors(Pointer<Utf16> pName, int Level, Pointer<Uint8> pMonitor,
        int cbBuf, Pointer<Uint32> pcbNeeded, Pointer<Uint32> pcReturned) =>
    _EnumMonitors(pName, Level, pMonitor, cbBuf, pcbNeeded, pcReturned);

late final _EnumMonitors = _winspool.lookupFunction<
    Int32 Function(Pointer<Utf16> pName, Uint32 Level, Pointer<Uint8> pMonitor,
        Uint32 cbBuf, Pointer<Uint32> pcbNeeded, Pointer<Uint32> pcReturned),
    int Function(
        Pointer<Utf16> pName,
        int Level,
        ...
        int cbBuf,
        Pointer<Uint32> pcbNeeded,
        Pointer<Uint32> pcReturned)>('EnumMonitorsW');

int EnumPorts(Pointer<Utf16> pName, int Level, Pointer<Uint8> pPort, int cbBuf,
        Pointer<Uint32> pcbNeeded, Pointer<Uint32> pcReturned) =>
    _EnumPorts(pName, Level, pPort, cbBuf, pcbNeeded, pcReturned);

late final _EnumPorts = _winspool.lookupFunction<
    Int32 Function(Pointer<Utf16> pName, Uint32 Level, Pointer<Uint8> pPort,
        Uint32 cbBuf, Pointer<Uint32> pcbNeeded, Pointer<Uint32> pcReturned),
    int Function(
        Pointer<Utf16> pName,
        int Level,
        ...
        int cbBuf,
        Pointer<Uint32> pcbNeeded,
        Pointer<Uint32> pcReturned)>('EnumPortsW');
...
int EnumPrintProcessorDatatypes(
        ...
        Pointer<Uint32> pcbNeeded,
        Pointer<Uint32> pcReturned) =>
    _EnumPrintProcessorDatatypes(pName, pPrintProcessorName, Level, pDatatypes,
...
late final _EnumPrintProcessorDatatypes = _winspool.lookupFunction<
    ...
    int Function(
        ...
        int cbBuf,
        Pointer<Uint32> pcbNeeded,
        Pointer<Uint32> pcReturned)>('EnumPrintProcessorDatatypesW');
...
int EnumPrintProcessors(
        ...
        Pointer<Uint32> pcbNeeded,
        Pointer<Uint32> pcReturned) =>
    _EnumPrintProcessors(pName, pEnvironment, Level, pPrintProcessorInfo, cbBuf,
...
late final _EnumPrintProcessors = _winspool.lookupFunction<
    ...
    int Function(
        ...
        int cbBuf,
        Pointer<Uint32> pcbNeeded,
        Pointer<Uint32> pcReturned)>('EnumPrintProcessorsW');
...
late final _EnumPrinterDrivers = _winspool.lookupFunction<
    ...
    int Function(
        ...
        int cbBuf,
        Pointer<Uint32> pcbNeeded,
        Pointer<Uint32> pcReturned)>('EnumPrinterDriversW');
...
int ExtDeviceMode(
        ...
        int fMode) =>
    _ExtDeviceMode(hWnd, hInst, pDevModeOutput, pDeviceName, pPort,
        pDevModeInput, pProfile, fMode);
...
void FreePrintNamedPropertyArray(
        int cProperties, Pointer<Pointer<PrintNamedProperty>> ppProperties) =>
    _FreePrintNamedPropertyArray(cProperties, ppProperties);

late final _FreePrintNamedPropertyArray = _winspool.lookupFunction<
    Void Function(
        Uint32 cProperties, Pointer<Pointer<PrintNamedProperty>> ppProperties),
    void Function(
        int cProperties,
        Pointer<Pointer<PrintNamedProperty>>
            ppProperties)>('FreePrintNamedPropertyArray');

void FreePrintPropertyValue(Pointer<PrintPropertyValue> pValue) =>
    _FreePrintPropertyValue(pValue);

late final _FreePrintPropertyValue = _winspool.lookupFunction<
    Void Function(Pointer<PrintPropertyValue> pValue),
    void Function(
        Pointer<PrintPropertyValue> pValue)>('FreePrintPropertyValue');
...
int GetCorePrinterDrivers(
    ...
    _GetCorePrinterDrivers(pszServer, pszEnvironment,
        pszzCoreDriverDependencies, cCorePrinterDrivers, pCorePrinterDrivers);
...
int GetJobNamedPropertyValue(int hPrinter, int JobId, Pointer<Utf16> pszName,
        Pointer<PrintPropertyValue> pValue) =>
    _GetJobNamedPropertyValue(hPrinter, JobId, pszName, pValue);

late final _GetJobNamedPropertyValue = _winspool.lookupFunction<
    Uint32 Function(IntPtr hPrinter, Uint32 JobId, Pointer<Utf16> pszName,
        Pointer<PrintPropertyValue> pValue),
    int Function(int hPrinter, int JobId, Pointer<Utf16> pszName,
        Pointer<PrintPropertyValue> pValue)>('GetJobNamedPropertyValue');
...
int GetPrintOutputInfo(int hWnd, Pointer<Utf16> pszPrinter,
        Pointer<IntPtr> phFile, Pointer<Pointer<Utf16>> ppszOutputFile) =>
    _GetPrintOutputInfo(hWnd, pszPrinter, phFile, ppszOutputFile);

late final _GetPrintOutputInfo = _winspool.lookupFunction<
    Int32 Function(IntPtr hWnd, Pointer<Utf16> pszPrinter,
        Pointer<IntPtr> phFile, Pointer<Pointer<Utf16>> ppszOutputFile),
    int Function(int hWnd, Pointer<Utf16> pszPrinter, Pointer<IntPtr> phFile,
        Pointer<Pointer<Utf16>> ppszOutputFile)>('GetPrintOutputInfo');
...
late final _GetPrintProcessorDirectory = _winspool.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint8> pPrintProcessorInfo,
        int cbBuf,
        Pointer<Uint32> pcbNeeded)>('GetPrintProcessorDirectoryW');
...
int GetPrinterDriver2(
        ...
        Pointer<Uint32> pcbNeeded) =>
    _GetPrinterDriver2(
        hWnd, hPrinter, pEnvironment, Level, pDriverInfo, cbBuf, pcbNeeded);
...
late final _GetPrinterDriver2 = _winspool.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint8> pDriverInfo,
        int cbBuf,
        Pointer<Uint32> pcbNeeded)>('GetPrinterDriver2W');
...
late final _GetPrinterDriverDirectory = _winspool.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint8> pDriverDirectory,
        int cbBuf,
        Pointer<Uint32> pcbNeeded)>('GetPrinterDriverDirectoryW');
...
late final _GetPrinterDriverPackagePath = _winspool.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Utf16> pszDriverPackageCab,
        int cchDriverPackageCab,
        Pointer<Uint32> pcchRequiredSize)>('GetPrinterDriverPackagePathW');

int GetPrinterDriver(int hPrinter, Pointer<Utf16> pEnvironment, int Level,
        Pointer<Uint8> pDriverInfo, int cbBuf, Pointer<Uint32> pcbNeeded) =>
    _GetPrinterDriver(
        hPrinter, pEnvironment, Level, pDriverInfo, cbBuf, pcbNeeded);

late final _GetPrinterDriver = _winspool.lookupFunction<
    Int32 Function(IntPtr hPrinter, Pointer<Utf16> pEnvironment, Uint32 Level,
        Pointer<Uint8> pDriverInfo, Uint32 cbBuf, Pointer<Uint32> pcbNeeded),
    int Function(
        int hPrinter,
        Pointer<Utf16> pEnvironment,
        int Level,
        Pointer<Uint8> pDriverInfo,
        int cbBuf,
        Pointer<Uint32> pcbNeeded)>('GetPrinterDriverW');
...
int InstallPrinterDriverFromPackage(
    ...
    _InstallPrinterDriverFromPackage(
        pszServer, pszInfPath, pszDriverName, pszEnvironment, dwFlags);
...
late final _InstallPrinterDriverFromPackage = _winspool.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Utf16> pszDriverName,
        Pointer<Utf16> pszEnvironment,
        int dwFlags)>('InstallPrinterDriverFromPackageW');
...
int PlayGdiScriptOnPrinterIC(int hPrinterIC, Pointer<Uint8> pIn, int cIn,
        Pointer<Uint8> pOut, int cOut, int ul) =>
    _PlayGdiScriptOnPrinterIC(hPrinterIC, pIn, cIn, pOut, cOut, ul);

late final _PlayGdiScriptOnPrinterIC = _winspool.lookupFunction<
    Int32 Function(IntPtr hPrinterIC, Pointer<Uint8> pIn, Uint32 cIn,
        Pointer<Uint8> pOut, Uint32 cOut, Uint32 ul),
    int Function(int hPrinterIC, Pointer<Uint8> pIn, int cIn,
        Pointer<Uint8> pOut, int cOut, int ul)>('PlayGdiScriptOnPrinterIC');

int PrinterMessageBox(int hPrinter, int Error, int hWnd, Pointer<Utf16> pText,
        Pointer<Utf16> pCaption, int dwType) =>
    _PrinterMessageBox(hPrinter, Error, hWnd, pText, pCaption, dwType);

late final _PrinterMessageBox = _winspool.lookupFunction<
    Uint32 Function(IntPtr hPrinter, Uint32 Error, IntPtr hWnd,
        Pointer<Utf16> pText, Pointer<Utf16> pCaption, Uint32 dwType),
    int Function(int hPrinter, int Error, int hWnd, Pointer<Utf16> pText,
        Pointer<Utf16> pCaption, int dwType)>('PrinterMessageBoxW');
...
int RegisterForPrintAsyncNotifications(
    ...
    _RegisterForPrintAsyncNotifications(pszName, pNotificationType, eUserFilter,
...
late final _RegisterForPrintAsyncNotifications = _winspool.lookupFunction<
    ...
    int Function(
        ...
        int eConversationStyle,
        Pointer<COMObject> pCallback,
        Pointer<IntPtr> phNotify)>('RegisterForPrintAsyncNotifications');
...
int RouterFreeBidiResponseContainer(Pointer<BIDI_RESPONSE_CONTAINER> pData) =>
    _RouterFreeBidiResponseContainer(pData);

late final _RouterFreeBidiResponseContainer = _winspool.lookupFunction<
        Uint32 Function(Pointer<BIDI_RESPONSE_CONTAINER> pData),
        int Function(Pointer<BIDI_RESPONSE_CONTAINER> pData)>(
...
int SetJobNamedProperty(
        int hPrinter, int JobId, Pointer<PrintNamedProperty> pProperty) =>
    _SetJobNamedProperty(hPrinter, JobId, pProperty);

late final _SetJobNamedProperty = _winspool.lookupFunction<
    Uint32 Function(
        IntPtr hPrinter, Uint32 JobId, Pointer<PrintNamedProperty> pProperty),
    int Function(int hPrinter, int JobId,
        Pointer<PrintNamedProperty> pProperty)>('SetJobNamedProperty');
...
int UnRegisterForPrintAsyncNotifications(int param0) =>
    _UnRegisterForPrintAsyncNotifications(param0);

late final _UnRegisterForPrintAsyncNotifications = _winspool.lookupFunction<
    Int32 Function(IntPtr param0),
    int Function(int param0)>('UnRegisterForPrintAsyncNotifications');
...
int UploadPrinterDriverPackage(
    ...
    _UploadPrinterDriverPackage(pszServer, pszInfPath, pszEnvironment, dwFlags,
        hwnd, pszDestInfPath, pcchDestInfPath);
...
late final _UploadPrinterDriverPackage = _winspool.lookupFunction<
    ...
    int Function(
        ...
        int hwnd,
        Pointer<Utf16> pszDestInfPath,
        Pointer<Uint32> pcchDestInfPath)>('UploadPrinterDriverPackageW');

int WaitForPrinterChange(int hPrinter, int Flags) =>
    _WaitForPrinterChange(hPrinter, Flags);

late final _WaitForPrinterChange = _winspool.lookupFunction<
    Uint32 Function(IntPtr hPrinter, Uint32 Flags),
    int Function(int hPrinter, int Flags)>('WaitForPrinterChange');
...
int XcvData(
    ...
    _XcvData(hXcv, pszDataName, pInputData, cbInputData, pOutputData,
...
late final _XcvData = _winspool.lookupFunction<
    ...
    int Function(
        ...
        int cbOutputData,
        Pointer<Uint32> pcbOutputNeeded,
        Pointer<Uint32> pdwStatus)>('XcvDataW');
...
int GdiDeleteSpoolFileHandle(int SpoolFileHandle) =>
    _GdiDeleteSpoolFileHandle(SpoolFileHandle);

late final _GdiDeleteSpoolFileHandle = _gdi32.lookupFunction<
    Int32 Function(IntPtr SpoolFileHandle),
    int Function(int SpoolFileHandle)>('GdiDeleteSpoolFileHandle');

int GdiEndDocEMF(int SpoolFileHandle) => _GdiEndDocEMF(SpoolFileHandle);

late final _GdiEndDocEMF = _gdi32.lookupFunction<
    Int32 Function(IntPtr SpoolFileHandle),
    int Function(int SpoolFileHandle)>('GdiEndDocEMF');

int GdiEndPageEMF(int SpoolFileHandle, int dwOptimization) =>
    _GdiEndPageEMF(SpoolFileHandle, dwOptimization);

late final _GdiEndPageEMF = _gdi32.lookupFunction<
    Int32 Function(IntPtr SpoolFileHandle, Uint32 dwOptimization),
    int Function(int SpoolFileHandle, int dwOptimization)>('GdiEndPageEMF');

int GdiGetDC(int SpoolFileHandle) => _GdiGetDC(SpoolFileHandle);

late final _GdiGetDC = _gdi32.lookupFunction<
    IntPtr Function(IntPtr SpoolFileHandle),
    int Function(int SpoolFileHandle)>('GdiGetDC');

int GdiGetDevmodeForPage(int SpoolFileHandle, int dwPageNumber,
        Pointer<Pointer<DEVMODE>> pCurrDM, Pointer<Pointer<DEVMODE>> pLastDM) =>
    _GdiGetDevmodeForPage(SpoolFileHandle, dwPageNumber, pCurrDM, pLastDM);

late final _GdiGetDevmodeForPage = _gdi32.lookupFunction<
    Int32 Function(IntPtr SpoolFileHandle, Uint32 dwPageNumber,
        Pointer<Pointer<DEVMODE>> pCurrDM, Pointer<Pointer<DEVMODE>> pLastDM),
    int Function(
        int SpoolFileHandle,
        int dwPageNumber,
        Pointer<Pointer<DEVMODE>> pCurrDM,
        Pointer<Pointer<DEVMODE>> pLastDM)>('GdiGetDevmodeForPage');

int GdiGetPageCount(int SpoolFileHandle) => _GdiGetPageCount(SpoolFileHandle);

late final _GdiGetPageCount = _gdi32.lookupFunction<
    Uint32 Function(IntPtr SpoolFileHandle),
    int Function(int SpoolFileHandle)>('GdiGetPageCount');

int GdiGetPageHandle(
        int SpoolFileHandle, int Page, Pointer<Uint32> pdwPageType) =>
    _GdiGetPageHandle(SpoolFileHandle, Page, pdwPageType);

late final _GdiGetPageHandle = _gdi32.lookupFunction<
    IntPtr Function(
        IntPtr SpoolFileHandle, Uint32 Page, Pointer<Uint32> pdwPageType),
    int Function(int SpoolFileHandle, int Page,
        Pointer<Uint32> pdwPageType)>('GdiGetPageHandle');

int GdiGetSpoolFileHandle(Pointer<Utf16> pwszPrinterName,
        Pointer<DEVMODE> pDevmode, Pointer<Utf16> pwszDocName) =>
    _GdiGetSpoolFileHandle(pwszPrinterName, pDevmode, pwszDocName);

late final _GdiGetSpoolFileHandle = _gdi32.lookupFunction<
    IntPtr Function(Pointer<Utf16> pwszPrinterName, Pointer<DEVMODE> pDevmode,
        Pointer<Utf16> pwszDocName),
    int Function(Pointer<Utf16> pwszPrinterName, Pointer<DEVMODE> pDevmode,
        Pointer<Utf16> pwszDocName)>('GdiGetSpoolFileHandle');

int GdiPlayPageEMF(int SpoolFileHandle, int hemf, Pointer<RECT> prectDocument,
        Pointer<RECT> prectBorder, Pointer<RECT> prectClip) =>
    _GdiPlayPageEMF(
...
late final _GdiPlayPageEMF = _gdi32.lookupFunction<
    ...
    int Function(int SpoolFileHandle, int hemf, Pointer<RECT> prectDocument,
        Pointer<RECT> prectBorder, Pointer<RECT> prectClip)>('GdiPlayPageEMF');

int GdiResetDCEMF(int SpoolFileHandle, Pointer<DEVMODE> pCurrDM) =>
    _GdiResetDCEMF(SpoolFileHandle, pCurrDM);

late final _GdiResetDCEMF = _gdi32.lookupFunction<
    Int32 Function(IntPtr SpoolFileHandle, Pointer<DEVMODE> pCurrDM),
    int Function(
        int SpoolFileHandle, Pointer<DEVMODE> pCurrDM)>('GdiResetDCEMF');

int GdiStartDocEMF(int SpoolFileHandle, Pointer<DOCINFO> pDocInfo) =>
    _GdiStartDocEMF(SpoolFileHandle, pDocInfo);

late final _GdiStartDocEMF = _gdi32.lookupFunction<
    Int32 Function(IntPtr SpoolFileHandle, Pointer<DOCINFO> pDocInfo),
    int Function(
        int SpoolFileHandle, Pointer<DOCINFO> pDocInfo)>('GdiStartDocEMF');

int GdiStartPageEMF(int SpoolFileHandle) => _GdiStartPageEMF(SpoolFileHandle);

late final _GdiStartPageEMF = _gdi32.lookupFunction<
    Int32 Function(IntPtr SpoolFileHandle),
    int Function(int SpoolFileHandle)>('GdiStartPageEMF');
...
int AddPrintDeviceObject(int hPrinter, Pointer<IntPtr> phDeviceObject) =>
    _AddPrintDeviceObject(hPrinter, phDeviceObject);

late final _AddPrintDeviceObject = _spoolss.lookupFunction<
    Int32 Function(IntPtr hPrinter, Pointer<IntPtr> phDeviceObject),
    int Function(
        int hPrinter, Pointer<IntPtr> phDeviceObject)>('AddPrintDeviceObject');

int AppendPrinterNotifyInfoData(Pointer<PRINTER_NOTIFY_INFO> pInfoDest,
        Pointer<PRINTER_NOTIFY_INFO_DATA> pDataSrc, int fdwFlags) =>
    _AppendPrinterNotifyInfoData(pInfoDest, pDataSrc, fdwFlags);

late final _AppendPrinterNotifyInfoData = _spoolss.lookupFunction<
    Int32 Function(Pointer<PRINTER_NOTIFY_INFO> pInfoDest,
        Pointer<PRINTER_NOTIFY_INFO_DATA> pDataSrc, Uint32 fdwFlags),
    int Function(
        Pointer<PRINTER_NOTIFY_INFO> pInfoDest,
        Pointer<PRINTER_NOTIFY_INFO_DATA> pDataSrc,
        int fdwFlags)>('AppendPrinterNotifyInfoData');
...
int CallRouterFindFirstPrinterChangeNotification(
    ...
    _CallRouterFindFirstPrinterChangeNotification(hPrinterRPC, fdwFilterFlags,
        fdwOptions, hNotify, pPrinterNotifyOptions);
...
int GetJobAttributes(Pointer<Utf16> pPrinterName, Pointer<DEVMODE> pDevmode,
        Pointer<ATTRIBUTE_INFO_3> pAttributeInfo) =>
    _GetJobAttributes(pPrinterName, pDevmode, pAttributeInfo);

late final _GetJobAttributes = _spoolss.lookupFunction<
    Int32 Function(Pointer<Utf16> pPrinterName, Pointer<DEVMODE> pDevmode,
        Pointer<ATTRIBUTE_INFO_3> pAttributeInfo),
    int Function(Pointer<Utf16> pPrinterName, Pointer<DEVMODE> pDevmode,
        Pointer<ATTRIBUTE_INFO_3> pAttributeInfo)>('GetJobAttributes');

int GetJobAttributesEx(Pointer<Utf16> pPrinterName, Pointer<DEVMODE> pDevmode,
        int dwLevel, Pointer<Uint8> pAttributeInfo, int nSize, int dwFlags) =>
    _GetJobAttributesEx(
        pPrinterName, pDevmode, dwLevel, pAttributeInfo, nSize, dwFlags);
...
late final _GetJobAttributesEx = _spoolss.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint8> pAttributeInfo,
        int nSize,
        int dwFlags)>('GetJobAttributesEx');

int ImpersonatePrinterClient(int hToken) => _ImpersonatePrinterClient(hToken);

late final _ImpersonatePrinterClient = _spoolss.lookupFunction<
    Int32 Function(IntPtr hToken),
    int Function(int hToken)>('ImpersonatePrinterClient');

int PartialReplyPrinterChangeNotification(
        int hPrinter, Pointer<PRINTER_NOTIFY_INFO_DATA> pDataSrc) =>
    _PartialReplyPrinterChangeNotification(hPrinter, pDataSrc);

late final _PartialReplyPrinterChangeNotification = _spoolss.lookupFunction<
    Int32 Function(IntPtr hPrinter, Pointer<PRINTER_NOTIFY_INFO_DATA> pDataSrc),
    int Function(
        int hPrinter,
        Pointer<PRINTER_NOTIFY_INFO_DATA>
            pDataSrc)>('PartialReplyPrinterChangeNotification');

int ProvidorFindClosePrinterChangeNotification(int hPrinter) =>
    _ProvidorFindClosePrinterChangeNotification(hPrinter);

late final _ProvidorFindClosePrinterChangeNotification =
    _spoolss.lookupFunction<
        Int32 Function(IntPtr hPrinter),
        int Function(
            int hPrinter)>('ProvidorFindClosePrinterChangeNotification');
...
int ProvidorFindFirstPrinterChangeNotification(
        ...
        Pointer pPrinterNotifyOptions,
        Pointer pvReserved1) =>
    _ProvidorFindFirstPrinterChangeNotification(hPrinter, fdwFlags, fdwOptions,
        hNotify, pPrinterNotifyOptions, pvReserved1);

late final _ProvidorFindFirstPrinterChangeNotification =
    _spoolss.lookupFunction<
        Int32 Function(IntPtr hPrinter, Uint32 fdwFlags, Uint32 fdwOptions,
            IntPtr hNotify, Pointer pPrinterNotifyOptions, Pointer pvReserved1),
        int Function(
            int hPrinter,
            int fdwFlags,
            int fdwOptions,
            int hNotify,
            Pointer pPrinterNotifyOptions,
            Pointer pvReserved1)>('ProvidorFindFirstPrinterChangeNotification');

int RemovePrintDeviceObject(int hDeviceObject) =>
    _RemovePrintDeviceObject(hDeviceObject);

late final _RemovePrintDeviceObject = _spoolss.lookupFunction<
    Int32 Function(IntPtr hDeviceObject),
    int Function(int hDeviceObject)>('RemovePrintDeviceObject');

int ReplyPrinterChangeNotification(int hPrinter, int fdwChangeFlags,
        Pointer<Uint32> pdwResult, Pointer pPrinterNotifyInfo) =>
...
late final _ReplyPrinterChangeNotification = _spoolss.lookupFunction<
    Int32 Function(IntPtr hPrinter, Uint32 fdwChangeFlags,
        Pointer<Uint32> pdwResult, Pointer pPrinterNotifyInfo),
    int Function(int hPrinter, int fdwChangeFlags, Pointer<Uint32> pdwResult,
        Pointer pPrinterNotifyInfo)>('ReplyPrinterChangeNotification');

int ReplyPrinterChangeNotificationEx(int hNotify, int dwColor, int fdwFlags,
        Pointer<Uint32> pdwResult, Pointer pPrinterNotifyInfo) =>
...
late final _ReplyPrinterChangeNotificationEx = _spoolss.lookupFunction<
    Int32 Function(IntPtr hNotify, Uint32 dwColor, Uint32 fdwFlags,
        Pointer<Uint32> pdwResult, Pointer pPrinterNotifyInfo),
    int Function(
        int hNotify,
        int dwColor,
        ...
        Pointer pPrinterNotifyInfo)>('ReplyPrinterChangeNotificationEx');
...
Pointer RouterAllocBidiMem(int NumBytes) => _RouterAllocBidiMem(NumBytes);

late final _RouterAllocBidiMem = _spoolss.lookupFunction<
    Pointer Function(IntPtr NumBytes),
    Pointer Function(int NumBytes)>('RouterAllocBidiMem');

Pointer<BIDI_RESPONSE_CONTAINER> RouterAllocBidiResponseContainer(int Count) =>
    _RouterAllocBidiResponseContainer(Count);

late final _RouterAllocBidiResponseContainer = _spoolss.lookupFunction<
    Pointer<BIDI_RESPONSE_CONTAINER> Function(Uint32 Count),
    Pointer<BIDI_RESPONSE_CONTAINER> Function(
        int Count)>('RouterAllocBidiResponseContainer');

Pointer<PRINTER_NOTIFY_INFO> RouterAllocPrinterNotifyInfo(
        int cPrinterNotifyInfoData) =>
    _RouterAllocPrinterNotifyInfo(cPrinterNotifyInfoData);

late final _RouterAllocPrinterNotifyInfo = _spoolss.lookupFunction<
    Pointer<PRINTER_NOTIFY_INFO> Function(Uint32 cPrinterNotifyInfoData),
    Pointer<PRINTER_NOTIFY_INFO> Function(
        int cPrinterNotifyInfoData)>('RouterAllocPrinterNotifyInfo');

void RouterFreeBidiMem(Pointer pMemPointer) => _RouterFreeBidiMem(pMemPointer);

late final _RouterFreeBidiMem = _spoolss.lookupFunction<
    Void Function(Pointer pMemPointer),
    void Function(Pointer pMemPointer)>('RouterFreeBidiMem');

int RouterFreePrinterNotifyInfo(Pointer<PRINTER_NOTIFY_INFO> pInfo) =>
    _RouterFreePrinterNotifyInfo(pInfo);

late final _RouterFreePrinterNotifyInfo = _spoolss.lookupFunction<
    Int32 Function(Pointer<PRINTER_NOTIFY_INFO> pInfo),
    int Function(
        Pointer<PRINTER_NOTIFY_INFO> pInfo)>('RouterFreePrinterNotifyInfo');

int SplIsSessionZero(int hPrinter, int JobId, Pointer<Int32> pIsSessionZero) =>
    _SplIsSessionZero(hPrinter, JobId, pIsSessionZero);

late final _SplIsSessionZero = _spoolss.lookupFunction<
    Uint32 Function(
        IntPtr hPrinter, Uint32 JobId, Pointer<Int32> pIsSessionZero),
    int Function(int hPrinter, int JobId,
        Pointer<Int32> pIsSessionZero)>('SplIsSessionZero');

int SplPromptUIInUsersSession(int hPrinter, int JobId,
        Pointer<SHOWUIPARAMS> pUIParams, Pointer<Uint32> pResponse) =>
    _SplPromptUIInUsersSession(hPrinter, JobId, pUIParams, pResponse);

late final _SplPromptUIInUsersSession = _spoolss.lookupFunction<
    Int32 Function(IntPtr hPrinter, Uint32 JobId,
        Pointer<SHOWUIPARAMS> pUIParams, Pointer<Uint32> pResponse),
    int Function(int hPrinter, int JobId, Pointer<SHOWUIPARAMS> pUIParams,
        Pointer<Uint32> pResponse)>('SplPromptUIInUsersSession');

int SpoolerFindClosePrinterChangeNotification(int hPrinter) =>
    _SpoolerFindClosePrinterChangeNotification(hPrinter);

late final _SpoolerFindClosePrinterChangeNotification = _spoolss.lookupFunction<
    Int32 Function(IntPtr hPrinter),
    int Function(int hPrinter)>('SpoolerFindClosePrinterChangeNotification');
...
late final _SpoolerFindFirstPrinterChangeNotification = _spoolss.lookupFunction<
    ...
    int Function(
        ...
        Pointer pNotificationConfig,
        Pointer<IntPtr> phNotify,
        Pointer<IntPtr> phEvent)>('SpoolerFindFirstPrinterChangeNotification');
...
int SpoolerFindNextPrinterChangeNotification(
    ...
    _SpoolerFindNextPrinterChangeNotification(
        hPrinter, pfdwChange, pPrinterNotifyOptions, ppPrinterNotifyInfo);

late final _SpoolerFindNextPrinterChangeNotification = _spoolss.lookupFunction<
    Int32 Function(IntPtr hPrinter, Pointer<Uint32> pfdwChange,
        Pointer pPrinterNotifyOptions, Pointer<Pointer> ppPrinterNotifyInfo),
    int Function(
        int hPrinter,
        Pointer<Uint32> pfdwChange,
        Pointer pPrinterNotifyOptions,
        Pointer<Pointer>
            ppPrinterNotifyInfo)>('SpoolerFindNextPrinterChangeNotification');

void SpoolerFreePrinterNotifyInfo(Pointer<PRINTER_NOTIFY_INFO> pInfo) =>
    _SpoolerFreePrinterNotifyInfo(pInfo);

late final _SpoolerFreePrinterNotifyInfo = _spoolss.lookupFunction<
    Void Function(Pointer<PRINTER_NOTIFY_INFO> pInfo),
    void Function(
        Pointer<PRINTER_NOTIFY_INFO> pInfo)>('SpoolerFreePrinterNotifyInfo');
...
int UpdatePrintDeviceObject(int hPrinter, int hDeviceObject) =>
    _UpdatePrintDeviceObject(hPrinter, hDeviceObject);

late final _UpdatePrintDeviceObject = _spoolss.lookupFunction<
    Int32 Function(IntPtr hPrinter, IntPtr hDeviceObject),
    int Function(int hPrinter, int hDeviceObject)>('UpdatePrintDeviceObject');
