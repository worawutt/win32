      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pCallback,
                      Pointer<Pointer<COMObject>> ppAsyncOperation)>()(
          ptr.ref.lpVtbl, bstrBidiRequest, pCallback, ppAsyncOperation);

  int GetPrinterQueueView(int ulViewOffset, int ulViewSize,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int ulViewOffset, int ulViewSize,
                      Pointer<Pointer<COMObject>> ppJobView)>()(
          ptr.ref.lpVtbl, ulViewOffset, ulViewSize, ppJobView);
}
