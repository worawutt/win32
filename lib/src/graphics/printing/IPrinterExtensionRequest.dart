...
class IPrinterExtensionRequest extends IDispatch {
  ...
  int Cancel(int hrStatus, Pointer<Utf16> bstrLogMessage) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 hrStatus,
                              Pointer<Utf16> bstrLogMessage)>>>()
              .value
              .asFunction<
                  int Function(
                      Pointer, int hrStatus, Pointer<Utf16> bstrLogMessage)>()(
          ptr.ref.lpVtbl, hrStatus, bstrLogMessage);
