...
class IPrinterScriptableStream extends IPrinterScriptableSequentialStream {
  ...
  int Seek(int lOffset, int streamSeek, Pointer<Int32> plPosition) => ptr
          .ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 lOffset, Uint32 streamSeek,
                          Pointer<Int32> plPosition)>>>()
          .value
          .asFunction<
              int Function(Pointer, int lOffset, int streamSeek,
                  Pointer<Int32> plPosition)>()(
      ptr.ref.lpVtbl, lOffset, streamSeek, plPosition);

  int SetSize(int lSize) => ptr.ref.lpVtbl.value
      .elementAt(11)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 lSize)>>>()
      .value
      .asFunction<int Function(Pointer, int lSize)>()(ptr.ref.lpVtbl, lSize);
}
