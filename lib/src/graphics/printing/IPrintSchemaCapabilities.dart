...
class IPrintSchemaCapabilities extends IPrintSchemaElement {
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<COMObject>>
                      ppPageImageableSize)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  int GetSelectedOptionInPrintTicket(
          Pointer<COMObject> pFeature, Pointer<Pointer<COMObject>> ppOption) =>
      ptr.ref.lpVtbl.value
              .elementAt(15)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<COMObject> pFeature,
                              Pointer<Pointer<COMObject>> ppOption)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pFeature,
                      Pointer<Pointer<COMObject>> ppOption)>()(
          ptr.ref.lpVtbl, pFeature, ppOption);

  int
      GetOptions(Pointer<COMObject> pFeature,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(Pointer, Pointer<COMObject> pFeature,
                          Pointer<Pointer<COMObject>> ppOptionCollection)>()(
              ptr.ref.lpVtbl, pFeature, ppOptionCollection);
}
