          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<Utf16>>
                      pbstrBidiNotification)>()(ptr.ref.lpVtbl, retValuePtr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<GUID> pReasonId)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<GUID> pReasonId)>()(
  ...
  Pointer<COMObject> get Request {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppRequest)>()(
          ptr.ref.lpVtbl, retValuePtr);
  ...
  Pointer<Utf16> get SourceApplication {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> pbstrApplication)>()(
          ptr.ref.lpVtbl, retValuePtr);
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<GUID> pDetailedReasonId)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<GUID> pDetailedReasonId)>()(
          ptr.ref.lpVtbl, retValuePtr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> pbModal)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> pbModal)>()(
          ptr.ref.lpVtbl, retValuePtr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<IntPtr> phwndParent)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<IntPtr> phwndParent)>()(ptr.ref.lpVtbl, retValuePtr);
