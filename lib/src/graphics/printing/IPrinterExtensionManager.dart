...
class IPrinterExtensionManager extends IUnknown {
  ...
  int EnableEvents(GUID printerDriverId) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, GUID printerDriverId)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              GUID printerDriverId)>()(ptr.ref.lpVtbl, printerDriverId);
