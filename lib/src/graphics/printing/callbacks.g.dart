...
typedef EMFPLAYPROC = Int32 Function(
    IntPtr param0, Int32 param1, IntPtr param2);
typedef OEMCUIPCALLBACK = Int32 Function(
    Pointer<CPSUICBPARAM> param0, Pointer<OEMCUIPPARAM> param1);
typedef PFNCOMPROPSHEET = IntPtr Function(
    IntPtr hComPropSheet, Uint32 Function, IntPtr lParam1, IntPtr lParam2);
typedef PFNPROPSHEETUI = Int32 Function(
    Pointer<PROPSHEETUI_INFO> pPSUIInfo, IntPtr lParam);
...
typedef PFN_DrvUpdateUISetting = Int32 Function(Pointer pdriverobj,
    Pointer pOptItem, Uint32 dwPreviousSelection, Uint32 dwMode);
typedef PFN_DrvUpgradeRegistrySetting = Int32 Function(
    IntPtr hPrinter, Pointer<Utf8> pFeature, Pointer<Utf8> pOption);
...
typedef CPSUICALLBACK = Int32 Function(Pointer<CPSUICBPARAM> pCPSUICBParam);
