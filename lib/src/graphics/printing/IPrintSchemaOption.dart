...
class IPrintSchemaOption extends IPrintSchemaDisplayableElement {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> pbIsSelected)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int32> pbIsSelected)>()(ptr.ref.lpVtbl, retValuePtr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> pSetting)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> pSetting)>()(
  ...
  int GetPropertyValue(Pointer<Utf16> bstrName, Pointer<Utf16> bstrNamespaceUri,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf16> bstrNamespaceUri,
                      Pointer<Pointer<COMObject>> ppXmlValueNode)>()(
          ptr.ref.lpVtbl, bstrName, bstrNamespaceUri, ppXmlValueNode);
}
