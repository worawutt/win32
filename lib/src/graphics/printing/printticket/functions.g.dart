...
int PTCloseProvider(int hProvider) => _PTCloseProvider(hProvider);

late final _PTCloseProvider = _prntvpt.lookupFunction<
    Int32 Function(IntPtr hProvider),
    int Function(int hProvider)>('PTCloseProvider');
...
int PTConvertDevModeToPrintTicket(
    ...
    _PTConvertDevModeToPrintTicket(
        hProvider, cbDevmode, pDevmode, scope, pPrintTicket);
...
late final _PTConvertDevModeToPrintTicket = _prntvpt.lookupFunction<
    ...
    int Function(
        ...
        Pointer<DEVMODE> pDevmode,
        int scope,
        Pointer<COMObject> pPrintTicket)>('PTConvertDevModeToPrintTicket');
...
int PTConvertPrintTicketToDevMode(
    ...
    _PTConvertPrintTicketToDevMode(hProvider, pPrintTicket, baseDevmodeType,
        scope, pcbDevmode, ppDevmode, pbstrErrorMessage);
...
int PTGetPrintCapabilities(
    ...
    _PTGetPrintCapabilities(
        hProvider, pPrintTicket, pCapabilities, pbstrErrorMessage);
...
late final _PTGetPrintCapabilities = _prntvpt.lookupFunction<
    ...
    int Function(
        ...
        Pointer<COMObject> pPrintTicket,
        Pointer<COMObject> pCapabilities,
        Pointer<Pointer<Utf16>> pbstrErrorMessage)>('PTGetPrintCapabilities');
...
int PTGetPrintDeviceCapabilities(
    ...
    _PTGetPrintDeviceCapabilities(
        hProvider, pPrintTicket, pDeviceCapabilities, pbstrErrorMessage);
...
int PTGetPrintDeviceResources(
        ...
        Pointer<Pointer<Utf16>> pbstrErrorMessage) =>
    _PTGetPrintDeviceResources(hProvider, pszLocaleName, pPrintTicket,
        pDeviceResources, pbstrErrorMessage);
...
int PTMergeAndValidatePrintTicket(
        ...
        Pointer<Pointer<Utf16>> pbstrErrorMessage) =>
    _PTMergeAndValidatePrintTicket(hProvider, pBaseTicket, pDeltaTicket, scope,
        pResultTicket, pbstrErrorMessage);
...
int PTOpenProvider(Pointer<Utf16> pszPrinterName, int dwVersion,
        Pointer<IntPtr> phProvider) =>
    _PTOpenProvider(pszPrinterName, dwVersion, phProvider);

late final _PTOpenProvider = _prntvpt.lookupFunction<
    Int32 Function(Pointer<Utf16> pszPrinterName, Uint32 dwVersion,
        Pointer<IntPtr> phProvider),
    int Function(Pointer<Utf16> pszPrinterName, int dwVersion,
        Pointer<IntPtr> phProvider)>('PTOpenProvider');
...
int PTOpenProviderEx(
    ...
    _PTOpenProviderEx(
        pszPrinterName, dwMaxVersion, dwPrefVersion, phProvider, pUsedVersion);
...
late final _PTOpenProviderEx = _prntvpt.lookupFunction<
    ...
    int Function(
        ...
        int dwPrefVersion,
        Pointer<IntPtr> phProvider,
        Pointer<Uint32> pUsedVersion)>('PTOpenProviderEx');

int PTQuerySchemaVersionSupport(
        Pointer<Utf16> pszPrinterName, Pointer<Uint32> pMaxVersion) =>
    _PTQuerySchemaVersionSupport(pszPrinterName, pMaxVersion);

late final _PTQuerySchemaVersionSupport = _prntvpt.lookupFunction<
    Int32 Function(Pointer<Utf16> pszPrinterName, Pointer<Uint32> pMaxVersion),
    int Function(Pointer<Utf16> pszPrinterName,
        Pointer<Uint32> pMaxVersion)>('PTQuerySchemaVersionSupport');

int PTReleaseMemory(Pointer pBuffer) => _PTReleaseMemory(pBuffer);

late final _PTReleaseMemory = _prntvpt.lookupFunction<
    Int32 Function(Pointer pBuffer),
    int Function(Pointer pBuffer)>('PTReleaseMemory');
