...
class IPrintAsyncNotifyDataObject extends IUnknown {
  ...
  int AcquireData(Pointer<Pointer<Uint8>> ppNotificationData,
          Pointer<Uint32> pSize, Pointer<Pointer<GUID>> ppSchema) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint32> pSize,
                      Pointer<Pointer<GUID>> ppSchema)>()(
          ptr.ref.lpVtbl, ppNotificationData, pSize, ppSchema);
