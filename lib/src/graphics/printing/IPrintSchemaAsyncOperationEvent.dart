...
class IPrintSchemaAsyncOperationEvent extends IDispatch {
  ...
  int Completed(Pointer<COMObject> pTicket, int hrOperation) => ptr
      .ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> pTicket,
                      Int32 hrOperation)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<COMObject> pTicket,
              int hrOperation)>()(ptr.ref.lpVtbl, pTicket, hrOperation);
}
