      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Int8> pmszFeatureOptionBuf,
                      int cbIn,
                      Pointer<Uint32> pdwResult)>()(ptr.ref.lpVtbl, poemuiobj,
          dwFlags, pmszFeatureOptionBuf, cbIn, pdwResult);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint8> pbData,
                      int cbSize,
                      Pointer<Uint32> pcbNeeded)>()(ptr.ref.lpVtbl, poemuiobj,
          dwFlags, pszAttribute, pdwDataType, pbData, cbSize, pcbNeeded);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int cbSize,
                      Pointer<Uint32> pcbNeeded)>()(ptr.ref.lpVtbl, poemuiobj,
          dwFlags, pmszFeatureList, cbSize, pcbNeeded);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int cbSize,
                      Pointer<Uint32> pcbNeeded)>()(ptr.ref.lpVtbl, poemuiobj,
          dwFlags, pszFeatureKeyword, pmszOptionList, cbSize, pcbNeeded);

  int QuerySimulationSupport(int hPrinter, int dwLevel, Pointer<Uint8> pCaps,
          int cbSize, Pointer<Uint32> pcbNeeded) =>
      ptr.ref.lpVtbl.value
              .elementAt(15)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      int cbSize,
                      Pointer<Uint32> pcbNeeded)>()(
          ptr.ref.lpVtbl, hPrinter, dwLevel, pCaps, cbSize, pcbNeeded);
}
