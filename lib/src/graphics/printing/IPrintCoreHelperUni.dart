...
class IPrintCoreHelperUni extends IPrintCoreHelper {
  ...
  int CreateGDLSnapshot(Pointer<DEVMODE> pDevmode, int cbSize, int dwFlags,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int dwFlags,
                      Pointer<Pointer<COMObject>> ppSnapshotStream)>()(
          ptr.ref.lpVtbl, pDevmode, cbSize, dwFlags, ppSnapshotStream);

  int CreateDefaultGDLSnapshot(
          int dwFlags, Pointer<Pointer<COMObject>> ppSnapshotStream) =>
      ptr.ref.lpVtbl.value
              .elementAt(13)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, int dwFlags,
                      Pointer<Pointer<COMObject>> ppSnapshotStream)>()(
          ptr.ref.lpVtbl, dwFlags, ppSnapshotStream);
}
