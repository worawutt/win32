...
class IPrintCoreHelper extends IUnknown {
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Utf8> pszFeatureRequested,
                      Pointer<Pointer<Utf8>> ppszOption)>()(
          ptr.ref.lpVtbl, pDevmode, cbSize, pszFeatureRequested, ppszOption);
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              ...
                              Pointer<Utf8> pszFeatureKeyword,
                              Pointer<Utf8> pszOptionKeyword,
                              Pointer<Pointer<PRINT_FEATURE_OPTION>>
                                  ppFOConstraints,
                              Pointer<Uint32> pdwNumOptions)>>>()
              .value
              .asFunction<
  ...
  int
      EnumFeatures(Pointer<Pointer<Pointer<Pointer<Utf8>>>> pFeatureList,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(
                          ...
                          Pointer<Uint32> pdwNumFeatures)>()(
              ptr.ref.lpVtbl, pFeatureList, pdwNumFeatures);
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(
                          ...
                          Pointer<Pointer<Pointer<Pointer<Utf8>>>> pOptionList,
                          Pointer<Uint32> pdwNumOptions)>()(
              ptr.ref.lpVtbl, pszFeatureKeyword, pOptionList, pdwNumOptions);

  int GetFontSubstitution(Pointer<Utf16> pszTrueTypeFontName,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> pszTrueTypeFontName,
                      Pointer<Pointer<Utf16>> ppszDevFontName)>()(
          ptr.ref.lpVtbl, pszTrueTypeFontName, ppszDevFontName);

  int SetFontSubstitution(
          Pointer<Utf16> pszTrueTypeFontName, Pointer<Utf16> pszDevFontName) =>
      ptr.ref.lpVtbl.value
              .elementAt(10)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> pszTrueTypeFontName,
                      Pointer<Utf16> pszDevFontName)>()(
          ptr.ref.lpVtbl, pszTrueTypeFontName, pszDevFontName);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> riid,
                      Pointer<Pointer> ppv)>()(
          ptr.ref.lpVtbl, rclsid, pUnkOuter, dwClsContext, riid, ppv);
}
