...
class IPrinterQueueViewEvent extends IDispatch {
  ...
  int OnChanged(Pointer<COMObject> pCollection, int ulViewOffset,
          int ulViewSize, int ulCountJobsInPrintQueue) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int ulViewOffset,
                      int ulViewSize,
                      int ulCountJobsInPrintQueue)>()(ptr.ref.lpVtbl,
          pCollection, ulViewOffset, ulViewSize, ulCountJobsInPrintQueue);
}
