...
class IPrinterQueueView extends IDispatch {
  ...
  int SetViewRange(int ulViewOffset, int ulViewSize) => ptr.ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Uint32 ulViewOffset, Uint32 ulViewSize)>>>()
          .value
          .asFunction<
              int Function(Pointer, int ulViewOffset, int ulViewSize)>()(
      ptr.ref.lpVtbl, ulViewOffset, ulViewSize);
}
