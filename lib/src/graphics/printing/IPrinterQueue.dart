...
class IPrinterQueue extends IDispatch {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<IntPtr> phPrinter)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<IntPtr> phPrinter)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  int SendBidiQuery(Pointer<Utf16> bstrBidiQuery) => ptr.ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> bstrBidiQuery)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Utf16> bstrBidiQuery)>()(
      ptr.ref.lpVtbl, bstrBidiQuery);

  int GetProperties(Pointer<Pointer<COMObject>> ppPropertyBag) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppPropertyBag)>()(
          ptr.ref.lpVtbl, ppPropertyBag);
}
