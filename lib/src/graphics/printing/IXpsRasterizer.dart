      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> notificationCallback,
                      Pointer<Pointer<COMObject>> bitmap)>()(
          ptr.ref.lpVtbl, x, y, width, height, notificationCallback, bitmap);

  int SetMinimalLineWidth(int width) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 width)>>>()
      .value
      .asFunction<int Function(Pointer, int width)>()(ptr.ref.lpVtbl, width);
}
