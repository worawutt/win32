...
class IBidiAsyncNotifyChannel extends IPrintAsyncNotifyChannel {
  ...
  int GetPrintName(Pointer<Pointer<COMObject>> param0) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetChannelNotificationType(Pointer<Pointer<COMObject>> param0) =>
  ...
  int AsyncGetNotificationSendResponse(
          Pointer<COMObject> param0, Pointer<COMObject> param1) =>
      ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
  ...
  int AsyncCloseChannel(Pointer<COMObject> param0, Pointer<COMObject> param1) =>
      ptr.ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
