...
class IPrintAsyncNotifyCallback extends IUnknown {
  ...
  int OnEventNotify(Pointer<COMObject> pChannel, Pointer<COMObject> pData) =>
      ptr.ref.lpVtbl.value
          ...
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> pChannel,
                  Pointer<COMObject> pData)>()(ptr.ref.lpVtbl, pChannel, pData);

  int ChannelClosed(Pointer<COMObject> pChannel, Pointer<COMObject> pData) =>
      ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
