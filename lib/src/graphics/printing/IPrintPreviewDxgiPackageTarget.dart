...
class IPrintPreviewDxgiPackageTarget extends IUnknown {
  ...
  int SetJobPageCount(int countType, int count) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Int32 countType, Uint32 count)>>>()
              .value
              .asFunction<int Function(Pointer, int countType, int count)>()(
          ptr.ref.lpVtbl, countType, count);

  int DrawPage(int jobPageNumber, Pointer<COMObject> pageImage, double dpiX,
          double dpiY) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
              ...
              .asFunction<
                  int Function(
                      ...
                      double dpiX,
                      double dpiY)>()(
          ptr.ref.lpVtbl, jobPageNumber, pageImage, dpiX, dpiY);
