    ...
    try {
      final hr = ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> pbIsRequired)>>>()
          .value
          .asFunction<
              int Function(Pointer,
                  Pointer<Int32> pbIsRequired)>()(ptr.ref.lpVtbl, retValuePtr);
  ...
  Pointer<Utf16> get UnitType {
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> pbstrUnitType)>()(
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> pDataType)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> pDataType)>()(
          ptr.ref.lpVtbl, retValuePtr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> pRangeMin)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> pRangeMin)>()(
          ptr.ref.lpVtbl, retValuePtr);
    ...
    try {
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Int32> pRangeMax)>>>()
              .value
              .asFunction<int Function(Pointer, Pointer<Int32> pRangeMax)>()(
          ptr.ref.lpVtbl, retValuePtr);
