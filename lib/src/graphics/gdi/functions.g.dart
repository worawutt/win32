...
late final _CombineRgn = _gdi32.lookupFunction<
    Int32 Function(
        IntPtr hrgnDst, IntPtr hrgnSrc1, IntPtr hrgnSrc2, Int32 iMode),
    int Function(
...
late final _EnumObjects = _gdi32.lookupFunction<
    Int32 Function(IntPtr hdc, Int32 nType,
...
int ExtCreateRegion(Pointer<XFORM> lpx, int nCount, Pointer<RGNDATA> lpData) =>
    _ExtCreateRegion(lpx, nCount, lpData);
...
late final _ExtSelectClipRgn = _gdi32.lookupFunction<
    Int32 Function(IntPtr hdc, IntPtr hrgn, Int32 mode),
...
late final _GetCurrentObject = _gdi32.lookupFunction<
    IntPtr Function(IntPtr hdc, Int32 type),
...
int ResetDC(int hdc, Pointer<DEVMODE> lpdm) => _ResetDC(hdc, lpdm);
...
late final _SetROP2 = _gdi32.lookupFunction<
    Int32 Function(IntPtr hdc, Int32 rop2),
