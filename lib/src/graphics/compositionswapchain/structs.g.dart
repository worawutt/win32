...
class CompositionFrameDisplayInstance extends Struct {
  ...
  @Uint32() external int displayVidPnSourceId;
  @Uint32() external int displayUniqueId;
  external LUID renderAdapterLUID;
  @Uint32() external int instanceKind;
  external PresentationTransform finalTransform;
  @Uint8() external int requiredCrossAdapterCopy;
