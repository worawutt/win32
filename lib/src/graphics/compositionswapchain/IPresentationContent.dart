...
class IPresentationContent extends IUnknown {
  ...
  void SetTag(int tag) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<Pointer<NativeFunction<Void Function(Pointer, IntPtr tag)>>>()
      .value
      .asFunction<void Function(Pointer, int tag)>()(ptr.ref.lpVtbl, tag);
}
