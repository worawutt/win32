...
class ID2D1Factory1 extends ID2D1Factory {
  ...
  int CreateDevice(Pointer<COMObject> dxgiDevice,
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<COMObject> dxgiDevice,
                              Pointer<Pointer<COMObject>> d2dDevice)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> dxgiDevice,
                      Pointer<Pointer<COMObject>> d2dDevice)>()(
          ptr.ref.lpVtbl, dxgiDevice, d2dDevice);
                  ...
                  .cast<
                      Pointer<
                          NativeFunction<
                              Int32 Function(
                                  Pointer,
                                  Pointer<D2D1_STROKE_STYLE_PROPERTIES1>
  ...
  int CreatePathGeometry_1(Pointer<Pointer<COMObject>> pathGeometry) =>
      ptr.ref.lpVtbl.value
              .elementAt(19)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> pathGeometry)>()(
          ptr.ref.lpVtbl, pathGeometry);

  int
      CreateDrawingStateBlock_1(
                  ...
                  .cast<
                      Pointer<
                          NativeFunction<
                              Int32 Function(
                                  Pointer,
                                  Pointer<D2D1_DRAWING_STATE_DESCRIPTION1>
  ...
  int CreateGdiMetafile(Pointer<COMObject> metafileStream,
      ...
      ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> metafileStream,
                          Pointer<Pointer<COMObject>> metafile)>>>()
          .value
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<COMObject>>
                      metafile)>()(ptr.ref.lpVtbl, metafileStream, metafile);
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              ...
                              Pointer<NativeFunction<PD2D1_EFFECT_FACTORY>>
                                  effectFactory)>>>()
              .value
              .asFunction<
                  int Function(
                      ...
                      int bindingsCount,
                      Pointer<NativeFunction<PD2D1_EFFECT_FACTORY>>
                          effectFactory)>()(ptr.ref.lpVtbl, classId,
          propertyXml, bindings, bindingsCount, effectFactory);
  ...
  int UnregisterEffect(Pointer<GUID> classId) => ptr.ref.lpVtbl.value
      .elementAt(24)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<GUID> classId)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, Pointer<GUID> classId)>()(ptr.ref.lpVtbl, classId);

  int GetRegisteredEffects(Pointer<GUID> effects, int effectsCount,
          Pointer<Uint32> effectsReturned, Pointer<Uint32> effectsRegistered) =>
      ptr.ref.lpVtbl.value
              .elementAt(25)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      int effectsCount,
                      Pointer<Uint32> effectsReturned,
                      Pointer<Uint32> effectsRegistered)>()(ptr.ref.lpVtbl,
          effects, effectsCount, effectsReturned, effectsRegistered);

  int GetEffectProperties(
          Pointer<GUID> effectId, Pointer<Pointer<COMObject>> properties) =>
      ptr.ref.lpVtbl.value
              .elementAt(26)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, Pointer<GUID> effectId,
                      Pointer<Pointer<COMObject>> properties)>()(
          ptr.ref.lpVtbl, effectId, properties);
}
