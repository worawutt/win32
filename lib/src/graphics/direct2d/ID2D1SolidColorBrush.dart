...
class ID2D1SolidColorBrush extends ID2D1Brush {
  ...
  void SetColor(Pointer<D2D1_COLOR_F> color) => ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  D2D1_COLOR_F GetColor() => ptr.ref.lpVtbl.value
      .elementAt(9)
      .cast<Pointer<NativeFunction<D2D1_COLOR_F Function(Pointer)>>>()
      .value
      .asFunction<D2D1_COLOR_F Function(Pointer)>()(ptr.ref.lpVtbl);
}
