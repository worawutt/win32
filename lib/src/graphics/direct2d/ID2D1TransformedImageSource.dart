...
class ID2D1TransformedImageSource extends ID2D1Image {
  ...
  void GetSource(Pointer<Pointer<COMObject>> imageSource) => ptr
          .ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Void Function(
                          Pointer, Pointer<Pointer<COMObject>> imageSource)>>>()
          .value
          .asFunction<
              void Function(
                  Pointer, Pointer<Pointer<COMObject>> imageSource)>()(
      ptr.ref.lpVtbl, imageSource);
      ...
      ptr.ref.lpVtbl.value
          ...
          .asFunction<
              void Function(
                  Pointer,
                  Pointer<D2D1_TRANSFORMED_IMAGE_SOURCE_PROPERTIES>
                      properties)>()(ptr.ref.lpVtbl, properties);
}
