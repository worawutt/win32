...
class ID2D1GeometryGroup extends ID2D1Geometry {
  ...
  void GetSourceGeometries(
          Pointer<Pointer<COMObject>> geometries, int geometriesCount) =>
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  void Function(Pointer, Pointer<Pointer<COMObject>> geometries,
                      int geometriesCount)>()(
          ptr.ref.lpVtbl, geometries, geometriesCount);
}
