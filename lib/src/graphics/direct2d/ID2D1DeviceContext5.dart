...
class ID2D1DeviceContext5 extends ID2D1DeviceContext4 {
  ...
  int CreateSvgDocument(Pointer<COMObject> inputXmlStream,
          D2D_SIZE_F viewportSize, Pointer<Pointer<COMObject>> svgDocument) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      D2D_SIZE_F viewportSize,
                      Pointer<Pointer<COMObject>> svgDocument)>()(
          ptr.ref.lpVtbl, inputXmlStream, viewportSize, svgDocument);

  void DrawSvgDocument(Pointer<COMObject> svgDocument) => ptr.ref.lpVtbl.value
      .elementAt(116)
      .cast<
          Pointer<
              NativeFunction<
                  Void Function(Pointer, Pointer<COMObject> svgDocument)>>>()
      .value
      .asFunction<
          void Function(Pointer,
              Pointer<COMObject> svgDocument)>()(ptr.ref.lpVtbl, svgDocument);

  int CreateColorContextFromDxgiColorSpace(
          int colorSpace, Pointer<Pointer<COMObject>> colorContext) =>
      ptr.ref.lpVtbl.value
              .elementAt(117)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Int32 colorSpace,
                              Pointer<Pointer<COMObject>> colorContext)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int colorSpace,
                      Pointer<Pointer<COMObject>> colorContext)>()(
          ptr.ref.lpVtbl, colorSpace, colorContext);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<D2D1_SIMPLE_COLOR_PROFILE> simpleProfile,
                      Pointer<Pointer<COMObject>> colorContext)>()(
          ptr.ref.lpVtbl, simpleProfile, colorContext);
}
