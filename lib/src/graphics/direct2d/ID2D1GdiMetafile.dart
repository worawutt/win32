...
class ID2D1GdiMetafile extends ID2D1Resource {
  ...
  int Stream(Pointer<COMObject> sink) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> sink)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> sink)>()(
      ptr.ref.lpVtbl, sink);

  int GetBounds(Pointer<D2D_RECT_F> bounds) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
