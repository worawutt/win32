...
class ID2D1OffsetTransform extends ID2D1TransformNode {
  ...
  void SetOffset(POINT offset) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<Pointer<NativeFunction<Void Function(Pointer, POINT offset)>>>()
          .value
          .asFunction<void Function(Pointer, POINT offset)>()(
      ptr.ref.lpVtbl, offset);

  POINT GetOffset() => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<Pointer<NativeFunction<POINT Function(Pointer)>>>()
      .value
      .asFunction<POINT Function(Pointer)>()(ptr.ref.lpVtbl);
}
