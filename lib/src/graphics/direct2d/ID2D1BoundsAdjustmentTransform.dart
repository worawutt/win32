...
class ID2D1BoundsAdjustmentTransform extends ID2D1TransformNode {
  ...
  void SetOutputBounds(Pointer<RECT> outputBounds) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Void Function(Pointer, Pointer<RECT> outputBounds)>>>()
          .value
          .asFunction<void Function(Pointer, Pointer<RECT> outputBounds)>()(
      ptr.ref.lpVtbl, outputBounds);

  void GetOutputBounds(Pointer<RECT> outputBounds) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
