...
class ID2D1DCRenderTarget extends ID2D1RenderTarget {
  ...
  int BindDC(int hDC, Pointer<RECT> pSubRect) => ptr.ref.lpVtbl.value
          .elementAt(57)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, IntPtr hDC, Pointer<RECT> pSubRect)>>>()
          .value
          .asFunction<int Function(Pointer, int hDC, Pointer<RECT> pSubRect)>()(
      ptr.ref.lpVtbl, hDC, pSubRect);
}
