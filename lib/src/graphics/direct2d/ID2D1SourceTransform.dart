...
class ID2D1SourceTransform extends ID2D1Transform {
  ...
  int SetRenderInfo(Pointer<COMObject> renderInfo) => ptr.ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> renderInfo)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<COMObject> renderInfo)>()(ptr.ref.lpVtbl, renderInfo);

  int Draw(Pointer<COMObject> target, Pointer<RECT> drawRect,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> target,
                      Pointer<RECT> drawRect, D2D_POINT_2U targetOrigin)>()(
          ptr.ref.lpVtbl, target, drawRect, targetOrigin);
}
