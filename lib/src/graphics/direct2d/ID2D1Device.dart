...
class ID2D1Device extends ID2D1Resource {
  ...
  int CreateDeviceContext(
          int options, Pointer<Pointer<COMObject>> deviceContext) =>
      ptr
              .ref.lpVtbl.value
              .elementAt(4)
              .cast<
              ...
              .asFunction<
                  int Function(Pointer, int options,
                      Pointer<Pointer<COMObject>> deviceContext)>()(
          ptr.ref.lpVtbl, options, deviceContext);
                      ...
                      Pointer<
                          NativeFunction<
                              Int32 Function(
                                  ...
                                  Pointer<COMObject> wicFactory,
                                  Pointer<COMObject> documentTarget,
                                  Pointer<D2D1_PRINT_CONTROL_PROPERTIES>
  ...
  void SetMaximumTextureMemory(int maximumInBytes) => ptr.ref.lpVtbl.value
      .elementAt(6)
      .cast<
          Pointer<
              NativeFunction<Void Function(Pointer, Uint64 maximumInBytes)>>>()
      .value
      .asFunction<
          void Function(
              Pointer, int maximumInBytes)>()(ptr.ref.lpVtbl, maximumInBytes);
  ...
  void ClearResources(int millisecondsSinceUse) => ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
                      Void Function(Pointer, Uint32 millisecondsSinceUse)>>>()
          .value
          .asFunction<void Function(Pointer, int millisecondsSinceUse)>()(
      ptr.ref.lpVtbl, millisecondsSinceUse);
}
