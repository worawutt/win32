...
class ID2D1CommandSink2 extends ID2D1CommandSink1 {
  ...
  int DrawInk(Pointer<COMObject> ink, Pointer<COMObject> brush,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> ink,
                      Pointer<COMObject> brush, Pointer<COMObject> inkStyle)>()(
          ptr.ref.lpVtbl, ink, brush, inkStyle);

  int DrawGradientMesh(Pointer<COMObject> gradientMesh) => ptr.ref.lpVtbl.value
      .elementAt(30)
      .cast<
          Pointer<
              NativeFunction<
