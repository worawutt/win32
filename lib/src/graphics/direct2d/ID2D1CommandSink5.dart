...
typedef _BlendImage_Native = Int32 Function(
  Pointer,
  COMObject image, 
  Uint32 blendMode, 
...
typedef _BlendImage_Dart = int Function(
  Pointer,
  COMObject image, 
  int blendMode, 
  Pointer<D2D_POINT_2F> targetOffset, 
...
class ID2D1CommandSink5 extends ID2D1CommandSink4 {
  // vtable begins at 34, ends at 34

   ID2D1CommandSink5(Pointer<COMObject> ptr) : super(ptr);

  int BlendImage(COMObject image, int blendMode, Pointer<D2D_POINT_2F> targetOffset, Pointer<D2D_RECT_F> imageRectangle, int interpolationMode) => ptr.ref.lpVtbl.value      .elementAt(34)
