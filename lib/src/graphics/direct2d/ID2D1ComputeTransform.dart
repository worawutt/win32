...
class ID2D1ComputeTransform extends ID2D1Transform {
  ...
  int SetComputeInfo(Pointer<COMObject> computeInfo) => ptr.ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> computeInfo)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<COMObject> computeInfo)>()(ptr.ref.lpVtbl, computeInfo);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint32> dimensionY,
                      Pointer<Uint32> dimensionZ)>()(
          ptr.ref.lpVtbl, outputRect, dimensionX, dimensionY, dimensionZ);
}
