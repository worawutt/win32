...
class ID2D1Factory extends IUnknown {
  ...
  void GetDesktopDpi(Pointer<Float> dpiX, Pointer<Float> dpiY) => ptr
      .ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
  ...
  int
      CreateRectangleGeometry(Pointer<D2D_RECT_F> rectangle,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<D2D_RECT_F> rectangle,
                          Pointer<Pointer<COMObject>> rectangleGeometry)>()(
              ptr.ref.lpVtbl, rectangle, rectangleGeometry);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<D2D1_ROUNDED_RECT> roundedRectangle,
                      Pointer<Pointer<COMObject>> roundedRectangleGeometry)>()(
          ptr.ref.lpVtbl, roundedRectangle, roundedRectangleGeometry);

  int CreateEllipseGeometry(Pointer<D2D1_ELLIPSE> ellipse,
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<D2D1_ELLIPSE> ellipse,
                              Pointer<Pointer<COMObject>> ellipseGeometry)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<D2D1_ELLIPSE> ellipse,
                      Pointer<Pointer<COMObject>> ellipseGeometry)>()(
          ptr.ref.lpVtbl, ellipse, ellipseGeometry);

  int CreateGeometryGroup(int fillMode, Pointer<Pointer<COMObject>> geometries,
          int geometriesCount, Pointer<Pointer<COMObject>> geometryGroup) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      int geometriesCount,
                      Pointer<Pointer<COMObject>> geometryGroup)>()(
          ptr.ref.lpVtbl, fillMode, geometries, geometriesCount, geometryGroup);
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(
                          ...
                          Pointer<D2D_MATRIX_3X2_F> transform,
                          Pointer<Pointer<COMObject>> transformedGeometry)>()(
              ptr.ref.lpVtbl, sourceGeometry, transform, transformedGeometry);

  int CreatePathGeometry(Pointer<Pointer<COMObject>> pathGeometry) => ptr
          .ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
                  ...
                  .cast<
                      Pointer<
                          NativeFunction<
                              Int32 Function(
                                  Pointer,
                                  Pointer<D2D1_STROKE_STYLE_PROPERTIES>
                  ...
                  .asFunction<
                      int Function(
                          ...
                          Pointer<D2D1_RENDER_TARGET_PROPERTIES>
                              renderTargetProperties,
                          Pointer<Pointer<COMObject>> renderTarget)>()(
              ptr.ref.lpVtbl, target, renderTargetProperties, renderTarget);
                  ...
                  .asFunction<
                      int Function(
                          ...
                          Pointer<D2D1_RENDER_TARGET_PROPERTIES>
                              renderTargetProperties,
                          Pointer<Pointer<COMObject>> dcRenderTarget)>()(
              ptr.ref.lpVtbl, renderTargetProperties, dcRenderTarget);
}
