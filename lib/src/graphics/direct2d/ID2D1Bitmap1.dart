...
class ID2D1Bitmap1 extends ID2D1Bitmap {
  ...
  void GetColorContext(Pointer<Pointer<COMObject>> colorContext) => ptr
          .ref.lpVtbl.value
          .elementAt(11)
          .cast<
              Pointer<
          ...
          .asFunction<
              void Function(
                  Pointer, Pointer<Pointer<COMObject>> colorContext)>()(
      ptr.ref.lpVtbl, colorContext);
  ...
  int GetSurface(Pointer<Pointer<COMObject>> dxgiSurface) => ptr
          .ref.lpVtbl.value
          .elementAt(13)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> dxgiSurface)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> dxgiSurface)>()(
      ptr.ref.lpVtbl, dxgiSurface);

  int Map(int options, Pointer<D2D1_MAPPED_RECT> mappedRect) => ptr
          .ref.lpVtbl.value
          .elementAt(14)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(Pointer, int options,
                  Pointer<D2D1_MAPPED_RECT> mappedRect)>()(
      ptr.ref.lpVtbl, options, mappedRect);
