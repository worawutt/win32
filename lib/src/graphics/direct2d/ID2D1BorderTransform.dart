...
class ID2D1BorderTransform extends ID2D1ConcreteTransform {
  ...
  void SetExtendModeX(int extendMode) => ptr.ref.lpVtbl.value
      .elementAt(6)
      .cast<
          Pointer<NativeFunction<Void Function(Pointer, Uint32 extendMode)>>>()
      .value
      .asFunction<
          void Function(Pointer, int extendMode)>()(ptr.ref.lpVtbl, extendMode);

  void SetExtendModeY(int extendMode) => ptr.ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<NativeFunction<Void Function(Pointer, Uint32 extendMode)>>>()
      .value
