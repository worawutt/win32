...
class ID2D1LinearGradientBrush extends ID2D1Brush {
  ...
  void SetStartPoint(D2D_POINT_2F startPoint) => ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .value
          .asFunction<void Function(Pointer, D2D_POINT_2F startPoint)>()(
      ptr.ref.lpVtbl, startPoint);

  void SetEndPoint(D2D_POINT_2F endPoint) => ptr.ref.lpVtbl.value
      .elementAt(9)
      .cast<
          Pointer<
              NativeFunction<Void Function(Pointer, D2D_POINT_2F endPoint)>>>()
      .value
      .asFunction<
          void Function(
              Pointer, D2D_POINT_2F endPoint)>()(ptr.ref.lpVtbl, endPoint);
