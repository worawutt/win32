...
class ID2D1Transform extends ID2D1TransformNode {
  ...
  int
      MapOutputRectToInputRects(Pointer<RECT> outputRect,
              Pointer<RECT> inputRects, int inputRectsCount) =>
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<RECT> outputRect,
                          Pointer<RECT> inputRects, int inputRectsCount)>()(
              ptr.ref.lpVtbl, outputRect, inputRects, inputRectsCount);
  ...
  int MapInvalidRect(int inputIndex, RECT invalidInputRect,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int inputIndex, RECT invalidInputRect,
                      Pointer<RECT> invalidOutputRect)>()(
          ptr.ref.lpVtbl, inputIndex, invalidInputRect, invalidOutputRect);
}
