...
class ID2D1AnalysisTransform extends IUnknown {
  ...
  int ProcessAnalysisResults(
          Pointer<Uint8> analysisData, int analysisDataCount) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Uint8> analysisData,
                              Uint32 analysisDataCount)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint8> analysisData,
                      int analysisDataCount)>()(
          ptr.ref.lpVtbl, analysisData, analysisDataCount);
}
