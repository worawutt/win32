...
class ID2D1SvgAttribute extends ID2D1Resource {
  ...
  void GetElement(Pointer<Pointer<COMObject>> element) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .value
          .asFunction<
              void Function(Pointer, Pointer<Pointer<COMObject>> element)>()(
      ptr.ref.lpVtbl, element);

  int Clone(Pointer<Pointer<COMObject>> attribute) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> attribute)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> attribute)>()(
      ptr.ref.lpVtbl, attribute);
}
