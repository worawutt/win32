...
class ID2D1BlendTransform extends ID2D1ConcreteTransform {
  ...
  void SetDescription(Pointer<D2D1_BLEND_DESCRIPTION> description) => ptr
          .ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
          ...
          .asFunction<
              void Function(
                  Pointer, Pointer<D2D1_BLEND_DESCRIPTION> description)>()(
      ptr.ref.lpVtbl, description);

  void GetDescription(Pointer<D2D1_BLEND_DESCRIPTION> description) => ptr
          .ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
