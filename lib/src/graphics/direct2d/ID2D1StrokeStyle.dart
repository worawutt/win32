...
class ID2D1StrokeStyle extends ID2D1Resource {
  ...
  void GetDashes(Pointer<Float> dashes, int dashesCount) => ptr.ref.lpVtbl.value
      .elementAt(12)
      .cast<
          Pointer<
              NativeFunction<
                  Void Function(
                      Pointer, Pointer<Float> dashes, Uint32 dashesCount)>>>()
      .value
      .asFunction<
          void Function(Pointer, Pointer<Float> dashes,
              int dashesCount)>()(ptr.ref.lpVtbl, dashes, dashesCount);
}
