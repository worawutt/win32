...
class ID2D1ColorContext extends ID2D1Resource {
  ...
  int GetProfile(Pointer<Uint8> profile, int profileSize) => ptr
      .ref.lpVtbl.value
      .elementAt(6)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Pointer<Uint8> profile, Uint32 profileSize)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<Uint8> profile,
              int profileSize)>()(ptr.ref.lpVtbl, profile, profileSize);
}
