...
class ID2D1Mesh extends ID2D1Resource {
  ...
  int Open(Pointer<Pointer<COMObject>> tessellationSink) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<COMObject>> tessellationSink)>()(
      ptr.ref.lpVtbl, tessellationSink);
}
