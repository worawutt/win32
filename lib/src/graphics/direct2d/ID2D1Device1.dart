...
class ID2D1Device1 extends ID2D1Device {
  ...
  void SetRenderingPriority(int renderingPriority) => ptr.ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
                  NativeFunction<
                      Void Function(Pointer, Uint32 renderingPriority)>>>()
          .value
          .asFunction<void Function(Pointer, int renderingPriority)>()(
      ptr.ref.lpVtbl, renderingPriority);

  int CreateDeviceContext_1(
          int options, Pointer<Pointer<COMObject>> deviceContext1) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int options,
                      Pointer<Pointer<COMObject>> deviceContext1)>()(
          ptr.ref.lpVtbl, options, deviceContext1);
}
