...
class ID2D1DeviceContext1 extends ID2D1DeviceContext {
  ...
  void DrawGeometryRealization(
          Pointer<COMObject> geometryRealization, Pointer<COMObject> brush) =>
      ptr.ref.lpVtbl.value
              .elementAt(94)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  void Function(Pointer, Pointer<COMObject> geometryRealization,
                      Pointer<COMObject> brush)>()(
          ptr.ref.lpVtbl, geometryRealization, brush);
}
