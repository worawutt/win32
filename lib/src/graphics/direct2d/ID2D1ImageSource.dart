...
class ID2D1ImageSource extends ID2D1Image {
  ...
  int TryReclaimResources(Pointer<Int32> resourcesDiscarded) => ptr
          .ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Int32> resourcesDiscarded)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Int32> resourcesDiscarded)>()(
      ptr.ref.lpVtbl, resourcesDiscarded);
}
