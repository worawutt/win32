...
class ID2D1TessellationSink extends IUnknown {
  ...
  void AddTriangles(Pointer<D2D1_TRIANGLE> triangles, int trianglesCount) => ptr
      .ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Void Function(Pointer, Pointer<D2D1_TRIANGLE> triangles,
                      Uint32 trianglesCount)>>>()
      .value
      .asFunction<
          void Function(Pointer, Pointer<D2D1_TRIANGLE> triangles,
              int trianglesCount)>()(ptr.ref.lpVtbl, triangles, trianglesCount);
