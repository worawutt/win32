...
class ID2D1DeviceContext3 extends ID2D1DeviceContext2 {
  ...
  int CreateSpriteBatch(Pointer<Pointer<COMObject>> spriteBatch) => ptr
          .ref.lpVtbl.value
          .elementAt(106)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> spriteBatch)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> spriteBatch)>()(
      ptr.ref.lpVtbl, spriteBatch);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  void Function(
                      ...
                      Pointer<COMObject> bitmap,
                      int interpolationMode,
                      int spriteOptions)>()(ptr.ref.lpVtbl, spriteBatch,
          startIndex, spriteCount, bitmap, interpolationMode, spriteOptions);
}
