...
class ID2D1DrawTransform extends ID2D1Transform {
  ...
  int SetDrawInfo(Pointer<COMObject> drawInfo) => ptr.ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> drawInfo)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> drawInfo)>()(
      ptr.ref.lpVtbl, drawInfo);
}
