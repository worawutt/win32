      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer,
                              Pointer<NativeFunction<PFN_DESTRUCTION_CALLBACK>>
                                  callbackFn,
                              Pointer pData,
                              Pointer<Uint32> pCallbackID)>>>()
              .value
              .asFunction<
                  int Function(
                      ...
                      Pointer pData,
                      Pointer<Uint32> pCallbackID)>()(
          ptr.ref.lpVtbl, callbackFn, pData, pCallbackID);

  int UnregisterDestructionCallback(int callbackID) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<NativeFunction<Int32 Function(Pointer, Uint32 callbackID)>>>()
      .value
      .asFunction<
          int Function(Pointer, int callbackID)>()(ptr.ref.lpVtbl, callbackID);
}
