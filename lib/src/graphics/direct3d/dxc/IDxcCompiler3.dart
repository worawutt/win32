      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pIncludeHandler,
                      Pointer<GUID> riid,
                      Pointer<Pointer> ppResult)>()(ptr.ref.lpVtbl, pSource,
          pArguments, argCount, pIncludeHandler, riid, ppResult);

  int Disassemble(Pointer<DxcBuffer> pObject, Pointer<GUID> riid,
          Pointer<Pointer> ppResult) =>
      ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<DxcBuffer> pObject,
                          Pointer<GUID> riid, Pointer<Pointer> ppResult)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer,
                  ...
                  Pointer<GUID> riid,
                  Pointer<Pointer>
                      ppResult)>()(ptr.ref.lpVtbl, pObject, riid, ppResult);
}
