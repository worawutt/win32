...
class IDxcIncludeHandler extends IUnknown {
  ...
  int LoadSource(Pointer<Utf16> pFilename,
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf16> pFilename,
                              Pointer<Pointer<COMObject>> ppIncludeSource)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> pFilename,
                      Pointer<Pointer<COMObject>> ppIncludeSource)>()(
          ptr.ref.lpVtbl, pFilename, ppIncludeSource);
}
