...
class IDxcBlobEncoding extends IDxcBlob {
  ...
  int GetEncoding(Pointer<Int32> pKnown, Pointer<Uint32> pCodePage) => ptr
      .ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Int32> pKnown,
                      Pointer<Uint32> pCodePage)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<Int32> pKnown,
              Pointer<Uint32> pCodePage)>()(ptr.ref.lpVtbl, pKnown, pCodePage);
}
