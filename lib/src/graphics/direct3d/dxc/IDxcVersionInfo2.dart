...
class IDxcVersionInfo2 extends IDxcVersionInfo {
  ...
  int GetCommitInfo(
          Pointer<Uint32> pCommitCount, Pointer<Pointer<Int8>> pCommitHash) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Uint32> pCommitCount,
                              Pointer<Pointer<Int8>> pCommitHash)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> pCommitCount,
                      Pointer<Pointer<Int8>> pCommitHash)>()(
          ptr.ref.lpVtbl, pCommitCount, pCommitHash);
}
