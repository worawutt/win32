...
class IDxcResult extends IDxcOperationResult {
  ...
  int HasOutput(int dxcOutKind) => ptr.ref.lpVtbl.value
      .elementAt(6)
      .cast<
          Pointer<NativeFunction<Int32 Function(Pointer, Int32 dxcOutKind)>>>()
      .value
      .asFunction<
          int Function(Pointer, int dxcOutKind)>()(ptr.ref.lpVtbl, dxcOutKind);

  int GetOutput(int dxcOutKind, Pointer<GUID> iid, Pointer<Pointer> ppvObject,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer> ppvObject,
                      Pointer<Pointer<COMObject>> ppOutputName)>()(
          ptr.ref.lpVtbl, dxcOutKind, iid, ppvObject, ppOutputName);
  ...
  int GetOutputByIndex(int Index) => ptr.ref.lpVtbl.value
      .elementAt(9)
