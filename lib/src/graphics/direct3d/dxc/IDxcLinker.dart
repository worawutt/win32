...
class IDxcLinker extends IUnknown {
  ...
  int RegisterLibrary(Pointer<Utf16> pLibName, Pointer<COMObject> pLib) =>
      ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> pLibName,
                          Pointer<COMObject> pLib)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Utf16> pLibName,
                  Pointer<COMObject> pLib)>()(ptr.ref.lpVtbl, pLibName, pLib);
