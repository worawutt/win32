...
class IDxcOperationResult extends IUnknown {
  ...
  int GetStatus(Pointer<Int32> pStatus) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetResult(Pointer<Pointer<COMObject>> ppResult) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetErrorBuffer(Pointer<Pointer<COMObject>> ppErrors) => ptr
          .ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> ppErrors)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> ppErrors)>()(
      ptr.ref.lpVtbl, ppErrors);
}
