...
class IEnumFilters extends IUnknown {
  ...
  int Next(int cFilters, Pointer<COMObject> ppFilter, Pointer<Uint32> pcFetched) => ptr.ref.lpVtbl.value      .elementAt(3)
      .cast<Pointer<NativeFunction<_Next_Native>>>()
      .value
      .asFunction<_Next_Dart>()(ptr.ref.lpVtbl, cFilters, ppFilter, pcFetched);
