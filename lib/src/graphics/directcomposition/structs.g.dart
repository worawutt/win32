...
class COMPOSITION_FRAME_STATS extends Struct {
  ...
  @Uint64() external int targetTime;
  @Uint64() external int framePeriod;
}

/// {@category Struct}
class COMPOSITION_STATS extends Struct {
  @Uint32() external int presentCount;
  @Uint32() external int refreshCount;
  @Uint32() external int virtualRefreshCount;
  @Uint64() external int time;
}
...
class COMPOSITION_TARGET_ID extends Struct {
  ...
  @Uint32() external int vidPnSourceId;
  @Uint32() external int vidPnTargetId;
  @Uint32() external int uniqueId;
}

/// {@category Struct}
class COMPOSITION_TARGET_STATS extends Struct {
  @Uint32() external int outstandingPresents;
  @Uint64() external int presentTime;
  @Uint64() external int vblankDuration;
