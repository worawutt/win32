...
class IDCompositionDelegatedInkTrail extends IUnknown {
  ...
  int AddTrailPoints(Pointer<DCompositionInkTrailPoint> inkPoints,
          int inkPointsCount, Pointer<Uint32> generationId) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int inkPointsCount,
                      Pointer<Uint32> generationId)>()(
          ptr.ref.lpVtbl, inkPoints, inkPointsCount, generationId);
  ...
  int RemoveTrailPoints(int generationId) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Uint32 generationId)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int generationId)>()(ptr.ref.lpVtbl, generationId);

  int StartNewTrail(Pointer<D2D1_COLOR_F> color) => ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
