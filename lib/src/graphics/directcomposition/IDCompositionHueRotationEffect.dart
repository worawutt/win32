...
class IDCompositionHueRotationEffect extends IDCompositionFilterEffect {
  ...
  int SetAngle(double amountDegrees) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Float amountDegrees)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, double amountDegrees)>()(ptr.ref.lpVtbl, amountDegrees);
}
