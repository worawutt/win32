...
class IDCompositionVirtualSurface extends IDCompositionSurface {
  ...
  int Trim(Pointer<RECT> rectangles, int count) => ptr.ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<RECT> rectangles, Uint32 count)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<RECT> rectangles, int count)>()(
      ptr.ref.lpVtbl, rectangles, count);
}
