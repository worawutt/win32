...
class IDCompositionVisual2 extends IDCompositionVisual {
  ...
  int SetOpacityMode(int mode) => ptr.ref.lpVtbl.value
      .elementAt(20)
  ...
  int SetBackFaceVisibility(int visibility) => ptr.ref.lpVtbl.value
      .elementAt(21)
      .cast<
          Pointer<NativeFunction<Int32 Function(Pointer, Int32 visibility)>>>()
      .value
      .asFunction<
          int Function(Pointer, int visibility)>()(ptr.ref.lpVtbl, visibility);
}
