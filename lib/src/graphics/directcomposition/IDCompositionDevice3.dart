          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(Pointer,
                          Pointer<Pointer<COMObject>> gaussianBlurEffect)>()(
              ptr.ref.lpVtbl, gaussianBlurEffect);

  int CreateBrightnessEffect(Pointer<Pointer<COMObject>> brightnessEffect) =>
      ptr.ref.lpVtbl.value
              .elementAt(25)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> brightnessEffect)>()(
          ptr.ref.lpVtbl, brightnessEffect);

  int CreateColorMatrixEffect(Pointer<Pointer<COMObject>> colorMatrixEffect) =>
      ptr.ref.lpVtbl.value
          .elementAt(26)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer,
                  Pointer<Pointer<COMObject>>
                      colorMatrixEffect)>()(ptr.ref.lpVtbl, colorMatrixEffect);

  int CreateShadowEffect(Pointer<Pointer<COMObject>> shadowEffect) => ptr
          .ref.lpVtbl.value
          .elementAt(27)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<Pointer<COMObject>> shadowEffect)>()(
      ptr.ref.lpVtbl, shadowEffect);

  int CreateHueRotationEffect(Pointer<Pointer<COMObject>> hueRotationEffect) =>
      ptr.ref.lpVtbl.value
          .elementAt(28)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer,
                  Pointer<Pointer<COMObject>>
                      hueRotationEffect)>()(ptr.ref.lpVtbl, hueRotationEffect);

  int CreateSaturationEffect(Pointer<Pointer<COMObject>> saturationEffect) =>
      ptr.ref.lpVtbl.value
              .elementAt(29)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> saturationEffect)>()(
          ptr.ref.lpVtbl, saturationEffect);

  int CreateTurbulenceEffect(Pointer<Pointer<COMObject>> turbulenceEffect) =>
      ptr.ref.lpVtbl.value
              .elementAt(30)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> turbulenceEffect)>()(
          ptr.ref.lpVtbl, turbulenceEffect);
      ...
      CreateLinearTransferEffect(
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(Pointer,
                          Pointer<Pointer<COMObject>> linearTransferEffect)>()(
              ptr.ref.lpVtbl, linearTransferEffect);
      ...
      CreateTableTransferEffect(
          ...
          ptr
                  ...
                  .asFunction<
                      int Function(Pointer,
                          Pointer<Pointer<COMObject>> tableTransferEffect)>()(
              ptr.ref.lpVtbl, tableTransferEffect);

  int CreateCompositeEffect(Pointer<Pointer<COMObject>> compositeEffect) =>
      ptr.ref.lpVtbl.value
              .elementAt(33)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> compositeEffect)>()(
          ptr.ref.lpVtbl, compositeEffect);

  int CreateBlendEffect(Pointer<Pointer<COMObject>> blendEffect) => ptr
          .ref.lpVtbl.value
          .elementAt(34)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> blendEffect)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> blendEffect)>()(
      ptr.ref.lpVtbl, blendEffect);
  ...
  int CreateArithmeticCompositeEffect(
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer,
                      Pointer<Pointer<COMObject>> arithmeticCompositeEffect)>()(
          ptr.ref.lpVtbl, arithmeticCompositeEffect);
  ...
  int CreateAffineTransform2DEffect(
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer,
                      Pointer<Pointer<COMObject>> affineTransform2dEffect)>()(
          ptr.ref.lpVtbl, affineTransform2dEffect);
}
