...
class IDCompositionMatrixTransform3D extends IDCompositionTransform3D {
  ...
  int SetMatrix(Pointer<D3DMATRIX> matrix) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<D3DMATRIX> matrix)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<D3DMATRIX> matrix)>()(
