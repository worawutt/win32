...
class IDCompositionFilterEffect extends IDCompositionEffect {
  ...
  int SetInput(int index, Pointer<COMObject> input, int flags) =>
              ...
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Uint32 index,
                          Pointer<COMObject> input, Uint32 flags)>>>()
          .value
          .asFunction<
              int Function(Pointer, int index, Pointer<COMObject> input,
                  int flags)>()(ptr.ref.lpVtbl, index, input, flags);
}
