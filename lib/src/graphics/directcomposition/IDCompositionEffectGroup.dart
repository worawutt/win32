...
class IDCompositionEffectGroup extends IDCompositionEffect {
  ...
  int SetTransform3D(Pointer<COMObject> transform3D) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> transform3D)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<COMObject> transform3D)>()(ptr.ref.lpVtbl, transform3D);
}
