...
class IDCompositionColorMatrixEffect extends IDCompositionFilterEffect {
  ...
  int SetMatrix(Pointer<D2D_MATRIX_5X4_F> matrix) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<D2D_MATRIX_5X4_F> matrix)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<D2D_MATRIX_5X4_F> matrix)>()(ptr.ref.lpVtbl, matrix);

  int SetMatrixElement_1(int row, int column, Pointer<COMObject> animation) =>
  ...
  int SetMatrixElement(int row, int column, double value) =>
      ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
  ...
  int SetAlphaMode(int mode) => ptr.ref.lpVtbl.value
      .elementAt(7)
  ...
  int SetClampOutput(int clamp) => ptr.ref.lpVtbl.value
      .elementAt(8)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 clamp)>>>()
      .value
      .asFunction<int Function(Pointer, int clamp)>()(ptr.ref.lpVtbl, clamp);
}
