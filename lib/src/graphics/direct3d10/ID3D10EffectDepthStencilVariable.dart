...
class ID3D10EffectDepthStencilVariable extends ID3D10EffectVariable {
  ...
  int
      GetDepthStencilState(
              int Index, Pointer<Pointer<COMObject>> ppDepthStencilState) =>
          ptr.ref.lpVtbl.value
              ...
              ptr.ref.lpVtbl, Index, ppDepthStencilState);

  int GetBackingStore(
          int Index, Pointer<D3D10_DEPTH_STENCIL_DESC> pDepthStencilDesc) =>
      ptr.ref.lpVtbl.value
              .elementAt(26)
              .cast<
                  Pointer<
          ...
          ptr.ref.lpVtbl, Index, pDepthStencilDesc);
}
