...
class ID3D10EffectRasterizerVariable extends ID3D10EffectVariable {
  ...
  int
      GetRasterizerState(
              int Index, Pointer<Pointer<COMObject>> ppRasterizerState) =>
          ptr.ref.lpVtbl.value
              ...
              ptr.ref.lpVtbl, Index, ppRasterizerState);

  int
      GetBackingStore(
              int Index, Pointer<D3D10_RASTERIZER_DESC> pRasterizerDesc) =>
          ptr.ref.lpVtbl.value
                  .elementAt(26)
                  .cast<
                      Pointer<
              ...
              ptr.ref.lpVtbl, Index, pRasterizerDesc);
}
