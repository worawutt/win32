...
class ID3D10Buffer extends ID3D10Resource {
  ...
  int $Map(int MapType, int MapFlags, Pointer<Pointer> ppData) => ptr
          .ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Int32 MapType, Uint32 MapFlags,
                          Pointer<Pointer> ppData)>>>()
          .value
          .asFunction<
              int Function(Pointer, int MapType, int MapFlags,
                  Pointer<Pointer> ppData)>()(
      ptr.ref.lpVtbl, MapType, MapFlags, ppData);
  ...
  void GetDesc(Pointer<D3D10_BUFFER_DESC> pDesc) => ptr.ref.lpVtbl.value
      .elementAt(12)
      .cast<
          Pointer<
              NativeFunction<
                  Void Function(Pointer, Pointer<D3D10_BUFFER_DESC> pDesc)>>>()
      .value
      .asFunction<
          void Function(Pointer,
              Pointer<D3D10_BUFFER_DESC> pDesc)>()(ptr.ref.lpVtbl, pDesc);
}
