...
class ID3D10BlendState1 extends ID3D10BlendState {
  ...
  void GetDesc1(Pointer<D3D10_BLEND_DESC1> pDesc) => ptr.ref.lpVtbl.value
      .elementAt(8)
      .cast<
          Pointer<
              NativeFunction<
                  Void Function(Pointer, Pointer<D3D10_BLEND_DESC1> pDesc)>>>()
      .value
      .asFunction<
          void Function(Pointer,
              Pointer<D3D10_BLEND_DESC1> pDesc)>()(ptr.ref.lpVtbl, pDesc);
}
