...
int D3D10CompileEffectFromMemory(
    ...
    _D3D10CompileEffectFromMemory(pData, DataLength, pSrcFileName, pDefines,
        pInclude, HLSLFlags, FXFlags, ppCompiledEffect, ppErrors);
...
late final _D3D10CompileEffectFromMemory = _d3d10.lookupFunction<
    ...
    int Function(
        ...
        int FXFlags,
        Pointer<Pointer<COMObject>> ppCompiledEffect,
        Pointer<Pointer<COMObject>> ppErrors)>('D3D10CompileEffectFromMemory');
...
int D3D10CompileShader(
    ...
    _D3D10CompileShader(pSrcData, SrcDataSize, pFileName, pDefines, pInclude,
...
late final _D3D10CompileShader = _d3d10.lookupFunction<
    ...
    int Function(
        ...
        int Flags,
        Pointer<Pointer<COMObject>> ppShader,
        Pointer<Pointer<COMObject>> ppErrorMsgs)>('D3D10CompileShader');

int D3D10CreateBlob(int NumBytes, Pointer<Pointer<COMObject>> ppBuffer) =>
    _D3D10CreateBlob(NumBytes, ppBuffer);

late final _D3D10CreateBlob = _d3d10.lookupFunction<
    Int32 Function(IntPtr NumBytes, Pointer<Pointer<COMObject>> ppBuffer),
    int Function(
        int NumBytes, Pointer<Pointer<COMObject>> ppBuffer)>('D3D10CreateBlob');

int D3D10CreateDevice(Pointer<COMObject> pAdapter, int DriverType, int Software,
        int Flags, int SDKVersion, Pointer<Pointer<COMObject>> ppDevice) =>
    _D3D10CreateDevice(
...
late final _D3D10CreateDevice = _d3d10.lookupFunction<
    ...
    int Function(
        ...
        int Flags,
        int SDKVersion,
        Pointer<Pointer<COMObject>> ppDevice)>('D3D10CreateDevice');
...
int D3D10CreateDeviceAndSwapChain(
        ...
        Pointer<Pointer<COMObject>> ppDevice) =>
    _D3D10CreateDeviceAndSwapChain(pAdapter, DriverType, Software, Flags,
...
late final _D3D10CreateDeviceAndSwapChain = _d3d10.lookupFunction<
    ...
    int Function(
        ...
        Pointer<DXGI_SWAP_CHAIN_DESC> pSwapChainDesc,
        Pointer<Pointer<COMObject>> ppSwapChain,
        Pointer<Pointer<COMObject>> ppDevice)>('D3D10CreateDeviceAndSwapChain');
...
late final _D3D10CreateEffectFromMemory = _d3d10.lookupFunction<
    ...
    int Function(
        ...
        Pointer<COMObject> pDevice,
        Pointer<COMObject> pEffectPool,
        Pointer<Pointer<COMObject>> ppEffect)>('D3D10CreateEffectFromMemory');

int D3D10CreateEffectPoolFromMemory(Pointer pData, int DataLength, int FXFlags,
        Pointer<COMObject> pDevice, Pointer<Pointer<COMObject>> ppEffectPool) =>
...
late final _D3D10CreateEffectPoolFromMemory = _d3d10.lookupFunction<
    Int32 Function(Pointer pData, IntPtr DataLength, Uint32 FXFlags,
        Pointer<COMObject> pDevice, Pointer<Pointer<COMObject>> ppEffectPool),
    int Function(
        Pointer pData,
        int DataLength,
        ...
        Pointer<Pointer<COMObject>>
            ppEffectPool)>('D3D10CreateEffectPoolFromMemory');
...
late final _D3D10CreateStateBlock = _d3d10.lookupFunction<
    ...
    int Function(
        Pointer<COMObject> pDevice,
        Pointer<D3D10_STATE_BLOCK_MASK> pStateBlockMask,
        Pointer<Pointer<COMObject>> ppStateBlock)>('D3D10CreateStateBlock');

int D3D10DisassembleEffect(Pointer<COMObject> pEffect, int EnableColorCode,
...
late final _D3D10DisassembleEffect = _d3d10.lookupFunction<
    Int32 Function(Pointer<COMObject> pEffect, Int32 EnableColorCode,
        Pointer<Pointer<COMObject>> ppDisassembly),
    int Function(Pointer<COMObject> pEffect, int EnableColorCode,
        Pointer<Pointer<COMObject>> ppDisassembly)>('D3D10DisassembleEffect');
...
late final _D3D10DisassembleShader = _d3d10.lookupFunction<
    ...
    int Function(
        ...
        int EnableColorCode,
        Pointer<Utf8> pComments,
        Pointer<Pointer<COMObject>> ppDisassembly)>('D3D10DisassembleShader');

Pointer<Utf8> D3D10GetGeometryShaderProfile(Pointer<COMObject> pDevice) =>
    _D3D10GetGeometryShaderProfile(pDevice);

late final _D3D10GetGeometryShaderProfile = _d3d10.lookupFunction<
    Pointer<Utf8> Function(Pointer<COMObject> pDevice),
    Pointer<Utf8> Function(
        Pointer<COMObject> pDevice)>('D3D10GetGeometryShaderProfile');

int D3D10GetInputAndOutputSignatureBlob(Pointer pShaderBytecode,
        int BytecodeLength, Pointer<Pointer<COMObject>> ppSignatureBlob) =>
...
late final _D3D10GetInputAndOutputSignatureBlob = _d3d10.lookupFunction<
        ...
        int Function(Pointer pShaderBytecode, int BytecodeLength,
            Pointer<Pointer<COMObject>> ppSignatureBlob)>(
    'D3D10GetInputAndOutputSignatureBlob');

int D3D10GetInputSignatureBlob(Pointer pShaderBytecode, int BytecodeLength,
        Pointer<Pointer<COMObject>> ppSignatureBlob) =>
...
int D3D10GetOutputSignatureBlob(Pointer pShaderBytecode, int BytecodeLength,
        Pointer<Pointer<COMObject>> ppSignatureBlob) =>
...
Pointer<Utf8> D3D10GetPixelShaderProfile(Pointer<COMObject> pDevice) =>
    _D3D10GetPixelShaderProfile(pDevice);

late final _D3D10GetPixelShaderProfile = _d3d10.lookupFunction<
    Pointer<Utf8> Function(Pointer<COMObject> pDevice),
    Pointer<Utf8> Function(
        Pointer<COMObject> pDevice)>('D3D10GetPixelShaderProfile');

int D3D10GetShaderDebugInfo(Pointer pShaderBytecode, int BytecodeLength,
...
late final _D3D10GetShaderDebugInfo = _d3d10.lookupFunction<
    Int32 Function(Pointer pShaderBytecode, IntPtr BytecodeLength,
        Pointer<Pointer<COMObject>> ppDebugInfo),
    int Function(Pointer pShaderBytecode, int BytecodeLength,
        Pointer<Pointer<COMObject>> ppDebugInfo)>('D3D10GetShaderDebugInfo');

Pointer<Utf8> D3D10GetVertexShaderProfile(Pointer<COMObject> pDevice) =>
    _D3D10GetVertexShaderProfile(pDevice);

late final _D3D10GetVertexShaderProfile = _d3d10.lookupFunction<
    Pointer<Utf8> Function(Pointer<COMObject> pDevice),
    Pointer<Utf8> Function(
        Pointer<COMObject> pDevice)>('D3D10GetVertexShaderProfile');
...
int D3D10PreprocessShader(
        ...
        Pointer<Pointer<COMObject>> ppErrorMsgs) =>
    _D3D10PreprocessShader(pSrcData, SrcDataSize, pFileName, pDefines, pInclude,
...
late final _D3D10PreprocessShader = _d3d10.lookupFunction<
    ...
    int Function(
        ...
        Pointer<COMObject> pInclude,
        Pointer<Pointer<COMObject>> ppShaderText,
        Pointer<Pointer<COMObject>> ppErrorMsgs)>('D3D10PreprocessShader');

int D3D10ReflectShader(Pointer pShaderBytecode, int BytecodeLength,
...
late final _D3D10ReflectShader = _d3d10.lookupFunction<
    Int32 Function(Pointer pShaderBytecode, IntPtr BytecodeLength,
        Pointer<Pointer<COMObject>> ppReflector),
    int Function(Pointer pShaderBytecode, int BytecodeLength,
        Pointer<Pointer<COMObject>> ppReflector)>('D3D10ReflectShader');
...
int D3D10StateBlockMaskDisableCapture(Pointer<D3D10_STATE_BLOCK_MASK> pMask,
        int StateType, int RangeStart, int RangeLength) =>
...
late final _D3D10StateBlockMaskDisableCapture = _d3d10.lookupFunction<
    Int32 Function(Pointer<D3D10_STATE_BLOCK_MASK> pMask, Int32 StateType,
        Uint32 RangeStart, Uint32 RangeLength),
    int Function(Pointer<D3D10_STATE_BLOCK_MASK> pMask, int StateType,
        int RangeStart, int RangeLength)>('D3D10StateBlockMaskDisableCapture');
...
late final _D3D10StateBlockMaskEnableAll = _d3d10.lookupFunction<
    Int32 Function(Pointer<D3D10_STATE_BLOCK_MASK> pMask),
    int Function(
        Pointer<D3D10_STATE_BLOCK_MASK> pMask)>('D3D10StateBlockMaskEnableAll');

int D3D10StateBlockMaskEnableCapture(Pointer<D3D10_STATE_BLOCK_MASK> pMask,
        int StateType, int RangeStart, int RangeLength) =>
...
late final _D3D10StateBlockMaskEnableCapture = _d3d10.lookupFunction<
    Int32 Function(Pointer<D3D10_STATE_BLOCK_MASK> pMask, Int32 StateType,
        Uint32 RangeStart, Uint32 RangeLength),
    int Function(Pointer<D3D10_STATE_BLOCK_MASK> pMask, int StateType,
        int RangeStart, int RangeLength)>('D3D10StateBlockMaskEnableCapture');

int D3D10StateBlockMaskGetSetting(
        Pointer<D3D10_STATE_BLOCK_MASK> pMask, int StateType, int Entry) =>
    _D3D10StateBlockMaskGetSetting(pMask, StateType, Entry);

late final _D3D10StateBlockMaskGetSetting = _d3d10.lookupFunction<
    Int32 Function(
        Pointer<D3D10_STATE_BLOCK_MASK> pMask, Int32 StateType, Uint32 Entry),
    int Function(Pointer<D3D10_STATE_BLOCK_MASK> pMask, int StateType,
        int Entry)>('D3D10StateBlockMaskGetSetting');
...
late final _D3D10StateBlockMaskUnion = _d3d10.lookupFunction<
    ...
    int Function(
        Pointer<D3D10_STATE_BLOCK_MASK> pA,
        Pointer<D3D10_STATE_BLOCK_MASK> pB,
        Pointer<D3D10_STATE_BLOCK_MASK> pResult)>('D3D10StateBlockMaskUnion');
...
int D3D10CreateDevice1(
        ...
        int SDKVersion,
        Pointer<Pointer<COMObject>> ppDevice) =>
    _D3D10CreateDevice1(pAdapter, DriverType, Software, Flags, HardwareLevel,
        SDKVersion, ppDevice);
...
late final _D3D10CreateDevice1 = _d3d10_1.lookupFunction<
    ...
    int Function(
        ...
        int HardwareLevel,
        int SDKVersion,
        Pointer<Pointer<COMObject>> ppDevice)>('D3D10CreateDevice1');
...
int D3D10CreateDeviceAndSwapChain1(
        ...
        Pointer<Pointer<COMObject>> ppSwapChain,
        Pointer<Pointer<COMObject>> ppDevice) =>
    _D3D10CreateDeviceAndSwapChain1(pAdapter, DriverType, Software, Flags,
        HardwareLevel, SDKVersion, pSwapChainDesc, ppSwapChain, ppDevice);
