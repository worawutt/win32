...
class ID3D10Asynchronous extends ID3D10DeviceChild {
  ...
  int GetData(Pointer pData, int DataSize, int GetDataFlags) => ptr
          .ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer pData, Uint32 DataSize,
                          Uint32 GetDataFlags)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer, Pointer pData, int DataSize, int GetDataFlags)>()(
      ptr.ref.lpVtbl, pData, DataSize, GetDataFlags);
