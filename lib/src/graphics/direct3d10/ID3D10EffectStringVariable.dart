...
class ID3D10EffectStringVariable extends ID3D10EffectVariable {
  ...
  int GetString(Pointer<Pointer<Utf8>> ppString) => ptr.ref.lpVtbl.value
      .elementAt(25)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Pointer<Utf8>> ppString)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<Pointer<Utf8>> ppString)>()(ptr.ref.lpVtbl, ppString);

  int GetStringArray(Pointer<Pointer<Utf8>> ppStrings, int Offset, int Count) =>
      ptr.ref.lpVtbl.value
          .elementAt(26)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Pointer<Utf8>> ppStrings,
          ...
          .asFunction<
              int Function(
                  ...
                  int Offset,
                  int Count)>()(ptr.ref.lpVtbl, ppStrings, Offset, Count);
}
