...
class ID3D10EffectDepthStencilViewVariable extends ID3D10EffectVariable {
  ...
  int SetDepthStencil(Pointer<COMObject> pResource) => ptr.ref.lpVtbl.value
          .elementAt(25)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetDepthStencil(Pointer<Pointer<COMObject>> ppResource) => ptr
          .ref.lpVtbl.value
          .elementAt(26)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> ppResource)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> ppResource)>()(
      ptr.ref.lpVtbl, ppResource);

  int SetDepthStencilArray(
          Pointer<Pointer<COMObject>> ppResources, int Offset, int Count) =>
      ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<Pointer<COMObject>> ppResources,
                  int Offset,
                  int Count)>()(ptr.ref.lpVtbl, ppResources, Offset, Count);
