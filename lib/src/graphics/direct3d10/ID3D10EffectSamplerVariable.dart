...
class ID3D10EffectSamplerVariable extends ID3D10EffectVariable {
  ...
  int GetSampler(int Index, Pointer<Pointer<COMObject>> ppSampler) => ptr
          .ref.lpVtbl.value
          .elementAt(25)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, int Index, Pointer<Pointer<COMObject>> ppSampler)>()(
      ptr.ref.lpVtbl, Index, ppSampler);

  int GetBackingStore(int Index, Pointer<D3D10_SAMPLER_DESC> pSamplerDesc) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int Index,
                      Pointer<D3D10_SAMPLER_DESC> pSamplerDesc)>()(
          ptr.ref.lpVtbl, Index, pSamplerDesc);
}
