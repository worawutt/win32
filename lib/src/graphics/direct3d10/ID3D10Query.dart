...
class ID3D10Query extends ID3D10Asynchronous {
  ...
  void GetDesc(Pointer<D3D10_QUERY_DESC> pDesc) => ptr.ref.lpVtbl.value
      .elementAt(11)
      .cast<
          Pointer<
              NativeFunction<
                  Void Function(Pointer, Pointer<D3D10_QUERY_DESC> pDesc)>>>()
      .value
      .asFunction<
          void Function(Pointer,
              Pointer<D3D10_QUERY_DESC> pDesc)>()(ptr.ref.lpVtbl, pDesc);
}
