...
class ID3D10RasterizerState extends ID3D10DeviceChild {
  ...
  void GetDesc(Pointer<D3D10_RASTERIZER_DESC> pDesc) => ptr.ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
                  NativeFunction<
                      Void Function(
                          Pointer, Pointer<D3D10_RASTERIZER_DESC> pDesc)>>>()
          .value
          .asFunction<
              void Function(Pointer, Pointer<D3D10_RASTERIZER_DESC> pDesc)>()(
