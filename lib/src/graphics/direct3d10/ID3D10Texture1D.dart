...
class ID3D10Texture1D extends ID3D10Resource {
  ...
  int Map(int Subresource, int MapType, int MapFlags, Pointer<Pointer> ppData) => ptr.ref.lpVtbl.value      .elementAt(10)
      .cast<Pointer<NativeFunction<_Map_Native>>>()
      .value
      .asFunction<_Map_Dart>()(ptr.ref.lpVtbl, Subresource, MapType, MapFlags, ppData);
  ...
  void GetDesc(Pointer<D3D10_TEXTURE1D_DESC> pDesc) => ptr.ref.lpVtbl.value      .elementAt(12)
