...
class ID3D10Texture3D extends ID3D10Resource {
  ...
  int Map(int Subresource, int MapType, int MapFlags, Pointer<D3D10_MAPPED_TEXTURE3D> pMappedTex3D) => ptr.ref.lpVtbl.value      .elementAt(10)
      .cast<Pointer<NativeFunction<_Map_Native>>>()
      .value
      .asFunction<_Map_Dart>()(ptr.ref.lpVtbl, Subresource, MapType, MapFlags, pMappedTex3D);
  ...
  void GetDesc(Pointer<D3D10_TEXTURE3D_DESC> pDesc) => ptr.ref.lpVtbl.value      .elementAt(12)
