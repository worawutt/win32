...
class ID3D10EffectBlendVariable extends ID3D10EffectVariable {
  ...
  int GetBlendState(int Index, Pointer<Pointer<COMObject>> ppBlendState) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int Index,
                      Pointer<Pointer<COMObject>> ppBlendState)>()(
          ptr.ref.lpVtbl, Index, ppBlendState);

  int GetBackingStore(int Index, Pointer<D3D10_BLEND_DESC> pBlendDesc) => ptr
          .ref.lpVtbl.value
          .elementAt(26)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, int Index, Pointer<D3D10_BLEND_DESC> pBlendDesc)>()(
      ptr.ref.lpVtbl, Index, pBlendDesc);
}
