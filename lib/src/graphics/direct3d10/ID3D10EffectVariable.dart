...
class ID3D10EffectVariable {
  ...
  int GetDesc(Pointer<D3D10_EFFECT_VARIABLE_DESC> pDesc) => ptr.ref.lpVtbl.value
          .elementAt(2)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<D3D10_EFFECT_VARIABLE_DESC> pDesc)>()(
      ptr.ref.lpVtbl, pDesc);

  Pointer<COMObject> GetAnnotationByIndex(int Index) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  Pointer<COMObject> GetAnnotationByName(Pointer<Utf8> Name) => ptr
      .ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
  ...
  Pointer<COMObject> GetMemberByIndex(int Index) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  Pointer<COMObject> GetMemberByName(Pointer<Utf8> Name) => ptr.ref.lpVtbl.value
      .elementAt(6)
      .cast<
          Pointer<
              NativeFunction<
  ...
  Pointer<COMObject> GetMemberBySemantic(Pointer<Utf8> Semantic) => ptr
      .ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<
              NativeFunction<
                  Pointer<COMObject> Function(
                      Pointer, Pointer<Utf8> Semantic)>>>()
      .value
      .asFunction<
          Pointer<COMObject> Function(
              Pointer, Pointer<Utf8> Semantic)>()(ptr.ref.lpVtbl, Semantic);

  Pointer<COMObject> GetElement(int Index) => ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int SetRawValue(Pointer pData, int Offset, int ByteCount) =>
      ptr.ref.lpVtbl.value
          .elementAt(23)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer pData, Uint32 Offset,
                          Uint32 ByteCount)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer pData, int Offset,
                  int ByteCount)>()(ptr.ref.lpVtbl, pData, Offset, ByteCount);

  int GetRawValue(Pointer pData, int Offset, int ByteCount) =>
      ptr.ref.lpVtbl.value
          .elementAt(24)
          .cast<
              Pointer<
