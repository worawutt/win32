...
class ID3D12GraphicsCommandList4 extends ID3D12GraphicsCommandList3 {
                  ...
                  Pointer<
                      NativeFunction<
                          Void Function(
                              ...
                              Pointer<D3D12_RENDER_PASS_RENDER_TARGET_DESC>
                                  pRenderTargets,
                              Pointer<D3D12_RENDER_PASS_DEPTH_STENCIL_DESC>
                                  pDepthStencil,
                              Uint32 Flags)>>>()
              .value
              .asFunction<
                  void Function(
                      ...
                      Pointer<D3D12_RENDER_PASS_RENDER_TARGET_DESC> pRenderTargets,
                      Pointer<D3D12_RENDER_PASS_DEPTH_STENCIL_DESC> pDepthStencil,
                      int Flags)>()(ptr.ref.lpVtbl, NumRenderTargets,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  void Function(
                      ...
                      Pointer<D3D12_RAYTRACING_ACCELERATION_STRUCTURE_POSTBUILD_INFO_DESC>
                          pPostbuildInfoDescs)>()(
          ptr.ref.lpVtbl, pDesc, NumPostbuildInfoDescs, pPostbuildInfoDescs);
  ...
  void CopyRaytracingAccelerationStructure(int DestAccelerationStructureData,
          int SourceAccelerationStructureData, int Mode) =>
      ptr.ref.lpVtbl.value
              .elementAt(74)
              .cast<
                  Pointer<
              ...
              .value
              .asFunction<
                  void Function(Pointer, int DestAccelerationStructureData,
                      int SourceAccelerationStructureData, int Mode)>()(
          ptr.ref.lpVtbl,
  ...
  void SetPipelineState1(Pointer<COMObject> pStateObject) => ptr
      .ref.lpVtbl.value
      .elementAt(75)
      .cast<
          Pointer<
              NativeFunction<
                  Void Function(Pointer, Pointer<COMObject> pStateObject)>>>()
      .value
      .asFunction<
          void Function(Pointer,
              Pointer<COMObject> pStateObject)>()(ptr.ref.lpVtbl, pStateObject);

  void DispatchRays(Pointer<D3D12_DISPATCH_RAYS_DESC> pDesc) => ptr
          .ref.lpVtbl.value
          .elementAt(76)
          .cast<
              Pointer<
                  NativeFunction<
                      Void Function(
                          Pointer, Pointer<D3D12_DISPATCH_RAYS_DESC> pDesc)>>>()
          .value
          .asFunction<
              void Function(
                  Pointer, Pointer<D3D12_DISPATCH_RAYS_DESC> pDesc)>()(
