...
class ID3D12PipelineLibrary extends ID3D12DeviceChild {
  ...
  int StorePipeline(Pointer<Utf16> pName, Pointer<COMObject> pPipeline) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> pName,
                      Pointer<COMObject> pPipeline)>()(
          ptr.ref.lpVtbl, pName, pPipeline);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> riid,
                      Pointer<Pointer> ppPipelineState)>()(
          ptr.ref.lpVtbl, pName, pDesc, riid, ppPipelineState);
  ...
  int Serialize(Pointer pData, int DataSizeInBytes) => ptr.ref.lpVtbl.value
          .elementAt(12)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer pData, IntPtr DataSizeInBytes)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer pData, int DataSizeInBytes)>()(
      ptr.ref.lpVtbl, pData, DataSizeInBytes);
}
