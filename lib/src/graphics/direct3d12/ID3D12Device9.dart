...
class ID3D12Device9 extends ID3D12Device8 {
  ...
  int CreateShaderCacheSession(Pointer<D3D12_SHADER_CACHE_SESSION_DESC> pDesc,
          Pointer<GUID> riid, Pointer<Pointer> ppvSession) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> riid,
                      Pointer<Pointer> ppvSession)>()(
          ptr.ref.lpVtbl, pDesc, riid, ppvSession);

  int ShaderCacheControl(int Kinds, int Control) => ptr.ref.lpVtbl.value
          .elementAt(74)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Uint32 Kinds, Uint32 Control)>>>()
          .value
          .asFunction<int Function(Pointer, int Kinds, int Control)>()(
      ptr.ref.lpVtbl, Kinds, Control);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> riid,
                      Pointer<Pointer> ppCommandQueue)>()(
          ptr.ref.lpVtbl, pDesc, CreatorID, riid, ppCommandQueue);
}
