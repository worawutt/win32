...
class ID3D12ShaderCacheSession extends ID3D12DeviceChild {
  ...
  int FindValue(Pointer pKey, int KeySize, Pointer pValue,
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer pKey, Uint32 KeySize,
                              Pointer pValue, Pointer<Uint32> pValueSize)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer pKey, int KeySize,
                      Pointer pValue, Pointer<Uint32> pValueSize)>()(
          ptr.ref.lpVtbl, pKey, KeySize, pValue, pValueSize);

  int StoreValue(Pointer pKey, int KeySize, Pointer pValue, int ValueSize) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer pKey, Uint32 KeySize,
                              Pointer pValue, Uint32 ValueSize)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer pKey, int KeySize,
                      Pointer pValue, int ValueSize)>()(
          ptr.ref.lpVtbl, pKey, KeySize, pValue, ValueSize);
  ...
  D3D12_SHADER_CACHE_SESSION_DESC GetDesc() => ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      D3D12_SHADER_CACHE_SESSION_DESC Function(Pointer)>>>()
          .value
          .asFunction<D3D12_SHADER_CACHE_SESSION_DESC Function(Pointer)>()(
      ptr.ref.lpVtbl);
}
