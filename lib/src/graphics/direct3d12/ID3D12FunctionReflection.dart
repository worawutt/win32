...
class ID3D12FunctionReflection {
  ...
  int GetDesc(Pointer<D3D12_FUNCTION_DESC> pDesc) => ptr.ref.lpVtbl.value      .elementAt(0)
  ...
  int GetResourceBindingDesc(int ResourceIndex, Pointer<D3D12_SHADER_INPUT_BIND_DESC> pDesc) => ptr.ref.lpVtbl.value      .elementAt(3)
  ...
  int GetResourceBindingDescByName(Pointer<Utf8> Name, Pointer<D3D12_SHADER_INPUT_BIND_DESC> pDesc) => ptr.ref.lpVtbl.value      .elementAt(5)
