...
class ID3D12GraphicsCommandList extends ID3D12CommandList {
  ...
  int Reset(Pointer<COMObject> pAllocator, Pointer<COMObject> pInitialState) =>
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> pAllocator,
                      Pointer<COMObject> pInitialState)>()(
          ptr.ref.lpVtbl, pAllocator, pInitialState);

  void ClearState(Pointer<COMObject> pPipelineState) =>
      ptr.ref.lpVtbl.value
              .elementAt(11)
              .cast<
                  Pointer<
                      NativeFunction<
                          Void Function(
                              Pointer, Pointer<COMObject> pPipelineState)>>>()
              .value
              .asFunction<
                  void Function(Pointer, Pointer<COMObject> pPipelineState)>()(
          ptr.ref.lpVtbl, pPipelineState);
  ...
  void CopyBufferRegion(Pointer<COMObject> pDstBuffer, int DstOffset,
          Pointer<COMObject> pSrcBuffer, int SrcOffset, int NumBytes) =>
      ptr.ref.lpVtbl.value
              .elementAt(15)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  void Function(
                      ...
                      Pointer<COMObject> pSrcBuffer,
                      int SrcOffset,
                      int NumBytes)>()(ptr.ref.lpVtbl, pDstBuffer, DstOffset,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  void Function(
                      ...
                      Pointer<D3D12_TEXTURE_COPY_LOCATION> pSrc,
                      Pointer<D3D12_BOX> pSrcBox)>()(
          ptr.ref.lpVtbl, pDst, DstX, DstY, DstZ, pSrc, pSrcBox);
  ...
  void IASetPrimitiveTopology(int PrimitiveTopology) => ptr.ref.lpVtbl.value
          .elementAt(20)
          .cast<
              Pointer<
                  NativeFunction<
                      Void Function(Pointer, Int32 PrimitiveTopology)>>>()
          .value
          .asFunction<void Function(Pointer, int PrimitiveTopology)>()(
      ptr.ref.lpVtbl, PrimitiveTopology);

  void RSSetViewports(int NumViewports, Pointer<D3D12_VIEWPORT> pViewports) =>
      ptr.ref.lpVtbl.value
              .elementAt(21)
              .cast<
                  Pointer<
  ...
  void OMSetBlendFactor(Pointer<Float> BlendFactor) => ptr.ref.lpVtbl.value
          .elementAt(23)
          .cast<
              Pointer<
                  NativeFunction<
                      Void Function(Pointer, Pointer<Float> BlendFactor)>>>()
          .value
          .asFunction<void Function(Pointer, Pointer<Float> BlendFactor)>()(
      ptr.ref.lpVtbl, BlendFactor);

  void OMSetStencilRef(int StencilRef) => ptr.ref.lpVtbl.value
      .elementAt(24)
      .cast<
          Pointer<NativeFunction<Void Function(Pointer, Uint32 StencilRef)>>>()
      .value
      .asFunction<
          void Function(Pointer, int StencilRef)>()(ptr.ref.lpVtbl, StencilRef);

  void SetPipelineState(Pointer<COMObject> pPipelineState) =>
      ptr.ref.lpVtbl.value
              .elementAt(25)
              .cast<
                  Pointer<
  ...
  void ExecuteBundle(Pointer<COMObject> pCommandList) => ptr.ref.lpVtbl.value
      .elementAt(27)
      .cast<
          Pointer<
              NativeFunction<
      ...
      .asFunction<
          void Function(Pointer,
              Pointer<COMObject> pCommandList)>()(ptr.ref.lpVtbl, pCommandList);

  void
      SetDescriptorHeaps(int NumDescriptorHeaps,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      void Function(Pointer, int NumDescriptorHeaps,
                          Pointer<Pointer<COMObject>> ppDescriptorHeaps)>()(
              ptr.ref.lpVtbl, NumDescriptorHeaps, ppDescriptorHeaps);

  void SetComputeRootSignature(Pointer<COMObject> pRootSignature) =>
      ptr.ref.lpVtbl.value
              .elementAt(29)
              .cast<
                  Pointer<
                      NativeFunction<
                          Void Function(
                              Pointer, Pointer<COMObject> pRootSignature)>>>()
              .value
              .asFunction<
                  void Function(Pointer, Pointer<COMObject> pRootSignature)>()(
          ptr.ref.lpVtbl, pRootSignature);

  void SetGraphicsRootSignature(Pointer<COMObject> pRootSignature) =>
      ptr.ref.lpVtbl.value
              .elementAt(30)
              .cast<
                  Pointer<
  ...
  void SetComputeRootDescriptorTable(
          int RootParameterIndex, D3D12_GPU_DESCRIPTOR_HANDLE BaseDescriptor) =>
      ptr.ref.lpVtbl.value
              .elementAt(31)
              .cast<
                  Pointer<
                      NativeFunction<
                          Void Function(Pointer, Uint32 RootParameterIndex,
                              D3D12_GPU_DESCRIPTOR_HANDLE BaseDescriptor)>>>()
              .value
              .asFunction<
                  void Function(Pointer, int RootParameterIndex,
                      D3D12_GPU_DESCRIPTOR_HANDLE BaseDescriptor)>()(
          ptr.ref.lpVtbl, RootParameterIndex, BaseDescriptor);
  ...
  void
      SetComputeRoot32BitConstant(int RootParameterIndex, int SrcData,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      void Function(Pointer, int RootParameterIndex,
                          int SrcData, int DestOffsetIn32BitValues)>()(
              ptr.ref.lpVtbl,
              RootParameterIndex,
              SrcData,
  ...
  void
      SetGraphicsRoot32BitConstant(int RootParameterIndex, int SrcData,
              int DestOffsetIn32BitValues) =>
          ptr.ref.lpVtbl.value
                  .elementAt(34)
                  .cast<
  ...
  void SetComputeRootConstantBufferView(
          int RootParameterIndex, int BufferLocation) =>
      ptr.ref.lpVtbl.value
              .elementAt(37)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  void Function(
                      Pointer, int RootParameterIndex, int BufferLocation)>()(
          ptr.ref.lpVtbl, RootParameterIndex, BufferLocation);
  ...
  void IASetIndexBuffer(Pointer<D3D12_INDEX_BUFFER_VIE> pView) => ptr
          .ref.lpVtbl.value
          .elementAt(43)
          .cast<
              Pointer<
                  NativeFunction<
                      Void Function(
                          Pointer, Pointer<D3D12_INDEX_BUFFER_VIE> pView)>>>()
          .value
          .asFunction<
              void Function(Pointer, Pointer<D3D12_INDEX_BUFFER_VIE> pView)>()(
      ptr.ref.lpVtbl, pView);

  void IASetVertexBuffers(int StartSlot, int NumViews,
      ...
      ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Void Function(Pointer, Uint32 StartSlot, Uint32 NumViews,
                          Pointer<D3D12_VERTEX_BUFFER_VIE> pViews)>>>()
          .value
          .asFunction<
              void Function(
                  ...
                  int StartSlot,
                  int NumViews,
                  Pointer<D3D12_VERTEX_BUFFER_VIE>
                      pViews)>()(ptr.ref.lpVtbl, StartSlot, NumViews, pViews);

  void SOSetTargets(int StartSlot, int NumViews,
      ...
      ptr.ref.lpVtbl.value
          ...
          .asFunction<
              void Function(
                  ...
                  int StartSlot,
                  int NumViews,
                  Pointer<D3D12_STREAM_OUTPUT_BUFFER_VIE>
                      pViews)>()(ptr.ref.lpVtbl, StartSlot, NumViews, pViews);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  void Function(
                      ...
                      int Stencil,
                      int NumRects,
                      Pointer<RECT> pRects)>()(ptr.ref.lpVtbl, DepthStencilView,
          ClearFlags, Depth, Stencil, NumRects, pRects);

  void ClearRenderTargetView(D3D12_CPU_DESCRIPTOR_HANDLE RenderTargetView,
          Pointer<Float> ColorRGBA, int NumRects, Pointer<RECT> pRects) =>
      ptr.ref.lpVtbl.value
              .elementAt(48)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  void Function(
                      ...
                      int NumRects,
                      Pointer<RECT> pRects)>()(
          ptr.ref.lpVtbl, RenderTargetView, ColorRGBA, NumRects, pRects);
