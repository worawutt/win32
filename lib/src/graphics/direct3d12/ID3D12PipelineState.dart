...
class ID3D12PipelineState extends ID3D12Pageable {
  ...
  int GetCachedBlob(Pointer<Pointer<COMObject>> ppBlob) => ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<Pointer<COMObject>> ppBlob)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<Pointer<COMObject>> ppBlob)>()(
