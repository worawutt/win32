...
class ID3D12CommandQueue extends ID3D12Pageable {
      ...
      ptr.ref.lpVtbl.value
          ...
          .asFunction<
              void Function(
                  ...
                  Pointer<Uint32> pHeapRangeStartOffsets,
                  Pointer<Uint32> pRangeTileCounts,
                  int Flags)>()(ptr.ref.lpVtbl, pResource, NumResourceRegions, pResourceRegionStartCoordinates, pResourceRegionSizes, pHeap, NumRanges, pRangeFlags, pHeapRangeStartOffsets, pRangeTileCounts, Flags);
          ...
          .asFunction<
              void Function(
                  ...
                  Pointer<D3D12_TILED_RESOURCE_COORDINATE>
                      pSrcRegionStartCoordinate,
                  Pointer<D3D12_TILE_REGION_SIZE> pRegionSize,
                  int Flags)>()(ptr.ref.lpVtbl, pDstResource, pDstRegionStartCoordinate, pSrcResource, pSrcRegionStartCoordinate, pRegionSize, Flags);

  void ExecuteCommandLists(
          int NumCommandLists, Pointer<Pointer<COMObject>> ppCommandLists) =>
      ptr.ref.lpVtbl.value
              .elementAt(10)
              .cast<
                  Pointer<
                      NativeFunction<
                          Void Function(Pointer, Uint32 NumCommandLists,
                              Pointer<Pointer<COMObject>> ppCommandLists)>>>()
              .value
              .asFunction<
                  void Function(Pointer, int NumCommandLists,
                      Pointer<Pointer<COMObject>> ppCommandLists)>()(
          ptr.ref.lpVtbl, NumCommandLists, ppCommandLists);
  ...
  int Signal(Pointer<COMObject> pFence, int Value) => ptr.ref.lpVtbl.value
          .elementAt(14)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<COMObject> pFence, Uint64 Value)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> pFence, int Value)>()(
      ptr.ref.lpVtbl, pFence, Value);

  int Wait(Pointer<COMObject> pFence, int Value) => ptr.ref.lpVtbl.value
          .elementAt(15)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetTimestampFrequency(Pointer<Uint64> pFrequency) => ptr.ref.lpVtbl.value
          .elementAt(16)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Uint64> pFrequency)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Uint64> pFrequency)>()(
      ptr.ref.lpVtbl, pFrequency);

  int GetClockCalibration(
          Pointer<Uint64> pGpuTimestamp, Pointer<Uint64> pCpuTimestamp) =>
      ptr.ref.lpVtbl.value
              .elementAt(17)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Uint64> pGpuTimestamp,
                              Pointer<Uint64> pCpuTimestamp)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint64> pGpuTimestamp,
                      Pointer<Uint64> pCpuTimestamp)>()(
          ptr.ref.lpVtbl, pGpuTimestamp, pCpuTimestamp);

  D3D12_COMMAND_QUEUE_DESC GetDesc() => ptr.ref.lpVtbl.value
      .elementAt(18)
      .cast<
          Pointer<NativeFunction<D3D12_COMMAND_QUEUE_DESC Function(Pointer)>>>()
      .value
      .asFunction<D3D12_COMMAND_QUEUE_DESC Function(Pointer)>()(ptr.ref.lpVtbl);
}
