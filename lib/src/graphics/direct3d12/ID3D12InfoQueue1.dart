      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer,
                              Pointer<NativeFunction<D3D12MessageFunc>>
                                  CallbackFunc,
              ...
              .asFunction<
                  int Function(
                      ...
                      int CallbackFilterFlags,
                      Pointer pContext,
                      Pointer<Uint32> pCallbackCookie)>()(ptr.ref.lpVtbl,
          CallbackFunc, CallbackFilterFlags, pContext, pCallbackCookie);

  int UnregisterMessageCallback(int CallbackCookie) => ptr.ref.lpVtbl.value
      .elementAt(39)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Uint32 CallbackCookie)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int CallbackCookie)>()(ptr.ref.lpVtbl, CallbackCookie);
}
