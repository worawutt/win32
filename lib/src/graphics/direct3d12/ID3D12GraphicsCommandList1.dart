...
class ID3D12GraphicsCommandList1 extends ID3D12GraphicsCommandList {
  ...
  void AtomicCopyBufferUINT(
      ...
      ptr.ref.lpVtbl.value
          ...
          ptr.ref.lpVtbl, pDstBuffer, DstOffset, pSrcBuffer, SrcOffset, Dependencies, ppDependentResources, pDependentSubresourceRanges);
  ...
  void OMSetDepthBounds(double Min, double Max) => ptr.ref.lpVtbl.value
      .elementAt(62)
      .cast<
          Pointer<
              NativeFunction<Void Function(Pointer, Float Min, Float Max)>>>()
      .value
      .asFunction<
          void Function(
              Pointer, double Min, double Max)>()(ptr.ref.lpVtbl, Min, Max);

  void
      SetSamplePositions(int NumSamplesPerPixel, int NumPixels,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      void Function(
                          ...
                          int NumPixels,
                          Pointer<D3D12_SAMPLE_POSITION> pSamplePositions)>()(
              ptr.ref.lpVtbl, NumSamplesPerPixel, NumPixels, pSamplePositions);
  ...
  void SetViewInstanceMask(int Mask) => ptr.ref.lpVtbl.value
      .elementAt(65)
      .cast<Pointer<NativeFunction<Void Function(Pointer, Uint32 Mask)>>>()
      .value
      .asFunction<void Function(Pointer, int Mask)>()(ptr.ref.lpVtbl, Mask);
}
