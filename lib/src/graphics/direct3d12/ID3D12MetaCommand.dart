...
class ID3D12MetaCommand extends ID3D12Pageable {
  ...
  int GetRequiredParameterResourceSize(int Stage, int ParameterIndex) => ptr
          .ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
                      Uint64 Function(
                          Pointer, Int32 Stage, Uint32 ParameterIndex)>>>()
          .value
          .asFunction<int Function(Pointer, int Stage, int ParameterIndex)>()(
      ptr.ref.lpVtbl, Stage, ParameterIndex);
}
