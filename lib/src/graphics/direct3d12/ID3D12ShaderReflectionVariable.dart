...
class ID3D12ShaderReflectionVariable {
  ...
  int GetDesc(Pointer<D3D12_SHADER_VARIABLE_DESC> pDesc) => ptr.ref.lpVtbl.value
          .elementAt(0)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .asFunction<
              int Function(
                  Pointer, Pointer<D3D12_SHADER_VARIABLE_DESC> pDesc)>()(
  ...
  int GetInterfaceSlot(int uArrayIndex) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<Uint32 Function(Pointer, Uint32 uArrayIndex)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, int uArrayIndex)>()(ptr.ref.lpVtbl, uArrayIndex);
}
