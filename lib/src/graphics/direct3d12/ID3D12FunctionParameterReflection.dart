...
class ID3D12FunctionParameterReflection {
  ...
  int GetDesc(Pointer<D3D12_PARAMETER_DESC> pDesc) => ptr.ref.lpVtbl.value
          .elementAt(0)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<D3D12_PARAMETER_DESC> pDesc)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<D3D12_PARAMETER_DESC> pDesc)>()(
