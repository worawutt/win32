...
class ID3D12Tools extends IUnknown {
  ...
  void EnableShaderInstrumentation(int bEnable) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<Pointer<NativeFunction<Void Function(Pointer, Int32 bEnable)>>>()
      .value
      .asFunction<
          void Function(Pointer, int bEnable)>()(ptr.ref.lpVtbl, bEnable);
