...
class ID3D12Device4 extends ID3D12Device3 {
  ...
  int CreateCommandList1(int nodeMask, int type, int flags, Pointer<GUID> riid,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int nodeMask, int type, int flags,
                      Pointer<GUID> riid, Pointer<Pointer> ppCommandList)>()(
          ptr.ref.lpVtbl, nodeMask, type, flags, riid, ppCommandList);
      ...
      ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<GUID> riid,
                  Pointer<Pointer>
                      ppSession)>()(ptr.ref.lpVtbl, pDesc, riid, ppSession);
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> riid,
                      Pointer<Pointer> ppvHeap)>()(
          ptr.ref.lpVtbl, pDesc, pProtectedSession, riid, ppvHeap);
