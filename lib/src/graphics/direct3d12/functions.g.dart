...
int D3D12CreateDevice(Pointer<COMObject> pAdapter, int MinimumFeatureLevel,
        Pointer<GUID> riid, Pointer<Pointer> ppDevice) =>
    _D3D12CreateDevice(pAdapter, MinimumFeatureLevel, riid, ppDevice);

late final _D3D12CreateDevice = _d3d12.lookupFunction<
    Int32 Function(Pointer<COMObject> pAdapter, Int32 MinimumFeatureLevel,
        Pointer<GUID> riid, Pointer<Pointer> ppDevice),
    int Function(Pointer<COMObject> pAdapter, int MinimumFeatureLevel,
        Pointer<GUID> riid, Pointer<Pointer> ppDevice)>('D3D12CreateDevice');
...
int D3D12CreateRootSignatureDeserializer(
    ...
    _D3D12CreateRootSignatureDeserializer(pSrcData, SrcDataSizeInBytes,
...
int D3D12CreateVersionedRootSignatureDeserializer(
        ...
        Pointer<GUID> pRootSignatureDeserializerInterface,
        Pointer<Pointer> ppRootSignatureDeserializer) =>
    _D3D12CreateVersionedRootSignatureDeserializer(pSrcData, SrcDataSizeInBytes,
        pRootSignatureDeserializerInterface, ppRootSignatureDeserializer);
...
late final _D3D12GetDebugInterface = _d3d12.lookupFunction<
    ...
    int Function(Pointer<GUID> riid,
        Pointer<Pointer> ppvDebug)>('D3D12GetDebugInterface');

int D3D12GetInterface(
        Pointer<GUID> rclsid, Pointer<GUID> riid, Pointer<Pointer> ppvDebug) =>
...
late final _D3D12GetInterface = _d3d12.lookupFunction<
    ...
    int Function(Pointer<GUID> rclsid, Pointer<GUID> riid,
        Pointer<Pointer> ppvDebug)>('D3D12GetInterface');
