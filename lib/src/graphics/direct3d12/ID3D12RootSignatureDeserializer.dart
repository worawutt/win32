...
class ID3D12RootSignatureDeserializer extends IUnknown {
  ...
  Pointer<D3D12_ROOT_SIGNATURE_DESC> GetRootSignatureDesc() => ptr
          .ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Pointer<D3D12_ROOT_SIGNATURE_DESC> Function(Pointer)>>>()
          .value
          .asFunction<Pointer<D3D12_ROOT_SIGNATURE_DESC> Function(Pointer)>()(
      ptr.ref.lpVtbl);
}
