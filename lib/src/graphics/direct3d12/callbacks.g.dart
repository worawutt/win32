...
typedef D3D12MessageFunc = Void Function(Int32 Category, Int32 Severity,
    Int32 ID, Pointer<Utf8> pDescription, Pointer pContext);
typedef PFN_D3D12_CREATE_DEVICE = Int32 Function(Pointer<COMObject> param0,
    Int32 param1, Pointer<GUID> param2, Pointer<Pointer> param3);
...
typedef PFN_D3D12_GET_DEBUG_INTERFACE = Int32 Function(
    Pointer<GUID> param0, Pointer<Pointer> param1);
