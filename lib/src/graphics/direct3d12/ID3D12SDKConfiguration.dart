...
class ID3D12SDKConfiguration extends IUnknown {
  ...
  int SetSDKVersion(int SDKVersion, Pointer<Utf8> SDKPath) => ptr
      .ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Uint32 SDKVersion, Pointer<Utf8> SDKPath)>>>()
      .value
      .asFunction<
          int Function(Pointer, int SDKVersion,
              Pointer<Utf8> SDKPath)>()(ptr.ref.lpVtbl, SDKVersion, SDKPath);
}
