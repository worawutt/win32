...
class ID3D11DeviceContext2 extends ID3D11DeviceContext1 {
      ...
      ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<Uint32> pTilePoolStartOffsets,
                  Pointer<Uint32> pRangeTileCounts,
                  int Flags)>()(ptr.ref.lpVtbl, pTiledResource, NumTiledResourceRegions, pTiledResourceRegionStartCoordinates, pTiledResourceRegionSizes, pTilePool, NumRanges, pRangeFlags, pTilePoolStartOffsets, pRangeTileCounts, Flags);
          ...
          .asFunction<
              int Function(
                  ...
                  Pointer<D3D11_TILED_RESOURCE_COORDINATE>
                      pSourceRegionStartCoordinate,
                  Pointer<D3D11_TILE_REGION_SIZE> pTileRegionSize,
                  int Flags)>()(ptr.ref.lpVtbl, pDestTiledResource, pDestRegionStartCoordinate, pSourceTiledResource, pSourceRegionStartCoordinate, pTileRegionSize, Flags);
  ...
  int ResizeTilePool(Pointer<COMObject> pTilePool, int NewSizeInBytes) => ptr
      .ref.lpVtbl.value
      .elementAt(138)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> pTilePool,
                      Uint64 NewSizeInBytes)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<COMObject> pTilePool,
              int NewSizeInBytes)>()(ptr.ref.lpVtbl, pTilePool, NewSizeInBytes);
  ...
  void SetMarkerInt(Pointer<Utf16> pLabel, int Data) => ptr.ref.lpVtbl.value
      .elementAt(141)
      .cast<
          Pointer<
              NativeFunction<
                  Void Function(Pointer, Pointer<Utf16> pLabel, Int32 Data)>>>()
      .value
      .asFunction<
          void Function(Pointer, Pointer<Utf16> pLabel,
              int Data)>()(ptr.ref.lpVtbl, pLabel, Data);

  void BeginEventInt(Pointer<Utf16> pLabel, int Data) => ptr.ref.lpVtbl.value
      .elementAt(142)
      .cast<
          Pointer<
              NativeFunction<
