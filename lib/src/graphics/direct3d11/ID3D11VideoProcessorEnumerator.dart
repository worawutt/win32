      ...
      ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(
                  Pointer,
                  Pointer<D3D11_VIDEO_PROCESSOR_CONTENT_DESC>
                      pContentDesc)>()(ptr.ref.lpVtbl, pContentDesc);

  int CheckVideoProcessorFormat(int Format, Pointer<Uint32> pFlags) =>
      ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Uint32 Format, Pointer<Uint32> pFlags)>>>()
          .value
          .asFunction<
              int Function(Pointer, int Format,
                  Pointer<Uint32> pFlags)>()(ptr.ref.lpVtbl, Format, pFlags);

  int GetVideoProcessorCaps(Pointer<D3D11_VIDEO_PROCESSOR_CAPS> pCaps) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<D3D11_VIDEO_PROCESSOR_CAPS> pCaps)>()(
          ptr.ref.lpVtbl, pCaps);

  int GetVideoProcessorRateConversionCaps(int TypeIndex,
      ...
      ptr.ref.lpVtbl.value
          ...
          .asFunction<
              int Function(
                  ...
                  int TypeIndex,
                  Pointer<D3D11_VIDEO_PROCESSOR_RATE_CONVERSION_CAPS>
                      pCaps)>()(ptr.ref.lpVtbl, TypeIndex, pCaps);

  int
      GetVideoProcessorCustomRate(int TypeIndex, int CustomRateIndex,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, int TypeIndex, int CustomRateIndex,
                          Pointer<D3D11_VIDEO_PROCESSOR_CUSTOM_RATE> pRate)>()(
              ptr.ref.lpVtbl, TypeIndex, CustomRateIndex, pRate);

  int GetVideoProcessorFilterRange(
          int Filter, Pointer<D3D11_VIDEO_PROCESSOR_FILTER_RANGE> pRange) =>
      ptr.ref.lpVtbl.value
              .elementAt(12)
              .cast<
                  Pointer<
