...
int D3D11CreateDevice(
    ...
    _D3D11CreateDevice(pAdapter, DriverType, Software, Flags, pFeatureLevels,
...
late final _D3D11CreateDevice = _d3d11.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Pointer<COMObject>> ppDevice,
        Pointer<Int32> pFeatureLevel,
        Pointer<Pointer<COMObject>> ppImmediateContext)>('D3D11CreateDevice');
...
late final _D3DX11CreateFFT = _d3dcsx.lookupFunction<
    ...
    int Function(
        ...
        int Flags,
        Pointer<D3DX11_FFT_BUFFER_INFO> pBufferInfo,
        Pointer<Pointer<COMObject>> ppFFT)>('D3DX11CreateFFT');
...
late final _D3DX11CreateFFT1DComplex = _d3dcsx.lookupFunction<
    ...
    int Function(
        ...
        int Flags,
        Pointer<D3DX11_FFT_BUFFER_INFO> pBufferInfo,
        Pointer<Pointer<COMObject>> ppFFT)>('D3DX11CreateFFT1DComplex');
...
late final _D3DX11CreateFFT1DReal = _d3dcsx.lookupFunction<
    ...
    int Function(
        ...
        int Flags,
        Pointer<D3DX11_FFT_BUFFER_INFO> pBufferInfo,
        Pointer<Pointer<COMObject>> ppFFT)>('D3DX11CreateFFT1DReal');
...
late final _D3DX11CreateFFT2DComplex = _d3dcsx.lookupFunction<
    ...
    int Function(
        ...
        int Flags,
        Pointer<D3DX11_FFT_BUFFER_INFO> pBufferInfo,
        Pointer<Pointer<COMObject>> ppFFT)>('D3DX11CreateFFT2DComplex');
...
late final _D3DX11CreateFFT2DReal = _d3dcsx.lookupFunction<
    ...
    int Function(
        ...
        int Flags,
        Pointer<D3DX11_FFT_BUFFER_INFO> pBufferInfo,
        Pointer<Pointer<COMObject>> ppFFT)>('D3DX11CreateFFT2DReal');
...
int D3DX11CreateFFT3DComplex(
    ...
    _D3DX11CreateFFT3DComplex(
        pDeviceContext, X, Y, Z, Flags, pBufferInfo, ppFFT);
...
late final _D3DX11CreateFFT3DComplex = _d3dcsx.lookupFunction<
    ...
    int Function(
        ...
        int Flags,
        Pointer<D3DX11_FFT_BUFFER_INFO> pBufferInfo,
        Pointer<Pointer<COMObject>> ppFFT)>('D3DX11CreateFFT3DComplex');
...
late final _D3DX11CreateFFT3DReal = _d3dcsx.lookupFunction<
    ...
    int Function(
        ...
        int Flags,
        Pointer<D3DX11_FFT_BUFFER_INFO> pBufferInfo,
        Pointer<Pointer<COMObject>> ppFFT)>('D3DX11CreateFFT3DReal');

int D3DX11CreateScan(Pointer<COMObject> pDeviceContext, int MaxElementScanSize,
        int MaxScanCount, Pointer<Pointer<COMObject>> ppScan) =>
...
late final _D3DX11CreateScan = _d3dcsx.lookupFunction<
    Int32 Function(Pointer<COMObject> pDeviceContext, Uint32 MaxElementScanSize,
        Uint32 MaxScanCount, Pointer<Pointer<COMObject>> ppScan),
    int Function(
        Pointer<COMObject> pDeviceContext,
        int MaxElementScanSize,
        int MaxScanCount,
        Pointer<Pointer<COMObject>> ppScan)>('D3DX11CreateScan');

int D3DX11CreateSegmentedScan(Pointer<COMObject> pDeviceContext,
        int MaxElementScanSize, Pointer<Pointer<COMObject>> ppScan) =>
...
late final _D3DX11CreateSegmentedScan = _d3dcsx.lookupFunction<
    ...
    int Function(Pointer<COMObject> pDeviceContext, int MaxElementScanSize,
        Pointer<Pointer<COMObject>> ppScan)>('D3DX11CreateSegmentedScan');
