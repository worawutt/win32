...
class ID3D11Device2 extends ID3D11Device1 {
  ...
  void
      GetImmediateContext2(Pointer<Pointer<COMObject>> ppImmediateContext) =>
  ...
  int
      CreateDeferredContext2(int ContextFlags,
  ...
  int
      CheckMultisampleQualityLevels1(int Format, int SampleCount, int Flags,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(Pointer, int Format, int SampleCount,
                          int Flags, Pointer<Uint32> pNumQualityLevels)>()(
              ptr.ref.lpVtbl, Format, SampleCount, Flags, pNumQualityLevels);
}
