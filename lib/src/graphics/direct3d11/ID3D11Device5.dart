...
class ID3D11Device5 extends ID3D11Device4 {
  ...
  int OpenSharedFence(int hFence, Pointer<GUID> ReturnedInterface,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> ReturnedInterface,
                      Pointer<Pointer> ppFence)>()(
          ptr.ref.lpVtbl, hFence, ReturnedInterface, ppFence);

  int CreateFence(int InitialValue, int Flags, Pointer<GUID> ReturnedInterface,
          Pointer<Pointer> ppFence) =>
      ptr.ref.lpVtbl.value
              .elementAt(68)
              .cast<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> ReturnedInterface,
                      Pointer<Pointer> ppFence)>()(
          ptr.ref.lpVtbl, InitialValue, Flags, ReturnedInterface, ppFence);
}
