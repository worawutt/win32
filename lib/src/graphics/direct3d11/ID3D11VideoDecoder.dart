...
class ID3D11VideoDecoder extends ID3D11DeviceChild {
  ...
  int GetCreationParameters(Pointer<D3D11_VIDEO_DECODER_DESC> pVideoDesc,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<D3D11_VIDEO_DECODER_DESC> pVideoDesc,
                      Pointer<D3D11_VIDEO_DECODER_CONFIG> pConfig)>()(
          ptr.ref.lpVtbl, pVideoDesc, pConfig);

  int GetDriverHandle(Pointer<IntPtr> pDriverHandle) => ptr.ref.lpVtbl.value
      .elementAt(8)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<IntPtr> pDriverHandle)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<IntPtr> pDriverHandle)>()(ptr.ref.lpVtbl, pDriverHandle);
}
