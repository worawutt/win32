...
class ID3D11Linker extends IUnknown {
  ...
  int UseLibrary(Pointer<COMObject> pLibraryMI) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<COMObject> pLibraryMI)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<COMObject> pLibraryMI)>()(ptr.ref.lpVtbl, pLibraryMI);

  int AddClipPlaneFromCBuffer(int uCBufferSlot, int uCBufferEntry) => ptr
          .ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Uint32 uCBufferSlot,
                          Uint32 uCBufferEntry)>>>()
          .value
          .asFunction<
              int Function(Pointer, int uCBufferSlot, int uCBufferEntry)>()(
      ptr.ref.lpVtbl, uCBufferSlot, uCBufferEntry);
}
