...
class ID3D11VideoProcessorEnumerator1 extends ID3D11VideoProcessorEnumerator {
  ...
  int CheckVideoProcessorFormatConversion(int InputFormat, int InputColorSpace,
          int OutputFormat, int OutputColorSpace, Pointer<Int32> pSupported) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Int32> pSupported)>()(ptr.ref.lpVtbl, InputFormat,
          InputColorSpace, OutputFormat, OutputColorSpace, pSupported);
}
