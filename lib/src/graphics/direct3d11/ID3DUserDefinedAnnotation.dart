...
class ID3DUserDefinedAnnotation extends IUnknown {
  ...
  int BeginEvent(Pointer<Utf16> Name) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
  ...
  void SetMarker(Pointer<Utf16> Name) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
              NativeFunction<Void Function(Pointer, Pointer<Utf16> Name)>>>()
      .value
      .asFunction<
          void Function(Pointer, Pointer<Utf16> Name)>()(ptr.ref.lpVtbl, Name);
