...
class ID3D11Module extends IUnknown {
  ...
  int CreateInstance(Pointer<Utf8> pNamespace,
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Utf8> pNamespace,
                              Pointer<Pointer<COMObject>> ppModuleInstance)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf8> pNamespace,
                      Pointer<Pointer<COMObject>> ppModuleInstance)>()(
          ptr.ref.lpVtbl, pNamespace, ppModuleInstance);
}
