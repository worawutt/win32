...
class ID3D11SwitchToRef extends IUnknown {
  ...
  int SetUseRef(int UseRef) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Int32 UseRef)>>>()
      .value
      .asFunction<int Function(Pointer, int UseRef)>()(ptr.ref.lpVtbl, UseRef);
