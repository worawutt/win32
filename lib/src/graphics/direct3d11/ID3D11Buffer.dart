...
class ID3D11Buffer extends ID3D11Resource {
  ...
  void GetDesc(Pointer<D3D11_BUFFER_DESC> pDesc) => ptr.ref.lpVtbl.value
      .elementAt(10)
      .cast<
          Pointer<
              NativeFunction<
                  Void Function(Pointer, Pointer<D3D11_BUFFER_DESC> pDesc)>>>()
      .value
      .asFunction<
          void Function(Pointer,
              Pointer<D3D11_BUFFER_DESC> pDesc)>()(ptr.ref.lpVtbl, pDesc);
}
