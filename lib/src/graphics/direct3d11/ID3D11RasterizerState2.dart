...
class ID3D11RasterizerState2 extends ID3D11RasterizerState1 {
  ...
  void GetDesc2(Pointer<D3D11_RASTERIZER_DESC2> pDesc) => ptr.ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
                      Void Function(
                          Pointer, Pointer<D3D11_RASTERIZER_DESC2> pDesc)>>>()
          .value
          .asFunction<
              void Function(Pointer, Pointer<D3D11_RASTERIZER_DESC2> pDesc)>()(
