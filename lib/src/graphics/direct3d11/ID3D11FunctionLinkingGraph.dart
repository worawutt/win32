...
class ID3D11FunctionLinkingGraph extends IUnknown {
  ...
  int CreateModuleInstance(Pointer<Pointer<COMObject>> ppModuleInstance,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppModuleInstance,
                      Pointer<Pointer<COMObject>> ppErrorBuffer)>()(
          ptr.ref.lpVtbl, ppModuleInstance, ppErrorBuffer);

  int SetInputSignature(Pointer<D3D11_PARAMETER_DESC> pInputParameters,
          int cInputParameters, Pointer<Pointer<COMObject>> ppInputNode) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppInputNode)>()(
          ptr.ref.lpVtbl, pInputParameters, cInputParameters, ppInputNode);

  int SetOutputSignature(Pointer<D3D11_PARAMETER_DESC> pOutputParameters,
          int cOutputParameters, Pointer<Pointer<COMObject>> ppOutputNode) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<COMObject>> ppOutputNode)>()(
          ptr.ref.lpVtbl, pOutputParameters, cOutputParameters, ppOutputNode);
  ...
  int PassValue(Pointer<COMObject> pSrcNode, int SrcParameterIndex,
          Pointer<COMObject> pDstNode, int DstParameterIndex) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pDstNode,
                      int DstParameterIndex)>()(ptr.ref.lpVtbl, pSrcNode,
          SrcParameterIndex, pDstNode, DstParameterIndex);
  ...
  int GetLastError(Pointer<Pointer<COMObject>> ppErrorBuffer) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<COMObject>> ppErrorBuffer)>()(
          ptr.ref.lpVtbl, ppErrorBuffer);

  int GenerateHlsl(int uFlags, Pointer<Pointer<COMObject>> ppBuffer) => ptr
          .ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Uint32 uFlags,
                          Pointer<Pointer<COMObject>> ppBuffer)>>>()
          .value
          .asFunction<
              int Function(
                  Pointer, int uFlags, Pointer<Pointer<COMObject>> ppBuffer)>()(
      ptr.ref.lpVtbl, uFlags, ppBuffer);
}
