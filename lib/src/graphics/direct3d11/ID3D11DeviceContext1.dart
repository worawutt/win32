...
class ID3D11DeviceContext1 extends ID3D11DeviceContext {
  ...
  void DiscardResource(Pointer<COMObject> pResource) => ptr.ref.lpVtbl.value
          .elementAt(117)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .value
          .asFunction<void Function(Pointer, Pointer<COMObject> pResource)>()(
      ptr.ref.lpVtbl, pResource);

  void DiscardView(Pointer<COMObject> pResourceView) =>
      ptr.ref.lpVtbl.value
              .elementAt(118)
              .cast<
                  Pointer<
                      NativeFunction<
                          Void Function(
                              Pointer, Pointer<COMObject> pResourceView)>>>()
              .value
              .asFunction<
                  void Function(Pointer, Pointer<COMObject> pResourceView)>()(
          ptr.ref.lpVtbl, pResourceView);
  ...
  void SwapDeviceContextState(Pointer<COMObject> pState,
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Void Function(Pointer, Pointer<COMObject> pState,
                              Pointer<Pointer<COMObject>> ppPreviousState)>>>()
              .value
              .asFunction<
                  void Function(Pointer, Pointer<COMObject> pState,
                      Pointer<Pointer<COMObject>> ppPreviousState)>()(
          ptr.ref.lpVtbl, pState, ppPreviousState);

  void ClearView(Pointer<COMObject> pView, Pointer<Float> Color,
          Pointer<RECT> pRect, int NumRects) =>
      ptr.ref.lpVtbl.value
              .elementAt(132)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  void Function(
                      ...
                      Pointer<RECT> pRect,
                      int NumRects)>()(
          ptr.ref.lpVtbl, pView, Color, pRect, NumRects);

  void
      DiscardView1(Pointer<COMObject> pResourceView, Pointer<RECT> pRects,
              int NumRects) =>
          ptr.ref.lpVtbl.value
                  .elementAt(133)
                  .cast<
                  ...
                  .asFunction<
                      void Function(Pointer, Pointer<COMObject> pResourceView,
                          Pointer<RECT> pRects, int NumRects)>()(
              ptr.ref.lpVtbl, pResourceView, pRects, NumRects);
}
