...
class ID3D11Texture2D1 extends ID3D11Texture2D {
  ...
  void GetDesc1(Pointer<D3D11_TEXTURE2D_DESC1> pDesc) => ptr.ref.lpVtbl.value
          .elementAt(11)
          .cast<
              Pointer<
                  NativeFunction<
                      Void Function(
                          Pointer, Pointer<D3D11_TEXTURE2D_DESC1> pDesc)>>>()
          .value
          .asFunction<
              void Function(Pointer, Pointer<D3D11_TEXTURE2D_DESC1> pDesc)>()(
