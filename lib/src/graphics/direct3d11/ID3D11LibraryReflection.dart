...
class ID3D11LibraryReflection extends IUnknown {
  ...
  int GetDesc(Pointer<D3D11_LIBRARY_DESC> pDesc) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<D3D11_LIBRARY_DESC> pDesc)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<D3D11_LIBRARY_DESC> pDesc)>()(
