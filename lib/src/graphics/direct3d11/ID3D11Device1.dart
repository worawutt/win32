...
class ID3D11Device1 extends ID3D11Device {
  ...
  void
      GetImmediateContext1(Pointer<Pointer<COMObject>> ppImmediateContext) =>
  ...
  int
      CreateDeferredContext1(int ContextFlags,
  ...
  int CreateBlendState1(Pointer<D3D11_BLEND_DESC1> pBlendStateDesc,
  ...
  int CreateRasterizerState1(Pointer<D3D11_RASTERIZER_DESC1> pRasterizerDesc,
  ...
  int OpenSharedResource1(int hResource, Pointer<GUID> returnedInterface,
  ...
  int OpenSharedResourceByName(Pointer<Utf16> lpName, int dwDesiredAccess,
          Pointer<GUID> returnedInterface, Pointer<Pointer> ppResource) =>
      ptr.ref.lpVtbl.value
              .elementAt(49)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      int dwDesiredAccess,
                      Pointer<GUID> returnedInterface,
                      Pointer<Pointer> ppResource)>()(ptr.ref.lpVtbl, lpName,
          dwDesiredAccess, returnedInterface, ppResource);
}
