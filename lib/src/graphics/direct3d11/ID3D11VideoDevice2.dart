...
class ID3D11VideoDevice2 extends ID3D11VideoDevice1 {
  ...
  int
      NegotiateCryptoSessionKeyExchangeMT(Pointer<COMObject> pCryptoSession,
              int flags, int DataSize, Pointer pData) =>
          ptr.ref.lpVtbl.value
                  .elementAt(25)
                  .cast<
                      Pointer<
                  ...
                  .asFunction<
                      int Function(Pointer, Pointer<COMObject> pCryptoSession,
                          int flags, int DataSize, Pointer pData)>()(
              ptr.ref.lpVtbl, pCryptoSession, flags, DataSize, pData);
}
