...
class ID3D11RefTrackingOptions extends IUnknown {
  ...
  int SetTrackingOptions(int uOptions) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Uint32 uOptions)>>>()
      .value
      .asFunction<
          int Function(Pointer, int uOptions)>()(ptr.ref.lpVtbl, uOptions);
}
