...
class ID3D11Texture1D extends ID3D11Resource {
  ...
  void GetDesc(Pointer<D3D11_TEXTURE1D_DESC> pDesc) => ptr.ref.lpVtbl.value
          .elementAt(10)
          .cast<
              Pointer<
                  NativeFunction<
                      Void Function(
                          Pointer, Pointer<D3D11_TEXTURE1D_DESC> pDesc)>>>()
          .value
          .asFunction<
              void Function(Pointer, Pointer<D3D11_TEXTURE1D_DESC> pDesc)>()(
