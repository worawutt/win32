...
class ID3D11InfoQueue extends IUnknown {
  ...
  int GetMessage(int MessageIndex, Pointer<D3D11_MESSAGE> pMessage, Pointer<IntPtr> pMessageByteLength) => ptr.ref.lpVtbl.value      .elementAt(5)
  ...
  int AddStorageFilterEntries(Pointer<D3D11_INFO_QUEUE_FILTER> pFilter) => ptr.ref.lpVtbl.value      .elementAt(12)
  ...
  int GetStorageFilter(Pointer<D3D11_INFO_QUEUE_FILTER> pFilter, Pointer<IntPtr> pFilterByteLength) => ptr.ref.lpVtbl.value      .elementAt(13)
  ...
  int PushStorageFilter(Pointer<D3D11_INFO_QUEUE_FILTER> pFilter) => ptr.ref.lpVtbl.value      .elementAt(17)
  ...
  int AddRetrievalFilterEntries(Pointer<D3D11_INFO_QUEUE_FILTER> pFilter) => ptr.ref.lpVtbl.value      .elementAt(20)
  ...
  int GetRetrievalFilter(Pointer<D3D11_INFO_QUEUE_FILTER> pFilter, Pointer<IntPtr> pFilterByteLength) => ptr.ref.lpVtbl.value      .elementAt(21)
  ...
  int PushRetrievalFilter(Pointer<D3D11_INFO_QUEUE_FILTER> pFilter) => ptr.ref.lpVtbl.value      .elementAt(25)
