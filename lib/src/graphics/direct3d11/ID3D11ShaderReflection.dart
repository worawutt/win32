...
class ID3D11ShaderReflection extends IUnknown {
  ...
  int GetDesc(Pointer<D3D11_SHADER_DESC> pDesc) => ptr.ref.lpVtbl.value      .elementAt(3)
  ...
  int GetResourceBindingDesc(int ResourceIndex, Pointer<D3D11_SHADER_INPUT_BIND_DESC> pDesc) => ptr.ref.lpVtbl.value      .elementAt(6)
  ...
  int GetInputParameterDesc(int ParameterIndex, Pointer<D3D11_SIGNATURE_PARAMETER_DESC> pDesc) => ptr.ref.lpVtbl.value      .elementAt(7)
  ...
  int GetOutputParameterDesc(int ParameterIndex, Pointer<D3D11_SIGNATURE_PARAMETER_DESC> pDesc) => ptr.ref.lpVtbl.value      .elementAt(8)
  ...
  int GetPatchConstantParameterDesc(int ParameterIndex, Pointer<D3D11_SIGNATURE_PARAMETER_DESC> pDesc) => ptr.ref.lpVtbl.value      .elementAt(9)
  ...
  int GetResourceBindingDescByName(Pointer<Utf8> Name, Pointer<D3D11_SHADER_INPUT_BIND_DESC> pDesc) => ptr.ref.lpVtbl.value      .elementAt(11)
