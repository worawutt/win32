...
class ID3D11SamplerState extends ID3D11DeviceChild {
  ...
  void GetDesc(Pointer<D3D11_SAMPLER_DESC> pDesc) => ptr.ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<
              NativeFunction<
                  Void Function(Pointer, Pointer<D3D11_SAMPLER_DESC> pDesc)>>>()
      .value
      .asFunction<
          void Function(Pointer,
              Pointer<D3D11_SAMPLER_DESC> pDesc)>()(ptr.ref.lpVtbl, pDesc);
}
