      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int OutState,
                      Pointer<GUID> riid,
                      Pointer<Pointer> ppResource11)>()(ptr.ref.lpVtbl,
          pResource12, pFlags11, InState, OutState, riid, ppResource11);

  void ReleaseWrappedResources(
          Pointer<Pointer<COMObject>> ppResources, int NumResources) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  void Function(
                      ...
                      Pointer<Pointer<COMObject>> ppResources,
                      int NumResources)>()(
          ptr.ref.lpVtbl, ppResources, NumResources);
