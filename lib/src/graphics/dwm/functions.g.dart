...
int DwmAttachMilContent(int hwnd) => _DwmAttachMilContent(hwnd);

late final _DwmAttachMilContent =
    _dwmapi.lookupFunction<Int32 Function(IntPtr hwnd), int Function(int hwnd)>(
        'DwmAttachMilContent');

int DwmDefWindowProc(
        int hWnd, int msg, int wParam, int lParam, Pointer<IntPtr> plResult) =>
    _DwmDefWindowProc(hWnd, msg, wParam, lParam, plResult);
...
late final _DwmDefWindowProc = _dwmapi.lookupFunction<
    ...
    int Function(int hWnd, int msg, int wParam, int lParam,
        Pointer<IntPtr> plResult)>('DwmDefWindowProc');

int DwmDetachMilContent(int hwnd) => _DwmDetachMilContent(hwnd);

late final _DwmDetachMilContent =
    _dwmapi.lookupFunction<Int32 Function(IntPtr hwnd), int Function(int hwnd)>(
        'DwmDetachMilContent');
...
int DwmEnableComposition(int uCompositionAction) =>
    _DwmEnableComposition(uCompositionAction);

late final _DwmEnableComposition = _dwmapi.lookupFunction<
    Int32 Function(Uint32 uCompositionAction),
    int Function(int uCompositionAction)>('DwmEnableComposition');
...
int DwmGetCompositionTimingInfo(
        int hwnd, Pointer<DWM_TIMING_INFO> pTimingInfo) =>
    _DwmGetCompositionTimingInfo(hwnd, pTimingInfo);

late final _DwmGetCompositionTimingInfo = _dwmapi.lookupFunction<
    Int32 Function(IntPtr hwnd, Pointer<DWM_TIMING_INFO> pTimingInfo),
    int Function(int hwnd,
        Pointer<DWM_TIMING_INFO> pTimingInfo)>('DwmGetCompositionTimingInfo');

int DwmGetGraphicsStreamClient(int uIndex, Pointer<GUID> pClientUuid) =>
    _DwmGetGraphicsStreamClient(uIndex, pClientUuid);

late final _DwmGetGraphicsStreamClient = _dwmapi.lookupFunction<
    Int32 Function(Uint32 uIndex, Pointer<GUID> pClientUuid),
    int Function(
        int uIndex, Pointer<GUID> pClientUuid)>('DwmGetGraphicsStreamClient');

int DwmGetGraphicsStreamTransformHint(
        int uIndex, Pointer<MilMatrix3x2D> pTransform) =>
    _DwmGetGraphicsStreamTransformHint(uIndex, pTransform);

late final _DwmGetGraphicsStreamTransformHint = _dwmapi.lookupFunction<
        Int32 Function(Uint32 uIndex, Pointer<MilMatrix3x2D> pTransform),
        int Function(int uIndex, Pointer<MilMatrix3x2D> pTransform)>(
...
int DwmGetUnmetTabRequirements(int appWindow, Pointer<Uint32> value) =>
    _DwmGetUnmetTabRequirements(appWindow, value);

late final _DwmGetUnmetTabRequirements = _dwmapi.lookupFunction<
    Int32 Function(IntPtr appWindow, Pointer<Uint32> value),
    int Function(
        int appWindow, Pointer<Uint32> value)>('DwmGetUnmetTabRequirements');
...
int DwmIsCompositionEnabled(Pointer<Int32> pfEnabled) =>
    _DwmIsCompositionEnabled(pfEnabled);

late final _DwmIsCompositionEnabled = _dwmapi.lookupFunction<
    Int32 Function(Pointer<Int32> pfEnabled),
    int Function(Pointer<Int32> pfEnabled)>('DwmIsCompositionEnabled');

int DwmModifyPreviousDxFrameDuration(int hwnd, int cRefreshes, int fRelative) =>
    _DwmModifyPreviousDxFrameDuration(hwnd, cRefreshes, fRelative);

late final _DwmModifyPreviousDxFrameDuration = _dwmapi.lookupFunction<
    Int32 Function(IntPtr hwnd, Int32 cRefreshes, Int32 fRelative),
    int Function(int hwnd, int cRefreshes,
        int fRelative)>('DwmModifyPreviousDxFrameDuration');

int DwmQueryThumbnailSourceSize(int hThumbnail, Pointer<SIZE> pSize) =>
    _DwmQueryThumbnailSourceSize(hThumbnail, pSize);

late final _DwmQueryThumbnailSourceSize = _dwmapi.lookupFunction<
    Int32 Function(IntPtr hThumbnail, Pointer<SIZE> pSize),
    int Function(
        int hThumbnail, Pointer<SIZE> pSize)>('DwmQueryThumbnailSourceSize');

int DwmRegisterThumbnail(
        int hwndDestination, int hwndSource, Pointer<IntPtr> phThumbnailId) =>
    _DwmRegisterThumbnail(hwndDestination, hwndSource, phThumbnailId);

late final _DwmRegisterThumbnail = _dwmapi.lookupFunction<
    Int32 Function(IntPtr hwndDestination, IntPtr hwndSource,
        Pointer<IntPtr> phThumbnailId),
    int Function(int hwndDestination, int hwndSource,
        Pointer<IntPtr> phThumbnailId)>('DwmRegisterThumbnail');
...
int DwmSetDxFrameDuration(int hwnd, int cRefreshes) =>
    _DwmSetDxFrameDuration(hwnd, cRefreshes);

late final _DwmSetDxFrameDuration = _dwmapi.lookupFunction<
    Int32 Function(IntPtr hwnd, Int32 cRefreshes),
    int Function(int hwnd, int cRefreshes)>('DwmSetDxFrameDuration');

int DwmSetIconicLivePreviewBitmap(
        int hwnd, int hbmp, Pointer<POINT> pptClient, int dwSITFlags) =>
    _DwmSetIconicLivePreviewBitmap(hwnd, hbmp, pptClient, dwSITFlags);

late final _DwmSetIconicLivePreviewBitmap = _dwmapi.lookupFunction<
    Int32 Function(
        IntPtr hwnd, IntPtr hbmp, Pointer<POINT> pptClient, Uint32 dwSITFlags),
    int Function(int hwnd, int hbmp, Pointer<POINT> pptClient,
        int dwSITFlags)>('DwmSetIconicLivePreviewBitmap');

int DwmSetIconicThumbnail(int hwnd, int hbmp, int dwSITFlags) =>
    _DwmSetIconicThumbnail(hwnd, hbmp, dwSITFlags);

late final _DwmSetIconicThumbnail = _dwmapi.lookupFunction<
    Int32 Function(IntPtr hwnd, IntPtr hbmp, Uint32 dwSITFlags),
    int Function(int hwnd, int hbmp, int dwSITFlags)>('DwmSetIconicThumbnail');

int DwmSetPresentParameters(
        int hwnd, Pointer<DWM_PRESENT_PARAMETERS> pPresentParams) =>
    _DwmSetPresentParameters(hwnd, pPresentParams);

late final _DwmSetPresentParameters = _dwmapi.lookupFunction<
    Int32 Function(IntPtr hwnd, Pointer<DWM_PRESENT_PARAMETERS> pPresentParams),
    int Function(
        int hwnd,
        Pointer<DWM_PRESENT_PARAMETERS>
            pPresentParams)>('DwmSetPresentParameters');
...
int DwmTetherContact(int dwPointerID, int fEnable, POINT ptTether) =>
    _DwmTetherContact(dwPointerID, fEnable, ptTether);

late final _DwmTetherContact = _dwmapi.lookupFunction<
    Int32 Function(Uint32 dwPointerID, Int32 fEnable, POINT ptTether),
    int Function(
        int dwPointerID, int fEnable, POINT ptTether)>('DwmTetherContact');

int DwmTransitionOwnedWindow(int hwnd, int target) =>
    _DwmTransitionOwnedWindow(hwnd, target);

late final _DwmTransitionOwnedWindow = _dwmapi.lookupFunction<
    Int32 Function(IntPtr hwnd, Int32 target),
    int Function(int hwnd, int target)>('DwmTransitionOwnedWindow');

int DwmUnregisterThumbnail(int hThumbnailId) =>
    _DwmUnregisterThumbnail(hThumbnailId);

late final _DwmUnregisterThumbnail = _dwmapi.lookupFunction<
    Int32 Function(IntPtr hThumbnailId),
    int Function(int hThumbnailId)>('DwmUnregisterThumbnail');

int DwmUpdateThumbnailProperties(
        int hThumbnailId, Pointer<DWM_THUMBNAIL_PROPERTIES> ptnProperties) =>
    _DwmUpdateThumbnailProperties(hThumbnailId, ptnProperties);
