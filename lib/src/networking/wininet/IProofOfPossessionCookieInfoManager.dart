...
class IProofOfPossessionCookieInfoManager extends IUnknown {
  ...
  int GetCookieInfoForUri(Pointer<Utf16> uri, Pointer<Uint32> cookieInfoCount,
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              ...
                              Pointer<Pointer<ProofOfPossessionCookieInfo>>
                                  cookieInfo)>>>()
              .value
              .asFunction<
                  int Function(
                      ...
                      Pointer<Pointer<ProofOfPossessionCookieInfo>>
                          cookieInfo)>()(
          ptr.ref.lpVtbl, uri, cookieInfoCount, cookieInfo);
}
