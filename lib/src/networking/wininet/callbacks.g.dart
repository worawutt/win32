...
typedef CACHE_OPERATOR = Int32 Function(Pointer<INTERNET_CACHE_ENTRY_INFO> pcei,
    Pointer<Uint32> pcbcei, Pointer pOpData);
typedef GOPHER_ATTRIBUTE_ENUMERATOR = Int32 Function(
    Pointer<GOPHER_ATTRIBUTE_TYPE> lpAttributeInfo, Uint32 dwError);
typedef HTTP_POLICY_EXTENSION_INIT = Uint32 Function(
    Int32 Version, Int32 Type, Pointer pvData, Uint32 cbData);
typedef HTTP_POLICY_EXTENSION_SHUTDOWN = Uint32 Function(Int32 Type);
...
typedef pfnInternetDeInitializeAutoProxyDll = Int32 Function(
    Pointer<Utf8> lpszMime, Uint32 dwReserved);
