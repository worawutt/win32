...
/// @nodoc
const IID_IADsSession = '{398B7DA0-4AAB-11CF-AE2C-00AA006EBFB9}';

/// {@category Interface}
/// {@category com}
class IADsSession extends IADs {
  // vtable begins at 20, is 6 entries long.
  IADsSession(Pointer<COMObject> ptr) : super(ptr);
  ...
  Pointer<Utf16> get ComputerPath {
    final retValuePtr = calloc<Pointer<Utf16>>();
