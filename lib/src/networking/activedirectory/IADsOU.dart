...
/// @nodoc
const IID_IADsOU = '{A2F733B8-EFFE-11CF-8ABC-00C04FD8D503}';

/// {@category Interface}
/// {@category com}
class IADsOU extends IADs {
  // vtable begins at 20, is 14 entries long.
  IADsOU(Pointer<COMObject> ptr) : super(ptr);
  ...
  Pointer<Utf16> get BusinessCategory {
    final retValuePtr = calloc<Pointer<Utf16>>();
  ...
  set BusinessCategory(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
            .elementAt(33)
            .cast<
                Pointer<
                    NativeFunction<
                        Int32 Function(
                            Pointer, Pointer<Utf16> bstrBusinessCategory)>>>()
            .value
            .asFunction<
                int Function(Pointer, Pointer<Utf16> bstrBusinessCategory)>()(
        ptr.ref.lpVtbl, value);
