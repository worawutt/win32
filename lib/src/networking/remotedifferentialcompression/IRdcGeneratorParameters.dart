...
class IRdcGeneratorParameters extends IUnknown {
  ...
  int GetGeneratorParametersType(Pointer<Int32> parametersType) => ptr
      .ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Int32> parametersType)>>>()
      .value
      .asFunction<
          int Function(Pointer,
              Pointer<Int32> parametersType)>()(ptr.ref.lpVtbl, parametersType);

  int GetParametersVersion(Pointer<Uint32> currentVersion,
  ...
  int GetSerializeSize(Pointer<Uint32> size) => ptr.ref.lpVtbl.value
      .elementAt(5)
      .cast<
          Pointer<
  ...
  int Serialize(int size, Pointer<Uint8> parametersBlob,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int size, Pointer<Uint8> parametersBlob,
                      Pointer<Uint32> bytesWritten)>()(
          ptr.ref.lpVtbl, size, parametersBlob, bytesWritten);
}
