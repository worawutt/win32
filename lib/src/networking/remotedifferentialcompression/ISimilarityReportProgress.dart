...
class ISimilarityReportProgress extends IUnknown {
  ...
  int ReportProgress(int percentCompleted) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Uint32 percentCompleted)>>>()
          .value
          .asFunction<int Function(Pointer, int percentCompleted)>()(
      ptr.ref.lpVtbl, percentCompleted);
}
