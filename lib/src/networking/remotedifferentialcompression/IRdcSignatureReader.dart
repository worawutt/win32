...
class IRdcSignatureReader extends IUnknown {
  ...
  int ReadHeader(Pointer<Int32> rdc_ErrorCode) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Int32> rdc_ErrorCode)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Int32> rdc_ErrorCode)>()(
      ptr.ref.lpVtbl, rdc_ErrorCode);

  int ReadSignatures(Pointer<RdcSignaturePointer> rdcSignaturePointer,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<RdcSignaturePointer> rdcSignaturePointer,
                      Pointer<Int32> endOfOutput)>()(
          ptr.ref.lpVtbl, rdcSignaturePointer, endOfOutput);
}
