...
class IRdcLibrary extends IUnknown {
  ...
  int ComputeDefaultRecursionDepth(int fileSize, Pointer<Uint32> depth) =>
      ptr.ref.lpVtbl.value
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Uint64 fileSize, Pointer<Uint32> depth)>>>()
          .value
          .asFunction<
              int Function(Pointer, int fileSize,
                  Pointer<Uint32> depth)>()(ptr.ref.lpVtbl, fileSize, depth);

  int
      CreateGeneratorParameters(int parametersType, int level,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, int parametersType, int level,
                          Pointer<Pointer<COMObject>> iGeneratorParameters)>()(
              ptr.ref.lpVtbl, parametersType, level, iGeneratorParameters);

  int
      OpenGeneratorParameters(int size, Pointer<Uint8> parametersBlob,
              Pointer<Pointer<COMObject>> iGeneratorParameters) =>
          ptr.ref.lpVtbl.value
                  .elementAt(5)
                  .cast<
                  ...
                  .asFunction<
                      int Function(
                          ...
                          Pointer<Uint8> parametersBlob,
                          Pointer<Pointer<COMObject>> iGeneratorParameters)>()(
              ptr.ref.lpVtbl, size, parametersBlob, iGeneratorParameters);
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .asFunction<
                      int Function(
                          ...
                          Pointer<Pointer<COMObject>> iGeneratorParametersArray,
                          Pointer<Pointer<COMObject>> iGenerator)>()(
              ptr.ref.lpVtbl, depth, iGeneratorParametersArray, iGenerator);

  int CreateComparator(Pointer<COMObject> iSeedSignaturesFile,
          int comparatorBufferSize, Pointer<Pointer<COMObject>> iComparator) =>
      ptr.ref.lpVtbl.value
              .elementAt(7)
              .cast<
                  Pointer<
  ...
  int CreateSignatureReader(Pointer<COMObject> iFileReader,
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<COMObject> iFileReader,
                              Pointer<Pointer<COMObject>> iSignatureReader)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> iFileReader,
                      Pointer<Pointer<COMObject>> iSignatureReader)>()(
          ptr.ref.lpVtbl, iFileReader, iSignatureReader);

  int GetRDCVersion(Pointer<Uint32> currentVersion,
      ...
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Uint32> currentVersion,
                              Pointer<Uint32> minimumCompatibleAppVersion)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint32> currentVersion,
                      Pointer<Uint32> minimumCompatibleAppVersion)>()(
          ptr.ref.lpVtbl, currentVersion, minimumCompatibleAppVersion);
}
