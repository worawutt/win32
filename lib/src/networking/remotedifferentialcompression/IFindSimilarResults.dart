...
class IFindSimilarResults extends IUnknown {
  ...
  int GetSize(Pointer<Uint32> size) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<
  ...
  int
      GetNextFileId(Pointer<Uint32> numTraitsMatched,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, Pointer<Uint32> numTraitsMatched,
                          Pointer<SimilarityFileId> similarityFileId)>()(
              ptr.ref.lpVtbl, numTraitsMatched, similarityFileId);
}
