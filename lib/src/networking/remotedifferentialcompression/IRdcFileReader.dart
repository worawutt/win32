      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint32> bytesActuallyRead,
                      Pointer<Uint8> buffer,
                      Pointer<Int32> eof)>()(ptr.ref.lpVtbl, offsetFileStart,
          bytesToRead, bytesActuallyRead, buffer, eof);

  int GetFilePosition(Pointer<Uint64> offsetFromStart) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Uint64> offsetFromStart)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint64> offsetFromStart)>()(
          ptr.ref.lpVtbl, offsetFromStart);
}
