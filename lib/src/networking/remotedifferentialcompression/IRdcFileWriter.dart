...
class IRdcFileWriter extends IRdcFileReader {
  ...
  int Write(int offsetFileStart, int bytesToWrite, Pointer<Uint8> buffer) =>
      ptr.ref.lpVtbl.value
              .elementAt(6)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Uint64 offsetFileStart,
                              Uint32 bytesToWrite, Pointer<Uint8> buffer)>>>()
              .value
              .asFunction<
                  int Function(Pointer, int offsetFileStart, int bytesToWrite,
                      Pointer<Uint8> buffer)>()(
          ptr.ref.lpVtbl, offsetFileStart, bytesToWrite, buffer);
