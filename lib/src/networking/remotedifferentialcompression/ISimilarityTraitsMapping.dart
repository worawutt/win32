...
class ISimilarityTraitsMapping extends IUnknown {
  ...
  int SetFileSize(int fileSize) => ptr.ref.lpVtbl.value
      .elementAt(4)
      .cast<Pointer<NativeFunction<Int32 Function(Pointer, Uint64 fileSize)>>>()
      .value
      .asFunction<
          int Function(Pointer, int fileSize)>()(ptr.ref.lpVtbl, fileSize);

  int GetFileSize(Pointer<Uint64> fileSize) => ptr.ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Uint64> fileSize)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Uint64> fileSize)>()(
      ptr.ref.lpVtbl, fileSize);

  int
      OpenMapping(
              int accessMode, int begin, int end, Pointer<Uint64> actualEnd) =>
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, int accessMode, int begin, int end,
                          Pointer<Uint64> actualEnd)>()(
              ptr.ref.lpVtbl, accessMode, begin, end, actualEnd);
  ...
  void GetPageSize(Pointer<Uint32> pageSize) => ptr.ref.lpVtbl.value
          .elementAt(8)
          .cast<
              Pointer<
                  NativeFunction<
                      Void Function(Pointer, Pointer<Uint32> pageSize)>>>()
          .value
          .asFunction<void Function(Pointer, Pointer<Uint32> pageSize)>()(
      ptr.ref.lpVtbl, pageSize);

  int CreateView(int minimumMappedPages, int accessMode,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int minimumMappedPages, int accessMode,
                      Pointer<Pointer<COMObject>> mappedView)>()(
          ptr.ref.lpVtbl, minimumMappedPages, accessMode, mappedView);
}
