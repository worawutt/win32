...
class ISimilarityTraitsMappedView extends IUnknown {
  ...
  int Get(int index, int dirty, int numElements,
      ...
      ptr.ref.lpVtbl.value
              ...
              .value
              .asFunction<
                  int Function(Pointer, int index, int dirty, int numElements,
                      Pointer<SimilarityMappedViewInfo> viewInfo)>()(
          ptr.ref.lpVtbl, index, dirty, numElements, viewInfo);

  void GetView(Pointer<Pointer<Uint8>> mappedPageBegin,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  void Function(
                      ...
                      Pointer<Pointer<Uint8>> mappedPageBegin,
                      Pointer<Pointer<Uint8>> mappedPageEnd)>()(
          ptr.ref.lpVtbl, mappedPageBegin, mappedPageEnd);
}
