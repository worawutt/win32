...
class IRdcSimilarityGenerator extends IUnknown {
  ...
  int Results(Pointer<SimilarityData> similarityData) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
                          Pointer, Pointer<SimilarityData> similarityData)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<SimilarityData> similarityData)>()(
      ptr.ref.lpVtbl, similarityData);
}
