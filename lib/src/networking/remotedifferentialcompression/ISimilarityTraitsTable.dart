...
class ISimilarityTraitsTable extends IUnknown {
  ...
  int CreateTable(Pointer<Utf16> path, int truncate,
          Pointer<Uint8> securityDescriptor, Pointer<Int32> isNew) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Uint8> securityDescriptor,
                      Pointer<Int32> isNew)>()(
          ptr.ref.lpVtbl, path, truncate, securityDescriptor, isNew);

  int CreateTableIndirect(
          Pointer<COMObject> mapping, int truncate, Pointer<Int32> isNew) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<COMObject> mapping,
                              Int32 truncate, Pointer<Int32> isNew)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<COMObject> mapping,
                      int truncate, Pointer<Int32> isNew)>()(
          ptr.ref.lpVtbl, mapping, truncate, isNew);
  ...
  int Append(Pointer<SimilarityData> data, int fileIndex) =>
      ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<SimilarityData> data,
                          Uint32 fileIndex)>>>()
          .value
          .asFunction<
              int Function(Pointer, Pointer<SimilarityData> data,
                  int fileIndex)>()(ptr.ref.lpVtbl, data, fileIndex);
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              ...
                              Pointer<FindSimilarFileIndexResults>
  ...
  int BeginDump(Pointer<Pointer<COMObject>> similarityTableDumpState) =>
      ptr.ref.lpVtbl.value
              .elementAt(8)
              .cast<
                  Pointer<
          ...
          ptr.ref.lpVtbl, similarityTableDumpState);

  int GetLastIndex(Pointer<Uint32> fileIndex) => ptr.ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Uint32> fileIndex)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Uint32> fileIndex)>()(
      ptr.ref.lpVtbl, fileIndex);
}
