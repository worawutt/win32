...
class ISimilarityTableDumpState extends IUnknown {
  ...
  int GetNextData(int resultsSize, Pointer<Uint32> resultsUsed,
          Pointer<Int32> eof, Pointer<SimilarityDumpData> results) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<Int32> eof,
                      Pointer<SimilarityDumpData> results)>()(
          ptr.ref.lpVtbl, resultsSize, resultsUsed, eof, results);
}
