...
/// @nodoc
const IID_ISClusCryptoKeys = '{F2E6072C-2631-11D1-89F1-00A0C90D061E}';

/// {@category Interface}
/// {@category com}
class ISClusCryptoKeys extends IDispatch {
  // vtable begins at 7, is 6 entries long.
  ISClusCryptoKeys(Pointer<COMObject> ptr) : super(ptr);
  ...
  int get_Item(VARIANT varIndex, Pointer<Pointer<Utf16>> pbstrCyrptoKey) =>
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, VARIANT varIndex,
                              Pointer<Pointer<Utf16>> pbstrCyrptoKey)>>>()
              .value
              .asFunction<
                  int Function(Pointer, VARIANT varIndex,
                      Pointer<Pointer<Utf16>> pbstrCyrptoKey)>()(
          ptr.ref.lpVtbl, varIndex, pbstrCyrptoKey);

  int AddItem(Pointer<Utf16> bstrCryptoKey) => ptr.ref.lpVtbl.value
          .elementAt(11)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<Utf16> bstrCryptoKey)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<Utf16> bstrCryptoKey)>()(
      ptr.ref.lpVtbl, bstrCryptoKey);
