...
/// @nodoc
const IID_ISClusResTypes = '{F2E60712-2631-11D1-89F1-00A0C90D061E}';

/// {@category Interface}
/// {@category com}
class ISClusResTypes extends IDispatch {
  // vtable begins at 7, is 6 entries long.
  ISClusResTypes(Pointer<COMObject> ptr) : super(ptr);
  ...
  int get_Item(VARIANT varIndex, Pointer<Pointer<COMObject>> ppClusResType) =>
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, VARIANT varIndex,
                              Pointer<Pointer<COMObject>> ppClusResType)>>>()
              .value
              .asFunction<
                  int Function(Pointer, VARIANT varIndex,
                      Pointer<Pointer<COMObject>> ppClusResType)>()(
          ptr.ref.lpVtbl, varIndex, ppClusResType);

  int CreateItem(
          Pointer<Utf16> bstrResourceTypeName,
          Pointer<Utf16> bstrDisplayName,
          Pointer<Utf16> bstrResourceTypeDll,
          int dwLooksAlivePollInterval,
          int dwIsAlivePollInterval,
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              ...
                              Pointer<Utf16> bstrDisplayName,
                              Pointer<Utf16> bstrResourceTypeDll,
                              Int32 dwLooksAlivePollInterval,
                              Int32 dwIsAlivePollInterval,
                              Pointer<Pointer<COMObject>> ppResourceType)>>>()
              .value
              .asFunction<
                  int Function(
