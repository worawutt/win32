...
/// @nodoc
const IID_ISClusDisks = '{F2E60726-2631-11D1-89F1-00A0C90D061E}';

/// {@category Interface}
/// {@category com}
class ISClusDisks extends IDispatch {
  // vtable begins at 7, is 3 entries long.
  ISClusDisks(Pointer<COMObject> ptr) : super(ptr);
  ...
  int get_Item(VARIANT varIndex, Pointer<Pointer<COMObject>> ppDisk) =>
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, VARIANT varIndex,
                              Pointer<Pointer<COMObject>> ppDisk)>>>()
              .value
              .asFunction<
                  int Function(Pointer, VARIANT varIndex,
                      Pointer<Pointer<COMObject>> ppDisk)>()(
          ptr.ref.lpVtbl, varIndex, ppDisk);
}
