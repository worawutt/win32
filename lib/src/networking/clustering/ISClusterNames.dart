...
/// @nodoc
const IID_ISClusterNames = '{F2E606EC-2631-11D1-89F1-00A0C90D061E}';

/// {@category Interface}
/// {@category com}
class ISClusterNames extends IDispatch {
  // vtable begins at 7, is 5 entries long.
  ISClusterNames(Pointer<COMObject> ptr) : super(ptr);
  ...
  int get_Item(VARIANT varIndex, Pointer<Pointer<Utf16>> pbstrClusterName) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, VARIANT varIndex,
                      Pointer<Pointer<Utf16>> pbstrClusterName)>()(
          ptr.ref.lpVtbl, varIndex, pbstrClusterName);
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer,
                              Pointer<Pointer<Utf16>> pbstrDomainName)>>>()
              .value
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> pbstrDomainName)>()(
          ptr.ref.lpVtbl, retValuePtr);
