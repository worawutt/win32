...
/// @nodoc
const IID_ISClusResGroups = '{F2E60708-2631-11D1-89F1-00A0C90D061E}';

/// {@category Interface}
/// {@category com}
class ISClusResGroups extends IDispatch {
  // vtable begins at 7, is 6 entries long.
  ISClusResGroups(Pointer<COMObject> ptr) : super(ptr);
  ...
  int get_Item(VARIANT varIndex, Pointer<Pointer<COMObject>> ppClusResGroup) =>
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, VARIANT varIndex,
                              Pointer<Pointer<COMObject>> ppClusResGroup)>>>()
              .value
              .asFunction<
                  int Function(Pointer, VARIANT varIndex,
                      Pointer<Pointer<COMObject>> ppClusResGroup)>()(
          ptr.ref.lpVtbl, varIndex, ppClusResGroup);

  int CreateItem(Pointer<Utf16> bstrResourceGroupName,
          Pointer<Pointer<COMObject>> ppResourceGroup) =>
      ptr.ref.lpVtbl.value
              .elementAt(11)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer,
                              Pointer<Utf16> bstrResourceGroupName,
                              Pointer<Pointer<COMObject>> ppResourceGroup)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Utf16> bstrResourceGroupName,
                      Pointer<Pointer<COMObject>> ppResourceGroup)>()(
          ptr.ref.lpVtbl, bstrResourceGroupName, ppResourceGroup);
