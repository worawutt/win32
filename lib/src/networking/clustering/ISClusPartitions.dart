...
/// @nodoc
const IID_ISClusPartitions = '{F2E60722-2631-11D1-89F1-00A0C90D061E}';

/// {@category Interface}
/// {@category com}
class ISClusPartitions extends IDispatch {
  // vtable begins at 7, is 3 entries long.
  ISClusPartitions(Pointer<COMObject> ptr) : super(ptr);
  ...
  int get_Item(VARIANT varIndex, Pointer<Pointer<COMObject>> ppPartition) =>
                  ...
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, VARIANT varIndex,
                              Pointer<Pointer<COMObject>> ppPartition)>>>()
              .value
              .asFunction<
                  int Function(Pointer, VARIANT varIndex,
                      Pointer<Pointer<COMObject>> ppPartition)>()(
          ptr.ref.lpVtbl, varIndex, ppPartition);
}
