...
import '../../networking/clustering/ISClusNetworkNetInterfaces.dart';
import '../../networking/clustering/ISCluster.dart';

/// @nodoc
const IID_ISClusNetwork = '{F2E606F2-2631-11D1-89F1-00A0C90D061E}';

/// {@category Interface}
/// {@category com}
class ISClusNetwork extends IDispatch {
  // vtable begins at 7, is 11 entries long.
  ISClusNetwork(Pointer<COMObject> ptr) : super(ptr);
  ...
  set Name(Pointer<Utf16> value) {
    final hr = ptr.ref.lpVtbl.value
        ...
        .cast<
            Pointer<
                NativeFunction<
                    Int32 Function(Pointer, Pointer<Utf16> bstrNetworkName)>>>()
        .value
        .asFunction<
            int Function(Pointer,
                Pointer<Utf16> bstrNetworkName)>()(ptr.ref.lpVtbl, value);

    if (FAILED(hr)) throw WindowsException(hr);
  }

  Pointer<Utf16> get NetworkID {
    final retValuePtr = calloc<Pointer<Utf16>>();
      ...
      final hr = ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer,
                              Pointer<Pointer<Utf16>> pbstrNetworkID)>>>()
              .value
              .asFunction<
                  int Function(
                      Pointer, Pointer<Pointer<Utf16>> pbstrNetworkID)>()(
          ptr.ref.lpVtbl, retValuePtr);
