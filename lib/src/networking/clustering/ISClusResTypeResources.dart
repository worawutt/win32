...
/// @nodoc
const IID_ISClusResTypeResources = '{F2E60714-2631-11D1-89F1-00A0C90D061E}';

/// {@category Interface}
/// {@category com}
class ISClusResTypeResources extends IDispatch {
  // vtable begins at 7, is 6 entries long.
  ISClusResTypeResources(Pointer<COMObject> ptr) : super(ptr);
  ...
  int
      CreateItem(Pointer<Utf16> bstrResourceName, Pointer<Utf16> bstrGroupName,
              int dwFlags, Pointer<Pointer<COMObject>> ppClusterResource) =>
          ptr.ref.lpVtbl.value
                  .elementAt(11)
                  .cast<
                      Pointer<
