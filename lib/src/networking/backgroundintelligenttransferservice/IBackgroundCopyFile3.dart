...
class IBackgroundCopyFile3 extends IBackgroundCopyFile2 {
  ...
  int GetTemporaryName(Pointer<Pointer<Utf16>> pFilename) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<Utf16>> pFilename)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<Utf16>> pFilename)>()(
          ptr.ref.lpVtbl, pFilename);

  int SetValidationState(int state) => ptr.ref.lpVtbl.value
      .elementAt(9)
  ...
  int GetValidationState(Pointer<Int32> pState) => ptr.ref.lpVtbl.value
      .elementAt(10)
      .cast<
          Pointer<
  ...
  int IsDownloadedFromPeer(Pointer<Int32> pVal) => ptr.ref.lpVtbl.value
      .elementAt(11)
      .cast<
          Pointer<
