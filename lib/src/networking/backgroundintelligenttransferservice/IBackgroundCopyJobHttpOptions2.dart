...
class IBackgroundCopyJobHttpOptions2 extends IBackgroundCopyJobHttpOptions {
  ...
  int SetHttpMethod(Pointer<Utf16> method) => ptr.ref.lpVtbl.value
      .elementAt(11)
      .cast<
          Pointer<
              NativeFunction<Int32 Function(Pointer, Pointer<Utf16> method)>>>()
      .value
      .asFunction<
          int Function(
              Pointer, Pointer<Utf16> method)>()(ptr.ref.lpVtbl, method);

  int GetHttpMethod(Pointer<Pointer<Utf16>> method) => ptr.ref.lpVtbl.value
      .elementAt(12)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(Pointer, Pointer<Pointer<Utf16>> method)>>>()
      .value
      .asFunction<
