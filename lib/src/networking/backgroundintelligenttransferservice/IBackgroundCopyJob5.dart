...
class IBackgroundCopyJob5 extends IBackgroundCopyJob4 {
  ...
  int SetProperty(int PropertyId, BITS_JOB_PROPERTY_VALUE PropertyValue) =>
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(Pointer, int PropertyId,
                      BITS_JOB_PROPERTY_VALUE PropertyValue)>()(
          ptr.ref.lpVtbl, PropertyId, PropertyValue);

  int
      GetProperty(
              int PropertyId, Pointer<BITS_JOB_PROPERTY_VALUE> PropertyValue) =>
          ptr
                  .ref.lpVtbl.value
                  .elementAt(54)
                  .cast<
                      Pointer<
                          NativeFunction<
                              Int32 Function(
                                  Pointer,
                                  Int32 PropertyId,
                                  Pointer<BITS_JOB_PROPERTY_VALUE>
                                      PropertyValue)>>>()
                  .value
                  .asFunction<
                      int Function(Pointer, int PropertyId,
