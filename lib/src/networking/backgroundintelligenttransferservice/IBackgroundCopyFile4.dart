...
class IBackgroundCopyFile4 extends IBackgroundCopyFile3 {
  ...
  int GetPeerDownloadStats(
          Pointer<Uint64> pFromOrigin, Pointer<Uint64> pFromPeers) =>
      ptr.ref.lpVtbl.value
              .elementAt(12)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<Uint64> pFromOrigin,
                              Pointer<Uint64> pFromPeers)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Uint64> pFromOrigin,
                      Pointer<Uint64> pFromPeers)>()(
          ptr.ref.lpVtbl, pFromOrigin, pFromPeers);
}
