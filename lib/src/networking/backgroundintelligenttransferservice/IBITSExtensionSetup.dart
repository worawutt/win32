...
class IBITSExtensionSetup extends IDispatch {
  ...
  int GetCleanupTaskName(Pointer<Pointer<Utf16>> pTaskName) =>
      ptr.ref.lpVtbl.value
              ...
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(
                              Pointer, Pointer<Pointer<Utf16>> pTaskName)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<Pointer<Utf16>> pTaskName)>()(
          ptr.ref.lpVtbl, pTaskName);

  int GetCleanupTask(Pointer<GUID> riid, Pointer<Pointer<COMObject>> ppUnk) =>
      ptr.ref.lpVtbl.value
              .elementAt(10)
              .cast<
                  Pointer<
