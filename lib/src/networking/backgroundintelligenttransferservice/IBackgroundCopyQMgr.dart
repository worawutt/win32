...
class IBackgroundCopyQMgr extends IUnknown {
  ...
  int CreateGroup(GUID guidGroupID, Pointer<Pointer<COMObject>> ppGroup) =>
      ptr.ref.lpVtbl.value
              .elementAt(3)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, GUID guidGroupID,
                              Pointer<Pointer<COMObject>> ppGroup)>>>()
              .value
              .asFunction<
                  int Function(Pointer, GUID guidGroupID,
                      Pointer<Pointer<COMObject>> ppGroup)>()(
          ptr.ref.lpVtbl, guidGroupID, ppGroup);

  int GetGroup(GUID groupID, Pointer<Pointer<COMObject>> ppGroup) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, GUID groupID,
                              Pointer<Pointer<COMObject>> ppGroup)>>>()
              .value
              .asFunction<
                  int Function(Pointer, GUID groupID,
                      Pointer<Pointer<COMObject>> ppGroup)>()(
          ptr.ref.lpVtbl, groupID, ppGroup);

  int EnumGroups(int dwFlags, Pointer<Pointer<COMObject>> ppEnumGroups) =>
      ptr.ref.lpVtbl.value
              .elementAt(5)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(Pointer, int dwFlags,
                      Pointer<Pointer<COMObject>> ppEnumGroups)>()(
          ptr.ref.lpVtbl, dwFlags, ppEnumGroups);
}
