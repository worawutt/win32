...
class IBitsTokenOptions extends IUnknown {
  ...
  int SetHelperTokenFlags(int UsageFlags) => ptr.ref.lpVtbl.value
      .elementAt(3)
      .cast<
          Pointer<NativeFunction<Int32 Function(Pointer, Uint32 UsageFlags)>>>()
      .value
      .asFunction<
          int Function(Pointer, int UsageFlags)>()(ptr.ref.lpVtbl, UsageFlags);

  int GetHelperTokenFlags(Pointer<Uint32> pFlags) => ptr.ref.lpVtbl.value
          .elementAt(4)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetHelperTokenSid(Pointer<Pointer<Utf16>> pSid) => ptr.ref.lpVtbl.value
          .elementAt(7)
          .cast<
              Pointer<
                  NativeFunction<
          ...
          .value
          .asFunction<int Function(Pointer, Pointer<Pointer<Utf16>> pSid)>()(
      ptr.ref.lpVtbl, pSid);
}
