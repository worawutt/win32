...
class IBackgroundCopyCallback1 extends IUnknown {
  ...
  int OnProgress(int ProgressType, Pointer<COMObject> pGroup,
          Pointer<COMObject> pJob, int dwFileIndex, int dwProgressValue) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<COMObject> pJob,
                      int dwFileIndex,
                      int dwProgressValue)>()(ptr.ref.lpVtbl, ProgressType,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      int dwProgressValue,
                      int dwByteArraySize,
                      Pointer<Uint8> pByte)>()(ptr.ref.lpVtbl, ProgressType,
