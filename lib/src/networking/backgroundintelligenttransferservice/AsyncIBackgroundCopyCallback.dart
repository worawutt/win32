...
class AsyncIBackgroundCopyCallback extends IUnknown {
  ...
  int Begin_JobTransferred(Pointer<COMObject> pJob) => ptr.ref.lpVtbl.value
          .elementAt(3)
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(Pointer, Pointer<COMObject> pJob)>>>()
          .value
          .asFunction<int Function(Pointer, Pointer<COMObject> pJob)>()(
      ptr.ref.lpVtbl, pJob);
  ...
  int Begin_JobError(Pointer<COMObject> pJob, Pointer<COMObject> pError) =>
      ptr.ref.lpVtbl.value
          ...
          .value
          .asFunction<
              int Function(Pointer, Pointer<COMObject> pJob,
                  Pointer<COMObject> pError)>()(ptr.ref.lpVtbl, pJob, pError);
  ...
  int Begin_JobModification(Pointer<COMObject> pJob, int dwReserved) => ptr
      .ref.lpVtbl.value
      .elementAt(7)
      .cast<
          Pointer<
              NativeFunction<
                  Int32 Function(
                      Pointer, Pointer<COMObject> pJob, Uint32 dwReserved)>>>()
      .value
      .asFunction<
          int Function(Pointer, Pointer<COMObject> pJob,
              int dwReserved)>()(ptr.ref.lpVtbl, pJob, dwReserved);
