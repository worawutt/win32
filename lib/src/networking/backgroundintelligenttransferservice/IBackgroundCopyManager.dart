...
class IBackgroundCopyManager extends IUnknown {
  ...
  int CreateJob(Pointer<Utf16> DisplayName, int Type, Pointer<GUID> pJobId,
      ...
      ptr.ref.lpVtbl.value
              ...
              .asFunction<
                  int Function(
                      ...
                      Pointer<GUID> pJobId,
                      Pointer<Pointer<COMObject>> ppJob)>()(
          ptr.ref.lpVtbl, DisplayName, Type, pJobId, ppJob);

  int GetJob(Pointer<GUID> jobID, Pointer<Pointer<COMObject>> ppJob) =>
      ptr.ref.lpVtbl.value
              .elementAt(4)
              .cast<
                  Pointer<
                      NativeFunction<
                          Int32 Function(Pointer, Pointer<GUID> jobID,
                              Pointer<Pointer<COMObject>> ppJob)>>>()
              .value
              .asFunction<
                  int Function(Pointer, Pointer<GUID> jobID,
                      Pointer<Pointer<COMObject>> ppJob)>()(
          ptr.ref.lpVtbl, jobID, ppJob);

  int EnumJobs(int dwFlags, Pointer<Pointer<COMObject>> ppEnum) => ptr
          .ref.lpVtbl.value
          .elementAt(5)
          .cast<
              Pointer<
          ...
          .asFunction<
              int Function(
                  Pointer, int dwFlags, Pointer<Pointer<COMObject>> ppEnum)>()(
      ptr.ref.lpVtbl, dwFlags, ppEnum);

  int
      GetErrorDescription(int hResult, int LanguageId,
          ...
          ptr.ref.lpVtbl.value
                  ...
                  .value
                  .asFunction<
                      int Function(Pointer, int hResult, int LanguageId,
                          Pointer<Pointer<Utf16>> pErrorDescription)>()(
              ptr.ref.lpVtbl, hResult, LanguageId, pErrorDescription);
}
