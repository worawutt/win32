...
void WebSocketAbortHandle(int hWebSocket) => _WebSocketAbortHandle(hWebSocket);

late final _WebSocketAbortHandle = _websocket.lookupFunction<
    Void Function(IntPtr hWebSocket),
    void Function(int hWebSocket)>('WebSocketAbortHandle');
...
void WebSocketCompleteAction(
        int hWebSocket, Pointer pvActionContext, int ulBytesTransferred) =>
    _WebSocketCompleteAction(hWebSocket, pvActionContext, ulBytesTransferred);

late final _WebSocketCompleteAction = _websocket.lookupFunction<
    Void Function(
        IntPtr hWebSocket, Pointer pvActionContext, Uint32 ulBytesTransferred),
    void Function(int hWebSocket, Pointer pvActionContext,
        int ulBytesTransferred)>('WebSocketCompleteAction');

int WebSocketCreateClientHandle(Pointer<WEB_SOCKET_PROPERTY> pProperties,
        int ulPropertyCount, Pointer<IntPtr> phWebSocket) =>
    _WebSocketCreateClientHandle(pProperties, ulPropertyCount, phWebSocket);

late final _WebSocketCreateClientHandle = _websocket.lookupFunction<
    Int32 Function(Pointer<WEB_SOCKET_PROPERTY> pProperties,
        Uint32 ulPropertyCount, Pointer<IntPtr> phWebSocket),
    int Function(Pointer<WEB_SOCKET_PROPERTY> pProperties, int ulPropertyCount,
        Pointer<IntPtr> phWebSocket)>('WebSocketCreateClientHandle');

int WebSocketCreateServerHandle(Pointer<WEB_SOCKET_PROPERTY> pProperties,
        int ulPropertyCount, Pointer<IntPtr> phWebSocket) =>
    _WebSocketCreateServerHandle(pProperties, ulPropertyCount, phWebSocket);

late final _WebSocketCreateServerHandle = _websocket.lookupFunction<
    Int32 Function(Pointer<WEB_SOCKET_PROPERTY> pProperties,
        Uint32 ulPropertyCount, Pointer<IntPtr> phWebSocket),
    int Function(Pointer<WEB_SOCKET_PROPERTY> pProperties, int ulPropertyCount,
        Pointer<IntPtr> phWebSocket)>('WebSocketCreateServerHandle');

void WebSocketDeleteHandle(int hWebSocket) =>
    _WebSocketDeleteHandle(hWebSocket);

late final _WebSocketDeleteHandle = _websocket.lookupFunction<
    Void Function(IntPtr hWebSocket),
    void Function(int hWebSocket)>('WebSocketDeleteHandle');
...
late final _WebSocketEndClientHandshake = _websocket.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> pulSelectedExtensions,
        Pointer<Uint32> pulSelectedExtensionCount,
        Pointer<Uint32> pulSelectedSubprotocol)>('WebSocketEndClientHandshake');

int WebSocketEndServerHandshake(int hWebSocket) =>
    _WebSocketEndServerHandshake(hWebSocket);

late final _WebSocketEndServerHandshake = _websocket.lookupFunction<
    Int32 Function(IntPtr hWebSocket),
    int Function(int hWebSocket)>('WebSocketEndServerHandshake');
...
late final _WebSocketGetAction = _websocket.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Int32> pBufferType,
        Pointer<Pointer> pvApplicationContext,
        Pointer<Pointer> pvActionContext)>('WebSocketGetAction');

int WebSocketGetGlobalProperty(
        int eType, Pointer pvValue, Pointer<Uint32> ulSize) =>
    _WebSocketGetGlobalProperty(eType, pvValue, ulSize);

late final _WebSocketGetGlobalProperty = _websocket.lookupFunction<
    Int32 Function(Int32 eType, Pointer pvValue, Pointer<Uint32> ulSize),
    int Function(int eType, Pointer pvValue,
        Pointer<Uint32> ulSize)>('WebSocketGetGlobalProperty');

int WebSocketReceive(int hWebSocket, Pointer<WEB_SOCKET_BUFFER> pBuffer,
        Pointer pvContext) =>
    _WebSocketReceive(hWebSocket, pBuffer, pvContext);

late final _WebSocketReceive = _websocket.lookupFunction<
    Int32 Function(IntPtr hWebSocket, Pointer<WEB_SOCKET_BUFFER> pBuffer,
        Pointer pvContext),
    int Function(int hWebSocket, Pointer<WEB_SOCKET_BUFFER> pBuffer,
        Pointer pvContext)>('WebSocketReceive');

int WebSocketSend(int hWebSocket, int BufferType,
        Pointer<WEB_SOCKET_BUFFER> pBuffer, Pointer Context) =>
    _WebSocketSend(hWebSocket, BufferType, pBuffer, Context);

late final _WebSocketSend = _websocket.lookupFunction<
    Int32 Function(IntPtr hWebSocket, Int32 BufferType,
        Pointer<WEB_SOCKET_BUFFER> pBuffer, Pointer Context),
    int Function(int hWebSocket, int BufferType,
        Pointer<WEB_SOCKET_BUFFER> pBuffer, Pointer Context)>('WebSocketSend');
