...
typedef DBGPRINT = Uint32 Function(Pointer<Utf8> Format);
typedef DEREFERENCECONNECTION = Uint32 Function(
    Pointer<ldap> PrimaryConnection, Pointer<ldap> ConnectionToDereference);
...
typedef VERIFYSERVERCERT = Uint8 Function(
    Pointer<ldap> Connection, Pointer<Pointer<CERT_CONTEXT>> pServerCert);
