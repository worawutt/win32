...
typedef WS_ABANDON_MESSAGE_CALLBACK = Int32 Function(Pointer channelInstance,
    Pointer<WS_MESSAGE> message, Pointer<WS_ERROR> error);
typedef WS_ABORT_CHANNEL_CALLBACK = Int32 Function(
    Pointer channelInstance, Pointer<WS_ERROR> error);
typedef WS_ABORT_LISTENER_CALLBACK = Int32 Function(
    Pointer listenerInstance, Pointer<WS_ERROR> error);
...
typedef WS_ASYNC_CALLBACK = Void Function(
    Int32 errorCode, Int32 callbackModel, Pointer callbackState);
...
typedef WS_CERTIFICATE_VALIDATION_CALLBACK = Int32 Function(
    Pointer<CERT_CONTEXT> certContext, Pointer state);
typedef WS_CERT_ISSUER_LIST_NOTIFICATION_CALLBACK = Int32 Function(
    ...
    Pointer<WS_ERROR> error);
typedef WS_CLOSE_CHANNEL_CALLBACK = Int32 Function(Pointer channelInstance,
    Pointer<WS_ASYNC_CONTEXT> asyncContext, Pointer<WS_ERROR> error);
typedef WS_CLOSE_LISTENER_CALLBACK = Int32 Function(Pointer listenerInstance,
    Pointer<WS_ASYNC_CONTEXT> asyncContext, Pointer<WS_ERROR> error);
...
typedef WS_DECODER_DECODE_CALLBACK = Int32 Function(
    ...
    Pointer<WS_ASYNC_CONTEXT> asyncContext,
    Pointer<WS_ERROR> error);
typedef WS_DECODER_END_CALLBACK = Int32 Function(Pointer encoderContext,
    Pointer<WS_ASYNC_CONTEXT> asyncContext, Pointer<WS_ERROR> error);
typedef WS_DECODER_GET_CONTENT_TYPE_CALLBACK = Int32 Function(
    ...
    Pointer<WS_ERROR> error);
typedef WS_DECODER_START_CALLBACK = Int32 Function(Pointer encoderContext,
    Pointer<WS_ASYNC_CONTEXT> asyncContext, Pointer<WS_ERROR> error);
...
typedef WS_ENCODER_ENCODE_CALLBACK = Int32 Function(
    ...
    Pointer<WS_ASYNC_CONTEXT> asyncContext,
    Pointer<WS_ERROR> error);
typedef WS_ENCODER_END_CALLBACK = Int32 Function(Pointer encoderContext,
    Pointer<WS_ASYNC_CONTEXT> asyncContext, Pointer<WS_ERROR> error);
typedef WS_ENCODER_GET_CONTENT_TYPE_CALLBACK = Int32 Function(
    ...
    Pointer<WS_STRING> contentEncoding,
    Pointer<WS_ERROR> error);
typedef WS_ENCODER_START_CALLBACK = Int32 Function(Pointer encoderContext,
    Pointer<WS_ASYNC_CONTEXT> asyncContext, Pointer<WS_ERROR> error);
typedef WS_FREE_CHANNEL_CALLBACK = Void Function(Pointer channelInstance);
typedef WS_FREE_DECODER_CALLBACK = Void Function(Pointer decoderContext);
typedef WS_FREE_ENCODER_CALLBACK = Void Function(Pointer encoderContext);
typedef WS_FREE_LISTENER_CALLBACK = Void Function(Pointer listenerInstance);
...
typedef WS_HTTP_REDIRECT_CALLBACK = Int32 Function(
    Pointer state, Pointer<WS_STRING> originalUrl, Pointer<WS_STRING> newUrl);
typedef WS_IS_DEFAULT_VALUE_CALLBACK = Int32 Function(
    ...
    Pointer<WS_ERROR> error);
typedef WS_MESSAGE_DONE_CALLBACK = Void Function(Pointer doneCallbackState);
...
typedef WS_OPERATION_CANCEL_CALLBACK = Void Function(
    Int32 reason, Pointer state);
typedef WS_OPERATION_FREE_STATE_CALLBACK = Void Function(Pointer state);
typedef WS_PROXY_MESSAGE_CALLBACK = Int32 Function(Pointer<WS_MESSAGE> message,
    Pointer<WS_HEAP> heap, Pointer state, Pointer<WS_ERROR> error);
