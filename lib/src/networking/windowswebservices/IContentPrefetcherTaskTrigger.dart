...
class IContentPrefetcherTaskTrigger extends IInspectable {
  ...
  int TriggerContentPrefetcherTask(Pointer<Utf16> packageFullName) =>
  ...
  int
      IsRegisteredForContentPrefetch(
              Pointer<Utf16> packageFullName, Pointer<Uint8> isRegistered) =>
          ptr.ref.lpVtbl.value
                  .elementAt(7)
                  .cast<
                      Pointer<
                  ...
                  .asFunction<
                      int Function(Pointer, Pointer<Utf16> packageFullName,
                          Pointer<Uint8> isRegistered)>()(
              ptr.ref.lpVtbl, packageFullName, isRegistered);
}
