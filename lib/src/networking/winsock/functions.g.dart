...
void FreeAddrInfoEx(Pointer<addrinfoex> pAddrInfoEx) =>
    _FreeAddrInfoEx(pAddrInfoEx);

late final _FreeAddrInfoEx = _ws2_32.lookupFunction<
    Void Function(Pointer<addrinfoex> pAddrInfoEx),
    void Function(Pointer<addrinfoex> pAddrInfoEx)>('FreeAddrInfoExW');

void FreeAddrInfo(Pointer<addrinfo> pAddrInfo) => _FreeAddrInfo(pAddrInfo);

late final _FreeAddrInfo = _ws2_32.lookupFunction<
    Void Function(Pointer<addrinfo> pAddrInfo),
    void Function(Pointer<addrinfo> pAddrInfo)>('FreeAddrInfoW');

int GetAddrInfoExCancel(Pointer<IntPtr> lpHandle) =>
    _GetAddrInfoExCancel(lpHandle);

late final _GetAddrInfoExCancel = _ws2_32.lookupFunction<
    Int32 Function(Pointer<IntPtr> lpHandle),
    int Function(Pointer<IntPtr> lpHandle)>('GetAddrInfoExCancel');

int GetAddrInfoExOverlappedResult(Pointer<OVERLAPPED> lpOverlapped) =>
    _GetAddrInfoExOverlappedResult(lpOverlapped);

late final _GetAddrInfoExOverlappedResult = _ws2_32.lookupFunction<
    Int32 Function(Pointer<OVERLAPPED> lpOverlapped),
    int Function(
        Pointer<OVERLAPPED> lpOverlapped)>('GetAddrInfoExOverlappedResult');
...
int GetAddrInfoEx(
    ...
    _GetAddrInfoEx(pName, pServiceName, dwNameSpace, lpNspId, hints, ppResult,
...
late final _GetAddrInfoEx = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<NativeFunction<LPLOOKUPSERVICE_COMPLETION_ROUTINE>>
            lpCompletionRoutine,
        Pointer<IntPtr> lpHandle)>('GetAddrInfoExW');
...
int GetHostName(Pointer<Utf16> name, int namelen) =>
    _GetHostName(name, namelen);

late final _GetHostName = _ws2_32.lookupFunction<
    Int32 Function(Pointer<Utf16> name, Int32 namelen),
    int Function(Pointer<Utf16> name, int namelen)>('GetHostNameW');
...
late final _GetNameInfo = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Utf16> pServiceBuffer,
        int ServiceBufferSize,
        int Flags)>('GetNameInfoW');

Pointer<Utf16> InetNtop(int Family, Pointer pAddr, Pointer<Utf16> pStringBuf,
        int StringBufSize) =>
    _InetNtop(Family, pAddr, pStringBuf, StringBufSize);

late final _InetNtop = _ws2_32.lookupFunction<
    Pointer<Utf16> Function(Int32 Family, Pointer pAddr,
        Pointer<Utf16> pStringBuf, IntPtr StringBufSize),
    Pointer<Utf16> Function(int Family, Pointer pAddr,
        Pointer<Utf16> pStringBuf, int StringBufSize)>('InetNtopW');

int InetPton(int Family, Pointer<Utf16> pszAddrString, Pointer pAddrBuf) =>
    _InetPton(Family, pszAddrString, pAddrBuf);

late final _InetPton = _ws2_32.lookupFunction<
    Int32 Function(
        Int32 Family, Pointer<Utf16> pszAddrString, Pointer pAddrBuf),
    int Function(int Family, Pointer<Utf16> pszAddrString,
        Pointer pAddrBuf)>('InetPtonW');
...
late final _ProcessSocketNotifications = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        int completionCount,
        Pointer<OVERLAPPED_ENTRY> completionPortEntries,
        Pointer<Uint32> receivedEntryCount)>('ProcessSocketNotifications');
...
late final _SetAddrInfoEx = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<NativeFunction<LPLOOKUPSERVICE_COMPLETION_ROUTINE>>
            lpCompletionRoutine,
        Pointer<IntPtr> lpNameHandle)>('SetAddrInfoExW');

int WPUCompleteOverlappedRequest(int s, Pointer<OVERLAPPED> lpOverlapped,
        int dwError, int cbTransferred, Pointer<Int32> lpErrno) =>
...
late final _WPUCompleteOverlappedRequest = _ws2_32.lookupFunction<
    Int32 Function(IntPtr s, Pointer<OVERLAPPED> lpOverlapped, Uint32 dwError,
        Uint32 cbTransferred, Pointer<Int32> lpErrno),
    int Function(
        int s,
        Pointer<OVERLAPPED> lpOverlapped,
        int dwError,
        int cbTransferred,
        Pointer<Int32> lpErrno)>('WPUCompleteOverlappedRequest');
...
int WSAAccept(
        ...
        int dwCallbackData) =>
    _WSAAccept(s, addr, addrlen, lpfnCondition, dwCallbackData);
...
int WSAAddressToString(
    ...
    _WSAAddressToString(lpsaAddress, dwAddressLength, lpProtocolInfo,
...
late final _WSAAddressToString = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<WSAPROTOCOL_INFO> lpProtocolInfo,
        Pointer<Utf16> lpszAddressString,
        Pointer<Uint32> lpdwAddressStringLength)>('WSAAddressToStringW');

int WSAAdvertiseProvider(
        Pointer<GUID> puuidProviderId, Pointer<NSPV2_ROUTINE> pNSPv2Routine) =>
    _WSAAdvertiseProvider(puuidProviderId, pNSPv2Routine);

late final _WSAAdvertiseProvider = _ws2_32.lookupFunction<
    Int32 Function(
        Pointer<GUID> puuidProviderId, Pointer<NSPV2_ROUTINE> pNSPv2Routine),
    int Function(Pointer<GUID> puuidProviderId,
        Pointer<NSPV2_ROUTINE> pNSPv2Routine)>('WSAAdvertiseProvider');

int WSAAsyncGetHostByAddr(int hWnd, int wMsg, Pointer<Utf8> addr, int len,
        int type, Pointer<Utf8> buf, int buflen) =>
    _WSAAsyncGetHostByAddr(hWnd, wMsg, addr, len, type, buf, buflen);

late final _WSAAsyncGetHostByAddr = _ws2_32.lookupFunction<
    IntPtr Function(IntPtr hWnd, Uint32 wMsg, Pointer<Utf8> addr, Int32 len,
        Int32 type, Pointer<Utf8> buf, Int32 buflen),
    int Function(int hWnd, int wMsg, Pointer<Utf8> addr, int len, int type,
        Pointer<Utf8> buf, int buflen)>('WSAAsyncGetHostByAddr');

int WSAAsyncGetHostByName(int hWnd, int wMsg, Pointer<Utf8> name,
        Pointer<Utf8> buf, int buflen) =>
    _WSAAsyncGetHostByName(hWnd, wMsg, name, buf, buflen);

late final _WSAAsyncGetHostByName = _ws2_32.lookupFunction<
    IntPtr Function(IntPtr hWnd, Uint32 wMsg, Pointer<Utf8> name,
        Pointer<Utf8> buf, Int32 buflen),
    int Function(int hWnd, int wMsg, Pointer<Utf8> name, Pointer<Utf8> buf,
        int buflen)>('WSAAsyncGetHostByName');

int WSAAsyncGetProtoByName(int hWnd, int wMsg, Pointer<Utf8> name,
        Pointer<Utf8> buf, int buflen) =>
    _WSAAsyncGetProtoByName(hWnd, wMsg, name, buf, buflen);

late final _WSAAsyncGetProtoByName = _ws2_32.lookupFunction<
    IntPtr Function(IntPtr hWnd, Uint32 wMsg, Pointer<Utf8> name,
        Pointer<Utf8> buf, Int32 buflen),
    int Function(int hWnd, int wMsg, Pointer<Utf8> name, Pointer<Utf8> buf,
        int buflen)>('WSAAsyncGetProtoByName');

int WSAAsyncGetProtoByNumber(
        int hWnd, int wMsg, int number, Pointer<Utf8> buf, int buflen) =>
    _WSAAsyncGetProtoByNumber(hWnd, wMsg, number, buf, buflen);

late final _WSAAsyncGetProtoByNumber = _ws2_32.lookupFunction<
    IntPtr Function(IntPtr hWnd, Uint32 wMsg, Int32 number, Pointer<Utf8> buf,
        Int32 buflen),
    int Function(int hWnd, int wMsg, int number, Pointer<Utf8> buf,
        int buflen)>('WSAAsyncGetProtoByNumber');

int WSAAsyncGetServByName(int hWnd, int wMsg, Pointer<Utf8> name,
        Pointer<Utf8> proto, Pointer<Utf8> buf, int buflen) =>
    _WSAAsyncGetServByName(hWnd, wMsg, name, proto, buf, buflen);

late final _WSAAsyncGetServByName = _ws2_32.lookupFunction<
    IntPtr Function(IntPtr hWnd, Uint32 wMsg, Pointer<Utf8> name,
        Pointer<Utf8> proto, Pointer<Utf8> buf, Int32 buflen),
    int Function(int hWnd, int wMsg, Pointer<Utf8> name, Pointer<Utf8> proto,
        Pointer<Utf8> buf, int buflen)>('WSAAsyncGetServByName');

int WSAAsyncGetServByPort(int hWnd, int wMsg, int port, Pointer<Utf8> proto,
        Pointer<Utf8> buf, int buflen) =>
    _WSAAsyncGetServByPort(hWnd, wMsg, port, proto, buf, buflen);

late final _WSAAsyncGetServByPort = _ws2_32.lookupFunction<
    IntPtr Function(IntPtr hWnd, Uint32 wMsg, Int32 port, Pointer<Utf8> proto,
        Pointer<Utf8> buf, Int32 buflen),
    int Function(int hWnd, int wMsg, int port, Pointer<Utf8> proto,
        Pointer<Utf8> buf, int buflen)>('WSAAsyncGetServByPort');

int WSAAsyncSelect(int s, int hWnd, int wMsg, int lEvent) =>
    _WSAAsyncSelect(s, hWnd, wMsg, lEvent);

late final _WSAAsyncSelect = _ws2_32.lookupFunction<
    Int32 Function(IntPtr s, IntPtr hWnd, Uint32 wMsg, Int32 lEvent),
    int Function(int s, int hWnd, int wMsg, int lEvent)>('WSAAsyncSelect');

int WSACancelAsyncRequest(int hAsyncTaskHandle) =>
    _WSACancelAsyncRequest(hAsyncTaskHandle);

late final _WSACancelAsyncRequest = _ws2_32.lookupFunction<
    Int32 Function(IntPtr hAsyncTaskHandle),
    int Function(int hAsyncTaskHandle)>('WSACancelAsyncRequest');
...
int WSACloseEvent(int hEvent) => _WSACloseEvent(hEvent);

late final _WSACloseEvent = _ws2_32.lookupFunction<
    Int32 Function(IntPtr hEvent), int Function(int hEvent)>('WSACloseEvent');
...
int WSAConnect(
        ...
        Pointer<QOS> lpSQOS,
        Pointer<QOS> lpGQOS) =>
    _WSAConnect(s, name, namelen, lpCallerData, lpCalleeData, lpSQOS, lpGQOS);
...
int WSAConnectByList(
    ...
    _WSAConnectByList(s, SocketAddress, LocalAddressLength, LocalAddress,
...
late final _WSAConnectByList = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<SOCKADDR> RemoteAddress,
        Pointer<timeval> timeout,
        Pointer<OVERLAPPED> Reserved)>('WSAConnectByList');
...
int WSAConnectByName(
        ...
        Pointer<timeval> timeout,
        Pointer<OVERLAPPED> Reserved) =>
    _WSAConnectByName(s, nodename, servicename, LocalAddressLength,
...
late final _WSAConnectByName = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<SOCKADDR> RemoteAddress,
        Pointer<timeval> timeout,
        Pointer<OVERLAPPED> Reserved)>('WSAConnectByNameW');
...
int WSADuplicateSocket(
        int s, int dwProcessId, Pointer<WSAPROTOCOL_INFO> lpProtocolInfo) =>
    _WSADuplicateSocket(s, dwProcessId, lpProtocolInfo);

late final _WSADuplicateSocket = _ws2_32.lookupFunction<
    Int32 Function(
        IntPtr s, Uint32 dwProcessId, Pointer<WSAPROTOCOL_INFO> lpProtocolInfo),
    int Function(int s, int dwProcessId,
        Pointer<WSAPROTOCOL_INFO> lpProtocolInfo)>('WSADuplicateSocketW');

int WSAEnumNameSpaceProvidersEx(Pointer<Uint32> lpdwBufferLength,
        Pointer<WSANAMESPACE_INFOEX> lpnspBuffer) =>
    _WSAEnumNameSpaceProvidersEx(lpdwBufferLength, lpnspBuffer);

late final _WSAEnumNameSpaceProvidersEx = _ws2_32.lookupFunction<
        Int32 Function(Pointer<Uint32> lpdwBufferLength,
            Pointer<WSANAMESPACE_INFOEX> lpnspBuffer),
        int Function(Pointer<Uint32> lpdwBufferLength,
            Pointer<WSANAMESPACE_INFOEX> lpnspBuffer)>(
    'WSAEnumNameSpaceProvidersExW');

int WSAEnumNameSpaceProviders(Pointer<Uint32> lpdwBufferLength,
        Pointer<WSANAMESPACE_INFO> lpnspBuffer) =>
    _WSAEnumNameSpaceProviders(lpdwBufferLength, lpnspBuffer);

late final _WSAEnumNameSpaceProviders = _ws2_32.lookupFunction<
    Int32 Function(Pointer<Uint32> lpdwBufferLength,
        Pointer<WSANAMESPACE_INFO> lpnspBuffer),
    int Function(Pointer<Uint32> lpdwBufferLength,
        Pointer<WSANAMESPACE_INFO> lpnspBuffer)>('WSAEnumNameSpaceProvidersW');

int WSAEnumNetworkEvents(
        int s, int hEventObject, Pointer<WSANETWORKEVENTS> lpNetworkEvents) =>
    _WSAEnumNetworkEvents(s, hEventObject, lpNetworkEvents);

late final _WSAEnumNetworkEvents = _ws2_32.lookupFunction<
    Int32 Function(IntPtr s, IntPtr hEventObject,
        Pointer<WSANETWORKEVENTS> lpNetworkEvents),
    int Function(int s, int hEventObject,
        Pointer<WSANETWORKEVENTS> lpNetworkEvents)>('WSAEnumNetworkEvents');

int WSAEnumProtocols(
        Pointer<Int32> lpiProtocols,
        Pointer<WSAPROTOCOL_INFO> lpProtocolBuffer,
        Pointer<Uint32> lpdwBufferLength) =>
    _WSAEnumProtocols(lpiProtocols, lpProtocolBuffer, lpdwBufferLength);
...
late final _WSAEnumProtocols = _ws2_32.lookupFunction<
    ...
    int Function(
        Pointer<Int32> lpiProtocols,
        Pointer<WSAPROTOCOL_INFO> lpProtocolBuffer,
        Pointer<Uint32> lpdwBufferLength)>('WSAEnumProtocolsW');

int WSAEventSelect(int s, int hEventObject, int lNetworkEvents) =>
    _WSAEventSelect(s, hEventObject, lNetworkEvents);

late final _WSAEventSelect = _ws2_32.lookupFunction<
    Int32 Function(IntPtr s, IntPtr hEventObject, Int32 lNetworkEvents),
    int Function(
        int s, int hEventObject, int lNetworkEvents)>('WSAEventSelect');
...
int WSAGetOverlappedResult(int s, Pointer<OVERLAPPED> lpOverlapped,
        Pointer<Uint32> lpcbTransfer, int fWait, Pointer<Uint32> lpdwFlags) =>
    _WSAGetOverlappedResult(s, lpOverlapped, lpcbTransfer, fWait, lpdwFlags);

late final _WSAGetOverlappedResult = _ws2_32.lookupFunction<
    Int32 Function(IntPtr s, Pointer<OVERLAPPED> lpOverlapped,
        Pointer<Uint32> lpcbTransfer, Int32 fWait, Pointer<Uint32> lpdwFlags),
    int Function(
        int s,
        Pointer<OVERLAPPED> lpOverlapped,
        Pointer<Uint32> lpcbTransfer,
        int fWait,
        Pointer<Uint32> lpdwFlags)>('WSAGetOverlappedResult');

int WSAGetQOSByName(int s, Pointer<WSABUF> lpQOSName, Pointer<QOS> lpQOS) =>
    _WSAGetQOSByName(s, lpQOSName, lpQOS);

late final _WSAGetQOSByName = _ws2_32.lookupFunction<
    Int32 Function(IntPtr s, Pointer<WSABUF> lpQOSName, Pointer<QOS> lpQOS),
    int Function(int s, Pointer<WSABUF> lpQOSName,
        Pointer<QOS> lpQOS)>('WSAGetQOSByName');
...
late final _WSAGetServiceClassNameByClassId = _ws2_32.lookupFunction<
    Int32 Function(Pointer<GUID> lpServiceClassId,
        Pointer<Utf16> lpszServiceClassName, Pointer<Uint32> lpdwBufferLength),
    int Function(
        Pointer<GUID> lpServiceClassId,
        Pointer<Utf16> lpszServiceClassName,
        Pointer<Uint32> lpdwBufferLength)>('WSAGetServiceClassNameByClassIdW');

int WSAHtonl(int s, int hostlong, Pointer<Uint32> lpnetlong) =>
    _WSAHtonl(s, hostlong, lpnetlong);

late final _WSAHtonl = _ws2_32.lookupFunction<
    Int32 Function(IntPtr s, Uint32 hostlong, Pointer<Uint32> lpnetlong),
    int Function(int s, int hostlong, Pointer<Uint32> lpnetlong)>('WSAHtonl');

int WSAHtons(int s, int hostshort, Pointer<Uint16> lpnetshort) =>
    _WSAHtons(s, hostshort, lpnetshort);

late final _WSAHtons = _ws2_32.lookupFunction<
    Int32 Function(IntPtr s, Uint16 hostshort, Pointer<Uint16> lpnetshort),
    int Function(int s, int hostshort, Pointer<Uint16> lpnetshort)>('WSAHtons');

int WSAInstallServiceClass(Pointer<WSASERVICECLASSINFO> lpServiceClassInfo) =>
    _WSAInstallServiceClass(lpServiceClassInfo);

late final _WSAInstallServiceClass = _ws2_32.lookupFunction<
        Int32 Function(Pointer<WSASERVICECLASSINFO> lpServiceClassInfo),
        int Function(Pointer<WSASERVICECLASSINFO> lpServiceClassInfo)>(
...
int WSAIoctl(
        ...
        Pointer<NativeFunction<LPWSAOVERLAPPED_COMPLETION_ROUTINE>>
            lpCompletionRoutine) =>
    _WSAIoctl(s, dwIoControlCode, lpvInBuffer, cbInBuffer, lpvOutBuffer,
...
late final _WSAJoinLeaf = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<QOS> lpSQOS,
        Pointer<QOS> lpGQOS,
        int dwFlags)>('WSAJoinLeaf');

int WSALookupServiceBegin(Pointer<WSAQUERYSET> lpqsRestrictions,
        int dwControlFlags, Pointer<IntPtr> lphLookup) =>
    _WSALookupServiceBegin(lpqsRestrictions, dwControlFlags, lphLookup);

late final _WSALookupServiceBegin = _ws2_32.lookupFunction<
    Int32 Function(Pointer<WSAQUERYSET> lpqsRestrictions, Uint32 dwControlFlags,
        Pointer<IntPtr> lphLookup),
    int Function(Pointer<WSAQUERYSET> lpqsRestrictions, int dwControlFlags,
        Pointer<IntPtr> lphLookup)>('WSALookupServiceBeginW');

int WSALookupServiceEnd(int hLookup) => _WSALookupServiceEnd(hLookup);

late final _WSALookupServiceEnd = _ws2_32.lookupFunction<
    Int32 Function(IntPtr hLookup),
    int Function(int hLookup)>('WSALookupServiceEnd');

int WSALookupServiceNext(int hLookup, int dwControlFlags,
        Pointer<Uint32> lpdwBufferLength, Pointer<WSAQUERYSET> lpqsResults) =>
...
late final _WSALookupServiceNext = _ws2_32.lookupFunction<
    Int32 Function(IntPtr hLookup, Uint32 dwControlFlags,
        Pointer<Uint32> lpdwBufferLength, Pointer<WSAQUERYSET> lpqsResults),
    int Function(
        int hLookup,
        int dwControlFlags,
        Pointer<Uint32> lpdwBufferLength,
        Pointer<WSAQUERYSET> lpqsResults)>('WSALookupServiceNextW');
...
int WSANSPIoctl(
    ...
    _WSANSPIoctl(hLookup, dwControlCode, lpvInBuffer, cbInBuffer, lpvOutBuffer,
...
late final _WSANSPIoctl = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        int cbOutBuffer,
        Pointer<Uint32> lpcbBytesReturned,
        Pointer<WSACOMPLETION> lpCompletion)>('WSANSPIoctl');

int WSANtohl(int s, int netlong, Pointer<Uint32> lphostlong) =>
    _WSANtohl(s, netlong, lphostlong);

late final _WSANtohl = _ws2_32.lookupFunction<
    Int32 Function(IntPtr s, Uint32 netlong, Pointer<Uint32> lphostlong),
    int Function(int s, int netlong, Pointer<Uint32> lphostlong)>('WSANtohl');

int WSANtohs(int s, int netshort, Pointer<Uint16> lphostshort) =>
    _WSANtohs(s, netshort, lphostshort);

late final _WSANtohs = _ws2_32.lookupFunction<
    Int32 Function(IntPtr s, Uint16 netshort, Pointer<Uint16> lphostshort),
    int Function(int s, int netshort, Pointer<Uint16> lphostshort)>('WSANtohs');

int WSAPoll(Pointer<WSAPOLLFD> fdArray, int fds, int timeout) =>
    _WSAPoll(fdArray, fds, timeout);

late final _WSAPoll = _ws2_32.lookupFunction<
    Int32 Function(Pointer<WSAPOLLFD> fdArray, Uint32 fds, Int32 timeout),
    int Function(Pointer<WSAPOLLFD> fdArray, int fds, int timeout)>('WSAPoll');

int WSAProviderCompleteAsyncCall(int hAsyncCall, int iRetCode) =>
    _WSAProviderCompleteAsyncCall(hAsyncCall, iRetCode);

late final _WSAProviderCompleteAsyncCall = _ws2_32.lookupFunction<
    Int32 Function(IntPtr hAsyncCall, Int32 iRetCode),
    int Function(int hAsyncCall, int iRetCode)>('WSAProviderCompleteAsyncCall');
...
late final _WSAProviderConfigChange = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<OVERLAPPED> lpOverlapped,
        Pointer<NativeFunction<LPWSAOVERLAPPED_COMPLETION_ROUTINE>>
            lpCompletionRoutine)>('WSAProviderConfigChange');
...
int WSARecv(
        ...
        Pointer<NativeFunction<LPWSAOVERLAPPED_COMPLETION_ROUTINE>>
            lpCompletionRoutine) =>
    _WSARecv(s, lpBuffers, dwBufferCount, lpNumberOfBytesRecvd, lpFlags,
...
int WSARecvDisconnect(int s, Pointer<WSABUF> lpInboundDisconnectData) =>
    _WSARecvDisconnect(s, lpInboundDisconnectData);

late final _WSARecvDisconnect = _ws2_32.lookupFunction<
    Int32 Function(IntPtr s, Pointer<WSABUF> lpInboundDisconnectData),
    int Function(
        int s, Pointer<WSABUF> lpInboundDisconnectData)>('WSARecvDisconnect');
...
int WSARecvFrom(
        ...
        Pointer<NativeFunction<LPWSAOVERLAPPED_COMPLETION_ROUTINE>>
            lpCompletionRoutine) =>
    _WSARecvFrom(s, lpBuffers, dwBufferCount, lpNumberOfBytesRecvd, lpFlags,
...
late final _WSARecvFrom = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<OVERLAPPED> lpOverlapped,
        Pointer<NativeFunction<LPWSAOVERLAPPED_COMPLETION_ROUTINE>>
            lpCompletionRoutine)>('WSARecvFrom');

int WSARemoveServiceClass(Pointer<GUID> lpServiceClassId) =>
    _WSARemoveServiceClass(lpServiceClassId);

late final _WSARemoveServiceClass = _ws2_32.lookupFunction<
    Int32 Function(Pointer<GUID> lpServiceClassId),
    int Function(Pointer<GUID> lpServiceClassId)>('WSARemoveServiceClass');

int WSAResetEvent(int hEvent) => _WSAResetEvent(hEvent);

late final _WSAResetEvent = _ws2_32.lookupFunction<
    Int32 Function(IntPtr hEvent), int Function(int hEvent)>('WSAResetEvent');
...
int WSASend(
        ...
        Pointer<NativeFunction<LPWSAOVERLAPPED_COMPLETION_ROUTINE>>
            lpCompletionRoutine) =>
    _WSASend(s, lpBuffers, dwBufferCount, lpNumberOfBytesSent, dwFlags,
        lpOverlapped, lpCompletionRoutine);
...
late final _WSASend = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<OVERLAPPED> lpOverlapped,
        Pointer<NativeFunction<LPWSAOVERLAPPED_COMPLETION_ROUTINE>>
            lpCompletionRoutine)>('WSASend');

int WSASendDisconnect(int s, Pointer<WSABUF> lpOutboundDisconnectData) =>
    _WSASendDisconnect(s, lpOutboundDisconnectData);

late final _WSASendDisconnect = _ws2_32.lookupFunction<
    Int32 Function(IntPtr s, Pointer<WSABUF> lpOutboundDisconnectData),
    int Function(
        int s, Pointer<WSABUF> lpOutboundDisconnectData)>('WSASendDisconnect');
...
int WSASendMsg(
        ...
        Pointer<NativeFunction<LPWSAOVERLAPPED_COMPLETION_ROUTINE>>
            lpCompletionRoutine) =>
    _WSASendMsg($Handle, lpMsg, dwFlags, lpNumberOfBytesSent, lpOverlapped,
        lpCompletionRoutine);
...
late final _WSASendMsg = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<OVERLAPPED> lpOverlapped,
        Pointer<NativeFunction<LPWSAOVERLAPPED_COMPLETION_ROUTINE>>
            lpCompletionRoutine)>('WSASendMsg');
...
int WSASendTo(
        ...
        Pointer<NativeFunction<LPWSAOVERLAPPED_COMPLETION_ROUTINE>>
            lpCompletionRoutine) =>
    _WSASendTo(s, lpBuffers, dwBufferCount, lpNumberOfBytesSent, dwFlags, lpTo,
...
late final _WSASendTo = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<OVERLAPPED> lpOverlapped,
        Pointer<NativeFunction<LPWSAOVERLAPPED_COMPLETION_ROUTINE>>
            lpCompletionRoutine)>('WSASendTo');

Pointer WSASetBlockingHook(Pointer lpBlockFunc) =>
    _WSASetBlockingHook(lpBlockFunc);

late final _WSASetBlockingHook = _ws2_32.lookupFunction<
    Pointer Function(Pointer lpBlockFunc),
    Pointer Function(Pointer lpBlockFunc)>('WSASetBlockingHook');

int WSASetEvent(int hEvent) => _WSASetEvent(hEvent);

late final _WSASetEvent = _ws2_32.lookupFunction<Int32 Function(IntPtr hEvent),
    int Function(int hEvent)>('WSASetEvent');

void WSASetLastError(int iError) => _WSASetLastError(iError);

late final _WSASetLastError = _ws2_32.lookupFunction<
    Void Function(Int32 iError), void Function(int iError)>('WSASetLastError');

int WSASetService(Pointer<WSAQUERYSET> lpqsRegInfo, int essoperation,
        int dwControlFlags) =>
    _WSASetService(lpqsRegInfo, essoperation, dwControlFlags);

late final _WSASetService = _ws2_32.lookupFunction<
    Int32 Function(Pointer<WSAQUERYSET> lpqsRegInfo, Int32 essoperation,
        Uint32 dwControlFlags),
    int Function(Pointer<WSAQUERYSET> lpqsRegInfo, int essoperation,
        int dwControlFlags)>('WSASetServiceW');

int WSASocket(int af, int type, int protocol,
        Pointer<WSAPROTOCOL_INFO> lpProtocolInfo, int g, int dwFlags) =>
    _WSASocket(af, type, protocol, lpProtocolInfo, g, dwFlags);

late final _WSASocket = _ws2_32.lookupFunction<
    IntPtr Function(Int32 af, Int32 type, Int32 protocol,
        Pointer<WSAPROTOCOL_INFO> lpProtocolInfo, Uint32 g, Uint32 dwFlags),
    int Function(
        int af,
        int type,
        int protocol,
        Pointer<WSAPROTOCOL_INFO> lpProtocolInfo,
        int g,
        int dwFlags)>('WSASocketW');

int WSAStartup(int wVersionRequested, Pointer<WSAData> lpWSAData) =>
    _WSAStartup(wVersionRequested, lpWSAData);

late final _WSAStartup = _ws2_32.lookupFunction<
    Int32 Function(Uint16 wVersionRequested, Pointer<WSAData> lpWSAData),
    int Function(
        int wVersionRequested, Pointer<WSAData> lpWSAData)>('WSAStartup');
...
int WSAStringToAddress(
    ...
    _WSAStringToAddress(AddressString, AddressFamily, lpProtocolInfo, lpAddress,
        lpAddressLength);
...
late final _WSAStringToAddress = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<WSAPROTOCOL_INFO> lpProtocolInfo,
        Pointer<SOCKADDR> lpAddress,
        Pointer<Int32> lpAddressLength)>('WSAStringToAddressW');

int WSAUnadvertiseProvider(Pointer<GUID> puuidProviderId) =>
    _WSAUnadvertiseProvider(puuidProviderId);

late final _WSAUnadvertiseProvider = _ws2_32.lookupFunction<
    Int32 Function(Pointer<GUID> puuidProviderId),
    int Function(Pointer<GUID> puuidProviderId)>('WSAUnadvertiseProvider');
...
int WSAWaitForMultipleEvents(int cEvents, Pointer<IntPtr> lphEvents,
        int fWaitAll, int dwTimeout, int fAlertable) =>
...
late final _WSAWaitForMultipleEvents = _ws2_32.lookupFunction<
    Uint32 Function(Uint32 cEvents, Pointer<IntPtr> lphEvents, Int32 fWaitAll,
        Uint32 dwTimeout, Int32 fAlertable),
    int Function(int cEvents, Pointer<IntPtr> lphEvents, int fWaitAll,
        int dwTimeout, int fAlertable)>('WSAWaitForMultipleEvents');

int WSCDeinstallProvider(Pointer<GUID> lpProviderId, Pointer<Int32> lpErrno) =>
    _WSCDeinstallProvider(lpProviderId, lpErrno);

late final _WSCDeinstallProvider = _ws2_32.lookupFunction<
    Int32 Function(Pointer<GUID> lpProviderId, Pointer<Int32> lpErrno),
    int Function(Pointer<GUID> lpProviderId,
        Pointer<Int32> lpErrno)>('WSCDeinstallProvider');

int WSCDeinstallProvider32(
        Pointer<GUID> lpProviderId, Pointer<Int32> lpErrno) =>
    _WSCDeinstallProvider32(lpProviderId, lpErrno);

late final _WSCDeinstallProvider32 = _ws2_32.lookupFunction<
    Int32 Function(Pointer<GUID> lpProviderId, Pointer<Int32> lpErrno),
    int Function(Pointer<GUID> lpProviderId,
        Pointer<Int32> lpErrno)>('WSCDeinstallProvider32');

int WSCEnableNSProvider(Pointer<GUID> lpProviderId, int fEnable) =>
    _WSCEnableNSProvider(lpProviderId, fEnable);

late final _WSCEnableNSProvider = _ws2_32.lookupFunction<
    Int32 Function(Pointer<GUID> lpProviderId, Int32 fEnable),
    int Function(
        Pointer<GUID> lpProviderId, int fEnable)>('WSCEnableNSProvider');

int WSCEnableNSProvider32(Pointer<GUID> lpProviderId, int fEnable) =>
    _WSCEnableNSProvider32(lpProviderId, fEnable);

late final _WSCEnableNSProvider32 = _ws2_32.lookupFunction<
    Int32 Function(Pointer<GUID> lpProviderId, Int32 fEnable),
    int Function(
        Pointer<GUID> lpProviderId, int fEnable)>('WSCEnableNSProvider32');

int WSCEnumNameSpaceProviders32(Pointer<Uint32> lpdwBufferLength,
        Pointer<WSANAMESPACE_INFO> lpnspBuffer) =>
    _WSCEnumNameSpaceProviders32(lpdwBufferLength, lpnspBuffer);

late final _WSCEnumNameSpaceProviders32 = _ws2_32.lookupFunction<
    Int32 Function(Pointer<Uint32> lpdwBufferLength,
        Pointer<WSANAMESPACE_INFO> lpnspBuffer),
    int Function(Pointer<Uint32> lpdwBufferLength,
        Pointer<WSANAMESPACE_INFO> lpnspBuffer)>('WSCEnumNameSpaceProviders32');

int WSCEnumNameSpaceProvidersEx32(Pointer<Uint32> lpdwBufferLength,
        Pointer<WSANAMESPACE_INFOEX> lpnspBuffer) =>
    _WSCEnumNameSpaceProvidersEx32(lpdwBufferLength, lpnspBuffer);
...
late final _WSCEnumProtocols = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<WSAPROTOCOL_INFO> lpProtocolBuffer,
        Pointer<Uint32> lpdwBufferLength,
        Pointer<Int32> lpErrno)>('WSCEnumProtocols');
...
late final _WSCEnumProtocols32 = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<WSAPROTOCOL_INFO> lpProtocolBuffer,
        Pointer<Uint32> lpdwBufferLength,
        Pointer<Int32> lpErrno)>('WSCEnumProtocols32');
...
late final _WSCGetApplicationCategory = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        int ExtraLength,
        Pointer<Uint32> pPermittedLspCategories,
        Pointer<Int32> lpErrno)>('WSCGetApplicationCategory');
...
int WSCGetProviderInfo(
        ...
        int Flags,
        Pointer<Int32> lpErrno) =>
    _WSCGetProviderInfo(lpProviderId, InfoType, Info, InfoSize, Flags, lpErrno);
...
late final _WSCGetProviderInfo = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<IntPtr> InfoSize,
        int Flags,
        Pointer<Int32> lpErrno)>('WSCGetProviderInfo');
...
late final _WSCGetProviderInfo32 = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<IntPtr> InfoSize,
        int Flags,
        Pointer<Int32> lpErrno)>('WSCGetProviderInfo32');
...
late final _WSCGetProviderPath = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Utf16> lpszProviderDllPath,
        Pointer<Int32> lpProviderDllPathLen,
        Pointer<Int32> lpErrno)>('WSCGetProviderPath');
...
late final _WSCGetProviderPath32 = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Utf16> lpszProviderDllPath,
        Pointer<Int32> lpProviderDllPathLen,
        Pointer<Int32> lpErrno)>('WSCGetProviderPath32');
...
late final _WSCInstallNameSpace = _ws2_32.lookupFunction<
    Int32 Function(Pointer<Utf16> lpszIdentifier, Pointer<Utf16> lpszPathName,
        Uint32 dwNameSpace, Uint32 dwVersion, Pointer<GUID> lpProviderId),
    int Function(
        Pointer<Utf16> lpszIdentifier,
        Pointer<Utf16> lpszPathName,
        int dwNameSpace,
        int dwVersion,
        Pointer<GUID> lpProviderId)>('WSCInstallNameSpace');
...
late final _WSCInstallNameSpace32 = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        int dwNameSpace,
        int dwVersion,
        Pointer<GUID> lpProviderId)>('WSCInstallNameSpace32');
...
int WSCInstallNameSpaceEx(
    ...
    _WSCInstallNameSpaceEx(lpszIdentifier, lpszPathName, dwNameSpace, dwVersion,
        lpProviderId, lpProviderSpecific);
...
late final _WSCInstallNameSpaceEx = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        int dwVersion,
        Pointer<GUID> lpProviderId,
        Pointer<BLOB> lpProviderSpecific)>('WSCInstallNameSpaceEx');
...
int WSCInstallNameSpaceEx32(
        ...
        Pointer<GUID> lpProviderId,
        Pointer<BLOB> lpProviderSpecific) =>
    _WSCInstallNameSpaceEx32(lpszIdentifier, lpszPathName, dwNameSpace,
...
late final _WSCInstallNameSpaceEx32 = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        int dwVersion,
        Pointer<GUID> lpProviderId,
        Pointer<BLOB> lpProviderSpecific)>('WSCInstallNameSpaceEx32');
...
int WSCInstallProvider(
        ...
        Pointer<Int32> lpErrno) =>
    _WSCInstallProvider(lpProviderId, lpszProviderDllPath, lpProtocolInfoList,
...
late final _WSCInstallProvider = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<WSAPROTOCOL_INFO> lpProtocolInfoList,
        int dwNumberOfEntries,
        Pointer<Int32> lpErrno)>('WSCInstallProvider');
...
int WSCInstallProvider64_32(
        ...
        int dwNumberOfEntries,
        Pointer<Int32> lpErrno) =>
    _WSCInstallProvider64_32(lpProviderId, lpszProviderDllPath,
        lpProtocolInfoList, dwNumberOfEntries, lpErrno);
...
late final _WSCInstallProvider64_32 = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<WSAPROTOCOL_INFO> lpProtocolInfoList,
        int dwNumberOfEntries,
        Pointer<Int32> lpErrno)>('WSCInstallProvider64_32');
...
late final _WSCInstallProviderAndChains64_32 = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        int dwNumberOfEntries,
        Pointer<Uint32> lpdwCatalogEntryId,
        Pointer<Int32> lpErrno)>('WSCInstallProviderAndChains64_32');
...
int WSCSetApplicationCategory(
        ...
        Pointer<Int32> lpErrno) =>
    _WSCSetApplicationCategory(Path, PathLength, Extra, ExtraLength,
        PermittedLspCategories, pPrevPermLspCat, lpErrno);
...
late final _WSCSetApplicationCategory = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        int PermittedLspCategories,
        Pointer<Uint32> pPrevPermLspCat,
        Pointer<Int32> lpErrno)>('WSCSetApplicationCategory');

int WSCSetProviderInfo(Pointer<GUID> lpProviderId, int InfoType,
        Pointer<Uint8> Info, int InfoSize, int Flags, Pointer<Int32> lpErrno) =>
    _WSCSetProviderInfo(lpProviderId, InfoType, Info, InfoSize, Flags, lpErrno);
...
late final _WSCSetProviderInfo = _ws2_32.lookupFunction<
    Int32 Function(
        ...
        Uint32 Flags,
        Pointer<Int32> lpErrno),
    int Function(Pointer<GUID> lpProviderId, int InfoType, Pointer<Uint8> Info,
        int InfoSize, int Flags, Pointer<Int32> lpErrno)>('WSCSetProviderInfo');

int WSCSetProviderInfo32(Pointer<GUID> lpProviderId, int InfoType,
        Pointer<Uint8> Info, int InfoSize, int Flags, Pointer<Int32> lpErrno) =>
...
late final _WSCSetProviderInfo32 = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        int InfoSize,
        int Flags,
        Pointer<Int32> lpErrno)>('WSCSetProviderInfo32');

int WSCUnInstallNameSpace(Pointer<GUID> lpProviderId) =>
    _WSCUnInstallNameSpace(lpProviderId);

late final _WSCUnInstallNameSpace = _ws2_32.lookupFunction<
    Int32 Function(Pointer<GUID> lpProviderId),
    int Function(Pointer<GUID> lpProviderId)>('WSCUnInstallNameSpace');

int WSCUnInstallNameSpace32(Pointer<GUID> lpProviderId) =>
    _WSCUnInstallNameSpace32(lpProviderId);

late final _WSCUnInstallNameSpace32 = _ws2_32.lookupFunction<
    Int32 Function(Pointer<GUID> lpProviderId),
    int Function(Pointer<GUID> lpProviderId)>('WSCUnInstallNameSpace32');
...
int WSCUpdateProvider(
        ...
        int dwNumberOfEntries,
        Pointer<Int32> lpErrno) =>
    _WSCUpdateProvider(lpProviderId, lpszProviderDllPath, lpProtocolInfoList,
        dwNumberOfEntries, lpErrno);
...
late final _WSCUpdateProvider = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<WSAPROTOCOL_INFO> lpProtocolInfoList,
        int dwNumberOfEntries,
        Pointer<Int32> lpErrno)>('WSCUpdateProvider');
...
int WSCUpdateProvider32(
        ...
        int dwNumberOfEntries,
        Pointer<Int32> lpErrno) =>
    _WSCUpdateProvider32(lpProviderId, lpszProviderDllPath, lpProtocolInfoList,
        dwNumberOfEntries, lpErrno);
...
late final _WSCUpdateProvider32 = _ws2_32.lookupFunction<
    ...
    int Function(
        ...
        Pointer<WSAPROTOCOL_INFO> lpProtocolInfoList,
        int dwNumberOfEntries,
        Pointer<Int32> lpErrno)>('WSCUpdateProvider32');

int WSCWriteNameSpaceOrder(Pointer<GUID> lpProviderId, int dwNumberOfEntries) =>
    _WSCWriteNameSpaceOrder(lpProviderId, dwNumberOfEntries);

late final _WSCWriteNameSpaceOrder = _ws2_32.lookupFunction<
    Int32 Function(Pointer<GUID> lpProviderId, Uint32 dwNumberOfEntries),
    int Function(Pointer<GUID> lpProviderId,
        int dwNumberOfEntries)>('WSCWriteNameSpaceOrder');

int WSCWriteNameSpaceOrder32(
        Pointer<GUID> lpProviderId, int dwNumberOfEntries) =>
    _WSCWriteNameSpaceOrder32(lpProviderId, dwNumberOfEntries);

late final _WSCWriteNameSpaceOrder32 = _ws2_32.lookupFunction<
    Int32 Function(Pointer<GUID> lpProviderId, Uint32 dwNumberOfEntries),
    int Function(Pointer<GUID> lpProviderId,
        int dwNumberOfEntries)>('WSCWriteNameSpaceOrder32');

int WSCWriteProviderOrder(
        Pointer<Uint32> lpwdCatalogEntryId, int dwNumberOfEntries) =>
    _WSCWriteProviderOrder(lpwdCatalogEntryId, dwNumberOfEntries);

late final _WSCWriteProviderOrder = _ws2_32.lookupFunction<
    Int32 Function(
        Pointer<Uint32> lpwdCatalogEntryId, Uint32 dwNumberOfEntries),
    int Function(Pointer<Uint32> lpwdCatalogEntryId,
        int dwNumberOfEntries)>('WSCWriteProviderOrder');

int WSCWriteProviderOrder32(
        Pointer<Uint32> lpwdCatalogEntryId, int dwNumberOfEntries) =>
    _WSCWriteProviderOrder32(lpwdCatalogEntryId, dwNumberOfEntries);

late final _WSCWriteProviderOrder32 = _ws2_32.lookupFunction<
    Int32 Function(
        Pointer<Uint32> lpwdCatalogEntryId, Uint32 dwNumberOfEntries),
    int Function(Pointer<Uint32> lpwdCatalogEntryId,
        int dwNumberOfEntries)>('WSCWriteProviderOrder32');

int __WSAFDIsSet(int fd, Pointer<fd_set> param1) => ___WSAFDIsSet(fd, param1);

late final ___WSAFDIsSet = _ws2_32.lookupFunction<
    Int32 Function(IntPtr fd, Pointer<fd_set> param1),
    int Function(int fd, Pointer<fd_set> param1)>('__WSAFDIsSet');
...
late final _freeaddrinfo = _ws2_32.lookupFunction<
    Void Function(Pointer<ADDRINFO> pAddrInfo),
    void Function(Pointer<ADDRINFO> pAddrInfo)>('freeaddrinfo');

int getaddrinfo(Pointer<Utf8> pNodeName, Pointer<Utf8> pServiceName,
        Pointer<ADDRINFO> pHints, Pointer<Pointer<ADDRINFO>> ppResult) =>
    _getaddrinfo(pNodeName, pServiceName, pHints, ppResult);

late final _getaddrinfo = _ws2_32.lookupFunction<
    Int32 Function(Pointer<Utf8> pNodeName, Pointer<Utf8> pServiceName,
        Pointer<ADDRINFO> pHints, Pointer<Pointer<ADDRINFO>> ppResult),
    int Function(
        Pointer<Utf8> pNodeName,
        Pointer<Utf8> pServiceName,
        Pointer<ADDRINFO> pHints,
        Pointer<Pointer<ADDRINFO>> ppResult)>('getaddrinfo');
...
int inet_pton(int Family, Pointer<Utf8> pszAddrString, Pointer pAddrBuf) =>
    _inet_pton(Family, pszAddrString, pAddrBuf);

late final _inet_pton = _ws2_32.lookupFunction<
    Int32 Function(Int32 Family, Pointer<Utf8> pszAddrString, Pointer pAddrBuf),
    int Function(int Family, Pointer<Utf8> pszAddrString,
        Pointer pAddrBuf)>('inet_pton');
...
int setsockopt(
        int s, int level, int optname, Pointer<Utf8> optval, int optlen) =>
...
late final _AcceptEx = _mswsock.lookupFunction<
    ...
    int Function(
        ...
        int dwRemoteAddressLength,
        Pointer<Uint32> lpdwBytesReceived,
        Pointer<OVERLAPPED> lpOverlapped)>('AcceptEx');

int EnumProtocols(Pointer<Int32> lpiProtocols, Pointer lpProtocolBuffer,
        Pointer<Uint32> lpdwBufferLength) =>
    _EnumProtocols(lpiProtocols, lpProtocolBuffer, lpdwBufferLength);

late final _EnumProtocols = _mswsock.lookupFunction<
    Int32 Function(Pointer<Int32> lpiProtocols, Pointer lpProtocolBuffer,
        Pointer<Uint32> lpdwBufferLength),
    int Function(Pointer<Int32> lpiProtocols, Pointer lpProtocolBuffer,
        Pointer<Uint32> lpdwBufferLength)>('EnumProtocolsW');
...
late final _GetAcceptExSockaddrs = _mswsock.lookupFunction<
    ...
    void Function(
        ...
        Pointer<Int32> LocalSockaddrLength,
        Pointer<Pointer<SOCKADDR>> RemoteSockaddr,
        Pointer<Int32> RemoteSockaddrLength)>('GetAcceptExSockaddrs');
...
late final _GetAddressByName = _mswsock.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint32> lpdwBufferLength,
        Pointer<Utf16> lpAliasBuffer,
        Pointer<Uint32> lpdwAliasBufferLength)>('GetAddressByNameW');

int GetNameByType(Pointer<GUID> lpServiceType, Pointer<Utf16> lpServiceName,
        int dwNameLength) =>
    _GetNameByType(lpServiceType, lpServiceName, dwNameLength);

late final _GetNameByType = _mswsock.lookupFunction<
    Int32 Function(Pointer<GUID> lpServiceType, Pointer<Utf16> lpServiceName,
        Uint32 dwNameLength),
    int Function(Pointer<GUID> lpServiceType, Pointer<Utf16> lpServiceName,
        int dwNameLength)>('GetNameByTypeW');
...
int GetService(
        ...
        Pointer<SERVICE_ASYNC_INFO> lpServiceAsyncInfo) =>
    _GetService(dwNameSpace, lpGuid, lpServiceName, dwProperties, lpBuffer,
...
late final _GetService = _mswsock.lookupFunction<
    ...
    int Function(
        ...
        Pointer lpBuffer,
        Pointer<Uint32> lpdwBufferSize,
        Pointer<SERVICE_ASYNC_INFO> lpServiceAsyncInfo)>('GetServiceW');

int GetTypeByName(Pointer<Utf16> lpServiceName, Pointer<GUID> lpServiceType) =>
    _GetTypeByName(lpServiceName, lpServiceType);

late final _GetTypeByName = _mswsock.lookupFunction<
    Int32 Function(Pointer<Utf16> lpServiceName, Pointer<GUID> lpServiceType),
    int Function(Pointer<Utf16> lpServiceName,
        Pointer<GUID> lpServiceType)>('GetTypeByNameW');
...
int SetService(
    ...
    _SetService(dwNameSpace, dwOperation, dwFlags, lpServiceInfo,
...
late final _SetService = _mswsock.lookupFunction<
    ...
    int Function(
        ...
        Pointer<SERVICE_INFO> lpServiceInfo,
        Pointer<SERVICE_ASYNC_INFO> lpServiceAsyncInfo,
        Pointer<Uint32> lpdwStatusFlags)>('SetServiceW');
...
int TransmitFile(
        ...
        int dwReserved) =>
    _TransmitFile(hSocket, hFile, nNumberOfBytesToWrite, nNumberOfBytesPerSend,
...
late final _TransmitFile = _mswsock.lookupFunction<
    ...
    int Function(
        ...
        Pointer<OVERLAPPED> lpOverlapped,
        Pointer<TRANSMIT_FILE_BUFFERS> lpTransmitBuffers,
        int dwReserved)>('TransmitFile');

int WSARecvEx(int s, Pointer<Utf8> buf, int len, Pointer<Int32> flags) =>
    _WSARecvEx(s, buf, len, flags);

late final _WSARecvEx = _mswsock.lookupFunction<
    Int32 Function(
        IntPtr s, Pointer<Utf8> buf, Int32 len, Pointer<Int32> flags),
    int Function(
        int s, Pointer<Utf8> buf, int len, Pointer<Int32> flags)>('WSARecvEx');
...
int SetSocketMediaStreamingMode(int value) =>
    _SetSocketMediaStreamingMode(value);

late final _SetSocketMediaStreamingMode = _windows_networking.lookupFunction<
    Int32 Function(Int32 value),
    int Function(int value)>('SetSocketMediaStreamingMode');
