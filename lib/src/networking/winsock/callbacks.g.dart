...
typedef LPBLOCKINGCALLBACK = Int32 Function(IntPtr dwContext);
...
typedef LPFN_CONNECTEX = Int32 Function(
    ...
    Pointer<OVERLAPPED> lpOverlapped);
typedef LPFN_DISCONNECTEX = Int32 Function(IntPtr s,
    Pointer<OVERLAPPED> lpOverlapped, Uint32 dwFlags, Uint32 dwReserved);
...
typedef LPFN_RIOCLOSECOMPLETIONQUEUE = Void Function(Pointer<RIO_CQ_t> CQ);
...
typedef LPFN_RIODEQUEUECOMPLETION = Uint32 Function(
    Pointer<RIO_CQ_t> CQ, Pointer<RIORESULT> Array_, Uint32 ArraySize);
typedef LPFN_RIODEREGISTERBUFFER = Void Function(
    Pointer<RIO_BUFFERID_t> BufferId);
typedef LPFN_RIONOTIFY = Int32 Function(Pointer<RIO_CQ_t> CQ);
...
typedef LPFN_RIOREGISTERBUFFER = Pointer<RIO_BUFFERID_t> Function(
    Pointer<Utf8> DataBuffer, Uint32 DataLength);
typedef LPFN_RIORESIZECOMPLETIONQUEUE = Int32 Function(
    Pointer<RIO_CQ_t> CQ, Uint32 QueueSize);
typedef LPFN_RIORESIZEREQUESTQUEUE = Int32 Function(Pointer<RIO_RQ_t> RQ,
    Uint32 MaxOutstandingReceive, Uint32 MaxOutstandingSend);
...
typedef LPFN_WSAPOLL = Int32 Function(
    Pointer<WSAPOLLFD> fdarray, Uint32 nfds, Int32 timeout);
...
typedef LPLOOKUPSERVICE_COMPLETION_ROUTINE = Void Function(
    Uint32 dwError, Uint32 dwBytes, Pointer<OVERLAPPED> lpOverlapped);
typedef LPNSPCLEANUP = Int32 Function(Pointer<GUID> lpProviderId);
...
typedef LPNSPINSTALLSERVICECLASS = Int32 Function(Pointer<GUID> lpProviderId,
    Pointer<WSASERVICECLASSINFO> lpServiceClassInfo);
...
typedef LPNSPLOOKUPSERVICEEND = Int32 Function(IntPtr hLookup);
...
typedef LPNSPREMOVESERVICECLASS = Int32 Function(
    Pointer<GUID> lpProviderId, Pointer<GUID> lpServiceClassId);
...
typedef LPNSPSTARTUP = Int32 Function(
    Pointer<GUID> lpProviderId, Pointer<NSP_ROUTINE> lpnspRoutines);
typedef LPNSPV2CLEANUP = Int32 Function(
    Pointer<GUID> lpProviderId, Pointer pvClientSessionArg);
...
typedef LPNSPV2LOOKUPSERVICEBEGIN = Int32 Function(
    ...
    Pointer<IntPtr> lphLookup);
typedef LPNSPV2LOOKUPSERVICEEND = Int32 Function(IntPtr hLookup);
...
typedef LPNSPV2STARTUP = Int32 Function(
    Pointer<GUID> lpProviderId, Pointer<Pointer> ppvClientSessionArg);
typedef LPSERVICE_CALLBACK_PROC = Void Function(
    IntPtr lParam, IntPtr hAsyncTaskHandle);
typedef LPWPUCLOSEEVENT = Int32 Function(IntPtr hEvent, Pointer<Int32> lpErrno);
typedef LPWPUCLOSESOCKETHANDLE = Int32 Function(
    IntPtr s, Pointer<Int32> lpErrno);
typedef LPWPUCLOSETHREAD = Int32 Function(
    Pointer<WSATHREADID> lpThreadId, Pointer<Int32> lpErrno);
...
typedef LPWPUCREATEEVENT = IntPtr Function(Pointer<Int32> lpErrno);
typedef LPWPUCREATESOCKETHANDLE = IntPtr Function(
    Uint32 dwCatalogEntryId, IntPtr dwContext, Pointer<Int32> lpErrno);
typedef LPWPUFDISSET = Int32 Function(IntPtr s, Pointer<fd_set> fdset);
...
typedef LPWPUMODIFYIFSHANDLE = IntPtr Function(
    Uint32 dwCatalogEntryId, IntPtr ProposedHandle, Pointer<Int32> lpErrno);
...
typedef LPWPUQUERYSOCKETHANDLECONTEXT = Int32 Function(
    IntPtr s, Pointer<IntPtr> lpContext, Pointer<Int32> lpErrno);
typedef LPWPUQUEUEAPC = Int32 Function(
    Pointer<WSATHREADID> lpThreadId,
    Pointer<NativeFunction<LPWSAUSERAPC>> lpfnUserApc,
    IntPtr dwContext,
    Pointer<Int32> lpErrno);
typedef LPWPURESETEVENT = Int32 Function(IntPtr hEvent, Pointer<Int32> lpErrno);
typedef LPWPUSETEVENT = Int32 Function(IntPtr hEvent, Pointer<Int32> lpErrno);
typedef LPWSAOVERLAPPED_COMPLETION_ROUTINE = Void Function(Uint32 dwError,
    Uint32 cbTransferred, Pointer<OVERLAPPED> lpOverlapped, Uint32 dwFlags);
typedef LPWSAUSERAPC = Void Function(IntPtr dwContext);
...
typedef LPWSCENABLENSPROVIDER = Int32 Function(
    Pointer<GUID> lpProviderId, Int32 fEnable);
...
typedef LPWSCINSTALLPROVIDER = Int32 Function(
    ...
    Pointer<Int32> lpErrno);
typedef LPWSCUNINSTALLNAMESPACE = Int32 Function(Pointer<GUID> lpProviderId);
...
typedef LPWSCWRITENAMESPACEORDER = Int32 Function(
    Pointer<GUID> lpProviderId, Uint32 dwNumberOfEntries);
...
typedef LPWSPASYNCSELECT = Int32 Function(
    IntPtr s, IntPtr hWnd, Uint32 wMsg, Int32 lEvent, Pointer<Int32> lpErrno);
typedef LPWSPBIND = Int32 Function(
    IntPtr s, Pointer<SOCKADDR> name, Int32 namelen, Pointer<Int32> lpErrno);
typedef LPWSPCANCELBLOCKINGCALL = Int32 Function(Pointer<Int32> lpErrno);
typedef LPWSPCLEANUP = Int32 Function(Pointer<Int32> lpErrno);
typedef LPWSPCLOSESOCKET = Int32 Function(IntPtr s, Pointer<Int32> lpErrno);
typedef LPWSPCONNECT = Int32 Function(
    ...
    Pointer<QOS> lpGQOS,
    Pointer<Int32> lpErrno);
typedef LPWSPDUPLICATESOCKET = Int32 Function(IntPtr s, Uint32 dwProcessId,
    Pointer<WSAPROTOCOL_INFO> lpProtocolInfo, Pointer<Int32> lpErrno);
typedef LPWSPENUMNETWORKEVENTS = Int32 Function(IntPtr s, IntPtr hEventObject,
    Pointer<WSANETWORKEVENTS> lpNetworkEvents, Pointer<Int32> lpErrno);
typedef LPWSPEVENTSELECT = Int32 Function(IntPtr s, IntPtr hEventObject,
    Int32 lNetworkEvents, Pointer<Int32> lpErrno);
typedef LPWSPGETOVERLAPPEDRESULT = Int32 Function(
    ...
    Pointer<Int32> lpErrno);
typedef LPWSPGETPEERNAME = Int32 Function(IntPtr s, Pointer<SOCKADDR> name,
    Pointer<Int32> namelen, Pointer<Int32> lpErrno);
typedef LPWSPGETQOSBYNAME = Int32 Function(IntPtr s, Pointer<WSABUF> lpQOSName,
    Pointer<QOS> lpQOS, Pointer<Int32> lpErrno);
typedef LPWSPGETSOCKNAME = Int32 Function(IntPtr s, Pointer<SOCKADDR> name,
    Pointer<Int32> namelen, Pointer<Int32> lpErrno);
typedef LPWSPGETSOCKOPT = Int32 Function(IntPtr s, Int32 level, Int32 optname,
    Pointer<Utf8> optval, Pointer<Int32> optlen, Pointer<Int32> lpErrno);
...
typedef LPWSPLISTEN = Int32 Function(
    IntPtr s, Int32 backlog, Pointer<Int32> lpErrno);
...
typedef LPWSPRECVDISCONNECT = Int32 Function(
    IntPtr s, Pointer<WSABUF> lpInboundDisconnectData, Pointer<Int32> lpErrno);
...
typedef LPWSPSENDDISCONNECT = Int32 Function(
    IntPtr s, Pointer<WSABUF> lpOutboundDisconnectData, Pointer<Int32> lpErrno);
typedef LPWSPSENDTO = Int32 Function(
    ...
    Pointer<WSATHREADID> lpThreadId,
    Pointer<Int32> lpErrno);
typedef LPWSPSETSOCKOPT = Int32 Function(IntPtr s, Int32 level, Int32 optname,
    Pointer<Utf8> optval, Int32 optlen, Pointer<Int32> lpErrno);
typedef LPWSPSHUTDOWN = Int32 Function(
    IntPtr s, Int32 how, Pointer<Int32> lpErrno);
